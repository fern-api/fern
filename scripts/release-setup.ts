...
rc: false  # Set to true to create a release candidate (e.g., 3.15.0-rc0).
           # If the current version is already an RC of the same target, the RC counter increments (e.g., 3.15.0-rc1).
changes:
  - summary: |
