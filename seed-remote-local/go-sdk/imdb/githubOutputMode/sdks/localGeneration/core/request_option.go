...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/fern-api/test-remote-local-sdk/v7")
	headers.Set("X-Fern-SDK-Version", "v7.7.7")
	headers.Set("User-Agent", "github.com/fern-api/test-remote-local-sdk/7.7.7")
	return headers
}
