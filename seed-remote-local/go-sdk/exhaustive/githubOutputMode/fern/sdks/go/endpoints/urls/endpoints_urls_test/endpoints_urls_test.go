...
func TestEndpointsUrlsWithMixedCaseWithWireMock(
	...
	VerifyRequestCount(t, "GET", "/urls/MixedCase", nil, 1)
}
...
func TestEndpointsUrlsNoEndingSlashWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/urls/no-ending-slash", nil, 1)
}
...
func TestEndpointsUrlsWithEndingSlashWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/urls/with-ending-slash/", nil, 1)
}
...
func TestEndpointsUrlsWithUnderscoresWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/urls/with_underscores", nil, 1)
}
