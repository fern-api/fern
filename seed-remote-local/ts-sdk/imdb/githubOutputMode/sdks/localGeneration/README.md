...
[![npm shield](https://img.shields.io/npm/v/@fern-fern/test-remote-local-sdk)](https://www.npmjs.com/package/@fern-fern/test-remote-local-sdk)
...
```sh
npm i -s @fern-fern/test-remote-local-sdk
```
...
```typescript
import { FernApiClient } from "@fern-fern/test-remote-local-sdk";

const client = new FernApiClient({ environment: "YOUR_BASE_URL", token: "YOUR_TOKEN" });
...
```typescript
import { FernApiError } from "@fern-fern/test-remote-local-sdk";
...
```typescript
import { FernApiClient, logging } from "@fern-fern/test-remote-local-sdk";
