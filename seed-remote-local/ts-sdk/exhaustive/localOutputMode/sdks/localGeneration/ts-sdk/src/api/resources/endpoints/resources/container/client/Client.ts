...
export class Container {
    ...
    /**
     * @param {Record<string, FernExhaustive.types.ObjectWithRequiredField>} request
     * @param {Container.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public getAndReturnMapOfPrimToObject(
        request: Record<string, FernExhaustive.types.ObjectWithRequiredField>,
        requestOptions?: Container.RequestOptions,
    ): core.HttpResponsePromise<Record<string, FernExhaustive.types.ObjectWithRequiredField>> {
    ...
    private async __getAndReturnMapOfPrimToObject(
        request: Record<string, FernExhaustive.types.ObjectWithRequiredField>,
        requestOptions?: Container.RequestOptions,
    ): Promise<core.WithRawResponse<Record<string, FernExhaustive.types.ObjectWithRequiredField>>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({ Authorization: await this._getAuthorizationHeader() }),
            requestOptions?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Record<string, FernExhaustive.types.ObjectWithRequiredField>,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    public getAndReturnOptional(
        request?: FernExhaustive.types.ObjectWithRequiredField,
        requestOptions?: Container.RequestOptions,
    ): core.HttpResponsePromise<FernExhaustive.types.ObjectWithRequiredField | undefined> {
    ...
    private async __getAndReturnOptional(
        request?: FernExhaustive.types.ObjectWithRequiredField,
        requestOptions?: Container.RequestOptions,
    ): Promise<core.WithRawResponse<FernExhaustive.types.ObjectWithRequiredField | undefined>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({ Authorization: await this._getAuthorizationHeader() }),
            requestOptions?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as FernExhaustive.types.ObjectWithRequiredField | undefined,
                rawResponse: _response.rawResponse,
            };
        }
