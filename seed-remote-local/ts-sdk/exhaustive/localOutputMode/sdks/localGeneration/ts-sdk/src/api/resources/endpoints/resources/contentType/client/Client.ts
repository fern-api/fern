...
export class ContentType {
    ...
    private async __postJsonPatchContentType(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /foo/bar.");
            case "unknown":
                throw new errors.FernExhaustiveError({
    ...
    private async __postJsonPatchContentWithCharsetType(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /foo/baz.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
