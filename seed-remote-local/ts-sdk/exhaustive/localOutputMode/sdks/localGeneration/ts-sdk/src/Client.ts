...
export declare namespace FernExhaustiveClient {
    export interface Options extends BaseClientOptions {}

    export interface RequestOptions extends BaseRequestOptions {}
}

export class FernExhaustiveClient {
    protected readonly _options: FernExhaustiveClient.Options;
    ...
    constructor(_options: FernExhaustiveClient.Options) {
        this._options = {
            ..._options,
