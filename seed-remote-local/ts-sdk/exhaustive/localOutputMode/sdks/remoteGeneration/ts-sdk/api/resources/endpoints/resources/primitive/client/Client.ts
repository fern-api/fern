...
export class Primitive {
    ...
    private async __getAndReturnString(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /primitive/string.");
            case "unknown":
                throw new errors.FernExhaustiveError({
    ...
    private async __getAndReturnInt(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /primitive/integer.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __getAndReturnLong(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /primitive/long.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __getAndReturnDouble(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /primitive/double.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __getAndReturnBool(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /primitive/boolean.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __getAndReturnDatetime(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /primitive/datetime.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __getAndReturnDate(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /primitive/date.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __getAndReturnUuid(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /primitive/uuid.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __getAndReturnBase64(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /primitive/base64.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
