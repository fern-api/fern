...
export class HttpMethods {
    ...
    private async __testGet(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling GET /http-methods/{id}.");
            case "unknown":
                throw new errors.FernExhaustiveError({
    ...
    private async __testPost(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /http-methods.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __testPut(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling PUT /http-methods/{id}.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __testPatch(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling PATCH /http-methods/{id}.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __testDelete(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling DELETE /http-methods/{id}.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
