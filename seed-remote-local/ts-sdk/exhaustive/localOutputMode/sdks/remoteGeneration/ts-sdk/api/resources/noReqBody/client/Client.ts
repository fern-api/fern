...
export class NoReqBody {
    ...
    private async __getWithNoRequestBody(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling GET /no-req-body.");
            case "unknown":
                throw new errors.FernExhaustiveError({
    ...
    private async __postWithNoRequestBody(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling POST /no-req-body.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
