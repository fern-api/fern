...
export class Params {
    ...
    private async __getWithPath(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling GET /params/path/{param}.");
            case "unknown":
                throw new errors.FernExhaustiveError({
     ...
     * GET with path param
     *
     * @param {FernExhaustive.endpoints.GetWithInlinePath} request
     * @param {Params.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {FernExhaustive.endpoints.GetWithQuery} request
     * @param {Params.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    private async __getWithQuery(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling GET /params.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *
     * @param {FernExhaustive.endpoints.GetWithMultipleQuery} request
     * @param {Params.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {string} param
     * @param {FernExhaustive.endpoints.GetWithPathAndQuery} request
     * @param {Params.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     * GET with path and query params
     *
     * @param {FernExhaustive.endpoints.GetWithInlinePathAndQuery} request
     * @param {Params.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    private async __modifyWithPath(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.FernExhaustiveTimeoutError("Timeout exceeded when calling PUT /params/path/{param}.");
            case "unknown":
                throw new errors.FernExhaustiveError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     * PUT to update with path param
     *
     * @param {FernExhaustive.endpoints.ModifyResourceAtInlinedPath} request
     * @param {Params.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
