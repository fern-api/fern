...
public class FernExhaustiveClientBuilder {
   ...
   * Sets token
   */
  public FernExhaustiveClientBuilder token(String token) {
    this.token = token;
    return this;
  }

  public FernExhaustiveClientBuilder url(String url) {
   ...
   */
  public FernExhaustiveClientBuilder timeout(int timeout) {
   ...
   */
  public FernExhaustiveClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public FernExhaustiveClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public FernExhaustiveClientBuilder addHeader(String name, String value) {
  ...
  public FernExhaustiveClient build() {
    validateConfiguration();
    return new FernExhaustiveClient(buildClientOptions());
  }
}
