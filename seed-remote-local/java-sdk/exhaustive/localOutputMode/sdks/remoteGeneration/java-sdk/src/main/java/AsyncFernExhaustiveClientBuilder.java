...
public class AsyncFernExhaustiveClientBuilder {
   ...
   * Sets token
   */
  public AsyncFernExhaustiveClientBuilder token(String token) {
    this.token = token;
    return this;
  }

  public AsyncFernExhaustiveClientBuilder url(String url) {
   ...
   */
  public AsyncFernExhaustiveClientBuilder timeout(int timeout) {
   ...
   */
  public AsyncFernExhaustiveClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public AsyncFernExhaustiveClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public AsyncFernExhaustiveClientBuilder addHeader(String name, String value) {
  ...
  public AsyncFernExhaustiveClient build() {
    validateConfiguration();
    return new AsyncFernExhaustiveClient(buildClientOptions());
  }
}
