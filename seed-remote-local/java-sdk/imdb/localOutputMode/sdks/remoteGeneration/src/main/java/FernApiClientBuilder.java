...
public class FernApiClientBuilder {
   ...
   * Sets token
   */
  public FernApiClientBuilder token(String token) {
    this.token = token;
    return this;
  }

  public FernApiClientBuilder url(String url) {
   ...
   */
  public FernApiClientBuilder timeout(int timeout) {
   ...
   */
  public FernApiClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public FernApiClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public FernApiClientBuilder addHeader(String name, String value) {
  ...
  public FernApiClient build() {
    validateConfiguration();
    return new FernApiClient(buildClientOptions());
  }
}
