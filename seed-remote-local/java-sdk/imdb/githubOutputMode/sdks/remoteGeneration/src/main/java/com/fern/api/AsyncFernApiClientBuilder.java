...
import com.fern.api.core.Environment;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncFernApiClientBuilder {
     ...
     * Sets token
     */
    public AsyncFernApiClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public AsyncFernApiClientBuilder url(String url) {
     ...
     */
    public AsyncFernApiClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncFernApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncFernApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncFernApiClientBuilder addHeader(String name, String value) {
    ...
    public AsyncFernApiClient build() {
        validateConfiguration();
        return new AsyncFernApiClient(buildClientOptions());
    }
}
