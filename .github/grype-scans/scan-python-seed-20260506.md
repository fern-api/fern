...
- **Scan Date:** 2026-05-06T12:40:43.210Z
...
### GHSA-58pv-8j8x-9vj2 (High)
- **Package:** jaraco-context @ 5.3.0 (python)
- **Status:** fixed
- **Fix available: 6.1.0**
- **Source:** https://github.com/advisories/GHSA-58pv-8j8x-9vj2
...
### GHSA-8rrh-rw8j-w5fx (High)
- **Package:** wheel @ 0.45.1 (python)
- **Status:** fixed
- **Fix available: 0.46.2**
