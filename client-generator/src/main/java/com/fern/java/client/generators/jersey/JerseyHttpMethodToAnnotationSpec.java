...
import com.fern.ir.v3.model.services.http.HttpMethod;
...
public final class JerseyHttpMethodToAnnotationSpec implements HttpMethod.Visitor<AnnotationSpec> {

    public static final JerseyHttpMethodToAnnotationSpec INSTANCE = new JerseyHttpMethodToAnnotationSpec();
