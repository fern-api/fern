                    ...
                    return {
                        ...
                        displayName:
                            variant.type.type === "named"
                                ? (variant.type.displayName ?? variant.type.name.originalName)
                                : undefined
                    };
                })
            };
            ...
            return Ir.types.ContainerType._visit<FdrCjsSdk.api.v1.register.TypeReference>(container, {
                list: (listType) => {
                    return {
                        ...
                        minItems: listType.validation?.minItems,
                        maxItems: listType.validation?.maxItems
                    };
                },
                map: (mapType) => {
                    return {
                        ...
                        minProperties: mapType.validation?.minProperties,
                        maxProperties: mapType.validation?.maxProperties
                    };
                },
                optional: (itemType) => {
                    return {
                ...
                set: (setType) => {
                    return {
                        ...
                        minItems: setType.validation?.minItems,
                        maxItems: setType.validation?.maxItems
                    };
                },
                literal: (literal) => {
