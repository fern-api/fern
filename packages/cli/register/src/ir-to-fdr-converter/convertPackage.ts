...
const AUTOGENERATED_EXAMPLE_PREFIX = "autogenerated_example_";
    ...
    for (const irEndpoint of irService.endpoints) {
        ...
        if (irEndpoint.v2Examples != null) {
            ...
            const mergedExamples = {
                ...irEndpoint.v2Examples.userSpecifiedExamples,
                ...irEndpoint.v2Examples.autogeneratedExamples
            };
            for (const [name, example] of Object.entries(mergedExamples)) {
                endpointExample = convertV2HttpEndpointExample({
                    exampleName:
                        Object.keys(mergedExamples).length > 1 && name.startsWith(AUTOGENERATED_EXAMPLE_PREFIX)
                            ? name
                            : undefined,
                    example,
                    irEndpoint
