...
/**
 * Adds a placeholder scheme and host to URLs that don't have them. For example,
 * "///my-service/api/my-endpoint" becomes "https://your-hostname/my-service/api/my-endpoint".
 */
function addPlaceholderSchemeAndHost(url: string): string {
...
function convertHttpEndpointExample({
    ...
    return {
        name: example.name?.originalName,
        description: example.docs,
        path: ir.environments == null ? addPlaceholderSchemeAndHost(example.url) : example.url,
        pathParameters: [
