...
function convertWebSocketChannel(
    ...
    if (
        ...
        for (const [exampleName, example] of Object.entries(channel.v2Examples.userSpecifiedExamples)) {
            examples.push({
                name: example.name ?? exampleName,
                description: "",
                path: example.baseUrl ?? "",
        ...
        for (const [exampleName, example] of Object.entries(channel.v2Examples.autogeneratedExamples)) {
            examples.push({
                name: example.name ?? exampleName,
                description: "",
                path: example.baseUrl ?? "",
