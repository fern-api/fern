...
export type ExampleEndpointCallWithResponseHeaders = FdrCjsSdk.api.v1.register.ExampleEndpointCall & {
...
function convertResponseHeaderExamples(headers: Ir.http.HttpHeader[] | undefined): Record<string, unknown> | undefined {
    ...
    for (const header of headers ?? []) {
        // First example wins: prefer the first user-specified example, else the first autogenerated.
        const example =
...
function convertHttpEndpointExample({
    ...
    return {
        ...
        responseHeaders: convertResponseHeaderExamples(responseHeadersForExample),
