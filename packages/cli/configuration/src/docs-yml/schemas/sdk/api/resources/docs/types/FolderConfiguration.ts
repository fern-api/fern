...
export interface FolderConfiguration extends FernDocsConfig.WithPermissions, FernDocsConfig.WithFeatureFlags {
    ...
    hidden?: boolean;
    skipSlug?: boolean;
    /** Deprecated. Use `collapsible` and `collapsed-by-default` instead. When set to `true` or `{ default: "closed" }`, the section starts collapsed. When set to `{ default: "open" }`, the section starts expanded but can be collapsed. */
    collapsed?: FernDocsConfig.CollapsedConfig;
