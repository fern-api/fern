...
export interface VersionInfo extends CjsFdrSdk.navigation.v1.WithPermissions, CjsFdrSdk.navigation.latest.WithFeatureFlags {
    landingPage: DocsNavigationItem.Page | undefined;
...
export interface TabbedNavigation extends CjsFdrSdk.navigation.v1.WithPermissions, CjsFdrSdk.navigation.latest.WithFeatureFlags {
    // tab: string;
    title: string;
...
export declare namespace DocsNavigationItem {
    export interface Page extends CjsFdrSdk.navigation.v1.WithPermissions, CjsFdrSdk.navigation.latest.WithFeatureFlags {
        type: "page";
        title: string;
        icon: string | undefined;
        absolutePath: AbsoluteFilePath;
    ...
    export interface Section extends CjsFdrSdk.navigation.v1.WithPermissions, CjsFdrSdk.navigation.latest.WithFeatureFlags {
        type: "section";
        title: string;
        icon: string | undefined;
    ...
    export interface ApiSection extends CjsFdrSdk.navigation.v1.WithPermissions, CjsFdrSdk.navigation.latest.WithFeatureFlags {
        type: "apiSection";
        title: string;
        icon: string | undefined;
    ...
    export interface Changelog extends CjsFdrSdk.navigation.v1.WithPermissions, CjsFdrSdk.navigation.latest.WithFeatureFlags {
        type: "changelog";
        changelog: AbsoluteFilePath[];
        title: string;
        icon: string | undefined;
...
export declare namespace ParsedApiReferenceLayoutItem {
    ...
    export interface Package extends CjsFdrSdk.navigation.v1.WithPermissions, CjsFdrSdk.navigation.latest.WithFeatureFlags {
        type: "package";
    ...
    export interface Endpoint extends CjsFdrSdk.navigation.v1.WithPermissions, CjsFdrSdk.navigation.latest.WithFeatureFlags {
        type: "endpoint";
