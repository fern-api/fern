...
export const PROTOC_GEN_FERN_PLUGIN_PATH = "/Users/sahil/Fern/fern/packages/cli/generation/protoc-gen-fern/lib/protoc-gen-fern.js";

export const PROTOBUF_GEN_CONFIG = 
`version: v2
plugins:
...
export const PROTOBUF_SHELL_PROXY = 
`#!/usr/bin/env node
