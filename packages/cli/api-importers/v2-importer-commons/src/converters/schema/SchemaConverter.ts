...
import { V2SchemaExample } from "@fern-api/ir-sdk";
...
export class SchemaConverter extends AbstractConverter<AbstractConverterContext<object>, SchemaConverter.Output> {
    ...
    public async createTypeDeclaration({
        ...
        const v2UserSpecifiedExamples: V2SchemaExample[] = [];
        if (this.schema.example != null) {
            v2UserSpecifiedExamples.push(this.schema.example);
        }
        if (this.schema.examples != null) {
            v2UserSpecifiedExamples.push(...Object.values(this.schema.examples));
        }
        return {
            ...
            inline: this.inlined,
            v2Examples: {
                userSpecifiedExamples: v2UserSpecifiedExamples,
                autogeneratedExamples: []
            }
        };
    }
    ...
    private async createTypeDeclarationFromFernType({
        ...
        return {
            ...
            inline: this.inlined,
            v2Examples: {
                userSpecifiedExamples: this.schema.examples ?? [],
                autogeneratedExamples: []
            }
        };
    }
