...
export class SchemaConverter extends AbstractConverter<AbstractConverterContext<object>, SchemaConverter.Output> {
    ...
    // public async createTypeDeclarationFromFernType({
    //     fernType,
    //     context,
    //     errorCollector
    // }: {
    ...
    //     const typeShape = await this.getTypeShapeFromFernType(fernType);
    //     return {
    //         name: this.convertDeclaredTypeName({ context }),
    //         shape: typeShape,
    //         autogeneratedExamples: [],
    ...
    private async createTypeDeclarationFromFernType({
        ...
        const name = this.convertDeclaredTypeName({ context });
        const docs = this.schema.description;
        ...
        const inline = this.inlined;
        const baseTypeDeclaration = {
            name,
            autogeneratedExamples: [],
            userProvidedExamples: [],
            encoding: undefined,
