...
export abstract class AbstractExampleWebsocketSessionFactory {
    public readonly exampleTypeFactory: ExampleTypeFactory;
    public readonly schemas: Record<string, SchemaWithExample>;
    ...
    public abstract buildWebsocketSessionExamplesForExtension({
        context,
        extensionExamples,
        publish,
        subscribe,
    ...
    public isSchemaRequired(schema: SchemaWithExample) {
        return isSchemaRequired(this.getResolvedSchema(schema));
    }

    public getResolvedSchema(schema: SchemaWithExample) {
