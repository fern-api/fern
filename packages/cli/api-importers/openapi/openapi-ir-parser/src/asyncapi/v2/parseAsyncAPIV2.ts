...
import { V2ExampleWebsocketSessionFactory } from "./V2ExampleWebsocketSessionFactory";
...
export function parseAsyncAPIV2({
    ...
    const exampleFactory = new V2ExampleWebsocketSessionFactory(schemas, context);
