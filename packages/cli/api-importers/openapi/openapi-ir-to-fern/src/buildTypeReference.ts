...
export function buildNonInlineableTypeReference({
    ...
    console.log("buildNonInlineableTypeReference");
    context.disableInlining();
...
export function buildTypeReference({
    ...
    context: OpenApiIrConverterContext;
    namespace: string | undefined;
}): RawSchemas.InlineableTypeReferenceDeclarationWithNameSchema {
    switch (schema.type) {
        case "primitive": {
        ...
        case "object": {
            ...
            console.log("buildObjectTypeReference", JSON.stringify(value));
            return value;
        }
        case "oneOf":
...
export function buildOptionalTypeReference({
    ...
    const itemTypeReference = buildNonInlineableTypeReference({
        schema: schema.value,
        fileContainingReference,
        declarationFile,
        context,
...
export function buildObjectTypeReference({
    ...
    console.log("objectSchema", JSON.stringify(schema));
    ...
    console.log("objectTypeDeclaration", objectTypeDeclaration);
    const name = schema.nameOverride ?? schema.generatedName;
    if (context.shouldInline()) {
        console.log("Inlining!");
        const response = {
            // TODO: add autogenerated name
            type: objectTypeDeclaration.schema
        };
        console.log("Inlined response!", JSON.stringify(response));
        return response;
    }
