...
description: "Zep helps developers search through long-term memory stores to find relevant historical conversations efficiently. With automated embedding and advanced indexing, Zep offers robust search capabilities that are straightforward and effective."
---
