...
title: FAQ
slug: >-
  /users/dsinghvi/git/fern/packages/cli/docs-importers/mintlify/src/__test__/fixtures/zep/faq
---
...
<Accordion title="Does Zep Cloud work with Flowise?">
    ...
    You can learn more in our [Flowise Ecosystem section](ecosystem/flowise.mdx).

</Accordion>

<Accordion title="Are there any features missing from Zep Cloud that are available in Zep Open Source?">
    Yes - we've deprecated Intent Analysis and replaced it with a [Session Classifier](dialog-classification.mdx).
