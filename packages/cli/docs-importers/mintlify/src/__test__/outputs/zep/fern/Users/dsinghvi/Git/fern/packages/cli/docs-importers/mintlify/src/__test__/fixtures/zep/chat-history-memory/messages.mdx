---
slug: >-
  /users/dsinghvi/git/fern/packages/cli/docs-importers/mintlify/src/__test__/fixtures/zep/chat-history-memory/messages
---

<Card title="Messages" icon="message">
  Messages are the individual components of a conversation, each linked to a [Session](sessions.mdx) in a many-to-one
  relationship. To incorporate messages into sessions, utilize the [Memories](memories.mdx) feature.
</Card>
