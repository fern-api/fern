...
slug: >-
  /users/dsinghvi/git/fern/packages/cli/docs-importers/mintlify/src/__test__/fixtures/zep/working-with-search
---
...
Read more about [chat message history search](chat-history-memory/search.mdx).
