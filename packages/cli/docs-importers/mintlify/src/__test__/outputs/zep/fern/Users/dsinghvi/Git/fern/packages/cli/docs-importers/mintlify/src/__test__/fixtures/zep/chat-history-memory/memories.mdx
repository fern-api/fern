...
slug: >-
  /users/dsinghvi/git/fern/packages/cli/docs-importers/mintlify/src/__test__/fixtures/zep/chat-history-memory/memories
---
...
>
    ...
    Memories are associated with [Sessions](sessions.mdx) in a many-to-one relationship.
...
[Manually creating a session](sessions.mdx) can be useful if you want to associate it with a user or add metadata.
