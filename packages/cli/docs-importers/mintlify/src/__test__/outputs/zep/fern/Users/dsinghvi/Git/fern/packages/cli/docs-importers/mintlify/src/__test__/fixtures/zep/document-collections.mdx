...
slug: >-
  /users/dsinghvi/git/fern/packages/cli/docs-importers/mintlify/src/__test__/fixtures/zep/document-collections
---
...
For details on initializing the Zep client, check out the [SDK documentation](sdks.mdx).
...
<Info>
    ...
    Read more about [constructing search queries](working-with-search.mdx).
