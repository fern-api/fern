---
slug: >-
  /users/dsinghvi/git/fern/packages/cli/docs-importers/mintlify/src/__test__/fixtures/zep/chat-history-memory/summaries
---
...
Summaries are added to Memory responses when you retrieve a Session's [Memory](memories.mdx), enabling your prompt to be
