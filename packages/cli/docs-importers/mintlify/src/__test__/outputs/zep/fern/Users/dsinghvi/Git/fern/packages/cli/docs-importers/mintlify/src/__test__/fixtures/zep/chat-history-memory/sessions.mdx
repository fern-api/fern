---
slug: >-
  /users/dsinghvi/git/fern/packages/cli/docs-importers/mintlify/src/__test__/fixtures/zep/chat-history-memory/sessions
---
...
Chat messages are added to sessions in the form of [Memories](memories.mdx). Each session can have many messages
associated with it.
