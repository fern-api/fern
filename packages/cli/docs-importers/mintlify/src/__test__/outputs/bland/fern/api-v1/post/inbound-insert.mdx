...
Any phone numbers that failed to be inserted will not be included in this array - for example if they are already in your account or not associated with the specified Twilio account.
