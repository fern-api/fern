...
<Steps>
  ...
  <Step title="Write your prompt">
    For the task box either select one of the example prompts or write your own. For more instructions about prompting
...
To send a phone call programmatically, read the <a href="/api-v1/post/calls">API reference</a>.
...
You now know how to send and test phone calls, but you've only scratched the surface of Bland's capabilities.
