...
<img style={{ borderRadius: "0.5rem" }} src="webhook.png" />
...
<img style={{ borderRadius: "0.5rem" }} src="inbound-number-webhook.png" />
...
<img style={{ borderRadius: "0.5rem" }} src="webhook-fires-successfully.png" />
