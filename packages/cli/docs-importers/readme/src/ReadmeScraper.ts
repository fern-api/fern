...
import { DEFAULT_LAYOUT, FernDocsBuilder } from "@fern-api/docs-importer-commons";
...
export declare namespace ReadmeScraper {
    interface Args {
        url: string;
        logger: Logger;
        /**
...
export class ReadmeScraper {
    ...
    public async scrape(): Promise<void> {
        ...
        const navBuilder = this.builder.getNavigationBuilder();
    ...
    private async downloadMarkdownPages({
        ...
        for (const section of sections) {
            ...
            const absolutePathToOutputDirectoryForSection = fsUtilsJoin(
                absolutePathToOutputDirectory,
