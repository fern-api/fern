...
export class DocsDefinitionResolver {
    ...
    private getFernWorkspaceForApiSection(
        ...
        const errorMessage = apiSection.apiName
            ? `Failed to load API Definition '${apiSection.apiName}' referenced in docs. A valid API configuration was not found at the path: fern/apis/${apiSection.apiName}. Learn more about API definitions: https://buildwithfern.com/learn/docs/getting-started/project-structure#api-definitions`
            : "Failed to load API Definition referenced in docs. Learn more about API definitions: https://buildwithfern.com/learn/docs/getting-started/project-structure#api-definitions";
