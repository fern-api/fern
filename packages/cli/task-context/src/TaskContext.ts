...
export interface TaskContext {
    ...
    failAndThrow: (message?: string, error?: unknown, options?: { code?: CliErrorCode }) => never;
    failWithoutThrowing: (message?: string, error?: unknown, options?: { code?: CliErrorCode }) => void;
