...
export class BamlSyncClient {
  ...
  */
  ...
  AnalyzeSdkDiff(
      diff: string,language: string,previous_version: string,prior_changelog: string,
    ...
    try {
      ...
      const __raw__ = this.runtime.callFunctionSync(
        "AnalyzeSdkDiff",
        {
          "diff": diff,"language": language,"previous_version": previous_version,"prior_changelog": prior_changelog
        },
