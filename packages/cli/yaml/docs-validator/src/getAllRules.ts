...
import { NoExternalNpmDependenciesRule } from "./rules/no-external-npm-dependencies";
...
const allRules = [
    ...
    NoExternalNpmDependenciesRule, // Check custom components don't use external npm dependencies
