import { getPathToNamedChildType, PathToNamedChildTypeArgs, TypeResolverImpl } from "@fern-api/ir-generator";
        ...
        return {
            definitionFile: {
                typeDeclaration: ({ typeName, declaration }, { relativeFilepath, contents }) => {
                    ...
                    const args: PathToNamedChildTypeArgs = {
                        childName: name,
                        typeName: name,
                    ...
                    const cyclicType = getPathToNamedChildType(args);
