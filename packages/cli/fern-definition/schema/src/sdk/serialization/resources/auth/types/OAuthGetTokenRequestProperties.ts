...
> = core.serialization.object({
    clientId: core.serialization.property("client-id", core.serialization.string().optional()),
    clientSecret: core.serialization.property("client-secret", core.serialization.string().optional()),
