...
import { HttpPathParameter } from "../../service/types/HttpPathParameter";
...
export const RootApiFile: core.serialization.ObjectSchema<serializers.RootApiFile.Raw, FernDefinition.RootApiFile> =
    core.serialization
        .object({
            ...
            errorDiscrimination: core.serialization.property("error-discrimination", ErrorDiscrimination.optional()),
            ...
            idempotencyHeaders: core.serialization.property(
                "idempotency-headers",
                core.serialization.record(core.serialization.string(), HttpHeader).optional()
            ),
