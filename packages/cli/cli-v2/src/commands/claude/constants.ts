...
export const FERN_SKILLS: readonly FernSkill[] = [
  {
    ...
    description:
      "Initialize a Fern project from an OpenAPI / AsyncAPI / gRPC definition.",
  },
  {
    name: "generate-sdk",
    description:
      "Generate a language SDK (TypeScript, Python, Java, Go, Ruby, C#, PHP, Rust, Swift).",
  },
  {
    name: "scaffold-docs-site",
    description:
      "Scaffold a Fern documentation site from an existing API definition.",
  },
  {
