...
export class Imdb {
     ...
     * @param {SeedApi.UpdateMovieRequest} request
     * @param {Imdb.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public updateMovie(
        ...
        return core.HttpResponsePromise.fromPromise(this.__updateMovie(movieId, request, requestOptions));
    }

    private async __updateMovie(
        movieId: SeedApi.MovieId,
        request: SeedApi.UpdateMovieRequest,
        requestOptions?: Imdb.RequestOptions,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedApiTimeoutError("Timeout exceeded when calling PUT /movies/{movieId}.");
            case "unknown":
                throw new errors.SeedApiError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
