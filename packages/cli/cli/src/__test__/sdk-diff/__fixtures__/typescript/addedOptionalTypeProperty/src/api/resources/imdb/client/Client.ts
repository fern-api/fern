...
export class Imdb {
     ...
     */
    public listMovies(requestOptions?: Imdb.RequestOptions): core.HttpResponsePromise<SeedApi.Movie[]> {
        return core.HttpResponsePromise.fromPromise(this.__listMovies(requestOptions));
    }

    private async __listMovies(requestOptions?: Imdb.RequestOptions): Promise<core.WithRawResponse<SeedApi.Movie[]>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
