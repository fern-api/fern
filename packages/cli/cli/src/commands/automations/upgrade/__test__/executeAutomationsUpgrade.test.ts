...
describe("getChangelogUrl", () => {
    it("derives typescript changelog URL from SDK generator name", () => {
        expect(getChangelogUrl("fernenterprise/fern-typescript-sdk")).toBe(
    ...
    it("handles model generators (non-SDK)", () => {
        expect(getChangelogUrl("fernenterprise/fern-java-model")).toBe(
            "https://buildwithfern.com/learn/sdks/generators/java/changelog"
        );
    });

    it("handles server generators", () => {
        expect(getChangelogUrl("fernenterprise/fern-python-server")).toBe(
            "https://buildwithfern.com/learn/sdks/generators/python/changelog"
        );
    });
});
...
describe("getShortGeneratorName", () => {
    it("strips fernenterprise/fern- prefix", () => {
        expect(getShortGeneratorName("fernenterprise/fern-typescript-sdk")).toBe("typescript-sdk");
    });

    it("strips prefix from variant names", () => {
        expect(getShortGeneratorName("fernenterprise/fern-ruby-sdk-v2")).toBe("ruby-sdk-v2");
    });
...
describe("buildPrBody", () => {
    it("includes CLI section and generator table", () => {
        ...
        expect(body).toContain("| fernenterprise/fern-typescript-sdk | 3.63.4 | 3.65.5 |");
...
describe("AutomationsUpgradeResult schema", () => {
    it("documents the expected JSON output shape including pr field", () => {
        const exampleResult = {
            ...
            skippedMajor: [{ name: "fernenterprise/fern-ruby-sdk-v2", current: "0.3.0", latest: "1.0.0" }],
            alreadyUpToDate: [{ name: "fernenterprise/fern-go-sdk", version: "1.37.0" }],
            pr: {
