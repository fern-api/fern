...
describe("addLanguageSuffixToUrl", () => {
    describe("buildwithfern.com domains", () => {
        ...
        it("should handle buildwithfern.com URLs with trailing slashes", () => {
            expect(addLanguageSuffixToUrl("https://acme.docs.buildwithfern.com/docs/", "de")).toBe(
                "https://acme-de.docs.buildwithfern.com/docs/"
            );
            expect(addLanguageSuffixToUrl("https://acme.docs.buildwithfern.com/api/v1/", "fr")).toBe(
                "https://acme-fr.docs.buildwithfern.com/api/v1/"
            );
        });
    });
    ...
    describe("custom domains", () => {
        it("should add language as subdomain prefix for custom domains", () => {
            expect(addLanguageSuffixToUrl("https://docs.custom.com", "de")).toBe("https://de.docs.custom.com");
            expect(addLanguageSuffixToUrl("https://api.example.com/v1", "fr")).toBe("https://fr.api.example.com/v1");
            expect(addLanguageSuffixToUrl("https://help.company.com/docs/getting-started", "es")).toBe(
                "https://es.help.company.com/docs/getting-started"
            );
        });
    ...
    describe("different protocols", () => {
        it("should handle different protocols correctly for buildwithfern.com", () => {
            expect(addLanguageSuffixToUrl("http://acme.docs.buildwithfern.com/docs", "de")).toBe(
                "http://acme-de.docs.buildwithfern.com/docs"
            );
            expect(addLanguageSuffixToUrl("https://acme.docs.buildwithfern.com/docs", "de")).toBe(
                "https://acme-de.docs.buildwithfern.com/docs"
            );
        ...
        it("should handle different protocols correctly for custom domains", () => {
            expect(addLanguageSuffixToUrl("http://docs.custom.com/api", "fr")).toBe("http://fr.docs.custom.com/api");
            expect(addLanguageSuffixToUrl("https://docs.custom.com/api", "fr")).toBe("https://fr.docs.custom.com/api");
        });
    });

    describe("edge cases and fallbacks", () => {
        it("should handle invalid URLs with fallback logic for buildwithfern.com", () => {
            expect(addLanguageSuffixToUrl("acme.docs.buildwithfern.com", "de")).toBe("acme-de.docs.buildwithfern.com");
            expect(addLanguageSuffixToUrl("test.docs.buildwithfern.com/path", "fr")).toBe(
                "test-fr.docs.buildwithfern.com/path"
            );
        });

        it("should handle invalid URLs with fallback logic for custom domains", () => {
            expect(addLanguageSuffixToUrl("docs.custom.com", "de")).toBe("de.docs.custom.com");
            expect(addLanguageSuffixToUrl("api.example.com/path", "de")).toBe("de.api.example.com/path");
            expect(addLanguageSuffixToUrl("simple-string", "de")).toBe("de.simple-string");
        });
    });
