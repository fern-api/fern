...
const UNDEFINED_API_DEFINITION_SETTINGS: generatorsYml.APIDefinitionSettings = {
    ...
    respectOptionalRequestBody: undefined,
    filter: undefined,
    ...
    preserveAnyOfAsUnion: undefined,
...
function parseOpenApiDefinitionSettingsSchema(
    ...
    return {
        ...
        respectOptionalRequestBody: settings?.["respect-optional-request-body"],
        ...
        preserveAnyOfAsUnion: settings?.["preserve-any-of-as-union"],
