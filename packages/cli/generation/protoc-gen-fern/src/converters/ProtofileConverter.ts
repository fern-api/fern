...
import { AutogeneratedEndpointExample, FernIr, HttpRequestBodyReference, IntermediateRepresentation, Package, V2HttpEndpointExample, V2HttpEndpointResponseBody } from "@fern-api/ir-sdk";
