        ...
        visitObject(file.definitionFile, {
            ...
            service: (service) => {
                ...
                convertedHttpService.endpoints.forEach((httpEndpoint) => {
                    ...
                    const rawEndpointSchema = service.endpoints[getNameString(httpEndpoint.name)];
                    irGraph.addEndpoint(convertedHttpService, httpEndpoint, rawEndpointSchema);
                    convertedEndpoints[getNameString(httpEndpoint.name)] = httpEndpoint;
                });
            ...
            webhooks: (webhooks) => {
                ...
                for (const convertedWebhook of convertedWebhookGroup) {
                    webhooksByOriginalName[getNameString(convertedWebhook.name)] = convertedWebhook;
                }
