        ...
        visitObject(file.definitionFile, {
            ...
            service: (service) => {
                ...
                convertedHttpService.endpoints.forEach((httpEndpoint) => {
                    ...
                    const endpointOriginalName = typeof httpEndpoint.name === "string" ? httpEndpoint.name : httpEndpoint.name.originalName;
            ...
            webhooks: (webhooks) => {
                ...
                for (const convertedWebhook of convertedWebhookGroup) {
                    webhooksByOriginalName[typeof convertedWebhook.name === "string" ? convertedWebhook.name : convertedWebhook.name.originalName] = convertedWebhook;
                }
