...
export function generateIntermediateRepresentation({
    ...
    const mergedIR = (workspace.additionalIrs ?? []).reduce<IntermediateRepresentation>(
        (acc, additionalIr) => mergeIntermediateRepresentation(acc, additionalIr, casingsGenerator),
        finalIR
    );
