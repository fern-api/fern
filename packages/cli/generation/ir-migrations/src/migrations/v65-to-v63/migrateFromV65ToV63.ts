...
> = {
    ...
    firstGeneratorVersionToConsumeNewIR: {
        [GeneratorName.TYPESCRIPT_NODE_SDK]: "3.49.2",
        [GeneratorName.TYPESCRIPT_BROWSER_SDK]: "3.49.2",
        [GeneratorName.TYPESCRIPT]: "3.49.2",
        [GeneratorName.TYPESCRIPT_SDK]: "3.49.2",
        [GeneratorName.TYPESCRIPT_EXPRESS]: "0.19.3",
