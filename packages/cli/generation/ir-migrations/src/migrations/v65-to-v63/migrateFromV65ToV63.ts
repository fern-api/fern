...
> = {
    ...
    migrateBackwards: (
        ...
        return {
            ...v65,
            services: mapValues(v65.services, (service) => convertHttpService(service))
        };
    }
};

function convertHttpService(service: IrVersions.V65.HttpService): IrVersions.V63.http.HttpService {
    return {
        ...service,
...
function convertHttpEndpoint(endpoint: IrVersions.V65.HttpEndpoint): IrVersions.V63.http.HttpEndpoint {
    return {
        ...endpoint,
...
function convertPagination(pagination: IrVersions.V65.Pagination): IrVersions.V63.http.Pagination {
