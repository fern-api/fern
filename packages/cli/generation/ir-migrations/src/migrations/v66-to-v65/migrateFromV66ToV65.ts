...
function inflateIr(
    ...
    const inflateNamedTypeDefault = (
        def: IrVersions.V66.NamedTypeDefault
    ): IrVersions.V65.NamedTypeDefault => {
    ...
    const inflateV2SchemaExamples = (
        v2: IrVersions.V66.V2SchemaExamples
    ): IrVersions.V65.V2SchemaExamples => ({
    ...
    const inflateSingleUnionType = (
        ut: IrVersions.V66.SingleUnionType
    ): IrVersions.V65.SingleUnionType => ({
        docs: ut.docs,
    ...
    const inflateSingleUnionTypeProperties = (
        ...
        switch (props.propertiesType) {
            ...
            case "samePropertiesAsObject":
                return IrVersions.V65.SingleUnionTypeProperties.samePropertiesAsObject(
                    inflateDeclaredTypeName(props)
                );
            case "noProperties":
    ...
    const inflateExamplePrimitive = (
        ep: IrVersions.V66.ExamplePrimitive
    ): IrVersions.V65.ExamplePrimitive => {
        switch (ep.type) {
            case "integer":
    ...
    const inflateHttpEndpointSource = (source: IrVersions.V66.HttpEndpointSource): IrVersions.V65.HttpEndpointSource => {
        switch (source.type) {
            case "proto":
    ...
    const inflateEndpoint = (ep: IrVersions.V66.HttpEndpoint): IrVersions.V65.HttpEndpoint => ({
        ...
        v2RequestBodies: ep.v2RequestBodies != null ? {
            requestBodies: ep.v2RequestBodies.requestBodies != null
        ...
        v2Responses: ep.v2Responses != null ? {
            responses: ep.v2Responses.responses != null
    ...
    const inflateExampleCodeSample = (
        cs: IrVersions.V66.ExampleCodeSample
    ): IrVersions.V65.ExampleCodeSample => {
        switch (cs.type) {
            case "language":
        ...
        switch (json.type) {
            ...
            case "nestedPropertyAsResponse":
                return IrVersions.V65.JsonResponse.nestedPropertyAsResponse({
                    docs: json.docs,
                    responseBodyType: inflateTypeReference(json.responseBodyType),
                    responseProperty: json.responseProperty != null
                        ? inflateObjectProperty(json.responseProperty)
                        : undefined,
                    v2Examples: json.v2Examples != null ? inflateV2SchemaExamples(json.v2Examples) : undefined
                });
            default:
    ...
    const inflateStreamingResponse = (
        sr: IrVersions.V66.StreamingResponse
    ): IrVersions.V65.StreamingResponse => {
        switch (sr.type) {
            case "json":
        ...
        switch (rb.type) {
            case "inlinedRequestBody":
                return IrVersions.V65.HttpRequestBody.inlinedRequestBody({
                    ...
                    extendedProperties: rb.extendedProperties != null
                        ? rb.extendedProperties.map(inflateObjectProperty)
                        : undefined,
    ...
    const inflateSdkRequestBodyType = (
        sbt: IrVersions.V66.SdkRequestBodyType
    ): IrVersions.V65.SdkRequestBodyType => {
        switch (sbt.type) {
            case "typeReference":
    ...
    const inflateSdkRequestShape = (shape: IrVersions.V66.SdkRequestShape): IrVersions.V65.SdkRequestShape => {
        switch (shape.type) {
            case "justRequestBody":
                return IrVersions.V65.SdkRequestShape.justRequestBody(
                    inflateSdkRequestBodyType(shape.value)
                );
            case "wrapper":
    ...
    const inflateExampleWebhookCall = (
        ex: IrVersions.V66.ExampleWebhookCall
    ): IrVersions.V65.ExampleWebhookCall => ({
        docs: ex.docs,
        name: inflateOptionalName(ex.name),
    ...
    const inflateWebhook = (wh: IrVersions.V66.webhooks.Webhook): IrVersions.V65.webhooks.Webhook => ({
        ...
        signatureVerification: wh.signatureVerification != null
            ? inflateWebhookSignatureVerification(wh.signatureVerification)
            : undefined,
        fileUploadPayload: wh.fileUploadPayload != null ? {
            ...
            v2Examples: wh.fileUploadPayload.v2Examples != null
            ...
            case "inferred":
                return IrVersions.V65.AuthScheme.inferred({
                    ...
                    tokenEndpoint: {
                        ...
                        expiryProperty: scheme.tokenEndpoint.expiryProperty != null
                            ? inflateResponseProperty(scheme.tokenEndpoint.expiryProperty)
                            : undefined,
                        authenticatedRequestHeaders: scheme.tokenEndpoint.authenticatedRequestHeaders.map(
                            (h) => ({
                        ...
                        requestProperties: {
                            ...
                            customProperties:
                                config.tokenEndpoint.requestProperties.customProperties != null
                                    ? config.tokenEndpoint.requestProperties.customProperties.map(inflateRequestProperty)
                                    : undefined
                        },
                        responseProperties: {
    ...
    const inflateEnvironments = (
        envs: IrVersions.V66.Environments
    ): IrVersions.V65.Environments => {
        switch (envs.type) {
            case "singleBaseUrl":
    ...
    const inflateSingleBaseUrlEnvironment = (
        ...
        urlVariables:
            env.urlVariables != null
                ? env.urlVariables.map(inflateServerVariable)
                : undefined,
    ...
    const inflateServerVariable = (
        sv: IrVersions.V66.ServerVariable
    ): IrVersions.V65.ServerVariable => ({
        id: sv.id,
    ...
    const inflateAsymmetricKeySource = (
        ks: IrVersions.V66.AsymmetricKeySource
    ): IrVersions.V65.AsymmetricKeySource => {
        switch (ks.type) {
            case "jwks":
    ...
    const inflateApiVersionScheme = (
        scheme: IrVersions.V66.ApiVersionScheme
    ): IrVersions.V65.ApiVersionScheme => {
    ...
    const inflateDynamicName = (
        name: IrVersions.V66.dynamic.NameOrString
    ): IrVersions.V65.dynamic.Name => {
    ...
    const inflateDynamicAuth = (
        auth: IrVersions.V66.dynamic.Auth
    ): IrVersions.V65.dynamic.Auth => {
        switch (auth.type) {
            case "basic":
            ...
            case "inferred":
                return IrVersions.V65.dynamic.Auth.inferred({
                    parameters: auth.parameters != null
                        ? auth.parameters.map(inflateDynamicNamedParameter)
                        : undefined
                });
            default:
                assertNever(auth);
        ...
        switch (sdu.type) {
            ...
            case "singleProperty":
                return IrVersions.V65.dynamic.SingleDiscriminatedUnionType.singleProperty({
                    ...
                    discriminantValue: inflateDynamicNameAndWireValue(sdu.discriminantValue),
                    properties: sdu.properties != null
                        ? sdu.properties.map(inflateDynamicNamedParameter)
                        : undefined
                });
            case "noProperties":
    ...
    const inflateDynamicNamedType = (
        nt: IrVersions.V66.dynamic.NamedType
    ): IrVersions.V65.dynamic.NamedType => {
        switch (nt.type) {
            case "alias":
    ...
    const inflateDynamicRequest = (
        req: IrVersions.V66.dynamic.Request
    ): IrVersions.V65.dynamic.Request => {
        switch (req.type) {
            case "body":
                return IrVersions.V65.dynamic.Request.body({
                    pathParameters: req.pathParameters != null
                        ? req.pathParameters.map(inflateDynamicNamedParameter)
                        : undefined,
                    body: req.body
                });
            case "inlined":
                return IrVersions.V65.dynamic.Request.inlined({
                    ...
                    pathParameters: req.pathParameters != null
                        ? req.pathParameters.map(inflateDynamicNamedParameter)
                        : undefined,
                    queryParameters: req.queryParameters != null
                        ? req.queryParameters.map(inflateDynamicNamedParameter)
                        : undefined,
                    headers: req.headers != null
                        ? req.headers.map(inflateDynamicNamedParameter)
                        : undefined,
    ...
    const inflateDynamicResponse = (
        resp: IrVersions.V66.dynamic.Response
    ): IrVersions.V65.dynamic.Response => {
        switch (resp.type) {
            case "json":
    ...
    const inflateDynamicEndpoint = (
        ep: IrVersions.V66.dynamic.Endpoint
    ): IrVersions.V65.dynamic.Endpoint => ({
    ...
    const inflateDynamicIr = (
        ...
        return {
            ...
            environments: dir.environments != null
                ? inflateDynamicEnvironmentsConfig(dir.environments)
                : undefined,
            headers: dir.headers != null
                ? dir.headers.map(inflateDynamicNamedParameter)
                : undefined,
            pathParameters: dir.pathParameters != null
                ? dir.pathParameters.map(inflateDynamicNamedParameter)
                : undefined,
            variables: dir.variables != null
                ? dir.variables.map(inflateDynamicVariableDeclaration)
                : undefined,
