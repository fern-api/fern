...
function inflateIr(
        ...
        switch (def.type) {
            case "enum":
                return IrVersions.V65.NamedTypeDefault.enum({
                    ...
                    docs: def.docs,
                    availability: inflateAvailability(def.availability)
                });
            default:
    ...
    ): IrVersions.V65.Availability | undefined => {
        if (availability == null) {
            return undefined;
        }
        return {
            status: inflateAvailabilityStatus(availability.status),
            message: availability.message
        };
    };

    const inflateAvailabilityStatus = (
        status: IrVersions.V66.AvailabilityStatus
    ): IrVersions.V65.AvailabilityStatus => {
        switch (status) {
            case "IN_DEVELOPMENT":
            case "ALPHA":
            ...
            case "GENERAL_AVAILABILITY":
                return IrVersions.V65.AvailabilityStatus.GeneralAvailability;
            case "DEPRECATED":
            case "LEGACY":
                return IrVersions.V65.AvailabilityStatus.Deprecated;
            default:
    ...
    const inflateObjectProperty = (prop: IrVersions.V66.ObjectProperty): IrVersions.V65.ObjectProperty => ({
        docs: prop.docs,
        availability: inflateAvailability(prop.availability),
    ...
    const inflateTypeDeclaration = (td: IrVersions.V66.TypeDeclaration): IrVersions.V65.TypeDeclaration => ({
        docs: td.docs,
        availability: inflateAvailability(td.availability),
    ...
    const inflateEnumValue = (ev: IrVersions.V66.EnumValue): IrVersions.V65.EnumValue => ({
        docs: ev.docs,
        availability: inflateAvailability(ev.availability),
    ...
    const inflateSingleUnionType = (ut: IrVersions.V66.SingleUnionType): IrVersions.V65.SingleUnionType => ({
        docs: ut.docs,
        availability: inflateAvailability(ut.availability),
    ...
    const inflateQueryParameter = (qp: IrVersions.V66.QueryParameter): IrVersions.V65.QueryParameter => ({
        docs: qp.docs,
        availability: inflateAvailability(qp.availability),
    ...
    const inflateHeader = (h: IrVersions.V66.HttpHeader): IrVersions.V65.HttpHeader => ({
        docs: h.docs,
        availability: inflateAvailability(h.availability),
    ...
    const inflateEndpoint = (ep: IrVersions.V66.HttpEndpoint): IrVersions.V65.HttpEndpoint => ({
        ...
        availability: inflateAvailability(ep.availability),
        docs: ep.docs
    });
    ...
    const inflateService = (svc: IrVersions.V66.HttpService): IrVersions.V65.HttpService => ({
        availability: inflateAvailability(svc.availability),
        name: {
    ...
    const inflateWebhook = (wh: IrVersions.V66.webhooks.Webhook): IrVersions.V65.webhooks.Webhook => ({
        ...
        availability: inflateAvailability(wh.availability),
        docs: wh.docs
    });
    ...
    const inflateChannel = (
        ...
        availability: inflateAvailability(ch.availability),
        docs: ch.docs
    });
    ...
    const inflateWebSocketMessage = (
        ...
        availability: inflateAvailability(msg.availability),
        docs: msg.docs
    });
