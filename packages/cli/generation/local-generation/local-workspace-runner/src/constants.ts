...
export const FULL_IR_FILENAME = "ir-full.json";
...
export const DOCKER_PATH_TO_FULL_IR = path.join(DOCKER_FERN_DIRECTORY, FULL_IR_FILENAME);
...
export const CONTAINER_PATH_TO_FULL_IR = DOCKER_PATH_TO_FULL_IR;
