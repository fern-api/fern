...
export const GENERATOR_OUTPUT_FILENAME = "generator-output.json";
...
export const DOCKER_PATH_TO_GENERATOR_OUTPUT = path.join(DOCKER_FERN_DIRECTORY, GENERATOR_OUTPUT_FILENAME);
...
export const CONTAINER_PATH_TO_GENERATOR_OUTPUT = DOCKER_PATH_TO_GENERATOR_OUTPUT;
