export type WebSocketMessageOrigin = WebSocketMessageOrigin.CLIENT | WebSocketMessageOrigin.SERVER;
...
export const WebSocketMessageOrigin = {
    ...
    visit: <R>(value: WebSocketMessageOrigin, visitor: WebSocketMessageOrigin.Visitor<R>): R => {
        switch (value) {
