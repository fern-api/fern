    ...
    public convertToWireMock(ir: FernIr.IntermediateRepresentation): WireMockStubMapping {
        ...
        for (const service of Object.values(ir.services)) {
            for (const endpoint of service.endpoints) {
                ...
                // Skip file download response endpoints (same as second pass)
        ...
        for (const service of Object.values(ir.services)) {
            for (const endpoint of service.endpoints) {
                ...
                // Skip file download response endpoints — autogenerated examples produce error
                // responses rather than binary content, and wire tests skip these endpoints too.
                if (endpoint.response?.body?.type === "fileDownload") {
                    continue;
                }
