...
export declare namespace TestRunner {
    ...
    interface RunArgs {
        ...
        /** Pre-loaded FernWorkspace to avoid duplicate workspace loading */
...
export abstract class TestRunner {
    ...
    protected readonly skipBuild: boolean;
    ...
    constructor({
        ...
        this.skipBuild = skipBuild ?? false;
    ...
    public async run({
        ...
        fernWorkspace: preloadedFernWorkspace
    }: TestRunner.RunArgs): Promise<TestRunner.TestResult> {
        let lockAcquired = false;
        try {
            if (this.buildInvocation == null) {
                this.buildInvocation = this.skipBuild ? Promise.resolve() : this.build();
            }
            ...
            let fernWorkspace: FernWorkspace | undefined = preloadedFernWorkspace;
