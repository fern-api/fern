...
export class GeneratedEndpointTypeSchemaImpl extends AbstractGeneratedEndpointTypeSchema {
    ...
    protected generateRawTypeDeclaration(context: SdkEndpointTypeSchemasContext, module: ModuleDeclaration): void {
        module.addTypeAlias({
    ...
    protected getReferenceToParsedShape(context: SdkEndpointTypeSchemasContext): ts.TypeNode {
        return context.type.getReferenceToType(this.type).typeNode;
    }

    protected buildSchema(context: SdkEndpointTypeSchemasContext): Zurg.Schema {
