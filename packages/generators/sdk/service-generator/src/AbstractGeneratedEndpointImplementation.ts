...
import { Fetcher, GeneratedEndpointTypeSchemas, ServiceContext } from "@fern-typescript/contexts";
import {
...
export abstract class AbstractGeneratedEndpointImplementation implements GeneratedEndpointImplementation {
    ...
    constructor({ service, endpoint, generatedService }: AbstractGeneratedEndpointImplementation.Init) {
    ...
    public getDocs(context: ServiceContext): string | undefined {
        const parts: string[] = [];
    ...
    protected abstract getAdditionalDocLines(context: ServiceContext): string[];
    ...
    protected getGeneratedEndpointTypeSchemas(context: ServiceContext): GeneratedEndpointTypeSchemas {
    ...
    protected getOkResponseBody(context: ServiceContext): ts.Expression {
    ...
    protected getReferenceToError(context: ServiceContext): ts.Expression {
    ...
    protected getReferenceToErrorBody(context: ServiceContext): ts.Expression {
        return ts.factory.createPropertyAccessExpression(
    ...
    protected abstract getResponseType(context: ServiceContext): ts.TypeNode;
    protected abstract getReturnValueForOkResponse(context: ServiceContext): ts.Expression | undefined;
    protected abstract getReturnFailedResponse(context: ServiceContext): ts.Statement[];
}
