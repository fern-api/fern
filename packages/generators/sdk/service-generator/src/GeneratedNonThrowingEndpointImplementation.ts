...
import { GeneratedEndpointTypes, ServiceContext } from "@fern-typescript/contexts";
...
export class GeneratedNonThrowingEndpointImplementation extends AbstractGeneratedEndpointImplementation {
    ...
    private getSwitchStatementForErrors(context: ServiceContext) {
    ...
    private getSwitchStatementForStatusCodeDiscriminatedErrors(context: ServiceContext) {
        return ts.factory.createSwitchStatement(
            ts.factory.createPropertyAccessExpression(
