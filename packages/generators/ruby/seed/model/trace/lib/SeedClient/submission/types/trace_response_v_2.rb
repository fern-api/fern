...
module SeedClient
  module Submission
    class TraceResponseV2
      ...
      # @return [JSON] 
      def to_json
        { submissionId: @submission_id, lineNumber: @line_number, file: @file, returnValue: @return_value, expressionLocation: @expression_location, stack: @stack, stdout: @stdout }.to_json()
      end
