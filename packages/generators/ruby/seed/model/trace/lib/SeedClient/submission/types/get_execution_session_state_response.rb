...
module SeedClient
  module Submission
    class GetExecutionSessionStateResponse
      ...
      def initialze(states:, num_warming_instances: nil, warming_session_ids:, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(states: states, num_warming_instances: num_warming_instances, warming_session_ids: warming_session_ids, additional_properties: struct)
      end
      # Serialize an instance of GetExecutionSessionStateResponse to a JSON object
      #
      # @return [JSON] 
      def to_json
        { states: @states, numWarmingInstances: @num_warming_instances, warmingSessionIds: @warming_session_ids }.to_json()
      end
