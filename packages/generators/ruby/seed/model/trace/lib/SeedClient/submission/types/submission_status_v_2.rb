...
require "json"
require "submission/types/TestSubmissionStatusV2"
require "submission/types/WorkspaceSubmissionStatusV2"
  ...
  module Submission
    class SubmissionStatusV2
      ...
      def self.from_json(json_object:)
        ...
        case struct.type
        when "test"
          member = Submission::TestSubmissionStatusV2.from_json(json_object: json_object)
        when "workspace"
          member = Submission::WorkspaceSubmissionStatusV2.from_json(json_object: json_object)
        else
          member = Submission::TestSubmissionStatusV2.from_json(json_object: json_object)
        end
