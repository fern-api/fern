...
require "v_2/problem/types/CustomFiles"
...
module SeedClient
  ...
  V2::Problem::TestCaseV2.from_json(json_object: v)
        ...
        # @return [JSON] 
        def to_json
          { problemName: @problem_name, problemDescription: @problem_description, customFiles: @custom_files, customTestCaseTemplates: @custom_test_case_templates, testcases: @testcases, supportedLanguages: @supported_languages.to_a(), isPublic: @is_public }.to_json()
        end
