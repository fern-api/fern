...
require "json"
require "v_2/problem/types/DeepEqualityCorrectnessCheck"
require "v_2/problem/types/VoidFunctionDefinitionThatTakesActualResult"
    ...
    module Problem
      class AssertCorrectnessCheck
        ...
        def self.from_json(json_object:)
          ...
          case struct.type
          when "deepEquality"
            member = V2::Problem::DeepEqualityCorrectnessCheck.from_json(json_object: json_object)
          when "custom"
            member = V2::Problem::VoidFunctionDefinitionThatTakesActualResult.from_json(json_object: json_object)
          else
            member = V2::Problem::DeepEqualityCorrectnessCheck.from_json(json_object: json_object)
          end
