...
- **BREAKING**: Add file upload examples support to ExampleRequestBody with fileUpload variant. This is a breaking change because adding a new union variant requires all generators to handle it.
