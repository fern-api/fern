...
export type WebhookPayload =
    ...
    | FernIr.WebhookPayload.FileUpload;
...
export namespace WebhookPayload {
    ...
    export interface FileUpload extends FernIr.WebhookFileUploadPayload, _Utils {
        type: "fileUpload";
    }
    ...
    export interface _Visitor<_Result> {
        ...
        fileUpload: (value: FernIr.WebhookFileUploadPayload) => _Result;
...
export const WebhookPayload = {
    ...
    fileUpload: (value: FernIr.WebhookFileUploadPayload): FernIr.WebhookPayload.FileUpload => {
        return {
            ...value,
            type: "fileUpload",
            _visit: function <_Result>(
                this: FernIr.WebhookPayload.FileUpload,
                visitor: FernIr.WebhookPayload._Visitor<_Result>,
            ) {
                return FernIr.WebhookPayload._visit(this, visitor);
            },
