...
export const DeconflictedName: core.serialization.ObjectSchema<
    serializers.DeconflictedName.Raw,
    FernIr.DeconflictedName
...
export declare namespace DeconflictedName {
