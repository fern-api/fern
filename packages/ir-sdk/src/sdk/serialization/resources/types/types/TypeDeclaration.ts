...
export const TypeDeclaration: core.serialization.ObjectSchema<serializers.TypeDeclaration.Raw, FernIr.TypeDeclaration> =
    core.serialization
        .objectWithoutOptionalProperties({
            ...
            isInvolvedInCycle: core.serialization.boolean().optional(),
            referencedTypesWithoutSelf: core.serialization.set(TypeId).optional(),
...
export declare namespace TypeDeclaration {
    interface Raw extends Declaration.Raw {
        ...
        isInvolvedInCycle?: boolean | null;
        referencedTypesWithoutSelf?: TypeId.Raw[] | null;
