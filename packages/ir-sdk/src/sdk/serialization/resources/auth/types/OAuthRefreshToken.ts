...
export const OAuthRefreshToken: core.serialization.ObjectSchema<
    serializers.OAuthRefreshToken.Raw,
    FernIr.OAuthRefreshToken
...
export declare namespace OAuthRefreshToken {
