...
> = core.serialization.enum_(["curl", "python", "javascript", "typescript", "go", "ruby", "csharp", "java", "php"]);

export declare namespace SupportedSdkLanguage {
    export type Raw = "curl" | "python" | "javascript" | "typescript" | "go" | "ruby" | "csharp" | "java" | "php";
}
