...
function getTransationSummary(transaction: FernApiEditor.transactions.Transaction): string {
    return transaction._visit({
        ...
        setUnionDiscriminant: () => "Set union discriminant",
        createUnionMember: () => "Create union member",
        setUnionMemberDiscriminantValue: () => "Set union member discriminant value",
        deleteUnionMember: () => "Delete union member",
