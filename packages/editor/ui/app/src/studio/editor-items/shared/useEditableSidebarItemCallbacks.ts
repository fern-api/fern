...
export function useEditableSidebarItemCallbacks<DefinitionId, ParentId = FernApiEditor.PackageId>({
    definitionId,
    parent,
    constructCreateTransaction,
    constructRenameTransaction,
    constructDeleteTransaction,
    isEqualToDraft,
}: useEditableSidebarItemCallbacks.Args<DefinitionId, ParentId>): useEditableSidebarItemCallbacks.Return {
