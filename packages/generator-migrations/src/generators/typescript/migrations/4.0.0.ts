...
// pre-4.0.0 versions, preserving their current retry behavior. Users can opt into the
// new defaults by removing the field or setting `retryStatusCodes: "recommended"`.
