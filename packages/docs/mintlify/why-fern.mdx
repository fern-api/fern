...
These inventions all share a common design: **schema-first automation for the API
development process.** This saves developer time and increases product
velocity.
...
<i>
  Building 2 new APIs this last 1.5 weeks with Fern was awesome - I bet it sped up new API development by at least 50%.
  The bits that were sped up was the most tedious, annoying bits too. Very thankful to be using Fern right now!
</i>

&nbsp;&nbsp;&nbsp;&nbsp; \-Steve Yazicioglu, Head of Engineering, Candid Health

The Fern compiler handles the uninteresting and time-consuming developer work
...
When it comes to consuming your new API, Fern's auto-generated SDKs are a dream.
You get client libraries to use in tests, in your frontend,
or in other microservices. They let you build faster.
...
You can feel comforable providing them to your customers.
