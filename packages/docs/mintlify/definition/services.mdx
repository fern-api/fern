---
title: "Services"
description: "This page describes how to define a REST service, which communicates over
  HTTP."
---
...
<Note>
  To encourage best practices, all query parameters are implicitly typed as `optional`. API consumers are never required
  to supply them.
</Note>
