...
description: "The Fern team uses Postman and, if you're here, you probably do too."
---
...
[here](https://go.postman.co/settings/me/api-keys). Save this as an environment
