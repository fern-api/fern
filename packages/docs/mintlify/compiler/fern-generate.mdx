...
To run the generators locally (rather than in the cloud), you can use the [`--local` option](/compiler/cli-reference.md#fern-generate---group-group---version-version).
