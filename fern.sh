...
npx --yes fern-api@0.0.22 generate packages/api/src packages/api/generated/ir.json
npx --yes fern-typescript@0.0.22 model packages/api/generated/ir.json packages/api/generated/ir
