...
npx --yes fern-api@0.0.24 generate packages/api/src packages/api/generated/ir.json
npx --yes fern-typescript@0.0.24 model packages/api/generated/ir.json packages/api/generated/ir
