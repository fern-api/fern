...
class TestSubmissionStatusV2(pydantic.BaseModel):
    ...
    def _validate_updates(
        cls, v: typing.List[TestSubmissionUpdate], values: typing.List[TestSubmissionUpdate]
    ) -> typing.List[TestSubmissionUpdate]:
    ...
    def _validate_problem_info(cls, v: ProblemInfoV2, values: ProblemInfoV2) -> ProblemInfoV2:
