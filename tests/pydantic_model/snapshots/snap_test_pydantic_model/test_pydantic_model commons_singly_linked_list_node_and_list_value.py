...
class SinglyLinkedListNodeAndListValue(pydantic.BaseModel):
    ...
    class Validators:
        ...
        @classmethod
        def root(cls, *, pre: bool = False) -> SinglyLinkedListNodeAndListValue.Validators._RootValidator:
        ...
        @classmethod
        def field(
            cls, field_name: typing_extensions.Literal["full_list"], *, pre: bool = False
        ) -> typing.Callable[
