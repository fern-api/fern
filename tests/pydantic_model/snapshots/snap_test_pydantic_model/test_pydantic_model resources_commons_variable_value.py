...
from .binary_tree_value import BinaryTreeValue as resources_commons_binary_tree_value_BinaryTreeValue
from .doubly_linked_list_value import (
    DoublyLinkedListValue as resources_commons_doubly_linked_list_value_DoublyLinkedListValue,
)
from .singly_linked_list_value import (
    SinglyLinkedListValue as resources_commons_singly_linked_list_value_SinglyLinkedListValue,
)
...
class _Factory:
    ...
    def map_value(self, value: resources_commons_map_value_MapValue) -> VariableValue:
    ...
    def binary_tree_value(self, value: resources_commons_binary_tree_value_BinaryTreeValue) -> VariableValue:
        return VariableValue(__root__=_VariableValue.BinaryTreeValue(**dict(value), type="binaryTreeValue"))

    def singly_linked_list_value(
        self, value: resources_commons_singly_linked_list_value_SinglyLinkedListValue
    ) -> VariableValue:
    ...
    def doubly_linked_list_value(
        self, value: resources_commons_doubly_linked_list_value_DoublyLinkedListValue
    ) -> VariableValue:
...
class VariableValue(pydantic.BaseModel):
    ...
    def visit(
        ...
        map_value: typing.Callable[[resources_commons_map_value_MapValue], T_Result],
        list_value: typing.Callable[[typing.List[VariableValue]], T_Result],
        binary_tree_value: typing.Callable[[resources_commons_binary_tree_value_BinaryTreeValue], T_Result],
        singly_linked_list_value: typing.Callable[
            [resources_commons_singly_linked_list_value_SinglyLinkedListValue], T_Result
        ],
        doubly_linked_list_value: typing.Callable[
            [resources_commons_doubly_linked_list_value_DoublyLinkedListValue], T_Result
        ],
...
from .map_value import MapValue as resources_commons_map_value_MapValue  # noqa: E402
...
class _VariableValue:
    ...
    class MapValue(resources_commons_map_value_MapValue):
    ...
    class BinaryTreeValue(resources_commons_binary_tree_value_BinaryTreeValue):
        type: typing_extensions.Literal["binaryTreeValue"]

        class Config:
            frozen = True

    class SinglyLinkedListValue(resources_commons_singly_linked_list_value_SinglyLinkedListValue):
        type: typing_extensions.Literal["singlyLinkedListValue"]

        class Config:
            frozen = True

    class DoublyLinkedListValue(resources_commons_doubly_linked_list_value_DoublyLinkedListValue):
...
_VariableValue.MapValue.update_forward_refs(
    KeyValuePair=KeyValuePair, MapValue=resources_commons_map_value_MapValue, VariableValue=VariableValue
)
