...
class WorkspaceSubmissionStatusV2(pydantic.BaseModel):
    ...
    class Validators:
        _updates: typing.ClassVar[typing.List[WorkspaceSubmissionUpdate]] = []

        @typing.overload
        @classmethod
        def field(updates: typing_extensions.Literal["updates"]) -> typing.List[WorkspaceSubmissionUpdate]:
            ...
