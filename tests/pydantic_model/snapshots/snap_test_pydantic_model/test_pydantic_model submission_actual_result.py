...
from .exception_v_2 import ExceptionV2 as submission_exception_v_2_ExceptionV2
...
class _Factory:
    ...
    def exception_v_2(self, value: submission_exception_v_2_ExceptionV2) -> ActualResult:
...
class ActualResult(pydantic.BaseModel):
    ...
    def visit(
        ...
        exception_v_2: typing.Callable[[submission_exception_v_2_ExceptionV2], T_Result],
    ) -> T_Result:
...
class _ActualResult:
    ...
    class ExceptionV2(pydantic.BaseModel):
        ...
        value: submission_exception_v_2_ExceptionV2
