...
class StoreTracedWorkspaceRequest(pydantic.BaseModel):
    ...
    class Validators:
        _workspace_run_details: typing.ClassVar[WorkspaceRunDetails] = []
        _trace_responses: typing.ClassVar[typing.List[TraceResponse]] = []

        @typing.overload
        @classmethod
        def field(workspace_run_details: typing_extensions.Literal["workspace_run_details"]) -> WorkspaceRunDetails:
            ...
        ...
        def field(cls, field_name: str) -> typing.Any:
            def decorator(validator: typing.Any) -> typing.Any:
                if field_name == "workspace_run_details":
                    cls._workspace_run_details.append(validator)  # type: ignore
