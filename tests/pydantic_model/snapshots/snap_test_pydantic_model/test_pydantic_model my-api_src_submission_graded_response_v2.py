...
class GradedResponseV2(pydantic.BaseModel):
    ...
    class Validators:
        ...
        _test_cases: typing.ClassVar[typing.Dict[TestCaseId, TestCaseGrade]] = []
        ...
        @typing.overload
        @classmethod
        def field(test_cases: typing_extensions.Literal["test_cases"]) -> typing.Dict[TestCaseId, TestCaseGrade]:
            ...
