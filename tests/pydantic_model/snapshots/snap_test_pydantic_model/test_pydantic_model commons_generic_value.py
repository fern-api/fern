...
class GenericValue(pydantic.BaseModel):
    ...
    def _validate_stringified_type(cls, v: typing.Optional[str], values: typing.Optional[str]) -> typing.Optional[str]:
        for validator in GenericValue.Validators._stringified_type_validators:
            v = validator(v, values=values)
        return v

    @pydantic.validator("stringified_value")
    def _validate_stringified_value(cls, v: str, values: str) -> str:
