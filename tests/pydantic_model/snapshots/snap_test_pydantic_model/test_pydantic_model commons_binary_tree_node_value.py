...
class BinaryTreeNodeValue(pydantic.BaseModel):
    ...
    def _validate_right(cls, v: typing.Optional[NodeId], values: typing.Optional[NodeId]) -> typing.Optional[NodeId]:
        for validator in BinaryTreeNodeValue.Validators._right_validators:
            v = validator(v, values=values)
        return v

    @pydantic.validator("left")
    def _validate_left(cls, v: typing.Optional[NodeId], values: typing.Optional[NodeId]) -> typing.Optional[NodeId]:
