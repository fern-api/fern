...
class BinaryTreeNodeAndTreeValue(pydantic.BaseModel):
    ...
    class Validators:
        ...
        _pre_validators: typing.ClassVar[typing.List[BinaryTreeNodeAndTreeValue.Validators._RootValidator]] = []
        ...
        def root(
            ...
            def decorator(
                validator: BinaryTreeNodeAndTreeValue.Validators._RootValidator,
            ) -> BinaryTreeNodeAndTreeValue.Validators._RootValidator:
                if pre:
        ...
        @classmethod
        def field(
            cls, field_name: typing_extensions.Literal["full_tree"], *, pre: bool = False
        ) -> typing.Callable[
