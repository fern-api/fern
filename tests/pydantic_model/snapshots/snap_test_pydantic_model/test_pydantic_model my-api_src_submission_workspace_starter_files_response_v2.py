...
class WorkspaceStarterFilesResponseV2(pydantic.BaseModel):
    ...
    class Validators:
        _files_by_language: typing.ClassVar[typing.Dict[Language, Files]] = []

        @typing.overload
        @classmethod
        def field(files_by_language: typing_extensions.Literal["files_by_language"]) -> typing.Dict[Language, Files]:
            ...
        ...
        def field(cls, field_name: str) -> typing.Any:
            def decorator(validator: typing.Any) -> typing.Any:
                if field_name == "files_by_language":
                    cls._files_by_language.append(validator)  # type: ignore
                else:
