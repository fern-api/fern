...
class ProblemInfoV2(pydantic.BaseModel):
    ...
    def _validate_supported_languages(
        cls, v: typing.List[Language], values: typing.List[Language]
    ...
    def _validate_custom_files(cls, v: CustomFiles, values: CustomFiles) -> CustomFiles:
        for validator in ProblemInfoV2.Validators._custom_files_validators:
            v = validator(v, values=values)
        return v

    @pydantic.validator("generated_files")
    def _validate_generated_files(cls, v: GeneratedFiles, values: GeneratedFiles) -> GeneratedFiles:
    ...
    def _validate_custom_test_case_templates(
        cls, v: typing.List[TestCaseTemplate], values: typing.List[TestCaseTemplate]
    ) -> typing.List[TestCaseTemplate]:
    ...
    def _validate_testcases(
        cls, v: typing.List[TestCaseV2], values: typing.List[TestCaseV2]
    ...
    def _validate_is_public(cls, v: bool, values: bool) -> bool:
