...
from .code_execution_update import CodeExecutionUpdate as resources_submission_code_execution_update_CodeExecutionUpdate
...
class _Factory:
    ...
    def code_execution_update(
        self, value: resources_submission_code_execution_update_CodeExecutionUpdate
    ) -> SubmissionResponse:
        return SubmissionResponse(
...
class SubmissionResponse(pydantic.BaseModel):
    ...
    def visit(
        ...
        code_execution_update: typing.Callable[
            [resources_submission_code_execution_update_CodeExecutionUpdate], T_Result
        ],
...
class _SubmissionResponse:
    ...
    class CodeExecutionUpdate(pydantic.BaseModel):
        ...
        value: resources_submission_code_execution_update_CodeExecutionUpdate
