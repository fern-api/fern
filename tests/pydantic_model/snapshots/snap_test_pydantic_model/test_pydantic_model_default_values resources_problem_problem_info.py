...
class ProblemInfo(pydantic.BaseModel):
    ...
    input_params: typing.Optional[typing.List[VariableTypeAndName]] = pydantic.Field(alias="inputParams", default=None)
    output_type: typing.Optional[VariableType] = pydantic.Field(alias="outputType", default=None)
    testcases: typing.Optional[typing.List[TestCaseWithExpectedResult]] = None
