...
class TestCaseV2(pydantic.BaseModel):
    ...
    class Validators:
        _metadata: typing.ClassVar[TestCaseMetadata] = []
        _implementation: typing.ClassVar[TestCaseImplementationReference] = []
        _arguments: typing.ClassVar[typing.Dict[ParameterId, VariableValue]] = []
        _expects: typing.ClassVar[typing.Optional[TestCaseExpects]] = []

        @typing.overload
        @classmethod
        def field(metadata: typing_extensions.Literal["metadata"]) -> TestCaseMetadata:
            ...

        @typing.overload
        @classmethod
        def field(implementation: typing_extensions.Literal["implementation"]) -> TestCaseImplementationReference:
            ...

        @typing.overload
        @classmethod
        def field(arguments: typing_extensions.Literal["arguments"]) -> typing.Dict[ParameterId, VariableValue]:
            ...

        @typing.overload
        @classmethod
        def field(expects: typing_extensions.Literal["expects"]) -> typing.Optional[TestCaseExpects]:
            ...
        ...
        def field(cls, field_name: str) -> typing.Any:
            def decorator(validator: typing.Any) -> typing.Any:
                if field_name == "metadata":
                    cls._metadata.append(validator)  # type: ignore
                elif field_name == "implementation":
                    cls._implementation.append(validator)  # type: ignore
                elif field_name == "arguments":
                    cls._arguments.append(validator)  # type: ignore
                elif field_name == "expects":
                    cls._expects.append(validator)  # type: ignore
                else:
