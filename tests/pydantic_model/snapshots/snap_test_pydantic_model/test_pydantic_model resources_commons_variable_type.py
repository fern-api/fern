...
class _Factory:
    ...
    def list_type(self, value: resources_commons_list_type_ListType) -> VariableType:
        return VariableType(__root__=_VariableType.ListType(**dict(value), type="listType"))

    def map_type(self, value: resources_commons_map_type_MapType) -> VariableType:
...
class VariableType(pydantic.BaseModel):
    ...
    def visit(
        ...
        list_type: typing.Callable[[resources_commons_list_type_ListType], T_Result],
        map_type: typing.Callable[[resources_commons_map_type_MapType], T_Result],
...
from .list_type import ListType as resources_commons_list_type_ListType  # noqa: E402
from .map_type import MapType as resources_commons_map_type_MapType  # noqa: E402
...
class _VariableType:
    ...
    class ListType(resources_commons_list_type_ListType):
        type: typing_extensions.Literal["listType"]

        class Config:
            frozen = True

    class MapType(resources_commons_map_type_MapType):
...
_VariableType.ListType.update_forward_refs(
    ListType=resources_commons_list_type_ListType, MapType=resources_commons_map_type_MapType, VariableType=VariableType
)
