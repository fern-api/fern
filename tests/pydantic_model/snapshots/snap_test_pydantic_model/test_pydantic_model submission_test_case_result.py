...
class TestCaseResult(pydantic.BaseModel):
    ...
    def _validate_expected_result(cls, v: VariableValue, values: VariableValue) -> VariableValue:
        for validator in TestCaseResult.Validators._expected_result_validators:
            v = validator(v, values=values)
        return v

    @pydantic.validator("actual_result")
    def _validate_actual_result(cls, v: ActualResult, values: ActualResult) -> ActualResult:
