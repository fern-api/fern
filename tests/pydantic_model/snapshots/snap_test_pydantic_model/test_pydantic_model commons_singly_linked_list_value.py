...
class SinglyLinkedListValue(pydantic.BaseModel):
    ...
    class Validators:
        ...
        _pre_validators: typing.ClassVar[typing.List[SinglyLinkedListValue.Validators._RootValidator]] = []
        ...
        def root(
            ...
            def decorator(
                validator: SinglyLinkedListValue.Validators._RootValidator,
            ) -> SinglyLinkedListValue.Validators._RootValidator:
                if pre:
