...
from .generic_value import GenericValue as resources_commons_generic_value_GenericValue
...
class _Factory:
    ...
    def generic_value(self, value: resources_commons_generic_value_GenericValue) -> DebugVariableValue:
...
class DebugVariableValue(pydantic.BaseModel):
    ...
    def visit(
        ...
        generic_value: typing.Callable[[resources_commons_generic_value_GenericValue], T_Result],
    ) -> T_Result:
...
class _DebugVariableValue:
    ...
    class GenericValue(resources_commons_generic_value_GenericValue):
