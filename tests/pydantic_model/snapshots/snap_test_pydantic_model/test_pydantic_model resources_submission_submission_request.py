...
from .initialize_problem_request import (
    InitializeProblemRequest as resources_submission_initialize_problem_request_InitializeProblemRequest,
)
...
class _Factory:
    def initialize_problem_request(
        self, value: resources_submission_initialize_problem_request_InitializeProblemRequest
    ) -> SubmissionRequest:
...
class SubmissionRequest(pydantic.BaseModel):
    ...
    def visit(
        ...
        initialize_problem_request: typing.Callable[
            [resources_submission_initialize_problem_request_InitializeProblemRequest], T_Result
        ],
...
class _SubmissionRequest:
    class InitializeProblemRequest(resources_submission_initialize_problem_request_InitializeProblemRequest):
