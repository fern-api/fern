...
class TraceResponsesPageV2(pydantic.BaseModel):
    ...
    class Validators:
        ...
        _trace_responses: typing.ClassVar[typing.List[TraceResponseV2]] = []
        ...
        @typing.overload
        @classmethod
        def field(trace_responses: typing_extensions.Literal["trace_responses"]) -> typing.List[TraceResponseV2]:
            ...
