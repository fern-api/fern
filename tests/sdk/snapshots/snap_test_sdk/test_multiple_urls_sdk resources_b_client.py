...
class BClient:
    ...
    def get_movie(self, movie_id: MovieId) -> Movie:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_environment().server_b}/", f"movie/movie/{movie_id}"),
    ...
    def create_movie(self, *, request: Movie) -> None:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._client_wrapper.get_environment().server_b}/", "movie/movie"),
    ...
    def delete_movie(self, movie_id: MovieId) -> None:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "DELETE",
            urllib.parse.urljoin(f"{self._client_wrapper.get_environment().server_b}/", f"movie/{movie_id}"),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
        if 200 <= _response.status_code < 300:
