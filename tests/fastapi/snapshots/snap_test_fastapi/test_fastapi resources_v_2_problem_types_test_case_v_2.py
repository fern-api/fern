...
class TestCaseV2(pydantic.BaseModel):
    ...
    def _validate_metadata(cls, v: TestCaseMetadata, values: TestCaseMetadata) -> TestCaseMetadata:
    ...
    def _validate_implementation(
        cls, v: TestCaseImplementationReference, values: TestCaseImplementationReference
    ) -> TestCaseImplementationReference:
    ...
    def _validate_arguments(
        cls, v: typing.Dict[ParameterId, VariableValue], values: typing.Dict[ParameterId, VariableValue]
    ) -> typing.Dict[ParameterId, VariableValue]:
    ...
    def _validate_expects(
        cls, v: typing.Optional[TestCaseExpects], values: typing.Optional[TestCaseExpects]
    ) -> typing.Optional[TestCaseExpects]:
