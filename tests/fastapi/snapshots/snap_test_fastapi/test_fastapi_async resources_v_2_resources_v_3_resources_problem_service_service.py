...
class AbstractV2V3ProblemService(AbstractFernService):
    ...
    @abc.abstractmethod
    async def get_problems(self, *, x_random_header: typing.Optional[str] = None) -> typing.List[ProblemInfoV2]:
        """
    ...
    def __init_get_lightweight_problems(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> typing.List[LightweightProblemInfoV2]:
            try:
                return await cls.get_lightweight_problems(*args, **kwargs)
    ...
    def __init_get_problems(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> typing.List[ProblemInfoV2]:
            try:
                return await cls.get_problems(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
    ...
    def __init_get_latest_problem(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> ProblemInfoV2:
            try:
                return await cls.get_latest_problem(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
    ...
    def __init_get_problem_version(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> ProblemInfoV2:
            try:
                return await cls.get_problem_version(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
