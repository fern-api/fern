...
class TestCaseTemplate(pydantic.BaseModel):
    ...
    def _validate_template_id(cls, v: TestCaseTemplateId, values: TestCaseTemplateId) -> TestCaseTemplateId:
    ...
    def _validate_implementation(
        cls, v: TestCaseImplementation, values: TestCaseImplementation
    ) -> TestCaseImplementation:
