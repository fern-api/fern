...
class DebugKeyValuePairs(pydantic.BaseModel):
    ...
    def _validate_key(cls, v: DebugVariableValue, values: DebugVariableValue) -> DebugVariableValue:
        for validator in DebugKeyValuePairs.Validators._key_validators:
            v = validator(v, values=values)
        return v

    @pydantic.validator("value")
    def _validate_value(cls, v: DebugVariableValue, values: DebugVariableValue) -> DebugVariableValue:
