...
class AbstractProblemService(AbstractFernService):
    ...
    @abc.abstractmethod
    async def delete_problem(self, *, problem_id: str, x_random_header: typing.Optional[str] = None) -> None:
        """
    ...
    def __init_create_problem(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> CreateProblemResponse:
            try:
                return await cls.create_problem(*args, **kwargs)
    ...
    def __init_update_problem(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> UpdateProblemResponse:
            try:
                return await cls.update_problem(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
    ...
    def __init_delete_problem(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> None:
            try:
                return await cls.delete_problem(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
    ...
    def __init_get_default_starter_files(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> GetDefaultStarterFilesResponse:
            try:
                return await cls.get_default_starter_files(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
