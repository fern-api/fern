...
class AbstractHomepageService(AbstractFernService):
    ...
    @abc.abstractmethod
    async def get_homepage_problems(self, *, x_random_header: typing.Optional[str] = None) -> typing.List[ProblemId]:
        ...
    ...
    def __init_get_homepage_problems(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> typing.List[ProblemId]:
            try:
                return await cls.get_homepage_problems(*args, **kwargs)
        ...
        router.get(
            path="/api/trace/homepage-problems",
    ...
    def __init_set_homepage_problems(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> None:
            try:
                return await cls.set_homepage_problems(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
