...
class InvalidRequestResponse(pydantic.BaseModel):
    ...
    def _validate_request(cls, v: SubmissionRequest, values: SubmissionRequest) -> SubmissionRequest:
        for validator in InvalidRequestResponse.Validators._request_validators:
            v = validator(v, values=values)
        return v

    @pydantic.validator("cause")
    def _validate_cause(cls, v: InvalidRequestCause, values: InvalidRequestCause) -> InvalidRequestCause:
