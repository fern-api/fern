...
class TestCaseImplementation(pydantic.BaseModel):
    ...
    def _validate_description(
        cls, v: TestCaseImplementationDescription, values: TestCaseImplementationDescription
    ) -> TestCaseImplementationDescription:
    ...
    def _validate_function(cls, v: TestCaseFunction, values: TestCaseFunction) -> TestCaseFunction:
