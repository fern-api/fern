...
class AbstractPlaylistService(AbstractFernService):
    ...
    def __init_create_playlist(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> Playlist:
            try:
                return await cls.create_playlist(*args, **kwargs)
    ...
    def __init_get_playlists(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> typing.List[Playlist]:
            try:
                return await cls.get_playlists(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
    ...
    def __init_get_playlist(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> Playlist:
            try:
                return await cls.get_playlist(*args, **kwargs)
    ...
    def __init_update_playlist(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> typing.Optional[Playlist]:
            try:
                return await cls.update_playlist(*args, **kwargs)
    ...
    def __init_delete_playlist(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> None:
            try:
                return await cls.delete_playlist(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
