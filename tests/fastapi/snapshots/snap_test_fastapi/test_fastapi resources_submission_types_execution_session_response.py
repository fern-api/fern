...
class ExecutionSessionResponse(pydantic.BaseModel):
    ...
    def _validate_session_id(cls, v: str, values: str) -> str:
    ...
    def _validate_execution_session_url(
        cls, v: typing.Optional[str], values: typing.Optional[str]
    ) -> typing.Optional[str]:
    ...
    def _validate_status(cls, v: ExecutionSessionStatus, values: ExecutionSessionStatus) -> ExecutionSessionStatus:
