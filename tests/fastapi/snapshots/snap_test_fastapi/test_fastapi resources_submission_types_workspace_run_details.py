...
class WorkspaceRunDetails(pydantic.BaseModel):
    ...
    def _validate_exception_v_2(
        cls, v: typing.Optional[ExceptionV2], values: typing.Optional[ExceptionV2]
    ) -> typing.Optional[ExceptionV2]:
    ...
    def _validate_exception(
        cls, v: typing.Optional[ExceptionInfo], values: typing.Optional[ExceptionInfo]
    ) -> typing.Optional[ExceptionInfo]:
    ...
    def _validate_stdout(cls, v: str, values: str) -> str:
