...
class AbstractSubmissionService(AbstractFernService):
    ...
    @abc.abstractmethod
    async def stop_execution_session(self, *, session_id: str, x_random_header: typing.Optional[str] = None) -> None:
        """
    ...
    def __init_create_execution_session(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> ExecutionSessionResponse:
            try:
                return await cls.create_execution_session(*args, **kwargs)
    ...
    def __init_get_execution_session(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> typing.Optional[ExecutionSessionResponse]:
            try:
                return await cls.get_execution_session(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
    ...
    def __init_stop_execution_session(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> None:
            try:
                return await cls.stop_execution_session(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
    ...
    def __init_get_execution_sessions_state(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> GetExecutionSessionStateResponse:
            try:
                return await cls.get_execution_sessions_state(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
