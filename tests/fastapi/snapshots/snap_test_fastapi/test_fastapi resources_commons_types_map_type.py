...
class MapType(pydantic.BaseModel):
    ...
    def _validate_key_type(cls, v: VariableType, values: VariableType) -> VariableType:
        for validator in MapType.Validators._key_type_validators:
            v = validator(v, values=values)
        return v

    @pydantic.validator("value_type")
    def _validate_value_type(cls, v: VariableType, values: VariableType) -> VariableType:
