...
class AbstractSyspropService(AbstractFernService):
    ...
    def __init_set_num_warm_instances(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> None:
            try:
                return await cls.set_num_warm_instances(*args, **kwargs)
    ...
    def __init_get_num_warm_instances(cls, router: fastapi.APIRouter) -> None:
        ...
        async def wrapper(*args: typing.Any, **kwargs: typing.Any) -> typing.Dict[Language, int]:
            try:
                return await cls.get_num_warm_instances(*args, **kwargs)
            except FernHTTPException as e:
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
