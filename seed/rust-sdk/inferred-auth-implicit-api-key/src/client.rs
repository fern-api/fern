use crate::api::resources::InferredAuthImplicitApiKeyClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<InferredAuthImplicitApiKeyClient, ApiError> {
        InferredAuthImplicitApiKeyClient::new(self.config)
    }
}
