...
impl UnionWithMultipleNoProperties {
    ...
    pub fn as_union_with_multiple_no_properties_zero(
        &self,
    ) -> Option<&UnionWithMultipleNoPropertiesZero> {
        match self {
    ...
    pub fn into_union_with_multiple_no_properties_zero(
        self,
    ) -> Option<UnionWithMultipleNoPropertiesZero> {
        match self {
            Self::UnionWithMultipleNoPropertiesZero(value) => Some(value),
    ...
    pub fn as_union_with_multiple_no_properties_one(
        &self,
    ) -> Option<&UnionWithMultipleNoPropertiesOne> {
        match self {
    ...
    pub fn into_union_with_multiple_no_properties_one(
        self,
    ) -> Option<UnionWithMultipleNoPropertiesOne> {
        match self {
            Self::UnionWithMultipleNoPropertiesOne(value) => Some(value),
    ...
    pub fn as_union_with_multiple_no_properties_two(
        &self,
    ) -> Option<&UnionWithMultipleNoPropertiesTwo> {
        match self {
    ...
    pub fn into_union_with_multiple_no_properties_two(
        self,
    ) -> Option<UnionWithMultipleNoPropertiesTwo> {
        match self {
            Self::UnionWithMultipleNoPropertiesTwo(value) => Some(value),
...
impl fmt::Display for UnionWithMultipleNoProperties {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Self::UnionWithMultipleNoPropertiesZero(value) => write!(
                f,
                "{}",
                serde_json::to_string(value).unwrap_or_else(|_| format!("{:?}", value))
            ),
            Self::UnionWithMultipleNoPropertiesOne(value) => write!(
                f,
                "{}",
                serde_json::to_string(value).unwrap_or_else(|_| format!("{:?}", value))
            ),
            Self::UnionWithMultipleNoPropertiesTwo(value) => write!(
                f,
                "{}",
                serde_json::to_string(value).unwrap_or_else(|_| format!("{:?}", value))
            ),
