...
pub struct PaginatedConversationResponse {
    ...
    #[serde(default)]
    pub total_count: i64,
    pub r#type: PaginatedConversationResponseType,
}
...
pub struct PaginatedConversationResponseBuilder {
    ...
    r#type: Option<PaginatedConversationResponseType>,
}
...
impl PaginatedConversationResponseBuilder {
    ...
    pub fn r#type(mut self, value: PaginatedConversationResponseType) -> Self {
