...
impl InlineUsersInlineUsersClient {
    ...
    pub async fn inline_users_inline_users_list_with_cursor_pagination(
        &self,
        request: &InlineUsersInlineUsersListWithCursorPaginationQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<InlineUsersListUsersPaginationResponse, ApiError> {
        self.http_client
            .execute_request(
                Method::GET,
                "inline-users/cursor",
    ...
    pub async fn inline_users_inline_users_list_with_mixed_type_cursor_pagination(
        &self,
        request: &InlineUsersInlineUsersListWithMixedTypeCursorPaginationQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<InlineUsersListUsersMixedTypePaginationResponse, ApiError> {
        self.http_client
            .execute_request(
                Method::POST,
    ...
    pub async fn inline_users_inline_users_list_with_body_cursor_pagination(
        &self,
        request: &InlineUsersInlineUsersListWithBodyCursorPaginationRequest,
        options: Option<RequestOptions>,
    ) -> Result<InlineUsersListUsersPaginationResponse, ApiError> {
        self.http_client
            .execute_request(
    ...
    pub async fn inline_users_inline_users_list_with_offset_pagination(
        &self,
    ...
    pub async fn inline_users_inline_users_list_with_double_offset_pagination(
        &self,
    ...
    pub async fn inline_users_inline_users_list_with_body_offset_pagination(
        &self,
        request: &InlineUsersInlineUsersListWithBodyOffsetPaginationRequest,
        options: Option<RequestOptions>,
    ) -> Result<InlineUsersListUsersPaginationResponse, ApiError> {
        self.http_client
            .execute_request(
    ...
    pub async fn inline_users_inline_users_list_with_offset_step_pagination(
        &self,
    ...
    pub async fn inline_users_inline_users_list_with_offset_pagination_has_next_page(
        &self,
    ...
    pub async fn inline_users_inline_users_list_with_extended_results(
        &self,
        request: &InlineUsersInlineUsersListWithExtendedResultsQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<InlineUsersListUsersExtendedResponse, ApiError> {
        self.http_client
            .execute_request(
                Method::GET,
    ...
    pub async fn inline_users_inline_users_list_with_extended_results_and_optional_data(
        &self,
        request: &InlineUsersInlineUsersListWithExtendedResultsAndOptionalDataQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<InlineUsersListUsersExtendedOptionalListResponse, ApiError> {
        self.http_client
            .execute_request(
                Method::GET,
    ...
    pub async fn inline_users_inline_users_list_usernames(
        &self,
    ...
    pub async fn inline_users_inline_users_list_with_global_config(
        &self,
        request: &InlineUsersInlineUsersListWithGlobalConfigQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<InlineUsersUsernameContainer, ApiError> {
        self.http_client
            .execute_request(
                Method::GET,
