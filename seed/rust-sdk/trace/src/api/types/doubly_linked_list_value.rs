...
pub struct DoublyLinkedListValue {
    ...
    #[serde(default)]
    pub nodes: HashMap<String, DoublyLinkedListNodeValue>,
}
...
pub struct DoublyLinkedListValueBuilder {
    head: Option<NodeId>,
    nodes: Option<HashMap<String, DoublyLinkedListNodeValue>>,
}
...
impl DoublyLinkedListValueBuilder {
    ...
    pub fn nodes(mut self, value: HashMap<String, DoublyLinkedListNodeValue>) -> Self {
