...
impl V2FunctionSignatureOneBuilder {
    pub fn v2non_void_function_signature_fields(
        mut self,
        value: V2NonVoidFunctionSignature,
    ) -> Self {
    ...
    pub fn build(self) -> Result<V2FunctionSignatureOne, BuildError> {
        Ok(V2FunctionSignatureOne {
            v2non_void_function_signature_fields: self
                .v2non_void_function_signature_fields
                .ok_or_else(|| BuildError::missing_field("v2non_void_function_signature_fields"))?,
            r#type: self
                .r#type
