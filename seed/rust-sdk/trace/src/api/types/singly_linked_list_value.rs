...
pub struct SinglyLinkedListValue {
    ...
    #[serde(default)]
    pub nodes: HashMap<String, SinglyLinkedListNodeValue>,
}
...
pub struct SinglyLinkedListValueBuilder {
    head: Option<NodeId>,
    nodes: Option<HashMap<String, SinglyLinkedListNodeValue>>,
}
...
impl SinglyLinkedListValueBuilder {
    ...
    pub fn nodes(mut self, value: HashMap<String, SinglyLinkedListNodeValue>) -> Self {
