...
pub struct GradedResponseV2 {
    ...
    #[serde(default)]
    pub test_cases: HashMap<String, TestCaseGrade>,
}

impl GradedResponseV2 {
    pub fn builder() -> GradedResponseV2Builder {
        <GradedResponseV2Builder as Default>::default()
    }
}
...
pub struct GradedResponseV2Builder {
    ...
    test_cases: Option<HashMap<String, TestCaseGrade>>,
}
...
impl GradedResponseV2Builder {
    ...
    pub fn test_cases(mut self, value: HashMap<String, TestCaseGrade>) -> Self {
