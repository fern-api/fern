...
impl V2AssertCorrectnessCheckZeroBuilder {
    pub fn v2deep_equality_correctness_check_fields(
        mut self,
        value: V2DeepEqualityCorrectnessCheck,
    ) -> Self {
    ...
    pub fn build(self) -> Result<V2AssertCorrectnessCheckZero, BuildError> {
        Ok(V2AssertCorrectnessCheckZero {
            v2deep_equality_correctness_check_fields: self
                .v2deep_equality_correctness_check_fields
                .ok_or_else(|| {
                    BuildError::missing_field("v2deep_equality_correctness_check_fields")
                })?,
            r#type: self
                .r#type
