...
impl MapType {
    pub fn builder() -> MapTypeBuilder {
        <MapTypeBuilder as Default>::default()
    }
}
...
pub struct MapTypeBuilder {
    key_type: Option<VariableType>,
    value_type: Option<VariableType>,
}

impl MapTypeBuilder {
    pub fn key_type(mut self, value: VariableType) -> Self {
        self.key_type = Some(value);
        self
    }

    pub fn value_type(mut self, value: VariableType) -> Self {
    ...
    pub fn build(self) -> Result<MapType, BuildError> {
        Ok(MapType {
            key_type: self
                .key_type
                .ok_or_else(|| BuildError::missing_field("key_type"))?,
            value_type: self
                .value_type
