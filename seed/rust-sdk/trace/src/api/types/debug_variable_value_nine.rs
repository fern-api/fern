...
impl DebugVariableValueNineBuilder {
    pub fn doubly_linked_list_node_and_list_value_fields(
        mut self,
        value: DoublyLinkedListNodeAndListValue,
    ) -> Self {
    ...
    pub fn build(self) -> Result<DebugVariableValueNine, BuildError> {
        Ok(DebugVariableValueNine {
            doubly_linked_list_node_and_list_value_fields: self
                .doubly_linked_list_node_and_list_value_fields
                .ok_or_else(|| {
                    BuildError::missing_field("doubly_linked_list_node_and_list_value_fields")
                })?,
            r#type: self
                .r#type
