...
pub struct BinaryTreeValue {
    ...
    #[serde(default)]
    pub nodes: HashMap<String, BinaryTreeNodeValue>,
}
...
pub struct BinaryTreeValueBuilder {
    root: Option<NodeId>,
    nodes: Option<HashMap<String, BinaryTreeNodeValue>>,
}
...
impl BinaryTreeValueBuilder {
    ...
    pub fn nodes(mut self, value: HashMap<String, BinaryTreeNodeValue>) -> Self {
