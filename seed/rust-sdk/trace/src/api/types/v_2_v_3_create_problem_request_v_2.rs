...
pub struct V2V3CreateProblemRequestV2 {
...
impl V2V3CreateProblemRequestV2 {
    pub fn builder() -> V2V3CreateProblemRequestV2Builder {
        <V2V3CreateProblemRequestV2Builder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct V2V3CreateProblemRequestV2Builder {
...
impl V2V3CreateProblemRequestV2Builder {
    ...
    /// Consumes the builder and constructs a [`V2V3CreateProblemRequestV2`].
    /// This method will fail if any of the following fields are not set:
    /// - [`problem_name`](V2V3CreateProblemRequestV2Builder::problem_name)
    /// - [`problem_description`](V2V3CreateProblemRequestV2Builder::problem_description)
    /// - [`custom_files`](V2V3CreateProblemRequestV2Builder::custom_files)
    /// - [`custom_test_case_templates`](V2V3CreateProblemRequestV2Builder::custom_test_case_templates)
    /// - [`testcases`](V2V3CreateProblemRequestV2Builder::testcases)
    /// - [`supported_languages`](V2V3CreateProblemRequestV2Builder::supported_languages)
    /// - [`is_public`](V2V3CreateProblemRequestV2Builder::is_public)
    pub fn build(self) -> Result<V2V3CreateProblemRequestV2, BuildError> {
        Ok(V2V3CreateProblemRequestV2 {
            problem_name: self
                .problem_name
