...
impl TestCaseWithActualResultImplementationBuilder {
    ...
    pub fn build(self) -> Result<TestCaseWithActualResultImplementation, BuildError> {
        Ok(TestCaseWithActualResultImplementation {
            get_actual_result: self
                .get_actual_result
                .ok_or_else(|| BuildError::missing_field("get_actual_result"))?,
            assert_correctness_check: self
                .assert_correctness_check
                .ok_or_else(|| BuildError::missing_field("assert_correctness_check"))?,
        })
    }
}
