...
pub struct V2V3FunctionSignatureTwo {
    #[serde(flatten)]
    pub v2v3void_function_signature_that_takes_actual_result_fields:
...
pub struct V2V3FunctionSignatureTwoBuilder {
    v2v3void_function_signature_that_takes_actual_result_fields:
        Option<V2V3VoidFunctionSignatureThatTakesActualResult>,
    r#type: Option<V2V3FunctionSignatureTwoType>,
}

impl V2V3FunctionSignatureTwoBuilder {
    pub fn v2v3void_function_signature_that_takes_actual_result_fields(
        mut self,
        value: V2V3VoidFunctionSignatureThatTakesActualResult,
    ) -> Self {
    ...
    pub fn build(self) -> Result<V2V3FunctionSignatureTwo, BuildError> {
        Ok(V2V3FunctionSignatureTwo {
            v2v3void_function_signature_that_takes_actual_result_fields: self
                .v2v3void_function_signature_that_takes_actual_result_fields
                .ok_or_else(|| {
