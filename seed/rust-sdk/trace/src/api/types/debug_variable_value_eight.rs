...
impl DebugVariableValueEightBuilder {
    pub fn singly_linked_list_node_and_list_value_fields(
        mut self,
        value: SinglyLinkedListNodeAndListValue,
    ) -> Self {
    ...
    pub fn build(self) -> Result<DebugVariableValueEight, BuildError> {
        Ok(DebugVariableValueEight {
            singly_linked_list_node_and_list_value_fields: self
                .singly_linked_list_node_and_list_value_fields
                .ok_or_else(|| {
                    BuildError::missing_field("singly_linked_list_node_and_list_value_fields")
                })?,
            r#type: self
                .r#type
