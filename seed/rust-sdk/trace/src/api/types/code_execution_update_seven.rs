...
impl CodeExecutionUpdateSevenBuilder {
    pub fn recording_response_notification_fields(
        mut self,
        value: RecordingResponseNotification,
    ) -> Self {
    ...
    pub fn build(self) -> Result<CodeExecutionUpdateSeven, BuildError> {
        Ok(CodeExecutionUpdateSeven {
            recording_response_notification_fields: self
                .recording_response_notification_fields
                .ok_or_else(|| {
                    BuildError::missing_field("recording_response_notification_fields")
                })?,
            r#type: self
                .r#type
