...
#[non_exhaustive]
pub struct CreateProblemRequestBuilder {
...
impl CreateProblemRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateProblemRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`problem_name`](CreateProblemRequestBuilder::problem_name)
    /// - [`problem_description`](CreateProblemRequestBuilder::problem_description)
    /// - [`files`](CreateProblemRequestBuilder::files)
    /// - [`input_params`](CreateProblemRequestBuilder::input_params)
    /// - [`output_type`](CreateProblemRequestBuilder::output_type)
    /// - [`testcases`](CreateProblemRequestBuilder::testcases)
