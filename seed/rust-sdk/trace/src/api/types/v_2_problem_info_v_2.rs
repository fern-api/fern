...
pub struct V2ProblemInfoV2 {
    ...
    #[serde(default)]
    pub generated_files: V2GeneratedFiles,
...
impl V2ProblemInfoV2 {
    pub fn builder() -> V2ProblemInfoV2Builder {
        <V2ProblemInfoV2Builder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct V2ProblemInfoV2Builder {
...
impl V2ProblemInfoV2Builder {
    ...
    pub fn generated_files(mut self, value: V2GeneratedFiles) -> Self {
    ...
    /// Consumes the builder and constructs a [`V2ProblemInfoV2`].
    /// This method will fail if any of the following fields are not set:
    /// - [`problem_id`](V2ProblemInfoV2Builder::problem_id)
    /// - [`problem_description`](V2ProblemInfoV2Builder::problem_description)
    /// - [`problem_name`](V2ProblemInfoV2Builder::problem_name)
    /// - [`problem_version`](V2ProblemInfoV2Builder::problem_version)
    /// - [`supported_languages`](V2ProblemInfoV2Builder::supported_languages)
    /// - [`custom_files`](V2ProblemInfoV2Builder::custom_files)
    /// - [`generated_files`](V2ProblemInfoV2Builder::generated_files)
    /// - [`custom_test_case_templates`](V2ProblemInfoV2Builder::custom_test_case_templates)
    /// - [`testcases`](V2ProblemInfoV2Builder::testcases)
    /// - [`is_public`](V2ProblemInfoV2Builder::is_public)
    pub fn build(self) -> Result<V2ProblemInfoV2, BuildError> {
        Ok(V2ProblemInfoV2 {
            problem_id: self
                .problem_id
