...
impl TestCaseFunction {
    pub fn with_actual_result(get_actual_result: NonVoidFunctionDefinition, assert_correctness_check: AssertCorrectnessCheck) -> Self {
        Self::WithActualResult { get_actual_result, assert_correctness_check }
    }

    pub fn custom(parameters: Vec<Parameter>, code: FunctionImplementationForMultipleLanguages) -> Self {
