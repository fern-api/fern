...
impl V2V3TestCaseImplementationReferenceOneBuilder {
    pub fn v2v3test_case_implementation_fields(
        mut self,
        value: V2V3TestCaseImplementation,
    ) -> Self {
    ...
    pub fn build(self) -> Result<V2V3TestCaseImplementationReferenceOne, BuildError> {
        Ok(V2V3TestCaseImplementationReferenceOne {
            v2v3test_case_implementation_fields: self
                .v2v3test_case_implementation_fields
                .ok_or_else(|| BuildError::missing_field("v2v3test_case_implementation_fields"))?,
            r#type: self
                .r#type
