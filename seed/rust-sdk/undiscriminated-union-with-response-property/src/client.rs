use crate::api::resources::UndiscriminatedUnionWithResponsePropertyClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<UndiscriminatedUnionWithResponsePropertyClient, ApiError> {
        UndiscriminatedUnionWithResponsePropertyClient::new(self.config)
    }
}
