...
impl JsonLikeWithNullAndUndefined {
    ...
    pub fn as_json_like_with_null_and_undefined_list(
        &self,
    ) -> Option<&Vec<JsonLikeWithNullAndUndefined>> {
        match self {
    ...
    pub fn into_json_like_with_null_and_undefined_list(
        self,
    ) -> Option<Vec<JsonLikeWithNullAndUndefined>> {
        match self {
            Self::JsonLikeWithNullAndUndefinedList(value) => Some(value),
    ...
    pub fn as_string_to_json_like_with_null_and_undefined_map(
        &self,
    ) -> Option<&HashMap<String, JsonLikeWithNullAndUndefined>> {
        match self {
    ...
    pub fn into_string_to_json_like_with_null_and_undefined_map(
        self,
    ) -> Option<HashMap<String, JsonLikeWithNullAndUndefined>> {
        match self {
            Self::StringToJsonLikeWithNullAndUndefinedMap(value) => Some(value),
