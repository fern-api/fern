...
use crate::client::InferredAuthImplicitNoExpiryClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<InferredAuthImplicitNoExpiryClient, ApiError> {  
        // Call the client constructor with all authentication parameters
        InferredAuthImplicitNoExpiryClient::new(self.config)
    }
}