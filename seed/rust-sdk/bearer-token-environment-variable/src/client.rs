use crate::api::resources::BearerTokenEnvironmentVariableClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<BearerTokenEnvironmentVariableClient, ApiError> {
        BearerTokenEnvironmentVariableClient::new(self.config)
    }
}
