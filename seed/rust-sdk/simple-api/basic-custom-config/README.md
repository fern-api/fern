...
[![crates.io shield](https://img.shields.io/crates/v/custom_simple_sdk)](https://crates.io/crates/custom_simple_sdk)
...
```toml
[dependencies]
custom_simple_sdk = "1.2.0"
```

Or install via cargo:

```sh
cargo add custom_simple_sdk
```
...
```rust
match client.user.get(None)?.await {
    Ok(response) => {
