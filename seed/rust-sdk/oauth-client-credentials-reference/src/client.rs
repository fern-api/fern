use crate::api::resources::OauthClientCredentialsReferenceClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<OauthClientCredentialsReferenceClient, ApiError> {
        OauthClientCredentialsReferenceClient::new(self.config)
    }
}
