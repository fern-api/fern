...
[![crates.io shield](https://img.shields.io/crates/v/seed_oauth_client_credentials_reference)](https://crates.io/crates/seed_oauth_client_credentials_reference)
...
```toml
[dependencies]
seed_oauth_client_credentials_reference = "0.0.1"
```

Or install via cargo:

```sh
cargo add seed_oauth_client_credentials_reference
```
