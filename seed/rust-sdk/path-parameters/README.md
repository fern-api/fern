...
[![crates.io shield](https://img.shields.io/crates/v/seed_path_parameters)](https://crates.io/crates/seed_path_parameters)
...
```rust
use seed_path_parameters::{ClientError, ClientConfig, PathParametersClient};
...
async fn main() -> Result<(), ClientError> {
    ...
    let client = PathParametersClient::new(config)?;
