use crate::api::resources::DollarStringExamplesClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<DollarStringExamplesClient, ApiError> {
        DollarStringExamplesClient::new(self.config)
    }
}
