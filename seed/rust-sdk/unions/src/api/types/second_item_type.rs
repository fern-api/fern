...
pub struct SecondItemType {
    ...
    pub r#type: Option<SecondItemTypeType>,
    #[serde(default)]
    pub title: String,
}
...
impl SecondItemType {
    pub fn builder() -> SecondItemTypeBuilder {
        <SecondItemTypeBuilder as Default>::default()
    }
}
...
pub struct SecondItemTypeBuilder {
    r#type: Option<SecondItemTypeType>,
    title: Option<String>,
}

impl SecondItemTypeBuilder {
    pub fn r#type(mut self, value: SecondItemTypeType) -> Self {
