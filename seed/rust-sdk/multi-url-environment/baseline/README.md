...
[![crates.io shield](https://img.shields.io/crates/v/seed_multi_url_environment)](https://crates.io/crates/seed_multi_url_environment)
...
```toml
[dependencies]
seed_multi_url_environment = "0.0.1"
```
