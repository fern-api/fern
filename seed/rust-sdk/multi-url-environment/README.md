...
```toml
[dependencies]
seed_multi_url_environment = "0.1.0"
```
...
```rust
use seed_multi_url_environment::{ClientError, ClientConfig, MultiUrlEnvironmentClient};
...
async fn main() -> Result<(), ClientError> {
    ...
    let client = MultiUrlEnvironmentClient::new(config)?;
