use crate::api::resources::OauthClientCredentialsEnvironmentVariablesClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<OauthClientCredentialsEnvironmentVariablesClient, ApiError> {
