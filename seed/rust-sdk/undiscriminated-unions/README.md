...
[![crates.io shield](https://img.shields.io/crates/v/seed_undiscriminated_unions)](https://crates.io/crates/seed_undiscriminated_unions)
...
```toml
[dependencies]
seed_undiscriminated_unions = "0.1.0"
```
...
```rust
use seed_undiscriminated_unions::{ClientError, ClientConfig, UndiscriminatedUnionsClient};
...
async fn main() -> Result<(), ClientError> {
    ...
    let client = UndiscriminatedUnionsClient::new(config)?;
