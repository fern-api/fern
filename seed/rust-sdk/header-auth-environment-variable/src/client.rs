use crate::api::resources::HeaderTokenEnvironmentVariableClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<HeaderTokenEnvironmentVariableClient, ApiError> {
        HeaderTokenEnvironmentVariableClient::new(self.config)
    }
}
