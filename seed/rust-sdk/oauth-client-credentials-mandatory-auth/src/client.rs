use crate::api::resources::OauthClientCredentialsMandatoryAuthClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<OauthClientCredentialsMandatoryAuthClient, ApiError> {
        OauthClientCredentialsMandatoryAuthClient::new(self.config)
    }
}
