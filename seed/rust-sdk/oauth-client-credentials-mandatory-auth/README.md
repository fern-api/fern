...
[![crates.io shield](https://img.shields.io/crates/v/seed_oauth_client_credentials_mandatory_auth)](https://crates.io/crates/seed_oauth_client_credentials_mandatory_auth)
...
```toml
[dependencies]
seed_oauth_client_credentials_mandatory_auth = "0.0.1"
```

Or install via cargo:

```sh
cargo add seed_oauth_client_credentials_mandatory_auth
```
