...
[![crates.io shield](https://img.shields.io/crates/v/seed_basic_auth_pw_omitted)](https://crates.io/crates/seed_basic_auth_pw_omitted)
...
```toml
[dependencies]
seed_basic_auth_pw_omitted = "0.0.1"
```

Or install via cargo:

```sh
cargo add seed_basic_auth_pw_omitted
```
