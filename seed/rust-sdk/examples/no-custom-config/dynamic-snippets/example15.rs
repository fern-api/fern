...
async fn main() {
    ...
    client.service.create_movie(&Movie {
        ...
        book: None,
        metadata: HashMap::from([("actors".to_string(), serde_json::json!(["Christian Bale","Florence Pugh","Willem Dafoe"])), ("releaseDate".to_string(), serde_json::json!("2023-12-08")), ("ratings".to_string(), serde_json::json!({"rottenTomatoes":97,"imdb":7.6}))]),
        revenue: 1000000
    }, None).await;
}
