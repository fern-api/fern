...
[![crates.io shield](https://img.shields.io/crates/v/seed_package_yml)](https://crates.io/crates/seed_package_yml)
...
async fn main() {
    ...
    client.echo("id", serde_json::json!({"name":"name","size":1})).await;
}
```
...
```rust
use seed_package_yml::{ApiError, ClientConfig, PackageYmlClient};
...
async fn main() -> Result<(), ApiError> {
    ...
    let client = PackageYmlClient::new(config)?;
