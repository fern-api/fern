...
impl ConvertAudioRequest {
    pub fn builder() -> ConvertAudioRequestBuilder {
        <ConvertAudioRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ConvertAudioRequestBuilder {
    audio: Option<Vec<u8>>,
...
impl ConvertAudioRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ConvertAudioRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`audio`](ConvertAudioRequestBuilder::audio)
    /// - [`output_format`](ConvertAudioRequestBuilder::output_format)
    pub fn build(self) -> Result<ConvertAudioRequest, BuildError> {
        Ok(ConvertAudioRequest {
            audio: self
                .audio
