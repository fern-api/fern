use crate::api::resources::RustUnknownPathParameterClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<RustUnknownPathParameterClient, ApiError> {
        RustUnknownPathParameterClient::new(self.config)
    }
}
#[cfg(test)]
mod tests {
