...
[![crates.io shield](https://img.shields.io/crates/v/seed_rust_unknown_path_parameter)](https://crates.io/crates/seed_rust_unknown_path_parameter)
...
```toml
[dependencies]
seed_rust_unknown_path_parameter = "0.0.1"
```

Or install via cargo:

```sh
cargo add seed_rust_unknown_path_parameter
```
