...
[![crates.io shield](https://img.shields.io/crates/v/seed_inferred_auth_explicit)](https://crates.io/crates/seed_inferred_auth_explicit)
...
```toml
[dependencies]
seed_inferred_auth_explicit = "0.1.0"
```
...
```rust
use seed_inferred_auth_explicit::{ClientError, ClientConfig, InferredAuthExplicitClient};
...
async fn main() -> Result<(), ClientError> {
    ...
    let client = InferredAuthExplicitClient::new(config)?;
