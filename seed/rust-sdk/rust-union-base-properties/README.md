...
[![crates.io shield](https://img.shields.io/crates/v/seed_rust_union_base_properties)](https://crates.io/crates/seed_rust_union_base_properties)
...
```toml
[dependencies]
seed_rust_union_base_properties = "0.0.1"
```

Or install via cargo:

```sh
cargo add seed_rust_union_base_properties
```
