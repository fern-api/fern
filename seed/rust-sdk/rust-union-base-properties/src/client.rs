use crate::api::resources::RustUnionBasePropertiesClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<RustUnionBasePropertiesClient, ApiError> {
        RustUnionBasePropertiesClient::new(self.config)
    }
}
#[cfg(test)]
mod tests {
