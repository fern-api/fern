    ...
    client
        ...
        .createcomplexprofile(
            &ComplexProfile {
                ...
                optional_notification: Some(NotificationMethod::NotificationMethodZero(
                    NotificationMethodZero {
                        email_notification_fields: EmailNotification {
                            email_address: "emailAddress".to_string(),
                            subject: "subject".to_string(),
                ...
                optional_nullable_notification: Some(NotificationMethod::NotificationMethodZero(
                    NotificationMethodZero {
                        email_notification_fields: EmailNotification {
                            email_address: "emailAddress".to_string(),
                            subject: "subject".to_string(),
                ...
                optional_search_result: Some(SearchResult::SearchResultZero(SearchResultZero {
                    user_response_fields: UserResponse {
                        id: "id".to_string(),
                        username: "username".to_string(),
                        email: Some("email".to_string()),
                ...
                nullable_list_of_unions: Some(vec![
                    NotificationMethod::NotificationMethodZero(NotificationMethodZero {
                        email_notification_fields: EmailNotification {
                            email_address: "emailAddress".to_string(),
                            subject: "subject".to_string(),
                            html_content: Some("htmlContent".to_string()),
