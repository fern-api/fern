...
use seed_nullable_optional::{UpdateUserRequest, Address, NullableUserId, OptionalUserId};
...
async fn main() {
    ...
    client.nullable_optional.update_user(&"userId".to_string(), &UpdateUserRequest {
