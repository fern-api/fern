...
use seed_nullable_optional::{DeserializationTestRequest, UserRole, UserStatus, NotificationMethod, EmailNotification, SmsNotification, PushNotification, SearchResult, UserResponse, Address, NullableUserId, OptionalUserId, Organization, Document};
...
async fn main() {
    ...
    client.nullable_optional.test_deserialization(&DeserializationTestRequest {
