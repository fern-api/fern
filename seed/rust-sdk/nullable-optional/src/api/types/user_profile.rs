...
pub struct UserProfile {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nullable_map: Option<HashMap<String, Option<String>>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub optional_map: Option<HashMap<String, Option<String>>>,
...
pub struct UserProfileBuilder {
    ...
    nullable_map: Option<HashMap<String, Option<String>>>,
    ...
    optional_map: Option<HashMap<String, Option<String>>>,
...
impl UserProfileBuilder {
    ...
    pub fn nullable_map(mut self, value: HashMap<String, Option<String>>) -> Self {
    ...
    pub fn optional_map(mut self, value: HashMap<String, Option<String>>) -> Self {
    ...
    /// - [`nullable_object`](UserProfileBuilder::nullable_object)
    pub fn build(self) -> Result<UserProfile, BuildError> {
        Ok(UserProfile {
            ...
            nullable_object: self
                .nullable_object
                .ok_or_else(|| BuildError::missing_field("nullable_object"))?,
