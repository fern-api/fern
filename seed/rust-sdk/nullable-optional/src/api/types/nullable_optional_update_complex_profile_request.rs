...
pub struct NullableOptionalUpdateComplexProfileRequest {
...
impl NullableOptionalUpdateComplexProfileRequest {
    pub fn builder() -> NullableOptionalUpdateComplexProfileRequestBuilder {
        <NullableOptionalUpdateComplexProfileRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct NullableOptionalUpdateComplexProfileRequestBuilder {
...
impl NullableOptionalUpdateComplexProfileRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`NullableOptionalUpdateComplexProfileRequest`].
    pub fn build(self) -> Result<NullableOptionalUpdateComplexProfileRequest, BuildError> {
        Ok(NullableOptionalUpdateComplexProfileRequest {
