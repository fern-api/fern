...
pub struct ComplexProfile {
    ...
    pub nullable_status: UserStatus,
    ...
    pub nullable_notification: NotificationMethod,
    ...
    pub nullable_search_result: SearchResult,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub optional_map_of_enums: Option<HashMap<String, Option<UserRole>>>,
}
...
pub struct ComplexProfileBuilder {
    ...
    optional_map_of_enums: Option<HashMap<String, Option<UserRole>>>,
}
...
impl ComplexProfileBuilder {
    ...
    pub fn optional_map_of_enums(mut self, value: HashMap<String, Option<UserRole>>) -> Self {
    ...
    /// - [`nullable_role`](ComplexProfileBuilder::nullable_role)
    /// - [`nullable_status`](ComplexProfileBuilder::nullable_status)
    /// - [`nullable_notification`](ComplexProfileBuilder::nullable_notification)
    /// - [`nullable_search_result`](ComplexProfileBuilder::nullable_search_result)
    pub fn build(self) -> Result<ComplexProfile, BuildError> {
        Ok(ComplexProfile {
            id: self.id.ok_or_else(|| BuildError::missing_field("id"))?,
            nullable_role: self
                .nullable_role
                .ok_or_else(|| BuildError::missing_field("nullable_role"))?,
            optional_role: self.optional_role,
            optional_nullable_role: self.optional_nullable_role,
            nullable_status: self
                .nullable_status
                .ok_or_else(|| BuildError::missing_field("nullable_status"))?,
            optional_status: self.optional_status,
            optional_nullable_status: self.optional_nullable_status,
            nullable_notification: self
                .nullable_notification
                .ok_or_else(|| BuildError::missing_field("nullable_notification"))?,
            optional_notification: self.optional_notification,
            optional_nullable_notification: self.optional_nullable_notification,
            nullable_search_result: self
                .nullable_search_result
                .ok_or_else(|| BuildError::missing_field("nullable_search_result"))?,
