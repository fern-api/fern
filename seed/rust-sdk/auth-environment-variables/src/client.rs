use crate::api::resources::AuthEnvironmentVariablesClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<AuthEnvironmentVariablesClient, ApiError> {
        AuthEnvironmentVariablesClient::new(self.config)
    }
}
