...
impl ApiClientBuilder {
    ...
    pub fn environment(mut self, environment: MyCustomEnvironment) -> Self {
...
mod tests {
    ...
    #[test]
    fn test_environment() {
        let builder = ApiClientBuilder::default().environment(MyCustomEnvironment::default());
        assert_eq!(
            builder.config.base_url,
            MyCustomEnvironment::default().url().to_string()
        );
    }
