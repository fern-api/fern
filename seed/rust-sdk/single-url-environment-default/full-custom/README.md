...
[![crates.io shield](https://img.shields.io/crates/v/full_custom_sdk)](https://crates.io/crates/full_custom_sdk)
...
For advanced users, you can configure custom retry policies and timeouts.
...
let config = ClientConfig {
    base_url: MyCustomEnvironment::Production.url().to_string(),
    ..Default::default()
};
