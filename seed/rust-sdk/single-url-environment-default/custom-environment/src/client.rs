use crate::api::resources::SingleUrlEnvironmentDefaultClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<SingleUrlEnvironmentDefaultClient, ApiError> {
        SingleUrlEnvironmentDefaultClient::new(self.config)
    }
}
