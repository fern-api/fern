...
[![crates.io shield](https://img.shields.io/crates/v/seed_alias_extends)](https://crates.io/crates/seed_alias_extends)
...
```rust
use seed_alias_extends::{ClientError, ClientConfig, AliasExtendsClient};
...
async fn main() -> Result<(), ClientError> {
    ...
    let client = AliasExtendsClient::new(config)?;
