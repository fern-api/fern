...
pub struct GetTokenRequest {
    ...
    pub audience: GetTokenRequestAudience,
    pub grant_type: GetTokenRequestGrantType,
...
pub struct GetTokenRequestBuilder {
    ...
    audience: Option<GetTokenRequestAudience>,
    grant_type: Option<GetTokenRequestGrantType>,
    scope: Option<String>,
}
...
impl GetTokenRequestBuilder {
    ...
    pub fn audience(mut self, value: GetTokenRequestAudience) -> Self {
        self.audience = Some(value);
        self
    }

    pub fn grant_type(mut self, value: GetTokenRequestGrantType) -> Self {
