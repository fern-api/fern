use crate::api::resources::OauthClientCredentialsDefaultClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<OauthClientCredentialsDefaultClient, ApiError> {
        OauthClientCredentialsDefaultClient::new(self.config)
    }
}
