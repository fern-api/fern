...
```rust
use seed_oauth_client_credentials_default::{ClientError, ClientConfig, OauthClientCredentialsDefaultClient};
...
async fn main() -> Result<(), ClientError> {
    ...
    let client = OauthClientCredentialsDefaultClient::new(config)?;
