...
impl ContainerClient {
    ...
    pub async fn get_and_return_set_of_primitives(&self, request: &HashSet<String>, options: Option<RequestOptions>) -> Result<HashSet<String>, ApiError> {
        self.http_client.execute_request(
            Method::POST,
    ...
    pub async fn get_and_return_set_of_objects(&self, request: &HashSet<ObjectWithRequiredField>, options: Option<RequestOptions>) -> Result<HashSet<ObjectWithRequiredField>, ApiError> {
        self.http_client.execute_request(
            Method::POST,
