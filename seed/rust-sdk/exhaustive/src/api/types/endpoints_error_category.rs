...
pub enum EndpointsErrorCategory {
    ApiError,
    AuthenticationError,
    InvalidRequestError,
...
impl Serialize for EndpointsErrorCategory {
...
impl<'de> Deserialize<'de> for EndpointsErrorCategory {
...
impl fmt::Display for EndpointsErrorCategory {
