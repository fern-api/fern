...
async fn main() {
    ...
    client.endpoints.http_methods.test_patch(&"id".to_string(), &ObjectWithOptionalField {
        ...
        base_64: Some(base64::engine::general_purpose::STANDARD.decode("SGVsbG8gd29ybGQh").unwrap()),
