...
[![crates.io shield](https://img.shields.io/crates/v/seed_custom_auth)](https://crates.io/crates/seed_custom_auth)
...
```rust
use seed_custom_auth::{ClientError, ClientConfig, CustomAuthClient};
