use crate::api::resources::EndpointSecurityAuthClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<EndpointSecurityAuthClient, ApiError> {
        EndpointSecurityAuthClient::new(self.config)
    }
}
