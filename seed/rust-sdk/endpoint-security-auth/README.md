...
[![crates.io shield](https://img.shields.io/crates/v/seed_endpoint_security_auth)](https://crates.io/crates/seed_endpoint_security_auth)
...
```toml
[dependencies]
seed_endpoint_security_auth = "0.0.1"
```

Or install via cargo:

```sh
cargo add seed_endpoint_security_auth
```
