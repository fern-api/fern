...
pub enum PlantPostWateringFrequency {
    Daily,
    Weekly,
    Biweekly,
    Monthly,
...
impl Serialize for PlantPostWateringFrequency {
...
impl<'de> Deserialize<'de> for PlantPostWateringFrequency {
...
impl fmt::Display for PlantPostWateringFrequency {
