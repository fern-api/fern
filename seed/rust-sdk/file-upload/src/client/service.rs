...
impl ServiceClient {
    ...
    pub async fn post(
        ...
        file_list: crate::core::File,
        maybe_file: Option<crate::core::File>,
        maybe_file_list: Option<crate::core::File>,
        maybe_integer: Option<&Option<i32>>,
        optional_list_of_strings: Option<&Option<Vec<String>>>,
        list_of_objects: Option<&Vec<MyObject>>,
        optional_metadata: Option<&Option<serde_json::Value>>,
        optional_object_type: Option<&Option<ObjectType>>,
        optional_id: Option<&Option<Id>>,
            ...
            .execute_multipart_request(
                ...
                "",
                {
                    ...
                    if let Some(Some(value)) = &maybe_string {
                        form = crate::core::add_text_field(
                            form,
                            "maybe_string",
                            &serde_json::to_string(&value).unwrap_or_default().as_str(),
                        );
                    }
            ...
            .execute_multipart_request(
                ...
                "/just-file-with-query-params",
                {
                    ...
                    form = crate::core::add_text_field(
                        form,
                        "optional_list_of_strings",
                        &optional_list_of_strings.to_string(),
                    );
                    form = crate::core::add_file_field(form, "file", file);
                    form
                },
    ...
    pub async fn with_content_type(
        ...
        foo: Option<&String>,
        bar: Option<&MyObject>,
        foo_bar: Option<&Option<MyObject>>,
        options: Option<RequestOptions>,
    ) -> Result<(), ApiError> {
        self.http_client
            .execute_multipart_request(
    ...
    pub async fn optional_args(
        &self,
        image_file: Option<crate::core::File>,
        request: Option<&Option<serde_json::Value>>,
        options: Option<RequestOptions>,
