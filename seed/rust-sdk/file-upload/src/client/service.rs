...
impl ServiceClient {
    ...
    pub async fn just_file(&self, file: crate::core::File, options: Option<RequestOptions>) -> Result<(), ApiError> {
        self.http_client.execute_multipart_request(
            Method::POST,
            "/just-file",
            { 
    ...
    pub async fn just_file_with_query_params(&self, maybe_string: Option<String>, integer: Option<i32>, maybe_integer: Option<i32>, list_of_strings: Option<String>, optional_list_of_strings: Option<String>, file: crate::core::File, options: Option<RequestOptions>) -> Result<(), ApiError> {
        self.http_client.execute_multipart_request(
            Method::POST,
            "/just-file-with-query-params",
            { 
    let mut form = crate::core::create_multipart_form();
    if let Some(ref value) = maybe_string {
        form = crate::core::add_text_field(form, "maybe_string", &value.to_string());
    }
    if let Some(ref value) = integer {
        form = crate::core::add_text_field(form, "integer", &value.to_string());
    }
    if let Some(ref value) = maybe_integer {
        form = crate::core::add_text_field(form, "maybe_integer", &value.to_string());
    }
    if let Some(ref value) = list_of_strings {
        form = crate::core::add_text_field(form, "list_of_strings", &value.to_string());
    }
    if let Some(ref value) = optional_list_of_strings {
        form = crate::core::add_text_field(form, "optional_list_of_strings", &value.to_string());
    }
    form = crate::core::add_file_field(form, "file", file);
    form
 },
    ...
    pub async fn with_content_type(&self, file: crate::core::File, foo: Option<&String>, bar: Option<&MyObject>, foo_bar: Option<&Option<MyObject>>, options: Option<RequestOptions>) -> Result<(), ApiError> {
        self.http_client.execute_multipart_request(
            Method::POST,
            "/with-content-type",
            { 
    ...
    pub async fn with_form_encoding(&self, file: crate::core::File, foo: Option<&String>, bar: Option<&MyObject>, options: Option<RequestOptions>) -> Result<(), ApiError> {
        self.http_client.execute_multipart_request(
            Method::POST,
            "/with-form-encoding",
            { 
    ...
    if let Some(ref value) = list_of_objects_with_optionals {
    ...
    pub async fn optional_args(&self, image_file: Option<crate::core::File>, request: Option<&Option<serde_json::Value>>, options: Option<RequestOptions>) -> Result<String, ApiError> {
        self.http_client.execute_multipart_request(
            Method::POST,
            "/optional-args",
            { 
    ...
    if let Some(Some(ref value)) = request {
    ...
    pub async fn with_inline_type(&self, file: crate::core::File, request: Option<&MyInlineType>, options: Option<RequestOptions>) -> Result<String, ApiError> {
        self.http_client.execute_multipart_request(
            Method::POST,
            "/inline-type",
            { 
