...
[![crates.io shield](https://img.shields.io/crates/v/seed_server_sent_events_resumable)](https://crates.io/crates/seed_server_sent_events_resumable)
...
```toml
[dependencies]
seed_server_sent_events_resumable = "0.0.1"
```

Or install via cargo:

```sh
cargo add seed_server_sent_events_resumable
```
