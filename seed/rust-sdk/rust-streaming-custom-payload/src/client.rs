use crate::api::resources::RustStreamingCustomPayloadClient;
...
impl ApiClientBuilder {
    ...
    pub fn build(self) -> Result<RustStreamingCustomPayloadClient, ApiError> {
        RustStreamingCustomPayloadClient::new(self.config)
    }
}
#[cfg(test)]
mod tests {
