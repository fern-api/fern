...
impl ServiceClient {
    ...
    ///
    /// The parsed response wrapped with raw HTTP metadata
    pub async fn search_resources_with_raw_response(
        &self,
        request: &SearchResourcesRequest,
        options: Option<RequestOptions>,
    ...
    pub async fn list_users_with_raw_response(
        ...
        request: &ListUsersQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<WithRawResponse<PaginatedUserResponse>, ApiError> {
        self.http_client
            .execute_request_with_raw_response(
                Method::GET,
                "/api/users",
    ...
    ///
    /// The parsed response wrapped with raw HTTP metadata
    pub async fn get_user_by_id_with_raw_response(
        &self,
        user_id: &str,
        request: &GetUserByIdQueryRequest,
        options: Option<RequestOptions>,
    ...
    ///
    /// The parsed response wrapped with raw HTTP metadata
    pub async fn list_connections_with_raw_response(
        &self,
        request: &ListConnectionsQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<WithRawResponse<Vec<Connection>>, ApiError> {
        self.http_client
            .execute_request_with_raw_response(
                Method::GET,
                "/api/connections",
    ...
    ///
    /// The parsed response wrapped with raw HTTP metadata
    pub async fn get_connection_with_raw_response(
        &self,
        connection_id: &str,
        request: &GetConnectionQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<WithRawResponse<Connection>, ApiError> {
        self.http_client
            .execute_request_with_raw_response(
                Method::GET,
                &format!("/api/connections/{}", connection_id),
    ...
    ///
    /// The parsed response wrapped with raw HTTP metadata
    pub async fn list_clients_with_raw_response(
        &self,
        request: &ListClientsQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<WithRawResponse<PaginatedClientResponse>, ApiError> {
        self.http_client
            .execute_request_with_raw_response(
                Method::GET,
                "/api/clients",
    ...
    ///
    /// The parsed response wrapped with raw HTTP metadata
    pub async fn get_client_with_raw_response(
        &self,
        client_id: &str,
        request: &GetClientQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<WithRawResponse<Client>, ApiError> {
        self.http_client
            .execute_request_with_raw_response(
                Method::GET,
                &format!("/api/clients/{}", client_id),
