...
[![crates.io shield](https://img.shields.io/crates/v/seed_client_side_params)](https://crates.io/crates/seed_client_side_params)
...
```rust
use seed_client_side_params::{ClientError, ClientConfig, ClientSideParamsClient};
...
async fn main() -> Result<(), ClientError> {
    ...
    let client = ClientSideParamsClient::new(config)?;
