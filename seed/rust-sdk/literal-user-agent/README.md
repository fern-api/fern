...
[![crates.io shield](https://img.shields.io/crates/v/seed_literal_user_agent)](https://crates.io/crates/seed_literal_user_agent)
...
```toml
[dependencies]
seed_literal_user_agent = "0.0.1"
```

Or install via cargo:

```sh
cargo add seed_literal_user_agent
```
