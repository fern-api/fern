...
[![crates.io shield](https://img.shields.io/crates/v/seed_bytes_download)](https://crates.io/crates/seed_bytes_download)
...
```toml
[dependencies]
seed_bytes_download = "0.0.1"
```

Or install via cargo:

```sh
cargo add seed_bytes_download
```
