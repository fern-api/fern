...
class StreamNoContextResponse extends JsonSerializableType
{
     ...
     * @return StreamNoContextResponse
     */
    public static function heartbeat(DataContextHeartbeat $heartbeat): StreamNoContextResponse
    {
        return new StreamNoContextResponse([
            'event' => 'heartbeat',
            'value' => $heartbeat,
        ]);
    }
     ...
     * @return StreamNoContextResponse
     */
    public static function entity(DataContextEntityEvent $entity): StreamNoContextResponse
    {
        return new StreamNoContextResponse([
            'event' => 'entity',
            'value' => $entity,
