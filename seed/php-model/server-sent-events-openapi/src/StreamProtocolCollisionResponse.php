...
class StreamProtocolCollisionResponse extends JsonSerializableType
{
     ...
     * @return StreamProtocolCollisionResponse
     */
    public static function heartbeat(ProtocolHeartbeat $heartbeat): StreamProtocolCollisionResponse
    {
        return new StreamProtocolCollisionResponse([
            'event' => 'heartbeat',
            'value' => $heartbeat,
        ]);
    }
     ...
     * @return StreamProtocolCollisionResponse
     */
    public static function stringData(ProtocolStringEvent $stringData): StreamProtocolCollisionResponse
    {
        return new StreamProtocolCollisionResponse([
            'event' => 'string_data',
            'value' => $stringData,
     ...
     * @return StreamProtocolCollisionResponse
     */
    public static function numberData(ProtocolNumberEvent $numberData): StreamProtocolCollisionResponse
    {
        return new StreamProtocolCollisionResponse([
            'event' => 'number_data',
            'value' => $numberData,
    ...
    /**
     * @param ProtocolCollisionObjectEvent $objectData
     * @return StreamProtocolCollisionResponse
     */
    public static function objectData(ProtocolCollisionObjectEvent $objectData): StreamProtocolCollisionResponse
    {
        return new StreamProtocolCollisionResponse([
            'event' => 'object_data',
            'value' => $objectData,
    ...
    {
        return $this->value instanceof ProtocolCollisionObjectEvent && $this->event === 'object_data';
    }

    /**
     * @return ProtocolCollisionObjectEvent
     */
    public function asObjectData(): ProtocolCollisionObjectEvent
    {
        if (!($this->value instanceof ProtocolCollisionObjectEvent && $this->event === 'object_data')) {
            throw new Exception(
    ...
    public static function jsonDeserialize(array $data): static
    {
        ...
        switch ($event) {
            ...
            case 'number_data':
                ...
                break;
            case 'object_data':
                $args['value'] = ProtocolCollisionObjectEvent::jsonDeserialize($data);
                break;
            case '_unknown':
            default:
                $args['event'] = '_unknown';
