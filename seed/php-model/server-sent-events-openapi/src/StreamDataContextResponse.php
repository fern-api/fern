...
class StreamDataContextResponse extends JsonSerializableType
{
     ...
     * @return StreamDataContextResponse
     */
    public static function heartbeat(DataContextHeartbeat $heartbeat): StreamDataContextResponse
    {
        return new StreamDataContextResponse([
            'event' => 'heartbeat',
            'value' => $heartbeat,
        ]);
    }
     ...
     * @return StreamDataContextResponse
     */
    public static function entity(DataContextEntityEvent $entity): StreamDataContextResponse
    {
        return new StreamDataContextResponse([
            'event' => 'entity',
            'value' => $entity,
