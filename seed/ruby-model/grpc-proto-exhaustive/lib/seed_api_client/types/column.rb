...
module SeedApiClient
  class Column
    ...
    # @return [SeedApiClient::Column]
    def initialize(id:, values:, metadata: OMIT, indexed_data: OMIT, additional_properties: nil)
      @id = id
      @values = values
    ...
    # Deserialize a JSON object to an instance of Column
    #
    ...
    # Serialize an instance of Column to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
