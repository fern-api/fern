...
module SeedNullableOptionalClient
  class NullableOptional
    ...
    class UpdateUserRequest
      ...
      # @return [SeedNullableOptionalClient::NullableOptional::UpdateUserRequest]
      def initialize(username: OMIT, email: OMIT, phone: OMIT, address: OMIT, additional_properties: nil)
