...
module SeedMixedCaseClient
  class RequestClient
    ...
    def initialize(base_url: nil, max_retries: nil, timeout_in_seconds: nil)
      @base_url = base_url
      @headers = { "X-Fern-Language": "Ruby", "X-Fern-SDK-Name": "seed_mixed_case_client" }
  ...
  class RequestOptions
    ...
    # @param timeout_in_seconds [Long]
    # @return [SeedMixedCaseClient::RequestOptions]
  ...
  class IdempotencyRequestOptions
    ...
    # @param additional_body_parameters [Hash{String => Object}]
    # @param timeout_in_seconds [Long]
    # @return [SeedMixedCaseClient::IdempotencyRequestOptions]
    def initialize(base_url: nil, additional_headers: nil, additional_query_parameters: nil,
                   additional_body_parameters: nil, timeout_in_seconds: nil)
      @base_url = base_url
      @additional_headers = additional_headers
