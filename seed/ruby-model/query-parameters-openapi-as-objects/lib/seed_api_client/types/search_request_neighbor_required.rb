...
module SeedApiClient
  class SearchRequestNeighborRequired
    # Deserialize a JSON object to an instance of SearchRequestNeighborRequired
    #
    # @param json_object [String]
    # @return [SeedApiClient::SearchRequestNeighborRequired]
