...
module SeedApiClient
  class Ast
    class FirstUnionFirstElement
      ...
      # @return [SeedApiClient::Ast::FirstUnionFirstElement]
      ...
      # Deserialize a JSON object to an instance of FirstUnionFirstElement
      #
      ...
      # Serialize an instance of FirstUnionFirstElement to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
