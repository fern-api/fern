...
module SeedUnionsClient
  class Types
    class UnionWithNullableReference
      # @return [Object]
      attr_reader :member
      # @return [String]
      ...
      # @return [SeedUnionsClient::Types::UnionWithNullableReference]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end

      # Deserialize a JSON object to an instance of UnionWithNullableReference
      #
