...
module SeedUnionsClient
  class Types
    class UnionWithOptionalReference
      # @return [Object]
      attr_reader :member
      # @return [String]
      ...
      # @return [SeedUnionsClient::Types::UnionWithOptionalReference]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end

      # Deserialize a JSON object to an instance of UnionWithOptionalReference
      #
      ...
      def self.from_json(json_object:)
        ...
        member = case struct.type
                 when "foo"
                   SeedUnionsClient::Types::Foo.from_json(json_object: json_object.value)
                 when "bar"
                   SeedUnionsClient::Types::Bar.from_json(json_object: json_object.value)
                 else
