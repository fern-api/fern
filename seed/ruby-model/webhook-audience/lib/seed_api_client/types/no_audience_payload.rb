...
module SeedApiClient
  class NoAudiencePayload
    ...
    # @return [SeedApiClient::NoAudiencePayload]
    ...
    # Deserialize a JSON object to an instance of NoAudiencePayload
    #
    ...
    # Serialize an instance of NoAudiencePayload to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
