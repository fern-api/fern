...
module SeedPaginationClient
  class Users
    class ListUsersOptionalDataPaginationResponse
      # @return [Boolean]
      ...
      def initialize(total_count:, has_next_page: OMIT, page: OMIT, data: OMIT, additional_properties: nil)
      ...
      # Serialize an instance of ListUsersOptionalDataPaginationResponse to a JSON
      #  object
      #
      # @return [String]
      def to_json(*_args)
