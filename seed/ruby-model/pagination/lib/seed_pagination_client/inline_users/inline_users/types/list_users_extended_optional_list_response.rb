  ...
  module InlineUsers
    class InlineUsers
      class ListUsersExtendedOptionalListResponse
        ...
        # @param data [SeedPaginationClient::InlineUsers::InlineUsers::UserOptionalListContainer]
        # @param next_ [String]
        # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
        # @return [SeedPaginationClient::InlineUsers::InlineUsers::ListUsersExtendedOptionalListResponse]
        ...
        def self.from_json(json_object:)
          ...
          if parsed_json["data"].nil?
            ...
            data = SeedPaginationClient::InlineUsers::InlineUsers::UserOptionalListContainer.from_json(json_object: data)
          end
        ...
        def self.validate_raw(obj:)
          ...
          SeedPaginationClient::InlineUsers::InlineUsers::UserOptionalListContainer.validate_raw(obj: obj.data)
