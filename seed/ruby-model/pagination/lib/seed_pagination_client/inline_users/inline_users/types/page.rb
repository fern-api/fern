  ...
  module InlineUsers
    class InlineUsers
      class Page
        ...
        attr_reader :page
        # @return [SeedPaginationClient::InlineUsers::InlineUsers::NextPage]
        attr_reader :next_
        # @return [Integer]
        ...
        # @param next_ [SeedPaginationClient::InlineUsers::InlineUsers::NextPage]
        ...
        def self.from_json(json_object:)
          ...
          if parsed_json["next"].nil?
            ...
            next_ = SeedPaginationClient::InlineUsers::InlineUsers::NextPage.from_json(json_object: next_)
          end
        ...
        def self.validate_raw(obj:)
          ...
          obj.next_.nil? || SeedPaginationClient::InlineUsers::InlineUsers::NextPage.validate_raw(obj: obj.next_)
