...
module SeedPaginationUriPathClient
  class Users
    class ListUsersPathPaginationResponse
      ...
      # @return [SeedPaginationUriPathClient::Users::ListUsersPathPaginationResponse]
      ...
      # Deserialize a JSON object to an instance of ListUsersPathPaginationResponse
      #
      ...
      # Serialize an instance of ListUsersPathPaginationResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
