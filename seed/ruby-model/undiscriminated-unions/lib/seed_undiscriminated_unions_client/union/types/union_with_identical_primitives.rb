...
module SeedUndiscriminatedUnionsClient
  class Union
    ...
    class UnionWithIdenticalPrimitives
      # Deserialize a JSON object to an instance of UnionWithIdenticalPrimitives
      #
      # @param json_object [String]
      # @return [SeedUndiscriminatedUnionsClient::Union::UnionWithIdenticalPrimitives]
