...
module SeedObjectClient
  ...
  class RootType1FooSetItem
    ...
    # @return [SeedObjectClient::RootType1FooSetItem]
    ...
    # Deserialize a JSON object to an instance of RootType1FooSetItem
    #
    ...
    # Serialize an instance of RootType1FooSetItem to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
