...
module SeedObjectClient
  # lorem ipsum
  class UndiscriminatedUnion1InlineListItem1
    ...
    # @return [SeedObjectClient::UndiscriminatedUnion1InlineListItem1]
    ...
    # Deserialize a JSON object to an instance of UndiscriminatedUnion1InlineListItem1
    #
    ...
    # Serialize an instance of UndiscriminatedUnion1InlineListItem1 to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
