...
require_relative "root_type_1_inline_type_1_nested_inline_type_1"
...
module SeedObjectClient
  # lorem ipsum
  class RootType1InlineType1
    # @return [String] lorem ipsum
    attr_reader :foo
    # @return [SeedObjectClient::RootType1InlineType1NestedInlineType1] lorem ipsum
    attr_reader :bar
    ...
    # @param bar [SeedObjectClient::RootType1InlineType1NestedInlineType1] lorem ipsum
    # @param ref [SeedObjectClient::ReferenceType] lorem ipsum
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SeedObjectClient::RootType1InlineType1]
    ...
    # Deserialize a JSON object to an instance of RootType1InlineType1
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["bar"].nil?
        ...
        bar = SeedObjectClient::RootType1InlineType1NestedInlineType1.from_json(json_object: bar)
      end
    ...
    # Serialize an instance of RootType1InlineType1 to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      SeedObjectClient::RootType1InlineType1NestedInlineType1.validate_raw(obj: obj.bar)
