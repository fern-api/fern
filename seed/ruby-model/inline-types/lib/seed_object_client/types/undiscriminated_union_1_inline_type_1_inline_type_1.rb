...
module SeedObjectClient
  # lorem ipsum
  class UndiscriminatedUnion1InlineType1InlineType1
    ...
    # @return [SeedObjectClient::UndiscriminatedUnion1InlineType1InlineType1]
    ...
    # Serialize an instance of UndiscriminatedUnion1InlineType1InlineType1 to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
