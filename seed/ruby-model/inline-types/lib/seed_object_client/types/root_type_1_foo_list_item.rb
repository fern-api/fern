...
module SeedObjectClient
  ...
  class RootType1FooListItem
    ...
    # @return [SeedObjectClient::RootType1FooListItem]
    ...
    # Deserialize a JSON object to an instance of RootType1FooListItem
    #
    ...
    # Serialize an instance of RootType1FooListItem to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
