...
module SeedObjectClient
  ...
  class RootType1FooMapValue
    ...
    # @return [SeedObjectClient::RootType1FooMapValue]
    ...
    # Deserialize a JSON object to an instance of RootType1FooMapValue
    #
    ...
    # Serialize an instance of RootType1FooMapValue to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
