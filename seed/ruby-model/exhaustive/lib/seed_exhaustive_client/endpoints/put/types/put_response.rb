...
module SeedExhaustiveClient
  module Endpoints
    class Put
      class PutResponse
        # @return [Array<SeedExhaustiveClient::Endpoints::Put::Error>]
        attr_reader :errors
        ...
        # @param errors [Array<SeedExhaustiveClient::Endpoints::Put::Error>]
        ...
        def self.from_json(json_object:)
          ...
          errors = parsed_json["errors"]&.map do |item|
            item = item.to_json
            SeedExhaustiveClient::Endpoints::Put::Error.from_json(json_object: item)
          end
