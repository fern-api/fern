...
module SeedExhaustiveClient
  module Endpoints
    class ObjectClient
      ...
      #  exhaustive.endpoints.object.get_and_return_with_optional_field(request: {  })
      ...
      # @example
      #  exhaustive = SeedExhaustiveClient::Client.new(base_url: "https://api.example.com", token: "YOUR_AUTH_TOKEN")
      #  exhaustive.endpoints.object.get_and_return_nested_with_optional_field(request: {  })
      ...
      # @example
      #  exhaustive = SeedExhaustiveClient::Client.new(base_url: "https://api.example.com", token: "YOUR_AUTH_TOKEN")
      #  exhaustive.endpoints.object.get_and_return_nested_with_required_field(string: "string", request: { string: "string", nested_object: {  } })
      ...
      # @example
      #  exhaustive = SeedExhaustiveClient::Client.new(base_url: "https://api.example.com", token: "YOUR_AUTH_TOKEN")
      #  exhaustive.endpoints.object.get_and_return_nested_with_required_field_as_list(request: [{ string: "string", nested_object: {  } }, { string: "string", nested_object: {  } }])
