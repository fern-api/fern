  ...
  module V2
    class Problem
      class FunctionImplementationForMultipleLanguages
        # @return [Hash{SeedTraceClient::Commons::Language => SeedTraceClient::V2::Problem::FunctionImplementation}]
        ...
        # @param code_by_language [Hash{SeedTraceClient::Commons::Language => SeedTraceClient::V2::Problem::FunctionImplementation}]
        ...
        def self.from_json(json_object:)
          ...
          code_by_language = parsed_json["codeByLanguage"]&.transform_values do |value|
            value = value.to_json
            SeedTraceClient::V2::Problem::FunctionImplementation.from_json(json_object: value)
          end
