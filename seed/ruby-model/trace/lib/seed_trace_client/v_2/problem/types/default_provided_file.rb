  ...
  module V2
    class Problem
      class DefaultProvidedFile
        ...
        OMIT = Object.new
        # @param file [SeedTraceClient::V2::Problem::FileInfoV2]
        # @param related_types [Array<SeedTraceClient::Commons::VariableType>]
        # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
        # @return [SeedTraceClient::V2::Problem::DefaultProvidedFile]
        def initialize(file:, related_types:, additional_properties: nil)
          # @type [SeedTraceClient::V2::Problem::FileInfoV2]
          @file = file
        ...
        def self.from_json(json_object:)
          ...
          if parsed_json["file"].nil?
            ...
            file = SeedTraceClient::V2::Problem::FileInfoV2.from_json(json_object: file)
          end
        ...
        def self.validate_raw(obj:)
          SeedTraceClient::V2::Problem::FileInfoV2.validate_raw(obj: obj.file)
