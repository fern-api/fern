    ...
    class Problem
      class ProblemInfoV2
        ...
        def initialize(problem_id:, problem_description:, problem_name:, problem_version:, supported_languages:,
          ...
          # @type [SeedTraceClient::V2::Problem::CustomFiles]
          @custom_files = custom_files
          # @type [SeedTraceClient::V2::Problem::GeneratedFiles]
          @generated_files = generated_files
          # @type [Array<SeedTraceClient::V2::Problem::TestCaseTemplate>]
          @custom_test_case_templates = custom_test_case_templates
          # @type [Array<SeedTraceClient::V2::Problem::TestCaseV2>]
          @testcases = testcases
          # @type [Boolean]
          @is_public = is_public
          @_field_set = {
