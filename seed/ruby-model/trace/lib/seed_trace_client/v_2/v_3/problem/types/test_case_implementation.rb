    ...
    module V3
      class Problem
        class TestCaseImplementation
          attr_reader :description, :function, :additional_properties, :_field_set
          ...
          def initialize(description:, function:, additional_properties: nil)
            # @type [SeedTraceClient::V2::V3::Problem::TestCaseImplementationDescription]
            @description = description
            # @type [SeedTraceClient::V2::V3::Problem::TestCaseFunction]
            @function = function
            @_field_set = { "description": @description, "function": @function }.reject do |_k, v|
              v == OMIT
            end
          end
