...
module SeedTraceClient
  module V2
    module V3
      class Problem
        class Files
          # @return [Array<SeedTraceClient::V2::V3::Problem::FileInfoV2>]
          attr_reader :files
          ...
          # @param files [Array<SeedTraceClient::V2::V3::Problem::FileInfoV2>]
          # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
          # @return [SeedTraceClient::V2::V3::Problem::Files]
          ...
          def self.from_json(json_object:)
            ...
            files = parsed_json["files"]&.map do |item|
              item = item.to_json
              SeedTraceClient::V2::V3::Problem::FileInfoV2.from_json(json_object: item)
            end
