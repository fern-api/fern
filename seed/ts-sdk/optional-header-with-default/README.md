...
[![npm shield](https://img.shields.io/npm/v/@fern/optional-header-with-default)](https://www.npmjs.com/package/@fern/optional-header-with-default)
...
```sh
npm i -s @fern/optional-header-with-default
```
...
```typescript
import { SeedApiClient, SeedApiEnvironment } from "@fern/optional-header-with-default";
...
```typescript
import { SeedApiError } from "@fern/optional-header-with-default";
...
```typescript
const { data, rawResponse } = await client.listItems(...).withRawResponse();
...
```typescript
import { SeedApiClient, logging } from "@fern/optional-header-with-default";
