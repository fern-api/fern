...
export function normalizeClientOptions<T extends BaseClientOptions = BaseClientOptions>(
    ...
    const headers = mergeHeaders(
        { "X-Fern-Language": "JavaScript", "X-Fern-SDK-Name": "@fern/literal-user-agent", "X-Fern-SDK-Version": "0.0.1", "User-Agent": "@fern/literal-user-agent/0.0.1", "X-Fern-Runtime": core.RUNTIME.type, "X-Fern-Runtime-Version": core.RUNTIME.version, "user-agent": options?.userAgent ?? "my-sdk" },
        options?.headers
    );
