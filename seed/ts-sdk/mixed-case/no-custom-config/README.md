...
[![npm shield](https://img.shields.io/npm/v/@fern/mixed-case)](https://www.npmjs.com/package/@fern/mixed-case)
...
const client = new SeedMixedCaseClient({ baseUrl: "YOUR_BASE_URL" });
...
```typescript
import { ServiceClient } from '@fern/mixed-case/service';
