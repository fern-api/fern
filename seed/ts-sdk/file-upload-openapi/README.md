...
[![npm shield](https://img.shields.io/npm/v/@fern/file-upload-openapi)](https://www.npmjs.com/package/@fern/file-upload-openapi)
...
```sh
npm i -s @fern/file-upload-openapi
```
...
```typescript
import { SeedApi } from "@fern/file-upload-openapi";

const request: SeedApi.UploadFileRequest = {
    ...
};
```
...
```typescript
import { SeedApiError } from "@fern/file-upload-openapi";
...
```typescript
import { FileUploadExampleClient } from '@fern/file-upload-openapi/fileUploadExample';

const client = new FileUploadExampleClient({...});
```
...
```typescript
const { data, rawResponse } = await client.fileUploadExample.uploadFile(...).withRawResponse();
...
```typescript
import { SeedApiClient, logging } from "@fern/file-upload-openapi";
