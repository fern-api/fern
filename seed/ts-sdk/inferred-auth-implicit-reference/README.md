...
[![npm shield](https://img.shields.io/npm/v/@fern/inferred-auth-implicit-reference)](https://www.npmjs.com/package/@fern/inferred-auth-implicit-reference)
...
```sh
npm i -s @fern/inferred-auth-implicit-reference
```
...
```typescript
import { SeedApiClient } from "@fern/inferred-auth-implicit-reference";
...
```typescript
import { SeedApi } from "@fern/inferred-auth-implicit-reference";
...
```typescript
import { SeedApiError } from "@fern/inferred-auth-implicit-reference";
...
```typescript
import { AuthClient } from '@fern/inferred-auth-implicit-reference/auth';
...
```typescript
import { SeedApiClient, logging } from "@fern/inferred-auth-implicit-reference";
