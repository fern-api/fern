...
export class InferredAuthProvider implements core.AuthProvider {
    ...
    public static canCreate(options: Partial<InferredAuthProvider.Options>): boolean {
        return options?.clientId != null && options?.clientSecret != null && options?.audience != null && options?.grantType != null;
    }
...
export namespace InferredAuthProvider {
    ...
    export const AUTH_CONFIG_ERROR_MESSAGE: string = "Please provide clientId and clientSecret and audience and grantType when initializing the client" as const;
