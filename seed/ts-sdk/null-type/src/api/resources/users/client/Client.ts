...
export class UsersClient {
     ...
     *     })
     */
    public get(request: SeedApi.GetUsersRequest, requestOptions?: UsersClient.RequestOptions): core.HttpResponsePromise<SeedApi.User> {
        return core.HttpResponsePromise.fromPromise(this.__get(request, requestOptions));
    }

    private async __get(request: SeedApi.GetUsersRequest, requestOptions?: UsersClient.RequestOptions): Promise<core.WithRawResponse<SeedApi.User>> {
        const { id } = request;
