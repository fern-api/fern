...
[![npm shield](https://img.shields.io/npm/v/@fern/null-type)](https://www.npmjs.com/package/@fern/null-type)
...
```typescript
import { ConversationsClient } from '@fern/null-type/conversations';
...
```typescript
import { SeedApiClient, logging } from "@fern/null-type";
