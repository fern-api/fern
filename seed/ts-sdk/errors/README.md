...
[![npm shield](https://img.shields.io/npm/v/@fern/errors)](https://www.npmjs.com/package/@fern/errors)
...
```typescript
import { SeedApiClient } from "@fern/errors";
...
```typescript
import { SeedApiError } from "@fern/errors";
...
```typescript
import { SimpleClient } from '@fern/errors/simple';
...
```typescript
import { SeedApiClient, logging } from "@fern/errors";
