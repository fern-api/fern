...
export class SeedLicenseClient {
    ...
    private async __get(requestOptions?: SeedLicenseClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "/"),
            method: "GET",
            headers: _headers,
        ...
        switch (_response.error.reason) {
            case "non-json": throw new errors.SeedLicenseError({
                statusCode: _response.error.statusCode,
                body: _response.error.rawBody,
                rawResponse: _response.rawResponse
            });
            case "timeout": throw new errors.SeedLicenseTimeoutError("Timeout exceeded when calling GET /.");
            case "unknown": throw new errors.SeedLicenseError({
