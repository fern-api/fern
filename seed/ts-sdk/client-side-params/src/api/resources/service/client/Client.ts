...
export class Service {
    ...
    private async __listResources(
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedClientSideParams.Resource[],
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedClientSideParamsTimeoutError(
                    "Timeout exceeded when calling GET /api/resources.",
                );
            case "unknown":
                throw new errors.SeedClientSideParamsError({
    ...
    public getResource(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getResource(resourceId, request, requestOptions),
        );
    }
    ...
    public searchResources(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__searchResources(request, requestOptions),
        );
    }
    ...
    private async __searchResources(
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedClientSideParams.SearchResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __listUsers(
        ...
        core.WithRawResponse<SeedClientSideParams.PaginatedUserResponse>
    > {
        const {
            page,
            per_page: perPage,
    ...
    public getUserById(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getUserById(userId, request, requestOptions),
        );
    }
    ...
    private async __getUserById(
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedClientSideParams.User,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    public listConnections(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__listConnections(request, requestOptions),
        );
    }
    ...
    private async __listConnections(
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedClientSideParams.Connection[],
                rawResponse: _response.rawResponse,
            };
        }
    ...
    public getConnection(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getConnection(connectionId, request, requestOptions),
        );
    }
    ...
    public listClients(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__listClients(request, requestOptions),
        );
    }
    ...
    private async __listClients(
        ...
        core.WithRawResponse<SeedClientSideParams.PaginatedClientResponse>
    > {
        const {
            fields,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedClientSideParamsTimeoutError(
                    "Timeout exceeded when calling GET /api/clients.",
                );
            case "unknown":
                throw new errors.SeedClientSideParamsError({
                    message: _response.error.errorMessage,
    ...
    public getClient(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getClient(clientId, request, requestOptions),
        );
    }
    ...
    private async __getClient(
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedClientSideParams.Client,
                rawResponse: _response.rawResponse,
            };
        }
