...
[![npm shield](https://img.shields.io/npm/v/@fern/no-environment)](https://www.npmjs.com/package/@fern/no-environment)
...
const seedNoEnvironment = new SeedNoEnvironmentClient({ token: "YOUR_TOKEN" });
...
```typescript
const response = await seedNoEnvironment.getDummy(..., {
