...
export class DummyClient {
    ...
    private async __getDummy(requestOptions?: DummyClient.RequestOptions): Promise<core.WithRawResponse<string>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? (await core.Supplier.get(this._options.environment) ?? environments.SeedSingleUrlEnvironmentDefaultEnvironment.Production), "dummy"),
            method: "GET",
            headers: _headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout": throw new errors.SeedSingleUrlEnvironmentDefaultTimeoutError("Timeout exceeded when calling GET /dummy.");
