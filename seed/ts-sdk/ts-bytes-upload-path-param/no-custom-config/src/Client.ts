...
export declare namespace SeedTsBytesUploadPathParamClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class SeedTsBytesUploadPathParamClient {
    protected readonly _options: NormalizedClientOptions<SeedTsBytesUploadPathParamClient.Options>;
    protected _service: ServiceClient | undefined;

    constructor(options: SeedTsBytesUploadPathParamClient.Options) {
