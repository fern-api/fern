...
[![npm shield](https://img.shields.io/npm/v/@fern/nullable-allof-extends)](https://www.npmjs.com/package/@fern/nullable-allof-extends)
...
```sh
npm i -s @fern/nullable-allof-extends
```
...
```typescript
import { SeedApiClient, SeedApiEnvironment } from "@fern/nullable-allof-extends";
...
```typescript
import { SeedApiError } from "@fern/nullable-allof-extends";
...
```typescript
const { data, rawResponse } = await client.createTest(...).withRawResponse();
...
```typescript
import { SeedApiClient, logging } from "@fern/nullable-allof-extends";
