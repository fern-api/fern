...
export class UserClient {
    ...
    private async __getWithAnyAuth(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/users/any-auth");
    }
    ...
    private async __getWithAllAuth(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/users/all-auth");
    }
}
