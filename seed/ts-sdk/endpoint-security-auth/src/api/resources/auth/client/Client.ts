...
export class AuthClient {
     ...
     *     })
     */
    public getToken(request: SeedEndpointSecurityAuth.GetTokenRequest, requestOptions?: AuthClient.RequestOptions): core.HttpResponsePromise<SeedEndpointSecurityAuth.TokenResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getToken(request, requestOptions));
    }

    private async __getToken(request: SeedEndpointSecurityAuth.GetTokenRequest, requestOptions?: AuthClient.RequestOptions): Promise<core.WithRawResponse<SeedEndpointSecurityAuth.TokenResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedEndpointSecurityAuth.TokenResponse, rawResponse: _response.rawResponse };
        }
