...
export namespace RoutingAuthProvider {
    ...
    export type AuthOptions<TAuthProviders extends readonly any[]> = Partial<
        UnionToIntersection<TAuthProviders[number]>
    >;
    ...
    export function createInstance(
        ...
        authProviderClasses: InstantiatableAuthProviderWithScheme[],
    ): core.AuthProvider {
