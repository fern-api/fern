...
export class TypesClient {
     ...
     */
    public get(id: string, requestOptions?: TypesClient.RequestOptions): core.HttpResponsePromise<SeedUnions.UnionWithTime> {
        return core.HttpResponsePromise.fromPromise(this.__get(id, requestOptions));
    }

    private async __get(id: string, requestOptions?: TypesClient.RequestOptions): Promise<core.WithRawResponse<SeedUnions.UnionWithTime>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `/time/${core.url.encodePathParam(id)}`),
            method: "GET",
            headers: _headers,
     ...
     *     })
     */
    public update(request: SeedUnions.UnionWithTime, requestOptions?: TypesClient.RequestOptions): core.HttpResponsePromise<boolean> {
        return core.HttpResponsePromise.fromPromise(this.__update(request, requestOptions));
    }

    private async __update(request: SeedUnions.UnionWithTime, requestOptions?: TypesClient.RequestOptions): Promise<core.WithRawResponse<boolean>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "/time"),
            method: "PATCH",
            headers: _headers,
