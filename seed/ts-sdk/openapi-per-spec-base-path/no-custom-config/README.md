...
[![npm shield](https://img.shields.io/npm/v/@fern/openapi-per-spec-base-path)](https://www.npmjs.com/package/@fern/openapi-per-spec-base-path)
...
```sh
npm i -s @fern/openapi-per-spec-base-path
```
...
```typescript
import { SeedApiClient } from "@fern/openapi-per-spec-base-path";
...
```typescript
import { SeedApi } from "@fern/openapi-per-spec-base-path";
...
```typescript
import { SeedApiError } from "@fern/openapi-per-spec-base-path";
...
```typescript
import { OauthClient } from '@fern/openapi-per-spec-base-path/oauth';
...
```typescript
import { SeedApiClient, logging } from "@fern/openapi-per-spec-base-path";
