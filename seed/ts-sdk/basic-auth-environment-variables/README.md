...
const client = new SeedBasicAuthEnvironmentVariablesClient({ baseUrl: "YOUR_BASE_URL", username: "YOUR_USERNAME", accessToken: "YOUR_PASSWORD" });
...
```typescript
import { BasicAuthClient } from '@fern/basic-auth-environment-variables/basicAuth';
...
```typescript
import { SeedBasicAuthEnvironmentVariablesClient, logging } from "@fern/basic-auth-environment-variables";
