...
```typescript
import { SeedApiClient } from "@fern/basic-auth-environment-variables";
...
```typescript
import { SeedApiError } from "@fern/basic-auth-environment-variables";
...
```typescript
import { SeedApiClient, logging } from "@fern/basic-auth-environment-variables";
