...
[![npm shield](https://img.shields.io/npm/v/@fern/multiple-request-bodies)](https://www.npmjs.com/package/@fern/multiple-request-bodies)
...
```sh
npm i -s @fern/multiple-request-bodies
```
...
```typescript
import { SeedApiClient, SeedApiEnvironment } from "@fern/multiple-request-bodies";
...
```typescript
import { SeedApiClient, logging } from "@fern/multiple-request-bodies";
