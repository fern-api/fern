...
[![npm shield](https://img.shields.io/npm/v/@fern/basic-auth)](https://www.npmjs.com/package/@fern/basic-auth)
...
const client = new SeedBasicAuthClient({ baseUrl: "YOUR_BASE_URL", username: "YOUR_USERNAME", password: "YOUR_PASSWORD" });
