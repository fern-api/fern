...
export class Dataservice {
     ...
     */
    public async foo(requestOptions?: Dataservice.RequestOptions): Promise<Record<string, unknown>> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.SeedApiEnvironment.Default,
                "foo"
            ),
            method: "POST",
            headers: {
        ...
        if (_response.ok) {
            return serializers.dataservice.foo.Response.parseOrThrow(_response.body, {
