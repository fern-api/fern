...
export namespace InferredAuthProvider {
    ...
    export const AUTH_CONFIG_ERROR_MESSAGE: string = "Please provide clientId and clientSecret when initializing the client" as const;
    export type AuthOptions = {
                [WRAPPER_PROPERTY]: { clientId: core.Supplier<string> | undefined; clientSecret: core.Supplier<string> | undefined };
            };
