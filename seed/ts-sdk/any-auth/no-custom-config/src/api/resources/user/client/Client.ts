...
export class User {
    ...
    ): core.HttpResponsePromise<SeedAnyAuth.User[]> {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedAnyAuth.User[],
    ...
    public getAdmins(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getAdmins(requestOptions),
        );
    }
    ...
    private async __getAdmins(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedAnyAuthTimeoutError(
                    "Timeout exceeded when calling GET /admins.",
                );
            case "unknown":
                throw new errors.SeedAnyAuthError({
                    message: _response.error.errorMessage,
