...
import { DiscriminatedUnionAuthProvider } from "./auth/DiscriminatedUnionAuthProvider.js";
...
} & DiscriminatedUnionAuthProvider.AuthOptions;
...
export function normalizeClientOptionsWithAuth<T extends BaseClientOptions>(
    ...
    const _normalizedWithNoOpAuthProvider = withNoOpAuthProvider(normalized);
    normalized.authProvider ??= new DiscriminatedUnionAuthProvider(options.auth);
    return normalized;
}
