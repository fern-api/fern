...
export class Auth {
  ...
  public getToken(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__getToken(request, requestOptions),
    );
  }
  ...
  private async __getToken(
    ...
    if (_response.ok) {
      return {
        data: _response.body as SeedAnyAuth.TokenResponse,
  ...
  protected async _getAuthorizationHeader(
    ...
    const bearer = await core.EndpointSupplier.get(this._options.token, {
      endpointMetadata,
    });
    if (bearer != null) {
  ...
  protected async _getCustomAuthorizationHeaders(
    ...
    const apiKeyValue =
      (await core.EndpointSupplier.get(this._options.apiKey, {
        endpointMetadata,
