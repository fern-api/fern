...
export class SeedApiClient {
     ...
     */
    public bulkUpdateTasks(request: SeedApi.BulkUpdateTasksRequest = {}, requestOptions?: SeedApiClient.RequestOptions): core.HttpResponsePromise<SeedApi.BulkUpdateTasksResponse> {
        return core.HttpResponsePromise.fromPromise(this.__bulkUpdateTasks(request, requestOptions));
    }

    private async __bulkUpdateTasks(request: SeedApi.BulkUpdateTasksRequest = {}, requestOptions?: SeedApiClient.RequestOptions): Promise<core.WithRawResponse<SeedApi.BulkUpdateTasksResponse>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "task/"),
            method: "PUT",
            headers: _headers,
