...
```typescript
import { SeedApiClient } from "@fern/oauth-client-credentials-with-variables";
...
```typescript
import { SeedApi } from "@fern/oauth-client-credentials-with-variables";
...
```typescript
import { SeedApiError } from "@fern/oauth-client-credentials-with-variables";
...
```typescript
import { AuthClient } from '@fern/oauth-client-credentials-with-variables/auth';
...
```typescript
import { SeedApiClient, logging } from "@fern/oauth-client-credentials-with-variables";
