...
export class ServiceClient {
    ...
    private async __post(requestOptions?: ServiceClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `/service/${core.url.encodePathParam(this._options.rootVariable)}`),
            method: "POST",
            headers: _headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout": throw new errors.SeedOauthClientCredentialsWithVariablesTimeoutError("Timeout exceeded when calling POST /service/{endpointParam}.");
