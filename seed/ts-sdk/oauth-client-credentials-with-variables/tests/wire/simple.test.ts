...
describe("SimpleClient", () => {
    ...
    test("getSomething", async () => {
        ...
        const client = new SeedOauthClientCredentialsWithVariablesClient({ "maxRetries" : 0 , "rootVariable" : "rootVariable" , "clientId" : "client_id" , "clientSecret" : "client_secret" , "environment" : server.baseUrl });
