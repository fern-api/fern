...
describe("ServiceClient", () => {
    ...
    test("post", async () => {
        ...
        const client = new SeedOauthClientCredentialsWithVariablesClient({ "rootVariable" : "endpointParam" , "clientId" : "client_id" , "clientSecret" : "client_secret" , "environment" : server.baseUrl });
