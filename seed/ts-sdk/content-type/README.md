...
[![npm shield](https://img.shields.io/npm/v/@fern/content-type)](https://www.npmjs.com/package/@fern/content-type)
...
```typescript
import { ServiceClient } from '@fern/content-type/service';
...
```typescript
const { data, rawResponse } = await client.service.patch(...).withRawResponse();
