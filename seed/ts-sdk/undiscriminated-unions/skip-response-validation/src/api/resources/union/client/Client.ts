...
export class Union {
    ...
    public async get(request: SeedUndiscriminatedUnions.MyUnion, requestOptions?: Union.RequestOptions): Promise<SeedUndiscriminatedUnions.MyUnion> {
        ...
        if (_response.ok) {
            return serializers.MyUnion.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] });
        }
    ...
    public async getMetadata(requestOptions?: Union.RequestOptions): Promise<SeedUndiscriminatedUnions.Metadata> {
        ...
        if (_response.ok) {
            return serializers.Metadata.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] });
        }
