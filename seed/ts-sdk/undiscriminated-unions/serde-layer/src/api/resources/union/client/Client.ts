...
export class UnionClient {
    ...
    private async __get(
        ...
        const _response = await core.fetcher({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.MyUnion.jsonOrThrow(request, { unrecognizedObjectKeys: "strip", omitUndefined: true }),
    ...
    private async __updateMetadata(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.MetadataUnion.jsonOrThrow(request, {
    ...
    private async __call(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.Request.jsonOrThrow(request, { unrecognizedObjectKeys: "strip", omitUndefined: true }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
    ...
    private async __duplicateTypesUnion(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.UnionWithDuplicateTypes.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
                requestOptions?.additionalBodyParameters,
        ...
        if (_response.ok) {
            return {
                data: serializers.UnionWithDuplicateTypes.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __nestedUnions(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.NestedUnionRoot.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
                requestOptions?.additionalBodyParameters,
        ...
        if (_response.ok) {
            return {
                data: serializers.union.nestedUnions.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __nestedObjectUnions(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.OuterNestedUnion.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
                requestOptions?.additionalBodyParameters,
        ...
        if (_response.ok) {
            return {
                data: serializers.union.nestedObjectUnions.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __aliasedObjectUnion(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.AliasedObjectUnion.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
                requestOptions?.additionalBodyParameters,
        ...
        if (_response.ok) {
            return {
                data: serializers.union.aliasedObjectUnion.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getWithBaseProperties(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.UnionWithBaseProperties.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
                requestOptions?.additionalBodyParameters,
        ...
        if (_response.ok) {
            return {
                data: serializers.UnionWithBaseProperties.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __testCamelCaseProperties(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.PaymentRequest.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
                requestOptions?.additionalBodyParameters,
        ...
        if (_response.ok) {
            return {
                data: serializers.union.testCamelCaseProperties.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
