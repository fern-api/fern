...
export class UnionClient {
     ...
     */
    public nestedObjectUnions(request: SeedUndiscriminatedUnions.OuterNestedUnion, requestOptions?: UnionClient.RequestOptions): core.HttpResponsePromise<string> {
        return core.HttpResponsePromise.fromPromise(this.__nestedObjectUnions(request, requestOptions));
    }

    private async __nestedObjectUnions(request: SeedUndiscriminatedUnions.OuterNestedUnion, requestOptions?: UnionClient.RequestOptions): Promise<core.WithRawResponse<string>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "/nested-objects"),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
     ...
     *     })
     */
    public aliasedObjectUnion(request: SeedUndiscriminatedUnions.AliasedObjectUnion, requestOptions?: UnionClient.RequestOptions): core.HttpResponsePromise<string> {
        return core.HttpResponsePromise.fromPromise(this.__aliasedObjectUnion(request, requestOptions));
    }

    private async __aliasedObjectUnion(request: SeedUndiscriminatedUnions.AliasedObjectUnion, requestOptions?: UnionClient.RequestOptions): Promise<core.WithRawResponse<string>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "/aliased-object"),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
     ...
     *     })
     */
    public getWithBaseProperties(request: SeedUndiscriminatedUnions.UnionWithBaseProperties, requestOptions?: UnionClient.RequestOptions): core.HttpResponsePromise<SeedUndiscriminatedUnions.UnionWithBaseProperties> {
        return core.HttpResponsePromise.fromPromise(this.__getWithBaseProperties(request, requestOptions));
    }

    private async __getWithBaseProperties(request: SeedUndiscriminatedUnions.UnionWithBaseProperties, requestOptions?: UnionClient.RequestOptions): Promise<core.WithRawResponse<SeedUndiscriminatedUnions.UnionWithBaseProperties>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "/with-base-properties"),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
        ...
        if (_response.ok) {
            return { data: _response.body as SeedUndiscriminatedUnions.UnionWithBaseProperties, rawResponse: _response.rawResponse };
        }
