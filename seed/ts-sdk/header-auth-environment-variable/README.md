...
[![npm shield](https://img.shields.io/npm/v/@fern/header-auth-environment-variable)](https://www.npmjs.com/package/@fern/header-auth-environment-variable)
...
```sh
npm i -s @fern/header-auth-environment-variable
```
...
const client = new SeedHeaderTokenEnvironmentVariableClient({ baseUrl: "YOUR_BASE_URL", headerTokenAuth: "YOUR_HEADER_VALUE" });
...
```typescript
import { ServiceClient } from '@fern/header-auth-environment-variable/service';
