...
export class CustomAuth {
     ...
     */
    public getWithCustomAuth(
        requestOptions?: CustomAuth.RequestOptions,
    ): core.HttpResponsePromise<boolean> {
        return core.HttpResponsePromise.fromPromise(
            this.__getWithCustomAuth(requestOptions),
        );
    }
            ...
            switch (_response.error.statusCode) {
                case 401:
                    throw new SeedCustomAuth.UnauthorizedRequest(
                        _response.error
                            .body as SeedCustomAuth.UnauthorizedRequestErrorBody,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedCustomAuthTimeoutError(
                    "Timeout exceeded when calling GET /custom-auth.",
                );
            case "unknown":
                throw new errors.SeedCustomAuthError({
    ...
    public postWithCustomAuth(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__postWithCustomAuth(request, requestOptions),
        );
    }
    ...
    private async __postWithCustomAuth(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedCustomAuthTimeoutError(
                    "Timeout exceeded when calling POST /custom-auth.",
                );
            case "unknown":
                throw new errors.SeedCustomAuthError({
                    message: _response.error.errorMessage,
    ...
    > {
        const customAuthSchemeValue = await core.Supplier.get(
            this._options.customAuthScheme,
        );
