...
[![npm shield](https://img.shields.io/npm/v/@fern/custom-auth)](https://www.npmjs.com/package/@fern/custom-auth)
...
```typescript
const { data, rawResponse } = await client.customAuth.postWithCustomAuth(...).withRawResponse();
...
```typescript
import { SeedCustomAuthClient, logging } from "@fern/custom-auth";
