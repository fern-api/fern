...
export declare namespace SeedPhpGlobalHeaderEnvClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class SeedPhpGlobalHeaderEnvClient {
    protected readonly _options: NormalizedClientOptions<SeedPhpGlobalHeaderEnvClient.Options>;
    protected _service: ServiceClient | undefined;

    constructor(options: SeedPhpGlobalHeaderEnvClient.Options) {
