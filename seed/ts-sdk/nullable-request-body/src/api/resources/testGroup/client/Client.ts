...
export class TestGroup {
    protected readonly _options: TestGroup.Options;

    constructor(_options: TestGroup.Options) {
     ...
     * @param {TestGroup.RequestOptions} requestOptions - Request-specific configuration.
     *
