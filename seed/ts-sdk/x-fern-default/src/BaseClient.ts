...
export function normalizeClientOptions<T extends BaseClientOptions = BaseClientOptions>(
    ...
    const headers = mergeHeaders(
        { "X-Fern-Language": "JavaScript", "X-Fern-SDK-Name": "@fern/x-fern-default", "X-Fern-SDK-Version": "0.0.1", "User-Agent": "@fern/x-fern-default/0.0.1", "X-Fern-Runtime": core.RUNTIME.type, "X-Fern-Runtime-Version": core.RUNTIME.version, "X-API-Version": options?.apiVersion ?? "2024-02-08" },
        options?.headers
    );
