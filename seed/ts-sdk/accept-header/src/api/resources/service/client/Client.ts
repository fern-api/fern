...
export class ServiceClient {
    ...
    private async __endpoint(requestOptions?: ServiceClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "/container/"),
            method: "DELETE",
            headers: _headers,
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 404: throw new SeedAccept.NotFoundError(_response.error.body as unknown, _response.rawResponse);
        ...
        switch (_response.error.reason) {
            ...
            case "timeout": throw new errors.SeedAcceptTimeoutError("Timeout exceeded when calling DELETE /container/.");
