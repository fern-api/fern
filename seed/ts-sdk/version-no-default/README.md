...
[![npm shield](https://img.shields.io/npm/v/@fern/version-no-default)](https://www.npmjs.com/package/@fern/version-no-default)
...
```sh
npm i -s @fern/version-no-default
```
...
```typescript
import { SeedApiClient } from "@fern/version-no-default";
...
```typescript
import { SeedApi } from "@fern/version-no-default";
...
```typescript
import { SeedApiError } from "@fern/version-no-default";
...
```typescript
import { UserClient } from '@fern/version-no-default/user';
...
```typescript
import { SeedApiClient, logging } from "@fern/version-no-default";
