...
[![npm shield](https://img.shields.io/npm/v/@fern/allof)](https://www.npmjs.com/package/@fern/allof)
...
```typescript
import { SeedApiClient, SeedApiEnvironment } from "@fern/allof";
...
```typescript
import { SeedApi } from "@fern/allof";

const request: SeedApi.SearchRuleTypesRequest = {
    ...
};
```
...
```typescript
import { SeedApiError } from "@fern/allof";
...
```typescript
const { data, rawResponse } = await client.createRule(...).withRawResponse();
...
```typescript
import { SeedApiClient, logging } from "@fern/allof";
