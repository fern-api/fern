...
describe("AuthClient", () => {
    test("getTokenWithClientCredentials", async () => {
        ...
        const response = await client.inferredAuthImplicitReference.auth.getTokenWithClientCredentials({
            client_id: "client_id",
            client_secret: "client_secret",
            audience: "https://api.example.com",
            grant_type: "client_credentials",
    ...
    test("refreshToken", async () => {
        ...
        const response = await client.inferredAuthImplicitReference.auth.refreshToken({
            client_id: "client_id",
            client_secret: "client_secret",
            refresh_token: "refresh_token",
            audience: "https://api.example.com",
