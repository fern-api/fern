...
describe("AuthClient", () => {
    test("getTokenWithClientCredentials", async () => {
        ...
        const response = await client.oauthClientCredentialsCustom.auth.getTokenWithClientCredentials({
            cid: "cid",
            csr: "csr",
            scp: "scp",
            entity_id: "entity_id",
    ...
    test("refreshToken", async () => {
        ...
        const response = await client.oauthClientCredentialsCustom.auth.refreshToken({
            client_id: "client_id",
            client_secret: "client_secret",
            refresh_token: "refresh_token",
            audience: "https://api.example.com",
