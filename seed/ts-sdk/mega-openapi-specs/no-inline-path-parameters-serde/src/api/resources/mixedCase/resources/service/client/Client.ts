...
export class ServiceClient {
     ...
     *
     * @example
     *     await client.mixedCase.service.getResource("rsc-xyz")
     */
    public getResource(
        ResourceID: string,
        request: SeedApi.mixedCase.GetResourceServiceRequest = {},
        requestOptions?: ServiceClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.mixedCase.Resource> {
    ...
    private async __getResource(
        ResourceID: string,
        _request: SeedApi.mixedCase.GetResourceServiceRequest = {},
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.mixedCase.Resource>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.mixedCase.Resource.parseOrThrow(_response.body, {
    ...
    private async __listResources(
        ...
        if (_response.ok) {
            return {
                data: serializers.mixedCase.service.listResources.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
