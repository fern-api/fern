    ...
    private async __endpoint(requestOptions?: ServiceClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 404:
                    throw new SeedApi.acceptHeader.NotFoundError(_response.error.body, _response.rawResponse);
                default:
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/container/");
    }
}
