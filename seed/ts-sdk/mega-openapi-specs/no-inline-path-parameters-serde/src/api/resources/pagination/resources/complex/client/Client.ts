...
export class ComplexClient {
     ...
     *
     * @example
     *     await client.pagination.complex.search("index", {
     *         query: {}
     *     })
     */
    public search(
    ...
    ): core.HttpResponsePromise<SeedApi.pagination.PaginatedConversationResponse> {
        return core.HttpResponsePromise.fromPromise(this.__search(index, request, requestOptions));
    }
    ...
    private async __search(
        ...
        request: SeedApi.pagination.SearchRequest,
        requestOptions?: ComplexClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.pagination.PaginatedConversationResponse>> {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.pagination.SearchRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.pagination.PaginatedConversationResponse.parseOrThrow(_response.body, {
