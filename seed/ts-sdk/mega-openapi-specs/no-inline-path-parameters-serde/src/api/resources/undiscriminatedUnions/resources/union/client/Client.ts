...
export class UnionClient {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return {
                data: serializers.undiscriminatedUnions.MyUnion.parseOrThrow(_response.body, {
    ...
    private async __getMetadata(
        ...
        if (_response.ok) {
            return {
                data: serializers.undiscriminatedUnions.Metadata.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __updateMetadata(
        ...
        if (_response.ok) {
            return {
                data: serializers.undiscriminatedUnions.union.updateMetadata.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __call(
        ...
        if (_response.ok) {
            return {
                data: serializers.undiscriminatedUnions.union.call.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __duplicateTypesUnion(
        ...
        if (_response.ok) {
            return {
                data: serializers.undiscriminatedUnions.UnionWithDuplicateTypes.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __nestedUnions(
        ...
        if (_response.ok) {
            return {
                data: serializers.undiscriminatedUnions.union.nestedUnions.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __nestedObjectUnions(
        ...
        if (_response.ok) {
            return {
                data: serializers.undiscriminatedUnions.union.nestedObjectUnions.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __aliasedObjectUnion(
        ...
        if (_response.ok) {
            return {
                data: serializers.undiscriminatedUnions.union.aliasedObjectUnion.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getWithBaseProperties(
        ...
        if (_response.ok) {
            return {
                data: serializers.undiscriminatedUnions.UnionWithBaseProperties.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __testCamelCaseProperties(
        ...
        if (_response.ok) {
            return {
                data: serializers.undiscriminatedUnions.union.testCamelCaseProperties.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
