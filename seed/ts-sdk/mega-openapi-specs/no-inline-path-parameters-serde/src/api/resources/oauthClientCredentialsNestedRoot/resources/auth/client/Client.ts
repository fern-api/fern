...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.oauthClientCredentialsNestedRoot.AuthTokenResponse> {
    ...
    private async __getToken(
        request: SeedApi.oauthClientCredentialsNestedRoot.GetTokenAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.oauthClientCredentialsNestedRoot.AuthTokenResponse>> {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.oauthClientCredentialsNestedRoot.GetTokenAuthRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.oauthClientCredentialsNestedRoot.AuthTokenResponse.parseOrThrow(_response.body, {
