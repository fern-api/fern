...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.anyAuth.TokenResponse> {
    ...
    private async __getToken(
        request: SeedApi.anyAuth.GetTokenAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.anyAuth.TokenResponse>> {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.anyAuth.GetTokenAuthRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.anyAuth.TokenResponse.parseOrThrow(_response.body, {
