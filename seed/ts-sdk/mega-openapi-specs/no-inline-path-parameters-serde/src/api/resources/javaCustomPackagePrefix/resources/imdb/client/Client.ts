...
export class ImdbClient {
    ...
    private async __createMovie(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.javaCustomPackagePrefix.CreateMovieRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.javaCustomPackagePrefix.MovieId.parseOrThrow(_response.body, {
    ...
    /**
     * @param {SeedApi.javaCustomPackagePrefix.MovieId} movieId
    ...
    private async __getMovie(
        movieId: SeedApi.javaCustomPackagePrefix.MovieId,
        _request: SeedApi.javaCustomPackagePrefix.GetMovieImdbRequest = {},
        requestOptions?: ImdbClient.RequestOptions,
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    ((await core.Supplier.get(this._options.environment)) ?? environments.SeedApiEnvironment.Production)
                        .base,
                `movies/${core.url.encodePathParam(serializers.javaCustomPackagePrefix.MovieId.jsonOrThrow(movieId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
        ...
        if (_response.ok) {
            return {
                data: serializers.javaCustomPackagePrefix.Movie.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
