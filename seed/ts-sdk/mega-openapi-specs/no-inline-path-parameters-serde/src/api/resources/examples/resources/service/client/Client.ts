...
export class ServiceClient {
    ...
    /**
     * @param {SeedApi.examples.MovieId} movieId
     * @param {SeedApi.examples.GetMovieServiceRequest} request
     * @param {ServiceClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.examples.service.getMovie("movieId")
     */
    public getMovie(
    ...
    private async __getMovie(
        movieId: SeedApi.examples.MovieId,
        _request: SeedApi.examples.GetMovieServiceRequest = {},
        requestOptions?: ServiceClient.RequestOptions,
        ...
        if (_response.ok) {
            return {
                data: serializers.examples.Movie.parseOrThrow(_response.body, {
    ...
    private async __createMovie(
        ...
        if (_response.ok) {
            return {
                data: serializers.examples.MovieId.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getMetadata(
        ...
        if (_response.ok) {
            return {
                data: serializers.examples.Metadata.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __createBigEntity(
        ...
        if (_response.ok) {
            return {
                data: serializers.examples.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
