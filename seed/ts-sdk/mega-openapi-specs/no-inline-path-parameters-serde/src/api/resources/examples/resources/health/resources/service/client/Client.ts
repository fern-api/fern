...
export class ServiceClient {
     ...
     *
     * @example
     *     await client.examples.health.service.check("id-2sdx82h")
     */
    public check(
        id: string,
    ...
    private async __check(
        id: string,
        _request: SeedApi.examples.health.CheckServiceRequest = {},
        requestOptions?: ServiceClient.RequestOptions,
    ...
    private async __ping(requestOptions?: ServiceClient.RequestOptions): Promise<core.WithRawResponse<boolean>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.examples.health.service.ping.Response.parseOrThrow(_response.body, {
