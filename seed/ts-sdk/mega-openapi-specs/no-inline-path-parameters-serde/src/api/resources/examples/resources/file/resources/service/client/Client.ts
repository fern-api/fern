...
export class ServiceClient {
     ...
     *
     * @example
     *     await client.examples.file.service.getFile("file.txt")
     */
    public getFile(
        filename: string,
    ...
    private async __getFile(
        filename: string,
        _request: SeedApi.examples.file.GetFileServiceRequest = {},
        requestOptions?: ServiceClient.RequestOptions,
        ...
        if (_response.ok) {
            return {
                data: serializers.examples.File_.parseOrThrow(_response.body, {
