...
export class ImdbClient {
    ...
    ): core.HttpResponsePromise<SeedApi.imdb.MovieId> {
    ...
    private async __createMovie(
        request: SeedApi.imdb.CreateMovieRequest,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.imdb.MovieId>> {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.imdb.CreateMovieRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.imdb.MovieId.parseOrThrow(_response.body, {
     ...
     * @deprecated
     *
     * @param {SeedApi.imdb.MovieId} movieId
    ...
    private async __getMovie(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    ((await core.Supplier.get(this._options.environment)) ?? environments.SeedApiEnvironment.Production)
                        .base,
                `movies/${core.url.encodePathParam(serializers.imdb.MovieId.jsonOrThrow(movieId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
        ...
        if (_response.ok) {
            return {
                data: serializers.imdb.Movie.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
