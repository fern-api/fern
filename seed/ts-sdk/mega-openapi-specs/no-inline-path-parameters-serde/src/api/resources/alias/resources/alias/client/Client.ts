...
export class AliasClient {
    ...
    public get(
        ...
        return core.HttpResponsePromise.fromPromise(this.__get(typeId, request, requestOptions));
    }

    private async __get(
        typeId: SeedApi.alias.TypeId,
        _request: SeedApi.alias.GetRequest = {},
        requestOptions?: AliasClient.RequestOptions,
