...
export class JavaRequiredBodyOptionalHeadersClient {
    ...
    private async __getUsers(
        ...
        if (_response.ok) {
            return {
                data: serializers.javaRequiredBodyOptionalHeaders.javaRequiredBodyOptionalHeaders.getUsers.Response.parseOrThrow(
                    _response.body,
                    {
    ...
    private async __createUser(
        ...
        if (_response.ok) {
            return {
                data: serializers.javaRequiredBodyOptionalHeaders.User.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
     ...
     *
     * @example
     *     await client.javaRequiredBodyOptionalHeaders.javaRequiredBodyOptionalHeaders.updateUser("userId", {
     *         body: {
     *             name: "name",
     *             email: "email"
     *         }
    ...
    private async __updateUser(
        ...
        const { dryRun, body: _body } = request;
        const _queryParams: Record<string, unknown> = {
            dryRun,
        };
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
