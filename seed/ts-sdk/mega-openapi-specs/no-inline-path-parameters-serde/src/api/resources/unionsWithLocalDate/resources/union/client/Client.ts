...
export class UnionClient {
     ...
     *
     * @example
     *     await client.unionsWithLocalDate.union.get("id")
     */
    public get(
        id: string,
    ...
    private async __get(
        id: string,
        _request: SeedApi.unionsWithLocalDate.GetUnionRequest = {},
        requestOptions?: UnionClient.RequestOptions,
        ...
        if (_response.ok) {
            return {
                data: serializers.unionsWithLocalDate.Shape.parseOrThrow(_response.body, {
    ...
    private async __update(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.unionsWithLocalDate.Shape.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.unionsWithLocalDate.union.update.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
