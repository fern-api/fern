...
export class AuthClient {
    ...
    private async __getTokenWithClientCredentials(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.oauthClientCredentialsWithVariables.GetTokenWithClientCredentialsAuthRequest.jsonOrThrow(
                request,
        ...
        if (_response.ok) {
            return {
                data: serializers.oauthClientCredentialsWithVariables.TokenResponse.parseOrThrow(_response.body, {
    ...
    private async __refreshToken(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.oauthClientCredentialsWithVariables.RefreshTokenAuthRequest.jsonOrThrow(request, {
