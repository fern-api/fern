...
export class UnionClient {
    ...
    private async __getAndReturnUnion(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.goDeterministicOrdering.TypesAnimal.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.TypesAnimal.parseOrThrow(_response.body, {
