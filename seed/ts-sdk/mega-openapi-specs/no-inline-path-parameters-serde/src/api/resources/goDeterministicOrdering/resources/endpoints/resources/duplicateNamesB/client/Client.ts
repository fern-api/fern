...
export class DuplicateNamesBClient {
    ...
    private async __create(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.goDeterministicOrdering.endpoints.CreateDuplicateNamesBRequest.jsonOrThrow(request, {
     ...
     *
     * @example
     *     await client.goDeterministicOrdering.endpoints.duplicateNamesB.get("id")
     */
    public get(
        id: string,
