...
export class PutClient {
     ...
     *
     * @example
     *     await client.goDeterministicOrdering.endpoints.put.add("id")
     */
    public add(
        id: string,
        request: SeedApi.goDeterministicOrdering.endpoints.AddPutRequest = {},
        requestOptions?: PutClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.goDeterministicOrdering.EndpointsPutResponse> {
        return core.HttpResponsePromise.fromPromise(this.__add(id, request, requestOptions));
    }

    private async __add(
        id: string,
        _request: SeedApi.goDeterministicOrdering.endpoints.AddPutRequest = {},
        requestOptions?: PutClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.goDeterministicOrdering.EndpointsPutResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.EndpointsPutResponse.parseOrThrow(_response.body, {
