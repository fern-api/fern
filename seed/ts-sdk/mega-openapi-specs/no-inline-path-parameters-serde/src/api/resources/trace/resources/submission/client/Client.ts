...
export class SubmissionClient {
     ...
     *
     * @param {SeedApi.trace.Language} language
    ...
    public createExecutionSession(
        ...
        return core.HttpResponsePromise.fromPromise(this.__createExecutionSession(language, request, requestOptions));
    }

    private async __createExecutionSession(
        language: SeedApi.trace.Language,
        _request: SeedApi.trace.CreateExecutionSessionSubmissionRequest = {},
        requestOptions?: SubmissionClient.RequestOptions,
        ...
        if (_response.ok) {
            return {
                data: serializers.trace.ExecutionSessionResponse.parseOrThrow(_response.body, {
    ...
    public getExecutionSession(
        ...
        return core.HttpResponsePromise.fromPromise(this.__getExecutionSession(sessionId, request, requestOptions));
    }

    private async __getExecutionSession(
        sessionId: string,
        _request: SeedApi.trace.GetExecutionSessionSubmissionRequest = {},
        requestOptions?: SubmissionClient.RequestOptions,
        ...
        if (_response.ok) {
            return {
                data: serializers.trace.submission.getExecutionSession.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    public stopExecutionSession(
        ...
        return core.HttpResponsePromise.fromPromise(this.__stopExecutionSession(sessionId, request, requestOptions));
    }

    private async __stopExecutionSession(
        sessionId: string,
        _request: SeedApi.trace.StopExecutionSessionSubmissionRequest = {},
        requestOptions?: SubmissionClient.RequestOptions,
    ...
    private async __getExecutionSessionsState(
        ...
        if (_response.ok) {
            return {
                data: serializers.trace.GetExecutionSessionStateResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
