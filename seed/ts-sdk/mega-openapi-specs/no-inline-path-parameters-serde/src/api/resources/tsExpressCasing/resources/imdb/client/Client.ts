...
export class ImdbClient {
    ...
    private async __createMovie(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.tsExpressCasing.CreateMovieImdbRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.tsExpressCasing.MovieId.parseOrThrow(_response.body, {
    ...
    /**
     * @param {SeedApi.tsExpressCasing.MovieId} movie_id
     ...
     *
     * @example
     *     await client.tsExpressCasing.imdb.getMovie("movie_id")
     */
    public getMovie(
        ...
        return core.HttpResponsePromise.fromPromise(this.__getMovie(movie_id, request, requestOptions));
    }

    private async __getMovie(
        movie_id: SeedApi.tsExpressCasing.MovieId,
        _request: SeedApi.tsExpressCasing.GetMovieImdbRequest = {},
        requestOptions?: ImdbClient.RequestOptions,
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    ((await core.Supplier.get(this._options.environment)) ?? environments.SeedApiEnvironment.Production)
                        .base,
                `movies/${core.url.encodePathParam(serializers.tsExpressCasing.MovieId.jsonOrThrow(movie_id, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
        ...
        if (_response.ok) {
            return {
                data: serializers.tsExpressCasing.Movie.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
