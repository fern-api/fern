...
export class UserClient {
    ...
    private async __getUser(
            ...
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    ((await core.Supplier.get(this._options.environment)) ?? environments.SeedApiEnvironment.Production)
                        .base,
                `users/${core.url.encodePathParam(serializers.versionNoDefault.UserId.jsonOrThrow(userId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: serializers.versionNoDefault.User.parseOrThrow(_response.body, {
