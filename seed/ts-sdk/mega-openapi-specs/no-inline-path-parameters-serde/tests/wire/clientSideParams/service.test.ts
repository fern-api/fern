...
describe("ServiceClient", () => {
    ...
    test("getResource", async () => {
        ...
        const response = await client.clientSideParams.service.getResource("resourceId", {
    ...
    test("getUserById", async () => {
        ...
        const response = await client.clientSideParams.service.getUserById("userId");
        expect(response).toEqual({
            userId: "user_id",
            email: "email",
            emailVerified: true,
    ...
    test("deleteUser", async () => {
        ...
        const response = await client.clientSideParams.service.deleteUser("userId");
    ...
    test("updateUser", async () => {
        ...
        const response = await client.clientSideParams.service.updateUser("userId");
        expect(response).toEqual({
            userId: "user_id",
            email: "email",
            emailVerified: true,
    ...
    test("getConnection", async () => {
        ...
        const response = await client.clientSideParams.service.getConnection("connectionId");
        expect(response).toEqual({
            id: "id",
            name: "name",
            displayName: "display_name",
    ...
    test("getClient", async () => {
        ...
        const response = await client.clientSideParams.service.getClient("clientId");
        expect(response).toEqual({
            clientId: "client_id",
            tenant: "tenant",
            name: "name",
