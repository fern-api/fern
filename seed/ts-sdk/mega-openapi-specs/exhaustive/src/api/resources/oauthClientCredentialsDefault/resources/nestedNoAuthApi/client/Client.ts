...
export class NestedNoAuthApiClient {
    ...
    public nestedNoAuthApiGetSomething(
        ...
        core.APIResponse<void, SeedApi.oauthClientCredentialsDefault.nestedNoAuthApi.nestedNoAuthApiGetSomething.Error>
    > {
    ...
    private async __nestedNoAuthApiGetSomething(
        ...
        core.WithRawResponse<
            core.APIResponse<
                void,
                SeedApi.oauthClientCredentialsDefault.nestedNoAuthApi.nestedNoAuthApiGetSomething.Error
            >
        >
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsDefault.nestedNoAuthApi.nestedNoAuthApiGetSomething.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
