...
export class UserClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<SeedApi.version.User, SeedApi.version.user.getUser.Error>> {
    ...
    private async __getUser(
        request: SeedApi.version.GetUserUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<SeedApi.version.User, SeedApi.version.user.getUser.Error>>> {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.version.User,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.version.user.getUser.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
