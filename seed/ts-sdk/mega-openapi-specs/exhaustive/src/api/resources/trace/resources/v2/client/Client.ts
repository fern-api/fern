...
export class V2Client {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.trace.v2.test.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__test(requestOptions));
    }

    private async __test(
        requestOptions?: V2Client.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.trace.v2.test.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.trace.v2.test.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
