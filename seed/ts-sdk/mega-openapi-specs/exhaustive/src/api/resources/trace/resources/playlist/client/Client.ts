    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.trace.Playlist,
            ...
            switch (_response.error.statusCode) {
                case 401:
                    return {
                        data: {
                            ok: false,
                            error: SeedApi.trace.playlist.getPlaylist.Error.unauthorizedError(
                ...
                case 404:
                    return {
                        data: {
                            ok: false,
                            error: SeedApi.trace.playlist.getPlaylist.Error.notFoundError(
                                _response.error.body as unknown,
                            ),
                            rawResponse: _response.rawResponse,
                        },
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.trace.Playlist | null,
                    headers: _response.headers,
                    rawResponse: _response.rawResponse,
                },
                rawResponse: _response.rawResponse,
            ...
            switch (_response.error.statusCode) {
                case 404:
                    return {
                        data: {
                            ok: false,
                            error: SeedApi.trace.playlist.updatePlaylist.Error.notFoundError(
                                _response.error.body as unknown,
                            ),
                            rawResponse: _response.rawResponse,
                        },
