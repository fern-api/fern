...
export class LicenseClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.license.license.get.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__get(requestOptions));
    }

    private async __get(
        requestOptions?: LicenseClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.license.license.get.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.license.license.get.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
