...
export class NestedNoAuthApiClient {
    ...
    public nestedNoAuthApiGetSomething(
        ...
        core.APIResponse<void, SeedApi.inferredAuthExplicit.nestedNoAuthApi.nestedNoAuthApiGetSomething.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthExplicit.nestedNoAuthApi.nestedNoAuthApiGetSomething.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
