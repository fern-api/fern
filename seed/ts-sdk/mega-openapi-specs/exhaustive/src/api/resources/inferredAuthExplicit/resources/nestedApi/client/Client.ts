...
export class NestedApiClient {
    ...
    public nestedApiGetSomething(
        ...
        core.APIResponse<void, SeedApi.inferredAuthExplicit.nestedApi.nestedApiGetSomething.Error>
    > {
    ...
    private async __nestedApiGetSomething(
        ...
        core.WithRawResponse<core.APIResponse<void, SeedApi.inferredAuthExplicit.nestedApi.nestedApiGetSomething.Error>>
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthExplicit.nestedApi.nestedApiGetSomething.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
