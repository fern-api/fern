...
export class AuthClient {
    ...
    public getTokenWithClientCredentials(
        ...
        core.APIResponse<
            SeedApi.inferredAuthExplicit.TokenResponse,
            SeedApi.inferredAuthExplicit.auth.getTokenWithClientCredentials.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.inferredAuthExplicit.TokenResponse,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthExplicit.auth.getTokenWithClientCredentials.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public refreshToken(
        ...
        core.APIResponse<
            SeedApi.inferredAuthExplicit.TokenResponse,
            SeedApi.inferredAuthExplicit.auth.refreshToken.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthExplicit.auth.refreshToken.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
