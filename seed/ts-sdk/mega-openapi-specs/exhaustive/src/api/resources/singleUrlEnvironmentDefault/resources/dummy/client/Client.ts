...
export class DummyClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<string, SeedApi.singleUrlEnvironmentDefault.dummy.getDummy.Error>> {
    ...
    private async __getDummy(
        ...
        core.WithRawResponse<core.APIResponse<string, SeedApi.singleUrlEnvironmentDefault.dummy.getDummy.Error>>
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.singleUrlEnvironmentDefault.dummy.getDummy.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
