...
export class SimpleClient {
    ...
    public getSomething(
        ...
        core.APIResponse<void, SeedApi.oauthClientCredentialsMandatoryAuth.simple.getSomething.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsMandatoryAuth.simple.getSomething.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
