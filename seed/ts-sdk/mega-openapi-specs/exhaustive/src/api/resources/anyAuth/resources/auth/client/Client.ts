...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<SeedApi.anyAuth.TokenResponse, SeedApi.anyAuth.auth.getToken.Error>> {
    ...
    private async __getToken(
        ...
        core.WithRawResponse<core.APIResponse<SeedApi.anyAuth.TokenResponse, SeedApi.anyAuth.auth.getToken.Error>>
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.anyAuth.TokenResponse,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.anyAuth.auth.getToken.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
