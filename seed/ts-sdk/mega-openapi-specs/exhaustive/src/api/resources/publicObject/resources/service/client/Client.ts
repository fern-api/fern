...
export class ServiceClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.publicObject.service.get.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__get(requestOptions));
    }

    private async __get(
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.publicObject.service.get.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.publicObject.service.get.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
