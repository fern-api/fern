...
export class AuthClient {
    ...
    public getToken(
        ...
        core.APIResponse<SeedApi.endpointSecurityAuth.TokenResponse, SeedApi.endpointSecurityAuth.auth.getToken.Error>
    > {
    ...
    private async __getToken(
        ...
        core.WithRawResponse<
            core.APIResponse<
                SeedApi.endpointSecurityAuth.TokenResponse,
                SeedApi.endpointSecurityAuth.auth.getToken.Error
            >
        >
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.endpointSecurityAuth.TokenResponse,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.endpointSecurityAuth.auth.getToken.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
