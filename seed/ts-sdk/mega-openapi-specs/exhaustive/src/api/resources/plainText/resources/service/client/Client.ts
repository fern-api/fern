...
export class ServiceClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.plainText.service.getText.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__getText(requestOptions));
    }

    private async __getText(
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.plainText.service.getText.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.plainText.service.getText.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
