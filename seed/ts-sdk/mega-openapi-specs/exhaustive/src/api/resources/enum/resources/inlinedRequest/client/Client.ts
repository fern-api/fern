...
export class InlinedRequestClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.enum_.inlinedRequest.send.Error>> {
    ...
    private async __send(
        request: SeedApi.enum_.SendInlinedRequestRequest,
        requestOptions?: InlinedRequestClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.enum_.inlinedRequest.send.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.enum_.inlinedRequest.send.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
