...
export class PlantsClient {
    ...
    public list(
        ...
        core.APIResponse<
            ...
            SeedApi.oauthClientCredentialsOpenapi.plants.list.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.oauthClientCredentialsOpenapi.Plant[],
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsOpenapi.plants.list.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public get(
        ...
        core.APIResponse<
            SeedApi.oauthClientCredentialsOpenapi.Plant,
            SeedApi.oauthClientCredentialsOpenapi.plants.get.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsOpenapi.plants.get.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
