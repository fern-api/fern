...
export class ClassClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.pythonReservedKeywordSubpackages.class_.create.Error>> {
    ...
    private async __create(
        ...
        core.WithRawResponse<core.APIResponse<void, SeedApi.pythonReservedKeywordSubpackages.class_.create.Error>>
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.pythonReservedKeywordSubpackages.class_.create.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
