...
export class AliasExtendsClient {
    ...
    public extendedInlineRequestBody(
        ...
        core.APIResponse<void, SeedApi.aliasExtends.aliasExtends.extendedInlineRequestBody.Error>
    > {
    ...
    private async __extendedInlineRequestBody(
        ...
        core.WithRawResponse<core.APIResponse<void, SeedApi.aliasExtends.aliasExtends.extendedInlineRequestBody.Error>>
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.aliasExtends.aliasExtends.extendedInlineRequestBody.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
