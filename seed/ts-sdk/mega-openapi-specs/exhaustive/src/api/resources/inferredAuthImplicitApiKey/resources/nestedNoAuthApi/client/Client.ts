...
export class NestedNoAuthApiClient {
    ...
    public nestedNoAuthApiGetSomething(
        ...
        core.APIResponse<void, SeedApi.inferredAuthImplicitApiKey.nestedNoAuthApi.nestedNoAuthApiGetSomething.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthImplicitApiKey.nestedNoAuthApi.nestedNoAuthApiGetSomething.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
