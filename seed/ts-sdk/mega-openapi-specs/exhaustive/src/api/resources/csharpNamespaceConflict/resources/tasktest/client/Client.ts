...
export class TasktestClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.csharpNamespaceConflict.tasktest.hello.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__hello(requestOptions));
    }

    private async __hello(
        requestOptions?: TasktestClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.csharpNamespaceConflict.tasktest.hello.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.csharpNamespaceConflict.tasktest.hello.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
