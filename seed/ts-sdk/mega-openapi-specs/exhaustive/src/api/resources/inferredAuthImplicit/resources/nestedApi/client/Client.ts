...
export class NestedApiClient {
    ...
    public nestedApiGetSomething(
        ...
        core.APIResponse<void, SeedApi.inferredAuthImplicit.nestedApi.nestedApiGetSomething.Error>
    > {
    ...
    private async __nestedApiGetSomething(
        ...
        core.WithRawResponse<core.APIResponse<void, SeedApi.inferredAuthImplicit.nestedApi.nestedApiGetSomething.Error>>
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthImplicit.nestedApi.nestedApiGetSomething.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
