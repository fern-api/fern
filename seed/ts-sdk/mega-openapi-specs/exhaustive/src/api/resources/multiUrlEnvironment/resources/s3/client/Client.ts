...
export class S3Client {
    ...
    ): core.HttpResponsePromise<core.APIResponse<string, SeedApi.multiUrlEnvironment.s3.getPresignedUrl.Error>> {
    ...
    private async __getPresignedUrl(
        request: SeedApi.multiUrlEnvironment.GetPresignedUrlS3Request,
        requestOptions?: S3Client.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<string, SeedApi.multiUrlEnvironment.s3.getPresignedUrl.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.multiUrlEnvironment.s3.getPresignedUrl.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
