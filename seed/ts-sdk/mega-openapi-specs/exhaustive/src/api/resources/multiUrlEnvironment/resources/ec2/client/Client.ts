...
export class Ec2Client {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.multiUrlEnvironment.ec2.bootInstance.Error>> {
    ...
    private async __bootInstance(
        request: SeedApi.multiUrlEnvironment.BootInstanceEc2Request,
        requestOptions?: Ec2Client.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.multiUrlEnvironment.ec2.bootInstance.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.multiUrlEnvironment.ec2.bootInstance.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
