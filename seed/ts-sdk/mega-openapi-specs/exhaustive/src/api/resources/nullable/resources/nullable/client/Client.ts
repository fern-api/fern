...
export class NullableClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<SeedApi.nullable.User[], SeedApi.nullable.nullable.getUsers.Error>> {
    ...
    private async __getUsers(
        ...
        core.WithRawResponse<core.APIResponse<SeedApi.nullable.User[], SeedApi.nullable.nullable.getUsers.Error>>
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.nullable.User[],
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.nullable.nullable.getUsers.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public createUser(
        ...
        requestOptions?: NullableClient.RequestOptions,
    ): core.HttpResponsePromise<core.APIResponse<SeedApi.nullable.User, SeedApi.nullable.nullable.createUser.Error>> {
    ...
    private async __createUser(
        ...
        core.WithRawResponse<core.APIResponse<SeedApi.nullable.User, SeedApi.nullable.nullable.createUser.Error>>
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.nullable.nullable.createUser.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public deleteUser(
        ...
        requestOptions?: NullableClient.RequestOptions,
    ): core.HttpResponsePromise<core.APIResponse<boolean, SeedApi.nullable.nullable.deleteUser.Error>> {
    ...
    private async __deleteUser(
        request: SeedApi.nullable.DeleteUserNullableRequest = {},
        requestOptions?: NullableClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<boolean, SeedApi.nullable.nullable.deleteUser.Error>>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.nullable.nullable.deleteUser.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
