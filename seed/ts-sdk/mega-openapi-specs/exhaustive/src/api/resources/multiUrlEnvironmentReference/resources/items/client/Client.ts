...
export class ItemsClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<string, SeedApi.multiUrlEnvironmentReference.items.listItems.Error>> {
    ...
    private async __listItems(
        ...
        core.WithRawResponse<core.APIResponse<string, SeedApi.multiUrlEnvironmentReference.items.listItems.Error>>
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.multiUrlEnvironmentReference.items.listItems.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
