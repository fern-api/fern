...
export class NestedApiClient {
    ...
    public nestedApiGetSomething(
        ...
        core.APIResponse<void, SeedApi.inferredAuthImplicitReference.nestedApi.nestedApiGetSomething.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthImplicitReference.nestedApi.nestedApiGetSomething.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
