...
export class AuthClient {
    ...
    public getTokenWithClientCredentials(
        ...
        core.APIResponse<
            SeedApi.inferredAuthImplicitReference.TokenResponse,
            SeedApi.inferredAuthImplicitReference.auth.getTokenWithClientCredentials.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.inferredAuthImplicitReference.TokenResponse,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthImplicitReference.auth.getTokenWithClientCredentials.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
     ...
     */
    public refreshToken(
        request: SeedApi.inferredAuthImplicitReference.RefreshTokenRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): core.HttpResponsePromise<
        core.APIResponse<
            SeedApi.inferredAuthImplicitReference.TokenResponse,
            SeedApi.inferredAuthImplicitReference.auth.refreshToken.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthImplicitReference.auth.refreshToken.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
