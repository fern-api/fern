...
export class NestedNoAuthApiClient {
    ...
    public nestedNoAuthApiGetSomething(
        ...
        core.APIResponse<
            void,
            SeedApi.oauthClientCredentialsNestedRoot.nestedNoAuthApi.nestedNoAuthApiGetSomething.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsNestedRoot.nestedNoAuthApi.nestedNoAuthApiGetSomething.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
