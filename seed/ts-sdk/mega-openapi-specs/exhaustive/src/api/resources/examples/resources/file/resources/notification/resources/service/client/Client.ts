...
export class ServiceClient {
    ...
    public getException(
        ...
        core.APIResponse<SeedApi.examples.Exception, SeedApi.examples.file.notification.service.getException.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.examples.Exception,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.examples.file.notification.service.getException.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
