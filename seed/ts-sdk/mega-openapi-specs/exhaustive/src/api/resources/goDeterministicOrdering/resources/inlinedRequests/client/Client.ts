...
export class InlinedRequestsClient {
    ...
    public postWithObjectBodyandResponse(
        ...
        core.APIResponse<
            ...
            SeedApi.goDeterministicOrdering.inlinedRequests.postWithObjectBodyandResponse.Error
        >
    > {
    ...
    > {
            ...
            switch (_response.error.statusCode) {
                case 400:
                    return {
                        data: {
                            ok: false,
                            error: SeedApi.goDeterministicOrdering.inlinedRequests.postWithObjectBodyandResponse.Error.badRequestError(
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.goDeterministicOrdering.inlinedRequests.postWithObjectBodyandResponse.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
