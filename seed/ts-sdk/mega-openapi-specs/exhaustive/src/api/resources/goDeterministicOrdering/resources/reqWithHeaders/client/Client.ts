...
export class ReqWithHeadersClient {
    ...
    public getWithCustomHeader(
        ...
        core.APIResponse<void, SeedApi.goDeterministicOrdering.reqWithHeaders.getWithCustomHeader.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.goDeterministicOrdering.reqWithHeaders.getWithCustomHeader.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
