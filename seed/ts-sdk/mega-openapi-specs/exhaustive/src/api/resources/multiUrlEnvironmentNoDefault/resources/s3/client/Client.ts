...
export class S3Client {
    ...
    public getPresignedUrl(
        ...
        core.APIResponse<string, SeedApi.multiUrlEnvironmentNoDefault.s3.getPresignedUrl.Error>
    > {
    ...
    private async __getPresignedUrl(
        ...
        core.WithRawResponse<core.APIResponse<string, SeedApi.multiUrlEnvironmentNoDefault.s3.getPresignedUrl.Error>>
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.multiUrlEnvironmentNoDefault.s3.getPresignedUrl.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
