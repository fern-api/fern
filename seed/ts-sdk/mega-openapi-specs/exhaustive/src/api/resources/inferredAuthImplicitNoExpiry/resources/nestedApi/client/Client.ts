...
export class NestedApiClient {
    ...
    public nestedApiGetSomething(
        ...
        core.APIResponse<void, SeedApi.inferredAuthImplicitNoExpiry.nestedApi.nestedApiGetSomething.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthImplicitNoExpiry.nestedApi.nestedApiGetSomething.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
