...
export class ServiceClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.goBytesRequest.service.upload.Error>> {
    ...
    private async __upload(
        uploadable: core.file.Uploadable,
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.goBytesRequest.service.upload.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.goBytesRequest.service.upload.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
