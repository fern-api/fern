...
export class ReqWithHeadersClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.exhaustive.reqWithHeaders.getWithCustomHeader.Error>> {
    ...
    private async __getWithCustomHeader(
        ...
        core.WithRawResponse<core.APIResponse<void, SeedApi.exhaustive.reqWithHeaders.getWithCustomHeader.Error>>
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.reqWithHeaders.getWithCustomHeader.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
