...
export class ContainerClient {
    ...
    public getAndReturnListOfPrimitives(
        ...
        core.APIResponse<string[], SeedApi.exhaustive.endpoints.container.getAndReturnListOfPrimitives.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.endpoints.container.getAndReturnListOfPrimitives.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getAndReturnListOfObjects(
        ...
        core.APIResponse<
            ...
            SeedApi.exhaustive.endpoints.container.getAndReturnListOfObjects.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.endpoints.container.getAndReturnListOfObjects.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public getAndReturnSetOfPrimitives(
        ...
        core.APIResponse<string[], SeedApi.exhaustive.endpoints.container.getAndReturnSetOfPrimitives.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.endpoints.container.getAndReturnSetOfPrimitives.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getAndReturnSetOfObjects(
        ...
        core.APIResponse<
            SeedApi.exhaustive.TypesObjectWithRequiredField[],
            SeedApi.exhaustive.endpoints.container.getAndReturnSetOfObjects.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.endpoints.container.getAndReturnSetOfObjects.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public getAndReturnMapPrimToPrim(
        ...
        core.APIResponse<Record<string, string>, SeedApi.exhaustive.endpoints.container.getAndReturnMapPrimToPrim.Error>
    > {
    ...
    private async __getAndReturnMapPrimToPrim(
        ...
        core.WithRawResponse<
            core.APIResponse<
                ...
                SeedApi.exhaustive.endpoints.container.getAndReturnMapPrimToPrim.Error
            >
        >
    > {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.endpoints.container.getAndReturnMapPrimToPrim.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public getAndReturnMapOfPrimToObject(
        ...
        core.APIResponse<
            Record<string, SeedApi.exhaustive.TypesObjectWithRequiredField>,
            SeedApi.exhaustive.endpoints.container.getAndReturnMapOfPrimToObject.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as Record<string, SeedApi.exhaustive.TypesObjectWithRequiredField>,
                    headers: _response.headers,
                    rawResponse: _response.rawResponse,
                },
                rawResponse: _response.rawResponse,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.endpoints.container.getAndReturnMapOfPrimToObject.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getAndReturnMapOfPrimToUndiscriminatedUnion(
        ...
        core.APIResponse<
            Record<string, SeedApi.exhaustive.TypesMixedType>,
            SeedApi.exhaustive.endpoints.container.getAndReturnMapOfPrimToUndiscriminatedUnion.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as Record<string, SeedApi.exhaustive.TypesMixedType>,
                    headers: _response.headers,
                    rawResponse: _response.rawResponse,
                },
                rawResponse: _response.rawResponse,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.endpoints.container.getAndReturnMapOfPrimToUndiscriminatedUnion.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getAndReturnOptional(
        ...
        core.APIResponse<
            ...
            SeedApi.exhaustive.endpoints.container.getAndReturnOptional.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.exhaustive.TypesObjectWithRequiredField | null,
                    headers: _response.headers,
                    rawResponse: _response.rawResponse,
                },
                rawResponse: _response.rawResponse,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.endpoints.container.getAndReturnOptional.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
