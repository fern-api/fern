...
export class NoReqBodyClient {
    ...
    public getWithNoRequestBody(
        ...
        core.APIResponse<
            ...
            SeedApi.exhaustive.noReqBody.getWithNoRequestBody.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.noReqBody.getWithNoRequestBody.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public postWithNoRequestBody(
        requestOptions?: NoReqBodyClient.RequestOptions,
    ): core.HttpResponsePromise<core.APIResponse<string, SeedApi.exhaustive.noReqBody.postWithNoRequestBody.Error>> {
    ...
    private async __postWithNoRequestBody(
        ...
        core.WithRawResponse<core.APIResponse<string, SeedApi.exhaustive.noReqBody.postWithNoRequestBody.Error>>
    > {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.noReqBody.postWithNoRequestBody.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
