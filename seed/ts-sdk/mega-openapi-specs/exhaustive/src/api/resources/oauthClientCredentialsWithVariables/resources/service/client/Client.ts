...
export class ServiceClient {
    ...
    public post(
        ...
        core.APIResponse<void, SeedApi.oauthClientCredentialsWithVariables.service.post.Error>
    > {
    ...
    private async __post(
        ...
        core.WithRawResponse<core.APIResponse<void, SeedApi.oauthClientCredentialsWithVariables.service.post.Error>>
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsWithVariables.service.post.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
