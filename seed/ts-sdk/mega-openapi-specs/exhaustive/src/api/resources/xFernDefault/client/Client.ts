...
export class XFernDefaultClient {
    ...
    public testGet(
        ...
        core.APIResponse<SeedApi.xFernDefault.TestGetResponse, SeedApi.xFernDefault.testGet.Error>
    > {
    ...
    private async __testGet(
        ...
        core.WithRawResponse<core.APIResponse<SeedApi.xFernDefault.TestGetResponse, SeedApi.xFernDefault.testGet.Error>>
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.xFernDefault.TestGetResponse,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.xFernDefault.testGet.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
