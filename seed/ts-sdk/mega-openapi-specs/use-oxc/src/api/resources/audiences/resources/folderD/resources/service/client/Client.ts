...
export class ServiceClient {
    ...
    ): core.HttpResponsePromise<SeedApi.audiences.FolderDResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getDirectThread(requestOptions));
    }

    private async __getDirectThread(
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.audiences.FolderDResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.audiences.FolderDResponse, rawResponse: _response.rawResponse };
        }
