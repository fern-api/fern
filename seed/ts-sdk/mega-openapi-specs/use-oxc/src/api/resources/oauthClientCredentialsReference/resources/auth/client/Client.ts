...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.oauthClientCredentialsReference.TokenResponse> {
    ...
    private async __getToken(
        request: SeedApi.oauthClientCredentialsReference.GetTokenRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.oauthClientCredentialsReference.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.oauthClientCredentialsReference.TokenResponse,
