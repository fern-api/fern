...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.oauthClientCredentialsEnvironmentVariables.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: SeedApi.oauthClientCredentialsEnvironmentVariables.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.oauthClientCredentialsEnvironmentVariables.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.oauthClientCredentialsEnvironmentVariables.TokenResponse,
