...
export class EnumClient {
    ...
    ): core.HttpResponsePromise<SeedApi.exhaustive.TypesWeatherReport> {
    ...
    private async __getAndReturnEnum(
        request: SeedApi.exhaustive.TypesWeatherReport,
        requestOptions?: EnumClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.exhaustive.TypesWeatherReport>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.exhaustive.TypesWeatherReport,
