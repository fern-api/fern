...
export class FoldersClient {
     ...
     */
    public foo(requestOptions?: FoldersClient.RequestOptions): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(this.__foo(requestOptions));
    }

    private async __foo(requestOptions?: FoldersClient.RequestOptions): Promise<core.WithRawResponse<void>> {
