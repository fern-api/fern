...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.inferredAuthImplicitReference.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: SeedApi.inferredAuthImplicitReference.GetTokenRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.inferredAuthImplicitReference.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.inferredAuthImplicitReference.TokenResponse,
