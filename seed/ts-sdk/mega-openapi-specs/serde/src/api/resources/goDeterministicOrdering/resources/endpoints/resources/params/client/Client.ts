...
export class ParamsClient {
    ...
    private async __getWithPath(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.endpoints.params.getWithPath.Response.parseOrThrow(
                    _response.body,
                    {
    ...
    private async __uploadWithPath(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.TypesObjectWithRequiredField.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __modifyWithPath(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.endpoints.params.modifyWithPath.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getWithInlinePath(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.endpoints.params.getWithInlinePath.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __modifyWithInlinePath(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.endpoints.params.modifyWithInlinePath.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
