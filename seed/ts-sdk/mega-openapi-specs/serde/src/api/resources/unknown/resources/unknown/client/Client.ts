...
export class UnknownClient {
    ...
    private async __post(
        ...
        if (_response.ok) {
            return {
                data: serializers.unknown.unknown.post.Response.parseOrThrow(_response.body, {
    ...
    private async __postObject(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.unknown.MyObject.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.unknown.unknown.postObject.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
