...
export class BigunionClient {
    ...
    ): core.HttpResponsePromise<SeedApi.unionsWithLocalDate.BigUnion> {
    ...
    private async __get(
        request: SeedApi.unionsWithLocalDate.GetBigunionRequest,
        requestOptions?: BigunionClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.unionsWithLocalDate.BigUnion>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return {
                data: serializers.unionsWithLocalDate.BigUnion.parseOrThrow(_response.body, {
    ...
    private async __update(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.unionsWithLocalDate.BigUnion.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.unionsWithLocalDate.bigunion.update.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __updateMany(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.unionsWithLocalDate.bigunion.updateMany.Request.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
        ...
        if (_response.ok) {
            return {
                data: serializers.unionsWithLocalDate.bigunion.updateMany.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
