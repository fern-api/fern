...
export class ContactsClient {
    ...
    private async __create(
        ...
        if (_response.ok) {
            return {
                data: serializers.noContentResponse.contacts.create.Response.parseOrThrow(_response.body, {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return {
                data: serializers.noContentResponse.Contact.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
