...
export class ExamplesClient {
    ...
    private async __echo(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.examples.examples.echo.Request.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.examples.examples.echo.Response.parseOrThrow(_response.body, {
    ...
    private async __createType(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.examples.Type.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
        ...
        if (_response.ok) {
            return {
                data: serializers.examples.Identifier.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
