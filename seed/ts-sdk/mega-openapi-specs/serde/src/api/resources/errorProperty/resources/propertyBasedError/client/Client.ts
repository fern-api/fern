...
export class PropertyBasedErrorClient {
    ...
    private async __throwError(
        ...
        if (_response.ok) {
            return {
                data: serializers.errorProperty.propertyBasedError.throwError.Response.parseOrThrow(_response.body, {
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 400:
                    throw new SeedApi.errorProperty.BadRequestError(_response.error.body, _response.rawResponse);
                default:
