...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.endpointSecurityAuth.TokenResponse> {
    ...
    private async __getToken(
        request: SeedApi.endpointSecurityAuth.GetTokenAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.endpointSecurityAuth.TokenResponse>> {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.endpointSecurityAuth.GetTokenAuthRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.endpointSecurityAuth.TokenResponse.parseOrThrow(_response.body, {
