...
export class ServiceClient {
    ...
    ): core.HttpResponsePromise<SeedApi.rubyReservedWordProperties.Foo> {
        return core.HttpResponsePromise.fromPromise(this.__get(requestOptions));
    }

    private async __get(
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.rubyReservedWordProperties.Foo>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.rubyReservedWordProperties.Foo,
