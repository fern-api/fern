...
export class ClassClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<ClassClient.Options>;
     ...
     */
    public create(requestOptions?: ClassClient.RequestOptions): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(this.__create(requestOptions));
    }

    private async __create(requestOptions?: ClassClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/class");
    }
}
