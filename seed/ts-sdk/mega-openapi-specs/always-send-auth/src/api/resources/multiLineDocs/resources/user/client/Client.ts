...
export class UserClient {
    ...
    public createUser(
        ...
        requestOptions?: UserClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.multiLineDocs.User> {
    ...
    private async __createUser(
        request: SeedApi.multiLineDocs.CreateUserUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.multiLineDocs.User>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.multiLineDocs.User, rawResponse: _response.rawResponse };
        }
