...
export class ObjectClient {
    ...
    private async __getAndReturnWithMapOfMap(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.TypesObjectWithMapOfMap.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getAndReturnNestedWithOptionalField(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.TypesNestedObjectWithOptionalField.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getAndReturnNestedWithRequiredField(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.TypesNestedObjectWithRequiredField.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getAndReturnWithUnknownField(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.TypesObjectWithUnknownField.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getAndReturnWithDatetimeLikeString(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.TypesObjectWithDatetimeLikeString.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
