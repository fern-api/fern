...
export class BigunionClient {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return {
                data: serializers.unions.BigUnion.parseOrThrow(_response.body, {
    ...
    private async __update(
        ...
        if (_response.ok) {
            return {
                data: serializers.unions.bigunion.update.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __updateMany(
        ...
        if (_response.ok) {
            return {
                data: serializers.unions.bigunion.updateMany.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
