...
export class VendorClient {
    ...
    ): core.HttpResponsePromise<SeedApi.openapiRequestBodyRef.Vendor> {
    ...
    private async __updateVendor(
        request: SeedApi.openapiRequestBodyRef.UpdateVendorBody,
        requestOptions?: VendorClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.openapiRequestBodyRef.Vendor>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.openapiRequestBodyRef.Vendor.parseOrThrow(_response.body, {
