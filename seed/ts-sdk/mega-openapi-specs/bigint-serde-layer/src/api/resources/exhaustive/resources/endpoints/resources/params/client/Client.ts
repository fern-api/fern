...
export class ParamsClient {
    ...
    private async __getWithPath(
        ...
        if (_response.ok) {
            return {
                data: serializers.exhaustive.endpoints.params.getWithPath.Response.parseOrThrow(_response.body, {
    ...
    private async __modifyWithPath(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.exhaustive.endpoints.params.modifyWithPath.Request.jsonOrThrow(_body, {
        ...
        if (_response.ok) {
            return {
                data: serializers.exhaustive.endpoints.params.modifyWithPath.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getWithInlinePath(
        ...
        if (_response.ok) {
            return {
                data: serializers.exhaustive.endpoints.params.getWithInlinePath.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __modifyWithInlinePath(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.exhaustive.endpoints.params.modifyWithInlinePath.Request.jsonOrThrow(_body, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
        ...
        if (_response.ok) {
            return {
                data: serializers.exhaustive.endpoints.params.modifyWithInlinePath.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getWithBooleanPath(
        ...
        if (_response.ok) {
            return {
                data: serializers.exhaustive.endpoints.params.getWithBooleanPath.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getWithPathAndErrors(
        ...
        if (_response.ok) {
            return {
                data: serializers.exhaustive.endpoints.params.getWithPathAndErrors.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
