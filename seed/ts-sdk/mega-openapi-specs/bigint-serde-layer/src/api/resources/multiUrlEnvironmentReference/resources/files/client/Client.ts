...
export class FilesClient {
    ...
    private async __upload(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.multiUrlEnvironmentReference.FilesUploadRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.multiUrlEnvironmentReference.files.upload.Response.parseOrThrow(_response.body, {
