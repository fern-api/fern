...
export class CsharpInlineTypesClient {
    ...
    private async __getRoot(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.csharpInlineTypes.GetRootRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.csharpInlineTypes.RootType1.parseOrThrow(_response.body, {
    ...
    private async __getDiscriminatedUnion(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.csharpInlineTypes.GetDiscriminatedUnionRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
    ...
    private async __getUndiscriminatedUnion(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.csharpInlineTypes.GetUndiscriminatedUnionRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
