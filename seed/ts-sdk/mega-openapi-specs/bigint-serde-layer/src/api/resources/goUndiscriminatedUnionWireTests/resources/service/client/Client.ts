...
export class ServiceClient {
    ...
    private async __rerank(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.goUndiscriminatedUnionWireTests.RerankRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.goUndiscriminatedUnionWireTests.RerankResponse.parseOrThrow(_response.body, {
