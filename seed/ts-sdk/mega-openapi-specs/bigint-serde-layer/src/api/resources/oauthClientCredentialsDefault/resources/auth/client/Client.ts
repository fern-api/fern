...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.oauthClientCredentialsDefault.TokenResponse> {
    ...
    private async __getToken(
        request: SeedApi.oauthClientCredentialsDefault.GetTokenAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.oauthClientCredentialsDefault.TokenResponse>> {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.oauthClientCredentialsDefault.GetTokenAuthRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.oauthClientCredentialsDefault.TokenResponse.parseOrThrow(_response.body, {
