...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.inferredAuthImplicitNoExpiry.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: SeedApi.inferredAuthImplicitNoExpiry.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.inferredAuthImplicitNoExpiry.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.inferredAuthImplicitNoExpiry.TokenResponse.parseOrThrow(_response.body, {
