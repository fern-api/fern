...
export class OptionalClient {
    ...
    private async __sendOptionalBody(
        ...
        if (_response.ok) {
            return {
                data: serializers.optional.optional.sendOptionalBody.Response.parseOrThrow(_response.body, {
    ...
    private async __sendOptionalTypedBody(
        ...
        if (_response.ok) {
            return {
                data: serializers.optional.optional.sendOptionalTypedBody.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __sendOptionalNullableWithAllOptionalProperties(
        ...
        if (_response.ok) {
            return {
                data: serializers.optional.DeployResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
