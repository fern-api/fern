...
export class OrganizationClient {
    ...
    private async __create(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.mixedFileDirectory.CreateOrganizationRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.mixedFileDirectory.Organization.parseOrThrow(_response.body, {
