...
export const Type: core.serialization.ObjectSchema<serializers.object.Type.Raw, SeedApi.object.Type> =
    core.serialization.object({
        ...
        five: core.serialization.bigint(),
        ...
        thirteen: core.serialization.bigint().optionalNullable(),
        ...
        nineteen: Name,
        twenty: core.serialization.bigint(),
        twentyone: core.serialization.bigint(),
...
export declare namespace Type {
    export interface Raw {
        ...
        thirteen?: ((bigint | number) | null | undefined) | null;
        fourteen?: unknown;
        fifteen: number[][];
        ...
        nineteen: Name.Raw;
        twenty: bigint | number;
        twentyone: bigint | number;
        twentytwo: number;
        twentythree: number;
