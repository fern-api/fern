...
<details><summary><code>client.exhaustive.endpoints.primitive.<a href="/src/api/resources/exhaustive/resources/endpoints/resources/primitive/client/Client.ts">getAndReturnLong</a>({ ...params }) -> bigint</code></summary>
<dl>
<dd>
...
```typescript
await client.exhaustive.endpoints.primitive.getAndReturnLong(BigInt("1000000"));
...
<details><summary><code>client.exhaustive.endpoints.primitive.<a href="/src/api/resources/exhaustive/resources/endpoints/resources/primitive/client/Client.ts">getAndReturnDatetime</a>({ ...params }) -> Date</code></summary>
<dl>
<dd>
...
<details><summary><code>client.goDeterministicOrdering.endpoints.primitive.<a href="/src/api/resources/goDeterministicOrdering/resources/endpoints/resources/primitive/client/Client.ts">getAndReturnLong</a>({ ...params }) -> bigint</code></summary>
<dl>
<dd>
...
<details><summary><code>client.goDeterministicOrdering.endpoints.primitive.<a href="/src/api/resources/goDeterministicOrdering/resources/endpoints/resources/primitive/client/Client.ts">getAndReturnDatetime</a>({ ...params }) -> Date</code></summary>
<dl>
<dd>
...
```typescript
await client.goDeterministicOrdering.endpoints.primitive.getAndReturnDatetime(new Date("2024-01-15T09:30:00.000Z"));
