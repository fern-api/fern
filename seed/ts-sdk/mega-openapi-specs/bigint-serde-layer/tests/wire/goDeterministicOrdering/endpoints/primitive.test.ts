...
describe("PrimitiveClient", () => {
    ...
    test("getAndReturnLong", async () => {
        ...
        const response = await client.goDeterministicOrdering.endpoints.primitive.getAndReturnLong(BigInt("1000000"));
    ...
    test("getAndReturnDatetime", async () => {
        ...
        const response = await client.goDeterministicOrdering.endpoints.primitive.getAndReturnDatetime(
