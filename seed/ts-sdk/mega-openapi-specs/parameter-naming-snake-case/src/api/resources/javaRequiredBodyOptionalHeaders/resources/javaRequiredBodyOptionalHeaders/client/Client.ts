...
export class JavaRequiredBodyOptionalHeadersClient {
    ...
    private async __createUser(
        ...
        const { correlation_id: correlationId, body: _body } = request;
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
    ...
    private async __updateUser(
        ...
        const { user_id: userId, dry_run: dryRun, body: _body } = request;
        const _queryParams: Record<string, unknown> = {
            dryRun,
        };
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
    ...
    private async __createUserWithOptions(
        ...
        const { validate, request_id: requestId, body: _body } = request;
        const _queryParams: Record<string, unknown> = {
            validate,
        };
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
