...
export class ServiceClient {
    ...
    private async __getResource(
        ...
        const { resource_id: resourceId, include_metadata: includeMetadata, format } = request;
        const _queryParams: Record<string, unknown> = {
    ...
    private async __getUserById(
        ...
        const { user_id: userId, fields, include_fields: includeFields } = request;
        const _queryParams: Record<string, unknown> = {
            fields,
    ...
    private async __getConnection(
        ...
        const { connection_id: connectionId, fields } = request;
        const _queryParams: Record<string, unknown> = {
            fields,
        };
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
    ...
    private async __getClient(
        ...
        const { client_id: clientId, fields, include_fields: includeFields } = request;
        const _queryParams: Record<string, unknown> = {
            fields,
            include_fields: includeFields,
        };
