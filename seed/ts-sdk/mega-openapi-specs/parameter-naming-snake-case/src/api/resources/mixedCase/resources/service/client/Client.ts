...
export class ServiceClient {
    ...
    private async __getResource(
        ...
        const { resource_id: resourceId } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.mixedCase.Resource, rawResponse: _response.rawResponse };
        }
    ...
    private async __listResources(
        ...
        const { page_limit: pageLimit, before_date: beforeDate } = request;
