...
export class AdminClient {
    ...
    private async __updateTestSubmissionStatus(
        ...
        const { submission_id: submissionId, body: _body } = request;
    ...
    private async __storeTracedTestCase(
        ...
        const { submission_id: submissionId, test_case_id: testCaseId, ..._body } = request;
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
    ...
    private async __storeTracedTestCaseV2(
        ...
        const { submission_id: submissionId, test_case_id: testCaseId, body: _body } = request;
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
    ...
    private async __storeTracedWorkspace(
        ...
        const { submission_id: submissionId, ..._body } = request;
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
