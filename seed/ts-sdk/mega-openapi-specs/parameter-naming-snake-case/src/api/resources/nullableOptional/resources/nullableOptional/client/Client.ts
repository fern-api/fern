...
export class NullableOptionalClient {
    ...
    private async __listUsers(
        ...
        const { limit, offset, include_deleted: includeDeleted, sort_by: sortBy } = request;
    ...
    private async __searchUsers(
        ...
        const { query, department, role, is_active: isActive } = request;
        const _queryParams: Record<string, unknown> = {
            query,
            department,
            role,
    ...
    private async __filterByRole(
        ...
        const { role, status, secondary_role: secondaryRole } = request;
        const _queryParams: Record<string, unknown> = {
