...
export class FooClient {
    ...
    ): core.HttpResponsePromise<SeedApi.crossPackageTypeNames.ImportingType> {
    ...
    private async __find(
        request: SeedApi.crossPackageTypeNames.FindFooRequest = {},
        requestOptions?: FooClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.crossPackageTypeNames.ImportingType>> {
        const { optional_string: optionalString, ..._body } = request;
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.crossPackageTypeNames.ImportingType,
