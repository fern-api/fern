...
describe("ProblemClient", () => {
    test("createProblem", async () => {
        ...
        const response = await client.trace.problem.createProblem({
            problemName: "problemName",
            problemDescription: {
                boards: [
                    {
    ...
    test("updateProblem", async () => {
        ...
        const response = await client.trace.problem.updateProblem({
            problemId: "problemId",
            body: {
                problemName: "problemName",
                problemDescription: {
    ...
    test("deleteProblem", async () => {
        ...
        const response = await client.trace.problem.deleteProblem({
            problemId: "problemId",
        });
    ...
    test("getDefaultStarterFiles", async () => {
        ...
        const response = await client.trace.problem.getDefaultStarterFiles({
            inputParams: [
                {
                    variableType: {
                        type: "integerType",
