...
export class UserClient {
     ...
     *     })
     */
    public getUsername(request: SeedApi.queryParameters.GetUsernameUserRequest, requestOptions?: UserClient.RequestOptions): core.HttpResponsePromise<SeedApi.queryParameters.User> {
        return core.HttpResponsePromise.fromPromise(this.__getUsername(request, requestOptions));
    }

    private async __getUsername(request: SeedApi.queryParameters.GetUsernameUserRequest, requestOptions?: UserClient.RequestOptions): Promise<core.WithRawResponse<SeedApi.queryParameters.User>> {
