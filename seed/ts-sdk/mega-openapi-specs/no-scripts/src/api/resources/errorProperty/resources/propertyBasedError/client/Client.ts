...
export class PropertyBasedErrorClient {
    ...
    private async __throwError(requestOptions?: PropertyBasedErrorClient.RequestOptions): Promise<core.WithRawResponse<string>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? (await core.Supplier.get(this._options.environment) ?? environments.SeedApiEnvironment.Production).base, "property-based-error"),
            method: "GET",
            headers: _headers,
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 400: throw new SeedApi.errorProperty.BadRequestError(_response.error.body as unknown, _response.rawResponse);
