...
export class UserClient {
     ...
     *     })
     */
    public list(request: SeedApi.httpHead.ListUserRequest, requestOptions?: UserClient.RequestOptions): core.HttpResponsePromise<SeedApi.httpHead.User[]> {
        return core.HttpResponsePromise.fromPromise(this.__list(request, requestOptions));
    }

    private async __list(request: SeedApi.httpHead.ListUserRequest, requestOptions?: UserClient.RequestOptions): Promise<core.WithRawResponse<SeedApi.httpHead.User[]>> {
        const { limit } = request;
