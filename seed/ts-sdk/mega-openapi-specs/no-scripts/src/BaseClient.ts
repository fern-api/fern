...
export function normalizeClientOptions<T extends BaseClientOptions = BaseClientOptions>(
    ...
    const headers = mergeHeaders(
        { "X-Fern-Language": "JavaScript", "X-Fern-SDK-Name": "@fern/mega-openapi-specs", "X-Fern-SDK-Version": "0.0.1", "User-Agent": "@fern/mega-openapi-specs/0.0.1", "X-Fern-Runtime": core.RUNTIME.type, "X-Fern-Runtime-Version": core.RUNTIME.version, "X-API-Version": options?.apiVersion ?? "2024-02-08", "X-Api-Key": options?.apiKey },
        options?.headers
    );
