...
export class ContainerClient {
    ...
    public getAndReturnMapOfPrimToObject(
        ...
        requestOptions?: ContainerClient.RequestOptions,
    ): core.HttpResponsePromise<Record<string, SeedApi.goDeterministicOrdering.TypesObjectWithRequiredField>> {
    ...
    private async __getAndReturnMapOfPrimToObject(
        request: Record<string, SeedApi.goDeterministicOrdering.TypesObjectWithRequiredField>,
        requestOptions?: ContainerClient.RequestOptions,
    ): Promise<core.WithRawResponse<Record<string, SeedApi.goDeterministicOrdering.TypesObjectWithRequiredField>>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Record<string, SeedApi.goDeterministicOrdering.TypesObjectWithRequiredField>,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    public getAndReturnMapOfPrimToUndiscriminatedUnion(
        ...
        requestOptions?: ContainerClient.RequestOptions,
    ): core.HttpResponsePromise<Record<string, SeedApi.goDeterministicOrdering.TypesMixedType>> {
    ...
    private async __getAndReturnMapOfPrimToUndiscriminatedUnion(
        request: Record<string, SeedApi.goDeterministicOrdering.TypesMixedType>,
        requestOptions?: ContainerClient.RequestOptions,
    ): Promise<core.WithRawResponse<Record<string, SeedApi.goDeterministicOrdering.TypesMixedType>>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Record<string, SeedApi.goDeterministicOrdering.TypesMixedType>,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    public getAndReturnOptional(
        ...
        requestOptions?: ContainerClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.goDeterministicOrdering.TypesObjectWithRequiredField | null> {
    ...
    private async __getAndReturnOptional(
        request: SeedApi.goDeterministicOrdering.TypesObjectWithRequiredField | null,
        requestOptions?: ContainerClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.goDeterministicOrdering.TypesObjectWithRequiredField | null>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.goDeterministicOrdering.TypesObjectWithRequiredField | null,
                rawResponse: _response.rawResponse,
            };
        }
