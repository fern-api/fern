...
export class UsersClient {
    ...
    private async __listWithUriPagination(
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.paginationUriPath.ListUsersUriPaginationResponse,
    ...
    private async __listWithPathPagination(
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.paginationUriPath.ListUsersPathPaginationResponse,
                rawResponse: _response.rawResponse,
            };
        }
