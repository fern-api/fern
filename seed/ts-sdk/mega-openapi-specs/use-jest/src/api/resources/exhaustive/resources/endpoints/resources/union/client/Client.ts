...
export class UnionClient {
    ...
    ): core.HttpResponsePromise<SeedApi.exhaustive.TypesAnimal> {
    ...
    private async __getAndReturnUnion(
        request: SeedApi.exhaustive.TypesAnimal,
        requestOptions?: UnionClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.exhaustive.TypesAnimal>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.exhaustive.TypesAnimal, rawResponse: _response.rawResponse };
        }
