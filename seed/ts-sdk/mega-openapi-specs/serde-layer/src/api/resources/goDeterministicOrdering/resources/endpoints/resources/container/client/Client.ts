...
export class ContainerClient {
    ...
    private async __getAndReturnListOfPrimitives(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.endpoints.container.getAndReturnListOfPrimitives.Response.parseOrThrow(
                    _response.body,
                    {
    ...
    private async __getAndReturnListOfObjects(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.endpoints.container.getAndReturnListOfObjects.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getAndReturnSetOfPrimitives(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.endpoints.container.getAndReturnSetOfPrimitives.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getAndReturnSetOfObjects(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.endpoints.container.getAndReturnSetOfObjects.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getAndReturnMapPrimToPrim(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.endpoints.container.getAndReturnMapPrimToPrim.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getAndReturnMapOfPrimToObject(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.endpoints.container.getAndReturnMapOfPrimToObject.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getAndReturnMapOfPrimToUndiscriminatedUnion(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.endpoints.container.getAndReturnMapOfPrimToUndiscriminatedUnion.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getAndReturnOptional(
        ...
        if (_response.ok) {
            return {
                data: serializers.goDeterministicOrdering.endpoints.container.getAndReturnOptional.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
