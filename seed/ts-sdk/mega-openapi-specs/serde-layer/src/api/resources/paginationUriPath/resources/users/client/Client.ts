...
export class UsersClient {
    ...
    ): core.HttpResponsePromise<SeedApi.paginationUriPath.ListUsersUriPaginationResponse> {
    ...
    private async __listWithUriPagination(
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.paginationUriPath.ListUsersUriPaginationResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.paginationUriPath.ListUsersUriPaginationResponse.parseOrThrow(_response.body, {
    ...
    public listWithPathPagination(
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.paginationUriPath.ListUsersPathPaginationResponse> {
    ...
    private async __listWithPathPagination(
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.paginationUriPath.ListUsersPathPaginationResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        if (_response.ok) {
            return {
                data: serializers.paginationUriPath.ListUsersPathPaginationResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
