...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.inferredAuthExplicit.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.inferredAuthExplicit.GetTokenWithClientCredentialsAuthRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.inferredAuthExplicit.TokenResponse.parseOrThrow(_response.body, {
    ...
    private async __refreshToken(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.inferredAuthExplicit.RefreshTokenAuthRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
