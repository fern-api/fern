...
export class ProblemClient {
    ...
    private async __createProblem(
        ...
        if (_response.ok) {
            return {
                data: serializers.trace.CreateProblemResponse.parseOrThrow(_response.body, {
    ...
    private async __updateProblem(
        ...
        if (_response.ok) {
            return {
                data: serializers.trace.UpdateProblemResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getDefaultStarterFiles(
        ...
        if (_response.ok) {
            return {
                data: serializers.trace.GetDefaultStarterFilesResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
