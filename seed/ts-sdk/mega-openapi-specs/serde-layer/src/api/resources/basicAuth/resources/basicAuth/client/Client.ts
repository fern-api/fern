...
export class BasicAuthClient {
    ...
    private async __getWithBasicAuth(
        ...
        if (_response.ok) {
            return {
                data: serializers.basicAuth.basicAuth.getWithBasicAuth.Response.parseOrThrow(_response.body, {
    ...
    private async __postWithBasicAuth(
        ...
        if (_response.ok) {
            return {
                data: serializers.basicAuth.basicAuth.postWithBasicAuth.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
