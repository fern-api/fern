...
export class PropertyAccessClient {
    ...
    ): core.HttpResponsePromise<SeedApi.propertyAccess.User> {
    ...
    private async __createUser(
        request: SeedApi.propertyAccess.User,
        requestOptions?: PropertyAccessClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.propertyAccess.User>> {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.propertyAccess.User.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.propertyAccess.User.parseOrThrow(_response.body, {
