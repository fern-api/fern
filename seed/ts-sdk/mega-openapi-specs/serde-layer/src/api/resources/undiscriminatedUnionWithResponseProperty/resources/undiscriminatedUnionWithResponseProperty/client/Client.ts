...
export class UndiscriminatedUnionWithResponsePropertyClient {
    ...
    private async __getUnion(
        ...
        if (_response.ok) {
            return {
                data: serializers.undiscriminatedUnionWithResponseProperty.UnionResponse.parseOrThrow(_response.body, {
    ...
    private async __listUnions(
        ...
        if (_response.ok) {
            return {
                data: serializers.undiscriminatedUnionWithResponseProperty.UnionListResponse.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
