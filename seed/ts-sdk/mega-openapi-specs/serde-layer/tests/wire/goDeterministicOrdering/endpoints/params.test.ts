...
describe("ParamsClient", () => {
    test("getWithPath", async () => {
        ...
        const response = await client.goDeterministicOrdering.endpoints.params.getWithPath({
            param: "param",
        });
    ...
    test("modifyWithPath", async () => {
        ...
        const response = await client.goDeterministicOrdering.endpoints.params.modifyWithPath({
            param: "param",
            body: "string",
        });
        expect(response).toEqual("string");
    ...
    test("getWithInlinePath", async () => {
        ...
        const response = await client.goDeterministicOrdering.endpoints.params.getWithInlinePath({
            param: "param",
        });
        expect(response).toEqual("string");
    });
    ...
    test("modifyWithInlinePath", async () => {
        ...
        const response = await client.goDeterministicOrdering.endpoints.params.modifyWithInlinePath({
            param: "param",
            body: "string",
        });
        expect(response).toEqual("string");
    ...
    test("getWithQuery", async () => {
        ...
        const response = await client.goDeterministicOrdering.endpoints.params.getWithQuery({
            query: "query",
            number: 1,
        });
    ...
    test("getWithAllowMultipleQuery", async () => {
        ...
        const response = await client.goDeterministicOrdering.endpoints.params.getWithAllowMultipleQuery({
            query: ["query"],
            number: [1],
        });
        expect(response).toEqual(undefined);
    ...
    test("getWithPathAndQuery", async () => {
        ...
        const response = await client.goDeterministicOrdering.endpoints.params.getWithPathAndQuery({
            param: "param",
            query: "query",
        });
        expect(response).toEqual(undefined);
    ...
    test("getWithInlinePathAndQuery", async () => {
        ...
        const response = await client.goDeterministicOrdering.endpoints.params.getWithInlinePathAndQuery({
            param: "param",
            query: "query",
        });
        expect(response).toEqual(undefined);
