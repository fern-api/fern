...
export const RecordingResponseNotification: core.serialization.ObjectSchema<
    serializers.trace.RecordingResponseNotification.Raw,
    SeedApi.trace.RecordingResponseNotification
> = core.serialization.object({
    ...
    tracedFile: TracedFile.optionalNullable(),
});
...
export declare namespace RecordingResponseNotification {
    export interface Raw {
        ...
        tracedFile?: (TracedFile.Raw | null | undefined) | null;
    }
}
