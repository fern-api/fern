...
export class UsersClient {
    ...
    public listWithCustomPager(
        ...
        core.APIResponse<
            ...
            SeedApi.paginationCustom.users.listWithCustomPager.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.paginationCustom.UsersListResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.paginationCustom.users.listWithCustomPager.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
