...
export class AuthClient {
    ...
    public getTokenWithClientCredentials(
        ...
        core.APIResponse<
            SeedApi.oauthClientCredentialsEnvironmentVariables.TokenResponse,
            SeedApi.oauthClientCredentialsEnvironmentVariables.auth.getTokenWithClientCredentials.Error
        >
    > {
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.oauthClientCredentialsEnvironmentVariables.GetTokenWithClientCredentialsAuthRequest.jsonOrThrow(
                request,
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.oauthClientCredentialsEnvironmentVariables.TokenResponse.parseOrThrow(
                        _response.body,
                        {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsEnvironmentVariables.auth.getTokenWithClientCredentials.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public refreshToken(
        ...
        core.APIResponse<
            SeedApi.oauthClientCredentialsEnvironmentVariables.TokenResponse,
            SeedApi.oauthClientCredentialsEnvironmentVariables.auth.refreshToken.Error
        >
    > {
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.oauthClientCredentialsEnvironmentVariables.RefreshTokenAuthRequest.jsonOrThrow(request, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsEnvironmentVariables.auth.refreshToken.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
