...
export class OptionalClient {
    ...
    private async __sendOptionalBody(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.optional.optional.sendOptionalBody.Request.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.optional.optional.sendOptionalBody.Response.parseOrThrow(_response.body, {
    ...
    private async __sendOptionalTypedBody(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.optional.optional.sendOptionalTypedBody.Request.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.optional.optional.sendOptionalTypedBody.Response.parseOrThrow(_response.body, {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
                        allowUnrecognizedEnumValues: true,
                        skipValidation: true,
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.optional.optional.sendOptionalNullableWithAllOptionalProperties.Request.jsonOrThrow(
                _body,
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.optional.DeployResponse.parseOrThrow(_response.body, {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
                        allowUnrecognizedEnumValues: true,
                        skipValidation: true,
