...
export class LiteralUserAgentClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<string, SeedApi.literalUserAgent.literalUserAgent.ping.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__ping(requestOptions));
    }

    private async __ping(
        requestOptions?: LiteralUserAgentClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<string, SeedApi.literalUserAgent.literalUserAgent.ping.Error>>> {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.literalUserAgent.literalUserAgent.ping.Response.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.literalUserAgent.literalUserAgent.ping.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
