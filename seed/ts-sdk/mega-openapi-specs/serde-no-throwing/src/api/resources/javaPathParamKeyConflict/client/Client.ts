...
export class JavaPathParamKeyConflictClient {
    ...
    public createItem(
        ...
        core.APIResponse<SeedApi.javaPathParamKeyConflict.Item, SeedApi.javaPathParamKeyConflict.createItem.Error>
    > {
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.javaPathParamKeyConflict.ItemData.jsonOrThrow(_body, {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.javaPathParamKeyConflict.Item.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.javaPathParamKeyConflict.createItem.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
