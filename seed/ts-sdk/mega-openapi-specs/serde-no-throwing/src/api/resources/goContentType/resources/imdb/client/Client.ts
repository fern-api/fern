...
export class ImdbClient {
    ...
    private async __createMovie(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.goContentType.CreateMovieRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.goContentType.imdb.createMovie.Response.parseOrThrow(_response.body, {
