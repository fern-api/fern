...
export class GoOptionalLiteralAliasClient {
    ...
    public search(
        ...
        core.APIResponse<
            ...
            SeedApi.goOptionalLiteralAlias.goOptionalLiteralAlias.search.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.goOptionalLiteralAlias.SearchResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.goOptionalLiteralAlias.goOptionalLiteralAlias.search.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
