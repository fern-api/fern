...
export class AuthClient {
    ...
    public gettoken(
        ...
        core.APIResponse<
            ...
            SeedApi.multiUrlEnvironmentReference.auth.gettoken.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.multiUrlEnvironmentReference.AuthGetTokenResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.multiUrlEnvironmentReference.auth.gettoken.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
