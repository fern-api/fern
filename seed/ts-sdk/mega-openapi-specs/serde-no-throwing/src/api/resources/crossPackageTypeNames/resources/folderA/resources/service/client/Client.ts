...
export class ServiceClient {
    ...
    public getDirectThread(
        ...
        core.APIResponse<
            ...
            SeedApi.crossPackageTypeNames.folderA.service.getDirectThread.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.crossPackageTypeNames.FolderAResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.crossPackageTypeNames.folderA.service.getDirectThread.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
