...
export class FooClient {
    ...
    public find(
        ...
        core.APIResponse<SeedApi.crossPackageTypeNames.ImportingType, SeedApi.crossPackageTypeNames.foo.find.Error>
    > {
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url
                ...
                .build(),
            requestType: "json",
            body: serializers.crossPackageTypeNames.FindFooRequest.jsonOrThrow(_body, {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.crossPackageTypeNames.ImportingType.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.crossPackageTypeNames.foo.find.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
