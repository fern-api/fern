...
export class UsersClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<SeedApi.nullType.User, SeedApi.nullType.users.get.Error>> {
    ...
    private async __get(
        request: SeedApi.nullType.GetUsersRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<SeedApi.nullType.User, SeedApi.nullType.users.get.Error>>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.nullType.User.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.nullType.users.get.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
