...
export class ExtendsClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.extends_.extends_.extendedInlineRequestBody.Error>> {
    ...
    private async __extendedInlineRequestBody(
        ...
        core.WithRawResponse<core.APIResponse<void, SeedApi.extends_.extends_.extendedInlineRequestBody.Error>>
    > {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.extends_.ExtendedInlineRequestBodyRequest.jsonOrThrow(request, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.extends_.extends_.extendedInlineRequestBody.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
