...
export class DummyClient {
    ...
    private async __generateStream(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.streaming.GenerateStreamDummyRequest.jsonOrThrow(request, {
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.streaming.GenerateDummyRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.streaming.StreamResponse.parseOrThrow(_response.body, {
