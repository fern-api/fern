...
export class NestedNoAuthApiClient {
    ...
    public nestedNoAuthApiGetSomething(
        ...
        core.APIResponse<
            void,
            SeedApi.oauthClientCredentialsWithVariables.nestedNoAuthApi.nestedNoAuthApiGetSomething.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsWithVariables.nestedNoAuthApi.nestedNoAuthApiGetSomething.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
