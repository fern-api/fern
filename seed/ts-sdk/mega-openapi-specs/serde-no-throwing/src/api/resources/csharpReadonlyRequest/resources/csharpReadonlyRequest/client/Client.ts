...
export class CsharpReadonlyRequestClient {
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.csharpReadonlyRequest.CreateVendorRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.csharpReadonlyRequest.CreateVendorResponse.parseOrThrow(_response.body, {
