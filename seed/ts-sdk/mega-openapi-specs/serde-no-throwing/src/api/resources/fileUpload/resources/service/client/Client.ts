    ...
    private async __optionalArgs(
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.fileUpload.service.optionalArgs.Response.parseOrThrow(_response.body, {
    ...
    private async __withInlineType(
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.fileUpload.service.withInlineType.Response.parseOrThrow(_response.body, {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
                        allowUnrecognizedEnumValues: true,
                        skipValidation: true,
    ...
    private async __withJsonProperty(
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.fileUpload.service.withJsonProperty.Response.parseOrThrow(_response.body, {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
                        allowUnrecognizedEnumValues: true,
                        skipValidation: true,
    ...
    private async __withRefBody(
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.fileUpload.service.withRefBody.Response.parseOrThrow(_response.body, {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
                        allowUnrecognizedEnumValues: true,
                        skipValidation: true,
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.fileUpload.service.withLiteralAndEnumTypes.Response.parseOrThrow(_response.body, {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
                        allowUnrecognizedEnumValues: true,
                        skipValidation: true,
