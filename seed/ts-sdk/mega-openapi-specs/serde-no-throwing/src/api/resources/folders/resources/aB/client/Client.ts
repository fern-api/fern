...
export class ABClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.folders.aB.aBFoo.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__aBFoo(requestOptions));
    }

    private async __aBFoo(
        requestOptions?: ABClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.folders.aB.aBFoo.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.folders.aB.aBFoo.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
