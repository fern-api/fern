...
export class HeadersClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.enum_.headers.send.Error>> {
    ...
    private async __send(
        request: SeedApi.enum_.SendHeadersRequest,
        requestOptions?: HeadersClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.enum_.headers.send.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.enum_.headers.send.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
