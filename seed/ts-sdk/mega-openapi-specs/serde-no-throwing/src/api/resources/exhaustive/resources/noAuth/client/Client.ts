...
export class NoAuthClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<boolean, SeedApi.exhaustive.noAuth.postWithNoAuth.Error>> {
    ...
    private async __postWithNoAuth(
        request?: unknown,
        requestOptions?: NoAuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<boolean, SeedApi.exhaustive.noAuth.postWithNoAuth.Error>>> {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.exhaustive.noAuth.postWithNoAuth.Response.parseOrThrow(_response.body, {
            ...
            switch (_response.error.statusCode) {
                case 400:
                    return {
                        data: {
                            ok: false,
                            error: SeedApi.exhaustive.noAuth.postWithNoAuth.Error.badRequestError(_response.error.body),
                            rawResponse: _response.rawResponse,
                        },
                        rawResponse: _response.rawResponse,
                    };
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.noAuth.postWithNoAuth.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
