...
export class PaginationClient {
    ...
    public listItems(
        ...
        core.APIResponse<
            SeedApi.exhaustive.EndpointsPaginatedResponse,
            SeedApi.exhaustive.endpoints.pagination.listItems.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.exhaustive.EndpointsPaginatedResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.endpoints.pagination.listItems.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
