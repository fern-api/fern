...
export class ContentTypeClient {
    ...
    public postJsonPatchContentType(
        ...
        core.APIResponse<void, SeedApi.exhaustive.endpoints.contentType.postJsonPatchContentType.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.endpoints.contentType.postJsonPatchContentType.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public postJsonPatchContentWithCharsetType(
        ...
        core.APIResponse<void, SeedApi.exhaustive.endpoints.contentType.postJsonPatchContentWithCharsetType.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.exhaustive.endpoints.contentType.postJsonPatchContentWithCharsetType.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
