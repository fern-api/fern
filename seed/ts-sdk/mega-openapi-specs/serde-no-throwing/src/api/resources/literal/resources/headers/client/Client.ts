...
export class HeadersClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<SeedApi.literal.SendResponse, SeedApi.literal.headers.send.Error>> {
    ...
    private async __send(
        ...
        core.WithRawResponse<core.APIResponse<SeedApi.literal.SendResponse, SeedApi.literal.headers.send.Error>>
    > {
        const { endpointVersion, async, ..._body } = request;
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.literal.SendHeadersRequest.jsonOrThrow(_body, {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.literal.SendResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.literal.headers.send.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
