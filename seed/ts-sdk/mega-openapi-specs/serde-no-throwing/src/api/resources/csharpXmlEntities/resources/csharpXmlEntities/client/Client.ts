...
export class CsharpXmlEntitiesClient {
    ...
    public getTimeZone(
        ...
        core.APIResponse<
            ...
            SeedApi.csharpXmlEntities.csharpXmlEntities.getTimeZone.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.csharpXmlEntities.TimeZoneModel.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.csharpXmlEntities.csharpXmlEntities.getTimeZone.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
