...
export class AuthClient {
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.websocketInferredAuth.GetTokenWithClientCredentialsAuthRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.websocketInferredAuth.TokenResponse.parseOrThrow(_response.body, {
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.websocketInferredAuth.RefreshTokenAuthRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
