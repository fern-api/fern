...
export class SimpleClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.inferredAuthImplicitApiKey.simple.getSomething.Error>> {
    ...
    private async __getSomething(
        ...
        core.WithRawResponse<core.APIResponse<void, SeedApi.inferredAuthImplicitApiKey.simple.getSomething.Error>>
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthImplicitApiKey.simple.getSomething.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
