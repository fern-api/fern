...
export class SimpleClient {
    ...
    public getSomething(
        ...
        core.APIResponse<void, SeedApi.inferredAuthImplicitReference.simple.getSomething.Error>
    > {
    ...
    private async __getSomething(
        ...
        core.WithRawResponse<core.APIResponse<void, SeedApi.inferredAuthImplicitReference.simple.getSomething.Error>>
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthImplicitReference.simple.getSomething.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
