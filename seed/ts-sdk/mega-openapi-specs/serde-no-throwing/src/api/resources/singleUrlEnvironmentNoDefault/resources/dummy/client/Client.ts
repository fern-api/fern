...
export class DummyClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<string, SeedApi.singleUrlEnvironmentNoDefault.dummy.getDummy.Error>> {
    ...
    private async __getDummy(
        ...
        core.WithRawResponse<core.APIResponse<string, SeedApi.singleUrlEnvironmentNoDefault.dummy.getDummy.Error>>
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.singleUrlEnvironmentNoDefault.dummy.getDummy.Response.parseOrThrow(
                        _response.body,
                        {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.singleUrlEnvironmentNoDefault.dummy.getDummy.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
