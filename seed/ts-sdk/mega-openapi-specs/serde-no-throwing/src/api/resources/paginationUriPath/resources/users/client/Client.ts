...
export class UsersClient {
    ...
    public listWithUriPagination(
        ...
        core.APIResponse<
            ...
            SeedApi.paginationUriPath.users.listWithUriPagination.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.paginationUriPath.ListUsersUriPaginationResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.paginationUriPath.users.listWithUriPagination.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public listWithPathPagination(
        ...
        core.APIResponse<
            ...
            SeedApi.paginationUriPath.users.listWithPathPagination.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.paginationUriPath.ListUsersPathPaginationResponse.parseOrThrow(_response.body, {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
                        allowUnrecognizedEnumValues: true,
                        skipValidation: true,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.paginationUriPath.users.listWithPathPagination.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
