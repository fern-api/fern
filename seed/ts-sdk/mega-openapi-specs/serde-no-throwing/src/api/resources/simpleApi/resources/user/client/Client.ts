...
export class UserClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<SeedApi.simpleApi.User, SeedApi.simpleApi.user.get.Error>> {
    ...
    private async __get(
        request: SeedApi.simpleApi.GetUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<SeedApi.simpleApi.User, SeedApi.simpleApi.user.get.Error>>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.simpleApi.User.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.simpleApi.user.get.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
