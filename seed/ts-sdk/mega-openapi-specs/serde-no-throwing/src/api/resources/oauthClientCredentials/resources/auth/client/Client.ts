...
export class AuthClient {
    ...
    public getTokenWithClientCredentials(
        ...
        core.APIResponse<
            SeedApi.oauthClientCredentials.TokenResponse,
            SeedApi.oauthClientCredentials.auth.getTokenWithClientCredentials.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.oauthClientCredentials.TokenResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentials.auth.getTokenWithClientCredentials.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public refreshToken(
        ...
        core.APIResponse<
            SeedApi.oauthClientCredentials.TokenResponse,
            SeedApi.oauthClientCredentials.auth.refreshToken.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentials.auth.refreshToken.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
