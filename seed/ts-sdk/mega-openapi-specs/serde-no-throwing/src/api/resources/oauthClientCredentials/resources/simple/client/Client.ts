...
export class SimpleClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.oauthClientCredentials.simple.getSomething.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__getSomething(requestOptions));
    }

    private async __getSomething(
        requestOptions?: SimpleClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.oauthClientCredentials.simple.getSomething.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentials.simple.getSomething.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
