...
export class NoAuthClient {
    ...
    public postWithNoAuth(
        ...
        core.APIResponse<boolean, SeedApi.goDeterministicOrdering.noAuth.postWithNoAuth.Error>
    > {
    ...
    private async __postWithNoAuth(
        ...
        core.WithRawResponse<core.APIResponse<boolean, SeedApi.goDeterministicOrdering.noAuth.postWithNoAuth.Error>>
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.goDeterministicOrdering.noAuth.postWithNoAuth.Response.parseOrThrow(
                        _response.body,
                        {
            ...
            switch (_response.error.statusCode) {
                case 400:
                    return {
                        data: {
                            ok: false,
                            error: SeedApi.goDeterministicOrdering.noAuth.postWithNoAuth.Error.badRequestError(
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.goDeterministicOrdering.noAuth.postWithNoAuth.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
