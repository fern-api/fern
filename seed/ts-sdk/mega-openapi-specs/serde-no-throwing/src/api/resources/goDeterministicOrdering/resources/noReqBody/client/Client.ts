...
export class NoReqBodyClient {
    ...
    public getWithNoRequestBody(
        ...
        core.APIResponse<
            ...
            SeedApi.goDeterministicOrdering.noReqBody.getWithNoRequestBody.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.goDeterministicOrdering.noReqBody.getWithNoRequestBody.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public postWithNoRequestBody(
        ...
        core.APIResponse<string, SeedApi.goDeterministicOrdering.noReqBody.postWithNoRequestBody.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.goDeterministicOrdering.noReqBody.postWithNoRequestBody.Response.parseOrThrow(
                        _response.body,
                        {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.goDeterministicOrdering.noReqBody.postWithNoRequestBody.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
