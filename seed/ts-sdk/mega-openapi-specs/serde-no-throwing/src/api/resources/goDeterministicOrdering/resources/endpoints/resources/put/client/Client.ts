...
export class PutClient {
    ...
    public add(
        ...
        core.APIResponse<
            SeedApi.goDeterministicOrdering.EndpointsPutResponse,
            SeedApi.goDeterministicOrdering.endpoints.put.add.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.goDeterministicOrdering.EndpointsPutResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.goDeterministicOrdering.endpoints.put.add.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
