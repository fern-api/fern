...
export class ComplexClient {
    ...
    public search(
        ...
        core.APIResponse<SeedApi.pagination.PaginatedConversationResponse, SeedApi.pagination.complex.search.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.pagination.PaginatedConversationResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.pagination.complex.search.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
