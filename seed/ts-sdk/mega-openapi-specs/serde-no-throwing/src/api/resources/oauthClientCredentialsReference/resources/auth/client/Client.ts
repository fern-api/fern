...
export class AuthClient {
    ...
    public getToken(
        ...
        core.APIResponse<
            SeedApi.oauthClientCredentialsReference.TokenResponse,
            SeedApi.oauthClientCredentialsReference.auth.getToken.Error
        >
    > {
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.oauthClientCredentialsReference.GetTokenRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.oauthClientCredentialsReference.TokenResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsReference.auth.getToken.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
