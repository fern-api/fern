...
export class MigrationClient {
    ...
    public getAttemptedMigrations(
        ...
        core.APIResponse<SeedApi.trace.Migration[], SeedApi.trace.migration.getAttemptedMigrations.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.trace.migration.getAttemptedMigrations.Response.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.trace.migration.getAttemptedMigrations.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
