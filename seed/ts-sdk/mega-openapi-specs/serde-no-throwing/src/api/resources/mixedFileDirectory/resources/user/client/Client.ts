...
export class UserClient {
    ...
    public list(
        ...
        core.APIResponse<SeedApi.mixedFileDirectory.User[], SeedApi.mixedFileDirectory.user.list.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.mixedFileDirectory.user.list.Response.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.mixedFileDirectory.user.list.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
