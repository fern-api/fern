...
export class MetadataClient {
    ...
    public getMetadata(
        ...
        core.APIResponse<
            ...
            SeedApi.mixedFileDirectory.user.events.metadata.getMetadata.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.mixedFileDirectory.UsereventsMetadata.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.mixedFileDirectory.user.events.metadata.getMetadata.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
