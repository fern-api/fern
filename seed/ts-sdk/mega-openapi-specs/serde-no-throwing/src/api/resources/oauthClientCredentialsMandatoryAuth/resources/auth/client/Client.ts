...
export class AuthClient {
    ...
    public getTokenWithClientCredentials(
        ...
        core.APIResponse<
            SeedApi.oauthClientCredentialsMandatoryAuth.TokenResponse,
            SeedApi.oauthClientCredentialsMandatoryAuth.auth.getTokenWithClientCredentials.Error
        >
    > {
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.oauthClientCredentialsMandatoryAuth.GetTokenWithClientCredentialsAuthRequest.jsonOrThrow(
                request,
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.oauthClientCredentialsMandatoryAuth.TokenResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsMandatoryAuth.auth.getTokenWithClientCredentials.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public refreshToken(
        ...
        core.APIResponse<
            SeedApi.oauthClientCredentialsMandatoryAuth.TokenResponse,
            SeedApi.oauthClientCredentialsMandatoryAuth.auth.refreshToken.Error
        >
    > {
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.oauthClientCredentialsMandatoryAuth.RefreshTokenAuthRequest.jsonOrThrow(request, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsMandatoryAuth.auth.refreshToken.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
