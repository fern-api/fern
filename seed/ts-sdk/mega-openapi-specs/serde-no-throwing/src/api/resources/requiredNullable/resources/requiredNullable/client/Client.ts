...
export class RequiredNullableClient {
    ...
    public getFoo(
        ...
        core.APIResponse<SeedApi.requiredNullable.Foo, SeedApi.requiredNullable.requiredNullable.getFoo.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.requiredNullable.Foo.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.requiredNullable.requiredNullable.getFoo.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public updateFoo(
        ...
        core.APIResponse<SeedApi.requiredNullable.Foo, SeedApi.requiredNullable.requiredNullable.updateFoo.Error>
    > {
    ...
    private async __updateFoo(
        ...
        >
    > {
        const { id, idempotencyKey, ..._body } = request;
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.requiredNullable.requiredNullable.updateFoo.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
