...
export class ServiceClient {
    ...
    public getDirectThread(
        ...
        core.APIResponse<SeedApi.audiences.FolderDResponse, SeedApi.audiences.folderD.service.getDirectThread.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.audiences.FolderDResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.audiences.folderD.service.getDirectThread.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
