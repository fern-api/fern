...
export class AuthClient {
    ...
    public getToken(
        ...
        core.APIResponse<
            ...
            SeedApi.oauthClientCredentialsNestedRoot.auth.getToken.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.oauthClientCredentialsNestedRoot.AuthTokenResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsNestedRoot.auth.getToken.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
