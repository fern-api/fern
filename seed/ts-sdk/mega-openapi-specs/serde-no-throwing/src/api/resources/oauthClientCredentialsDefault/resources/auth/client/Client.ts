...
export class AuthClient {
    ...
    public getToken(
        ...
        core.APIResponse<
            SeedApi.oauthClientCredentialsDefault.TokenResponse,
            SeedApi.oauthClientCredentialsDefault.auth.getToken.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.oauthClientCredentialsDefault.TokenResponse.parseOrThrow(_response.body, {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsDefault.auth.getToken.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
