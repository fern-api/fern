...
export class UserClient {
    ...
    ): core.HttpResponsePromise<SeedApi.simpleApi.User> {
    ...
    private async __get(
        request: SeedApi.simpleApi.GetUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.simpleApi.User>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.simpleApi.User, rawResponse: _response.rawResponse };
        }
