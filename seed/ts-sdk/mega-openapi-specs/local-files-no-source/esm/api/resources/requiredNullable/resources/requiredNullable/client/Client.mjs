...
export class RequiredNullableClient {
     ...
     *     })
     */
    updateFoo(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__updateFoo(request, requestOptions));
    }
    __updateFoo(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
            const { id, "X-Idempotency-Key": idempotencyKey } = request, _body = __rest(request, ["id", "X-Idempotency-Key"]);
            const _headers = mergeHeaders((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, mergeOnlyDefinedHeaders({
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : ((_h = (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.SeedApiEnvironment.Production)
                    .base, `foo/${core.url.encodePathParam(id)}`),
                method: "PATCH",
                headers: _headers,
