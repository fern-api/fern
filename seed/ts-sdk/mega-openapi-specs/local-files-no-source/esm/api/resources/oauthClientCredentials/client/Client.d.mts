...
export declare namespace OauthClientCredentialsClient {
    type Options = BaseClientOptions;
}
export declare class OauthClientCredentialsClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<OauthClientCredentialsClient.Options>;
    ...
    constructor(options: OauthClientCredentialsClient.Options);
    get auth(): AuthClient;
