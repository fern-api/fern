...
export class EndpointsClient {
    ...
    get duplicateNamesA() {
        var _a;
        return ((_a = this._duplicateNamesA) !== null && _a !== void 0 ? _a : (this._duplicateNamesA = new DuplicateNamesAClient(this._options)));
    }
    get duplicateNamesB() {
        var _a;
        return ((_a = this._duplicateNamesB) !== null && _a !== void 0 ? _a : (this._duplicateNamesB = new DuplicateNamesBClient(this._options)));
    }
    get duplicateNamesC() {
        var _a;
        return ((_a = this._duplicateNamesC) !== null && _a !== void 0 ? _a : (this._duplicateNamesC = new DuplicateNamesCClient(this._options)));
    }
    get enum() {
        var _a;
