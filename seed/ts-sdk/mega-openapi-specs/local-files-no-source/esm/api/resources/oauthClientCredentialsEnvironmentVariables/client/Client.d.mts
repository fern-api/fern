...
export declare namespace OauthClientCredentialsEnvironmentVariablesClient {
    type Options = BaseClientOptions;
}
export declare class OauthClientCredentialsEnvironmentVariablesClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<OauthClientCredentialsEnvironmentVariablesClient.Options>;
    ...
    constructor(options: OauthClientCredentialsEnvironmentVariablesClient.Options);
    get auth(): AuthClient;
