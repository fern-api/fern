...
exports.TestGroupClient = void 0;
...
class TestGroupClient {
     ...
     *     })
     */
    testMethodName(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__testMethodName(request, requestOptions));
    }
    __testMethodName(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
            const { path_param: pathParam, query_param_object: queryParamObject, query_param_integer: queryParamInteger, body: _body, } = request;
            const _queryParams = {
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : ((_h = (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.SeedApiEnvironment.Production)
                    .base, `optional-request-body/${core.url.encodePathParam(pathParam)}`),
                method: "POST",
                headers: _headers,
            ...
            if (_response.error.reason === "status-code") {
                switch (_response.error.statusCode) {
                    case 422:
                        throw new SeedApi.nullableRequestBody.UnprocessableEntityError(_response.error.body, _response.rawResponse);
                    default:
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/optional-request-body/{path_param}");
        });
    }
}
exports.TestGroupClient = TestGroupClient;
