...
exports.QueryParamClient = void 0;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _queryParams = {
                ...
                maybeOperandOrColor: Array.isArray(maybeOperandOrColor)
                    ? maybeOperandOrColor.map((item) => (typeof item === "string" ? item : (0, json_js_1.toJson)(item)))
        ...
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            const _queryParams = {
                ...
                operandOrColor: Array.isArray(operandOrColor)
                    ? operandOrColor.map((item) => (typeof item === "string" ? item : (0, json_js_1.toJson)(item)))
                    : operandOrColor != null
                        ? typeof operandOrColor === "string"
                            ? operandOrColor
                            : (0, json_js_1.toJson)(operandOrColor)
                        : undefined,
                maybeOperandOrColor: Array.isArray(maybeOperandOrColor)
                    ? maybeOperandOrColor.map((item) => (typeof item === "string" ? item : (0, json_js_1.toJson)(item)))
                    : maybeOperandOrColor !== undefined
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/query-list");
        });
    }
}
exports.QueryParamClient = QueryParamClient;
