...
const Client_js_1 = require("../resources/metadata/client/Client.js");
class EventsClient {
    constructor(options) {
    ...
    get metadata() {
        var _a;
        return ((_a = this._metadata) !== null && _a !== void 0 ? _a : (this._metadata = new Client_js_1.MetadataClient(this._options)));
    }
    /**
    ...
    __listEvents() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/users/events/");
        });
    }
}
