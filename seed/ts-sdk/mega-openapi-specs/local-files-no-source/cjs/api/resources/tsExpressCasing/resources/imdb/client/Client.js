        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (_response.error.reason === "status-code") {
                switch (_response.error.statusCode) {
                    case 404:
                        throw new SeedApi.tsExpressCasing.NotFoundError(_response.error.body, _response.rawResponse);
                    default:
                        throw new errors.SeedApiError({
                            statusCode: _response.error.statusCode,
                            body: _response.error.body,
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/movies/{movie_id}");
        });
    }
}
