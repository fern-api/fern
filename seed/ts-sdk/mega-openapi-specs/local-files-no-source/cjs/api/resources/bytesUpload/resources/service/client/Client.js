...
class ServiceClient {
    ...
    __upload(uploadable, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/upload-content");
        });
    }
    /**
     * @param {core.file.Uploadable} uploadable
     ...
     * @param {ServiceClient.RequestOptions} requestOptions - Request-specific configuration.
     */
    uploadWithQueryParams(uploadable, request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__uploadWithQueryParams(uploadable, request, requestOptions));
    }
    __uploadWithQueryParams(uploadable, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
            const _queryParams = {
                model: request.model,
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : ((_h = (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.SeedApiEnvironment.Production)
                    .base, "upload-content-with-query-params"),
                method: "POST",
                headers: _headers,
                contentType: "application/octet-stream",
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/upload-content-with-query-params");
        });
    }
}
