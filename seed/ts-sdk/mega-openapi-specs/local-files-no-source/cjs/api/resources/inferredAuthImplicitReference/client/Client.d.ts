...
export declare namespace InferredAuthImplicitReferenceClient {
    type Options = BaseClientOptions;
}
export declare class InferredAuthImplicitReferenceClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<InferredAuthImplicitReferenceClient.Options>;
    ...
    constructor(options: InferredAuthImplicitReferenceClient.Options);
    get auth(): AuthClient;
