...
class JavaOptionalNullableQueryParamsClient {
    ...
    __search() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            const { query, limit, includeArchived, sortOrder, optionalWithoutDefault, regularOptional, regularOptionalNoDefault, } = request;
            const _queryParams = {
                query,
                limit,
                includeArchived,
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/api/search");
        });
    }
}
