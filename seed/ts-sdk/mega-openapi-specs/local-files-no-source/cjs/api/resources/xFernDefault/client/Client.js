...
exports.XFernDefaultClient = void 0;
        ...
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : ((_h = (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.SeedApiEnvironment.Production)
                    .base, `test/${core.url.encodePathParam(region !== null && region !== void 0 ? region : "us-east-1")}/resource`),
                method: "GET",
                headers: _headers,
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/test/{region}/resource");
        });
    }
}
exports.XFernDefaultClient = XFernDefaultClient;
