        ...
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            const _queryParams = {
                event_type: Array.isArray(eventType)
                    ? eventType.map((item) => (typeof item === "string" ? item : (0, json_js_1.toJson)(item)))
                    : eventType !== undefined
                        ? typeof eventType === "string"
                            ? eventType
                            : (0, json_js_1.toJson)(eventType)
                        : undefined,
                tags: Array.isArray(tags)
                    ? tags.map((item) => (typeof item === "string" ? item : (0, json_js_1.toJson)(item)))
                    : tags !== undefined
                        ? typeof tags === "string"
                            ? tags
                            : (0, json_js_1.toJson)(tags)
                        : undefined,
            };
