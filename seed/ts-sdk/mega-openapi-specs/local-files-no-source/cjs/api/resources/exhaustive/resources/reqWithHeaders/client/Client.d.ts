...
export declare class ReqWithHeadersClient {
    ...
    /**
     * @param {SeedApi.exhaustive.GetWithCustomHeaderReqWithHeadersRequest} request
     ...
     *     })
     */
    getWithCustomHeader(request: SeedApi.exhaustive.GetWithCustomHeaderReqWithHeadersRequest, requestOptions?: ReqWithHeadersClient.RequestOptions): core.HttpResponsePromise<void>;
