        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (_response.error.reason === "status-code") {
                switch (_response.error.statusCode) {
                    case 401:
                        throw new SeedApi.basicAuthPwOmitted.UnauthorizedError(_response.error.body, _response.rawResponse);
                    default:
    ...
    __postWithBasicAuth(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (_response.error.reason === "status-code") {
                switch (_response.error.statusCode) {
                    case 400:
                        throw new SeedApi.basicAuthPwOmitted.BadRequestError(_response.error.body, _response.rawResponse);
                    case 401:
                        throw new SeedApi.basicAuthPwOmitted.UnauthorizedError(_response.error.body, _response.rawResponse);
                    default:
                        throw new errors.SeedApiError({
