        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (_response.error.reason === "status-code") {
                switch (_response.error.statusCode) {
                    case 400:
                        throw new SeedApi.javaStreamingAcceptHeader.BadRequestError(_response.error.body, _response.rawResponse);
                    default:
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/generate-stream");
        });
    }
    /**
