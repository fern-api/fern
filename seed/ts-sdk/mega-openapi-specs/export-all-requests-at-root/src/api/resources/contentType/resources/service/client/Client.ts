...
export class ServiceClient {
    ...
    /**
     * @param {SeedApi.PatchServiceRequest} request
     ...
     */
    public patch(
        request: SeedApi.PatchServiceRequest,
     ...
     *
     * @param {SeedApi.PatchComplexServiceRequest} request
     * @param {ServiceClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     */
    public patchComplex(
        request: SeedApi.PatchComplexServiceRequest,
        requestOptions?: ServiceClient.RequestOptions,
    ): core.HttpResponsePromise<void> {
     ...
     *
     * @param {SeedApi.NamedPatchWithMixedServiceRequest} request
     * @param {ServiceClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public namedPatchWithMixed(
        request: SeedApi.NamedPatchWithMixedServiceRequest,
        requestOptions?: ServiceClient.RequestOptions,
    ): core.HttpResponsePromise<void> {
     ...
     *
     * @param {SeedApi.OptionalMergePatchTestServiceRequest} request
     * @param {ServiceClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public optionalMergePatchTest(
        request: SeedApi.OptionalMergePatchTestServiceRequest,
        requestOptions?: ServiceClient.RequestOptions,
    ): core.HttpResponsePromise<void> {
     ...
     *
     * @param {SeedApi.RegularPatchServiceRequest} request
     * @param {ServiceClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     */
    public regularPatch(
        request: SeedApi.RegularPatchServiceRequest,
        requestOptions?: ServiceClient.RequestOptions,
    ): core.HttpResponsePromise<void> {
