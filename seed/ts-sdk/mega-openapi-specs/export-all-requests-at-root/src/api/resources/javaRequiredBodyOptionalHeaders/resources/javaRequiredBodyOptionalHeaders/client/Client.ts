...
export class JavaRequiredBodyOptionalHeadersClient {
     ...
     *
     * @param {SeedApi.CreateUserWithOptionsRequest} request
     * @param {JavaRequiredBodyOptionalHeadersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {SeedApi.CreateUserWithRequiredQueryRequest} request
     * @param {JavaRequiredBodyOptionalHeadersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {SeedApi.CreateUserInlinedRequest} request
     * @param {JavaRequiredBodyOptionalHeadersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
