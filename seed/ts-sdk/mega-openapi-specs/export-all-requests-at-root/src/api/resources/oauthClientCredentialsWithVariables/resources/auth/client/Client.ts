...
export class AuthClient {
    ...
    /**
     * @param {SeedApi.GetTokenWithClientCredentialsAuthRequest} request
    ...
    public getTokenWithClientCredentials(
        request: SeedApi.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.oauthClientCredentialsWithVariables.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: SeedApi.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.oauthClientCredentialsWithVariables.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.oauthClientCredentialsWithVariables.TokenResponse,
