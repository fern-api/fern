...
export class ProblemClient {
     ...
     *
     * @param {SeedApi.GetLatestProblemProblemRequest} request
     * @param {ProblemClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public getLatestProblem(
        request: SeedApi.GetLatestProblemProblemRequest,
        requestOptions?: ProblemClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.trace.V2ProblemInfoV2> {
     ...
     *
     * @param {SeedApi.GetProblemVersionProblemRequest} request
     * @param {ProblemClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public getProblemVersion(
        request: SeedApi.GetProblemVersionProblemRequest,
        requestOptions?: ProblemClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.trace.V2ProblemInfoV2> {
