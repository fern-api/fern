...
export class SubmissionClient {
     ...
     *
     * @param {SeedApi.CreateExecutionSessionSubmissionRequest} request
     ...
     *
     * @param {SeedApi.GetExecutionSessionSubmissionRequest} request
     * @param {SubmissionClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {SeedApi.StopExecutionSessionSubmissionRequest} request
     * @param {SubmissionClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
