...
export class ProblemClient {
     ...
     * Updates a problem
     *
     * @param {SeedApi.UpdateProblemProblemRequest} request
     * @param {ProblemClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {SeedApi.DeleteProblemProblemRequest} request
     * @param {ProblemClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {SeedApi.GetDefaultStarterFilesProblemRequest} request
     * @param {ProblemClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
