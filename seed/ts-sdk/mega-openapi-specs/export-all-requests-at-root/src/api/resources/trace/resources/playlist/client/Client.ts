...
export class PlaylistClient {
     ...
     *
     * @param {SeedApi.CreatePlaylistPlaylistRequest} request
     ...
     *
     * @param {SeedApi.GetPlaylistsPlaylistRequest} request
     * @param {PlaylistClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     * Returns a playlist
     *
     * @param {SeedApi.GetPlaylistPlaylistRequest} request
     * @param {PlaylistClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     * Updates a playlist
     *
     * @param {SeedApi.UpdatePlaylistPlaylistRequest} request
     * @param {PlaylistClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link SeedApi.trace.NotFoundError}
     *
     ...
     * Deletes a playlist
     *
     * @param {SeedApi.DeletePlaylistPlaylistRequest} request
     * @param {PlaylistClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
