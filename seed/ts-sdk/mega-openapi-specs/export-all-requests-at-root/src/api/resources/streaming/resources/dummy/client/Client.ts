...
export class DummyClient {
    ...
    /**
     * @param {SeedApi.GenerateStreamDummyRequest} request
    ...
    public generateStream(
        request: SeedApi.GenerateStreamDummyRequest,
    ...
    /**
     * @param {SeedApi.GenerateDummyRequest} request
     * @param {DummyClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     */
    public generate(
        request: SeedApi.GenerateDummyRequest,
        requestOptions?: DummyClient.RequestOptions,
