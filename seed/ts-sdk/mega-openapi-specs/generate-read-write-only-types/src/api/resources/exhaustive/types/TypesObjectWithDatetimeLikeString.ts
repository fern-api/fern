...
export namespace TypesObjectWithDatetimeLikeString {
    export type Request = Omit<TypesObjectWithDatetimeLikeString, "datetimeLikeString" | "actualDatetime"> & {
        datetimeLikeString: string;
        actualDatetime: string;
    };
    export type Response = Omit<TypesObjectWithDatetimeLikeString, "datetimeLikeString" | "actualDatetime"> & {
        datetimeLikeString: string;
        actualDatetime: string;
    };
}
