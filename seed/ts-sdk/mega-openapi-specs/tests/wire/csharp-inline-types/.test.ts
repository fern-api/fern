...
describe("Client", () => {
    test("getRoot", async () => {
        ...
        const response = await client.csharpInlineTypes..getRoot({
    bar: {
        foo: "foo"
    },
    foo: "foo"
    ...
    test("getDiscriminatedUnion", async () => {
        ...
        const response = await client.csharpInlineTypes..getDiscriminatedUnion({
    bar: {
        foo: "foo",
        bar: {
            foo: "foo",
    ...
    test("getUndiscriminatedUnion", async () => {
        ...
        const response = await client.csharpInlineTypes..getUndiscriminatedUnion({
    bar: "SUNNY",
    foo: "foo"
});
        expect(response).toEqual(undefined);
