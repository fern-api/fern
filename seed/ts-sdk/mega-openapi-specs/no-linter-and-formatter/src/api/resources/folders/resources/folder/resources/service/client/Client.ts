...
export class ServiceClient {
    ...
    private async __endpoint(requestOptions?: ServiceClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? (await core.Supplier.get(this._options.environment) ?? environments.SeedApiEnvironment.Production).base, "service"),
            method: "GET",
            headers: _headers,
    ...
    private async __unknownRequest(request?: unknown, requestOptions?: ServiceClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 404: throw new SeedApi.folders.NotFoundError(_response.error.body as unknown, _response.rawResponse);
