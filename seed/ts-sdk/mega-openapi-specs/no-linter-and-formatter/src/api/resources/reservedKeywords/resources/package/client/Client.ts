...
export class PackageClient {
     ...
     *     })
     */
    public test(request: SeedApi.reservedKeywords.TestPackageRequest, requestOptions?: PackageClient.RequestOptions): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(this.__test(request, requestOptions));
    }

    private async __test(request: SeedApi.reservedKeywords.TestPackageRequest, requestOptions?: PackageClient.RequestOptions): Promise<core.WithRawResponse<void>> {
