...
export class ReqWithHeadersClient {
     ...
     *     })
     */
    public getWithCustomHeader(request: SeedApi.goDeterministicOrdering.GetWithCustomHeaderReqWithHeadersRequest, requestOptions?: ReqWithHeadersClient.RequestOptions): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(this.__getWithCustomHeader(request, requestOptions));
    }

    private async __getWithCustomHeader(request: SeedApi.goDeterministicOrdering.GetWithCustomHeaderReqWithHeadersRequest, requestOptions?: ReqWithHeadersClient.RequestOptions): Promise<core.WithRawResponse<void>> {
