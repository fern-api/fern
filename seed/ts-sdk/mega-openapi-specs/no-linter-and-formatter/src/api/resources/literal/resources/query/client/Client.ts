...
export class QueryClient {
     ...
     *     })
     */
    public send(request: SeedApi.literal.SendQueryRequest, requestOptions?: QueryClient.RequestOptions): core.HttpResponsePromise<SeedApi.literal.SendResponse> {
        return core.HttpResponsePromise.fromPromise(this.__send(request, requestOptions));
    }

    private async __send(request: SeedApi.literal.SendQueryRequest, requestOptions?: QueryClient.RequestOptions): Promise<core.WithRawResponse<SeedApi.literal.SendResponse>> {
