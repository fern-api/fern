...
export class CsharpReadonlyRequestClient {
    ...
    ): core.HttpResponsePromise<SeedApi.csharpReadonlyRequest.CreateVendorResponse> {
    ...
    private async __batchCreate(
        request: SeedApi.csharpReadonlyRequest.CreateVendorRequest,
        requestOptions?: CsharpReadonlyRequestClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.csharpReadonlyRequest.CreateVendorResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.csharpReadonlyRequest.CreateVendorResponse,
