...
export class ImdbClient {
    ...
    private async __createMovie(
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.imdb.MovieId, rawResponse: _response.rawResponse };
        }
    ...
    private async __getMovie(
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.imdb.Movie, rawResponse: _response.rawResponse };
        }

        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 404:
                    throw new SeedApi.imdb.NotFoundError(_response.error.body as unknown, _response.rawResponse);
                default:
                    throw new errors.SeedApiError({
                        statusCode: _response.error.statusCode,
                        body: _response.error.body,
