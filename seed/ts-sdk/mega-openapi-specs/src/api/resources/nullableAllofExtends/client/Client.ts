...
export class NullableAllofExtendsClient {
    ...
    ): core.HttpResponsePromise<SeedApi.nullableAllofExtends.RootObject> {
        return core.HttpResponsePromise.fromPromise(this.__getTest(requestOptions));
    }

    private async __getTest(
        requestOptions?: NullableAllofExtendsClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.nullableAllofExtends.RootObject>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.nullableAllofExtends.RootObject,
