...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.oauthClientCredentialsMandatoryAuth.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: SeedApi.oauthClientCredentialsMandatoryAuth.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.oauthClientCredentialsMandatoryAuth.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.oauthClientCredentialsMandatoryAuth.TokenResponse,
