...
describe("ContentTypeClient", () => {
    test("postJsonPatchContentType", async () => {
        ...
        const response = await client.exhaustive.endpoints.contentType.postJsonPatchContentType({});
    ...
    test("postJsonPatchContentWithCharsetType", async () => {
        ...
        const response = await client.exhaustive.endpoints.contentType.postJsonPatchContentWithCharsetType({});
        expect(response).toEqual(undefined);
    });
});
