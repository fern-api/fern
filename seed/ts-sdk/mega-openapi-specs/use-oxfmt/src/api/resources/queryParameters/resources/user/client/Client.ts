...
export class UserClient {
    ...
    ): core.HttpResponsePromise<SeedApi.queryParameters.User> {
    ...
    private async __getUsername(
        request: SeedApi.queryParameters.GetUsernameUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.queryParameters.User>> {
        const {
            limit,
            id,
            date,
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.queryParameters.User, rawResponse: _response.rawResponse };
        }
