...
export class S3Client {
    ...
    private async __getPresignedUrl(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.multiUrlEnvironmentNoDefault.GetPresignedUrlS3Request.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.multiUrlEnvironmentNoDefault.s3.getPresignedUrl.Response.parseOrThrow(
                    _response.body,
                    {
