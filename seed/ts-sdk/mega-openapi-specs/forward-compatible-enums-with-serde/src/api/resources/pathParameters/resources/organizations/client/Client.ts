...
export class OrganizationsClient {
    ...
    private async __getOrganization(
        ...
        if (_response.ok) {
            return {
                data: serializers.pathParameters.Organization.parseOrThrow(_response.body, {
    ...
    private async __searchOrganizations(
        ...
        if (_response.ok) {
            return {
                data: serializers.pathParameters.organizations.searchOrganizations.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
