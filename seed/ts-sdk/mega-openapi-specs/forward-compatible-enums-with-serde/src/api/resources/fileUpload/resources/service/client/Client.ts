...
export class ServiceClient {
    ...
    private async __post(
        ...
        if (request.listOfObjects != null) {
            for (const _item of request.listOfObjects) {
                _body.append(
                    "list_of_objects",
                    toJson(
                        serializers.fileUpload.MyObject.jsonOrThrow(_item, {
        ...
        if (request.optionalObjectType != null) {
            _body.append(
                ...
                serializers.fileUpload.ObjectType.jsonOrThrow(request.optionalObjectType, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
            );
        ...
        if (request.optionalId != null) {
            _body.append(
                "optional_id",
                serializers.fileUpload.Id.jsonOrThrow(request.optionalId, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
            );
        ...
        if (request.aliasObject != null) {
            if (Array.isArray(request.aliasObject) || request.aliasObject instanceof Set)
                for (const _item of request.aliasObject) {
    ...
    private async __withContentType(
        ...
        if (request.bar != null) {
            _body.append(
                "bar",
                toJson(
                    serializers.fileUpload.MyObject.jsonOrThrow(request.bar, {
                        unrecognizedObjectKeys: "strip",
                        omitUndefined: true,
                    }),
                ),
        ...
        if (request.fooBar != null) {
            _body.append(
                "foo_bar",
                toJson(
                    serializers.fileUpload.MyObject.jsonOrThrow(request.fooBar, {
                        unrecognizedObjectKeys: "strip",
                        omitUndefined: true,
                    }),
                ),
        ...
        if (request.listOfObjectsWithOptionals != null) {
            for (const _item of request.listOfObjectsWithOptionals) {
                _body.append(
                    ...
                    toJson(
                        serializers.fileUpload.MyObjectWithOptional.jsonOrThrow(_item, {
                            unrecognizedObjectKeys: "strip",
                            omitUndefined: true,
                        }),
                    ),
    ...
    private async __optionalArgs(
        ...
        if (_response.ok) {
            return {
                data: serializers.fileUpload.service.optionalArgs.Response.parseOrThrow(_response.body, {
    ...
    private async __withInlineType(
        ...
        if (request.request != null) {
            _body.append(
                "request",
                toJson(
                    serializers.fileUpload.MyInlineType.jsonOrThrow(request.request, {
                        unrecognizedObjectKeys: "strip",
                        omitUndefined: true,
                    }),
                ),
        ...
        if (_response.ok) {
            return {
                data: serializers.fileUpload.service.withInlineType.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __withJsonProperty(
        ...
        if (request.json != null) {
            _body.append(
                "json",
                toJson(
                    serializers.fileUpload.MyObject.jsonOrThrow(request.json, {
                        unrecognizedObjectKeys: "strip",
                        omitUndefined: true,
                    }),
                ),
        ...
        if (_response.ok) {
            return {
                data: serializers.fileUpload.service.withJsonProperty.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __withRefBody(
        ...
        if (request.request != null) {
            _body.append(
                "request",
                toJson(
                    serializers.fileUpload.MyObject.jsonOrThrow(request.request, {
                        unrecognizedObjectKeys: "strip",
                        omitUndefined: true,
                    }),
                ),
        ...
        if (_response.ok) {
            return {
                data: serializers.fileUpload.service.withRefBody.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __withLiteralAndEnumTypes(
        ...
        if (request.modelType != null) {
            _body.append(
                "model_type",
                serializers.fileUpload.ModelType.jsonOrThrow(request.modelType, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
            );
        ...
        if (request.openEnum != null) {
            _body.append(
                "open_enum",
                serializers.fileUpload.OpenEnumType.jsonOrThrow(request.openEnum, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
            );
        ...
        if (_response.ok) {
            return {
                data: serializers.fileUpload.service.withLiteralAndEnumTypes.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
