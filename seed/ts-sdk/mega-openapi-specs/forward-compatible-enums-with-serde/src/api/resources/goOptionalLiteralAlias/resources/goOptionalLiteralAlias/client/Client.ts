...
export class GoOptionalLiteralAliasClient {
    ...
    private async __search(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.goOptionalLiteralAlias.SearchRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.goOptionalLiteralAlias.SearchResponse.parseOrThrow(_response.body, {
