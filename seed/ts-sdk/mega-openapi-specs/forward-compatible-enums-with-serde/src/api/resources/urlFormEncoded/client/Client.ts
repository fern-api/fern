...
export class UrlFormEncodedClient {
    ...
    private async __submitFormData(
        ...
        if (_response.ok) {
            return {
                data: serializers.urlFormEncoded.PostSubmitResponse.parseOrThrow(_response.body, {
    ...
    private async __getToken(
        ...
        if (_response.ok) {
            return {
                data: serializers.urlFormEncoded.TokenResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
