...
export class TsExtraPropertiesClient {
    ...
    ): core.HttpResponsePromise<SeedApi.tsExtraProperties.User> {
        return core.HttpResponsePromise.fromPromise(this.__getUser(requestOptions));
    }

    private async __getUser(
        requestOptions?: TsExtraPropertiesClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.tsExtraProperties.User>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.tsExtraProperties.User.parseOrThrow(_response.body, {
    ...
    private async __createUser(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.tsExtraProperties.CreateUserRequest.jsonOrThrow(request, {
