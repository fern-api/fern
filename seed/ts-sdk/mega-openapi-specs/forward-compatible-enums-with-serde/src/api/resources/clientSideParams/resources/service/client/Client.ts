...
export class ServiceClient {
    ...
    private async __listResources(
        ...
        const { page, perPage, sort, order, includeTotals, fields, search } = request;
        ...
        if (_response.ok) {
            return {
                data: serializers.clientSideParams.service.listResources.Response.parseOrThrow(_response.body, {
    ...
    private async __getResource(
        ...
        const { resourceId, includeMetadata, format } = request;
        const _queryParams: Record<string, unknown> = {
        ...
        if (_response.ok) {
            return {
                data: serializers.clientSideParams.Resource.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __searchResources(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url
                ...
                .build(),
            requestType: "json",
            body: serializers.clientSideParams.SearchResourcesServiceRequest.jsonOrThrow(_body, {
        ...
        if (_response.ok) {
            return {
                data: serializers.clientSideParams.SearchResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __listUsers(
        ...
        const { page, perPage, includeTotals, sort, connection, q, searchEngine, fields } = request;
        const _queryParams: Record<string, unknown> = {
            page,
            per_page: perPage,
            include_totals: includeTotals,
        ...
        if (_response.ok) {
            return {
                data: serializers.clientSideParams.PaginatedUserResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __createUser(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.clientSideParams.CreateUserRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
        ...
        if (_response.ok) {
            return {
                data: serializers.clientSideParams.User.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getUserById(
        ...
        const { userId, fields, includeFields } = request;
        const _queryParams: Record<string, unknown> = {
            fields,
    ...
    private async __updateUser(
        ...
        const _response = await core.fetcher({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.clientSideParams.UpdateUserRequest.jsonOrThrow(_body, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
    ...
    private async __listConnections(
        ...
        if (_response.ok) {
            return {
                data: serializers.clientSideParams.service.listConnections.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getConnection(
        ...
        if (_response.ok) {
            return {
                data: serializers.clientSideParams.Connection.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __listClients(
        ...
        const { fields, includeFields, page, perPage, includeTotals, isGlobal, isFirstParty, appType } = request;
        const _queryParams: Record<string, unknown> = {
            fields,
            include_fields: includeFields,
            page,
        ...
        if (_response.ok) {
            return {
                data: serializers.clientSideParams.PaginatedClientResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getClient(
        ...
        const { clientId, fields, includeFields } = request;
        const _queryParams: Record<string, unknown> = {
            fields,
            include_fields: includeFields,
        };
        ...
        if (_response.ok) {
            return {
                data: serializers.clientSideParams.Client.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
