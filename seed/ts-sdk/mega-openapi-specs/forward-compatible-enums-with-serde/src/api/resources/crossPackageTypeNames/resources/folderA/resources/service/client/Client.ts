...
export class ServiceClient {
    ...
    ): core.HttpResponsePromise<SeedApi.crossPackageTypeNames.FolderAResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getDirectThread(requestOptions));
    }

    private async __getDirectThread(
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.crossPackageTypeNames.FolderAResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.crossPackageTypeNames.FolderAResponse.parseOrThrow(_response.body, {
