...
export class ServiceClient {
    ...
    ): core.HttpResponsePromise<SeedApi.crossPackageTypeNames.FolderDResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getDirectThread(requestOptions));
    }

    private async __getDirectThread(
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.crossPackageTypeNames.FolderDResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.crossPackageTypeNames.FolderDResponse.parseOrThrow(_response.body, {
