...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.multiUrlEnvironmentReference.AuthGetTokenResponse> {
    ...
    private async __gettoken(
        request: SeedApi.multiUrlEnvironmentReference.AuthGetTokenRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.multiUrlEnvironmentReference.AuthGetTokenResponse>> {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.multiUrlEnvironmentReference.AuthGetTokenRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.multiUrlEnvironmentReference.AuthGetTokenResponse.parseOrThrow(_response.body, {
