...
export class S3Client {
    ...
    private async __getPresignedUrl(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.multiUrlEnvironment.GetPresignedUrlS3Request.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.multiUrlEnvironment.s3.getPresignedUrl.Response.parseOrThrow(_response.body, {
