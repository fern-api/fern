...
export class PlaylistClient {
    ...
    private async __createPlaylist(
        ...
        const { serviceParam, datetime, optionalDatetime, ..._body } = request;
    ...
    private async __getPlaylist(
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 401:
                    throw new SeedApi.trace.UnauthorizedError(_response.error.body as unknown, _response.rawResponse);
                case 404:
                    throw new SeedApi.trace.NotFoundError(_response.error.body as unknown, _response.rawResponse);
                default:
                    throw new errors.SeedApiError({
                        statusCode: _response.error.statusCode,
                        body: _response.error.body,
