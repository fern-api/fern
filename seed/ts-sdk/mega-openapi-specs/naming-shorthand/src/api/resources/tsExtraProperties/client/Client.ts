...
export class TsExtraPropertiesClient {
    ...
    ): core.HttpResponsePromise<acme.tsExtraProperties.User> {
        return core.HttpResponsePromise.fromPromise(this.__getUser(requestOptions));
    }

    private async __getUser(
        requestOptions?: TsExtraPropertiesClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.tsExtraProperties.User>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.tsExtraProperties.User, rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {acme.tsExtraProperties.CreateUserRequest} request
     * @param {TsExtraPropertiesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
