...
export class AuthClient {
    ...
    /**
     * @param {acme.oauthClientCredentialsReference.GetTokenRequest} request
    ...
    ): core.HttpResponsePromise<acme.oauthClientCredentialsReference.TokenResponse> {
    ...
    private async __getToken(
        request: acme.oauthClientCredentialsReference.GetTokenRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.oauthClientCredentialsReference.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.oauthClientCredentialsReference.TokenResponse,
