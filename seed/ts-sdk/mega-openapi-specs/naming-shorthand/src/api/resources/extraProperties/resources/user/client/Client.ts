...
export class UserClient {
    ...
    /**
     * @param {acme.extraProperties.CreateUserUserRequest} request
    ...
    ): core.HttpResponsePromise<acme.extraProperties.User> {
    ...
    private async __createUser(
        request: acme.extraProperties.CreateUserUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.extraProperties.User>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.extraProperties.User, rawResponse: _response.rawResponse };
        }
