...
export class JavaDefaultTimeoutClient {
    ...
    ): core.HttpResponsePromise<acme.javaDefaultTimeout.User> {
        return core.HttpResponsePromise.fromPromise(this.__getUser(requestOptions));
    }

    private async __getUser(
        requestOptions?: JavaDefaultTimeoutClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.javaDefaultTimeout.User>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.javaDefaultTimeout.User, rawResponse: _response.rawResponse };
        }
