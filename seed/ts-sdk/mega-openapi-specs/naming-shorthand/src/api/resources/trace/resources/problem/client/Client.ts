...
export class ProblemClient {
     ...
     * Creates a problem
     *
     * @param {acme.trace.CreateProblemRequest} request
    ...
    public createProblem(
        request: acme.trace.CreateProblemRequest,
        requestOptions?: ProblemClient.RequestOptions,
    ): core.HttpResponsePromise<acme.trace.CreateProblemResponse> {
    ...
    private async __createProblem(
        request: acme.trace.CreateProblemRequest,
        requestOptions?: ProblemClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.trace.CreateProblemResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.trace.CreateProblemResponse, rawResponse: _response.rawResponse };
        }
     ...
     * Updates a problem
     *
     * @param {acme.trace.UpdateProblemProblemRequest} request
     * @param {ProblemClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public updateProblem(
        ...
        requestOptions?: ProblemClient.RequestOptions,
    ): core.HttpResponsePromise<acme.trace.UpdateProblemResponse> {
    ...
    private async __updateProblem(
        request: acme.trace.UpdateProblemProblemRequest,
        requestOptions?: ProblemClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.trace.UpdateProblemResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.trace.UpdateProblemResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {acme.trace.DeleteProblemProblemRequest} request
     * @param {ProblemClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {acme.trace.GetDefaultStarterFilesProblemRequest} request
     * @param {ProblemClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public getDefaultStarterFiles(
        ...
        requestOptions?: ProblemClient.RequestOptions,
    ): core.HttpResponsePromise<acme.trace.GetDefaultStarterFilesResponse> {
    ...
    private async __getDefaultStarterFiles(
        request: acme.trace.GetDefaultStarterFilesProblemRequest,
        requestOptions?: ProblemClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.trace.GetDefaultStarterFilesResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.trace.GetDefaultStarterFilesResponse,
                rawResponse: _response.rawResponse,
            };
        }
