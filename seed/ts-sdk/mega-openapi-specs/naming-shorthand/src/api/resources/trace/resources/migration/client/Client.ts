...
export class MigrationClient {
    ...
    /**
     * @param {acme.trace.GetAttemptedMigrationsMigrationRequest} request
    ...
    ): core.HttpResponsePromise<acme.trace.Migration[]> {
    ...
    private async __getAttemptedMigrations(
        request: acme.trace.GetAttemptedMigrationsMigrationRequest,
        requestOptions?: MigrationClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.trace.Migration[]>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.trace.Migration[], rawResponse: _response.rawResponse };
        }
