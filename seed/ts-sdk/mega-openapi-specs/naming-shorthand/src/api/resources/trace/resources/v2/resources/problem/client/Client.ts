...
export class ProblemClient {
    ...
    ): core.HttpResponsePromise<acme.trace.V2LightweightProblemInfoV2[]> {
    ...
    private async __getLightweightProblems(
        requestOptions?: ProblemClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.trace.V2LightweightProblemInfoV2[]>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.trace.V2LightweightProblemInfoV2[],
    ...
    public getProblems(
        requestOptions?: ProblemClient.RequestOptions,
    ): core.HttpResponsePromise<acme.trace.V2ProblemInfoV2[]> {
        return core.HttpResponsePromise.fromPromise(this.__getProblems(requestOptions));
    }

    private async __getProblems(
        requestOptions?: ProblemClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.trace.V2ProblemInfoV2[]>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        if (_response.ok) {
            return { data: _response.body as acme.trace.V2ProblemInfoV2[], rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {acme.trace.v2.GetLatestProblemProblemRequest} request
     * @param {ProblemClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {acme.trace.v2.GetProblemVersionProblemRequest} request
     * @param {ProblemClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
