...
export class PlaylistClient {
     ...
     *
     * @param {acme.trace.CreatePlaylistPlaylistRequest} request
    ...
    ): core.HttpResponsePromise<acme.trace.Playlist> {
    ...
    private async __createPlaylist(
        request: acme.trace.CreatePlaylistPlaylistRequest,
        requestOptions?: PlaylistClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.trace.Playlist>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.trace.Playlist, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {acme.trace.GetPlaylistsPlaylistRequest} request
     * @param {PlaylistClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     * Returns a playlist
     *
     * @param {acme.trace.GetPlaylistPlaylistRequest} request
     * @param {PlaylistClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link acme.trace.UnauthorizedError}
     * @throws {@link acme.trace.NotFoundError}
     *
     * @example
    ...
    private async __getPlaylist(
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 401:
                    throw new acme.trace.UnauthorizedError(_response.error.body as unknown, _response.rawResponse);
                case 404:
                    throw new acme.trace.NotFoundError(_response.error.body as unknown, _response.rawResponse);
                default:
                    throw new errors.AcmeError({
                        statusCode: _response.error.statusCode,
                        body: _response.error.body,
     ...
     * Updates a playlist
     *
     * @param {acme.trace.UpdatePlaylistPlaylistRequest} request
     * @param {PlaylistClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link acme.trace.NotFoundError}
     *
    ...
    public updatePlaylist(
        ...
        requestOptions?: PlaylistClient.RequestOptions,
    ): core.HttpResponsePromise<acme.trace.Playlist | null> {
    ...
    private async __updatePlaylist(
        request: acme.trace.UpdatePlaylistPlaylistRequest,
        requestOptions?: PlaylistClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.trace.Playlist | null>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.trace.Playlist | null, rawResponse: _response.rawResponse };
        }
     ...
     * Deletes a playlist
     *
     * @param {acme.trace.DeletePlaylistPlaylistRequest} request
     * @param {PlaylistClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
