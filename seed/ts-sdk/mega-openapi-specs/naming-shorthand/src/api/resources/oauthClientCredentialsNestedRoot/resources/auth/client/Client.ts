...
export class AuthClient {
    ...
    /**
     * @param {acme.oauthClientCredentialsNestedRoot.GetTokenAuthRequest} request
    ...
    ): core.HttpResponsePromise<acme.oauthClientCredentialsNestedRoot.AuthTokenResponse> {
    ...
    private async __getToken(
        request: acme.oauthClientCredentialsNestedRoot.GetTokenAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.oauthClientCredentialsNestedRoot.AuthTokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.oauthClientCredentialsNestedRoot.AuthTokenResponse,
