...
export class AuthClient {
    ...
    /**
     * @param {acme.oauthClientCredentialsWithVariables.GetTokenWithClientCredentialsAuthRequest} request
    ...
    ): core.HttpResponsePromise<acme.oauthClientCredentialsWithVariables.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: acme.oauthClientCredentialsWithVariables.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.oauthClientCredentialsWithVariables.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.oauthClientCredentialsWithVariables.TokenResponse,
    ...
    /**
     * @param {acme.oauthClientCredentialsWithVariables.RefreshTokenAuthRequest} request
     * @param {AuthClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
