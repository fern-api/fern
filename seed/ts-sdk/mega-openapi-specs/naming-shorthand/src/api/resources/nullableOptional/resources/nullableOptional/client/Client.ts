...
export class NullableOptionalClient {
     ...
     * Get a user by ID
     *
     * @param {acme.nullableOptional.GetUserNullableOptionalRequest} request
    ...
    ): core.HttpResponsePromise<acme.nullableOptional.UserResponse> {
    ...
    private async __getUser(
        request: acme.nullableOptional.GetUserNullableOptionalRequest,
        requestOptions?: NullableOptionalClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.nullableOptional.UserResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.nullableOptional.UserResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {acme.nullableOptional.UpdateUserRequest} request
     * @param {NullableOptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     * List all users
     *
     * @param {acme.nullableOptional.ListUsersNullableOptionalRequest} request
     * @param {NullableOptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     * Create a new user
     *
     * @param {acme.nullableOptional.CreateUserRequest} request
     * @param {NullableOptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     * Search users
     *
     * @param {acme.nullableOptional.SearchUsersNullableOptionalRequest} request
     * @param {NullableOptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {acme.nullableOptional.ComplexProfile} request
     * @param {NullableOptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public createComplexProfile(
        request: acme.nullableOptional.ComplexProfile,
        requestOptions?: NullableOptionalClient.RequestOptions,
    ): core.HttpResponsePromise<acme.nullableOptional.ComplexProfile> {
    ...
    private async __createComplexProfile(
        request: acme.nullableOptional.ComplexProfile,
        requestOptions?: NullableOptionalClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.nullableOptional.ComplexProfile>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        if (_response.ok) {
            return { data: _response.body as acme.nullableOptional.ComplexProfile, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {acme.nullableOptional.GetComplexProfileNullableOptionalRequest} request
     * @param {NullableOptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {acme.nullableOptional.UpdateComplexProfileNullableOptionalRequest} request
     * @param {NullableOptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {acme.nullableOptional.DeserializationTestRequest} request
     * @param {NullableOptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public testDeserialization(
        request: acme.nullableOptional.DeserializationTestRequest,
        requestOptions?: NullableOptionalClient.RequestOptions,
    ): core.HttpResponsePromise<acme.nullableOptional.DeserializationTestResponse> {
    ...
    private async __testDeserialization(
        request: acme.nullableOptional.DeserializationTestRequest,
        requestOptions?: NullableOptionalClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.nullableOptional.DeserializationTestResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.nullableOptional.DeserializationTestResponse,
                rawResponse: _response.rawResponse,
            };
        }
     ...
     *
     * @param {acme.nullableOptional.FilterByRoleNullableOptionalRequest} request
     * @param {NullableOptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {acme.nullableOptional.GetNotificationSettingsNullableOptionalRequest} request
     * @param {NullableOptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public getNotificationSettings(
        ...
        requestOptions?: NullableOptionalClient.RequestOptions,
    ): core.HttpResponsePromise<acme.nullableOptional.NotificationMethod | null> {
    ...
    private async __getNotificationSettings(
        request: acme.nullableOptional.GetNotificationSettingsNullableOptionalRequest,
        requestOptions?: NullableOptionalClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.nullableOptional.NotificationMethod | null>> {
        const { userId } = request;
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.nullableOptional.NotificationMethod | null,
                rawResponse: _response.rawResponse,
            };
        }
     ...
     *
     * @param {acme.nullableOptional.UpdateTagsNullableOptionalRequest} request
     * @param {NullableOptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {acme.nullableOptional.GetSearchResultsNullableOptionalRequest} request
     * @param {NullableOptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public getSearchResults(
        ...
        requestOptions?: NullableOptionalClient.RequestOptions,
    ): core.HttpResponsePromise<acme.nullableOptional.SearchResult[] | null> {
    ...
    private async __getSearchResults(
        request: acme.nullableOptional.GetSearchResultsNullableOptionalRequest,
        requestOptions?: NullableOptionalClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.nullableOptional.SearchResult[] | null>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.nullableOptional.SearchResult[] | null,
                rawResponse: _response.rawResponse,
            };
        }
