...
export class MultipleRequestBodiesClient {
    ...
    /**
     * @param {acme.multipleRequestBodies.UploadJsonDocumentRequest} request
    ...
    ): core.HttpResponsePromise<acme.multipleRequestBodies.UploadDocumentResponse> {
    ...
    private async __uploadJsonDocument(
        request: acme.multipleRequestBodies.UploadJsonDocumentRequest = {},
        requestOptions?: MultipleRequestBodiesClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.multipleRequestBodies.UploadDocumentResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.multipleRequestBodies.UploadDocumentResponse,
