...
export class ImdbClient {
     ...
     *
     * @param {acme.tsExpressCasing.CreateMovieImdbRequest} request
    ...
    ): core.HttpResponsePromise<acme.tsExpressCasing.MovieId> {
    ...
    private async __createMovie(
        request: acme.tsExpressCasing.CreateMovieImdbRequest,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.tsExpressCasing.MovieId>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.tsExpressCasing.MovieId, rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {acme.tsExpressCasing.GetMovieImdbRequest} request
     * @param {ImdbClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link acme.tsExpressCasing.NotFoundError}
     *
     * @example
    ...
    public getMovie(
        ...
        requestOptions?: ImdbClient.RequestOptions,
    ): core.HttpResponsePromise<acme.tsExpressCasing.Movie> {
    ...
    private async __getMovie(
        request: acme.tsExpressCasing.GetMovieImdbRequest,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.tsExpressCasing.Movie>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.tsExpressCasing.Movie, rawResponse: _response.rawResponse };
        }

        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 404:
                    throw new acme.tsExpressCasing.NotFoundError(
