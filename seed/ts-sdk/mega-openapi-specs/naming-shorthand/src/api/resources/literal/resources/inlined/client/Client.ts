...
export class InlinedClient {
    ...
    /**
     * @param {acme.literal.SendInlinedRequest} request
    ...
    ): core.HttpResponsePromise<acme.literal.SendResponse> {
    ...
    private async __send(
        request: acme.literal.SendInlinedRequest,
        requestOptions?: InlinedClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.literal.SendResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.literal.SendResponse, rawResponse: _response.rawResponse };
        }
