...
export class InlinedRequestsClient {
     ...
     *
     * @param {acme.exhaustive.PostWithObjectBodyandResponseInlinedRequestsRequest} request
     * @param {InlinedRequestsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link acme.exhaustive.BadRequestError}
     *
     * @example
    ...
    private async __postWithObjectBodyandResponse(
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 400:
                    throw new acme.exhaustive.BadRequestError(_response.error.body as unknown, _response.rawResponse);
                default:
