...
export class EnumClient {
    ...
    /**
     * @param {acme.exhaustive.TypesWeatherReport} request
    ...
    public getAndReturnEnum(
        request: acme.exhaustive.TypesWeatherReport,
        requestOptions?: EnumClient.RequestOptions,
    ): core.HttpResponsePromise<acme.exhaustive.TypesWeatherReport> {
    ...
    private async __getAndReturnEnum(
        request: acme.exhaustive.TypesWeatherReport,
        requestOptions?: EnumClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.exhaustive.TypesWeatherReport>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.exhaustive.TypesWeatherReport, rawResponse: _response.rawResponse };
        }
