...
export class UnionClient {
    ...
    /**
     * @param {acme.exhaustive.TypesAnimal} request
    ...
    public getAndReturnUnion(
        request: acme.exhaustive.TypesAnimal,
        requestOptions?: UnionClient.RequestOptions,
    ): core.HttpResponsePromise<acme.exhaustive.TypesAnimal> {
    ...
    private async __getAndReturnUnion(
        request: acme.exhaustive.TypesAnimal,
        requestOptions?: UnionClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.exhaustive.TypesAnimal>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.exhaustive.TypesAnimal, rawResponse: _response.rawResponse };
        }
