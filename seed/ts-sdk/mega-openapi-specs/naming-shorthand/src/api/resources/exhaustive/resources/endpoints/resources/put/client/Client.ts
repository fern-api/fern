...
export class PutClient {
    ...
    /**
     * @param {acme.exhaustive.endpoints.AddPutRequest} request
    ...
    ): core.HttpResponsePromise<acme.exhaustive.EndpointsPutResponse> {
    ...
    private async __add(
        request: acme.exhaustive.endpoints.AddPutRequest,
        requestOptions?: PutClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.exhaustive.EndpointsPutResponse>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as acme.exhaustive.EndpointsPutResponse, rawResponse: _response.rawResponse };
        }
