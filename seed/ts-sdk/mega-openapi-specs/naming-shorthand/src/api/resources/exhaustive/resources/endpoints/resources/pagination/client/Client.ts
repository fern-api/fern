...
export class PaginationClient {
     ...
     *
     * @param {acme.exhaustive.endpoints.ListItemsPaginationRequest} request
    ...
    ): core.HttpResponsePromise<acme.exhaustive.EndpointsPaginatedResponse> {
    ...
    private async __listItems(
        request: acme.exhaustive.endpoints.ListItemsPaginationRequest = {},
        requestOptions?: PaginationClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.exhaustive.EndpointsPaginatedResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.exhaustive.EndpointsPaginatedResponse,
