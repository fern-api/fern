...
export class UserClient {
    ...
    /**
     * @param {acme.simpleApi.GetUserRequest} request
    ...
    ): core.HttpResponsePromise<acme.simpleApi.User> {
    ...
    private async __get(
        request: acme.simpleApi.GetUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.simpleApi.User>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as acme.simpleApi.User, rawResponse: _response.rawResponse };
        }
