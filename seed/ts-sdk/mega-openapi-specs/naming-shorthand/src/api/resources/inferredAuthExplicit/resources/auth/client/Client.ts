...
export class AuthClient {
    ...
    /**
     * @param {acme.inferredAuthExplicit.GetTokenWithClientCredentialsAuthRequest} request
    ...
    ): core.HttpResponsePromise<acme.inferredAuthExplicit.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: acme.inferredAuthExplicit.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.inferredAuthExplicit.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.inferredAuthExplicit.TokenResponse,
    ...
    /**
     * @param {acme.inferredAuthExplicit.RefreshTokenAuthRequest} request
     * @param {AuthClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
