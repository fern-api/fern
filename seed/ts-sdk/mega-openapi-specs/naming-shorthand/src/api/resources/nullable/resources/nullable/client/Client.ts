...
export class NullableClient {
    ...
    /**
     * @param {acme.nullable.GetUsersNullableRequest} request
    ...
    ): core.HttpResponsePromise<acme.nullable.User[]> {
    ...
    private async __getUsers(
        request: acme.nullable.GetUsersNullableRequest = {},
        requestOptions?: NullableClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.nullable.User[]>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.nullable.User[], rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {acme.nullable.CreateUserNullableRequest} request
     * @param {NullableClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    /**
     * @param {acme.nullable.DeleteUserNullableRequest} request
     * @param {NullableClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
