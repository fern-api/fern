...
export class ServiceClient {
    ...
    ): core.HttpResponsePromise<acme.crossPackageTypeNames.FolderAResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getDirectThread(requestOptions));
    }

    private async __getDirectThread(
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.crossPackageTypeNames.FolderAResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.crossPackageTypeNames.FolderAResponse,
