...
export class ServiceClient {
    ...
    ): core.HttpResponsePromise<acme.crossPackageTypeNames.FolderDResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getDirectThread(requestOptions));
    }

    private async __getDirectThread(
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.crossPackageTypeNames.FolderDResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.crossPackageTypeNames.FolderDResponse,
