...
export class OptionalClient {
    ...
    /**
     * @param {acme.optional.SendOptionalBodyRequest | null} request
     * @param {OptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public sendOptionalTypedBody(
        request: acme.optional.SendOptionalBodyRequest | null,
        requestOptions?: OptionalClient.RequestOptions,
    ): core.HttpResponsePromise<string> {
     ...
     *
     * @param {acme.optional.SendOptionalNullableWithAllOptionalPropertiesOptionalRequest} request
     * @param {OptionalClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public sendOptionalNullableWithAllOptionalProperties(
        ...
        requestOptions?: OptionalClient.RequestOptions,
    ): core.HttpResponsePromise<acme.optional.DeployResponse> {
    ...
    private async __sendOptionalNullableWithAllOptionalProperties(
        request: acme.optional.SendOptionalNullableWithAllOptionalPropertiesOptionalRequest,
        requestOptions?: OptionalClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.optional.DeployResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.optional.DeployResponse, rawResponse: _response.rawResponse };
        }
