...
export class UserClient {
    ...
    /**
     * @param {acme.queryParameters.GetUsernameUserRequest} request
    ...
    ): core.HttpResponsePromise<acme.queryParameters.User> {
    ...
    private async __getUsername(
        request: acme.queryParameters.GetUsernameUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.queryParameters.User>> {
        const {
            limit,
            id,
            date,
        ...
        if (_response.ok) {
            return { data: _response.body as acme.queryParameters.User, rawResponse: _response.rawResponse };
        }
