...
export class UserClient {
    ...
    /**
     * @param {acme.requestParameters.CreateUsernameUserRequest} request
    ...
    /**
     * @param {acme.requestParameters.CreateUsernameBody} request
     * @param {UserClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    /**
     * @param {acme.requestParameters.CreateUsernameBodyOptionalProperties | null} request
     * @param {UserClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public createUsernameOptional(
        request: acme.requestParameters.CreateUsernameBodyOptionalProperties | null,
        requestOptions?: UserClient.RequestOptions,
    ): core.HttpResponsePromise<void> {
    ...
    /**
     * @param {acme.requestParameters.GetUsernameUserRequest} request
     * @param {UserClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public getUsername(
        ...
        requestOptions?: UserClient.RequestOptions,
    ): core.HttpResponsePromise<acme.requestParameters.User> {
    ...
    private async __getUsername(
        request: acme.requestParameters.GetUsernameUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.requestParameters.User>> {
        const {
            limit,
            id,
            date,
        ...
        if (_response.ok) {
            return { data: _response.body as acme.requestParameters.User, rawResponse: _response.rawResponse };
        }
