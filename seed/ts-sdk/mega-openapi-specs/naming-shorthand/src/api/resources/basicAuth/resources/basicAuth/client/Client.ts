...
export class BasicAuthClient {
     ...
     *
     * @throws {@link acme.basicAuth.UnauthorizedError}
     *
     * @example
    ...
    private async __getWithBasicAuth(
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 401:
                    throw new acme.basicAuth.UnauthorizedError(_response.error.body as unknown, _response.rawResponse);
                default:
     ...
     * @param {BasicAuthClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link acme.basicAuth.BadRequestError}
     * @throws {@link acme.basicAuth.UnauthorizedError}
     *
     * @example
    ...
    private async __postWithBasicAuth(
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 400:
                    throw new acme.basicAuth.BadRequestError(_response.error.body as unknown, _response.rawResponse);
                case 401:
                    throw new acme.basicAuth.UnauthorizedError(_response.error.body as unknown, _response.rawResponse);
                default:
                    throw new errors.AcmeError({
