...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<acme.inferredAuthImplicitApiKey.TokenResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getToken(requestOptions));
    }

    private async __getToken(
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.inferredAuthImplicitApiKey.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.inferredAuthImplicitApiKey.TokenResponse,
