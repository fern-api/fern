...
export class UserClient {
    ...
    /**
     * @param {acme.versionNoDefault.GetUserUserRequest} request
    ...
    ): core.HttpResponsePromise<acme.versionNoDefault.User> {
    ...
    private async __getUser(
        request: acme.versionNoDefault.GetUserUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.versionNoDefault.User>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.versionNoDefault.User, rawResponse: _response.rawResponse };
        }
