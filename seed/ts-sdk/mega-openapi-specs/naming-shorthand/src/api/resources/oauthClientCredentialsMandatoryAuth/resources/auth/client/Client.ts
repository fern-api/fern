...
export class AuthClient {
    ...
    /**
     * @param {acme.oauthClientCredentialsMandatoryAuth.GetTokenWithClientCredentialsAuthRequest} request
    ...
    ): core.HttpResponsePromise<acme.oauthClientCredentialsMandatoryAuth.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: acme.oauthClientCredentialsMandatoryAuth.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.oauthClientCredentialsMandatoryAuth.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.oauthClientCredentialsMandatoryAuth.TokenResponse,
    ...
    /**
     * @param {acme.oauthClientCredentialsMandatoryAuth.RefreshTokenAuthRequest} request
     * @param {AuthClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
