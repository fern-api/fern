...
export class AuthClient {
    ...
    /**
     * @param {acme.oauthClientCredentialsCustom.GetTokenWithClientCredentialsAuthRequest} request
    ...
    ): core.HttpResponsePromise<acme.oauthClientCredentialsCustom.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: acme.oauthClientCredentialsCustom.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.oauthClientCredentialsCustom.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.oauthClientCredentialsCustom.TokenResponse,
    ...
    /**
     * @param {acme.oauthClientCredentialsCustom.RefreshTokenAuthRequest} request
     * @param {AuthClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
