...
export class AuthClient {
    ...
    /**
     * @param {acme.inferredAuthImplicit.GetTokenWithClientCredentialsAuthRequest} request
    ...
    ): core.HttpResponsePromise<acme.inferredAuthImplicit.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: acme.inferredAuthImplicit.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.inferredAuthImplicit.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.inferredAuthImplicit.TokenResponse,
    ...
    /**
     * @param {acme.inferredAuthImplicit.RefreshTokenAuthRequest} request
     * @param {AuthClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
