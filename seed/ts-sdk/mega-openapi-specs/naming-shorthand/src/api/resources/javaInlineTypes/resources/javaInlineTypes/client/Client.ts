...
export class JavaInlineTypesClient {
    ...
    /**
     * @param {acme.javaInlineTypes.GetRootRequest} request
    ...
    ): core.HttpResponsePromise<acme.javaInlineTypes.RootType1> {
    ...
    private async __getRoot(
        request: acme.javaInlineTypes.GetRootRequest,
        requestOptions?: JavaInlineTypesClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.javaInlineTypes.RootType1>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.javaInlineTypes.RootType1, rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {acme.javaInlineTypes.GetDiscriminatedUnionRequest} request
     * @param {JavaInlineTypesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    /**
     * @param {acme.javaInlineTypes.GetUndiscriminatedUnionRequest} request
     * @param {JavaInlineTypesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
