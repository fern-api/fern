...
export class UserClient {
     ...
     * List all users.
     *
     * @param {acme.mixedFileDirectory.ListUserRequest} request
    ...
    ): core.HttpResponsePromise<acme.mixedFileDirectory.User[]> {
    ...
    private async __list(
        request: acme.mixedFileDirectory.ListUserRequest = {},
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.mixedFileDirectory.User[]>> {
        const { limit } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as acme.mixedFileDirectory.User[], rawResponse: _response.rawResponse };
        }
