...
export class DummyClient {
    ...
    /**
     * @param {acme.javaStreamingAcceptHeader.GenerateStreamDummyRequest} request
     * @param {DummyClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link acme.javaStreamingAcceptHeader.BadRequestError}
     *
     * @example
    ...
    private async __generateStream(
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 400:
                    throw new acme.javaStreamingAcceptHeader.BadRequestError(
    ...
    /**
     * @param {acme.javaStreamingAcceptHeader.GenerateDummyRequest} request
     * @param {DummyClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link acme.javaStreamingAcceptHeader.BadRequestError}
     *
    ...
    public generate(
        ...
        requestOptions?: DummyClient.RequestOptions,
    ): core.HttpResponsePromise<acme.javaStreamingAcceptHeader.StreamResponse> {
    ...
    private async __generate(
        request: acme.javaStreamingAcceptHeader.GenerateDummyRequest,
        requestOptions?: DummyClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.javaStreamingAcceptHeader.StreamResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.javaStreamingAcceptHeader.StreamResponse,
                rawResponse: _response.rawResponse,
            };
        }
