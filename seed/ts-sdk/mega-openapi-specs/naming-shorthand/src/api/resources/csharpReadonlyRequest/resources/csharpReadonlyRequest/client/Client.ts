...
export class CsharpReadonlyRequestClient {
    ...
    /**
     * @param {acme.csharpReadonlyRequest.CreateVendorRequest} request
    ...
    ): core.HttpResponsePromise<acme.csharpReadonlyRequest.CreateVendorResponse> {
    ...
    private async __batchCreate(
        request: acme.csharpReadonlyRequest.CreateVendorRequest,
        requestOptions?: CsharpReadonlyRequestClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.csharpReadonlyRequest.CreateVendorResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.csharpReadonlyRequest.CreateVendorResponse,
