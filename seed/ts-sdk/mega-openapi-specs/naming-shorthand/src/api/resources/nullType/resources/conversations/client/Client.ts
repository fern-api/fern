...
export class ConversationsClient {
     ...
     *
     * @param {acme.nullType.OutboundCallConversationsRequest} request
    ...
    ): core.HttpResponsePromise<acme.nullType.OutboundCallConversationsResponse> {
    ...
    private async __outboundCall(
        request: acme.nullType.OutboundCallConversationsRequest,
        requestOptions?: ConversationsClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.nullType.OutboundCallConversationsResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.nullType.OutboundCallConversationsResponse,
