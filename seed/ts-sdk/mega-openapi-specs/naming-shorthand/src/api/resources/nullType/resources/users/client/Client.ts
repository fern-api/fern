...
export class UsersClient {
     ...
     *
     * @param {acme.nullType.GetUsersRequest} request
    ...
    ): core.HttpResponsePromise<acme.nullType.User> {
    ...
    private async __get(
        request: acme.nullType.GetUsersRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.nullType.User>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as acme.nullType.User, rawResponse: _response.rawResponse };
        }
