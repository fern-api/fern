...
export class UsersClient {
    ...
    ): core.HttpResponsePromise<acme.paginationUriPath.ListUsersUriPaginationResponse> {
    ...
    private async __listWithUriPagination(
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.paginationUriPath.ListUsersUriPaginationResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.paginationUriPath.ListUsersUriPaginationResponse,
    ...
    public listWithPathPagination(
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<acme.paginationUriPath.ListUsersPathPaginationResponse> {
    ...
    private async __listWithPathPagination(
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.paginationUriPath.ListUsersPathPaginationResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.paginationUriPath.ListUsersPathPaginationResponse,
                rawResponse: _response.rawResponse,
            };
        }
