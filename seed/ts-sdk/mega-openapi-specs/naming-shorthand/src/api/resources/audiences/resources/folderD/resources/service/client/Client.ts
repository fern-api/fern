...
export class ServiceClient {
    ...
    ): core.HttpResponsePromise<acme.audiences.FolderDResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getDirectThread(requestOptions));
    }

    private async __getDirectThread(
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.audiences.FolderDResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.audiences.FolderDResponse, rawResponse: _response.rawResponse };
        }
