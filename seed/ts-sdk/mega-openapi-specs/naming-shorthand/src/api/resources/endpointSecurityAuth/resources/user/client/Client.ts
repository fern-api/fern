...
export class UserClient {
    ...
    ): core.HttpResponsePromise<acme.endpointSecurityAuth.User[]> {
        return core.HttpResponsePromise.fromPromise(this.__getWithBearer(requestOptions));
    }

    private async __getWithBearer(
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.endpointSecurityAuth.User[]>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.endpointSecurityAuth.User[], rawResponse: _response.rawResponse };
        }
