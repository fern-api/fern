...
export class NullableAllofExtendsClient {
    ...
    ): core.HttpResponsePromise<acme.nullableAllofExtends.RootObject> {
        return core.HttpResponsePromise.fromPromise(this.__getTest(requestOptions));
    }

    private async __getTest(
        requestOptions?: NullableAllofExtendsClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.nullableAllofExtends.RootObject>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.nullableAllofExtends.RootObject, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {acme.nullableAllofExtends.RootObject} request
     * @param {NullableAllofExtendsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     */
    public createTest(
        request: acme.nullableAllofExtends.RootObject,
        requestOptions?: NullableAllofExtendsClient.RequestOptions,
    ): core.HttpResponsePromise<acme.nullableAllofExtends.RootObject> {
