...
export class PutClient {
    ...
    /**
     * @param {acme.goDeterministicOrdering.endpoints.AddPutRequest} request
    ...
    ): core.HttpResponsePromise<acme.goDeterministicOrdering.EndpointsPutResponse> {
    ...
    private async __add(
        request: acme.goDeterministicOrdering.endpoints.AddPutRequest,
        requestOptions?: PutClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.goDeterministicOrdering.EndpointsPutResponse>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.goDeterministicOrdering.EndpointsPutResponse,
