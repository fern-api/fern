...
export class TestGroupClient {
     ...
     *
     * @param {acme.nullableRequestBody.TestMethodNameTestGroupRequest} request
     * @param {TestGroupClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link acme.nullableRequestBody.UnprocessableEntityError}
     *
     * @example
    ...
    private async __testMethodName(
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 422:
                    throw new acme.nullableRequestBody.UnprocessableEntityError(
                        _response.error.body as acme.nullableRequestBody.PlainObject,
