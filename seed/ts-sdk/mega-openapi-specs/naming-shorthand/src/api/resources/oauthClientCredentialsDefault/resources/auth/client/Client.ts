...
export class AuthClient {
    ...
    /**
     * @param {acme.oauthClientCredentialsDefault.GetTokenAuthRequest} request
    ...
    ): core.HttpResponsePromise<acme.oauthClientCredentialsDefault.TokenResponse> {
    ...
    private async __getToken(
        request: acme.oauthClientCredentialsDefault.GetTokenAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.oauthClientCredentialsDefault.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.oauthClientCredentialsDefault.TokenResponse,
