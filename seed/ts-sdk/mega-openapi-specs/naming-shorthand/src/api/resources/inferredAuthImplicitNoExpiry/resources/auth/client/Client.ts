...
export class AuthClient {
    ...
    /**
     * @param {acme.inferredAuthImplicitNoExpiry.GetTokenWithClientCredentialsAuthRequest} request
    ...
    ): core.HttpResponsePromise<acme.inferredAuthImplicitNoExpiry.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: acme.inferredAuthImplicitNoExpiry.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.inferredAuthImplicitNoExpiry.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.inferredAuthImplicitNoExpiry.TokenResponse,
    ...
    /**
     * @param {acme.inferredAuthImplicitNoExpiry.RefreshTokenAuthRequest} request
     * @param {AuthClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
