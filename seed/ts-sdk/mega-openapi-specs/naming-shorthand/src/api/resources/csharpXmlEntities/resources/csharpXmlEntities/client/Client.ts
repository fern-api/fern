...
export class CsharpXmlEntitiesClient {
    ...
    ): core.HttpResponsePromise<acme.csharpXmlEntities.TimeZoneModel> {
        return core.HttpResponsePromise.fromPromise(this.__getTimeZone(requestOptions));
    }

    private async __getTimeZone(
        requestOptions?: CsharpXmlEntitiesClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.csharpXmlEntities.TimeZoneModel>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.csharpXmlEntities.TimeZoneModel, rawResponse: _response.rawResponse };
        }
