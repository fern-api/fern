...
export class ImdbClient {
     ...
     *
     * @param {acme.imdb.CreateMovieRequest} request
    ...
    ): core.HttpResponsePromise<acme.imdb.MovieId> {
    ...
    private async __createMovie(
        request: acme.imdb.CreateMovieRequest,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.imdb.MovieId>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.imdb.MovieId, rawResponse: _response.rawResponse };
        }
     ...
     * @deprecated
     *
     * @param {acme.imdb.GetMovieImdbRequest} request
     * @param {ImdbClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link acme.imdb.NotFoundError}
     *
     * @example
    ...
    public getMovie(
        ...
        requestOptions?: ImdbClient.RequestOptions,
    ): core.HttpResponsePromise<acme.imdb.Movie> {
    ...
    private async __getMovie(
        request: acme.imdb.GetMovieImdbRequest,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.imdb.Movie>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.imdb.Movie, rawResponse: _response.rawResponse };
        }

        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 404:
                    throw new acme.imdb.NotFoundError(_response.error.body as unknown, _response.rawResponse);
                default:
                    throw new errors.AcmeError({
                        statusCode: _response.error.statusCode,
                        body: _response.error.body,
