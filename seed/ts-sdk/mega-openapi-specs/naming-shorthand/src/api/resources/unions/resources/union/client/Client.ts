...
export class UnionClient {
    ...
    /**
     * @param {acme.unions.GetUnionRequest} request
    ...
    ): core.HttpResponsePromise<acme.unions.Shape> {
    ...
    private async __get(
        request: acme.unions.GetUnionRequest,
        requestOptions?: UnionClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.unions.Shape>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as acme.unions.Shape, rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {acme.unions.Shape} request
     * @param {UnionClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
