...
export class BigunionClient {
    ...
    /**
     * @param {acme.unions.GetBigunionRequest} request
    ...
    ): core.HttpResponsePromise<acme.unions.BigUnion> {
    ...
    private async __get(
        request: acme.unions.GetBigunionRequest,
        requestOptions?: BigunionClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.unions.BigUnion>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as acme.unions.BigUnion, rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {acme.unions.BigUnion} request
     * @param {BigunionClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
