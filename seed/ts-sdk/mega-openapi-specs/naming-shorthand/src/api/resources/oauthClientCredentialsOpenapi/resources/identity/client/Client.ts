...
export class IdentityClient {
    ...
    /**
     * @param {acme.oauthClientCredentialsOpenapi.GetTokenIdentityRequest} request
    ...
    ): core.HttpResponsePromise<acme.oauthClientCredentialsOpenapi.TokenResponse> {
    ...
    private async __getToken(
        request: acme.oauthClientCredentialsOpenapi.GetTokenIdentityRequest,
        requestOptions?: IdentityClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.oauthClientCredentialsOpenapi.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.oauthClientCredentialsOpenapi.TokenResponse,
