...
export class AuthClient {
    ...
    /**
     * @param {acme.multiUrlEnvironmentReference.AuthGetTokenRequest} request
    ...
    ): core.HttpResponsePromise<acme.multiUrlEnvironmentReference.AuthGetTokenResponse> {
    ...
    private async __gettoken(
        request: acme.multiUrlEnvironmentReference.AuthGetTokenRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.multiUrlEnvironmentReference.AuthGetTokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.multiUrlEnvironmentReference.AuthGetTokenResponse,
