...
export class DummyClient {
    ...
    /**
     * @param {acme.streaming.GenerateStreamDummyRequest} request
    ...
    /**
     * @param {acme.streaming.GenerateDummyRequest} request
     * @param {DummyClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public generate(
        ...
        requestOptions?: DummyClient.RequestOptions,
    ): core.HttpResponsePromise<acme.streaming.StreamResponse> {
    ...
    private async __generate(
        request: acme.streaming.GenerateDummyRequest,
        requestOptions?: DummyClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.streaming.StreamResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        if (_response.ok) {
            return { data: _response.body as acme.streaming.StreamResponse, rawResponse: _response.rawResponse };
        }
