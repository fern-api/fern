...
export class BigunionClient {
    ...
    /**
     * @param {acme.unionsWithLocalDate.GetBigunionRequest} request
    ...
    ): core.HttpResponsePromise<acme.unionsWithLocalDate.BigUnion> {
    ...
    private async __get(
        request: acme.unionsWithLocalDate.GetBigunionRequest,
        requestOptions?: BigunionClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.unionsWithLocalDate.BigUnion>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as acme.unionsWithLocalDate.BigUnion, rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {acme.unionsWithLocalDate.BigUnion} request
     * @param {BigunionClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     */
    public update(
        request: acme.unionsWithLocalDate.BigUnion,
        requestOptions?: BigunionClient.RequestOptions,
