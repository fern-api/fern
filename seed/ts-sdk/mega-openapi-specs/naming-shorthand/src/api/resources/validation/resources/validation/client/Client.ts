...
export class ValidationClient {
    ...
    /**
     * @param {acme.validation.CreateRequest} request
    ...
    ): core.HttpResponsePromise<acme.validation.Type> {
    ...
    private async __create(
        request: acme.validation.CreateRequest,
        requestOptions?: ValidationClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.validation.Type>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.validation.Type, rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {acme.validation.GetRequest} request
     * @param {ValidationClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
