...
export class ComplexClient {
    ...
    /**
     * @param {acme.pagination.SearchRequest} request
    ...
    ): core.HttpResponsePromise<acme.pagination.PaginatedConversationResponse> {
    ...
    private async __search(
        request: acme.pagination.SearchRequest,
        requestOptions?: ComplexClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.pagination.PaginatedConversationResponse>> {
        const { index, ..._body } = request;
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.pagination.PaginatedConversationResponse,
