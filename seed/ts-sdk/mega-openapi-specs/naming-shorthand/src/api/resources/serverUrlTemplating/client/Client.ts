...
export class ServerUrlTemplatingClient {
    ...
    ): core.HttpResponsePromise<acme.serverUrlTemplating.User[]> {
        return core.HttpResponsePromise.fromPromise(this.__getUsers(requestOptions));
    }

    private async __getUsers(
        requestOptions?: ServerUrlTemplatingClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.serverUrlTemplating.User[]>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.serverUrlTemplating.User[], rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {acme.serverUrlTemplating.GetUserRequest} request
     * @param {ServerUrlTemplatingClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    /**
     * @param {acme.serverUrlTemplating.TokenRequest} request
     * @param {ServerUrlTemplatingClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     */
    public getToken(
        request: acme.serverUrlTemplating.TokenRequest,
        requestOptions?: ServerUrlTemplatingClient.RequestOptions,
    ): core.HttpResponsePromise<acme.serverUrlTemplating.TokenResponse> {
    ...
    private async __getToken(
        request: acme.serverUrlTemplating.TokenRequest,
        requestOptions?: ServerUrlTemplatingClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.serverUrlTemplating.TokenResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.serverUrlTemplating.TokenResponse,
                rawResponse: _response.rawResponse,
            };
        }
