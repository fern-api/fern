...
describe("ObjectClient", () => {
    test("getAndReturnWithOptionalField", async () => {
        ...
        const response = await client.exhaustive.endpoints.object.getAndReturnWithOptionalField({});
    ...
    test("getAndReturnWithRequiredField", async () => {
        ...
        const response = await client.exhaustive.endpoints.object.getAndReturnWithRequiredField({
            string: "uploaded",
        });
        expect(response).toEqual(rawResponseBody);
    });
    ...
    test("getAndReturnWithMapOfMap", async () => {
        ...
        const response = await client.exhaustive.endpoints.object.getAndReturnWithMapOfMap({
            map: {
                key: {
                    key: "value",
                },
    ...
    test("getAndReturnNestedWithOptionalField", async () => {
        ...
        const response = await client.exhaustive.endpoints.object.getAndReturnNestedWithOptionalField({});
        expect(response).toEqual(rawResponseBody);
    });
    ...
    test("getAndReturnNestedWithRequiredField", async () => {
        ...
        const response = await client.exhaustive.endpoints.object.getAndReturnNestedWithRequiredField("string", {
            body: {
                string: "string",
                NestedObject: {},
            },
    ...
    test("getAndReturnNestedWithRequiredFieldAsList", async () => {
        ...
        const response = await client.exhaustive.endpoints.object.getAndReturnNestedWithRequiredFieldAsList([
            {
                string: "string",
                NestedObject: {},
            },
    ...
    test("getAndReturnWithUnknownField", async () => {
        ...
        const response = await client.exhaustive.endpoints.object.getAndReturnWithUnknownField({
            unknown: {
    ...
    test("getAndReturnWithDocumentedUnknownType", async () => {
        ...
        const response = await client.exhaustive.endpoints.object.getAndReturnWithDocumentedUnknownType({
    ...
    test("getAndReturnMapOfDocumentedUnknownType", async () => {
        ...
        const response = await client.exhaustive.endpoints.object.getAndReturnMapOfDocumentedUnknownType({});
        expect(response).toEqual(rawResponseBody);
    });
    ...
    test("getAndReturnWithMixedRequiredAndOptionalFields", async () => {
        ...
        const response = await client.exhaustive.endpoints.object.getAndReturnWithMixedRequiredAndOptionalFields({
            requiredString: "hello",
            requiredInteger: 0,
            optionalString: "world",
            requiredLong: 0,
    ...
    test("getAndReturnWithRequiredNestedObject", async () => {
        ...
        const response = await client.exhaustive.endpoints.object.getAndReturnWithRequiredNestedObject({
            requiredString: "hello",
            requiredObject: {
                string: "nested",
                NestedObject: {},
    ...
    test("getAndReturnWithDatetimeLikeString", async () => {
        ...
        const response = await client.exhaustive.endpoints.object.getAndReturnWithDatetimeLikeString({
