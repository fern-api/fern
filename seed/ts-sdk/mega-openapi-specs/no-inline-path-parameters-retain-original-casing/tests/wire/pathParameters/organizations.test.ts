...
describe("OrganizationsClient", () => {
    test("getOrganization", async () => {
        ...
        const response = await client.pathParameters.organizations.getOrganization("tenant_id", "organization_id");
    ...
    test("searchOrganizations", async () => {
        ...
        const response = await client.pathParameters.organizations.searchOrganizations("tenant_id", "organization_id");
        expect(response).toEqual(rawResponseBody);
    });
});
