...
describe("SubmissionClient", () => {
    test("createExecutionSession", async () => {
        ...
        const response = await client.trace.submission.createExecutionSession("JAVA");
    ...
    test("getExecutionSession", async () => {
        ...
        const response = await client.trace.submission.getExecutionSession("sessionId");
        expect(response).toEqual(rawResponseBody);
    });
    ...
    test("stopExecutionSession", async () => {
        ...
        const response = await client.trace.submission.stopExecutionSession("sessionId");
