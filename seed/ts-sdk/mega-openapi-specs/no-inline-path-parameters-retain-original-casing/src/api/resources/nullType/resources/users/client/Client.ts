...
export class UsersClient {
     ...
     *
     * @example
     *     await client.nullType.users.get("id")
     */
    public get(
        id: string,
        request: SeedApi.nullType.GetUsersRequest = {},
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.nullType.User> {
        return core.HttpResponsePromise.fromPromise(this.__get(id, request, requestOptions));
    }

    private async __get(
        id: string,
        _request: SeedApi.nullType.GetUsersRequest = {},
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.nullType.User>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.nullType.User, rawResponse: _response.rawResponse };
        }
