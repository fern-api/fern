...
export class ParamsClient {
    ...
    private async __getWithPath(
        param: string,
        _request: SeedApi.goDeterministicOrdering.endpoints.GetWithPathParamsRequest = {},
        requestOptions?: ParamsClient.RequestOptions,
    ...
    private async __getWithInlinePath(
        param: string,
        _request: SeedApi.goDeterministicOrdering.endpoints.GetWithInlinePathParamsRequest = {},
        requestOptions?: ParamsClient.RequestOptions,
    ): Promise<core.WithRawResponse<string>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
