...
export class ProblemClient {
     ...
     *
     * @example
     *     await client.trace.problem.updateProblem("problemId", {
     *         body: {
     *             problemName: "problemName",
     *             problemDescription: {
     *                 boards: [{
     ...
     *
     * @example
     *     await client.trace.problem.deleteProblem("problemId")
     */
    public deleteProblem(
        ...
        return core.HttpResponsePromise.fromPromise(this.__deleteProblem(problemId, request, requestOptions));
    }

    private async __deleteProblem(
        problemId: SeedApi.trace.ProblemId,
        _request: SeedApi.trace.DeleteProblemProblemRequest = {},
        requestOptions?: ProblemClient.RequestOptions,
