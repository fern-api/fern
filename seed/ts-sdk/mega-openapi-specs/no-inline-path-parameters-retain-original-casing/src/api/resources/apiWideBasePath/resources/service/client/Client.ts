...
export class ServiceClient {
     ...
     *
     * @example
     *     await client.apiWideBasePath.service.post("pathParam", "serviceParam", 1, "resourceParam")
     */
    public post(
        pathParam: string,
        serviceParam: string,
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__post(pathParam, serviceParam, endpointParam, resourceParam, request, requestOptions),
        );
    }
    ...
    private async __post(
        ...
        endpointParam: number,
        resourceParam: string,
        _request: SeedApi.apiWideBasePath.PostServiceRequest = {},
        requestOptions?: ServiceClient.RequestOptions,
