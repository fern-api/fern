    ...
    private async __fooWithoutEndpointError(
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 400:
                    throw new SeedApi.errors.BadRequestError(_response.error.body as any, _response.rawResponse);
                case 404:
                    throw new SeedApi.errors.NotFoundError(_response.error.body as any, _response.rawResponse);
                case 500:
