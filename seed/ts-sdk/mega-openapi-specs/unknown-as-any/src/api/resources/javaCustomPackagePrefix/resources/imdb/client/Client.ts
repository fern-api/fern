...
export class ImdbClient {
    ...
    ): core.HttpResponsePromise<SeedApi.javaCustomPackagePrefix.MovieId> {
    ...
    private async __createMovie(
        request: SeedApi.javaCustomPackagePrefix.CreateMovieRequest,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.javaCustomPackagePrefix.MovieId>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.javaCustomPackagePrefix.MovieId,
    ...
    public getMovie(
        ...
        requestOptions?: ImdbClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.javaCustomPackagePrefix.Movie> {
    ...
    private async __getMovie(
        request: SeedApi.javaCustomPackagePrefix.GetMovieImdbRequest,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.javaCustomPackagePrefix.Movie>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.javaCustomPackagePrefix.Movie,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 404:
                    throw new SeedApi.javaCustomPackagePrefix.NotFoundError(
                        _response.error.body as any,
