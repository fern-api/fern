...
export class BasicAuthClient {
    ...
    private async __getWithBasicAuth(
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 401:
                    throw new SeedApi.basicAuth.UnauthorizedError(_response.error.body as any, _response.rawResponse);
                default:
    ...
    private async __postWithBasicAuth(
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 400:
                    throw new SeedApi.basicAuth.BadRequestError(_response.error.body as any, _response.rawResponse);
                case 401:
                    throw new SeedApi.basicAuth.UnauthorizedError(_response.error.body as any, _response.rawResponse);
                default:
                    throw new errors.SeedApiError({
