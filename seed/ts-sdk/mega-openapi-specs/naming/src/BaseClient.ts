...
export type BaseClientOptions = {
    environment?: core.Supplier<environments.AcmeApiEnvironment | environments.AcmeApiEnvironmentUrls>;
    ...
    const headers = mergeHeaders(
        {
            ...
            "X-Fern-SDK-Name": "@fern/mega-openapi-specs",
            "X-Fern-SDK-Version": "0.0.1",
            "User-Agent": "@fern/mega-openapi-specs/0.0.1",
