...
export class ContainerClient {
    ...
    /**
     * @param {Record<string, acme.exhaustive.TypesObjectWithRequiredField>} request
     * @param {ContainerClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public getAndReturnMapOfPrimToObject(
        request: Record<string, acme.exhaustive.TypesObjectWithRequiredField>,
        requestOptions?: ContainerClient.RequestOptions,
    ): core.HttpResponsePromise<Record<string, acme.exhaustive.TypesObjectWithRequiredField>> {
    ...
    private async __getAndReturnMapOfPrimToObject(
        request: Record<string, acme.exhaustive.TypesObjectWithRequiredField>,
        requestOptions?: ContainerClient.RequestOptions,
    ): Promise<core.WithRawResponse<Record<string, acme.exhaustive.TypesObjectWithRequiredField>>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Record<string, acme.exhaustive.TypesObjectWithRequiredField>,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    /**
     * @param {Record<string, acme.exhaustive.TypesMixedType>} request
     * @param {ContainerClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public getAndReturnMapOfPrimToUndiscriminatedUnion(
        request: Record<string, acme.exhaustive.TypesMixedType>,
        requestOptions?: ContainerClient.RequestOptions,
    ): core.HttpResponsePromise<Record<string, acme.exhaustive.TypesMixedType>> {
    ...
    private async __getAndReturnMapOfPrimToUndiscriminatedUnion(
        request: Record<string, acme.exhaustive.TypesMixedType>,
        requestOptions?: ContainerClient.RequestOptions,
    ): Promise<core.WithRawResponse<Record<string, acme.exhaustive.TypesMixedType>>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Record<string, acme.exhaustive.TypesMixedType>,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    /**
     * @param {acme.exhaustive.TypesObjectWithRequiredField | null} request
     * @param {ContainerClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public getAndReturnOptional(
        request: acme.exhaustive.TypesObjectWithRequiredField | null,
        requestOptions?: ContainerClient.RequestOptions,
    ): core.HttpResponsePromise<acme.exhaustive.TypesObjectWithRequiredField | null> {
    ...
    private async __getAndReturnOptional(
        request: acme.exhaustive.TypesObjectWithRequiredField | null,
        requestOptions?: ContainerClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.exhaustive.TypesObjectWithRequiredField | null>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.exhaustive.TypesObjectWithRequiredField | null,
                rawResponse: _response.rawResponse,
            };
        }
