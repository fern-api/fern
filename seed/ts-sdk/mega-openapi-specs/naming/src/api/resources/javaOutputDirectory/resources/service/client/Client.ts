...
export class ServiceClient {
    ...
    /**
     * @param {acme.javaOutputDirectory.GetUserServiceRequest} request
    ...
    ): core.HttpResponsePromise<acme.javaOutputDirectory.User> {
    ...
    private async __getUser(
        request: acme.javaOutputDirectory.GetUserServiceRequest,
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.javaOutputDirectory.User>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.javaOutputDirectory.User, rawResponse: _response.rawResponse };
        }
