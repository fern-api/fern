...
export class GoOptionalLiteralAliasClient {
    ...
    /**
     * @param {acme.goOptionalLiteralAlias.SearchRequest} request
    ...
    ): core.HttpResponsePromise<acme.goOptionalLiteralAlias.SearchResponse> {
    ...
    private async __search(
        request: acme.goOptionalLiteralAlias.SearchRequest,
        requestOptions?: GoOptionalLiteralAliasClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.goOptionalLiteralAlias.SearchResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.goOptionalLiteralAlias.SearchResponse,
