...
export class UserClient {
    ...
    /**
     * @param {acme.httpHead.ListUserRequest} request
    ...
    ): core.HttpResponsePromise<acme.httpHead.User[]> {
    ...
    private async __list(
        request: acme.httpHead.ListUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.httpHead.User[]>> {
        const { limit } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as acme.httpHead.User[], rawResponse: _response.rawResponse };
        }
