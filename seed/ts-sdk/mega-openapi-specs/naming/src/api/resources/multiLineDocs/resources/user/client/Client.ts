...
export class UserClient {
     ...
     *
     * @param {acme.multiLineDocs.GetUserUserRequest} request
     ...
     *
     * @param {acme.multiLineDocs.CreateUserUserRequest} request
     * @param {UserClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public createUser(
        ...
        requestOptions?: UserClient.RequestOptions,
    ): core.HttpResponsePromise<acme.multiLineDocs.User> {
    ...
    private async __createUser(
        request: acme.multiLineDocs.CreateUserUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.multiLineDocs.User>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        if (_response.ok) {
            return { data: _response.body as acme.multiLineDocs.User, rawResponse: _response.rawResponse };
        }
