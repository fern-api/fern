...
export class JavaOptionalNullableQueryParamsClient {
     ...
     *
     * @param {acme.javaOptionalNullableQueryParams.SearchRequest} request
    ...
    ): core.HttpResponsePromise<acme.javaOptionalNullableQueryParams.SearchResponse> {
    ...
    private async __search(
        request: acme.javaOptionalNullableQueryParams.SearchRequest = {},
        requestOptions?: JavaOptionalNullableQueryParamsClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.javaOptionalNullableQueryParams.SearchResponse>> {
        const {
            query,
            limit,
            includeArchived,
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.javaOptionalNullableQueryParams.SearchResponse,
