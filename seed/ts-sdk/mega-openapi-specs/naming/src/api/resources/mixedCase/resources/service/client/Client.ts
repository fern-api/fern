...
export class ServiceClient {
    ...
    /**
     * @param {acme.mixedCase.GetResourceServiceRequest} request
    ...
    ): core.HttpResponsePromise<acme.mixedCase.Resource> {
    ...
    private async __getResource(
        request: acme.mixedCase.GetResourceServiceRequest,
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.mixedCase.Resource>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.mixedCase.Resource, rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {acme.mixedCase.ListResourcesServiceRequest} request
     * @param {ServiceClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
