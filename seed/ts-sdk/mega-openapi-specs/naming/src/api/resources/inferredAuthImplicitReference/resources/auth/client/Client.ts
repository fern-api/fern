...
export class AuthClient {
    ...
    /**
     * @param {acme.inferredAuthImplicitReference.GetTokenRequest} request
    ...
    ): core.HttpResponsePromise<acme.inferredAuthImplicitReference.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: acme.inferredAuthImplicitReference.GetTokenRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.inferredAuthImplicitReference.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.inferredAuthImplicitReference.TokenResponse,
    ...
    /**
     * @param {acme.inferredAuthImplicitReference.RefreshTokenRequest} request
     * @param {AuthClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     */
    public refreshToken(
        request: acme.inferredAuthImplicitReference.RefreshTokenRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): core.HttpResponsePromise<acme.inferredAuthImplicitReference.TokenResponse> {
