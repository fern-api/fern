...
export class AuthClient {
    ...
    /**
     * @param {acme.endpointSecurityAuth.GetTokenAuthRequest} request
    ...
    ): core.HttpResponsePromise<acme.endpointSecurityAuth.TokenResponse> {
    ...
    private async __getToken(
        request: acme.endpointSecurityAuth.GetTokenAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.endpointSecurityAuth.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.endpointSecurityAuth.TokenResponse,
