...
export class FooClient {
    ...
    /**
     * @param {acme.audiences.FindFooRequest} request
    ...
    ): core.HttpResponsePromise<acme.audiences.ImportingType> {
    ...
    private async __find(
        request: acme.audiences.FindFooRequest = {},
        requestOptions?: FooClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.audiences.ImportingType>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.audiences.ImportingType, rawResponse: _response.rawResponse };
        }
