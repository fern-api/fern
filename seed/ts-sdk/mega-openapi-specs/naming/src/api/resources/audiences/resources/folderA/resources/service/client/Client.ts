...
export class ServiceClient {
    ...
    /**
     * @param {acme.audiences.folderA.GetDirectThreadServiceRequest} request
    ...
    ): core.HttpResponsePromise<acme.audiences.FolderAResponse> {
    ...
    private async __getDirectThread(
        request: acme.audiences.folderA.GetDirectThreadServiceRequest = {},
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.audiences.FolderAResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.audiences.FolderAResponse, rawResponse: _response.rawResponse };
        }
