...
export class RequiredNullableClient {
    ...
    /**
     * @param {acme.requiredNullable.GetFooRequest} request
    ...
    ): core.HttpResponsePromise<acme.requiredNullable.Foo> {
    ...
    private async __getFoo(
        request: acme.requiredNullable.GetFooRequest,
        requestOptions?: RequiredNullableClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.requiredNullable.Foo>> {
        const {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.requiredNullable.Foo, rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {acme.requiredNullable.UpdateFooRequest} request
     * @param {RequiredNullableClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
