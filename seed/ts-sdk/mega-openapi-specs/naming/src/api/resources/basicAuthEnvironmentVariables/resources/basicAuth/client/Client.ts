...
export class BasicAuthClient {
     ...
     *
     * @throws {@link acme.basicAuthEnvironmentVariables.UnauthorizedError}
     *
     * @example
    ...
    private async __getWithBasicAuth(
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 401:
                    throw new acme.basicAuthEnvironmentVariables.UnauthorizedError(
     ...
     * @param {BasicAuthClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link acme.basicAuthEnvironmentVariables.BadRequestError}
     * @throws {@link acme.basicAuthEnvironmentVariables.UnauthorizedError}
     *
     * @example
    ...
    private async __postWithBasicAuth(
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 400:
                    throw new acme.basicAuthEnvironmentVariables.BadRequestError(
                        _response.error.body as unknown,
                        _response.rawResponse,
                    );
                case 401:
