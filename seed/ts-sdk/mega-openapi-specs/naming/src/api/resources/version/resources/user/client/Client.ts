...
export class UserClient {
    ...
    /**
     * @param {acme.version.GetUserUserRequest} request
    ...
    ): core.HttpResponsePromise<acme.version.User> {
    ...
    private async __getUser(
        request: acme.version.GetUserUserRequest,
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.version.User>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.version.User, rawResponse: _response.rawResponse };
        }
