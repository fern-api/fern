...
export class RetriesClient {
     ...
     */
    public getUsers(requestOptions?: RetriesClient.RequestOptions): core.HttpResponsePromise<acme.noRetries.User[]> {
    ...
    private async __getUsers(
    ...
    ): Promise<core.WithRawResponse<acme.noRetries.User[]>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.noRetries.User[], rawResponse: _response.rawResponse };
        }
