...
export class EventsClient {
     ...
     *
     * @param {acme.mixedFileDirectory.user.ListEventsEventsRequest} request
    ...
    ): core.HttpResponsePromise<acme.mixedFileDirectory.UserEvent[]> {
    ...
    private async __listEvents(
        request: acme.mixedFileDirectory.user.ListEventsEventsRequest = {},
        requestOptions?: EventsClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.mixedFileDirectory.UserEvent[]>> {
        const { limit } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as acme.mixedFileDirectory.UserEvent[], rawResponse: _response.rawResponse };
        }
