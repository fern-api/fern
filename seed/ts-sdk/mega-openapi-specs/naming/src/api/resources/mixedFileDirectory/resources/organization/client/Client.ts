...
export class OrganizationClient {
     ...
     *
     * @param {acme.mixedFileDirectory.CreateOrganizationRequest} request
    ...
    ): core.HttpResponsePromise<acme.mixedFileDirectory.Organization> {
    ...
    private async __create(
        request: acme.mixedFileDirectory.CreateOrganizationRequest,
        requestOptions?: OrganizationClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.mixedFileDirectory.Organization>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.mixedFileDirectory.Organization, rawResponse: _response.rawResponse };
        }
