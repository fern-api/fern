...
export class MetadataClient {
     ...
     * Get event metadata.
     *
     * @param {acme.mixedFileDirectory.user.events.GetMetadataMetadataRequest} request
    ...
    ): core.HttpResponsePromise<acme.mixedFileDirectory.UsereventsMetadata> {
    ...
    private async __getMetadata(
        request: acme.mixedFileDirectory.user.events.GetMetadataMetadataRequest,
        requestOptions?: MetadataClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.mixedFileDirectory.UsereventsMetadata>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.mixedFileDirectory.UsereventsMetadata,
