...
export class ContactsClient {
     ...
     *
     * @param {acme.noContentResponse.CreateContactRequest} request
    ...
    ): core.HttpResponsePromise<acme.noContentResponse.Contact | undefined> {
    ...
    private async __create(
        request: acme.noContentResponse.CreateContactRequest,
        requestOptions?: ContactsClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.noContentResponse.Contact | undefined>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.noContentResponse.Contact | undefined,
     ...
     *
     * @param {acme.noContentResponse.GetContactsRequest} request
     * @param {ContactsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public get(
        ...
        requestOptions?: ContactsClient.RequestOptions,
    ): core.HttpResponsePromise<acme.noContentResponse.Contact> {
    ...
    private async __get(
        request: acme.noContentResponse.GetContactsRequest,
        requestOptions?: ContactsClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.noContentResponse.Contact>> {
        const { id } = request;
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
        ...
        if (_response.ok) {
            return { data: _response.body as acme.noContentResponse.Contact, rawResponse: _response.rawResponse };
        }
