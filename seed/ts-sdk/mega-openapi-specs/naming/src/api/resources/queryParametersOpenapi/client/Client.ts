...
export class QueryParametersOpenapiClient {
    ...
    /**
     * @param {acme.queryParametersOpenapi.SearchRequest} request
    ...
    ): core.HttpResponsePromise<acme.queryParametersOpenapi.SearchResponse> {
    ...
    private async __search(
        request: acme.queryParametersOpenapi.SearchRequest,
        requestOptions?: QueryParametersOpenapiClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.queryParametersOpenapi.SearchResponse>> {
        const {
            limit,
            id,
            date,
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.queryParametersOpenapi.SearchResponse,
