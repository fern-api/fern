...
export class UnionClient {
    ...
    /**
     * @param {acme.goDeterministicOrdering.TypesAnimal} request
    ...
    public getAndReturnUnion(
        request: acme.goDeterministicOrdering.TypesAnimal,
        requestOptions?: UnionClient.RequestOptions,
    ): core.HttpResponsePromise<acme.goDeterministicOrdering.TypesAnimal> {
    ...
    private async __getAndReturnUnion(
        request: acme.goDeterministicOrdering.TypesAnimal,
        requestOptions?: UnionClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.goDeterministicOrdering.TypesAnimal>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.goDeterministicOrdering.TypesAnimal,
