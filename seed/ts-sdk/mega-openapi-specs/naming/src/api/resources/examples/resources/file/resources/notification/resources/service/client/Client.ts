...
export class ServiceClient {
    ...
    /**
     * @param {acme.examples.file.notification.GetExceptionServiceRequest} request
    ...
    ): core.HttpResponsePromise<acme.examples.Exception> {
    ...
    private async __getException(
        request: acme.examples.file.notification.GetExceptionServiceRequest,
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.examples.Exception>> {
        ...
        if (_response.ok) {
            return { data: _response.body as acme.examples.Exception, rawResponse: _response.rawResponse };
        }
