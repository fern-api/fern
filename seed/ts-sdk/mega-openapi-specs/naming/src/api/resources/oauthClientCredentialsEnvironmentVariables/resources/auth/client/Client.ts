...
export class AuthClient {
    ...
    /**
     * @param {acme.oauthClientCredentialsEnvironmentVariables.GetTokenWithClientCredentialsAuthRequest} request
    ...
    ): core.HttpResponsePromise<acme.oauthClientCredentialsEnvironmentVariables.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: acme.oauthClientCredentialsEnvironmentVariables.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.oauthClientCredentialsEnvironmentVariables.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.oauthClientCredentialsEnvironmentVariables.TokenResponse,
    ...
    /**
     * @param {acme.oauthClientCredentialsEnvironmentVariables.RefreshTokenAuthRequest} request
     * @param {AuthClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
