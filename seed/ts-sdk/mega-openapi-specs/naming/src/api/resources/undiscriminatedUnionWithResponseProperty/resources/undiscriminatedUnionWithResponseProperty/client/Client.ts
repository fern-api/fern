...
export class UndiscriminatedUnionWithResponsePropertyClient {
    ...
    ): core.HttpResponsePromise<acme.undiscriminatedUnionWithResponseProperty.UnionResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getUnion(requestOptions));
    }

    private async __getUnion(
        requestOptions?: UndiscriminatedUnionWithResponsePropertyClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.undiscriminatedUnionWithResponseProperty.UnionResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.undiscriminatedUnionWithResponseProperty.UnionResponse,
    ...
    public listUnions(
        requestOptions?: UndiscriminatedUnionWithResponsePropertyClient.RequestOptions,
    ): core.HttpResponsePromise<acme.undiscriminatedUnionWithResponseProperty.UnionListResponse> {
        return core.HttpResponsePromise.fromPromise(this.__listUnions(requestOptions));
    }

    private async __listUnions(
        requestOptions?: UndiscriminatedUnionWithResponsePropertyClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.undiscriminatedUnionWithResponseProperty.UnionListResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.undiscriminatedUnionWithResponseProperty.UnionListResponse,
                rawResponse: _response.rawResponse,
            };
        }
