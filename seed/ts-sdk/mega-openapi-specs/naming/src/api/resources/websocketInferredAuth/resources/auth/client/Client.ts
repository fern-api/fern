...
export class AuthClient {
    ...
    /**
     * @param {acme.websocketInferredAuth.GetTokenWithClientCredentialsAuthRequest} request
    ...
    ): core.HttpResponsePromise<acme.websocketInferredAuth.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: acme.websocketInferredAuth.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.websocketInferredAuth.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.websocketInferredAuth.TokenResponse,
    ...
    /**
     * @param {acme.websocketInferredAuth.RefreshTokenAuthRequest} request
     * @param {AuthClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
