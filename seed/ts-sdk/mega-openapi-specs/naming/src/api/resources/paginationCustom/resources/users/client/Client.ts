...
export class UsersClient {
    ...
    /**
     * @param {acme.paginationCustom.ListWithCustomPagerUsersRequest} request
    ...
    ): core.HttpResponsePromise<acme.paginationCustom.UsersListResponse> {
    ...
    private async __listWithCustomPager(
        request: acme.paginationCustom.ListWithCustomPagerUsersRequest = {},
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.paginationCustom.UsersListResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.paginationCustom.UsersListResponse,
