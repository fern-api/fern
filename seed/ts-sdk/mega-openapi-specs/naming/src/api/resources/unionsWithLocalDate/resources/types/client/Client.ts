...
export class TypesClient {
    ...
    /**
     * @param {acme.unionsWithLocalDate.GetTypesRequest} request
    ...
    ): core.HttpResponsePromise<acme.unionsWithLocalDate.UnionWithTime> {
    ...
    private async __get(
        request: acme.unionsWithLocalDate.GetTypesRequest,
        requestOptions?: TypesClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.unionsWithLocalDate.UnionWithTime>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return {
                data: _response.body as acme.unionsWithLocalDate.UnionWithTime,
    ...
    /**
     * @param {acme.unionsWithLocalDate.UnionWithTime} request
     * @param {TypesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     */
    public update(
        request: acme.unionsWithLocalDate.UnionWithTime,
        requestOptions?: TypesClient.RequestOptions,
