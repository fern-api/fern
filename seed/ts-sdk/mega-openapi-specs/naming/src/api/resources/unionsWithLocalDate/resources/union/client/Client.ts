...
export class UnionClient {
    ...
    /**
     * @param {acme.unionsWithLocalDate.GetUnionRequest} request
    ...
    ): core.HttpResponsePromise<acme.unionsWithLocalDate.Shape> {
    ...
    private async __get(
        request: acme.unionsWithLocalDate.GetUnionRequest,
        requestOptions?: UnionClient.RequestOptions,
    ): Promise<core.WithRawResponse<acme.unionsWithLocalDate.Shape>> {
        const { id } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as acme.unionsWithLocalDate.Shape, rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {acme.unionsWithLocalDate.Shape} request
     * @param {UnionClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     */
    public update(
        request: acme.unionsWithLocalDate.Shape,
        requestOptions?: UnionClient.RequestOptions,
