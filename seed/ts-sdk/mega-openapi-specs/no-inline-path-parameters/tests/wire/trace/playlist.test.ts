...
describe("PlaylistClient", () => {
    test("createPlaylist", async () => {
        ...
        const response = await client.trace.playlist.createPlaylist(1, {
    ...
    test("getPlaylists", async () => {
        ...
        const response = await client.trace.playlist.getPlaylists(1, {
    ...
    test("getPlaylist (1)", async () => {
        ...
        const response = await client.trace.playlist.getPlaylist(1, "playlistId");
        expect(response).toEqual(rawResponseBody);
    });
    ...
    test("getPlaylist (2)", async () => {
        ...
        await expect(async () => {
            return await client.trace.playlist.getPlaylist(1, "playlistId");
    ...
    test("updatePlaylist (1)", async () => {
        ...
        const response = await client.trace.playlist.updatePlaylist(1, "playlistId", {
            body: {
                name: "name",
                problems: ["problems"],
            },
    ...
    test("updatePlaylist (2)", async () => {
        ...
        await expect(async () => {
            return await client.trace.playlist.updatePlaylist(1, "playlistId", {
                body: {
                    name: "name",
    ...
    test("deletePlaylist", async () => {
        ...
        const response = await client.trace.playlist.deletePlaylist(1, "playlist_id");
