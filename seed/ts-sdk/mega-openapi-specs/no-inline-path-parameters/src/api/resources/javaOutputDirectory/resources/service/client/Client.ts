...
export class ServiceClient {
     ...
     *
     * @example
     *     await client.javaOutputDirectory.service.getUser("userId")
     */
    public getUser(
        userId: string,
        request: SeedApi.javaOutputDirectory.GetUserServiceRequest = {},
        requestOptions?: ServiceClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.javaOutputDirectory.User> {
        return core.HttpResponsePromise.fromPromise(this.__getUser(userId, request, requestOptions));
    }

    private async __getUser(
        userId: string,
        _request: SeedApi.javaOutputDirectory.GetUserServiceRequest = {},
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.javaOutputDirectory.User>> {
