...
export class UserClient {
    ...
    private async __getUser(
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.versionNoDefault.User, rawResponse: _response.rawResponse };
        }
