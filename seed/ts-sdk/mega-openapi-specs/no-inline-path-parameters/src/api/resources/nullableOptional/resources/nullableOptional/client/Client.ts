...
export class NullableOptionalClient {
    ...
    private async __getUser(
        userId: string,
        _request: SeedApi.nullableOptional.GetUserNullableOptionalRequest = {},
        requestOptions?: NullableOptionalClient.RequestOptions,
    ...
    public getComplexProfile(
        ...
        return core.HttpResponsePromise.fromPromise(this.__getComplexProfile(profileId, request, requestOptions));
    }

    private async __getComplexProfile(
        profileId: string,
        _request: SeedApi.nullableOptional.GetComplexProfileNullableOptionalRequest = {},
        requestOptions?: NullableOptionalClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.nullableOptional.ComplexProfile>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
    ...
    public getNotificationSettings(
        ...
        return core.HttpResponsePromise.fromPromise(this.__getNotificationSettings(userId, request, requestOptions));
    }

    private async __getNotificationSettings(
        userId: string,
        _request: SeedApi.nullableOptional.GetNotificationSettingsNullableOptionalRequest = {},
        requestOptions?: NullableOptionalClient.RequestOptions,
