...
export class ParamsClient {
    ...
    public getWithPath(
        ...
        return core.HttpResponsePromise.fromPromise(this.__getWithPath(param, request, requestOptions));
    }

    private async __getWithPath(
        param: string,
        _request: SeedApi.exhaustive.endpoints.GetWithPathParamsRequest = {},
        requestOptions?: ParamsClient.RequestOptions,
    ...
    private async __getWithInlinePath(
        param: string,
        _request: SeedApi.exhaustive.endpoints.GetWithInlinePathParamsRequest = {},
        requestOptions?: ParamsClient.RequestOptions,
    ): Promise<core.WithRawResponse<string>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
    ...
    public getWithBooleanPath(
        ...
        return core.HttpResponsePromise.fromPromise(this.__getWithBooleanPath(param, request, requestOptions));
    }

    private async __getWithBooleanPath(
        param: boolean,
        _request: SeedApi.exhaustive.endpoints.GetWithBooleanPathParamsRequest = {},
        requestOptions?: ParamsClient.RequestOptions,
    ): Promise<core.WithRawResponse<string>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
    ...
    public getWithPathAndErrors(
        ...
        return core.HttpResponsePromise.fromPromise(this.__getWithPathAndErrors(param, request, requestOptions));
    }

    private async __getWithPathAndErrors(
        param: string,
        _request: SeedApi.exhaustive.endpoints.GetWithPathAndErrorsParamsRequest = {},
        requestOptions?: ParamsClient.RequestOptions,
    ): Promise<core.WithRawResponse<string>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
