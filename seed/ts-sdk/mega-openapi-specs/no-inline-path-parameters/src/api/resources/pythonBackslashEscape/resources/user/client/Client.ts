...
export class UserClient {
     ...
     *
     * @example
     *     await client.pythonBackslashEscape.user.get("id")
     */
    public get(
        id: string,
        request: SeedApi.pythonBackslashEscape.GetUserRequest = {},
        requestOptions?: UserClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.pythonBackslashEscape.User> {
    ...
    private async __get(
        ...
        request: SeedApi.pythonBackslashEscape.GetUserRequest = {},
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.pythonBackslashEscape.User>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.pythonBackslashEscape.User, rawResponse: _response.rawResponse };
        }
