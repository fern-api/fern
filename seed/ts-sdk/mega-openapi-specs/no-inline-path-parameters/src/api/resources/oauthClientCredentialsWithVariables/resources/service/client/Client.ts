...
export class ServiceClient {
    ...
    public post(
        ...
        return core.HttpResponsePromise.fromPromise(this.__post(endpointParam, request, requestOptions));
    }

    private async __post(
        endpointParam: string,
        _request: SeedApi.oauthClientCredentialsWithVariables.PostServiceRequest = {},
        requestOptions?: ServiceClient.RequestOptions,
