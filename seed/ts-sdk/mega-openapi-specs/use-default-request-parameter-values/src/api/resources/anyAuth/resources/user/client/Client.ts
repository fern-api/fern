...
export class UserClient {
     ...
     */
    public get(requestOptions?: UserClient.RequestOptions): core.HttpResponsePromise<SeedApi.anyAuth.User[]> {
        return core.HttpResponsePromise.fromPromise(this.__get(requestOptions));
    }

    private async __get(
        requestOptions?: UserClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.anyAuth.User[]>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.anyAuth.User[], rawResponse: _response.rawResponse };
        }
     ...
     */
    public getAdmins(requestOptions?: UserClient.RequestOptions): core.HttpResponsePromise<SeedApi.anyAuth.User[]> {
