...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.oauthClientCredentialsCustom.TokenResponse> {
    ...
    private async __getTokenWithClientCredentials(
        request: SeedApi.oauthClientCredentialsCustom.GetTokenWithClientCredentialsAuthRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.oauthClientCredentialsCustom.TokenResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.oauthClientCredentialsCustom.TokenResponse,
