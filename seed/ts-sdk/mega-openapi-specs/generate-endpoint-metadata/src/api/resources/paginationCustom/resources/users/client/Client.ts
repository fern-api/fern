...
export class UsersClient {
    ...
    ): core.HttpResponsePromise<SeedApi.paginationCustom.UsersListResponse> {
    ...
    private async __listWithCustomPager(
        request: SeedApi.paginationCustom.ListWithCustomPagerUsersRequest = {},
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.paginationCustom.UsersListResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.paginationCustom.UsersListResponse,
