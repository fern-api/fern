...
export class EnumClient {
    ...
    ): core.HttpResponsePromise<SeedApi.goDeterministicOrdering.TypesWeatherReport> {
    ...
    private async __getAndReturnEnum(
        request: SeedApi.goDeterministicOrdering.TypesWeatherReport,
        requestOptions?: EnumClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.goDeterministicOrdering.TypesWeatherReport>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.goDeterministicOrdering.TypesWeatherReport,
