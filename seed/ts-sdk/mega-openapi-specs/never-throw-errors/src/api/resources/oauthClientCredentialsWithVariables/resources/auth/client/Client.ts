...
export class AuthClient {
    ...
    public getTokenWithClientCredentials(
        ...
        core.APIResponse<
            SeedApi.oauthClientCredentialsWithVariables.TokenResponse,
            SeedApi.oauthClientCredentialsWithVariables.auth.getTokenWithClientCredentials.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.oauthClientCredentialsWithVariables.TokenResponse,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsWithVariables.auth.getTokenWithClientCredentials.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public refreshToken(
        ...
        core.APIResponse<
            SeedApi.oauthClientCredentialsWithVariables.TokenResponse,
            SeedApi.oauthClientCredentialsWithVariables.auth.refreshToken.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsWithVariables.auth.refreshToken.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
