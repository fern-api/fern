...
export class UserClient {
    ...
    public getUser(
        ...
        core.APIResponse<SeedApi.versionNoDefault.User, SeedApi.versionNoDefault.user.getUser.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.versionNoDefault.User,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.versionNoDefault.user.getUser.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
