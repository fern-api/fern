...
export class TsExtraPropertiesClient {
    ...
    public getUser(
        ...
        core.APIResponse<SeedApi.tsExtraProperties.User, SeedApi.tsExtraProperties.getUser.Error>
    > {
    ...
    private async __getUser(
        ...
        core.WithRawResponse<core.APIResponse<SeedApi.tsExtraProperties.User, SeedApi.tsExtraProperties.getUser.Error>>
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.tsExtraProperties.User,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.tsExtraProperties.getUser.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public createUser(
        ...
        core.APIResponse<SeedApi.tsExtraProperties.User, SeedApi.tsExtraProperties.createUser.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.tsExtraProperties.createUser.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
