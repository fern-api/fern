...
export class AuthClient {
    ...
    public getTokenWithClientCredentials(
        ...
        core.APIResponse<
            SeedApi.inferredAuthImplicit.TokenResponse,
            SeedApi.inferredAuthImplicit.auth.getTokenWithClientCredentials.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.inferredAuthImplicit.TokenResponse,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthImplicit.auth.getTokenWithClientCredentials.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public refreshToken(
        ...
        core.APIResponse<
            SeedApi.inferredAuthImplicit.TokenResponse,
            SeedApi.inferredAuthImplicit.auth.refreshToken.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthImplicit.auth.refreshToken.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
