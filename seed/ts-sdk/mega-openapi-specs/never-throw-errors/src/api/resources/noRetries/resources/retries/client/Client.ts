...
export class RetriesClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<SeedApi.noRetries.User[], SeedApi.noRetries.retries.getUsers.Error>> {
    ...
    private async __getUsers(
        ...
        core.WithRawResponse<core.APIResponse<SeedApi.noRetries.User[], SeedApi.noRetries.retries.getUsers.Error>>
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.noRetries.User[],
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.noRetries.retries.getUsers.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
