...
export class SimpleFhirClient {
    ...
    public getAccount(
        ...
        core.APIResponse<SeedApi.simpleFhir.Account, SeedApi.simpleFhir.simpleFhir.getAccount.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.simpleFhir.Account,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.simpleFhir.simpleFhir.getAccount.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
