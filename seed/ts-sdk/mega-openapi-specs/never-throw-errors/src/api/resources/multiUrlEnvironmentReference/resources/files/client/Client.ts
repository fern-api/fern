...
export class FilesClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<string, SeedApi.multiUrlEnvironmentReference.files.upload.Error>> {
    ...
    private async __upload(
        ...
        core.WithRawResponse<core.APIResponse<string, SeedApi.multiUrlEnvironmentReference.files.upload.Error>>
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.multiUrlEnvironmentReference.files.upload.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
