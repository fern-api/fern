...
export class UserClient {
    ...
    public get(
        ...
        core.APIResponse<SeedApi.pythonBackslashEscape.User, SeedApi.pythonBackslashEscape.user.get.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.pythonBackslashEscape.User,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.pythonBackslashEscape.user.get.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
