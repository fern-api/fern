...
export class PathClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<SeedApi.literal.SendResponse, SeedApi.literal.path.send.Error>> {
    ...
    private async __send(
        request: SeedApi.literal.SendPathRequest,
        requestOptions?: PathClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<SeedApi.literal.SendResponse, SeedApi.literal.path.send.Error>>> {
        const { id } = request;
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.literal.path.send.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
