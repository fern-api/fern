...
export class DummyClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.streamingParameter.dummy.generate.Error>> {
    ...
    private async __generate(
        request: SeedApi.streamingParameter.GenerateDummyRequest,
        requestOptions?: DummyClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.streamingParameter.dummy.generate.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.streamingParameter.dummy.generate.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
