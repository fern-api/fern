...
export class ServiceClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.variables.service.post.Error>> {
    ...
    private async __post(
        request: SeedApi.variables.PostServiceRequest,
        requestOptions?: ServiceClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.variables.service.post.Error>>> {
            ...
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    ((await core.Supplier.get(this._options.environment)) ?? environments.SeedApiEnvironment.Production)
                        .base,
                `${core.url.encodePathParam(endpointParam)}`,
            ),
            method: "POST",
            headers: _headers,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.variables.service.post.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
