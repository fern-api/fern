...
export class ExamplesClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<string, SeedApi.examples.examples.echo.Error>> {
    ...
    private async __echo(
        request: string,
        requestOptions?: ExamplesClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<string, SeedApi.examples.examples.echo.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.examples.examples.echo.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public createType(
        ...
        core.APIResponse<SeedApi.examples.Identifier, SeedApi.examples.examples.createType.Error>
    > {
    ...
    private async __createType(
        ...
        core.WithRawResponse<core.APIResponse<SeedApi.examples.Identifier, SeedApi.examples.examples.createType.Error>>
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.examples.Identifier,
                    headers: _response.headers,
                    rawResponse: _response.rawResponse,
                },
                rawResponse: _response.rawResponse,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.examples.examples.createType.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
