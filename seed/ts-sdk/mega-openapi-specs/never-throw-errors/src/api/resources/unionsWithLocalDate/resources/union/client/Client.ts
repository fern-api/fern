...
export class UnionClient {
    ...
    public get(
        ...
        core.APIResponse<SeedApi.unionsWithLocalDate.Shape, SeedApi.unionsWithLocalDate.union.get.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.unionsWithLocalDate.Shape,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.unionsWithLocalDate.union.get.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public update(
        ...
        requestOptions?: UnionClient.RequestOptions,
    ): core.HttpResponsePromise<core.APIResponse<boolean, SeedApi.unionsWithLocalDate.union.update.Error>> {
    ...
    private async __update(
        request: SeedApi.unionsWithLocalDate.Shape,
        requestOptions?: UnionClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<boolean, SeedApi.unionsWithLocalDate.union.update.Error>>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "X-API-Version": requestOptions?.apiVersion ?? this._options?.apiVersion ?? "2024-02-08",
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.unionsWithLocalDate.union.update.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
