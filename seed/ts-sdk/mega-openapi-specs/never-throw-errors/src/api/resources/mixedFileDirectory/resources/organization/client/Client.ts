...
export class OrganizationClient {
    ...
    public create(
        ...
        core.APIResponse<SeedApi.mixedFileDirectory.Organization, SeedApi.mixedFileDirectory.organization.create.Error>
    > {
    ...
    private async __create(
        ...
        core.WithRawResponse<
            core.APIResponse<
                ...
                SeedApi.mixedFileDirectory.organization.create.Error
            >
        >
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.mixedFileDirectory.Organization,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.mixedFileDirectory.organization.create.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
