...
export class NestedApiClient {
    ...
    public nestedApiGetSomething(
        ...
        core.APIResponse<void, SeedApi.inferredAuthImplicitApiKey.nestedApi.nestedApiGetSomething.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.inferredAuthImplicitApiKey.nestedApi.nestedApiGetSomething.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
