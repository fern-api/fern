...
export class MultipleRequestBodiesClient {
    ...
    public uploadJsonDocument(
        ...
        core.APIResponse<
            ...
            SeedApi.multipleRequestBodies.multipleRequestBodies.uploadJsonDocument.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.multipleRequestBodies.UploadDocumentResponse,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.multipleRequestBodies.multipleRequestBodies.uploadJsonDocument.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public uploadPdfDocument(
        ...
        core.APIResponse<
            SeedApi.multipleRequestBodies.UploadDocumentResponse,
            SeedApi.multipleRequestBodies.multipleRequestBodies.uploadPdfDocument.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.multipleRequestBodies.multipleRequestBodies.uploadPdfDocument.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
