...
export class ImdbClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<SeedApi.imdb.MovieId, SeedApi.imdb.imdb.createMovie.Error>> {
    ...
    private async __createMovie(
        request: SeedApi.imdb.CreateMovieRequest,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<SeedApi.imdb.MovieId, SeedApi.imdb.imdb.createMovie.Error>>> {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.imdb.MovieId,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.imdb.imdb.createMovie.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public getMovie(
        ...
        requestOptions?: ImdbClient.RequestOptions,
    ): core.HttpResponsePromise<core.APIResponse<SeedApi.imdb.Movie, SeedApi.imdb.imdb.getMovie.Error>> {
    ...
    private async __getMovie(
        request: SeedApi.imdb.GetMovieImdbRequest,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<SeedApi.imdb.Movie, SeedApi.imdb.imdb.getMovie.Error>>> {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.imdb.Movie,
                    headers: _response.headers,
                    rawResponse: _response.rawResponse,
                },
                rawResponse: _response.rawResponse,
            ...
            switch (_response.error.statusCode) {
                case 404:
                    return {
                        data: {
                            ok: false,
                            error: SeedApi.imdb.imdb.getMovie.Error.notFoundError(_response.error.body as unknown),
                            rawResponse: _response.rawResponse,
                        },
                        rawResponse: _response.rawResponse,
                    };
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.imdb.imdb.getMovie.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
