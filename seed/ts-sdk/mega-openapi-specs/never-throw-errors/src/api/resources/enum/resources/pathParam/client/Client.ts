...
export class PathParamClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.enum_.pathParam.send.Error>> {
    ...
    private async __send(
        request: SeedApi.enum_.SendPathParamRequest,
        requestOptions?: PathParamClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.enum_.pathParam.send.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.enum_.pathParam.send.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
