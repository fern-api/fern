...
export class SimpleClient {
    ...
    public getSomething(
        ...
        core.APIResponse<void, SeedApi.oauthClientCredentialsEnvironmentVariables.simple.getSomething.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.oauthClientCredentialsEnvironmentVariables.simple.getSomething.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
