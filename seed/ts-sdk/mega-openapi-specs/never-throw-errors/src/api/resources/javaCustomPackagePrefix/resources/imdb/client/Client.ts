...
export class ImdbClient {
    ...
    public createMovie(
        ...
        core.APIResponse<
            ...
            SeedApi.javaCustomPackagePrefix.imdb.createMovie.Error
        >
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.javaCustomPackagePrefix.MovieId,
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.javaCustomPackagePrefix.imdb.createMovie.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
    ...
    public getMovie(
        ...
        core.APIResponse<SeedApi.javaCustomPackagePrefix.Movie, SeedApi.javaCustomPackagePrefix.imdb.getMovie.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: _response.body as SeedApi.javaCustomPackagePrefix.Movie,
                    headers: _response.headers,
                    rawResponse: _response.rawResponse,
                },
                rawResponse: _response.rawResponse,
            ...
            switch (_response.error.statusCode) {
                case 404:
                    return {
                        data: {
                            ok: false,
                            error: SeedApi.javaCustomPackagePrefix.imdb.getMovie.Error.notFoundError(
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.javaCustomPackagePrefix.imdb.getMovie.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
