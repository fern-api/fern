...
export class ACClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.folders.aC.aCFoo.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__aCFoo(requestOptions));
    }

    private async __aCFoo(
        requestOptions?: ACClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.folders.aC.aCFoo.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.folders.aC.aCFoo.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
