...
export class FoldersClient {
    ...
    ): core.HttpResponsePromise<core.APIResponse<void, SeedApi.folders.folders.foo.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__foo(requestOptions));
    }

    private async __foo(
        requestOptions?: FoldersClient.RequestOptions,
    ): Promise<core.WithRawResponse<core.APIResponse<void, SeedApi.folders.folders.foo.Error>>> {
        ...
        return {
            data: {
                ok: false,
                error: SeedApi.folders.folders.foo.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
