...
export class Users {
    ...
    public async listWithCursorPagination(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                core.WithRawResponse<SeedPagination.ListUsersPaginationResponse>
            > => {
                const {
                    page,
                    per_page: perPage,
    ...
    public async listWithMixedTypeCursorPagination(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                core.WithRawResponse<SeedPagination.ListUsersMixedTypePaginationResponse>
            > => {
    ...
    public async listWithOffsetPaginationHasNextPage(
        ...
        >({
            ...
            rawResponse: dataWithRawResponse.rawResponse,
            hasNextPage: (response) =>
                response?.hasNextPage ?? (response?.data ?? []).length > 0,
            getItems: (response) => response?.data ?? [],
            loadPage: (response) => {
                _offset += response?.data != null ? response.data.length : 1;
                return list(core.setObjectProperty(request, "page", _offset));
    ...
    public async listWithExtendedResults(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                core.WithRawResponse<SeedPagination.ListUsersExtendedResponse>
            > => {
                const { cursor } = request;
                const _queryParams: Record<
                    string,
    ...
    public async listWithExtendedResultsAndOptionalData(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                core.WithRawResponse<SeedPagination.ListUsersExtendedOptionalListResponse>
            > => {
                const { cursor } = request;
                const _queryParams: Record<
                    string,
    ...
    public async listWithGlobalConfig(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                core.WithRawResponse<SeedPagination.UsernameContainer>
            > => {
