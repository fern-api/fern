...
export class InlineUsers {
  ...
  public async listWithCursorPagination(
    ...
    core.Page<SeedPagination.inlineUsers.ListUsersPaginationResponse.Data.Users.Item>
  > {
    const list = core.HttpResponsePromise.interceptFunction(
      async (
        request: SeedPagination.inlineUsers.ListUsersCursorPaginationRequest,
      ): Promise<
        core.WithRawResponse<SeedPagination.inlineUsers.ListUsersPaginationResponse>
      > => {
        const {
          page,
          per_page: perPage,
        ...
        switch (_response.error.reason) {
          ...
          case "timeout":
            throw new errors.SeedPaginationTimeoutError(
              "Timeout exceeded when calling GET /inline-users.",
            );
          case "unknown":
            throw new errors.SeedPaginationError({
  ...
  public async listWithMixedTypeCursorPagination(
    ...
    core.Page<SeedPagination.inlineUsers.ListUsersMixedTypePaginationResponse.Data.Users.Item>
  > {
    const list = core.HttpResponsePromise.interceptFunction(
      async (
        request: SeedPagination.inlineUsers.ListUsersMixedTypeCursorPaginationRequest,
      ): Promise<
        core.WithRawResponse<SeedPagination.inlineUsers.ListUsersMixedTypePaginationResponse>
      > => {
    ...
    >({
      ...
      hasNextPage: (response) =>
        response?.next != null &&
        !(typeof response?.next === "string" && response?.next === ""),
      getItems: (response) => response?.data.users ?? [],
      loadPage: (response) => {
  ...
  > {
    ...
    let _offset =
      request?.pagination?.page != null ? request?.pagination?.page : 1;
    const dataWithRawResponse = await list(request).withRawResponse();
    return new core.Pageable<
      SeedPagination.inlineUsers.ListUsersPaginationResponse,
      SeedPagination.inlineUsers.ListUsersPaginationResponse.Data.Users.Item
    >({
      ...
      loadPage: (_response) => {
        _offset += 1;
        return list(
          core.setObjectProperty(request, "pagination.page", _offset),
        );
      },
    });
  }
  ...
  > {
    ...
    >({
      ...
      loadPage: (response) => {
        _offset +=
          response?.data.users != null ? response.data.users.length : 1;
        return list(core.setObjectProperty(request, "page", _offset));
      },
    });
  }
  ...
  > {
    ...
    >({
      ...
      rawResponse: dataWithRawResponse.rawResponse,
      hasNextPage: (response) =>
        response?.hasNextPage ?? (response?.data.users ?? []).length > 0,
      getItems: (response) => response?.data.users ?? [],
      loadPage: (response) => {
        _offset +=
          response?.data.users != null ? response.data.users.length : 1;
  ...
  public async listWithExtendedResults(
    ...
    core.Page<SeedPagination.inlineUsers.UserListContainer.Users.Item>
  > {
    const list = core.HttpResponsePromise.interceptFunction(
      async (
        request: SeedPagination.inlineUsers.ListUsersExtendedRequest,
      ): Promise<
        core.WithRawResponse<SeedPagination.inlineUsers.ListUsersExtendedResponse>
      > => {
        const { cursor } = request;
        const _queryParams: Record<
          string,
  ...
  public async listWithExtendedResultsAndOptionalData(
    ...
    core.Page<SeedPagination.inlineUsers.UserOptionalListContainer.Users.Item>
  > {
    const list = core.HttpResponsePromise.interceptFunction(
      async (
        request: SeedPagination.inlineUsers.ListUsersExtendedRequestForOptionalData,
      ): Promise<
        core.WithRawResponse<SeedPagination.inlineUsers.ListUsersExtendedOptionalListResponse>
      > => {
        const { cursor } = request;
        const _queryParams: Record<
          string,
  ...
  public async listUsernames(
    ...
    return new core.Pageable<SeedPagination.UsernameCursor, string>({
      ...
      hasNextPage: (response) =>
        ...
        !(
          typeof response?.cursor.after === "string" &&
  ...
  public async listWithGlobalConfig(
    ...
    const list = core.HttpResponsePromise.interceptFunction(
      async (
        ...
        core.WithRawResponse<SeedPagination.inlineUsers.UsernameContainer>
      > => {
