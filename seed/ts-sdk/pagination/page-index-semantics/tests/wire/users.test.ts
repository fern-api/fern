...
describe("UsersClient", () => {
    ...
    test("listWithBodyCursorPagination", async () => {
        const server = mockServerPool.createServer();
        const client = new SeedPaginationClient({ maxRetries: 0, token: "test", environment: server.baseUrl });
        const rawRequestBody = { pagination: { cursor: "cursor_value" } };
        const rawResponseBody = {
            hasNextPage: true,
            page: { page: 1, next: { page: 2, starting_after: "next_cursor_value" }, per_page: 10, total_page: 5 },
            total_count: 50,
            data: [
                { name: "Alice", id: 1 },
                { name: "Bob", id: 2 },
        ...
        const expected = {
            ...
            page: {
                ...
                next: {
                    page: 2,
                    starting_after: "next_cursor_value",
                },
                per_page: 10,
                total_page: 5,
            },
