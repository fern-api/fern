...
describe("UsersClient", () => {
    ...
    test("listWithMixedTypeCursorPagination", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .post("/users/mixed-type-cursor-pagination")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("listWithBodyCursorPagination", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .post("/users/body-cursor-pagination")
    ...
    test("listWithDoubleOffsetPagination", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .get("/users/double-offset-pagination")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("listWithBodyOffsetPagination", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .post("/users/body-offset-pagination")
    ...
    test("listWithOffsetStepPagination", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .get("/users/offset-step-pagination")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("listWithOffsetPaginationHasNextPage (1)", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .get("/users/offset-pagination-has-next-page")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("listWithExtendedResultsAndOptionalData", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .get("/users/extended-results-optional-data")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("listUsernamesWithOptionalResponse", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .get("/users/usernames-optional-response")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
