...
describe("InlineUsersClient", () => {
    ...
    test("listWithCursorPagination", async () => {
        ...
        const rawResponseBody = { "hasNextPage" : true , "page" : { "page" : 1 , "next" : { "page" : 1 , "starting_after" : "starting_after" } , "per_page" : 1 , "total_page" : 1 } , "total_count" : 1 , "data" : { "users" : [ { "name" : "name" , "id" : 1 } , { "name" : "name" , "id" : 1 } ] } };
        server
            .mockEndpoint({ once: false })
            .get("/inline-users").respondWith()
    ...
    test("listWithMixedTypeCursorPagination", async () => {
        ...
        const rawResponseBody = { "next" : "next" , "data" : { "users" : [ { "name" : "name" , "id" : 1 } , { "name" : "name" , "id" : 1 } ] } };
        server
            .mockEndpoint({ once: false })
            .post("/inline-users").respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("listWithBodyCursorPagination", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .post("/inline-users").jsonBody(rawRequestBody)
                .respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
