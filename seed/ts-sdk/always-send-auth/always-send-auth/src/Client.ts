...
export declare namespace SeedAlwaysSendAuthClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class SeedAlwaysSendAuthClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<SeedAlwaysSendAuthClient.Options>;
    protected _service: ServiceClient | undefined;

    constructor(options: SeedAlwaysSendAuthClient.Options) {
