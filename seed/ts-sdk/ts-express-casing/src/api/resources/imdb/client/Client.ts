...
import type { CreateMovieRequest } from "./requests/CreateMovieRequest.js";
...
export class ImdbClient {
     ...
     */
    public getMovie(movie_id: MovieId, requestOptions?: ImdbClient.RequestOptions): core.HttpResponsePromise<Movie> {
