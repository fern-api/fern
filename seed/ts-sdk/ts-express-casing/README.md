...
[![npm shield](https://img.shields.io/npm/v/@fern/ts-express-casing)](https://www.npmjs.com/package/@fern/ts-express-casing)
...
```sh
npm i -s @fern/ts-express-casing
```
...
const client = new SeedApiClient({ baseUrl: "YOUR_BASE_URL", token: "YOUR_TOKEN" });
...
```typescript
import { SeedApiError } from "@fern/ts-express-casing";
...
```typescript
import { ImdbClient } from '@fern/ts-express-casing/imdb';
...
```typescript
import { SeedApiClient, logging } from "@fern/ts-express-casing";
