# Reference
## Auth
<details><summary><code>client.auth.<a href="/src/api/resources/auth/client/Client.ts">getTokenWithClientCredentials</a>({ ...params }) -> SeedInferredAuthImplicitNoExpiry.TokenResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.auth.<a href="/src/api/resources/auth/client/Client.ts">refreshToken</a>({ ...params }) -> SeedInferredAuthImplicitNoExpiry.TokenResponse</code></summary>
<dl>
<dd>
