...
export const TokenResponse: core.serialization.ObjectSchema<serializers.TokenResponse.Raw, SeedOauthClientCredentialsEnvironmentVariables.TokenResponse> = core.serialization.object({
