...
export const RefreshTokenRequest: core.serialization.Schema<serializers.RefreshTokenRequest.Raw, SeedOauthClientCredentialsEnvironmentVariables.RefreshTokenRequest> = core.serialization.object({
