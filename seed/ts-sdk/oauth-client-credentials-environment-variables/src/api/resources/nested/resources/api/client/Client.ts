...
export class ApiClient {
    ...
    private async __getSomething(requestOptions?: ApiClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "/nested/get-something"),
            method: "GET",
            headers: _headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout": throw new errors.SeedOauthClientCredentialsEnvironmentVariablesTimeoutError("Timeout exceeded when calling GET /nested/get-something.");
