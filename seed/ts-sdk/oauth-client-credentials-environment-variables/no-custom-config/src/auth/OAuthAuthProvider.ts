...
export class OAuthAuthProvider implements core.AuthProvider {
    ...
    public static canCreate(options?: Partial<OAuthAuthProvider.ClientCredentials & BaseClientOptions>): boolean {
        return (options?.[CLIENT_ID_PARAM] != null || process.env?.[ENV_CLIENT_ID] != null) && (options?.[CLIENT_SECRET_PARAM] != null || process.env?.[ENV_CLIENT_SECRET] != null);
    }
...
export namespace OAuthAuthProvider {
    ...
    export type ClientCredentials = {
                [CLIENT_ID_PARAM]?: core.Supplier<string> | undefined; [CLIENT_SECRET_PARAM]?: core.Supplier<string> | undefined
            };
