...
import type * as SeedWebsocketAuthFallback from "../../../index.js";
...
export declare namespace RealtimeSocket {
    ...
    export type Response = SeedWebsocketAuthFallback.ReceiveEvent;
    type EventHandlers = {
        open?: () => void;
...
export class RealtimeSocket {
    ...
    public sendSend(message: SeedWebsocketAuthFallback.SendEvent): void {
    ...
    protected sendJson(payload: SeedWebsocketAuthFallback.SendEvent): void {
