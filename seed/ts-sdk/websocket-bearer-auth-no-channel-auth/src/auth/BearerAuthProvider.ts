...
export class BearerAuthProvider implements core.AuthProvider {
    ...
    public async getAuthRequest(_arg?: { endpointMetadata?: core.EndpointMetadata }): Promise<core.AuthRequest> {
        ...
        if (apiKey == null) {
            throw new errors.SeedWebsocketBearerAuthNoChannelAuthError({
                message:
                    "Please specify a apiKey by either passing it in to the constructor or initializing a SEED_API_KEY environment variable",
            });
        }
