...
export class Service {
    ...
    private async __post(
        ...
        if (request.optional_metadata != null) {
            if (
                Array.isArray(request.optional_metadata) ||
                request.optional_metadata instanceof Set
            )
    ...
    public justFile(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__justFile(request, requestOptions),
        );
    }
    ...
    private async __justFile(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedFileUploadTimeoutError(
                    "Timeout exceeded when calling POST /just-file.",
                );
            case "unknown":
                throw new errors.SeedFileUploadError({
                    message: _response.error.errorMessage,
    ...
    public justFileWithQueryParams(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__justFileWithQueryParams(request, requestOptions),
        );
    }
    ...
    private async __justFileWithQueryParams(
        ...
        if (Array.isArray(request.listOfStrings)) {
            _queryParams.listOfStrings = request.listOfStrings.map(
                (item) => item,
            );
        } else {
        ...
        if (request.optionalListOfStrings != null) {
            if (Array.isArray(request.optionalListOfStrings)) {
                _queryParams.optionalListOfStrings =
                    request.optionalListOfStrings.map((item) => item);
            } else {
                _queryParams.optionalListOfStrings =
    ...
    public withContentType(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__withContentType(request, requestOptions),
        );
    }
    ...
    public withFormEncoding(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__withFormEncoding(request, requestOptions),
        );
    }
    ...
    private async __withFormEncoding(
        ...
        for (const [key, value] of Object.entries(
            core.encodeAsFormParameter({ foo: request.foo }),
        )) {
            _request.append(key, value);
        }

        for (const [key, value] of Object.entries(
            core.encodeAsFormParameter({ bar: request.bar }),
        )) {
            _request.append(key, value);
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedFileUploadTimeoutError(
                    "Timeout exceeded when calling POST /with-form-encoding.",
                );
            case "unknown":
                throw new errors.SeedFileUploadError({
                    message: _response.error.errorMessage,
    ...
    public withFormEncodedContainers(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__withFormEncodedContainers(request, requestOptions),
        );
    }
    ...
    private async __withFormEncodedContainers(
        ...
        if (request.maybe_string != null) {
            for (const [key, value] of Object.entries(
                core.encodeAsFormParameter({
                    maybe_string: request.maybe_string,
                }),
            )) {
                _request.append(key, value);
            }
        ...
        for (const [key, value] of Object.entries(
            core.encodeAsFormParameter({ integer: request.integer }),
        )) {
            _request.append(key, value);
        }
        ...
        if (request.maybe_integer != null) {
            for (const [key, value] of Object.entries(
                core.encodeAsFormParameter({
                    maybe_integer: request.maybe_integer,
                }),
            )) {
                _request.append(key, value);
            }
        ...
        if (request.optional_list_of_strings != null) {
            for (const [key, value] of Object.entries(
                core.encodeAsFormParameter({
                    optional_list_of_strings: request.optional_list_of_strings,
                }),
            )) {
                _request.append(key, value);
            }
        ...
        for (const [key, value] of Object.entries(
            core.encodeAsFormParameter({
                list_of_objects: request.list_of_objects,
            }),
        )) {
            _request.append(key, value);
        }
        ...
        if (request.optional_metadata != null) {
            for (const [key, value] of Object.entries(
                core.encodeAsFormParameter({
                    optional_metadata: request.optional_metadata,
                }),
            )) {
                _request.append(key, value);
            }
        ...
        if (request.optional_object_type != null) {
            for (const [key, value] of Object.entries(
                core.encodeAsFormParameter({
                    optional_object_type: request.optional_object_type,
                }),
            )) {
                _request.append(key, value);
            }
        ...
        for (const [key, value] of Object.entries(
            core.encodeAsFormParameter({
                list_of_objects_with_optionals:
                    request.list_of_objects_with_optionals,
            }),
        )) {
            _request.append(key, value);
        }
        ...
        for (const [key, value] of Object.entries(
            core.encodeAsFormParameter({
                list_of_alias_object: request.list_of_alias_object,
            }),
        )) {
            _request.append(key, value);
        }
        ...
        for (const [key, value] of Object.entries(
            core.encodeAsFormParameter({
                alias_list_of_object: request.alias_list_of_object,
            }),
        )) {
            _request.append(key, value);
        }
    ...
    public optionalArgs(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__optionalArgs(request, requestOptions),
        );
    }
    ...
    private async __optionalArgs(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedFileUploadTimeoutError(
                    "Timeout exceeded when calling POST /optional-args.",
                );
            case "unknown":
                throw new errors.SeedFileUploadError({
                    message: _response.error.errorMessage,
    ...
    public withInlineType(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__withInlineType(request, requestOptions),
        );
    }
    ...
    private async __withInlineType(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedFileUploadTimeoutError(
                    "Timeout exceeded when calling POST /inline-type.",
                );
            case "unknown":
                throw new errors.SeedFileUploadError({
                    message: _response.error.errorMessage,
