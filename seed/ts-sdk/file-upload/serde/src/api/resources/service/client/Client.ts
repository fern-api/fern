...
export class Service {
    ...
    private async __post(
        ...
        if (request.optionalMetadata != null) {
            if (
                Array.isArray(request.optionalMetadata) ||
                request.optionalMetadata instanceof Set
            )
    ...
    private async __withFormEncodedContainers(
        ...
        if (request.maybeString != null) {
            for (const [key, value] of Object.entries(
                core.encodeAsFormParameter({
                    maybe_string: request.maybeString,
                }),
            )) {
                _request.append(key, value);
            }
        ...
        if (request.maybeInteger != null) {
            for (const [key, value] of Object.entries(
                core.encodeAsFormParameter({
                    maybe_integer: request.maybeInteger,
                }),
            )) {
                _request.append(key, value);
            }
        ...
        if (request.optionalListOfStrings != null) {
            for (const [key, value] of Object.entries(
                core.encodeAsFormParameter({
                    optional_list_of_strings: request.optionalListOfStrings,
                }),
            )) {
                _request.append(key, value);
            }
        ...
        for (const [key, value] of Object.entries(
            core.encodeAsFormParameter({
                list_of_objects: request.listOfObjects,
            }),
        )) {
            _request.append(key, value);
        }
        ...
        if (request.optionalMetadata != null) {
            for (const [key, value] of Object.entries(
                core.encodeAsFormParameter({
                    optional_metadata: request.optionalMetadata,
                }),
            )) {
                _request.append(key, value);
            }
        ...
        if (request.optionalObjectType != null) {
            for (const [key, value] of Object.entries(
                core.encodeAsFormParameter({
                    optional_object_type: request.optionalObjectType,
                }),
            )) {
                _request.append(key, value);
            }
        ...
        for (const [key, value] of Object.entries(
            core.encodeAsFormParameter({
                list_of_alias_object: request.listOfAliasObject,
            }),
        )) {
            _request.append(key, value);
        }
        ...
        for (const [key, value] of Object.entries(
            core.encodeAsFormParameter({
                alias_list_of_object: request.aliasListOfObject,
            }),
        )) {
            _request.append(key, value);
        }
    ...
    private async __optionalArgs(
        ...
        if (_response.ok) {
            return {
                data: serializers.service.optionalArgs.Response.parseOrThrow(
                    _response.body,
                    {
    ...
    private async __withInlineType(
        ...
        if (_response.ok) {
            return {
                data: serializers.service.withInlineType.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
