...
[![npm shield](https://img.shields.io/npm/v/@fern/required-nullable)](https://www.npmjs.com/package/@fern/required-nullable)
...
```sh
npm i -s @fern/required-nullable
```
...
```typescript
import { SeedApi } from "@fern/required-nullable";

const request: SeedApi.GetFooRequest = {
    ...
};
```
...
```typescript
import { SeedApiClient, logging } from "@fern/required-nullable";
