...
export class AuthClient {
     ...
     *     })
     */
    public getToken(request: SeedOauthClientCredentials.auth.GetTokenRequest, requestOptions?: AuthClient.RequestOptions): core.HttpResponsePromise<core.APIResponse<SeedOauthClientCredentials.auth.TokenResponse, SeedOauthClientCredentials.auth.getToken.Error>> {
