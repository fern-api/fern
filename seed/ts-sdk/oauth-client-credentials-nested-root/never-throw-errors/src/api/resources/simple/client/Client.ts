...
export class Simple {
  ...
  public getSomething(
    ...
    core.APIResponse<void, SeedOauthClientCredentials.simple.getSomething.Error>
  > {
  ...
  private async __getSomething(
    ...
    core.WithRawResponse<
      core.APIResponse<
        void,
        SeedOauthClientCredentials.simple.getSomething.Error
      >
    >
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedOauthClientCredentials.simple.getSomething.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
