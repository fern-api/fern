...
export const TokenResponse: core.serialization.ObjectSchema<serializers.auth.TokenResponse.Raw, SeedOauthClientCredentials.auth.TokenResponse> = core.serialization.object({
