...
export const GetTokenRequest: core.serialization.Schema<serializers.auth.GetTokenRequest.Raw, SeedOauthClientCredentials.auth.GetTokenRequest> = core.serialization.object({
