...
export class AuthClient {
     ...
     *     })
     */
    public getToken(request: SeedOauthClientCredentials.auth.GetTokenRequest, requestOptions?: AuthClient.RequestOptions): core.HttpResponsePromise<SeedOauthClientCredentials.auth.TokenResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getToken(request, requestOptions));
    }

    private async __getToken(request: SeedOauthClientCredentials.auth.GetTokenRequest, requestOptions?: AuthClient.RequestOptions): Promise<core.WithRawResponse<SeedOauthClientCredentials.auth.TokenResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedOauthClientCredentials.auth.TokenResponse, rawResponse: _response.rawResponse };
        }
