...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.AuthTokenResponse> {
    ...
    private async __gettoken(
        request: SeedApi.AuthGetTokenRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.AuthTokenResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.AuthTokenResponse, rawResponse: _response.rawResponse };
        }
