...
```typescript
import { SeedApiClient } from "@fern/oauth-client-credentials-nested-root";
...
```typescript
import { SeedApi } from "@fern/oauth-client-credentials-nested-root";
...
```typescript
import { SeedApiError } from "@fern/oauth-client-credentials-nested-root";
...
```typescript
import { AuthClient } from '@fern/oauth-client-credentials-nested-root/auth';
...
```typescript
import { SeedApiClient, logging } from "@fern/oauth-client-credentials-nested-root";
