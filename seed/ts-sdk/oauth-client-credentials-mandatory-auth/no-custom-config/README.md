...
[![npm shield](https://img.shields.io/npm/v/@fern/oauth-client-credentials-mandatory-auth)](https://www.npmjs.com/package/@fern/oauth-client-credentials-mandatory-auth)
...
```sh
npm i -s @fern/oauth-client-credentials-mandatory-auth
```
...
```typescript
import { SeedOauthClientCredentialsMandatoryAuth } from "@fern/oauth-client-credentials-mandatory-auth";

const request: SeedOauthClientCredentialsMandatoryAuth.GetTokenRequest = {
    ...
};
```
...
```typescript
import { SeedOauthClientCredentialsMandatoryAuthError } from "@fern/oauth-client-credentials-mandatory-auth";

try {
    await client.auth.getTokenWithClientCredentials(...);
} catch (err) {
    if (err instanceof SeedOauthClientCredentialsMandatoryAuthError) {
...
```typescript
import { AuthClient } from '@fern/oauth-client-credentials-mandatory-auth/auth';
...
```typescript
import { SeedOauthClientCredentialsMandatoryAuthClient, logging } from "@fern/oauth-client-credentials-mandatory-auth";
