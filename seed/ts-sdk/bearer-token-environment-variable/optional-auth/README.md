...
```typescript
import { ServiceClient } from '@fern/bearer-token-environment-variable/service';
...
```typescript
import { SeedBearerTokenEnvironmentVariableClient, logging } from "@fern/bearer-token-environment-variable";
