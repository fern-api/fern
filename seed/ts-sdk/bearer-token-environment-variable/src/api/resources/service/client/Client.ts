...
export class Service {
     ...
     */
    public getWithBearerToken(requestOptions?: Service.RequestOptions): core.APIPromise<string> {
        return core.APIPromise.from(
            (async () => {
                ...
                if (_response.ok) {
                    return {
                        ok: _response.ok,
                        body: serializers.service.getWithBearerToken.Response.parseOrThrow(_response.body, {
