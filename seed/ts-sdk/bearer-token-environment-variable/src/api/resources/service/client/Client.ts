...
export class ServiceClient {
    ...
    private async __getWithBearerToken(requestOptions?: ServiceClient.RequestOptions): Promise<core.WithRawResponse<string>> {
        ...
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, mergeOnlyDefinedHeaders({ "X-API-Version": requestOptions?.version ?? "1.0.0" }), requestOptions?.headers);
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/apiKey");
    }
}
