...
export class ServiceClient {
    ...
    private async __getDirectThread(requestOptions?: ServiceClient.RequestOptions): Promise<core.WithRawResponse<SeedCrossPackageTypeNames.folderD.Response>> {
        ...
        if (_response.ok) {
            return { data: serializers.folderD.Response.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        }
