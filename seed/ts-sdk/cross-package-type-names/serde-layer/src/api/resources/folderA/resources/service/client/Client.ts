...
export class ServiceClient {
    ...
    private async __getDirectThread(requestOptions?: ServiceClient.RequestOptions): Promise<core.WithRawResponse<SeedCrossPackageTypeNames.folderA.Response>> {
        ...
        if (_response.ok) {
            return { data: serializers.folderA.Response.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        }
