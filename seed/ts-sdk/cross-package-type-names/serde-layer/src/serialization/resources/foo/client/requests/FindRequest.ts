...
export const FindRequest: core.serialization.Schema<serializers.FindRequest.Raw, Omit<SeedCrossPackageTypeNames.FindRequest, "optionalString">> = core.serialization.object({
