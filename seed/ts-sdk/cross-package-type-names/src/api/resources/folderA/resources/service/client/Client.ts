...
export class ServiceClient {
     ...
     */
    public getDirectThread(requestOptions?: ServiceClient.RequestOptions): core.HttpResponsePromise<SeedCrossPackageTypeNames.folderA.Response> {
        return core.HttpResponsePromise.fromPromise(this.__getDirectThread(requestOptions));
    }

    private async __getDirectThread(requestOptions?: ServiceClient.RequestOptions): Promise<core.WithRawResponse<SeedCrossPackageTypeNames.folderA.Response>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedCrossPackageTypeNames.folderA.Response, rawResponse: _response.rawResponse };
        }
