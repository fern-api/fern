...
export const TokenResponse: core.serialization.ObjectSchema<serializers.TokenResponse.Raw, SeedOauthClientCredentials.TokenResponse> = core.serialization.object({
