...
```typescript
const { data, rawResponse } = await client.service.getWithApiKey(...).withRawResponse();
...
```typescript
import { SeedAuthEnvironmentVariablesClient, logging } from "@fern/auth-environment-variables";
