...
[![npm shield](https://img.shields.io/npm/v/@fern/x-fern-global-parameters)](https://www.npmjs.com/package/@fern/x-fern-global-parameters)
...
```sh
npm i -s @fern/x-fern-global-parameters
```
...
```typescript
import { SeedApi } from "@fern/x-fern-global-parameters";

const request: SeedApi.SearchProductsRequest = {
    ...
};
```
...
```typescript
import { SeedApiError } from "@fern/x-fern-global-parameters";
...
```typescript
import { ProductsClient } from '@fern/x-fern-global-parameters/products';
...
```typescript
const { data, rawResponse } = await client.products.search(...).withRawResponse();
...
```typescript
import { SeedApiClient, logging } from "@fern/x-fern-global-parameters";
