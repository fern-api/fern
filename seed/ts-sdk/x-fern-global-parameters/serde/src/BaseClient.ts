...
export interface BaseClientOptions {
    ...
    xTraceId?: string;
    /** A datetime global must serialize to ISO-8601 on the wire, not String(Date). */
    updatedSince?: Date;
    ...
    const headers = mergeHeaders(
        {
            ...
            "X-Fern-SDK-Name": "@fern/x-fern-global-parameters",
            "X-Fern-SDK-Version": "0.0.1",
            "User-Agent": "@fern/x-fern-global-parameters/0.0.1",
