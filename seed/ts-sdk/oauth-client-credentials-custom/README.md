...
[![npm shield](https://img.shields.io/npm/v/@fern/oauth-client-credentials-custom)](https://www.npmjs.com/package/@fern/oauth-client-credentials-custom)
...
```sh
npm i -s @fern/oauth-client-credentials-custom
```
...
const client = new SeedOauthClientCredentialsClient({ baseUrl: "YOUR_BASE_URL", clientId: "YOUR_CLIENT_ID", clientSecret: "YOUR_CLIENT_SECRET" });
...
```typescript
import { SeedOauthClientCredentials } from "@fern/oauth-client-credentials-custom";
...
```typescript
import { SeedOauthClientCredentialsError } from "@fern/oauth-client-credentials-custom";
...
```typescript
import { AuthClient } from '@fern/oauth-client-credentials-custom/auth';
...
```typescript
import { SeedOauthClientCredentialsClient, logging } from "@fern/oauth-client-credentials-custom";
