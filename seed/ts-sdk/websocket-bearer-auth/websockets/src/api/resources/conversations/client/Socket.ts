...
export declare namespace ConversationsSocket {
    ...
    export type Response = SeedWebsocketBearerAuth.ConversationReceiveEvent;
    type EventHandlers = {
        open?: () => void;
...
export class ConversationsSocket {
    ...
    public sendSend(message: SeedWebsocketBearerAuth.ConversationSendEvent): void {
    ...
    protected sendJson(payload: SeedWebsocketBearerAuth.ConversationSendEvent): void {
