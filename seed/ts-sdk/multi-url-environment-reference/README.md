...
[![npm shield](https://img.shields.io/npm/v/@fern/multi-url-environment-reference)](https://www.npmjs.com/package/@fern/multi-url-environment-reference)
...
```sh
npm i -s @fern/multi-url-environment-reference
```
...
```typescript
import { SeedApiClient } from "@fern/multi-url-environment-reference";
...
```typescript
import { SeedApiClient, SeedApiEnvironment } from "@fern/multi-url-environment-reference";
...
```typescript
import { SeedApi } from "@fern/multi-url-environment-reference";
...
```typescript
import { SeedApiError } from "@fern/multi-url-environment-reference";
...
```typescript
import { ItemsClient } from '@fern/multi-url-environment-reference/items';
...
```typescript
import { SeedApiClient, logging } from "@fern/multi-url-environment-reference";
