...
import { SeedValidationClient as SeedValidationClient_SeedValidation } from "../../src/Client";
import { mockServerPool } from "../mock-server/MockServerPool";

describe("SeedValidationClient", () => {
    test("create", async () => {
        const server = mockServerPool.createServer();
        const client = new SeedValidationClient_SeedValidation({ environment: server.baseUrl });
