...
import type { CreateRequest } from "./api/client/requests/CreateRequest.js";
import type { GetRequest } from "./api/client/requests/GetRequest.js";
...
export class SeedValidationClient {
    ...
    private async __create(
        request: CreateRequest,
        requestOptions?: SeedValidationClient.RequestOptions,
    ): Promise<core.WithRawResponse<Type>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Type, rawResponse: _response.rawResponse };
        }
