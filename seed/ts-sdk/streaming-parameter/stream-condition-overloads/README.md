...
[![npm shield](https://img.shields.io/npm/v/@fern/streaming-parameter)](https://www.npmjs.com/package/@fern/streaming-parameter)
...
```sh
npm i -s @fern/streaming-parameter
```
...
```typescript
import { DummyClient } from '@fern/streaming-parameter/dummy';
...
```typescript
const { data, rawResponse } = await client.dummy.generate(...).withRawResponse();
