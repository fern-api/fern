...
export class SeedApiClient {
    ...
    /**
     * @param {SeedApi.ConvertRequest} request
     ...
     */
    public convert(
        request: SeedApi.ConvertRequest,
        requestOptions?: SeedApiClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.ConvertResponse> {
    ...
    private async __convert(
        request: SeedApi.ConvertRequest,
        requestOptions?: SeedApiClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.ConvertResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.ConvertResponse, rawResponse: _response.rawResponse };
        }
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/convert");
    }
}
