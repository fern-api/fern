...
export class Homepage {
     ...
     */
    public async getHomepageProblems(requestOptions?: Homepage.RequestOptions): Promise<core.APIResponse<SeedTrace.ProblemId[], SeedTrace.homepage.getHomepageProblems.Error>> {
     ...
     */
    public async setHomepageProblems(request: SeedTrace.ProblemId[], requestOptions?: Homepage.RequestOptions): Promise<core.APIResponse<void, SeedTrace.homepage.setHomepageProblems.Error>> {
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment) ?? environments.SeedTraceEnvironment.Prod, "/homepage-problems"),
            method: "POST",
            headers: {
