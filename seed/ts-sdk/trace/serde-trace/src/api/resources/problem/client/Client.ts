...
export class Problem {
    ...
    private async __createProblem(
        ...
        if (_response.ok) {
            return {
                data: serializers.CreateProblemResponse.parseOrThrow(
                    _response.body,
                    {
    ...
    private async __updateProblem(
        ...
        if (_response.ok) {
            return {
                data: serializers.UpdateProblemResponse.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getDefaultStarterFiles(
        ...
        if (_response.ok) {
            return {
                data: serializers.GetDefaultStarterFilesResponse.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
