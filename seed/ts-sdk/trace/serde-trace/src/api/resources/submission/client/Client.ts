...
export class Submission {
  ...
  private async __createExecutionSession(
    ...
    if (_response.ok) {
      return {
        data: serializers.ExecutionSessionResponse.parseOrThrow(
          _response.body,
          {
  ...
  > {
    ...
    if (_response.ok) {
      return {
        data: serializers.submission.getExecutionSession.Response.parseOrThrow(
          _response.body,
          {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
  ...
  private async __getExecutionSessionsState(
    ...
    if (_response.ok) {
      return {
        data: serializers.GetExecutionSessionStateResponse.parseOrThrow(
          _response.body,
          {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
