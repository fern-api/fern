...
export class Problem {
    ...
    private async __getLightweightProblems(
        ...
        if (_response.ok) {
            return {
                data: serializers.v2.problem.getLightweightProblems.Response.parseOrThrow(
                    _response.body,
                    {
    ...
    private async __getProblems(
        ...
        if (_response.ok) {
            return {
                data: serializers.v2.problem.getProblems.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getLatestProblem(
        ...
        if (_response.ok) {
            return {
                data: serializers.v2.ProblemInfoV2.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
