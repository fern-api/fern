...
export class Problem {
    ...
    public getLightweightProblems(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getLightweightProblems(requestOptions),
        );
    }
    ...
    private async __getLightweightProblems(
        ...
        core.WithRawResponse<SeedTrace.v2.v3.LightweightProblemInfoV2[]>
    > {
        ...
        if (_response.ok) {
            return {
                data: serializers.v2.v3.problem.getLightweightProblems.Response.parseOrThrow(
                    _response.body,
                    {
    ...
    public getProblems(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getProblems(requestOptions),
        );
    }
    ...
    private async __getProblems(
        ...
        if (_response.ok) {
            return {
                data: serializers.v2.v3.problem.getProblems.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    public getLatestProblem(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getLatestProblem(problemId, requestOptions),
        );
    }
    ...
    private async __getLatestProblem(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SeedTraceEnvironment.Prod,
                `/problems-v2/problem-info/${encodeURIComponent(serializers.ProblemId.jsonOrThrow(problemId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        if (_response.ok) {
            return {
                data: serializers.v2.v3.ProblemInfoV2.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SeedTraceEnvironment.Prod,
                `/problems-v2/problem-info/${encodeURIComponent(serializers.ProblemId.jsonOrThrow(problemId, { omitUndefined: true }))}/version/${encodeURIComponent(problemVersion)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
