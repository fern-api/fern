...
export class Homepage {
  ...
  public getHomepageProblems(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__getHomepageProblems(requestOptions),
    );
  }
  ...
  private async __getHomepageProblems(
    ...
    if (_response.ok) {
      return {
        data: serializers.homepage.getHomepageProblems.Response.parseOrThrow(
          _response.body,
          {
    ...
    switch (_response.error.reason) {
      ...
      case "timeout":
        throw new errors.SeedTraceTimeoutError(
          "Timeout exceeded when calling GET /homepage-problems.",
        );
      case "unknown":
        throw new errors.SeedTraceError({
  ...
  public setHomepageProblems(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__setHomepageProblems(request, requestOptions),
    );
  }
  ...
  private async __setHomepageProblems(
    ...
    const _response = await core.fetcher({
      ...
      queryParameters: requestOptions?.queryParams,
      requestType: "json",
      body: serializers.homepage.setHomepageProblems.Request.jsonOrThrow(
        request,
