...
export class Playlist {
    ...
    private async __getPlaylists(
        ...
        if (_response.ok) {
            return {
                data: serializers.playlist.getPlaylists.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
            ...
            switch ((_response.error.body as any)?.errorName) {
                case "PlaylistIdNotFoundError":
                    throw new SeedTrace.PlaylistIdNotFoundError(
                        serializers.PlaylistIdNotFoundErrorBody.parseOrThrow(
    ...
    private async __updatePlaylist(
        ...
        if (_response.ok) {
            return {
                data: serializers.playlist.updatePlaylist.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
