...
import type { SubmissionRequest } from "../../../../api/resources/submission/types/SubmissionRequest.js";
...
export const SubmissionRequest: core.serialization.Schema<serializers.SubmissionRequest.Raw, SubmissionRequest> =
    core.serialization
        .union("type", {
