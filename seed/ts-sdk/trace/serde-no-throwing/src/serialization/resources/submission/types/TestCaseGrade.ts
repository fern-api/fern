...
import type { TestCaseGrade } from "../../../../api/resources/submission/types/TestCaseGrade.js";
...
export const TestCaseGrade: core.serialization.Schema<serializers.TestCaseGrade.Raw, TestCaseGrade> = core.serialization
    .union("type", {
        hidden: TestCaseHiddenGrade,
        nonHidden: TestCaseNonHiddenGrade,
    })
    .transform<TestCaseGrade>({
