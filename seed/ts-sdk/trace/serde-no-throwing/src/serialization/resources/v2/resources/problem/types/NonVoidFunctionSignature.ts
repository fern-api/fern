...
export const NonVoidFunctionSignature: core.serialization.ObjectSchema<serializers.v2.NonVoidFunctionSignature.Raw, SeedTrace.v2.NonVoidFunctionSignature> = core.serialization.object({
