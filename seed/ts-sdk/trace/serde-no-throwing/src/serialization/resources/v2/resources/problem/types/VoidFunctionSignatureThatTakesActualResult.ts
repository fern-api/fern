...
export const VoidFunctionSignatureThatTakesActualResult: core.serialization.ObjectSchema<serializers.v2.VoidFunctionSignatureThatTakesActualResult.Raw, SeedTrace.v2.VoidFunctionSignatureThatTakesActualResult> = core.serialization.object({
