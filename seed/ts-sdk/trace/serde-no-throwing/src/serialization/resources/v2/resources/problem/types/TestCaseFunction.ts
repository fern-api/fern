...
import type { TestCaseFunction as TestCaseFunctionType } from "../../../../../../api/resources/v2/resources/problem/types/TestCaseFunction.js";
...
export const TestCaseFunction: core.serialization.Schema<serializers.v2.TestCaseFunction.Raw, TestCaseFunctionType> =
    core.serialization
        .union("type", {
