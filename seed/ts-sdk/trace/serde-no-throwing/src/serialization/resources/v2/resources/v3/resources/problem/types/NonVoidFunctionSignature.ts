...
export const NonVoidFunctionSignature: core.serialization.ObjectSchema<serializers.v2.v3.NonVoidFunctionSignature.Raw, SeedTrace.v2.v3.NonVoidFunctionSignature> = core.serialization.object({
