...
import type { CustomFiles as CustomFilesType } from "../../../../../../api/resources/v2/resources/problem/types/CustomFiles.js";
...
export const CustomFiles: core.serialization.Schema<serializers.v2.CustomFiles.Raw, CustomFilesType> =
    core.serialization
        .union("type", {
