...
import type { FunctionSignature } from "../../../../../../api/resources/v2/resources/problem/types/FunctionSignature.js";
...
export const FunctionSignature: core.serialization.Schema<serializers.v2.FunctionSignature.Raw, FunctionSignature> =
    core.serialization
        .union("type", {
