...
export class Problem {
    ...
    public createProblem(
        ...
        core.APIResponse<
            ...
            SeedTrace.problem.createProblem.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__createProblem(request, requestOptions),
        );
    }
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.CreateProblemResponse.parseOrThrow(
                        _response.body,
                        {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.problem.createProblem.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public updateProblem(
        ...
        core.APIResponse<
            ...
            SeedTrace.problem.updateProblem.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__updateProblem(problemId, request, requestOptions),
        );
    }
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SeedTraceEnvironment.Prod,
                `/problem-crud/update/${encodeURIComponent(serializers.ProblemId.jsonOrThrow(problemId, { omitUndefined: true }))}`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.UpdateProblemResponse.parseOrThrow(
                        _response.body,
                        {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.problem.updateProblem.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public deleteProblem(
        ...
        core.APIResponse<void, SeedTrace.problem.deleteProblem.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__deleteProblem(problemId, requestOptions),
        );
    }
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SeedTraceEnvironment.Prod,
                `/problem-crud/delete/${encodeURIComponent(serializers.ProblemId.jsonOrThrow(problemId, { omitUndefined: true }))}`,
            ),
            method: "DELETE",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.problem.deleteProblem.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getDefaultStarterFiles(
        ...
        core.APIResponse<
            ...
            SeedTrace.problem.getDefaultStarterFiles.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__getDefaultStarterFiles(request, requestOptions),
        );
    }
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.GetDefaultStarterFilesRequest.jsonOrThrow(
                request,
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.GetDefaultStarterFilesResponse.parseOrThrow(
                        _response.body,
                        {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.problem.getDefaultStarterFiles.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
