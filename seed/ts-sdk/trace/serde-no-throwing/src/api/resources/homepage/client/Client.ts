...
export class Homepage {
  ...
  public getHomepageProblems(
    ...
    core.APIResponse<
      SeedTrace.ProblemId[],
      SeedTrace.homepage.getHomepageProblems.Error
    >
  > {
  ...
  > {
    ...
    if (_response.ok) {
      return {
        data: {
          ok: true,
          body: serializers.homepage.getHomepageProblems.Response.parseOrThrow(
            _response.body,
            {
    ...
    return {
      data: {
        ok: false,
        error: SeedTrace.homepage.getHomepageProblems.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public setHomepageProblems(
    ...
    core.APIResponse<void, SeedTrace.homepage.setHomepageProblems.Error>
  > {
    return core.HttpResponsePromise.fromPromise(
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedTrace.homepage.setHomepageProblems.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
