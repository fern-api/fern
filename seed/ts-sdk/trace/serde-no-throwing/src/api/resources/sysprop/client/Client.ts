...
export class Sysprop {
  ...
  public setNumWarmInstances(
    ...
    core.APIResponse<void, SeedTrace.sysprop.setNumWarmInstances.Error>
  > {
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedTrace.sysprop.setNumWarmInstances.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  > {
    return core.HttpResponsePromise.fromPromise(
      this.__getNumWarmInstances(requestOptions),
    );
  }
  ...
  > {
    ...
    if (_response.ok) {
      return {
        data: {
          ok: true,
          body: serializers.sysprop.getNumWarmInstances.Response.parseOrThrow(
            _response.body,
            {
    ...
    return {
      data: {
        ok: false,
        error: SeedTrace.sysprop.getNumWarmInstances.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
