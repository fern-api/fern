...
export class Admin {
    ...
    public updateTestSubmissionStatus(
        ...
        core.APIResponse<void, SeedTrace.admin.updateTestSubmissionStatus.Error>
    > {
    ...
    private async __updateTestSubmissionStatus(
        ...
        core.WithRawResponse<
            core.APIResponse<
                void,
                SeedTrace.admin.updateTestSubmissionStatus.Error
            >
        >
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            ...
            mergeOnlyDefinedHeaders({
                ...
                "X-Random-Header":
                    requestOptions?.xRandomHeader ??
                    this._options?.xRandomHeader,
            }),
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.admin.updateTestSubmissionStatus.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public sendTestSubmissionUpdate(
        ...
        core.APIResponse<void, SeedTrace.admin.sendTestSubmissionUpdate.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    private async __sendTestSubmissionUpdate(
        ...
        core.WithRawResponse<
            core.APIResponse<
                void,
                SeedTrace.admin.sendTestSubmissionUpdate.Error
            >
        >
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.admin.sendTestSubmissionUpdate.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public updateWorkspaceSubmissionStatus(
        ...
        core.APIResponse<
            void,
            SeedTrace.admin.updateWorkspaceSubmissionStatus.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.admin.updateWorkspaceSubmissionStatus.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public sendWorkspaceSubmissionUpdate(
        ...
        core.APIResponse<
            void,
            SeedTrace.admin.sendWorkspaceSubmissionUpdate.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.admin.sendWorkspaceSubmissionUpdate.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public storeTracedTestCase(
        ...
        core.APIResponse<void, SeedTrace.admin.storeTracedTestCase.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.admin.storeTracedTestCase.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public storeTracedTestCaseV2(
        ...
        core.APIResponse<void, SeedTrace.admin.storeTracedTestCaseV2.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.admin.storeTracedTestCaseV2.Request.jsonOrThrow(
                request,
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.admin.storeTracedTestCaseV2.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public storeTracedWorkspace(
        ...
        core.APIResponse<void, SeedTrace.admin.storeTracedWorkspace.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__storeTracedWorkspace(submissionId, request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.admin.storeTracedWorkspace.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public storeTracedWorkspaceV2(
        ...
        core.APIResponse<void, SeedTrace.admin.storeTracedWorkspaceV2.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.admin.storeTracedWorkspaceV2.Request.jsonOrThrow(
                request,
                { unrecognizedObjectKeys: "strip", omitUndefined: true },
            ),
            timeoutMs:
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.admin.storeTracedWorkspaceV2.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
