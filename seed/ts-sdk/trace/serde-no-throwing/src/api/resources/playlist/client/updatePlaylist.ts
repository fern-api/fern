...
export const Error = {
        playlistIdNotFoundError: (value: SeedTrace.PlaylistIdNotFoundErrorBody): SeedTrace.playlist.updatePlaylist.Error.PlaylistIdNotFoundError => {
            return {
                content: value,
                errorName: "PlaylistIdNotFoundError",
                "_visit": function <_Result>(this: SeedTrace.playlist.updatePlaylist.Error.PlaylistIdNotFoundError, visitor: SeedTrace.playlist.updatePlaylist.Error._Visitor<_Result>) {
        ...
        _unknown: (fetcherError: core.Fetcher.Error): SeedTrace.playlist.updatePlaylist.Error._Unknown => {
            return {
                ...
                "_visit": function <_Result>(this: SeedTrace.playlist.updatePlaylist.Error._Unknown, visitor: SeedTrace.playlist.updatePlaylist.Error._Visitor<_Result>) {
                    return SeedTrace.playlist.updatePlaylist.Error._visit(this, visitor);
                }
            };
        },
        ...
        _visit: <_Result>(value: SeedTrace.playlist.updatePlaylist.Error, visitor: SeedTrace.playlist.updatePlaylist.Error._Visitor<_Result>): _Result => {
            switch (value.errorName) {
                case "PlaylistIdNotFoundError": return visitor.playlistIdNotFoundError((value as SeedTrace.playlist.updatePlaylist.Error.PlaylistIdNotFoundError).content);
