...
export class Playlist {
    ...
    public createPlaylist(
        ...
        core.APIResponse<
            SeedTrace.Playlist,
            SeedTrace.playlist.createPlaylist.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__createPlaylist(serviceParam, request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.playlist.createPlaylist.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getPlaylists(
        ...
        core.APIResponse<
            SeedTrace.Playlist[],
            SeedTrace.playlist.getPlaylists.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__getPlaylists(serviceParam, request, requestOptions),
        );
    }
    ...
    > {
        ...
        if (optionalMultipleField != null) {
            if (Array.isArray(optionalMultipleField)) {
                _queryParams.optionalMultipleField = optionalMultipleField.map(
                    (item) => item,
                );
            } else {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.playlist.getPlaylists.Response.parseOrThrow(
                        _response.body,
                        {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.playlist.getPlaylists.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__getPlaylist(serviceParam, playlistId, requestOptions),
        );
    }
    ...
    > {
        ...
        if (_response.error.reason === "status-code") {
            switch (
                (
                    _response.error
                        .body as serializers.playlist.getPlaylist.Error.Raw
                )?.errorName
            ) {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.playlist.getPlaylist.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            body:
                request != null
                    ? serializers.playlist.updatePlaylist.Request.jsonOrThrow(
                          request,
                          {
                              unrecognizedObjectKeys: "strip",
                              omitUndefined: true,
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.playlist.updatePlaylist.Response.parseOrThrow(
                        _response.body,
                        {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
        ...
        if (_response.error.reason === "status-code") {
            switch (
                (
                    _response.error
                        .body as serializers.playlist.updatePlaylist.Error.Raw
                )?.errorName
            ) {
                case "PlaylistIdNotFoundError":
                    return {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.playlist.updatePlaylist.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public deletePlaylist(
        ...
        core.APIResponse<void, SeedTrace.playlist.deletePlaylist.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__deletePlaylist(serviceParam, playlistId, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.playlist.deletePlaylist.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
