...
import type { TestCaseGrade as TestCaseGradeType } from "../../../../api/resources/submission/types/TestCaseGrade.js";
...
export const TestCaseGrade: core.serialization.Schema<serializers.TestCaseGrade.Raw, TestCaseGradeType> =
    core.serialization
        .union("type", {
            hidden: TestCaseHiddenGrade,
            nonHidden: TestCaseNonHiddenGrade,
        })
        .transform<TestCaseGradeType>({
