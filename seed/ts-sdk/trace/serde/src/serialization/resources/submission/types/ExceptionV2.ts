...
import type { ExceptionV2 } from "../../../../api/resources/submission/types/ExceptionV2.js";
import * as core from "../../../../core/index.js";
import type * as serializers from "../../../index.js";
import { ExceptionInfo } from "./ExceptionInfo.js";

export const ExceptionV2: core.serialization.Schema<serializers.ExceptionV2.Raw, ExceptionV2> = core.serialization
    .union("type", {
        generic: ExceptionInfo,
        timeout: core.serialization.object({}),
    })
    .transform<ExceptionV2>({
