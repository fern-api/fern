...
import type { SubmissionTypeState as SeedTrace_SubmissionTypeState } from "../../../../api/resources/submission/types/SubmissionTypeState.js";
...
export const SubmissionTypeState: core.serialization.Schema<
    ...
    SeedTrace_SubmissionTypeState
> = core.serialization
    .union("type", {
        test: TestSubmissionState,
        workspace: WorkspaceSubmissionState,
    })
    .transform<SeedTrace_SubmissionTypeState>({
