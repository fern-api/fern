...
import type { SubmissionTypeState } from "../../../../api/resources/submission/types/SubmissionTypeState.js";
...
export const SubmissionTypeState: core.serialization.Schema<serializers.SubmissionTypeState.Raw, SubmissionTypeState> =
    core.serialization
        .union("type", {
            test: TestSubmissionState,
            workspace: WorkspaceSubmissionState,
        })
        .transform<SubmissionTypeState>({
