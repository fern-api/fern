...
import type { FunctionSignature as FunctionSignatureType } from "../../../../../../api/resources/v2/resources/problem/types/FunctionSignature.js";
...
export const FunctionSignature: core.serialization.Schema<serializers.v2.FunctionSignature.Raw, FunctionSignatureType> =
    core.serialization
        .union("type", {
        ...
        .transform<FunctionSignatureType>({
