...
describe("PlaylistClient", () => {
    ...
    test("createPlaylist", async () => {
        ...
        const rawResponseBody = { "playlist_id" : "playlist_id" , "owner-id" : "owner-id" , "name" : "name" , "problems" : [ "problems" , "problems" ] };
        server
            .mockEndpoint()
            .post("/v2/playlist/1/create").jsonBody(rawRequestBody)
                .respondWith()
    ...
    test("getPlaylists", async () => {
        ...
        const rawResponseBody = [ { "playlist_id" : "playlist_id" , "owner-id" : "owner-id" , "name" : "name" , "problems" : [ "problems" , "problems" ] } , { "playlist_id" : "playlist_id" , "owner-id" : "owner-id" , "name" : "name" , "problems" : [ "problems" , "problems" ] } ];
        server
            .mockEndpoint()
            .get("/v2/playlist/1/all").respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("getPlaylist (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/v2/playlist/1/playlistId").respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("updatePlaylist (1)", async () => {
        ...
        server
            .mockEndpoint()
            .put("/v2/playlist/1/playlistId").jsonBody(rawRequestBody)
                .respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("deletePlaylist", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/v2/playlist/1/playlist_id").respondWith()
