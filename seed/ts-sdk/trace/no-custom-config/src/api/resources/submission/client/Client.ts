...
export class Submission {
    ...
    public createExecutionSession(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__createExecutionSession(language, requestOptions),
        );
    }
    ...
    private async __createExecutionSession(
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedTrace.ExecutionSessionResponse,
    ...
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__getExecutionSession(sessionId, requestOptions),
        );
    }
    ...
    private async __getExecutionSession(
        ...
        core.WithRawResponse<SeedTrace.ExecutionSessionResponse | undefined>
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedTraceTimeoutError(
                    "Timeout exceeded when calling GET /sessions/{sessionId}.",
                );
            case "unknown":
                throw new errors.SeedTraceError({
                    message: _response.error.errorMessage,
    ...
    public stopExecutionSession(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__stopExecutionSession(sessionId, requestOptions),
        );
    }
    ...
    public getExecutionSessionsState(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getExecutionSessionsState(requestOptions),
        );
    }
    ...
    private async __getExecutionSessionsState(
        ...
        core.WithRawResponse<SeedTrace.GetExecutionSessionStateResponse>
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
