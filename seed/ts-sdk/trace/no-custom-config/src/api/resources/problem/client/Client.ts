...
export class Problem {
     ...
     *     })
     */
    public async createProblem(request: SeedTrace.CreateProblemRequest, requestOptions?: Problem.RequestOptions): Promise<SeedTrace.CreateProblemResponse> {
        ...
        if (_response.ok) {
            return serializers.CreateProblemResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, breadcrumbsPrefix: ["response"] });
        }
     ...
     *     })
     */
    public async updateProblem(problemId: SeedTrace.ProblemId, request: SeedTrace.CreateProblemRequest, requestOptions?: Problem.RequestOptions): Promise<SeedTrace.UpdateProblemResponse> {
        const _response = await core.fetcher({
        ...
        if (_response.ok) {
            return serializers.UpdateProblemResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, breadcrumbsPrefix: ["response"] });
        }
     ...
     *     })
     */
    public async getDefaultStarterFiles(request: SeedTrace.GetDefaultStarterFilesRequest, requestOptions?: Problem.RequestOptions): Promise<SeedTrace.GetDefaultStarterFilesResponse> {
        const _response = await core.fetcher({
        ...
        if (_response.ok) {
            return serializers.GetDefaultStarterFilesResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, breadcrumbsPrefix: ["response"] });
        }
