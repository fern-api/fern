...
describe("HomepageClient", () => {
    ...
    test("getHomepageProblems", async () => {
        ...
        server
            .mockEndpoint()
            .get("/homepage-problems").respondWith()
    ...
    test("setHomepageProblems", async () => {
        ...
        server
            .mockEndpoint()
            .post("/homepage-problems").jsonBody(rawRequestBody)
                .respondWith()
            .statusCode(200).build();

        
                    
                            const response = await client.homepage.setHomepageProblems([SeedTrace.ProblemId("string"), SeedTrace.ProblemId("string")]);
                            expect(response).toEqual({
                    body: undefined,
                    ok: true,
                    headers: expect.any(Object),
