...
describe("Problem", () => {
    ...
    test("getLatestProblem", async () => {
        ...
        const response = await client.v2.v3.problem.getLatestProblem(
                ...
                customFiles: {
                    ...
                    signature: {
                        parameters: [
                            {
                                parameterId:
                                    SeedTrace.v2.v3.ParameterId("parameterId"),
                                name: "name",
                                variableType: {
                                    type: "integerType",
                                },
                    ...
                    basicTestCaseTemplate: {
                        templateId:
                            SeedTrace.v2.v3.TestCaseTemplateId("templateId"),
                        name: "name",
                        description: {
                            boards: [
                                {
    ...
    test("getProblemVersion", async () => {
        ...
        const response = await client.v2.v3.problem.getProblemVersion(
            SeedTrace.ProblemId("problemId"),
            1,
        );
        expect(response).toEqual({
