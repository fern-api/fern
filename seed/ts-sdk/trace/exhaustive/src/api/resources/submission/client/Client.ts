...
export class Submission {
    ...
    public createExecutionSession(
        ...
        core.APIResponse<
            ...
            SeedTrace.submission.createExecutionSession.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.submission.createExecutionSession.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.submission.getExecutionSession.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public stopExecutionSession(
        ...
        core.APIResponse<void, SeedTrace.submission.stopExecutionSession.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    private async __stopExecutionSession(
        ...
        core.WithRawResponse<
            core.APIResponse<
                void,
                SeedTrace.submission.stopExecutionSession.Error
            >
        >
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.submission.stopExecutionSession.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.submission.getExecutionSessionsState.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
