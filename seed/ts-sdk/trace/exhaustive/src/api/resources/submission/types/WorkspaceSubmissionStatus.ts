...
export const WorkspaceSubmissionStatus = {
        stopped: (): SeedTrace.WorkspaceSubmissionStatus.Stopped => {
            return {
                type: "stopped",
                "_visit": function <_Result>(this: SeedTrace.WorkspaceSubmissionStatus.Stopped, visitor: SeedTrace.WorkspaceSubmissionStatus._Visitor<_Result>) {
        ...
        errored: (value: SeedTrace.ErrorInfo): SeedTrace.WorkspaceSubmissionStatus.Errored => {
            return {
                value: value,
                type: "errored",
                "_visit": function <_Result>(this: SeedTrace.WorkspaceSubmissionStatus.Errored, visitor: SeedTrace.WorkspaceSubmissionStatus._Visitor<_Result>) {
                    return SeedTrace.WorkspaceSubmissionStatus._visit(this, visitor);
                }
            };
        },
        ...
        running: (value: SeedTrace.RunningSubmissionState): SeedTrace.WorkspaceSubmissionStatus.Running => {
            return {
                value: value,
                type: "running",
                "_visit": function <_Result>(this: SeedTrace.WorkspaceSubmissionStatus.Running, visitor: SeedTrace.WorkspaceSubmissionStatus._Visitor<_Result>) {
                    return SeedTrace.WorkspaceSubmissionStatus._visit(this, visitor);
                }
            };
        },
        ...
        ran: (value: SeedTrace.WorkspaceRunDetails): SeedTrace.WorkspaceSubmissionStatus.Ran => {
            return {
                ...value,
                type: "ran",
                "_visit": function <_Result>(this: SeedTrace.WorkspaceSubmissionStatus.Ran, visitor: SeedTrace.WorkspaceSubmissionStatus._Visitor<_Result>) {
                    return SeedTrace.WorkspaceSubmissionStatus._visit(this, visitor);
                }
            };
        },
        ...
        traced: (value: SeedTrace.WorkspaceRunDetails): SeedTrace.WorkspaceSubmissionStatus.Traced => {
            return {
                ...value,
                type: "traced",
                "_visit": function <_Result>(this: SeedTrace.WorkspaceSubmissionStatus.Traced, visitor: SeedTrace.WorkspaceSubmissionStatus._Visitor<_Result>) {
                    return SeedTrace.WorkspaceSubmissionStatus._visit(this, visitor);
                }
            };
        },
        ...
        _unknown: (value: {
            ...
            return {
                ...(value as any),
                "_visit": function <_Result>(this: SeedTrace.WorkspaceSubmissionStatus._Unknown, visitor: SeedTrace.WorkspaceSubmissionStatus._Visitor<_Result>) {
                    return SeedTrace.WorkspaceSubmissionStatus._visit(this, visitor);
                }
            };
        },

        _visit: <_Result>(value: SeedTrace.WorkspaceSubmissionStatus, visitor: SeedTrace.WorkspaceSubmissionStatus._Visitor<_Result>): _Result => {
            switch (value.type) {
