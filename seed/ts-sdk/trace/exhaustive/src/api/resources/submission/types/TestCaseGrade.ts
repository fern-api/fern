...
export const TestCaseGrade = {
        hidden: (value: SeedTrace.TestCaseHiddenGrade): SeedTrace.TestCaseGrade.Hidden => {
            return {
                ...value,
                type: "hidden",
                "_visit": function <_Result>(this: SeedTrace.TestCaseGrade.Hidden, visitor: SeedTrace.TestCaseGrade._Visitor<_Result>) {
        ...
        nonHidden: (value: SeedTrace.TestCaseNonHiddenGrade): SeedTrace.TestCaseGrade.NonHidden => {
            return {
                ...value,
                type: "nonHidden",
                "_visit": function <_Result>(this: SeedTrace.TestCaseGrade.NonHidden, visitor: SeedTrace.TestCaseGrade._Visitor<_Result>) {
                    return SeedTrace.TestCaseGrade._visit(this, visitor);
                }
            };
        },
        ...
        _unknown: (value: {
            ...
            return {
                ...(value as any),
                "_visit": function <_Result>(this: SeedTrace.TestCaseGrade._Unknown, visitor: SeedTrace.TestCaseGrade._Visitor<_Result>) {
                    return SeedTrace.TestCaseGrade._visit(this, visitor);
                }
            };
        },
