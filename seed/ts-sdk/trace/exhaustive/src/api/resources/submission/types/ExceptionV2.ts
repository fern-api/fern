...
export const ExceptionV2 = {
        generic: (value: SeedTrace.ExceptionInfo): SeedTrace.ExceptionV2.Generic => {
            return {
                ...value,
                type: "generic",
                "_visit": function <_Result>(this: SeedTrace.ExceptionV2.Generic, visitor: SeedTrace.ExceptionV2._Visitor<_Result>) {
        ...
        timeout: (): SeedTrace.ExceptionV2.Timeout => {
            return {
                type: "timeout",
                "_visit": function <_Result>(this: SeedTrace.ExceptionV2.Timeout, visitor: SeedTrace.ExceptionV2._Visitor<_Result>) {
                    return SeedTrace.ExceptionV2._visit(this, visitor);
                }
            };
        },
        ...
        _unknown: (value: {
            ...
            return {
                ...(value as any),
                "_visit": function <_Result>(this: SeedTrace.ExceptionV2._Unknown, visitor: SeedTrace.ExceptionV2._Visitor<_Result>) {
                    return SeedTrace.ExceptionV2._visit(this, visitor);
                }
            };
        },
