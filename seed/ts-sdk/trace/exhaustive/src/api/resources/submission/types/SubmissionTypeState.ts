...
export const SubmissionTypeState = {
        test: (value: SeedTrace.TestSubmissionState): SeedTrace.SubmissionTypeState.Test => {
            return {
                ...value,
                type: "test",
                "_visit": function <_Result>(this: SeedTrace.SubmissionTypeState.Test, visitor: SeedTrace.SubmissionTypeState._Visitor<_Result>) {
        ...
        workspace: (value: SeedTrace.WorkspaceSubmissionState): SeedTrace.SubmissionTypeState.Workspace => {
            return {
                ...value,
                type: "workspace",
                "_visit": function <_Result>(this: SeedTrace.SubmissionTypeState.Workspace, visitor: SeedTrace.SubmissionTypeState._Visitor<_Result>) {
                    return SeedTrace.SubmissionTypeState._visit(this, visitor);
                }
            };
        },
        ...
        _unknown: (value: {
            ...
            return {
                ...(value as any),
                "_visit": function <_Result>(this: SeedTrace.SubmissionTypeState._Unknown, visitor: SeedTrace.SubmissionTypeState._Visitor<_Result>) {
                    return SeedTrace.SubmissionTypeState._visit(this, visitor);
                }
            };
        },

        _visit: <_Result>(value: SeedTrace.SubmissionTypeState, visitor: SeedTrace.SubmissionTypeState._Visitor<_Result>): _Result => {
            switch (value.type) {
