...
export const SubmissionStatusV2 = {
        test: (value: SeedTrace.TestSubmissionStatusV2): SeedTrace.SubmissionStatusV2.Test => {
            return {
                ...value,
                type: "test",
                "_visit": function <_Result>(this: SeedTrace.SubmissionStatusV2.Test, visitor: SeedTrace.SubmissionStatusV2._Visitor<_Result>) {
        ...
        workspace: (value: SeedTrace.WorkspaceSubmissionStatusV2): SeedTrace.SubmissionStatusV2.Workspace => {
            return {
                ...value,
                type: "workspace",
                "_visit": function <_Result>(this: SeedTrace.SubmissionStatusV2.Workspace, visitor: SeedTrace.SubmissionStatusV2._Visitor<_Result>) {
                    return SeedTrace.SubmissionStatusV2._visit(this, visitor);
                }
            };
        },
        ...
        _unknown: (value: {
            ...
            return {
                ...(value as any),
                "_visit": function <_Result>(this: SeedTrace.SubmissionStatusV2._Unknown, visitor: SeedTrace.SubmissionStatusV2._Visitor<_Result>) {
                    return SeedTrace.SubmissionStatusV2._visit(this, visitor);
                }
            };
        },

        _visit: <_Result>(value: SeedTrace.SubmissionStatusV2, visitor: SeedTrace.SubmissionStatusV2._Visitor<_Result>): _Result => {
            switch (value.type) {
