...
export const CreateProblemResponse = {
        success: (value: SeedTrace.ProblemId): SeedTrace.CreateProblemResponse.Success => {
            return {
                value: value,
                type: "success",
                "_visit": function <_Result>(this: SeedTrace.CreateProblemResponse.Success, visitor: SeedTrace.CreateProblemResponse._Visitor<_Result>) {
        ...
        error: (value: SeedTrace.CreateProblemError): SeedTrace.CreateProblemResponse.Error_ => {
            return {
                value: value,
                type: "error",
                "_visit": function <_Result>(this: SeedTrace.CreateProblemResponse.Error_, visitor: SeedTrace.CreateProblemResponse._Visitor<_Result>) {
                    return SeedTrace.CreateProblemResponse._visit(this, visitor);
                }
            };
        },
        ...
        _unknown: (value: {
            ...
            return {
                ...(value as any),
                "_visit": function <_Result>(this: SeedTrace.CreateProblemResponse._Unknown, visitor: SeedTrace.CreateProblemResponse._Visitor<_Result>) {
                    return SeedTrace.CreateProblemResponse._visit(this, visitor);
                }
            };
        },

        _visit: <_Result>(value: SeedTrace.CreateProblemResponse, visitor: SeedTrace.CreateProblemResponse._Visitor<_Result>): _Result => {
            switch (value.type) {
