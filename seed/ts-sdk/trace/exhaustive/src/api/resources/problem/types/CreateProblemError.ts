...
export const CreateProblemError = {
        generic: (value: SeedTrace.GenericCreateProblemError): SeedTrace.CreateProblemError.Generic => {
            return {
                ...value,
                errorType: "generic",
                "_visit": function <_Result>(this: SeedTrace.CreateProblemError.Generic, visitor: SeedTrace.CreateProblemError._Visitor<_Result>) {
        ...
        _unknown: (value: {
            ...
            return {
                ...(value as any),
                "_visit": function <_Result>(this: SeedTrace.CreateProblemError._Unknown, visitor: SeedTrace.CreateProblemError._Visitor<_Result>) {
                    return SeedTrace.CreateProblemError._visit(this, visitor);
                }
            };
        },

        _visit: <_Result>(value: SeedTrace.CreateProblemError, visitor: SeedTrace.CreateProblemError._Visitor<_Result>): _Result => {
