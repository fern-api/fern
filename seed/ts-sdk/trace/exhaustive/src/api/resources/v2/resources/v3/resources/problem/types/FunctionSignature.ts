...
export const FunctionSignature = {
        void: (value: SeedTrace.v2.v3.VoidFunctionSignature): SeedTrace.v2.v3.FunctionSignature.Void => {
            return {
                ...value,
                type: "void",
                "_visit": function <_Result>(this: SeedTrace.v2.v3.FunctionSignature.Void, visitor: SeedTrace.v2.v3.FunctionSignature._Visitor<_Result>) {
        ...
        nonVoid: (value: SeedTrace.v2.v3.NonVoidFunctionSignature): SeedTrace.v2.v3.FunctionSignature.NonVoid => {
            return {
                ...value,
                type: "nonVoid",
                "_visit": function <_Result>(this: SeedTrace.v2.v3.FunctionSignature.NonVoid, visitor: SeedTrace.v2.v3.FunctionSignature._Visitor<_Result>) {
                    return SeedTrace.v2.v3.FunctionSignature._visit(this, visitor);
                }
            };
        },

        voidThatTakesActualResult: (value: SeedTrace.v2.v3.VoidFunctionSignatureThatTakesActualResult): SeedTrace.v2.v3.FunctionSignature.VoidThatTakesActualResult => {
            return {
                ...value,
                type: "voidThatTakesActualResult",
                "_visit": function <_Result>(this: SeedTrace.v2.v3.FunctionSignature.VoidThatTakesActualResult, visitor: SeedTrace.v2.v3.FunctionSignature._Visitor<_Result>) {
                    return SeedTrace.v2.v3.FunctionSignature._visit(this, visitor);
                }
            };
        },
        ...
        _unknown: (value: {
            ...
            return {
                ...(value as any),
                "_visit": function <_Result>(this: SeedTrace.v2.v3.FunctionSignature._Unknown, visitor: SeedTrace.v2.v3.FunctionSignature._Visitor<_Result>) {
                    return SeedTrace.v2.v3.FunctionSignature._visit(this, visitor);
                }
            };
        },

        _visit: <_Result>(value: SeedTrace.v2.v3.FunctionSignature, visitor: SeedTrace.v2.v3.FunctionSignature._Visitor<_Result>): _Result => {
            switch (value.type) {
