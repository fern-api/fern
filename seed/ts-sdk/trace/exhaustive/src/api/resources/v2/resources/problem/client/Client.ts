...
export class Problem {
    ...
    public getLightweightProblems(
        ...
        core.APIResponse<
            ...
            SeedTrace.v2.problem.getLightweightProblems.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.v2.problem.getLightweightProblems.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getProblems(
        ...
        core.APIResponse<
            ...
            SeedTrace.v2.problem.getProblems.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.v2.problem.getProblems.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getLatestProblem(
        ...
        core.APIResponse<
            SeedTrace.v2.ProblemInfoV2,
            SeedTrace.v2.problem.getLatestProblem.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.v2.problem.getLatestProblem.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getProblemVersion(
        ...
        core.APIResponse<
            SeedTrace.v2.ProblemInfoV2,
            SeedTrace.v2.problem.getProblemVersion.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedTrace.v2.problem.getProblemVersion.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
