...
export const CustomFiles = {
        basic: (value: SeedTrace.v2.BasicCustomFiles): SeedTrace.v2.CustomFiles.Basic => {
            return {
                ...value,
                type: "basic",
                "_visit": function <_Result>(this: SeedTrace.v2.CustomFiles.Basic, visitor: SeedTrace.v2.CustomFiles._Visitor<_Result>) {
        ...
        custom: (value: Record<SeedTrace.Language, SeedTrace.v2.Files | undefined>): SeedTrace.v2.CustomFiles.Custom => {
            return {
                value: value,
                type: "custom",
                "_visit": function <_Result>(this: SeedTrace.v2.CustomFiles.Custom, visitor: SeedTrace.v2.CustomFiles._Visitor<_Result>) {
                    return SeedTrace.v2.CustomFiles._visit(this, visitor);
                }
            };
        },
        ...
        _unknown: (value: {
            ...
            return {
                ...(value as any),
                "_visit": function <_Result>(this: SeedTrace.v2.CustomFiles._Unknown, visitor: SeedTrace.v2.CustomFiles._Visitor<_Result>) {
                    return SeedTrace.v2.CustomFiles._visit(this, visitor);
                }
            };
        },

        _visit: <_Result>(value: SeedTrace.v2.CustomFiles, visitor: SeedTrace.v2.CustomFiles._Visitor<_Result>): _Result => {
            switch (value.type) {
