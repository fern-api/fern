...
export const TestCaseImplementationDescriptionBoard = {
        html: (value: string): SeedTrace.v2.v3.TestCaseImplementationDescriptionBoard.Html => {
            return {
                value: value,
                type: "html",
                "_visit": function <_Result>(this: SeedTrace.v2.v3.TestCaseImplementationDescriptionBoard.Html, visitor: SeedTrace.v2.v3.TestCaseImplementationDescriptionBoard._Visitor<_Result>) {
        ...
        paramId: (value: SeedTrace.v2.v3.ParameterId): SeedTrace.v2.v3.TestCaseImplementationDescriptionBoard.ParamId => {
            return {
                value: value,
                type: "paramId",
                "_visit": function <_Result>(this: SeedTrace.v2.v3.TestCaseImplementationDescriptionBoard.ParamId, visitor: SeedTrace.v2.v3.TestCaseImplementationDescriptionBoard._Visitor<_Result>) {
                    return SeedTrace.v2.v3.TestCaseImplementationDescriptionBoard._visit(this, visitor);
                }
            };
        },
        ...
        _unknown: (value: {
            ...
            return {
                ...(value as any),
                "_visit": function <_Result>(this: SeedTrace.v2.v3.TestCaseImplementationDescriptionBoard._Unknown, visitor: SeedTrace.v2.v3.TestCaseImplementationDescriptionBoard._Visitor<_Result>) {
                    return SeedTrace.v2.v3.TestCaseImplementationDescriptionBoard._visit(this, visitor);
                }
            };
        },

        _visit: <_Result>(value: SeedTrace.v2.v3.TestCaseImplementationDescriptionBoard, visitor: SeedTrace.v2.v3.TestCaseImplementationDescriptionBoard._Visitor<_Result>): _Result => {
            switch (value.type) {
