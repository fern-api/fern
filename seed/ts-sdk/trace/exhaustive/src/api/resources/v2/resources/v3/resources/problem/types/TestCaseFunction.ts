...
export const TestCaseFunction = {
        withActualResult: (value: SeedTrace.v2.v3.TestCaseWithActualResultImplementation): SeedTrace.v2.v3.TestCaseFunction.WithActualResult => {
            return {
                ...value,
                type: "withActualResult",
                "_visit": function <_Result>(this: SeedTrace.v2.v3.TestCaseFunction.WithActualResult, visitor: SeedTrace.v2.v3.TestCaseFunction._Visitor<_Result>) {
        ...
        custom: (value: SeedTrace.v2.v3.VoidFunctionDefinition): SeedTrace.v2.v3.TestCaseFunction.Custom => {
            return {
                ...value,
                type: "custom",
                "_visit": function <_Result>(this: SeedTrace.v2.v3.TestCaseFunction.Custom, visitor: SeedTrace.v2.v3.TestCaseFunction._Visitor<_Result>) {
                    return SeedTrace.v2.v3.TestCaseFunction._visit(this, visitor);
                }
            };
        },
        ...
        _unknown: (value: {
            ...
            return {
                ...(value as any),
                "_visit": function <_Result>(this: SeedTrace.v2.v3.TestCaseFunction._Unknown, visitor: SeedTrace.v2.v3.TestCaseFunction._Visitor<_Result>) {
                    return SeedTrace.v2.v3.TestCaseFunction._visit(this, visitor);
                }
            };
        },

        _visit: <_Result>(value: SeedTrace.v2.v3.TestCaseFunction, visitor: SeedTrace.v2.v3.TestCaseFunction._Visitor<_Result>): _Result => {
            switch (value.type) {
