...
export class Migration {
  ...
  public getAttemptedMigrations(
    ...
    core.APIResponse<
      SeedTrace.Migration[],
      SeedTrace.migration.getAttemptedMigrations.Error
    >
  > {
    return core.HttpResponsePromise.fromPromise(
      this.__getAttemptedMigrations(request, requestOptions),
    );
  }
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedTrace.migration.getAttemptedMigrations.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
