...
export const VariableType = {
        integerType: (): SeedTrace.VariableType.IntegerType => {
            return {
                type: "integerType",
                "_visit": function <_Result>(this: SeedTrace.VariableType.IntegerType, visitor: SeedTrace.VariableType._Visitor<_Result>) {
        ...
        doubleType: (): SeedTrace.VariableType.DoubleType => {
            return {
                type: "doubleType",
                "_visit": function <_Result>(this: SeedTrace.VariableType.DoubleType, visitor: SeedTrace.VariableType._Visitor<_Result>) {
                    return SeedTrace.VariableType._visit(this, visitor);
                }
            };
        },
        ...
        booleanType: (): SeedTrace.VariableType.BooleanType => {
            return {
                type: "booleanType",
                "_visit": function <_Result>(this: SeedTrace.VariableType.BooleanType, visitor: SeedTrace.VariableType._Visitor<_Result>) {
                    return SeedTrace.VariableType._visit(this, visitor);
                }
            };
        },
        ...
        stringType: (): SeedTrace.VariableType.StringType => {
            return {
                type: "stringType",
                "_visit": function <_Result>(this: SeedTrace.VariableType.StringType, visitor: SeedTrace.VariableType._Visitor<_Result>) {
                    return SeedTrace.VariableType._visit(this, visitor);
                }
            };
        },
        ...
        charType: (): SeedTrace.VariableType.CharType => {
            return {
                type: "charType",
                "_visit": function <_Result>(this: SeedTrace.VariableType.CharType, visitor: SeedTrace.VariableType._Visitor<_Result>) {
                    return SeedTrace.VariableType._visit(this, visitor);
                }
            };
        },
        ...
        listType: (value: SeedTrace.ListType): SeedTrace.VariableType.ListType => {
            return {
                ...value,
                type: "listType",
                "_visit": function <_Result>(this: SeedTrace.VariableType.ListType, visitor: SeedTrace.VariableType._Visitor<_Result>) {
                    return SeedTrace.VariableType._visit(this, visitor);
                }
            };
        },
        ...
        mapType: (value: SeedTrace.MapType): SeedTrace.VariableType.MapType => {
            return {
                ...value,
                type: "mapType",
                "_visit": function <_Result>(this: SeedTrace.VariableType.MapType, visitor: SeedTrace.VariableType._Visitor<_Result>) {
                    return SeedTrace.VariableType._visit(this, visitor);
                }
            };
        },
        ...
        binaryTreeType: (): SeedTrace.VariableType.BinaryTreeType => {
            return {
                type: "binaryTreeType",
                "_visit": function <_Result>(this: SeedTrace.VariableType.BinaryTreeType, visitor: SeedTrace.VariableType._Visitor<_Result>) {
                    return SeedTrace.VariableType._visit(this, visitor);
                }
            };
        },
        ...
        singlyLinkedListType: (): SeedTrace.VariableType.SinglyLinkedListType => {
            return {
                type: "singlyLinkedListType",
                "_visit": function <_Result>(this: SeedTrace.VariableType.SinglyLinkedListType, visitor: SeedTrace.VariableType._Visitor<_Result>) {
                    return SeedTrace.VariableType._visit(this, visitor);
                }
            };
        },
        ...
        doublyLinkedListType: (): SeedTrace.VariableType.DoublyLinkedListType => {
            return {
                type: "doublyLinkedListType",
                "_visit": function <_Result>(this: SeedTrace.VariableType.DoublyLinkedListType, visitor: SeedTrace.VariableType._Visitor<_Result>) {
                    return SeedTrace.VariableType._visit(this, visitor);
                }
            };
        },
        ...
        _unknown: (value: {
            ...
            return {
                ...(value as any),
                "_visit": function <_Result>(this: SeedTrace.VariableType._Unknown, visitor: SeedTrace.VariableType._Visitor<_Result>) {
                    return SeedTrace.VariableType._visit(this, visitor);
                }
            };
        },
