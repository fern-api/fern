...
export const Error = {
        _unknown: (fetcherError: core.Fetcher.Error): SeedTrace.playlist.getPlaylists.Error._Unknown => {
            return {
                ...
                "_visit": function <_Result>(this: SeedTrace.playlist.getPlaylists.Error._Unknown, visitor: SeedTrace.playlist.getPlaylists.Error._Visitor<_Result>) {
                    return SeedTrace.playlist.getPlaylists.Error._visit(this, visitor);
                }
            };
        },

        _visit: <_Result>(value: SeedTrace.playlist.getPlaylists.Error, visitor: SeedTrace.playlist.getPlaylists.Error._Visitor<_Result>): _Result => {
