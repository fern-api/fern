...
export class Playlist {
  ...
  > {
    ...
    if (_response.error.reason === "status-code") {
      switch (
        (_response.error.body as SeedTrace.playlist.getPlaylist.Error)
          ?.errorName
      ) {
          ...
          return {
            data: {
              ...
              error: _response.error
                .body as SeedTrace.playlist.getPlaylist.Error,
              rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
          };
  ...
  > {
    ...
    if (_response.error.reason === "status-code") {
      switch (
        (_response.error.body as SeedTrace.playlist.updatePlaylist.Error)
          ?.errorName
      ) {
        case "PlaylistIdNotFoundError":
          return {
            data: {
              ok: false,
              error: _response.error
                .body as SeedTrace.playlist.updatePlaylist.Error,
              rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
          };
