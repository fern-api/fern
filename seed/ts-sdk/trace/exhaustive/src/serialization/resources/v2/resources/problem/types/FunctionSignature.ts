...
export const FunctionSignature: core.serialization.Schema<serializers.v2.FunctionSignature.Raw, SeedTrace.v2.FunctionSignature> = core.serialization.union("type", {
        ...
        transform: value => {
            switch (value.type) {
                case "void": return SeedTrace.v2.FunctionSignature.void(value);
                case "nonVoid": return SeedTrace.v2.FunctionSignature.nonVoid(value);
                case "voidThatTakesActualResult": return SeedTrace.v2.FunctionSignature.voidThatTakesActualResult(value);
                default: return SeedTrace.v2.FunctionSignature._unknown(value);
            }
        },
