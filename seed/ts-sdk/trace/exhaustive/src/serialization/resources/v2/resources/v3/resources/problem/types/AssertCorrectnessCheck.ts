...
export const AssertCorrectnessCheck: core.serialization.Schema<serializers.v2.v3.AssertCorrectnessCheck.Raw, SeedTrace.v2.v3.AssertCorrectnessCheck> = core.serialization.union("type", {
        ...
        transform: value => {
            switch (value.type) {
                case "deepEquality": return SeedTrace.v2.v3.AssertCorrectnessCheck.deepEquality(value);
                case "custom": return SeedTrace.v2.v3.AssertCorrectnessCheck.custom(value);
                default: return SeedTrace.v2.v3.AssertCorrectnessCheck._unknown(value);
            }
        },
