...
export const AssertCorrectnessCheck: core.serialization.Schema<serializers.v2.AssertCorrectnessCheck.Raw, SeedTrace.v2.AssertCorrectnessCheck> = core.serialization.union("type", {
        ...
        transform: value => {
            switch (value.type) {
                case "deepEquality": return SeedTrace.v2.AssertCorrectnessCheck.deepEquality(value);
                case "custom": return SeedTrace.v2.AssertCorrectnessCheck.custom(value);
                default: return SeedTrace.v2.AssertCorrectnessCheck._unknown(value);
            }
        },
