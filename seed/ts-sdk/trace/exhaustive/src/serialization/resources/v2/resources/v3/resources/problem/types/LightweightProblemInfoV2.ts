...
export const LightweightProblemInfoV2: core.serialization.ObjectSchema<serializers.v2.v3.LightweightProblemInfoV2.Raw, SeedTrace.v2.v3.LightweightProblemInfoV2> = core.serialization.object({
        "problemId": ProblemId,
