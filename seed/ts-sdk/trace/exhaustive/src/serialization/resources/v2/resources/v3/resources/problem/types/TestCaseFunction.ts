...
export const TestCaseFunction: core.serialization.Schema<serializers.v2.v3.TestCaseFunction.Raw, SeedTrace.v2.v3.TestCaseFunction> = core.serialization.union("type", {
        ...
        transform: value => {
            switch (value.type) {
                case "withActualResult": return SeedTrace.v2.v3.TestCaseFunction.withActualResult(value);
                case "custom": return SeedTrace.v2.v3.TestCaseFunction.custom(value);
                default: return SeedTrace.v2.v3.TestCaseFunction._unknown(value);
            }
        },
