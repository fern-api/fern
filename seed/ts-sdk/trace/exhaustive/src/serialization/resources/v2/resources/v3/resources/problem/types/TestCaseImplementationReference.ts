...
> = core.serialization
    ...
    .transform<SeedTrace.v2.v3.TestCaseImplementationReference>({
        transform: (value) => {
            switch (value.type) {
                case "templateId":
                    return SeedTrace.v2.v3.TestCaseImplementationReference.templateId(value.value);
                case "implementation":
                    return SeedTrace.v2.v3.TestCaseImplementationReference.implementation(value);
                default:
                    return SeedTrace.v2.v3.TestCaseImplementationReference._unknown(value);
            }
        },
