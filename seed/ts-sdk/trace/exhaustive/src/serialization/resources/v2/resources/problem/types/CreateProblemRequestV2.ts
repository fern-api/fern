...
export const CreateProblemRequestV2: core.serialization.ObjectSchema<serializers.v2.CreateProblemRequestV2.Raw, SeedTrace.v2.CreateProblemRequestV2> = core.serialization.object({
