...
export const GetFunctionSignatureResponse: core.serialization.ObjectSchema<serializers.v2.v3.GetFunctionSignatureResponse.Raw, SeedTrace.v2.v3.GetFunctionSignatureResponse> = core.serialization.object({
