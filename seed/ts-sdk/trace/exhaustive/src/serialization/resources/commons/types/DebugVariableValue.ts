...
export const DebugVariableValue: core.serialization.Schema<serializers.DebugVariableValue.Raw, SeedTrace.DebugVariableValue> = core.serialization.union("type", {
        ...
        transform: value => {
            switch (value.type) {
                case "integerValue": return SeedTrace.DebugVariableValue.integerValue(value.value);
                case "booleanValue": return SeedTrace.DebugVariableValue.booleanValue(value.value);
                case "doubleValue": return SeedTrace.DebugVariableValue.doubleValue(value.value);
                case "stringValue": return SeedTrace.DebugVariableValue.stringValue(value.value);
                case "charValue": return SeedTrace.DebugVariableValue.charValue(value.value);
                case "mapValue": return SeedTrace.DebugVariableValue.mapValue(value);
                case "listValue": return SeedTrace.DebugVariableValue.listValue(value.value);
                case "binaryTreeNodeValue": return SeedTrace.DebugVariableValue.binaryTreeNodeValue(value);
                case "singlyLinkedListNodeValue": return SeedTrace.DebugVariableValue.singlyLinkedListNodeValue(value);
                case "doublyLinkedListNodeValue": return SeedTrace.DebugVariableValue.doublyLinkedListNodeValue(value);
                case "undefinedValue": return SeedTrace.DebugVariableValue.undefinedValue();
                case "nullValue": return SeedTrace.DebugVariableValue.nullValue();
                case "genericValue": return SeedTrace.DebugVariableValue.genericValue(value);
                default: return SeedTrace.DebugVariableValue._unknown(value);
            }
        },
