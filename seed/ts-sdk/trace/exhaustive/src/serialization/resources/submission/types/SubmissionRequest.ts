...
export const SubmissionRequest: core.serialization.Schema<serializers.SubmissionRequest.Raw, SeedTrace.SubmissionRequest> = core.serialization.union("type", {
        ...
        transform: value => {
            switch (value.type) {
                case "initializeProblemRequest": return SeedTrace.SubmissionRequest.initializeProblemRequest(value);
                case "initializeWorkspaceRequest": return SeedTrace.SubmissionRequest.initializeWorkspaceRequest();
                case "submitV2": return SeedTrace.SubmissionRequest.submitV2(value);
                case "workspaceSubmit": return SeedTrace.SubmissionRequest.workspaceSubmit(value);
                case "stop": return SeedTrace.SubmissionRequest.stop(value);
                default: return SeedTrace.SubmissionRequest._unknown(value);
            }
        },
