...
export const WorkspaceSubmissionStatus: core.serialization.Schema<serializers.WorkspaceSubmissionStatus.Raw, SeedTrace.WorkspaceSubmissionStatus> = core.serialization.union("type", {
        ...
        transform: value => {
            switch (value.type) {
                case "stopped": return SeedTrace.WorkspaceSubmissionStatus.stopped();
                case "errored": return SeedTrace.WorkspaceSubmissionStatus.errored(value.value);
                case "running": return SeedTrace.WorkspaceSubmissionStatus.running(value.value);
                case "ran": return SeedTrace.WorkspaceSubmissionStatus.ran(value);
                case "traced": return SeedTrace.WorkspaceSubmissionStatus.traced(value);
                default: return SeedTrace.WorkspaceSubmissionStatus._unknown(value);
            }
        },
