...
export declare namespace SeedOauthPkceClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class SeedOauthPkceClient {
    protected readonly _options: NormalizedClientOptions<SeedOauthPkceClient.Options>;
    protected _oauth: OauthClient | undefined;

    constructor(options: SeedOauthPkceClient.Options) {
