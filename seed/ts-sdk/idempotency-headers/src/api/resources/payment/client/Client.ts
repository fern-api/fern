...
export class Payment {
     ...
     *     })
     */
    public async create(request: SeedIdempotencyHeaders.CreatePaymentRequest, requestOptions?: Payment.IdempotentRequestOptions): Promise<string> {
        ...
        if (_response.ok) {
            return serializers.payment.create.Response.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, breadcrumbsPrefix: ["response"] });
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout": throw new errors.SeedIdempotencyHeadersTimeoutError;
    ...
    public async delete(paymentId: string, requestOptions?: Payment.RequestOptions): Promise<void> {
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), `/payment/${encodeURIComponent(paymentId)}`),
            method: "DELETE",
            headers: {
                "Authorization": await this._getAuthorizationHeader(),
                "X-Fern-Language": "JavaScript",
