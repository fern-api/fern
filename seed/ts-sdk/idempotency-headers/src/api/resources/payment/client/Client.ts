...
export class PaymentClient {
    ...
    private async __create(request: SeedIdempotencyHeaders.CreatePaymentRequest, requestOptions?: PaymentClient.IdempotentRequestOptions): Promise<core.WithRawResponse<string>> {
        ...
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, mergeOnlyDefinedHeaders({ "Idempotency-Key": requestOptions?.idempotencyKey, "Idempotency-Expiration": requestOptions?.idempotencyExpiration }), requestOptions?.headers);
