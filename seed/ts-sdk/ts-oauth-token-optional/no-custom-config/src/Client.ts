...
export declare namespace SeedTsOauthTokenOptionalClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class SeedTsOauthTokenOptionalClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<SeedTsOauthTokenOptionalClient.Options>;
    protected _auth: AuthClient | undefined;
    protected _simple: SimpleClient | undefined;

    constructor(options: SeedTsOauthTokenOptionalClient.Options) {
