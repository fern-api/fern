...
export class SeedPackageYmlClient {
     ...
     *     })
     */
    public echo(request: SeedPackageYml.EchoRequest, requestOptions?: SeedPackageYmlClient.RequestOptions): core.HttpResponsePromise<string> {
        return core.HttpResponsePromise.fromPromise(this.__echo(request, requestOptions));
    }

    private async __echo(request: SeedPackageYml.EchoRequest, requestOptions?: SeedPackageYmlClient.RequestOptions): Promise<core.WithRawResponse<string>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `/${core.url.encodePathParam(this._options.id)}/`),
            method: "POST",
            headers: _headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout": throw new errors.SeedPackageYmlTimeoutError("Timeout exceeded when calling POST /{id}/.");
