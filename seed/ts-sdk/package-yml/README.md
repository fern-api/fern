...
[![npm shield](https://img.shields.io/npm/v/@fern/package-yml)](https://www.npmjs.com/package/@fern/package-yml)
...
const client = new SeedPackageYmlClient({ baseUrl: "YOUR_BASE_URL" });
await client.echo({
    name: "Hello world!",
    size: 20
});
