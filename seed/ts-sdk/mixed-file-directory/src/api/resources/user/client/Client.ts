...
import type { User as User_SeedMixedFileDirectory } from "../types/User.js";
...
export class User {
    ...
    ): core.HttpResponsePromise<User_SeedMixedFileDirectory[]> {
    ...
    private async __list(
        request: ListUsersRequest = {},
        requestOptions?: User.RequestOptions,
    ): Promise<core.WithRawResponse<User_SeedMixedFileDirectory[]>> {
        const { limit } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as User_SeedMixedFileDirectory[], rawResponse: _response.rawResponse };
        }
