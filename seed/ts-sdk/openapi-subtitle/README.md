...
[![npm shield](https://img.shields.io/npm/v/@fern/openapi-subtitle)](https://www.npmjs.com/package/@fern/openapi-subtitle)
...
```typescript
import { SeedApiClient } from "@fern/openapi-subtitle";
...
```typescript
import { SeedApi } from "@fern/openapi-subtitle";

const request: SeedApi.GetPlantRequest = {
    ...
};
```
...
```typescript
import { SeedApiError } from "@fern/openapi-subtitle";
...
```typescript
const { data, rawResponse } = await client.listPlants(...).withRawResponse();
...
```typescript
import { SeedApiClient, logging } from "@fern/openapi-subtitle";
