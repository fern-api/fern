...
[![npm shield](https://img.shields.io/npm/v/@fern/cli-oauth)](https://www.npmjs.com/package/@fern/cli-oauth)
...
```typescript
import { SeedApiClient } from "@fern/cli-oauth";

const client = new SeedApiClient({ clientId: "YOUR_CLIENT_ID", clientSecret: "YOUR_CLIENT_SECRET" });
...
```typescript
import { SeedApiClient, SeedApiEnvironment } from "@fern/cli-oauth";
...
```typescript
import { SeedApi } from "@fern/cli-oauth";

const request: SeedApi.GetTokenAuthRequest = {
    ...
};
```
...
```typescript
import { SeedApiError } from "@fern/cli-oauth";
...
```typescript
import { AuthClient } from '@fern/cli-oauth/auth';
...
```typescript
import { SeedApiClient, logging } from "@fern/cli-oauth";
