...
import * as SeedWebsocketAuth from "../../../index.js";
...
export declare namespace RealtimeSocket {
    ...
    export type Response = SeedWebsocketAuth.ReceiveEvent | SeedWebsocketAuth.ReceiveSnakeCase | SeedWebsocketAuth.ReceiveEvent2 | SeedWebsocketAuth.ReceiveEvent3;
    type EventHandlers = {
            open?: () => void;
...
export class RealtimeSocket {
    ...
    protected sendJson(payload: SeedWebsocketAuth.SendEvent | SeedWebsocketAuth.SendSnakeCase | SeedWebsocketAuth.SendEvent2): void {
