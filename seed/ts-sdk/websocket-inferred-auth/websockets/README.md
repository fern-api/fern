...
[![npm shield](https://img.shields.io/npm/v/@fern/websocket-inferred-auth)](https://www.npmjs.com/package/@fern/websocket-inferred-auth)
...
```sh
npm i -s @fern/websocket-inferred-auth
```
...
```typescript
import { AuthClient } from '@fern/websocket-inferred-auth/auth';
