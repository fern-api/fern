...
import { SeedUndiscriminatedUnionWithResponsePropertyClient as SeedUndiscriminatedUnionWithResponsePropertyClientType } from "../../src/Client";
import { mockServerPool } from "../mock-server/MockServerPool";

describe("SeedUndiscriminatedUnionWithResponsePropertyClient", () => {
    test("getUnion", async () => {
        const server = mockServerPool.createServer();
        const client = new SeedUndiscriminatedUnionWithResponsePropertyClientType({ environment: server.baseUrl });
