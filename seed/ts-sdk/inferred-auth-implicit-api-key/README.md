...
[![npm shield](https://img.shields.io/npm/v/@fern/inferred-auth-implicit-api-key)](https://www.npmjs.com/package/@fern/inferred-auth-implicit-api-key)
...
```sh
npm i -s @fern/inferred-auth-implicit-api-key
```
...
```typescript
import { AuthClient } from '@fern/inferred-auth-implicit-api-key/auth';
