...
const client = new SeedOauthClientCredentialsDefaultClient({ baseUrl: "YOUR_BASE_URL", clientId: "YOUR_CLIENT_ID", clientSecret: "YOUR_CLIENT_SECRET" });
...
```typescript
import { AuthClient } from '@fern/oauth-client-credentials-default/auth';
