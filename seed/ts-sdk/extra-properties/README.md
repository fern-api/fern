...
```typescript
import { SeedApiClient } from "@fern/extra-properties";
...
```typescript
import { SeedApi } from "@fern/extra-properties";

const request: SeedApi.UserCreateUserRequest = {
    ...
};
```
...
```typescript
import { SeedApiError } from "@fern/extra-properties";
...
```typescript
import { UserClient } from '@fern/extra-properties/user';
...
```typescript
import { SeedApiClient, logging } from "@fern/extra-properties";
