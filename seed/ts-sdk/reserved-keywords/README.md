...
[![npm shield](https://img.shields.io/npm/v/@fern/reserved-keywords)](https://www.npmjs.com/package/@fern/reserved-keywords)
...
```sh
npm i -s @fern/reserved-keywords
```
...
```typescript
import { PackageClient } from '@fern/reserved-keywords/package_';
...
```typescript
const { data, rawResponse } = await client.package.test(...).withRawResponse();
