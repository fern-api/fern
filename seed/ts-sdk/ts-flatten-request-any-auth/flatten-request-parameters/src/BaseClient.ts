...
export type AuthOption =
    ...
    | core.AuthProvider
    | AnyAuthProvider.AuthOptions<[BearerAuthProvider.AuthOptions, HeaderAuthProvider.AuthOptions]>;
    ...
    const headers = mergeHeaders(
        {
            ...
            "X-Fern-SDK-Name": "@fern/ts-flatten-request-any-auth",
            "X-Fern-SDK-Version": "0.0.1",
            "User-Agent": "@fern/ts-flatten-request-any-auth/0.0.1",
