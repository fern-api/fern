...
export declare namespace SeedTsFlattenRequestAnyAuthClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class SeedTsFlattenRequestAnyAuthClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<SeedTsFlattenRequestAnyAuthClient.Options>;
    protected _users: UsersClient | undefined;

    constructor(options: SeedTsFlattenRequestAnyAuthClient.Options) {
