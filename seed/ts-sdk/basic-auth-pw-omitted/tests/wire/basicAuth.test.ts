...
import * as SeedBasicAuthPwOmitted from "../../src/api/index";
import { SeedBasicAuthPwOmittedClient } from "../../src/Client";
...
describe("BasicAuthClient", () => {
    ...
    test("getWithBasicAuth (1)", async () => {
        ...
        const client = new SeedBasicAuthPwOmittedClient({ "maxRetries" : 0 , "username" : "test" , "environment" : server.baseUrl });
    ...
    test("getWithBasicAuth (2)", async () => {
        ...
        server
            ...
            }).rejects.toThrow(SeedBasicAuthPwOmitted.UnauthorizedRequest);
    });
    ...
    "key": "value"
            ...
            }).rejects.toThrow(SeedBasicAuthPwOmitted.BadRequest);
    });
