...
```typescript
import { SeedApiClient } from "@fern/basic-auth-pw-omitted";
...
```typescript
import { SeedApiError } from "@fern/basic-auth-pw-omitted";
...
```typescript
import { SeedApiClient, logging } from "@fern/basic-auth-pw-omitted";
