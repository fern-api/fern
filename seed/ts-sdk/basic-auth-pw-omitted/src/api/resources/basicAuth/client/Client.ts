...
export class BasicAuthClient {
    ...
    private async __getWithBasicAuth(requestOptions?: BasicAuthClient.RequestOptions): Promise<core.WithRawResponse<boolean>> {
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 401: throw new SeedBasicAuthPwOmitted.UnauthorizedRequest(_response.error.body as SeedBasicAuthPwOmitted.UnauthorizedRequestErrorBody, _response.rawResponse);
    ...
    private async __postWithBasicAuth(request?: unknown, requestOptions?: BasicAuthClient.RequestOptions): Promise<core.WithRawResponse<boolean>> {
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 401: throw new SeedBasicAuthPwOmitted.UnauthorizedRequest(_response.error.body as SeedBasicAuthPwOmitted.UnauthorizedRequestErrorBody, _response.rawResponse);
                case 400: throw new SeedBasicAuthPwOmitted.BadRequest(_response.rawResponse);
                default: throw new errors.SeedBasicAuthPwOmittedError({
                    statusCode: _response.error.statusCode,
                    body: _response.error.body,
                    rawResponse: _response.rawResponse
