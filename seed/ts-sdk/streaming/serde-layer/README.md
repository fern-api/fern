...
```typescript
import { SeedApiClient } from "@fern/streaming";
...
```typescript
import { SeedApi } from "@fern/streaming";

const request: SeedApi.DummyGenerateStreamRequest = {
    ...
};
```
...
```typescript
import { SeedApiError } from "@fern/streaming";
...
```typescript
import { DummyClient } from '@fern/streaming/dummy';
...
```typescript
import { SeedApiClient, logging } from "@fern/streaming";
