...
[![npm shield](https://img.shields.io/npm/v/@fern/inline-types)](https://www.npmjs.com/package/@fern/inline-types)
...
```typescript
import { SeedObject } from "@fern/inline-types";
...
```typescript
import { SeedObjectError } from "@fern/inline-types";
...
```typescript
const response = await client.getRoot(...).asRaw();
