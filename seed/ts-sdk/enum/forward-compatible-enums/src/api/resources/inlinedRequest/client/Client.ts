...
export class InlinedRequestClient {
     ...
     *     })
     */
    public send(request: SeedEnum.SendEnumInlinedRequest, requestOptions?: InlinedRequestClient.RequestOptions): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(this.__send(request, requestOptions));
    }

    private async __send(request: SeedEnum.SendEnumInlinedRequest, requestOptions?: InlinedRequestClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "inlined"),
            method: "POST",
            headers: _headers,
