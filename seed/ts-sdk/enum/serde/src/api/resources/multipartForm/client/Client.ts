...
export declare namespace MultipartForm {
...
export class MultipartForm {
    protected readonly _options: MultipartForm.Options;

    constructor(_options: MultipartForm.Options) {
        this._options = _options;
    }

    /**
     * @param {SeedEnum.MultipartFormRequest} request
     * @param {MultipartForm.RequestOptions} requestOptions - Request-specific configuration.
     */
    public multipartForm(
        request: SeedEnum.MultipartFormRequest,
        requestOptions?: MultipartForm.RequestOptions,
