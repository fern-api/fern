...
export class QueryParamClient {
    ...
    private async __send(request: SeedEnum.SendEnumAsQueryParamRequest, requestOptions?: QueryParamClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        const _queryParams: Record<string, unknown> = {
            ...
            maybeOperand: maybeOperand != null ? serializers.Operand.jsonOrThrow(maybeOperand, { unrecognizedObjectKeys: "strip", omitUndefined: true }) : undefined,
            operandOrColor: (() => {
                const mapped = serializers.ColorOrOperand.jsonOrThrow(operandOrColor, { unrecognizedObjectKeys: "strip", omitUndefined: true });
                return typeof mapped === "string" ? mapped : toJson(mapped);
            })(),
            maybeOperandOrColor: maybeOperandOrColor != null ? (() => {
                const mapped = serializers.ColorOrOperand.jsonOrThrow(maybeOperandOrColor, { unrecognizedObjectKeys: "strip", omitUndefined: true });
                return typeof mapped === "string" ? mapped : toJson(mapped);
            })() : undefined
        };
    ...
    private async __sendList(request: SeedEnum.SendEnumListAsQueryParamRequest, requestOptions?: QueryParamClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        const { operand, maybeOperand, operandOrColor, maybeOperandOrColor } = request;
        const _queryParams: Record<string, unknown> = {
            operand: Array.isArray(operand) ? operand.map(item => serializers.Operand.jsonOrThrow(item, { unrecognizedObjectKeys: "strip", omitUndefined: true })) : serializers.Operand.jsonOrThrow(operand, { unrecognizedObjectKeys: "strip", omitUndefined: true }),
            maybeOperand: Array.isArray(maybeOperand) ? maybeOperand.map(item => serializers.Operand.jsonOrThrow(item, { unrecognizedObjectKeys: "strip", omitUndefined: true })) : maybeOperand != null ? serializers.Operand.jsonOrThrow(maybeOperand, { unrecognizedObjectKeys: "strip", omitUndefined: true }) : undefined,
            operandOrColor: Array.isArray(operandOrColor) ? operandOrColor.map(item => (() => {
                const mapped = serializers.ColorOrOperand.jsonOrThrow(item, { unrecognizedObjectKeys: "strip", omitUndefined: true });
                return typeof mapped === "string" ? mapped : toJson(mapped);
            })()) : (() => {
                const mapped = serializers.ColorOrOperand.jsonOrThrow(operandOrColor, { unrecognizedObjectKeys: "strip", omitUndefined: true });
                return typeof mapped === "string" ? mapped : toJson(mapped);
            })(),
            maybeOperandOrColor: Array.isArray(maybeOperandOrColor) ? maybeOperandOrColor.map(item => (() => {
                const mapped = serializers.ColorOrOperand.jsonOrThrow(item, { unrecognizedObjectKeys: "strip", omitUndefined: true });
                return typeof mapped === "string" ? mapped : toJson(mapped);
