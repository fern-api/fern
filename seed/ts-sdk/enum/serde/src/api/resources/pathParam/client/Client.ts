    ...
    private async __send(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `path/${encodeURIComponent(serializers.Operand.jsonOrThrow(operand, { omitUndefined: true }))}/${encodeURIComponent(serializers.ColorOrOperand.jsonOrThrow(operandOrColor, { omitUndefined: true }))}`,
            ),
            method: "POST",
