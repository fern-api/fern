...
[![npm shield](https://img.shields.io/npm/v/@fern/unknown)](https://www.npmjs.com/package/@fern/unknown)
...
```typescript
import { UnknownClient } from '@fern/unknown/unknown';
...
```typescript
const { data, rawResponse } = await client.unknown.post(...).withRawResponse();
