...
export class UnknownClient {
     ...
     *     })
     */
    public postObject(request: SeedUnknownAsAny.MyObject, requestOptions?: UnknownClient.RequestOptions): core.HttpResponsePromise<unknown[]> {
        return core.HttpResponsePromise.fromPromise(this.__postObject(request, requestOptions));
    }

    private async __postObject(request: SeedUnknownAsAny.MyObject, requestOptions?: UnknownClient.RequestOptions): Promise<core.WithRawResponse<unknown[]>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
