...
export declare namespace SeedServerSentEventsResumableClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class SeedServerSentEventsResumableClient {
    protected readonly _options: NormalizedClientOptions<SeedServerSentEventsResumableClient.Options>;
    protected _completions: CompletionsClient | undefined;

    constructor(options: SeedServerSentEventsResumableClient.Options) {
