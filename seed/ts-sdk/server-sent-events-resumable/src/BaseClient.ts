    ...
    const headers = mergeHeaders(
        {
            ...
            "X-Fern-SDK-Name": "@fern/server-sent-events-resumable",
            "X-Fern-SDK-Version": "0.0.1",
            "User-Agent": "@fern/server-sent-events-resumable/0.0.1",
