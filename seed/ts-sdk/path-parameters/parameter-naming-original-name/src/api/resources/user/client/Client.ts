...
export class UserClient {
    ...
    private async __getUser(request: SeedPathParameters.GetUsersRequest, requestOptions?: UserClient.RequestOptions): Promise<core.WithRawResponse<SeedPathParameters.User>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `/${core.url.encodePathParam(this._options.tenant_id)}/user/${core.url.encodePathParam(userId)}`),
            method: "GET",
            headers: _headers,
    ...
    private async __searchUsers(request: SeedPathParameters.SearchUsersRequest, requestOptions?: UserClient.RequestOptions): Promise<core.WithRawResponse<SeedPathParameters.User[]>> {
        ...
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `/${core.url.encodePathParam(this._options.tenant_id)}/user/${core.url.encodePathParam(userId)}/search`),
            method: "GET",
            headers: _headers,
    ...
    private async __getUserMetadata(request: SeedPathParameters.GetUserMetadataRequest, requestOptions?: UserClient.RequestOptions): Promise<core.WithRawResponse<SeedPathParameters.User>> {
        ...
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `/${core.url.encodePathParam(this._options.tenant_id)}/user/${core.url.encodePathParam(userId)}/metadata/v${core.url.encodePathParam(version)}`),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
    ...
    private async __getUserSpecifics(request: SeedPathParameters.GetUserSpecificsRequest, requestOptions?: UserClient.RequestOptions): Promise<core.WithRawResponse<SeedPathParameters.User>> {
        ...
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `/${core.url.encodePathParam(this._options.tenant_id)}/user/${core.url.encodePathParam(userId)}/specifics/${core.url.encodePathParam(version)}/${core.url.encodePathParam(thought)}`),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
