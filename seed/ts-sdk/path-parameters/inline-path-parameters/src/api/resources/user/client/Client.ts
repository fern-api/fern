...
export class User {
    ...
    public async getUser(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                await core.Supplier.get(this._options.environment),
                `/user/users/${encodeURIComponent(request.userId)}`
            ),
            method: "GET",
            headers: {
                "X-Fern-Language": "JavaScript",
    ...
    public async getOrganizationUser(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                await core.Supplier.get(this._options.environment),
                `/user/organizations/${encodeURIComponent(request.organizationId)}/users/${encodeURIComponent(
                    request.userId
                )}`
            ),
            method: "GET",
    ...
    public async searchUsers(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                await core.Supplier.get(this._options.environment),
                `/user/users/${encodeURIComponent(request.userId)}/search`
            ),
            method: "GET",
            headers: {
                "X-Fern-Language": "JavaScript",
