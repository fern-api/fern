...
export class Organizations {
    ...
    public async getOrganization(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `/${encodeURIComponent(this._options.tenantId)}/user/organizations/${encodeURIComponent(
                    organizationId
                )}`
            ),
            method: "GET",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedPathParametersTimeoutError(
                    "Timeout exceeded when calling GET /{tenantId}/user/organizations/{organizationId}."
                );
            case "unknown":
                throw new errors.SeedPathParametersError({
    ...
    public async getOrganizationUser(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedPathParametersTimeoutError(
                    "Timeout exceeded when calling GET /{tenantId}/user/organizations/{organizationId}/users/{userId}."
                );
            case "unknown":
                throw new errors.SeedPathParametersError({
                    message: _response.error.errorMessage,
    ...
    public async searchOrganizations(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedPathParametersTimeoutError(
                    "Timeout exceeded when calling GET /{tenantId}/user/organizations/{organizationId}/search."
                );
            case "unknown":
                throw new errors.SeedPathParametersError({
                    message: _response.error.errorMessage,
