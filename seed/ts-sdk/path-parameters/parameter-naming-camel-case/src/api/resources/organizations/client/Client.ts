...
export class OrganizationsClient {
     ...
     */
    public getOrganization(organizationId: string, requestOptions?: OrganizationsClient.RequestOptions): core.HttpResponsePromise<SeedPathParameters.Organization> {
        return core.HttpResponsePromise.fromPromise(this.__getOrganization(organizationId, requestOptions));
    }

    private async __getOrganization(organizationId: string, requestOptions?: OrganizationsClient.RequestOptions): Promise<core.WithRawResponse<SeedPathParameters.Organization>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `/${core.url.encodePathParam(this._options.tenantId)}/organizations/${core.url.encodePathParam(organizationId)}/`),
            method: "GET",
            headers: _headers,
    ...
    private async __getOrganizationUser(request: SeedPathParameters.GetOrganizationUserRequest, requestOptions?: OrganizationsClient.RequestOptions): Promise<core.WithRawResponse<SeedPathParameters.User>> {
        ...
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `/${core.url.encodePathParam(this._options.tenantId)}/organizations/${core.url.encodePathParam(organizationId)}/users/${core.url.encodePathParam(userId)}`),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
     ...
     *     })
     */
    public searchOrganizations(organizationId: string, request: SeedPathParameters.SearchOrganizationsRequest = {}, requestOptions?: OrganizationsClient.RequestOptions): core.HttpResponsePromise<SeedPathParameters.Organization[]> {
        return core.HttpResponsePromise.fromPromise(this.__searchOrganizations(organizationId, request, requestOptions));
    }

    private async __searchOrganizations(organizationId: string, request: SeedPathParameters.SearchOrganizationsRequest = {}, requestOptions?: OrganizationsClient.RequestOptions): Promise<core.WithRawResponse<SeedPathParameters.Organization[]>> {
        const { limit } = request;
        ...
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `/${core.url.encodePathParam(this._options.tenantId)}/organizations/${core.url.encodePathParam(organizationId)}/search`),
            method: "GET",
            headers: _headers,
