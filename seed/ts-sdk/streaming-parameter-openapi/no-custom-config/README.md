...
[![npm shield](https://img.shields.io/npm/v/@fern/streaming-parameter-openapi)](https://www.npmjs.com/package/@fern/streaming-parameter-openapi)
...
```sh
npm i -s @fern/streaming-parameter-openapi
```
...
```typescript
import { SeedApiClient } from "@fern/streaming-parameter-openapi";
...
```typescript
import { SeedApi } from "@fern/streaming-parameter-openapi";

const request: SeedApi.ChatRequestStreaming = {
    ...
};
```
...
```typescript
import { SeedApiError } from "@fern/streaming-parameter-openapi";
...
```typescript
const { data, rawResponse } = await client.chatStream(...).withRawResponse();
...
```typescript
import { SeedApiClient, logging } from "@fern/streaming-parameter-openapi";
