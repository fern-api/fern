...
[![npm shield](https://img.shields.io/npm/v/@fern-api/dummy)](https://www.npmjs.com/package/@fern-api/dummy)
...
```typescript
import { SeedApiClient } from "@fern-api/dummy";
...
```typescript
import { SeedApiClient, SeedApiEnvironment } from "@fern-api/dummy";
...
```typescript
import { SeedApi } from "@fern-api/dummy";
...
```typescript
import { SeedApiError } from "@fern-api/dummy";
...
```typescript
import { UserClient } from '@fern-api/dummy/user';
...
```typescript
const { data, rawResponse } = await client.user.get(...).withRawResponse();
...
```typescript
import { SeedApiClient, logging } from "@fern-api/dummy";
