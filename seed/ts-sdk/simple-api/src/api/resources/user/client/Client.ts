...
export class User {
    ...
    ): core.HttpResponsePromise<SeedSimpleApi.User> {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedSimpleApi.User,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedSimpleApiTimeoutError(
                    "Timeout exceeded when calling GET /users/{id}.",
                );
            case "unknown":
                throw new errors.SeedSimpleApiError({
