...
[![npm shield](https://img.shields.io/npm/v/@fern/version)](https://www.npmjs.com/package/@fern/version)
...
const client = new SeedVersionClient({ baseUrl: "YOUR_BASE_URL" });
...
```typescript
import { UserClient } from '@fern/version/user';
