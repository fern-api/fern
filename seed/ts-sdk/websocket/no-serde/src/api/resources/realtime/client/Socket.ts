...
export declare namespace RealtimeSocket {
    ...
    export type Response = SeedWebsocket.ReceiveEvent | SeedWebsocket.ReceiveSnakeCase | SeedWebsocket.ReceiveEvent2 | SeedWebsocket.ReceiveEvent3 | SeedWebsocket.TranscriptEvent | SeedWebsocket.FlushedEvent | SeedWebsocket.ErrorEvent;
    type EventHandlers = {
            open?: () => void;
...
export class RealtimeSocket {
    ...
    protected sendJson(payload: SeedWebsocket.SendEvent | SeedWebsocket.SendSnakeCase | SeedWebsocket.SendEvent2): void {
