...
export class ImdbClient {
     ...
     */
    public getMovie(movieId: SeedApi.MovieId, requestOptions?: ImdbClient.RequestOptions): core.HttpResponsePromise<SeedApi.Movie> {
        return core.HttpResponsePromise.fromPromise(this.__getMovie(movieId, requestOptions));
    }

    private async __getMovie(movieId: SeedApi.MovieId, requestOptions?: ImdbClient.RequestOptions): Promise<core.WithRawResponse<SeedApi.Movie>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
