...
export class ImdbClient {
     ...
     *     })
     */
    public getMovie(request: SeedApi.GetMovieImdbRequest, requestOptions?: ImdbClient.RequestOptions): core.HttpResponsePromise<SeedApi.Movie> {
        return core.HttpResponsePromise.fromPromise(this.__getMovie(request, requestOptions));
    }

    private async __getMovie(request: SeedApi.GetMovieImdbRequest, requestOptions?: ImdbClient.RequestOptions): Promise<core.WithRawResponse<SeedApi.Movie>> {
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 404: throw new SeedApi.NotFoundError(_response.error.body as SeedApi.MovieId, _response.rawResponse);
