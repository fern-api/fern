...
export class SeedApiClient {
     ...
     *     })
     */
    public updateProfileIdentifier(
        request: SeedApi.IdentifierUpdate,
        requestOptions?: SeedApiClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.UpdateProfileIdentifierResponse> {
        return core.HttpResponsePromise.fromPromise(this.__updateProfileIdentifier(request, requestOptions));
    }

    private async __updateProfileIdentifier(
        request: SeedApi.IdentifierUpdate,
        requestOptions?: SeedApiClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.UpdateProfileIdentifierResponse>> {
        const { profileId, idTypePathParam, ..._body } = request;
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `Profiles/${core.url.encodePathParam(profileId)}/Identifiers/${core.url.encodePathParam(idTypePathParam)}`,
            ),
            method: "PATCH",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedApi.UpdateProfileIdentifierResponse,
        ...
        return handleNonStatusCodeError(
            ...
            "PATCH",
            "/Profiles/{profileId}/Identifiers/{idTypePathParam}",
        );
    }
