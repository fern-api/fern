...
export class InlinedClient {
     ...
     *     })
     */
    public send(request: SeedLiteral.SendLiteralsInlinedRequest, requestOptions?: InlinedClient.RequestOptions): core.HttpResponsePromise<SeedLiteral.SendResponse> {
        return core.HttpResponsePromise.fromPromise(this.__send(request, requestOptions));
    }

    private async __send(request: SeedLiteral.SendLiteralsInlinedRequest, requestOptions?: InlinedClient.RequestOptions): Promise<core.WithRawResponse<SeedLiteral.SendResponse>> {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: { ...(request), prompt: "You are a helpful assistant", stream: false, aliasedContext: "You're super wise" },
        ...
        switch (_response.error.reason) {
            ...
            case "timeout": throw new errors.SeedLiteralTimeoutError("Timeout exceeded when calling POST /inlined.");
