...
export class Path {
    ...
    private async __send(
        ...
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            ...
            mergeOnlyDefinedHeaders({
                ...
                "X-API-Enable-Audit-Logging": (
                    requestOptions?.auditLogging ?? true
                ).toString(),
            }),
        ...
        if (_response.ok) {
            return {
                data: _response.body as SeedLiteral.SendResponse,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedLiteralTimeoutError(
                    "Timeout exceeded when calling POST /path/{id}.",
                );
            case "unknown":
                throw new errors.SeedLiteralError({
