...
export class Union {
     ...
     */
    public get(id: string, requestOptions?: Union.RequestOptions): core.APIPromise<SeedUnions.Shape> {
        return core.APIPromise.from(
            (async () => {
                ...
                if (_response.ok) {
                    return {
                        ok: _response.ok,
                        body: serializers.Shape.parseOrThrow(_response.body, {
     ...
     *     })
     */
    public update(request: SeedUnions.Shape, requestOptions?: Union.RequestOptions): core.APIPromise<boolean> {
        return core.APIPromise.from(
            (async () => {
                const _response = await core.fetcher({
                ...
                if (_response.ok) {
                    return {
                        ok: _response.ok,
                        body: serializers.union.update.Response.parseOrThrow(_response.body, {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
                            allowUnrecognizedEnumValues: true,
                            breadcrumbsPrefix: ["response"],
