...
export const UnionWithDuplicatePrimitive: core.serialization.Schema<serializers.UnionWithDuplicatePrimitive.Raw, SeedUnions.UnionWithDuplicatePrimitive> = core.serialization.union("type", {
...
export declare namespace UnionWithDuplicatePrimitive {
    export type Raw = UnionWithDuplicatePrimitive.Integer1 | UnionWithDuplicatePrimitive.Integer2 | UnionWithDuplicatePrimitive.String1 | UnionWithDuplicatePrimitive.String2;
