...
export const UnionWithSameNumberTypes: core.serialization.Schema<serializers.UnionWithSameNumberTypes.Raw, SeedUnions.UnionWithSameNumberTypes> = core.serialization.union("type", {
...
export declare namespace UnionWithSameNumberTypes {
    export type Raw = UnionWithSameNumberTypes.PositiveInt | UnionWithSameNumberTypes.NegativeInt | UnionWithSameNumberTypes.AnyNumber;
