...
export const UnionWithNoProperties: core.serialization.Schema<serializers.UnionWithNoProperties.Raw, SeedUnions.UnionWithNoProperties> = core.serialization.union("type", {
        "foo": Foo,
