...
export const UnionWithSameStringTypes: core.serialization.Schema<serializers.UnionWithSameStringTypes.Raw, SeedUnions.UnionWithSameStringTypes> = core.serialization.union("type", {
...
export declare namespace UnionWithSameStringTypes {
    export type Raw = UnionWithSameStringTypes.CustomFormat | UnionWithSameStringTypes.RegularString | UnionWithSameStringTypes.PatternString;
