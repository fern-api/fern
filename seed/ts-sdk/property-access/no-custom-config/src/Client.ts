...
export class SeedPropertyAccessClient {
     ...
     *     })
     */
    public createUser(request: SeedPropertyAccess.User, requestOptions?: SeedPropertyAccessClient.RequestOptions): core.HttpResponsePromise<SeedPropertyAccess.User> {
        return core.HttpResponsePromise.fromPromise(this.__createUser(request, requestOptions));
    }

    private async __createUser(request: SeedPropertyAccess.User, requestOptions?: SeedPropertyAccessClient.RequestOptions): Promise<core.WithRawResponse<SeedPropertyAccess.User>> {
