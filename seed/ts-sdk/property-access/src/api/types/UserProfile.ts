...
import * as SeedCsharpAccess from "../index.js";
...
export interface UserProfile {
    ...
    verification: SeedCsharpAccess.UserProfileVerification;
...
export namespace UserProfile {
    export type Request = Omit<UserProfile, "verification"> & {
        verification: SeedCsharpAccess.UserProfileVerification.Request;
    };
