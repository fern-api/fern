...
import type { GetDiscriminatedUnionRequest } from "./api/client/requests/GetDiscriminatedUnionRequest.js";
import type { GetUndiscriminatedUnionRequest } from "./api/client/requests/GetUndiscriminatedUnionRequest.js";
import type { PostRootRequest } from "./api/client/requests/PostRootRequest.js";
import type { RootType1 } from "./api/types/RootType1.js";
...
export class SeedObjectClient {
    ...
    ): core.HttpResponsePromise<RootType1> {
    ...
    private async __getRoot(
        request: PostRootRequest,
        requestOptions?: SeedObjectClient.RequestOptions,
    ): Promise<core.WithRawResponse<RootType1>> {
        ...
        if (_response.ok) {
            return { data: _response.body as RootType1, rawResponse: _response.rawResponse };
        }
