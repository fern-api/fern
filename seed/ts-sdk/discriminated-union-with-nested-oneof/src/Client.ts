...
export class SeedApiClient {
     ...
     */
    public createAst(
        request: SeedApi.AstNode,
        requestOptions?: SeedApiClient.RequestOptions,
    ): core.HttpResponsePromise<SeedApi.AstNode> {
        return core.HttpResponsePromise.fromPromise(this.__createAst(request, requestOptions));
    }

    private async __createAst(
        request: SeedApi.AstNode,
        requestOptions?: SeedApiClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.AstNode>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.AstNode, rawResponse: _response.rawResponse };
        }
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/ast");
    }
