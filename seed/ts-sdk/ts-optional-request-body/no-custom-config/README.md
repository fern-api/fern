...
[![npm shield](https://img.shields.io/npm/v/@fern/ts-optional-request-body)](https://www.npmjs.com/package/@fern/ts-optional-request-body)
...
```sh
npm i -s @fern/ts-optional-request-body
```
...
```typescript
import { SeedTsOptionalRequestBody } from "@fern/ts-optional-request-body";

const request: SeedTsOptionalRequestBody.RefundWithHeaderRequest = {
    ...
};
```
...
```typescript
import { SeedTsOptionalRequestBodyError } from "@fern/ts-optional-request-body";

try {
    await client.refund(...);
} catch (err) {
    if (err instanceof SeedTsOptionalRequestBodyError) {
...
const client = new SeedTsOptionalRequestBodyClient({
    ...
    headers: {
...
```typescript
import { SeedTsOptionalRequestBodyClient, logging } from "@fern/ts-optional-request-body";
