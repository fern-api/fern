...
[![npm shield](https://img.shields.io/npm/v/@fern/api-wide-base-path)](https://www.npmjs.com/package/@fern/api-wide-base-path)
...
```sh
npm i -s @fern/api-wide-base-path
```
...
```typescript
import { ServiceClient } from '@fern/api-wide-base-path/service';
