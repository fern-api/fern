...
export class AuthClient {
    ...
    ): core.HttpResponsePromise<SeedApi.auth.GetTokenResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getToken(requestOptions));
    }

    private async __getToken(
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<SeedApi.auth.GetTokenResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.auth.GetTokenResponse, rawResponse: _response.rawResponse };
        }
