...
import { CoreClient } from "./api/resources/core/client/Client.js";
...
export class SeedApiClient {
    ...
    protected _core: CoreClient | undefined;
    ...
    public get core(): CoreClient {
        return (this._core ??= new CoreClient(this._options));
    }
                ...
                baseUrl:
                    ...
                    (async () => {
                        ...
                        return typeof env === "string"
                            ? env
                            : ((env as Record<string, string>)?.oauth ??
                                  environments.SeedApiEnvironment.Production.oauth);
                    }),
