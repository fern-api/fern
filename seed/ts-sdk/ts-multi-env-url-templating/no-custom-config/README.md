...
[![npm shield](https://img.shields.io/npm/v/@fern/ts-multi-env-url-templating)](https://www.npmjs.com/package/@fern/ts-multi-env-url-templating)
...
```sh
npm i -s @fern/ts-multi-env-url-templating
```
...
```typescript
import { SeedApiClient } from "@fern/ts-multi-env-url-templating";
...
```typescript
import { SeedApiClient, SeedApiEnvironment } from "@fern/ts-multi-env-url-templating";
...
```typescript
import { SeedApiError } from "@fern/ts-multi-env-url-templating";
...
```typescript
import { AuthClient } from '@fern/ts-multi-env-url-templating/auth';
...
```typescript
import { SeedApiClient, logging } from "@fern/ts-multi-env-url-templating";
