...
export class V2Client {
     ...
     */
    public listUsers(request: SeedApi.v2.ListUsersRequest = {}, requestOptions?: V2Client.RequestOptions): core.HttpResponsePromise<SeedApi.v2.UserV2[]> {
        return core.HttpResponsePromise.fromPromise(this.__listUsers(request, requestOptions));
    }

    private async __listUsers(request: SeedApi.v2.ListUsersRequest = {}, requestOptions?: V2Client.RequestOptions): Promise<core.WithRawResponse<SeedApi.v2.UserV2[]>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedApi.v2.UserV2[], rawResponse: _response.rawResponse };
        }
