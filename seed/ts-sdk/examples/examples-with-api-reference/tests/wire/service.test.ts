...
describe("ServiceClient", () => {
    ...
    test("getMovie", async () => {
        ...
        const rawResponseBody = { "id" : "movie-c06a4ad7" , "prequel" : "movie-cv9b914f" , "title" : "The Boy and the Heron" , "from" : "Hayao Miyazaki" , "rating" : 8 , "type" : "movie" , "tag" : "tag-wf9as23d" , "metadata" : { "actors" : [ "Christian Bale" , "Florence Pugh" , "Willem Dafoe" ] , "releaseDate" : "2023-12-08" , "ratings" : { "rottenTomatoes" : 97 , "imdb" : 7.6 } } , "revenue" : 1000000 };
        server
            .mockEndpoint()
            .get("/movie/movie-c06a4ad7").respondWith()
    ...
    test("getMetadata", async () => {
        ...
        server
            .mockEndpoint()
            .get("/metadata").header("X-API-Version", "0.0.1")
                    .respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("refreshToken (1)", async () => {
        ...
        server
            .mockEndpoint()
            .post("/refresh-token").respondWith()
