...
export class Service {
     ...
     *     })
     */
    public async getFile(filename: string, request: SeedExamples.file.GetFileRequest, requestOptions?: Service.RequestOptions): Promise<SeedExamples.File_> {
        ...
        if (_response.ok) {
            return serializers.File_.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, breadcrumbsPrefix: ["response"] });
        }

        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 404: throw new SeedExamples.NotFoundError(serializers.NotFoundError.parseOrThrow(_response.error.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, breadcrumbsPrefix: ["response"] }));
