...
export class Service {
  ...
  public getMovie(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__getMovie(movieId, requestOptions),
    );
  }
  ...
  private async __getMovie(
    ...
    if (_response.ok) {
      return {
        data: _response.body as SeedExamples.Movie,
  ...
  public createMovie(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__createMovie(request, requestOptions),
    );
  }
  ...
  private async __createMovie(
    ...
    if (_response.ok) {
      return {
        data: _response.body as SeedExamples.MovieId,
        rawResponse: _response.rawResponse,
      };
    }
  ...
  private async __getMetadata(
    ...
    if (_response.ok) {
      return {
        data: _response.body as SeedExamples.Metadata,
        rawResponse: _response.rawResponse,
      };
    }
  ...
  public createBigEntity(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__createBigEntity(request, requestOptions),
    );
  }
  ...
  private async __createBigEntity(
    ...
    if (_response.ok) {
      return {
        data: _response.body as SeedExamples.Response,
        rawResponse: _response.rawResponse,
      };
    }
    ...
    switch (_response.error.reason) {
      ...
      case "timeout":
        throw new errors.SeedExamplesTimeoutError(
          "Timeout exceeded when calling POST /big-entity.",
        );
      case "unknown":
        throw new errors.SeedExamplesError({
          message: _response.error.errorMessage,
  ...
  public refreshToken(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__refreshToken(request, requestOptions),
    );
  }
  ...
  private async __refreshToken(
    ...
    switch (_response.error.reason) {
      ...
      case "timeout":
        throw new errors.SeedExamplesTimeoutError(
          "Timeout exceeded when calling POST /refresh-token.",
        );
      case "unknown":
        throw new errors.SeedExamplesError({
          message: _response.error.errorMessage,
