...
export class Service {
     ...
     */
    public check(id: string, requestOptions?: Service.RequestOptions): core.APIPromise<void> {
     ...
     */
    public ping(requestOptions?: Service.RequestOptions): core.APIPromise<boolean> {
        return core.APIPromise.from(
            (async () => {
                const _response = await core.fetcher({
                ...
                if (_response.ok) {
                    return {
                        ok: _response.ok,
                        body: serializers.health.service.ping.Response.parseOrThrow(_response.body, {
