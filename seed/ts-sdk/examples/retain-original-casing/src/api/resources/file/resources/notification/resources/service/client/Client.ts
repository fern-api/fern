...
export class ServiceClient {
     ...
     */
    public getException(notificationId: string, requestOptions?: ServiceClient.RequestOptions): core.HttpResponsePromise<SeedExamples.Exception> {
        return core.HttpResponsePromise.fromPromise(this.__getException(notificationId, requestOptions));
    }

    private async __getException(notificationId: string, requestOptions?: ServiceClient.RequestOptions): Promise<core.WithRawResponse<SeedExamples.Exception>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `/file/notification/${core.url.encodePathParam(notificationId)}`),
            method: "GET",
            headers: _headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout": throw new errors.SeedExamplesTimeoutError("Timeout exceeded when calling GET /file/notification/{notificationId}.");
