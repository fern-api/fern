...
import type { Identifier } from "./api/types/Identifier.js";
import type { Type } from "./api/types/Type.js";
...
export class SeedExamplesClient {
    ...
    public createType(
        request: Type,
        requestOptions?: SeedExamplesClient.RequestOptions,
    ): core.HttpResponsePromise<Identifier> {
    ...
    private async __createType(
        request: Type,
        requestOptions?: SeedExamplesClient.RequestOptions,
    ): Promise<core.WithRawResponse<Identifier>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url:
                (await core.Supplier.get(this._options.baseUrl)) ??
        ...
        if (_response.ok) {
            return { data: _response.body as Identifier, rawResponse: _response.rawResponse };
        }
