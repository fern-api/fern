...
import { SeedExamplesClient as SeedExamplesClient_SeedExamples } from "../../src/Client";
import { mockServerPool } from "../mock-server/MockServerPool";

describe("SeedExamplesClient", () => {
    test("echo", async () => {
        const server = mockServerPool.createServer();
        const client = new SeedExamplesClient_SeedExamples({ token: "test", environment: server.baseUrl });
