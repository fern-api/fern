...
export class IdentityClient {
     ...
     *     })
     */
    public getToken(request: SeedApi.GetTokenIdentityRequest, requestOptions?: IdentityClient.RequestOptions): core.HttpResponsePromise<SeedApi.TokenResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getToken(request, requestOptions));
    }

    private async __getToken(request: SeedApi.GetTokenIdentityRequest, requestOptions?: IdentityClient.RequestOptions): Promise<core.WithRawResponse<SeedApi.TokenResponse>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "identity/token"),
            method: "POST",
            headers: _headers,
