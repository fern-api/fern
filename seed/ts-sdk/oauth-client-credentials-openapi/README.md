...
[![npm shield](https://img.shields.io/npm/v/@fern/oauth-client-credentials-openapi)](https://www.npmjs.com/package/@fern/oauth-client-credentials-openapi)
...
```sh
npm i -s @fern/oauth-client-credentials-openapi
```
...
```typescript
import { IdentityClient } from '@fern/oauth-client-credentials-openapi/identity';
...
```typescript
import { SeedApiClient, logging } from "@fern/oauth-client-credentials-openapi";
