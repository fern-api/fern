...
[![npm shield](https://img.shields.io/npm/v/@fern/examples-minimal)](https://www.npmjs.com/package/@fern/examples-minimal)
...
```typescript
import { SeedExamplesEnvironment, SeedExamplesClient } from "@fern/examples-minimal";
...
```typescript
import { SeedExamplesError } from "@fern/examples-minimal";
