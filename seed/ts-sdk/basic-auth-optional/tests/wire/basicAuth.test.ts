...
import * as SeedBasicAuthOptional from "../../src/api/index";
import { SeedBasicAuthOptionalClient } from "../../src/Client";
...
describe("BasicAuthClient", () => {
    ...
    test("getWithBasicAuth (2)", async () => {
        ...
        }).rejects.toThrow(SeedBasicAuthOptional.UnauthorizedRequest);
    });
    ...
    test("postWithBasicAuth (3)", async () => {
        ...
        }).rejects.toThrow(SeedBasicAuthOptional.BadRequest);
    });
});
