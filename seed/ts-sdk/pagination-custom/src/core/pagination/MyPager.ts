 ...
 */
type MyPagerParser<TItem, TRequest, TResponse> = (
    request: TRequest,
 ...
 * @template TResponse The type of the API response.
 */
export class MyPager<TItem, TRequest, TResponse> implements AsyncIterable<TItem> {
    ...
    private parser: MyPagerParser<TItem, TRequest, TResponse>;
