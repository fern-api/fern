...
export class UsersClient {
     ...
     *     })
     */
    public async listUsernamesCustom(request: SeedPagination.ListUsernamesRequestCustom = {}, requestOptions?: UsersClient.RequestOptions): Promise<core.MyPager<string, SeedPagination.UsernameCursor>> {
        ...
        return core.createMyPager<string, SeedPagination.UsernameCursor>({ sendRequest: _sendRequest, initialHttpRequest: _request, clientOptions: this._options, requestOptions: requestOptions });
    }
}
