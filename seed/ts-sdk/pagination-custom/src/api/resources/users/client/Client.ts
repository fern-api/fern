...
export class UsersClient {
     ...
     *     })
     */
    public async listWithCustomPager(request: SeedPagination.ListWithCustomPagerRequest = {}, requestOptions?: UsersClient.RequestOptions): Promise<core.MyPager<string, SeedPagination.UsersListResponse>> {
        ...
        return core.createMyPager<string, SeedPagination.UsersListResponse>({ sendRequest: _sendRequest, initialHttpRequest: _request, clientOptions: this._options, requestOptions: requestOptions });
    }
}
