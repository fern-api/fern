...
export class Object_ {
    ...
    public getAndReturnWithOptionalField(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getAndReturnWithOptionalField(request, requestOptions),
        );
    }
    ...
    private async __getAndReturnWithOptionalField(
        ...
        core.WithRawResponse<SeedExhaustive.types.ObjectWithOptionalField>
    > {
    ...
    public getAndReturnWithRequiredField(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getAndReturnWithRequiredField(request, requestOptions),
        );
    }
    ...
    private async __getAndReturnWithRequiredField(
        ...
        core.WithRawResponse<SeedExhaustive.types.ObjectWithRequiredField>
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
    ...
    public getAndReturnWithMapOfMap(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getAndReturnWithMapOfMap(request, requestOptions),
        );
    }
    ...
    private async __getAndReturnNestedWithOptionalField(
        ...
        core.WithRawResponse<SeedExhaustive.types.NestedObjectWithOptionalField>
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
    ...
    private async __getAndReturnNestedWithRequiredField(
        ...
        core.WithRawResponse<SeedExhaustive.types.NestedObjectWithRequiredField>
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
