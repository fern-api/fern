...
export class PrimitiveClient {
    ...
    private async __getAndReturnString(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.primitive.getAndReturnString.Response.validateSync(_response.body),
    ...
    private async __getAndReturnInt(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.primitive.getAndReturnInt.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnLong(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.primitive.getAndReturnLong.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnDouble(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.primitive.getAndReturnDouble.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnBool(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.primitive.getAndReturnBool.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnDatetime(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.primitive.getAndReturnDatetime.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnDate(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.primitive.getAndReturnDate.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnUuid(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.primitive.getAndReturnUuid.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnBase64(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.primitive.getAndReturnBase64.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
