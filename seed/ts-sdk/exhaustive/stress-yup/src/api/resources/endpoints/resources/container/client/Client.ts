...
export class ContainerClient {
    ...
    private async __getAndReturnListOfPrimitives(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.container.getAndReturnListOfPrimitives.Response.validateSync(
                    _response.body,
                ),
    ...
    private async __getAndReturnListOfObjects(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.container.getAndReturnListOfObjects.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnSetOfPrimitives(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.container.getAndReturnSetOfPrimitives.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnSetOfObjects(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.container.getAndReturnSetOfObjects.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnMapPrimToPrim(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.container.getAndReturnMapPrimToPrim.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnMapOfPrimToObject(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.container.getAndReturnMapOfPrimToObject.Response.validateSync(
                    _response.body,
                ),
                rawResponse: _response.rawResponse,
            };
    ...
    private async __getAndReturnOptional(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.container.getAndReturnOptional.Response.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
