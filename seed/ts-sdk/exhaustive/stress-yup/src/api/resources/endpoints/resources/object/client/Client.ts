...
export class ObjectClient {
    ...
    private async __getAndReturnWithOptionalField(
        ...
        if (_response.ok) {
            return {
                data: serializers.types.ObjectWithOptionalField.validateSync(_response.body),
    ...
    private async __getAndReturnWithRequiredField(
        ...
        if (_response.ok) {
            return {
                data: serializers.types.ObjectWithRequiredField.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnWithMapOfMap(
        ...
        if (_response.ok) {
            return {
                data: serializers.types.ObjectWithMapOfMap.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnNestedWithOptionalField(
        ...
        if (_response.ok) {
            return {
                data: serializers.types.NestedObjectWithOptionalField.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getAndReturnNestedWithRequiredField(
        ...
        if (_response.ok) {
            return {
                data: serializers.types.NestedObjectWithRequiredField.validateSync(_response.body),
                rawResponse: _response.rawResponse,
            };
        }
