...
export class PaginationClient {
    ...
    public async listItems(request: SeedExhaustive.endpoints.ListItemsRequest = {}, requestOptions?: PaginationClient.RequestOptions): Promise<core.Page<SeedExhaustive.types.ObjectWithRequiredField, SeedExhaustive.endpoints.PaginatedResponse>> {
        const list = core.HttpResponsePromise.interceptFunction(async (request: SeedExhaustive.endpoints.ListItemsRequest): Promise<core.WithRawResponse<SeedExhaustive.endpoints.PaginatedResponse>> => { const { cursor, limit } = request; const _queryParams: Record<string, unknown> = {
            ...
            return { data: serializers.endpoints.PaginatedResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
