...
export class Params {
  ...
  private async __getWithPath(
    ...
    if (_response.ok) {
      return {
        data: serializers.endpoints.params.getWithPath.Response.parseOrThrow(
          _response.body,
          {
  ...
  private async __getWithInlinePath(
    ...
    if (_response.ok) {
      return {
        data: serializers.endpoints.params.getWithInlinePath.Response.parseOrThrow(
          _response.body,
          {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
  ...
  private async __modifyWithPath(
    ...
    const _response = await core.fetcher({
      ...
      queryParameters: requestOptions?.queryParams,
      requestType: "json",
      body: serializers.endpoints.params.modifyWithPath.Request.jsonOrThrow(
        request,
    ...
    if (_response.ok) {
      return {
        data: serializers.endpoints.params.modifyWithPath.Response.parseOrThrow(
          _response.body,
          {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
  ...
  private async __modifyWithInlinePath(
    ...
    const _response = await core.fetcher({
      ...
      queryParameters: requestOptions?.queryParams,
      requestType: "json",
      body: serializers.endpoints.params.modifyWithInlinePath.Request.jsonOrThrow(
        _body,
        { unrecognizedObjectKeys: "strip", omitUndefined: true },
      ),
      timeoutMs:
    ...
    if (_response.ok) {
      return {
        data: serializers.endpoints.params.modifyWithInlinePath.Response.parseOrThrow(
          _response.body,
          {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
