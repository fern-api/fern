...
export class InlinedRequests {
  ...
  public postWithObjectBodyandResponse(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__postWithObjectBodyandResponse(request, requestOptions),
    );
  }
      ...
      switch (_response.error.statusCode) {
        case 400:
          throw new SeedExhaustive.BadRequestBody(
            serializers.BadObjectRequestInfo.parseOrThrow(
    ...
    switch (_response.error.reason) {
      ...
      case "timeout":
        throw new errors.SeedExhaustiveTimeoutError(
          "Timeout exceeded when calling POST /req-bodies/object.",
        );
      case "unknown":
        throw new errors.SeedExhaustiveError({
