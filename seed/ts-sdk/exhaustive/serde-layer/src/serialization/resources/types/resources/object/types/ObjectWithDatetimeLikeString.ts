...
export const ObjectWithDatetimeLikeString: core.serialization.ObjectSchema<serializers.types.ObjectWithDatetimeLikeString.Raw, SeedExhaustive.types.ObjectWithDatetimeLikeString> = core.serialization.object({
