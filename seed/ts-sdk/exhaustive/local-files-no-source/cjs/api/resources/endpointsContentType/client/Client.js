...
class EndpointsContentTypeClient {
    ...
    endpointsContentTypePostJsonPatchContentType(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__endpointsContentTypePostJsonPatchContentType(request, requestOptions));
    }
    __endpointsContentTypePostJsonPatchContentType(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/foo/bar");
        });
    }
    /**
     * @param {SeedApi.TypesObjectWithOptionalField} request
    ...
    endpointsContentTypePostJsonPatchContentWithCharsetType(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__endpointsContentTypePostJsonPatchContentWithCharsetType(request, requestOptions));
    }
    __endpointsContentTypePostJsonPatchContentWithCharsetType(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h;
            const _authRequest = yield this._options.authProvider.getAuthRequest();
            const _headers = (0, headers_js_1.mergeHeaders)(_authRequest.headers, (_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
...
exports.EndpointsContentTypeClient = EndpointsContentTypeClient;
