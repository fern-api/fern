...
export class NoReqBody {
    ...
    public getWithNoRequestBody(
        ...
        core.APIResponse<
            ...
            Fiddle.noReqBody.getWithNoRequestBody.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.noReqBody.getWithNoRequestBody.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public postWithNoRequestBody(
        ...
        core.APIResponse<string, Fiddle.noReqBody.postWithNoRequestBody.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    private async __postWithNoRequestBody(
        ...
        core.WithRawResponse<
            core.APIResponse<
                string,
                Fiddle.noReqBody.postWithNoRequestBody.Error
            >
        >
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.noReqBody.postWithNoRequestBody.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
