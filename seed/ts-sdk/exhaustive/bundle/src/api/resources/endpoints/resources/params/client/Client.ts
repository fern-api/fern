...
export class Params {
  ...
  public getWithPath(
    ...
    core.APIResponse<string, Fiddle.endpoints.params.getWithPath.Error>
  > {
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: Fiddle.endpoints.params.getWithPath.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public getWithInlinePath(
    ...
    core.APIResponse<string, Fiddle.endpoints.params.getWithInlinePath.Error>
  > {
    return core.HttpResponsePromise.fromPromise(
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: Fiddle.endpoints.params.getWithInlinePath.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public getWithQuery(
    ...
    core.APIResponse<void, Fiddle.endpoints.params.getWithQuery.Error>
  > {
    return core.HttpResponsePromise.fromPromise(
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: Fiddle.endpoints.params.getWithQuery.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public getWithAllowMultipleQuery(
    ...
    core.APIResponse<
      void,
      Fiddle.endpoints.params.getWithAllowMultipleQuery.Error
    >
  > {
    return core.HttpResponsePromise.fromPromise(
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: Fiddle.endpoints.params.getWithAllowMultipleQuery.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public getWithPathAndQuery(
    ...
    core.APIResponse<void, Fiddle.endpoints.params.getWithPathAndQuery.Error>
  > {
    return core.HttpResponsePromise.fromPromise(
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: Fiddle.endpoints.params.getWithPathAndQuery.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public getWithInlinePathAndQuery(
    ...
    core.APIResponse<
      void,
      Fiddle.endpoints.params.getWithInlinePathAndQuery.Error
    >
  > {
    return core.HttpResponsePromise.fromPromise(
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: Fiddle.endpoints.params.getWithInlinePathAndQuery.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public modifyWithPath(
    ...
    core.APIResponse<string, Fiddle.endpoints.params.modifyWithPath.Error>
  > {
    return core.HttpResponsePromise.fromPromise(
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: Fiddle.endpoints.params.modifyWithPath.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public modifyWithInlinePath(
    ...
    core.APIResponse<string, Fiddle.endpoints.params.modifyWithInlinePath.Error>
  > {
    return core.HttpResponsePromise.fromPromise(
  ...
  private async __modifyWithInlinePath(
    ...
    core.WithRawResponse<
      core.APIResponse<
        string,
        Fiddle.endpoints.params.modifyWithInlinePath.Error
      >
    >
  > {
    ...
    return {
      data: {
        ok: false,
        error: Fiddle.endpoints.params.modifyWithInlinePath.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
