...
export const Error = {
        _unknown: (fetcherError: core.Fetcher.Error): Fiddle.endpoints.container.getAndReturnOptional.Error._Unknown => {
            return {
                ...
                "_visit": function <_Result>(this: Fiddle.endpoints.container.getAndReturnOptional.Error._Unknown, visitor: Fiddle.endpoints.container.getAndReturnOptional.Error._Visitor<_Result>) {
                    return Fiddle.endpoints.container.getAndReturnOptional.Error._visit(this, visitor);
                }
            };
        },

        _visit: <_Result>(value: Fiddle.endpoints.container.getAndReturnOptional.Error, visitor: Fiddle.endpoints.container.getAndReturnOptional.Error._Visitor<_Result>): _Result => {
