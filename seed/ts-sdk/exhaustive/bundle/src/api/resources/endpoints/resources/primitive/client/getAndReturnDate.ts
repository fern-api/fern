...
export type Error = Fiddle.endpoints.primitive.getAndReturnDate.Error._Unknown;
...
export declare namespace Error {
    ...
    interface _Utils {
        _visit: <_Result>(visitor: Fiddle.endpoints.primitive.getAndReturnDate.Error._Visitor<_Result>) => _Result;
    }
...
export const Error = {
    _unknown: (fetcherError: core.Fetcher.Error): Fiddle.endpoints.primitive.getAndReturnDate.Error._Unknown => {
        return {
