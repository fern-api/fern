...
export class Object_ {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.object.getAndReturnWithOptionalField.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.object.getAndReturnWithRequiredField.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getAndReturnWithMapOfMap(
        ...
        core.APIResponse<
            ...
            Fiddle.endpoints.object.getAndReturnWithMapOfMap.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.object.getAndReturnWithMapOfMap.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.object.getAndReturnNestedWithOptionalField.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.object.getAndReturnNestedWithRequiredField.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
