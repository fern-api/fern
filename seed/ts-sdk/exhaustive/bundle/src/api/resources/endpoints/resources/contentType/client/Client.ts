...
export class ContentType {
    ...
    public postJsonPatchContentType(
        ...
        core.APIResponse<
            void,
            Fiddle.endpoints.contentType.postJsonPatchContentType.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.contentType.postJsonPatchContentType.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public postJsonPatchContentWithCharsetType(
        ...
        core.APIResponse<
            void,
            Fiddle.endpoints.contentType.postJsonPatchContentWithCharsetType.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.contentType.postJsonPatchContentWithCharsetType.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
