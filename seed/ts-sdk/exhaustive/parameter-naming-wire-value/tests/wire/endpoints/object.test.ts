...
describe("ObjectClient", () => {
    ...
    test("getAndReturnWithUnknownField", async () => {
        ...
        server
            .mockEndpoint()
            .post("/object/get-and-return-with-unknown-field").jsonBody(rawRequestBody)
                .respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("getAndReturnWithDocumentedUnknownType", async () => {
        ...
        server
            .mockEndpoint()
            .post("/object/get-and-return-with-documented-unknown-type").jsonBody(rawRequestBody)
                .respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("getAndReturnMapOfDocumentedUnknownType", async () => {
        ...
        server
            .mockEndpoint()
            .post("/object/get-and-return-map-of-documented-unknown-type").jsonBody(rawRequestBody)
                .respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("getAndReturnWithMixedRequiredAndOptionalFields", async () => {
        const server = mockServerPool.createServer();
        const client = new SeedExhaustiveClient({ "maxRetries" : 0 , "token" : "test" , "environment" : server.baseUrl });
        const rawRequestBody = { "requiredString" : "hello" , "requiredInteger" : 0 , "optionalString" : "world" , "requiredLong" : 0 };
        const rawResponseBody = { "requiredString" : "hello" , "requiredInteger" : 0 , "optionalString" : "world" , "requiredLong" : 0 };
        
        server
            .mockEndpoint()
            .post("/object/get-and-return-with-mixed-required-and-optional-fields").jsonBody(rawRequestBody)
                .respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("getAndReturnWithRequiredNestedObject", async () => {
        ...
        server
            .mockEndpoint()
            .post("/object/get-and-return-with-required-nested-object").jsonBody(rawRequestBody)
                .respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("getAndReturnWithDatetimeLikeString", async () => {
        ...
        server
            .mockEndpoint()
            .post("/object/get-and-return-with-datetime-like-string").jsonBody(rawRequestBody)
                .respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
