...
export class NoAuth {
     ...
     *     })
     */
    public postWithNoAuth(request?: unknown, requestOptions?: NoAuth.RequestOptions): core.HttpResponsePromise<boolean> {
        return core.HttpResponsePromise.fromPromise(this.__postWithNoAuth(request, requestOptions));
    }

    private async __postWithNoAuth(request?: unknown, requestOptions?: NoAuth.RequestOptions): Promise<core.WithRawResponse<boolean>> {
