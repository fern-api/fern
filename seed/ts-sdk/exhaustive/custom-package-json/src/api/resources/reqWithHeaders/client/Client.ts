...
export class ReqWithHeaders {
    ...
    public getWithCustomHeader(
        ...
        core.APIResponse<void, Fiddle.reqWithHeaders.getWithCustomHeader.Error>
    > {
    ...
    private async __getWithCustomHeader(
        ...
        core.WithRawResponse<
            core.APIResponse<
                void,
                Fiddle.reqWithHeaders.getWithCustomHeader.Error
            >
        >
    > {
        const {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.reqWithHeaders.getWithCustomHeader.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
