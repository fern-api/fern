...
export class HttpMethods {
    ...
    public testGet(
        ...
        core.APIResponse<string, Fiddle.endpoints.httpMethods.testGet.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__testGet(id, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.httpMethods.testGet.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public testPost(
        ...
        core.APIResponse<
            ...
            Fiddle.endpoints.httpMethods.testPost.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__testPost(request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.httpMethods.testPost.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public testPut(
        ...
        core.APIResponse<
            Fiddle.types.ObjectWithOptionalField,
            Fiddle.endpoints.httpMethods.testPut.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__testPut(id, request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.httpMethods.testPut.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public testPatch(
        ...
        core.APIResponse<
            Fiddle.types.ObjectWithOptionalField,
            Fiddle.endpoints.httpMethods.testPatch.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__testPatch(id, request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.httpMethods.testPatch.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public testDelete(
        ...
        core.APIResponse<boolean, Fiddle.endpoints.httpMethods.testDelete.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__testDelete(id, requestOptions),
        );
    }
    ...
    private async __testDelete(
        ...
        core.WithRawResponse<
            core.APIResponse<
                boolean,
                Fiddle.endpoints.httpMethods.testDelete.Error
            >
        >
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.httpMethods.testDelete.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
