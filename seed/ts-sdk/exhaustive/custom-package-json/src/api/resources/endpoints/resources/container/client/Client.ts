...
export class Container {
    ...
    public getAndReturnListOfPrimitives(
        ...
        core.APIResponse<
            string[],
            Fiddle.endpoints.container.getAndReturnListOfPrimitives.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__getAndReturnListOfPrimitives(request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.container.getAndReturnListOfPrimitives.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__getAndReturnListOfObjects(request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.container.getAndReturnListOfObjects.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getAndReturnSetOfPrimitives(
        ...
        core.APIResponse<
            string[],
            Fiddle.endpoints.container.getAndReturnSetOfPrimitives.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__getAndReturnSetOfPrimitives(request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.container.getAndReturnSetOfPrimitives.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__getAndReturnSetOfObjects(request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.container.getAndReturnSetOfObjects.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getAndReturnMapPrimToPrim(
        ...
        core.APIResponse<
            ...
            Fiddle.endpoints.container.getAndReturnMapPrimToPrim.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__getAndReturnMapPrimToPrim(request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.container.getAndReturnMapPrimToPrim.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__getAndReturnMapOfPrimToObject(request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.container.getAndReturnMapOfPrimToObject.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__getAndReturnOptional(request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.container.getAndReturnOptional.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
