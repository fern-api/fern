  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error:
          Fiddle.endpoints.container.getAndReturnListOfObjects.Error._unknown(
            _response.error,
          ),
        rawResponse: _response.rawResponse,
      },
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error:
          Fiddle.endpoints.container.getAndReturnSetOfObjects.Error._unknown(
            _response.error,
          ),
        rawResponse: _response.rawResponse,
      },
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error:
          Fiddle.endpoints.container.getAndReturnMapPrimToPrim.Error._unknown(
            _response.error,
          ),
        rawResponse: _response.rawResponse,
      },
