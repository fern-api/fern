...
export async function toBinaryUploadRequest(
    file: Uploadable,
): Promise<{ body: Uploadable.FileLike; headers?: Record<string, string> | undefined }> {
...
export async function toMultipartDataPart(
    file: Uploadable,
): Promise<{ data: Uploadable.FileLike; filename?: string | undefined; contentType?: string | undefined }> {
...
async function getFileWithMetadata(
    file: Uploadable,
    { noSniffFileSize }: { noSniffFileSize?: boolean | undefined } = {},
...
type StreamLike = {
    ...
    pipe?: ((dest: unknown) => unknown) | undefined;
} & unknown;
