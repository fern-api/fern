...
describe("Test qs toQueryString", () => {
    ...
    describe("Array handling", () => {
        interface ArrayTestCase {
            description: string;
            input: any;
            options?: { arrayFormat?: "repeat" | "indices" | "comma" | undefined } | undefined;
            expected: string;
        }
    ...
    describe("Encoding", () => {
        interface EncodingTestCase {
            description: string;
            input: any;
            options?: { encode?: boolean | undefined } | undefined;
            expected: string;
        }
    ...
    describe("Comma array format", () => {
        interface CommaTestCase {
            description: string;
            input: any;
            options?: { arrayFormat?: "comma" | undefined; encode?: boolean | undefined } | undefined;
            expected: string;
        }
    ...
    describe("Options combinations", () => {
        interface OptionsTestCase {
            ...
            input: any;
            options?:
                | { arrayFormat?: "repeat" | "indices" | "comma" | undefined; encode?: boolean | undefined }
                | undefined;
            expected: string;
        }
