...
export class PutClient {
     ...
     *     })
     */
    public add(request: SeedExhaustive.PutRequest, requestOptions?: PutClient.RequestOptions): core.HttpResponsePromise<SeedExhaustive.endpoints.PutResponse> {
        return core.HttpResponsePromise.fromPromise(this.__add(request, requestOptions));
    }

    private async __add(request: SeedExhaustive.PutRequest, requestOptions?: PutClient.RequestOptions): Promise<core.WithRawResponse<SeedExhaustive.endpoints.PutResponse>> {
        const { id } = request;
        ...
        switch (_response.error.reason) {
            ...
            case "timeout": throw new errors.SeedExhaustiveTimeoutError("Timeout exceeded when calling PUT /{id}.");
