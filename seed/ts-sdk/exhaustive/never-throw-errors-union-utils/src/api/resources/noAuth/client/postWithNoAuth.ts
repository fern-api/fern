...
export namespace Error {
    ...
    export interface _Utils {
        _visit: <_Result>(visitor: SeedExhaustive.noAuth.postWithNoAuth.Error._Visitor<_Result>) => _Result;
    }
...
export const Error = {
    badRequestBody: (
        ...
        return {
            ...
            _visit: function <_Result>(
                this: SeedExhaustive.noAuth.postWithNoAuth.Error.BadRequestBody,
                visitor: SeedExhaustive.noAuth.postWithNoAuth.Error._Visitor<_Result>,
            ) {
                return SeedExhaustive.noAuth.postWithNoAuth.Error._visit(this, visitor);
            },
        };
    },
    ...
    _unknown: (fetcherError: core.Fetcher.Error): SeedExhaustive.noAuth.postWithNoAuth.Error._Unknown => {
        return {
            ...
            _visit: function <_Result>(
                this: SeedExhaustive.noAuth.postWithNoAuth.Error._Unknown,
                visitor: SeedExhaustive.noAuth.postWithNoAuth.Error._Visitor<_Result>,
            ) {
                return SeedExhaustive.noAuth.postWithNoAuth.Error._visit(this, visitor);
            },
