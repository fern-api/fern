...
export class PrimitiveClient {
    ...
    public getAndReturnDatetime(
        request: Date,
        requestOptions?: PrimitiveClient.RequestOptions,
    ): core.HttpResponsePromise<core.APIResponse<Date, SeedExhaustive.endpoints.primitive.getAndReturnDatetime.Error>> {
    ...
    private async __getAndReturnDatetime(
        ...
        core.WithRawResponse<core.APIResponse<Date, SeedExhaustive.endpoints.primitive.getAndReturnDatetime.Error>>
    > {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
