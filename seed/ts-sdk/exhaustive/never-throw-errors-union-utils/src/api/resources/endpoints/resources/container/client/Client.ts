...
export class ContainerClient {
    ...
    public getAndReturnSetOfPrimitives(
        ...
        core.APIResponse<Set<string>, SeedExhaustive.endpoints.container.getAndReturnSetOfPrimitives.Error>
    > {
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.endpoints.container.getAndReturnMapOfPrimToUndiscriminatedUnion.Response.parseOrThrow(
                        _response.body,
                        {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
