...
<details><summary><code>client.endpoints.container.<a href="/src/api/resources/endpoints/resources/container/client/Client.ts">getAndReturnSetOfPrimitives</a>({ ...params }) -> core.APIResponse&lt;Set&lt;string&gt;, SeedExhaustive.endpoints.container.getAndReturnSetOfPrimitives.Error&gt;</code></summary>
<dl>
<dd>
...
<details><summary><code>client.endpoints.primitive.<a href="/src/api/resources/endpoints/resources/primitive/client/Client.ts">getAndReturnDatetime</a>({ ...params }) -> core.APIResponse&lt;Date, SeedExhaustive.endpoints.primitive.getAndReturnDatetime.Error&gt;</code></summary>
<dl>
<dd>
...
```typescript
await client.endpoints.union.getAndReturnUnion(SeedExhaustive.Animal.dog({
    name: "name",
    likesToWoof: true
}));
...
<details><summary><code>client.endpoints.union.<a href="/src/api/resources/endpoints/resources/union/client/Client.ts">getAndReturnObjectWithUnionField</a>({ ...params }) -> core.APIResponse&lt;SeedExhaustive.ObjectWithUnionField, SeedExhaustive.endpoints.union.getAndReturnObjectWithUnionField.Error&gt;</code></summary>
<dl>
<dd>
...
await client.endpoints.union.getAndReturnObjectWithUnionField({
    name: "name",
    animal: SeedExhaustive.Animal.dog({
        name: "name",
        likesToWoof: true
    })
});
...
**request:** `SeedExhaustive.ObjectWithUnionField` 
