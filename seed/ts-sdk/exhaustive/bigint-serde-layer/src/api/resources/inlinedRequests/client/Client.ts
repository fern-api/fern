...
export class InlinedRequestsClient {
    ...
    private async __postWithObjectBodyandResponse(
        ...
        const _response = await core.fetcher({
            ...
            body: mergeBodyProperties(
                serializers.PostWithObjectBody.jsonOrThrow(request, {
    ...
    private async __postWithArrayBodyAndHeaders(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: mergeBodyProperties(
                serializers.inlinedRequests.postWithArrayBodyAndHeaders.Request.jsonOrThrow(_body, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
                requestOptions?.bodyProperties,
        ...
        if (_response.ok) {
            return {
                data: serializers.inlinedRequests.postWithArrayBodyAndHeaders.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
