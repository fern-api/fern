...
export class EndpointsParamsClient {
    ...
    private async __endpointsParamsGetWithPath(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpointsParams.endpointsParamsGetWithPath.Response.parseOrThrow(_response.body, {
    ...
    private async __endpointsParamsModifyWithPath(
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.endpointsParams.endpointsParamsModifyWithPath.Request.jsonOrThrow(_body, {
        ...
        if (_response.ok) {
            return {
                data: serializers.endpointsParams.endpointsParamsModifyWithPath.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __endpointsParamsGetWithInlinePath(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpointsParams.endpointsParamsGetWithInlinePath.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __endpointsParamsModifyWithInlinePath(
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.endpointsParams.endpointsParamsModifyWithInlinePath.Request.jsonOrThrow(_body, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
        ...
        if (_response.ok) {
            return {
                data: serializers.endpointsParams.endpointsParamsModifyWithInlinePath.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __endpointsParamsGetWithBooleanPath(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpointsParams.endpointsParamsGetWithBooleanPath.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __endpointsParamsGetWithPathAndErrors(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpointsParams.endpointsParamsGetWithPathAndErrors.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
