...
export class ParamsClient {
    ...
    private async __modifyWithPath(
        ...
        const _response = await core.fetcher({
            ...
            body: mergeBodyProperties(
                serializers.endpoints.params.modifyWithPath.Request.jsonOrThrow(request, {
    ...
    private async __modifyWithInlinePath(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: mergeBodyProperties(
                serializers.endpoints.params.modifyWithInlinePath.Request.jsonOrThrow(_body, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
                requestOptions?.bodyProperties,
    ...
    private async __createWithBodyAndQuery(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: mergeBodyProperties(
                serializers.types.ObjectWithRequiredField.jsonOrThrow(_body, {
                    unrecognizedObjectKeys: "strip",
                    omitUndefined: true,
                }),
                requestOptions?.bodyProperties,
    ...
    private async __getWithBooleanPath(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.params.getWithBooleanPath.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getWithPathAndErrors(
        ...
        if (_response.ok) {
            return {
                data: serializers.endpoints.params.getWithPathAndErrors.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
