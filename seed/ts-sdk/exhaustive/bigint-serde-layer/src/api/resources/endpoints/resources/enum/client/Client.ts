...
export class EnumClient {
    ...
    private async __getAndReturnEnum(request: SeedExhaustive.types.WeatherReport, requestOptions?: EnumClient.RequestOptions): Promise<core.WithRawResponse<SeedExhaustive.types.WeatherReport>> {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.types.WeatherReport.jsonOrThrow(request, { unrecognizedObjectKeys: "strip", omitUndefined: true }),
        ...
        if (_response.ok) {
            return { data: serializers.types.WeatherReport.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        }
