...
export class Urls {
  ...
  private async __withMixedCase(
    ...
    if (_response.ok) {
      return {
        data: serializers.endpoints.urls.withMixedCase.Response.parseOrThrow(
          _response.body,
          {
  ...
  private async __noEndingSlash(
    ...
    if (_response.ok) {
      return {
        data: serializers.endpoints.urls.noEndingSlash.Response.parseOrThrow(
          _response.body,
          {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
  ...
  private async __withEndingSlash(
    ...
    if (_response.ok) {
      return {
        data: serializers.endpoints.urls.withEndingSlash.Response.parseOrThrow(
          _response.body,
          {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
  ...
  private async __withUnderscores(
    ...
    if (_response.ok) {
      return {
        data: serializers.endpoints.urls.withUnderscores.Response.parseOrThrow(
          _response.body,
          {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
