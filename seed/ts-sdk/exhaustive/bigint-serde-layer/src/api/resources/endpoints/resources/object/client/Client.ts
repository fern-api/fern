...
export class Object_ {
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.types.ObjectWithRequiredField.jsonOrThrow(
                request,
                { unrecognizedObjectKeys: "strip", omitUndefined: true },
            ),
            timeoutMs:
        ...
        if (_response.ok) {
            return {
                data: serializers.types.ObjectWithRequiredField.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    private async __getAndReturnWithMapOfMap(
        ...
        if (_response.ok) {
            return {
                data: serializers.types.ObjectWithMapOfMap.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.types.NestedObjectWithOptionalField.jsonOrThrow(
                request,
                { unrecognizedObjectKeys: "strip", omitUndefined: true },
            ),
            timeoutMs:
        ...
        if (_response.ok) {
            return {
                data: serializers.types.NestedObjectWithOptionalField.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.types.NestedObjectWithRequiredField.jsonOrThrow(
                request,
                { unrecognizedObjectKeys: "strip", omitUndefined: true },
            ),
            timeoutMs:
        ...
        if (_response.ok) {
            return {
                data: serializers.types.NestedObjectWithRequiredField.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
