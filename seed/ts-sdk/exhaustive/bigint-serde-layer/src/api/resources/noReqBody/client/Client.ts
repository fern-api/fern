...
export class NoReqBody {
    ...
    public getWithNoRequestBody(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getWithNoRequestBody(requestOptions),
        );
    }
    ...
    > {
        ...
        if (_response.ok) {
            return {
                data: serializers.types.ObjectWithOptionalField.parseOrThrow(
                    _response.body,
                    {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedExhaustiveTimeoutError(
                    "Timeout exceeded when calling GET /no-req-body.",
                );
            case "unknown":
                throw new errors.SeedExhaustiveError({
    ...
    public postWithNoRequestBody(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__postWithNoRequestBody(requestOptions),
        );
    }
    ...
    private async __postWithNoRequestBody(
        ...
        if (_response.ok) {
            return {
                data: serializers.noReqBody.postWithNoRequestBody.Response.parseOrThrow(
                    _response.body,
                    {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedExhaustiveTimeoutError(
                    "Timeout exceeded when calling POST /no-req-body.",
                );
            case "unknown":
                throw new errors.SeedExhaustiveError({
                    message: _response.error.errorMessage,
