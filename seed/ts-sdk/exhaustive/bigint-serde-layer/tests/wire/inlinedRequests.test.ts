...
describe("InlinedRequestsClient", () => {
    ...
    test("postWithObjectBodyandResponse (1)", async () => {
        ...
        const rawRequestBody = { "string" : "string" , "integer" : 1 , "NestedObject" : { "string" : "string" , "integer" : 1 , "long" : BigInt(1000000) , "double" : 1.1 , "bool" : true , "datetime" : "2024-01-15T09:30:00Z" , "date" : "2023-01-15" , "uuid" : "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32" , "base64" : "SGVsbG8gd29ybGQh" , "list" : [ "list" , "list" ] , "set" : [ "set" ] , "map" : { "1" : "map" } , "bigint" : BigInt("1000000") } };
        const rawResponseBody = { "string" : "string" , "integer" : 1 , "long" : BigInt(1000000) , "double" : 1.1 , "bool" : true , "datetime" : "2024-01-15T09:30:00Z" , "date" : "2023-01-15" , "uuid" : "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32" , "base64" : "SGVsbG8gd29ybGQh" , "list" : [ "list" , "list" ] , "set" : [ "set" ] , "map" : { "1" : "map" } , "bigint" : BigInt("1000000") };
    ...
    test("postWithArrayBodyAndHeaders", async () => {
        ...
        server
            .mockEndpoint()
            .post("/req-bodies/array-body-with-headers").header("X-Custom-Header", "X-Custom-Header")
