...
export class ParamsClient {
    ...
    private async __getWithPath(
        ...
        if (_response.ok) {
            return {
                data: (() => {
                    if (!ajv.validate(serializers.endpoints.params.getWithPath.Response, _response.body)) {
    ...
    private async __getWithInlinePath(
        ...
        if (_response.ok) {
            return {
                data: (() => {
                    if (!ajv.validate(serializers.endpoints.params.getWithInlinePath.Response, _response.body)) {
                        throw new Error("Validation failed");
                    }
                    return _response.body;
                })(),
    ...
    private async __modifyWithPath(
        ...
        if (_response.ok) {
            return {
                data: (() => {
                    if (!ajv.validate(serializers.endpoints.params.modifyWithPath.Response, _response.body)) {
                        throw new Error("Validation failed");
                    }
                    return _response.body;
                })(),
    ...
    private async __modifyWithInlinePath(
        ...
        if (_response.ok) {
            return {
                data: (() => {
                    if (!ajv.validate(serializers.endpoints.params.modifyWithInlinePath.Response, _response.body)) {
                        throw new Error("Validation failed");
                    }
                    return _response.body;
                })(),
