...
export const NestedObjectWithRequiredField: core.serialization.ObjectSchema<serializers.types.NestedObjectWithRequiredField.Raw, Fiddle.types.NestedObjectWithRequiredField> = core.serialization.object({
