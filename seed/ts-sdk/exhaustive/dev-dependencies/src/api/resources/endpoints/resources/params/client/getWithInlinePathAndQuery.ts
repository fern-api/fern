...
export type Error = Fiddle.endpoints.params.getWithInlinePathAndQuery.Error._Unknown;
...
export const Error = {
    _unknown: (fetcherError: core.Fetcher.Error): Fiddle.endpoints.params.getWithInlinePathAndQuery.Error._Unknown => {
        return {
