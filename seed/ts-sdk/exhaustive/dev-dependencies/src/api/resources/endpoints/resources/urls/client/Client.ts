...
export class Urls {
    ...
    public withMixedCase(
        ...
        core.APIResponse<string, Fiddle.endpoints.urls.withMixedCase.Error>
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.urls.withMixedCase.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public noEndingSlash(
        ...
        core.APIResponse<string, Fiddle.endpoints.urls.noEndingSlash.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.urls.noEndingSlash.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public withEndingSlash(
        ...
        core.APIResponse<string, Fiddle.endpoints.urls.withEndingSlash.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    private async __withEndingSlash(
        ...
        core.WithRawResponse<
            core.APIResponse<
                string,
                Fiddle.endpoints.urls.withEndingSlash.Error
            >
        >
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.urls.withEndingSlash.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public withUnderscores(
        ...
        core.APIResponse<string, Fiddle.endpoints.urls.withUnderscores.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    private async __withUnderscores(
        ...
        core.WithRawResponse<
            core.APIResponse<
                string,
                Fiddle.endpoints.urls.withUnderscores.Error
            >
        >
    > {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
        ...
        return {
            data: {
                ok: false,
                error: Fiddle.endpoints.urls.withUnderscores.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
