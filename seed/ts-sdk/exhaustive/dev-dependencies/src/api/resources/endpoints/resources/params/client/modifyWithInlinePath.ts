...
export type Error = Fiddle.endpoints.params.modifyWithInlinePath.Error._Unknown;
...
export namespace Error {
    ...
    interface _Utils {
        _visit: <_Result>(visitor: Fiddle.endpoints.params.modifyWithInlinePath.Error._Visitor<_Result>) => _Result;
    }
...
export const Error = {
    _unknown: (fetcherError: core.Fetcher.Error): Fiddle.endpoints.params.modifyWithInlinePath.Error._Unknown => {
        return {
