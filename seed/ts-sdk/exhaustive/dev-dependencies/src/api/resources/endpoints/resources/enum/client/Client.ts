...
export class Enum {
  ...
  public getAndReturnEnum(
    ...
    core.APIResponse<
      Fiddle.types.WeatherReport,
      Fiddle.endpoints.enum_.getAndReturnEnum.Error
    >
  > {
    return core.HttpResponsePromise.fromPromise(
      this.__getAndReturnEnum(request, requestOptions),
    );
  }
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: Fiddle.endpoints.enum_.getAndReturnEnum.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
