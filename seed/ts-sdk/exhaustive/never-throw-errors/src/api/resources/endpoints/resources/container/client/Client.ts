...
export class ContainerClient {
     ...
     *     })
     */
    public getAndReturnMapOfPrimToUndiscriminatedUnion(request: Record<string, SeedExhaustive.types.MixedType>, requestOptions?: ContainerClient.RequestOptions): core.HttpResponsePromise<core.APIResponse<Record<string, SeedExhaustive.types.MixedType>, SeedExhaustive.endpoints.container.getAndReturnMapOfPrimToUndiscriminatedUnion.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__getAndReturnMapOfPrimToUndiscriminatedUnion(request, requestOptions));
    }

    private async __getAndReturnMapOfPrimToUndiscriminatedUnion(request: Record<string, SeedExhaustive.types.MixedType>, requestOptions?: ContainerClient.RequestOptions): Promise<core.WithRawResponse<core.APIResponse<Record<string, SeedExhaustive.types.MixedType>, SeedExhaustive.endpoints.container.getAndReturnMapOfPrimToUndiscriminatedUnion.Error>>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
        ...
        return { data: {
                ok: false,
                error: SeedExhaustive.endpoints.container.getAndReturnMapOfPrimToUndiscriminatedUnion.Error._unknown(_response.error),
                rawResponse: _response.rawResponse
            }, rawResponse: _response.rawResponse };
    }
