...
export class ContentType {
  ...
  public postJsonPatchContentType(
    ...
    core.APIResponse<
      void,
      SeedExhaustive.endpoints.contentType.postJsonPatchContentType.Error
    >
  > {
    return core.HttpResponsePromise.fromPromise(
      this.__postJsonPatchContentType(request, requestOptions),
    );
  }
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error:
          SeedExhaustive.endpoints.contentType.postJsonPatchContentType.Error._unknown(
            _response.error,
          ),
        rawResponse: _response.rawResponse,
      },
  ...
  public postJsonPatchContentWithCharsetType(
    ...
    core.APIResponse<
      void,
      SeedExhaustive.endpoints.contentType.postJsonPatchContentWithCharsetType.Error
    >
  > {
    return core.HttpResponsePromise.fromPromise(
