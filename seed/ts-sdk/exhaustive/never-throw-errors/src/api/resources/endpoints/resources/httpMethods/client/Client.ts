...
export class HttpMethods {
  ...
  public testGet(
    ...
    core.APIResponse<string, SeedExhaustive.endpoints.httpMethods.testGet.Error>
  > {
  ...
  private async __testGet(
    ...
    core.WithRawResponse<
      core.APIResponse<
        string,
        SeedExhaustive.endpoints.httpMethods.testGet.Error
      >
    >
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedExhaustive.endpoints.httpMethods.testGet.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedExhaustive.endpoints.httpMethods.testPost.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedExhaustive.endpoints.httpMethods.testPut.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedExhaustive.endpoints.httpMethods.testPatch.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public testDelete(
    ...
    core.APIResponse<
      boolean,
      SeedExhaustive.endpoints.httpMethods.testDelete.Error
    >
  > {
    return core.HttpResponsePromise.fromPromise(
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedExhaustive.endpoints.httpMethods.testDelete.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
