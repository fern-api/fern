...
export class Union {
  ...
  public getAndReturnUnion(
    ...
    core.APIResponse<
      ...
      SeedExhaustive.endpoints.union.getAndReturnUnion.Error
    >
  > {
    return core.HttpResponsePromise.fromPromise(
      this.__getAndReturnUnion(request, requestOptions),
    );
  }
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedExhaustive.endpoints.union.getAndReturnUnion.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
