...
export class Params {
    ...
    public getWithPath(
        ...
        core.APIResponse<
            string,
            SeedExhaustive.endpoints.params.getWithPath.Error
        >
    > {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.endpoints.params.getWithPath.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getWithInlinePath(
        ...
        core.APIResponse<
            string,
            SeedExhaustive.endpoints.params.getWithInlinePath.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.endpoints.params.getWithInlinePath.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getWithQuery(
        ...
        core.APIResponse<
            void,
            SeedExhaustive.endpoints.params.getWithQuery.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.endpoints.params.getWithQuery.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getWithAllowMultipleQuery(
        ...
        core.APIResponse<
            void,
            SeedExhaustive.endpoints.params.getWithAllowMultipleQuery.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.endpoints.params.getWithAllowMultipleQuery.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getWithPathAndQuery(
        ...
        core.APIResponse<
            void,
            SeedExhaustive.endpoints.params.getWithPathAndQuery.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.endpoints.params.getWithPathAndQuery.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public getWithInlinePathAndQuery(
        ...
        core.APIResponse<
            void,
            SeedExhaustive.endpoints.params.getWithInlinePathAndQuery.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.endpoints.params.getWithInlinePathAndQuery.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public modifyWithPath(
        ...
        core.APIResponse<
            string,
            SeedExhaustive.endpoints.params.modifyWithPath.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.endpoints.params.modifyWithPath.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    public modifyWithInlinePath(
        ...
        core.APIResponse<
            string,
            SeedExhaustive.endpoints.params.modifyWithInlinePath.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.endpoints.params.modifyWithInlinePath.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
