...
export class Params {
  ...
  public getWithPath(
    ...
    core.APIResponse<string, SeedExhaustive.endpoints.params.getWithPath.Error>
  > {
  ...
  public getWithQuery(
    ...
    core.APIResponse<void, SeedExhaustive.endpoints.params.getWithQuery.Error>
  > {
    return core.HttpResponsePromise.fromPromise(
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error:
          SeedExhaustive.endpoints.params.getWithAllowMultipleQuery.Error._unknown(
            _response.error,
          ),
        rawResponse: _response.rawResponse,
      },
