...
export class ParamsClient {
     ...
     */
    public uploadWithPath(uploadable: core.file.Uploadable, param: string, requestOptions?: ParamsClient.RequestOptions): core.HttpResponsePromise<core.APIResponse<SeedExhaustive.types.ObjectWithRequiredField, SeedExhaustive.endpoints.params.uploadWithPath.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__uploadWithPath(uploadable, param, requestOptions));
    }

    private async __uploadWithPath(uploadable: core.file.Uploadable, param: string, requestOptions?: ParamsClient.RequestOptions): Promise<core.WithRawResponse<core.APIResponse<SeedExhaustive.types.ObjectWithRequiredField, SeedExhaustive.endpoints.params.uploadWithPath.Error>>> {
     ...
     *     })
     */
    public createWithBodyAndQuery(request: SeedExhaustive.endpoints.CreateWithBodyAndQuery, requestOptions?: ParamsClient.RequestOptions): core.HttpResponsePromise<core.APIResponse<SeedExhaustive.types.ObjectWithOptionalField, SeedExhaustive.endpoints.params.createWithBodyAndQuery.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__createWithBodyAndQuery(request, requestOptions));
    }

    private async __createWithBodyAndQuery(request: SeedExhaustive.endpoints.CreateWithBodyAndQuery, requestOptions?: ParamsClient.RequestOptions): Promise<core.WithRawResponse<core.APIResponse<SeedExhaustive.types.ObjectWithOptionalField, SeedExhaustive.endpoints.params.createWithBodyAndQuery.Error>>> {
     ...
     * @param {ParamsClient.RequestOptions} requestOptions - Request-specific configuration.
     */
    public uploadBytesWithQuery(uploadable: core.file.Uploadable, request: SeedExhaustive.endpoints.UploadBytesWithQuery, requestOptions?: ParamsClient.RequestOptions): core.HttpResponsePromise<core.APIResponse<SeedExhaustive.types.ObjectWithOptionalField, SeedExhaustive.endpoints.params.uploadBytesWithQuery.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__uploadBytesWithQuery(uploadable, request, requestOptions));
    }

    private async __uploadBytesWithQuery(uploadable: core.file.Uploadable, request: SeedExhaustive.endpoints.UploadBytesWithQuery, requestOptions?: ParamsClient.RequestOptions): Promise<core.WithRawResponse<core.APIResponse<SeedExhaustive.types.ObjectWithOptionalField, SeedExhaustive.endpoints.params.uploadBytesWithQuery.Error>>> {
        const _queryParams: Record<string, unknown> = {
     ...
     */
    public getWithBooleanPath(param: boolean, requestOptions?: ParamsClient.RequestOptions): core.HttpResponsePromise<core.APIResponse<string, SeedExhaustive.endpoints.params.getWithBooleanPath.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__getWithBooleanPath(param, requestOptions));
    }

    private async __getWithBooleanPath(param: boolean, requestOptions?: ParamsClient.RequestOptions): Promise<core.WithRawResponse<core.APIResponse<string, SeedExhaustive.endpoints.params.getWithBooleanPath.Error>>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
     ...
     */
    public getWithPathAndErrors(param: string, requestOptions?: ParamsClient.RequestOptions): core.HttpResponsePromise<core.APIResponse<string, SeedExhaustive.endpoints.params.getWithPathAndErrors.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__getWithPathAndErrors(param, requestOptions));
    }

    private async __getWithPathAndErrors(param: string, requestOptions?: ParamsClient.RequestOptions): Promise<core.WithRawResponse<core.APIResponse<string, SeedExhaustive.endpoints.params.getWithPathAndErrors.Error>>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `/params/path/${core.url.encodePathParam(param)}`),
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 400: return { data: {
                        ok: false,
                        error: SeedExhaustive.endpoints.params.getWithPathAndErrors.Error.badRequestBody(_response.error.body as SeedExhaustive.BadObjectRequestInfo),
                        rawResponse: _response.rawResponse
                    }, rawResponse: _response.rawResponse };
            }
        }
