...
export class Urls {
  ...
  public withMixedCase(
    ...
    core.APIResponse<string, SeedExhaustive.endpoints.urls.withMixedCase.Error>
  > {
    return core.HttpResponsePromise.fromPromise(
      this.__withMixedCase(requestOptions),
    );
  }
  ...
  private async __withMixedCase(
    ...
    core.WithRawResponse<
      core.APIResponse<
        string,
        SeedExhaustive.endpoints.urls.withMixedCase.Error
      >
    >
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedExhaustive.endpoints.urls.withMixedCase.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public noEndingSlash(
    ...
    core.APIResponse<string, SeedExhaustive.endpoints.urls.noEndingSlash.Error>
  > {
    return core.HttpResponsePromise.fromPromise(
      this.__noEndingSlash(requestOptions),
    );
  }
  ...
  private async __noEndingSlash(
    ...
    core.WithRawResponse<
      core.APIResponse<
        string,
        SeedExhaustive.endpoints.urls.noEndingSlash.Error
      >
    >
  > {
    const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
    ...
    return {
      data: {
        ok: false,
        error: SeedExhaustive.endpoints.urls.noEndingSlash.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public withEndingSlash(
    ...
    core.APIResponse<
      string,
      SeedExhaustive.endpoints.urls.withEndingSlash.Error
    >
  > {
    return core.HttpResponsePromise.fromPromise(
      this.__withEndingSlash(requestOptions),
    );
  }
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedExhaustive.endpoints.urls.withEndingSlash.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public withUnderscores(
    ...
    core.APIResponse<
      string,
      SeedExhaustive.endpoints.urls.withUnderscores.Error
    >
  > {
    return core.HttpResponsePromise.fromPromise(
      this.__withUnderscores(requestOptions),
    );
  }
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedExhaustive.endpoints.urls.withUnderscores.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
