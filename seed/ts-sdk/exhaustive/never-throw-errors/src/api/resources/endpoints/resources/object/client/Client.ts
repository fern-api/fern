...
export class ObjectClient {
     ...
     *     })
     */
    public getAndReturnWithUnknownField(request: SeedExhaustive.types.ObjectWithUnknownField, requestOptions?: ObjectClient.RequestOptions): core.HttpResponsePromise<core.APIResponse<SeedExhaustive.types.ObjectWithUnknownField, SeedExhaustive.endpoints.object.getAndReturnWithUnknownField.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__getAndReturnWithUnknownField(request, requestOptions));
    }

    private async __getAndReturnWithUnknownField(request: SeedExhaustive.types.ObjectWithUnknownField, requestOptions?: ObjectClient.RequestOptions): Promise<core.WithRawResponse<core.APIResponse<SeedExhaustive.types.ObjectWithUnknownField, SeedExhaustive.endpoints.object.getAndReturnWithUnknownField.Error>>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
     ...
     *     })
     */
    public getAndReturnWithDocumentedUnknownType(request: SeedExhaustive.types.ObjectWithDocumentedUnknownType, requestOptions?: ObjectClient.RequestOptions): core.HttpResponsePromise<core.APIResponse<SeedExhaustive.types.ObjectWithDocumentedUnknownType, SeedExhaustive.endpoints.object.getAndReturnWithDocumentedUnknownType.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__getAndReturnWithDocumentedUnknownType(request, requestOptions));
    }

    private async __getAndReturnWithDocumentedUnknownType(request: SeedExhaustive.types.ObjectWithDocumentedUnknownType, requestOptions?: ObjectClient.RequestOptions): Promise<core.WithRawResponse<core.APIResponse<SeedExhaustive.types.ObjectWithDocumentedUnknownType, SeedExhaustive.endpoints.object.getAndReturnWithDocumentedUnknownType.Error>>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
        ...
        return { data: {
                ok: false,
                error: SeedExhaustive.endpoints.object.getAndReturnWithDocumentedUnknownType.Error._unknown(_response.error),
                rawResponse: _response.rawResponse
            }, rawResponse: _response.rawResponse };
    }
     ...
     *     })
     */
    public getAndReturnMapOfDocumentedUnknownType(request: SeedExhaustive.types.MapOfDocumentedUnknownType, requestOptions?: ObjectClient.RequestOptions): core.HttpResponsePromise<core.APIResponse<SeedExhaustive.types.MapOfDocumentedUnknownType, SeedExhaustive.endpoints.object.getAndReturnMapOfDocumentedUnknownType.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__getAndReturnMapOfDocumentedUnknownType(request, requestOptions));
    }

    private async __getAndReturnMapOfDocumentedUnknownType(request: SeedExhaustive.types.MapOfDocumentedUnknownType, requestOptions?: ObjectClient.RequestOptions): Promise<core.WithRawResponse<core.APIResponse<SeedExhaustive.types.MapOfDocumentedUnknownType, SeedExhaustive.endpoints.object.getAndReturnMapOfDocumentedUnknownType.Error>>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
        ...
        return { data: {
                ok: false,
                error: SeedExhaustive.endpoints.object.getAndReturnMapOfDocumentedUnknownType.Error._unknown(_response.error),
                rawResponse: _response.rawResponse
            }, rawResponse: _response.rawResponse };
    }
    ...
    private async __getAndReturnWithMixedRequiredAndOptionalFields(request: SeedExhaustive.types.ObjectWithMixedRequiredAndOptionalFields, requestOptions?: ObjectClient.RequestOptions): Promise<core.WithRawResponse<core.APIResponse<SeedExhaustive.types.ObjectWithMixedRequiredAndOptionalFields, SeedExhaustive.endpoints.object.getAndReturnWithMixedRequiredAndOptionalFields.Error>>> {
        ...
        return { data: {
                ok: false,
                error: SeedExhaustive.endpoints.object.getAndReturnWithMixedRequiredAndOptionalFields.Error._unknown(_response.error),
                rawResponse: _response.rawResponse
            }, rawResponse: _response.rawResponse };
    }
     ...
     *     })
     */
    public getAndReturnWithRequiredNestedObject(request: SeedExhaustive.types.ObjectWithRequiredNestedObject, requestOptions?: ObjectClient.RequestOptions): core.HttpResponsePromise<core.APIResponse<SeedExhaustive.types.ObjectWithRequiredNestedObject, SeedExhaustive.endpoints.object.getAndReturnWithRequiredNestedObject.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__getAndReturnWithRequiredNestedObject(request, requestOptions));
    }

    private async __getAndReturnWithRequiredNestedObject(request: SeedExhaustive.types.ObjectWithRequiredNestedObject, requestOptions?: ObjectClient.RequestOptions): Promise<core.WithRawResponse<core.APIResponse<SeedExhaustive.types.ObjectWithRequiredNestedObject, SeedExhaustive.endpoints.object.getAndReturnWithRequiredNestedObject.Error>>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
        ...
        return { data: {
                ok: false,
                error: SeedExhaustive.endpoints.object.getAndReturnWithRequiredNestedObject.Error._unknown(_response.error),
                rawResponse: _response.rawResponse
            }, rawResponse: _response.rawResponse };
    }
     ...
     *     })
     */
    public getAndReturnWithDatetimeLikeString(request: SeedExhaustive.types.ObjectWithDatetimeLikeString, requestOptions?: ObjectClient.RequestOptions): core.HttpResponsePromise<core.APIResponse<SeedExhaustive.types.ObjectWithDatetimeLikeString, SeedExhaustive.endpoints.object.getAndReturnWithDatetimeLikeString.Error>> {
        return core.HttpResponsePromise.fromPromise(this.__getAndReturnWithDatetimeLikeString(request, requestOptions));
    }

    private async __getAndReturnWithDatetimeLikeString(request: SeedExhaustive.types.ObjectWithDatetimeLikeString, requestOptions?: ObjectClient.RequestOptions): Promise<core.WithRawResponse<core.APIResponse<SeedExhaustive.types.ObjectWithDatetimeLikeString, SeedExhaustive.endpoints.object.getAndReturnWithDatetimeLikeString.Error>>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
        ...
        return { data: {
                ok: false,
                error: SeedExhaustive.endpoints.object.getAndReturnWithDatetimeLikeString.Error._unknown(_response.error),
                rawResponse: _response.rawResponse
            }, rawResponse: _response.rawResponse };
    }
}
