...
export class Object_ {
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.endpoints.object.getAndReturnWithOptionalField.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.endpoints.object.getAndReturnWithRequiredField.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.endpoints.object.getAndReturnWithMapOfMap.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
