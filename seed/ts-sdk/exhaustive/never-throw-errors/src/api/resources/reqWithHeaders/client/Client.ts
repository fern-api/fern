...
export class ReqWithHeaders {
    ...
    public getWithCustomHeader(
        ...
        core.APIResponse<
            void,
            SeedExhaustive.reqWithHeaders.getWithCustomHeader.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__getWithCustomHeader(request, requestOptions),
        );
    }
    ...
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.reqWithHeaders.getWithCustomHeader.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
