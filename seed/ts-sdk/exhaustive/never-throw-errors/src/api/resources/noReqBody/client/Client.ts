...
export class NoReqBody {
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedExhaustive.noReqBody.getWithNoRequestBody.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
  ...
  public postWithNoRequestBody(
    ...
    core.APIResponse<
      string,
      SeedExhaustive.noReqBody.postWithNoRequestBody.Error
    >
  > {
    return core.HttpResponsePromise.fromPromise(
  ...
  > {
    ...
    return {
      data: {
        ok: false,
        error: SeedExhaustive.noReqBody.postWithNoRequestBody.Error._unknown(
          _response.error,
        ),
        rawResponse: _response.rawResponse,
      },
