...
export class NoAuth {
    ...
    public postWithNoAuth(
        ...
        core.APIResponse<boolean, SeedExhaustive.noAuth.postWithNoAuth.Error>
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__postWithNoAuth(request, requestOptions),
        );
    }
    ...
    private async __postWithNoAuth(
        ...
        core.WithRawResponse<
            core.APIResponse<
                boolean,
                SeedExhaustive.noAuth.postWithNoAuth.Error
            >
        >
    > {
        ...
        return {
            data: {
                ok: false,
                error: SeedExhaustive.noAuth.postWithNoAuth.Error._unknown(
                    _response.error,
                ),
                rawResponse: _response.rawResponse,
            },
