...
export class Union {
     ...
     *     })
     */
    public async getAndReturnUnion(request: SeedExhaustive.types.Animal, requestOptions?: Union.RequestOptions): Promise<SeedExhaustive.types.Animal> {
        ...
        if (_response.ok) {
            return serializers.types.Animal.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, breadcrumbsPrefix: ["response"] });
        }
