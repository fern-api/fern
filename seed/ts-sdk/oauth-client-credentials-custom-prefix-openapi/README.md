...
[![npm shield](https://img.shields.io/npm/v/@fern/oauth-client-credentials-custom-prefix-openapi)](https://www.npmjs.com/package/@fern/oauth-client-credentials-custom-prefix-openapi)
...
```sh
npm i -s @fern/oauth-client-credentials-custom-prefix-openapi
```
...
```typescript
import { SeedApiClient } from "@fern/oauth-client-credentials-custom-prefix-openapi";
...
```typescript
import { SeedApi } from "@fern/oauth-client-credentials-custom-prefix-openapi";
...
```typescript
import { SeedApiError } from "@fern/oauth-client-credentials-custom-prefix-openapi";
...
```typescript
import { IdentityClient } from '@fern/oauth-client-credentials-custom-prefix-openapi/identity';
...
```typescript
import { SeedApiClient, logging } from "@fern/oauth-client-credentials-custom-prefix-openapi";
