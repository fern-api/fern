...
export class Dial implements core.xml.XmlSerializable {
    ...
    constructor(fields: Dial.Fields = {}) {
        ...
        this.statusCallbackEvent = fields.statusCallbackEvent;
    ...
    toXml(): string {
        return core.xml.serializeXmlElement({
            ...
            prefix: "tw",
            attributes: [
                { name: "statusCallbackEvent", value: this.statusCallbackEvent, separator: " " },
...
export namespace Dial {
    ...
    export class Builder implements core.xml.XmlBuilder<Dial> {
        ...
        statusCallbackEvent(statusCallbackEvent: string[] | undefined): this {
            this.fields.statusCallbackEvent = statusCallbackEvent;
            return this;
        }

        record(record: SeedApi.DialRecordItem[] | undefined): this {
