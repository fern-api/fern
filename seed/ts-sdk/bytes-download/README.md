...
[![npm shield](https://img.shields.io/npm/v/@fern/bytes-download)](https://www.npmjs.com/package/@fern/bytes-download)
...
```typescript
const response = await client.service.download(...);
