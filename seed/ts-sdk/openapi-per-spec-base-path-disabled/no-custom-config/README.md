...
[![npm shield](https://img.shields.io/npm/v/@fern/openapi-per-spec-base-path-disabled)](https://www.npmjs.com/package/@fern/openapi-per-spec-base-path-disabled)
...
```sh
npm i -s @fern/openapi-per-spec-base-path-disabled
```
...
```typescript
import { SeedApiClient } from "@fern/openapi-per-spec-base-path-disabled";
...
```typescript
import { SeedApi } from "@fern/openapi-per-spec-base-path-disabled";
...
```typescript
import { SeedApiError } from "@fern/openapi-per-spec-base-path-disabled";
...
```typescript
import { OauthClient } from '@fern/openapi-per-spec-base-path-disabled/oauth';
...
```typescript
const { data, rawResponse } = await client.oauth.getToken(...).withRawResponse();
...
```typescript
import { SeedApiClient, logging } from "@fern/openapi-per-spec-base-path-disabled";
