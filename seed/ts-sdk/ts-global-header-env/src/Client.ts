...
export declare namespace SeedTsGlobalHeaderEnvClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class SeedTsGlobalHeaderEnvClient {
    protected readonly _options: NormalizedClientOptions<SeedTsGlobalHeaderEnvClient.Options>;
    protected _service: ServiceClient | undefined;

    constructor(options: SeedTsGlobalHeaderEnvClient.Options) {
