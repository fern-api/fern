    ...
    const headers = mergeHeaders(
        {
            ...
            "X-Fern-SDK-Name": "@fern/ts-global-header-env",
            "X-Fern-SDK-Version": "0.0.1",
            "User-Agent": "@fern/ts-global-header-env/0.0.1",
            "X-Fern-Runtime": core.RUNTIME.type,
            "X-Fern-Runtime-Version": core.RUNTIME.version,
            "X-API-Version": options?.version ?? process.env?.MY_API_VERSION ?? "2024-01-01",
        },
        options?.headers,
    );
