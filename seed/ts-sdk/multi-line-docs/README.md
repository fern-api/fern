...
[![npm shield](https://img.shields.io/npm/v/@fern/multi-line-docs)](https://www.npmjs.com/package/@fern/multi-line-docs)
...
```typescript
import { SeedApiClient } from "@fern/multi-line-docs";
...
```typescript
import { SeedApi } from "@fern/multi-line-docs";
...
```typescript
import { SeedApiError } from "@fern/multi-line-docs";
...
```typescript
import { UserClient } from '@fern/multi-line-docs/user';
...
```typescript
import { SeedApiClient, logging } from "@fern/multi-line-docs";
