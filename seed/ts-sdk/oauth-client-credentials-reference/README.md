...
[![npm shield](https://img.shields.io/npm/v/@fern/oauth-client-credentials-reference)](https://www.npmjs.com/package/@fern/oauth-client-credentials-reference)
...
```sh
npm i -s @fern/oauth-client-credentials-reference
```
...
const client = new SeedOauthClientCredentialsReferenceClient({ baseUrl: "YOUR_BASE_URL", clientId: "YOUR_CLIENT_ID", clientSecret: "YOUR_CLIENT_SECRET" });
...
```typescript
import { AuthClient } from '@fern/oauth-client-credentials-reference/auth';
