...
import * as SeedOauthClientCredentialsReference from "../../../index.js";
...
export class AuthClient {
     ...
     *     })
     */
    public getToken(request: SeedOauthClientCredentialsReference.GetTokenRequest, requestOptions?: AuthClient.RequestOptions): core.HttpResponsePromise<SeedOauthClientCredentialsReference.TokenResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getToken(request, requestOptions));
    }

    private async __getToken(request: SeedOauthClientCredentialsReference.GetTokenRequest, requestOptions?: AuthClient.RequestOptions): Promise<core.WithRawResponse<SeedOauthClientCredentialsReference.TokenResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as SeedOauthClientCredentialsReference.TokenResponse, rawResponse: _response.rawResponse };
        }
