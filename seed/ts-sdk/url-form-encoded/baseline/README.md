...
[![npm shield](https://img.shields.io/npm/v/@fern/url-form-encoded)](https://www.npmjs.com/package/@fern/url-form-encoded)
...
```typescript
import { SeedApiError } from "@fern/url-form-encoded";
...
```typescript
const { data, rawResponse } = await client.submitFormData(...).withRawResponse();
...
```typescript
import { SeedApiClient, logging } from "@fern/url-form-encoded";
