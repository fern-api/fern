...
export class SeedApiClient {
     ...
     *     })
     */
    public submitFormData(request: SeedApi.PostSubmitRequest, requestOptions?: SeedApiClient.RequestOptions): core.HttpResponsePromise<SeedApi.PostSubmitResponse> {
        return core.HttpResponsePromise.fromPromise(this.__submitFormData(request, requestOptions));
    }

    private async __submitFormData(request: SeedApi.PostSubmitRequest, requestOptions?: SeedApiClient.RequestOptions): Promise<core.WithRawResponse<SeedApi.PostSubmitResponse>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "submit"),
            method: "POST",
            headers: _headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout": throw new errors.SeedApiTimeoutError("Timeout exceeded when calling POST /submit.");
