...
export class SeedApiClient {
    ...
    ): core.HttpResponsePromise<PostSubmitResponse> {
    ...
    private async __submitFormData(
        request: PostSubmitRequest,
        requestOptions?: SeedApiClient.RequestOptions,
    ): Promise<core.WithRawResponse<PostSubmitResponse>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SeedApiTimeoutError("Timeout exceeded when calling POST /submit.");
            case "unknown":
                throw new errors.SeedApiError({
