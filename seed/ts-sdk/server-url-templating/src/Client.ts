...
export class SeedApiClient {
    ...
    private async __getUsers(requestOptions?: SeedApiClient.RequestOptions): Promise<core.WithRawResponse<SeedApi.User[]>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? (await core.Supplier.get(this._options.environment) ?? environments.SeedApiEnvironment.RegionalApiServer).base, "users"),
            method: "GET",
            headers: _headers,
     ...
     *     })
     */
    public getUser(request: SeedApi.GetUserRequest, requestOptions?: SeedApiClient.RequestOptions): core.HttpResponsePromise<SeedApi.User> {
        return core.HttpResponsePromise.fromPromise(this.__getUser(request, requestOptions));
    }

    private async __getUser(request: SeedApi.GetUserRequest, requestOptions?: SeedApiClient.RequestOptions): Promise<core.WithRawResponse<SeedApi.User>> {
        const { userId } = request;
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? (await core.Supplier.get(this._options.environment) ?? environments.SeedApiEnvironment.RegionalApiServer).base, `users/${core.url.encodePathParam(userId)}`),
            method: "GET",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
     ...
     *     })
     */
    public getToken(request: SeedApi.TokenRequest, requestOptions?: SeedApiClient.RequestOptions): core.HttpResponsePromise<SeedApi.TokenResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getToken(request, requestOptions));
    }

    private async __getToken(request: SeedApi.TokenRequest, requestOptions?: SeedApiClient.RequestOptions): Promise<core.WithRawResponse<SeedApi.TokenResponse>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? (await core.Supplier.get(this._options.environment) ?? environments.SeedApiEnvironment.RegionalApiServer).auth, "auth/token"),
            method: "POST",
            headers: _headers,
    ...
    public async fetch(input: Request | string | URL, init?: RequestInit, requestOptions?: core.PassthroughRequest.RequestOptions): Promise<Response> {
        ...
        return core.makePassthroughRequest(input, init, {
            baseUrl: this._options.baseUrl ?? (async () => {
                ...
                return typeof env === "string" ? env : (env as Record<string, string>)?.base ?? environments.SeedApiEnvironment.RegionalApiServer.base;
            }),
