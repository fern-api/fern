...
[![npm shield](https://img.shields.io/npm/v/@fern/server-url-templating)](https://www.npmjs.com/package/@fern/server-url-templating)
...
```sh
npm i -s @fern/server-url-templating
```
...
```typescript
import { SeedApi } from "@fern/server-url-templating";
...
```typescript
import { SeedApiError } from "@fern/server-url-templating";
...
```typescript
import { SeedApiClient, logging } from "@fern/server-url-templating";
