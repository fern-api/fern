...
impl server_url_templating_api_single_base_url_sdk::RequestExecutor for CliExecutorAdapter {
    fn execute(
        &self,
...
pub fn client(ctx: &AppContext) -> server_url_templating_api_single_base_url_sdk::api::ApiClient {
    ...
    server_url_templating_api_single_base_url_sdk::api::ApiClient {
        config,
...
where
    F: Future<Output = Result<T, server_url_templating_api_single_base_url_sdk::ApiError>>,
{
...
fn convert_api_error(e: server_url_templating_api_single_base_url_sdk::ApiError) -> CliError {
    match e {
        server_url_templating_api_single_base_url_sdk::ApiError::Http { status, message } => CliError::Api {
            code: status,
            message,
            reason: http_status_reason(status).to_string(),
        },
        server_url_templating_api_single_base_url_sdk::ApiError::Network(err) => {
            CliError::Other(anyhow::anyhow!("SDK network error: {err}"))
        }
        server_url_templating_api_single_base_url_sdk::ApiError::Executor(boxed) => match boxed.downcast::<SdkError>() {
