# Webhooks CLI CLI Reference

Full command reference for `webhooks-cli`.

## Commands

- [`webhooks-cli messages`](#webhooks-cli-messages)
- [`webhooks-cli webhooks`](#webhooks-cli-webhooks)

---

### `webhooks-cli messages`

#### `webhooks-cli messages list`
...
#### `webhooks-cli webhooks call-status`
...
|------|------|----------|-------------|
| `--call-sid` | `string` | Yes |  |
| `--call-status` | `ringing | in-progress | completed` | Yes |  |

#### `webhooks-cli webhooks message-received`
