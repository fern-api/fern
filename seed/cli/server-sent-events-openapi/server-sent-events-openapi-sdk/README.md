...
[![crates.io shield](https://img.shields.io/crates/v/server_sent_events_openapi_sdk)](https://crates.io/crates/server_sent_events_openapi_sdk)
...
```toml
[dependencies]
server_sent_events_openapi_sdk = "0.1.0"
```

Or install via cargo:

```sh
cargo add server_sent_events_openapi_sdk
```
