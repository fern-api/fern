...
The `super::sdk::client(ctx)` call returns a `discriminated_union_with_nested_oneof_sdk::api::Client`
...
|------|-------------|-------|
| `cli/discriminated-union-with-nested-oneof/custom.rs` | **No** | Protected by `.fernignore` |
| `cli/discriminated-union-with-nested-oneof/sdk.rs` | Yes | Bridges AppContext → SDK client |
| `cli/discriminated-union-with-nested-oneof/main.rs` | Yes | Calls `custom::register(app)` |
| `discriminated-union-with-nested-oneof-sdk/` | Yes | Co-generated typed SDK crate |
| `discriminated-union-with-nested-oneof-types/` | Yes | Co-generated typed models |
...
discriminated-union-with-nested-oneof <your-command> [args]

# Run with verbose output for debugging
RUST_LOG=debug discriminated-union-with-nested-oneof <your-command> [args]
```
