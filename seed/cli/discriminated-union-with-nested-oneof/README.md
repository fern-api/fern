...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-CLI%20generated%20by%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=Discriminated%20Union%20with%20Nested%20OneOf%2FCLI)
...
discriminated-union-with-nested-oneof <resource> <method> --human | less

# Machine-readable catalog of every operation (same as --schema)
discriminated-union-with-nested-oneof --help --format json | jq '.operations | length'
```
