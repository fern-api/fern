...
```bash
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/query-parameters-openapi/fern/releases/latest/download/query-params-cli-installer.sh | sh
```

### PowerShell (Windows)

```powershell
powershell -ExecutionPolicy ByPass -c "irm https://github.com/query-parameters-openapi/fern/releases/latest/download/query-params-cli-installer.ps1 | iex"
```
