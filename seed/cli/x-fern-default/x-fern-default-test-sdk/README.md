...
[![crates.io shield](https://img.shields.io/crates/v/x_fern_default_test_sdk)](https://crates.io/crates/x_fern_default_test_sdk)
...
```toml
[dependencies]
x_fern_default_test_sdk = "0.1.0"
```

Or install via cargo:

```sh
cargo add x_fern_default_test_sdk
```
...
```rust
match client.test_get(None)?.await {
    Ok(response) => {
