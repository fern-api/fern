...
The `schemaless-request-body-examples-api` CLI supports user-authored custom commands compiled
...
```bash
cargo build
schemaless-request-body-examples-api hello world              # top-level custom command
schemaless-request-body-examples-api admin users list --limit 5  # nested under custom namespace
schemaless-request-body-examples-api fetch my-id --format json   # output cohesion
schemaless-request-body-examples-api fetch my-id --dry-run       # dry-run preview
```
