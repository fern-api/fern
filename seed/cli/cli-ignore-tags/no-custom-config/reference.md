...
#### `acme knowledge create-knowledge`

Create a knowledge resource

`POST /v1/Knowledge`

#### `acme knowledge fetch-knowledge-base`
...
#### `acme knowledge list-knowledge-bases`
...
#### `acme messages messages create-message`
...
#### `acme messages messages list-message`
