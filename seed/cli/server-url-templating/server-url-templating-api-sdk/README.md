...
[![crates.io shield](https://img.shields.io/crates/v/server_url_templating_api_sdk)](https://crates.io/crates/server_url_templating_api_sdk)
...
```toml
[dependencies]
server_url_templating_api_sdk = "0.1.0"
```

Or install via cargo:

```sh
cargo add server_url_templating_api_sdk
```
...
```rust
match client.get_token(None)?.await {
    Ok(response) => {
