...
pub fn sdk_client(ctx: &AppContext) -> server_url_templating_api_sdk::api::ApiClient {
    ...
    server_url_templating_api_sdk::api::ApiClient {
        config,
        http_client: server_url_templating_api_sdk::api::HttpClient { http_client: http_client.clone() },
    }
}
