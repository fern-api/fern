...
[![crates.io shield](https://img.shields.io/crates/v/allof_composition_sdk)](https://crates.io/crates/allof_composition_sdk)
...
```toml
[dependencies]
allof_composition_sdk = "0.1.0"
```

Or install via cargo:

```sh
cargo add allof_composition_sdk
```
...
```rust
match client.create_rule(None)?.await {
    Ok(response) => {
