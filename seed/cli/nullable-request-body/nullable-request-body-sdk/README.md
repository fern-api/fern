...
[![crates.io shield](https://img.shields.io/crates/v/nullable_request_body_sdk)](https://crates.io/crates/nullable_request_body_sdk)
...
```toml
[dependencies]
nullable_request_body_sdk = "0.1.0"
```

Or install via cargo:

```sh
cargo add nullable_request_body_sdk
```
