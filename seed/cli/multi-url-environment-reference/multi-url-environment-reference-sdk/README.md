...
[![crates.io shield](https://img.shields.io/crates/v/multi_url_environment_reference_sdk)](https://crates.io/crates/multi_url_environment_reference_sdk)
...
```toml
[dependencies]
multi_url_environment_reference_sdk = "0.1.0"
```

Or install via cargo:

```sh
cargo add multi_url_environment_reference_sdk
```
