...
[![crates.io shield](https://img.shields.io/crates/v/plant_store_api_sdk)](https://crates.io/crates/plant_store_api_sdk)
...
```toml
[dependencies]
plant_store_api_sdk = "0.1.0"
```

Or install via cargo:

```sh
cargo add plant_store_api_sdk
```
