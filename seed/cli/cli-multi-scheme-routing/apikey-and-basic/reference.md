# Multi Scheme Routing CLI CLI Reference

Full command reference for `multi-scheme-cli`.

## Commands

- [`multi-scheme-cli admin`](#multi-scheme-cli-admin)
- [`multi-scheme-cli system`](#multi-scheme-cli-system)
- [`multi-scheme-cli widgets`](#multi-scheme-cli-widgets)

---

### `multi-scheme-cli admin`

#### `multi-scheme-cli admin list-users`
...
### `multi-scheme-cli system`

#### `multi-scheme-cli system health`
...
### `multi-scheme-cli widgets`

#### `multi-scheme-cli widgets list`
