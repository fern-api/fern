...
[![crates.io shield](https://img.shields.io/crates/v/inline_enum_type_name_override_sdk)](https://crates.io/crates/inline_enum_type_name_override_sdk)
...
```toml
[dependencies]
inline_enum_type_name_override_sdk = "0.1.0"
```

Or install via cargo:

```sh
cargo add inline_enum_type_name_override_sdk
```
