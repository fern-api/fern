...
[![crates.io shield](https://img.shields.io/crates/v/api_wide_base_path_with_default_sdk)](https://crates.io/crates/api_wide_base_path_with_default_sdk)
...
```toml
[dependencies]
api_wide_base_path_with_default_sdk = "0.1.0"
```

Or install via cargo:

```sh
cargo add api_wide_base_path_with_default_sdk
```
