...
|----------|-------------|
| `API_WIDE_BASE_PATH_WITH_DEFAULT_BASE_URL` | Override the API base URL |
| `API_WIDE_BASE_PATH_WITH_DEFAULT_CA_BUNDLE` | Path to PEM file with extra trust roots (or `SSL_CERT_FILE`) |
| `API_WIDE_BASE_PATH_WITH_DEFAULT_INSECURE=1` | Skip TLS verification (debugging only) |
| `API_WIDE_BASE_PATH_WITH_DEFAULT_PROXY` | HTTP(S) proxy URL |
| `API_WIDE_BASE_PATH_WITH_DEFAULT_TIMEOUT_SECS` | Total request timeout in seconds |
