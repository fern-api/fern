...
[![crates.io shield](https://img.shields.io/crates/v/acme_versioned_sdk)](https://crates.io/crates/acme_versioned_sdk)
...
```toml
[dependencies]
acme_versioned_sdk = "0.1.0"
```

Or install via cargo:

```sh
cargo add acme_versioned_sdk
```
