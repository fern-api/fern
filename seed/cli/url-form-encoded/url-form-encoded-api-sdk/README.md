...
[![crates.io shield](https://img.shields.io/crates/v/url_form_encoded_api_sdk)](https://crates.io/crates/url_form_encoded_api_sdk)
...
```toml
[dependencies]
url_form_encoded_api_sdk = "0.1.0"
```

Or install via cargo:

```sh
cargo add url_form_encoded_api_sdk
```
