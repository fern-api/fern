...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-CLI%20generated%20by%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=URL%20Form%20Encoded%20API%2FCLI)
...
url-form-encoded-api <resource> <method> --human | less

# Machine-readable catalog of every operation (same as --schema)
url-form-encoded-api --help --format json | jq '.operations | length'
```
