# Any Auth CLI CLI Reference

Full command reference for `any-auth-cli`.

## Commands

- [`any-auth-cli auth`](#any-auth-cli-auth)
- [`any-auth-cli system`](#any-auth-cli-system)
- [`any-auth-cli widgets`](#any-auth-cli-widgets)

---

### `any-auth-cli auth`

#### `any-auth-cli auth get-token`
...
### `any-auth-cli widgets`

#### `any-auth-cli widgets list`
