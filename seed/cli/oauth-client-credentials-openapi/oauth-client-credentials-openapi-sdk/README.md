...
[![crates.io shield](https://img.shields.io/crates/v/oauth_client_credentials_openapi_sdk)](https://crates.io/crates/oauth_client_credentials_openapi_sdk)
...
```toml
[dependencies]
oauth_client_credentials_openapi_sdk = "0.1.0"
```

Or install via cargo:

```sh
cargo add oauth_client_credentials_openapi_sdk
```
