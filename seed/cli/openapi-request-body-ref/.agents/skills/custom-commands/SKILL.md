...
The `openapi-request-body-ref` CLI supports user-authored custom commands compiled
...
| Field | Type |
|-------|------|
| `client.vendor` | `openapi_request_body_ref_sdk::api::VendorClient` |
| `client.catalog` | `openapi_request_body_ref_sdk::api::CatalogClient` |
| `client.team_member` | `openapi_request_body_ref_sdk::api::TeamMemberClient` |
...
```bash
cargo build
openapi-request-body-ref hello world              # top-level custom command
openapi-request-body-ref admin users list --limit 5  # nested under custom namespace
openapi-request-body-ref fetch my-id --format json   # output cohesion
openapi-request-body-ref fetch my-id --dry-run       # dry-run preview
```
