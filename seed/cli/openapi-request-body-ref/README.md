...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-CLI%20generated%20by%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=openapi-request-body-ref%2FCLI)
...
openapi-request-body-ref <resource> <method> --human | less

# Machine-readable catalog of every operation (same as --schema)
openapi-request-body-ref --help --format json | jq '.operations | length'
```
