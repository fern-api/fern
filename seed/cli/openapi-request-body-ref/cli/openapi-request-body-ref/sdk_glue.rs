...
impl openapi_request_body_ref_sdk::RequestExecutor for CliExecutorAdapter {
    fn execute(
        &self,
...
pub fn sdk_client(ctx: &AppContext) -> openapi_request_body_ref_sdk::api::ApiClient {
...
where
    F: Future<Output = Result<T, openapi_request_body_ref_sdk::ApiError>>,
{
...
fn convert_api_error(e: openapi_request_body_ref_sdk::ApiError) -> CliError {
    match e {
        ...
        openapi_request_body_ref_sdk::ApiError::Executor(boxed) => match boxed.downcast::<SdkError>() {
