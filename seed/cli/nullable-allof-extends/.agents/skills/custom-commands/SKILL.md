...
The `nullable-allof-extends-test` CLI supports user-authored custom commands compiled
...
```bash
cargo build
nullable-allof-extends-test hello world              # top-level custom command
nullable-allof-extends-test admin users list --limit 5  # nested under custom namespace
nullable-allof-extends-test fetch my-id --format json   # output cohesion
nullable-allof-extends-test fetch my-id --dry-run       # dry-run preview
```
