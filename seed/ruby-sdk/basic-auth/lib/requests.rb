...
module SeedBasicAuthClient
  class RequestClient
    ...
    def initialize(environment: nil, max_retries: nil, timeout_in_seconds: nil, username: nil, password: nil)
  ...
  class RequestOptions
    ...
    def initialize(max_retries: nil, timeout_in_seconds: nil, username: nil, password: nil, additional_headers: nil,
