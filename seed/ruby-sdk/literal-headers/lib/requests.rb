...
module SeedLiteralHeadersClient
  ...
  class RequestOptions
    attr_reader :api_header, :api_test, :additional_headers, :additional_query_parameters, :additional_body_parameters,
                :timeout_in_seconds
    ...
    def initialize(api_header: nil, api_test: nil, additional_headers: nil, additional_query_parameters: nil,
