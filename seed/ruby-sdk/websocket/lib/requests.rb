...
module SeedWebsocketClient
  class RequestClient
    ...
    # @return [SeedWebsocketClient::RequestClient]
    def initialize(base_url: nil, max_retries: nil, timeout_in_seconds: nil)
      @base_url = base_url
      @headers = { "X-Fern-Language": "Ruby", "X-Fern-SDK-Name": "fern_websocket", "X-Fern-SDK-Version": "0.0.1" }
    ...
    # @param request_options [SeedWebsocketClient::RequestOptions]
    # @return [String]
  ...
  class AsyncRequestClient
    ...
    # @param max_retries [Long] The number of times to retry a failed request, defaults to 2.
    # @param timeout_in_seconds [Long]
    # @return [SeedWebsocketClient::AsyncRequestClient]
    def initialize(base_url: nil, max_retries: nil, timeout_in_seconds: nil)
      @base_url = base_url
      @headers = { "X-Fern-Language": "Ruby", "X-Fern-SDK-Name": "fern_websocket", "X-Fern-SDK-Version": "0.0.1" }
      @conn = Faraday.new(headers: @headers) do |faraday|
