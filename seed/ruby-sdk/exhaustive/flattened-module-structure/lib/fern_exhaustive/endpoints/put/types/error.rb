...
module SeedExhaustiveClient
  module Endpoints
    module Put
      module Types
        class Error
          # @return [SeedExhaustiveClient::Endpoints::Put::Types::ErrorCategory]
          attr_reader :category
          # @return [SeedExhaustiveClient::Endpoints::Put::Types::ErrorCode]
          attr_reader :code
          # @return [String]
          attr_reader :detail
          # @return [String]
          ...
          # @param category [SeedExhaustiveClient::Endpoints::Put::Types::ErrorCategory]
          # @param code [SeedExhaustiveClient::Endpoints::Put::Types::ErrorCode]
          # @param detail [String]
          # @param field [String]
          # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
          # @return [SeedExhaustiveClient::Endpoints::Put::Types::Error]
          ...
          def self.validate_raw(obj:)
            obj.category.is_a?(SeedExhaustiveClient::Endpoints::Put::Types::ErrorCategory) != false || raise("Passed value for field obj.category is not the expected type, validation failed.")
            obj.code.is_a?(SeedExhaustiveClient::Endpoints::Put::Types::ErrorCode) != false || raise("Passed value for field obj.code is not the expected type, validation failed.")
