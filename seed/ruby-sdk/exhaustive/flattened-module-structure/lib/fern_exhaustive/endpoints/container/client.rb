...
module SeedExhaustiveClient
  module Endpoints
    class ContainerClient
      ...
      # @param request [Array<Hash>] Request of type Array<SeedExhaustiveClient::Types::Object_::Types::ObjectWithRequiredField>, as a Hash
      #   * :string (String)
      # @param request_options [SeedExhaustiveClient::RequestOptions]
      ...
      def get_and_return_list_of_objects(request:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
        ...
        parsed_json&.map do |item|
          item = item.to_json
          SeedExhaustiveClient::Types::Object_::Types::ObjectWithRequiredField.from_json(json_object: item)
        end
      end
      ...
      # @param request [Set<SeedExhaustiveClient::Types::Object_::Types::ObjectWithRequiredField>]
      # @param request_options [SeedExhaustiveClient::RequestOptions]
      # @return [Set<SeedExhaustiveClient::Types::Object_::Types::ObjectWithRequiredField>]
      # @example
      #  exhaustive = SeedExhaustiveClient::Client.new(base_url: "https://api.example.com", token: "YOUR_AUTH_TOKEN")
      ...
      # @param request [Hash{String => SeedExhaustiveClient::Types::Object_::Types::ObjectWithRequiredField}]
      # @param request_options [SeedExhaustiveClient::RequestOptions]
      # @return [Hash{String => SeedExhaustiveClient::Types::Object_::Types::ObjectWithRequiredField}]
      # @example
      #  exhaustive = SeedExhaustiveClient::Client.new(base_url: "https://api.example.com", token: "YOUR_AUTH_TOKEN")
      ...
      def get_and_return_map_of_prim_to_object(request:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
        ...
        parsed_json&.transform_values do |value|
          value = value.to_json
          SeedExhaustiveClient::Types::Object_::Types::ObjectWithRequiredField.from_json(json_object: value)
        end
      end
