...
module SeedIdempotencyHeadersClient
  ...
  unless timeout_in_seconds.nil?
    ...
    def get_headers
      headers = { "X-Fern-Language": 'Ruby', "X-Fern-SDK-Name": 'fern_idempotency_headers', "X-Fern-SDK-Version": '0.0.1' }
...
#  SDK.
  ...
  # @return [Integer] 
    ...
    def initialize(base_url: nil, token: nil, additional_headers: nil, additional_query_parameters: nil, additional_body_parameters: nil, timeout_in_seconds: nil, idempotency_key: nil, idempotency_expiration: nil)
      @base_url = base_url
      @token = token
      @additional_headers = additional_headers
      @additional_query_parameters = additional_query_parameters
