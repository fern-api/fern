...
module SeedApiWideBasePathClient
  class Client
    ...
    def initialize(base_url: nil, max_retries: nil, timeout_in_seconds: nil)
      @request_client = SeedApiWideBasePathClient::RequestClient.new(base_url: base_url, max_retries: max_retries,
  ...
  class AsyncClient
    ...
    def initialize(base_url: nil, max_retries: nil, timeout_in_seconds: nil)
      @async_request_client = SeedApiWideBasePathClient::AsyncRequestClient.new(base_url: base_url,
