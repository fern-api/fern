...
module SeedNoEnvironmentClient
  ...
  # @return [String] 
    ...
    def initialize(base_url: nil, max_retries: nil, timeout_in_seconds: nil, token:)
      @base_url = base_url
...
#  SDK.
  ...
  # @return [Long] 
    ...
    # @param timeout_in_seconds [Long] 
    # @return [SeedNoEnvironmentClient::RequestOptions]
...
#  SDK.
  ...
  # @return [Long] 
    ...
    # @param additional_body_parameters [Hash{String => Object}] 
    # @param timeout_in_seconds [Long] 
    # @return [SeedNoEnvironmentClient::IdempotencyRequestOptions]
    def initialize(base_url: nil, token: nil, additional_headers: nil, additional_query_parameters: nil, additional_body_parameters: nil, timeout_in_seconds: nil)
      @base_url = base_url
      @token = token
      @additional_headers = additional_headers
