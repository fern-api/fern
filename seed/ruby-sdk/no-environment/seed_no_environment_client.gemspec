...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "async-http-faraday", ">= 0.0", "< 0.13"
  spec.add_dependency "faraday", ">= 1.0", "<= 2.9"
  spec.add_dependency "faraday-net_http", ">= 1.0", "< 3.2"
  spec.add_dependency "faraday-retry", ">= 1.0", "< 2.3"
end
