...
module SeedApiClient
  class Practitioner
    ...
    def initialize(resource_type:, name:, id:, related_resources:, memo:, additional_properties: nil)
    ...
    # Deserialize a JSON object to an instance of Practitioner
    #
    ...
    # Serialize an instance of Practitioner to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
