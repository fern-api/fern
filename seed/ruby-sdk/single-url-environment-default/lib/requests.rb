...
module SeedSingleUrlEnvironmentDefaultClient
  ...
  # @return [String] 
    ...
    def initialize(base_url: nil, environment: SeedSingleUrlEnvironmentDefaultClient::Environment::PRODUCTION, max_retries: nil, timeout_in_seconds: nil, token:)
  ...
  unless timeout_in_seconds.nil?
    ...
    def get_headers
      headers = { "X-Fern-Language": 'Ruby', "X-Fern-SDK-Name": 'fern_single_url_environment_default', "X-Fern-SDK-Version": '0.0.1' }
