...
module SeedSingleUrlEnvironmentDefaultClient
  class Client
    ...
    def initialize(token:, environment: Environment::PRODUCTION, base_url: nil, max_retries: nil,
      ...
      @request_client = SeedSingleUrlEnvironmentDefaultClient::RequestClient.new(environment: environment,
  ...
  class AsyncClient
    ...
    def initialize(token:, environment: Environment::PRODUCTION, base_url: nil, max_retries: nil,
                   timeout_in_seconds: nil)
      @async_request_client = SeedSingleUrlEnvironmentDefaultClient::AsyncRequestClient.new(environment: environment,
                                                                                            base_url: base_url, max_retries: max_retries, timeout_in_seconds: timeout_in_seconds, token: token)
