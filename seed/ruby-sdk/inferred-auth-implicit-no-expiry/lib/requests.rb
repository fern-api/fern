...
module SeedInferredAuthImplicitNoExpiryClient
    ...
    def get_headers
      {
        ...
        "X-Fern-SDK-Name": "fern_inferred_auth_implicit_no_expiry",
  ...
  class RequestOptions
    ...
    # @param timeout_in_seconds [Long]
    # @return [SeedInferredAuthImplicitNoExpiryClient::RequestOptions]
  ...
  class IdempotencyRequestOptions
    ...
    # @param additional_body_parameters [Hash{String => Object}]
    # @param timeout_in_seconds [Long]
    # @return [SeedInferredAuthImplicitNoExpiryClient::IdempotencyRequestOptions]
    def initialize(base_url: nil, additional_headers: nil, additional_query_parameters: nil,
                   additional_body_parameters: nil, timeout_in_seconds: nil)
      @base_url = base_url
      @additional_headers = additional_headers
