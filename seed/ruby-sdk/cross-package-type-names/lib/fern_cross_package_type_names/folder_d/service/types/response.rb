...
module SeedCrossPackageTypeNamesClient
  module FolderD
    class Service
      class Response
        # @return [SeedCrossPackageTypeNamesClient::FolderB::Common::Foo]
        attr_reader :foo
        ...
        # @param foo [SeedCrossPackageTypeNamesClient::FolderB::Common::Foo]
        ...
        def self.from_json(json_object:)
          ...
          if parsed_json["foo"].nil?
            ...
            foo = SeedCrossPackageTypeNamesClient::FolderB::Common::Foo.from_json(json_object: foo)
          end
        ...
        def self.validate_raw(obj:)
          obj.foo.nil? || SeedCrossPackageTypeNamesClient::FolderB::Common::Foo.validate_raw(obj: obj.foo)
        end
      end
    end
  end
