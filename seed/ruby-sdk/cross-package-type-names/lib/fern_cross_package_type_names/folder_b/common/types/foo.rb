  ...
  module FolderB
    class Common
      class Foo
        ...
        # @param foo [SeedCrossPackageTypeNamesClient::FolderC::Common::Foo]
        ...
        def self.from_json(json_object:)
          ...
          if parsed_json["foo"].nil?
            ...
            foo = SeedCrossPackageTypeNamesClient::FolderC::Common::Foo.from_json(json_object: foo)
          end
        ...
        def self.validate_raw(obj:)
          obj.foo.nil? || SeedCrossPackageTypeNamesClient::FolderC::Common::Foo.validate_raw(obj: obj.foo)
        end
      end
    end
  end
