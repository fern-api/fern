...
module SeedCrossPackageTypeNamesClient
  module FolderA
    class ServiceClient
      ...
      # @return [SeedCrossPackageTypeNamesClient::FolderA::Service::Response]
      # @example
      #  cross_package_type_names = SeedCrossPackageTypeNamesClient::Client.new(base_url: "https://api.example.com")
      #  cross_package_type_names.folder_a.service.get_direct_thread
      def get_direct_thread(request_options: nil)
        ...
        **(request_options&.additional_headers || {})
        ...
        SeedCrossPackageTypeNamesClient::FolderA::Service::Response.from_json(json_object: response.body)
      end
    end
