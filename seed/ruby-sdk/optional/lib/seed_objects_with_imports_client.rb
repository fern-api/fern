...
module SeedObjectsWithImportsClient
  class Client
    ...
    def initialize(max_retries: nil, timeout_in_seconds: nil)
      ...
      @optional_client = OptionalClient.initialize(request_client: request_client)
    end
  end
  ...
  class AsyncClient
    ...
    def initialize(max_retries: nil, timeout_in_seconds: nil)
      ...
      @async_optional_client = AsyncOptionalClient.initialize(request_client: request_client)
    end
  end
end
