...
module SeedOauthClientCredentialsWithVariablesClient
  class AccessToken
    ...
    # @return [SeedOauthClientCredentialsWithVariablesClient::AccessToken]
  ...
  class OauthTokenProvider
    ...
    # @return [SeedOauthClientCredentialsWithVariablesClient::OauthTokenProvider]
    def initialize(client_id:, client_secret:, request_client:)
      @client_id = client_id
      @client_secret = client_secret
      @auth_client = SeedOauthClientCredentialsWithVariablesClient::AuthClient.new(request_client: request_client)
    end
    ...
    def refresh_token
      token_response = @auth_client.get_token_with_client_credentials(client_id: @client_id,
                                                                      client_secret: @client_secret)
      SeedOauthClientCredentialsWithVariablesClient::AccessToken.new(access_token: token_response.access_token,
