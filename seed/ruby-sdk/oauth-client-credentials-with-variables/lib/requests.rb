...
module SeedOauthClientCredentialsWithVariablesClient
  class RequestClient
    ...
    def get_headers
      headers = {
        ...
        "X-Fern-SDK-Name": "fern_oauth_client_credentials_with_variables",
  ...
  class RequestOptions
    ...
    # @param timeout_in_seconds [Long]
    # @return [SeedOauthClientCredentialsWithVariablesClient::RequestOptions]
  ...
  class IdempotencyRequestOptions
    ...
    # @param additional_body_parameters [Hash{String => Object}]
    # @param timeout_in_seconds [Long]
    # @return [SeedOauthClientCredentialsWithVariablesClient::IdempotencyRequestOptions]
    def initialize(base_url: nil, token: nil, additional_headers: nil, additional_query_parameters: nil,
                   additional_body_parameters: nil, timeout_in_seconds: nil)
      @base_url = base_url
      @token = token
