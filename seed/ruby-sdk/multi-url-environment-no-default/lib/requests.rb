...
module SeedMultiUrlEnvironmentNoDefaultClient
  ...
  # @return [String] 
    ...
    def initialize(base_url: nil, environment: nil, max_retries: nil, timeout_in_seconds: nil, token:)
  ...
  unless timeout_in_seconds.nil?
    ...
    def get_headers
      headers = { "X-Fern-Language": 'Ruby', "X-Fern-SDK-Name": 'fern_multi_url_environment_no_default', "X-Fern-SDK-Version": '0.0.1' }
...
#  SDK.
  ...
  # @return [Long] 
    ...
    # @param timeout_in_seconds [Long] 
    # @return [SeedMultiUrlEnvironmentNoDefaultClient::RequestOptions]
...
#  SDK.
  ...
  # @return [Long] 
    ...
    # @param additional_body_parameters [Hash{String => Object}] 
    # @param timeout_in_seconds [Long] 
    # @return [SeedMultiUrlEnvironmentNoDefaultClient::IdempotencyRequestOptions]
    def initialize(base_url: nil, token: nil, additional_headers: nil, additional_query_parameters: nil, additional_body_parameters: nil, timeout_in_seconds: nil)
      @base_url = base_url
      @token = token
      @additional_headers = additional_headers
