  ...
  class OrganizationsClient
    ...
    def get_organization(tenant_id:, organization_id:, request_options: nil)
      ...
      **(request_options&.additional_headers || {})
        ...
        req.url "#{@request_client.get_url(request_options: request_options)}/#{tenant_id}/user/organizations"
      end
    ...
    def get_organization_user(tenant_id:, organization_id:, user_id:, request_options: nil)
      ...
      **(request_options&.additional_headers || {})
        ...
        req.url "#{@request_client.get_url(request_options: request_options)}/#{tenant_id}/user/organizations/#{user_id}/users"
      end
      SeedPathParametersClient::Organizations::User.from_json(json_object: response.body)
    end
