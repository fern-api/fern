  ...
  class UserClient
    ...
    def get_user(tenant_id:, user_id:, request_options: nil)
      ...
      **(request_options&.additional_headers || {})
        ...
        req.url "#{@request_client.get_url(request_options: request_options)}/#{tenant_id}/user/users/#{user_id}"
      end
    ...
    def search_users(tenant_id:, user_id:, limit: nil, request_options: nil)
      ...
      **(request_options&.additional_headers || {})
        ...
        req.url "#{@request_client.get_url(request_options: request_options)}/#{tenant_id}/user/users/#{user_id}/search"
      end
