...
module SeedMultiUrlEnvironmentClient
  ...
  # @return [String] 
    ...
    def initialize(base_url: nil, environment: SeedMultiUrlEnvironmentClient::Environment::PRODUCTION, max_retries: nil, timeout_in_seconds: nil, token:)
  ...
  unless timeout_in_seconds.nil?
    ...
    def get_headers
      headers = { "X-Fern-Language": 'Ruby', "X-Fern-SDK-Name": 'fern_multi_url_environment', "X-Fern-SDK-Version": '0.0.1' }
