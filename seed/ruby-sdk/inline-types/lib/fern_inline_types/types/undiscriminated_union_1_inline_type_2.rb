...
module SeedObjectClient
  # lorem ipsum
  class UndiscriminatedUnion1InlineType2
    ...
    # @return [SeedObjectClient::UndiscriminatedUnion1InlineType2]
    ...
    # Deserialize a JSON object to an instance of UndiscriminatedUnion1InlineType2
    #
    ...
    # Serialize an instance of UndiscriminatedUnion1InlineType2 to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
