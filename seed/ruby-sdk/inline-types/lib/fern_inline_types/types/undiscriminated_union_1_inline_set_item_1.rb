...
module SeedObjectClient
  # lorem ipsum
  class UndiscriminatedUnion1InlineSetItem1
    ...
    # @return [SeedObjectClient::UndiscriminatedUnion1InlineSetItem1]
    ...
    # Deserialize a JSON object to an instance of UndiscriminatedUnion1InlineSetItem1
    #
    ...
    # Serialize an instance of UndiscriminatedUnion1InlineSetItem1 to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
