...
module SeedObjectClient
  # lorem ipsum
  class DiscriminatedUnion1InlineType1InlineType1
    ...
    # @return [SeedObjectClient::DiscriminatedUnion1InlineType1InlineType1]
    ...
    # Serialize an instance of DiscriminatedUnion1InlineType1InlineType1 to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
