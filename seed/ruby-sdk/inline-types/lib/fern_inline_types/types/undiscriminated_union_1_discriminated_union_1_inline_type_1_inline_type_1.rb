...
module SeedObjectClient
  # lorem ipsum
  class UndiscriminatedUnion1DiscriminatedUnion1InlineType1InlineType1
    ...
    # @return [SeedObjectClient::UndiscriminatedUnion1DiscriminatedUnion1InlineType1InlineType1]
    ...
    #  UndiscriminatedUnion1DiscriminatedUnion1InlineType1InlineType1 to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
