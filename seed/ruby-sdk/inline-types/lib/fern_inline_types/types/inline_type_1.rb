...
require_relative "nested_inline_type_1"
require "ostruct"
require "json"
...
module SeedObjectClient
  class InlineType1
    ...
    # @param foo [String]
    # @param bar [SeedObjectClient::NestedInlineType1]
    ...
    # Deserialize a JSON object to an instance of InlineType1
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["bar"].nil?
        ...
        bar = SeedObjectClient::NestedInlineType1.from_json(json_object: bar)
      end
      new(
        foo: foo,
        bar: bar,
    ...
    # Serialize an instance of InlineType1 to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      SeedObjectClient::NestedInlineType1.validate_raw(obj: obj.bar)
    end
  end
end
