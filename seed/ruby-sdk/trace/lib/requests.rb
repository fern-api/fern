...
module SeedTraceClient
  ...
  # @return [String] 
    ...
    def initialize(base_url: nil, environment: SeedTraceClient::Environment::PROD, max_retries: nil, timeout_in_seconds: nil, token:, x_random_header: nil)
      @default_environment = environment
      @base_url = environment || base_url
      "Authorization" = "Bearer #{@token}"
      @headers = {  }
      unless x_random_header.nil?
        @headers["X-Random-Header"] = x_random_header
      end
...
#  SDK.
  ...
  # @return [Long] 
    ...
    def initialize(base_url: nil, token: nil, x_random_header: nil, additional_headers: nil, additional_query_parameters: nil, additional_body_parameters: nil, timeout_in_seconds: nil)
      @base_url = base_url
      @token = token
