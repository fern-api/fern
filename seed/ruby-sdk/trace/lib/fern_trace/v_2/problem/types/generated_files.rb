  ...
  module V2
    class Problem
      class GeneratedFiles
        ...
        # @param generated_test_case_files [Hash{Language => V2::Files}]
        # @param generated_template_files [Hash{Language => V2::Files}]
        # @param other [Hash{Language => V2::Files}]
        # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
        # @return [V2::GeneratedFiles]
