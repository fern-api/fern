      ...
      class DefaultProvidedFile
        ...
        def self.from_json(json_object:)
          ...
          if parsed_json["file"].nil?
            ...
            file = V2::FileInfoV2.from_json(json_object: file)
          end
        ...
        def self.validate_raw(obj:)
          V2::FileInfoV2.validate_raw(obj: obj.file)
