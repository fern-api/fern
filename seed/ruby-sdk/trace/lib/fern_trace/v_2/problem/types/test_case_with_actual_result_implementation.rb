  ...
  module V2
    class Problem
      class TestCaseWithActualResultImplementation
        # @return [V2::NonVoidFunctionDefinition]
        attr_reader :get_actual_result
        # @return [V2::AssertCorrectnessCheck]
        ...
        # @param get_actual_result [V2::NonVoidFunctionDefinition]
        # @param assert_correctness_check [V2::AssertCorrectnessCheck]
        # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
        # @return [V2::TestCaseWithActualResultImplementation]
        ...
        def self.from_json(json_object:)
          ...
          if parsed_json["getActualResult"].nil?
            ...
            get_actual_result = V2::NonVoidFunctionDefinition.from_json(json_object: get_actual_result)
          end
          if parsed_json["assertCorrectnessCheck"].nil?
            ...
            assert_correctness_check = V2::AssertCorrectnessCheck.from_json(json_object: assert_correctness_check)
          end
          new(
            get_actual_result: get_actual_result,
            assert_correctness_check: assert_correctness_check,
        ...
        def self.validate_raw(obj:)
          V2::NonVoidFunctionDefinition.validate_raw(obj: obj.get_actual_result)
          V2::AssertCorrectnessCheck.validate_raw(obj: obj.assert_correctness_check)
        end
      end
    end
  end
