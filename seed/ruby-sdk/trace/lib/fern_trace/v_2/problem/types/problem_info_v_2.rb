  ...
  module V2
    class Problem
      class ProblemInfoV2
        ...
        # @param generated_files [V2::GeneratedFiles]
        ...
        def self.from_json(json_object:)
          ...
          if parsed_json["generatedFiles"].nil?
            ...
            generated_files = V2::GeneratedFiles.from_json(json_object: generated_files)
          end
        ...
        def self.validate_raw(obj:)
          ...
          V2::GeneratedFiles.validate_raw(obj: obj.generated_files)
