  ...
  module V2
    module V3
      class ProblemClient
        ...
        # @return [Array<V2::V3::LightweightProblemInfoV2>]
        # @example
        ...
        def get_lightweight_problems(request_options: nil)
          ...
          **(request_options&.additional_headers || {})
          ...
          parsed_json&.map do |v|
            v = v.to_json
            V2::V3::LightweightProblemInfoV2.from_json(json_object: v)
          end
        end
        ...
        #
        # @param request_options [SeedTraceClient::RequestOptions]
        # @return [Array<V2::V3::ProblemInfoV2>]
        # @example
        #  trace = SeedTraceClient::Client.new(
        #    base_url: "https://api.example.com",
        #    environment: SeedTraceClient::Environment::PROD,
        ...
        def get_problems(request_options: nil)
          ...
          **(request_options&.additional_headers || {})
          ...
          parsed_json&.map do |v|
            v = v.to_json
            V2::V3::ProblemInfoV2.from_json(json_object: v)
          end
        end
        ...
        #    token: "YOUR_AUTH_TOKEN"
        #  )
        #  trace.v_2.v_3.problem.get_latest_problem(problem_id: "string")
        def get_latest_problem(problem_id:, request_options: nil)
          ...
          **(request_options&.additional_headers || {})
          ...
          V2::V3::ProblemInfoV2.from_json(json_object: response.body)
        end
        ...
        #    token: "YOUR_AUTH_TOKEN"
        #  )
        #  trace.v_2.v_3.problem.get_problem_version(problem_id: "string", problem_version: 1)
