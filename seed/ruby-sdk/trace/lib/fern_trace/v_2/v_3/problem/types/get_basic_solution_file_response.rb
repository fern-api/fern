    ...
    module V3
      class Problem
        class GetBasicSolutionFileResponse
          # @return [Hash{Language => V2::V3::FileInfoV2}]
          ...
          # @param solution_file_by_language [Hash{Language => V2::V3::FileInfoV2}]
          # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
          # @return [V2::V3::GetBasicSolutionFileResponse]
          ...
          def self.from_json(json_object:)
            ...
            solution_file_by_language = parsed_json["solutionFileByLanguage"]&.transform_values do |v|
              v = v.to_json
              V2::V3::FileInfoV2.from_json(json_object: v)
            end
