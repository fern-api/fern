        ...
        class CustomFiles
          ...
          def self.from_json(json_object:)
            ...
            member = case struct.type
                     when "basic"
                       V2::V3::BasicCustomFiles.from_json(json_object: json_object)
                     when "custom"
          ...
          def self.validate_raw(obj:)
            case obj.type
            when "basic"
              V2::V3::BasicCustomFiles.validate_raw(obj: obj)
            when "custom"
          ...
          # @param member [V2::V3::BasicCustomFiles]
          # @return [V2::V3::CustomFiles]
          def self.basic(member:)
            new(member: member, discriminant: "basic")
          end

          # @param member [Hash{Language => V2::V3::Files}]
          # @return [V2::V3::CustomFiles]
