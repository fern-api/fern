    ...
    module V3
      class Problem
        class GetFunctionSignatureRequest
          # @return [V2::V3::FunctionSignature]
          ...
          # @param function_signature [V2::V3::FunctionSignature]
          # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
          # @return [V2::V3::GetFunctionSignatureRequest]
          ...
          def self.from_json(json_object:)
            ...
            if parsed_json["functionSignature"].nil?
              ...
              function_signature = V2::V3::FunctionSignature.from_json(json_object: function_signature)
            end
          ...
          def self.validate_raw(obj:)
            V2::V3::FunctionSignature.validate_raw(obj: obj.function_signature)
          end
        end
      end
    end
