    ...
    module V3
      class Problem
        class GetGeneratedTestCaseFileRequest
          ...
          # @param test_case [V2::V3::TestCaseV2]
          # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
          # @return [V2::V3::GetGeneratedTestCaseFileRequest]
          ...
          def self.from_json(json_object:)
            ...
            if parsed_json["testCase"].nil?
              ...
              test_case = V2::V3::TestCaseV2.from_json(json_object: test_case)
            end
            new(
              template: template,
              test_case: test_case,
          ...
          def self.validate_raw(obj:)
            obj.template.nil? || V2::V3::TestCaseTemplate.validate_raw(obj: obj.template)
            V2::V3::TestCaseV2.validate_raw(obj: obj.test_case)
          end
        end
      end
    end
