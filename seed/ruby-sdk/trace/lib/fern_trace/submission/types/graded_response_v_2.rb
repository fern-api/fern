...
module SeedTraceClient
  class Submission
    class GradedResponseV2
      ...
      # @param test_cases [Hash{SeedTraceClient::V2::Problem::TEST_CASE_ID => SeedTraceClient::Submission::TestCaseGrade}]
      ...
      def initialize(submission_id:, test_cases:, additional_properties: nil)
        ...
        # @type [Hash{SeedTraceClient::V2::Problem::TEST_CASE_ID => SeedTraceClient::Submission::TestCaseGrade}]
