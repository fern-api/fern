...
module SeedTraceClient
  class Submission
    class GetSubmissionStateResponse
      attr_reader :time_submitted, :submission, :language, :submission_type_state, :additional_properties, :_field_set
      ...
      def initialize(submission:, language:, submission_type_state:, time_submitted: OMIT, additional_properties: nil)
        ...
        @language = language
        # @type [SeedTraceClient::Submission::SubmissionTypeState]
