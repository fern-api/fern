...
module SeedTraceClient
  class Submission
    class TestSubmissionState
      ...
      # @param default_test_cases [Array<TestCase>]
      # @param custom_test_cases [Array<TestCase>]
      # @param status [TestSubmissionStatus]
      ...
      def self.from_json(json_object:)
        ...
        default_test_cases = parsed_json["defaultTestCases"]&.map do |v|
          v = v.to_json
          TestCase.from_json(json_object: v)
        end
        ...
        if parsed_json["status"].nil?
          ...
          status = TestSubmissionStatus.from_json(json_object: status)
        end
        new(
          problem_id: problem_id,
          default_test_cases: default_test_cases,
