  ...
  module Level1
    class Types
      class Person
        ...
        # @param name [String]
        # @param address [SeedEmptyClientsClient::Level1::Types::Address]
        # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
        # @return [SeedEmptyClientsClient::Level1::Types::Person]
        ...
        def self.from_json(json_object:)
          ...
          if parsed_json["address"].nil?
            ...
            address = SeedEmptyClientsClient::Level1::Types::Address.from_json(json_object: address)
          end
          new(
            name: name,
            address: address,
        ...
        def self.validate_raw(obj:)
          ...
          SeedEmptyClientsClient::Level1::Types::Address.validate_raw(obj: obj.address)
        end
      end
    end
  end
