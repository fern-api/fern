...
module SeedStreamingClient
  class Client
    ...
    def initialize(base_url: nil, max_retries: nil, timeout_in_seconds: nil)
      @request_client = SeedStreamingClient::RequestClient.new(base_url: base_url, max_retries: max_retries,
  ...
  class AsyncClient
    ...
    def initialize(base_url: nil, max_retries: nil, timeout_in_seconds: nil)
      @async_request_client = SeedStreamingClient::AsyncRequestClient.new(base_url: base_url, max_retries: max_retries,
                                                                          timeout_in_seconds: timeout_in_seconds)
