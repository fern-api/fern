...
require_relative "../types/types/refresh_token_request"
require "async"
...
module SeedExamplesClient
  class ServiceClient
    ...
    # @param request [Hash] Request of type SeedExamplesClient::Types::RefreshTokenRequest, as a Hash
    #   * :ttl (Integer)
    # @param request_options [SeedExamplesClient::RequestOptions]
    # @return [Void]
    # @example
    #  examples = SeedExamplesClient::Client.new(base_url: "https://api.example.com", token: "YOUR_AUTH_TOKEN")
    #  examples.service.refresh_token
    def refresh_token(request: nil, request_options: nil)
      ...
      **(request_options&.additional_headers || {})
        ...
        req.body = { **(request || {}), **(request_options&.additional_body_parameters || {}) }.compact
        req.url "#{@request_client.get_url(request_options: request_options)}/refresh-token"
      end
    end
  end
