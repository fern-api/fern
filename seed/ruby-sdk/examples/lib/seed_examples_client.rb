...
module SeedExamplesClient
  class Client
    attr_reader :client, :client, :service_client
    ...
    def initialize(environment: nil, max_retries: nil, timeout_in_seconds: nil, token: nil)
      ...
      @client = File::Client.new(request_client: request_client)
      @client = Health::Client.new(request_client: request_client)
  ...
  class AsyncClient
    attr_reader :async_client, :async_client, :async_service_client
    ...
    def initialize(environment: nil, max_retries: nil, timeout_in_seconds: nil, token: nil)
      ...
      @async_client = File::AsyncClient.new(client: request_client)
      @async_client = Health::AsyncClient.new(client: request_client)
