...
[![nuget shield](https://img.shields.io/nuget/v/SeedMixedFileDirectory)](https://nuget.org/packages/SeedMixedFileDirectory)
...
```sh
dotnet add package SeedMixedFileDirectory
```
