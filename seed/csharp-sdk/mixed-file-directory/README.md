...
[![nuget shield](https://img.shields.io/nuget/v/Fernmixed-file-directory)](https://nuget.org/packages/Fernmixed-file-directory)
...
```sh
dotnet add package Fernmixed-file-directory
```
...
var parsedData = await client.Organization.CreateAsync(...);
