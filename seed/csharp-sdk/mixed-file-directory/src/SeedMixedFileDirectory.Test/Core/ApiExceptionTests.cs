...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedMixedFileDirectoryApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedMixedFileDirectoryApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedMixedFileDirectory.SeedMixedFileDirectoryApiException")
        );
    }
    ...
    {
        var exception = new SeedMixedFileDirectoryApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedMixedFileDirectoryApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedMixedFileDirectoryApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedMixedFileDirectoryApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedMixedFileDirectoryApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedMixedFileDirectoryApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedMixedFileDirectoryApiException("Error", 400, "");
    ...
    {
        var exception = new SeedMixedFileDirectoryApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedMixedFileDirectoryApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedMixedFileDirectoryApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedMixedFileDirectoryApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedMixedFileDirectoryException>());
