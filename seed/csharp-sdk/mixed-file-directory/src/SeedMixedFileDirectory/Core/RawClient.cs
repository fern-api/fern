...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedMixedFileDirectory.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedMixedFileDirectory.Core.ApiResponse> SendRequestAsync(
        global::SeedMixedFileDirectory.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedMixedFileDirectory.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
