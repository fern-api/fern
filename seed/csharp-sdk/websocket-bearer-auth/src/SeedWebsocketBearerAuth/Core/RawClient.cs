...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedWebsocketBearerAuth.Core.ApiResponse> MakeRequestAsync(
        global::SeedWebsocketBearerAuth.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedWebsocketBearerAuth.Core.ApiResponse> SendRequestAsync(
        global::SeedWebsocketBearerAuth.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedWebsocketBearerAuth.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedWebsocketBearerAuth.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedWebsocketBearerAuth.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedWebsocketBearerAuth.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedWebsocketBearerAuth.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedWebsocketBearerAuth.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedWebsocketBearerAuth.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedWebsocketBearerAuth.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedWebsocketBearerAuth.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedWebsocketBearerAuth.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedWebsocketBearerAuth.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedWebsocketBearerAuth.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedWebsocketBearerAuth.Core.StreamRequest;
}
