...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedWebsocketBearerAuth.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedWebsocketBearerAuth.Core.ApiResponse> SendRequestAsync(
        global::SeedWebsocketBearerAuth.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedWebsocketBearerAuth.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
