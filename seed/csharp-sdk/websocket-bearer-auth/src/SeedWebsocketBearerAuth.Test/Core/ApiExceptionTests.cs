...
using SeedWebsocketBearerAuth;

namespace SeedWebsocketBearerAuth.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedWebsocketBearerAuthApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedWebsocketBearerAuthApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedWebsocketBearerAuth.SeedWebsocketBearerAuthApiException")
        );
    }
    ...
    {
        var exception = new SeedWebsocketBearerAuthApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedWebsocketBearerAuthApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedWebsocketBearerAuthApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedWebsocketBearerAuthApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedWebsocketBearerAuthApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedWebsocketBearerAuthApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedWebsocketBearerAuthApiException("Error", 400, "");
    ...
    {
        var exception = new SeedWebsocketBearerAuthApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedWebsocketBearerAuthApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedWebsocketBearerAuthApiException("Error", 429, "rate limited");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedWebsocketBearerAuthException>());
