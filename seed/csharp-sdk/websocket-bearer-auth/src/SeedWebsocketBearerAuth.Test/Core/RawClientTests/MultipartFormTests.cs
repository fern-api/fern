...
public class MultipartFormTests
{
    ...
    private static SeedWebsocketBearerAuth.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedWebsocketBearerAuth.Core.MultipartFormRequest
        {
