...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedContentTypes.Core.ApiResponse> MakeRequestAsync(
        SeedContentTypes.Core.BaseRequest request,
    ...
    internal async Task<SeedContentTypes.Core.ApiResponse> SendRequestAsync(
        SeedContentTypes.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedContentTypes.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedContentTypes.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedContentTypes.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedContentTypes.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedContentTypes.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedContentTypes.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedContentTypes.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedContentTypes.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedContentTypes.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedContentTypes.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedContentTypes.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedContentTypes.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedContentTypes.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedContentTypes.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedContentTypes.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedContentTypes.Core.StreamRequest;
}
