...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedContentTypes.Core.ApiResponse> MakeRequestAsync(
        global::SeedContentTypes.Core.BaseRequest request,
    ...
    internal async Task<global::SeedContentTypes.Core.ApiResponse> SendRequestAsync(
        global::SeedContentTypes.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedContentTypes.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    internal HttpRequestMessage CreateHttpRequest(global::SeedContentTypes.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedContentTypes.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedContentTypes.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedContentTypes.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedContentTypes.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedContentTypes.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedContentTypes.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedContentTypes.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedContentTypes.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedContentTypes.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedContentTypes.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedContentTypes.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedContentTypes.Core.StreamRequest;
}
