...
namespace SeedContentTypes.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedContentTypes.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedContentTypes.Core.MultipartFormRequest
        {
