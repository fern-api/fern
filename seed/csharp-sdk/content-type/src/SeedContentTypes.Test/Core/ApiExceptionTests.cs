...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedContentTypesApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedContentTypesApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedContentTypes.SeedContentTypesApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SeedContentTypesApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedContentTypesApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedContentTypesApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedContentTypesApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedContentTypesApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedContentTypesApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedContentTypesApiException("Error", 400, "");
    ...
    {
        var exception = new SeedContentTypesApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SeedContentTypesApiException(
            "Service Unavailable",
            503,
            "gateway timeout",
            inner
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedContentTypesApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedContentTypesApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedContentTypesApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedContentTypesException>());
