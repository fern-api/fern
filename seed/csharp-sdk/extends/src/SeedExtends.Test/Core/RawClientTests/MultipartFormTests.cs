...
namespace SeedExtends.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedExtends.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedExtends.Core.MultipartFormRequest
        {
