...
[![nuget shield](https://img.shields.io/nuget/v/Fernmixed-case)](https://nuget.org/packages/Fernmixed-case)
...
```sh
dotnet add package Fernmixed-case
```
...
var result = await client.Service.GetResourceAsync(...).WithRawResponse();
