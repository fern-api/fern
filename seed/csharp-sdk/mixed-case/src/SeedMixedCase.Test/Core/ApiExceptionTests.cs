...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedMixedCaseApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedMixedCaseApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedMixedCase.SeedMixedCaseApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SeedMixedCaseApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedMixedCaseApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedMixedCaseApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedMixedCaseApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedMixedCaseApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedMixedCaseApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedMixedCaseApiException("Error", 400, "");
    ...
    {
        var exception = new SeedMixedCaseApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SeedMixedCaseApiException(
            "Service Unavailable",
            503,
            "gateway timeout",
            inner
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedMixedCaseApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedMixedCaseApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedMixedCaseApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedMixedCaseException>());
