...
[JsonConverter(typeof(ResourceStatus.ResourceStatusSerializer))]
[Serializable]
public readonly record struct ResourceStatus : IStringEnum
{
    ...
    internal class ResourceStatusSerializer : JsonConverter<ResourceStatus>
    {
        ...
        )
        {
            ...
            return new ResourceStatus(stringValue);
        }
        ...
        public override ResourceStatus ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
