...
public class ApiExceptionTests
{
    ...
    {
        var exception = new CustomApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new CustomApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedApi.CustomApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new CustomApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new CustomApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new CustomApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new CustomApiException("No Content", 204, null!);
    ...
    {
        var exception = new CustomApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new CustomApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new CustomApiException("Error", 400, "");
    ...
    {
        var exception = new CustomApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new CustomApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new CustomApiException("Error: \"quotes\" & <brackets>", 400, "body");
    ...
    {
        var exception = new CustomApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new CustomApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<CustomException>());
