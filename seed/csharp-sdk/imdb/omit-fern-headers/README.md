...
[![nuget shield](https://img.shields.io/nuget/v/Fernimdb)](https://nuget.org/packages/Fernimdb)
...
var result = await client.Imdb.CreateMovieAsync(...).WithRawResponse();
...
var data = await client.Imdb.CreateMovieAsync(...);
```
