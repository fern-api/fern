...
[![nuget shield](https://img.shields.io/nuget/v/Fernapi-wide-base-path)](https://nuget.org/packages/Fernapi-wide-base-path)
...
```sh
dotnet add package Fernapi-wide-base-path
```
