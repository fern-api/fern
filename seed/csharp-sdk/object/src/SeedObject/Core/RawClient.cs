...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedObject.Core.ApiResponse> MakeRequestAsync(
        SeedObject.Core.BaseRequest request,
    ...
    internal async Task<SeedObject.Core.ApiResponse> SendRequestAsync(
        SeedObject.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedObject.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedObject.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedObject.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedObject.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedObject.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedObject.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedObject.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedObject.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedObject.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedObject.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedObject.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedObject.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedObject.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedObject.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedObject.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedObject.Core.StreamRequest;
}
