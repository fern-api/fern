...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedVariables.Core.ApiResponse> MakeRequestAsync(
        SeedVariables.Core.BaseRequest request,
    ...
    internal async Task<SeedVariables.Core.ApiResponse> SendRequestAsync(
        SeedVariables.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedVariables.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedVariables.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedVariables.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedVariables.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedVariables.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedVariables.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedVariables.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedVariables.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedVariables.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedVariables.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedVariables.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedVariables.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedVariables.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedVariables.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedVariables.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedVariables.Core.StreamRequest;
}
