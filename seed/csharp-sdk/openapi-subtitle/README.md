...
[![nuget shield](https://img.shields.io/nuget/v/Fernopenapi-subtitle)](https://nuget.org/packages/Fernopenapi-subtitle)
...
```sh
dotnet add package Fernopenapi-subtitle
```
...
var result = await client.ListPlantsAsync(...).WithRawResponse();
...
var parsedData = await client.ListPlantsAsync(...);
