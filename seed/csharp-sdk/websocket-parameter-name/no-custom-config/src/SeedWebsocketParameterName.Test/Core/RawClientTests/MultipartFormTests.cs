...
namespace SeedWebsocketParameterName.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedWebsocketParameterName.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedWebsocketParameterName.Core.MultipartFormRequest
        {
