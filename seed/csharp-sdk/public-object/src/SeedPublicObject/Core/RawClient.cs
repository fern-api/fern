...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedPublicObject.Core.ApiResponse> MakeRequestAsync(
        SeedPublicObject.Core.BaseRequest request,
    ...
    internal async Task<SeedPublicObject.Core.ApiResponse> SendRequestAsync(
        SeedPublicObject.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedPublicObject.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedPublicObject.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedPublicObject.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedPublicObject.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedPublicObject.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedPublicObject.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedPublicObject.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedPublicObject.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedPublicObject.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedPublicObject.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedPublicObject.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedPublicObject.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedPublicObject.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedPublicObject.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedPublicObject.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedPublicObject.Core.StreamRequest;
}
