...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedPublicObject.Core.ApiResponse> MakeRequestAsync(
        global::SeedPublicObject.Core.BaseRequest request,
    ...
    internal async Task<global::SeedPublicObject.Core.ApiResponse> SendRequestAsync(
        global::SeedPublicObject.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedPublicObject.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    internal HttpRequestMessage CreateHttpRequest(global::SeedPublicObject.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedPublicObject.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedPublicObject.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPublicObject.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedPublicObject.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPublicObject.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedPublicObject.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPublicObject.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedPublicObject.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPublicObject.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedPublicObject.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPublicObject.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedPublicObject.Core.StreamRequest;
}
