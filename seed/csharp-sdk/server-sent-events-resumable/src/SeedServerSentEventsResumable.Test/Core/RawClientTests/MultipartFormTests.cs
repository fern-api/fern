...
public class MultipartFormTests
{
    ...
    private static SeedServerSentEventsResumable.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedServerSentEventsResumable.Core.MultipartFormRequest
        {
