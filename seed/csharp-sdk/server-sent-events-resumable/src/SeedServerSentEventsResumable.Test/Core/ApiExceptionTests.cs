...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedServerSentEventsResumableApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    {
        var exception = new SeedServerSentEventsResumableApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedServerSentEventsResumable.SeedServerSentEventsResumableApiException")
        );
    }
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedServerSentEventsResumableApiException("Unauthorized", 401, body);
    ...
    {
        var exception = new SeedServerSentEventsResumableApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedServerSentEventsResumableApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedServerSentEventsResumableApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedServerSentEventsResumableApiException("Error", 400, "");
    ...
    {
        var exception = new SeedServerSentEventsResumableApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedServerSentEventsResumableApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedServerSentEventsResumableApiException("Error", 429, "rate limited");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedServerSentEventsResumableException>());
