...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedServerSentEventsResumable.Core.ApiResponse> SendRequestAsync(
        global::SeedServerSentEventsResumable.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedServerSentEventsResumable.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    private string BuildUrl(global::SeedServerSentEventsResumable.Core.BaseRequest request)
    {
