...
[![nuget shield](https://img.shields.io/nuget/v/Fernserver-sent-events-resumable)](https://nuget.org/packages/Fernserver-sent-events-resumable)
...
```sh
dotnet add package Fernserver-sent-events-resumable
```
...
} catch (SeedServerSentEventsResumableApiException e) {
...
var parsedData = await client.Completions.StreamAsync(...);
