...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-multi-env-url-templating)](https://nuget.org/packages/Ferncsharp-multi-env-url-templating)
...
```sh
dotnet add package Ferncsharp-multi-env-url-templating
```
