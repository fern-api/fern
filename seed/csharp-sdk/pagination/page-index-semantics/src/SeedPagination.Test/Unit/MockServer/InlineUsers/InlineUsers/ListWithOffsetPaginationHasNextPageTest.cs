...
namespace SeedPagination.Test.Unit.MockServer.InlineUsers.InlineUsers;
...
public class ListWithOffsetPaginationHasNextPageTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        var items = await Client.InlineUsers.InlineUsers.ListWithOffsetPaginationHasNextPageAsync(
