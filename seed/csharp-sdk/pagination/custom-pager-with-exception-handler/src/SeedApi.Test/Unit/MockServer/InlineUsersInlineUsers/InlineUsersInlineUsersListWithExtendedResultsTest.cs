...
public class InlineUsersInlineUsersListWithExtendedResultsTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        var response =
            await Client.InlineUsersInlineUsers.InlineUsersInlineUsersListWithExtendedResultsAsync(
                new InlineUsersInlineUsersListWithExtendedResultsRequest { Cursor = "cursor" }
            );
