...
public readonly record struct SingleFilterSearchRequestOperator : IStringEnum
{
    ...
    public static readonly SingleFilterSearchRequestOperator Tilde = new(Values.Tilde);

    public static readonly SingleFilterSearchRequestOperator NotTilde = new(Values.NotTilde);

    public static readonly SingleFilterSearchRequestOperator Caret = new(Values.Caret);

    public static readonly SingleFilterSearchRequestOperator Dollar = new(Values.Dollar);
