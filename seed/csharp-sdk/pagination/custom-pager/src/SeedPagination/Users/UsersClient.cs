...
public partial class UsersClient : IUsersClient
{
    ...
    {
        var response = await Raw.ListWithCursorPaginationAsync(request, options, cancellationToken);
    ...
    {
        var response = await Raw.ListWithTopLevelBodyCursorPaginationAsync(
            request,
            options,
            cancellationToken
        );
    ...
    {
        var response = await Raw.ListWithOffsetPaginationAsync(request, options, cancellationToken);
        return response.Data;
    }
    ...
    {
        var response = await Raw.ListWithExtendedResultsAsync(request, options, cancellationToken);
        return response.Data;
    }
    ...
    {
        var response = await Raw.ListUsernamesWithOptionalResponseAsync(
            request,
            options,
            cancellationToken
        );
    ...
    {
        var response = await Raw.ListWithGlobalConfigAsync(request, options, cancellationToken);
        return response.Data;
    }
    ...
    {
        var response = await Raw.ListWithOptionalDataAsync(request, options, cancellationToken);
        return response.Data;
    }
    ...
    public partial class RawAccessClient
    {
        ...
        )
        {
            ...
            if (response.StatusCode is >= 200 and < 400)
            {
                ...
                try
                {
                    var data = JsonUtils.Deserialize<ListUsersTopLevelCursorPaginationResponse>(
                        responseBody
                    )!;
        ...
        )
        {
            ...
            if (response.StatusCode is >= 200 and < 400)
            {
                ...
                try
                {
                    var data = JsonUtils.Deserialize<ListUsersOptionalDataPaginationResponse>(
                        responseBody
                    )!;
