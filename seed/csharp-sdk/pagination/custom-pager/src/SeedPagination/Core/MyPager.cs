...
internal static class MyPagerFactory
{
    public static async Task<MyPager<TItem>> CreateAsync<TItem>(
...
public class MyPager<TItem> : BiPager<TItem>, IAsyncEnumerable<TItem>
{
