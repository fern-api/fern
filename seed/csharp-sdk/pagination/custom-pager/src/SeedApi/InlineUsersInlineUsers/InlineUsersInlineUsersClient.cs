...
public partial class InlineUsersInlineUsersClient : IInlineUsersInlineUsersClient
{
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<InlineUsersListUsersPaginationResponse>(
                    responseBody
                )!;
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<InlineUsersListUsersExtendedResponse>(
                    responseBody
                )!;
