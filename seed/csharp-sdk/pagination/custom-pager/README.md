...
[![nuget shield](https://img.shields.io/nuget/v/Fernpagination)](https://nuget.org/packages/Fernpagination)
...
```sh
dotnet add package Fernpagination
```
...
var data = await client.Complex.SearchAsync(...);
```
