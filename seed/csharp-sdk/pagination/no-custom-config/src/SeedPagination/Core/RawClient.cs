...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedPagination.Core.ApiResponse> MakeRequestAsync(
        global::SeedPagination.Core.BaseRequest request,
    ...
    internal async Task<global::SeedPagination.Core.ApiResponse> SendRequestAsync(
        global::SeedPagination.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedPagination.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    internal HttpRequestMessage CreateHttpRequest(global::SeedPagination.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedPagination.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedPagination.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPagination.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedPagination.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPagination.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedPagination.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPagination.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedPagination.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPagination.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedPagination.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPagination.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedPagination.Core.StreamRequest;
}
