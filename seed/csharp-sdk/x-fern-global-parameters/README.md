...
[![nuget shield](https://img.shields.io/nuget/v/Fernx-fern-global-parameters)](https://nuget.org/packages/Fernx-fern-global-parameters)
...
```sh
dotnet add package Fernx-fern-global-parameters
```
...
var result = await client.Products.SearchAsync(...).WithRawResponse();
...
var parsedData = await client.Products.SearchAsync(...);
