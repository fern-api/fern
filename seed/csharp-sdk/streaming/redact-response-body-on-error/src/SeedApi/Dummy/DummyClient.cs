...
public partial class DummyClient : IDummyClient
{
    ...
    private async Task<WithRawResponse<global::System.IO.Stream>> GenerateStreamAsyncCore(
    ...
    public WithRawResponseTask<global::System.IO.Stream> GenerateStreamAsync(
        DummyGenerateStreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
