...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedStreaming.Core.ApiResponse> MakeRequestAsync(
        global::SeedStreaming.Core.BaseRequest request,
    ...
    internal async Task<global::SeedStreaming.Core.ApiResponse> SendRequestAsync(
        global::SeedStreaming.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedStreaming.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    internal HttpRequestMessage CreateHttpRequest(global::SeedStreaming.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedStreaming.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedStreaming.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedStreaming.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedStreaming.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedStreaming.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedStreaming.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedStreaming.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedStreaming.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedStreaming.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : global::SeedStreaming.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedStreaming.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedStreaming.Core.StreamRequest;
}
