...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedStreaming.Core.ApiResponse> MakeRequestAsync(
        SeedStreaming.Core.BaseRequest request,
    ...
    internal async Task<SeedStreaming.Core.ApiResponse> SendRequestAsync(
        SeedStreaming.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedStreaming.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedStreaming.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedStreaming.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedStreaming.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedStreaming.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedStreaming.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedStreaming.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedStreaming.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedStreaming.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedStreaming.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedStreaming.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedStreaming.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedStreaming.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedStreaming.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedStreaming.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedStreaming.Core.StreamRequest;
}
