...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedStreamingApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedStreamingApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedStreamingApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedStreamingApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedStreamingApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedStreamingApiException("Error", 400, "");
    ...
    {
        var exception = new SeedStreamingApiException("Error", 400, false);
