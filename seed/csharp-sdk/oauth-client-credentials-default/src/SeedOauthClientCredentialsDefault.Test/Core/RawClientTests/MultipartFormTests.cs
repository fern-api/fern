...
public class MultipartFormTests
{
    ...
    private static SeedOauthClientCredentialsDefault.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedOauthClientCredentialsDefault.Core.MultipartFormRequest
        {
