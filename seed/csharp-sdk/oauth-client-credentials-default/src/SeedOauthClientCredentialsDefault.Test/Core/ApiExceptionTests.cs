...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedOauthClientCredentialsDefaultApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    {
        var exception = new SeedOauthClientCredentialsDefaultApiException("Error", 500, "body");
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedOauthClientCredentialsDefault.SeedOauthClientCredentialsDefaultApiException"
            )
        );
    }
    ...
    {
        var exception = new SeedOauthClientCredentialsDefaultApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedOauthClientCredentialsDefaultApiException("Error", 500, 42);
    ...
    {
        var exception = new SeedOauthClientCredentialsDefaultApiException("Error", 400, "");
    ...
    {
        var exception = new SeedOauthClientCredentialsDefaultApiException("Error", 400, false);
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedOauthClientCredentialsDefaultException>());
