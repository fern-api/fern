...
[JsonConverter(typeof(Foo.JsonConverter))][Serializable]
public record Foo
{
    [Optional][JsonPropertyName("bar")]
    public string? Bar { get; set; }

    [Nullable, Optional][JsonPropertyName("nullable_bar")]
    public Optional<string?> NullableBar { get; set; }

    [Nullable][JsonPropertyName("nullable_required_bar")]
    ...
    {
        public override bool CanConvert(global::System.Type typeToConvert) => typeof(Foo).IsAssignableFrom(typeToConvert);

        public override Foo? Read(ref Utf8JsonReader reader, global::System.Type typeToConvert, JsonSerializerOptions options) {
            if (reader.TokenType == JsonTokenType.Null)
            {
                return null;
            }
            
            var _bar = string?.Undefined;
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                {
                    case "bar":
                        _bar = string?.Of(JsonSerializer.Deserialize<string>(ref reader, options));
                        break;
                    case "nullable_bar":
                        _nullableBar = Optional<string?>.Of(JsonSerializer.Deserialize<string?>(ref reader, options));
                        break;
                    case "nullable_required_bar":
                        _nullableRequiredBar = JsonSerializer.Deserialize<string?>(ref reader, options);
                        break;
                    case "required_bar":
...
;
        ...
        public override void Write(Utf8JsonWriter writer, Foo value, JsonSerializerOptions options) {
            ...
            if (value.Bar.IsDefined)
            {
                writer.WritePropertyName("bar");
                JsonSerializer.Serialize(writer, value.Bar.Value, options);
            }
