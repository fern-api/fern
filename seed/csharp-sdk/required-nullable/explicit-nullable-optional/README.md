...
[![nuget shield](https://img.shields.io/nuget/v/Fernrequired-nullable)](https://nuget.org/packages/Fernrequired-nullable)
...
```sh
dotnet add package Fernrequired-nullable
```
...
var result = await client._.GetFooAsync(...).WithRawResponse();
...
var data = await client._.GetFooAsync(...);
```
