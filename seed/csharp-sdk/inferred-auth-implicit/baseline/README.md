...
[![nuget shield](https://img.shields.io/nuget/v/Ferninferred-auth-implicit)](https://nuget.org/packages/Ferninferred-auth-implicit)
...
```sh
dotnet add package Ferninferred-auth-implicit
```
