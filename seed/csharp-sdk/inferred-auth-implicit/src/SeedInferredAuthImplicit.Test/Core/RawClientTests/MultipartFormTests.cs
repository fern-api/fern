...
public class MultipartFormTests
{
    ...
    private static SeedInferredAuthImplicit.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedInferredAuthImplicit.Core.MultipartFormRequest
        {
