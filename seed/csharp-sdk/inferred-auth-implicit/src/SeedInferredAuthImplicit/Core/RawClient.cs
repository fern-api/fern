...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedInferredAuthImplicit.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedInferredAuthImplicit.Core.ApiResponse> SendRequestAsync(
        global::SeedInferredAuthImplicit.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedInferredAuthImplicit.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
