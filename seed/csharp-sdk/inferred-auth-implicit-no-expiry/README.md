...
[![nuget shield](https://img.shields.io/nuget/v/Ferninferred-auth-implicit-no-expiry)](https://nuget.org/packages/Ferninferred-auth-implicit-no-expiry)
...
```sh
dotnet add package Ferninferred-auth-implicit-no-expiry
```
