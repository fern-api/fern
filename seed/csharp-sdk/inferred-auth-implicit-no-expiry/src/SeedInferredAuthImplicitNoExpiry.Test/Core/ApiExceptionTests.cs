...
namespace SeedInferredAuthImplicitNoExpiry.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedInferredAuthImplicitNoExpiryApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    {
        var exception = new SeedInferredAuthImplicitNoExpiryApiException("Error", 500, "body");
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedInferredAuthImplicitNoExpiry.SeedInferredAuthImplicitNoExpiryApiException"
            )
        );
    }
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedInferredAuthImplicitNoExpiryApiException("Unauthorized", 401, body);
    ...
    {
        var exception = new SeedInferredAuthImplicitNoExpiryApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedInferredAuthImplicitNoExpiryApiException("Error", 500, 42);
    ...
    {
        var exception = new SeedInferredAuthImplicitNoExpiryApiException("Error", 400, "");
    ...
    {
        var exception = new SeedInferredAuthImplicitNoExpiryApiException("Error", 400, false);
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedInferredAuthImplicitNoExpiryException>());
