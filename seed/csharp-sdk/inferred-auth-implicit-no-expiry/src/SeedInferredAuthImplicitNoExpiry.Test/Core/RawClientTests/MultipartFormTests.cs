...
public class MultipartFormTests
{
    ...
    private static SeedInferredAuthImplicitNoExpiry.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedInferredAuthImplicitNoExpiry.Core.MultipartFormRequest
        {
