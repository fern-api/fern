...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedInferredAuthImplicitNoExpiry.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedInferredAuthImplicitNoExpiry.Core.ApiResponse> SendRequestAsync(
        global::SeedInferredAuthImplicitNoExpiry.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedInferredAuthImplicitNoExpiry.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
