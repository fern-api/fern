...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedWebsocketOauth.Core.ApiResponse> SendRequestAsync(
        global::SeedWebsocketOauth.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedWebsocketOauth.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::SeedWebsocketOauth.Core.ApiResponse
            {
    ...
    private static string BuildUrl(global::SeedWebsocketOauth.Core.BaseRequest request)
    {
