...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-websocket-oauth)](https://nuget.org/packages/Ferncsharp-websocket-oauth)
...
```sh
dotnet add package Ferncsharp-websocket-oauth
```
...
var client = new SeedWebsocketOauthClient("client_id", "client_secret", "TENANT_NAME");
...
} catch (SeedWebsocketOauthApiException e) {
