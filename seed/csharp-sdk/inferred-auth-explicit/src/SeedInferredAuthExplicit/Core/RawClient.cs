...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedInferredAuthExplicit.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedInferredAuthExplicit.Core.ApiResponse> SendRequestAsync(
        global::SeedInferredAuthExplicit.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedInferredAuthExplicit.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
