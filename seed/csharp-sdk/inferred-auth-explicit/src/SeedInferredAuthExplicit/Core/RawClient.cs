...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedInferredAuthExplicit.Core.ApiResponse> MakeRequestAsync(
        global::SeedInferredAuthExplicit.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedInferredAuthExplicit.Core.ApiResponse> SendRequestAsync(
        global::SeedInferredAuthExplicit.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedInferredAuthExplicit.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedInferredAuthExplicit.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedInferredAuthExplicit.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedInferredAuthExplicit.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedInferredAuthExplicit.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedInferredAuthExplicit.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedInferredAuthExplicit.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedInferredAuthExplicit.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedInferredAuthExplicit.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedInferredAuthExplicit.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedInferredAuthExplicit.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedInferredAuthExplicit.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedInferredAuthExplicit.Core.StreamRequest;
}
