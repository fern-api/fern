...
public class MultipartFormTests
{
    ...
    private static SeedInferredAuthExplicit.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedInferredAuthExplicit.Core.MultipartFormRequest
        {
