...
[![nuget shield](https://img.shields.io/nuget/v/Ferninferred-auth-explicit)](https://nuget.org/packages/Ferninferred-auth-explicit)
...
```sh
dotnet add package Ferninferred-auth-explicit
```
