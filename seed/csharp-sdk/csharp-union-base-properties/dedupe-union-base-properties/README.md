...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-union-base-properties)](https://nuget.org/packages/Ferncsharp-union-base-properties)
...
```sh
dotnet add package Ferncsharp-union-base-properties
```
...
} catch (SeedCsharpUnionBasePropertiesApiException e) {
