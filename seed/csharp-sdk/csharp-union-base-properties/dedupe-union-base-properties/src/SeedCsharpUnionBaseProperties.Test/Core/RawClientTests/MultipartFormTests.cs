...
namespace SeedCsharpUnionBaseProperties.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedCsharpUnionBaseProperties.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedCsharpUnionBaseProperties.Core.MultipartFormRequest
        {
