...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedCsharpUnionBaseProperties.Core.ApiResponse> SendRequestAsync(
        global::SeedCsharpUnionBaseProperties.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedCsharpUnionBaseProperties.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::SeedCsharpUnionBaseProperties.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::SeedCsharpUnionBaseProperties.Core.BaseRequest request)
    {
