...
public partial class ClientOptions
{
    ...
    /// <summary>
    /// OAuth authentication. Use `Auth.ClientCredentials` for the standard OAuth client-credentials flow, or `Auth.Bearer` to provide a pre-fetched access token.
    /// </summary>
    public required Auth Auth { get;
#if NET5_0_OR_GREATER
        init;
#else
        set;
