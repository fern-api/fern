...
namespace SeedOauthClientCredentialsMandatoryAuth.Test.Core.RawClientTests;
...
public class RetriesTests
{
    ...
    public async SystemTask SendRequestAsync_ShouldNotRetry_WithStreamRequest()
    {
        ...
        var request = new SeedOauthClientCredentialsMandatoryAuth.Core.StreamRequest
        {
            BaseUrl = _baseUrl,
    ...
    public async SystemTask SendRequestAsync_ShouldNotRetry_WithMultiPartFormRequest_WithStream()
    {
        ...
        var request = new SeedOauthClientCredentialsMandatoryAuth.Core.MultipartFormRequest
        {
            BaseUrl = _baseUrl,
            Method = HttpMethod.Post,
            Path = "/test",
