...
namespace SeedOauthClientCredentialsMandatoryAuth.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedOauthClientCredentialsMandatoryAuthApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    public void ToString_ContainsFullTypeName()
    {
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedOauthClientCredentialsMandatoryAuth.SeedOauthClientCredentialsMandatoryAuthApiException"
            )
        );
    }
    ...
    {
        var exception = new SeedOauthClientCredentialsMandatoryAuthApiException("Error", 500, 42);
    ...
    {
        var exception = new SeedOauthClientCredentialsMandatoryAuthApiException("Error", 400, "");
    ...
    public void Body_ReturnsCorrectValue()
    {
        ...
        var exception = new SeedOauthClientCredentialsMandatoryAuthApiException("Error", 500, body);
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedOauthClientCredentialsMandatoryAuthException>());
