...
public class MultipartFormTests
{
    ...
    private static SeedOauthClientCredentialsMandatoryAuth.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedOauthClientCredentialsMandatoryAuth.Core.MultipartFormRequest
        {
