...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedOauthClientCredentialsMandatoryAuth.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedOauthClientCredentialsMandatoryAuth.Core.ApiResponse> SendRequestAsync(
        global::SeedOauthClientCredentialsMandatoryAuth.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedOauthClientCredentialsMandatoryAuth.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
