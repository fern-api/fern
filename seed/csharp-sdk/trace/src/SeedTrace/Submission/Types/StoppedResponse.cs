...
[JsonConverter(typeof(StoppedResponse.JsonConverter))]
[Serializable]
public record StoppedResponse
{
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<StoppedResponse>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(StoppedResponse).IsAssignableFrom(typeToConvert);

        public override StoppedResponse? Read(
