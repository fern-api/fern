...
[JsonConverter(typeof(BuildingExecutorResponse.JsonConverter))]
[Serializable]
public record BuildingExecutorResponse
{
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<BuildingExecutorResponse>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(BuildingExecutorResponse).IsAssignableFrom(typeToConvert);

        public override BuildingExecutorResponse? Read(
        ...
        )
        {
            ...
            return new BuildingExecutorResponse
            {
        ...
        public override BuildingExecutorResponse ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return JsonSerializer.Deserialize<BuildingExecutorResponse>(json, options);
        }
