...
[JsonConverter(typeof(InitializeProblemRequest.JsonConverter))]
[Serializable]
public record InitializeProblemRequest
{
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<InitializeProblemRequest>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(InitializeProblemRequest).IsAssignableFrom(typeToConvert);

        public override InitializeProblemRequest? Read(
        ...
        )
        {
            ...
            return new InitializeProblemRequest
            {
        ...
        public override InitializeProblemRequest ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return JsonSerializer.Deserialize<InitializeProblemRequest>(json, options);
        }
