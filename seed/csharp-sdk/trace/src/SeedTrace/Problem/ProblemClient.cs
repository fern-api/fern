...
public partial class ProblemClient : IProblemClient
{
    ...
    {
        var response = await Raw.CreateProblemAsync(request, options, cancellationToken);
    ...
    {
        var response = await Raw.UpdateProblemAsync(problemId, request, options, cancellationToken);
        return response.Data;
    }
    ...
    {
        await Raw.DeleteProblemAsync(problemId, options, cancellationToken);
    }
    ...
    {
        var response = await Raw.GetDefaultStarterFilesAsync(request, options, cancellationToken);
        return response.Data;
    }
