...
public record FunctionImplementationForMultipleLanguages
{
    ...
    internal sealed class JsonConverter : JsonConverter<FunctionImplementationForMultipleLanguages>
    {
        ...
        public override FunctionImplementationForMultipleLanguages ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return JsonSerializer.Deserialize<FunctionImplementationForMultipleLanguages>(
                json,
                options
            );
        }
