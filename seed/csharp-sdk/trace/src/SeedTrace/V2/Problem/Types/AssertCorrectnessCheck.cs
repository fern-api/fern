...
public record AssertCorrectnessCheck
{
    ...
    public DeepEqualityCorrectnessCheck AsDeepEquality() =>
        IsDeepEquality
            ...
            : throw new Exception("SeedTrace.V2.AssertCorrectnessCheck.Type is not 'deepEquality'");
    ...
    public VoidFunctionDefinitionThatTakesActualResult AsCustom() =>
        IsCustom
            ...
            : throw new Exception("SeedTrace.V2.AssertCorrectnessCheck.Type is not 'custom'");
