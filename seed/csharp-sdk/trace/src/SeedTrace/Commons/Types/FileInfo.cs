...
[JsonConverter(typeof(FileInfo.JsonConverter))]
[Serializable]
public record FileInfo
{
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<FileInfo>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(FileInfo).IsAssignableFrom(typeToConvert);
        ...
        )
        {
            ...
            return JsonSerializer.Deserialize<FileInfo>(json, options);
        }
