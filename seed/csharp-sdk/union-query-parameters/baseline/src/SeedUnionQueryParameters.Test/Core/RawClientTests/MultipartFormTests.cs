...
public class MultipartFormTests
{
    ...
    private static SeedUnionQueryParameters.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedUnionQueryParameters.Core.MultipartFormRequest
        {
