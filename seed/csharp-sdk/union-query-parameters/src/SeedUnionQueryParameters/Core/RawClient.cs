...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedUnionQueryParameters.Core.ApiResponse> SendRequestAsync(
        global::SeedUnionQueryParameters.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedUnionQueryParameters.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    private string BuildUrl(global::SeedUnionQueryParameters.Core.BaseRequest request)
    {
