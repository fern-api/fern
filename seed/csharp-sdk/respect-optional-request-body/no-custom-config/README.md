...
[![nuget shield](https://img.shields.io/nuget/v/Fernrespect-optional-request-body)](https://nuget.org/packages/Fernrespect-optional-request-body)
...
```sh
dotnet add package Fernrespect-optional-request-body
```
...
var result = await client.RefundAsync(...).WithRawResponse();
...
var data = await client.RefundAsync(...);
