...
[![nuget shield](https://img.shields.io/nuget/v/Fernno-environment)](https://nuget.org/packages/Fernno-environment)
...
```sh
dotnet add package Fernno-environment
```
...
var parsedData = await client.Dummy.GetDummyAsync(...);
