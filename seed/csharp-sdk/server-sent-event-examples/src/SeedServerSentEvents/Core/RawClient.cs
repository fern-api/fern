...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedServerSentEvents.Core.ApiResponse> MakeRequestAsync(
        SeedServerSentEvents.Core.BaseRequest request,
    ...
    internal async Task<SeedServerSentEvents.Core.ApiResponse> SendRequestAsync(
        SeedServerSentEvents.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedServerSentEvents.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedServerSentEvents.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedServerSentEvents.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedServerSentEvents.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedServerSentEvents.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedServerSentEvents.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedServerSentEvents.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedServerSentEvents.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedServerSentEvents.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedServerSentEvents.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedServerSentEvents.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedServerSentEvents.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedServerSentEvents.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedServerSentEvents.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedServerSentEvents.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedServerSentEvents.Core.StreamRequest;
}
