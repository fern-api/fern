...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedServerSentEvents.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedServerSentEvents.Core.ApiResponse> SendRequestAsync(
        global::SeedServerSentEvents.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedServerSentEvents.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
