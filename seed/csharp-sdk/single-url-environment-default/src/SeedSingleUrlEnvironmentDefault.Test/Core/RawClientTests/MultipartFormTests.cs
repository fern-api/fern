...
public class MultipartFormTests
{
    ...
    private static SeedSingleUrlEnvironmentDefault.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedSingleUrlEnvironmentDefault.Core.MultipartFormRequest
        {
