...
namespace SeedSingleUrlEnvironmentDefault.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedSingleUrlEnvironmentDefaultApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    {
        var exception = new SeedSingleUrlEnvironmentDefaultApiException("Error", 500, "body");
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedSingleUrlEnvironmentDefault.SeedSingleUrlEnvironmentDefaultApiException"
            )
        );
    }
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedSingleUrlEnvironmentDefaultApiException("Unauthorized", 401, body);
    ...
    {
        var exception = new SeedSingleUrlEnvironmentDefaultApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedSingleUrlEnvironmentDefaultApiException("Error", 500, 42);
    ...
    {
        var exception = new SeedSingleUrlEnvironmentDefaultApiException("Error", 400, "");
    ...
    {
        var exception = new SeedSingleUrlEnvironmentDefaultApiException("Error", 400, false);
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedSingleUrlEnvironmentDefaultException>());
