...
public class MultipartFormTests
{
    ...
    private static SeedBearerTokenEnvironmentVariable.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedBearerTokenEnvironmentVariable.Core.MultipartFormRequest
        {
