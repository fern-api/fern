...
[![nuget shield](https://img.shields.io/nuget/v/Fernbearer-token-environment-variable)](https://nuget.org/packages/Fernbearer-token-environment-variable)
...
```sh
dotnet add package Fernbearer-token-environment-variable
```
...
var client = new SeedBearerTokenEnvironmentVariableClient(
    new SeedBearerTokenEnvironmentVariable.Auth.Bearer { Token = "<token>" }
);
