...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedBearerTokenEnvironmentVariableApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    {
        var exception = new SeedBearerTokenEnvironmentVariableApiException("Error", 500, "body");
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedBearerTokenEnvironmentVariable.SeedBearerTokenEnvironmentVariableApiException"
            )
        );
    }
    ...
    {
        var exception = new SeedBearerTokenEnvironmentVariableApiException("Error", 500, 42);
    ...
    {
        var exception = new SeedBearerTokenEnvironmentVariableApiException("Error", 400, "");
    ...
    {
        var exception = new SeedBearerTokenEnvironmentVariableApiException("Error", 400, false);
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedBearerTokenEnvironmentVariableException>());
