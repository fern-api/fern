...
public class MultipartFormTests
{
    ...
    private static SeedOauthClientCredentialsWithVariables.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedOauthClientCredentialsWithVariables.Core.MultipartFormRequest
        {
