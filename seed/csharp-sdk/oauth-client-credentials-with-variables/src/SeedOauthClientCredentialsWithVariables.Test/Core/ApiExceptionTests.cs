...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedOauthClientCredentialsWithVariablesApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    public void ToString_ContainsFullTypeName()
    {
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedOauthClientCredentialsWithVariables.SeedOauthClientCredentialsWithVariablesApiException"
            )
        );
    }
    ...
    {
        var exception = new SeedOauthClientCredentialsWithVariablesApiException("Error", 500, 42);
    ...
    {
        var exception = new SeedOauthClientCredentialsWithVariablesApiException("Error", 400, "");
    ...
    public void Body_ReturnsCorrectValue()
    {
        ...
        var exception = new SeedOauthClientCredentialsWithVariablesApiException("Error", 500, body);
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedOauthClientCredentialsWithVariablesException>());
