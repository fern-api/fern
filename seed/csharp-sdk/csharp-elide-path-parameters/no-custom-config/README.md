...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-elide-path-parameters)](https://nuget.org/packages/Ferncsharp-elide-path-parameters)
...
```sh
dotnet add package Ferncsharp-elide-path-parameters
```
...
} catch (SeedCsharpElidePathParametersApiException e) {
...
var result = await client.EndpointHeaders.GetEndpointHeadersPathParamAsync(...).WithRawResponse();
...
var data = await client.EndpointHeaders.GetEndpointHeadersPathParamAsync(...);
```
