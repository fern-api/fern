...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedCsharpElidePathParameters.Core.ApiResponse> SendRequestAsync(
        global::SeedCsharpElidePathParameters.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedCsharpElidePathParameters.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::SeedCsharpElidePathParameters.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::SeedCsharpElidePathParameters.Core.BaseRequest request)
    {
