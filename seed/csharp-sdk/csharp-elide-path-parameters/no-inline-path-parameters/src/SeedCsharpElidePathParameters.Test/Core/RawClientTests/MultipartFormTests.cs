...
public class MultipartFormTests
{
    ...
    private static SeedCsharpElidePathParameters.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedCsharpElidePathParameters.Core.MultipartFormRequest
        {
