...
[![nuget shield](https://img.shields.io/nuget/v/SeedHeaderTokenEnvironmentVariable)](https://nuget.org/packages/SeedHeaderTokenEnvironmentVariable)
...
```sh
dotnet add package SeedHeaderTokenEnvironmentVariable
```
