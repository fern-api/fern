...
[![nuget shield](https://img.shields.io/nuget/v/Fernheader-auth-environment-variable)](https://nuget.org/packages/Fernheader-auth-environment-variable)
...
```sh
dotnet add package Fernheader-auth-environment-variable
```
...
var client = new SeedHeaderTokenEnvironmentVariableClient("YOUR_HEADER_VALUE");
...
} catch (SeedHeaderTokenEnvironmentVariableApiException e) {
