...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedHeaderTokenEnvironmentVariable.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedHeaderTokenEnvironmentVariable.Core.ApiResponse> SendRequestAsync(
        global::SeedHeaderTokenEnvironmentVariable.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedHeaderTokenEnvironmentVariable.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
