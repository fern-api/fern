...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedHeaderTokenEnvironmentVariableApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    {
        var exception = new SeedHeaderTokenEnvironmentVariableApiException("Error", 500, "body");
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedHeaderTokenEnvironmentVariable.SeedHeaderTokenEnvironmentVariableApiException"
            )
        );
    }
    ...
    {
        var exception = new SeedHeaderTokenEnvironmentVariableApiException("Error", 500, 42);
    ...
    {
        var exception = new SeedHeaderTokenEnvironmentVariableApiException("Error", 400, "");
    ...
    {
        var exception = new SeedHeaderTokenEnvironmentVariableApiException("Error", 400, false);
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedHeaderTokenEnvironmentVariableException>());
