...
public class MultipartFormTests
{
    ...
    private static SeedHeaderTokenEnvironmentVariable.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedHeaderTokenEnvironmentVariable.Core.MultipartFormRequest
        {
