...
public partial class ServiceClient : IServiceClient
{
    ...
    public async Task<Response> GetDirectThreadAsync(RequestOptions? options = null, CancellationToken cancellationToken = default) {
        var response = await _client.SendRequestAsync(new JsonRequest {BaseUrl = _client.Options.BaseUrl, Method = HttpMethod.Get, Path = "/partner-path", Options = options}, cancellationToken).ConfigureAwait(false);
