...
public partial class ServiceClient : IServiceClient
{
    ...
    /// );
    /// </code></example>
    public async Task<Response> GetDirectThreadAsync(GetDirectThreadRequest request, RequestOptions? options = null, CancellationToken cancellationToken = default) {
    ...
    public partial class RawAccessClient
    {
        ...
        public async Task<RawResponse<Response>> GetDirectThreadAsync(GetDirectThreadRequest request, RequestOptions? options = null, CancellationToken cancellationToken = default) {
            var _query = new Dictionary<string, object>();
            _query["ids"] = request.Ids;
            _query["tags"] = request.Tags;
            var response = await _client.SendRequestAsync(new JsonRequest {BaseUrl = _client.Options.BaseUrl, Method = HttpMethod.Get, Path = "", Query = _query, Options = options}, cancellationToken).ConfigureAwait(false);
