...
[![nuget shield](https://img.shields.io/nuget/v/Fernoauth-client-credentials-custom-prefix-openapi)](https://nuget.org/packages/Fernoauth-client-credentials-custom-prefix-openapi)
...
```sh
dotnet add package Fernoauth-client-credentials-custom-prefix-openapi
```
