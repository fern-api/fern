...
[![nuget shield](https://img.shields.io/nuget/v/Fernnullable-allof-extends)](https://nuget.org/packages/Fernnullable-allof-extends)
...
```sh
dotnet add package Fernnullable-allof-extends
```
...
var result = await client.CreateTestAsync(...).WithRawResponse();
...
var parsedData = await client.CreateTestAsync(...);
