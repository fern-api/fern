...
public partial interface ISeedApiClient
{
    ...
    /// </summary>
    WithRawResponseStream<StreamProtocolNoCollisionResponse> StreamProtocolNoCollisionAsync(
    ...
    /// </summary>
    WithRawResponseStream<StreamProtocolCollisionResponse> StreamProtocolCollisionAsync(
        StreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    );
    ...
    /// </summary>
    WithRawResponseStream<StreamDataContextResponse> StreamDataContextAsync(
        StreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    );
    ...
    /// </summary>
    WithRawResponseStream<StreamNoContextResponse> StreamNoContextAsync(
        StreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    );
    ...
    /// </summary>
    WithRawResponseStream<StreamProtocolWithFlatSchemaResponse> StreamProtocolWithFlatSchemaAsync(
        StreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    );
    ...
    /// </summary>
    WithRawResponseStream<Event> StreamOasSpecNativeAsync(
        StreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    );
    ...
    /// </summary>
    WithRawResponseStream<CompletionStreamChunk> StreamXFernStreamingConditionStreamAsync(
    ...
    /// </summary>
    WithRawResponseStream<CompletionStreamChunk> StreamXFernStreamingSharedSchemaStreamAsync(
    ...
    /// </summary>
    WithRawResponseStream<CompletionStreamChunk> StreamXFernStreamingUnionStreamAsync(
    ...
    /// </summary>
    WithRawResponseStream<CompletionStreamChunk> StreamXFernStreamingNullableConditionStreamAsync(
    ...
    /// </summary>
    WithRawResponseStream<string> StreamXFernStreamingSseOnlyAsync(
        StreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    );
