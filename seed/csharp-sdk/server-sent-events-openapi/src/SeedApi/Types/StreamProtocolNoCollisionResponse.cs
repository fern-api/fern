...
[JsonConverter(typeof(StreamProtocolNoCollisionResponse.JsonConverter))]
[Serializable]
public record StreamProtocolNoCollisionResponse
{
    internal StreamProtocolNoCollisionResponse(string type, object? value)
    {
        Event = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of StreamProtocolNoCollisionResponse with <see cref="StreamProtocolNoCollisionResponse.Heartbeat"/>.
    /// </summary>
    public StreamProtocolNoCollisionResponse(StreamProtocolNoCollisionResponse.Heartbeat value)
    {
        Event = "heartbeat";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of StreamProtocolNoCollisionResponse with <see cref="StreamProtocolNoCollisionResponse.StringData"/>.
    /// </summary>
    public StreamProtocolNoCollisionResponse(StreamProtocolNoCollisionResponse.StringData value)
    {
        Event = "string_data";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of StreamProtocolNoCollisionResponse with <see cref="StreamProtocolNoCollisionResponse.NumberData"/>.
    /// </summary>
    public StreamProtocolNoCollisionResponse(StreamProtocolNoCollisionResponse.NumberData value)
    {
        Event = "number_data";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of StreamProtocolNoCollisionResponse with <see cref="StreamProtocolNoCollisionResponse.ObjectData"/>.
    /// </summary>
    public StreamProtocolNoCollisionResponse(StreamProtocolNoCollisionResponse.ObjectData value)
    {
        Event = "object_data";
        Value = value.Value;
    }
    ...
    public SeedApi.ProtocolHeartbeat AsHeartbeat() =>
        IsHeartbeat
            ...
            : throw new global::System.Exception(
                "StreamProtocolNoCollisionResponse.Event is not 'heartbeat'"
            );
    ...
    public SeedApi.ProtocolStringEvent AsStringData() =>
        IsStringData
            ...
            : throw new global::System.Exception(
                "StreamProtocolNoCollisionResponse.Event is not 'string_data'"
            );
    ...
    public SeedApi.ProtocolNumberEvent AsNumberData() =>
        IsNumberData
            ...
            : throw new global::System.Exception(
                "StreamProtocolNoCollisionResponse.Event is not 'number_data'"
            );
    ...
    public SeedApi.ProtocolObjectEvent AsObjectData() =>
        IsObjectData
            ...
            : throw new global::System.Exception(
                "StreamProtocolNoCollisionResponse.Event is not 'object_data'"
            );
    ...
    public static implicit operator StreamProtocolNoCollisionResponse(
        StreamProtocolNoCollisionResponse.Heartbeat value
    ) => new(value);

    public static implicit operator StreamProtocolNoCollisionResponse(
        StreamProtocolNoCollisionResponse.StringData value
    ) => new(value);

    public static implicit operator StreamProtocolNoCollisionResponse(
        StreamProtocolNoCollisionResponse.NumberData value
    ) => new(value);

    public static implicit operator StreamProtocolNoCollisionResponse(
        StreamProtocolNoCollisionResponse.ObjectData value
    ) => new(value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<StreamProtocolNoCollisionResponse>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(StreamProtocolNoCollisionResponse).IsAssignableFrom(typeToConvert);

        public override StreamProtocolNoCollisionResponse Read(
        ...
        )
        {
            ...
            return new StreamProtocolNoCollisionResponse(discriminator, value);
        }

        public override void Write(
            Utf8JsonWriter writer,
            StreamProtocolNoCollisionResponse value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
        ...
        public override StreamProtocolNoCollisionResponse ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new StreamProtocolNoCollisionResponse(stringValue, stringValue);
        }
    ...
    public struct Heartbeat
    {
        ...
        public static implicit operator StreamProtocolNoCollisionResponse.Heartbeat(
            SeedApi.ProtocolHeartbeat value
        ) => new(value);
    }
    ...
    public struct StringData
    {
        ...
        public static implicit operator StreamProtocolNoCollisionResponse.StringData(
            SeedApi.ProtocolStringEvent value
        ) => new(value);
    }
    ...
    public struct NumberData
    {
        ...
        public static implicit operator StreamProtocolNoCollisionResponse.NumberData(
            SeedApi.ProtocolNumberEvent value
        ) => new(value);
    }
    ...
    public struct ObjectData
    {
        ...
        public static implicit operator StreamProtocolNoCollisionResponse.ObjectData(
            SeedApi.ProtocolObjectEvent value
        ) => new(value);
    }
}
