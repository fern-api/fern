...
/// </summary>
[JsonConverter(typeof(UnionStreamRequest.JsonConverter))]
[Serializable]
public record UnionStreamRequest
{
    internal UnionStreamRequest(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of UnionStreamRequest with <see cref="UnionStreamRequest.Message"/>.
    /// </summary>
    public UnionStreamRequest(UnionStreamRequest.Message value)
    {
        Type = "message";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of UnionStreamRequest with <see cref="UnionStreamRequest.Interrupt"/>.
    /// </summary>
    public UnionStreamRequest(UnionStreamRequest.Interrupt value)
    {
        Type = "interrupt";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of UnionStreamRequest with <see cref="UnionStreamRequest.Compact"/>.
    /// </summary>
    public UnionStreamRequest(UnionStreamRequest.Compact value)
    {
        Type = "compact";
        Value = value.Value;
    }
    ...
    public SeedApi.UnionStreamMessageVariant AsMessage() =>
        IsMessage
            ...
            : throw new global::System.Exception("UnionStreamRequest.Type is not 'message'");
    ...
    public SeedApi.UnionStreamInterruptVariant AsInterrupt() =>
        IsInterrupt
            ...
            : throw new global::System.Exception("UnionStreamRequest.Type is not 'interrupt'");
    ...
    public SeedApi.UnionStreamCompactVariant AsCompact() =>
        IsCompact
            ...
            : throw new global::System.Exception("UnionStreamRequest.Type is not 'compact'");
    ...
    public static implicit operator UnionStreamRequest(UnionStreamRequest.Message value) =>
        new(value);

    public static implicit operator UnionStreamRequest(UnionStreamRequest.Interrupt value) =>
        new(value);

    public static implicit operator UnionStreamRequest(UnionStreamRequest.Compact value) =>
        new(value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<UnionStreamRequest>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(UnionStreamRequest).IsAssignableFrom(typeToConvert);

        public override UnionStreamRequest Read(
        ...
        )
        {
            ...
            return new UnionStreamRequest(discriminator, value);
        }

        public override void Write(
            Utf8JsonWriter writer,
            UnionStreamRequest value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
        ...
        public override UnionStreamRequest ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new UnionStreamRequest(stringValue, stringValue);
        }
    ...
    public struct Message
    {
        ...
        public static implicit operator UnionStreamRequest.Message(
            SeedApi.UnionStreamMessageVariant value
        ) => new(value);
    }
    ...
    public struct Interrupt
    {
        ...
        public static implicit operator UnionStreamRequest.Interrupt(
            SeedApi.UnionStreamInterruptVariant value
        ) => new(value);
    }
    ...
    public struct Compact
    {
        ...
        public static implicit operator UnionStreamRequest.Compact(
            SeedApi.UnionStreamCompactVariant value
        ) => new(value);
    }
}
