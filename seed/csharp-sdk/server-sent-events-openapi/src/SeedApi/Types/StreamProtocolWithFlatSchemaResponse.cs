...
[JsonConverter(typeof(StreamProtocolWithFlatSchemaResponse.JsonConverter))]
[Serializable]
public record StreamProtocolWithFlatSchemaResponse
{
    internal StreamProtocolWithFlatSchemaResponse(string type, object? value)
    {
        Event = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of StreamProtocolWithFlatSchemaResponse with <see cref="StreamProtocolWithFlatSchemaResponse.Heartbeat"/>.
    /// </summary>
    public StreamProtocolWithFlatSchemaResponse(
        StreamProtocolWithFlatSchemaResponse.Heartbeat value
    )
    {
        Event = "heartbeat";
        Value = value.Value;
    ...
    /// <summary>
    /// Create an instance of StreamProtocolWithFlatSchemaResponse with <see cref="StreamProtocolWithFlatSchemaResponse.Entity"/>.
    /// </summary>
    public StreamProtocolWithFlatSchemaResponse(StreamProtocolWithFlatSchemaResponse.Entity value)
    {
        Event = "entity";
        Value = value.Value;
    }
    ...
    public SeedApi.DataContextHeartbeat AsHeartbeat() =>
        IsHeartbeat
            ...
            : throw new global::System.Exception(
                "StreamProtocolWithFlatSchemaResponse.Event is not 'heartbeat'"
            );
    ...
    public SeedApi.DataContextEntityEvent AsEntity() =>
        IsEntity
            ...
            : throw new global::System.Exception(
                "StreamProtocolWithFlatSchemaResponse.Event is not 'entity'"
            );
    ...
    public static implicit operator StreamProtocolWithFlatSchemaResponse(
        StreamProtocolWithFlatSchemaResponse.Heartbeat value
    ) => new(value);

    public static implicit operator StreamProtocolWithFlatSchemaResponse(
        StreamProtocolWithFlatSchemaResponse.Entity value
    ) => new(value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<StreamProtocolWithFlatSchemaResponse>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(StreamProtocolWithFlatSchemaResponse).IsAssignableFrom(typeToConvert);

        public override StreamProtocolWithFlatSchemaResponse Read(
        ...
        )
        {
            ...
            return new StreamProtocolWithFlatSchemaResponse(discriminator, value);
        }

        public override void Write(
            Utf8JsonWriter writer,
            StreamProtocolWithFlatSchemaResponse value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
        ...
        public override StreamProtocolWithFlatSchemaResponse ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new StreamProtocolWithFlatSchemaResponse(stringValue, stringValue);
        }
    ...
    public struct Heartbeat
    {
        ...
        public static implicit operator StreamProtocolWithFlatSchemaResponse.Heartbeat(
            SeedApi.DataContextHeartbeat value
        ) => new(value);
    }
    ...
    public struct Entity
    {
        ...
        public static implicit operator StreamProtocolWithFlatSchemaResponse.Entity(
            SeedApi.DataContextEntityEvent value
        ) => new(value);
    }
}
