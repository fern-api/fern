...
[JsonConverter(typeof(StreamDataContextResponse.JsonConverter))]
[Serializable]
public record StreamDataContextResponse
{
    internal StreamDataContextResponse(string type, object? value)
    {
        Event = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of StreamDataContextResponse with <see cref="StreamDataContextResponse.Heartbeat"/>.
    /// </summary>
    public StreamDataContextResponse(StreamDataContextResponse.Heartbeat value)
    {
        Event = "heartbeat";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of StreamDataContextResponse with <see cref="StreamDataContextResponse.Entity"/>.
    /// </summary>
    public StreamDataContextResponse(StreamDataContextResponse.Entity value)
    {
        Event = "entity";
        Value = value.Value;
    }
    ...
    public SeedApi.DataContextHeartbeat AsHeartbeat() =>
        IsHeartbeat
            ...
            : throw new global::System.Exception(
                "StreamDataContextResponse.Event is not 'heartbeat'"
            );
    ...
    public SeedApi.DataContextEntityEvent AsEntity() =>
        IsEntity
            ...
            : throw new global::System.Exception("StreamDataContextResponse.Event is not 'entity'");
    ...
    public static implicit operator StreamDataContextResponse(
        StreamDataContextResponse.Heartbeat value
    ) => new(value);

    public static implicit operator StreamDataContextResponse(
        StreamDataContextResponse.Entity value
    ) => new(value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<StreamDataContextResponse>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(StreamDataContextResponse).IsAssignableFrom(typeToConvert);

        public override StreamDataContextResponse Read(
        ...
        )
        {
            ...
            return new StreamDataContextResponse(discriminator, value);
        }

        public override void Write(
            Utf8JsonWriter writer,
            StreamDataContextResponse value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
        ...
        public override StreamDataContextResponse ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new StreamDataContextResponse(stringValue, stringValue);
        }
    ...
    public struct Heartbeat
    {
        ...
        public static implicit operator StreamDataContextResponse.Heartbeat(
            SeedApi.DataContextHeartbeat value
        ) => new(value);
    }
    ...
    public struct Entity
    {
        ...
        public static implicit operator StreamDataContextResponse.Entity(
            SeedApi.DataContextEntityEvent value
        ) => new(value);
    }
}
