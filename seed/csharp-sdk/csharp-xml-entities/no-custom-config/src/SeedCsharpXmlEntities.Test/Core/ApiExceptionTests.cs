...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedCsharpXmlEntitiesApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedCsharpXmlEntitiesApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedCsharpXmlEntities.SeedCsharpXmlEntitiesApiException")
        );
    }
    ...
    {
        var exception = new SeedCsharpXmlEntitiesApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedCsharpXmlEntitiesApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedCsharpXmlEntitiesApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedCsharpXmlEntitiesApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedCsharpXmlEntitiesApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedCsharpXmlEntitiesApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedCsharpXmlEntitiesApiException("Error", 400, "");
    ...
    {
        var exception = new SeedCsharpXmlEntitiesApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedCsharpXmlEntitiesApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedCsharpXmlEntitiesApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedCsharpXmlEntitiesApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedCsharpXmlEntitiesException>());
