...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedCsharpXmlEntities.Core.ApiResponse> MakeRequestAsync(
        global::SeedCsharpXmlEntities.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedCsharpXmlEntities.Core.ApiResponse> SendRequestAsync(
        global::SeedCsharpXmlEntities.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedCsharpXmlEntities.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedCsharpXmlEntities.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedCsharpXmlEntities.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedCsharpXmlEntities.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedCsharpXmlEntities.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedCsharpXmlEntities.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedCsharpXmlEntities.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedCsharpXmlEntities.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedCsharpXmlEntities.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedCsharpXmlEntities.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedCsharpXmlEntities.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedCsharpXmlEntities.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedCsharpXmlEntities.Core.StreamRequest;
}
