...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedCsharpXmlEntities.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedCsharpXmlEntities.Core.ApiResponse> SendRequestAsync(
        global::SeedCsharpXmlEntities.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedCsharpXmlEntities.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
