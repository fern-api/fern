...
[![nuget shield](https://img.shields.io/nuget/v/SeedCsharpXmlEntities)](https://nuget.org/packages/SeedCsharpXmlEntities)
...
```sh
dotnet add package SeedCsharpXmlEntities
```
...
var data = await client.GetTimeZoneAsync(...);
```
