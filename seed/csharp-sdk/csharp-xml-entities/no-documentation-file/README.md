...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-xml-entities)](https://nuget.org/packages/Ferncsharp-xml-entities)
...
```sh
dotnet add package Ferncsharp-xml-entities
```
...
} catch (SeedCsharpXmlEntitiesApiException e) {
...
var result = await client.GetTimeZoneAsync(...).WithRawResponse();
...
var parsedData = await client.GetTimeZoneAsync(...);
