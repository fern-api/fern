...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedCsharpOauthTokenRequiredGrantType.Core.ApiResponse> SendRequestAsync(
        global::SeedCsharpOauthTokenRequiredGrantType.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedCsharpOauthTokenRequiredGrantType.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::SeedCsharpOauthTokenRequiredGrantType.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::SeedCsharpOauthTokenRequiredGrantType.Core.BaseRequest request)
    {
