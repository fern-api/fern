...
public partial class AuthClient : IAuthClient
{
    ...
    {
        var _queryString =
            new SeedCsharpOauthTokenRequiredGrantType.Core.QueryStringBuilder.Builder(capacity: 0)
                .MergeAdditional(options?.AdditionalQueryParameters)
                .Build();
        var _headers = await new SeedCsharpOauthTokenRequiredGrantType.Core.HeadersBuilder.Builder()
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                {
                    Data = responseData,
                    RawResponse = new SeedCsharpOauthTokenRequiredGrantType.RawResponse()
                    {
            ...
            {
                throw new SeedCsharpOauthTokenRequiredGrantTypeApiException(
