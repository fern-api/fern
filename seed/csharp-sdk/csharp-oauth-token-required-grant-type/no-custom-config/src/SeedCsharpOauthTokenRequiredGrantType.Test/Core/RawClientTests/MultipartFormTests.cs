...
public class MultipartFormTests
{
    ...
    private static SeedCsharpOauthTokenRequiredGrantType.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedCsharpOauthTokenRequiredGrantType.Core.MultipartFormRequest
        {
