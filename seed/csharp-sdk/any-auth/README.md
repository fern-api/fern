...
[![nuget shield](https://img.shields.io/nuget/v/SeedAnyAuth)](https://nuget.org/packages/SeedAnyAuth)
...
```sh
dotnet add package SeedAnyAuth
```
...
var client = new SeedAnyAuth.SeedAnyAuthClient("TOKEN");
