...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedAnyAuthApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedAnyAuthApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedAnyAuth.SeedAnyAuthApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SeedAnyAuthApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedAnyAuthApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedAnyAuthApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedAnyAuthApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedAnyAuthApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedAnyAuthApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedAnyAuthApiException("Error", 400, "");
    ...
    {
        var exception = new SeedAnyAuthApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SeedAnyAuthApiException(
            "Service Unavailable",
            503,
            "gateway timeout",
            inner
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedAnyAuthApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedAnyAuthApiException("Error: \"quotes\" & <brackets>", 400, "body");
    ...
    {
        var exception = new SeedAnyAuthApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedAnyAuthApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedAnyAuthException>());
