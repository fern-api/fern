...
public partial class SeedAnyAuthClient : ISeedAnyAuthClient
{
    ...
    {
        var explicitOAuthAuth = clientId != null || clientSecret != null;
        var explicitBasicAuth = username != null || password != null;
        ...
        if (clientId != null && clientSecret != null && (explicitOAuthAuth || !explicitBasicAuth))
        {
