...
[![nuget shield](https://img.shields.io/nuget/v/SeedInferredAuthImplicit)](https://nuget.org/packages/SeedInferredAuthImplicit)
...
```sh
dotnet add package SeedInferredAuthImplicit
```
