...
namespace SeedAuthEnvironmentVariables.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedAuthEnvironmentVariables.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedAuthEnvironmentVariables.Core.MultipartFormRequest
        {
