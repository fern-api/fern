...
[![nuget shield](https://img.shields.io/nuget/v/Fernquery-parameters-openapi)](https://nuget.org/packages/Fernquery-parameters-openapi)
...
```sh
dotnet add package Fernquery-parameters-openapi
```
