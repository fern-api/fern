...
[![nuget shield](https://img.shields.io/nuget/v/SeedErrorProperty)](https://nuget.org/packages/SeedErrorProperty)
...
```sh
dotnet add package SeedErrorProperty
```
...
var client = new SeedErrorProperty.SeedErrorPropertyClient();
