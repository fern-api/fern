...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedErrorProperty.Core.ApiResponse> MakeRequestAsync(
        SeedErrorProperty.Core.BaseRequest request,
    ...
    internal async Task<SeedErrorProperty.Core.ApiResponse> SendRequestAsync(
        SeedErrorProperty.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedErrorProperty.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedErrorProperty.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedErrorProperty.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedErrorProperty.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedErrorProperty.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedErrorProperty.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedErrorProperty.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedErrorProperty.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedErrorProperty.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedErrorProperty.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedErrorProperty.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedErrorProperty.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedErrorProperty.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedErrorProperty.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedErrorProperty.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedErrorProperty.Core.StreamRequest;
}
