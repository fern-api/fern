...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedErrorPropertyApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedErrorPropertyApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedErrorProperty.SeedErrorPropertyApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SeedErrorPropertyApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedErrorPropertyApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedErrorPropertyApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedErrorPropertyApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedErrorPropertyApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedErrorPropertyApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedErrorPropertyApiException("Error", 400, "");
    ...
    {
        var exception = new SeedErrorPropertyApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SeedErrorPropertyApiException(
            "Service Unavailable",
            503,
            "gateway timeout",
            inner
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedErrorPropertyApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedErrorPropertyApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedErrorPropertyApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedErrorPropertyException>());
