...
public class MyUnion
{
    ...
    /// <summary>
    /// Factory method to create a union from a <see cref="IEnumerable{Int32}"/> value.
    /// </summary>
    public static MyUnion FromListOfInt(IEnumerable<int> value) => new("list_1", value);

    /// <summary>
    /// Factory method to create a union from a <c>IEnumerable&lt;IEnumerable&lt;int&gt;&gt;</c> value.
    /// </summary>
    ...
    /// <summary>
    /// Returns the value as a <see cref="IEnumerable{Int32}"/> if <see cref="Type"/> is 'list_1', otherwise throws an exception.
    /// </summary>
    ...
    /// <summary>
    /// Returns the value as a <c>IEnumerable&lt;IEnumerable&lt;int&gt;&gt;</c> if <see cref="Type"/> is 'list_2', otherwise throws an exception.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="IEnumerable{Int32}"/> and returns true if successful.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to cast the value to a <c>IEnumerable&lt;IEnumerable&lt;int&gt;&gt;</c> and returns true if successful.
    /// </summary>
