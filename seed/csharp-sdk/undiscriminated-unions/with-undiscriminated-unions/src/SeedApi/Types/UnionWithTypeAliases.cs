...
public class UnionWithTypeAliases
{
    ...
    /// </summary>
    /// <exception cref="SeedApiException">Thrown when <see cref="Type"/> is not 'userId'.</exception>
    public string AsUserId() =>
        IsUserId() ? (string)Value! : throw new SeedApiException("Union type is not 'userId'");

    /// <summary>
    /// Returns the value as a <see cref="string"/> if <see cref="Type"/> is 'name', otherwise throws an exception.
    /// </summary>
    /// <exception cref="SeedApiException">Thrown when <see cref="Type"/> is not 'name'.</exception>
    public string AsName() =>
        IsName() ? (string)Value! : throw new SeedApiException("Union type is not 'name'");
