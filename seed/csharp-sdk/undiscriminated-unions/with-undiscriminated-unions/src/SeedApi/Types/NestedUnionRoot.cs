...
public class NestedUnionRoot
{
    ...
    /// <summary>
    /// Factory method to create a union from a SeedApi.NestedUnionL1 value.
    /// </summary>
    public static NestedUnionRoot FromNestedUnionL1(SeedApi.NestedUnionL1 value) =>
    ...
    /// <summary>
    /// Returns the value as a <see cref="SeedApi.NestedUnionL1"/> if <see cref="Type"/> is 'nestedUnionL1', otherwise throws an exception.
    /// </summary>
    /// <exception cref="SeedApiException">Thrown when <see cref="Type"/> is not 'nestedUnionL1'.</exception>
    public SeedApi.NestedUnionL1 AsNestedUnionL1() =>
        IsNestedUnionL1()
            ? (SeedApi.NestedUnionL1)Value!
            : throw new SeedApiException("Union type is not 'nestedUnionL1'");
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="SeedApi.NestedUnionL1"/> and returns true if successful.
    /// </summary>
    public bool TryGetNestedUnionL1(out SeedApi.NestedUnionL1? value)
    {
        if (Type == "nestedUnionL1")
        {
            value = (SeedApi.NestedUnionL1)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    public T Match<T>(
        ...
        Func<SeedApi.NestedUnionL1, T> onNestedUnionL1
    )
    {
        return Type switch
        {
    ...
    public void Visit(
        ...
        Action<SeedApi.NestedUnionL1> onNestedUnionL1
    )
    {
        switch (Type)
        {
    ...
    public static implicit operator NestedUnionRoot(SeedApi.NestedUnionL1 value) =>
        new("nestedUnionL1", value);
    ...
    internal sealed class JsonConverter : JsonConverter<NestedUnionRoot>
    {
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.StartObject)
            {
                ...
                var types = new (string Key, System.Type Type)[]
                {
                    ("nestedUnionL1", typeof(SeedApi.NestedUnionL1)),
                };
