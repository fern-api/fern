...
public class MetadataUnion
{
    ...
    /// <summary>
    /// Factory method to create a union from a SeedApi.NamedMetadata value.
    /// </summary>
    public static MetadataUnion FromNamedMetadata(SeedApi.NamedMetadata value) =>
    ...
    /// </summary>
    /// <exception cref="SeedApiException">Thrown when <see cref="Type"/> is not 'optionalMetadata'.</exception>
    public Dictionary<string, object?>? AsOptionalMetadata() =>
        IsOptionalMetadata()
            ? (Dictionary<string, object?>?)Value!
            : throw new SeedApiException("Union type is not 'optionalMetadata'");

    /// <summary>
    /// Returns the value as a <see cref="SeedApi.NamedMetadata"/> if <see cref="Type"/> is 'namedMetadata', otherwise throws an exception.
    /// </summary>
    /// <exception cref="SeedApiException">Thrown when <see cref="Type"/> is not 'namedMetadata'.</exception>
    public SeedApi.NamedMetadata AsNamedMetadata() =>
        IsNamedMetadata()
            ? (SeedApi.NamedMetadata)Value!
            : throw new SeedApiException("Union type is not 'namedMetadata'");
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="SeedApi.NamedMetadata"/> and returns true if successful.
    /// </summary>
    public bool TryGetNamedMetadata(out SeedApi.NamedMetadata? value)
    {
        if (Type == "namedMetadata")
        {
            value = (SeedApi.NamedMetadata)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    public T Match<T>(
        ...
        Func<SeedApi.NamedMetadata, T> onNamedMetadata
    )
    {
        return Type switch
        {
    ...
    public void Visit(
        ...
        Action<SeedApi.NamedMetadata> onNamedMetadata
    )
    {
        switch (Type)
        {
    ...
    public static implicit operator MetadataUnion(SeedApi.NamedMetadata value) =>
        new("namedMetadata", value);
    ...
    internal sealed class JsonConverter : JsonConverter<MetadataUnion>
    {
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.StartObject)
            {
                ...
                {
                    ("namedMetadata", typeof(SeedApi.NamedMetadata)),
