...
public class NestedUnionL2
{
    ...
    public T Match<T>(Func<bool, T> onBool, Func<IEnumerable<string>, T> onListOfString)
    {
        return Type switch
        {
            "bool" => onBool(AsBool()),
    ...
    public void Visit(Action<bool> onBool, Action<IEnumerable<string>> onListOfString)
    {
        switch (Type)
        {
            case "bool":
