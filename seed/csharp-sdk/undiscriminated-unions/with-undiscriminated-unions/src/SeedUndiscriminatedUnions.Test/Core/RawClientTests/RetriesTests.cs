...
namespace SeedUndiscriminatedUnions.Test.Core.RawClientTests;
...
public class RetriesTests
{
    ...
    public async SystemTask SendRequestAsync_ShouldRetry_OnRetryableStatusCodes(int statusCode)
    {
        ...
        var request = new SeedUndiscriminatedUnions.Core.EmptyRequest
        {
            BaseUrl = _baseUrl,
    ...
    public async SystemTask SendRequestAsync_ShouldRetry_OnNonRetryableStatusCodes(int statusCode)
    {
        ...
        var request = new SeedUndiscriminatedUnions.Core.JsonRequest
        {
            BaseUrl = _baseUrl,
            Method = HttpMethod.Get,
            Path = "/test",
    ...
    public async SystemTask SendRequestAsync_ShouldNotRetry_WithStreamRequest()
    {
        ...
        var request = new SeedUndiscriminatedUnions.Core.StreamRequest
        {
            BaseUrl = _baseUrl,
    ...
    public async SystemTask SendRequestAsync_ShouldNotRetry_WithMultiPartFormRequest_WithStream()
    {
        ...
        var request = new SeedUndiscriminatedUnions.Core.MultipartFormRequest
        {
            BaseUrl = _baseUrl,
            Method = HttpMethod.Post,
            Path = "/test",
