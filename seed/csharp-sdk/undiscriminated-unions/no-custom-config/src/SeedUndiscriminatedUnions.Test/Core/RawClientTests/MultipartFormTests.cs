...
public class MultipartFormTests
{
    ...
    private static SeedUndiscriminatedUnions.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedUndiscriminatedUnions.Core.MultipartFormRequest
        {
