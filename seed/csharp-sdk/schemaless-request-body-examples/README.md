...
[![nuget shield](https://img.shields.io/nuget/v/Fernschemaless-request-body-examples)](https://nuget.org/packages/Fernschemaless-request-body-examples)
...
```sh
dotnet add package Fernschemaless-request-body-examples
```
...
var result = await client.CreatePlantAsync(...).WithRawResponse();
...
var parsedData = await client.CreatePlantAsync(...);
