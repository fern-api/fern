...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedNoRetries.Core.ApiResponse> MakeRequestAsync(
        global::SeedNoRetries.Core.BaseRequest request,
    ...
    internal async Task<global::SeedNoRetries.Core.ApiResponse> SendRequestAsync(
        global::SeedNoRetries.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedNoRetries.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    internal HttpRequestMessage CreateHttpRequest(global::SeedNoRetries.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedNoRetries.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedNoRetries.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedNoRetries.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedNoRetries.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedNoRetries.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedNoRetries.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedNoRetries.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedNoRetries.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedNoRetries.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : global::SeedNoRetries.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedNoRetries.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedNoRetries.Core.StreamRequest;
}
