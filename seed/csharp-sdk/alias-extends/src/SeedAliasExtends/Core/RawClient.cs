...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedAliasExtends.Core.ApiResponse> MakeRequestAsync(
        SeedAliasExtends.Core.BaseRequest request,
    ...
    internal async Task<SeedAliasExtends.Core.ApiResponse> SendRequestAsync(
        SeedAliasExtends.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedAliasExtends.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedAliasExtends.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedAliasExtends.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedAliasExtends.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedAliasExtends.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedAliasExtends.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedAliasExtends.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedAliasExtends.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedAliasExtends.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedAliasExtends.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedAliasExtends.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedAliasExtends.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedAliasExtends.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedAliasExtends.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedAliasExtends.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedAliasExtends.Core.StreamRequest;
}
