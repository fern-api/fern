...
[![nuget shield](https://img.shields.io/nuget/v/SeedSingleUrlEnvironmentNoDefault)](https://nuget.org/packages/SeedSingleUrlEnvironmentNoDefault)
...
```sh
dotnet add package SeedSingleUrlEnvironmentNoDefault
```
