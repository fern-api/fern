...
namespace SeedSingleUrlEnvironmentNoDefault.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedSingleUrlEnvironmentNoDefault.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedSingleUrlEnvironmentNoDefault.Core.MultipartFormRequest
        {
