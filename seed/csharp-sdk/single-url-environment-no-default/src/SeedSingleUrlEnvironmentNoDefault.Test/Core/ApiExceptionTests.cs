...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedSingleUrlEnvironmentNoDefaultApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    {
        var exception = new SeedSingleUrlEnvironmentNoDefaultApiException("Error", 500, "body");
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedSingleUrlEnvironmentNoDefault.SeedSingleUrlEnvironmentNoDefaultApiException"
            )
        );
    }
    ...
    {
        var exception = new SeedSingleUrlEnvironmentNoDefaultApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedSingleUrlEnvironmentNoDefaultApiException("Error", 500, 42);
    ...
    {
        var exception = new SeedSingleUrlEnvironmentNoDefaultApiException("Error", 400, "");
    ...
    {
        var exception = new SeedSingleUrlEnvironmentNoDefaultApiException("Error", 400, false);
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedSingleUrlEnvironmentNoDefaultException>());
