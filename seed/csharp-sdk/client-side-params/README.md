...
[![nuget shield](https://img.shields.io/nuget/v/Fernclient-side-params)](https://nuget.org/packages/Fernclient-side-params)
...
```sh
dotnet add package Fernclient-side-params
```
