...
public class ListclientsTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_2()
    {
        ...
        Server
            .Given(WireMock.RequestBuilders.Request.Create().WithPath("/api/clients").UsingGet())
            .RespondWith(
                WireMock
                    .ResponseBuilders.Response.Create()
                    .WithStatusCode(200)
        ...
        var response = await Client.Service.ListclientsAsync(new ServiceListClientsRequest());
        JsonAssert.AreEqual(response, mockResponse);
    }
}
