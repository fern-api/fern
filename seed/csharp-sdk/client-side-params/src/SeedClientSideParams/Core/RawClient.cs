...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedClientSideParams.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedClientSideParams.Core.ApiResponse> SendRequestAsync(
        global::SeedClientSideParams.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedClientSideParams.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
