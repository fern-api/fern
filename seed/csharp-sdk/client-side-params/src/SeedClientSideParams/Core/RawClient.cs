...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedClientSideParams.Core.ApiResponse> MakeRequestAsync(
        global::SeedClientSideParams.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedClientSideParams.Core.ApiResponse> SendRequestAsync(
        global::SeedClientSideParams.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedClientSideParams.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedClientSideParams.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedClientSideParams.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedClientSideParams.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedClientSideParams.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedClientSideParams.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedClientSideParams.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedClientSideParams.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedClientSideParams.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedClientSideParams.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedClientSideParams.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedClientSideParams.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedClientSideParams.Core.StreamRequest;
}
