...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedEnum.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedEnum.Core.ApiResponse> SendRequestAsync(
        global::SeedEnum.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedEnum.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
