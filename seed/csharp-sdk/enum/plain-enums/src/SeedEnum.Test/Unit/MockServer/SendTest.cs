...
public class SendTest : BaseMockServerTest
{
    ...
    public void MockServerTest_1() {
        ...
        Server.Given(WireMock.RequestBuilders.Request.Create().WithPath("/query").WithParam("operand", ">").WithParam("maybeOperand", ">").WithParam("operandOrColor", "red").UsingPost())
    ...
    public void MockServerTest_2() {
        ...
        Assert.DoesNotThrowAsync(async () => await Client.QueryParam.SendAsync(new SendEnumAsQueryParamRequest{ 
                Operand = Operand.GreaterThan, OperandOrColor = Color.Red
            }, RequestOptions));}
