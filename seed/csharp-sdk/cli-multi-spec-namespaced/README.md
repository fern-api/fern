...
[![nuget shield](https://img.shields.io/nuget/v/Ferncli-multi-spec-namespaced)](https://nuget.org/packages/Ferncli-multi-spec-namespaced)
...
```sh
dotnet add package Ferncli-multi-spec-namespaced
```
...
var client = new SeedApiClient("TOKEN", "API_KEY");
...
var result = await client.V1.ListUsersAsync(...).WithRawResponse();
...
var data = await client.V1.ListUsersAsync(...);
