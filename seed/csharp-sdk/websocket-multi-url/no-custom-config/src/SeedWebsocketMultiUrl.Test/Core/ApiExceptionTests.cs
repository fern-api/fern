...
using SeedWebsocketMultiUrl;

namespace SeedWebsocketMultiUrl.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedWebsocketMultiUrlApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedWebsocketMultiUrlApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedWebsocketMultiUrl.SeedWebsocketMultiUrlApiException")
        );
    }
    ...
    {
        var exception = new SeedWebsocketMultiUrlApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedWebsocketMultiUrlApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedWebsocketMultiUrlApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedWebsocketMultiUrlApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedWebsocketMultiUrlApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedWebsocketMultiUrlApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedWebsocketMultiUrlApiException("Error", 400, "");
    ...
    {
        var exception = new SeedWebsocketMultiUrlApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedWebsocketMultiUrlApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedWebsocketMultiUrlApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedWebsocketMultiUrlApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedWebsocketMultiUrlException>());
