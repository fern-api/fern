...
[System.Text.Json.Serialization.JsonConverter(typeof(Test.JsonConverter))]
[Serializable]
public record Test
{
    ...
    [Serializable]
    internal sealed class JsonConverter : System.Text.Json.Serialization.JsonConverter<Test>
    {
