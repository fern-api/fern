...
public record TypeWithSingleCharPropertyEqualToTypeStartingLetter
{
        ...
        : JsonConverter<TypeWithSingleCharPropertyEqualToTypeStartingLetter>
    {
        ...
        public override TypeWithSingleCharPropertyEqualToTypeStartingLetter ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return JsonSerializer.Deserialize<TypeWithSingleCharPropertyEqualToTypeStartingLetter>(
                json,
                options
            );
        }
