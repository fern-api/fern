...
public record Directory
{
    ...
    internal sealed class JsonConverter : JsonConverter<Directory>
    {
        ...
        )
        {
            ...
            IEnumerable<File>? _files = default;
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                switch (propertyName)
                {
                    case "name":
                        ...
                        break;
                    case "files":
                        _files = JsonSerializer.Deserialize<IEnumerable<File>?>(
                            ref reader,
                            options
                        );
                        break;
        ...
        public override Directory ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return JsonSerializer.Deserialize<Directory>(json, options);
        }
