...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedServerSentEvents.Core.ApiResponse> MakeRequestAsync(
        global::SeedServerSentEvents.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedServerSentEvents.Core.ApiResponse> SendRequestAsync(
        global::SeedServerSentEvents.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedServerSentEvents.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedServerSentEvents.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedServerSentEvents.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedServerSentEvents.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedServerSentEvents.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedServerSentEvents.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedServerSentEvents.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedServerSentEvents.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedServerSentEvents.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedServerSentEvents.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedServerSentEvents.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedServerSentEvents.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedServerSentEvents.Core.StreamRequest;
}
