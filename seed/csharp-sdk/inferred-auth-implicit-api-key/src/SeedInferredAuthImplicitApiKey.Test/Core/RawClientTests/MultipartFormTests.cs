...
public class MultipartFormTests
{
    ...
    private static SeedInferredAuthImplicitApiKey.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedInferredAuthImplicitApiKey.Core.MultipartFormRequest
        {
