...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedInferredAuthImplicitApiKeyApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    {
        var exception = new SeedInferredAuthImplicitApiKeyApiException("Error", 500, "body");
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedInferredAuthImplicitApiKey.SeedInferredAuthImplicitApiKeyApiException"
            )
        );
    }
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedInferredAuthImplicitApiKeyApiException("Unauthorized", 401, body);
    ...
    {
        var exception = new SeedInferredAuthImplicitApiKeyApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedInferredAuthImplicitApiKeyApiException("Error", 500, 42);
    ...
    {
        var exception = new SeedInferredAuthImplicitApiKeyApiException("Error", 400, "");
    ...
    {
        var exception = new SeedInferredAuthImplicitApiKeyApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedInferredAuthImplicitApiKeyApiException("Error", 500, "body", inner);
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedInferredAuthImplicitApiKeyException>());
