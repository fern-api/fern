...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedInferredAuthImplicitApiKey.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedInferredAuthImplicitApiKey.Core.ApiResponse> SendRequestAsync(
        global::SeedInferredAuthImplicitApiKey.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedInferredAuthImplicitApiKey.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
