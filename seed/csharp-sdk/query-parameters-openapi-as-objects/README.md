...
[![nuget shield](https://img.shields.io/nuget/v/Fernquery-parameters-openapi-as-objects)](https://nuget.org/packages/Fernquery-parameters-openapi-as-objects)
...
```sh
dotnet add package Fernquery-parameters-openapi-as-objects
```
