...
[![nuget shield](https://img.shields.io/nuget/v/Fernquery-parameters)](https://nuget.org/packages/Fernquery-parameters)
...
```sh
dotnet add package Fernquery-parameters
```
...
var parsedData = await client.User.GetUsernameAsync(...);
