...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedBasicAuthPwOmitted.Core.ApiResponse> SendRequestAsync(
        global::SeedBasicAuthPwOmitted.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedBasicAuthPwOmitted.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    private string BuildUrl(global::SeedBasicAuthPwOmitted.Core.BaseRequest request)
    {
