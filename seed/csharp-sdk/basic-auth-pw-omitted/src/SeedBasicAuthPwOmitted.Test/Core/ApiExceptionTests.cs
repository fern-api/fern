...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedBasicAuthPwOmittedApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedBasicAuthPwOmittedApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedBasicAuthPwOmitted.SeedBasicAuthPwOmittedApiException")
        );
    }
    ...
    {
        var exception = new SeedBasicAuthPwOmittedApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedBasicAuthPwOmittedApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedBasicAuthPwOmittedApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedBasicAuthPwOmittedApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedBasicAuthPwOmittedApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedBasicAuthPwOmittedApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedBasicAuthPwOmittedApiException("Error", 400, "");
    ...
    {
        var exception = new SeedBasicAuthPwOmittedApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedBasicAuthPwOmittedApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedBasicAuthPwOmittedApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedBasicAuthPwOmittedApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedBasicAuthPwOmittedException>());
