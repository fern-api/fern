...
[![nuget shield](https://img.shields.io/nuget/v/Fernbasic-auth-pw-omitted)](https://nuget.org/packages/Fernbasic-auth-pw-omitted)
...
```sh
dotnet add package Fernbasic-auth-pw-omitted
```
