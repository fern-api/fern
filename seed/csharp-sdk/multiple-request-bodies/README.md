...
[![nuget shield](https://img.shields.io/nuget/v/Fernmultiple-request-bodies)](https://nuget.org/packages/Fernmultiple-request-bodies)
...
```sh
dotnet add package Fernmultiple-request-bodies
```
...
var parsedData = await client.UploadJsonDocumentAsync(...);
