...
public class GetAndReturnNestedWithOptionalFieldTest : BaseWireTest
{
    ...
    public async Task WireTest() {
        ...
        var response = await Client.Endpoints.Object.GetAndReturnNestedWithOptionalFieldAsync(new NestedObjectWithOptionalFieldnew NestedObjectWithOptionalField{ 
