...
/// </summary>
[JsonConverter(typeof(ObjectWithDocumentedUnknownType.JsonConverter))]
[Serializable]
public record ObjectWithDocumentedUnknownType
{
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<ObjectWithDocumentedUnknownType>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(ObjectWithDocumentedUnknownType).IsAssignableFrom(typeToConvert);

        public override ObjectWithDocumentedUnknownType? Read(
        ...
        )
        {
            ...
            object _documentedUnknownType = default;
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                switch (propertyName)
                {
                    case "documentedUnknownType":
                        _documentedUnknownType = JsonSerializer.Deserialize<object>(
                            ref reader,
                            options
                        );
                        break;
            ...
            return new ObjectWithDocumentedUnknownType
            {
                DocumentedUnknownType = _documentedUnknownType,
