...
public partial class NoreqbodyClient : INoreqbodyClient
{
    ...
    private async Task<WithRawResponse<TypesObjectWithOptionalField>> GetwithnorequestbodyAsyncCore(
    ...
    /// </code></example>
    public WithRawResponseTask<TypesObjectWithOptionalField> GetwithnorequestbodyAsync(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
