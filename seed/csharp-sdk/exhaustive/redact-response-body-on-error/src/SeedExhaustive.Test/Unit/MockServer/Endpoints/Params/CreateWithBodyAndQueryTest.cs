...
public class CreateWithBodyAndQueryTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/params/body-and-query")
        ...
        var response = await Client.Endpoints.Params.CreateWithBodyAndQueryAsync(
