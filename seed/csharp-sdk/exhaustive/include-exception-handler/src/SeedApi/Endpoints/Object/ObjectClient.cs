        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        var responseData = JsonUtils.Deserialize<TypesObjectWithMapOfMap>(
                            responseBody
                        )!;
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    {
                        var responseData =
                            JsonUtils.Deserialize<TypesNestedObjectWithOptionalField>(
                                responseBody
                            )!;
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                    ...
                    .SendRequestAsync(
                        new JsonRequest
                        {
                            ...
                            Path = string.Format(
                                ...
                                ValueConvert.ToPathParameterString(request.StringValue)
                            ),
                            Body = request.Body,
                            Headers = _headers,
                            ContentType = "application/json",
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    {
                        var responseData =
                            JsonUtils.Deserialize<TypesNestedObjectWithRequiredField>(
                                responseBody
                            )!;
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    {
                        var responseData =
                            JsonUtils.Deserialize<TypesObjectWithDocumentedUnknownType>(
                                responseBody
                            )!;
