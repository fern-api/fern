...
public partial class ParamsClient : IParamsClient
{
    ...
    {
        var response = await Raw.GetWithInlinePathAsync(request, options, cancellationToken);
        return response.Data;
    }
    ...
    {
        var response = await Raw.ModifyWithPathAsync(param, request, options, cancellationToken);
        return response.Data;
    }
    ...
    {
        var response = await Raw.ModifyWithInlinePathAsync(request, options, cancellationToken);
        return response.Data;
    }
