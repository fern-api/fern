...
public partial class ContainerClient
{
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.DeserializeWithFallback<IEnumerable<string>>(responseBody)!;
            }
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.DeserializeWithFallback<IEnumerable<ObjectWithRequiredField>>(
                    responseBody
                )!;
            }
            catch (JsonException e)
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.DeserializeWithFallback<HashSet<string>>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SeedExhaustiveException("Failed to deserialize response", e);
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.DeserializeWithFallback<HashSet<ObjectWithRequiredField>>(
                    responseBody
                )!;
            }
            catch (JsonException e)
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.DeserializeWithFallback<Dictionary<string, string>>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SeedExhaustiveException("Failed to deserialize response", e);
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.DeserializeWithFallback<
                    Dictionary<string, ObjectWithRequiredField>
                >(responseBody)!;
            }
            catch (JsonException e)
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.DeserializeWithFallback<ObjectWithRequiredField?>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SeedExhaustiveException("Failed to deserialize response", e);
