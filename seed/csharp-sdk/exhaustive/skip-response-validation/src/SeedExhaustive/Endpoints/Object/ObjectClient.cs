...
public partial class ObjectClient
{
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.DeserializeWithFallback<ObjectWithMapOfMap>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SeedExhaustiveException("Failed to deserialize response", e);
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.DeserializeWithFallback<NestedObjectWithOptionalField>(
                    responseBody
                )!;
            }
            catch (JsonException e)
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            try
            {
                return JsonUtils.DeserializeWithFallback<NestedObjectWithRequiredField>(
                    responseBody
                )!;
            }
            catch (JsonException e)
