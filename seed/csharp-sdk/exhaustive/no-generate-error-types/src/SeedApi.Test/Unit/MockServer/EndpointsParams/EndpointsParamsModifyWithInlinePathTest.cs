...
public class EndpointsParamsModifyWithInlinePathTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        var response = await Client.EndpointsParams.EndpointsParamsModifyWithInlinePathAsync(
