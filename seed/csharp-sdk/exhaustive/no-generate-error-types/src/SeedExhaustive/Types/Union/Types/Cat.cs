...
public record Cat
{
    ...
    internal sealed class JsonConverter : JsonConverter<Cat>
    {
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                switch (propertyName)
                {
                    case "name":
                        ...
                        break;
                    case "likesToMeow":
                        _likesToMeow = JsonSerializer.Deserialize<bool>(ref reader, options);
                        break;
                    default:
        ...
        public override Cat ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return JsonSerializer.Deserialize<Cat>(json, options);
        }
