...
public record Animal
{
    ...
    /// <summary>
    /// Returns the value as a <see cref="SeedExhaustive.Types.Dog"/> if <see cref="_Animal"/> is 'dog', otherwise throws an exception.
    /// </summary>
    ...
    /// <summary>
    /// Returns the value as a <see cref="SeedExhaustive.Types.Cat"/> if <see cref="_Animal"/> is 'cat', otherwise throws an exception.
    /// </summary>
