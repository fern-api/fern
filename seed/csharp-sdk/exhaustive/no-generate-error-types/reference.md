...
<details><summary><code>client.Endpoints.Container.<a href="Endpoints/Container">GetAndReturnListOfObjectsAsync</a>(using SeedExhaustive.Types;

    #nullable enable
    
    IEnumerable<ObjectWithRequiredField> { ... }) -> using SeedExhaustive.Types;
...
**request:** `using SeedExhaustive.Types;
...
<details><summary><code>client.Endpoints.Container.<a href="Endpoints/Container">GetAndReturnSetOfObjectsAsync</a>(using SeedExhaustive.Types;

    #nullable enable
    
    HashSet<ObjectWithRequiredField> { ... }) -> using SeedExhaustive.Types;
...
<details><summary><code>client.Endpoints.Container.<a href="Endpoints/Container">GetAndReturnMapOfPrimToObjectAsync</a>(using SeedExhaustive.Types;

    #nullable enable
    
    Dictionary<string, ObjectWithRequiredField> { ... }) -> using SeedExhaustive.Types;
...
<details><summary><code>client.Endpoints.Container.<a href="Endpoints/Container">GetAndReturnOptionalAsync</a>(using SeedExhaustive.Types;

    #nullable enable
    
    ObjectWithRequiredField? { ... }) -> using SeedExhaustive.Types;
...
## Endpoints Enum
<details><summary><code>client.Endpoints.Enum.<a href="Endpoints/Enum">GetAndReturnEnumAsync</a>(using SeedExhaustive.Types;

    #nullable enable
    
    WeatherReport { ... }) -> using SeedExhaustive.Types;
...
<details><summary><code>client.Endpoints.HttpMethods.<a href="Endpoints/HttpMethods">TestPostAsync</a>(using SeedExhaustive.Types;
...
<details><summary><code>client.Endpoints.HttpMethods.<a href="Endpoints/HttpMethods">TestPutAsync</a>(id, using SeedExhaustive.Types;
...
<details><summary><code>client.Endpoints.HttpMethods.<a href="Endpoints/HttpMethods">TestPatchAsync</a>(id, using SeedExhaustive.Types;

    #nullable enable
    
    ObjectWithOptionalField { ... }) -> using SeedExhaustive.Types;
...
## Endpoints Object
<details><summary><code>client.Endpoints.Object.<a href="Endpoints/Object">GetAndReturnWithOptionalFieldAsync</a>(using SeedExhaustive.Types;
...
<details><summary><code>client.Endpoints.Object.<a href="Endpoints/Object">GetAndReturnWithRequiredFieldAsync</a>(using SeedExhaustive.Types;
...
<details><summary><code>client.Endpoints.Object.<a href="Endpoints/Object">GetAndReturnWithMapOfMapAsync</a>(using SeedExhaustive.Types;

    #nullable enable
    
    ObjectWithMapOfMap { ... }) -> using SeedExhaustive.Types;
...
<details><summary><code>client.Endpoints.Object.<a href="Endpoints/Object">GetAndReturnNestedWithOptionalFieldAsync</a>(using SeedExhaustive.Types;

    #nullable enable
    
    NestedObjectWithOptionalField { ... }) -> using SeedExhaustive.Types;
...
<details><summary><code>client.Endpoints.Object.<a href="Endpoints/Object">GetAndReturnNestedWithRequiredFieldAsync</a>(string_, using SeedExhaustive.Types;

    #nullable enable
    
    NestedObjectWithRequiredField { ... }) -> using SeedExhaustive.Types;
...
<details><summary><code>client.Endpoints.Object.<a href="Endpoints/Object">GetAndReturnNestedWithRequiredFieldAsListAsync</a>(using SeedExhaustive.Types;

    #nullable enable
    
    IEnumerable<NestedObjectWithRequiredField> { ... }) -> using SeedExhaustive.Types;
...
<details><summary><code>client.Endpoints.Params.<a href="Endpoints/Params">GetWithQueryAsync</a>(using SeedExhaustive.Endpoints;
...
**request:** `using SeedExhaustive.Endpoints;
...
<details><summary><code>client.Endpoints.Params.<a href="Endpoints/Params">GetWithAllowMultipleQueryAsync</a>(using SeedExhaustive.Endpoints;
...
<details><summary><code>client.Endpoints.Params.<a href="Endpoints/Params">GetWithPathAndQueryAsync</a>(param, using SeedExhaustive.Endpoints;
...
## InlinedRequests
<details><summary><code>client.InlinedRequests.<a href="InlinedRequests">PostWithObjectBodyandResponseAsync</a>(PostWithObjectBody { ... }) -> using SeedExhaustive.Types;
...
## NoReqBody
<details><summary><code>client.NoReqBody.<a href="NoReqBody">GetWithNoRequestBodyAsync</a>() -> using SeedExhaustive.Types;
...
## ReqWithHeaders
<details><summary><code>client.ReqWithHeaders.<a href="ReqWithHeaders">GetWithCustomHeaderAsync</a>(ReqWithHeaders { ... })</code></summary>
<dl>
<dd>
