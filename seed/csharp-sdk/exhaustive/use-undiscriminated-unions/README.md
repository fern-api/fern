...
[![nuget shield](https://img.shields.io/nuget/v/Fernexhaustive)](https://nuget.org/packages/Fernexhaustive)
...
```sh
dotnet add package Fernexhaustive
```
...
var result = await client.Inlinedrequests.PostwithobjectbodyandresponseAsync(...).WithRawResponse();
...
var data = await client.Inlinedrequests.PostwithobjectbodyandresponseAsync(...);
```
