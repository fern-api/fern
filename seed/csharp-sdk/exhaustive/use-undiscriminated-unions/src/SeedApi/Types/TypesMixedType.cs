...
[JsonConverter(typeof(TypesMixedType.JsonConverter))]
[Serializable]
public class TypesMixedType
{
    private TypesMixedType(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static TypesMixedType FromDouble(double value) => new("double", value);

    /// <summary>
    /// Factory method to create a union from a bool value.
    /// </summary>
    public static TypesMixedType FromBool(bool value) => new("bool", value);

    /// <summary>
    /// Factory method to create a union from a string value.
    /// </summary>
    public static TypesMixedType FromString(string value) => new("string", value);

    /// <summary>
    /// Factory method to create a union from a IEnumerable<string> value.
    /// </summary>
    public static TypesMixedType FromListOfString(IEnumerable<string> value) => new("list", value);
    ...
    /// </summary>
    /// <exception cref="SeedApiException">Thrown when <see cref="Type"/> is not 'double'.</exception>
    public double AsDouble() =>
        IsDouble() ? (double)Value! : throw new SeedApiException("Union type is not 'double'");

    /// <summary>
    /// Returns the value as a <see cref="bool"/> if <see cref="Type"/> is 'bool', otherwise throws an exception.
    /// </summary>
    /// <exception cref="SeedApiException">Thrown when <see cref="Type"/> is not 'bool'.</exception>
    public bool AsBool() =>
        IsBool() ? (bool)Value! : throw new SeedApiException("Union type is not 'bool'");
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not TypesMixedType other)
            return false;
    ...
    public static implicit operator TypesMixedType(double value) => new("double", value);

    public static implicit operator TypesMixedType(bool value) => new("bool", value);

    public static implicit operator TypesMixedType(string value) => new("string", value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<TypesMixedType>
    {
        public override TypesMixedType? Read(
        ...
        )
        {
            ...
            {
                TypesMixedType doubleResult = new("double", reader.GetDouble());
                return doubleResult;
            }

            if (reader.TokenType == JsonTokenType.True || reader.TokenType == JsonTokenType.False)
            {
                TypesMixedType boolResult = new("bool", reader.GetBoolean());
                return boolResult;
            }
            ...
            if (reader.TokenType == JsonTokenType.String)
            {
                ...
                TypesMixedType stringResult = new("string", stringValue);
                return stringResult;
            }
            ...
            if (reader.TokenType == JsonTokenType.StartArray)
            {
                ...
                foreach (var (key, type) in types)
                {
                    try
                    {
                        ...
                        if (value != null)
                        {
                            TypesMixedType result = new(key, value);
                            return result;
                        }
                    }
                    catch (JsonException)
            ...
            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into TypesMixedType"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            TypesMixedType value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        public override TypesMixedType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            var stringValue = reader.GetString()!;
            TypesMixedType result = new("string", stringValue);
            return result;
        }
