...
[![nuget shield](https://img.shields.io/nuget/v/Fernbasic-auth-environment-variables)](https://nuget.org/packages/Fernbasic-auth-environment-variables)
...
```sh
dotnet add package Fernbasic-auth-environment-variables
```
...
var client = new SeedBasicAuthEnvironmentVariablesClient("YOUR_USERNAME", "YOUR_PASSWORD");
