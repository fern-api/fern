...
public class MultipartFormTests
{
    ...
    private static SeedBasicAuthEnvironmentVariables.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedBasicAuthEnvironmentVariables.Core.MultipartFormRequest
        {
