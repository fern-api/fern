...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedBasicAuthEnvironmentVariablesApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    {
        var exception = new SeedBasicAuthEnvironmentVariablesApiException("Error", 500, "body");
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedBasicAuthEnvironmentVariables.SeedBasicAuthEnvironmentVariablesApiException"
            )
        );
    }
    ...
    {
        var exception = new SeedBasicAuthEnvironmentVariablesApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedBasicAuthEnvironmentVariablesApiException("Error", 500, 42);
    ...
    {
        var exception = new SeedBasicAuthEnvironmentVariablesApiException("Error", 400, "");
    ...
    {
        var exception = new SeedBasicAuthEnvironmentVariablesApiException("Error", 400, false);
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedBasicAuthEnvironmentVariablesException>());
