...
[![nuget shield](https://img.shields.io/nuget/v/Fernno-content-response)](https://nuget.org/packages/Fernno-content-response)
...
```sh
dotnet add package Fernno-content-response
```
...
var result = await client.Contacts.CreateAsync(...).WithRawResponse();
...
var parsedData = await client.Contacts.CreateAsync(...);
