...
[![nuget shield](https://img.shields.io/nuget/v/Fernvalidation)](https://nuget.org/packages/Fernvalidation)
...
```sh
dotnet add package Fernvalidation
```
...
var parsedData = await client.CreateAsync(...);
