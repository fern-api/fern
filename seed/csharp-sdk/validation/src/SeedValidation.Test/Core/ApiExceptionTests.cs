...
namespace SeedValidation.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedValidationApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedValidationApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedValidation.SeedValidationApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SeedValidationApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedValidationApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedValidationApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedValidationApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedValidationApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedValidationApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedValidationApiException("Error", 400, "");
    ...
    {
        var exception = new SeedValidationApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SeedValidationApiException(
            "Service Unavailable",
            503,
            "gateway timeout",
            inner
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedValidationApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedValidationApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedValidationApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedValidationException>());
