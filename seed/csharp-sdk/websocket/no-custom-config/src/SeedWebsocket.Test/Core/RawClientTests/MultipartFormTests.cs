...
namespace SeedWebsocket.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedWebsocket.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedWebsocket.Core.MultipartFormRequest
        {
