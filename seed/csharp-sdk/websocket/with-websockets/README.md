...
[![nuget shield](https://img.shields.io/nuget/v/Fernwebsocket)](https://nuget.org/packages/Fernwebsocket)
...
```sh
dotnet add package Fernwebsocket
```
...
var result = await client.Status.GetStatusAsync(...).WithRawResponse();
...
var parsedData = await client.Status.GetStatusAsync(...);
