...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedDollarStringExamples.Core.ApiResponse> MakeRequestAsync(
        global::SeedDollarStringExamples.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedDollarStringExamples.Core.ApiResponse> SendRequestAsync(
        global::SeedDollarStringExamples.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedDollarStringExamples.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedDollarStringExamples.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedDollarStringExamples.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedDollarStringExamples.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedDollarStringExamples.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedDollarStringExamples.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedDollarStringExamples.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedDollarStringExamples.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedDollarStringExamples.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedDollarStringExamples.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedDollarStringExamples.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedDollarStringExamples.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedDollarStringExamples.Core.StreamRequest;
}
