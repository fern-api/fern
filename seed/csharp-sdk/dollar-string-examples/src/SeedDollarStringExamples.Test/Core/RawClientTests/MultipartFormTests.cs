...
namespace SeedDollarStringExamples.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedDollarStringExamples.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedDollarStringExamples.Core.MultipartFormRequest
        {
