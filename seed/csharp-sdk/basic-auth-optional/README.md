...
[![nuget shield](https://img.shields.io/nuget/v/Fernbasic-auth-optional)](https://nuget.org/packages/Fernbasic-auth-optional)
...
```sh
dotnet add package Fernbasic-auth-optional
```
