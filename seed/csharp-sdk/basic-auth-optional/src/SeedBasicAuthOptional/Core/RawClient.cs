...
namespace SeedBasicAuthOptional.Core;
...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedBasicAuthOptional.Core.ApiResponse> SendRequestAsync(
        global::SeedBasicAuthOptional.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedBasicAuthOptional.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::SeedBasicAuthOptional.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::SeedBasicAuthOptional.Core.BaseRequest request)
    {
