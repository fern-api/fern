...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-oauth-token-optional)](https://nuget.org/packages/Ferncsharp-oauth-token-optional)
...
```sh
dotnet add package Ferncsharp-oauth-token-optional
```
...
var client = new SeedCsharpOauthTokenOptionalClient("client_id", "client_secret");
...
} catch (SeedCsharpOauthTokenOptionalApiException e) {
...
var data = await client.Auth.CreateOauth2TokenAsync(...);
