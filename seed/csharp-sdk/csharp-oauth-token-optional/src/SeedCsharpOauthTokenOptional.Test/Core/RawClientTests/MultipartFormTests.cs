...
public class MultipartFormTests
{
    ...
    private static SeedCsharpOauthTokenOptional.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedCsharpOauthTokenOptional.Core.MultipartFormRequest
        {
