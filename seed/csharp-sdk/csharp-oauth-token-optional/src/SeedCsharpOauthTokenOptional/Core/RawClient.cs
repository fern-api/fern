...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedCsharpOauthTokenOptional.Core.ApiResponse> SendRequestAsync(
        global::SeedCsharpOauthTokenOptional.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedCsharpOauthTokenOptional.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::SeedCsharpOauthTokenOptional.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::SeedCsharpOauthTokenOptional.Core.BaseRequest request)
    {
