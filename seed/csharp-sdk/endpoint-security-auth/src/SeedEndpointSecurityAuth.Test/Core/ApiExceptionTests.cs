...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedEndpointSecurityAuthApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedEndpointSecurityAuthApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedEndpointSecurityAuth.SeedEndpointSecurityAuthApiException")
        );
    }
    ...
    {
        var exception = new SeedEndpointSecurityAuthApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedEndpointSecurityAuthApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedEndpointSecurityAuthApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedEndpointSecurityAuthApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedEndpointSecurityAuthApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedEndpointSecurityAuthApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedEndpointSecurityAuthApiException("Error", 400, "");
    ...
    {
        var exception = new SeedEndpointSecurityAuthApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedEndpointSecurityAuthApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedEndpointSecurityAuthApiException("Error", 429, "rate limited");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedEndpointSecurityAuthException>());
