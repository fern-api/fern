...
public class MultipartFormTests
{
    ...
    private static SeedEndpointSecurityAuth.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedEndpointSecurityAuth.Core.MultipartFormRequest
        {
