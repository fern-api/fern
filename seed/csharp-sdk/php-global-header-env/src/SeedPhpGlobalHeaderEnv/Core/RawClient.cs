...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedPhpGlobalHeaderEnv.Core.ApiResponse> SendRequestAsync(
        global::SeedPhpGlobalHeaderEnv.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedPhpGlobalHeaderEnv.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::SeedPhpGlobalHeaderEnv.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::SeedPhpGlobalHeaderEnv.Core.BaseRequest request)
    {
