...
namespace SeedPhpGlobalHeaderEnv.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedPhpGlobalHeaderEnv.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedPhpGlobalHeaderEnv.Core.MultipartFormRequest
        {
