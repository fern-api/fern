...
[![nuget shield](https://img.shields.io/nuget/v/Fernphp-global-header-env)](https://nuget.org/packages/Fernphp-global-header-env)
...
```sh
dotnet add package Fernphp-global-header-env
```
...
var client = new SeedPhpGlobalHeaderEnvClient("VERSION");
...
} catch (SeedPhpGlobalHeaderEnvApiException e) {
...
var result = await client.Service.GetWithApiVersionAsync(...).WithRawResponse();
