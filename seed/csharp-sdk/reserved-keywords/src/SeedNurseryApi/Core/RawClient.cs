...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedNurseryApi.Core.ApiResponse> MakeRequestAsync(
        SeedNurseryApi.Core.BaseRequest request,
    ...
    internal async Task<SeedNurseryApi.Core.ApiResponse> SendRequestAsync(
        SeedNurseryApi.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedNurseryApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedNurseryApi.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedNurseryApi.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedNurseryApi.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedNurseryApi.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedNurseryApi.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedNurseryApi.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedNurseryApi.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedNurseryApi.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedNurseryApi.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedNurseryApi.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedNurseryApi.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedNurseryApi.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedNurseryApi.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedNurseryApi.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedNurseryApi.Core.StreamRequest;
}
