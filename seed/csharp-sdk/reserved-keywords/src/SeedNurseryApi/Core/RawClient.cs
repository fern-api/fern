...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedNurseryApi.Core.ApiResponse> MakeRequestAsync(
        global::SeedNurseryApi.Core.BaseRequest request,
    ...
    internal async Task<global::SeedNurseryApi.Core.ApiResponse> SendRequestAsync(
        global::SeedNurseryApi.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedNurseryApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    internal HttpRequestMessage CreateHttpRequest(global::SeedNurseryApi.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedNurseryApi.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedNurseryApi.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedNurseryApi.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedNurseryApi.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedNurseryApi.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedNurseryApi.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedNurseryApi.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedNurseryApi.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedNurseryApi.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedNurseryApi.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedNurseryApi.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedNurseryApi.Core.StreamRequest;
}
