...
namespace SeedLiteralUserAgent.Core;
...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedLiteralUserAgent.Core.ApiResponse> SendRequestAsync(
        global::SeedLiteralUserAgent.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedLiteralUserAgent.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    private string BuildUrl(global::SeedLiteralUserAgent.Core.BaseRequest request)
    {
