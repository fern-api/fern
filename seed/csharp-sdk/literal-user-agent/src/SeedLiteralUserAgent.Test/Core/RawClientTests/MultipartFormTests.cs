...
namespace SeedLiteralUserAgent.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedLiteralUserAgent.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedLiteralUserAgent.Core.MultipartFormRequest
        {
