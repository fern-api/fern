...
[![nuget shield](https://img.shields.io/nuget/v/Fernliteral-user-agent)](https://nuget.org/packages/Fernliteral-user-agent)
...
```sh
dotnet add package Fernliteral-user-agent
```
...
var result = await client.PingAsync(...).WithRawResponse();
...
var parsedData = await client.PingAsync(...);
