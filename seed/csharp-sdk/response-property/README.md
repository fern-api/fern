...
[![nuget shield](https://img.shields.io/nuget/v/Fernresponse-property)](https://nuget.org/packages/Fernresponse-property)
...
```sh
dotnet add package Fernresponse-property
```
...
var parsedData = await client.Service.GetMovieAsync(...);
