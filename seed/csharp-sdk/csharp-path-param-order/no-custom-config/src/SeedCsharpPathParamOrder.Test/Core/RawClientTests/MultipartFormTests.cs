...
public class MultipartFormTests
{
    ...
    private static SeedCsharpPathParamOrder.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedCsharpPathParamOrder.Core.MultipartFormRequest
        {
