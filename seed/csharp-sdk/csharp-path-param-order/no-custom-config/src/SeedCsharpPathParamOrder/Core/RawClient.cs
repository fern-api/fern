...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedCsharpPathParamOrder.Core.ApiResponse> SendRequestAsync(
        global::SeedCsharpPathParamOrder.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedCsharpPathParamOrder.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::SeedCsharpPathParamOrder.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::SeedCsharpPathParamOrder.Core.BaseRequest request)
    {
