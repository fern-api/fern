...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedObjectsWithImportsApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedObjectsWithImportsApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedObjectsWithImports.SeedObjectsWithImportsApiException")
        );
    }
    ...
    {
        var exception = new SeedObjectsWithImportsApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedObjectsWithImportsApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedObjectsWithImportsApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedObjectsWithImportsApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedObjectsWithImportsApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedObjectsWithImportsApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedObjectsWithImportsApiException("Error", 400, "");
    ...
    {
        var exception = new SeedObjectsWithImportsApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedObjectsWithImportsApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedObjectsWithImportsApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedObjectsWithImportsApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedObjectsWithImportsException>());
