...
namespace SeedObjectsWithImports.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedObjectsWithImports.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedObjectsWithImports.Core.MultipartFormRequest
        {
