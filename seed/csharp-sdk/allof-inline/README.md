...
[![nuget shield](https://img.shields.io/nuget/v/Fernallof-inline)](https://nuget.org/packages/Fernallof-inline)
...
```sh
dotnet add package Fernallof-inline
```
...
var result = await client.CreateRuleAsync(...).WithRawResponse();
