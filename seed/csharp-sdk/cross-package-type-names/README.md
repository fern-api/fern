...
[![nuget shield](https://img.shields.io/nuget/v/Ferncross-package-type-names)](https://nuget.org/packages/Ferncross-package-type-names)
...
```sh
dotnet add package Ferncross-package-type-names
```
