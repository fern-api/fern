...
public class MultipartFormTests
{
    ...
    private static SeedCrossPackageTypeNames.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedCrossPackageTypeNames.Core.MultipartFormRequest
        {
