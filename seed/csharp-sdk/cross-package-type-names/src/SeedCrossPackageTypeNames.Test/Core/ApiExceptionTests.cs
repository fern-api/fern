...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedCrossPackageTypeNamesApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedCrossPackageTypeNamesApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedCrossPackageTypeNames.SeedCrossPackageTypeNamesApiException")
        );
    }
    ...
    {
        var exception = new SeedCrossPackageTypeNamesApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedCrossPackageTypeNamesApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedCrossPackageTypeNamesApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedCrossPackageTypeNamesApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedCrossPackageTypeNamesApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedCrossPackageTypeNamesApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedCrossPackageTypeNamesApiException("Error", 400, "");
    ...
    {
        var exception = new SeedCrossPackageTypeNamesApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedCrossPackageTypeNamesApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedCrossPackageTypeNamesApiException("Error", 429, "rate limited");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedCrossPackageTypeNamesException>());
