...
public class MultipartFormTests
{
    ...
    private static SeedUndiscriminatedUnionWithResponseProperty.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedUndiscriminatedUnionWithResponseProperty.Core.MultipartFormRequest
        {
