...
[![nuget shield](https://img.shields.io/nuget/v/SeedUndiscriminatedUnionWithResponseProperty)](https://nuget.org/packages/SeedUndiscriminatedUnionWithResponseProperty)
...
```sh
dotnet add package SeedUndiscriminatedUnionWithResponseProperty
```
