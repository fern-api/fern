...
[![nuget shield](https://img.shields.io/nuget/v/Fernundiscriminated-union-with-response-property)](https://nuget.org/packages/Fernundiscriminated-union-with-response-property)
...
```sh
dotnet add package Fernundiscriminated-union-with-response-property
```
...
var result = await client.GetUnionAsync(...).WithRawResponse();
...
var parsedData = await client.GetUnionAsync(...);
