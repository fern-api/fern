...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedUndiscriminatedUnionWithResponsePropertyApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    public void ToString_ContainsFullTypeName()
    {
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedUndiscriminatedUnionWithResponseProperty.SeedUndiscriminatedUnionWithResponsePropertyApiException"
            )
        );
    }
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(
            exception,
            Is.InstanceOf<SeedUndiscriminatedUnionWithResponsePropertyException>()
        );
