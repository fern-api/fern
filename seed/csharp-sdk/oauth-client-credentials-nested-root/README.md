...
[![nuget shield](https://img.shields.io/nuget/v/Fernoauth-client-credentials-nested-root)](https://nuget.org/packages/Fernoauth-client-credentials-nested-root)
...
```sh
dotnet add package Fernoauth-client-credentials-nested-root
```
