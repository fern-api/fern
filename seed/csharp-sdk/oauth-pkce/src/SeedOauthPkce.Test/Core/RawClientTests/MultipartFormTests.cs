...
namespace SeedOauthPkce.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedOauthPkce.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedOauthPkce.Core.MultipartFormRequest
        {
