...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedOauthPkce.Core.ApiResponse> SendRequestAsync(
        global::SeedOauthPkce.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedOauthPkce.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::SeedOauthPkce.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::SeedOauthPkce.Core.BaseRequest request)
    {
