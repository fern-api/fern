...
[![nuget shield](https://img.shields.io/nuget/v/Fernoauth-pkce)](https://nuget.org/packages/Fernoauth-pkce)
...
```sh
dotnet add package Fernoauth-pkce
```
...
var result = await client.Oauth.AuthorizeAsync(...).WithRawResponse();
...
var parsedData = await client.Oauth.AuthorizeAsync(...);
