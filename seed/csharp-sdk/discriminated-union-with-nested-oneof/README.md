...
[![nuget shield](https://img.shields.io/nuget/v/Ferndiscriminated-union-with-nested-oneof)](https://nuget.org/packages/Ferndiscriminated-union-with-nested-oneof)
...
```sh
dotnet add package Ferndiscriminated-union-with-nested-oneof
```
...
var result = await client.CreateAstAsync(...).WithRawResponse();
...
var parsedData = await client.CreateAstAsync(...);
...
var astllmNodeWithSchemaType = AstllmNodeWithSchemaType.Llm;

// Using a custom value
var customAstllmNodeWithSchemaType = AstllmNodeWithSchemaType.FromCustom("custom-value");

// Using in a switch statement
switch (astllmNodeWithSchemaType.Value)
{
    case AstllmNodeWithSchemaType.Values.Llm:
        Console.WriteLine("Llm");
        break;
    default:
        Console.WriteLine($"Unknown value: {astllmNodeWithSchemaType.Value}");
        break;
}

// Explicit casting
string astllmNodeWithSchemaTypeString = (string)AstllmNodeWithSchemaType.Llm;
AstllmNodeWithSchemaType astllmNodeWithSchemaTypeFromString = (AstllmNodeWithSchemaType)"llm";
```
