...
[![nuget shield](https://img.shields.io/nuget/v/Fernx-fern-default)](https://nuget.org/packages/Fernx-fern-default)
...
```sh
dotnet add package Fernx-fern-default
```
...
var result = await client.TestGetAsync(...).WithRawResponse();
...
var parsedData = await client.TestGetAsync(...);
