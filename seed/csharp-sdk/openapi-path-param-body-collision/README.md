...
[![nuget shield](https://img.shields.io/nuget/v/Fernopenapi-path-param-body-collision)](https://nuget.org/packages/Fernopenapi-path-param-body-collision)
...
```sh
dotnet add package Fernopenapi-path-param-body-collision
```
...
var result = await client.UpdateProfileIdentifierAsync(...).WithRawResponse();
...
var parsedData = await client.UpdateProfileIdentifierAsync(...);
