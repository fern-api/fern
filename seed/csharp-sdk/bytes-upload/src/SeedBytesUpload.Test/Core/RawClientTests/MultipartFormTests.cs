...
namespace SeedBytesUpload.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedBytesUpload.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedBytesUpload.Core.MultipartFormRequest
        {
