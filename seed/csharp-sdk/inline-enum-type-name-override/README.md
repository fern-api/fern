...
[![nuget shield](https://img.shields.io/nuget/v/Ferninline-enum-type-name-override)](https://nuget.org/packages/Ferninline-enum-type-name-override)
...
```sh
dotnet add package Ferninline-enum-type-name-override
```
...
var result = await client.Reporting.LoadAsync(...).WithRawResponse();
...
var parsedData = await client.Reporting.LoadAsync(...);
...
var loadRequestCache = LoadRequestCache.StaleIfSlow;

// Using a custom value
var customLoadRequestCache = LoadRequestCache.FromCustom("custom-value");

// Using in a switch statement
switch (loadRequestCache.Value)
{
    case LoadRequestCache.Values.StaleIfSlow:
        Console.WriteLine("StaleIfSlow");
        break;
    default:
        Console.WriteLine($"Unknown value: {loadRequestCache.Value}");
        break;
}

// Explicit casting
string loadRequestCacheString = (string)LoadRequestCache.StaleIfSlow;
LoadRequestCache loadRequestCacheFromString = (LoadRequestCache)"stale-if-slow";
```
