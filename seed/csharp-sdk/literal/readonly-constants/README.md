...
[![nuget shield](https://img.shields.io/nuget/v/Fernliteral)](https://nuget.org/packages/Fernliteral)
...
```sh
dotnet add package Fernliteral
```
...
var parsedData = await client.Headers.SendAsync(...);
