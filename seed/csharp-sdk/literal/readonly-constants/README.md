...
[![nuget shield](https://img.shields.io/nuget/v/SeedLiteral)](https://nuget.org/packages/SeedLiteral)
...
```sh
dotnet add package SeedLiteral
```
...
var data = await client.Headers.SendAsync(...);
```
