...
[![nuget shield](https://img.shields.io/nuget/v/Fernnullable-request-body)](https://nuget.org/packages/Fernnullable-request-body)
...
```sh
dotnet add package Fernnullable-request-body
```
...
var parsedData = await client.TestGroup.TestMethodNameAsync(...);
