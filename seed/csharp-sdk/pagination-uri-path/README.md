...
[![nuget shield](https://img.shields.io/nuget/v/SeedPaginationUriPath)](https://nuget.org/packages/SeedPaginationUriPath)
...
```sh
dotnet add package SeedPaginationUriPath
```
