...
[![nuget shield](https://img.shields.io/nuget/v/Fernpagination-uri-path)](https://nuget.org/packages/Fernpagination-uri-path)
...
```sh
dotnet add package Fernpagination-uri-path
```
