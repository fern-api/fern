...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedPaginationUriPathApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedPaginationUriPathApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedPaginationUriPath.SeedPaginationUriPathApiException")
        );
    }
    ...
    {
        var exception = new SeedPaginationUriPathApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedPaginationUriPathApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedPaginationUriPathApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedPaginationUriPathApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedPaginationUriPathApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedPaginationUriPathApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedPaginationUriPathApiException("Error", 400, "");
    ...
    {
        var exception = new SeedPaginationUriPathApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedPaginationUriPathApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedPaginationUriPathApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedPaginationUriPathApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedPaginationUriPathException>());
