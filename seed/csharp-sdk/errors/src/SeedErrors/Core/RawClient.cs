...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedErrors.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedErrors.Core.ApiResponse> SendRequestAsync(
        global::SeedErrors.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedErrors.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    internal HttpRequestMessage CreateHttpRequest(global::SeedErrors.Core.BaseRequest request)
    {
