...
[![nuget shield](https://img.shields.io/nuget/v/SeedErrors)](https://nuget.org/packages/SeedErrors)
...
var data = await client.Simple.FooWithoutEndpointErrorAsync(...);
```
