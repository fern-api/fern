...
[![nuget shield](https://img.shields.io/nuget/v/Fernerrors)](https://nuget.org/packages/Fernerrors)
...
var result = await client.Simple.FooWithoutEndpointErrorAsync(...).WithRawResponse();
...
var parsedData = await client.Simple.FooWithoutEndpointErrorAsync(...);
