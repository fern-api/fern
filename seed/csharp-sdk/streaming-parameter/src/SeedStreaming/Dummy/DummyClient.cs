...
public partial class DummyClient : IDummyClient
{
    ...
    private async Task<WithRawResponse<IAsyncEnumerable<StreamResponse>>> GenerateAsyncCore(
    ...
    private async IAsyncEnumerable<StreamResponse> GenerateAsyncBody(
    ...
    /// </code></example>
    public WithRawResponseStream<StreamResponse> GenerateAsync(
        GenerateRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
