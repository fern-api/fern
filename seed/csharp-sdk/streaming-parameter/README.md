...
[![nuget shield](https://img.shields.io/nuget/v/Fernstreaming-parameter)](https://nuget.org/packages/Fernstreaming-parameter)
...
```sh
dotnet add package Fernstreaming-parameter
```
...
var parsedData = await client.Dummy.GenerateAsync(...);
