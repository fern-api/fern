...
[![nuget shield](https://img.shields.io/nuget/v/Fernoauth-client-credentials-openapi)](https://nuget.org/packages/Fernoauth-client-credentials-openapi)
...
```sh
dotnet add package Fernoauth-client-credentials-openapi
```
...
var client = new SeedApiClient("client_id", "client_secret");
...
var result = await client.Identity.GetTokenAsync(...).WithRawResponse();
...
var data = await client.Identity.GetTokenAsync(...);
```
