...
[![nuget shield](https://img.shields.io/nuget/v/Fernmulti-content-type-examples)](https://nuget.org/packages/Fernmulti-content-type-examples)
...
```sh
dotnet add package Fernmulti-content-type-examples
```
...
var result = await client.Clients.CreateAsync(...).WithRawResponse();
...
var parsedData = await client.Clients.CreateAsync(...);
