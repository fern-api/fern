...
[![nuget shield](https://img.shields.io/nuget/v/Fernquery-param-name-conflict)](https://nuget.org/packages/Fernquery-param-name-conflict)
...
```sh
dotnet add package Fernquery-param-name-conflict
```
...
var result = await client.BulkUpdateTasksAsync(...).WithRawResponse();
...
var parsedData = await client.BulkUpdateTasksAsync(...);
