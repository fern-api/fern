...
[![nuget shield](https://img.shields.io/nuget/v/Ferncli-multi-spec)](https://nuget.org/packages/Ferncli-multi-spec)
...
```sh
dotnet add package Ferncli-multi-spec
```
...
var result = await client.ListUsersAsync(...).WithRawResponse();
...
var data = await client.ListUsersAsync(...);
```
