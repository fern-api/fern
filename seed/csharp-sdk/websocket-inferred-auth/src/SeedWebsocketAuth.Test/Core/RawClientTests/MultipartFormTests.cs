...
namespace SeedWebsocketAuth.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedWebsocketAuth.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedWebsocketAuth.Core.MultipartFormRequest
        {
