...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedWebsocketAuth.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedWebsocketAuth.Core.ApiResponse> SendRequestAsync(
        global::SeedWebsocketAuth.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedWebsocketAuth.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
