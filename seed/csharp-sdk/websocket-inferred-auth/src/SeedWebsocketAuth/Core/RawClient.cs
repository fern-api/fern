...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedWebsocketAuth.Core.ApiResponse> MakeRequestAsync(
        global::SeedWebsocketAuth.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedWebsocketAuth.Core.ApiResponse> SendRequestAsync(
        global::SeedWebsocketAuth.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedWebsocketAuth.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedWebsocketAuth.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedWebsocketAuth.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedWebsocketAuth.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedWebsocketAuth.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedWebsocketAuth.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedWebsocketAuth.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedWebsocketAuth.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedWebsocketAuth.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedWebsocketAuth.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedWebsocketAuth.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedWebsocketAuth.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedWebsocketAuth.Core.StreamRequest;
}
