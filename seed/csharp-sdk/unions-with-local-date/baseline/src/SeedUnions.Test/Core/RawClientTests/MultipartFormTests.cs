...
namespace SeedUnions.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedUnions.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedUnions.Core.MultipartFormRequest
        {
