...
[![nuget shield](https://img.shields.io/nuget/v/Fernunions-with-local-date)](https://nuget.org/packages/Fernunions-with-local-date)
...
```sh
dotnet add package Fernunions-with-local-date
```
