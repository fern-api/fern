...
namespace SeedUnions.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedUnionsApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedUnionsApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedUnions.SeedUnionsApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SeedUnionsApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedUnionsApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedUnionsApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedUnionsApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedUnionsApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedUnionsApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedUnionsApiException("Error", 400, "");
    ...
    {
        var exception = new SeedUnionsApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SeedUnionsApiException(
            "Service Unavailable",
            503,
            "gateway timeout",
            inner
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedUnionsApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedUnionsApiException("Error: \"quotes\" & <brackets>", 400, "body");
    ...
    {
        var exception = new SeedUnionsApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedUnionsApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedUnionsException>());
