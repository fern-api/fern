...
[![nuget shield](https://img.shields.io/nuget/v/Fernunions)](https://nuget.org/packages/Fernunions)
...
var data = await client.Bigunion.GetAsync(...);
```
