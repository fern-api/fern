...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedPropertyAccess.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedPropertyAccess.Core.ApiResponse> SendRequestAsync(
        global::SeedPropertyAccess.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedPropertyAccess.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
