...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedPropertyAccess.Core.ApiResponse> MakeRequestAsync(
        global::SeedPropertyAccess.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedPropertyAccess.Core.ApiResponse> SendRequestAsync(
        global::SeedPropertyAccess.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedPropertyAccess.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedPropertyAccess.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedPropertyAccess.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPropertyAccess.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedPropertyAccess.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPropertyAccess.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedPropertyAccess.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPropertyAccess.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedPropertyAccess.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPropertyAccess.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedPropertyAccess.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPropertyAccess.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedPropertyAccess.Core.StreamRequest;
}
