...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedIdempotencyHeaders.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedIdempotencyHeaders.Core.ApiResponse> SendRequestAsync(
        global::SeedIdempotencyHeaders.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedIdempotencyHeaders.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            await MergeHeadersAsync(mergedHeaders, idempotentRequest.GetIdempotencyHeaders())
                .ConfigureAwait(false);
        }
