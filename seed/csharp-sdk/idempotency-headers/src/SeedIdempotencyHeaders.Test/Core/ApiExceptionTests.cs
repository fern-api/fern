...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedIdempotencyHeadersApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedIdempotencyHeadersApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedIdempotencyHeaders.SeedIdempotencyHeadersApiException")
        );
    }
    ...
    {
        var exception = new SeedIdempotencyHeadersApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedIdempotencyHeadersApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedIdempotencyHeadersApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedIdempotencyHeadersApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedIdempotencyHeadersApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedIdempotencyHeadersApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedIdempotencyHeadersApiException("Error", 400, "");
    ...
    {
        var exception = new SeedIdempotencyHeadersApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedIdempotencyHeadersApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedIdempotencyHeadersApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedIdempotencyHeadersApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedIdempotencyHeadersException>());
