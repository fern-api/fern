...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedNullableApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedNullableApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedNullable.SeedNullableApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SeedNullableApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedNullableApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedNullableApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedNullableApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedNullableApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedNullableApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedNullableApiException("Error", 400, "");
    ...
    {
        var exception = new SeedNullableApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SeedNullableApiException(
            "Service Unavailable",
            503,
            "gateway timeout",
            inner
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedNullableApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedNullableApiException("Error: \"quotes\" & <brackets>", 400, "body");
    ...
    {
        var exception = new SeedNullableApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedNullableApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedNullableException>());
