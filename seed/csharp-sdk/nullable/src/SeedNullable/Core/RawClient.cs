...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedNullable.Core.ApiResponse> MakeRequestAsync(
        SeedNullable.Core.BaseRequest request,
    ...
    internal async Task<SeedNullable.Core.ApiResponse> SendRequestAsync(
        SeedNullable.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedNullable.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedNullable.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedNullable.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedNullable.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedNullable.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedNullable.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedNullable.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedNullable.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedNullable.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedNullable.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedNullable.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedNullable.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedNullable.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedNullable.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedNullable.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedNullable.Core.StreamRequest;
}
