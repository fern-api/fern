...
public record NotificationMethod
{
    ...
    internal sealed class JsonConverter : JsonConverter<NotificationMethod>
    {
        ...
        )
        {
            ...
            {
                "email" =>
                    jsonWithoutDiscriminator.Deserialize<SeedNullableOptional.EmailNotification?>(
                        options
                    )
                        ?? throw new JsonException(
                ...
                "sms" =>
                    jsonWithoutDiscriminator.Deserialize<SeedNullableOptional.SmsNotification?>(
                        options
                    )
                        ?? throw new JsonException(
                ...
                "push" =>
                    jsonWithoutDiscriminator.Deserialize<SeedNullableOptional.PushNotification?>(
                        options
                    )
                        ?? throw new JsonException(
