...
[![nuget shield](https://img.shields.io/nuget/v/Fernnullable-optional)](https://nuget.org/packages/Fernnullable-optional)
...
```sh
dotnet add package Fernnullable-optional
```
