...
[![nuget shield](https://img.shields.io/nuget/v/Fernopenapi-per-spec-base-path)](https://nuget.org/packages/Fernopenapi-per-spec-base-path)
...
```sh
dotnet add package Fernopenapi-per-spec-base-path
```
