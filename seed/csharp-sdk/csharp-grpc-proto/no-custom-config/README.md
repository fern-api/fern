...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-grpc-proto)](https://nuget.org/packages/Ferncsharp-grpc-proto)
...
```sh
dotnet add package Ferncsharp-grpc-proto
```
