...
[![nuget shield](https://img.shields.io/nuget/v/Fernunknown)](https://nuget.org/packages/Fernunknown)
...
```sh
dotnet add package Fernunknown
```
...
var parsedData = await client.Unknown.PostAsync(...);
