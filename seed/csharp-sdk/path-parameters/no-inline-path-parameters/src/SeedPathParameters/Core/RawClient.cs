...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedPathParameters.Core.ApiResponse> MakeRequestAsync(
        global::SeedPathParameters.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedPathParameters.Core.ApiResponse> SendRequestAsync(
        global::SeedPathParameters.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedPathParameters.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedPathParameters.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedPathParameters.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPathParameters.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedPathParameters.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPathParameters.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedPathParameters.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPathParameters.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedPathParameters.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPathParameters.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedPathParameters.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedPathParameters.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedPathParameters.Core.StreamRequest;
}
