...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedPathParameters.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedPathParameters.Core.ApiResponse> SendRequestAsync(
        global::SeedPathParameters.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedPathParameters.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
