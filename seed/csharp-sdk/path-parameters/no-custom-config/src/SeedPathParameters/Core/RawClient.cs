...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedPathParameters.Core.ApiResponse> MakeRequestAsync(
        SeedPathParameters.Core.BaseRequest request,
    ...
    internal async Task<SeedPathParameters.Core.ApiResponse> SendRequestAsync(
        SeedPathParameters.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedPathParameters.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedPathParameters.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedPathParameters.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedPathParameters.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedPathParameters.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedPathParameters.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedPathParameters.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedPathParameters.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedPathParameters.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedPathParameters.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedPathParameters.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedPathParameters.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedPathParameters.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedPathParameters.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedPathParameters.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedPathParameters.Core.StreamRequest;
}
