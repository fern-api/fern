...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedMultiUrlEnvironmentApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedMultiUrlEnvironmentApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedMultiUrlEnvironment.SeedMultiUrlEnvironmentApiException")
        );
    }
    ...
    {
        var exception = new SeedMultiUrlEnvironmentApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedMultiUrlEnvironmentApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedMultiUrlEnvironmentApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedMultiUrlEnvironmentApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedMultiUrlEnvironmentApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedMultiUrlEnvironmentApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedMultiUrlEnvironmentApiException("Error", 400, "");
    ...
    {
        var exception = new SeedMultiUrlEnvironmentApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedMultiUrlEnvironmentApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedMultiUrlEnvironmentApiException("Error", 429, "rate limited");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedMultiUrlEnvironmentException>());
