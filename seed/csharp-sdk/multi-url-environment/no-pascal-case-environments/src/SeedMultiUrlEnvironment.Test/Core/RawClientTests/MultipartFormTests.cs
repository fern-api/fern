...
public class MultipartFormTests
{
    ...
    private static SeedMultiUrlEnvironment.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedMultiUrlEnvironment.Core.MultipartFormRequest
        {
