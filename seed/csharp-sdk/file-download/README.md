...
[![nuget shield](https://img.shields.io/nuget/v/Fernfile-download)](https://nuget.org/packages/Fernfile-download)
...
```sh
dotnet add package Fernfile-download
```
...
var result = await client.Service.SimpleAsync(...).WithRawResponse();
