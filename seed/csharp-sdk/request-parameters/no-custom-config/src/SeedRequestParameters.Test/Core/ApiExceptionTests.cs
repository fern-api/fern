...
namespace SeedRequestParameters.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedRequestParametersApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedRequestParametersApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedRequestParameters.SeedRequestParametersApiException")
        );
    }
    ...
    {
        var exception = new SeedRequestParametersApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedRequestParametersApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedRequestParametersApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedRequestParametersApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedRequestParametersApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedRequestParametersApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedRequestParametersApiException("Error", 400, "");
    ...
    {
        var exception = new SeedRequestParametersApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedRequestParametersApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedRequestParametersApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedRequestParametersApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedRequestParametersException>());
