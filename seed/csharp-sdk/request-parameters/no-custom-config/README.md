...
[![nuget shield](https://img.shields.io/nuget/v/Fernrequest-parameters)](https://nuget.org/packages/Fernrequest-parameters)
...
```sh
dotnet add package Fernrequest-parameters
```
...
var result = await client.User.CreateUsernameAsync(...).WithRawResponse();
...
var parsedData = await client.User.CreateUsernameAsync(...);
