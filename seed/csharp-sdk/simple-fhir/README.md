...
[![nuget shield](https://img.shields.io/nuget/v/Fernsimple-fhir)](https://nuget.org/packages/Fernsimple-fhir)
...
```sh
dotnet add package Fernsimple-fhir
```
...
var parsedData = await client.GetAccountAsync(...);
