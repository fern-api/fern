...
[JsonConverter(typeof(BaseResource.JsonConverter))]
[Serializable]
public record BaseResource
{
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<BaseResource>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(BaseResource).IsAssignableFrom(typeToConvert);

        public override BaseResource? Read(
