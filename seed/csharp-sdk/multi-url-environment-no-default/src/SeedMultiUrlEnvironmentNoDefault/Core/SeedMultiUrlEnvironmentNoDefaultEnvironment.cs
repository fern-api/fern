...
{
    public static string PRODUCTION = new SeedMultiUrlEnvironmentNoDefaultEnvironment
    {
        Ec2 = "https://ec2.aws.com",
        S3 = "https://s3.aws.com"
    };

    public static string STAGING = new SeedMultiUrlEnvironmentNoDefaultEnvironment
    {
