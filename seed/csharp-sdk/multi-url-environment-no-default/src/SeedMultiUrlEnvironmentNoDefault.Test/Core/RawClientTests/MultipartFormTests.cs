...
public class MultipartFormTests
{
    ...
    private static SeedMultiUrlEnvironmentNoDefault.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedMultiUrlEnvironmentNoDefault.Core.MultipartFormRequest
        {
