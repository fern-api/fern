...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedMultiUrlEnvironmentNoDefaultApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    {
        var exception = new SeedMultiUrlEnvironmentNoDefaultApiException("Error", 500, "body");
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedMultiUrlEnvironmentNoDefault.SeedMultiUrlEnvironmentNoDefaultApiException"
            )
        );
    }
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedMultiUrlEnvironmentNoDefaultApiException("Unauthorized", 401, body);
    ...
    {
        var exception = new SeedMultiUrlEnvironmentNoDefaultApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedMultiUrlEnvironmentNoDefaultApiException("Error", 500, 42);
    ...
    {
        var exception = new SeedMultiUrlEnvironmentNoDefaultApiException("Error", 400, "");
    ...
    {
        var exception = new SeedMultiUrlEnvironmentNoDefaultApiException("Error", 400, false);
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedMultiUrlEnvironmentNoDefaultException>());
