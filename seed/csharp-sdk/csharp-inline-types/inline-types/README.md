...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-inline-types)](https://nuget.org/packages/Ferncsharp-inline-types)
...
```sh
dotnet add package Ferncsharp-inline-types
```
...
var result = await client.GetRootAsync(...).WithRawResponse();
...
var parsedData = await client.GetRootAsync(...);
...
var inlineEnum1 = InlineEnum1.Sunny;

// Using a custom value
var customInlineEnum1 = InlineEnum1.FromCustom("custom-value");

// Using in a switch statement
switch (inlineEnum1.Value)
{
    case InlineEnum1.Values.Sunny:
        Console.WriteLine("Sunny");
        break;
    default:
        Console.WriteLine($"Unknown value: {inlineEnum1.Value}");
        break;
}

// Explicit casting
string inlineEnum1String = (string)InlineEnum1.Sunny;
InlineEnum1 inlineEnum1FromString = (InlineEnum1)"SUNNY";
```
