...
namespace SeedCsharpReadonlyRequest.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedCsharpReadonlyRequestApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedCsharpReadonlyRequestApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedCsharpReadonlyRequest.SeedCsharpReadonlyRequestApiException")
        );
    }
    ...
    {
        var exception = new SeedCsharpReadonlyRequestApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedCsharpReadonlyRequestApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedCsharpReadonlyRequestApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedCsharpReadonlyRequestApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedCsharpReadonlyRequestApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedCsharpReadonlyRequestApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedCsharpReadonlyRequestApiException("Error", 400, "");
    ...
    {
        var exception = new SeedCsharpReadonlyRequestApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedCsharpReadonlyRequestApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedCsharpReadonlyRequestApiException("Error", 429, "rate limited");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedCsharpReadonlyRequestException>());
