...
public class MultipartFormTests
{
    ...
    private static SeedCsharpReadonlyRequest.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedCsharpReadonlyRequest.Core.MultipartFormRequest
        {
