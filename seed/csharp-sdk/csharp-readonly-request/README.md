...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-readonly-request)](https://nuget.org/packages/Ferncsharp-readonly-request)
...
```sh
dotnet add package Ferncsharp-readonly-request
```
...
var parsedData = await client.BatchCreateAsync(...);
