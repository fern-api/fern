...
[![nuget shield](https://img.shields.io/nuget/v/SeedCsharpReadonlyRequest)](https://nuget.org/packages/SeedCsharpReadonlyRequest)
...
```sh
dotnet add package SeedCsharpReadonlyRequest
```
