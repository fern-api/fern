...
namespace SeedCsharpBytesUploadPathParam.Core;
...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedCsharpBytesUploadPathParam.Core.ApiResponse> SendRequestAsync(
        global::SeedCsharpBytesUploadPathParam.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedCsharpBytesUploadPathParam.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::SeedCsharpBytesUploadPathParam.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::SeedCsharpBytesUploadPathParam.Core.BaseRequest request)
    {
