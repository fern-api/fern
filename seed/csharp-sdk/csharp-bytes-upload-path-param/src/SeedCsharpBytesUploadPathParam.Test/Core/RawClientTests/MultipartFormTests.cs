...
public class MultipartFormTests
{
    ...
    private static SeedCsharpBytesUploadPathParam.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedCsharpBytesUploadPathParam.Core.MultipartFormRequest
        {
