...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedHeaderToken.Core.ApiResponse> MakeRequestAsync(
        global::SeedHeaderToken.Core.BaseRequest request,
    ...
    internal async Task<global::SeedHeaderToken.Core.ApiResponse> SendRequestAsync(
        global::SeedHeaderToken.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedHeaderToken.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    internal HttpRequestMessage CreateHttpRequest(global::SeedHeaderToken.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedHeaderToken.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedHeaderToken.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedHeaderToken.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedHeaderToken.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedHeaderToken.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedHeaderToken.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedHeaderToken.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedHeaderToken.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedHeaderToken.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedHeaderToken.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedHeaderToken.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedHeaderToken.Core.StreamRequest;
}
