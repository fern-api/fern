...
[![nuget shield](https://img.shields.io/nuget/v/Fernaccept-header)](https://nuget.org/packages/Fernaccept-header)
...
```sh
dotnet add package Fernaccept-header
```
...
var client = new SeedAcceptClient("TOKEN");
...
var result = await client.Service.EndpointAsync(...).WithRawResponse();
