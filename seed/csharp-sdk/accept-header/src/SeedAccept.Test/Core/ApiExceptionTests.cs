...
namespace SeedAccept.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedAcceptApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedAcceptApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedAccept.SeedAcceptApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SeedAcceptApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedAcceptApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedAcceptApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedAcceptApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedAcceptApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedAcceptApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedAcceptApiException("Error", 400, "");
    ...
    {
        var exception = new SeedAcceptApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SeedAcceptApiException(
            "Service Unavailable",
            503,
            "gateway timeout",
            inner
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedAcceptApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedAcceptApiException("Error: \"quotes\" & <brackets>", 400, "body");
    ...
    {
        var exception = new SeedAcceptApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedAcceptApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedAcceptException>());
