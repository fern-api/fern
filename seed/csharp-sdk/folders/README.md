...
[![nuget shield](https://img.shields.io/nuget/v/Fernfolders)](https://nuget.org/packages/Fernfolders)
...
```sh
dotnet add package Fernfolders
```
...
try {
    var response = await client.Ab.ABFooAsync(...);
...
var result = await client.Ab.ABFooAsync(...).WithRawResponse();
...
var data = await client.Ab.ABFooAsync(...);
```
