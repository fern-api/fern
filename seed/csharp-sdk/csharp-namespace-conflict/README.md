...
[![nuget shield](https://img.shields.io/nuget/v/SeedCsharpNamespaceConflict)](https://nuget.org/packages/SeedCsharpNamespaceConflict)
...
```sh
dotnet add package SeedCsharpNamespaceConflict
```
...
} catch (SeedCsharpNamespaceConflictApiException e) {
