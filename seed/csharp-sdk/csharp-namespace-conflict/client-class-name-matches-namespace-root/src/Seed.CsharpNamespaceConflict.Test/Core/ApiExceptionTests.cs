...
namespace Seed.CsharpNamespaceConflict.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("Seed.CsharpNamespaceConflict.SeedApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SeedApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedApiException("Error", 400, "");
    ...
    {
        var exception = new SeedApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SeedApiException("Service Unavailable", 503, "gateway timeout", inner);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedApiException("Error: \"quotes\" & <brackets>", 400, "body");
    ...
    {
        var exception = new SeedApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedException>());
