...
[![nuget shield](https://img.shields.io/nuget/v/Seed.CsharpNamespaceConflict)](https://nuget.org/packages/Seed.CsharpNamespaceConflict)
...
```sh
dotnet add package Seed.CsharpNamespaceConflict
```
