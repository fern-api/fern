...
[![nuget shield](https://img.shields.io/nuget/v/Fernfile-upload-openapi)](https://nuget.org/packages/Fernfile-upload-openapi)
...
```sh
dotnet add package Fernfile-upload-openapi
```
...
var result = await client.FileUploadExample.UploadFileAsync(...).WithRawResponse();
...
var parsedData = await client.FileUploadExample.UploadFileAsync(...);
