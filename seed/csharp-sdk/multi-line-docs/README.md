...
[![nuget shield](https://img.shields.io/nuget/v/Fernmulti-line-docs)](https://nuget.org/packages/Fernmulti-line-docs)
...
```sh
dotnet add package Fernmulti-line-docs
```
...
var parsedData = await client.User.CreateUserAsync(...);
