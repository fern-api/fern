...
public partial class UserClient : IUserClient
{
    ...
    private async Task<RawResponse> GetUserAsyncCore(
        string userId,
    ...
    )
    {
        ...
        {
            return new SeedMultiLineDocs.RawResponse()
            {
        ...
        }
        {
            ...
            throw new SeedMultiLineDocsApiException(
                ...
                response.StatusCode,
                responseBody,
                rawResponse: new SeedMultiLineDocs.RawResponse()
                {
                    StatusCode = response.Raw.StatusCode,
                    Url = response.Raw.RequestMessage?.RequestUri ?? new Uri("about:blank"),
                    Headers = ResponseHeaders.FromHttpResponseMessage(response.Raw),
    ...
    /// </code></example>
    public WithRawResponseTask GetUserAsync(
        string userId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(GetUserAsyncCore(userId, options, cancellationToken));
    }
