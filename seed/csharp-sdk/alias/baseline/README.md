...
[![nuget shield](https://img.shields.io/nuget/v/Fernalias)](https://nuget.org/packages/Fernalias)
...
var result = await client.GetAsync(...).WithRawResponse();
