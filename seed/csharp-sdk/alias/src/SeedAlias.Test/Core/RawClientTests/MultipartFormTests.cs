...
namespace SeedAlias.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedAlias.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedAlias.Core.MultipartFormRequest
        {
