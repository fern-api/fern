...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-property-name-collision)](https://nuget.org/packages/Ferncsharp-property-name-collision)
...
```sh
dotnet add package Ferncsharp-property-name-collision
```
...
var parsedData = await client._.CreateCatalogAsync(...);
