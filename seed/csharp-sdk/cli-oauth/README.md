...
[![nuget shield](https://img.shields.io/nuget/v/Ferncli-oauth)](https://nuget.org/packages/Ferncli-oauth)
...
```sh
dotnet add package Ferncli-oauth
```
...
var client = new SeedApiClient("grantType", "tenant", "scopes", "client_id", "client_secret");
...
var getTokenAuthRequestAudience = GetTokenAuthRequestAudience.Pets;

// Using a custom value
var customGetTokenAuthRequestAudience = GetTokenAuthRequestAudience.FromCustom("custom-value");

// Using in a switch statement
switch (getTokenAuthRequestAudience.Value)
{
    case GetTokenAuthRequestAudience.Values.Pets:
        Console.WriteLine("Pets");
        break;
    default:
        Console.WriteLine($"Unknown value: {getTokenAuthRequestAudience.Value}");
        break;
}

// Explicit casting
string getTokenAuthRequestAudienceString = (string)GetTokenAuthRequestAudience.Pets;
GetTokenAuthRequestAudience getTokenAuthRequestAudienceFromString = (GetTokenAuthRequestAudience)"pets";
```
