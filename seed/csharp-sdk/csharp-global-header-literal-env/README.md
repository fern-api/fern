...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-global-header-literal-env)](https://nuget.org/packages/Ferncsharp-global-header-literal-env)
...
```sh
dotnet add package Ferncsharp-global-header-literal-env
```
...
} catch (SeedCsharpGlobalHeaderLiteralEnvApiException e) {
...
var result = await client.Service.GetWithLiteralVersionHeaderAsync(...).WithRawResponse();
