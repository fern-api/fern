...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedCsharpGlobalHeaderLiteralEnv.Core.ApiResponse> SendRequestAsync(
        global::SeedCsharpGlobalHeaderLiteralEnv.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedCsharpGlobalHeaderLiteralEnv.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::SeedCsharpGlobalHeaderLiteralEnv.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::SeedCsharpGlobalHeaderLiteralEnv.Core.BaseRequest request)
    {
