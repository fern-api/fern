...
public class MultipartFormTests
{
    ...
    private static SeedCsharpGlobalHeaderLiteralEnv.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedCsharpGlobalHeaderLiteralEnv.Core.MultipartFormRequest
        {
