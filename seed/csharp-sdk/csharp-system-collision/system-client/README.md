...
[![nuget shield](https://img.shields.io/nuget/v/SeedCsharpSystemCollision)](https://nuget.org/packages/SeedCsharpSystemCollision)
...
```sh
dotnet add package SeedCsharpSystemCollision
```
