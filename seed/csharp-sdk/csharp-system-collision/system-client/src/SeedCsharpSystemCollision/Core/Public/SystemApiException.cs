...
/// </summary>
public class SystemApiException(
    string message,
    int statusCode,
    object body,
    Exception? innerException = null,
    SeedCsharpSystemCollision.RawResponse? rawResponse = null
) : SystemException(message, innerException)
{
    ...
    /// </summary>
    public SeedCsharpSystemCollision.RawResponse? RawResponse => rawResponse;
}
