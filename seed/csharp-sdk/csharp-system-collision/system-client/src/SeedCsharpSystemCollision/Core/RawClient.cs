...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedCsharpSystemCollision.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedCsharpSystemCollision.Core.ApiResponse> SendRequestAsync(
        global::SeedCsharpSystemCollision.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedCsharpSystemCollision.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
