...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedCsharpSystemCollision.Core.ApiResponse> MakeRequestAsync(
        global::SeedCsharpSystemCollision.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedCsharpSystemCollision.Core.ApiResponse> SendRequestAsync(
        global::SeedCsharpSystemCollision.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedCsharpSystemCollision.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedCsharpSystemCollision.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedCsharpSystemCollision.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedCsharpSystemCollision.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedCsharpSystemCollision.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedCsharpSystemCollision.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedCsharpSystemCollision.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedCsharpSystemCollision.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedCsharpSystemCollision.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedCsharpSystemCollision.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedCsharpSystemCollision.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedCsharpSystemCollision.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest
        : global::SeedCsharpSystemCollision.Core.StreamRequest;
}
