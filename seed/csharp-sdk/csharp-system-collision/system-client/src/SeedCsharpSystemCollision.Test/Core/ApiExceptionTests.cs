...
namespace SeedCsharpSystemCollision.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SystemApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SystemApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedCsharpSystemCollision.SystemApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SystemApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SystemApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SystemApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SystemApiException("No Content", 204, null!);
    ...
    {
        var exception = new SystemApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SystemApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SystemApiException("Error", 400, "");
    ...
    {
        var exception = new SystemApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SystemApiException(
            "Service Unavailable",
            503,
            "gateway timeout",
            inner
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SystemApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SystemApiException("Error: \"quotes\" & <brackets>", 400, "body");
    ...
    {
        var exception = new SystemApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SystemApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SystemException>());
