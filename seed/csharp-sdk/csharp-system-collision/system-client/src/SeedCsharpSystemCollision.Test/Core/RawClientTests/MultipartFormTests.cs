...
namespace SeedCsharpSystemCollision.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedCsharpSystemCollision.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedCsharpSystemCollision.Core.MultipartFormRequest
        {
