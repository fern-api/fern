...
public class MultipartFormTests
{
    ...
    private static SeedOauthClientCredentialsReference.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedOauthClientCredentialsReference.Core.MultipartFormRequest
        {
