...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedOauthClientCredentialsReferenceApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    {
        var exception = new SeedOauthClientCredentialsReferenceApiException("Error", 500, "body");
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedOauthClientCredentialsReference.SeedOauthClientCredentialsReferenceApiException"
            )
        );
    }
    ...
    {
        var exception = new SeedOauthClientCredentialsReferenceApiException("Error", 500, 42);
    ...
    {
        var exception = new SeedOauthClientCredentialsReferenceApiException("Error", 400, "");
    ...
    {
        var exception = new SeedOauthClientCredentialsReferenceApiException("Error", 400, false);
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedOauthClientCredentialsReferenceException>());
