...
public class MultipartFormTests
{
    ...
    private static SeedCsharpGlobalHeaderEnv.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedCsharpGlobalHeaderEnv.Core.MultipartFormRequest
        {
