...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedCsharpGlobalHeaderEnv.Core.ApiResponse> SendRequestAsync(
        global::SeedCsharpGlobalHeaderEnv.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedCsharpGlobalHeaderEnv.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::SeedCsharpGlobalHeaderEnv.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::SeedCsharpGlobalHeaderEnv.Core.BaseRequest request)
    {
