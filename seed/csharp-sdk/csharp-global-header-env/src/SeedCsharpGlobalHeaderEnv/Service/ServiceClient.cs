...
public partial class ServiceClient : IServiceClient
{
    ...
    {
        var _queryString = new SeedCsharpGlobalHeaderEnv.Core.QueryStringBuilder.Builder(
            capacity: 0
        )
            .MergeAdditional(options?.AdditionalQueryParameters)
            .Build();
        var _headers = await new SeedCsharpGlobalHeaderEnv.Core.HeadersBuilder.Builder()
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                {
                    Data = responseData,
                    RawResponse = new SeedCsharpGlobalHeaderEnv.RawResponse()
                    {
            ...
            {
                throw new SeedCsharpGlobalHeaderEnvApiException(
