...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-global-header-env)](https://nuget.org/packages/Ferncsharp-global-header-env)
...
```sh
dotnet add package Ferncsharp-global-header-env
```
...
} catch (SeedCsharpGlobalHeaderEnvApiException e) {
