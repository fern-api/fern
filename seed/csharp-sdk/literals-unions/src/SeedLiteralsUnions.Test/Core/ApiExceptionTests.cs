...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedLiteralsUnionsApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedLiteralsUnionsApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedLiteralsUnions.SeedLiteralsUnionsApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SeedLiteralsUnionsApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedLiteralsUnionsApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedLiteralsUnionsApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedLiteralsUnionsApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedLiteralsUnionsApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedLiteralsUnionsApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedLiteralsUnionsApiException("Error", 400, "");
    ...
    {
        var exception = new SeedLiteralsUnionsApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SeedLiteralsUnionsApiException(
            "Service Unavailable",
            503,
            "gateway timeout",
            inner
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedLiteralsUnionsApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedLiteralsUnionsApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedLiteralsUnionsApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedLiteralsUnionsException>());
