...
namespace SeedLiteralsUnions.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedLiteralsUnions.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedLiteralsUnions.Core.MultipartFormRequest
        {
