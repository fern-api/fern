...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::SeedLiteralsUnions.Core.ApiResponse> MakeRequestAsync(
        global::SeedLiteralsUnions.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::SeedLiteralsUnions.Core.ApiResponse> SendRequestAsync(
        global::SeedLiteralsUnions.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SeedLiteralsUnions.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedLiteralsUnions.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedLiteralsUnions.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedLiteralsUnions.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedLiteralsUnions.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedLiteralsUnions.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedLiteralsUnions.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedLiteralsUnions.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedLiteralsUnions.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedLiteralsUnions.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedLiteralsUnions.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedLiteralsUnions.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedLiteralsUnions.Core.StreamRequest;
}
