...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedLiteralsUnions.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async Task<global::SeedLiteralsUnions.Core.ApiResponse> SendRequestAsync(
        global::SeedLiteralsUnions.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedLiteralsUnions.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
