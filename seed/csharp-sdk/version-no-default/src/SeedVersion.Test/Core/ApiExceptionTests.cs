...
namespace SeedVersion.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedVersionApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedVersionApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedVersion.SeedVersionApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SeedVersionApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedVersionApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedVersionApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedVersionApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedVersionApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedVersionApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedVersionApiException("Error", 400, "");
    ...
    {
        var exception = new SeedVersionApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SeedVersionApiException(
            "Service Unavailable",
            503,
            "gateway timeout",
            inner
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedVersionApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedVersionApiException("Error: \"quotes\" & <brackets>", 400, "body");
    ...
    {
        var exception = new SeedVersionApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedVersionApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedVersionException>());
