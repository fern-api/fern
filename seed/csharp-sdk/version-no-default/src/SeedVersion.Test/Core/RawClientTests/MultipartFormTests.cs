...
namespace SeedVersion.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedVersion.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedVersion.Core.MultipartFormRequest
        {
