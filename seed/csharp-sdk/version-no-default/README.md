...
[![nuget shield](https://img.shields.io/nuget/v/Fernversion-no-default)](https://nuget.org/packages/Fernversion-no-default)
...
```sh
dotnet add package Fernversion-no-default
```
...
var result = await client.User.GetUserAsync(...).WithRawResponse();
...
var data = await client.User.GetUserAsync(...);
```
