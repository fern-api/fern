...
namespace SeedEmptyClients.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedEmptyClientsApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedEmptyClientsApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(result, Does.Contain("SeedEmptyClients.SeedEmptyClientsApiException"));
    }

    [Test]
    public void ToString_WithStringBody_IncludesSerializedBody()
    {
        var exception = new SeedEmptyClientsApiException("Bad Request", 400, "some error text");
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedEmptyClientsApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedEmptyClientsApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedEmptyClientsApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedEmptyClientsApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedEmptyClientsApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedEmptyClientsApiException("Error", 400, "");
    ...
    {
        var exception = new SeedEmptyClientsApiException("Error", 400, false);
    ...
    public void ToString_WithInnerException_IncludesInnerExceptionDetails()
    {
        ...
        var exception = new SeedEmptyClientsApiException(
            "Service Unavailable",
            503,
            "gateway timeout",
            inner
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedEmptyClientsApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedEmptyClientsApiException("Error", 429, "rate limited");
    ...
    {
        var exception = new SeedEmptyClientsApiException("Something went wrong", 500, "body");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedEmptyClientsException>());
