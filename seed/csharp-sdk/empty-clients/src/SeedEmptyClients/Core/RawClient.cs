...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedEmptyClients.Core.ApiResponse> MakeRequestAsync(
        SeedEmptyClients.Core.BaseRequest request,
    ...
    internal async Task<SeedEmptyClients.Core.ApiResponse> SendRequestAsync(
        SeedEmptyClients.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedEmptyClients.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedEmptyClients.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedEmptyClients.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedEmptyClients.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedEmptyClients.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedEmptyClients.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedEmptyClients.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedEmptyClients.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedEmptyClients.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedEmptyClients.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedEmptyClients.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedEmptyClients.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedEmptyClients.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedEmptyClients.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedEmptyClients.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedEmptyClients.Core.StreamRequest;
}
