...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::SeedEmptyClients.Core.ApiResponse> MakeRequestAsync(
        global::SeedEmptyClients.Core.BaseRequest request,
    ...
    internal async Task<global::SeedEmptyClients.Core.ApiResponse> SendRequestAsync(
        global::SeedEmptyClients.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::SeedEmptyClients.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    internal HttpRequestMessage CreateHttpRequest(global::SeedEmptyClients.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::SeedEmptyClients.Core.ApiResponse instead.")]
    internal record ApiResponse : global::SeedEmptyClients.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::SeedEmptyClients.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::SeedEmptyClients.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedEmptyClients.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::SeedEmptyClients.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedEmptyClients.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::SeedEmptyClients.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedEmptyClients.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::SeedEmptyClients.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::SeedEmptyClients.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::SeedEmptyClients.Core.StreamRequest;
}
