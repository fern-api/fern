...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedPagination.Core.ApiResponse> MakeRequestAsync(
        SeedPagination.Core.BaseRequest request,
    ...
    internal async Task<SeedPagination.Core.ApiResponse> SendRequestAsync(
        SeedPagination.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedPagination.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedPagination.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedPagination.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedPagination.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedPagination.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedPagination.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedPagination.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedPagination.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedPagination.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedPagination.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedPagination.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedPagination.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedPagination.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedPagination.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedPagination.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedPagination.Core.StreamRequest;
}
