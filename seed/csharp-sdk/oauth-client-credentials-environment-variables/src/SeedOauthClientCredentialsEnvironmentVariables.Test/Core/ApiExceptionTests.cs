...
namespace SeedOauthClientCredentialsEnvironmentVariables.Test.Core;
...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedOauthClientCredentialsEnvironmentVariablesApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    public void ToString_ContainsFullTypeName()
    {
        ...
        Assert.That(
            result,
            Does.Contain(
                "SeedOauthClientCredentialsEnvironmentVariables.SeedOauthClientCredentialsEnvironmentVariablesApiException"
            )
        );
    }
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(
            exception,
            Is.InstanceOf<SeedOauthClientCredentialsEnvironmentVariablesException>()
        );
