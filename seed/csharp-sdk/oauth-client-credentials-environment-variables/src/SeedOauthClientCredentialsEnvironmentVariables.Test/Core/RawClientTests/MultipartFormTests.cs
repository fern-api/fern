...
public class MultipartFormTests
{
    ...
    private static SeedOauthClientCredentialsEnvironmentVariables.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedOauthClientCredentialsEnvironmentVariables.Core.MultipartFormRequest
        {
