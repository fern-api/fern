...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedBytes.Core.ApiResponse> MakeRequestAsync(
        SeedBytes.Core.BaseRequest request,
    ...
    internal async Task<SeedBytes.Core.ApiResponse> SendRequestAsync(
        SeedBytes.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedBytes.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedBytes.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedBytes.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedBytes.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedBytes.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedBytes.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedBytes.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedBytes.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedBytes.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedBytes.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedBytes.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedBytes.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedBytes.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedBytes.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedBytes.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedBytes.Core.StreamRequest;
}
