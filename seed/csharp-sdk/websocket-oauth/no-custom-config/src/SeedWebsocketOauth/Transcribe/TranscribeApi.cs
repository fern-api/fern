        ...
        INotifyPropertyChanged
{
    ...
    public TranscribeApi(TranscribeApi.Options options)
    {
        ...
        {
            Query = new SeedWebsocketOauth.Core.QueryStringBuilder.Builder(capacity: 3)
    ...
    /// <summary>
    /// Sends a AudioEvent message to the server
    /// </summary>
    public async Task Send(AudioEvent message, CancellationToken cancellationToken = default)
    {
    ...
    public class Options
    {
        ...
        /// <summary>
        /// TenantName. If not set, inherited from the parent client.
        /// </summary>
        public string? TenantName { get; set; }

        /// <summary>
        /// Token. If not set, inherited from the parent client.
        /// </summary>
