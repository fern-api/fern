...
[![nuget shield](https://img.shields.io/nuget/v/Fernapi-wide-base-path-with-default)](https://nuget.org/packages/Fernapi-wide-base-path-with-default)
...
```sh
dotnet add package Fernapi-wide-base-path-with-default
```
