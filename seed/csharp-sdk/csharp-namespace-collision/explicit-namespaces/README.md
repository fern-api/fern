...
[![nuget shield](https://img.shields.io/nuget/v/Ferncsharp-namespace-collision)](https://nuget.org/packages/Ferncsharp-namespace-collision)
...
```sh
dotnet add package Ferncsharp-namespace-collision
```
...
var parsedData = await client.CreateUserAsync(...);
