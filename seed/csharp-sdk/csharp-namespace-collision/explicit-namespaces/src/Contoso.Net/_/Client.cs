...
public partial class Client : IClient
{
    ...
    private async global::System.Threading.Tasks.Task<
        WithRawResponse<global::Contoso.Net.Task>
    > CreateTaskAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<global::Contoso.Net.Task>(responseBody)!;
                return new WithRawResponse<global::Contoso.Net.Task>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<global::Contoso.Net.Task> CreateTaskAsync(
        global::Contoso.Net.Task request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<global::Contoso.Net.Task>(
