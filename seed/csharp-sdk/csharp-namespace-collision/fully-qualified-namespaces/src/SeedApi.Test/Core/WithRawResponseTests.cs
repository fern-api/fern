...
{
    [Test]
    public async System.Threading.Tasks.Task WithRawResponseTask_DirectAwait_ReturnsData()
    {
        // Arrange
    ...
    [Test]
    public async System.Threading.Tasks.Task WithRawResponseTask_WithRawResponse_ReturnsDataAndMetadata()
    {
        // Arrange
        var expectedData = "test-data";
    ...
    [Test]
    public async System.Threading.Tasks.Task ResponseHeaders_TryGetValue_CaseInsensitive()
    {
        // Arrange
    ...
    [Test]
    public async System.Threading.Tasks.Task ResponseHeaders_TryGetValues_ReturnsMultipleValues()
    {
        // Arrange
        using var response = CreateHttpResponse(HttpStatusCode.OK);
    ...
    [Test]
    public async System.Threading.Tasks.Task ResponseHeaders_ContentType_ReturnsValue()
    {
        // Arrange
        using var response = CreateHttpResponse(HttpStatusCode.OK);
    ...
    [Test]
    public async System.Threading.Tasks.Task ResponseHeaders_ContentLength_ReturnsValue()
    {
        // Arrange
    ...
    [Test]
    public async System.Threading.Tasks.Task ResponseHeaders_Contains_ReturnsTrueForExistingHeader()
    {
        // Arrange
        using var response = CreateHttpResponse(HttpStatusCode.OK);
    ...
    [Test]
    public async System.Threading.Tasks.Task ResponseHeaders_Enumeration_IncludesAllHeaders()
    {
        // Arrange
        using var response = CreateHttpResponse(HttpStatusCode.OK);
    ...
    [Test]
    public async System.Threading.Tasks.Task WithRawResponseTask_ErrorStatusCode_StillReturnsMetadata()
    {
        // Arrange
    ...
    [Test]
    public async System.Threading.Tasks.Task WithRawResponseTask_Url_IsPreserved()
    {
        // Arrange
    ...
    [Test]
    public async System.Threading.Tasks.Task ResponseHeaders_TryGetValue_NonExistentHeader_ReturnsFalse()
    {
        // Arrange
        using var response = CreateHttpResponse(HttpStatusCode.OK);
        var headers = ResponseHeaders.FromHttpResponseMessage(response);
    ...
    [Test]
    public async System.Threading.Tasks.Task ResponseHeaders_TryGetValues_NonExistentHeader_ReturnsFalse()
    {
        // Arrange
        using var response = CreateHttpResponse(HttpStatusCode.OK);
        var headers = ResponseHeaders.FromHttpResponseMessage(response);
    ...
    [Test]
    public async System.Threading.Tasks.Task WithRawResponseTask_ImplicitConversion_ToTask()
    {
        // Arrange
        var expectedData = "test-data";
        var task = CreateWithRawResponseTask(expectedData, HttpStatusCode.OK);
    ...
    public void WithRawResponseTask_ImplicitConversion_AssignToTaskVariable()
    {
        ...
        Task<string> regularTask = wrappedTask;

        // Assert
        Assert.That(regularTask, Is.Not.Null);
        Assert.That(regularTask, Is.InstanceOf<Task<string>>());
    }
    ...
    )
    {
        ...
        var task = System.Threading.Tasks.Task.FromResult(withRawResponse);
