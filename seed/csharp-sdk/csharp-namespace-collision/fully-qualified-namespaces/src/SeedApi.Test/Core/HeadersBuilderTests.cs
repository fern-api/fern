...
{
    [Test]
    public async System.Threading.Tasks.Task Add_SimpleHeaders()
    {
    ...
    [Test]
    public async System.Threading.Tasks.Task Add_NullValuesIgnored()
    {
        var headers = await new HeadersBuilder.Builder()
            .Add("Header1", "value1")
            .Add("Header2", null)
    ...
    [Test]
    public async System.Threading.Tasks.Task Add_OverwritesExistingHeader()
    {
        var headers = await new HeadersBuilder.Builder()
            .Add("Content-Type", "application/json")
    ...
    [Test]
    public async System.Threading.Tasks.Task Add_HeadersOverload_MergesExistingHeaders()
    {
    ...
    [Test]
    public async System.Threading.Tasks.Task Add_HeadersOverload_OverwritesExistingHeaders()
    {
        var existingHeaders = new Headers(
    ...
    [Test]
    public async System.Threading.Tasks.Task Add_HeadersOverload_NullHeadersIgnored()
    {
        var result = await new HeadersBuilder.Builder()
            .Add("Header1", "value1")
            .Add((Headers?)null)
    ...
    [Test]
    public async System.Threading.Tasks.Task Add_KeyValuePairOverload_AddsHeaders()
    {
    ...
    [Test]
    public async System.Threading.Tasks.Task Add_KeyValuePairOverload_IgnoresNullValues()
    {
        var additionalHeaders = new List<KeyValuePair<string, string?>>
        {
            new("Header1", "value1"),
    ...
    [Test]
    public async System.Threading.Tasks.Task Add_DictionaryOverload_AddsHeaders()
    {
    ...
    [Test]
    public async System.Threading.Tasks.Task EmptyBuilder_ReturnsEmptyHeaders()
    {
    ...
    [Test]
    public async System.Threading.Tasks.Task OnlyNullValues_ReturnsEmptyHeaders()
    {
        var headers = await new HeadersBuilder.Builder()
            .Add("Header1", null)
            .Add("Header2", null)
    ...
    [Test]
    public async System.Threading.Tasks.Task ComplexMergingScenario()
    {
    ...
    [Test]
    public async System.Threading.Tasks.Task Builder_WithCapacity()
    {
    ...
    [Test]
    public async System.Threading.Tasks.Task Add_HeadersOverload_ResolvesDynamicHeaderValues()
    {
        // Test that BuildAsync properly resolves HeaderValue instances
        var existingHeaders = new Headers();
        existingHeaders["DynamicHeader"] =
            (Func<Task<string>>)(() => System.Threading.Tasks.Task.FromResult("dynamic-value"));
    ...
    [Test]
    public async System.Threading.Tasks.Task MultipleSyncAdds()
    {
    ...
    [Test]
    public async System.Threading.Tasks.Task PrecedenceOrder_LatestWins()
    {
    ...
    [Test]
    public async System.Threading.Tasks.Task CaseInsensitiveKeys()
    {
