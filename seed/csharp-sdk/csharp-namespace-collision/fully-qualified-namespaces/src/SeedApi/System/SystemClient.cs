...
public partial class SystemClient : ISystemClient
{
    ...
    private async Task<WithRawResponse<SystemUser>> CreateuserAsyncCore(
        SystemUser request,
    ...
    private async Task<WithRawResponse<SystemTask>> CreatetaskAsyncCore(
        SystemTask request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    private async Task<WithRawResponse<SystemUser>> GetuserAsyncCore(
