...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedCsharpNamespaceCollisionApiException(
            "Not Found",
            404,
            "error body"
        );
    ...
    {
        var exception = new SeedCsharpNamespaceCollisionApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedCsharpNamespaceCollision.SeedCsharpNamespaceCollisionApiException")
        );
    }
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedCsharpNamespaceCollisionApiException("Unauthorized", 401, body);
    ...
    {
        var exception = new SeedCsharpNamespaceCollisionApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedCsharpNamespaceCollisionApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedCsharpNamespaceCollisionApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedCsharpNamespaceCollisionApiException("Error", 400, "");
    ...
    {
        var exception = new SeedCsharpNamespaceCollisionApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var inner = new InvalidOperationException("write failed", innerMost);

        var exception = new SeedCsharpNamespaceCollisionApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedCsharpNamespaceCollisionApiException("Error", 429, "rate limited");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedCsharpNamespaceCollisionException>());
