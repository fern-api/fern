...
[![nuget shield](https://img.shields.io/nuget/v/Fernmulti-url-environment-reference)](https://nuget.org/packages/Fernmulti-url-environment-reference)
...
```sh
dotnet add package Fernmulti-url-environment-reference
```
