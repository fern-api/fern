...
[![nuget shield](https://img.shields.io/nuget/v/Fernbasic-auth)](https://nuget.org/packages/Fernbasic-auth)
...
```sh
dotnet add package Fernbasic-auth
```
...
var client = new SeedBasicAuthClient(
    clientOptions: new ClientOptions { Username = "USERNAME", Password = "PASSWORD" }
);
