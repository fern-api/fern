...
namespace SeedBasicAuth.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedBasicAuth.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedBasicAuth.Core.MultipartFormRequest
        {
