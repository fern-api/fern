...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SeedBasicAuth.Core.ApiResponse> MakeRequestAsync(
        SeedBasicAuth.Core.BaseRequest request,
    ...
    internal async Task<SeedBasicAuth.Core.ApiResponse> SendRequestAsync(
        SeedBasicAuth.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SeedBasicAuth.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SeedBasicAuth.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SeedBasicAuth.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SeedBasicAuth.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SeedBasicAuth.Core.ApiResponse instead.")]
    internal record ApiResponse : SeedBasicAuth.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SeedBasicAuth.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SeedBasicAuth.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedBasicAuth.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SeedBasicAuth.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedBasicAuth.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SeedBasicAuth.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedBasicAuth.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SeedBasicAuth.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SeedBasicAuth.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SeedBasicAuth.Core.StreamRequest;
}
