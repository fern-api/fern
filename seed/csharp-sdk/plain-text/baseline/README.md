...
[![nuget shield](https://img.shields.io/nuget/v/Fernplain-text)](https://nuget.org/packages/Fernplain-text)
...
```sh
dotnet add package Fernplain-text
```
...
var result = await client.Service.GetTextAsync(...).WithRawResponse();
...
var data = await client.Service.GetTextAsync(...);
```
