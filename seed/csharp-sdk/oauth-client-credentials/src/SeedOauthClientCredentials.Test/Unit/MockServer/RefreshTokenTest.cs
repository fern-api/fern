...
public class RefreshTokenTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest() {
        ...
        var response = await Client.Auth.RefreshTokenAsync(new RefreshTokenRequest{ 
                ClientId = "client_id", ClientSecret = "client_secret", RefreshToken = "refresh_token", Audience = "https://api.example.com", GrantType = "refresh_token", Scope = "scope"
            }, RequestOptions);
