...
public class ApiExceptionTests
{
    ...
    {
        var exception = new SeedOauthClientCredentialsApiException("Not Found", 404, "error body");
    ...
    {
        var exception = new SeedOauthClientCredentialsApiException("Error", 500, "body");

        var result = exception.ToString();

        Assert.That(
            result,
            Does.Contain("SeedOauthClientCredentials.SeedOauthClientCredentialsApiException")
        );
    }
    ...
    {
        var exception = new SeedOauthClientCredentialsApiException(
            "Bad Request",
            400,
            "some error text"
        );
    ...
    public void ToString_WithObjectBody_SerializesBodyAsJson()
    {
        ...
        var exception = new SeedOauthClientCredentialsApiException("Unauthorized", 401, body);
    ...
    public void ToString_WithNestedObjectBody_SerializesNestedJson()
    {
        ...
        var exception = new SeedOauthClientCredentialsApiException("Validation Failed", 422, body);
    ...
    {
        var exception = new SeedOauthClientCredentialsApiException("No Content", 204, null!);
    ...
    {
        var exception = new SeedOauthClientCredentialsApiException("Error", 500, 42);
    ...
    public void ToString_WithListBody_SerializesArray()
    {
        ...
        var exception = new SeedOauthClientCredentialsApiException("Multiple Errors", 400, body);
    ...
    {
        var exception = new SeedOauthClientCredentialsApiException("Error", 400, "");
    ...
    {
        var exception = new SeedOauthClientCredentialsApiException("Error", 400, false);
    ...
    public void ToString_WithNestedInnerExceptions_IncludesOutermostInnerException()
    {
        ...
        var exception = new SeedOauthClientCredentialsApiException("Error", 500, "body", inner);
    ...
    {
        var exception = new SeedOauthClientCredentialsApiException("Error", 429, "rate limited");
    ...
    public void InheritsFromBaseException()
    {
        ...
        Assert.That(exception, Is.InstanceOf<SeedOauthClientCredentialsException>());
