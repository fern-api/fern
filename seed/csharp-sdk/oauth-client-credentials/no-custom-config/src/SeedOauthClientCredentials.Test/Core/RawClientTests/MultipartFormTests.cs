...
namespace SeedOauthClientCredentials.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SeedOauthClientCredentials.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SeedOauthClientCredentials.Core.MultipartFormRequest
        {
