...
[![nuget shield](https://img.shields.io/nuget/v/Fernopenapi-per-spec-base-path-disabled)](https://nuget.org/packages/Fernopenapi-per-spec-base-path-disabled)
...
```sh
dotnet add package Fernopenapi-per-spec-base-path-disabled
```
...
var result = await client.Oauth.GetTokenAsync(...).WithRawResponse();
...
var parsedData = await client.Oauth.GetTokenAsync(...);
