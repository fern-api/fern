...
class SeedClient
{
     ...
     */
    public function refund(string $id, RefundBody $request, ?array $options = null): void
    {
     ...
     *
     * @param string $id
     * @param RequiredRefundRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws SeedApiException
     */
    public function requiredRefund(string $id, RequiredRefundRequest $request, ?array $options = null): void
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
