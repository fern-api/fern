 ...
 */
class StreamXFernStreamingUnionStreamRequest extends JsonSerializableType
{
    /**
     * @var true $streamResponse
     */
    ...
    /**
     * @param true $streamResponse
     * @param UnionStreamMessageVariant $message
     * @return StreamXFernStreamingUnionStreamRequest
     */
    public static function message(bool $streamResponse, UnionStreamMessageVariant $message): StreamXFernStreamingUnionStreamRequest
    {
        return new StreamXFernStreamingUnionStreamRequest([
     ...
     * @return StreamXFernStreamingUnionStreamRequest
     */
    public static function interrupt(bool $streamResponse, UnionStreamInterruptVariant $interrupt): StreamXFernStreamingUnionStreamRequest
    {
        return new StreamXFernStreamingUnionStreamRequest([
            'streamResponse' => $streamResponse,
            'type' => 'interrupt',
     ...
     * @return StreamXFernStreamingUnionStreamRequest
     */
    public static function compact(bool $streamResponse, UnionStreamCompactVariant $compact): StreamXFernStreamingUnionStreamRequest
    {
        return new StreamXFernStreamingUnionStreamRequest([
            'streamResponse' => $streamResponse,
            'type' => 'compact',
    ...
    public static function jsonDeserialize(array $data): static
    {
        ...
        if (!($data['stream_response'] === true)) {
            throw new Exception(
                "Expected property 'streamResponse' in JSON data to be true, instead received " . get_debug_type($data['stream_response']),
            );
        }
