...
class SeedClient
{
     ...
     */
    public function listAuditLogs(ListAuditLogsRequest $request = new ListAuditLogsRequest(), ?array $options = null): void
    {
        ...
        if ($request->includeResolved !== null) {
            $query['includeResolved'] = $request->includeResolved;
        }
     ...
     * ```
     *
     * @param CountAuditLogsRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws SeedApiException
     */
    public function countAuditLogs(CountAuditLogsRequest $request = new CountAuditLogsRequest(), ?array $options = null): void
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
        if ($request->resolvedOnly !== null) {
            $query['resolvedOnly'] = $request->resolvedOnly;
        }
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
