...
class ScalarTypesTestTypeWithTrait extends SerializableType
{
...
class ScalarTypesTestWithTrait extends TestCase
{
    public function testAllScalarTypesIncludingTraitProperty(): void
    {
        // Create test data
        $data = [
            'integer_property' => 42,
        ...
        $object = ScalarTypesTestTypeWithTrait::fromJson($json);
