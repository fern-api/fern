...
namespace Seed\EndpointsContainer;
...
class EndpointsContainerClient
{
     ...
     */
    public function endpointsContainerGetAndReturnListOfPrimitives(array $request, ?array $options = null): ?array
    {
     ...
     * @throws SeedApiException
     */
    public function endpointsContainerGetAndReturnListOfObjects(array $request, ?array $options = null): ?array
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function endpointsContainerGetAndReturnSetOfPrimitives(array $request, ?array $options = null): ?array
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function endpointsContainerGetAndReturnSetOfObjects(array $request, ?array $options = null): ?array
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function endpointsContainerGetAndReturnMapPrimToPrim(array $request, ?array $options = null): ?array
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function endpointsContainerGetAndReturnMapOfPrimToObject(array $request, ?array $options = null): ?array
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function endpointsContainerGetAndReturnMapOfPrimToUndiscriminatedUnion(array $request, ?array $options = null): ?array
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function endpointsContainerGetAndReturnOptional(TypesObjectWithRequiredField $request, ?array $options = null): ?TypesObjectWithRequiredField
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
