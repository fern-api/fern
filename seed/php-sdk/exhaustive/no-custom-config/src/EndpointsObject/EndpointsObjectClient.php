...
namespace Seed\EndpointsObject;
...
class EndpointsObjectClient
{
     ...
     */
    public function endpointsObjectGetAndReturnWithOptionalField(TypesObjectWithOptionalField $request, ?array $options = null): ?TypesObjectWithOptionalField
    {
     ...
     * @throws SeedApiException
     */
    public function endpointsObjectGetAndReturnWithRequiredField(TypesObjectWithRequiredField $request, ?array $options = null): ?TypesObjectWithRequiredField
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function endpointsObjectGetAndReturnWithMapOfMap(TypesObjectWithMapOfMap $request, ?array $options = null): ?TypesObjectWithMapOfMap
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function endpointsObjectGetAndReturnNestedWithOptionalField(TypesNestedObjectWithOptionalField $request, ?array $options = null): ?TypesNestedObjectWithOptionalField
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
    ...
    /**
     * @param string $string
     * @param EndpointsObjectGetAndReturnNestedWithRequiredFieldRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws SeedApiException
     */
    public function endpointsObjectGetAndReturnNestedWithRequiredField(string $string, EndpointsObjectGetAndReturnNestedWithRequiredFieldRequest $request, ?array $options = null): ?TypesNestedObjectWithRequiredField
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function endpointsObjectGetAndReturnNestedWithRequiredFieldAsList(array $request, ?array $options = null): ?TypesNestedObjectWithRequiredField
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function endpointsObjectGetAndReturnWithUnknownField(TypesObjectWithUnknownField $request, ?array $options = null): ?TypesObjectWithUnknownField
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function endpointsObjectGetAndReturnWithDocumentedUnknownType(TypesObjectWithDocumentedUnknownType $request, ?array $options = null): ?TypesObjectWithDocumentedUnknownType
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function endpointsObjectGetAndReturnMapOfDocumentedUnknownType(array $request, ?array $options = null): ?array
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     *
     * @param TypesObjectWithMixedRequiredAndOptionalFields $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return ?TypesObjectWithMixedRequiredAndOptionalFields
     * @throws SeedException
     * @throws SeedApiException
     */
    public function endpointsObjectGetAndReturnWithMixedRequiredAndOptionalFields(TypesObjectWithMixedRequiredAndOptionalFields $request, ?array $options = null): ?TypesObjectWithMixedRequiredAndOptionalFields
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return TypesObjectWithMixedRequiredAndOptionalFields::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SeedException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     *
     * @param TypesObjectWithRequiredNestedObject $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return ?TypesObjectWithRequiredNestedObject
     * @throws SeedException
     * @throws SeedApiException
     */
    public function endpointsObjectGetAndReturnWithRequiredNestedObject(TypesObjectWithRequiredNestedObject $request, ?array $options = null): ?TypesObjectWithRequiredNestedObject
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return TypesObjectWithRequiredNestedObject::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SeedException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     * @throws SeedApiException
     */
    public function endpointsObjectGetAndReturnWithDatetimeLikeString(TypesObjectWithDatetimeLikeString $request, ?array $options = null): ?TypesObjectWithDatetimeLikeString
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
