...
class EndpointsUnionClient
{
     ...
     */
    public function endpointsUnionGetAndReturnUnion(TypesAnimalZero|TypesAnimalOne $request, ?array $options = null): TypesAnimalZero|TypesAnimalOne|null
    {
