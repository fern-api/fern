...
class HttpMethodsClient
{
    ...
    /**
     * @param string $id
     * @param TestPutHttpMethodsRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws SeedApiException
     */
    public function testPut(string $id, TestPutHttpMethodsRequest $request, ?array $options = null): ?TypesObjectWithOptionalField
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
    ...
    /**
     * @param string $id
     * @param TestPatchHttpMethodsRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws SeedApiException
     */
    public function testPatch(string $id, TestPatchHttpMethodsRequest $request, ?array $options = null): ?TypesObjectWithOptionalField
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function testPost(TypesObjectWithRequiredField $request, ?array $options = null): ?TypesObjectWithOptionalField
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
