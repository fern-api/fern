...
class TestgroupClient
{
     ...
     * @param TestGroupTestMethodNameRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function testMethodName(string $pathParam, TestGroupTestMethodNameRequest $request, ?array $options = null): mixed
    {
