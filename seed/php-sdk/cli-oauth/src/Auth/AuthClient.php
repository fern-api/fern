...
class AuthClient
{
     ...
     * ```
     *
     * @param GetTokenAuthRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function getToken(GetTokenAuthRequest $request, ?array $options = null): ?TokenResponse
    {
     ...
     * ```
     *
     * @param RefreshTokenAuthRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws SeedApiException
     */
    public function refreshToken(RefreshTokenAuthRequest $request, ?array $options = null): ?TokenResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
