...
class SeedClient
{
     ...
     */
    public function refund(string $id, ?RefundRequest $request = null, ?array $options = null): ?Refund
    {
     ...
     * @throws SeedApiException
     */
    public function bulkRefund(?RefundRequest $request = null, ?array $options = null): ?array
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SeedApiException
     */
    public function refundWithHeader(RefundWithHeaderRequest $request = new RefundWithHeaderRequest(), ?array $options = null): ?Refund
    {
        $options = array_merge($this->options, $options ?? []);
        $headers = [];
     ...
     * @throws SeedApiException
     */
    public function refundExactAmount(string $id, ?ExactRefundRequest $request = null, ?array $options = null): ?Refund
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
