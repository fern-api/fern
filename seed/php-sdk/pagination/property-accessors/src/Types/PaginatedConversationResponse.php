...
class PaginatedConversationResponse extends JsonSerializableType
{
    ...
    /**
     * @var value-of<PaginatedConversationResponseType> $type
     */
    #[JsonProperty('type')]
    private string $type;
     ...
     *   totalCount: int,
     *   type: value-of<PaginatedConversationResponseType>,
     *   pages?: ?CursorPages,
     * } $values
     */
    ...
    /**
     * @return value-of<PaginatedConversationResponseType>
     */
    ...
    /**
     * @param value-of<PaginatedConversationResponseType> $value
     */
