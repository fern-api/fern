...
use Seed\InlineUsers\InlineUsers\Types\User;
use Seed\Core\Pagination\CursorPager;
use Seed\InlineUsers\InlineUsers\Types\ListUsersPaginationResponse;
use Seed\InlineUsers\InlineUsers\Requests\ListUsersMixedTypeCursorPaginationRequest;
use Seed\InlineUsers\InlineUsers\Types\ListUsersMixedTypePaginationResponse;
use Seed\InlineUsers\InlineUsers\Requests\ListUsersBodyCursorPaginationRequest;
use Seed\Core\Pagination\PaginationHelper;
use Seed\InlineUsers\InlineUsers\Requests\ListUsersOffsetPaginationRequest;
...
use Seed\InlineUsers\InlineUsers\Types\ListUsersExtendedResponse;
use Seed\InlineUsers\InlineUsers\Requests\ListUsersExtendedRequestForOptionalData;
use Seed\InlineUsers\InlineUsers\Types\ListUsersExtendedOptionalListResponse;
...
use Seed\InlineUsers\InlineUsers\Types\UsernameContainer;
...
class InlineUsersClient 
{
    ...
    public function listWithCursorPagination(ListUsersCursorPaginationRequest $request = new ListUsersCursorPaginationRequest(), ?array $options = null): Pager {
        return new CursorPager(
            ...
            /* @phpstan-ignore-next-line */
            getItems: fn (ListUsersPaginationResponse $response) => $response?->getData()?->getUsers() ?? [],
        );
    }
    ...
    public function listWithMixedTypeCursorPagination(ListUsersMixedTypeCursorPaginationRequest $request = new ListUsersMixedTypeCursorPaginationRequest(), ?array $options = null): Pager {
        return new CursorPager(
            ...
            /* @phpstan-ignore-next-line */
            getItems: fn (ListUsersMixedTypePaginationResponse $response) => $response?->getData()?->getUsers() ?? [],
        );
    }
