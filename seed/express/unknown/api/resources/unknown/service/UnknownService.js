            ...
            try {
                yield this.methods.post(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(yield serializers.unknown.post.Response.jsonOrThrow(responseBody, {
                ...
                if (error instanceof errors.SeedUnknownAsAnyError) {
                    console.warn(`Endpoint 'post' unexpectedly threw ${error.constructor.name}.` +
...
exports.UnknownService = UnknownService;
