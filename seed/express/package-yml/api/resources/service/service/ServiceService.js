...
class ServiceService {
    ...
    toRouter() {
        this.router.get("/:nestedId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.nop(req, {
                ...
                if (error instanceof errors.SeedPackageYmlError) {
                    console.warn(`Endpoint 'nop' unexpectedly threw ${error.constructor.name}.` +
