...
class ServiceService {
    ...
    toRouter() {
        this.router.get("/movie/:movieId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        this.router.post("/movie", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.Movie.parse(req.body);
            if (request.ok) {
        ...
        this.router.get("/metadata", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.getMetadata(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(yield serializers.Metadata.jsonOrThrow(responseBody, { unrecognizedObjectKeys: "strip" }));
                    }),
                    cookie: res.cookie.bind(res),
                    locals: res.locals,
                });
                ...
                console.error(error);
                if (error instanceof errors.SeedExamplesError) {
                    console.warn(`Endpoint 'getMetadata' unexpectedly threw ${error.constructor.name}.` +
                        ` If this was intentional, please add ${error.constructor.name} to` +
                        " the endpoint's errors list in your Fern Definition.");
                    yield error.send(res);
                }
