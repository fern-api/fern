...
export interface WithNonLiteralHeadersServiceMethods {
    get(
...
export class WithNonLiteralHeadersService {
    private router;

    constructor(
        private readonly methods: WithNonLiteralHeadersServiceMethods,
