...
class EnumService {
    ...
    toRouter() {
        this.router.post("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.types.WeatherReport.parse(req.body);
            if (request.ok) {
                req.body = request.value;
                try {
                    yield this.methods.getAndReturnEnum(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.types.WeatherReport.jsonOrThrow(responseBody, {
                    ...
                    if (error instanceof errors.SeedExhaustiveError) {
                        console.warn(`Endpoint 'getAndReturnEnum' unexpectedly threw ${error.constructor.name}.` +
