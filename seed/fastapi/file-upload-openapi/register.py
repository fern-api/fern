...
from .resources.file_upload_example.service.service import AbstractFileUploadExampleService
...
def register(
    ...
    *,
    file_upload_example: AbstractFileUploadExampleService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None,
) -> None:
    _app.include_router(__register_service(file_upload_example), dependencies=dependencies)
