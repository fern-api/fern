...
from .organization import (
    Organization as resources_service_types_organization_Organization,
)
...
class Resource(UniversalRootModel):
    ...
    if IS_PYDANTIC_V2:
        root: typing_extensions.Annotated[
            typing.Union[_Resource.User, _Resource.Organization],
    ...
    def visit(
        ...
        organization: typing.Callable[
            [resources_service_types_organization_Organization], T_Result
        ],
    ) -> T_Result:
