...
from .resources.property_based_error.service.service import AbstractPropertyBasedErrorService


def register(
    _app: fastapi.FastAPI,
    *,
    property_based_error: AbstractPropertyBasedErrorService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None
) -> None:
    _app.include_router(__register_service(property_based_error), dependencies=dependencies)
