...
from .resources.dummy.service.service import AbstractDummyService


def register(
    _app: fastapi.FastAPI,
    *,
    dummy: AbstractDummyService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None
) -> None:
    _app.include_router(__register_service(dummy), dependencies=dependencies)
