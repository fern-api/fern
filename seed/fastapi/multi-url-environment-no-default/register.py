...
from .resources.ec_2.service.service import AbstractEc2Service
from .resources.s_3.service.service import AbstractS3Service
...
def register(
    ...
    *,
    ec_2: AbstractEc2Service,
    s_3: AbstractS3Service,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None,
) -> None:
    _app.include_router(__register_service(ec_2), dependencies=dependencies)
    _app.include_router(__register_service(s_3), dependencies=dependencies)
