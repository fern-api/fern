...
from .resources.payment.service.service import AbstractPaymentService


def register(
    _app: fastapi.FastAPI,
    *,
    payment: AbstractPaymentService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None
) -> None:
    _app.include_router(__register_service(payment), dependencies=dependencies)
