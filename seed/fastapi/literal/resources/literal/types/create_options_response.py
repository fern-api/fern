...
class _Factory:
    def ok(self, value: typing.Literal[True]) -> CreateOptionsResponse:
        return CreateOptionsResponse(
            __root__=_CreateOptionsResponse.Ok(type="ok", value=value)
        )

    def options(
        self, value: resources_literal_types_options_Options
    ) -> CreateOptionsResponse:
        return CreateOptionsResponse(
            __root__=_CreateOptionsResponse.Options(
                **value.dict(exclude_unset=True), type="options"
            )
        )
...
class CreateOptionsResponse(pydantic.BaseModel):
    ...
    def get_as_union(
        self,
    ) -> typing.Union[_CreateOptionsResponse.Ok, _CreateOptionsResponse.Options]:
    ...
    def visit(
        ...
        if self.__root__.type == "options":
            return options(
                resources_literal_types_options_Options(
