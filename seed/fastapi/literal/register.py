...
from .resources.literal.service.service import AbstractLiteralService


def register(
    _app: fastapi.FastAPI,
    *,
    literal: AbstractLiteralService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None
) -> None:
    _app.include_router(__register_service(literal), dependencies=dependencies)
