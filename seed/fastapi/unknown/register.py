...
from .resources.unknown.service.service import AbstractUnknownService
...
def register(
    ...
    *,
    unknown: AbstractUnknownService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None,
) -> None:
    _app.include_router(__register_service(unknown), dependencies=dependencies)
