...
from .resources.package.service.service import AbstractPackageService


def register(
    _app: fastapi.FastAPI,
    *,
    package: AbstractPackageService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None
) -> None:
    _app.include_router(__register_service(package), dependencies=dependencies)
