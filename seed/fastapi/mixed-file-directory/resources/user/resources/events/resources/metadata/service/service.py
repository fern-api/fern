...
class AbstractUserEventsMetadataService(AbstractFernService):
    """
    AbstractUserEventsMetadataService is an abstract class containing the methods that you should implement.
