...
class AbstractInlineUsersInlineUsersService(AbstractFernService):
    """
    AbstractInlineUsersInlineUsersService is an abstract class containing the methods that you should implement.
