...
class AbstractIdentityService(AbstractFernService):
    """
    AbstractIdentityService is an abstract class containing the methods that you should implement.
    ...
    @abc.abstractmethod
    def get_token(self, *, body: GetTokenIdentityRequest) -> TokenResponse: ...
    ...
    def __init_get_token(cls, router: fastapi.APIRouter) -> None:
        ...
        router.post(
            path="/identity/token",
            response_model=None,
            description=AbstractIdentityService.get_token.__doc__,
            **get_route_args(cls.get_token, default_tag="identity"),
        )(wrapper)
