...
from .resources.identity.service.service import AbstractIdentityService
from .resources.plants.service.service import AbstractPlantsService
...
def register(
    ...
    *,
    identity: AbstractIdentityService,
    plants: AbstractPlantsService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None,
) -> None:
    _app.include_router(__register_service(identity), dependencies=dependencies)
    _app.include_router(__register_service(plants), dependencies=dependencies)
