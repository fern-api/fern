...
from .resources.optional.service.service import AbstractOptionalService
...
def register(
    ...
    *,
    optional: AbstractOptionalService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None,
) -> None:
    _app.include_router(__register_service(optional), dependencies=dependencies)
