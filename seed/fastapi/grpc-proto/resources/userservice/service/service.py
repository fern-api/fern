...
class AbstractUserserviceService(AbstractFernService):
    """
    AbstractUserserviceService is an abstract class containing the methods that you should implement.
    ...
    def __init_create(cls, router: fastapi.APIRouter) -> None:
        ...
        router.post(
            ...
            description=AbstractUserserviceService.create.__doc__,
            **get_route_args(cls.create, default_tag="userservice"),
        )(wrapper)
