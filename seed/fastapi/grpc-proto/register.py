...
import fastapi
from .resources.userservice.service.service import AbstractUserserviceService
import typing
...
def register(
    ...
    *,
    userservice: AbstractUserserviceService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None,
) -> None:
    _app.include_router(__register_service(userservice), dependencies=dependencies)
