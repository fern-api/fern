...
class Data(UniversalRootModel):
    ...
    if IS_PYDANTIC_V2:
        root: typing_extensions.Annotated[typing.Union[_Data.String, _Data.Base64], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_Data.String, _Data.Base64]:
            return self.root
    else:
        __root__: typing_extensions.Annotated[typing.Union[_Data.String, _Data.Base64], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_Data.String, _Data.Base64]:
