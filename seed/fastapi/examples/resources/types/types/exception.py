...
class Exception(UniversalRootModel):
    ...
    if IS_PYDANTIC_V2:
        root: typing_extensions.Annotated[typing.Union[_Exception.Generic, _Exception.Timeout], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_Exception.Generic, _Exception.Timeout]:
            return self.root
    else:
        __root__: typing_extensions.Annotated[typing.Union[_Exception.Generic, _Exception.Timeout], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_Exception.Generic, _Exception.Timeout]:
