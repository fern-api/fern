...
class Metadata(UniversalRootModel):
    ...
    if IS_PYDANTIC_V2:
        root: typing_extensions.Annotated[typing.Union[_Metadata.Html, _Metadata.Markdown], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_Metadata.Html, _Metadata.Markdown]:
            return self.root
    else:
        __root__: typing_extensions.Annotated[typing.Union[_Metadata.Html, _Metadata.Markdown], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_Metadata.Html, _Metadata.Markdown]:
