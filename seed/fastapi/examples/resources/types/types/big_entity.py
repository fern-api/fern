...
from ...commons.resources.types.types.metadata import Metadata as resources_commons_resources_types_types_metadata_Metadata
...
class BigEntity(UniversalBaseModel):
    ...
    common_metadata: typing.Optional[resources_commons_resources_types_types_metadata_Metadata] = pydantic.Field(alias="commonMetadata", default=None)
