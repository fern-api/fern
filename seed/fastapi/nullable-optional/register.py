...
from .resources.nullable_optional.service.service import AbstractNullableOptionalService
...
def register(
    ...
    *,
    nullable_optional: AbstractNullableOptionalService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None,
) -> None:
    _app.include_router(__register_service(nullable_optional), dependencies=dependencies)
