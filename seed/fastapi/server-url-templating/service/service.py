...
class AbstractRootService(AbstractFernService):
    ...
    def __init_get_users(cls, router: fastapi.APIRouter) -> None:
        ...
        router.get(
            path="/users",
            response_model=None,
            description=AbstractRootService.get_users.__doc__,
            **get_route_args(cls.get_users, default_tag=""),
        )(wrapper)
    ...
    def __init_get_user(cls, router: fastapi.APIRouter) -> None:
        ...
        router.get(
            path="/users/{user_id}",
            response_model=None,
            description=AbstractRootService.get_user.__doc__,
            **get_route_args(cls.get_user, default_tag=""),
        )(wrapper)
