...
class _Factory:
    def list_(
        self, value: typing.List[resources_ast_types_field_value_FieldValue]
    ) -> resources_ast_types_container_value_ContainerValue:
        if IS_PYDANTIC_V2:
    ...
    def optional(
        self, value: typing.Optional[resources_ast_types_field_value_FieldValue]
    ) -> resources_ast_types_container_value_ContainerValue:
        if IS_PYDANTIC_V2:
...
class ContainerValue(UniversalRootModel):
    ...
    def visit(
        self,
        list_: typing.Callable[[typing.List["resources_ast_types_field_value_FieldValue"]], T_Result],
        optional: typing.Callable[[typing.Optional["resources_ast_types_field_value_FieldValue"]], T_Result],
    ) -> T_Result:
...
class _ContainerValue:
    class List(UniversalBaseModel):
        ...
        value: typing.List[resources_ast_types_field_value_FieldValue]

    class Optional(UniversalBaseModel):
        type: typing.Literal["optional"] = "optional"
        value: typing.Optional[resources_ast_types_field_value_FieldValue] = None
...
from .field_value import FieldValue as resources_ast_types_field_value_FieldValue  # noqa: E402, F401, I001
