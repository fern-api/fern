...
from .resources.retries.service.service import AbstractRetriesService
...
def register(
    ...
    *,
    retries: AbstractRetriesService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None,
) -> None:
    _app.include_router(__register_service(retries), dependencies=dependencies)
