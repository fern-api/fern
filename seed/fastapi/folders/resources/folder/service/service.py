...
class AbstractFolderService(AbstractFernService):
    """
    AbstractFolderService is an abstract class containing the methods that you should implement.
    ...
    def __init_foo(cls, router: fastapi.APIRouter) -> None:
        ...
        router.post(
            ...
            **get_route_args(cls.foo, default_tag="folder"),
        )(wrapper)
