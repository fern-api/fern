...
from .resources.custom_auth.service.service import AbstractCustomAuthService


def register(
    _app: fastapi.FastAPI,
    *,
    custom_auth: AbstractCustomAuthService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None
) -> None:
    _app.include_router(__register_service(custom_auth), dependencies=dependencies)
