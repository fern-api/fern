...
from .resources.contacts.service.service import AbstractContactsService
...
def register(
    ...
    *,
    contacts: AbstractContactsService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None,
) -> None:
    _app.include_router(__register_service(contacts), dependencies=dependencies)
