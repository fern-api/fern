...
class _Factory:
    def type_1(self, value: DiscriminatedUnion1InlineType1) -> DiscriminatedUnion1:
        if IS_PYDANTIC_V2:
            return DiscriminatedUnion1(root=_DiscriminatedUnion1.Type1(**value.dict(exclude_unset=True), type="type1"))  # type: ignore
        else:
            return DiscriminatedUnion1(
                __root__=_DiscriminatedUnion1.Type1(**value.dict(exclude_unset=True), type="type1")
            )  # type: ignore

    def type_2(self, value: DiscriminatedUnion1InlineType2) -> DiscriminatedUnion1:
        if IS_PYDANTIC_V2:
            return DiscriminatedUnion1(root=_DiscriminatedUnion1.Type2(**value.dict(exclude_unset=True), type="type2"))  # type: ignore
        else:
            return DiscriminatedUnion1(
                __root__=_DiscriminatedUnion1.Type2(**value.dict(exclude_unset=True), type="type2")
            )  # type: ignore

    def ref(self, value: ReferenceType) -> DiscriminatedUnion1:
        if IS_PYDANTIC_V2:
            return DiscriminatedUnion1(root=_DiscriminatedUnion1.Ref(**value.dict(exclude_unset=True), type="ref"))  # type: ignore
        else:
            return DiscriminatedUnion1(__root__=_DiscriminatedUnion1.Ref(**value.dict(exclude_unset=True), type="ref"))  # type: ignore
...
class DiscriminatedUnion1(UniversalRootModel):
    ...
    def visit(
        ...
        if unioned_value.type == "type1":
            return type_1(DiscriminatedUnion1InlineType1(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "type2":
            return type_2(DiscriminatedUnion1InlineType2(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "ref":
            return ref(ReferenceType(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
