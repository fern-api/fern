...
from .resources.nullable.service.service import AbstractNullableService
...
def register(
    ...
    *,
    nullable: AbstractNullableService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None,
) -> None:
    _app.include_router(__register_service(nullable), dependencies=dependencies)
