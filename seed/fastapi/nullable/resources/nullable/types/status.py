...
class Status(UniversalRootModel):
    ...
    if IS_PYDANTIC_V2:
        root: typing_extensions.Annotated[typing.Union[_Status.Active, _Status.Archived, _Status.SoftDeleted], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_Status.Active, _Status.Archived, _Status.SoftDeleted]:
            return self.root
    else:
        __root__: typing_extensions.Annotated[typing.Union[_Status.Active, _Status.Archived, _Status.SoftDeleted], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_Status.Active, _Status.Archived, _Status.SoftDeleted]:
    ...
    def visit(self, active: typing.Callable[[], T_Result], archived: typing.Callable[[typing.Optional[dt.datetime]], T_Result], soft_deleted: typing.Callable[[typing.Optional[dt.datetime]], T_Result]) -> T_Result:
