...
class AbstractEndpointsContainerService(AbstractFernService):
    ...
    @abc.abstractmethod
    def get_and_return_map_of_prim_to_undiscriminated_union(self, *, body: typing.Dict[str, MixedType], auth: ApiAuth) -> typing.Dict[str, MixedType]:
        ...
    ...
    def __init_get_and_return_map_of_prim_to_undiscriminated_union(cls, router: fastapi.APIRouter) -> None:
        ...
        for index, (parameter_name, parameter) in enumerate(endpoint_function.parameters.items()):
            ...
            if index == 0:
                ...
                new_parameters.append(parameter)
        setattr(cls.get_and_return_map_of_prim_to_undiscriminated_union, "__signature__", endpoint_function.replace(parameters=new_parameters))
        ...
        router.post(
            ...
            **get_route_args(cls.get_and_return_map_of_prim_to_undiscriminated_union, default_tag="endpoints.container"),
        )(wrapper)
