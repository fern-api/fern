...
class Animal(pydantic_v1.BaseModel):
    ...
    def visit(self, dog: typing.Callable[[resources_types_resources_union_types_dog_Dog], T_Result], cat: typing.Callable[[resources_types_resources_union_types_cat_Cat], T_Result]) -> T_Result:
        if self.__root__.animal == "dog":
            return dog(
            resources_types_resources_union_types_dog_Dog(**self.__root__.dict(exclude_unset=True, exclude={"animal"})))
    ...
    __root__: typing_extensions.Annotated[typing.Union[_Animal.Dog, _Animal.Cat], pydantic_v1.Field(discriminator="animal")]
