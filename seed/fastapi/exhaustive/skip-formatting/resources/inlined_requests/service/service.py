    ...
    def __init_post_with_object_bodyand_response(cls, router: fastapi.APIRouter) -> None:
        ...
        for index, (parameter_name, parameter) in enumerate(endpoint_function.parameters.items()):
            if index == 0:
                ...
                evaluated = fastapi._compat.evaluate_forwardref(parameter.annotation, cls.post_with_object_bodyand_response.__globals__, cls.post_with_object_bodyand_response.__globals__)
