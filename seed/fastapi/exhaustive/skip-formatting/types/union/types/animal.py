...
class Animal(pydantic.BaseModel):
    ...
    def visit(self, dog: typing.Callable[[types_union_types_dog_Dog], T_Result], cat: typing.Callable[[types_union_types_cat_Cat], T_Result]) -> T_Result:
        if self.__root__.animal == "dog":
            return dog(
            types_union_types_dog_Dog(**self.__root__.dict(exclude_unset=True, exclude={"animal"})))
        if self.__root__.animal == "cat":
            return cat(
            types_union_types_cat_Cat(**self.__root__.dict(exclude_unset=True, exclude={"animal"})))
