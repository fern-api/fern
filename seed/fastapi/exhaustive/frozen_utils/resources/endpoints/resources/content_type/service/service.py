...
class AbstractEndpointsContentTypeService(AbstractFernService):
    ...
    def __init_post_json_patch_content_type(cls, router: fastapi.APIRouter) -> None:
        ...
        setattr(
            cls.post_json_patch_content_type,
            "__signature__",
        ...
        router.post(
            ...
            **get_route_args(
                cls.post_json_patch_content_type, default_tag="endpoints.content_type"
            ),
        )(wrapper)

    @classmethod
    def __init_post_json_patch_content_with_charset_type(
        ...
        router.post(
            ...
            **get_route_args(
                cls.post_json_patch_content_with_charset_type,
                default_tag="endpoints.content_type",
            ),
        )(wrapper)
