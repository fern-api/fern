...
class BadObjectRequestInfo(UniversalBaseModel):
    ...
    class Validators:
        ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[False] = False) -> typing.Callable[[BadObjectRequestInfo.Validators._RootValidator], BadObjectRequestInfo.Validators._RootValidator]:
            ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[True]) -> typing.Callable[[BadObjectRequestInfo.Validators._PreRootValidator], BadObjectRequestInfo.Validators._PreRootValidator]:
            ...
        @classmethod
        ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["message"], *, pre: typing.Literal[True]) -> typing.Callable[[BadObjectRequestInfo.Validators.PreMessageValidator], BadObjectRequestInfo.Validators.PreMessageValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["message"], *, pre: typing.Literal[False] = False) -> typing.Callable[[BadObjectRequestInfo.Validators.MessageValidator], BadObjectRequestInfo.Validators.MessageValidator]:
            ...
        @classmethod
    ...
    def _pre_validate_bad_object_request_info(cls, values: BadObjectRequestInfo.Partial) -> BadObjectRequestInfo.Partial:
        for validator in BadObjectRequestInfo.Validators._pre_validators:
            values = validator(values)
        return values
    
    @universal_root_validator(pre=False)
    def _post_validate_bad_object_request_info(cls, values: BadObjectRequestInfo.Partial) -> BadObjectRequestInfo.Partial:
