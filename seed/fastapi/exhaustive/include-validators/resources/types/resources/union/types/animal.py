...
class Animal(UniversalRootModel):
    ...
    class Validators:
        ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[False] = False) -> typing.Callable[[Animal.Validators._RootValidator], Animal.Validators._RootValidator]:
            ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[True]) -> typing.Callable[[Animal.Validators._PreRootValidator], Animal.Validators._PreRootValidator]:
            ...
        @classmethod
