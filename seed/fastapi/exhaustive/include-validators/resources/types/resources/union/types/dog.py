...
class Dog(UniversalBaseModel):
    ...
    class Validators:
        ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[False] = False) -> typing.Callable[[Dog.Validators._RootValidator], Dog.Validators._RootValidator]:
            ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[True]) -> typing.Callable[[Dog.Validators._PreRootValidator], Dog.Validators._PreRootValidator]:
            ...
        @classmethod
        ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["name"], *, pre: typing.Literal[True]) -> typing.Callable[[Dog.Validators.PreNameValidator], Dog.Validators.PreNameValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["name"], *, pre: typing.Literal[False] = False) -> typing.Callable[[Dog.Validators.NameValidator], Dog.Validators.NameValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["likes_to_woof"], *, pre: typing.Literal[True]) -> typing.Callable[[Dog.Validators.PreLikesToWoofValidator], Dog.Validators.PreLikesToWoofValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["likes_to_woof"], *, pre: typing.Literal[False] = False) -> typing.Callable[[Dog.Validators.LikesToWoofValidator], Dog.Validators.LikesToWoofValidator]:
            ...
        @classmethod
