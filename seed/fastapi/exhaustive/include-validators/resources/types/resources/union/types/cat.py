...
class Cat(UniversalBaseModel):
    ...
    class Validators:
        ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[False] = False) -> typing.Callable[[Cat.Validators._RootValidator], Cat.Validators._RootValidator]:
            ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[True]) -> typing.Callable[[Cat.Validators._PreRootValidator], Cat.Validators._PreRootValidator]:
            ...
        @classmethod
        ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["name"], *, pre: typing.Literal[True]) -> typing.Callable[[Cat.Validators.PreNameValidator], Cat.Validators.PreNameValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["name"], *, pre: typing.Literal[False] = False) -> typing.Callable[[Cat.Validators.NameValidator], Cat.Validators.NameValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["likes_to_meow"], *, pre: typing.Literal[True]) -> typing.Callable[[Cat.Validators.PreLikesToMeowValidator], Cat.Validators.PreLikesToMeowValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["likes_to_meow"], *, pre: typing.Literal[False] = False) -> typing.Callable[[Cat.Validators.LikesToMeowValidator], Cat.Validators.LikesToMeowValidator]:
            ...
        @classmethod
