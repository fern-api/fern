...
class ObjectWithRequiredField(UniversalBaseModel):
    ...
    class Validators:
        ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[False] = False) -> typing.Callable[[ObjectWithRequiredField.Validators._RootValidator], ObjectWithRequiredField.Validators._RootValidator]:
            ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[True]) -> typing.Callable[[ObjectWithRequiredField.Validators._PreRootValidator], ObjectWithRequiredField.Validators._PreRootValidator]:
            ...
        @classmethod
        ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["string"], *, pre: typing.Literal[True]) -> typing.Callable[[ObjectWithRequiredField.Validators.PreStringValidator], ObjectWithRequiredField.Validators.PreStringValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["string"], *, pre: typing.Literal[False] = False) -> typing.Callable[[ObjectWithRequiredField.Validators.StringValidator], ObjectWithRequiredField.Validators.StringValidator]:
            ...
        @classmethod
    ...
    def _pre_validate_types_object_with_required_field(cls, values: ObjectWithRequiredField.Partial) -> ObjectWithRequiredField.Partial:
        for validator in ObjectWithRequiredField.Validators._pre_validators:
            values = validator(values)
        return values
    
    @universal_root_validator(pre=False)
    def _post_validate_types_object_with_required_field(cls, values: ObjectWithRequiredField.Partial) -> ObjectWithRequiredField.Partial:
