...
class ObjectWithMapOfMap(UniversalBaseModel):
    ...
    class Validators:
        ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[False] = False) -> typing.Callable[[ObjectWithMapOfMap.Validators._RootValidator], ObjectWithMapOfMap.Validators._RootValidator]:
            ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[True]) -> typing.Callable[[ObjectWithMapOfMap.Validators._PreRootValidator], ObjectWithMapOfMap.Validators._PreRootValidator]:
            ...
        @classmethod
        ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["map_"], *, pre: typing.Literal[True]) -> typing.Callable[[ObjectWithMapOfMap.Validators.PreMapValidator], ObjectWithMapOfMap.Validators.PreMapValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["map_"], *, pre: typing.Literal[False] = False) -> typing.Callable[[ObjectWithMapOfMap.Validators.MapValidator], ObjectWithMapOfMap.Validators.MapValidator]:
            ...
        @classmethod
        ...
        class MapValidator(typing.Protocol):
            ...
            def __call__(self, __v: typing.Dict[str, typing.Dict[str, str]], __values: ObjectWithMapOfMap.Partial) -> typing.Dict[str, typing.Dict[str, str]]:
                ...
    ...
    def _pre_validate_types_object_with_map_of_map(cls, values: ObjectWithMapOfMap.Partial) -> ObjectWithMapOfMap.Partial:
        for validator in ObjectWithMapOfMap.Validators._pre_validators:
            values = validator(values)
        return values
    
    @universal_root_validator(pre=False)
    def _post_validate_types_object_with_map_of_map(cls, values: ObjectWithMapOfMap.Partial) -> ObjectWithMapOfMap.Partial:
        for validator in ObjectWithMapOfMap.Validators._post_validators:
            values = validator(values)
        return values
    
    @universal_field_validator("map_", pre=True)
    def _pre_validate_map_(cls, v: typing.Dict[str, typing.Dict[str, str]], values: ObjectWithMapOfMap.Partial) -> typing.Dict[str, typing.Dict[str, str]]:
        for validator in ObjectWithMapOfMap.Validators._map__pre_validators:
            v = validator(v, values)
        return v
    
    @universal_field_validator("map_", pre=False)
    def _post_validate_map_(cls, v: typing.Dict[str, typing.Dict[str, str]], values: ObjectWithMapOfMap.Partial) -> typing.Dict[str, typing.Dict[str, str]]:
