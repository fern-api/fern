...
class DoubleOptional(UniversalBaseModel):
    ...
    class Validators:
        ...
        _optional_alias_pre_validators: typing.ClassVar[typing.List[DoubleOptional.Validators.PreOptionalAliasValidator]] = []
        _optional_alias_post_validators: typing.ClassVar[typing.List[DoubleOptional.Validators.OptionalAliasValidator]] = []
        
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[False] = False) -> typing.Callable[[DoubleOptional.Validators._RootValidator], DoubleOptional.Validators._RootValidator]:
            ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[True]) -> typing.Callable[[DoubleOptional.Validators._PreRootValidator], DoubleOptional.Validators._PreRootValidator]:
            ...
        @classmethod
        ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["optional_alias"], *, pre: typing.Literal[True]) -> typing.Callable[[DoubleOptional.Validators.PreOptionalAliasValidator], DoubleOptional.Validators.PreOptionalAliasValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["optional_alias"], *, pre: typing.Literal[False] = False) -> typing.Callable[[DoubleOptional.Validators.OptionalAliasValidator], DoubleOptional.Validators.OptionalAliasValidator]:
            ...
        @classmethod
        ...
        class OptionalAliasValidator(typing.Protocol):
            ...
            def __call__(self, __v: typing.Optional[OptionalAlias], __values: DoubleOptional.Partial) -> typing.Optional[OptionalAlias]:
                ...
    ...
    def _pre_validate_optional_alias(cls, v: typing.Optional[OptionalAlias], values: DoubleOptional.Partial) -> typing.Optional[OptionalAlias]:
    ...
    def _post_validate_optional_alias(cls, v: typing.Optional[OptionalAlias], values: DoubleOptional.Partial) -> typing.Optional[OptionalAlias]:
