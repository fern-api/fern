...
class NestedObjectWithRequiredField(UniversalBaseModel):
    ...
    class Validators:
        ...
        _string_pre_validators: typing.ClassVar[typing.List[NestedObjectWithRequiredField.Validators.PreStringValidator]] = []
        _string_post_validators: typing.ClassVar[typing.List[NestedObjectWithRequiredField.Validators.StringValidator]] = []
        _nested_object_pre_validators: typing.ClassVar[typing.List[NestedObjectWithRequiredField.Validators.PreNestedObjectValidator]] = []
        _nested_object_post_validators: typing.ClassVar[typing.List[NestedObjectWithRequiredField.Validators.NestedObjectValidator]] = []
        
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[False] = False) -> typing.Callable[[NestedObjectWithRequiredField.Validators._RootValidator], NestedObjectWithRequiredField.Validators._RootValidator]:
            ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[True]) -> typing.Callable[[NestedObjectWithRequiredField.Validators._PreRootValidator], NestedObjectWithRequiredField.Validators._PreRootValidator]:
            ...
        @classmethod
        ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["string"], *, pre: typing.Literal[True]) -> typing.Callable[[NestedObjectWithRequiredField.Validators.PreStringValidator], NestedObjectWithRequiredField.Validators.PreStringValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["string"], *, pre: typing.Literal[False] = False) -> typing.Callable[[NestedObjectWithRequiredField.Validators.StringValidator], NestedObjectWithRequiredField.Validators.StringValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["nested_object"], *, pre: typing.Literal[True]) -> typing.Callable[[NestedObjectWithRequiredField.Validators.PreNestedObjectValidator], NestedObjectWithRequiredField.Validators.PreNestedObjectValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["nested_object"], *, pre: typing.Literal[False] = False) -> typing.Callable[[NestedObjectWithRequiredField.Validators.NestedObjectValidator], NestedObjectWithRequiredField.Validators.NestedObjectValidator]:
            ...
        @classmethod
        ...
        class NestedObjectValidator(typing.Protocol):
            ...
            def __call__(self, __v: ObjectWithOptionalField, __values: NestedObjectWithRequiredField.Partial) -> ObjectWithOptionalField:
                ...
        ...
        class _RootValidator(typing.Protocol):
            ...
            def __call__(self, __values: NestedObjectWithRequiredField.Partial) -> NestedObjectWithRequiredField.Partial:
                ...
    
    @universal_root_validator(pre=True)
    def _pre_validate_types_nested_object_with_required_field(cls, values: NestedObjectWithRequiredField.Partial) -> NestedObjectWithRequiredField.Partial:
        for validator in NestedObjectWithRequiredField.Validators._pre_validators:
            values = validator(values)
        return values
    
    @universal_root_validator(pre=False)
    def _post_validate_types_nested_object_with_required_field(cls, values: NestedObjectWithRequiredField.Partial) -> NestedObjectWithRequiredField.Partial:
    ...
    def _pre_validate_nested_object(cls, v: ObjectWithOptionalField, values: NestedObjectWithRequiredField.Partial) -> ObjectWithOptionalField:
    ...
    def _post_validate_nested_object(cls, v: ObjectWithOptionalField, values: NestedObjectWithRequiredField.Partial) -> ObjectWithOptionalField:
