...
class Error(UniversalBaseModel):
    ...
    class Validators:
        ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[False] = False) -> typing.Callable[[Error.Validators._RootValidator], Error.Validators._RootValidator]:
            ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[True]) -> typing.Callable[[Error.Validators._PreRootValidator], Error.Validators._PreRootValidator]:
            ...
        @classmethod
        ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["category"], *, pre: typing.Literal[True]) -> typing.Callable[[Error.Validators.PreCategoryValidator], Error.Validators.PreCategoryValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["category"], *, pre: typing.Literal[False] = False) -> typing.Callable[[Error.Validators.CategoryValidator], Error.Validators.CategoryValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["code"], *, pre: typing.Literal[True]) -> typing.Callable[[Error.Validators.PreCodeValidator], Error.Validators.PreCodeValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["code"], *, pre: typing.Literal[False] = False) -> typing.Callable[[Error.Validators.CodeValidator], Error.Validators.CodeValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["detail"], *, pre: typing.Literal[True]) -> typing.Callable[[Error.Validators.PreDetailValidator], Error.Validators.PreDetailValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["detail"], *, pre: typing.Literal[False] = False) -> typing.Callable[[Error.Validators.DetailValidator], Error.Validators.DetailValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["field"], *, pre: typing.Literal[True]) -> typing.Callable[[Error.Validators.PreFieldValidator], Error.Validators.PreFieldValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["field"], *, pre: typing.Literal[False] = False) -> typing.Callable[[Error.Validators.FieldValidator], Error.Validators.FieldValidator]:
            ...
        @classmethod
