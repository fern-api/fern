...
class PutResponse(UniversalBaseModel):
    ...
    class Validators:
        ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[False] = False) -> typing.Callable[[PutResponse.Validators._RootValidator], PutResponse.Validators._RootValidator]:
            ...
        @typing.overload
        @classmethod
        def root(cls, *, pre: typing.Literal[True]) -> typing.Callable[[PutResponse.Validators._PreRootValidator], PutResponse.Validators._PreRootValidator]:
            ...
        @classmethod
        ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["errors"], *, pre: typing.Literal[True]) -> typing.Callable[[PutResponse.Validators.PreErrorsValidator], PutResponse.Validators.PreErrorsValidator]:
            ...
        @typing.overload
        @classmethod
        def field(cls, field_name: typing.Literal["errors"], *, pre: typing.Literal[False] = False) -> typing.Callable[[PutResponse.Validators.ErrorsValidator], PutResponse.Validators.ErrorsValidator]:
            ...
        @classmethod
        ...
        class ErrorsValidator(typing.Protocol):
            ...
            def __call__(self, __v: typing.Optional[typing.List[Error]], __values: PutResponse.Partial) -> typing.Optional[typing.List[Error]]:
                ...
    ...
    def _pre_validate_errors(cls, v: typing.Optional[typing.List[Error]], values: PutResponse.Partial) -> typing.Optional[typing.List[Error]]:
        for validator in PutResponse.Validators._errors_pre_validators:
            v = validator(v, values)
        return v
    
    @universal_field_validator("errors", pre=False)
    def _post_validate_errors(cls, v: typing.Optional[typing.List[Error]], values: PutResponse.Partial) -> typing.Optional[typing.List[Error]]:
