...
from .resources.organizations.service.service import AbstractOrganizationsService
...
def register(
    ...
    *,
    organizations: AbstractOrganizationsService,
    user: AbstractUserService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None,
) -> None:
    _app.include_router(__register_service(organizations), dependencies=dependencies)
