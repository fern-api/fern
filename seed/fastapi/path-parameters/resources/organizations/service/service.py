...
class AbstractOrganizationsService(AbstractFernService):
    ...
    def __init_get_organization(cls, router: fastapi.APIRouter) -> None:
        ...
        router.get(
            path="/{tenant_id}/user/organizations/{organization_id}",
    ...
    def __init_get_organization_user(cls, router: fastapi.APIRouter) -> None:
        ...
        router.get(
            path="/{tenant_id}/user/organizations/{organization_id}/users/{user_id}",
            response_model=User,
    ...
    def __init_search_organizations(cls, router: fastapi.APIRouter) -> None:
        ...
        router.get(
            path="/{tenant_id}/user/organizations/{organization_id}/search",
