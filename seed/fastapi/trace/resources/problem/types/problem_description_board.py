...
class ProblemDescriptionBoard(UniversalRootModel):
    ...
    if IS_PYDANTIC_V2:
        root: typing_extensions.Annotated[typing.Union[_ProblemDescriptionBoard.Html, _ProblemDescriptionBoard.Variable, _ProblemDescriptionBoard.TestCaseId], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_ProblemDescriptionBoard.Html, _ProblemDescriptionBoard.Variable, _ProblemDescriptionBoard.TestCaseId]:
            return self.root
    else:
        __root__: typing_extensions.Annotated[typing.Union[_ProblemDescriptionBoard.Html, _ProblemDescriptionBoard.Variable, _ProblemDescriptionBoard.TestCaseId], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_ProblemDescriptionBoard.Html, _ProblemDescriptionBoard.Variable, _ProblemDescriptionBoard.TestCaseId]:
    ...
    def visit(self, html: typing.Callable[[str], T_Result], variable: typing.Callable[["VariableValue"], T_Result], test_case_id: typing.Callable[[str], T_Result]) -> T_Result:
