...
class ExecutionSessionStatus(str, enum.Enum):
    ...
    def visit(self, creating_container: typing.Callable[[], T_Result], provisioning_container: typing.Callable[[], T_Result], pending_container: typing.Callable[[], T_Result], running_container: typing.Callable[[], T_Result], live_container: typing.Callable[[], T_Result], failed_to_launch: typing.Callable[[], T_Result]) -> T_Result:
