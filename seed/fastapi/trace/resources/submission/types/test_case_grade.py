...
class TestCaseGrade(UniversalRootModel):
    ...
    if IS_PYDANTIC_V2:
        root: typing_extensions.Annotated[typing.Union[_TestCaseGrade.Hidden, _TestCaseGrade.NonHidden], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_TestCaseGrade.Hidden, _TestCaseGrade.NonHidden]:
            return self.root
    else:
        __root__: typing_extensions.Annotated[typing.Union[_TestCaseGrade.Hidden, _TestCaseGrade.NonHidden], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_TestCaseGrade.Hidden, _TestCaseGrade.NonHidden]:
    ...
    def visit(self, hidden: typing.Callable[[TestCaseHiddenGrade], T_Result], non_hidden: typing.Callable[[TestCaseNonHiddenGrade], T_Result]) -> T_Result:
        unioned_value = self.get_as_union()
        if unioned_value.type == "hidden":
            return hidden(
            TestCaseHiddenGrade(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "nonHidden":
            return non_hidden(
            TestCaseNonHiddenGrade(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
