...
class ExceptionV2(UniversalRootModel):
    ...
    if IS_PYDANTIC_V2:
        root: typing_extensions.Annotated[typing.Union[_ExceptionV2.Generic, _ExceptionV2.Timeout], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_ExceptionV2.Generic, _ExceptionV2.Timeout]:
            return self.root
    else:
        __root__: typing_extensions.Annotated[typing.Union[_ExceptionV2.Generic, _ExceptionV2.Timeout], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_ExceptionV2.Generic, _ExceptionV2.Timeout]:
    ...
    def visit(self, generic: typing.Callable[[ExceptionInfo], T_Result], timeout: typing.Callable[[], T_Result]) -> T_Result:
        unioned_value = self.get_as_union()
        if unioned_value.type == "generic":
            return generic(
            ExceptionInfo(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
