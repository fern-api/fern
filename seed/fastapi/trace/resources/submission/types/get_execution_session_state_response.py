...
class GetExecutionSessionStateResponse(UniversalBaseModel):
    ...
    num_warming_instances: typing_extensions.Annotated[
        typing.Optional[int], pydantic.Field(alias="numWarmingInstances")
    ] = None
    warming_session_ids: typing_extensions.Annotated[typing.List[str], pydantic.Field(alias="warmingSessionIds")]
