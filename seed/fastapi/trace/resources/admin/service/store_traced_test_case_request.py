...
update_forward_refs(KeyValuePair, StoreTracedTestCaseRequest=StoreTracedTestCaseRequest)
update_forward_refs(MapValue, StoreTracedTestCaseRequest=StoreTracedTestCaseRequest)
update_forward_refs(
    DebugKeyValuePairs, StoreTracedTestCaseRequest=StoreTracedTestCaseRequest
)
update_forward_refs(
    DebugMapValue, StoreTracedTestCaseRequest=StoreTracedTestCaseRequest
)
