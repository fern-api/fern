...
class ListType(UniversalBaseModel):
    value_type: "resources_commons_types_variable_type_VariableType" = pydantic.Field(alias="valueType")
...
class MapType(UniversalBaseModel):
    key_type: "resources_commons_types_variable_type_VariableType" = pydantic.Field(alias="keyType")
    value_type: "resources_commons_types_variable_type_VariableType" = pydantic.Field(alias="valueType")
...
class _Factory:
    ...
    def map_type(
        self, value: resources_commons_types_map_type_MapType
    ) -> resources_commons_types_variable_type_VariableType:
        if IS_PYDANTIC_V2:
    ...
    def doubly_linked_list_type(self) -> resources_commons_types_variable_type_VariableType:
        if IS_PYDANTIC_V2:
...
from .variable_type import VariableType as resources_commons_types_variable_type_VariableType  # noqa: E402, F401, I001
