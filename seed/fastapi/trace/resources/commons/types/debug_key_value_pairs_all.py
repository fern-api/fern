...
class DebugKeyValuePairs(UniversalBaseModel):
    key: "resources_commons_types_debug_variable_value_DebugVariableValue"
    value: "resources_commons_types_debug_variable_value_DebugVariableValue"
...
class DebugMapValue(UniversalBaseModel):
    key_value_pairs: typing.List["resources_commons_types_debug_key_value_pairs_DebugKeyValuePairs"] = pydantic.Field(
        alias="keyValuePairs"
    )
...
class _Factory:
    def integer_value(self, value: int) -> resources_commons_types_debug_variable_value_DebugVariableValue:
        if IS_PYDANTIC_V2:
    ...
    def string_value(self, value: str) -> resources_commons_types_debug_variable_value_DebugVariableValue:
        if IS_PYDANTIC_V2:
    ...
    def char_value(self, value: str) -> resources_commons_types_debug_variable_value_DebugVariableValue:
        if IS_PYDANTIC_V2:
    ...
    def map_value(
        self, value: resources_commons_types_debug_map_value_DebugMapValue
    ...
    def list_value(
        self, value: typing.List[resources_commons_types_debug_variable_value_DebugVariableValue]
    ) -> resources_commons_types_debug_variable_value_DebugVariableValue:
        if IS_PYDANTIC_V2:
    ...
    def undefined_value(self) -> resources_commons_types_debug_variable_value_DebugVariableValue:
        if IS_PYDANTIC_V2:
    ...
    def null_value(self) -> resources_commons_types_debug_variable_value_DebugVariableValue:
        if IS_PYDANTIC_V2:
...
class DebugVariableValue(UniversalRootModel):
    ...
    def visit(
        ...
        map_value: typing.Callable[["resources_commons_types_debug_map_value_DebugMapValue"], T_Result],
        list_value: typing.Callable[
            [typing.List["resources_commons_types_debug_variable_value_DebugVariableValue"]], T_Result
        ],
        ...
        if unioned_value.type == "mapValue":
            return map_value(
                resources_commons_types_debug_map_value_DebugMapValue(
...
from .debug_variable_value import DebugVariableValue as resources_commons_types_debug_variable_value_DebugVariableValue  # noqa: E402, F401, I001
from .debug_key_value_pairs import (
    DebugKeyValuePairs as resources_commons_types_debug_key_value_pairs_DebugKeyValuePairs,
)  # noqa: E402, F401, I001
from .debug_map_value import DebugMapValue as resources_commons_types_debug_map_value_DebugMapValue  # noqa: E402, F401, I001
...
class _DebugVariableValue:
    ...
    class MapValue(resources_commons_types_debug_map_value_DebugMapValue):
        type: typing.Literal["mapValue"] = "mapValue"

    class ListValue(UniversalBaseModel):
        type: typing.Literal["listValue"] = "listValue"
        value: typing.List[resources_commons_types_debug_variable_value_DebugVariableValue]
