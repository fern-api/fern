...
class _Factory:
    ...
    def binary_tree_value(self, value: resources_commons_types_binary_tree_value_BinaryTreeValue) -> VariableValue:
        if IS_PYDANTIC_V2:
            return VariableValue(root=_VariableValue.BinaryTreeValue(**value.dict(exclude_unset=True), type="binaryTreeValue"))  # type: ignore
        else:
            return VariableValue(__root__=_VariableValue.BinaryTreeValue(**value.dict(exclude_unset=True), type="binaryTreeValue"))  # type: ignore
    
    def singly_linked_list_value(self, value: resources_commons_types_singly_linked_list_value_SinglyLinkedListValue) -> VariableValue:
        if IS_PYDANTIC_V2:
            return VariableValue(root=_VariableValue.SinglyLinkedListValue(**value.dict(exclude_unset=True), type="singlyLinkedListValue"))  # type: ignore
        else:
            return VariableValue(__root__=_VariableValue.SinglyLinkedListValue(**value.dict(exclude_unset=True), type="singlyLinkedListValue"))  # type: ignore
    
    def doubly_linked_list_value(self, value: resources_commons_types_doubly_linked_list_value_DoublyLinkedListValue) -> VariableValue:
        if IS_PYDANTIC_V2:
            return VariableValue(root=_VariableValue.DoublyLinkedListValue(**value.dict(exclude_unset=True), type="doublyLinkedListValue"))  # type: ignore
        else:
            return VariableValue(__root__=_VariableValue.DoublyLinkedListValue(**value.dict(exclude_unset=True), type="doublyLinkedListValue"))  # type: ignore
...
class VariableValue(UniversalRootModel):
    ...
    def visit(self, integer_value: typing.Callable[[int], T_Result], boolean_value: typing.Callable[[bool], T_Result], double_value: typing.Callable[[float], T_Result], string_value: typing.Callable[[str], T_Result], char_value: typing.Callable[[str], T_Result], map_value: typing.Callable[["resources_commons_types_map_value_MapValue"], T_Result], list_value: typing.Callable[[typing.List["VariableValue"]], T_Result], binary_tree_value: typing.Callable[[resources_commons_types_binary_tree_value_BinaryTreeValue], T_Result], singly_linked_list_value: typing.Callable[[resources_commons_types_singly_linked_list_value_SinglyLinkedListValue], T_Result], doubly_linked_list_value: typing.Callable[[resources_commons_types_doubly_linked_list_value_DoublyLinkedListValue], T_Result], null_value: typing.Callable[[], T_Result]) -> T_Result:
        ...
        if unioned_value.type == "binaryTreeValue":
            ...
            resources_commons_types_binary_tree_value_BinaryTreeValue(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "singlyLinkedListValue":
            return singly_linked_list_value(
            resources_commons_types_singly_linked_list_value_SinglyLinkedListValue(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "doublyLinkedListValue":
            return doubly_linked_list_value(
            resources_commons_types_doubly_linked_list_value_DoublyLinkedListValue(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
