...
class KeyValuePair(UniversalBaseModel):
    key: "resources_commons_types_variable_value_VariableValue"
    value: "resources_commons_types_variable_value_VariableValue"
...
class MapValue(UniversalBaseModel):
    key_value_pairs: typing.List["resources_commons_types_key_value_pair_KeyValuePair"] = pydantic.Field(
        alias="keyValuePairs"
    )
...
class _Factory:
    ...
    def string_value(self, value: str) -> resources_commons_types_variable_value_VariableValue:
        if IS_PYDANTIC_V2:
    ...
    def char_value(self, value: str) -> resources_commons_types_variable_value_VariableValue:
        if IS_PYDANTIC_V2:
    ...
    def list_value(
        self, value: typing.List[resources_commons_types_variable_value_VariableValue]
    ) -> resources_commons_types_variable_value_VariableValue:
        if IS_PYDANTIC_V2:
    ...
    def null_value(self) -> resources_commons_types_variable_value_VariableValue:
        if IS_PYDANTIC_V2:
...
class VariableValue(UniversalRootModel):
    ...
    def visit(
        ...
        list_value: typing.Callable[[typing.List["resources_commons_types_variable_value_VariableValue"]], T_Result],
...
from .variable_value import VariableValue as resources_commons_types_variable_value_VariableValue  # noqa: E402, F401, I001
from .key_value_pair import KeyValuePair as resources_commons_types_key_value_pair_KeyValuePair  # noqa: E402, F401, I001
...
class _VariableValue:
    ...
    class ListValue(UniversalBaseModel):
        ...
        value: typing.List[resources_commons_types_variable_value_VariableValue]
