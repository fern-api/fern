...
class UnionWithOptionalTime(UniversalRootModel):
    ...
    if IS_PYDANTIC_V2:
        root: typing_extensions.Annotated[typing.Union[_UnionWithOptionalTime.Date, _UnionWithOptionalTime.Datetime], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_UnionWithOptionalTime.Date, _UnionWithOptionalTime.Datetime]:
            return self.root
    else:
        __root__: typing_extensions.Annotated[typing.Union[_UnionWithOptionalTime.Date, _UnionWithOptionalTime.Datetime], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_UnionWithOptionalTime.Date, _UnionWithOptionalTime.Datetime]:
    ...
    def visit(self, date: typing.Callable[[typing.Optional[dt.date]], T_Result], datetime: typing.Callable[[typing.Optional[dt.datetime]], T_Result]) -> T_Result:
