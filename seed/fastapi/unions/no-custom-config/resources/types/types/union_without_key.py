...
class UnionWithoutKey(UniversalRootModel):
    ...
    def visit(self, foo: typing.Callable[[resources_types_types_foo_Foo], T_Result], bar: typing.Callable[[resources_types_types_bar_Bar], T_Result]) -> T_Result:
        ...
        if unioned_value.type == "bar":
            return bar(
            resources_types_types_bar_Bar(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
