...
class Shape(UniversalRootModel):
    ...
    def visit(self, circle: typing.Callable[[resources_union_types_circle_Circle], T_Result], square: typing.Callable[[resources_union_types_square_Square], T_Result]) -> T_Result:
