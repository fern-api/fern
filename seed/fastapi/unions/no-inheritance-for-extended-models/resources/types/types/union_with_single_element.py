...
class _Factory:
    ...
    def foo(self, value: resources_types_types_foo_Foo) -> UnionWithSingleElement:
        if IS_PYDANTIC_V2:
            return UnionWithSingleElement(root=_UnionWithSingleElement.Foo(**value.dict(exclude_unset=True), type="foo"))  # type: ignore
        else:
            return UnionWithSingleElement(__root__=_UnionWithSingleElement.Foo(**value.dict(exclude_unset=True), type="foo"))  # type: ignore
