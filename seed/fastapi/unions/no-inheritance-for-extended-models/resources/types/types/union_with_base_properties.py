...
class UnionWithBaseProperties(UniversalRootModel):
    ...
    def visit(self, integer: typing.Callable[[int], T_Result], string: typing.Callable[[str], T_Result], foo: typing.Callable[[resources_types_types_foo_Foo], T_Result]) -> T_Result:
