...
class _Factory:
    ...
    def integer_1(self, value: int) -> UnionWithDuplicatePrimitive:
        if IS_PYDANTIC_V2:
            ...
            return UnionWithDuplicatePrimitive(__root__=_UnionWithDuplicatePrimitive.Integer1(type="integer1", value=value))  # type: ignore
    ...
    def integer_2(self, value: int) -> UnionWithDuplicatePrimitive:
        if IS_PYDANTIC_V2:
            ...
            return UnionWithDuplicatePrimitive(__root__=_UnionWithDuplicatePrimitive.Integer2(type="integer2", value=value))  # type: ignore
    ...
    def string_1(self, value: str) -> UnionWithDuplicatePrimitive:
        if IS_PYDANTIC_V2:
            ...
            return UnionWithDuplicatePrimitive(__root__=_UnionWithDuplicatePrimitive.String1(type="string1", value=value))  # type: ignore
    ...
    def string_2(self, value: str) -> UnionWithDuplicatePrimitive:
        if IS_PYDANTIC_V2:
            ...
            return UnionWithDuplicatePrimitive(__root__=_UnionWithDuplicatePrimitive.String2(type="string2", value=value))  # type: ignore
class UnionWithDuplicatePrimitive(UniversalRootModel):
    ...
    if IS_PYDANTIC_V2:
        root: typing_extensions.Annotated[typing.Union[_UnionWithDuplicatePrimitive.Integer1, _UnionWithDuplicatePrimitive.Integer2, _UnionWithDuplicatePrimitive.String1, _UnionWithDuplicatePrimitive.String2], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_UnionWithDuplicatePrimitive.Integer1, _UnionWithDuplicatePrimitive.Integer2, _UnionWithDuplicatePrimitive.String1, _UnionWithDuplicatePrimitive.String2]:
            return self.root
    else:
        __root__: typing_extensions.Annotated[typing.Union[_UnionWithDuplicatePrimitive.Integer1, _UnionWithDuplicatePrimitive.Integer2, _UnionWithDuplicatePrimitive.String1, _UnionWithDuplicatePrimitive.String2], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_UnionWithDuplicatePrimitive.Integer1, _UnionWithDuplicatePrimitive.Integer2, _UnionWithDuplicatePrimitive.String1, _UnionWithDuplicatePrimitive.String2]:
    ...
    def visit(self, integer_1: typing.Callable[[int], T_Result], integer_2: typing.Callable[[int], T_Result], string_1: typing.Callable[[str], T_Result], string_2: typing.Callable[[str], T_Result]) -> T_Result:
