...
class _Factory:
    ...
    def distinct_failure(self, value: resources_bigunion_types_distinct_failure_DistinctFailure) -> BigUnion:
        if IS_PYDANTIC_V2:
            ...
            return BigUnion(__root__=_BigUnion.DistinctFailure(**value.dict(exclude_unset=True), type="distinctFailure"))  # type: ignore
    
    def practical_principle(self, value: resources_bigunion_types_practical_principle_PracticalPrinciple) -> BigUnion:
        if IS_PYDANTIC_V2:
            return BigUnion(root=_BigUnion.PracticalPrinciple(**value.dict(exclude_unset=True), type="practicalPrinciple"))  # type: ignore
        else:
            return BigUnion(__root__=_BigUnion.PracticalPrinciple(**value.dict(exclude_unset=True), type="practicalPrinciple"))  # type: ignore
    ...
    def vibrant_excitement(self, value: resources_bigunion_types_vibrant_excitement_VibrantExcitement) -> BigUnion:
        if IS_PYDANTIC_V2:
            return BigUnion(root=_BigUnion.VibrantExcitement(**value.dict(exclude_unset=True), type="vibrantExcitement"))  # type: ignore
        else:
            return BigUnion(__root__=_BigUnion.VibrantExcitement(**value.dict(exclude_unset=True), type="vibrantExcitement"))  # type: ignore
    ...
    def attractive_script(self, value: resources_bigunion_types_attractive_script_AttractiveScript) -> BigUnion:
        if IS_PYDANTIC_V2:
            ...
            return BigUnion(__root__=_BigUnion.AttractiveScript(**value.dict(exclude_unset=True), type="attractiveScript"))  # type: ignore
    ...
    def triangular_repair(self, value: resources_bigunion_types_triangular_repair_TriangularRepair) -> BigUnion:
        if IS_PYDANTIC_V2:
            ...
            return BigUnion(__root__=_BigUnion.TriangularRepair(**value.dict(exclude_unset=True), type="triangularRepair"))  # type: ignore
...
class BigUnion(UniversalRootModel):
    ...
    if IS_PYDANTIC_V2:
        root: typing_extensions.Annotated[typing.Union[_BigUnion.NormalSweet, _BigUnion.ThankfulFactor, _BigUnion.JumboEnd, _BigUnion.HastyPain, _BigUnion.MistySnow, _BigUnion.DistinctFailure, _BigUnion.PracticalPrinciple, _BigUnion.LimpingStep, _BigUnion.VibrantExcitement, _BigUnion.ActiveDiamond, _BigUnion.PopularLimit, _BigUnion.FalseMirror, _BigUnion.PrimaryBlock, _BigUnion.RotatingRatio, _BigUnion.ColorfulCover, _BigUnion.DisloyalValue, _BigUnion.GruesomeCoach, _BigUnion.TotalWork, _BigUnion.HarmoniousPlay, _BigUnion.UniqueStress, _BigUnion.UnwillingSmoke, _BigUnion.FrozenSleep, _BigUnion.DiligentDeal, _BigUnion.AttractiveScript, _BigUnion.HoarseMouse, _BigUnion.CircularCard, _BigUnion.PotableBad, _BigUnion.TriangularRepair, _BigUnion.GaseousRoad], pydantic.Field(discriminator="type")]
        def get_as_union(self) -> typing.Union[_BigUnion.NormalSweet, _BigUnion.ThankfulFactor, _BigUnion.JumboEnd, _BigUnion.HastyPain, _BigUnion.MistySnow, _BigUnion.DistinctFailure, _BigUnion.PracticalPrinciple, _BigUnion.LimpingStep, _BigUnion.VibrantExcitement, _BigUnion.ActiveDiamond, _BigUnion.PopularLimit, _BigUnion.FalseMirror, _BigUnion.PrimaryBlock, _BigUnion.RotatingRatio, _BigUnion.ColorfulCover, _BigUnion.DisloyalValue, _BigUnion.GruesomeCoach, _BigUnion.TotalWork, _BigUnion.HarmoniousPlay, _BigUnion.UniqueStress, _BigUnion.UnwillingSmoke, _BigUnion.FrozenSleep, _BigUnion.DiligentDeal, _BigUnion.AttractiveScript, _BigUnion.HoarseMouse, _BigUnion.CircularCard, _BigUnion.PotableBad, _BigUnion.TriangularRepair, _BigUnion.GaseousRoad]:
            return self.root
    else:
    ...
    def visit(self, normal_sweet: typing.Callable[[resources_bigunion_types_normal_sweet_NormalSweet], T_Result], thankful_factor: typing.Callable[[resources_bigunion_types_thankful_factor_ThankfulFactor], T_Result], jumbo_end: typing.Callable[[resources_bigunion_types_jumbo_end_JumboEnd], T_Result], hasty_pain: typing.Callable[[resources_bigunion_types_hasty_pain_HastyPain], T_Result], misty_snow: typing.Callable[[resources_bigunion_types_misty_snow_MistySnow], T_Result], distinct_failure: typing.Callable[[resources_bigunion_types_distinct_failure_DistinctFailure], T_Result], practical_principle: typing.Callable[[resources_bigunion_types_practical_principle_PracticalPrinciple], T_Result], limping_step: typing.Callable[[resources_bigunion_types_limping_step_LimpingStep], T_Result], vibrant_excitement: typing.Callable[[resources_bigunion_types_vibrant_excitement_VibrantExcitement], T_Result], active_diamond: typing.Callable[[resources_bigunion_types_active_diamond_ActiveDiamond], T_Result], popular_limit: typing.Callable[[resources_bigunion_types_popular_limit_PopularLimit], T_Result], false_mirror: typing.Callable[[resources_bigunion_types_false_mirror_FalseMirror], T_Result], primary_block: typing.Callable[[resources_bigunion_types_primary_block_PrimaryBlock], T_Result], rotating_ratio: typing.Callable[[resources_bigunion_types_rotating_ratio_RotatingRatio], T_Result], colorful_cover: typing.Callable[[resources_bigunion_types_colorful_cover_ColorfulCover], T_Result], disloyal_value: typing.Callable[[resources_bigunion_types_disloyal_value_DisloyalValue], T_Result], gruesome_coach: typing.Callable[[resources_bigunion_types_gruesome_coach_GruesomeCoach], T_Result], total_work: typing.Callable[[resources_bigunion_types_total_work_TotalWork], T_Result], harmonious_play: typing.Callable[[resources_bigunion_types_harmonious_play_HarmoniousPlay], T_Result], unique_stress: typing.Callable[[resources_bigunion_types_unique_stress_UniqueStress], T_Result], unwilling_smoke: typing.Callable[[resources_bigunion_types_unwilling_smoke_UnwillingSmoke], T_Result], frozen_sleep: typing.Callable[[resources_bigunion_types_frozen_sleep_FrozenSleep], T_Result], diligent_deal: typing.Callable[[resources_bigunion_types_diligent_deal_DiligentDeal], T_Result], attractive_script: typing.Callable[[resources_bigunion_types_attractive_script_AttractiveScript], T_Result], hoarse_mouse: typing.Callable[[resources_bigunion_types_hoarse_mouse_HoarseMouse], T_Result], circular_card: typing.Callable[[resources_bigunion_types_circular_card_CircularCard], T_Result], potable_bad: typing.Callable[[resources_bigunion_types_potable_bad_PotableBad], T_Result], triangular_repair: typing.Callable[[resources_bigunion_types_triangular_repair_TriangularRepair], T_Result], gaseous_road: typing.Callable[[resources_bigunion_types_gaseous_road_GaseousRoad], T_Result]) -> T_Result:
        unioned_value = self.get_as_union()
        if unioned_value.type == "normalSweet":
            return normal_sweet(
            resources_bigunion_types_normal_sweet_NormalSweet(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "thankfulFactor":
            return thankful_factor(
            resources_bigunion_types_thankful_factor_ThankfulFactor(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        ...
        if unioned_value.type == "hastyPain":
            return hasty_pain(
            resources_bigunion_types_hasty_pain_HastyPain(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "mistySnow":
            return misty_snow(
            resources_bigunion_types_misty_snow_MistySnow(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "distinctFailure":
            return distinct_failure(
            resources_bigunion_types_distinct_failure_DistinctFailure(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "practicalPrinciple":
            return practical_principle(
            resources_bigunion_types_practical_principle_PracticalPrinciple(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "limpingStep":
            return limping_step(
            resources_bigunion_types_limping_step_LimpingStep(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "vibrantExcitement":
            return vibrant_excitement(
            resources_bigunion_types_vibrant_excitement_VibrantExcitement(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "activeDiamond":
            return active_diamond(
            resources_bigunion_types_active_diamond_ActiveDiamond(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "popularLimit":
            return popular_limit(
            resources_bigunion_types_popular_limit_PopularLimit(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "falseMirror":
            return false_mirror(
            resources_bigunion_types_false_mirror_FalseMirror(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "primaryBlock":
            return primary_block(
            resources_bigunion_types_primary_block_PrimaryBlock(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "rotatingRatio":
            return rotating_ratio(
            resources_bigunion_types_rotating_ratio_RotatingRatio(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "colorfulCover":
            return colorful_cover(
            resources_bigunion_types_colorful_cover_ColorfulCover(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "disloyalValue":
            return disloyal_value(
            resources_bigunion_types_disloyal_value_DisloyalValue(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "gruesomeCoach":
            return gruesome_coach(
            resources_bigunion_types_gruesome_coach_GruesomeCoach(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "totalWork":
            return total_work(
            resources_bigunion_types_total_work_TotalWork(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "harmoniousPlay":
            return harmonious_play(
            resources_bigunion_types_harmonious_play_HarmoniousPlay(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "uniqueStress":
            return unique_stress(
            resources_bigunion_types_unique_stress_UniqueStress(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "unwillingSmoke":
            return unwilling_smoke(
            resources_bigunion_types_unwilling_smoke_UnwillingSmoke(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "frozenSleep":
            return frozen_sleep(
            resources_bigunion_types_frozen_sleep_FrozenSleep(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "diligentDeal":
            return diligent_deal(
            resources_bigunion_types_diligent_deal_DiligentDeal(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "attractiveScript":
            return attractive_script(
            resources_bigunion_types_attractive_script_AttractiveScript(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "hoarseMouse":
            return hoarse_mouse(
            resources_bigunion_types_hoarse_mouse_HoarseMouse(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "circularCard":
            return circular_card(
            resources_bigunion_types_circular_card_CircularCard(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "potableBad":
            return potable_bad(
            resources_bigunion_types_potable_bad_PotableBad(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "triangularRepair":
            return triangular_repair(
            resources_bigunion_types_triangular_repair_TriangularRepair(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "gaseousRoad":
            return gaseous_road(
            resources_bigunion_types_gaseous_road_GaseousRoad(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
class _BigUnion:
