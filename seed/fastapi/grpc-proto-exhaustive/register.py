...
import fastapi
from .resources.dataservice.service.service import AbstractDataserviceService
import typing
...
def register(
    ...
    *,
    dataservice: AbstractDataserviceService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None,
) -> None:
    _app.include_router(__register_service(dataservice), dependencies=dependencies)
