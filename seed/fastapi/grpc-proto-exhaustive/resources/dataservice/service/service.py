...
class AbstractDataserviceService(AbstractFernService):
    ...
    def __init_foo(cls, router: fastapi.APIRouter) -> None:
        ...
        router.post(
            path="/foo",
            response_model=typing.Dict[str, typing.Optional[typing.Any]],
            description=AbstractDataserviceService.foo.__doc__,
            **get_route_args(cls.foo, default_tag="dataservice"),
        )(wrapper)
