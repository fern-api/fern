...
from .resources.types.service.service import AbstractTypesService
...
def register(
    ...
    *,
    ...
    _app.include_router(__register_service(types), dependencies=dependencies)
