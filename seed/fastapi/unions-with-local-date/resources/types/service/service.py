...
class AbstractTypesService(AbstractFernService):
    """
    AbstractTypesService is an abstract class containing the methods that you should implement.
    ...
    @abc.abstractmethod
    def get(self, *, id: str) -> UnionWithTime: ...

    @abc.abstractmethod
    def update(self, *, body: UnionWithTime) -> bool: ...
    ...
    def __init_get(cls, router: fastapi.APIRouter) -> None:
        ...
        def wrapper(*args: typing.Any, **kwargs: typing.Any) -> UnionWithTime:
            try:
