...
from .resources.completions.service.service import AbstractCompletionsService


def register(
    _app: fastapi.FastAPI,
    *,
    completions: AbstractCompletionsService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None
) -> None:
    _app.include_router(__register_service(completions), dependencies=dependencies)
