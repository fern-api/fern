...
class AbstractCompletionsService(AbstractFernService):
    """
    AbstractCompletionsService is an abstract class containing the methods that you should implement.
    ...
    def _init_fern(cls, router: fastapi.APIRouter) -> None:
        cls.__init_stream(router=router)
    ...
    def __init_stream(cls, router: fastapi.APIRouter) -> None:
        ...
        def wrapper(*args: typing.Any, **kwargs: typing.Any) -> None:
            try:
                ...
                logging.getLogger(f"{cls.__module__}.{cls.__name__}").warn(
                    f"Endpoint 'stream' unexpectedly threw {e.__class__.__name__}. "
        ...
        wrapper.__globals__.update(cls.stream.__globals__)

        router.post(
            path="//stream",
            response_model=None,
            status_code=starlette.status.HTTP_204_NO_CONTENT,
            description=AbstractCompletionsService.stream.__doc__,
            **get_route_args(cls.stream, default_tag="completions"),
        )(wrapper)
