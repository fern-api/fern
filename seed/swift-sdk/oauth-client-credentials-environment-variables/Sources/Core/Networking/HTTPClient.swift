...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw OauthClientCredentialsEnvironmentVariablesError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw OauthClientCredentialsEnvironmentVariablesError.decodingError(error)
        }
    }
    ...
    private func buildRequestURL(
        ...
        let baseURL = resolveBaseURL(baseUrlId: baseUrlId)
    ...
    private func resolveBaseURL(baseUrlId: Swift.String?) -> Swift.String {
        if let baseUrlId, let baseURL = clientConfig.baseURLs?[baseUrlId] {
            return baseURL
        }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: OauthClientCredentialsEnvironmentVariablesError?
                ...
                } else if let existingClientError = error as? OauthClientCredentialsEnvironmentVariablesError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw OauthClientCredentialsEnvironmentVariablesError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> OauthClientCredentialsEnvironmentVariablesError
    {
        ...
        return OauthClientCredentialsEnvironmentVariablesError.httpError(httpError)
    }
}
