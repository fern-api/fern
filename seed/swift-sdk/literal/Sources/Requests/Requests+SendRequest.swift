...
extension Requests {
    public struct SendRequest: Codable, Hashable, Sendable {
        public let prompt: SendRequestPrompt
        public let query: String
        public let stream: Bool
        public let ending: SendRequestEnding
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.prompt = try container.decode(SendRequestPrompt.self, forKey: .prompt)
            self.query = try container.decode(String.self, forKey: .query)
            self.stream = try container.decode(Bool.self, forKey: .stream)
            self.ending = try container.decode(SendRequestEnding.self, forKey: .ending)
