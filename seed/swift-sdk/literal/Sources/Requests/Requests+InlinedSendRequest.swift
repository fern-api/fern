...
extension Requests {
    public struct InlinedSendRequest: Codable, Hashable, Sendable {
        public let prompt: InlinedSendRequestPrompt
        public let context: Nullable<InlinedSendRequestContext>?
        ...
        public init(
            ...
            context: Nullable<InlinedSendRequestContext>? = nil,
            query: String,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.prompt = try container.decode(InlinedSendRequestPrompt.self, forKey: .prompt)
            self.context = try container.decodeNullableIfPresent(InlinedSendRequestContext.self, forKey: .context)
