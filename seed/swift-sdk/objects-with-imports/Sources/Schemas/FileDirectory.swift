...
public struct FileDirectory: Codable, Hashable, Sendable {
    public let name: String
    public let files: Nullable<[File]>?
    public let directories: Nullable<[FileDirectory]>?
    ...
    public init(
        ...
        directories: Nullable<[FileDirectory]>? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.directories = try container.decodeNullableIfPresent([FileDirectory].self, forKey: .directories)
