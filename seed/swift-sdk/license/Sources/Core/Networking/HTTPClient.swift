...
final class HTTPClient: Swift.Sendable {
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                } else if let existingClientError = error as? LicenseError {
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> LicenseError
    {
        ...
        return LicenseError.httpError(httpError)
    }
}
