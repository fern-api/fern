...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw AuthEnvironmentVariablesError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw AuthEnvironmentVariablesError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: AuthEnvironmentVariablesError?
                ...
                } else if let existingClientError = error as? AuthEnvironmentVariablesError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw AuthEnvironmentVariablesError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> AuthEnvironmentVariablesError
    {
        ...
        return AuthEnvironmentVariablesError.httpError(httpError)
    }
}
