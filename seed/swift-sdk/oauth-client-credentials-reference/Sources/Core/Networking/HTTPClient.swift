...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw OauthClientCredentialsReferenceError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw OauthClientCredentialsReferenceError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw OauthClientCredentialsReferenceError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: OauthClientCredentialsReferenceError?
                ...
                } else if let existingClientError = error as? OauthClientCredentialsReferenceError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw OauthClientCredentialsReferenceError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> OauthClientCredentialsReferenceError
    {
        ...
        return OauthClientCredentialsReferenceError.httpError(httpError)
    }
}
