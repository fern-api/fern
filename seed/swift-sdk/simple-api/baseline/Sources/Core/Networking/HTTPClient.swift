...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw SimpleApiError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw SimpleApiError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: SimpleApiError?
                ...
                } else if let existingClientError = error as? SimpleApiError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw SimpleApiError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> SimpleApiError
    {
        ...
        return SimpleApiError.httpError(httpError)
    }
}
