...
```swift
dependencies: [
    .package(url: "https://github.com/openapi-path-param-body-collision/fern", from: "0.0.1"),
]
```
...
do {
    let response = try await client.updateProfileIdentifier(...)
...
let request = Requests.IdentifierUpdate(
    ...
)
```
...
```swift
try await client.updateProfileIdentifier(..., requestOptions: .init(
    additionalHeaders: [
