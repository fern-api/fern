...
public final class ApiClient: Sendable {
    ...
    public func updateProfileIdentifier(profileId: String, idTypePathParam: String, request: Requests.IdentifierUpdate, requestOptions: RequestOptions? = nil) async throws -> UpdateProfileIdentifierResponse {
        return try await httpClient.performRequest(
            method: .patch,
            path: "/Profiles/\(profileId)/Identifiers/\(idTypePathParam)",
            body: request,
            requestOptions: requestOptions,
            responseType: UpdateProfileIdentifierResponse.self
        )
    }
}