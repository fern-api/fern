...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw MultiUrlEnvironmentError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw MultiUrlEnvironmentError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: MultiUrlEnvironmentError?
                ...
                } else if let existingClientError = error as? MultiUrlEnvironmentError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw MultiUrlEnvironmentError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> MultiUrlEnvironmentError
    {
        ...
        return MultiUrlEnvironmentError.httpError(httpError)
    }
}
