public struct Order: Codable, Hashable {
    ...
    public init(complete: Bool? = nil, id: Int64? = nil, petId: Int64? = nil, quantity: Int? = nil, shipDate: Date? = nil, status: OrderStatus? = nil, additionalProperties: [String: JSONValue] = .init()) {
