...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw LiteralUserAgentError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw LiteralUserAgentError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: LiteralUserAgentError?
                ...
                } else if let existingClientError = error as? LiteralUserAgentError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw LiteralUserAgentError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> LiteralUserAgentError
    {
        ...
        return LiteralUserAgentError.httpError(httpError)
    }
}
