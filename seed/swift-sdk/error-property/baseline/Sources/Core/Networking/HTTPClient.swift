...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw ErrorPropertyError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw ErrorPropertyError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: ErrorPropertyError?
                ...
                } else if let existingClientError = error as? ErrorPropertyError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw ErrorPropertyError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> ErrorPropertyError
    {
        ...
        return ErrorPropertyError.httpError(httpError)
    }
}
