public final class ErrorPropertyClient: Sendable {
    ...
    public init(baseURL: String = ErrorPropertyEnvironment.default.rawValue, apiKey qpiKey: String, token: String? = nil, headers: [String: String]? = [:], timeout: Int? = nil, maxRetries: Int? = nil, urlSession: URLSession? = nil) {
