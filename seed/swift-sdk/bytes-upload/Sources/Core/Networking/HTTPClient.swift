...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw BytesUploadError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw BytesUploadError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: BytesUploadError?
                ...
                } else if let existingClientError = error as? BytesUploadError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw BytesUploadError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> BytesUploadError
    {
        ...
        return BytesUploadError.httpError(httpError)
    }
}
