...
```swift
dependencies: [
    .package(url: "https://github.com/no-retries/fern", from: "0.0.1"),
]
```
...
do {
    let response = try await client.retries.getUsers(...)
...
```swift
try await client.retries.getUsers(..., requestOptions: .init(
    additionalHeaders: [
