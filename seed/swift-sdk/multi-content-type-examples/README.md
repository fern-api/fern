...
```swift
dependencies: [
    .package(url: "https://github.com/multi-content-type-examples/fern", from: "0.0.1"),
]
```
...
let request = Requests.ClientRequest(
    ...
)
```
...
```swift
try await client.clients.create(..., requestOptions: .init(
    additionalHeaders: [
