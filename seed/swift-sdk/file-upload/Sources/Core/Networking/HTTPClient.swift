...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        do {
            ...
            throw FileUploadError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw FileUploadError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: FileUploadError?
                ...
                } else if let existingClientError = error as? FileUploadError {
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> FileUploadError
    {
        ...
        return FileUploadError.httpError(httpError)
    }
}
