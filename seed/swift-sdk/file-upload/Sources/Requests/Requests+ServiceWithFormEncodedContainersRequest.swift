...
extension Requests {
    public struct ServiceWithFormEncodedContainersRequest {
        ...
        public let listOfObjectsWithOptionals: [MyObjectWithOptional]?
        ...
        public init(
            ...
            optionalId: Id? = nil,
            listOfObjectsWithOptionals: [MyObjectWithOptional]? = nil,
            ...
            self.listOfObjectsWithOptionals = listOfObjectsWithOptionals
...
extension Requests.ServiceWithFormEncodedContainersRequest: MultipartFormDataConvertible {
    var multipartFormFields: [MultipartFormField] {
        [
            ...
            .field(listOfObjectsWithOptionals, fieldName: "list_of_objects_with_optionals"),
