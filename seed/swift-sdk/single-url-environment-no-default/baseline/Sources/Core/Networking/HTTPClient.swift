...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw SingleUrlEnvironmentNoDefaultError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw SingleUrlEnvironmentNoDefaultError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: SingleUrlEnvironmentNoDefaultError?
                ...
                } else if let existingClientError = error as? SingleUrlEnvironmentNoDefaultError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw SingleUrlEnvironmentNoDefaultError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> SingleUrlEnvironmentNoDefaultError
    {
        ...
        return SingleUrlEnvironmentNoDefaultError.httpError(httpError)
    }
}
