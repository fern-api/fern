...
public struct InlineUsersPage: Codable, Hashable, Sendable {
    /// The current page
    public let page: Int
    public let next: InlineUsersNextPage?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.next = try container.decodeIfPresent(InlineUsersNextPage.self, forKey: .next)
