...
public struct PageType: Codable, Hashable, Sendable {
    /// The current page
    public let page: Int
    public let next: NextPageType?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.next = try container.decodeIfPresent(NextPageType.self, forKey: .next)
