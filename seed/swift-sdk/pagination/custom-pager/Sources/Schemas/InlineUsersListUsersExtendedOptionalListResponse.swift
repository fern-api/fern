...
public struct InlineUsersListUsersExtendedOptionalListResponse: Codable, Hashable, Sendable {
    public let data: InlineUsersUserOptionalListContainer
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.data = try container.decode(InlineUsersUserOptionalListContainer.self, forKey: .data)
