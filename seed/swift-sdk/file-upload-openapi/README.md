...
```swift
dependencies: [
    .package(url: "https://github.com/file-upload-openapi/fern", from: "0.0.1"),
]
```
...
let request = Requests.UploadFileRequest(
    ...
)
```
...
```swift
try await client.fileUploadExample.uploadFile(..., requestOptions: .init(
    additionalHeaders: [
