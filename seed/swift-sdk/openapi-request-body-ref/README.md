...
```swift
dependencies: [
    .package(url: "https://github.com/openapi-request-body-ref/fern", from: "0.0.1"),
]
```
...
let request = Requests.CreateVendorRequest(
    ...
)
```
...
```swift
try await client.vendor.createVendor(..., requestOptions: .init(
    additionalHeaders: [
