...
public final class ApiClient: Sendable {
    public let vendor: VendorClient
    public let catalog: CatalogClient
    public let teamMember: TeamMemberClient
    ...
    init(
        ...
        self.vendor = VendorClient(config: config)
        self.catalog = CatalogClient(config: config)
        self.teamMember = TeamMemberClient(config: config)
