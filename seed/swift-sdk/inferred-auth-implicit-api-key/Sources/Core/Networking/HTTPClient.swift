...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw InferredAuthImplicitApiKeyError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw InferredAuthImplicitApiKeyError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: InferredAuthImplicitApiKeyError?
                ...
                } else if let existingClientError = error as? InferredAuthImplicitApiKeyError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw InferredAuthImplicitApiKeyError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> InferredAuthImplicitApiKeyError
    {
        ...
        return InferredAuthImplicitApiKeyError.httpError(httpError)
    }
}
