public final class ResponsePropertyClient: Sendable {
    ...
    public init(baseURL: String = ResponsePropertyEnvironment.default.rawValue, apiKey qpiKey: String, token: String? = nil, headers: [String: String]? = [:], timeout: Int? = nil, maxRetries: Int? = nil, urlSession: URLSession? = nil) {
