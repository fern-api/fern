...
final class HTTPClient: Swift.Sendable {
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: StreamingError?
                ...
                } else if let existingClientError = error as? StreamingError {
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> StreamingError
    {
        ...
        return StreamingError.httpError(httpError)
    }
}
