...
```swift
dependencies: [
    .package(url: "https://github.com/schemaless-request-body-examples/fern", from: "0.0.1"),
]
```
...
do {
    let response = try await client.createPlant(...)
...
let request = Requests.CreatePlantWithSchemaRequest(
    ...
)
```
...
```swift
try await client.createPlant(..., requestOptions: .init(
    additionalHeaders: [
