...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw OauthClientCredentialsDefaultError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw OauthClientCredentialsDefaultError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw OauthClientCredentialsDefaultError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: OauthClientCredentialsDefaultError?
                ...
                } else if let existingClientError = error as? OauthClientCredentialsDefaultError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw OauthClientCredentialsDefaultError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> OauthClientCredentialsDefaultError
    {
        ...
        return OauthClientCredentialsDefaultError.httpError(httpError)
    }
}
