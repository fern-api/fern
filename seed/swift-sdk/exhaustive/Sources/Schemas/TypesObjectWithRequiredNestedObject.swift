...
public struct TypesObjectWithRequiredNestedObject: Codable, Hashable, Sendable {
    public let requiredString: String
    public let requiredObject: TypesNestedObjectWithRequiredField
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.requiredObject = try container.decode(TypesNestedObjectWithRequiredField.self, forKey: .requiredObject)
