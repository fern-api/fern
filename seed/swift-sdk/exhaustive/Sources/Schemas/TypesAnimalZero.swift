...
public struct TypesAnimalZero: Codable, Hashable, Sendable {
    public let name: String
    public let likesToWoof: Bool
    public let animal: TypesAnimalZeroAnimal
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.animal = try container.decode(TypesAnimalZeroAnimal.self, forKey: .animal)
