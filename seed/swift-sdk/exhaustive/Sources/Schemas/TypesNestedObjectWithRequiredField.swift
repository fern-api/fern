...
public struct TypesNestedObjectWithRequiredField: Codable, Hashable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.nestedObject = try container.decode(TypesObjectWithOptionalField.self, forKey: .nestedObject)
