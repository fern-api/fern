...
public struct TypesAnimalOne: Codable, Hashable, Sendable {
    public let name: String
    public let likesToMeow: Bool
    public let animal: TypesAnimalOneAnimal
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.animal = try container.decode(TypesAnimalOneAnimal.self, forKey: .animal)
