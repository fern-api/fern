...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw BearerTokenEnvironmentVariableError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw BearerTokenEnvironmentVariableError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: BearerTokenEnvironmentVariableError?
                ...
                } else if let existingClientError = error as? BearerTokenEnvironmentVariableError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw BearerTokenEnvironmentVariableError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> BearerTokenEnvironmentVariableError
    {
        ...
        return BearerTokenEnvironmentVariableError.httpError(httpError)
    }
}
