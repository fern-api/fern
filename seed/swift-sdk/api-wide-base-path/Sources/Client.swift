public final class ApiWideBasePathClient: Sendable {
    ...
    public init(baseURL: String = ApiWideBasePathEnvironment.default.rawValue, apiKey qpiKey: String, token: String? = nil, headers: [String: String]? = [:], timeout: Int? = nil, maxRetries: Int? = nil, urlSession: URLSession? = nil) {
