...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw ApiWideBasePathError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw ApiWideBasePathError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: ApiWideBasePathError?
                ...
                } else if let existingClientError = error as? ApiWideBasePathError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw ApiWideBasePathError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> ApiWideBasePathError
    {
        ...
        return ApiWideBasePathError.httpError(httpError)
    }
}
