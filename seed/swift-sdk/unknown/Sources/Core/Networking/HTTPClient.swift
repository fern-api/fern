...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw UnknownAsAnyError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw UnknownAsAnyError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw UnknownAsAnyError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: UnknownAsAnyError?
                ...
                } else if let existingClientError = error as? UnknownAsAnyError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw UnknownAsAnyError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> UnknownAsAnyError
    {
        ...
        return UnknownAsAnyError.httpError(httpError)
    }
}
