...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw ServerSentEventsResumableError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw ServerSentEventsResumableError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: ServerSentEventsResumableError?
                ...
                } else if let existingClientError = error as? ServerSentEventsResumableError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw ServerSentEventsResumableError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> ServerSentEventsResumableError
    {
        ...
        return ServerSentEventsResumableError.httpError(httpError)
    }
}
