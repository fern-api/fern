...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw DollarStringExamplesError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw DollarStringExamplesError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw DollarStringExamplesError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: DollarStringExamplesError?
                ...
                } else if let existingClientError = error as? DollarStringExamplesError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw DollarStringExamplesError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> DollarStringExamplesError
    {
        ...
        return DollarStringExamplesError.httpError(httpError)
    }
}
