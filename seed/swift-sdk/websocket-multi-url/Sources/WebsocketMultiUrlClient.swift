...
public final class WebsocketMultiUrlClient: Sendable {
    ...
    public convenience init(
        environment: WebsocketMultiUrlEnvironment = WebsocketMultiUrlEnvironment.production,
        token: String,
    ...
    init(
        environment: WebsocketMultiUrlEnvironment,
