...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw WebsocketMultiUrlError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw WebsocketMultiUrlError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: WebsocketMultiUrlError?
                ...
                } else if let existingClientError = error as? WebsocketMultiUrlError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw WebsocketMultiUrlError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> WebsocketMultiUrlError
    {
        ...
        return WebsocketMultiUrlError.httpError(httpError)
    }
}
