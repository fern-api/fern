...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw OauthPkceError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw OauthPkceError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: OauthPkceError?
                ...
                } else if let existingClientError = error as? OauthPkceError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw OauthPkceError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> OauthPkceError
    {
        ...
        return OauthPkceError.httpError(httpError)
    }
}
