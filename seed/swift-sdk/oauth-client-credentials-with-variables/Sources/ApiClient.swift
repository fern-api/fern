...
public final class ApiClient: Sendable {
    ...
    public let nestedNoAuthApi: NestedNoAuthApiClient
    public let nestedApi: NestedApiClient
    ...
    init(
        ...
        self.nestedNoAuthApi = NestedNoAuthApiClient(config: config)
        self.nestedApi = NestedApiClient(config: config)
