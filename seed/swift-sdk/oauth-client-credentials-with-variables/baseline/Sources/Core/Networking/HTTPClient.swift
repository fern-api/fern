...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw OauthClientCredentialsWithVariablesError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw OauthClientCredentialsWithVariablesError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: OauthClientCredentialsWithVariablesError?
                ...
                } else if let existingClientError = error as? OauthClientCredentialsWithVariablesError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw OauthClientCredentialsWithVariablesError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> OauthClientCredentialsWithVariablesError
    {
        ...
        return OauthClientCredentialsWithVariablesError.httpError(httpError)
    }
}
