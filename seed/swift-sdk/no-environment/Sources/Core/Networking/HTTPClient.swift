...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw NoEnvironmentError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw NoEnvironmentError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: NoEnvironmentError?
                ...
                } else if let existingClientError = error as? NoEnvironmentError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw NoEnvironmentError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> NoEnvironmentError
    {
        ...
        return NoEnvironmentError.httpError(httpError)
    }
}
