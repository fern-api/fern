...
public final class ApiClient: Sendable {
    public let folderAService: FolderAServiceClient
    public let foo: FooClient
    public let folderDService: FolderDServiceClient
    ...
    init(
        ...
        self.folderAService = FolderAServiceClient(config: config)
        self.foo = FooClient(config: config)
        self.folderDService = FolderDServiceClient(config: config)
