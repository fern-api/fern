...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw UnionQueryParametersError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw UnionQueryParametersError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: UnionQueryParametersError?
                ...
                } else if let existingClientError = error as? UnionQueryParametersError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw UnionQueryParametersError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> UnionQueryParametersError
    {
        ...
        return UnionQueryParametersError.httpError(httpError)
    }
}
