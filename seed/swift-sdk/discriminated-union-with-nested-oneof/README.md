...
```swift
dependencies: [
    .package(url: "https://github.com/discriminated-union-with-nested-oneof/fern", from: "0.0.1"),
]
```
...
do {
    let response = try await client.createAst(...)
...
```swift
try await client.createAst(..., requestOptions: .init(
    additionalHeaders: [
