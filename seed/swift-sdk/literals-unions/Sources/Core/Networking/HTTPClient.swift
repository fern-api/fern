...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw LiteralsUnionsError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw LiteralsUnionsError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw LiteralsUnionsError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: LiteralsUnionsError?
                ...
                } else if let existingClientError = error as? LiteralsUnionsError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw LiteralsUnionsError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> LiteralsUnionsError
    {
        ...
        return LiteralsUnionsError.httpError(httpError)
    }
}
