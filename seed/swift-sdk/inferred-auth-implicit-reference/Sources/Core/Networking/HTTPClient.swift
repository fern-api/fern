...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw InferredAuthImplicitError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw InferredAuthImplicitError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw InferredAuthImplicitError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: InferredAuthImplicitError?
                ...
                } else if let existingClientError = error as? InferredAuthImplicitError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw InferredAuthImplicitError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> InferredAuthImplicitError
    {
        ...
        return InferredAuthImplicitError.httpError(httpError)
    }
}
