...
extension Requests {
    public struct GetTokenRequest: Codable, Hashable, Sendable {
        ...
        public let audience: GetTokenRequestAudience
        public let grantType: GetTokenRequestGrantType
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.audience = try container.decode(GetTokenRequestAudience.self, forKey: .audience)
            self.grantType = try container.decode(GetTokenRequestGrantType.self, forKey: .grantType)
