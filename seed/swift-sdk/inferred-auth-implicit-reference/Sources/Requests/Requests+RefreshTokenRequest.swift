...
extension Requests {
    public struct RefreshTokenRequest: Codable, Hashable, Sendable {
        ...
        public let audience: RefreshTokenRequestAudience
        public let grantType: RefreshTokenRequestGrantType
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.audience = try container.decode(RefreshTokenRequestAudience.self, forKey: .audience)
            self.grantType = try container.decode(RefreshTokenRequestGrantType.self, forKey: .grantType)
