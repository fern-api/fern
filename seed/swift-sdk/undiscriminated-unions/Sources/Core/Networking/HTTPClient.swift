...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw UndiscriminatedUnionsError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw UndiscriminatedUnionsError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: UndiscriminatedUnionsError?
                ...
                } else if let existingClientError = error as? UndiscriminatedUnionsError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw UndiscriminatedUnionsError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> UndiscriminatedUnionsError
    {
        ...
        return UndiscriminatedUnionsError.httpError(httpError)
    }
}
