    ...
    @Test func testClientErrorFor400BadRequest() async throws {
        ...
        do {
            ...
            guard case .httpError(let httpError) = error else {
                Issue.record("Expected UndiscriminatedUnionsError.httpError, got \(error)")
                return
            }
            ...
            Issue.record("Expected UndiscriminatedUnionsError, got \(error)")
        }
    }
