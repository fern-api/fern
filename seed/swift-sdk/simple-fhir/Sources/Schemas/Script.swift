...
public struct Script: Codable, Hashable, Sendable {
    ...
    public let resourceType: ScriptResourceType
    ...
    public init(
        ...
        memo: Memo,
        resourceType: ScriptResourceType,
        name: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.resourceType = try container.decode(ScriptResourceType.self, forKey: .resourceType)
