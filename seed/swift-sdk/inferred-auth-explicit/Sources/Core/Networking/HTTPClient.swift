...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw InferredAuthExplicitError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw InferredAuthExplicitError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw InferredAuthExplicitError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: InferredAuthExplicitError?
                ...
                } else if let existingClientError = error as? InferredAuthExplicitError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw InferredAuthExplicitError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> InferredAuthExplicitError
    {
        ...
        return InferredAuthExplicitError.httpError(httpError)
    }
}
