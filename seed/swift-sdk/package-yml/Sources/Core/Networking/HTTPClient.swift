...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw PackageYmlError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw PackageYmlError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: PackageYmlError?
                ...
                } else if let existingClientError = error as? PackageYmlError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw PackageYmlError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> PackageYmlError
    {
        ...
        return PackageYmlError.httpError(httpError)
    }
}
