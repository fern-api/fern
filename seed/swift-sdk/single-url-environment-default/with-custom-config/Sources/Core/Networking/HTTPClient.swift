...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw SingleUrlEnvironmentDefaultError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw SingleUrlEnvironmentDefaultError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw SingleUrlEnvironmentDefaultError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: SingleUrlEnvironmentDefaultError?
                ...
                } else if let existingClientError = error as? SingleUrlEnvironmentDefaultError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw SingleUrlEnvironmentDefaultError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> SingleUrlEnvironmentDefaultError
    {
        ...
        return SingleUrlEnvironmentDefaultError.httpError(httpError)
    }
}
