...
```swift
dependencies: [
    .package(url: "https://github.com/allof-duplicate-properties/fern", from: "0.0.1"),
]
```
...
do {
    let response = try await client.createPlantOrder(...)
...
```swift
try await client.createPlantOrder(..., requestOptions: .init(
    additionalHeaders: [
