...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw WebsocketBearerAuthError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw WebsocketBearerAuthError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: WebsocketBearerAuthError?
                ...
                } else if let existingClientError = error as? WebsocketBearerAuthError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw WebsocketBearerAuthError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> WebsocketBearerAuthError
    {
        ...
        return WebsocketBearerAuthError.httpError(httpError)
    }
}
