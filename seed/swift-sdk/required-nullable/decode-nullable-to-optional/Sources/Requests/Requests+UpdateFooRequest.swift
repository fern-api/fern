...
extension Requests {
    public struct UpdateFooRequest: Codable, Hashable, Sendable {
        ...
        public let nullableText: String?
        /// Can be explicitly set to null to clear the value
        public let nullableNumber: Double?
        ...
        public init(
            nullableText: String? = nil,
            nullableNumber: Double? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.nullableText = try container.decodeIfPresent(String.self, forKey: .nullableText)
            self.nullableNumber = try container.decodeIfPresent(Double.self, forKey: .nullableNumber)
        ...
        public func encode(to encoder: Encoder) throws -> Void {
            ...
            try container.encodeIfPresent(self.nullableText, forKey: .nullableText)
            try container.encodeIfPresent(self.nullableNumber, forKey: .nullableNumber)
