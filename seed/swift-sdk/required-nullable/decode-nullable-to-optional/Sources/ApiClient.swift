...
public final class ApiClient: Sendable {
    ...
    public func getFoo(optionalBaz: String? = nil, optionalNullableBaz: String? = nil, requiredBaz: String, requiredNullableBaz: String? = nil, requestOptions: RequestOptions? = nil) async throws -> Foo {
        return try await httpClient.performRequest(
            method: .get,
            path: "/foo",
            queryParams: [
                "optional_baz": optionalBaz.map { .string($0) }, 
                "optional_nullable_baz": optionalNullableBaz.map { .string($0) }, 
                "required_baz": .string(requiredBaz), 
                "required_nullable_baz": requiredNullableBaz.map { .string($0) }
            ],
