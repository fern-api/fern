...
```swift
dependencies: [
    .package(url: "https://github.com/php-global-header-env/fern", from: "0.0.1"),
]
```
...
do {
    let response = try await client.service.getWithApiVersion(...)
...
```swift
try await client.service.getWithApiVersion(..., requestOptions: .init(
    additionalHeaders: [
