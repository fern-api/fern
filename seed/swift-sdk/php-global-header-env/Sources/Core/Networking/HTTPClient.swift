...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw PhpGlobalHeaderEnvError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw PhpGlobalHeaderEnvError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: PhpGlobalHeaderEnvError?
                ...
                } else if let existingClientError = error as? PhpGlobalHeaderEnvError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw PhpGlobalHeaderEnvError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> PhpGlobalHeaderEnvError
    {
        ...
        return PhpGlobalHeaderEnvError.httpError(httpError)
    }
}
