...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw OauthClientCredentialsError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw OauthClientCredentialsError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw OauthClientCredentialsError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: OauthClientCredentialsError?
                ...
                } else if let existingClientError = error as? OauthClientCredentialsError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw OauthClientCredentialsError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> OauthClientCredentialsError
    {
        ...
        return OauthClientCredentialsError.httpError(httpError)
    }
}
