...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw RequestParametersError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw RequestParametersError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: RequestParametersError?
                ...
                } else if let existingClientError = error as? RequestParametersError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw RequestParametersError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> RequestParametersError
    {
        ...
        return RequestParametersError.httpError(httpError)
    }
}
