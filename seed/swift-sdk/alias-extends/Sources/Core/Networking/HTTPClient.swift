...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw AliasExtendsError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw AliasExtendsError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: AliasExtendsError?
                ...
                } else if let existingClientError = error as? AliasExtendsError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw AliasExtendsError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> AliasExtendsError
    {
        ...
        return AliasExtendsError.httpError(httpError)
    }
}
