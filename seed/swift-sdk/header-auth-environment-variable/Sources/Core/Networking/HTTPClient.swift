...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw HeaderTokenEnvironmentVariableError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw HeaderTokenEnvironmentVariableError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: HeaderTokenEnvironmentVariableError?
                ...
                } else if let existingClientError = error as? HeaderTokenEnvironmentVariableError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw HeaderTokenEnvironmentVariableError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> HeaderTokenEnvironmentVariableError
    {
        ...
        return HeaderTokenEnvironmentVariableError.httpError(httpError)
    }
}
