...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw BasicAuthEnvironmentVariablesError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw BasicAuthEnvironmentVariablesError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw BasicAuthEnvironmentVariablesError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: BasicAuthEnvironmentVariablesError?
                ...
                } else if let existingClientError = error as? BasicAuthEnvironmentVariablesError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw BasicAuthEnvironmentVariablesError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> BasicAuthEnvironmentVariablesError
    {
        ...
        return BasicAuthEnvironmentVariablesError.httpError(httpError)
    }
}
