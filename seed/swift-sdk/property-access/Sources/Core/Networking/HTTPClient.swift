...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw PropertyAccessError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw PropertyAccessError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: PropertyAccessError?
                ...
                } else if let existingClientError = error as? PropertyAccessError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw PropertyAccessError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> PropertyAccessError
    {
        ...
        return PropertyAccessError.httpError(httpError)
    }
}
