...
extension Requests {
    public struct BigEntity: Codable, Hashable, Sendable {
        ...
        public let commonMetadata: CommonsMetadata?
        public let eventInfo: CommonsEventInfo?
        public let data: CommonsData?
        ...
        public init(
            ...
            commonMetadata: CommonsMetadata? = nil,
            eventInfo: CommonsEventInfo? = nil,
            data: CommonsData? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.commonMetadata = try container.decodeIfPresent(CommonsMetadata.self, forKey: .commonMetadata)
            self.eventInfo = try container.decodeIfPresent(CommonsEventInfo.self, forKey: .eventInfo)
            self.data = try container.decodeIfPresent(CommonsData.self, forKey: .data)
