...
public struct ExceptionZero: Codable, Hashable, Sendable {
    public let exceptionType: String
    public let exceptionMessage: String
    public let exceptionStacktrace: String
    public let type: ExceptionZeroType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(ExceptionZeroType.self, forKey: .type)
