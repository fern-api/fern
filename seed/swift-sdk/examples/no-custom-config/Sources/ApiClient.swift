...
public final class ApiClient: Sendable {
    public let fileNotificationService: FileNotificationServiceClient
    public let fileService: FileServiceClient
    public let healthService: HealthServiceClient
    ...
    init(
        ...
        self.fileNotificationService = FileNotificationServiceClient(config: config)
        self.fileService = FileServiceClient(config: config)
        self.healthService = HealthServiceClient(config: config)
