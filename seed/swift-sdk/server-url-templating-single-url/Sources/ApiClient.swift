...
public final class ApiClient: Sendable {
    ...
    ///
    /// - Parameter baseURL: The base URL to use for requests from the client. If not provided, the default base URL is resolved from the server URL variables.
    /// - Parameter region: The `region` server URL variable, substituted into the base URL. Defaults to "us-east-1".
    /// - Parameter environment: The `environment` server URL variable, substituted into the base URL. Defaults to "prod".
