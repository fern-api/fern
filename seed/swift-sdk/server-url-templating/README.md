...
```swift
dependencies: [
    .package(url: "https://github.com/server-url-templating/fern", from: "0.0.1"),
]
```
...
let request = Requests.TokenRequest(
    ...
)
```
...
```swift
try await client.getToken(..., requestOptions: .init(
    additionalHeaders: [
