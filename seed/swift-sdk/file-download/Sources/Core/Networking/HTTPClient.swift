...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        do {
            ...
            throw FileDownloadError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw FileDownloadError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: FileDownloadError?
                ...
                } else if let existingClientError = error as? FileDownloadError {
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> FileDownloadError
    {
        ...
        return FileDownloadError.httpError(httpError)
    }
}
