...
```swift
dependencies: [
    .package(url: "https://github.com/respect-optional-request-body/fern", from: "0.0.1"),
]
```
...
do {
    let response = try await client.refund(...)
...
```swift
try await client.refund(..., requestOptions: .init(
    additionalHeaders: [
