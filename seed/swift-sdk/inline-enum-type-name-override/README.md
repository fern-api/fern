...
```swift
dependencies: [
    .package(url: "https://github.com/inline-enum-type-name-override/fern", from: "0.0.1"),
]
```
...
do {
    let response = try await client.reporting.load(...)
...
let request = Requests.LoadRequest(
    ...
)
```
...
```swift
try await client.reporting.load(..., requestOptions: .init(
    additionalHeaders: [
