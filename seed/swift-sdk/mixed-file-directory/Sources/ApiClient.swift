...
public final class ApiClient: Sendable {
    ...
    public let userEvents: UserEventsClient
    public let userEventsMetadata: UserEventsMetadataClient
    ...
    init(
        ...
        self.userEvents = UserEventsClient(config: config)
        self.userEventsMetadata = UserEventsMetadataClient(config: config)
