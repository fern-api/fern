...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw MixedFileDirectoryError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw MixedFileDirectoryError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: MixedFileDirectoryError?
                ...
                } else if let existingClientError = error as? MixedFileDirectoryError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw MixedFileDirectoryError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> MixedFileDirectoryError
    {
        ...
        return MixedFileDirectoryError.httpError(httpError)
    }
}
