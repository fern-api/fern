...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw BasicAuthPwOmittedError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw BasicAuthPwOmittedError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: BasicAuthPwOmittedError?
                ...
                } else if let existingClientError = error as? BasicAuthPwOmittedError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw BasicAuthPwOmittedError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> BasicAuthPwOmittedError
    {
        ...
        return BasicAuthPwOmittedError.httpError(httpError)
    }
}
