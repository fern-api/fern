...
```swift
dependencies: [
    .package(url: "https://github.com/x-fern-global-parameters/fern", from: "0.0.1"),
]
```
...
let request = Requests.SearchProductsRequest(
    ...
)
```
...
```swift
try await client.products.search(..., requestOptions: .init(
    additionalHeaders: [
