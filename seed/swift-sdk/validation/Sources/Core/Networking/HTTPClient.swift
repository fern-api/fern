...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        do {
            ...
            throw ValidationError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: ValidationError?
                ...
                } else if let existingClientError = error as? ValidationError {
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> ValidationError
    {
        ...
        return ValidationError.httpError(httpError)
    }
}
