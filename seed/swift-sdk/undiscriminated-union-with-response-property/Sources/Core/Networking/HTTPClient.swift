...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw UndiscriminatedUnionWithResponsePropertyError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw UndiscriminatedUnionWithResponsePropertyError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw UndiscriminatedUnionWithResponsePropertyError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: UndiscriminatedUnionWithResponsePropertyError?
                ...
                } else if let existingClientError = error as? UndiscriminatedUnionWithResponsePropertyError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw UndiscriminatedUnionWithResponsePropertyError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> UndiscriminatedUnionWithResponsePropertyError
    {
        ...
        return UndiscriminatedUnionWithResponsePropertyError.httpError(httpError)
    }
}
