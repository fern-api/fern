...
public struct DebugVariableValueEight: Codable, Hashable, Sendable {
    public let nodeId: NodeId
    public let fullList: SinglyLinkedListValue
    public let type: DebugVariableValueEightType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(DebugVariableValueEightType.self, forKey: .type)
