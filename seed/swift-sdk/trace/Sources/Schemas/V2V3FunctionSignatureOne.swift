...
public struct V2V3FunctionSignatureOne: Codable, Hashable, Sendable {
    public let parameters: [V2V3Parameter]
    public let returnType: VariableType
    public let type: V2V3FunctionSignatureOneType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(V2V3FunctionSignatureOneType.self, forKey: .type)
