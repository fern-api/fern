...
public struct DebugVariableValueSeven: Codable, Hashable, Sendable {
    public let nodeId: NodeId
    public let fullTree: BinaryTreeValue
    public let type: DebugVariableValueSevenType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(DebugVariableValueSevenType.self, forKey: .type)
