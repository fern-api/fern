...
public struct SubmissionResponseThree: Codable, Hashable, Sendable {
    public let exceptionType: String
    public let exceptionMessage: String
    public let exceptionStacktrace: String
    public let type: SubmissionResponseThreeType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(SubmissionResponseThreeType.self, forKey: .type)
