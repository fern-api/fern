...
public struct VariableValueNine: Codable, Hashable, Sendable {
    public let head: NodeId?
    public let nodes: [String: DoublyLinkedListNodeValue]
    public let type: VariableValueNineType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(VariableValueNineType.self, forKey: .type)
