...
public struct ExceptionV2Zero: Codable, Hashable, Sendable {
    public let exceptionType: String
    public let exceptionMessage: String
    public let exceptionStacktrace: String
    public let type: ExceptionV2ZeroType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(ExceptionV2ZeroType.self, forKey: .type)
