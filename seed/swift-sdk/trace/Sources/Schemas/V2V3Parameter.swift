...
public struct V2V3Parameter: Codable, Hashable, Sendable {
    public let parameterId: V2V3ParameterId
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.parameterId = try container.decode(V2V3ParameterId.self, forKey: .parameterId)
