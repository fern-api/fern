...
public struct V2CreateProblemRequestV2: Codable, Hashable, Sendable {
    public let problemName: String
    public let problemDescription: ProblemDescription
    public let customFiles: V2CustomFiles
    public let customTestCaseTemplates: [V2TestCaseTemplate]
    public let testcases: [V2TestCaseV2]
    ...
    public init(
        ...
        customTestCaseTemplates: [V2TestCaseTemplate],
        testcases: [V2TestCaseV2],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.customFiles = try container.decode(V2CustomFiles.self, forKey: .customFiles)
        self.customTestCaseTemplates = try container.decode([V2TestCaseTemplate].self, forKey: .customTestCaseTemplates)
        self.testcases = try container.decode([V2TestCaseV2].self, forKey: .testcases)
