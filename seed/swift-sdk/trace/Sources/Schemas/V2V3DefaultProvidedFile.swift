...
public struct V2V3DefaultProvidedFile: Codable, Hashable, Sendable {
    public let file: V2V3FileInfoV2
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.file = try container.decode(V2V3FileInfoV2.self, forKey: .file)
