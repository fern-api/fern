...
public struct DebugVariableValueNine: Codable, Hashable, Sendable {
    public let nodeId: NodeId
    public let fullList: DoublyLinkedListValue
    public let type: DebugVariableValueNineType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(DebugVariableValueNineType.self, forKey: .type)
