...
public struct SubmissionRequestTwo: Codable, Hashable, Sendable {
    ...
    public let type: SubmissionRequestTwoType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(SubmissionRequestTwoType.self, forKey: .type)
