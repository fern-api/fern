...
public struct V2FunctionSignatureTwo: Codable, Hashable, Sendable {
    public let parameters: [V2Parameter]
    public let actualResultType: VariableType
    public let type: V2FunctionSignatureTwoType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(V2FunctionSignatureTwoType.self, forKey: .type)
