...
public struct V2BasicTestCaseTemplate: Codable, Hashable, Sendable {
    public let templateId: V2TestCaseTemplateId
    public let name: String
    public let description: V2TestCaseImplementationDescription
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.templateId = try container.decode(V2TestCaseTemplateId.self, forKey: .templateId)
        self.name = try container.decode(String.self, forKey: .name)
        self.description = try container.decode(V2TestCaseImplementationDescription.self, forKey: .description)
