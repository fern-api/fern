...
public struct V2ProblemInfoV2: Codable, Hashable, Sendable {
    ...
    public let generatedFiles: V2GeneratedFiles
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.generatedFiles = try container.decode(V2GeneratedFiles.self, forKey: .generatedFiles)
