...
public struct ActualResultOne: Codable, Hashable, Sendable {
    public let exceptionType: String
    public let exceptionMessage: String
    public let exceptionStacktrace: String
    public let type: ActualResultOneType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(ActualResultOneType.self, forKey: .type)
