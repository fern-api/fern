...
public struct SubmissionRequestZero: Codable, Hashable, Sendable {
    public let problemId: ProblemId
    public let problemVersion: Nullable<Int>?
    public let type: SubmissionRequestZeroType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(SubmissionRequestZeroType.self, forKey: .type)
