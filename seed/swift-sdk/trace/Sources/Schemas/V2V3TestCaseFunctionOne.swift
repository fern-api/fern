...
public struct V2V3TestCaseFunctionOne: Codable, Hashable, Sendable {
    public let parameters: [V2V3Parameter]
    public let code: V2V3FunctionImplementationForMultipleLanguages
    public let type: V2V3TestCaseFunctionOneType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(V2V3TestCaseFunctionOneType.self, forKey: .type)
