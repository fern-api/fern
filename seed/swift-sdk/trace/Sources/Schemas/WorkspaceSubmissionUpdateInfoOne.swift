...
public struct WorkspaceSubmissionUpdateInfoOne: Codable, Hashable, Sendable {
    public let exceptionV2: ExceptionV2?
    public let exception: ExceptionInfo?
    public let stdout: String
    public let type: WorkspaceSubmissionUpdateInfoOneType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(WorkspaceSubmissionUpdateInfoOneType.self, forKey: .type)
