...
public struct V2Parameter: Codable, Hashable, Sendable {
    public let parameterId: V2ParameterId
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.parameterId = try container.decode(V2ParameterId.self, forKey: .parameterId)
