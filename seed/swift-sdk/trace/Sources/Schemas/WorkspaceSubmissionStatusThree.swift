...
public struct WorkspaceSubmissionStatusThree: Codable, Hashable, Sendable {
    public let exceptionV2: ExceptionV2?
    public let exception: ExceptionInfo?
    public let stdout: String
    public let type: WorkspaceSubmissionStatusThreeType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(WorkspaceSubmissionStatusThreeType.self, forKey: .type)
