...
public struct V2TestCaseFunctionZero: Codable, Hashable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(V2TestCaseFunctionZeroType.self, forKey: .type)
