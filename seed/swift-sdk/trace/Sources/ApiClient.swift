...
public final class ApiClient: Sendable {
    ...
    public let v2Problem: V2ProblemClient
    public let v2V3Problem: V2V3ProblemClient
    ...
    init(
        ...
        self.v2Problem = V2ProblemClient(config: config)
        self.v2V3Problem = V2V3ProblemClient(config: config)
