...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw InferredAuthImplicitNoExpiryError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw InferredAuthImplicitNoExpiryError.decodingError(error)
        }
    }
    ...
    private static func validateHTTPS(url: Foundation.URL) throws {
        ...
        throw InferredAuthImplicitNoExpiryError.networkError(
            NSError(
                domain: "HTTPClient",
                code: -1,
                userInfo: [
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: InferredAuthImplicitNoExpiryError?
                ...
                } else if let existingClientError = error as? InferredAuthImplicitNoExpiryError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw InferredAuthImplicitNoExpiryError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> InferredAuthImplicitNoExpiryError
    {
        ...
        return InferredAuthImplicitNoExpiryError.httpError(httpError)
    }
}
