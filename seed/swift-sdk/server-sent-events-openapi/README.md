...
```swift
dependencies: [
    .package(url: "https://github.com/server-sent-events-openapi/fern", from: "0.0.1"),
]
```
...
do {
    let response = try await client.streamProtocolNoCollision(...)
...
```swift
try await client.streamProtocolNoCollision(..., requestOptions: .init(
    additionalHeaders: [
