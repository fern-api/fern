...
public enum StreamProtocolCollisionResponse: Codable, Hashable, Sendable {
    case heartbeat(ProtocolHeartbeat)
    case numberData(ProtocolNumberEvent)
    case objectData(ProtocolCollisionObjectEvent)
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "object_data":
            self = .objectData(try ProtocolCollisionObjectEvent(from: decoder))
        case "string_data":
