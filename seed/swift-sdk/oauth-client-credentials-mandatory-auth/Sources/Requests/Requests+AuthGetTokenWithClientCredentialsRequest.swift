...
extension Requests {
    public struct AuthGetTokenWithClientCredentialsRequest: Codable, Hashable, Sendable {
        public let clientId: String
        public let clientSecret: String
        public let audience: AuthGetTokenWithClientCredentialsRequestAudience
        public let grantType: AuthGetTokenWithClientCredentialsRequestGrantType
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.audience = try container.decode(AuthGetTokenWithClientCredentialsRequestAudience.self, forKey: .audience)
            self.grantType = try container.decode(AuthGetTokenWithClientCredentialsRequestGrantType.self, forKey: .grantType)
