...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw OauthClientCredentialsMandatoryAuthError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw OauthClientCredentialsMandatoryAuthError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: OauthClientCredentialsMandatoryAuthError?
                ...
                } else if let existingClientError = error as? OauthClientCredentialsMandatoryAuthError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw OauthClientCredentialsMandatoryAuthError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> OauthClientCredentialsMandatoryAuthError
    {
        ...
        return OauthClientCredentialsMandatoryAuthError.httpError(httpError)
    }
}
