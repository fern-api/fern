...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw ContentTypesError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw ContentTypesError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: ContentTypesError?
                ...
                } else if let existingClientError = error as? ContentTypesError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw ContentTypesError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> ContentTypesError
    {
        ...
        return ContentTypesError.httpError(httpError)
    }
}
