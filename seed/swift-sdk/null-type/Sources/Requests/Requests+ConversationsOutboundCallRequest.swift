...
extension Requests {
    public struct ConversationsOutboundCallRequest: Codable, Hashable, Sendable {
        ...
        public let dryRun: Nullable<Bool>?
        /// Additional properties that are not explicitly defined in the schema
        public let additionalProperties: [String: JSONValue]

        public init(
            toPhoneNumber: String,
            dryRun: Nullable<Bool>? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.dryRun = try container.decodeNullableIfPresent(Bool.self, forKey: .dryRun)
        ...
        public func encode(to encoder: Encoder) throws -> Void {
            ...
            try container.encodeNullableIfPresent(self.dryRun, forKey: .dryRun)
        }
