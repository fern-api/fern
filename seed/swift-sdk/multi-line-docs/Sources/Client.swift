public final class MultiLineDocsClient: Sendable {
    ...
    public init(baseURL: String = MultiLineDocsEnvironment.default.rawValue, apiKey qpiKey: String, token: String? = nil, headers: [String: String]? = [:], timeout: Int? = nil, maxRetries: Int? = nil, urlSession: URLSession? = nil) {
