...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw MultiLineDocsError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw MultiLineDocsError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: MultiLineDocsError?
                ...
                } else if let existingClientError = error as? MultiLineDocsError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw MultiLineDocsError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> MultiLineDocsError
    {
        ...
        return MultiLineDocsError.httpError(httpError)
    }
}
