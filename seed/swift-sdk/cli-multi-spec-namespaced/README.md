...
```swift
dependencies: [
    .package(url: "https://github.com/cli-multi-spec-namespaced/fern", from: "0.0.1"),
]
```
...
do {
    let response = try await client.v1.listUsers(...)
...
```swift
try await client.v1.listUsers(..., requestOptions: .init(
    additionalHeaders: [
