...
@Suite("Client Retry Tests") struct ClientRetryTests {
    ...
    @Test func testEndpointLevelMaxRetriesOverride() async throws {
        ...
        do {
            _ = try await client.v1.listUsers(requestOptions: RequestOptions(maxRetries: 5, additionalHeaders: stub.headers))
    ...
    @Test func testEndpointLevelMaxRetriesZero() async throws {
        ...
        do {
            _ = try await client.v1.listUsers(requestOptions: RequestOptions(maxRetries: 0, additionalHeaders: stub.headers))
