...
extension Requests {
    public struct NullableOptionalGetSearchResultsRequest: Codable, Hashable, Sendable {
        public let query: String
        public let filters: Nullable<[String: Nullable<String>]>?
        ...
        public init(
            query: String,
            filters: Nullable<[String: Nullable<String>]>? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.filters = try container.decodeNullableIfPresent([String: Nullable<String>].self, forKey: .filters)
