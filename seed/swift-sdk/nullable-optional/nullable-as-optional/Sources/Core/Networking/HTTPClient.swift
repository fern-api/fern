...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw NullableOptionalError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw NullableOptionalError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: NullableOptionalError?
                ...
                } else if let existingClientError = error as? NullableOptionalError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw NullableOptionalError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> NullableOptionalError
    {
        ...
        return NullableOptionalError.httpError(httpError)
    }
}
