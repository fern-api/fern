...
public struct ComplexProfile: Codable, Hashable, Sendable {
    ...
    public let optionalArray: Nullable<[String]>?
    ...
    public let optionalMapOfEnums: Nullable<[String: Nullable<UserRole>]>?
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        id: String,
        nullableRole: UserRole,
        optionalRole: UserRole? = nil,
        optionalNullableRole: UserRole? = nil,
        nullableStatus: UserStatus,
        ...
        optionalArray: Nullable<[String]>? = nil,
        ...
        optionalMapOfEnums: Nullable<[String: Nullable<UserRole>]>? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.nullableRole = try container.decode(UserRole.self, forKey: .nullableRole)
        ...
        self.nullableStatus = try container.decode(UserStatus.self, forKey: .nullableStatus)
        ...
        self.nullableNotification = try container.decode(NotificationMethod.self, forKey: .nullableNotification)
        ...
        self.nullableSearchResult = try container.decode(SearchResult.self, forKey: .nullableSearchResult)
        ...
        self.optionalArray = try container.decodeNullableIfPresent([String].self, forKey: .optionalArray)
        ...
        self.optionalMapOfEnums = try container.decodeNullableIfPresent([String: Nullable<UserRole>].self, forKey: .optionalMapOfEnums)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encodeNullableIfPresent(self.optionalArray, forKey: .optionalArray)
        ...
        try container.encodeNullableIfPresent(self.optionalMapOfEnums, forKey: .optionalMapOfEnums)
    }
