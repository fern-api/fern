...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw CustomAuthError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw CustomAuthError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: CustomAuthError?
                ...
                } else if let existingClientError = error as? CustomAuthError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw CustomAuthError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> CustomAuthError
    {
        ...
        return CustomAuthError.httpError(httpError)
    }
}
