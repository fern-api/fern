...
@pytest.mark.parametrize(
    ...
    [
        ("seed.service.types.movie", "Movie"),
        ("seed.service.types.optional_with_docs", "OptionalWithDocs"),
        ("seed.service.types.response", "Response"),
        ("seed.service.types.with_docs", "WithDocs"),
        ("seed.types.optional_string_response", "OptionalStringResponse"),
        ("seed.types.string_response", "StringResponse"),
        ("seed.types.with_metadata", "WithMetadata"),
    ],
)
