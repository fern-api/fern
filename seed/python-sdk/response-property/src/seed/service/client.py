...
class ServiceClient:
    ...
    def get_movie(self, *, request: str, request_options: typing.Optional[RequestOptions] = None) -> Movie:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "movie", method="POST", json=request, request_options=request_options, omit=OMIT
        )
        try:
            if 200 <= _response.status_code < 300:
                _parsed_response = typing.cast(Response, parse_obj_as(type_=Response, object_=_response.json()))  # type: ignore
    ...
    def get_movie_name(self, *, request: str, request_options: typing.Optional[RequestOptions] = None) -> str:
        ...
        try:
            if 200 <= _response.status_code < 300:
                _parsed_response = typing.cast(StringResponse, parse_obj_as(type_=StringResponse, object_=_response.json()))  # type: ignore
    ...
    def get_optional_movie(
        ...
        try:
            if 200 <= _response.status_code < 300:
                _parsed_response = typing.cast(typing.Optional[Response], parse_obj_as(type_=typing.Optional[Response], object_=_response.json()))  # type: ignore
    ...
    def get_optional_movie_docs(self, *, request: str, request_options: typing.Optional[RequestOptions] = None) -> str:
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(OptionalWithDocs, parse_obj_as(type_=OptionalWithDocs, object_=_response.json()))  # type: ignore
            _response_json = _response.json()
        except JSONDecodeError:
            raise ApiError(status_code=_response.status_code, body=_response.text)
        raise ApiError(status_code=_response.status_code, body=_response_json)
    ...
    def get_optional_movie_name(self, *, request: str, request_options: typing.Optional[RequestOptions] = None) -> str:
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(OptionalStringResponse, parse_obj_as(type_=OptionalStringResponse, object_=_response.json()))  # type: ignore
            _response_json = _response.json()
        except JSONDecodeError:
            raise ApiError(status_code=_response.status_code, body=_response.text)
        raise ApiError(status_code=_response.status_code, body=_response_json)
