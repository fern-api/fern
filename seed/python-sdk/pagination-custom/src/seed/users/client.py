...
class UsersClient:
    ...
    def list_usernames_custom(self, *, starting_after: typing.Optional[str] = None, request_options: typing.Optional[RequestOptions] = None) -> SyncPager[str]:
        """
        Parameters
        ----------
...
class AsyncUsersClient:
    ...
    async def list_usernames_custom(self, *, starting_after: typing.Optional[str] = None, request_options: typing.Optional[RequestOptions] = None) -> AsyncPager[str]:
        """
        Parameters
        ----------
        starting_after : typing.Optional[str]
