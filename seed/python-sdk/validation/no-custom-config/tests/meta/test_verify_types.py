...
@pytest.mark.parametrize(
    ...
    [
        ("seed.types.double", "Double"),
        ("seed.types.large_integer", "LargeInteger"),
        ("seed.types.sentence", "Sentence"),
        ("seed.types.shape", "Shape"),
        ("seed.types.small_integer", "SmallInteger"),
        ("seed.types.type", "Type"),
        ("seed.types.word", "Word"),
    ],
)
