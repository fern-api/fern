...
class RawServiceClient:
    ...
    def get_resource(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/resources/{encode_path_parameter(resource_id)}",
            method="GET",
            params={
    ...
    def get_user_by_id(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/users/{encode_path_parameter(user_id)}",
            method="GET",
            params={
                "fields": fields,
    ...
    def get_connection(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/connections/{encode_path_parameter(connection_id)}",
            method="GET",
            params={
                "fields": fields,
            },
    ...
    def get_client(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/clients/{encode_path_parameter(client_id)}",
            method="GET",
            params={
                "fields": fields,
                "include_fields": include_fields,
