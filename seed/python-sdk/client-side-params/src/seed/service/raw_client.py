...
class RawServiceClient:
    ...
    def get_resource(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/resources/{urllib.parse.quote(str(jsonable_encoder(resource_id)), safe='')}",
            method="GET",
            params={
    ...
    def get_user_by_id(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/users/{urllib.parse.quote(str(jsonable_encoder(user_id)), safe='')}",
            method="GET",
            params={
                "fields": fields,
    ...
    def get_connection(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/connections/{urllib.parse.quote(str(jsonable_encoder(connection_id)), safe='')}",
            method="GET",
            params={
                "fields": fields,
            },
    ...
    def get_client(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/clients/{urllib.parse.quote(str(jsonable_encoder(client_id)), safe='')}",
            method="GET",
            params={
                "fields": fields,
                "include_fields": include_fields,
