...
@pytest.mark.parametrize(
    ...
    [
        ("seed.types.types.client", "Client"),
        ("seed.types.types.connection", "Connection"),
        ("seed.types.types.create_user_request", "CreateUserRequest"),
        ("seed.types.types.identity", "Identity"),
        ("seed.types.types.paginated_client_response", "PaginatedClientResponse"),
        ("seed.types.types.paginated_user_response", "PaginatedUserResponse"),
        ("seed.types.types.resource", "Resource"),
        ("seed.types.types.search_response", "SearchResponse"),
        ("seed.types.types.update_user_request", "UpdateUserRequest"),
        ("seed.types.types.user", "User"),
    ],
)
