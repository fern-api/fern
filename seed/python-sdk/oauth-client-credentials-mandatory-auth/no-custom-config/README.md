...
[![pypi](https://img.shields.io/pypi/v/fern_oauth-client-credentials-mandatory-auth)](https://pypi.python.org/pypi/fern_oauth-client-credentials-mandatory-auth)
...
```sh
pip install fern_oauth-client-credentials-mandatory-auth
```
