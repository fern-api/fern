...
class SeedApi:
    ...
    def repro(
        ...
        *,
        ...
        client.repro()
        """
        _response = self._raw_client.repro(
            id=id, other_field=other_field, unique_field=unique_field, request_options=request_options
        )
...
class AsyncSeedApi:
    ...
    async def repro(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.repro(
            id=id, other_field=other_field, unique_field=unique_field, request_options=request_options
        )
        return _response.data
