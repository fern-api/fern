...
[![pypi](https://img.shields.io/pypi/v/fern_payabliApi)](https://pypi.python.org/pypi/fern_payabliApi)
...
client = SeedApi(...)
response = client.bill.with_raw_response.add_bill(...)
...
```python
client.bill.add_bill(..., request_options={
    "max_retries": 1
})
```
