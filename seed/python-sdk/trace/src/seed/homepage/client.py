...
class HomepageClient:
    ...
    def get_homepage_problems(
        ...
        _response = self._client_wrapper.httpx_client.request(
            "homepage-problems", method="GET", request_options=request_options
        )
        try:
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(typing.List[ProblemId], parse_obj_as(type_=typing.List[ProblemId], object_=_response_json))  # type: ignore
    ...
    def set_homepage_problems(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "homepage-problems", method="POST", json=request, request_options=request_options, omit=OMIT
        )
        if 200 <= _response.status_code < 300:
            return
        try:
