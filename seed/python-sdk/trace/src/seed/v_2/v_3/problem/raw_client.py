...
class RawProblemClient:
    ...
    def get_latest_problem(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"problems-v2/problem-info/{urllib.parse.quote(str(jsonable_encoder(problem_id)), safe='')}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_problem_version(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"problems-v2/problem-info/{urllib.parse.quote(str(jsonable_encoder(problem_id)), safe='')}/version/{urllib.parse.quote(str(jsonable_encoder(problem_version)), safe='')}",
            method="GET",
            request_options=request_options,
        )
        try:
