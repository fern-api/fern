...
class KeyValuePair(UniversalBaseModel):
    key: "commons_types_variable_value_VariableValue"
    value: "commons_types_variable_value_VariableValue"
...
class MapValue(UniversalBaseModel):
    key_value_pairs: typing_extensions.Annotated[
        typing.List["commons_types_key_value_pair_KeyValuePair"], FieldMetadata(alias="keyValuePairs")
    ]
...
from .map_value import MapValue as commons_types_map_value_MapValue  # noqa: E402, F401, I001


class VariableValue_ListValue(UniversalBaseModel):
    value: typing.List["commons_types_variable_value_VariableValue"]
...
from .variable_value import VariableValue as commons_types_variable_value_VariableValue  # noqa: E402, F401, I001
from .key_value_pair import KeyValuePair as commons_types_key_value_pair_KeyValuePair  # noqa: E402, F401, I001
