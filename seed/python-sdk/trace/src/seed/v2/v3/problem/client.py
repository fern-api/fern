...
class AsyncProblemClient:
    ...
    async def get_lightweight_problems(
        ...
        async def main() -> None:
            await client.v2.v3.problem.get_lightweight_problems()
    ...
    async def get_problems(
        ...
        async def main() -> None:
            await client.v2.v3.problem.get_problems()
    ...
    async def get_latest_problem(
        ...
        async def main() -> None:
            await client.v2.v3.problem.get_latest_problem(
                problem_id="problemId",
            )
    ...
    async def get_problem_version(
        ...
        async def main() -> None:
            await client.v2.v3.problem.get_problem_version(
                problem_id="problemId",
                problem_version=1,
            )
