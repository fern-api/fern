...
if typing.TYPE_CHECKING:
    ...
    from .v3.client import AsyncV3Client, V3Client
...
class V2Client:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        ...
        self._v3: typing.Optional[V3Client] = None
    ...
    def v3(self):
        if self._v3 is None:
            from .v3.client import V3Client  # noqa: E402

            self._v3 = V3Client(client_wrapper=self._client_wrapper)
        return self._v3
...
class AsyncV2Client:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        ...
        self._v3: typing.Optional[AsyncV3Client] = None
    ...
    def v3(self):
        if self._v3 is None:
            from .v3.client import AsyncV3Client  # noqa: E402

            self._v3 = AsyncV3Client(client_wrapper=self._client_wrapper)
        return self._v3
