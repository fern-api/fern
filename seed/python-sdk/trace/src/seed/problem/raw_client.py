...
class RawProblemClient:
    ...
    def update_problem(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"problem-crud/update/{urllib.parse.quote(str(jsonable_encoder(problem_id)), safe='')}",
            method="POST",
            json={
                "problemName": problem_name,
                "problemDescription": convert_and_respect_annotation_metadata(
    ...
    def delete_problem(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"problem-crud/delete/{urllib.parse.quote(str(jsonable_encoder(problem_id)), safe='')}",
            method="DELETE",
            request_options=request_options,
        )
        if 200 <= _response.status_code < 300:
