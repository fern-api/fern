...
update_forward_refs(MapValue, ProblemInfo=ProblemInfo)
update_forward_refs(ListType, ProblemInfo=ProblemInfo)
update_forward_refs(MapType, ProblemInfo=ProblemInfo)
