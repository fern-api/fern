...
class ProblemClient:
    ...
    def create_problem(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(CreateProblemResponse, parse_obj_as(type_=CreateProblemResponse, object_=_response_json))  # type: ignore
    ...
    def update_problem(
        ...
        *,
        ...
        try:
            ...
            raise ApiError(status_code=_response.status_code, body=_response.text)
        if 200 <= _response.status_code < 300:
            return typing.cast(UpdateProblemResponse, parse_obj_as(type_=UpdateProblemResponse, object_=_response_json))  # type: ignore
        raise ApiError(status_code=_response.status_code, body=_response_json)
    ...
    def delete_problem(self, problem_id: ProblemId, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"problem-crud/delete/{jsonable_encoder(problem_id)}", method="DELETE", request_options=request_options
        )
        if 200 <= _response.status_code < 300:
            return
        try:
    ...
    def get_default_starter_files(
        ...
        *,
        ...
        try:
            ...
            raise ApiError(status_code=_response.status_code, body=_response.text)
        if 200 <= _response.status_code < 300:
            return typing.cast(GetDefaultStarterFilesResponse, parse_obj_as(type_=GetDefaultStarterFilesResponse, object_=_response_json))  # type: ignore
        raise ApiError(status_code=_response.status_code, body=_response_json)
