...
class RawPlaylistClient:
    ...
    def create_playlist(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v2/playlist/{encode_path_parameter(service_param)}/create",
            method="POST",
            params={
    ...
    def get_playlists(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/playlist/{encode_path_parameter(service_param)}/all",
            method="GET",
            params={
                "limit": limit,
    ...
    def get_playlist(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/playlist/{encode_path_parameter(service_param)}/{encode_path_parameter(playlist_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
