...
class SubmissionClient:
    ...
    def create_execution_session(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"sessions/create-session/{jsonable_encoder(language)}", method="POST", request_options=request_options
        )
        try:
        ...
        if 200 <= _response.status_code < 300:
            return typing.cast(ExecutionSessionResponse, parse_obj_as(type_=ExecutionSessionResponse, object_=_response_json))  # type: ignore
    ...
    def get_execution_session(
        ...
        try:
            ...
            raise ApiError(status_code=_response.status_code, body=_response.text)
        if 200 <= _response.status_code < 300:
            return typing.cast(typing.Optional[ExecutionSessionResponse], parse_obj_as(type_=typing.Optional[ExecutionSessionResponse], object_=_response_json))  # type: ignore
        raise ApiError(status_code=_response.status_code, body=_response_json)
    ...
    def stop_execution_session(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sessions/stop/{jsonable_encoder(session_id)}", method="DELETE", request_options=request_options
        )
        if 200 <= _response.status_code < 300:
            return
        try:
    ...
    def get_execution_sessions_state(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "sessions/execution-sessions-state", method="GET", request_options=request_options
        )
        try:
            _response_json = _response.json()
        except JSONDecodeError:
            raise ApiError(status_code=_response.status_code, body=_response.text)
        if 200 <= _response.status_code < 300:
            return typing.cast(GetExecutionSessionStateResponse, parse_obj_as(type_=GetExecutionSessionStateResponse, object_=_response_json))  # type: ignore
        raise ApiError(status_code=_response.status_code, body=_response_json)
