...
update_forward_refs(SubmissionStatusForTestCase_Graded, KeyValuePair=KeyValuePair, MapValue=MapValue)
update_forward_refs(SubmissionStatusForTestCase_Traced, KeyValuePair=KeyValuePair, MapValue=MapValue)
