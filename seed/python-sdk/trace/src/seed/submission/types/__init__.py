...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "ActualResult_Exception": ".actual_result",
    "ActualResult_ExceptionV2": ".actual_result",
    "ActualResult_Value": ".actual_result",
    "BuildingExecutorResponse": ".building_executor_response",
    "CodeExecutionUpdate": ".code_execution_update",
    "CodeExecutionUpdate_BuildingExecutor": ".code_execution_update",
    "CodeExecutionUpdate_Errored": ".code_execution_update",
    "CodeExecutionUpdate_Finished": ".code_execution_update",
    "CodeExecutionUpdate_Graded": ".code_execution_update",
    "CodeExecutionUpdate_GradedV2": ".code_execution_update",
    "CodeExecutionUpdate_InvalidRequest": ".code_execution_update",
    "CodeExecutionUpdate_Recorded": ".code_execution_update",
    "CodeExecutionUpdate_Recording": ".code_execution_update",
    "CodeExecutionUpdate_Running": ".code_execution_update",
    "CodeExecutionUpdate_Stopped": ".code_execution_update",
    "CodeExecutionUpdate_WorkspaceRan": ".code_execution_update",
    "CompileError": ".compile_error",
    "CustomTestCasesUnsupported": ".custom_test_cases_unsupported",
    "ErrorInfo": ".error_info",
    "ErrorInfo_CompileError": ".error_info",
    "ErrorInfo_InternalError": ".error_info",
    ...
    "InvalidRequestCause_CustomTestCasesUnsupported": ".invalid_request_cause",
    "InvalidRequestCause_SubmissionIdNotFound": ".invalid_request_cause",
    "InvalidRequestCause_UnexpectedLanguage": ".invalid_request_cause",
    ...
    "SubmissionRequest_InitializeProblemRequest": ".submission_request",
    "SubmissionRequest_InitializeWorkspaceRequest": ".submission_request",
    "SubmissionRequest_Stop": ".submission_request",
    "SubmissionRequest_SubmitV2": ".submission_request",
    "SubmissionRequest_WorkspaceSubmit": ".submission_request",
    "SubmissionResponse": ".submission_response",
    "SubmissionResponse_CodeExecutionUpdate": ".submission_response",
    "SubmissionResponse_ProblemInitialized": ".submission_response",
    "SubmissionResponse_ServerErrored": ".submission_response",
    "SubmissionResponse_ServerInitialized": ".submission_response",
    "SubmissionResponse_Terminated": ".submission_response",
    "SubmissionResponse_WorkspaceInitialized": ".submission_response",
    ...
    "TestCaseGrade_NonHidden": ".test_case_grade",
    ...
    "TestSubmissionUpdateInfo_Errored": ".test_submission_update_info",
    "TestSubmissionUpdateInfo_Finished": ".test_submission_update_info",
    "TestSubmissionUpdateInfo_GradedTestCase": ".test_submission_update_info",
    "TestSubmissionUpdateInfo_RecordedTestCase": ".test_submission_update_info",
    ...
    "WorkspaceSubmissionStatus_Stopped": ".workspace_submission_status",
    "WorkspaceSubmissionStatus_Traced": ".workspace_submission_status",
    "WorkspaceSubmissionUpdate": ".workspace_submission_update",
    "WorkspaceSubmissionUpdateInfo": ".workspace_submission_update_info",
    "WorkspaceSubmissionUpdateInfo_Errored": ".workspace_submission_update_info",
    "WorkspaceSubmissionUpdateInfo_Finished": ".workspace_submission_update_info",
    "WorkspaceSubmissionUpdateInfo_Ran": ".workspace_submission_update_info",
    "WorkspaceSubmissionUpdateInfo_Running": ".workspace_submission_update_info",
    "WorkspaceSubmissionUpdateInfo_Stopped": ".workspace_submission_update_info",
    "WorkspaceSubmissionUpdateInfo_Traced": ".workspace_submission_update_info",
    "WorkspaceSubmissionUpdateInfo_TracedV2": ".workspace_submission_update_info",
