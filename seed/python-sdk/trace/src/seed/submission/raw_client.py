...
class RawSubmissionClient:
    ...
    def create_execution_session(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"sessions/create-session/{urllib.parse.quote(str(jsonable_encoder(language)), safe='')}",
            method="POST",
    ...
    def get_execution_session(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sessions/{urllib.parse.quote(str(jsonable_encoder(session_id)), safe='')}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def stop_execution_session(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"sessions/stop/{urllib.parse.quote(str(jsonable_encoder(session_id)), safe='')}",
            method="DELETE",
            request_options=request_options,
        )
        if 200 <= _response.status_code < 300:
