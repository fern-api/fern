...
class RawAdminClient:
    ...
    def update_test_submission_status(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"admin/store-test-submission-status/{encode_path_parameter(submission_id)}",
            method="POST",
    ...
    def send_test_submission_update(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"admin/store-test-submission-status-v2/{encode_path_parameter(submission_id)}",
            method="POST",
            json={
    ...
    def update_workspace_submission_status(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"admin/store-workspace-submission-status/{encode_path_parameter(submission_id)}",
            method="POST",
            json=convert_and_respect_annotation_metadata(
    ...
    def send_workspace_submission_update(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"admin/store-workspace-submission-status-v2/{encode_path_parameter(submission_id)}",
            method="POST",
            json={
                "updateTime": update_time,
                "updateInfo": convert_and_respect_annotation_metadata(
    ...
    def store_traced_test_case(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"admin/store-test-trace/submission/{encode_path_parameter(submission_id)}/testCase/{encode_path_parameter(test_case_id)}",
            method="POST",
            json={
    ...
    def store_traced_test_case_v_2(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"admin/store-test-trace-v2/submission/{encode_path_parameter(submission_id)}/testCase/{encode_path_parameter(test_case_id)}",
            method="POST",
            json=convert_and_respect_annotation_metadata(
    ...
    def store_traced_workspace(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"admin/store-workspace-trace/submission/{encode_path_parameter(submission_id)}",
            method="POST",
            json={
    ...
    def store_traced_workspace_v_2(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"admin/store-workspace-trace-v2/submission/{encode_path_parameter(submission_id)}",
            method="POST",
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=typing.Sequence[TraceResponseV2], direction="write"
            ),
