...
class WorkspaceSubmissionStatus_Traced(WorkspaceRunDetails):
    ...
    class Config:
        ...
        allow_population_by_field_name = True
        populate_by_name = True
WorkspaceSubmissionStatus = typing.Union[WorkspaceSubmissionStatus_Stopped, WorkspaceSubmissionStatus_Errored, WorkspaceSubmissionStatus_Running, WorkspaceSubmissionStatus_Ran, WorkspaceSubmissionStatus_Traced]
