...
async def test_get_latest_problem(
    ...
    async_response = await async_client.v_2.v_3.problem.get_latest_problem(
        problem_id="string"
    )
    validate_response(async_response, expected_response, expected_types)
...
async def test_get_problem_version(
    ...
    response = client.v_2.v_3.problem.get_problem_version(
        problem_id="string", problem_version=1
    )
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.v_2.v_3.problem.get_problem_version(
        problem_id="string", problem_version=1
    )
    validate_response(async_response, expected_response, expected_types)
