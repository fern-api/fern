...
def client() -> SeedTrace:
    return SeedTrace(x_random_header=os.getenv("ENV_X_RANDOM_HEADER", "x_random_header")
    , token=os.getenv("ENV_TOKEN", "token")
    , base_url=os.getenv("TESTS_BASE_URL", "base_url")
    )
@pytest.fixture
def async_client() -> AsyncSeedTrace:
    return AsyncSeedTrace(x_random_header=os.getenv("ENV_X_RANDOM_HEADER", "x_random_header")
    , token=os.getenv("ENV_TOKEN", "token")
    , base_url=os.getenv("TESTS_BASE_URL", "base_url")
    )
