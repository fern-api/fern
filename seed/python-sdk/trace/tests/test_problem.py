...
async def test_update_problem(client: SeedTrace, async_client: AsyncSeedTrace) -> None:
    expected_response = {}
    response = client.problem.update_problem(problem_id="string", request=CreateProblemRequest(problem_name="string", problem_description=ProblemDescription(boards=[ProblemDescriptionBoard_Html(type="html", value="string")]), files={Language.JAVA: ProblemFiles(solution_file=FileInfo(filename="string", contents="string"), read_only_files=[FileInfo(filename="string", contents="string")])}, input_params=[VariableTypeAndName(variable_type=VariableType(), name="string")], output_type=VariableType(), testcases=[TestCaseWithExpectedResult(test_case=TestCase(id="string", params=[VariableValue_IntegerValue(type="integerValue", value=1)]), expected_result=VariableValue_IntegerValue(type="integerValue", value=1))], method_name="string"))
    validate_response(response, expected_response)
    
    async_response = await async_client.problem.update_problem(problem_id="string", request=CreateProblemRequest(problem_name="string", problem_description=ProblemDescription(boards=[ProblemDescriptionBoard_Html(type="html", value="string")]), files={Language.JAVA: ProblemFiles(solution_file=FileInfo(filename="string", contents="string"), read_only_files=[FileInfo(filename="string", contents="string")])}, input_params=[VariableTypeAndName(variable_type=VariableType(), name="string")], output_type=VariableType(), testcases=[TestCaseWithExpectedResult(test_case=TestCase(id="string", params=[VariableValue_IntegerValue(type="integerValue", value=1)]), expected_result=VariableValue_IntegerValue(type="integerValue", value=1))], method_name="string"))
    validate_response(async_response, expected_response)
...
async def test_get_default_starter_files(client: SeedTrace, async_client: AsyncSeedTrace) -> None:
    expected_response = {}
    response = client.problem.get_default_starter_files(input_params=[VariableTypeAndName(variable_type=VariableType(), name="string")], output_type=VariableType(), method_name="string")
    validate_response(response, expected_response)
    
    async_response = await async_client.problem.get_default_starter_files(input_params=[VariableTypeAndName(variable_type=VariableType(), name="string")], output_type=VariableType(), method_name="string")
    validate_response(async_response, expected_response)
