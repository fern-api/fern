...
async def test_update_test_submission_status(
...
async def test_send_test_submission_update(
    client: SeedTrace, async_client: AsyncSeedTrace
) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert (
...
async def test_update_workspace_submission_status(
    client: SeedTrace, async_client: AsyncSeedTrace
) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert (
...
async def test_send_workspace_submission_update(
    client: SeedTrace, async_client: AsyncSeedTrace
) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert (
...
async def test_store_traced_test_case(
    client: SeedTrace, async_client: AsyncSeedTrace
) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert (
...
async def test_store_traced_test_case_v_2(
    client: SeedTrace, async_client: AsyncSeedTrace
) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert (
...
async def test_store_traced_workspace(
    client: SeedTrace, async_client: AsyncSeedTrace
) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert (
...
async def test_store_traced_workspace_v_2(
    client: SeedTrace, async_client: AsyncSeedTrace
) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert (
