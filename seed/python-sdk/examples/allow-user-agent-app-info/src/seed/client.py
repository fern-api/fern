...
class SeedExamples:
    ...
    app_info : typing.Optional[typing.Dict[str, str]]
        Application identification appended to the User-Agent header as a product token, e.g. `{"name": "partner-app", "version": "3.1.0", "comment": "+https://partner.example"}`. `name` is required; `version` and `comment` are optional.
