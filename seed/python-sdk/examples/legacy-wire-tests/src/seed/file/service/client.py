...
class ServiceClient:
    ...
    def get_file(self, filename: str, *, x_file_api_version: str, request_options: typing.Optional[RequestOptions] = None) -> File:
        ...
        """
        _response = self._raw_client.get_file(filename, x_file_api_version=x_file_api_version, request_options=request_options)
...
class AsyncServiceClient:
    ...
    async def get_file(self, filename: str, *, x_file_api_version: str, request_options: typing.Optional[RequestOptions] = None) -> File:
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_file(filename, x_file_api_version=x_file_api_version, request_options=request_options)
        return _response.data
