...
[![pypi](https://img.shields.io/pypi/v/fern_python-positional-single-property)](https://pypi.python.org/pypi/fern_python-positional-single-property)
...
```sh
pip install fern_python-positional-single-property
```
