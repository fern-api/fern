...
@pytest.mark.parametrize(
    ...
    [
        ("seed.optional.types.deploy_params", "DeployParams"),
        ("seed.optional.types.deploy_response", "DeployResponse"),
        ("seed.optional.types.send_optional_body_request", "SendOptionalBodyRequest"),
    ],
)
