...
class OptionalClient:
    ...
    def send_optional_body(self, *, request: typing.Optional[typing.Dict[str, typing.Optional[typing.Any]]] = None, request_options: typing.Optional[RequestOptions] = None) -> str:
        """
        Parameters
        ----------
...
class AsyncOptionalClient:
    ...
    async def send_optional_body(self, *, request: typing.Optional[typing.Dict[str, typing.Optional[typing.Any]]] = None, request_options: typing.Optional[RequestOptions] = None) -> str:
        """
        Parameters
        ----------
        request : typing.Optional[typing.Dict[str, typing.Optional[typing.Any]]]
