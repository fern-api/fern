...
from .optional.client import OptionalClient
from .core.client_wrapper import AsyncClientWrapper
from .optional.client import AsyncOptionalClient
class SeedObjectsWithImports:
    """
    ...
    """
    def __init__(self, *, base_url: str, headers: typing.Optional[typing.Dict[str, str]] = None, timeout: typing.Optional[float] = None, follow_redirects: typing.Optional[bool] = True, httpx_client: typing.Optional[httpx.Client] = None):
        ...
        self.optional = OptionalClient(client_wrapper=self._client_wrapper)
class AsyncSeedObjectsWithImports:
    """
    Use this class to access the different functions within the SDK. You can instantiate any number of clients with different configuration that will propagate to these functions.
    ...
    """
    def __init__(self, *, base_url: str, headers: typing.Optional[typing.Dict[str, str]] = None, timeout: typing.Optional[float] = None, follow_redirects: typing.Optional[bool] = True, httpx_client: typing.Optional[httpx.AsyncClient] = None):
        _defaulted_timeout = timeout if timeout is not None else 60 if httpx_client is None else httpx_client.timeout.read
        ...
        , timeout=_defaulted_timeout)
        self.optional = AsyncOptionalClient(client_wrapper=self._client_wrapper)
