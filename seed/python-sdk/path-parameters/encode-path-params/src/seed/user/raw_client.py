...
class RawUserClient:
    ...
    def get_user(self, user_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[User]:
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"{quote_path_param(self._client_wrapper._tenant_id)}/user/{quote_path_param(user_id)}",
            method="GET",
    ...
    def create_user(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"{quote_path_param(self._client_wrapper._tenant_id)}/user/",
            method="POST",
            json={
                "name": name,
                "tags": tags,
    ...
    def search_users(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"{quote_path_param(self._client_wrapper._tenant_id)}/user/{quote_path_param(user_id)}/search",
            method="GET",
            params={
                "limit": limit,
            },
    ...
    def get_user_metadata(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"{quote_path_param(self._client_wrapper._tenant_id)}/user/{quote_path_param(user_id)}/metadata/v{quote_path_param(version)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_user_specifics(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"{quote_path_param(self._client_wrapper._tenant_id)}/user/{quote_path_param(user_id)}/specifics/{quote_path_param(version)}/{quote_path_param(thought)}",
            method="GET",
            request_options=request_options,
        )
        try:
