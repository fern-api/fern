...
class RawOrganizationsClient:
    ...
    def get_organization(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"{urllib.parse.quote(str(jsonable_encoder(tenant_id)), safe='')}/organizations/{urllib.parse.quote(str(jsonable_encoder(organization_id)), safe='')}/",
            method="GET",
    ...
    def get_organization_user(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"{urllib.parse.quote(str(jsonable_encoder(tenant_id)), safe='')}/organizations/{urllib.parse.quote(str(jsonable_encoder(organization_id)), safe='')}/users/{urllib.parse.quote(str(jsonable_encoder(user_id)), safe='')}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def search_organizations(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"{urllib.parse.quote(str(jsonable_encoder(tenant_id)), safe='')}/organizations/{urllib.parse.quote(str(jsonable_encoder(organization_id)), safe='')}/search",
            method="GET",
            params={
                "limit": limit,
            },
