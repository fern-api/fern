...
class OAuthTokenProvider:
    ...
    def __init__(
        self, *, client_id: str, client_secret: str, scopes: str, tenant: str, client_wrapper: SyncClientWrapper
    ):
...
class AsyncOAuthTokenProvider:
    ...
    def __init__(
        self, *, client_id: str, client_secret: str, scopes: str, tenant: str, client_wrapper: AsyncClientWrapper
    ):
        self._client_id = client_id
        self._client_secret = client_secret
        self._scopes = scopes
