...
@pytest.mark.parametrize(
    ...
    [
        ("seed.service.types.nested_user", "NestedUser"),
        ("seed.service.types.organization", "Organization"),
        ("seed.service.types.resource", "Resource"),
        ("seed.service.types.resource_status", "ResourceStatus"),
        ("seed.service.types.user", "User"),
    ],
)
