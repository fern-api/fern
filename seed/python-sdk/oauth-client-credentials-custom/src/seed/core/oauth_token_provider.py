...
class OAuthTokenProvider:
    ...
    def __init__(
        self, *, client_id: str, client_secret: str, scp: str, entity_id: str, client_wrapper: SyncClientWrapper
    ):
    ...
    def _refresh(self) -> str:
        token_response = self._auth_client.get_token_with_client_credentials(
            cid=self._client_id, csr=self._client_secret, scp=self._scp, entity_id=self._entity_id
        )
...
class AsyncOAuthTokenProvider:
    ...
    def __init__(
        self, *, client_id: str, client_secret: str, scp: str, entity_id: str, client_wrapper: AsyncClientWrapper
    ):
        self._client_id = client_id
        self._client_secret = client_secret
        self._scp = scp
