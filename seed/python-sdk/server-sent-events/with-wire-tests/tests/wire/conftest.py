...
from seed.client import SeedServerSentEventsWithWireTests

# Check once at import time whether the client constructor accepts a headers kwarg.
try:
    _CLIENT_SUPPORTS_HEADERS: bool = "headers" in inspect.signature(SeedServerSentEventsWithWireTests).parameters
...
def get_client(test_id: str) -> SeedServerSentEventsWithWireTests:
    """
    ...
    if _CLIENT_SUPPORTS_HEADERS:
        return SeedServerSentEventsWithWireTests(
            base_url=base_url,
