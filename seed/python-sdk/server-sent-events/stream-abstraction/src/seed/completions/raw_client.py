...
class RawCompletionsClient:
    ...
    def stream(
    ...
    ) -> typing.Iterator[HttpResponse[Stream[StreamedCompletion]]]:
        """
        Parameters
        ----------
        query : str
        ...
        with self._client_wrapper.httpx_client.stream(
            ...
            def _stream() -> HttpResponse[Stream[StreamedCompletion]]:
                try:
                    if 200 <= _response.status_code < 300:

                        def _iter() -> typing.Generator[StreamEvent[StreamedCompletion], None, None]:
...
class AsyncRawCompletionsClient:
    ...
    async def stream(
        self, *, query: str, request_options: typing.Optional[RequestOptions] = None
    ) -> typing.AsyncIterator[AsyncHttpResponse[AsyncStream[StreamedCompletion]]]:
        """
        Parameters
        ----------
        query : str
        ...
        async with self._client_wrapper.httpx_client.stream(
            ...
            async def _stream() -> AsyncHttpResponse[AsyncStream[StreamedCompletion]]:
                try:
                    if 200 <= _response.status_code < 300:

                        async def _iter() -> typing.AsyncGenerator[StreamEvent[StreamedCompletion], None]:
                            _event_source = EventSource(_response)
