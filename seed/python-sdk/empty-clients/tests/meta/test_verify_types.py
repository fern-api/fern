...
@pytest.mark.parametrize(
    ...
    [
        ("seed.level_1.level_2.types.types.address", "Address"),
        ("seed.level_1.level_2.types.types.person", "Person"),
        ("seed.level_1.types.types.address", "Address"),
        ("seed.level_1.types.types.person", "Person"),
    ],
)
