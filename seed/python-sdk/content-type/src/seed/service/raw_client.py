...
class RawServiceClient:
    ...
    def patch_complex(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"complex/{urllib.parse.quote(str(jsonable_encoder(id)), safe='')}",
            method="PATCH",
            json={
                "name": name,
                "age": age,
    ...
    def named_patch_with_mixed(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"named-mixed/{urllib.parse.quote(str(jsonable_encoder(id)), safe='')}",
            method="PATCH",
            json={
                "appId": app_id,
    ...
    def regular_patch(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"regular/{urllib.parse.quote(str(jsonable_encoder(id)), safe='')}",
            method="PATCH",
            json={
                "field1": field_1,
                "field2": field_2,
