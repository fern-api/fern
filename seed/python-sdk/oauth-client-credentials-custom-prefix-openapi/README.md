...
[![pypi](https://img.shields.io/pypi/v/fern_oauth-client-credentials-custom-prefix-openapi)](https://pypi.python.org/pypi/fern_oauth-client-credentials-custom-prefix-openapi)
...
```sh
pip install fern_oauth-client-credentials-custom-prefix-openapi
```
...
client = SeedApi(...)
response = client.identity.with_raw_response.get_token(...)
...
```python
client.identity.get_token(..., request_options={
    "max_retries": 1
})
```
