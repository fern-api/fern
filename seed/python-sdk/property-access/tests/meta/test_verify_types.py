...
@pytest.mark.parametrize(
    ...
    [
        ("seed.types.admin", "Admin"),
        ("seed.types.foo", "Foo"),
        ("seed.types.user", "User"),
        ("seed.types.user_or_admin", "UserOrAdmin"),
        ("seed.types.user_or_admin_discriminated", "UserOrAdminDiscriminated"),
        ("seed.types.user_profile", "UserProfile"),
        ("seed.types.user_profile_verification", "UserProfileVerification"),
    ],
)
