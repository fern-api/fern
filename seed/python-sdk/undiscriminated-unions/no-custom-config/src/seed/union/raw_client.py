...
from .types.subscribed_event import SubscribedEvent
...
class RawUnionClient:
    ...
    def subscribe(
        self, *, events: typing.Sequence[SubscribedEvent], request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[bool]:
        """
        Parameters
        ----------
        events : typing.Sequence[SubscribedEvent]
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "events": convert_and_respect_annotation_metadata(
                    object_=events, annotation=typing.Sequence[SubscribedEvent], direction="write"
                ),
            },
            request_options=request_options,
            omit=OMIT,
