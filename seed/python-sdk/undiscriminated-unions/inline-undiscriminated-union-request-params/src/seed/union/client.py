...
class UnionClient:
    ...
    def subscribe(
        self,
        *,
        events: typing.Sequence[typing.Literal["batch.succeeded", "batch.failed", "document.processed", "system"]],
        ...
        client.union.subscribe(
            events=["batch.succeeded", "batch.succeeded"],
        )
        """
        _response = self._raw_client.subscribe(events=events, request_options=request_options)
        return _response.data
...
class AsyncUnionClient:
    ...
    async def subscribe(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.subscribe(events=events, request_options=request_options)
        return _response.data
