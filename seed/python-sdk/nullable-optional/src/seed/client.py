...
class SeedNullableOptional:
    ...
    def __init__(
        ...
        *,
        ...
        self.nullable_optional = NullableOptionalClient(client_wrapper=self._client_wrapper)
...
class AsyncSeedNullableOptional:
    ...
    def __init__(
        ...
        *,
        ...
        self.nullable_optional = AsyncNullableOptionalClient(client_wrapper=self._client_wrapper)
