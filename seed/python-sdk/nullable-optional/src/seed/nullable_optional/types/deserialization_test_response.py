...
class DeserializationTestResponse(UniversalBaseModel):
    ...
    processed_at: typing_extensions.Annotated[
        dt.datetime, FieldMetadata(alias="processedAt"), pydantic.Field(alias="processedAt")
    ]
    null_count: typing_extensions.Annotated[int, FieldMetadata(alias="nullCount"), pydantic.Field(alias="nullCount")]
    present_fields_count: typing_extensions.Annotated[
        int, FieldMetadata(alias="presentFieldsCount"), pydantic.Field(alias="presentFieldsCount")
    ]
