...
class RawNullableOptionalClient:
    ...
    def get_complex_profile(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/profiles/complex/{encode_path_parameter(profile_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_notification_settings(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/users/{encode_path_parameter(user_id)}/notifications",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def update_tags(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/users/{encode_path_parameter(user_id)}/tags",
            method="PUT",
            json={
                "tags": tags,
