...
class RawNullableOptionalClient:
    ...
    def get_complex_profile(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/profiles/complex/{urllib.parse.quote(str(jsonable_encoder(profile_id)), safe='')}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_notification_settings(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/users/{urllib.parse.quote(str(jsonable_encoder(user_id)), safe='')}/notifications",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def update_tags(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/users/{urllib.parse.quote(str(jsonable_encoder(user_id)), safe='')}/tags",
            method="PUT",
            json={
                "tags": tags,
