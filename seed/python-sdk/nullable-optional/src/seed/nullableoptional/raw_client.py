...
class RawNullableoptionalClient:
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "nullableNotification": convert_and_respect_annotation_metadata(
                    object_=nullable_notification, annotation=NotificationMethod, direction="write"
                ),
                ...
                "optionalNullableNotification": convert_and_respect_annotation_metadata(
                    object_=optional_nullable_notification, annotation=NotificationMethod, direction="write"
                ),
                "nullableSearchResult": convert_and_respect_annotation_metadata(
                    object_=nullable_search_result, annotation=SearchResult, direction="write"
                ),
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "nullableUnion": convert_and_respect_annotation_metadata(
                    object_=nullable_union, annotation=NotificationMethod, direction="write"
                ),
                ...
                "nullableObject": convert_and_respect_annotation_metadata(
                    object_=nullable_object, annotation=Address, direction="write"
                ),
    ...
    def getnotificationsettings(
        self, user_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[NotificationMethod]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    NotificationMethod,
                    parse_obj_as(
                        type_=NotificationMethod,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawNullableoptionalClient:
    ...
    async def getnotificationsettings(
        self, user_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[NotificationMethod]:
        """
        Get notification settings which may be null
