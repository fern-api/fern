...
[![pypi](https://img.shields.io/pypi/v/fern_nullable-request-body)](https://pypi.python.org/pypi/fern_nullable-request-body)
...
```sh
pip install fern_nullable-request-body
```
