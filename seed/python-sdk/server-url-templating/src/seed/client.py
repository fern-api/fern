...
class SeedApi:
    ...
    region : str
        Server variable for URL templating. Used to construct the base URL. Allowed values: us-east-1, us-west-2, eu-west-1.

    environment : str
        Server variable for URL templating. Used to construct the base URL. Allowed values: prod, staging, dev.
    ...
    def __init__(
        ...
        *,
        ...
        self._client_wrapper = SyncClientWrapper(
            ...
            else "https://api.{region}.{environment}.example.com/v1".format(region=region, environment=environment),
            headers=headers,
