...
class OAuthTokenProvider:
    ...
    def __init__(self, *, client_id: str, client_secret: str, client_wrapper: SyncClientWrapper):
        ...
        self._auth_client = IdentityClient(client_wrapper=client_wrapper)
    ...
    def _refresh(self) -> str:
        token_response = self._auth_client.gettoken(client_id=self._client_id, client_secret=self._client_secret)
...
class AsyncOAuthTokenProvider:
    ...
    def __init__(self, *, client_id: str, client_secret: str, client_wrapper: AsyncClientWrapper):
        ...
        self._expires_at: dt.datetime = dt.datetime.now()
        self._refresh_token: typing.Optional[str] = None
        self._auth_client = AsyncIdentityClient(client_wrapper=client_wrapper)
    ...
    async def _refresh(self) -> str:
        token_response = await self._auth_client.gettoken(client_id=self._client_id, client_secret=self._client_secret)
        self._access_token = token_response.access_token
        if token_response.refresh_token is None:
            raise RuntimeError("Access token not present in OAuth response")
        self._refresh_token = token_response.refresh_token
