...
if typing.TYPE_CHECKING:
    ...
    from .plants.client import AsyncPlantsClient, PlantsClient
...
class SeedApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._plants: typing.Optional[PlantsClient] = None
    ...
    def plants(self):
        if self._plants is None:
            from .plants.client import PlantsClient  # noqa: E402

            self._plants = PlantsClient(client_wrapper=self._client_wrapper)
        return self._plants
...
class AsyncSeedApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._plants: typing.Optional[AsyncPlantsClient] = None
    ...
    def plants(self):
        if self._plants is None:
            from .plants.client import AsyncPlantsClient  # noqa: E402

            self._plants = AsyncPlantsClient(client_wrapper=self._client_wrapper)
        return self._plants
