...
[![pypi](https://img.shields.io/pypi/v/fern_oauth-client-credentials-openapi)](https://pypi.python.org/pypi/fern_oauth-client-credentials-openapi)
...
```sh
pip install fern_oauth-client-credentials-openapi
```
