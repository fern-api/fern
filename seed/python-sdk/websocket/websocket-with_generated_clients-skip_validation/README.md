...
[![pypi](https://img.shields.io/pypi/v/fern_websocket)](https://pypi.python.org/pypi/fern_websocket)
...
with client.empty_realtime.connect() as socket:
...
async with client.empty_realtime.connect() as socket:
...
```python
client.status.get_status(request_options={
    "max_retries": 1
})
```
...
client = SeedWebsocket(..., timeout=20.0)
