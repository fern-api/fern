...
@pytest.mark.parametrize(
    ...
    [
        ("seed.realtime.types.receive_event", "ReceiveEvent"),
        ("seed.realtime.types.receive_event_2", "ReceiveEvent2"),
        ("seed.realtime.types.receive_event_3", "ReceiveEvent3"),
        ("seed.realtime.types.receive_snake_case", "ReceiveSnakeCase"),
        ("seed.realtime.types.send_event", "SendEvent"),
        ("seed.realtime.types.send_event_2", "SendEvent2"),
        ("seed.realtime.types.send_snake_case", "SendSnakeCase"),
    ],
)
