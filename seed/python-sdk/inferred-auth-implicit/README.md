...
[![pypi](https://img.shields.io/pypi/v/fern_inferred-auth-implicit)](https://pypi.python.org/pypi/fern_inferred-auth-implicit)
...
```sh
pip install fern_inferred-auth-implicit
```
