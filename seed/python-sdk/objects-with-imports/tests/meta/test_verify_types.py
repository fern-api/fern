...
@pytest.mark.parametrize(
    ...
    [
        ("seed.commons.metadata.types.metadata", "Metadata"),
        ("seed.file.directory.types.directory", "Directory"),
        ("seed.file.types.file", "File"),
        ("seed.file.types.file_info", "FileInfo"),
        ("seed.types.node", "Node"),
        ("seed.types.tree", "Tree"),
    ],
)
