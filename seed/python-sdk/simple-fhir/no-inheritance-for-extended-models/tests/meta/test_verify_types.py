...
@pytest.mark.parametrize(
    ...
    [
        ("seed.types.account", "Account"),
        ("seed.types.base_resource", "BaseResource"),
        ("seed.types.memo", "Memo"),
        ("seed.types.patient", "Patient"),
        ("seed.types.practitioner", "Practitioner"),
        ("seed.types.resource_list", "ResourceList"),
        ("seed.types.script", "Script"),
    ],
)
