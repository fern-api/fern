...
@pytest.mark.parametrize(
    ...
    [
        ("seed.types.document_metadata", "DocumentMetadata"),
        ("seed.types.document_upload_result", "DocumentUploadResult"),
        ("seed.types.upload_document_response", "UploadDocumentResponse"),
    ],
)
