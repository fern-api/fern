...
class PaymentClient:
    ...
    def create(
        self, *, amount: int, currency: Currency, request_options: typing.Optional[RequestOptions] = None
    ) -> str:
        """
        Parameters
        ----------
        ...
        """
        _response = self._raw_client.create(amount=amount, currency=currency, request_options=request_options)
...
class AsyncPaymentClient:
    ...
    async def create(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.create(amount=amount, currency=currency, request_options=request_options)
        return _response.data
