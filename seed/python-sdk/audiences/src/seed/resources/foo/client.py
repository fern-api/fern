...
class FooClient:
    ...
    def find(self, *, optional_string: OptionalString, public_property: typing.Optional[str] = OMIT, private_property: typing.Optional[int] = OMIT, request_options: typing.Optional[RequestOptions] = None) -> ImportingType:
        """
        Parameters:
        ...
        client = SeedAudiences(base_url="https://yourhost.com/path/to/api", )
        client.foo.find(optional_string="string", public_property="string", private_property=1, )
        """
        ...
        _response = self._client_wrapper.httpx_client.request("POST", self._client_wrapper.get_base_url(), 
            params=jsonable_encoder(remove_none_from_dict({"optionalString": optional_string, **(request_options.get('additional_query_parameters', {}) if request_options is not None else {}),},
            )),
...
class AsyncFooClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper
    async def find(self, *, optional_string: OptionalString, public_property: typing.Optional[str] = OMIT, private_property: typing.Optional[int] = OMIT, request_options: typing.Optional[RequestOptions] = None) -> ImportingType:
        """
        Parameters:
            - optional_string: OptionalString.
        ...
        client = AsyncSeedAudiences(base_url="https://yourhost.com/path/to/api", )
        await client.foo.find(optional_string="string", public_property="string", private_property=1, )
        """
        _request: typing.Dict[str, typing.Any] = {}
        if public_property is not OMIT:
            _request["publicProperty"] = public_property
