...
@pytest.mark.parametrize(
    ...
    [
        ("seed.commons.types.imported", "Imported"),
        ("seed.folder_a.service.types.response", "Response"),
        ("seed.folder_b.common.types.foo", "Foo"),
        ("seed.folder_c.common.types.folder_c_foo", "FolderCFoo"),
        ("seed.folder_d.service.types.response", "Response"),
        ("seed.foo.types.filtered_type", "FilteredType"),
        ("seed.foo.types.importing_type", "ImportingType"),
        ("seed.foo.types.optional_string", "OptionalString"),
    ],
)
