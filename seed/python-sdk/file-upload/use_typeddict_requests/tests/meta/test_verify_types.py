...
@pytest.mark.parametrize(
    ...
    [
        ("seed.service.types.id", "Id"),
        ("seed.service.types.my_alias_object", "MyAliasObject"),
        ("seed.service.types.my_collection_alias_object", "MyCollectionAliasObject"),
        ("seed.service.types.my_inline_type", "MyInlineType"),
        ("seed.service.types.my_object", "MyObject"),
        ("seed.service.types.my_object_with_optional", "MyObjectWithOptional"),
        ("seed.service.types.object_type", "ObjectType"),
    ],
)
