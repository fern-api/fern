...
class RawServiceClient:
    ...
    def get(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.Iterator[HttpResponse[typing.Iterator[bytes]]]:
        """
        Parameters
        ----------
...
class AsyncRawServiceClient:
    ...
    async def get(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.AsyncIterator[AsyncHttpResponse[typing.AsyncIterator[bytes]]]:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
