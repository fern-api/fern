...
@pytest.mark.parametrize(
    ...
    [
        ("seed.types.my_union", "MyUnion"),
        ("seed.types.union_list_response", "UnionListResponse"),
        ("seed.types.union_response", "UnionResponse"),
        ("seed.types.variant_a", "VariantA"),
        ("seed.types.variant_b", "VariantB"),
        ("seed.types.variant_c", "VariantC"),
    ],
)
