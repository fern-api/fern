...
[![pypi](https://img.shields.io/pypi/v/fern_undiscriminated-union-with-response-property)](https://pypi.python.org/pypi/fern_undiscriminated-union-with-response-property)
...
```sh
pip install fern_undiscriminated-union-with-response-property
```
