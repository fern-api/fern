...
[![pypi](https://img.shields.io/pypi/v/fern_inferred-auth-explicit)](https://pypi.python.org/pypi/fern_inferred-auth-explicit)
...
```sh
pip install fern_inferred-auth-explicit
```
...
client = SeedInferredAuthExplicit(..., timeout=20.0)
