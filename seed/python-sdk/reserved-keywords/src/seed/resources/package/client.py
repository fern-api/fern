...
class PackageClient:
    ...
    def test(self, *, for_: str, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client.package.test(for_="string", )
        """
        _response = self._client_wrapper.httpx_client.request("POST", self._client_wrapper.get_base_url(), 
            params=jsonable_encoder(remove_none_from_dict({"for": for_, **(request_options.get('additional_query_parameters', {}) if request_options is not None else {}),},
            )),
...
class AsyncPackageClient:
    ...
    async def test(self, *, for_: str, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        await client.package.test(for_="string", )
        """
