        ...
        try:
            if 200 <= _response.status_code < 300:
                ...
                def _fetch_next_page(_next_path):
                    _next_response = self._client_wrapper.httpx_client.request(_next_path, method="GET")
                    _next_parsed = typing.cast(
                        ListUsersPathPaginationResponse,
                        parse_obj_as(
                            type_=ListUsersPathPaginationResponse,  # type: ignore
        ...
        try:
            if 200 <= _response.status_code < 300:
                ...
                async def _fetch_next_page(_next_path):
                    _next_response = await self._client_wrapper.httpx_client.request(_next_path, method="GET")
                    _next_parsed = typing.cast(
                        ListUsersPathPaginationResponse,
                        parse_obj_as(
                            type_=ListUsersPathPaginationResponse,  # type: ignore
