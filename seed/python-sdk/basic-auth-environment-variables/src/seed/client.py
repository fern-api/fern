...
class SeedBasicAuthEnvironmentVariables:
    ...
    """
    def __init__(self, *, base_url: str, username: typing.Optional[typing.Union[str, typing.Callable[[], str]]] = os.getenv("USERNAME"), access_token: typing.Optional[typing.Union[str, typing.Callable[[], str]]] = os.getenv("PASSWORD"), timeout: typing.Optional[float] = None, follow_redirects: typing.Optional[bool] = True, httpx_client: typing.Optional[httpx.Client] = None):
        ...
        self._client_wrapper = SyncClientWrapper(base_url=base_url, username=username, access_token=access_token, httpx_client=httpx_client if httpx_client is not None else httpx.Client(timeout=_defaulted_timeout, follow_redirects=follow_redirects) if follow_redirects is not None else httpx.Client(timeout=_defaulted_timeout)
...
class AsyncSeedBasicAuthEnvironmentVariables:
    ...
    """
    def __init__(self, *, base_url: str, username: typing.Optional[typing.Union[str, typing.Callable[[], str]]] = os.getenv("USERNAME"), access_token: typing.Optional[typing.Union[str, typing.Callable[[], str]]] = os.getenv("PASSWORD"), timeout: typing.Optional[float] = None, follow_redirects: typing.Optional[bool] = True, httpx_client: typing.Optional[httpx.AsyncClient] = None):
        _defaulted_timeout = timeout if timeout is not None else 60 if httpx_client is None else httpx_client.timeout.read
        if username is None:
            raise ApiError(body="The client must be instantiated be either passing in username or setting USERNAME")
        if access_token is None:
            raise ApiError(body="The client must be instantiated be either passing in access_token or setting PASSWORD")
        self._client_wrapper = AsyncClientWrapper(base_url=base_url, username=username, access_token=access_token, httpx_client=httpx_client if httpx_client is not None else httpx.AsyncClient(timeout=_defaulted_timeout, follow_redirects=follow_redirects) if follow_redirects is not None else httpx.AsyncClient(timeout=_defaulted_timeout)
        , timeout=_defaulted_timeout)
