...
class SeedBasicAuthEnvironmentVariables:
    ...
    def __init__(
        ...
        *,
        ...
        if username is None:
            raise ApiError(
                body="The client must be instantiated be either passing in username or setting USERNAME"
            )
        if password is None:
            raise ApiError(
                body="The client must be instantiated be either passing in password or setting PASSWORD"
            )
