...
class AsyncEc2SocketClient(EventEmitterMixin):
    ...
    async def __aiter__(self):
        async for message in self._websocket:
            if isinstance(message, bytes):
                ...
                yield parse_obj_as(Ec2SocketClientResponse, json.loads(message))  # type: ignore
        ...
        try:
            async for raw_message in self._websocket:
                if isinstance(raw_message, bytes):
                    ...
                    parsed = parse_obj_as(Ec2SocketClientResponse, json_data)  # type: ignore
    ...
    async def recv(self) -> Ec2SocketClientResponse:
        """
        ...
        return parse_obj_as(Ec2SocketClientResponse, json_data)  # type: ignore
...
class Ec2SocketClient(EventEmitterMixin):
    ...
    def recv(self) -> Ec2SocketClientResponse:
        """
        Receive a message from the websocket connection.
        """
