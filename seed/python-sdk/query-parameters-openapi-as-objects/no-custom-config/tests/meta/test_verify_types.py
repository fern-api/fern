...
@pytest.mark.parametrize(
    ...
    [
        ("seed.types.nested_user", "NestedUser"),
        ("seed.types.search_request_neighbor", "SearchRequestNeighbor"),
        ("seed.types.search_request_neighbor_required", "SearchRequestNeighborRequired"),
        ("seed.types.search_response", "SearchResponse"),
        ("seed.types.user", "User"),
    ],
)
