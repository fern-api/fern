...
if typing.TYPE_CHECKING:
    ...
    from .plant_post_watering_frequency import PlantPostWateringFrequency
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "PlantPostWateringFrequency": ".plant_post_watering_frequency",
