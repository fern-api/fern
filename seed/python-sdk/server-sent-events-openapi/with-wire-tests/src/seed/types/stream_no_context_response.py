...
class StreamNoContextResponse_Heartbeat(UniversalBaseModel):
...
class StreamNoContextResponse_Entity(UniversalBaseModel):
...
StreamNoContextResponse = typing_extensions.Annotated[
    typing.Union[StreamNoContextResponse_Heartbeat, StreamNoContextResponse_Entity],
