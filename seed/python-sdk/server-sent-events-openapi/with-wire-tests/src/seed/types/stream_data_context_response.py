...
class StreamDataContextResponse_Heartbeat(UniversalBaseModel):
...
class StreamDataContextResponse_Entity(UniversalBaseModel):
...
StreamDataContextResponse = typing_extensions.Annotated[
    typing.Union[StreamDataContextResponse_Heartbeat, StreamDataContextResponse_Entity],
