...
class SeedApi:
    ...
    def list_items(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[Item]:
        """
        Parameters
        ----------
...
class AsyncSeedApi:
    ...
    async def list_items(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[Item]:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
