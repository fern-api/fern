...
[![pypi](https://img.shields.io/pypi/v/fern_openapi-namespace-tag-stripping)](https://pypi.python.org/pypi/fern_openapi-namespace-tag-stripping)
...
```sh
pip install fern_openapi-namespace-tag-stripping
```
