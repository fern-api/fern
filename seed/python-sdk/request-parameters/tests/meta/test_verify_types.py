...
@pytest.mark.parametrize(
    ...
    [
        ("seed.user.types.create_username_body", "CreateUsernameBody"),
        ("seed.user.types.create_username_body_optional_properties", "CreateUsernameBodyOptionalProperties"),
        ("seed.user.types.nested_user", "NestedUser"),
