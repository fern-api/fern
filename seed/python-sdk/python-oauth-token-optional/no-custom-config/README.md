...
[![pypi](https://img.shields.io/pypi/v/fern_python-oauth-token-optional)](https://pypi.python.org/pypi/fern_python-oauth-token-optional)
...
```sh
pip install fern_python-oauth-token-optional
```
