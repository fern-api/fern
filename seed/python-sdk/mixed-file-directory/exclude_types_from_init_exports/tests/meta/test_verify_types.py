...
@pytest.mark.parametrize(
    ...
    [
        ("seed.organization.types.create_organization_request", "CreateOrganizationRequest"),
        ("seed.organization.types.organization", "Organization"),
        ("seed.types.id", "Id"),
        ("seed.user.events.metadata.types.metadata", "Metadata"),
        ("seed.user.events.types.event", "Event"),
