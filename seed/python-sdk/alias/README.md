...
[![pypi](https://img.shields.io/pypi/v/fern_alias)](https://pypi.python.org/pypi/fern_alias)
...
from seed import SeedAlias
import httpx
client = SeedAlias(..., httpx_client=httpx.Client(proxies="http://my.test.proxy.example.com", transport=httpx.HTTPTransport(local_address="0.0.0.0"), ))```
