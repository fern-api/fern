...
[![pypi](https://img.shields.io/pypi/v/fern_endpoint-security-auth)](https://pypi.python.org/pypi/fern_endpoint-security-auth)
...
```sh
pip install fern_endpoint-security-auth
```
...
client = SeedEndpointSecurityAuth(..., token="my-pre-generated-bearer-token")
