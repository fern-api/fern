...
[![pypi](https://img.shields.io/pypi/v/fern_openapi-per-spec-base-path-disabled)](https://pypi.python.org/pypi/fern_openapi-per-spec-base-path-disabled)
...
```sh
pip install fern_openapi-per-spec-base-path-disabled
```
