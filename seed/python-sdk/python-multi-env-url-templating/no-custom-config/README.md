...
[![pypi](https://img.shields.io/pypi/v/fern_python-multi-env-url-templating)](https://pypi.python.org/pypi/fern_python-multi-env-url-templating)
...
```sh
pip install fern_python-multi-env-url-templating
```
