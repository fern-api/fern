...
class RawAuthClient:
    ...
    def get_token(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[GetTokenResponse]:
        """
        Parameters
        ----------
        ...
        _response = self._client_wrapper.httpx_client.request(
            "token",
            base_url=self._client_wrapper.get_environment().oauth,
            method="POST",
