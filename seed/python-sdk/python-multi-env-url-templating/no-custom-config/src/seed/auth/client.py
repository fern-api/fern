...
class AuthClient:
    ...
    def get_token(self, *, request_options: typing.Optional[RequestOptions] = None) -> GetTokenResponse:
        """
        Parameters
        ----------
...
class AsyncAuthClient:
    ...
    async def get_token(self, *, request_options: typing.Optional[RequestOptions] = None) -> GetTokenResponse:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
