...
[![pypi](https://img.shields.io/pypi/v/fern_header-auth-environment-variable)](https://pypi.python.org/pypi/fern_header-auth-environment-variable)
...
```sh
pip install fern_header-auth-environment-variable
```
