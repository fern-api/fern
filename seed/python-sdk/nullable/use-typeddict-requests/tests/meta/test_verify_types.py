...
@pytest.mark.parametrize(
    ...
    [
        ("seed.nullable.types.email", "Email"),
        ("seed.nullable.types.metadata", "Metadata"),
        ("seed.nullable.types.status", "Status"),
        ("seed.nullable.types.user", "User"),
        ("seed.nullable.types.user_id", "UserId"),
        ("seed.nullable.types.weird_number", "WeirdNumber"),
    ],
)
