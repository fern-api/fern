...
[![pypi](https://img.shields.io/pypi/v/fern_python-streaming-parameter-openapi)](https://pypi.python.org/pypi/fern_python-streaming-parameter-openapi)
...
```sh
pip install fern_python-streaming-parameter-openapi
```
