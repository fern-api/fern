...
if IS_PYDANTIC_V2:
    ...
    class _UnionWithPrimitiveBase(UniversalBaseModel, pydantic.RootModel):
    ...
    class _UnionWithPrimitiveBase(UniversalBaseModel):
...
class UnionWithPrimitive(_UnionWithPrimitiveBase):
