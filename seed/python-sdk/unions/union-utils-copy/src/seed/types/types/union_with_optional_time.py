...
if IS_PYDANTIC_V2:
    ...
    class _UnionWithOptionalTimeBase(UniversalBaseModel, pydantic.RootModel):
    ...
    class _UnionWithOptionalTimeBase(UniversalBaseModel):
...
class UnionWithOptionalTime(_UnionWithOptionalTimeBase):
