...
if IS_PYDANTIC_V2:
    ...
    class _UnionWithBasePropertiesBase(UniversalBaseModel, pydantic.RootModel):
    ...
    class _UnionWithBasePropertiesBase(UniversalBaseModel):
...
class UnionWithBaseProperties(_UnionWithBasePropertiesBase):
