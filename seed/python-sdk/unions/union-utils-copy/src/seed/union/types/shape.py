...
from ...core.pydantic_utilities import IS_PYDANTIC_V2, RootModelRootType
...
class Shape(RootModelRootType):
    ...
    def visit(
        ...
        raise ValueError(f"Unexpected union type: {self.get_as_union().type}")
