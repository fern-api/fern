...
class BigUnion(UniversalRootModel):
    ...
    def visit(self, normal_sweet: typing.Callable[[bigunion_types_normal_sweet_NormalSweet], T_Result], thankful_factor: typing.Callable[[bigunion_types_thankful_factor_ThankfulFactor], T_Result], jumbo_end: typing.Callable[[bigunion_types_jumbo_end_JumboEnd], T_Result], hasty_pain: typing.Callable[[bigunion_types_hasty_pain_HastyPain], T_Result], misty_snow: typing.Callable[[bigunion_types_misty_snow_MistySnow], T_Result], distinct_failure: typing.Callable[[bigunion_types_distinct_failure_DistinctFailure], T_Result], practical_principle: typing.Callable[[bigunion_types_practical_principle_PracticalPrinciple], T_Result], limping_step: typing.Callable[[bigunion_types_limping_step_LimpingStep], T_Result], vibrant_excitement: typing.Callable[[bigunion_types_vibrant_excitement_VibrantExcitement], T_Result], active_diamond: typing.Callable[[bigunion_types_active_diamond_ActiveDiamond], T_Result], popular_limit: typing.Callable[[bigunion_types_popular_limit_PopularLimit], T_Result], false_mirror: typing.Callable[[bigunion_types_false_mirror_FalseMirror], T_Result], primary_block: typing.Callable[[bigunion_types_primary_block_PrimaryBlock], T_Result], rotating_ratio: typing.Callable[[bigunion_types_rotating_ratio_RotatingRatio], T_Result], colorful_cover: typing.Callable[[bigunion_types_colorful_cover_ColorfulCover], T_Result], disloyal_value: typing.Callable[[bigunion_types_disloyal_value_DisloyalValue], T_Result], gruesome_coach: typing.Callable[[bigunion_types_gruesome_coach_GruesomeCoach], T_Result], total_work: typing.Callable[[bigunion_types_total_work_TotalWork], T_Result], harmonious_play: typing.Callable[[bigunion_types_harmonious_play_HarmoniousPlay], T_Result], unique_stress: typing.Callable[[bigunion_types_unique_stress_UniqueStress], T_Result], unwilling_smoke: typing.Callable[[bigunion_types_unwilling_smoke_UnwillingSmoke], T_Result], frozen_sleep: typing.Callable[[bigunion_types_frozen_sleep_FrozenSleep], T_Result], diligent_deal: typing.Callable[[bigunion_types_diligent_deal_DiligentDeal], T_Result], attractive_script: typing.Callable[[bigunion_types_attractive_script_AttractiveScript], T_Result], hoarse_mouse: typing.Callable[[bigunion_types_hoarse_mouse_HoarseMouse], T_Result], circular_card: typing.Callable[[bigunion_types_circular_card_CircularCard], T_Result], potable_bad: typing.Callable[[bigunion_types_potable_bad_PotableBad], T_Result], triangular_repair: typing.Callable[[bigunion_types_triangular_repair_TriangularRepair], T_Result], gaseous_road: typing.Callable[[bigunion_types_gaseous_road_GaseousRoad], T_Result]) -> T_Result:
        ...
        if unioned_value.type == "thankfulFactor":
            ...
            bigunion_types_thankful_factor_ThankfulFactor(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        ...
        if unioned_value.type == "distinctFailure":
            ...
            bigunion_types_distinct_failure_DistinctFailure(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        if unioned_value.type == "practicalPrinciple":
            return practical_principle(
            bigunion_types_practical_principle_PracticalPrinciple(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        ...
        if unioned_value.type == "vibrantExcitement":
            ...
            bigunion_types_vibrant_excitement_VibrantExcitement(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        ...
        if unioned_value.type == "harmoniousPlay":
            ...
            bigunion_types_harmonious_play_HarmoniousPlay(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        ...
        if unioned_value.type == "unwillingSmoke":
            ...
            bigunion_types_unwilling_smoke_UnwillingSmoke(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        ...
        if unioned_value.type == "attractiveScript":
            ...
            bigunion_types_attractive_script_AttractiveScript(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
        ...
        if unioned_value.type == "triangularRepair":
            ...
            bigunion_types_triangular_repair_TriangularRepair(**unioned_value.dict(exclude_unset=True, exclude={"type"})))
