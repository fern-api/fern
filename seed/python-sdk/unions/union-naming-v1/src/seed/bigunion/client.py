...
class BigunionClient:
    ...
    def update_many(self, *, request: typing.Sequence[BigUnion], request_options: typing.Optional[RequestOptions] = None) -> typing.Dict[str, bool]:
        """
        Parameters
        ----------
...
class AsyncBigunionClient:
    ...
    async def update_many(self, *, request: typing.Sequence[BigUnion], request_options: typing.Optional[RequestOptions] = None) -> typing.Dict[str, bool]:
        """
        Parameters
        ----------
        request : typing.Sequence[BigUnion]
