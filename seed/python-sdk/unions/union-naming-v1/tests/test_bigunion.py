...
async def test_update(client: SeedUnions, async_client: AsyncSeedUnions) -> None:
    ...
    response = client.bigunion.update(request=NormalSweetBigUnion(value="value"))
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.bigunion.update(request=NormalSweetBigUnion(value="value"))
    validate_response(async_response, expected_response, expected_types)
...
async def test_update_many(client: SeedUnions, async_client: AsyncSeedUnions) -> None:
    ...
    response = client.bigunion.update_many(
        request=[NormalSweetBigUnion(value="value"), NormalSweetBigUnion(value="value")]
    )
    validate_response(response, expected_response, expected_types)
