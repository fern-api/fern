...
class AsyncRawUnionClient:
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[Shape]:
        """
        Parameters
        ----------
        id : str
    ...
    async def update(self, *, request: Shape, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[bool]:
        """
        Parameters
        ----------
        request : Shape
