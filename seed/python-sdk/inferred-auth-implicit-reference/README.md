...
[![pypi](https://img.shields.io/pypi/v/fern_inferred-auth-implicit-reference)](https://pypi.python.org/pypi/fern_inferred-auth-implicit-reference)
...
```sh
pip install fern_inferred-auth-implicit-reference
```
