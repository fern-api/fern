...
[![pypi](https://img.shields.io/pypi/v/fern_unions-with-local-date)](https://pypi.python.org/pypi/fern_unions-with-local-date)
...
```sh
pip install fern_unions-with-local-date
```
