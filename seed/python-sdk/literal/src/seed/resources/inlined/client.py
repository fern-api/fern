...
class InlinedClient:
    ...
    def send(self, *, query: str, temperature: typing.Optional[float] = OMIT, request_options: typing.Optional[RequestOptions] = None) -> SendResponse:
        """
        Parameters:
            - query: str.
        ...
        client.inlined.send(temperature=10.1, query="What is the weather today", )
        """
...
class AsyncInlinedClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper
    async def send(self, *, query: str, temperature: typing.Optional[float] = OMIT, request_options: typing.Optional[RequestOptions] = None) -> SendResponse:
        """
        Parameters:
            - query: str.
        ...
        await client.inlined.send(temperature=10.1, query="What is the weather today", )
        """
        _request: typing.Dict[str, typing.Any] = {
            "prompt": "You are a helpful assistant",
            "query": query,
