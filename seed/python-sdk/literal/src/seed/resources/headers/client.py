...
class HeadersClient:
    ...
    def send(self, *, query: str, request_options: typing.Optional[RequestOptions] = None) -> SendResponse:
        ...
        """
        _response = self._client_wrapper.httpx_client.request("POST", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "headers"), 
            ...
            headers=jsonable_encoder(remove_none_from_dict({**self._client_wrapper.get_headers(),"X-Endpoint-Version": "02-12-2024", "X-Async": True, **(request_options.get('additional_headers', {}) if request_options is not None else {}),},
            )),
...
class AsyncHeadersClient:
    ...
    async def send(self, *, query: str, request_options: typing.Optional[RequestOptions] = None) -> SendResponse:
        ...
        """
        _response = await self._client_wrapper.httpx_client.request("POST", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "headers"), 
            params=jsonable_encoder(request_options.get('additional_query_parameters') if request_options is not None else None),
            json=jsonable_encoder({
                "query": query,
            }
