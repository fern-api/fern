...
class QueryClient:
    ...
    def send(self, *, query: str, request_options: typing.Optional[RequestOptions] = None) -> SendResponse:
        ...
        _response = self._client_wrapper.httpx_client.request("POST", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "query"), 
            params=jsonable_encoder(remove_none_from_dict({"prompt": "You are a helpful assistant", "query": query, "stream": "False", **(request_options.get('additional_query_parameters', {}) if request_options is not None else {}),},
            )),
