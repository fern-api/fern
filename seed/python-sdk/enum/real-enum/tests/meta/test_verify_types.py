...
@pytest.mark.parametrize(
    ...
    [
        ("seed.types.color", "Color"),
        ("seed.types.color_or_operand", "ColorOrOperand"),
        ("seed.types.enum_with_custom", "EnumWithCustom"),
        ("seed.types.enum_with_special_characters", "EnumWithSpecialCharacters"),
        ("seed.types.operand", "Operand"),
        ("seed.types.special_enum", "SpecialEnum"),
        ("seed.unknown.types.status", "Status"),
    ],
)
