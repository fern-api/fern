...
class InlinedRequestClient:
    ...
    def send(self, *, operand: Operand, maybe_operand: typing.Optional[Operand] = OMIT, operand_or_color: ColorOrOperand, maybe_operand_or_color: typing.Optional[ColorOrOperand] = OMIT, request_options: typing.Optional[RequestOptions] = None) -> None:
        """
        Parameters:
            - operand: Operand.
        ...
        _response = self._client_wrapper.httpx_client.request("POST", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "inlined"), 
...
class AsyncInlinedRequestClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper
    async def send(self, *, operand: Operand, maybe_operand: typing.Optional[Operand] = OMIT, operand_or_color: ColorOrOperand, maybe_operand_or_color: typing.Optional[ColorOrOperand] = OMIT, request_options: typing.Optional[RequestOptions] = None) -> None:
        """
        Parameters:
            - operand: Operand.
        ...
        if maybe_operand_or_color is not OMIT:
            _request["maybeOperandOrColor"] = maybe_operand_or_color
        _response = await self._client_wrapper.httpx_client.request("POST", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "inlined"), 
            params=jsonable_encoder(request_options.get('additional_query_parameters') if request_options is not None else None),
            json=jsonable_encoder(_request) if request_options is None or request_options.get('additional_body_parameters') is None else {**jsonable_encoder(_request), **(jsonable_encoder(remove_none_from_dict(request_options.get('additional_body_parameters', {}))))},
            headers=jsonable_encoder(remove_none_from_dict({**self._client_wrapper.get_headers(),**(request_options.get('additional_headers', {}) if request_options is not None else {}),},
            )),
