...
class EnumClient:
    ...
    def get_and_return_enum(self, *, request: WeatherReport, request_options: typing.Optional[RequestOptions] = None) -> WeatherReport:
        """
        Parameters:
        ...
        client.endpoints.enum.get_and_return_enum(request=WeatherReport.SUNNY, )
        """
        _response = self._client_wrapper.httpx_client.request("POST", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "enum"), 
...
class AsyncEnumClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper
    async def get_and_return_enum(self, *, request: WeatherReport, request_options: typing.Optional[RequestOptions] = None) -> WeatherReport:
        """
        Parameters:
            - request: WeatherReport.
        ...
        await client.endpoints.enum.get_and_return_enum(request=WeatherReport.SUNNY, )
        """
        _response = await self._client_wrapper.httpx_client.request("POST", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "enum"), 
            params=jsonable_encoder(request_options.get('additional_query_parameters') if request_options is not None else None),
            json=jsonable_encoder(request),
            headers=jsonable_encoder(remove_none_from_dict({**self._client_wrapper.get_headers(),**(request_options.get('additional_headers', {}) if request_options is not None else {}),},
            )),
