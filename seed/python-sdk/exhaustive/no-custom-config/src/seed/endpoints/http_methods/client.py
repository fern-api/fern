...
class HttpMethodsClient:
    ...
    def http_methods_test_get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> str:
        """
        Parameters
        ----------
        id : str
        ...
        """
        _response = self._raw_client.http_methods_test_get(id, request_options=request_options)
        return _response.data

    def http_methods_test_put(
        ...
        """
        _response = self._raw_client.http_methods_test_put(id, string=string, request_options=request_options)
        return _response.data

    def http_methods_test_delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> bool:
        """
        Parameters
        ----------
        id : str
        ...
        """
        _response = self._raw_client.http_methods_test_delete(id, request_options=request_options)
        return _response.data

    def http_methods_test_patch(
        self,
        id: str,
        *,
        ...
        """
        _response = self._raw_client.http_methods_test_patch(
            id,
            string=string,
            integer=integer,
            long_=long_,
    ...
    def http_methods_test_post(
        ...
        """
        _response = self._raw_client.http_methods_test_post(string=string, request_options=request_options)
        return _response.data
...
class AsyncHttpMethodsClient:
    ...
    async def http_methods_test_get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> str:
        """
        Parameters
        ----------
        id : str
        ...
        async def main() -> None:
            await client.endpoints.http_methods.http_methods_test_get(
                id="id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.http_methods_test_get(id, request_options=request_options)
        return _response.data

    async def http_methods_test_put(
        self, id: str, *, string: str, request_options: typing.Optional[RequestOptions] = None
    ) -> TypesObjectWithOptionalField:
        """
        Parameters
        ...
        async def main() -> None:
            await client.endpoints.http_methods.http_methods_test_put(
                id="id",
                string="string",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.http_methods_test_put(id, string=string, request_options=request_options)
        return _response.data

    async def http_methods_test_delete(
        ...
        async def main() -> None:
            await client.endpoints.http_methods.http_methods_test_delete(
                id="id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.http_methods_test_delete(id, request_options=request_options)
        return _response.data

    async def http_methods_test_patch(
        self,
        id: str,
        *,
        string: typing.Optional[str] = OMIT,
        ...
        async def main() -> None:
            await client.endpoints.http_methods.http_methods_test_patch(
                id="id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.http_methods_test_patch(
            id,
            string=string,
            integer=integer,
            long_=long_,
    ...
    async def http_methods_test_post(
        self, *, string: str, request_options: typing.Optional[RequestOptions] = None
    ) -> TypesObjectWithOptionalField:
        """
        Parameters
        ...
        async def main() -> None:
            await client.endpoints.http_methods.http_methods_test_post(
                string="string",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.http_methods_test_post(string=string, request_options=request_options)
        return _response.data
