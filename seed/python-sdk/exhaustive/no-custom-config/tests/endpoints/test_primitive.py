...
async def test_get_and_return_datetime(client: SeedExhaustive, async_client: AsyncSeedExhaustive) -> None:
    ...
    response = client.endpoints.primitive.get_and_return_datetime(request=datetime.datetime.fromisoformat("2024-01-15 09:30:00+00:00"))
    validate_response(response, expected_response)
    
    async_response = await async_client.endpoints.primitive.get_and_return_datetime(request=datetime.datetime.fromisoformat("2024-01-15 09:30:00+00:00"))
    validate_response(async_response, expected_response)
async def test_get_and_return_date(client: SeedExhaustive, async_client: AsyncSeedExhaustive) -> None:
    ...
    async_response = await async_client.endpoints.primitive.get_and_return_date(request=datetime.date.fromisoformat("2023-01-15"))
    validate_response(async_response, expected_response)
async def test_get_and_return_uuid(client: SeedExhaustive, async_client: AsyncSeedExhaustive) -> None:
    ...
    async_response = await async_client.endpoints.primitive.get_and_return_uuid(request=uuid.UUID("d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32"))
    validate_response(async_response, expected_response)
