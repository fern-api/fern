...
from seed.client import SeedExhaustiveNoCustomConfig

# Check once at import time whether the client constructor accepts a headers kwarg.
try:
    _CLIENT_SUPPORTS_HEADERS: bool = "headers" in inspect.signature(SeedExhaustiveNoCustomConfig).parameters
...
def get_client(test_id: str) -> SeedExhaustiveNoCustomConfig:
    """
    ...
    if _CLIENT_SUPPORTS_HEADERS:
        return SeedExhaustiveNoCustomConfig(
            base_url=base_url,
