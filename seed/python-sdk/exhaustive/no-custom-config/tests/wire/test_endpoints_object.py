...
def test_endpoints_object_get_and_return_with_optional_field() -> None:
    ...
    result = client.get_and_return_with_optional_field(request={"string":"string","integer":1,"long":1000000,"double":1.1,"bool":true,"datetime":"2024-01-15T09:30:00Z","date":"2023-01-15","uuid":"d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32","base64":"SGVsbG8gd29ybGQh","list":["list","list"],"set":["set"],"map":{"1":"map"},"bigint":"1000000"})
...
def test_endpoints_object_get_and_return_with_required_field() -> None:
    ...
    client = seed_exhaustive(base_url="http://localhost:8080")
    result = client.get_and_return_with_required_field(request={"string":"string"})
...
def test_endpoints_object_get_and_return_with_map_of_map() -> None:
    ...
    client = seed_exhaustive(base_url="http://localhost:8080")
    result = client.get_and_return_with_map_of_map(request={"map":{"map":{"map":"map"}}})
...
def test_endpoints_object_get_and_return_nested_with_optional_field() -> None:
    ...
    client = seed_exhaustive(base_url="http://localhost:8080")
    result = client.get_and_return_nested_with_optional_field(request={"string":"string","NestedObject":{"string":"string","integer":1,"long":1000000,"double":1.1,"bool":true,"datetime":"2024-01-15T09:30:00Z","date":"2023-01-15","uuid":"d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32","base64":"SGVsbG8gd29ybGQh","list":["list","list"],"set":["set"],"map":{"1":"map"},"bigint":"1000000"}})
