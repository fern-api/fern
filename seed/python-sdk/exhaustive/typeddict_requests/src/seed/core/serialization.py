...
def _convert_typeddict(
    ...
    for key, value in object_.items():
        ...
        if type_ is None:
            ...
            converted_object[_alias_key(key, type_)] = convert_object(object_=value, annotation=type_)
...
def convert_object(
    *,
    object_: object,
    annotation: type,
    inner_type: typing.Optional[type] = None,
) -> object:
    if object_ is None:
        return None
    ...
    if (
        ...
        return [convert_object(object_=item, annotation=annotation, inner_type=inner_type) for item in object_]
    ...
    if typing_extensions.get_origin(clean_type) == typing.Union:
        ...
        for member in typing_extensions.get_args(clean_type):
            object_ = convert_object(object_=object_, annotation=annotation, inner_type=member)
        return object_
