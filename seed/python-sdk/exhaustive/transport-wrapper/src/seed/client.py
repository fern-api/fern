...
class SeedExhaustive:
    ...
    account_sid : typing.Optional[str]
    api_key_sid : typing.Optional[str]
    api_key_secret : typing.Optional[str]
    Examples
    --------
    ...
    def __init__(
        ...
        *,
        ...
        api_key_secret: typing.Optional[str] = None,
    ):
        _defaulted_timeout = (
            timeout if timeout is not None else 60 if httpx_client is None else httpx_client.timeout.read
        )
        if account_sid is not None or api_key_sid is not None or api_key_secret is not None:
            from .core.custom_transport import CustomTransport

            _transport = CustomTransport(
                account_sid=account_sid, api_key_sid=api_key_sid, api_key_secret=api_key_secret
            )
        else:
            _transport = None
...
class AsyncSeedExhaustive:
    ...
    def __init__(
        ...
        *,
        ...
        if account_sid is not None or api_key_sid is not None or api_key_secret is not None:
            from .core.custom_transport import AsyncCustomTransport

            _transport = AsyncCustomTransport(
                account_sid=account_sid, api_key_sid=api_key_sid, api_key_secret=api_key_secret
            )
        else:
            _transport = None
