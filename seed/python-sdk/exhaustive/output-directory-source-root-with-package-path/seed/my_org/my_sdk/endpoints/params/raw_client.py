...
class RawParamsClient:
    ...
    def get_with_path(self, param: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[str]:
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"params/path/{encode_path_param(param)}",method="GET",
    ...
    def get_with_path_and_query(self, param: str, *, query: str, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[None]:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"params/path-query/{encode_path_param(param)}",method="GET",
            params={"query": query, }
            ,
            request_options=request_options,)
        try:
    ...
    def modify_with_path(self, param: str, *, request: str, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[str]:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"params/path/{encode_path_param(param)}",method="PUT",
            json=request,
    ...
    def upload_with_path(self, param: str, *, request: typing.Union[bytes, typing.Iterator[bytes], typing.AsyncIterator[bytes]], request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[ObjectWithRequiredField]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"params/path/{encode_path_param(param)}",method="POST",
            content=request,
            request_options=request_options,omit=OMIT,
        )
        try:
    ...
    def get_with_boolean_path(self, param: bool, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[str]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"params/path-bool/{encode_path_param(param)}",method="GET",
            request_options=request_options,)
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
    ...
    def get_with_path_and_errors(self, param: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[str]:
        """
...
class AsyncRawParamsClient:
    ...
    async def upload_with_path(self, param: str, *, request: typing.Union[bytes, typing.Iterator[bytes], typing.AsyncIterator[bytes]], request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[ObjectWithRequiredField]:
        """
        POST bytes with path param returning object
    ...
    async def get_with_boolean_path(self, param: bool, *, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[str]:
        """
        GET with boolean path param
    ...
    async def get_with_path_and_errors(self, param: str, *, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[str]:
        """
        GET with path param that can throw errors
