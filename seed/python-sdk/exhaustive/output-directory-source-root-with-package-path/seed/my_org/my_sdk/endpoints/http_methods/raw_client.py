...
class RawHttpMethodsClient:
    ...
    def test_get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[str]:
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"http-methods/{encode_path_param(id)}",method="GET",
    ...
    def test_put(self, id: str, *, string: str, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[ObjectWithOptionalField]:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"http-methods/{encode_path_param(id)}",method="PUT",
            json={
                "string": string,
            }
            ,
    ...
    def test_patch(self, id: str, *, string: typing.Optional[str] = OMIT, integer: typing.Optional[int] = OMIT, long_: typing.Optional[int] = OMIT, double: typing.Optional[float] = OMIT, bool_: typing.Optional[bool] = OMIT, datetime: typing.Optional[dt.datetime] = OMIT, date: typing.Optional[dt.date] = OMIT, uuid_: typing.Optional[uuid.UUID] = OMIT, base64: typing.Optional[str] = OMIT, list_: typing.Optional[typing.Sequence[str]] = OMIT, set_: typing.Optional[typing.Set[str]] = OMIT, map_: typing.Optional[typing.Dict[int, str]] = OMIT, bigint: typing.Optional[str] = OMIT, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[ObjectWithOptionalField]:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"http-methods/{encode_path_param(id)}",method="PATCH",
            json={
                "string": string,
                "integer": integer,
                "long": long_,
    ...
    def test_delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[bool]:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"http-methods/{encode_path_param(id)}",method="DELETE",
            request_options=request_options,)
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
