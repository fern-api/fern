...
class ObjectWithRequiredExtendedField(UniversalBaseModel):
    ...
    """
    required_extended: typing_extensions.Annotated[ExtendedObjectWithInheritedEnum, FieldMetadata(alias="requiredExtended"), pydantic.Field(alias="requiredExtended")]
