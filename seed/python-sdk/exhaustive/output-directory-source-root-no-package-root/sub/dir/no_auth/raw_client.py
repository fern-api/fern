...
class RawNoAuthClient:
    ...
    def post_with_no_auth(self, *, request: typing.Any, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[bool]:
        """
...
class AsyncRawNoAuthClient:
    ...
    async def post_with_no_auth(self, *, request: typing.Any, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[bool]:
        """
        POST request with no auth
