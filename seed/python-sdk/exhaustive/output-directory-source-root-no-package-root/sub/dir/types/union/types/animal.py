...
class Animal_Dog(UniversalBaseModel):
    ...
    name: str
    likes_to_woof: typing_extensions.Annotated[bool, FieldMetadata(alias="likesToWoof"), pydantic.Field(alias="likesToWoof")]
...
class Animal_Cat(UniversalBaseModel):
    ...
    name: str
    likes_to_meow: typing_extensions.Annotated[bool, FieldMetadata(alias="likesToMeow"), pydantic.Field(alias="likesToMeow")]
