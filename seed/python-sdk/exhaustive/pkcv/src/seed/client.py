...
class SeedExhaustive:
    ...
    account_sid : typing.Optional[str]
        The Account SID used as the JWT subject for PKCV request signing.

    api_key_sid : typing.Optional[str]
        A Twilio API Key SID starting with 'SK', used for PKCV request signing.

    credential_sid : typing.Optional[str]
        A Credential SID starting with 'CR', corresponds to the public key uploaded to Twilio.

    private_key : typing.Optional[str]
        The RSA private key used to sign PKCV request JWTs.
