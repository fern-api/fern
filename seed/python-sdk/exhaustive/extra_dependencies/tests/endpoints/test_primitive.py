...
async def test_get_and_return_string(
    ...
    async_response = await async_client.endpoints.primitive.get_and_return_string(
        request="string"
    )
    validate_response(async_response, expected_response, expected_types)


async def test_get_and_return_int(
    client: SeedExhaustive, async_client: AsyncSeedExhaustive
) -> None:
    ...
    async_response = await async_client.endpoints.primitive.get_and_return_int(
        request=1
    )
    validate_response(async_response, expected_response, expected_types)


async def test_get_and_return_long(
    client: SeedExhaustive, async_client: AsyncSeedExhaustive
) -> None:
    ...
    async_response = await async_client.endpoints.primitive.get_and_return_long(
        request=1000000
    )
    validate_response(async_response, expected_response, expected_types)


async def test_get_and_return_double(
    client: SeedExhaustive, async_client: AsyncSeedExhaustive
) -> None:
    ...
    async_response = await async_client.endpoints.primitive.get_and_return_double(
        request=1.1
    )
    validate_response(async_response, expected_response, expected_types)


async def test_get_and_return_bool(
    client: SeedExhaustive, async_client: AsyncSeedExhaustive
) -> None:
    ...
    async_response = await async_client.endpoints.primitive.get_and_return_bool(
        request=True
    )
    validate_response(async_response, expected_response, expected_types)


async def test_get_and_return_datetime(
    client: SeedExhaustive, async_client: AsyncSeedExhaustive
) -> None:
...
async def test_get_and_return_date(
    client: SeedExhaustive, async_client: AsyncSeedExhaustive
) -> None:
    expected_response: typing.Any = "2023-01-15"
    expected_types: typing.Any = "date"
    response = client.endpoints.primitive.get_and_return_date(
...
async def test_get_and_return_base_64(
    client: SeedExhaustive, async_client: AsyncSeedExhaustive
) -> None:
    expected_response: typing.Any = "SGVsbG8gd29ybGQh"
    expected_types: typing.Any = None
    response = client.endpoints.primitive.get_and_return_base_64(
        request="SGVsbG8gd29ybGQh"
    )
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.endpoints.primitive.get_and_return_base_64(
        request="SGVsbG8gd29ybGQh"
    )
    validate_response(async_response, expected_response, expected_types)
