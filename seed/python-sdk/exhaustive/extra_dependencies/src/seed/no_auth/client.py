...
class NoAuthClient:
    ...
    def post_with_no_auth(self, *, request: typing.Optional[typing.Any] = None, request_options: typing.Optional[RequestOptions] = None) -> bool:
        """
...
class AsyncNoAuthClient:
    ...
    async def post_with_no_auth(self, *, request: typing.Optional[typing.Any] = None, request_options: typing.Optional[RequestOptions] = None) -> bool:
        """
        POST request with no auth
