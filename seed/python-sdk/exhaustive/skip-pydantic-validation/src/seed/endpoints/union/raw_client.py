...
class RawUnionClient:
    ...
    def get_and_return_union(self, *, request: Animal, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[Animal]:
        """
        Parameters
        ----------
        request : Animal
...
class AsyncRawUnionClient:
    ...
    async def get_and_return_union(self, *, request: Animal, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[Animal]:
        """
        Parameters
        ----------
        request : Animal
