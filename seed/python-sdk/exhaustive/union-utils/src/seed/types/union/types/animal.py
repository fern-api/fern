...
class Animal(UniversalRootModel):
    ...
    def visit(self, dog: typing.Callable[[types_union_types_dog_Dog], T_Result], cat: typing.Callable[[types_union_types_cat_Cat], T_Result]) -> T_Result:
        unioned_value = self.get_as_union()
        if unioned_value.animal == "dog":
            return dog(
            types_union_types_dog_Dog(**unioned_value.dict(exclude_unset=True, exclude={"animal"})))
        if unioned_value.animal == "cat":
            return cat(
            types_union_types_cat_Cat(**unioned_value.dict(exclude_unset=True, exclude={"animal"})))
