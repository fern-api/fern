...
class SeedExhaustive:
    ...
    """
    def __init__(self, *, base_url: str, token: typing.Optional[typing.Union[str, typing.Callable[[], str]]] = None, timeout: typing.Optional[float] = 5, httpx_client: typing.Optional[httpx.Client] = None):
...
class AsyncSeedExhaustive:
    ...
    """
    def __init__(self, *, base_url: str, token: typing.Optional[typing.Union[str, typing.Callable[[], str]]] = None, timeout: typing.Optional[float] = 5, httpx_client: typing.Optional[httpx.AsyncClient] = None):
