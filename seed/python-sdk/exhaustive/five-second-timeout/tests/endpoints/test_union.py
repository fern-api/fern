...
async def test_get_and_return_union(client: SeedExhaustive, async_client: AsyncSeedExhaustive) -> None:
    ...
    response = client.endpoints.union.get_and_return_union(request=Animal_Dog(animal="dog", name="string", likes_to_woof=True))
    validate_response(response, expected_response)
    
    async_response = await async_client.endpoints.union.get_and_return_union(request=Animal_Dog(animal="dog", name="string", likes_to_woof=True))
