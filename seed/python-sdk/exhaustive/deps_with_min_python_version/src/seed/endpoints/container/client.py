...
class ContainerClient:
    ...
    def get_and_return_list_of_primitives(
        ...
        try:
            if 200 <= _response.status_code < 300:
                return parse_obj_as(typing.List[str], _response.json())
    ...
    def get_and_return_list_of_objects(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return parse_obj_as(typing.List[ObjectWithRequiredField], _response.json())
            _response_json = _response.json()
        except JSONDecodeError:
            raise ApiError(status_code=_response.status_code, body=_response.text)
        raise ApiError(status_code=_response.status_code, body=_response_json)
    ...
    def get_and_return_set_of_primitives(
        ...
        try:
            if 200 <= _response.status_code < 300:
                return parse_obj_as(typing.Set[str], _response.json())
            _response_json = _response.json()
        except JSONDecodeError:
            raise ApiError(status_code=_response.status_code, body=_response.text)
        raise ApiError(status_code=_response.status_code, body=_response_json)
    ...
    def get_and_return_map_prim_to_prim(
        ...
        try:
            if 200 <= _response.status_code < 300:
                return parse_obj_as(typing.Dict[str, str], _response.json())
            _response_json = _response.json()
        except JSONDecodeError:
            raise ApiError(status_code=_response.status_code, body=_response.text)
        raise ApiError(status_code=_response.status_code, body=_response_json)
    ...
    def get_and_return_map_of_prim_to_object(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return parse_obj_as(typing.Dict[str, ObjectWithRequiredField], _response.json())
            _response_json = _response.json()
        except JSONDecodeError:
            raise ApiError(status_code=_response.status_code, body=_response.text)
        raise ApiError(status_code=_response.status_code, body=_response_json)
    ...
    def get_and_return_optional(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return parse_obj_as(typing.Optional[ObjectWithRequiredField], _response.json())
            _response_json = _response.json()
        except JSONDecodeError:
            raise ApiError(status_code=_response.status_code, body=_response.text)
        raise ApiError(status_code=_response.status_code, body=_response_json)
