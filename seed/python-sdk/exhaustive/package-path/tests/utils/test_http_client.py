...
def test_default_aiohttp_client_without_dependency():
    ...
    with patch.dict("sys.modules", {"httpx_aiohttp": None}):
        ...
        from seed.matryoshka.doll.structure.core.http_client import DefaultAioHttpClient
...
def test_default_async_httpx_client_export():
    ...
    from seed.matryoshka.doll.structure.core.http_client import DefaultAsyncHttpxClient
