...
public final class ProblemDescriptionBoard {
  ...
  public static ProblemDescriptionBoard variable(commons.VariableValue value) {
  ...
  public Optional<commons.VariableValue> getVariable() {
    if (isVariable()) {
  ...
  public interface Visitor<T> {
    ...
    T visitVariable(commons.VariableValue variable);
  ...
  private static final class VariableValue implements Value {
    @JsonProperty("value")
    private commons.VariableValue value;

    @JsonCreator(
        mode = JsonCreator.Mode.PROPERTIES
    )
    private VariableValue(@JsonProperty("value") commons.VariableValue value) {
      this.value = value;
    }
