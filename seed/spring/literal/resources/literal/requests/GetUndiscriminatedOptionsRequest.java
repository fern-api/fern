...
@JsonDeserialize(
    builder = GetUndiscriminatedOptionsRequest.Builder.class
)
public final class GetUndiscriminatedOptionsRequest {
  private final Boolean dryRun;

  private GetUndiscriminatedOptionsRequest(Boolean dryRun) {
    this.dryRun = dryRun;
  }
  ...
  public static final class Builder implements DryRunStage, _FinalStage {
    ...
    public GetUndiscriminatedOptionsRequest build() {
      return new GetUndiscriminatedOptionsRequest(dryRun);
    }
  }
}
