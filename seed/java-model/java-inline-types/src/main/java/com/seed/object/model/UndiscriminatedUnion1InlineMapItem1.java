...
@JsonDeserialize(
    builder = UndiscriminatedUnion1InlineMapItem1.Builder.class
)
public final class UndiscriminatedUnion1InlineMapItem1 {
  private final String foo;

  private final ReferenceType ref;

  private UndiscriminatedUnion1InlineMapItem1(String foo, ReferenceType ref) {
    this.foo = foo;
    this.ref = ref;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof UndiscriminatedUnion1InlineMapItem1 && equalTo((UndiscriminatedUnion1InlineMapItem1) other);
  }
  ...
  public static final class Builder implements FooStage, RefStage, _FinalStage {
    ...
    public UndiscriminatedUnion1InlineMapItem1 build() {
      return new UndiscriminatedUnion1InlineMapItem1(foo, ref);
    }
  }
}
