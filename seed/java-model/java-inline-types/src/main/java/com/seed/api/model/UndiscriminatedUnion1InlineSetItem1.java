...
@JsonDeserialize(
    builder = UndiscriminatedUnion1InlineSetItem1.Builder.class
)
public final class UndiscriminatedUnion1InlineSetItem1 {
  ...
  private UndiscriminatedUnion1InlineSetItem1(String foo, ReferenceType ref) {
    this.foo = foo;
    this.ref = ref;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof UndiscriminatedUnion1InlineSetItem1 && equalTo((UndiscriminatedUnion1InlineSetItem1) other);
  }
  ...
  public static final class Builder implements FooStage, RefStage, _FinalStage {
    ...
    public UndiscriminatedUnion1InlineSetItem1 build() {
      return new UndiscriminatedUnion1InlineSetItem1(foo, ref);
    }
  }
}
