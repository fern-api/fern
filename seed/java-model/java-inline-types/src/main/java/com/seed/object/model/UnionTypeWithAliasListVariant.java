...
public final class UnionTypeWithAliasListVariant {
  ...
  public static UnionTypeWithAliasListVariant aliasVariant(List<AliasVariantType> value) {
  ...
  public Optional<List<AliasVariantType>> getAliasVariant() {
    if (isAliasVariant()) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof UnionTypeWithAliasListVariant && value.equals(((UnionTypeWithAliasListVariant) other).value);
  }
  ...
  public interface Visitor<T> {
    T visitAliasVariant(List<AliasVariantType> aliasVariant);
  ...
  private static final class AliasVariantValue implements Value {
    @JsonProperty("value")
    private List<AliasVariantType> value;

    @JsonCreator(
        mode = JsonCreator.Mode.PROPERTIES
    )
    private AliasVariantValue(@JsonProperty("value") List<AliasVariantType> value) {
      this.value = value;
    }
