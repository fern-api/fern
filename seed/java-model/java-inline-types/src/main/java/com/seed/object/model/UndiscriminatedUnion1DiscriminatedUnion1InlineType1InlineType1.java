...
@JsonDeserialize(
    builder = UndiscriminatedUnion1DiscriminatedUnion1InlineType1InlineType1.Builder.class
)
public final class UndiscriminatedUnion1DiscriminatedUnion1InlineType1InlineType1 {
  ...
  private UndiscriminatedUnion1DiscriminatedUnion1InlineType1InlineType1(String foo,
      ReferenceType ref) {
    this.foo = foo;
    this.ref = ref;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof UndiscriminatedUnion1DiscriminatedUnion1InlineType1InlineType1 && equalTo((UndiscriminatedUnion1DiscriminatedUnion1InlineType1InlineType1) other);
  }
