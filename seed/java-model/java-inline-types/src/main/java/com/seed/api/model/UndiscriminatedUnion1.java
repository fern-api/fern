...
public final class UndiscriminatedUnion1 {
  ...
  public <T> T visit(Visitor<T> visitor) {
    if(this.type == 0) {
      ...
      return visitor.visitListOfUndiscriminatedUnion1InlineListItem1((List<UndiscriminatedUnion1InlineListItem1>) this.value);
    } else if(this.type == 6) {
      return visitor.visitListOfUndiscriminatedUnion1InlineSetItem1((List<UndiscriminatedUnion1InlineSetItem1>) this.value);
    } else if(this.type == 7) {
  ...
  public static UndiscriminatedUnion1 ofListOfUndiscriminatedUnion1InlineListItem1(
      List<UndiscriminatedUnion1InlineListItem1> value) {
    return new UndiscriminatedUnion1(value, 5);
  }

  public static UndiscriminatedUnion1 ofListOfUndiscriminatedUnion1InlineSetItem1(
      List<UndiscriminatedUnion1InlineSetItem1> value) {
  ...
  public interface Visitor<T> {
    ...
    T visitListOfUndiscriminatedUnion1InlineListItem1(
        List<UndiscriminatedUnion1InlineListItem1> value);

    T visitListOfUndiscriminatedUnion1InlineSetItem1(
        List<UndiscriminatedUnion1InlineSetItem1> value);
  ...
  static final class Deserializer extends StdDeserializer<UndiscriminatedUnion1> {
    ...
    public UndiscriminatedUnion1 deserialize(JsonParser p, DeserializationContext context) throws
      ...
      try {
        return ofListOfUndiscriminatedUnion1InlineListItem1(ObjectMappers.JSON_MAPPER.convertValue(value, new TypeReference<List<UndiscriminatedUnion1InlineListItem1>>() {}));
      } catch(RuntimeException e) {
      }
      try {
        return ofListOfUndiscriminatedUnion1InlineSetItem1(ObjectMappers.JSON_MAPPER.convertValue(value, new TypeReference<List<UndiscriminatedUnion1InlineSetItem1>>() {}));
      } catch(RuntimeException e) {
      }
      try {
