...
public final class ObjectTypeWithMapAliasTypeKey {
  ...
  private ObjectTypeWithMapAliasTypeKey(Map<String, String> prop) {
    this.prop = prop;
  }
  ...
  public static final class Builder {
    private Map<String, String> prop = new LinkedHashMap<>();
    ...
    public Builder putAllProp(Map<String, String> prop) {
      if (prop != null) {
        this.prop.putAll(prop);
      }
      return this;
