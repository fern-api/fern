...
public final class Error {
    ...
    private Error(ErrorCategory category, ErrorCode code, Optional<String> detail, Optional<String> field) {
    ...
    public interface CategoryStage {
        CodeStage category(ErrorCategory category);

        Builder from(Error other);
    }

    public interface CodeStage {
        _FinalStage code(ErrorCode code);
    }
    ...
    public static final class Builder implements CategoryStage, CodeStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("category")
        public CodeStage category(ErrorCategory category) {
        ...
        @java.lang.Override
        @JsonSetter("code")
        public _FinalStage code(ErrorCode code) {
