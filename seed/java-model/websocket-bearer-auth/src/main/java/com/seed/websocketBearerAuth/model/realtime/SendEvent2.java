...
@JsonDeserialize(
    builder = SendEvent2.Builder.class
)
public final class SendEvent2 {
  ...
  private SendEvent2(String sendText2, boolean sendParam2) {
  ...
  public interface SendText2Stage {
    SendParam2Stage sendText2(String sendText2);
  ...
  public static final class Builder implements SendText2Stage, SendParam2Stage, _FinalStage {
    ...
    public SendParam2Stage sendText2(String sendText2) {
    ...
    public SendEvent2 build() {
      return new SendEvent2(sendText2, sendParam2);
    }
  }
}
