...
package com.seed.inferredAuthImplicitApiKey.model.auth;
...
public final class TokenResponse {
  ...
  private TokenResponse(String accessToken, String tokenType, int expiresIn,
  ...
  private boolean equalTo(TokenResponse other) {
    return accessToken.equals(other.accessToken) && tokenType.equals(other.tokenType) && expiresIn == other.expiresIn && scope.equals(other.scope);
  }
  ...
  public interface AccessTokenStage {
    TokenTypeStage accessToken(String accessToken);

    Builder from(TokenResponse other);
  }

  public interface TokenTypeStage {
    ExpiresInStage tokenType(String tokenType);
  }
  ...
  public static final class Builder implements AccessTokenStage, TokenTypeStage, ExpiresInStage, _FinalStage {
    ...
    public TokenTypeStage accessToken(String accessToken) {
    ...
    public ExpiresInStage tokenType(String tokenType) {
