...
public final class Key {
  ...
  public <T> T visit(Visitor<T> visitor) {
    if(this.type == 0) {
      ...
      return visitor.visit((KeyOne) this.value);
    }
  ...
  public static Key of(KeyOne value) {
  ...
  static final class Deserializer extends StdDeserializer<Key> {
    ...
    public Key deserialize(JsonParser p, DeserializationContext context) throws IOException {
      ...
      try {
        return of(ObjectMappers.JSON_MAPPER.convertValue(value, KeyOne.class));
      } catch(RuntimeException e) {
      }
