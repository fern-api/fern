...
public final class ComplexProfile {
  ...
  private final Optional<Map<String, Optional<UserRole>>> optionalMapOfEnums;
  ...
  private ComplexProfile(String id, UserRole nullableRole, Optional<UserRole> optionalRole,
      ...
      Optional<SearchResult> optionalSearchResult, Optional<List<String>> nullableArray,
      ...
      Optional<Map<String, Optional<UserRole>>> optionalMapOfEnums) {
    this.id = id;
  ...
  public Optional<Map<String, Optional<UserRole>>> getOptionalMapOfEnums() {
  ...
  public interface IdStage {
    NullableRoleStage id(String id);

    Builder from(ComplexProfile other);
  }

  public interface NullableRoleStage {
    NullableStatusStage nullableRole(UserRole nullableRole);
  }

  public interface NullableStatusStage {
    NullableNotificationStage nullableStatus(UserStatus nullableStatus);
  }

  public interface NullableNotificationStage {
    NullableSearchResultStage nullableNotification(NotificationMethod nullableNotification);
  }
  ...
  public interface _FinalStage {
    ...
    _FinalStage optionalMapOfEnums(Optional<Map<String, Optional<UserRole>>> optionalMapOfEnums);

    _FinalStage optionalMapOfEnums(Map<String, Optional<UserRole>> optionalMapOfEnums);
  }

  @JsonIgnoreProperties(
      ignoreUnknown = true
  )
  public static final class Builder implements IdStage, NullableRoleStage, NullableStatusStage, NullableNotificationStage, NullableSearchResultStage, _FinalStage {
    private String id;
    ...
    private Optional<Map<String, Optional<UserRole>>> optionalMapOfEnums = Optional.empty();
    ...
    @java.lang.Override
    @JsonSetter("id")
    public NullableRoleStage id(String id) {
    ...
    public NullableStatusStage nullableRole(UserRole nullableRole) {
    ...
    public NullableNotificationStage nullableStatus(UserStatus nullableStatus) {
    ...
    public NullableSearchResultStage nullableNotification(NotificationMethod nullableNotification) {
      this.nullableNotification = Objects.requireNonNull(nullableNotification, "nullableNotification must not be null");
      return this;
    }
    ...
    public _FinalStage nullableSearchResult(SearchResult nullableSearchResult) {
      this.nullableSearchResult = Objects.requireNonNull(nullableSearchResult, "nullableSearchResult must not be null");
      return this;
    }

    @java.lang.Override
    public _FinalStage optionalMapOfEnums(Map<String, Optional<UserRole>> optionalMapOfEnums) {
