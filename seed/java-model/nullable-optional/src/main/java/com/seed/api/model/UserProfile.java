...
public final class UserProfile {
  ...
  private UserProfile(String id, String username, Optional<String> nullableString,
      ...
      Optional<OffsetDateTime> nullableDate, Address nullableObject,
      Optional<List<String>> nullableList, Optional<Map<String, Optional<String>>> nullableMap,
      ...
      Optional<Map<String, Optional<String>>> optionalMap, Optional<String> optionalNullableString,
  ...
  public interface UsernameStage {
    NullableObjectStage username(String username);
  }
  ...
  public static final class Builder implements IdStage, UsernameStage, NullableObjectStage, _FinalStage {
    ...
    @java.lang.Override
    @JsonSetter("username")
    public NullableObjectStage username(String username) {
