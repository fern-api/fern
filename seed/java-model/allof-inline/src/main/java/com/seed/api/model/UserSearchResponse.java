...
@JsonDeserialize(
    builder = UserSearchResponse.Builder.class
)
public final class UserSearchResponse {
  ...
  private UserSearchResponse(PagingCursors paging, Optional<List<User>> results) {
    this.paging = paging;
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof UserSearchResponse && equalTo((UserSearchResponse) other);
  }

  private boolean equalTo(UserSearchResponse other) {
  ...
  public interface PagingStage {
    ...
    Builder from(UserSearchResponse other);
  }
  ...
  public static final class Builder implements PagingStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(UserSearchResponse other) {
    ...
    public UserSearchResponse build() {
      return new UserSearchResponse(paging, results);
    }
  }
}
