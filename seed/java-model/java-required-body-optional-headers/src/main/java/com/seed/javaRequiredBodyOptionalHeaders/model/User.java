...
public final class User {
  ...
  private User(String id, String name, String email, Optional<Integer> age, String createdAt) {
    this.id = id;
    this.name = name;
    this.email = email;
    this.age = age;
  ...
  private boolean equalTo(User other) {
    return id.equals(other.id) && name.equals(other.name) && email.equals(other.email) && age.equals(other.age) && createdAt.equals(other.createdAt);
  }
