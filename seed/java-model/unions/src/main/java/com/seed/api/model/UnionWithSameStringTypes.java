...
public final class UnionWithSameStringTypes {
  ...
  public static UnionWithSameStringTypes regularString(
      UnionWithSameStringTypesRegularString value) {
    return new UnionWithSameStringTypes(new RegularStringValue(value));
  }

  public static UnionWithSameStringTypes patternString(
      UnionWithSameStringTypesPatternString value) {
