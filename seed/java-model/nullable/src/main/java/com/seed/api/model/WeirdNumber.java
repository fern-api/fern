...
public final class WeirdNumber {
  ...
  public <T> T visit(Visitor<T> visitor) {
    if(this.type == 0) {
      ...
      return visitor.visitNullableFloat((Optional<Float>) this.value);
    } else if(this.type == 2) {
  ...
  public static WeirdNumber ofNullableFloat(Optional<Float> value) {
    return new WeirdNumber(value, 1);
  }

  public static WeirdNumber ofNullableString(Optional<String> value) {
  ...
  public interface Visitor<T> {
    ...
    T visitNullableFloat(Optional<Float> value);
  ...
  static final class Deserializer extends StdDeserializer<WeirdNumber> {
    ...
    public WeirdNumber deserialize(JsonParser p, DeserializationContext context) throws
      ...
      try {
        return ofNullableFloat(ObjectMappers.JSON_MAPPER.convertValue(value, new TypeReference<Optional<Float>>() {}));
