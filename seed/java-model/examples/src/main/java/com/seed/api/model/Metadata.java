...
public final class Metadata {
  ...
  public static Metadata html(MetadataHtml value) {
    return new Metadata(new HtmlValue(value));
  }

  public static Metadata markdown(MetadataMarkdown value) {
  ...
  public Optional<MetadataHtml> getHtml() {
    if (isHtml()) {
  ...
  public Optional<MetadataMarkdown> getMarkdown() {
    if (isMarkdown()) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof Metadata && value.equals(((Metadata) other).value);
  }
  ...
  public interface Visitor<T> {
    T visitHtml(MetadataHtml html);

    T visitMarkdown(MetadataMarkdown markdown);
  ...
  private static final class HtmlValue implements Value {
    ...
    private HtmlValue(MetadataHtml value) {
      this.value = value;
    }
  ...
  private static final class MarkdownValue implements Value {
    ...
    private MetadataMarkdown value;
    ...
    private MarkdownValue(MetadataMarkdown value) {
      this.value = value;
    }
