...
public final class FetchResponse {
    ...
    private FetchResponse(Optional<Map<String, Column>> columns, Optional<String> namespace, Optional<Usage> usage) {
    ...
    public static final class Builder {
        ...
        public FetchResponse build() {
            return new FetchResponse(columns, namespace, usage);
        }
    }
}
