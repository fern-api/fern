...
public final class MetadataValue {
    ...
    public <T> T visit(Visitor<T> visitor) {
        if (this.type == 0) {
            ...
            return visitor.visit((List<MetadataValue>) this.value);
        }
    ...
    public static MetadataValue of(List<MetadataValue> value) {
        return new MetadataValue(value, 3);
    }
    ...
    public interface Visitor<T> {
        ...
        T visit(List<MetadataValue> value);
    }
    ...
    static final class Deserializer extends StdDeserializer<MetadataValue> {
        ...
        public MetadataValue deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            try {
                return of(ObjectMappers.JSON_MAPPER.convertValue(value, new TypeReference<List<MetadataValue>>() {}));
            } catch (IllegalArgumentException e) {
            }
