...
public final class Union {
  ...
  public static Union foo(UnionFoo value) {
    return new Union(new FooValue(value));
  }

  public static Union bar(UnionBar value) {
    return new Union(new BarValue(value));
  }
  ...
  public Optional<UnionFoo> getFoo() {
    if (isFoo()) {
  ...
  public Optional<UnionBar> getBar() {
    if (isBar()) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof Union && value.equals(((Union) other).value);
  }
  ...
  public interface Visitor<T> {
    T visitFoo(UnionFoo foo);

    T visitBar(UnionBar bar);
  ...
  private static final class FooValue implements Value {
    ...
    private FooValue(UnionFoo value) {
      this.value = value;
    }
  ...
  private static final class BarValue implements Value {
    ...
    private BarValue(UnionBar value) {
      this.value = value;
    }
  ...
  private static final class _UnknownValue implements Value {
    ...
    @java.lang.Override
    public String toString() {
      return "Union{" + "type: " + type + ", value: " + value + "}";
    }
  }
}
