...
public final class UnionWithBaseProperties {
  ...
  private UnionWithBaseProperties(Value value) {
    this.value = value;
  }
  ...
  public static UnionWithBaseProperties integer(int value) {
    return new UnionWithBaseProperties(new IntegerValue(value));
  }

  public static UnionWithBaseProperties string(String value) {
  ...
  private static final class _UnknownValue implements Value {
    ...
    @java.lang.Override
    public String toString() {
      return "UnionWithBaseProperties{" + "type: " + type + ", value: " + value + "}";
    }
  }
}
