...
public final class StderrResponse {
  ...
  private StderrResponse(String submissionId, String stderr) {
  ...
  public interface SubmissionIdStage {
    StderrStage submissionId(String submissionId);
  ...
  public static final class Builder implements SubmissionIdStage, StderrStage, _FinalStage {
    ...
    public StderrStage submissionId(String submissionId) {
