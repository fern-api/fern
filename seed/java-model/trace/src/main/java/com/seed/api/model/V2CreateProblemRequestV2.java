...
@JsonDeserialize(
    builder = V2CreateProblemRequestV2.Builder.class
)
public final class V2CreateProblemRequestV2 {
  ...
  private V2CreateProblemRequestV2(String problemName, ProblemDescription problemDescription,
      V2CustomFiles customFiles, List<V2TestCaseTemplate> customTestCaseTemplates,
      List<V2TestCaseV2> testcases, List<Language> supportedLanguages, boolean isPublic) {
  ...
  public interface CustomFilesStage {
    IsPublicStage customFiles(V2CustomFiles customFiles);
  }
  ...
  public static final class Builder implements ProblemNameStage, ProblemDescriptionStage, CustomFilesStage, IsPublicStage, _FinalStage {
    ...
    public IsPublicStage customFiles(V2CustomFiles customFiles) {
    ...
    public V2CreateProblemRequestV2 build() {
      return new V2CreateProblemRequestV2(problemName, problemDescription, customFiles, customTestCaseTemplates, testcases, supportedLanguages, isPublic);
    }
  }
}
