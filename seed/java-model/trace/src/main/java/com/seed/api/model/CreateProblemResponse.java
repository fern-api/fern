...
public final class CreateProblemResponse {
  ...
  public static CreateProblemResponse success(CreateProblemResponseSuccess value) {
    return new CreateProblemResponse(new SuccessValue(value));
  }

  public static CreateProblemResponse error(CreateProblemResponseError value) {
  ...
  public Optional<CreateProblemResponseSuccess> getSuccess() {
    if (isSuccess()) {
  ...
  public Optional<CreateProblemResponseError> getError() {
    if (isError()) {
  ...
  public interface Visitor<T> {
    T visitSuccess(CreateProblemResponseSuccess success);

    T visitError(CreateProblemResponseError error);
  ...
  private static final class SuccessValue implements Value {
    ...
    private CreateProblemResponseSuccess value;
    ...
    private SuccessValue(CreateProblemResponseSuccess value) {
      this.value = value;
    }
  ...
  private static final class ErrorValue implements Value {
    ...
    private CreateProblemResponseError value;
    ...
    private ErrorValue(CreateProblemResponseError value) {
      this.value = value;
    }
