...
@JsonDeserialize(
    builder = V2TestCaseTemplate.Builder.class
)
public final class V2TestCaseTemplate {
  ...
  private V2TestCaseTemplate(String templateId, String name,
  ...
  public interface ImplementationStage {
    _FinalStage implementation(V2TestCaseImplementation implementation);
  }
  ...
  public static final class Builder implements TemplateIdStage, NameStage, ImplementationStage, _FinalStage {
    ...
    public _FinalStage implementation(V2TestCaseImplementation implementation) {
    ...
    public V2TestCaseTemplate build() {
      return new V2TestCaseTemplate(templateId, name, implementation);
    }
  }
}
