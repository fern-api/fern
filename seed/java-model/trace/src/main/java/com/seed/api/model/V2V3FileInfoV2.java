...
@JsonDeserialize(
    builder = V2V3FileInfoV2.Builder.class
)
public final class V2V3FileInfoV2 {
  ...
  private V2V3FileInfoV2(String filename, String directory, String contents, boolean editable) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof V2V3FileInfoV2 && equalTo((V2V3FileInfoV2) other);
  }

  private boolean equalTo(V2V3FileInfoV2 other) {
  ...
  public interface FilenameStage {
    ...
    Builder from(V2V3FileInfoV2 other);
  }
  ...
  public static final class Builder implements FilenameStage, DirectoryStage, ContentsStage, EditableStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(V2V3FileInfoV2 other) {
    ...
    @java.lang.Override
    public V2V3FileInfoV2 build() {
      return new V2V3FileInfoV2(filename, directory, contents, editable);
    }
  }
}
