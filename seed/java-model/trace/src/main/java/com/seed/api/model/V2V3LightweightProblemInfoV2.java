...
@JsonDeserialize(
    builder = V2V3LightweightProblemInfoV2.Builder.class
)
public final class V2V3LightweightProblemInfoV2 {
  ...
  private V2V3LightweightProblemInfoV2(String problemId, String problemName, int problemVersion,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof V2V3LightweightProblemInfoV2 && equalTo((V2V3LightweightProblemInfoV2) other);
  }

  private boolean equalTo(V2V3LightweightProblemInfoV2 other) {
  ...
  public interface ProblemIdStage {
    ...
    Builder from(V2V3LightweightProblemInfoV2 other);
  }
  ...
  public interface _FinalStage {
    V2V3LightweightProblemInfoV2 build();
  ...
  public static final class Builder implements ProblemIdStage, ProblemNameStage, ProblemVersionStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(V2V3LightweightProblemInfoV2 other) {
    ...
    @java.lang.Override
    public V2V3LightweightProblemInfoV2 build() {
      return new V2V3LightweightProblemInfoV2(problemId, problemName, problemVersion, variableTypes);
    }
  }
}
