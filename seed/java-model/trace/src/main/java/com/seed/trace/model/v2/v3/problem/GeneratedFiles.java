...
package com.seed.trace.model.v2.v3.problem;
...
public final class GeneratedFiles {
  ...
  private GeneratedFiles(Map<Language, Files> generatedTestCaseFiles,
      Map<Language, Files> generatedTemplateFiles, Map<Language, Files> other) {
