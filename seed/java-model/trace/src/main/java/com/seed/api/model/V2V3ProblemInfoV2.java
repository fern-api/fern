...
@JsonDeserialize(
    builder = V2V3ProblemInfoV2.Builder.class
)
public final class V2V3ProblemInfoV2 {
  ...
  private V2V3ProblemInfoV2(String problemId, ProblemDescription problemDescription,
      String problemName, int problemVersion, List<Language> supportedLanguages,
      V2V3CustomFiles customFiles, V2V3GeneratedFiles generatedFiles,
      List<V2V3TestCaseTemplate> customTestCaseTemplates, List<V2V3TestCaseV2> testcases,
      boolean isPublic) {
  ...
  public interface CustomFilesStage {
    GeneratedFilesStage customFiles(V2V3CustomFiles customFiles);
  }

  public interface GeneratedFilesStage {
    IsPublicStage generatedFiles(V2V3GeneratedFiles generatedFiles);
  }
  ...
  public static final class Builder implements ProblemIdStage, ProblemDescriptionStage, ProblemNameStage, ProblemVersionStage, CustomFilesStage, GeneratedFilesStage, IsPublicStage, _FinalStage {
    ...
    public GeneratedFilesStage customFiles(V2V3CustomFiles customFiles) {
    ...
    public IsPublicStage generatedFiles(V2V3GeneratedFiles generatedFiles) {
    ...
    public V2V3ProblemInfoV2 build() {
      return new V2V3ProblemInfoV2(problemId, problemDescription, problemName, problemVersion, supportedLanguages, customFiles, generatedFiles, customTestCaseTemplates, testcases, isPublic);
    }
  }
}
