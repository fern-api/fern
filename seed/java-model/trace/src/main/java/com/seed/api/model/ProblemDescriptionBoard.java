...
public final class ProblemDescriptionBoard {
  ...
  public static ProblemDescriptionBoard html(ProblemDescriptionBoardHtml value) {
    return new ProblemDescriptionBoard(new HtmlValue(value));
  }

  public static ProblemDescriptionBoard variable(ProblemDescriptionBoardVariable value) {
    return new ProblemDescriptionBoard(new VariableValue(value));
  }

  public static ProblemDescriptionBoard testCaseId(ProblemDescriptionBoardTestCaseId value) {
  ...
  public Optional<ProblemDescriptionBoardHtml> getHtml() {
    if (isHtml()) {
  ...
  public Optional<ProblemDescriptionBoardVariable> getVariable() {
    if (isVariable()) {
  ...
  public Optional<ProblemDescriptionBoardTestCaseId> getTestCaseId() {
    if (isTestCaseId()) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ProblemDescriptionBoard && value.equals(((ProblemDescriptionBoard) other).value);
  }
  ...
  public interface Visitor<T> {
    T visitHtml(ProblemDescriptionBoardHtml html);

    T visitVariable(ProblemDescriptionBoardVariable variable);

    T visitTestCaseId(ProblemDescriptionBoardTestCaseId testCaseId);
  ...
  private static final class HtmlValue implements Value {
    ...
    private ProblemDescriptionBoardHtml value;
    ...
    private HtmlValue(ProblemDescriptionBoardHtml value) {
      this.value = value;
    }
  ...
  private static final class VariableValue implements Value {
    ...
    private ProblemDescriptionBoardVariable value;
    ...
    private VariableValue(ProblemDescriptionBoardVariable value) {
      this.value = value;
    }
  ...
  private static final class TestCaseIdValue implements Value {
    ...
    private ProblemDescriptionBoardTestCaseId value;

    @JsonCreator(
        mode = JsonCreator.Mode.PROPERTIES
    )
    private TestCaseIdValue() {
    }

    private TestCaseIdValue(ProblemDescriptionBoardTestCaseId value) {
      this.value = value;
    }
