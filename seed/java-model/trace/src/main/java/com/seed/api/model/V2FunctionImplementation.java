...
@JsonDeserialize(
    builder = V2FunctionImplementation.Builder.class
)
public final class V2FunctionImplementation {
  ...
  private V2FunctionImplementation(String impl, Optional<String> imports) {
    this.impl = impl;
  ...
  public static final class Builder implements ImplStage, _FinalStage {
    ...
    public V2FunctionImplementation build() {
      return new V2FunctionImplementation(impl, imports);
    }
  }
}
