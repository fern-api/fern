...
@JsonDeserialize(
    builder = V2V3BasicTestCaseTemplate.Builder.class
)
public final class V2V3BasicTestCaseTemplate {
  ...
  private V2V3BasicTestCaseTemplate(String templateId, String name,
      V2V3TestCaseImplementationDescription description, String expectedValueParameterId) {
  ...
  public interface DescriptionStage {
    ExpectedValueParameterIdStage description(V2V3TestCaseImplementationDescription description);
  }
  ...
  public static final class Builder implements TemplateIdStage, NameStage, DescriptionStage, ExpectedValueParameterIdStage, _FinalStage {
    ...
    public V2V3BasicTestCaseTemplate build() {
      return new V2V3BasicTestCaseTemplate(templateId, name, description, expectedValueParameterId);
    }
  }
}
