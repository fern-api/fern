...
public final class TestSubmissionStatusV2 implements ITestSubmissionStatusV2 {
  ...
  private TestSubmissionStatusV2(List<TestSubmissionUpdate> updates, String problemId,
      int problemVersion, V2ProblemInfoV2 problemInfo) {
  ...
  public interface ProblemInfoStage {
    _FinalStage problemInfo(V2ProblemInfoV2 problemInfo);
  }
  ...
  public static final class Builder implements ProblemIdStage, ProblemVersionStage, ProblemInfoStage, _FinalStage {
    ...
    public _FinalStage problemInfo(V2ProblemInfoV2 problemInfo) {
