...
@JsonDeserialize(
    builder = V2DefaultProvidedFile.Builder.class
)
public final class V2DefaultProvidedFile {
  private final V2FileInfoV2 file;

  private final List<VariableType> relatedTypes;

  private V2DefaultProvidedFile(V2FileInfoV2 file, List<VariableType> relatedTypes) {
    this.file = file;
    this.relatedTypes = relatedTypes;
  }

  @JsonProperty("file")
  public V2FileInfoV2 getFile() {
    return file;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof V2DefaultProvidedFile && equalTo((V2DefaultProvidedFile) other);
  }

  private boolean equalTo(V2DefaultProvidedFile other) {
  ...
  public interface FileStage {
    _FinalStage file(V2FileInfoV2 file);

    Builder from(V2DefaultProvidedFile other);
  }

  public interface _FinalStage {
    V2DefaultProvidedFile build();
  ...
  public static final class Builder implements FileStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(V2DefaultProvidedFile other) {
      file(other.getFile());
    ...
    @java.lang.Override
    @JsonSetter("file")
    public _FinalStage file(V2FileInfoV2 file) {
    ...
    @java.lang.Override
    public V2DefaultProvidedFile build() {
      return new V2DefaultProvidedFile(file, relatedTypes);
    }
  }
}
