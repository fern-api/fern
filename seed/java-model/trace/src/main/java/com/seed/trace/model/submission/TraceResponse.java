...
public final class TraceResponse {
  ...
  private TraceResponse(UUID submissionId, int lineNumber, Optional<DebugVariableValue> returnValue,
      Optional<ExpressionLocation> expressionLocation, StackInformation stack,
