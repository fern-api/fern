...
class UnionService {
    ...
    toRouter() {
            ...
            try {
                yield this.methods.get(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(yield serializers.Shape.jsonOrThrow(responseBody, { unrecognizedObjectKeys: "strip" }));
                    }),
        ...
        this.router.patch("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.Shape.parse(req.body);
            if (request.ok) {
                req.body = request.value;
                try {
                    yield this.methods.update(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.union.update.Response.jsonOrThrow(responseBody, {
