        ...
        this.router.get("", async (req, res, next) => {
            try {
                ...
                if (error instanceof errors.SeedPaginationError) {
                    console.warn(
                        `Endpoint 'listUsernamesCustom' unexpectedly threw ${error.constructor.name}. If this was intentional, please add ${error.constructor.name} to the endpoint's errors list in your Fern Definition.`,
                    );
