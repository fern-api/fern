...
class CompletionsService {
    ...
    toRouter() {
        this.router.post("/stream", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.StreamCompletionRequest.parse(req.body);
            if (request.ok) {
                req.body = request.value;
                try {
                    yield this.methods.stream(req, {
                    ...
                    console.error(error);
                    if (error instanceof errors.SeedServerSentEventsError) {
                        console.warn(`Endpoint 'stream' unexpectedly threw ${error.constructor.name}.` +
