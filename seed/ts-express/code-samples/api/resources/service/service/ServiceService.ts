...
export interface ServiceServiceMethods {
    hello(
        req: express.Request<never, SeedCodeSamples.MyResponse, SeedCodeSamples.MyRequest, never>,
        res: {
    ...
    public toRouter(): express.Router {
        this.router.post("/hello", async (req, res, next) => {
            ...
            if (request.ok) {
                ...
                try {
                    await this.methods.hello(req as any, {
                    ...
                    if (error instanceof errors.SeedCodeSamplesError) {
                        console.warn(
                            `Endpoint 'hello' unexpectedly threw ${error.constructor.name}.` +
