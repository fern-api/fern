...
class ServiceService {
    ...
    toRouter() {
        this.router.get("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.getException(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(yield serializers.Exception.jsonOrThrow(responseBody, { unrecognizedObjectKeys: "strip" }));
                    }),
                ...
                if (error instanceof errors.SeedExamplesError) {
                    console.warn(`Endpoint 'getException' unexpectedly threw ${error.constructor.name}.` +
