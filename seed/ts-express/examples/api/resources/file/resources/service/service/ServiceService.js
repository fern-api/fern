...
class ServiceService {
    ...
    toRouter() {
        this.router.get("/:filename", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.getFile(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(yield serializers.File_.jsonOrThrow(responseBody, { unrecognizedObjectKeys: "strip" }));
                    }),
