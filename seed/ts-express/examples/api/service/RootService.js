...
class RootService {
    ...
    toRouter() {
        this.router.post("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.echo.Request.parse(req.body);
            if (request.ok) {
                req.body = request.value;
                try {
                    yield this.methods.echo(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.echo.Response.jsonOrThrow(responseBody, {
                    ...
                    if (error instanceof errors.SeedExamplesError) {
                        console.warn(`Endpoint 'echo' unexpectedly threw ${error.constructor.name}.` +
