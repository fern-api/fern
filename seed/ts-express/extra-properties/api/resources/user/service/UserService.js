...
class UserService {
    ...
    toRouter() {
        this.router.post("/user", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.CreateUserRequest.parse(req.body);
            if (request.ok) {
                req.body = request.value;
                try {
                    yield this.methods.createUser(req, {
                    ...
                    if (error instanceof errors.SeedExtraPropertiesError) {
                        console.warn(`Endpoint 'createUser' unexpectedly threw ${error.constructor.name}.` +
