...
export class PropertyBasedErrorService {
    ...
    constructor(
        private readonly methods: PropertyBasedErrorServiceMethods,
            ...
            try {
                ...
                if (error instanceof errors.SeedErrorPropertyError) {
                    switch (error.errorName) {
                        ...
                        default:
                            console.warn(
                                `Endpoint 'ThrowError' unexpectedly threw ${error.constructor.name}. If this was intentional, please add ${error.constructor.name} to the endpoint's errors list in your Fern Definition.`,
                            );
                    }
