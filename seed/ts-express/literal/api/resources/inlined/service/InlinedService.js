...
exports.InlinedService = void 0;
const express_1 = __importDefault(require("express"));
const serializers = __importStar(require("../../../../serialization/index"));
const errors = __importStar(require("../../../../errors/index"));
class InlinedService {
    ...
    toRouter() {
        this.router.post("/inlined", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.SendLiteralsInlinedRequest.parse(req.body);
            if (request.ok) {
...
exports.InlinedService = InlinedService;
