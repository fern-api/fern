...
class HeadersService {
    ...
    toRouter() {
        this.router.post("/headers", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.SendLiteralsInHeadersRequest.parse(req.body);
            if (request.ok) {
                req.body = request.value;
                try {
                    yield this.methods.send(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.SendResponse.jsonOrThrow(responseBody, {
