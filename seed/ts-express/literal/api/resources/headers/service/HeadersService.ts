...
export interface HeadersServiceMethods {
    send(
        req: express.Request<never, SeedLiteral.SendResponse, SeedLiteral.SendLiteralsInHeadersRequest, never>,
        res: {
...
export class HeadersService {
    ...
    constructor(private readonly methods: HeadersServiceMethods, middleware: express.RequestHandler[] = []) {
