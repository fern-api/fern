...
class HomepageService {
    ...
    toRouter() {
        this.router.get("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.getHomepageProblems(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(yield serializers.homepage.getHomepageProblems.Response.jsonOrThrow(responseBody, {
        ...
        this.router.post("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.homepage.setHomepageProblems.Request.parse(req.body);
            if (request.ok) {
                req.body = request.value;
                try {
                    yield this.methods.setHomepageProblems(req, {
