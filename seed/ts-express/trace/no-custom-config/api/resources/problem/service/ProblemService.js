...
class ProblemService {
    ...
    toRouter() {
        this.router.post("/create", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.CreateProblemRequest.parse(req.body);
            if (request.ok) {
                req.body = request.value;
                try {
                    yield this.methods.createProblem(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.CreateProblemResponse.jsonOrThrow(responseBody, {
            ...
            if (request.ok) {
                ...
                try {
                    yield this.methods.updateProblem(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.UpdateProblemResponse.jsonOrThrow(responseBody, {
                                unrecognizedObjectKeys: "strip",
                            }));
                        }),
                        cookie: res.cookie.bind(res),
        ...
        this.router.post("/default-starter-files", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.GetDefaultStarterFilesRequest.parse(req.body);
            if (request.ok) {
                req.body = request.value;
                try {
                    yield this.methods.getDefaultStarterFiles(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.GetDefaultStarterFilesResponse.jsonOrThrow(responseBody, {
                                unrecognizedObjectKeys: "strip",
                            }));
                        }),
                        cookie: res.cookie.bind(res),
