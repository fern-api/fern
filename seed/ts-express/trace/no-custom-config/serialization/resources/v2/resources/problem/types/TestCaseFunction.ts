...
export declare namespace TestCaseFunction {
    ...
    export interface WithActualResult extends serializers.v2.TestCaseWithActualResultImplementation.Raw {
        type: "withActualResult";
    }

    export interface Custom extends serializers.v2.VoidFunctionDefinition.Raw {
        type: "custom";
    }
}
