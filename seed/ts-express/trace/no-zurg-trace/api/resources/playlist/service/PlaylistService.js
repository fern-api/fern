...
class PlaylistService {
    ...
    toRouter() {
        this.router.post("/create", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.createPlaylist(req, {
        ...
        this.router.get("/all", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.getPlaylists(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(responseBody);
                    }),
                    cookie: res.cookie.bind(res),
        ...
        this.router.get("/:playlistId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.getPlaylist(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(responseBody);
                    }),
                    cookie: res.cookie.bind(res),
        ...
        this.router.put("/:playlistId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.updatePlaylist(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(responseBody);
                    }),
                    cookie: res.cookie.bind(res),
        ...
        this.router.delete("/:playlist_id", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.deletePlaylist(req, {
