...
class SyspropService {
    ...
    toRouter() {
        this.router.put("/num-warm-instances/:language/:numWarmInstances", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.setNumWarmInstances(req, {
        ...
        this.router.get("/num-warm-instances", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.getNumWarmInstances(req, {
...
exports.SyspropService = SyspropService;
