...
class ServiceService {
    ...
    toRouter() {
        this.router.get("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.endpoint(req, {
                ...
                if (error instanceof errors.SeedApiError) {
                    console.warn(`Endpoint 'endpoint' unexpectedly threw ${error.constructor.name}.` +
        ...
        this.router.post("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.unknownRequest(req, {
                    send: () => __awaiter(this, void 0, void 0, function* () {
                        res.sendStatus(204);
                    }),
                    cookie: res.cookie.bind(res),
                ...
                if (error instanceof errors.SeedApiError) {
                    switch (error.errorName) {
                        case "NotFoundError":
                            break;
                        default:
                            console.warn(`Endpoint 'unknownRequest' unexpectedly threw ${error.constructor.name}.` +
                                ` If this was intentional, please add ${error.constructor.name} to` +
                                " the endpoint's errors list in your Fern Definition.");
                    }
                    yield error.send(res);
