...
class ServiceService {
    ...
    toRouter() {
        this.router.get("/apiKey", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.getWithApiKey(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(yield serializers.service.getWithApiKey.Response.jsonOrThrow(responseBody, {
                ...
                if (error instanceof errors.SeedAuthEnvironmentVariablesError) {
                    console.warn(`Endpoint 'getWithApiKey' unexpectedly threw ${error.constructor.name}.` +
