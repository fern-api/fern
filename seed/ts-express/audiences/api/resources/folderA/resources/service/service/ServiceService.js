...
class ServiceService {
    ...
    toRouter() {
        this.router.get("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.getDirectThread(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(yield serializers.folderA.Response.jsonOrThrow(responseBody, {
                ...
                if (error instanceof errors.SeedAudiencesError) {
                    console.warn(`Endpoint 'getDirectThread' unexpectedly threw ${error.constructor.name}.` +
