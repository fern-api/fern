...
export class FooService {
    ...
    constructor(
        private readonly methods: FooServiceMethods,
            ...
            if (request.ok) {
                ...
                try {
                    ...
                    if (error instanceof errors.SeedAudiencesError) {
                        console.warn(
                            `Endpoint 'find' unexpectedly threw ${error.constructor.name}. If this was intentional, please add ${error.constructor.name} to the endpoint's errors list in your Fern Definition.`,
                        );
