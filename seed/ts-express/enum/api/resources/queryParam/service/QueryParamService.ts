...
import type * as SeedEnum from "../../../index";
    ...
    public toRouter(): express.Router {
        ...
        this.router.post("/query-list", async (req, res, next) => {
            try {
                ...
                if (error instanceof errors.SeedEnumError) {
                    console.warn(
                        `Endpoint 'sendList' unexpectedly threw ${error.constructor.name}. If this was intentional, please add ${error.constructor.name} to the endpoint's errors list in your Fern Definition.`,
                    );
                    await error.send(res);
                } else {
                    res.status(500).json("Internal Server Error");
