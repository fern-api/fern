...
class Ec2Service {
    ...
    toRouter() {
        this.router.post("/boot", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.BootInstanceRequest.parse(req.body);
            if (request.ok) {
                req.body = request.value;
                try {
                    yield this.methods.bootInstance(req, {
                    ...
                    if (error instanceof errors.SeedMultiUrlEnvironmentError) {
                        console.warn(`Endpoint 'bootInstance' unexpectedly threw ${error.constructor.name}.` +
