...
export class EnumService {
    ...
    constructor(
        private readonly methods: EnumServiceMethods,
    ...
    public toRouter(): express.Router {
        this.router.post("", async (req, res, next) => {
            ...
            if (request.ok) {
                ...
                try {
                    await this.methods.getAndReturnEnum(
                        req as any,
                        {
                    ...
                    if (error instanceof errors.SeedExhaustiveError) {
                        console.warn(
                            `Endpoint 'getAndReturnEnum' unexpectedly threw ${error.constructor.name}. If this was intentional, please add ${error.constructor.name} to the endpoint's errors list in your Fern Definition.`,
                        );
