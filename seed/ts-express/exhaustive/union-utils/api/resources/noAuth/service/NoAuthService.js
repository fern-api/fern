...
class NoAuthService {
    ...
    toRouter() {
        this.router.post("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.postWithNoAuth(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(yield serializers.noAuth.postWithNoAuth.Response.jsonOrThrow(responseBody, {
                ...
                if (error instanceof errors.SeedExhaustiveError) {
                    switch (error.errorName) {
                        case "BadRequestBody":
                            break;
                        default:
                            console.warn(`Endpoint 'postWithNoAuth' unexpectedly threw ${error.constructor.name}.` +
...
exports.NoAuthService = NoAuthService;
