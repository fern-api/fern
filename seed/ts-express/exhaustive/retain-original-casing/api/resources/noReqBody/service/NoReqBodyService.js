...
exports.NoReqBodyService = void 0;
const express_1 = __importDefault(require("express"));
const serializers = __importStar(require("../../../../serialization/index"));
const errors = __importStar(require("../../../../errors/index"));
class NoReqBodyService {
    ...
    toRouter() {
        this.router.get("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.getWithNoRequestBody(req, {
                ...
                if (error instanceof errors.SeedExhaustiveError) {
                    console.warn(`Endpoint 'getWithNoRequestBody' unexpectedly threw ${error.constructor.name}.` +
        ...
        this.router.post("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.postWithNoRequestBody(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(yield serializers.noReqBody.postWithNoRequestBody.Response.jsonOrThrow(responseBody, {
                            unrecognizedObjectKeys: "strip",
                        }));
                    }),
                    cookie: res.cookie.bind(res),
                ...
                console.error(error);
                if (error instanceof errors.SeedExhaustiveError) {
                    console.warn(`Endpoint 'postWithNoRequestBody' unexpectedly threw ${error.constructor.name}.` +
                        ` If this was intentional, please add ${error.constructor.name} to` +
                        " the endpoint's errors list in your Fern Definition.");
                    yield error.send(res);
                }
...
exports.NoReqBodyService = NoReqBodyService;
