                ...
                try {
                    yield this.methods.getAndReturnListOfPrimitives(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.endpoints.container.getAndReturnListOfPrimitives.Response.jsonOrThrow(responseBody, {
            ...
            if (request.ok) {
                ...
                try {
                    yield this.methods.getAndReturnListOfObjects(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.endpoints.container.getAndReturnListOfObjects.Response.jsonOrThrow(responseBody, {
                                unrecognizedObjectKeys: "passthrough",
                                allowUnrecognizedUnionMembers: true,
                                allowUnrecognizedEnumValues: true,
                            }));
            ...
            if (request.ok) {
                ...
                try {
                    yield this.methods.getAndReturnSetOfPrimitives(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.endpoints.container.getAndReturnSetOfPrimitives.Response.jsonOrThrow(responseBody, {
                                unrecognizedObjectKeys: "passthrough",
                                allowUnrecognizedUnionMembers: true,
                                allowUnrecognizedEnumValues: true,
                            }));
            ...
            if (request.ok) {
                ...
                try {
                    yield this.methods.getAndReturnSetOfObjects(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.endpoints.container.getAndReturnSetOfObjects.Response.jsonOrThrow(responseBody, {
                                unrecognizedObjectKeys: "passthrough",
                                allowUnrecognizedUnionMembers: true,
                                allowUnrecognizedEnumValues: true,
                            }));
            ...
            if (request.ok) {
                ...
                try {
                    yield this.methods.getAndReturnMapPrimToPrim(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.endpoints.container.getAndReturnMapPrimToPrim.Response.jsonOrThrow(responseBody, {
                                unrecognizedObjectKeys: "passthrough",
                                allowUnrecognizedUnionMembers: true,
                                allowUnrecognizedEnumValues: true,
                            }));
            ...
            if (request.ok) {
                ...
                try {
                    yield this.methods.getAndReturnMapOfPrimToObject(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.endpoints.container.getAndReturnMapOfPrimToObject.Response.jsonOrThrow(responseBody, {
                                unrecognizedObjectKeys: "passthrough",
                                allowUnrecognizedUnionMembers: true,
                                allowUnrecognizedEnumValues: true,
                            }));
            ...
            if (request.ok) {
                ...
                try {
                    yield this.methods.getAndReturnOptional(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                            res.json(yield serializers.endpoints.container.getAndReturnOptional.Response.jsonOrThrow(responseBody, {
                                unrecognizedObjectKeys: "passthrough",
                                allowUnrecognizedUnionMembers: true,
                                allowUnrecognizedEnumValues: true,
                            }));
