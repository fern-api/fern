...
exports.OnlyLiteralHeadersService = void 0;
const express_1 = __importDefault(require("express"));
const errors = __importStar(require("../../../../errors"));
class OnlyLiteralHeadersService {
    ...
    toRouter() {
        this.router.post("", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error(error);
                if (error instanceof errors.SeedLiteralHeadersError) {
...
exports.OnlyLiteralHeadersService = OnlyLiteralHeadersService;
