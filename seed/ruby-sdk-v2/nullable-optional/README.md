...
### Custom URL
```ruby
require "fern_nullable_optional"

client = FernNullableOptional::Client.new(
...
rescue FernNullableOptional::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernNullableOptional::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernNullableOptional::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernNullableOptional::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernNullableOptional::Errors::ApiError => e
