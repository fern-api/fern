...
describe FernNullableOptional::Internal::Types::Utils do
  Utils = FernNullableOptional::Internal::Types::Utils

  module TestUtils
    class M < FernNullableOptional::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernNullableOptional::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernNullableOptional::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernNullableOptional::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernNullableOptional::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernNullableOptional::Internal::Errors::TypeError do
    ...
    describe "Array" do
      StringArray = FernNullableOptional::Internal::Types::Array[String]
      ModelArray = -> { FernNullableOptional::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernNullableOptional::Internal::Types::Array[TestUtils::U] }
