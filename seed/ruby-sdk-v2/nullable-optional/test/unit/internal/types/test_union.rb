...
describe FernNullableOptional::Internal::Types::Union do
  class Rectangle < FernNullableOptional::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernNullableOptional::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernNullableOptional::Internal::Types::Model
