  ...
  module NullableOptional
    module Types
      ...
      class UserProfile < Internal::Types::Model
        ...
        field :nullable_boolean, -> { Internal::Types::Boolean }, optional: false, nullable: true, api_name: "nullableBoolean"
        ...
        field :nullable_map, -> { Internal::Types::Hash[String, String] }, optional: false, nullable: true, api_name: "nullableMap"
        ...
        field :optional_boolean, -> { Internal::Types::Boolean }, optional: true, nullable: false, api_name: "optionalBoolean"
        field :optional_date, -> { String }, optional: true, nullable: false, api_name: "optionalDate"
        field :optional_object, -> { FernNullableOptional::NullableOptional::Types::Address }, optional: true, nullable: false, api_name: "optionalObject"
        ...
        field :optional_nullable_object, -> { FernNullableOptional::NullableOptional::Types::Address }, optional: true, nullable: false, api_name: "optionalNullableObject"
      end
    end
  end
end
