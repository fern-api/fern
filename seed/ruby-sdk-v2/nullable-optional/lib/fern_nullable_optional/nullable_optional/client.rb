    ...
    class Client
      ...
      def update_complex_profile(request_options: {}, **params)
        ...
        request = FernNullableOptional::Internal::JSON::Request.new(
          ...
          method: "PATCH",
          path: "/api/profiles/complex/#{params[:profile_id]}",
          body: FernNullableOptional::NullableOptional::Types::UpdateComplexProfileRequest.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      def update_tags(request_options: {}, **params)
        ...
        request = FernNullableOptional::Internal::JSON::Request.new(
          ...
          body: FernNullableOptional::NullableOptional::Types::UpdateTagsRequest.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      def get_search_results(request_options: {}, **params)
        ...
        request = FernNullableOptional::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "/api/search",
          body: FernNullableOptional::NullableOptional::Types::SearchRequest.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
