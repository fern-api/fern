  ...
  module NullableOptional
    module Types
      ...
      class DeserializationTestRequest < Internal::Types::Model
        ...
        field :optional_enum, -> { Seed::NullableOptional::Types::UserStatus }, optional: true, nullable: false, api_name: "optionalEnum"
        field :nullable_union, -> { Seed::NullableOptional::Types::NotificationMethod }, optional: false, nullable: true, api_name: "nullableUnion"
        field :optional_union, -> { Seed::NullableOptional::Types::SearchResult }, optional: true, nullable: false, api_name: "optionalUnion"
        ...
        field :optional_object, -> { Seed::NullableOptional::Types::Organization }, optional: true, nullable: false, api_name: "optionalObject"
      end
    end
  end
end
