...
module Seed
  module Types
    ...
    class UserProfile < Internal::Types::Model
      ...
      field :optional_object, -> { Seed::Types::Address }, optional: true, nullable: false, api_name: "optionalObject"
      ...
      field :optional_nullable_object, -> { Seed::Types::Address }, optional: true, nullable: false, api_name: "optionalNullableObject"
    end
  end
end
