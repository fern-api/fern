...
module Seed
  module Types
    ...
    class DeserializationTestRequest < Internal::Types::Model
      ...
      field :nullable_enum, -> { Seed::Types::UserRole }, optional: false, nullable: false, api_name: "nullableEnum"
      field :optional_enum, -> { Seed::Types::UserStatus }, optional: true, nullable: false, api_name: "optionalEnum"
      field :nullable_union, -> { Seed::Types::NotificationMethod }, optional: false, nullable: false, api_name: "nullableUnion"
      field :optional_union, -> { Seed::Types::SearchResult }, optional: true, nullable: false, api_name: "optionalUnion"
      ...
      field :nullable_object, -> { Seed::Types::Address }, optional: false, nullable: false, api_name: "nullableObject"
      field :optional_object, -> { Seed::Types::Organization }, optional: true, nullable: false, api_name: "optionalObject"
    end
  end
end
