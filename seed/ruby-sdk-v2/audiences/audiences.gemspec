...
Gem::Specification.new do |spec|
  spec.name = "audiences"
  spec.version = "0.0.1" # TODO: audiences::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the audiences API"
  # spec.description = "The audiences Ruby library provides convenient access to the audiences API from Ruby."
