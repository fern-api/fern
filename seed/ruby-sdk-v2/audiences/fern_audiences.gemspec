...
require_relative "lib/fern_audiences/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernAudiences"]
  spec.version = FernAudiences::VERSION
  spec.summary = "Ruby client library for the FernAudiences API"
  spec.description = "The FernAudiences Ruby library provides convenient access to the FernAudiences API from Ruby."
