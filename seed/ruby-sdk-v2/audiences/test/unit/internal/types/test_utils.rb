...
describe FernAudiences::Internal::Types::Utils do
  Utils = FernAudiences::Internal::Types::Utils

  module TestUtils
    class M < FernAudiences::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernAudiences::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernAudiences::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernAudiences::Internal::Types::Union
    ...
    SymbolStringHash = FernAudiences::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernAudiences::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernAudiences::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernAudiences::Internal::Types::Array[String]
      ModelArray = -> { FernAudiences::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernAudiences::Internal::Types::Array[TestUtils::U] }
