...
describe FernAudiences::Internal::Types::Model do
  ...
  class ExampleModel < FernAudiences::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernAudiences::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernAudiences::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernAudiences::Internal::Types::Model
