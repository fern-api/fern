...
describe FernAudiences::Internal::Types::Union do
  class Rectangle < FernAudiences::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernAudiences::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernAudiences::Internal::Types::Model
