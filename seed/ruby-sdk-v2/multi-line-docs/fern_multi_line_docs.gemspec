...
require_relative "lib/fern_multi_line_docs/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernMultiLineDocs"]
  spec.version = FernMultiLineDocs::VERSION
  spec.summary = "Ruby client library for the FernMultiLineDocs API"
  spec.description = "The FernMultiLineDocs Ruby library provides convenient access to the FernMultiLineDocs API from Ruby."
