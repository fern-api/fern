...
# require_relative "lib/multi_line_docs/version"

Gem::Specification.new do |spec|
  spec.name = "multi_line_docs"
  spec.version = "0.0.1" # TODO: multi_line_docs::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the multi_line_docs API"
  # spec.description = "The multi_line_docs Ruby library provides convenient access to the multi_line_docs API from Ruby."
