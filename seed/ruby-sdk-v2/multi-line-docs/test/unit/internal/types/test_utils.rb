...
describe FernMultiLineDocs::Internal::Types::Utils do
  Utils = FernMultiLineDocs::Internal::Types::Utils

  module TestUtils
    class M < FernMultiLineDocs::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernMultiLineDocs::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernMultiLineDocs::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernMultiLineDocs::Internal::Types::Union
    ...
    SymbolStringHash = FernMultiLineDocs::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernMultiLineDocs::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernMultiLineDocs::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernMultiLineDocs::Internal::Types::Array[String]
      ModelArray = -> { FernMultiLineDocs::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernMultiLineDocs::Internal::Types::Array[TestUtils::U] }
