...
describe FernMultiLineDocs::Internal::Types::Union do
  class Rectangle < FernMultiLineDocs::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernMultiLineDocs::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernMultiLineDocs::Internal::Types::Model
