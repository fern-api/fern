...
### Custom URL
```ruby
require "fern_multi_line_docs"

client = FernMultiLineDocs::Client.new(
...
rescue FernMultiLineDocs::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernMultiLineDocs::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernMultiLineDocs::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernMultiLineDocs::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernMultiLineDocs::Errors::ApiError => e
