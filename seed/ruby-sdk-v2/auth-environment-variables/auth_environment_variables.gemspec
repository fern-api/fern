...
# require_relative "lib/auth_environment_variables/version"

Gem::Specification.new do |spec|
  spec.name = "auth_environment_variables"
  spec.version = "0.0.1" # TODO: auth_environment_variables::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the auth_environment_variables API"
  # spec.description = "The auth_environment_variables Ruby library provides convenient access to the auth_environment_variables API from Ruby."
