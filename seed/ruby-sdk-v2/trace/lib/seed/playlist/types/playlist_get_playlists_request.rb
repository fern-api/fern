...
module Seed
  module Playlist
    module Types
      class PlaylistGetPlaylistsRequest < Internal::Types::Model
        ...
        field :optional_multiple_field, -> { String }, optional: true, nullable: false, api_name: "optionalMultipleField"
        field :multiple_field, -> { String }, optional: true, nullable: false, api_name: "multipleField"
      end
    end
  end
end
