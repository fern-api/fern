  ...
  module Playlist
    class Client
      ...
      def create_playlist(request_options: {}, **params)
        ...
        _query_param_names = ["datetime", "optionalDatetime"] +%i[datetime optionalDatetime]
      ...
      def get_playlists(request_options: {}, **params)
        _query_param_names = ["limit", "otherField", "multiLineDocs", "optionalMultipleField", "multipleField"] +%i[limit otherField multiLineDocs optionalMultipleField multipleField]
        _query = params.slice(*_query_param_names)
        params = params.except(*_query_param_names)
