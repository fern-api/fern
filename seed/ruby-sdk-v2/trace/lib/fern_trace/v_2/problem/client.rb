  ...
  module V2
    module Problem
      class Client
        ...
        #
        # @return [Array[FernTrace::V2::Problem::Types::LightweightProblemInfoV2]]
        ...
        # @option request_options [Integer] :timeout_in_seconds
        #
        # @return [Array[FernTrace::V2::Problem::Types::ProblemInfoV2]]
        ...
        #
        # @return [FernTrace::V2::Problem::Types::ProblemInfoV2]
        def get_latest_problem(request_options: {}, **params)
          ...
          if code.between?(200, 299)
            FernTrace::V2::Problem::Types::ProblemInfoV2.load(response.body)
          else
            error_class = FernTrace::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
