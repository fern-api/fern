...
require_relative "lib/fern_trace/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernTrace"]
  spec.version = FernTrace::VERSION
  spec.summary = "Ruby client library for the FernTrace API"
  spec.description = "The FernTrace Ruby library provides convenient access to the FernTrace API from Ruby."
