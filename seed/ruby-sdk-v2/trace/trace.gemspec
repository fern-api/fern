...
Gem::Specification.new do |spec|
  spec.name = "trace"
  spec.version = "0.0.1" # TODO: trace::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the trace API"
  # spec.description = "The trace Ruby library provides convenient access to the trace API from Ruby."
