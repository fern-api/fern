...
describe FernTrace::Internal::Types::Model do
  ...
  class ExampleModel < FernTrace::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernTrace::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernTrace::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernTrace::Internal::Types::Model
