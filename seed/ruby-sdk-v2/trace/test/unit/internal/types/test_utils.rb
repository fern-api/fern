...
describe FernTrace::Internal::Types::Utils do
  Utils = FernTrace::Internal::Types::Utils

  module TestUtils
    class M < FernTrace::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernTrace::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernTrace::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernTrace::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernTrace::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernTrace::Internal::Types::Array[String]
      ModelArray = -> { FernTrace::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernTrace::Internal::Types::Array[TestUtils::U] }
