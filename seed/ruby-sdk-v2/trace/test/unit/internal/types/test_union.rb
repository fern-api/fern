...
describe FernTrace::Internal::Types::Union do
  class Rectangle < FernTrace::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernTrace::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernTrace::Internal::Types::Model
