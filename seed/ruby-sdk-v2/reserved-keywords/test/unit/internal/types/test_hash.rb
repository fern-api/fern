...
describe FernReservedKeywords::Internal::Types::Hash do
  module TestHash
    SymbolStringHash = FernReservedKeywords::Internal::Types::Hash[Symbol, String]
  end
  ...
  describe "#coerce" do
    ...
    it "raises an error with other values with strictness on" do
      assert_raises FernReservedKeywords::Internal::Errors::TypeError do
