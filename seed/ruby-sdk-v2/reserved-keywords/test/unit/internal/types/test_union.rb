...
describe FernReservedKeywords::Internal::Types::Union do
  class Rectangle < FernReservedKeywords::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernReservedKeywords::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernReservedKeywords::Internal::Types::Model
