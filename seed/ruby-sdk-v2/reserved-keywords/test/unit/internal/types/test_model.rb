...
describe FernReservedKeywords::Internal::Types::Model do
  module StringInteger
    extend FernReservedKeywords::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernReservedKeywords::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernReservedKeywords::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernReservedKeywords::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernReservedKeywords::Internal::Types::Model
