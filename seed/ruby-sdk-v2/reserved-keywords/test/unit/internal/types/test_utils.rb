...
describe FernReservedKeywords::Internal::Types::Utils do
  Utils = FernReservedKeywords::Internal::Types::Utils

  module TestUtils
    class M < FernReservedKeywords::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernReservedKeywords::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernReservedKeywords::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernReservedKeywords::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernReservedKeywords::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernReservedKeywords::Internal::Types::Array[TestUtils::U] }
