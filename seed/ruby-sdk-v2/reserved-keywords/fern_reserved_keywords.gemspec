...
require_relative "lib/fern_reserved_keywords/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernReservedKeywords"]
  spec.version = FernReservedKeywords::VERSION
  spec.summary = "Ruby client library for the FernReservedKeywords API"
  spec.description = "The FernReservedKeywords Ruby library provides convenient access to the FernReservedKeywords API from Ruby."
