...
# require_relative "lib/nursery_api/version"

Gem::Specification.new do |spec|
  spec.name = "nursery_api"
  spec.version = "0.0.1" # TODO: nursery_api::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the nursery_api API"
  # spec.description = "The nursery_api Ruby library provides convenient access to the nursery_api API from Ruby."
