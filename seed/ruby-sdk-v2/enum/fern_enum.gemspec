...
require_relative "lib/fern_enum/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_enum"
  spec.authors = ["FernEnum"]
  spec.version = FernEnum::VERSION
  spec.summary = "Ruby client library for the FernEnum API"
  spec.description = "The FernEnum Ruby library provides convenient access to the FernEnum API from Ruby."
