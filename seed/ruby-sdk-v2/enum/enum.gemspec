...
Gem::Specification.new do |spec|
  spec.name = "enum"
  spec.version = "0.0.1" # TODO: enum::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the enum API"
  # spec.description = "The enum Ruby library provides convenient access to the enum API from Ruby."
