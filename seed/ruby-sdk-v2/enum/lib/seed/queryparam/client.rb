...
module Seed
  module Queryparam
    class Client
      ...
      # @option params [Seed::Types::Color] :operand_or_color
      ...
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      # @option params [Seed::Types::Operand, nil] :operand
      # @option params [Seed::Types::Operand, nil] :maybe_operand
      # @option params [Seed::Types::ColorOrOperand, nil] :operand_or_color
      # @option params [Seed::Types::ColorOrOperand, nil] :maybe_operand_or_color
      #
      # @return [untyped]
      def sendlist(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        query_param_names = %i[operand maybe_operand operand_or_color maybe_operand_or_color]
        query_params = {}
        query_params["operand"] = params[:operand] if params.key?(:operand)
