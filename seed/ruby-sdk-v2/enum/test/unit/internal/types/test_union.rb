...
describe FernEnum::Internal::Types::Union do
  class Rectangle < FernEnum::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernEnum::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernEnum::Internal::Types::Model
