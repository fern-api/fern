...
describe FernEnum::Internal::Types::Utils do
  Utils = FernEnum::Internal::Types::Utils

  module TestUtils
    class M < FernEnum::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernEnum::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernEnum::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernEnum::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernEnum::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernEnum::Internal::Errors::TypeError do
    ...
    describe "Array" do
      StringArray = FernEnum::Internal::Types::Array[String]
      ModelArray = -> { FernEnum::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernEnum::Internal::Types::Array[TestUtils::U] }
