...
describe FernEnum::Internal::Types::Model do
  ...
  class ExampleModel < FernEnum::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernEnum::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernEnum::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernEnum::Internal::Types::Model
