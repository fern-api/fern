...
require_relative "lib/fern_webhook_audience/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_webhook_audience"
  spec.authors = ["FernWebhookAudience"]
  spec.version = FernWebhookAudience::VERSION
  spec.summary = "Ruby client library for the FernWebhookAudience API"
  spec.description = "The FernWebhookAudience Ruby library provides convenient access to the FernWebhookAudience API from Ruby."
