...
describe FernWebhookAudience::Internal::Types::Model do
  module StringInteger
    extend FernWebhookAudience::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernWebhookAudience::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernWebhookAudience::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernWebhookAudience::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernWebhookAudience::Internal::Types::Model
