...
describe FernWebhookAudience::Internal::Types::Union do
  class Rectangle < FernWebhookAudience::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernWebhookAudience::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernWebhookAudience::Internal::Types::Model
