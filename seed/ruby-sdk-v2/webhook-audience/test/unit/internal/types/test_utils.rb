...
describe FernWebhookAudience::Internal::Types::Utils do
  Utils = FernWebhookAudience::Internal::Types::Utils

  module TestUtils
    class M < FernWebhookAudience::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernWebhookAudience::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernWebhookAudience::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernWebhookAudience::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernWebhookAudience::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernWebhookAudience::Internal::Types::Array[TestUtils::U] }
