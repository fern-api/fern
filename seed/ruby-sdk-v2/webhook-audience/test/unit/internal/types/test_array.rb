...
describe FernWebhookAudience::Internal::Types::Array do
  module TestArray
    StringArray = FernWebhookAudience::Internal::Types::Array[String]
  end
  ...
  describe "#coerce" do
    ...
    it "raises an error if not an array and strictness is on" do
      assert_raises FernWebhookAudience::Internal::Errors::TypeError do
