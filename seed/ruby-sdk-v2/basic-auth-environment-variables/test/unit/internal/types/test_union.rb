...
describe FernBasicAuthEnvironmentVariables::Internal::Types::Union do
  class Rectangle < FernBasicAuthEnvironmentVariables::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernBasicAuthEnvironmentVariables::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernBasicAuthEnvironmentVariables::Internal::Types::Model
