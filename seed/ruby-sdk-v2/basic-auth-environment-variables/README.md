...
### Custom URL
```ruby
require "fern_basic_auth_environment_variables"

client = FernBasicAuthEnvironmentVariables::Client.new(
...
rescue FernBasicAuthEnvironmentVariables::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernBasicAuthEnvironmentVariables::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernBasicAuthEnvironmentVariables::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernBasicAuthEnvironmentVariables::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernBasicAuthEnvironmentVariables::Errors::ApiError => e
