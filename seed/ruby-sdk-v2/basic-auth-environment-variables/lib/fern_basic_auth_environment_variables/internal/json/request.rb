...
module FernBasicAuthEnvironmentVariables
  module Internal
    module JSON
      # @api private
      class Request < FernBasicAuthEnvironmentVariables::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernBasicAuthEnvironmentVariables::RequestOptions, Hash{Symbol=>Object}, nil]
