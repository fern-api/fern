...
describe FernUrlFormEncoded::Internal::Types::Utils do
  Utils = FernUrlFormEncoded::Internal::Types::Utils

  module TestUtils
    class M < FernUrlFormEncoded::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernUrlFormEncoded::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernUrlFormEncoded::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernUrlFormEncoded::Internal::Types::Union
    ...
    SymbolStringHash = FernUrlFormEncoded::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernUrlFormEncoded::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernUrlFormEncoded::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernUrlFormEncoded::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernUrlFormEncoded::Internal::Types::Array[TestUtils::U] }
