...
describe FernUrlFormEncoded::Internal::Types::Union do
  class Rectangle < FernUrlFormEncoded::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernUrlFormEncoded::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernUrlFormEncoded::Internal::Types::Model
