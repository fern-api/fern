...
### Custom URL
```ruby
require "fern_url_form_encoded"

client = FernUrlFormEncoded::Client.new(
...
rescue FernUrlFormEncoded::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernUrlFormEncoded::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernUrlFormEncoded::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernUrlFormEncoded::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernUrlFormEncoded::Errors::ApiError => e
