...
require_relative "lib/fern_url_form_encoded/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_url_form_encoded"
  spec.authors = ["FernUrlFormEncoded"]
  spec.version = FernUrlFormEncoded::VERSION
  spec.summary = "Ruby client library for the FernUrlFormEncoded API"
  spec.description = "The FernUrlFormEncoded Ruby library provides convenient access to the FernUrlFormEncoded API from Ruby."
