...
# require_relative "lib/custom_auth/version"

Gem::Specification.new do |spec|
  spec.name = "custom_auth"
  spec.version = "0.0.1" # TODO: custom_auth::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the custom_auth API"
  # spec.description = "The custom_auth Ruby library provides convenient access to the custom_auth API from Ruby."
