...
describe FernPaginationCustom::Internal::Types::Enum do
  module EnumTest
    module ExampleEnum
      extend FernPaginationCustom::Internal::Types::Enum
  ...
  describe "#coerce" do
    ...
    it "raises an error if value is not a member with strictness on" do
      assert_raises FernPaginationCustom::Internal::Errors::TypeError do
