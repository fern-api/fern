...
describe FernPaginationCustom::Internal::Types::Utils do
  Utils = FernPaginationCustom::Internal::Types::Utils

  module TestUtils
    class M < FernPaginationCustom::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernPaginationCustom::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernPaginationCustom::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernPaginationCustom::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernPaginationCustom::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernPaginationCustom::Internal::Types::Array[String]
      ModelArray = -> { FernPaginationCustom::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernPaginationCustom::Internal::Types::Array[TestUtils::U] }
