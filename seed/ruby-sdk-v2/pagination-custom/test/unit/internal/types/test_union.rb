...
describe FernPaginationCustom::Internal::Types::Union do
  class Rectangle < FernPaginationCustom::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernPaginationCustom::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernPaginationCustom::Internal::Types::Model
