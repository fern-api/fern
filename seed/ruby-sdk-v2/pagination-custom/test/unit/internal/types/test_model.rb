...
describe FernPaginationCustom::Internal::Types::Model do
  module StringInteger
    extend FernPaginationCustom::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernPaginationCustom::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernPaginationCustom::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernPaginationCustom::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernPaginationCustom::Internal::Types::Model
