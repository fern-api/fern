...
# require_relative "lib/pagination/version"

Gem::Specification.new do |spec|
  spec.name = "pagination"
  spec.version = "0.0.1" # TODO: pagination::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the pagination API"
  # spec.description = "The pagination Ruby library provides convenient access to the pagination API from Ruby."
