...
client = FernOauthClientCredentialsCustom::Client.new(
...
rescue FernOauthClientCredentialsCustom::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernOauthClientCredentialsCustom::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernOauthClientCredentialsCustom::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernOauthClientCredentialsCustom::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernOauthClientCredentialsCustom::Errors::ApiError => e
