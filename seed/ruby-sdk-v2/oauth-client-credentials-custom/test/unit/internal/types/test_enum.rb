...
describe FernOauthClientCredentialsCustom::Internal::Types::Enum do
  module EnumTest
    module ExampleEnum
      extend FernOauthClientCredentialsCustom::Internal::Types::Enum
  ...
  describe "#coerce" do
    ...
    it "raises an error if value is not a member with strictness on" do
      assert_raises FernOauthClientCredentialsCustom::Internal::Errors::TypeError do
