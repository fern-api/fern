...
describe FernOauthClientCredentialsCustom::Internal::Types::Utils do
  Utils = FernOauthClientCredentialsCustom::Internal::Types::Utils

  module TestUtils
    class M < FernOauthClientCredentialsCustom::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernOauthClientCredentialsCustom::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernOauthClientCredentialsCustom::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernOauthClientCredentialsCustom::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernOauthClientCredentialsCustom::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernOauthClientCredentialsCustom::Internal::Types::Array[String]
      ModelArray = -> { FernOauthClientCredentialsCustom::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernOauthClientCredentialsCustom::Internal::Types::Array[TestUtils::U] }
