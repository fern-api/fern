...
module FernOauthClientCredentialsCustom
  module Internal
    module JSON
      # @api private
      class Request < FernOauthClientCredentialsCustom::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernOauthClientCredentialsCustom::RequestOptions, Hash{Symbol=>Object}, nil]
