...
describe FernNoRetries::Internal::Types::Model do
  module StringInteger
    extend FernNoRetries::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernNoRetries::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernNoRetries::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernNoRetries::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernNoRetries::Internal::Types::Model
