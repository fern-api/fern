...
describe FernNoRetries::Internal::Types::Utils do
  Utils = FernNoRetries::Internal::Types::Utils

  module TestUtils
    class M < FernNoRetries::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernNoRetries::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernNoRetries::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernNoRetries::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernNoRetries::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernNoRetries::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernNoRetries::Internal::Types::Array[TestUtils::U] }
