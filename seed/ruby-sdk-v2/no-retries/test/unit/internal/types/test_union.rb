...
describe FernNoRetries::Internal::Types::Union do
  class Rectangle < FernNoRetries::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernNoRetries::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernNoRetries::Internal::Types::Model
