...
### Custom URL
```ruby
require "fern_no_retries"

client = FernNoRetries::Client.new(
...
begin
    result = client.retries.get_users
rescue FernNoRetries::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernNoRetries::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernNoRetries::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernNoRetries::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernNoRetries::Errors::ApiError => e
...
response = client.retries.get_users(
    ...,
