...
require_relative "lib/fern_no_retries/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_no_retries"
  spec.authors = ["FernNoRetries"]
  spec.version = FernNoRetries::VERSION
  spec.summary = "Ruby client library for the FernNoRetries API"
  spec.description = "The FernNoRetries Ruby library provides convenient access to the FernNoRetries API from Ruby."
