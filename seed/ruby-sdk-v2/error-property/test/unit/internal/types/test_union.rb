...
describe FernErrorProperty::Internal::Types::Union do
  class Rectangle < FernErrorProperty::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernErrorProperty::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernErrorProperty::Internal::Types::Model
