...
describe FernErrorProperty::Internal::Types::Model do
  module StringInteger
    extend FernErrorProperty::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernErrorProperty::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernErrorProperty::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernErrorProperty::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernErrorProperty::Internal::Types::Model
