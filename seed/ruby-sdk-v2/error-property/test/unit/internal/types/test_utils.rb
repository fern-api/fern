...
describe FernErrorProperty::Internal::Types::Utils do
  Utils = FernErrorProperty::Internal::Types::Utils

  module TestUtils
    class M < FernErrorProperty::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernErrorProperty::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernErrorProperty::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernErrorProperty::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernErrorProperty::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernErrorProperty::Internal::Types::Array[TestUtils::U] }
