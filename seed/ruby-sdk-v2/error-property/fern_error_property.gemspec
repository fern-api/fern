...
require_relative "lib/fern_error_property/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernErrorProperty"]
  spec.version = FernErrorProperty::VERSION
  spec.summary = "Ruby client library for the FernErrorProperty API"
  spec.description = "The FernErrorProperty Ruby library provides convenient access to the FernErrorProperty API from Ruby."
