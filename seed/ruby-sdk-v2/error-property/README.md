...
### Custom URL
```ruby
require "fern_error_property"

client = FernErrorProperty::Client.new(
...
begin
    result = client.property_based_error.throw_error
rescue FernErrorProperty::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernErrorProperty::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernErrorProperty::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernErrorProperty::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernErrorProperty::Errors::ApiError => e
