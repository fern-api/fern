...
# require_relative "lib/error_property/version"

Gem::Specification.new do |spec|
  spec.name = "error_property"
  spec.version = "0.0.1" # TODO: error_property::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the error_property API"
  # spec.description = "The error_property Ruby library provides convenient access to the error_property API from Ruby."
