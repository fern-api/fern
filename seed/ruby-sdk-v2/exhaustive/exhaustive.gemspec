...
# require_relative "lib/exhaustive/version"

Gem::Specification.new do |spec|
  spec.name = "exhaustive"
  spec.version = "0.0.1" # TODO: exhaustive::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the exhaustive API"
  # spec.description = "The exhaustive Ruby library provides convenient access to the exhaustive API from Ruby."
