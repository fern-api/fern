...
require_relative "lib/fern_exhaustive/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernExhaustive"]
  spec.version = FernExhaustive::VERSION
  spec.summary = "Ruby client library for the FernExhaustive API"
  spec.description = "The FernExhaustive Ruby library provides convenient access to the FernExhaustive API from Ruby."
