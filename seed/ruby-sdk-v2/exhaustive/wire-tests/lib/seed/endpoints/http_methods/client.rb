  ...
  module Endpoints
    module HTTPMethods
      class Client
        ...
        #
        # @return [String]
        def http_methods_test_get(request_options: {}, **params)
        ...
        def http_methods_test_put(request_options: {}, **params)
          params = Seed::Internal::Types::Utils.normalize_keys(params)
        ...
        #
        # @return [Boolean]
        def http_methods_test_delete(request_options: {}, **params)
          params = Seed::Internal::Types::Utils.normalize_keys(params)
          request = Seed::Internal::JSON::Request.new(
            base_url: request_options[:base_url],
            method: "DELETE",
        ...
        #
        # @return [Seed::Types::TypesObjectWithOptionalField]
        def http_methods_test_patch(request_options: {}, **params)
          params = Seed::Internal::Types::Utils.normalize_keys(params)
          path_param_names = %i[id]
          body_params = params.except(*path_param_names)
        ...
        #
        # @return [Seed::Types::TypesObjectWithOptionalField]
        def http_methods_test_post(request_options: {}, **params)
          params = Seed::Internal::Types::Utils.normalize_keys(params)
          request = Seed::Internal::JSON::Request.new(
            base_url: request_options[:base_url],
            method: "POST",
