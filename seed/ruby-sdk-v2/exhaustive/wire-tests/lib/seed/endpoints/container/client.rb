    ...
    module Container
      class Client
        ...
        def get_and_return_map_prim_to_prim(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Seed::Internal::Types::Utils.coerce(Internal::Types::Hash[String, String], (response.body.to_s.empty? ? nil : JSON.parse(response.body)))
          else
            error_class = Seed::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        def get_and_return_map_of_prim_to_object(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Seed::Internal::Types::Utils.coerce(Internal::Types::Hash[String, Seed::Types::Object_::Types::ObjectWithRequiredField], (response.body.to_s.empty? ? nil : JSON.parse(response.body)))
          else
            error_class = Seed::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        def get_and_return_map_of_prim_to_undiscriminated_union(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Seed::Internal::Types::Utils.coerce(Internal::Types::Hash[String, Seed::Types::Union::Types::MixedType], (response.body.to_s.empty? ? nil : JSON.parse(response.body)))
          else
            error_class = Seed::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
