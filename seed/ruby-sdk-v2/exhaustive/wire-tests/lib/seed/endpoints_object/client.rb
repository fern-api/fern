...
module Seed
  module EndpointsObject
    class Client
      ...
      def endpoints_object_get_and_return_with_optional_field(request_options: {}, **params)
      ...
      def endpoints_object_get_and_return_with_required_field(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
      ...
      def endpoints_object_get_and_return_with_map_of_map(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
      ...
      def endpoints_object_get_and_return_nested_with_optional_field(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
      ...
      def endpoints_object_get_and_return_nested_with_required_field(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
      ...
      #
      # @return [Seed::Types::TypesNestedObjectWithRequiredField]
      def endpoints_object_get_and_return_nested_with_required_field_as_list(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
      ...
      def endpoints_object_get_and_return_with_unknown_field(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
      ...
      def endpoints_object_get_and_return_with_documented_unknown_type(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
      ...
      def endpoints_object_get_and_return_map_of_documented_unknown_type(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
      ...
      #
      # @param request_options [Hash]
      # @param params [Seed::Types::TypesObjectWithMixedRequiredAndOptionalFields]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      #
      # @return [Seed::Types::TypesObjectWithMixedRequiredAndOptionalFields]
      def endpoints_object_get_and_return_with_mixed_required_and_optional_fields(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
          path: "object/get-and-return-with-mixed-required-and-optional-fields",
          body: Seed::Types::TypesObjectWithMixedRequiredAndOptionalFields.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Seed::Types::TypesObjectWithMixedRequiredAndOptionalFields.load(response.body)
        else
          error_class = Seed::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @param request_options [Hash]
      # @param params [Seed::Types::TypesObjectWithRequiredNestedObject]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      #
      # @return [Seed::Types::TypesObjectWithRequiredNestedObject]
      def endpoints_object_get_and_return_with_required_nested_object(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
          path: "object/get-and-return-with-required-nested-object",
          body: Seed::Types::TypesObjectWithRequiredNestedObject.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Seed::Types::TypesObjectWithRequiredNestedObject.load(response.body)
        else
          error_class = Seed::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      def endpoints_object_get_and_return_with_datetime_like_string(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
