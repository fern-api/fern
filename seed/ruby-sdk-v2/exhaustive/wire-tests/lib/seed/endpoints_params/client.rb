...
module Seed
  module EndpointsParams
    class Client
      ...
      #
      # @return [String]
      def endpoints_params_get_with_path(request_options: {}, **params)
      ...
      def endpoints_params_upload_with_path(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
      ...
      #
      # @return [String]
      def endpoints_params_modify_with_path(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
      ...
      #
      # @return [String]
      def endpoints_params_get_with_inline_path(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "GET",
      ...
      #
      # @return [String]
      def endpoints_params_modify_with_inline_path(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        path_param_names = %i[param]
        body_params = params.except(*path_param_names)
      ...
      #
      # @return [untyped]
      def endpoints_params_get_with_query(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
      ...
      # @option params [Integer, nil] :number
      #
      # @return [untyped]
      def endpoints_params_get_with_allow_multiple_query(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        query_param_names = %i[query number]
        query_params = {}
        query_params["query"] = params[:query] if params.key?(:query)
      ...
      #
      # @return [untyped]
      def endpoints_params_get_with_path_and_query(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
      ...
      #
      # @return [untyped]
      def endpoints_params_get_with_inline_path_and_query(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        query_param_names = %i[query]
        query_params = {}
        query_params["query"] = params[:query] if params.key?(:query)
      ...
      #
      # @return [String]
      def endpoints_params_get_with_boolean_path(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "GET",
      ...
      #
      # @return [String]
      def endpoints_params_get_with_path_and_errors(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "GET",
