  ...
  module Endpoints
    module Object_
      class Client
        ...
        # @option request_options [Integer] :timeout_in_seconds
        #
        # @return [FernExhaustive::Types::Object_::Types::ObjectWithRequiredField]
        def get_and_return_with_required_field(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            FernExhaustive::Types::Object_::Types::ObjectWithRequiredField.load(response.body)
          else
            error_class = FernExhaustive::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        # @param request_options [Hash]
        # @param params [FernExhaustive::Types::Object_::Types::ObjectWithMapOfMap]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        # @option request_options [Integer] :timeout_in_seconds
        #
        # @return [FernExhaustive::Types::Object_::Types::ObjectWithMapOfMap]
        def get_and_return_with_map_of_map(request_options: {}, **params)
          ...
          request = FernExhaustive::Internal::JSON::Request.new(
            ...
            body: FernExhaustive::Types::Object_::Types::ObjectWithMapOfMap.new(params).to_h,
            request_options: request_options
          )
          begin
            response = @client.send(request)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            FernExhaustive::Types::Object_::Types::ObjectWithMapOfMap.load(response.body)
          else
            error_class = FernExhaustive::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        # @param request_options [Hash]
        # @param params [FernExhaustive::Types::Object_::Types::NestedObjectWithOptionalField]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        # @option request_options [Integer] :timeout_in_seconds
        #
        # @return [FernExhaustive::Types::Object_::Types::NestedObjectWithOptionalField]
        def get_and_return_nested_with_optional_field(request_options: {}, **params)
          ...
          request = FernExhaustive::Internal::JSON::Request.new(
            ...
            body: FernExhaustive::Types::Object_::Types::NestedObjectWithOptionalField.new(params).to_h,
            request_options: request_options
          )
          begin
            response = @client.send(request)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            FernExhaustive::Types::Object_::Types::NestedObjectWithOptionalField.load(response.body)
          else
            error_class = FernExhaustive::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        # @param request_options [Hash]
        # @param params [FernExhaustive::Types::Object_::Types::NestedObjectWithRequiredField]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        #
        # @return [FernExhaustive::Types::Object_::Types::NestedObjectWithRequiredField]
        def get_and_return_nested_with_required_field(request_options: {}, **params)
          ...
          request = FernExhaustive::Internal::JSON::Request.new(
            ...
            body: FernExhaustive::Types::Object_::Types::NestedObjectWithRequiredField.new(params).to_h,
            request_options: request_options
          )
          begin
            response = @client.send(request)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            FernExhaustive::Types::Object_::Types::NestedObjectWithRequiredField.load(response.body)
          else
            error_class = FernExhaustive::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
