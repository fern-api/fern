...
client.endpoints_container.endpoints_container_get_and_return_list_of_primitives(request: ["string"])
```
...
begin
    result = client.endpoints_container.endpoints_container_get_and_return_list_of_primitives
...
response = client.endpoints_container.endpoints_container_get_and_return_list_of_primitives(
    ...,
