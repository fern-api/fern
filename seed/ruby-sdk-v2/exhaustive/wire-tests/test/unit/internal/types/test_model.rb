...
describe FernExhaustive::Internal::Types::Model do
  ...
  class ExampleModel < FernExhaustive::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernExhaustive::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernExhaustive::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernExhaustive::Internal::Types::Model
