...
describe FernExhaustive::Internal::Types::Union do
  class Rectangle < FernExhaustive::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernExhaustive::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernExhaustive::Internal::Types::Model
