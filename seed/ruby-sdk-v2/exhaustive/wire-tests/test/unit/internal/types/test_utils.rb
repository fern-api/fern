...
describe FernExhaustive::Internal::Types::Utils do
  Utils = FernExhaustive::Internal::Types::Utils

  module TestUtils
    class M < FernExhaustive::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernExhaustive::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernExhaustive::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernExhaustive::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernExhaustive::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernExhaustive::Internal::Types::Array[String]
      ModelArray = -> { FernExhaustive::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernExhaustive::Internal::Types::Array[TestUtils::U] }
