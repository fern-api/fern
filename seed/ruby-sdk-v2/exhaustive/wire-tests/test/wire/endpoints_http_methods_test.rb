...
class EndpointsHttpMethodsWireTest < WireMockTestCase
  ...
  def test_endpoints_http_methods_http_methods_test_get_with_wiremock
    ...
    @client.endpoints.http_methods.http_methods_test_get(
      ...
      request_options: {
        additional_headers: {
          "X-Test-Id" => "endpoints.http_methods.http_methods_test_get.0"
        }
      }
    )
  ...
  def test_endpoints_http_methods_http_methods_test_put_with_wiremock
    ...
    @client.endpoints.http_methods.http_methods_test_put(
      ...
      request_options: {
        additional_headers: {
          "X-Test-Id" => "endpoints.http_methods.http_methods_test_put.0"
        }
      }
    )
  ...
  def test_endpoints_http_methods_http_methods_test_delete_with_wiremock
    ...
    @client.endpoints.http_methods.http_methods_test_delete(
      ...
      request_options: {
        additional_headers: {
          "X-Test-Id" => "endpoints.http_methods.http_methods_test_delete.0"
        }
      }
    )
  ...
  def test_endpoints_http_methods_http_methods_test_patch_with_wiremock
    ...
    @client.endpoints.http_methods.http_methods_test_patch(
      ...
      request_options: {
        additional_headers: {
          "X-Test-Id" => "endpoints.http_methods.http_methods_test_patch.0"
        }
      }
    )
  ...
  def test_endpoints_http_methods_http_methods_test_post_with_wiremock
    ...
    @client.endpoints.http_methods.http_methods_test_post(
      ...
      request_options: {
        additional_headers: {
          "X-Test-Id" => "endpoints.http_methods.http_methods_test_post.0"
        }
      }
    )
