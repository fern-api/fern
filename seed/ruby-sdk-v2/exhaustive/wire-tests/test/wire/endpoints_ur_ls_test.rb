...
class EndpointsUrLsWireTest < WireMockTestCase
  ...
  def test_endpoints_ur_ls_endpoints_urls_with_mixed_case_with_wiremock
    test_id = "endpoints_ur_ls.endpoints_urls_with_mixed_case.0"

    @client.endpoints_ur_ls.endpoints_urls_with_mixed_case(request_options: {
                                                             additional_headers: {
  ...
  def test_endpoints_ur_ls_endpoints_urls_no_ending_slash_with_wiremock
    test_id = "endpoints_ur_ls.endpoints_urls_no_ending_slash.0"

    @client.endpoints_ur_ls.endpoints_urls_no_ending_slash(request_options: {
                                                             additional_headers: {
  ...
  def test_endpoints_ur_ls_endpoints_urls_with_ending_slash_with_wiremock
    test_id = "endpoints_ur_ls.endpoints_urls_with_ending_slash.0"

    @client.endpoints_ur_ls.endpoints_urls_with_ending_slash(request_options: {
                                                               additional_headers: {
  ...
  def test_endpoints_ur_ls_endpoints_urls_with_underscores_with_wiremock
    test_id = "endpoints_ur_ls.endpoints_urls_with_underscores.0"

    @client.endpoints_ur_ls.endpoints_urls_with_underscores(request_options: {
                                                              additional_headers: {
