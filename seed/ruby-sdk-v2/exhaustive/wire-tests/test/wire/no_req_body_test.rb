...
class NoReqBodyWireTest < Minitest::Test
  ...
  def test_no_req_body_get_with_no_request_body_with_wiremock
    ...
    client.no_req_body.get_with_no_request_body(request_options: { base_url: WIREMOCK_BASE_URL,
                                                                   additional_headers: {
  ...
  def test_no_req_body_post_with_no_request_body_with_wiremock
    ...
    require "seed"
    client = Seed::Client.new(base_url: WIREMOCK_BASE_URL, token: "<token>")
    client.no_req_body.post_with_no_request_body(request_options: { base_url: WIREMOCK_BASE_URL,
                                                                    additional_headers: {
