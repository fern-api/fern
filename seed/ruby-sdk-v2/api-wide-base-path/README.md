...
client = FernApiWideBasePath::Client.new(
...
rescue FernApiWideBasePath::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernApiWideBasePath::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernApiWideBasePath::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernApiWideBasePath::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernApiWideBasePath::Errors::ApiError => e
