...
require_relative "lib/fern_api_wide_base_path/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernApiWideBasePath"]
  spec.version = FernApiWideBasePath::VERSION
  spec.summary = "Ruby client library for the FernApiWideBasePath API"
  spec.description = "The FernApiWideBasePath Ruby library provides convenient access to the FernApiWideBasePath API from Ruby."
