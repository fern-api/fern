...
describe FernApiWideBasePath::Internal::Types::Utils do
  Utils = FernApiWideBasePath::Internal::Types::Utils

  module TestUtils
    class M < FernApiWideBasePath::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernApiWideBasePath::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernApiWideBasePath::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernApiWideBasePath::Internal::Types::Union
    ...
    SymbolStringHash = FernApiWideBasePath::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernApiWideBasePath::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernApiWideBasePath::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernApiWideBasePath::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernApiWideBasePath::Internal::Types::Array[String]
      ModelArray = -> { FernApiWideBasePath::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernApiWideBasePath::Internal::Types::Array[TestUtils::U] }
