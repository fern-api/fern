...
# require_relative "lib/api_wide_base_path/version"

Gem::Specification.new do |spec|
  spec.name = "api_wide_base_path"
  spec.version = "0.0.1" # TODO: api_wide_base_path::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the api_wide_base_path API"
  # spec.description = "The api_wide_base_path Ruby library provides convenient access to the api_wide_base_path API from Ruby."
