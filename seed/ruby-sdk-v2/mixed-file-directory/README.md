...
### Custom URL
```ruby
require "fern_mixed_file_directory"

client = FernMixedFileDirectory::Client.new(
...
rescue FernMixedFileDirectory::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernMixedFileDirectory::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernMixedFileDirectory::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernMixedFileDirectory::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernMixedFileDirectory::Errors::ApiError => e
