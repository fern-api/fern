...
# require_relative "lib/mixed_file_directory/version"

Gem::Specification.new do |spec|
  spec.name = "mixed_file_directory"
  spec.version = "0.0.1" # TODO: mixed_file_directory::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the mixed_file_directory API"
  # spec.description = "The mixed_file_directory Ruby library provides convenient access to the mixed_file_directory API from Ruby."
