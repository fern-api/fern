  ...
  module User
    module Events
      class Client
        ...
        #
        # @return [Array[FernMixedFileDirectory::User::Events::Types::Event]]
        ...
        # @return [FernMixedFileDirectory::Metadata::Client]
        def metadata
          @metadata ||= FernMixedFileDirectory::User::Events::Metadata::Client.new(client: @client)
        end
      end
    end
  end
