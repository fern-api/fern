...
describe FernMixedFileDirectory::Internal::Types::Model do
  ...
  class ExampleModel < FernMixedFileDirectory::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernMixedFileDirectory::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernMixedFileDirectory::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernMixedFileDirectory::Internal::Types::Model
