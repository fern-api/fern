...
describe FernMixedFileDirectory::Internal::Types::Utils do
  Utils = FernMixedFileDirectory::Internal::Types::Utils

  module TestUtils
    class M < FernMixedFileDirectory::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernMixedFileDirectory::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernMixedFileDirectory::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernMixedFileDirectory::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernMixedFileDirectory::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernMixedFileDirectory::Internal::Types::Array[String]
      ModelArray = -> { FernMixedFileDirectory::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernMixedFileDirectory::Internal::Types::Array[TestUtils::U] }
