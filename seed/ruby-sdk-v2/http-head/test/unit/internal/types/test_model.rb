...
describe FernHttpHead::Internal::Types::Model do
  module StringInteger
    extend FernHttpHead::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernHttpHead::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernHttpHead::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernHttpHead::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernHttpHead::Internal::Types::Model
