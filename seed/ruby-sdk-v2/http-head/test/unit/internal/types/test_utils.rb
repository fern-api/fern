...
describe FernHttpHead::Internal::Types::Utils do
  Utils = FernHttpHead::Internal::Types::Utils

  module TestUtils
    class M < FernHttpHead::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernHttpHead::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernHttpHead::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernHttpHead::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernHttpHead::Internal::Types::Array[String]
      ModelArray = -> { FernHttpHead::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernHttpHead::Internal::Types::Array[TestUtils::U] }
