...
describe FernHttpHead::Internal::Types::Union do
  class Rectangle < FernHttpHead::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernHttpHead::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernHttpHead::Internal::Types::Model
