...
require_relative "lib/fern_http_head/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernHttpHead"]
  spec.version = FernHttpHead::VERSION
  spec.summary = "Ruby client library for the FernHttpHead API"
  spec.description = "The FernHttpHead Ruby library provides convenient access to the FernHttpHead API from Ruby."
