...
### Custom URL
```ruby
require "fern_http_head"

client = FernHttpHead::Client.new(
...
rescue FernHttpHead::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernHttpHead::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernHttpHead::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernHttpHead::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernHttpHead::Errors::ApiError => e
