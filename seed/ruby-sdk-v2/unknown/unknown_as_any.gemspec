...
# require_relative "lib/unknown_as_any/version"

Gem::Specification.new do |spec|
  spec.name = "unknown_as_any"
  spec.version = "0.0.1" # TODO: unknown_as_any::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the unknown_as_any API"
  # spec.description = "The unknown_as_any Ruby library provides convenient access to the unknown_as_any API from Ruby."
