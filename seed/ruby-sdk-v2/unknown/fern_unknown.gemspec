...
require_relative "lib/fern_unknown/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernUnknown"]
  spec.version = FernUnknown::VERSION
  spec.summary = "Ruby client library for the FernUnknown API"
  spec.description = "The FernUnknown Ruby library provides convenient access to the FernUnknown API from Ruby."
