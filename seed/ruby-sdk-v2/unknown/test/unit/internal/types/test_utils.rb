...
describe FernUnknown::Internal::Types::Utils do
  Utils = FernUnknown::Internal::Types::Utils

  module TestUtils
    class M < FernUnknown::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernUnknown::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernUnknown::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernUnknown::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernUnknown::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernUnknown::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernUnknown::Internal::Types::Array[TestUtils::U] }
