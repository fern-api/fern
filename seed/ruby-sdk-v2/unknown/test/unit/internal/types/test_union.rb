...
describe FernUnknown::Internal::Types::Union do
  class Rectangle < FernUnknown::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernUnknown::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernUnknown::Internal::Types::Model
  ...
  module Shape
    extend FernUnknown::Internal::Types::Union
