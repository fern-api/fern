...
describe FernClientSideParams::Internal::Types::Utils do
  Utils = FernClientSideParams::Internal::Types::Utils

  module TestUtils
    class M < FernClientSideParams::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernClientSideParams::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernClientSideParams::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernClientSideParams::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernClientSideParams::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernClientSideParams::Internal::Types::Array[String]
      ModelArray = -> { FernClientSideParams::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernClientSideParams::Internal::Types::Array[TestUtils::U] }
