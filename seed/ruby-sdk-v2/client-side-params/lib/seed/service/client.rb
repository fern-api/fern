    ...
    class Client
      ...
      def list_resources(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          Seed::Internal::Types::Utils.coerce(Internal::Types::Array[Seed::Types::Types::Resource], JSON.parse(response.body, symbolize_names: true))
        else
      ...
      def list_connections(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Seed::Internal::Types::Utils.coerce(Internal::Types::Array[Seed::Types::Types::Connection], JSON.parse(response.body, symbolize_names: true))
        else
          error_class = Seed::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
