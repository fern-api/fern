...
### Custom URL
```ruby
require "fern_client_side_params"

client = FernClientSideParams::Client.new(
...
rescue FernClientSideParams::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernClientSideParams::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernClientSideParams::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernClientSideParams::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernClientSideParams::Errors::ApiError => e
