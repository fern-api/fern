...
# require_relative "lib/client_side_params/version"

Gem::Specification.new do |spec|
  spec.name = "client_side_params"
  spec.version = "0.0.1" # TODO: client_side_params::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the client_side_params API"
  # spec.description = "The client_side_params Ruby library provides convenient access to the client_side_params API from Ruby."
