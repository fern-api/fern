...
module FernOauthClientCredentialsEnvironmentVariables
  module Internal
    module Multipart
      # @api private
      class Request < FernOauthClientCredentialsEnvironmentVariables::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernOauthClientCredentialsEnvironmentVariables::RequestOptions, Hash{Symbol=>Object}, nil]
