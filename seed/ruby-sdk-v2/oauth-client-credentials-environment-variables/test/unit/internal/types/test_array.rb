...
describe FernOauthClientCredentialsEnvironmentVariables::Internal::Types::Array do
  module TestArray
    StringArray = FernOauthClientCredentialsEnvironmentVariables::Internal::Types::Array[String]
  end
