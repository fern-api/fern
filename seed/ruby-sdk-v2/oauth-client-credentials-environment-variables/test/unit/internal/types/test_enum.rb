...
describe FernOauthClientCredentialsEnvironmentVariables::Internal::Types::Enum do
  module EnumTest
    module ExampleEnum
      extend FernOauthClientCredentialsEnvironmentVariables::Internal::Types::Enum
