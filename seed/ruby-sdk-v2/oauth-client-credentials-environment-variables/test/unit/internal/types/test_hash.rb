...
describe FernOauthClientCredentialsEnvironmentVariables::Internal::Types::Hash do
  module TestHash
    SymbolStringHash = FernOauthClientCredentialsEnvironmentVariables::Internal::Types::Hash[Symbol, String]
  end
