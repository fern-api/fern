...
describe FernPropertyAccess::Internal::Types::Union do
  class Rectangle < FernPropertyAccess::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernPropertyAccess::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernPropertyAccess::Internal::Types::Model
