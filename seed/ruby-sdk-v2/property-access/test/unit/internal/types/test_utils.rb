...
describe FernPropertyAccess::Internal::Types::Utils do
  Utils = FernPropertyAccess::Internal::Types::Utils

  module TestUtils
    class M < FernPropertyAccess::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernPropertyAccess::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernPropertyAccess::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernPropertyAccess::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernPropertyAccess::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernPropertyAccess::Internal::Types::Array[String]
      ModelArray = -> { FernPropertyAccess::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernPropertyAccess::Internal::Types::Array[TestUtils::U] }
