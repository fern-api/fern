...
describe FernPropertyAccess::Internal::Types::Model do
  ...
  class ExampleModel < FernPropertyAccess::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernPropertyAccess::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernPropertyAccess::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernPropertyAccess::Internal::Types::Model
