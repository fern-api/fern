...
require_relative "lib/fern_property_access/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_property_access"
  spec.authors = ["FernPropertyAccess"]
  spec.version = FernPropertyAccess::VERSION
  spec.summary = "Ruby client library for the FernPropertyAccess API"
  spec.description = "The FernPropertyAccess Ruby library provides convenient access to the FernPropertyAccess API from Ruby."
