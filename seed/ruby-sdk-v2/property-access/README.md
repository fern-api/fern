...
### Custom URL
```ruby
require "fern_property_access"

client = FernPropertyAccess::Client.new(
...
rescue FernPropertyAccess::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernPropertyAccess::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernPropertyAccess::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernPropertyAccess::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernPropertyAccess::Errors::ApiError => e
