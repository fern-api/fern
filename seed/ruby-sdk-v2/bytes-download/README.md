...
### Custom URL
```ruby
require "fern_bytes_download"

client = FernBytesDownload::Client.new(
...
rescue FernBytesDownload::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernBytesDownload::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernBytesDownload::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernBytesDownload::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernBytesDownload::Errors::ApiError => e
