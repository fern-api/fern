...
# require_relative "lib/bytes_download/version"

Gem::Specification.new do |spec|
  spec.name = "bytes_download"
  spec.version = "0.0.1" # TODO: bytes_download::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the bytes_download API"
  # spec.description = "The bytes_download Ruby library provides convenient access to the bytes_download API from Ruby."
