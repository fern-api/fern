...
require_relative "lib/fern_bytes_download/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernBytesDownload"]
  spec.version = FernBytesDownload::VERSION
  spec.summary = "Ruby client library for the FernBytesDownload API"
  spec.description = "The FernBytesDownload Ruby library provides convenient access to the FernBytesDownload API from Ruby."
