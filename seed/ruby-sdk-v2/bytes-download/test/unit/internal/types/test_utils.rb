...
describe FernBytesDownload::Internal::Types::Utils do
  Utils = FernBytesDownload::Internal::Types::Utils

  module TestUtils
    class M < FernBytesDownload::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernBytesDownload::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernBytesDownload::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernBytesDownload::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernBytesDownload::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernBytesDownload::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernBytesDownload::Internal::Types::Array[String]
      ModelArray = -> { FernBytesDownload::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernBytesDownload::Internal::Types::Array[TestUtils::U] }
