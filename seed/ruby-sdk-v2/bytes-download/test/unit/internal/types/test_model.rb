...
describe FernBytesDownload::Internal::Types::Model do
  ...
  class ExampleModel < FernBytesDownload::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernBytesDownload::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernBytesDownload::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernBytesDownload::Internal::Types::Model
