...
# require_relative "lib/server_sent_events/version"

Gem::Specification.new do |spec|
  spec.name = "server_sent_events"
  spec.version = "0.0.1" # TODO: server_sent_events::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the server_sent_events API"
  # spec.description = "The server_sent_events Ruby library provides convenient access to the server_sent_events API from Ruby."
