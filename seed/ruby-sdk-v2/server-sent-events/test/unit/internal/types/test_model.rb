...
describe FernServerSentEvents::Internal::Types::Model do
  module StringInteger
    extend FernServerSentEvents::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernServerSentEvents::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernServerSentEvents::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernServerSentEvents::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernServerSentEvents::Internal::Types::Model
