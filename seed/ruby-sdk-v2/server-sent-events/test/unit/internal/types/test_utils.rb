...
describe FernServerSentEvents::Internal::Types::Utils do
  Utils = FernServerSentEvents::Internal::Types::Utils

  module TestUtils
    class M < FernServerSentEvents::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernServerSentEvents::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernServerSentEvents::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernServerSentEvents::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernServerSentEvents::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernServerSentEvents::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernServerSentEvents::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernServerSentEvents::Internal::Types::Array[TestUtils::U] }
