...
describe FernServerSentEvents::Internal::Types::Union do
  class Rectangle < FernServerSentEvents::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernServerSentEvents::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernServerSentEvents::Internal::Types::Model
