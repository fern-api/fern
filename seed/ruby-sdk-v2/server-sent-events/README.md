...
### Custom URL
```ruby
require "fern_server_sent_events"

client = FernServerSentEvents::Client.new(
...
rescue FernServerSentEvents::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernServerSentEvents::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernServerSentEvents::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernServerSentEvents::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernServerSentEvents::Errors::ApiError => e
