...
require_relative "lib/fern_literals_unions/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_literals_unions"
  spec.authors = ["FernLiteralsUnions"]
  spec.version = FernLiteralsUnions::VERSION
  spec.summary = "Ruby client library for the FernLiteralsUnions API"
  spec.description = "The FernLiteralsUnions Ruby library provides convenient access to the FernLiteralsUnions API from Ruby."
