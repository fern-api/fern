...
# require_relative "lib/literals_unions/version"

Gem::Specification.new do |spec|
  spec.name = "literals_unions"
  spec.version = "0.0.1" # TODO: literals_unions::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the literals_unions API"
  # spec.description = "The literals_unions Ruby library provides convenient access to the literals_unions API from Ruby."
