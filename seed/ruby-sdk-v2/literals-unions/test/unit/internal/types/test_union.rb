...
describe FernLiteralsUnions::Internal::Types::Union do
  class Rectangle < FernLiteralsUnions::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernLiteralsUnions::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernLiteralsUnions::Internal::Types::Model
