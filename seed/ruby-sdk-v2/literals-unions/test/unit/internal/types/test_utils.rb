...
describe FernLiteralsUnions::Internal::Types::Utils do
  Utils = FernLiteralsUnions::Internal::Types::Utils

  module TestUtils
    class M < FernLiteralsUnions::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernLiteralsUnions::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernLiteralsUnions::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernLiteralsUnions::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernLiteralsUnions::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernLiteralsUnions::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernLiteralsUnions::Internal::Types::Array[TestUtils::U] }
