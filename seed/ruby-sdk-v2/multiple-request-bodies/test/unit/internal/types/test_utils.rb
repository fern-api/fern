...
describe FernMultipleRequestBodies::Internal::Types::Utils do
  Utils = FernMultipleRequestBodies::Internal::Types::Utils

  module TestUtils
    class M < FernMultipleRequestBodies::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernMultipleRequestBodies::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernMultipleRequestBodies::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernMultipleRequestBodies::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernMultipleRequestBodies::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernMultipleRequestBodies::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernMultipleRequestBodies::Internal::Types::Array[TestUtils::U] }
