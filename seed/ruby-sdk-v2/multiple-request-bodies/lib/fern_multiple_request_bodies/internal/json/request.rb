...
module FernMultipleRequestBodies
  module Internal
    module JSON
      # @api private
      class Request < FernMultipleRequestBodies::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernMultipleRequestBodies::RequestOptions, Hash{Symbol=>Object}, nil]
