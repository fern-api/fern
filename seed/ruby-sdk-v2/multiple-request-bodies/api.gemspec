...
Gem::Specification.new do |spec|
  spec.name = "api"
  spec.version = "0.0.1" # TODO: api::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the api API"
  # spec.description = "The api Ruby library provides convenient access to the api API from Ruby."
