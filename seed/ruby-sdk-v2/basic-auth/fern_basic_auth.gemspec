...
require_relative "lib/fern_basic_auth/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernBasicAuth"]
  spec.version = FernBasicAuth::VERSION
  spec.summary = "Ruby client library for the FernBasicAuth API"
  spec.description = "The FernBasicAuth Ruby library provides convenient access to the FernBasicAuth API from Ruby."
