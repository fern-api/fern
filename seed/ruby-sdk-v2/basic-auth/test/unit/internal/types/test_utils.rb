...
describe FernBasicAuth::Internal::Types::Utils do
  Utils = FernBasicAuth::Internal::Types::Utils

  module TestUtils
    class M < FernBasicAuth::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernBasicAuth::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernBasicAuth::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernBasicAuth::Internal::Types::Union
    ...
    SymbolStringHash = FernBasicAuth::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernBasicAuth::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernBasicAuth::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernBasicAuth::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernBasicAuth::Internal::Types::Array[String]
      ModelArray = -> { FernBasicAuth::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernBasicAuth::Internal::Types::Array[TestUtils::U] }
