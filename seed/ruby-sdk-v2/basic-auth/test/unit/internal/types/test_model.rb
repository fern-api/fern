...
describe FernBasicAuth::Internal::Types::Model do
  ...
  class ExampleModel < FernBasicAuth::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernBasicAuth::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernBasicAuth::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernBasicAuth::Internal::Types::Model
