...
describe FernBasicAuth::Internal::Types::Union do
  class Rectangle < FernBasicAuth::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernBasicAuth::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernBasicAuth::Internal::Types::Model
