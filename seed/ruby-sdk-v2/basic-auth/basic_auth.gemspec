...
# require_relative "lib/basic_auth/version"

Gem::Specification.new do |spec|
  spec.name = "basic_auth"
  spec.version = "0.0.1" # TODO: basic_auth::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the basic_auth API"
  # spec.description = "The basic_auth Ruby library provides convenient access to the basic_auth API from Ruby."
