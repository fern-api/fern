...
describe FernFolders::Internal::Types::Model do
  ...
  class ExampleModel < FernFolders::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernFolders::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernFolders::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernFolders::Internal::Types::Model
