...
describe FernFolders::Internal::Types::Union do
  class Rectangle < FernFolders::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernFolders::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernFolders::Internal::Types::Model
