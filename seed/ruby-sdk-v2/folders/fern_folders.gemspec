...
require_relative "lib/fern_folders/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernFolders"]
  spec.version = FernFolders::VERSION
  spec.summary = "Ruby client library for the FernFolders API"
  spec.description = "The FernFolders Ruby library provides convenient access to the FernFolders API from Ruby."
