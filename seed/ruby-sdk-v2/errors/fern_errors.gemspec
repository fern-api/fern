...
require_relative "lib/fern_errors/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernErrors"]
  spec.version = FernErrors::VERSION
  spec.summary = "Ruby client library for the FernErrors API"
  spec.description = "The FernErrors Ruby library provides convenient access to the FernErrors API from Ruby."
