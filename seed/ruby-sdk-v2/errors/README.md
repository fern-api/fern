...
begin
    result = client.simple.foo_without_endpoint_error
rescue FernErrors::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernErrors::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernErrors::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernErrors::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernErrors::Errors::ApiError => e
...
response = client.simple.foo_without_endpoint_error(
    ...,
