...
describe FernErrors::Internal::Types::Union do
  class Rectangle < FernErrors::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernErrors::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernErrors::Internal::Types::Model
