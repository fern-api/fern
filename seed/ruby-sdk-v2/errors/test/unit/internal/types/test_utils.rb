...
describe FernErrors::Internal::Types::Utils do
  Utils = FernErrors::Internal::Types::Utils

  module TestUtils
    class M < FernErrors::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernErrors::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernErrors::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernErrors::Internal::Types::Union
    ...
    SymbolStringHash = FernErrors::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernErrors::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernErrors::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernErrors::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernErrors::Internal::Types::Array[String]
      ModelArray = -> { FernErrors::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernErrors::Internal::Types::Array[TestUtils::U] }
