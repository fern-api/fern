...
describe FernIdempotencyHeaders::Internal::Types::Model do
  ...
  class ExampleModel < FernIdempotencyHeaders::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernIdempotencyHeaders::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernIdempotencyHeaders::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernIdempotencyHeaders::Internal::Types::Model
