...
describe FernIdempotencyHeaders::Internal::Types::Utils do
  Utils = FernIdempotencyHeaders::Internal::Types::Utils

  module TestUtils
    class M < FernIdempotencyHeaders::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernIdempotencyHeaders::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernIdempotencyHeaders::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernIdempotencyHeaders::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernIdempotencyHeaders::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernIdempotencyHeaders::Internal::Types::Array[TestUtils::U] }
