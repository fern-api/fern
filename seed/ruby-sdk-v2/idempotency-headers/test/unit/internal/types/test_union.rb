...
describe FernIdempotencyHeaders::Internal::Types::Union do
  class Rectangle < FernIdempotencyHeaders::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernIdempotencyHeaders::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernIdempotencyHeaders::Internal::Types::Model
