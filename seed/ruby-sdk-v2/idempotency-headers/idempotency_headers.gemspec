...
# require_relative "lib/idempotency_headers/version"

Gem::Specification.new do |spec|
  spec.name = "idempotency_headers"
  spec.version = "0.0.1" # TODO: idempotency_headers::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the idempotency_headers API"
  # spec.description = "The idempotency_headers Ruby library provides convenient access to the idempotency_headers API from Ruby."
