...
require_relative "lib/fern_idempotency_headers/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernIdempotencyHeaders"]
  spec.version = FernIdempotencyHeaders::VERSION
  spec.summary = "Ruby client library for the FernIdempotencyHeaders API"
  spec.description = "The FernIdempotencyHeaders Ruby library provides convenient access to the FernIdempotencyHeaders API from Ruby."
