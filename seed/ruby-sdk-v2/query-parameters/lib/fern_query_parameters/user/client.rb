...
module FernQueryParameters
  module User
    class Client
      # @param client [FernQueryParameters::Internal::Http::RawClient]
      #
      # @return [void]
      ...
      # @option params [FernQueryParameters::User::Types::User] :user
      # @option params [Array[FernQueryParameters::User::Types::User]] :user_list
      ...
      # @option params [FernQueryParameters::User::Types::NestedUser] :nested_user
      # @option params [FernQueryParameters::User::Types::User, nil] :optional_user
      # @option params [FernQueryParameters::User::Types::User] :exclude_user
      # @option params [String] :filter
      #
      # @return [FernQueryParameters::User::Types::User]
      def get_username(request_options: {}, **params)
        params = FernQueryParameters::Internal::Types::Utils.normalize_keys(params)
        ...
        request = FernQueryParameters::Internal::JSON::Request.new(
        ...
        begin
          ...
          raise FernQueryParameters::Errors::TimeoutError
        end
        code = response.code.to_i
        if code.between?(200, 299)
          FernQueryParameters::User::Types::User.load(response.body)
        else
          error_class = FernQueryParameters::Errors::ResponseError.subclass_for_code(code)
