...
# require_relative "lib/query_parameters/version"

Gem::Specification.new do |spec|
  spec.name = "query_parameters"
  spec.version = "0.0.1" # TODO: query_parameters::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the query_parameters API"
  # spec.description = "The query_parameters Ruby library provides convenient access to the query_parameters API from Ruby."
