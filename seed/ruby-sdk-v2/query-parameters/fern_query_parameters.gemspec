...
require_relative "lib/fern_query_parameters/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernQueryParameters"]
  spec.version = FernQueryParameters::VERSION
  spec.summary = "Ruby client library for the FernQueryParameters API"
  spec.description = "The FernQueryParameters Ruby library provides convenient access to the FernQueryParameters API from Ruby."
