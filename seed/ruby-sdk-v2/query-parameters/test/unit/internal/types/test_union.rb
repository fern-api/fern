...
describe FernQueryParameters::Internal::Types::Union do
  class Rectangle < FernQueryParameters::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernQueryParameters::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernQueryParameters::Internal::Types::Model
