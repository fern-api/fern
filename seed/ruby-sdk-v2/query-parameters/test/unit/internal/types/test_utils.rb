...
describe FernQueryParameters::Internal::Types::Utils do
  Utils = FernQueryParameters::Internal::Types::Utils

  module TestUtils
    class M < FernQueryParameters::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernQueryParameters::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernQueryParameters::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernQueryParameters::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernQueryParameters::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernQueryParameters::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernQueryParameters::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernQueryParameters::Internal::Types::Array[TestUtils::U] }
