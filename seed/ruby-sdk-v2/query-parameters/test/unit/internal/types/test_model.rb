...
describe FernQueryParameters::Internal::Types::Model do
  ...
  class ExampleModel < FernQueryParameters::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernQueryParameters::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernQueryParameters::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernQueryParameters::Internal::Types::Model
