...
describe FernOauthClientCredentialsNestedRoot::Internal::Types::Utils do
  Utils = FernOauthClientCredentialsNestedRoot::Internal::Types::Utils

  module TestUtils
    class M < FernOauthClientCredentialsNestedRoot::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernOauthClientCredentialsNestedRoot::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernOauthClientCredentialsNestedRoot::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernOauthClientCredentialsNestedRoot::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernOauthClientCredentialsNestedRoot::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernOauthClientCredentialsNestedRoot::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernOauthClientCredentialsNestedRoot::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernOauthClientCredentialsNestedRoot::Internal::Types::Array[String]
      ModelArray = -> { FernOauthClientCredentialsNestedRoot::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernOauthClientCredentialsNestedRoot::Internal::Types::Array[TestUtils::U] }
