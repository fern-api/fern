...
describe FernOauthClientCredentialsNestedRoot::Internal::Types::Union do
  class Rectangle < FernOauthClientCredentialsNestedRoot::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernOauthClientCredentialsNestedRoot::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernOauthClientCredentialsNestedRoot::Internal::Types::Model
