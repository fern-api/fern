...
module FernOauthClientCredentialsNestedRoot
  module Internal
    module Types
      ...
      module Union
        include FernOauthClientCredentialsNestedRoot::Internal::Types::Type
        ...
        private def type_matches?(value, member_type)
          case member_type
          when FernOauthClientCredentialsNestedRoot::Internal::Types::Hash
            value.is_a?(::Hash)
          when FernOauthClientCredentialsNestedRoot::Internal::Types::Array
            value.is_a?(::Array)
          when Class, Module
