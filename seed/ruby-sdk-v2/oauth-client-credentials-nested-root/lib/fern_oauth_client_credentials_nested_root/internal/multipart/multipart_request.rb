...
module FernOauthClientCredentialsNestedRoot
  module Internal
    module Multipart
      # @api private
      class Request < FernOauthClientCredentialsNestedRoot::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernOauthClientCredentialsNestedRoot::RequestOptions, Hash{Symbol=>Object}, nil]
