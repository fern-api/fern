...
### Custom URL
```ruby
require "fern_query_parameters_openapi"

client = FernQueryParametersOpenapi::Client.new(
...
rescue FernQueryParametersOpenapi::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernQueryParametersOpenapi::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernQueryParametersOpenapi::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernQueryParametersOpenapi::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernQueryParametersOpenapi::Errors::ApiError => e
