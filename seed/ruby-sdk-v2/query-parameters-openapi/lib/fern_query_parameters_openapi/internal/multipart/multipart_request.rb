...
module FernQueryParametersOpenapi
  module Internal
    module Multipart
      # @api private
      class Request < FernQueryParametersOpenapi::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernQueryParametersOpenapi::RequestOptions, Hash{Symbol=>Object}, nil]
