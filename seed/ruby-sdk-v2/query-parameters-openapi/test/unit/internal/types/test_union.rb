...
describe FernQueryParametersOpenapi::Internal::Types::Union do
  class Rectangle < FernQueryParametersOpenapi::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernQueryParametersOpenapi::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernQueryParametersOpenapi::Internal::Types::Model
