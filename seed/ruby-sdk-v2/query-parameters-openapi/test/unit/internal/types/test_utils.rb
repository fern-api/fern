...
describe FernQueryParametersOpenapi::Internal::Types::Utils do
  Utils = FernQueryParametersOpenapi::Internal::Types::Utils

  module TestUtils
    class M < FernQueryParametersOpenapi::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernQueryParametersOpenapi::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernQueryParametersOpenapi::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernQueryParametersOpenapi::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernQueryParametersOpenapi::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernQueryParametersOpenapi::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernQueryParametersOpenapi::Internal::Types::Array[String]
      ModelArray = -> { FernQueryParametersOpenapi::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernQueryParametersOpenapi::Internal::Types::Array[TestUtils::U] }
