...
### Custom URL
```ruby
require "fern_oauth_client_credentials_with_variables"

client = FernOauthClientCredentialsWithVariables::Client.new(
...
rescue FernOauthClientCredentialsWithVariables::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernOauthClientCredentialsWithVariables::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernOauthClientCredentialsWithVariables::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernOauthClientCredentialsWithVariables::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernOauthClientCredentialsWithVariables::Errors::ApiError => e
