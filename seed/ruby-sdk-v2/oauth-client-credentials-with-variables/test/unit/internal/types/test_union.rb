...
describe FernOauthClientCredentialsWithVariables::Internal::Types::Union do
  class Rectangle < FernOauthClientCredentialsWithVariables::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernOauthClientCredentialsWithVariables::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernOauthClientCredentialsWithVariables::Internal::Types::Model
