...
describe FernOauthClientCredentialsWithVariables::Internal::Types::Utils do
  Utils = FernOauthClientCredentialsWithVariables::Internal::Types::Utils

  module TestUtils
    class M < FernOauthClientCredentialsWithVariables::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernOauthClientCredentialsWithVariables::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernOauthClientCredentialsWithVariables::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernOauthClientCredentialsWithVariables::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernOauthClientCredentialsWithVariables::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernOauthClientCredentialsWithVariables::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernOauthClientCredentialsWithVariables::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernOauthClientCredentialsWithVariables::Internal::Types::Array[String]
      ModelArray = -> { FernOauthClientCredentialsWithVariables::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernOauthClientCredentialsWithVariables::Internal::Types::Array[TestUtils::U] }
