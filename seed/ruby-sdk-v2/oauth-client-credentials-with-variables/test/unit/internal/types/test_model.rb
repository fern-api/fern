...
describe FernOauthClientCredentialsWithVariables::Internal::Types::Model do
  module StringInteger
    extend FernOauthClientCredentialsWithVariables::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernOauthClientCredentialsWithVariables::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernOauthClientCredentialsWithVariables::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernOauthClientCredentialsWithVariables::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernOauthClientCredentialsWithVariables::Internal::Types::Model
