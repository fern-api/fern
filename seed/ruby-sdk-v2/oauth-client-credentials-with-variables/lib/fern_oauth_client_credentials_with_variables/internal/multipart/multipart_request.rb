...
module FernOauthClientCredentialsWithVariables
  module Internal
    module Multipart
      # @api private
      class Request < FernOauthClientCredentialsWithVariables::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernOauthClientCredentialsWithVariables::RequestOptions, Hash{Symbol=>Object}, nil]
