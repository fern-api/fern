...
# require_relative "lib/streaming/version"

Gem::Specification.new do |spec|
  spec.name = "streaming"
  spec.version = "0.0.1" # TODO: streaming::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the streaming API"
  # spec.description = "The streaming Ruby library provides convenient access to the streaming API from Ruby."
