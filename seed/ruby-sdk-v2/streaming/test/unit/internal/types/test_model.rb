...
describe FernStreaming::Internal::Types::Model do
  ...
  class ExampleModel < FernStreaming::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernStreaming::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernStreaming::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernStreaming::Internal::Types::Model
