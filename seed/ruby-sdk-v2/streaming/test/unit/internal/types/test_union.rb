...
describe FernStreaming::Internal::Types::Union do
  class Rectangle < FernStreaming::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernStreaming::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernStreaming::Internal::Types::Model
