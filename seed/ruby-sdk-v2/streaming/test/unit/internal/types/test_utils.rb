...
describe FernStreaming::Internal::Types::Utils do
  Utils = FernStreaming::Internal::Types::Utils

  module TestUtils
    class M < FernStreaming::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernStreaming::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernStreaming::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernStreaming::Internal::Types::Union
    ...
    SymbolStringHash = FernStreaming::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernStreaming::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernStreaming::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernStreaming::Internal::Types::Array[String]
      ModelArray = -> { FernStreaming::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernStreaming::Internal::Types::Array[TestUtils::U] }
