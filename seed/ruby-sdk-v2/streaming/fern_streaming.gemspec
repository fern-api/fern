...
require_relative "lib/fern_streaming/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_streaming"
  spec.authors = ["FernStreaming"]
  spec.version = FernStreaming::VERSION
  spec.summary = "Ruby client library for the FernStreaming API"
  spec.description = "The FernStreaming Ruby library provides convenient access to the FernStreaming API from Ruby."
