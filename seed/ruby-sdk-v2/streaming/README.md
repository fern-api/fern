...
client = FernStreaming::Client.new(
...
begin
    result = client.dummy.generate_stream
rescue FernStreaming::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernStreaming::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernStreaming::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernStreaming::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernStreaming::Errors::ApiError => e
