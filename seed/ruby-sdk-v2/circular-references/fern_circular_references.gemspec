...
require_relative "lib/fern_circular_references/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernCircularReferences"]
  spec.version = FernCircularReferences::VERSION
  spec.summary = "Ruby client library for the FernCircularReferences API"
  spec.description = "The FernCircularReferences Ruby library provides convenient access to the FernCircularReferences API from Ruby."
