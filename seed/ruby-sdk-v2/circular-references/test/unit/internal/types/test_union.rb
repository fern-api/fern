...
describe FernCircularReferences::Internal::Types::Union do
  class Rectangle < FernCircularReferences::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernCircularReferences::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernCircularReferences::Internal::Types::Model
