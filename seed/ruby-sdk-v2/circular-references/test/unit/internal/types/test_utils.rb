...
describe FernCircularReferences::Internal::Types::Utils do
  Utils = FernCircularReferences::Internal::Types::Utils

  module TestUtils
    class M < FernCircularReferences::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernCircularReferences::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernCircularReferences::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernCircularReferences::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernCircularReferences::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernCircularReferences::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernCircularReferences::Internal::Types::Array[TestUtils::U] }
