...
client = FernFileDownload::Client.new(
...
rescue FernFileDownload::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernFileDownload::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernFileDownload::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernFileDownload::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernFileDownload::Errors::ApiError => e
