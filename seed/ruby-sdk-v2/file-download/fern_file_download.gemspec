...
require_relative "lib/fern_file_download/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_file_download"
  spec.authors = ["FernFileDownload"]
  spec.version = FernFileDownload::VERSION
  spec.summary = "Ruby client library for the FernFileDownload API"
  spec.description = "The FernFileDownload Ruby library provides convenient access to the FernFileDownload API from Ruby."
