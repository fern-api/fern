...
# require_relative "lib/file_download/version"

Gem::Specification.new do |spec|
  spec.name = "file_download"
  spec.version = "0.0.1" # TODO: file_download::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the file_download API"
  # spec.description = "The file_download Ruby library provides convenient access to the file_download API from Ruby."
