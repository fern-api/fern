...
describe FernFileDownload::Internal::Types::Union do
  class Rectangle < FernFileDownload::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernFileDownload::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernFileDownload::Internal::Types::Model
