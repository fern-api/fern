...
require_relative "lib/fern_accept_header/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_accept_header"
  spec.authors = ["FernAcceptHeader"]
  spec.version = FernAcceptHeader::VERSION
  spec.summary = "Ruby client library for the FernAcceptHeader API"
  spec.description = "The FernAcceptHeader Ruby library provides convenient access to the FernAcceptHeader API from Ruby."
