...
### Custom URL
```ruby
require "fern_accept_header"

client = FernAcceptHeader::Client.new(
...
rescue FernAcceptHeader::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernAcceptHeader::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernAcceptHeader::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernAcceptHeader::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernAcceptHeader::Errors::ApiError => e
