...
# require_relative "lib/accept/version"

Gem::Specification.new do |spec|
  spec.name = "accept"
  spec.version = "0.0.1" # TODO: accept::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the accept API"
  # spec.description = "The accept Ruby library provides convenient access to the accept API from Ruby."
