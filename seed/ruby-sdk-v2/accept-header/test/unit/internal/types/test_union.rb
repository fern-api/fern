...
describe FernAcceptHeader::Internal::Types::Union do
  class Rectangle < FernAcceptHeader::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernAcceptHeader::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernAcceptHeader::Internal::Types::Model
