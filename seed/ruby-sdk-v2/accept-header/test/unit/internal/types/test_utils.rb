...
describe FernAcceptHeader::Internal::Types::Utils do
  Utils = FernAcceptHeader::Internal::Types::Utils

  module TestUtils
    class M < FernAcceptHeader::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernAcceptHeader::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernAcceptHeader::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernAcceptHeader::Internal::Types::Union
    ...
    SymbolStringHash = FernAcceptHeader::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernAcceptHeader::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernAcceptHeader::Internal::Types::Array[String]
      ModelArray = -> { FernAcceptHeader::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernAcceptHeader::Internal::Types::Array[TestUtils::U] }
