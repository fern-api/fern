...
fern_multi_url_environment_no_default = FernMultiUrlEnvironmentNoDefault::Client.new(
    base_url: FernMultiUrlEnvironmentNoDefault::Environment::PRODUCTION
)
```
...
client = FernMultiUrlEnvironmentNoDefault::Client.new(
...
rescue FernMultiUrlEnvironmentNoDefault::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernMultiUrlEnvironmentNoDefault::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernMultiUrlEnvironmentNoDefault::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernMultiUrlEnvironmentNoDefault::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernMultiUrlEnvironmentNoDefault::Errors::ApiError => e
