...
describe FernMultiUrlEnvironmentNoDefault::Internal::Types::Utils do
  Utils = FernMultiUrlEnvironmentNoDefault::Internal::Types::Utils

  module TestUtils
    class M < FernMultiUrlEnvironmentNoDefault::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernMultiUrlEnvironmentNoDefault::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernMultiUrlEnvironmentNoDefault::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernMultiUrlEnvironmentNoDefault::Internal::Types::Union
    ...
    SymbolStringHash = FernMultiUrlEnvironmentNoDefault::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernMultiUrlEnvironmentNoDefault::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernMultiUrlEnvironmentNoDefault::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernMultiUrlEnvironmentNoDefault::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernMultiUrlEnvironmentNoDefault::Internal::Types::Array[String]
      ModelArray = -> { FernMultiUrlEnvironmentNoDefault::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernMultiUrlEnvironmentNoDefault::Internal::Types::Array[TestUtils::U] }
