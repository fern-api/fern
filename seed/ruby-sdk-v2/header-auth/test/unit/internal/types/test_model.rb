...
describe FernHeaderAuth::Internal::Types::Model do
  ...
  class ExampleModel < FernHeaderAuth::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernHeaderAuth::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernHeaderAuth::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernHeaderAuth::Internal::Types::Model
