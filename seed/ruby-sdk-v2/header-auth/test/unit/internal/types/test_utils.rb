...
describe FernHeaderAuth::Internal::Types::Utils do
  Utils = FernHeaderAuth::Internal::Types::Utils

  module TestUtils
    class M < FernHeaderAuth::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernHeaderAuth::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernHeaderAuth::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernHeaderAuth::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernHeaderAuth::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernHeaderAuth::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernHeaderAuth::Internal::Types::Array[String]
      ModelArray = -> { FernHeaderAuth::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernHeaderAuth::Internal::Types::Array[TestUtils::U] }
