...
require_relative "lib/fern_header_auth/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_header_auth"
  spec.authors = ["FernHeaderAuth"]
  spec.version = FernHeaderAuth::VERSION
  spec.summary = "Ruby client library for the FernHeaderAuth API"
  spec.description = "The FernHeaderAuth Ruby library provides convenient access to the FernHeaderAuth API from Ruby."
