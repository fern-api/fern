...
### Custom URL
```ruby
require "fern_header_auth"

client = FernHeaderAuth::Client.new(
...
rescue FernHeaderAuth::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernHeaderAuth::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernHeaderAuth::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernHeaderAuth::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernHeaderAuth::Errors::ApiError => e
