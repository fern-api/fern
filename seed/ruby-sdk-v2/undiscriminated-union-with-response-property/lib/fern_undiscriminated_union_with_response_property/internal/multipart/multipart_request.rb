...
module FernUndiscriminatedUnionWithResponseProperty
  module Internal
    module Multipart
      # @api private
      class Request < FernUndiscriminatedUnionWithResponseProperty::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernUndiscriminatedUnionWithResponseProperty::RequestOptions, Hash{Symbol=>Object}, nil]
