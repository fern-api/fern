...
module FernUndiscriminatedUnionWithResponseProperty
  module Internal
    class CursorItemIterator < ItemIterator
      ...
      # @return [FernUndiscriminatedUnionWithResponseProperty::Internal::CursorItemIterator]
      ...
      #
      # @return [FernUndiscriminatedUnionWithResponseProperty::Internal::CursorPageIterator]
      def pages
        @page_iterator
      end
    end
