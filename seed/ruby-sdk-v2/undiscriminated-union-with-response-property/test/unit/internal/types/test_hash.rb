...
describe FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Hash do
  module TestHash
    SymbolStringHash = FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Hash[Symbol, String]
  end
