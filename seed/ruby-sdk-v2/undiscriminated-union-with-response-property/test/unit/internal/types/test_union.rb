...
describe FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Union do
  class Rectangle < FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Model
