...
describe FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Utils do
  Utils = FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Utils

  module TestUtils
    class M < FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Array[String]
      ModelArray = -> { FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Array[TestUtils::U] }
