...
describe FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Model do
  ...
  class ExampleModel < FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernUndiscriminatedUnionWithResponseProperty::Internal::Types::Model
