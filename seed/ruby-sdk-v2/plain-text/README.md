...
client = FernPlainText::Client.new(
...
begin
    result = client.service.get_text
rescue FernPlainText::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernPlainText::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernPlainText::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernPlainText::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernPlainText::Errors::ApiError => e
