...
require_relative "lib/fern_plain_text/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_plain_text"
  spec.authors = ["FernPlainText"]
  spec.version = FernPlainText::VERSION
  spec.summary = "Ruby client library for the FernPlainText API"
  spec.description = "The FernPlainText Ruby library provides convenient access to the FernPlainText API from Ruby."
