...
# require_relative "lib/plain_text/version"

Gem::Specification.new do |spec|
  spec.name = "plain_text"
  spec.version = "0.0.1" # TODO: plain_text::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the plain_text API"
  # spec.description = "The plain_text Ruby library provides convenient access to the plain_text API from Ruby."
