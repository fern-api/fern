...
describe FernPlainText::Internal::Types::Union do
  class Rectangle < FernPlainText::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernPlainText::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernPlainText::Internal::Types::Model
