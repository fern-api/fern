...
describe FernPlainText::Internal::Types::Utils do
  Utils = FernPlainText::Internal::Types::Utils

  module TestUtils
    class M < FernPlainText::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernPlainText::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernPlainText::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernPlainText::Internal::Types::Union
    ...
    SymbolModelHash = -> { FernPlainText::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernPlainText::Internal::Types::Array[String]
      ModelArray = -> { FernPlainText::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernPlainText::Internal::Types::Array[TestUtils::U] }
