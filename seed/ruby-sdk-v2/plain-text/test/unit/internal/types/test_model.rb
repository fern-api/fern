...
describe FernPlainText::Internal::Types::Model do
  ...
  class ExampleModel < FernPlainText::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernPlainText::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernPlainText::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernPlainText::Internal::Types::Model
