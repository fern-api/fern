...
describe FernUnionsWithLocalDate::Internal::Types::Model do
  ...
  class ExampleModel < FernUnionsWithLocalDate::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernUnionsWithLocalDate::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernUnionsWithLocalDate::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernUnionsWithLocalDate::Internal::Types::Model
