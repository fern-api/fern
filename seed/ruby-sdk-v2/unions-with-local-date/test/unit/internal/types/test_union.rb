...
describe FernUnionsWithLocalDate::Internal::Types::Union do
  class Rectangle < FernUnionsWithLocalDate::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernUnionsWithLocalDate::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernUnionsWithLocalDate::Internal::Types::Model
