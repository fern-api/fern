...
describe FernUnionsWithLocalDate::Internal::Types::Utils do
  Utils = FernUnionsWithLocalDate::Internal::Types::Utils

  module TestUtils
    class M < FernUnionsWithLocalDate::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernUnionsWithLocalDate::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernUnionsWithLocalDate::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernUnionsWithLocalDate::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernUnionsWithLocalDate::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernUnionsWithLocalDate::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernUnionsWithLocalDate::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernUnionsWithLocalDate::Internal::Types::Array[String]
      ModelArray = -> { FernUnionsWithLocalDate::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernUnionsWithLocalDate::Internal::Types::Array[TestUtils::U] }
