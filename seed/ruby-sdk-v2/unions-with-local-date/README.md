...
### Custom URL
```ruby
require "fern_unions_with_local_date"

client = FernUnionsWithLocalDate::Client.new(
...
begin
    result = client.bigunion.get
rescue FernUnionsWithLocalDate::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernUnionsWithLocalDate::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernUnionsWithLocalDate::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernUnionsWithLocalDate::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernUnionsWithLocalDate::Errors::ApiError => e
