...
require_relative "lib/fern_variables/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernVariables"]
  spec.version = FernVariables::VERSION
  spec.summary = "Ruby client library for the FernVariables API"
  spec.description = "The FernVariables Ruby library provides convenient access to the FernVariables API from Ruby."
