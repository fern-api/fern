...
# require_relative "lib/variables/version"

Gem::Specification.new do |spec|
  spec.name = "variables"
  spec.version = "0.0.1" # TODO: variables::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the variables API"
  # spec.description = "The variables Ruby library provides convenient access to the variables API from Ruby."
