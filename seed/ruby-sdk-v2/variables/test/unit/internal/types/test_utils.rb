...
describe FernVariables::Internal::Types::Utils do
  Utils = FernVariables::Internal::Types::Utils

  module TestUtils
    class M < FernVariables::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernVariables::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernVariables::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernVariables::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernVariables::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernVariables::Internal::Types::Array[TestUtils::U] }
