...
describe FernVariables::Internal::Types::Union do
  class Rectangle < FernVariables::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernVariables::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernVariables::Internal::Types::Model
