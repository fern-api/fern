...
### Custom URL
```ruby
require "fern_variables"

client = FernVariables::Client.new(
...
rescue FernVariables::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernVariables::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernVariables::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernVariables::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernVariables::Errors::ApiError => e
