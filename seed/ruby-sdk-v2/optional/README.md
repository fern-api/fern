...
client = FernOptional::Client.new(
...
begin
    result = client.optional.send_optional_body
rescue FernOptional::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernOptional::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernOptional::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernOptional::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernOptional::Errors::ApiError => e
