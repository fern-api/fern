...
require_relative "lib/fern_optional/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_optional"
  spec.authors = ["FernOptional"]
  spec.version = FernOptional::VERSION
  spec.summary = "Ruby client library for the FernOptional API"
  spec.description = "The FernOptional Ruby library provides convenient access to the FernOptional API from Ruby."
