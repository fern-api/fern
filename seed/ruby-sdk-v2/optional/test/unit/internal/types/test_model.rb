...
describe FernOptional::Internal::Types::Model do
  ...
  class ExampleModel < FernOptional::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernOptional::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernOptional::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernOptional::Internal::Types::Model
