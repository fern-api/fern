...
describe FernOptional::Internal::Types::Utils do
  Utils = FernOptional::Internal::Types::Utils

  module TestUtils
    class M < FernOptional::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernOptional::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernOptional::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernOptional::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernOptional::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernOptional::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernOptional::Internal::Types::Array[TestUtils::U] }
