...
describe FernOptional::Internal::Types::Union do
  class Rectangle < FernOptional::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernOptional::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernOptional::Internal::Types::Model
  ...
  module Shape
    extend FernOptional::Internal::Types::Union
