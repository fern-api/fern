...
describe FernAliasExtends::Internal::Types::Union do
  class Rectangle < FernAliasExtends::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernAliasExtends::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernAliasExtends::Internal::Types::Model
