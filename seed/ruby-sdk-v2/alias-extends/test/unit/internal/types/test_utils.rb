...
describe FernAliasExtends::Internal::Types::Utils do
  Utils = FernAliasExtends::Internal::Types::Utils

  module TestUtils
    class M < FernAliasExtends::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernAliasExtends::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernAliasExtends::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernAliasExtends::Internal::Types::Union
    ...
    SymbolModelHash = -> { FernAliasExtends::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernAliasExtends::Internal::Types::Array[String]
      ModelArray = -> { FernAliasExtends::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernAliasExtends::Internal::Types::Array[TestUtils::U] }
