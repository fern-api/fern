...
# require_relative "lib/alias_extends/version"

Gem::Specification.new do |spec|
  spec.name = "alias_extends"
  spec.version = "0.0.1" # TODO: alias_extends::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the alias_extends API"
  # spec.description = "The alias_extends Ruby library provides convenient access to the alias_extends API from Ruby."
