...
require_relative "lib/fern_alias_extends/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_alias_extends"
  spec.authors = ["FernAliasExtends"]
  spec.version = FernAliasExtends::VERSION
  spec.summary = "Ruby client library for the FernAliasExtends API"
  spec.description = "The FernAliasExtends Ruby library provides convenient access to the FernAliasExtends API from Ruby."
