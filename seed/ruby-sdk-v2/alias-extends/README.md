...
### Custom URL
```ruby
require "fern_alias_extends"

client = FernAliasExtends::Client.new(
...
rescue FernAliasExtends::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernAliasExtends::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernAliasExtends::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernAliasExtends::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernAliasExtends::Errors::ApiError => e
