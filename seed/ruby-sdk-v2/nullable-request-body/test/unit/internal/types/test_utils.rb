...
describe FernNullableRequestBody::Internal::Types::Utils do
  Utils = FernNullableRequestBody::Internal::Types::Utils

  module TestUtils
    class M < FernNullableRequestBody::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernNullableRequestBody::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernNullableRequestBody::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernNullableRequestBody::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernNullableRequestBody::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernNullableRequestBody::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernNullableRequestBody::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernNullableRequestBody::Internal::Types::Array[String]
      ModelArray = -> { FernNullableRequestBody::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernNullableRequestBody::Internal::Types::Array[TestUtils::U] }
