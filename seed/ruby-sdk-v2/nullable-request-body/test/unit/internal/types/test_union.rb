...
describe FernNullableRequestBody::Internal::Types::Union do
  class Rectangle < FernNullableRequestBody::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernNullableRequestBody::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernNullableRequestBody::Internal::Types::Model
  ...
  module Shape
    extend FernNullableRequestBody::Internal::Types::Union
