...
### Custom URL
```ruby
require "fern_nullable_request_body"

client = FernNullableRequestBody::Client.new(
...
begin
    result = client.test_group.test_method_name
rescue FernNullableRequestBody::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernNullableRequestBody::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernNullableRequestBody::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernNullableRequestBody::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernNullableRequestBody::Errors::ApiError => e
...
response = client.test_group.test_method_name(
    ...,
