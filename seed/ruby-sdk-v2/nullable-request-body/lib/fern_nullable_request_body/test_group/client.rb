...
module FernNullableRequestBody
  module TestGroup
    class Client
      # @param client [FernNullableRequestBody::Internal::Http::RawClient]
      #
      # @return [void]
      ...
      # @option params [FernNullableRequestBody::Types::PlainObject, nil] :query_param_object
      # @option params [Integer, nil] :query_param_integer
      #
      # @return [Object]
      def test_method_name(request_options: {}, **params)
        params = FernNullableRequestBody::Internal::Types::Utils.normalize_keys(params)
        ...
        request = FernNullableRequestBody::Internal::JSON::Request.new(
        ...
        begin
          ...
          raise FernNullableRequestBody::Errors::TimeoutError
        end
        code = response.code.to_i
        return if code.between?(200, 299)

        error_class = FernNullableRequestBody::Errors::ResponseError.subclass_for_code(code)
