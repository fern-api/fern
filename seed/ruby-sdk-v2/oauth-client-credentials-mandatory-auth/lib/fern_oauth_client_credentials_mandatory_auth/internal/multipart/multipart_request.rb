...
module FernOauthClientCredentialsMandatoryAuth
  module Internal
    module Multipart
      # @api private
      class Request < FernOauthClientCredentialsMandatoryAuth::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernOauthClientCredentialsMandatoryAuth::RequestOptions, Hash{Symbol=>Object}, nil]
