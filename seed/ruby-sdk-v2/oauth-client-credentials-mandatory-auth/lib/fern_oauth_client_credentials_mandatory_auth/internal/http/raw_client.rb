      ...
      class RawClient
        ...
        def initialize(base_url:, max_retries: 2, timeout: 60.0, headers: {})
          ...
          @default_headers = {
            ...
            "X-Fern-SDK-Name": "fernoauthclientcredentialsmandatoryauth",
            "X-Fern-SDK-Version": "0.0.1"
          }.merge(headers)
        end

        # @param request [FernOauthClientCredentialsMandatoryAuth::Internal::Http::BaseRequest] The HTTP request.
