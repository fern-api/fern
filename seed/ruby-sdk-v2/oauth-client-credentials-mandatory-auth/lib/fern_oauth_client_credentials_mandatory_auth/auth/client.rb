...
module FernOauthClientCredentialsMandatoryAuth
  module Auth
    class Client
      ...
      # @param params [FernOauthClientCredentialsMandatoryAuth::Auth::Types::GetTokenRequest]
      ...
      def get_token_with_client_credentials(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          FernOauthClientCredentialsMandatoryAuth::Auth::Types::TokenResponse.load(response.body)
        else
      ...
      # @param request_options [Hash]
      # @param params [FernOauthClientCredentialsMandatoryAuth::Auth::Types::RefreshTokenRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
