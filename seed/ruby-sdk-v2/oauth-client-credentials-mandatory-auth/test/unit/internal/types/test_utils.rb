...
describe FernOauthClientCredentialsMandatoryAuth::Internal::Types::Utils do
  Utils = FernOauthClientCredentialsMandatoryAuth::Internal::Types::Utils

  module TestUtils
    class M < FernOauthClientCredentialsMandatoryAuth::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernOauthClientCredentialsMandatoryAuth::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernOauthClientCredentialsMandatoryAuth::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernOauthClientCredentialsMandatoryAuth::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernOauthClientCredentialsMandatoryAuth::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernOauthClientCredentialsMandatoryAuth::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernOauthClientCredentialsMandatoryAuth::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernOauthClientCredentialsMandatoryAuth::Internal::Types::Array[TestUtils::U] }
