...
describe FernOauthClientCredentialsMandatoryAuth::Internal::Types::Array do
  module TestArray
    StringArray = FernOauthClientCredentialsMandatoryAuth::Internal::Types::Array[String]
  end
