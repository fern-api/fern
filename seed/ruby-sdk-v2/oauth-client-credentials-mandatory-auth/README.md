...
### Custom URL
```ruby
require "fern_oauth_client_credentials_mandatory_auth"

client = FernOauthClientCredentialsMandatoryAuth::Client.new(
...
rescue FernOauthClientCredentialsMandatoryAuth::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernOauthClientCredentialsMandatoryAuth::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernOauthClientCredentialsMandatoryAuth::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernOauthClientCredentialsMandatoryAuth::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernOauthClientCredentialsMandatoryAuth::Errors::ApiError => e
