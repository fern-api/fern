...
describe FernPathParameters::Internal::Types::Utils do
  Utils = FernPathParameters::Internal::Types::Utils

  module TestUtils
    class M < FernPathParameters::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernPathParameters::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernPathParameters::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernPathParameters::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernPathParameters::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernPathParameters::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernPathParameters::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernPathParameters::Internal::Types::Array[String]
      ModelArray = -> { FernPathParameters::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernPathParameters::Internal::Types::Array[TestUtils::U] }
