...
describe FernPathParameters::Internal::Types::Model do
  ...
  class ExampleModel < FernPathParameters::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernPathParameters::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernPathParameters::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernPathParameters::Internal::Types::Model
