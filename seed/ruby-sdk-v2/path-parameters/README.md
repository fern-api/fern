...
### Custom URL
```ruby
require "fern_path_parameters"

client = FernPathParameters::Client.new(
...
rescue FernPathParameters::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernPathParameters::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernPathParameters::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernPathParameters::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernPathParameters::Errors::ApiError => e
