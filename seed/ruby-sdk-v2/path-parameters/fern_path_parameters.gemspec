...
require_relative "lib/fern_path_parameters/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernPathParameters"]
  spec.version = FernPathParameters::VERSION
  spec.summary = "Ruby client library for the FernPathParameters API"
  spec.description = "The FernPathParameters Ruby library provides convenient access to the FernPathParameters API from Ruby."
