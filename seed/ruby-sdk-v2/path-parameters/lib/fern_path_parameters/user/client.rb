...
module FernPathParameters
  module User
    class Client
      ...
      # @param request_options [Hash]
      # @param params [FernPathParameters::User::Types::User]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def create_user(request_options: {}, **params)
        ...
        request = FernPathParameters::Internal::JSON::Request.new(
          ...
          body: FernPathParameters::User::Types::User.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      def update_user(request_options: {}, **params)
        ...
        request = FernPathParameters::Internal::JSON::Request.new(
          ...
          method: "PATCH",
          path: "/#{params[:tenant_id]}/user/#{params[:user_id]}",
          body: FernPathParameters::User::Types::User.new(body_params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      #
      # @return [Array[FernPathParameters::User::Types::User]]
