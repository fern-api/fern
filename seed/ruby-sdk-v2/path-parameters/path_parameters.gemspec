...
# require_relative "lib/path_parameters/version"

Gem::Specification.new do |spec|
  spec.name = "path_parameters"
  spec.version = "0.0.1" # TODO: path_parameters::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the path_parameters API"
  # spec.description = "The path_parameters Ruby library provides convenient access to the path_parameters API from Ruby."
