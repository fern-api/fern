...
# require_relative "lib/request_parameters/version"

Gem::Specification.new do |spec|
  spec.name = "request_parameters"
  spec.version = "0.0.1" # TODO: request_parameters::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the request_parameters API"
  # spec.description = "The request_parameters Ruby library provides convenient access to the request_parameters API from Ruby."
