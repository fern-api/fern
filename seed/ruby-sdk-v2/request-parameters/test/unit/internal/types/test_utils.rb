...
describe FernRequestParameters::Internal::Types::Utils do
  Utils = FernRequestParameters::Internal::Types::Utils

  module TestUtils
    class M < FernRequestParameters::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernRequestParameters::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernRequestParameters::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernRequestParameters::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernRequestParameters::Internal::Types::Array[String]
      ModelArray = -> { FernRequestParameters::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernRequestParameters::Internal::Types::Array[TestUtils::U] }
