...
describe FernRequestParameters::Internal::Types::Model do
  ...
  class ExampleModel < FernRequestParameters::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernRequestParameters::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernRequestParameters::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernRequestParameters::Internal::Types::Model
