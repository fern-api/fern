...
module FernRequestParameters
  module User
    class Client
      # @param client [FernRequestParameters::Internal::Http::RawClient]
      #
      # @return [void]
      ...
      # @param params [FernRequestParameters::User::Types::CreateUsernameRequest]
      ...
      def create_username(request_options: {}, **params)
        params = FernRequestParameters::Internal::Types::Utils.normalize_keys(params)
        request_data = FernRequestParameters::User::Types::CreateUsernameRequest.new(params).to_h
        ...
        request = FernRequestParameters::Internal::JSON::Request.new(
        ...
        begin
          ...
          raise FernRequestParameters::Errors::TimeoutError
        end
        code = response.code.to_i
        return if code.between?(200, 299)

        error_class = FernRequestParameters::Errors::ResponseError.subclass_for_code(code)
        raise error_class.new(response.body, code: code)
      end

      # @param request_options [Hash]
      # @param params [FernRequestParameters::User::Types::CreateUsernameBody]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def create_username_with_referenced_type(request_options: {}, **params)
        ...
        request = FernRequestParameters::Internal::JSON::Request.new(
          ...
          query: query_params,
          body: FernRequestParameters::User::Types::CreateUsernameBody.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      # @option params [FernRequestParameters::User::Types::User] :user
      # @option params [Array[FernRequestParameters::User::Types::User]] :user_list
      ...
      # @option params [FernRequestParameters::User::Types::NestedUser] :nested_user
      # @option params [FernRequestParameters::User::Types::User, nil] :optional_user
      # @option params [FernRequestParameters::User::Types::User] :exclude_user
      # @option params [String] :filter
      # @option params [Integer] :long_param
      # @option params [String] :big_int_param
      #
      # @return [FernRequestParameters::User::Types::User]
      def get_username(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          FernRequestParameters::User::Types::User.load(response.body)
        else
          error_class = FernRequestParameters::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
