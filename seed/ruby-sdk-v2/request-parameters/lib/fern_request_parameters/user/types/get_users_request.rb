  ...
  module User
    module Types
      class GetUsersRequest < Internal::Types::Model
        ...
        field :user, -> { FernRequestParameters::User::Types::User }, optional: false, nullable: false
        field :user_list, -> { Internal::Types::Array[FernRequestParameters::User::Types::User] }, optional: false, nullable: false, api_name: "userList"
        ...
        field :nested_user, -> { FernRequestParameters::User::Types::NestedUser }, optional: false, nullable: false, api_name: "nestedUser"
        field :optional_user, -> { FernRequestParameters::User::Types::User }, optional: true, nullable: false, api_name: "optionalUser"
        field :exclude_user, -> { FernRequestParameters::User::Types::User }, optional: false, nullable: false, api_name: "excludeUser"
