...
require_relative "lib/fern_request_parameters/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernRequestParameters"]
  spec.version = FernRequestParameters::VERSION
  spec.summary = "Ruby client library for the FernRequestParameters API"
  spec.description = "The FernRequestParameters Ruby library provides convenient access to the FernRequestParameters API from Ruby."
