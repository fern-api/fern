...
### Custom URL
```ruby
require "fern_request_parameters"

client = FernRequestParameters::Client.new(
...
begin
    result = client.user.create_username
rescue FernRequestParameters::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernRequestParameters::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernRequestParameters::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernRequestParameters::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernRequestParameters::Errors::ApiError => e
...
response = client.user.create_username(
    ...,
