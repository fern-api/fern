...
# require_relative "lib/extra_properties/version"

Gem::Specification.new do |spec|
  spec.name = "extra_properties"
  spec.version = "0.0.1" # TODO: extra_properties::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the extra_properties API"
  # spec.description = "The extra_properties Ruby library provides convenient access to the extra_properties API from Ruby."
