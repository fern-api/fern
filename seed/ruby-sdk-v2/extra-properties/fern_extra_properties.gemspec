...
require_relative "lib/fern_extra_properties/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernExtraProperties"]
  spec.version = FernExtraProperties::VERSION
  spec.summary = "Ruby client library for the FernExtraProperties API"
  spec.description = "The FernExtraProperties Ruby library provides convenient access to the FernExtraProperties API from Ruby."
