...
describe FernExtraProperties::Internal::Types::Model do
  module StringInteger
    extend FernExtraProperties::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernExtraProperties::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernExtraProperties::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernExtraProperties::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernExtraProperties::Internal::Types::Model
