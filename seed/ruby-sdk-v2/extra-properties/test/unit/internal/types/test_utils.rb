...
describe FernExtraProperties::Internal::Types::Utils do
  Utils = FernExtraProperties::Internal::Types::Utils

  module TestUtils
    class M < FernExtraProperties::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernExtraProperties::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernExtraProperties::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernExtraProperties::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernExtraProperties::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernExtraProperties::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernExtraProperties::Internal::Types::Array[TestUtils::U] }
