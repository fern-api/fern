...
# require_relative "lib/objects_with_imports/version"

Gem::Specification.new do |spec|
  spec.name = "objects_with_imports"
  spec.version = "0.0.1" # TODO: objects_with_imports::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the objects_with_imports API"
  # spec.description = "The objects_with_imports Ruby library provides convenient access to the objects_with_imports API from Ruby."
