...
describe FernObjectsWithImports::Internal::Types::Utils do
  Utils = FernObjectsWithImports::Internal::Types::Utils

  module TestUtils
    class M < FernObjectsWithImports::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernObjectsWithImports::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernObjectsWithImports::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernObjectsWithImports::Internal::Types::Union
    ...
    SymbolStringHash = FernObjectsWithImports::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernObjectsWithImports::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernObjectsWithImports::Internal::Types::Array[String]
      ModelArray = -> { FernObjectsWithImports::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernObjectsWithImports::Internal::Types::Array[TestUtils::U] }
