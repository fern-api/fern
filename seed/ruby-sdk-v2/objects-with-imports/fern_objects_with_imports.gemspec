...
require_relative "lib/fern_objects_with_imports/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernObjectsWithImports"]
  spec.version = FernObjectsWithImports::VERSION
  spec.summary = "Ruby client library for the FernObjectsWithImports API"
  spec.description = "The FernObjectsWithImports Ruby library provides convenient access to the FernObjectsWithImports API from Ruby."
