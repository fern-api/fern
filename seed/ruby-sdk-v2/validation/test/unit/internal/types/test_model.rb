...
describe FernValidation::Internal::Types::Model do
  module StringInteger
    extend FernValidation::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernValidation::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernValidation::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernValidation::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernValidation::Internal::Types::Model
