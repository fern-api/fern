...
describe FernValidation::Internal::Types::Utils do
  Utils = FernValidation::Internal::Types::Utils

  module TestUtils
    class M < FernValidation::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernValidation::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernValidation::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernValidation::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernValidation::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernValidation::Internal::Types::Array[String]
      ModelArray = -> { FernValidation::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernValidation::Internal::Types::Array[TestUtils::U] }
