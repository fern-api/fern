...
describe FernValidation::Internal::Types::Union do
  class Rectangle < FernValidation::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernValidation::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernValidation::Internal::Types::Model
