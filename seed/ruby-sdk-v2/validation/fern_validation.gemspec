...
require_relative "lib/fern_validation/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernValidation"]
  spec.version = FernValidation::VERSION
  spec.summary = "Ruby client library for the FernValidation API"
  spec.description = "The FernValidation Ruby library provides convenient access to the FernValidation API from Ruby."
