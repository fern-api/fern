...
Gem::Specification.new do |spec|
  ...
  spec.version = "0.0.1" # TODO: validation::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the validation API"
  # spec.description = "The validation Ruby library provides convenient access to the validation API from Ruby."
