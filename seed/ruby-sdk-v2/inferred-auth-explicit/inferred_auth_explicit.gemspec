...
# require_relative "lib/inferred_auth_explicit/version"

Gem::Specification.new do |spec|
  spec.name = "inferred_auth_explicit"
  spec.version = "0.0.1" # TODO: inferred_auth_explicit::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the inferred_auth_explicit API"
  # spec.description = "The inferred_auth_explicit Ruby library provides convenient access to the inferred_auth_explicit API from Ruby."
