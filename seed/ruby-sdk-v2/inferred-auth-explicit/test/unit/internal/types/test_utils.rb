...
describe FernInferredAuthExplicit::Internal::Types::Utils do
  Utils = FernInferredAuthExplicit::Internal::Types::Utils

  module TestUtils
    class M < FernInferredAuthExplicit::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernInferredAuthExplicit::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernInferredAuthExplicit::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernInferredAuthExplicit::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernInferredAuthExplicit::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernInferredAuthExplicit::Internal::Types::Array[TestUtils::U] }
