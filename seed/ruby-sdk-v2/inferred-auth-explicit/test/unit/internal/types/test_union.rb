...
describe FernInferredAuthExplicit::Internal::Types::Union do
  class Rectangle < FernInferredAuthExplicit::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernInferredAuthExplicit::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernInferredAuthExplicit::Internal::Types::Model
