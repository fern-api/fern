...
### Custom URL
```ruby
require "fern_oauth_client_credentials_default"

client = FernOauthClientCredentialsDefault::Client.new(
...
rescue FernOauthClientCredentialsDefault::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernOauthClientCredentialsDefault::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernOauthClientCredentialsDefault::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernOauthClientCredentialsDefault::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernOauthClientCredentialsDefault::Errors::ApiError => e
