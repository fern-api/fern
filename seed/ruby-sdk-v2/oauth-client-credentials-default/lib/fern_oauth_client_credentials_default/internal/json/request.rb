...
module FernOauthClientCredentialsDefault
  module Internal
    module JSON
      # @api private
      class Request < FernOauthClientCredentialsDefault::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernOauthClientCredentialsDefault::RequestOptions, Hash{Symbol=>Object}, nil]
