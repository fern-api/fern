...
module FernOauthClientCredentialsDefault
  module Auth
    class Client
      ...
      # @param params [FernOauthClientCredentialsDefault::Auth::Types::GetTokenRequest]
      ...
      def get_token(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          FernOauthClientCredentialsDefault::Auth::Types::TokenResponse.load(response.body)
        else
