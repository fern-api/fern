...
describe FernOauthClientCredentialsDefault::Internal::Types::Utils do
  Utils = FernOauthClientCredentialsDefault::Internal::Types::Utils

  module TestUtils
    class M < FernOauthClientCredentialsDefault::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernOauthClientCredentialsDefault::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernOauthClientCredentialsDefault::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernOauthClientCredentialsDefault::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernOauthClientCredentialsDefault::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernOauthClientCredentialsDefault::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernOauthClientCredentialsDefault::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernOauthClientCredentialsDefault::Internal::Types::Array[TestUtils::U] }
