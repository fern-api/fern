...
describe FernOauthClientCredentialsDefault::Internal::Types::Union do
  class Rectangle < FernOauthClientCredentialsDefault::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernOauthClientCredentialsDefault::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernOauthClientCredentialsDefault::Internal::Types::Model
  ...
  module Shape
    extend FernOauthClientCredentialsDefault::Internal::Types::Union
