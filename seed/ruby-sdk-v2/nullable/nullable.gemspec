...
# require_relative "lib/nullable/version"

Gem::Specification.new do |spec|
  spec.name = "nullable"
  spec.version = "0.0.1" # TODO: nullable::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the nullable API"
  # spec.description = "The nullable Ruby library provides convenient access to the nullable API from Ruby."
