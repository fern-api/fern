...
describe FernNullable::Internal::Types::Model do
  ...
  class ExampleModel < FernNullable::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernNullable::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernNullable::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernNullable::Internal::Types::Model
