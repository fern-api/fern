...
describe FernNullable::Internal::Types::Union do
  class Rectangle < FernNullable::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernNullable::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernNullable::Internal::Types::Model
