...
describe FernNullable::Internal::Types::Utils do
  Utils = FernNullable::Internal::Types::Utils

  module TestUtils
    class M < FernNullable::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernNullable::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernNullable::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernNullable::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernNullable::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernNullable::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernNullable::Internal::Types::Array[String]
      ModelArray = -> { FernNullable::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernNullable::Internal::Types::Array[TestUtils::U] }
