...
require_relative "lib/fern_nullable/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernNullable"]
  spec.version = FernNullable::VERSION
  spec.summary = "Ruby client library for the FernNullable API"
  spec.description = "The FernNullable Ruby library provides convenient access to the FernNullable API from Ruby."
