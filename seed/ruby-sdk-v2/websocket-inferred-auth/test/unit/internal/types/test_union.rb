...
describe FernWebsocketInferredAuth::Internal::Types::Union do
  class Rectangle < FernWebsocketInferredAuth::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernWebsocketInferredAuth::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernWebsocketInferredAuth::Internal::Types::Model
