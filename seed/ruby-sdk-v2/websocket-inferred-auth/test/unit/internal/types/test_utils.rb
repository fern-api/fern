...
describe FernWebsocketInferredAuth::Internal::Types::Utils do
  Utils = FernWebsocketInferredAuth::Internal::Types::Utils

  module TestUtils
    class M < FernWebsocketInferredAuth::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernWebsocketInferredAuth::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernWebsocketInferredAuth::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernWebsocketInferredAuth::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernWebsocketInferredAuth::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernWebsocketInferredAuth::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernWebsocketInferredAuth::Internal::Types::Array[TestUtils::U] }
