...
describe FernWebsocketInferredAuth::Internal::Types::Model do
  module StringInteger
    extend FernWebsocketInferredAuth::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernWebsocketInferredAuth::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernWebsocketInferredAuth::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernWebsocketInferredAuth::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernWebsocketInferredAuth::Internal::Types::Model
