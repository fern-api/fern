...
### Custom URL
```ruby
require "fern_websocket_inferred_auth"

client = FernWebsocketInferredAuth::Client.new(
...
rescue FernWebsocketInferredAuth::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernWebsocketInferredAuth::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernWebsocketInferredAuth::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernWebsocketInferredAuth::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernWebsocketInferredAuth::Errors::ApiError => e
