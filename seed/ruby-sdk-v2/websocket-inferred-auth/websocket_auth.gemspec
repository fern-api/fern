...
# require_relative "lib/websocket_auth/version"

Gem::Specification.new do |spec|
  spec.name = "websocket_auth"
  spec.version = "0.0.1" # TODO: websocket_auth::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the websocket_auth API"
  # spec.description = "The websocket_auth Ruby library provides convenient access to the websocket_auth API from Ruby."
