...
# require_relative "lib/alias/version"

Gem::Specification.new do |spec|
  spec.name = "alias"
  spec.version = "0.0.1" # TODO: alias::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the alias API"
  # spec.description = "The alias Ruby library provides convenient access to the alias API from Ruby."
