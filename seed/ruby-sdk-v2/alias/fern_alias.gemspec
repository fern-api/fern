...
require_relative "lib/fern_alias/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernAlias"]
  spec.version = FernAlias::VERSION
  spec.summary = "Ruby client library for the FernAlias API"
  spec.description = "The FernAlias Ruby library provides convenient access to the FernAlias API from Ruby."
