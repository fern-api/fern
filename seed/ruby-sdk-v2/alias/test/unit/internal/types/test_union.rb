...
describe FernAlias::Internal::Types::Union do
  class Rectangle < FernAlias::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernAlias::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernAlias::Internal::Types::Model
