...
describe FernAlias::Internal::Types::Model do
  ...
  class ExampleModel < FernAlias::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernAlias::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernAlias::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernAlias::Internal::Types::Model
