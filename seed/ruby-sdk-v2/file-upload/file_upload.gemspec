...
# require_relative "lib/file_upload/version"

Gem::Specification.new do |spec|
  spec.name = "file_upload"
  spec.version = "0.0.1" # TODO: file_upload::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the file_upload API"
  # spec.description = "The file_upload Ruby library provides convenient access to the file_upload API from Ruby."
