...
describe FernFileUpload::Internal::Types::Utils do
  Utils = FernFileUpload::Internal::Types::Utils

  module TestUtils
    class M < FernFileUpload::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernFileUpload::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernFileUpload::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernFileUpload::Internal::Types::Union
    ...
    SymbolStringHash = FernFileUpload::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernFileUpload::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernFileUpload::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernFileUpload::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernFileUpload::Internal::Types::Array[String]
      ModelArray = -> { FernFileUpload::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernFileUpload::Internal::Types::Array[TestUtils::U] }
