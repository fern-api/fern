...
describe FernFileUpload::Internal::Types::Union do
  class Rectangle < FernFileUpload::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernFileUpload::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernFileUpload::Internal::Types::Model
