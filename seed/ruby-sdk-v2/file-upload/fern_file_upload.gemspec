...
require_relative "lib/fern_file_upload/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernFileUpload"]
  spec.version = FernFileUpload::VERSION
  spec.summary = "Ruby client library for the FernFileUpload API"
  spec.description = "The FernFileUpload Ruby library provides convenient access to the FernFileUpload API from Ruby."
