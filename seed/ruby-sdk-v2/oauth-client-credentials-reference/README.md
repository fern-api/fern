...
### Custom URL
```ruby
require "fern_oauth_client_credentials_reference"

client = FernOauthClientCredentialsReference::Client.new(
...
rescue FernOauthClientCredentialsReference::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernOauthClientCredentialsReference::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernOauthClientCredentialsReference::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernOauthClientCredentialsReference::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernOauthClientCredentialsReference::Errors::ApiError => e
