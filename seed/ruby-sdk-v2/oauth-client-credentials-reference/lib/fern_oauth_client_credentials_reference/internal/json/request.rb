...
module FernOauthClientCredentialsReference
  module Internal
    module JSON
      # @api private
      class Request < FernOauthClientCredentialsReference::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernOauthClientCredentialsReference::RequestOptions, Hash{Symbol=>Object}, nil]
