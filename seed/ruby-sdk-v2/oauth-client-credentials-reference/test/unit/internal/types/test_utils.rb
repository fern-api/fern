...
describe FernOauthClientCredentialsReference::Internal::Types::Utils do
  Utils = FernOauthClientCredentialsReference::Internal::Types::Utils

  module TestUtils
    class M < FernOauthClientCredentialsReference::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernOauthClientCredentialsReference::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernOauthClientCredentialsReference::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernOauthClientCredentialsReference::Internal::Types::Union
    ...
    SymbolStringHash = FernOauthClientCredentialsReference::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernOauthClientCredentialsReference::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernOauthClientCredentialsReference::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernOauthClientCredentialsReference::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernOauthClientCredentialsReference::Internal::Types::Array[TestUtils::U] }
