...
describe FernOauthClientCredentialsReference::Internal::Types::Model do
  ...
  class ExampleModel < FernOauthClientCredentialsReference::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernOauthClientCredentialsReference::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernOauthClientCredentialsReference::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernOauthClientCredentialsReference::Internal::Types::Model
