...
describe FernOauthClientCredentialsReference::Internal::Types::Union do
  class Rectangle < FernOauthClientCredentialsReference::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernOauthClientCredentialsReference::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernOauthClientCredentialsReference::Internal::Types::Model
