...
describe FernOauthClientCredentialsReference::Internal::Types::Array do
  module TestArray
    StringArray = FernOauthClientCredentialsReference::Internal::Types::Array[String]
  end
  ...
  describe "#coerce" do
    ...
    it "raises an error if not an array and strictness is on" do
      assert_raises FernOauthClientCredentialsReference::Internal::Errors::TypeError do
