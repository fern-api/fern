...
describe FernFileUploadOpenapi::Internal::Types::Model do
  ...
  class ExampleModel < FernFileUploadOpenapi::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernFileUploadOpenapi::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernFileUploadOpenapi::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernFileUploadOpenapi::Internal::Types::Model
