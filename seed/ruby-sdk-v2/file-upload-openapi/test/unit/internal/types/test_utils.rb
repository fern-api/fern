...
describe FernFileUploadOpenapi::Internal::Types::Utils do
  Utils = FernFileUploadOpenapi::Internal::Types::Utils

  module TestUtils
    class M < FernFileUploadOpenapi::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernFileUploadOpenapi::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernFileUploadOpenapi::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernFileUploadOpenapi::Internal::Types::Union
    ...
    SymbolStringHash = FernFileUploadOpenapi::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernFileUploadOpenapi::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernFileUploadOpenapi::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernFileUploadOpenapi::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernFileUploadOpenapi::Internal::Types::Array[String]
      ModelArray = -> { FernFileUploadOpenapi::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernFileUploadOpenapi::Internal::Types::Array[TestUtils::U] }
