...
### Custom URL
```ruby
require "fern_file_upload_openapi"

client = FernFileUploadOpenapi::Client.new(
...
begin
    result = client.file_upload_example.upload_file
rescue FernFileUploadOpenapi::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernFileUploadOpenapi::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernFileUploadOpenapi::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernFileUploadOpenapi::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernFileUploadOpenapi::Errors::ApiError => e
...
response = client.file_upload_example.upload_file(
    ...,
