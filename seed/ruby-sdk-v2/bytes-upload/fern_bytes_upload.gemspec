...
require_relative "lib/fern_bytes_upload/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_bytes_upload"
  spec.authors = ["FernBytesUpload"]
  spec.version = FernBytesUpload::VERSION
  spec.summary = "Ruby client library for the FernBytesUpload API"
  spec.description = "The FernBytesUpload Ruby library provides convenient access to the FernBytesUpload API from Ruby."
