...
client = FernBytesUpload::Client.new(
...
rescue FernBytesUpload::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernBytesUpload::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernBytesUpload::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernBytesUpload::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernBytesUpload::Errors::ApiError => e
...
response = client.service.upload(
    ...,
