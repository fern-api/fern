...
# require_relative "lib/bytes_upload/version"

Gem::Specification.new do |spec|
  spec.name = "bytes_upload"
  spec.version = "0.0.1" # TODO: bytes_upload::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the bytes_upload API"
  # spec.description = "The bytes_upload Ruby library provides convenient access to the bytes_upload API from Ruby."
