...
describe FernBytesUpload::Internal::Types::Model do
  ...
  class ExampleModel < FernBytesUpload::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernBytesUpload::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernBytesUpload::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernBytesUpload::Internal::Types::Model
