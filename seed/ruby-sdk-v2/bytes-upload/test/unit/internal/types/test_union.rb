...
describe FernBytesUpload::Internal::Types::Union do
  class Rectangle < FernBytesUpload::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernBytesUpload::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernBytesUpload::Internal::Types::Model
  ...
  module Shape
    extend FernBytesUpload::Internal::Types::Union
