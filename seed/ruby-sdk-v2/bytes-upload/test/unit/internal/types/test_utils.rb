...
describe FernBytesUpload::Internal::Types::Utils do
  Utils = FernBytesUpload::Internal::Types::Utils

  module TestUtils
    class M < FernBytesUpload::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernBytesUpload::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernBytesUpload::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernBytesUpload::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernBytesUpload::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernBytesUpload::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernBytesUpload::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernBytesUpload::Internal::Types::Array[TestUtils::U] }
