...
describe FernBytesUpload::Internal::Types::Array do
  module TestArray
    StringArray = FernBytesUpload::Internal::Types::Array[String]
  end
  ...
  describe "#coerce" do
    ...
    it "raises an error if not an array and strictness is on" do
      assert_raises FernBytesUpload::Internal::Errors::TypeError do
