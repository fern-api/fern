...
describe FernExamples::Internal::Types::Utils do
  Utils = FernExamples::Internal::Types::Utils

  module TestUtils
    class M < FernExamples::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernExamples::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernExamples::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernExamples::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernExamples::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernExamples::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernExamples::Internal::Types::Array[TestUtils::U] }
