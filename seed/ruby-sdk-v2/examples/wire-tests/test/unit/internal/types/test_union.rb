...
describe FernExamples::Internal::Types::Union do
  class Rectangle < FernExamples::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernExamples::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernExamples::Internal::Types::Model
