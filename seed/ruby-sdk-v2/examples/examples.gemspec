...
# require_relative "lib/examples/version"

Gem::Specification.new do |spec|
  spec.name = "examples"
  spec.version = "0.0.1" # TODO: examples::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the examples API"
  # spec.description = "The examples Ruby library provides convenient access to the examples API from Ruby."
