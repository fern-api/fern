...
describe FernContentType::Internal::Types::Union do
  class Rectangle < FernContentType::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernContentType::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernContentType::Internal::Types::Model
  ...
  module Shape
    extend FernContentType::Internal::Types::Union
