...
describe FernContentType::Internal::Types::Utils do
  Utils = FernContentType::Internal::Types::Utils

  module TestUtils
    class M < FernContentType::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernContentType::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernContentType::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernContentType::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernContentType::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernContentType::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernContentType::Internal::Types::Array[TestUtils::U] }
