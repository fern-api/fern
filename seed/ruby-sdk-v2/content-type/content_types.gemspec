...
# require_relative "lib/content_types/version"

Gem::Specification.new do |spec|
  spec.name = "content_types"
  spec.version = "0.0.1" # TODO: content_types::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the content_types API"
  # spec.description = "The content_types Ruby library provides convenient access to the content_types API from Ruby."
