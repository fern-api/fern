...
client = FernContentType::Client.new(
...
rescue FernContentType::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernContentType::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernContentType::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernContentType::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernContentType::Errors::ApiError => e
