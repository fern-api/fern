...
require_relative "lib/fern_content_type/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernContentType"]
  spec.version = FernContentType::VERSION
  spec.summary = "Ruby client library for the FernContentType API"
  spec.description = "The FernContentType Ruby library provides convenient access to the FernContentType API from Ruby."
