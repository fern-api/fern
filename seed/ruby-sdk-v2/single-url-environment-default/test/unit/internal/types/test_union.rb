...
describe FernSingleUrlEnvironmentDefault::Internal::Types::Union do
  class Rectangle < FernSingleUrlEnvironmentDefault::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernSingleUrlEnvironmentDefault::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernSingleUrlEnvironmentDefault::Internal::Types::Model
