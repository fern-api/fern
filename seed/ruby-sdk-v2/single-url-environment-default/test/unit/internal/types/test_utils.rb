...
describe FernSingleUrlEnvironmentDefault::Internal::Types::Utils do
  Utils = FernSingleUrlEnvironmentDefault::Internal::Types::Utils

  module TestUtils
    class M < FernSingleUrlEnvironmentDefault::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernSingleUrlEnvironmentDefault::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernSingleUrlEnvironmentDefault::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernSingleUrlEnvironmentDefault::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernSingleUrlEnvironmentDefault::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernSingleUrlEnvironmentDefault::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernSingleUrlEnvironmentDefault::Internal::Types::Array[String]
      ModelArray = -> { FernSingleUrlEnvironmentDefault::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernSingleUrlEnvironmentDefault::Internal::Types::Array[TestUtils::U] }
