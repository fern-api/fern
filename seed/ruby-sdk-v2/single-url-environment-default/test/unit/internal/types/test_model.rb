...
describe FernSingleUrlEnvironmentDefault::Internal::Types::Model do
  module StringInteger
    extend FernSingleUrlEnvironmentDefault::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernSingleUrlEnvironmentDefault::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernSingleUrlEnvironmentDefault::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernSingleUrlEnvironmentDefault::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernSingleUrlEnvironmentDefault::Internal::Types::Model
