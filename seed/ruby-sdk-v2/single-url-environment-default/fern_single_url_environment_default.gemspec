...
require_relative "lib/fern_single_url_environment_default/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernSingleUrlEnvironmentDefault"]
  spec.version = FernSingleUrlEnvironmentDefault::VERSION
  spec.summary = "Ruby client library for the FernSingleUrlEnvironmentDefault API"
  spec.description = "The FernSingleUrlEnvironmentDefault Ruby library provides convenient access to the FernSingleUrlEnvironmentDefault API from Ruby."
