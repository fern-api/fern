...
module FernSingleUrlEnvironmentDefault
  module Internal
    module Multipart
      # @api private
      class Request < FernSingleUrlEnvironmentDefault::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernSingleUrlEnvironmentDefault::RequestOptions, Hash{Symbol=>Object}, nil]
