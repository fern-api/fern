...
client = Seed::Client.new(header_token_auth: '<value>');
...
### Custom URL
```ruby
require "fern_header_auth_environment_variable"

client = FernHeaderAuthEnvironmentVariable::Client.new(
...
rescue FernHeaderAuthEnvironmentVariable::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernHeaderAuthEnvironmentVariable::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernHeaderAuthEnvironmentVariable::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernHeaderAuthEnvironmentVariable::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernHeaderAuthEnvironmentVariable::Errors::ApiError => e
