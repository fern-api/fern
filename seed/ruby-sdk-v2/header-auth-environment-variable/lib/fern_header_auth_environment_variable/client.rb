...
module FernHeaderAuthEnvironmentVariable
  class Client
    ...
    def initialize(base_url: nil, header_token_auth: ENV.fetch("HEADER_TOKEN_ENV_VAR", nil))
      @raw_client = FernHeaderAuthEnvironmentVariable::Internal::Http::RawClient.new(
        base_url: base_url,
        headers: {
    ...
    # @return [FernHeaderAuthEnvironmentVariable::Service::Client]
    def service
      @service ||= FernHeaderAuthEnvironmentVariable::Service::Client.new(client: @raw_client)
    end
  end
end
