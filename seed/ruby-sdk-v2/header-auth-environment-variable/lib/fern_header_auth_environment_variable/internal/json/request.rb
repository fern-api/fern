...
module FernHeaderAuthEnvironmentVariable
  module Internal
    module JSON
      # @api private
      class Request < FernHeaderAuthEnvironmentVariable::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernHeaderAuthEnvironmentVariable::RequestOptions, Hash{Symbol=>Object}, nil]
