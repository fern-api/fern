...
describe FernHeaderAuthEnvironmentVariable::Internal::Types::Union do
  class Rectangle < FernHeaderAuthEnvironmentVariable::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernHeaderAuthEnvironmentVariable::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernHeaderAuthEnvironmentVariable::Internal::Types::Model
