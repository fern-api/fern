...
describe FernHeaderAuthEnvironmentVariable::Internal::Types::Utils do
  Utils = FernHeaderAuthEnvironmentVariable::Internal::Types::Utils

  module TestUtils
    class M < FernHeaderAuthEnvironmentVariable::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernHeaderAuthEnvironmentVariable::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernHeaderAuthEnvironmentVariable::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernHeaderAuthEnvironmentVariable::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernHeaderAuthEnvironmentVariable::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernHeaderAuthEnvironmentVariable::Internal::Types::Array[String]
      ModelArray = -> { FernHeaderAuthEnvironmentVariable::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernHeaderAuthEnvironmentVariable::Internal::Types::Array[TestUtils::U] }
