...
describe FernInferredAuthImplicitNoExpiry::Internal::Types::Model do
  ...
  class ExampleModel < FernInferredAuthImplicitNoExpiry::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernInferredAuthImplicitNoExpiry::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernInferredAuthImplicitNoExpiry::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernInferredAuthImplicitNoExpiry::Internal::Types::Model
