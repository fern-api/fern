...
describe FernInferredAuthImplicitNoExpiry::Internal::Types::Utils do
  Utils = FernInferredAuthImplicitNoExpiry::Internal::Types::Utils

  module TestUtils
    class M < FernInferredAuthImplicitNoExpiry::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernInferredAuthImplicitNoExpiry::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernInferredAuthImplicitNoExpiry::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernInferredAuthImplicitNoExpiry::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernInferredAuthImplicitNoExpiry::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernInferredAuthImplicitNoExpiry::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernInferredAuthImplicitNoExpiry::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernInferredAuthImplicitNoExpiry::Internal::Types::Array[String]
      ModelArray = -> { FernInferredAuthImplicitNoExpiry::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernInferredAuthImplicitNoExpiry::Internal::Types::Array[TestUtils::U] }
