...
module FernInferredAuthImplicitNoExpiry
  module Internal
    module Multipart
      # @api private
      class Request < FernInferredAuthImplicitNoExpiry::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernInferredAuthImplicitNoExpiry::RequestOptions, Hash{Symbol=>Object}, nil]
