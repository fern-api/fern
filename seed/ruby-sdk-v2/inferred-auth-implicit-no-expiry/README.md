...
### Custom URL
```ruby
require "fern_inferred_auth_implicit_no_expiry"

client = FernInferredAuthImplicitNoExpiry::Client.new(
...
rescue FernInferredAuthImplicitNoExpiry::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernInferredAuthImplicitNoExpiry::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernInferredAuthImplicitNoExpiry::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernInferredAuthImplicitNoExpiry::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernInferredAuthImplicitNoExpiry::Errors::ApiError => e
