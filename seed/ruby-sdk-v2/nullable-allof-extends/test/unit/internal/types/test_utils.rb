...
describe FernNullableAllofExtends::Internal::Types::Utils do
  Utils = FernNullableAllofExtends::Internal::Types::Utils

  module TestUtils
    class M < FernNullableAllofExtends::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernNullableAllofExtends::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernNullableAllofExtends::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernNullableAllofExtends::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernNullableAllofExtends::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernNullableAllofExtends::Internal::Types::Array[String]
      ModelArray = -> { FernNullableAllofExtends::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernNullableAllofExtends::Internal::Types::Array[TestUtils::U] }
