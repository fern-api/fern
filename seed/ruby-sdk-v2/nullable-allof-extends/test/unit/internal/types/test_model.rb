...
describe FernNullableAllofExtends::Internal::Types::Model do
  module StringInteger
    extend FernNullableAllofExtends::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernNullableAllofExtends::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernNullableAllofExtends::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernNullableAllofExtends::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernNullableAllofExtends::Internal::Types::Model
