...
describe FernNullableAllofExtends::Internal::Types::Union do
  class Rectangle < FernNullableAllofExtends::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernNullableAllofExtends::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernNullableAllofExtends::Internal::Types::Model
