...
### Environments
```ruby
require "fern_nullable_allof_extends"

fern_nullable_allof_extends = FernNullableAllofExtends::Client.new(
    base_url: FernNullableAllofExtends::Environment::DEFAULT
)
```
...
client = FernNullableAllofExtends::Client.new(
...
rescue FernNullableAllofExtends::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernNullableAllofExtends::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernNullableAllofExtends::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernNullableAllofExtends::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernNullableAllofExtends::Errors::ApiError => e
