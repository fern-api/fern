...
require_relative "lib/fern_version_no_default/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernVersionNoDefault"]
  spec.version = FernVersionNoDefault::VERSION
  spec.summary = "Ruby client library for the FernVersionNoDefault API"
  spec.description = "The FernVersionNoDefault Ruby library provides convenient access to the FernVersionNoDefault API from Ruby."
