...
describe FernVersionNoDefault::Internal::Types::Union do
  class Rectangle < FernVersionNoDefault::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernVersionNoDefault::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernVersionNoDefault::Internal::Types::Model
