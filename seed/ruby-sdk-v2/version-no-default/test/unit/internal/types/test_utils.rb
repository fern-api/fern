...
describe FernVersionNoDefault::Internal::Types::Utils do
  Utils = FernVersionNoDefault::Internal::Types::Utils

  module TestUtils
    class M < FernVersionNoDefault::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernVersionNoDefault::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernVersionNoDefault::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernVersionNoDefault::Internal::Types::Union
    ...
    SymbolStringHash = FernVersionNoDefault::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernVersionNoDefault::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernVersionNoDefault::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernVersionNoDefault::Internal::Types::Array[String]
      ModelArray = -> { FernVersionNoDefault::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernVersionNoDefault::Internal::Types::Array[TestUtils::U] }
