...
client = FernVersionNoDefault::Client.new(
...
rescue FernVersionNoDefault::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernVersionNoDefault::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernVersionNoDefault::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernVersionNoDefault::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernVersionNoDefault::Errors::ApiError => e
