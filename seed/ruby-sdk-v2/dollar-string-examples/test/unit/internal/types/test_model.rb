...
describe FernDollarStringExamples::Internal::Types::Model do
  module StringInteger
    extend FernDollarStringExamples::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernDollarStringExamples::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernDollarStringExamples::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernDollarStringExamples::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernDollarStringExamples::Internal::Types::Model
