...
describe FernDollarStringExamples::Internal::Types::Utils do
  Utils = FernDollarStringExamples::Internal::Types::Utils

  module TestUtils
    class M < FernDollarStringExamples::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernDollarStringExamples::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernDollarStringExamples::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernDollarStringExamples::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernDollarStringExamples::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernDollarStringExamples::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernDollarStringExamples::Internal::Types::Array[TestUtils::U] }
