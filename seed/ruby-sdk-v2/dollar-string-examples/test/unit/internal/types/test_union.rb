...
describe FernDollarStringExamples::Internal::Types::Union do
  class Rectangle < FernDollarStringExamples::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernDollarStringExamples::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernDollarStringExamples::Internal::Types::Model
