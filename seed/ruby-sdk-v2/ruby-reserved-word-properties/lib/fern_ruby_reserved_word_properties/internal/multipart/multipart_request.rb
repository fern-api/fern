...
module FernRubyReservedWordProperties
  module Internal
    module Multipart
      # @api private
      class Request < FernRubyReservedWordProperties::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernRubyReservedWordProperties::RequestOptions, Hash{Symbol=>Object}, nil]
