...
### Custom URL
```ruby
require "fern_ruby_reserved_word_properties"

client = FernRubyReservedWordProperties::Client.new(
...
rescue FernRubyReservedWordProperties::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernRubyReservedWordProperties::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernRubyReservedWordProperties::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernRubyReservedWordProperties::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernRubyReservedWordProperties::Errors::ApiError => e
