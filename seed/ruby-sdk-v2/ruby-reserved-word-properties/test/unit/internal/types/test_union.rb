...
describe FernRubyReservedWordProperties::Internal::Types::Union do
  class Rectangle < FernRubyReservedWordProperties::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernRubyReservedWordProperties::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernRubyReservedWordProperties::Internal::Types::Model
