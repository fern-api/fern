...
describe FernRubyReservedWordProperties::Internal::Types::Model do
  module StringInteger
    extend FernRubyReservedWordProperties::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernRubyReservedWordProperties::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernRubyReservedWordProperties::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernRubyReservedWordProperties::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernRubyReservedWordProperties::Internal::Types::Model
