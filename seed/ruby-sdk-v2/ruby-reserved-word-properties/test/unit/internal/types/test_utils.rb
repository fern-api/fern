...
describe FernRubyReservedWordProperties::Internal::Types::Utils do
  Utils = FernRubyReservedWordProperties::Internal::Types::Utils

  module TestUtils
    class M < FernRubyReservedWordProperties::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernRubyReservedWordProperties::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernRubyReservedWordProperties::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernRubyReservedWordProperties::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernRubyReservedWordProperties::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernRubyReservedWordProperties::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernRubyReservedWordProperties::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernRubyReservedWordProperties::Internal::Types::Array[TestUtils::U] }
