...
describe FernRubyReservedWordProperties::Internal::Types::Array do
  module TestArray
    StringArray = FernRubyReservedWordProperties::Internal::Types::Array[String]
  end
  ...
  describe "#coerce" do
    ...
    it "raises an error if not an array and strictness is on" do
      assert_raises FernRubyReservedWordProperties::Internal::Errors::TypeError do
