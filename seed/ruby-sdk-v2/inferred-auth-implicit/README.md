...
### Custom URL
```ruby
require "fern_inferred_auth_implicit"

client = FernInferredAuthImplicit::Client.new(
...
rescue FernInferredAuthImplicit::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernInferredAuthImplicit::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernInferredAuthImplicit::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernInferredAuthImplicit::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernInferredAuthImplicit::Errors::ApiError => e
