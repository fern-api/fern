...
describe FernInferredAuthImplicit::Internal::Types::Utils do
  Utils = FernInferredAuthImplicit::Internal::Types::Utils

  module TestUtils
    class M < FernInferredAuthImplicit::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernInferredAuthImplicit::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernInferredAuthImplicit::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernInferredAuthImplicit::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernInferredAuthImplicit::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernInferredAuthImplicit::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernInferredAuthImplicit::Internal::Types::Array[TestUtils::U] }
