...
describe FernInferredAuthImplicit::Internal::Types::Union do
  class Rectangle < FernInferredAuthImplicit::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernInferredAuthImplicit::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernInferredAuthImplicit::Internal::Types::Model
