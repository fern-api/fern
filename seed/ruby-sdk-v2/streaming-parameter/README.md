...
client = FernStreamingParameter::Client.new(
...
rescue FernStreamingParameter::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernStreamingParameter::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernStreamingParameter::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernStreamingParameter::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernStreamingParameter::Errors::ApiError => e
