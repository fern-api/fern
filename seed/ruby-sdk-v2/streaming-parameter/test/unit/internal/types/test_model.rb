...
describe FernStreamingParameter::Internal::Types::Model do
  ...
  class ExampleModel < FernStreamingParameter::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernStreamingParameter::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernStreamingParameter::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernStreamingParameter::Internal::Types::Model
