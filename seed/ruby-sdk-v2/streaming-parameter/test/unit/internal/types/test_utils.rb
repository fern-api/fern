...
describe FernStreamingParameter::Internal::Types::Utils do
  Utils = FernStreamingParameter::Internal::Types::Utils

  module TestUtils
    class M < FernStreamingParameter::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernStreamingParameter::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernStreamingParameter::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernStreamingParameter::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernStreamingParameter::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernStreamingParameter::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernStreamingParameter::Internal::Types::Array[TestUtils::U] }
