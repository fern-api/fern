...
describe FernRequiredNullable::Internal::Types::Model do
  ...
  class ExampleModel < FernRequiredNullable::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernRequiredNullable::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernRequiredNullable::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernRequiredNullable::Internal::Types::Model
