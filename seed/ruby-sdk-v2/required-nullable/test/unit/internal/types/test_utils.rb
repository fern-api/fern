...
describe FernRequiredNullable::Internal::Types::Utils do
  Utils = FernRequiredNullable::Internal::Types::Utils

  module TestUtils
    class M < FernRequiredNullable::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernRequiredNullable::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernRequiredNullable::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernRequiredNullable::Internal::Types::Union
    ...
    SymbolStringHash = FernRequiredNullable::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernRequiredNullable::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernRequiredNullable::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernRequiredNullable::Internal::Types::Array[String]
      ModelArray = -> { FernRequiredNullable::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernRequiredNullable::Internal::Types::Array[TestUtils::U] }
