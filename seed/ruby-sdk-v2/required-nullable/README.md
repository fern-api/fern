...
### Custom URL
```ruby
require "fern_required_nullable"

client = FernRequiredNullable::Client.new(
...
rescue FernRequiredNullable::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernRequiredNullable::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernRequiredNullable::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernRequiredNullable::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernRequiredNullable::Errors::ApiError => e
