...
module FernBearerTokenEnvironmentVariable
  module Internal
    module JSON
      # @api private
      class Request < FernBearerTokenEnvironmentVariable::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernBearerTokenEnvironmentVariable::RequestOptions, Hash{Symbol=>Object}, nil]
