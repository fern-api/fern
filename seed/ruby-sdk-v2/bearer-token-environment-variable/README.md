...
client = Seed::Client.new(api_key: '<token>');
...
client = FernBearerTokenEnvironmentVariable::Client.new(
...
begin
    result = client.service.get_with_bearer_token
rescue FernBearerTokenEnvironmentVariable::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernBearerTokenEnvironmentVariable::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernBearerTokenEnvironmentVariable::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernBearerTokenEnvironmentVariable::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernBearerTokenEnvironmentVariable::Errors::ApiError => e
