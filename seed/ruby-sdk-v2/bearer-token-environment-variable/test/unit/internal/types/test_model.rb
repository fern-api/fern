...
describe FernBearerTokenEnvironmentVariable::Internal::Types::Model do
  ...
  class ExampleModel < FernBearerTokenEnvironmentVariable::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernBearerTokenEnvironmentVariable::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernBearerTokenEnvironmentVariable::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernBearerTokenEnvironmentVariable::Internal::Types::Model
