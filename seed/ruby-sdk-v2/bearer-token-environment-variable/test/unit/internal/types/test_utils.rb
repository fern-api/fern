...
describe FernBearerTokenEnvironmentVariable::Internal::Types::Utils do
  Utils = FernBearerTokenEnvironmentVariable::Internal::Types::Utils

  module TestUtils
    class M < FernBearerTokenEnvironmentVariable::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernBearerTokenEnvironmentVariable::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernBearerTokenEnvironmentVariable::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernBearerTokenEnvironmentVariable::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernBearerTokenEnvironmentVariable::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernBearerTokenEnvironmentVariable::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernBearerTokenEnvironmentVariable::Internal::Types::Array[String]
      ModelArray = -> { FernBearerTokenEnvironmentVariable::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernBearerTokenEnvironmentVariable::Internal::Types::Array[TestUtils::U] }
