...
require_relative "lib/fern_no_environment/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_no_environment"
  spec.authors = ["FernNoEnvironment"]
  spec.version = FernNoEnvironment::VERSION
  spec.summary = "Ruby client library for the FernNoEnvironment API"
  spec.description = "The FernNoEnvironment Ruby library provides convenient access to the FernNoEnvironment API from Ruby."
