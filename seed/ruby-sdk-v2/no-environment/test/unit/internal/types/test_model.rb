...
describe FernNoEnvironment::Internal::Types::Model do
  ...
  class ExampleModel < FernNoEnvironment::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernNoEnvironment::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernNoEnvironment::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernNoEnvironment::Internal::Types::Model
