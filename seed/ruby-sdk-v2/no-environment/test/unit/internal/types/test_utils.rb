...
describe FernNoEnvironment::Internal::Types::Utils do
  Utils = FernNoEnvironment::Internal::Types::Utils

  module TestUtils
    class M < FernNoEnvironment::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernNoEnvironment::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernNoEnvironment::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernNoEnvironment::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernNoEnvironment::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernNoEnvironment::Internal::Types::Array[String]
      ModelArray = -> { FernNoEnvironment::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernNoEnvironment::Internal::Types::Array[TestUtils::U] }
