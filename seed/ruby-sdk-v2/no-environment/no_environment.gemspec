...
# require_relative "lib/no_environment/version"

Gem::Specification.new do |spec|
  spec.name = "no_environment"
  spec.version = "0.0.1" # TODO: no_environment::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the no_environment API"
  # spec.description = "The no_environment Ruby library provides convenient access to the no_environment API from Ruby."
