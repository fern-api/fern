...
require_relative "lib/fern_license/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernLicense"]
  spec.version = FernLicense::VERSION
  spec.summary = "Ruby client library for the FernLicense API"
  spec.description = "The FernLicense Ruby library provides convenient access to the FernLicense API from Ruby."
