...
# require_relative "lib/license/version"

Gem::Specification.new do |spec|
  spec.name = "license"
  spec.version = "0.0.1" # TODO: license::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the license API"
  # spec.description = "The license Ruby library provides convenient access to the license API from Ruby."
