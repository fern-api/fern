...
describe FernLicense::Internal::Types::Union do
  class Rectangle < FernLicense::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernLicense::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernLicense::Internal::Types::Model
