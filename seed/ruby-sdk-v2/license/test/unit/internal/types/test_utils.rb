...
describe FernLicense::Internal::Types::Utils do
  Utils = FernLicense::Internal::Types::Utils

  module TestUtils
    class M < FernLicense::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernLicense::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernLicense::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernLicense::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernLicense::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernLicense::Internal::Types::Array[String]
      ModelArray = -> { FernLicense::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernLicense::Internal::Types::Array[TestUtils::U] }
