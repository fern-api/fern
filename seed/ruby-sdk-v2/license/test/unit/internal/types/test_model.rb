...
describe FernLicense::Internal::Types::Model do
  module StringInteger
    extend FernLicense::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernLicense::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernLicense::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernLicense::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernLicense::Internal::Types::Model
