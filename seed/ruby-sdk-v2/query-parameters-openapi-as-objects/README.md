...
### Custom URL
```ruby
require "fern_query_parameters_openapi_as_objects"

client = FernQueryParametersOpenapiAsObjects::Client.new(
...
rescue FernQueryParametersOpenapiAsObjects::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernQueryParametersOpenapiAsObjects::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernQueryParametersOpenapiAsObjects::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernQueryParametersOpenapiAsObjects::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernQueryParametersOpenapiAsObjects::Errors::ApiError => e
