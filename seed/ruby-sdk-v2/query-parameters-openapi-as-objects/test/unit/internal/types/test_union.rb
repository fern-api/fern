...
describe FernQueryParametersOpenapiAsObjects::Internal::Types::Union do
  class Rectangle < FernQueryParametersOpenapiAsObjects::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernQueryParametersOpenapiAsObjects::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernQueryParametersOpenapiAsObjects::Internal::Types::Model
