...
describe FernQueryParametersOpenapiAsObjects::Internal::Types::Utils do
  Utils = FernQueryParametersOpenapiAsObjects::Internal::Types::Utils

  module TestUtils
    class M < FernQueryParametersOpenapiAsObjects::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernQueryParametersOpenapiAsObjects::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernQueryParametersOpenapiAsObjects::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernQueryParametersOpenapiAsObjects::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernQueryParametersOpenapiAsObjects::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernQueryParametersOpenapiAsObjects::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernQueryParametersOpenapiAsObjects::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernQueryParametersOpenapiAsObjects::Internal::Types::Array[String]
      ModelArray = -> { FernQueryParametersOpenapiAsObjects::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernQueryParametersOpenapiAsObjects::Internal::Types::Array[TestUtils::U] }
