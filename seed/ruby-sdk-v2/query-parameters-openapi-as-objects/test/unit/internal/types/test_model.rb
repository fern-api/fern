...
describe FernQueryParametersOpenapiAsObjects::Internal::Types::Model do
  ...
  class ExampleModel < FernQueryParametersOpenapiAsObjects::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernQueryParametersOpenapiAsObjects::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernQueryParametersOpenapiAsObjects::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernQueryParametersOpenapiAsObjects::Internal::Types::Model
