...
module FernQueryParametersOpenapiAsObjects
  module Internal
    module JSON
      # @api private
      class Request < FernQueryParametersOpenapiAsObjects::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernQueryParametersOpenapiAsObjects::RequestOptions, Hash{Symbol=>Object}, nil]
