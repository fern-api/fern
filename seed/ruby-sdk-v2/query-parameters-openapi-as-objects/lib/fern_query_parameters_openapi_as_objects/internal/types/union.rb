...
module FernQueryParametersOpenapiAsObjects
  module Internal
    module Types
      ...
      module Union
        include FernQueryParametersOpenapiAsObjects::Internal::Types::Type
        ...
        private def type_matches?(value, member_type)
          case member_type
          when FernQueryParametersOpenapiAsObjects::Internal::Types::Hash
            value.is_a?(::Hash)
          when FernQueryParametersOpenapiAsObjects::Internal::Types::Array
            value.is_a?(::Array)
          when Class, Module
