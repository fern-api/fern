...
describe FernCrossPackageTypeNames::Internal::Types::Utils do
  Utils = FernCrossPackageTypeNames::Internal::Types::Utils

  module TestUtils
    class M < FernCrossPackageTypeNames::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernCrossPackageTypeNames::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernCrossPackageTypeNames::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernCrossPackageTypeNames::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernCrossPackageTypeNames::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernCrossPackageTypeNames::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernCrossPackageTypeNames::Internal::Types::Array[TestUtils::U] }
