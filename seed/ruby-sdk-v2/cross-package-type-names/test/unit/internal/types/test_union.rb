...
describe FernCrossPackageTypeNames::Internal::Types::Union do
  class Rectangle < FernCrossPackageTypeNames::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernCrossPackageTypeNames::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernCrossPackageTypeNames::Internal::Types::Model
