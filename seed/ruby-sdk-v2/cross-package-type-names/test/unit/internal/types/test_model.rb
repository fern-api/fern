...
describe FernCrossPackageTypeNames::Internal::Types::Model do
  module StringInteger
    extend FernCrossPackageTypeNames::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernCrossPackageTypeNames::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernCrossPackageTypeNames::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernCrossPackageTypeNames::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernCrossPackageTypeNames::Internal::Types::Model
