...
# require_relative "lib/cross_package_type_names/version"

Gem::Specification.new do |spec|
  spec.name = "cross_package_type_names"
  spec.version = "0.0.1" # TODO: cross_package_type_names::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the cross_package_type_names API"
  # spec.description = "The cross_package_type_names Ruby library provides convenient access to the cross_package_type_names API from Ruby."
