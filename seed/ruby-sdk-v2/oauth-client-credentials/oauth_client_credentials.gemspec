...
# require_relative "lib/oauth_client_credentials/version"

Gem::Specification.new do |spec|
  spec.name = "oauth_client_credentials"
  spec.version = "0.0.1" # TODO: oauth_client_credentials::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the oauth_client_credentials API"
  # spec.description = "The oauth_client_credentials Ruby library provides convenient access to the oauth_client_credentials API from Ruby."
