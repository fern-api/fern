    ...
    class Client
      ...
      def get_token_with_client_credentials(request_options: {}, **params)
        ...
        request = FernOauthClientCredentials::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "/token",
          body: FernOauthClientCredentials::Auth::Types::GetTokenRequest.new(body_bag).to_h,
      ...
      def refresh_token(request_options: {}, **params)
        ...
        request = FernOauthClientCredentials::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "/token",
          body: FernOauthClientCredentials::Auth::Types::RefreshTokenRequest.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
