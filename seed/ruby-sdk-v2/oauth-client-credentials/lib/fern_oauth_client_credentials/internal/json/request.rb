...
module FernOauthClientCredentials
  module Internal
    module JSON
      # @api private
      class Request < FernOauthClientCredentials::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernOauthClientCredentials::RequestOptions, Hash{Symbol=>Object}, nil]
