...
describe FernOauthClientCredentials::Internal::Types::Utils do
  Utils = FernOauthClientCredentials::Internal::Types::Utils

  module TestUtils
    class M < FernOauthClientCredentials::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernOauthClientCredentials::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernOauthClientCredentials::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernOauthClientCredentials::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernOauthClientCredentials::Internal::Types::Array[String]
      ModelArray = -> { FernOauthClientCredentials::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernOauthClientCredentials::Internal::Types::Array[TestUtils::U] }
