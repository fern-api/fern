...
client = FernOauthClientCredentials::Client.new(
...
rescue FernOauthClientCredentials::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernOauthClientCredentials::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernOauthClientCredentials::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernOauthClientCredentials::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernOauthClientCredentials::Errors::ApiError => e
