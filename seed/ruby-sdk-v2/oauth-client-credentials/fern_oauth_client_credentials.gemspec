...
require_relative "lib/fern_oauth_client_credentials/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernOauthClientCredentials"]
  spec.version = FernOauthClientCredentials::VERSION
  spec.summary = "Ruby client library for the FernOauthClientCredentials API"
  spec.description = "The FernOauthClientCredentials Ruby library provides convenient access to the FernOauthClientCredentials API from Ruby."
