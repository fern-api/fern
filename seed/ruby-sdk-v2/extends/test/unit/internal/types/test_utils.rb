...
describe FernExtends::Internal::Types::Utils do
  Utils = FernExtends::Internal::Types::Utils

  module TestUtils
    class M < FernExtends::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernExtends::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernExtends::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernExtends::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernExtends::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernExtends::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernExtends::Internal::Types::Array[String]
      ModelArray = -> { FernExtends::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernExtends::Internal::Types::Array[TestUtils::U] }
