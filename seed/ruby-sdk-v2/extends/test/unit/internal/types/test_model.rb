...
describe FernExtends::Internal::Types::Model do
  ...
  class ExampleModel < FernExtends::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernExtends::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernExtends::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernExtends::Internal::Types::Model
