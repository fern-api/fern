...
require_relative "lib/fern_extends/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernExtends"]
  spec.version = FernExtends::VERSION
  spec.summary = "Ruby client library for the FernExtends API"
  spec.description = "The FernExtends Ruby library provides convenient access to the FernExtends API from Ruby."
