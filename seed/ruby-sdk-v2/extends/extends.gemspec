...
# require_relative "lib/extends/version"

Gem::Specification.new do |spec|
  spec.name = "extends"
  spec.version = "0.0.1" # TODO: extends::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the extends API"
  # spec.description = "The extends Ruby library provides convenient access to the extends API from Ruby."
