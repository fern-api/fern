...
client = FernMixedCase::Client.new(
...
begin
    result = client.service.get_resource
rescue FernMixedCase::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernMixedCase::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernMixedCase::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernMixedCase::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernMixedCase::Errors::ApiError => e
...
response = client.service.get_resource(
    ...,
