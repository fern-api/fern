...
# require_relative "lib/mixed_case/version"

Gem::Specification.new do |spec|
  spec.name = "mixed_case"
  spec.version = "0.0.1" # TODO: mixed_case::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the mixed_case API"
  # spec.description = "The mixed_case Ruby library provides convenient access to the mixed_case API from Ruby."
