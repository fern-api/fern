...
require_relative "lib/fern_mixed_case/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernMixedCase"]
  spec.version = FernMixedCase::VERSION
  spec.summary = "Ruby client library for the FernMixedCase API"
  spec.description = "The FernMixedCase Ruby library provides convenient access to the FernMixedCase API from Ruby."
