...
describe FernMixedCase::Internal::Types::Utils do
  Utils = FernMixedCase::Internal::Types::Utils

  module TestUtils
    class M < FernMixedCase::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernMixedCase::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernMixedCase::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernMixedCase::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernMixedCase::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernMixedCase::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernMixedCase::Internal::Types::Array[TestUtils::U] }
