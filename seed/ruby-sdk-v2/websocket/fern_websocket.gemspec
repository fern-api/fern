...
require_relative "lib/fern_websocket/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernWebsocket"]
  spec.version = FernWebsocket::VERSION
  spec.summary = "Ruby client library for the FernWebsocket API"
  spec.description = "The FernWebsocket Ruby library provides convenient access to the FernWebsocket API from Ruby."
