...
describe FernWebsocket::Internal::Types::Union do
  class Rectangle < FernWebsocket::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernWebsocket::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernWebsocket::Internal::Types::Model
