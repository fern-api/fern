...
describe FernWebsocket::Internal::Types::Utils do
  Utils = FernWebsocket::Internal::Types::Utils

  module TestUtils
    class M < FernWebsocket::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernWebsocket::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernWebsocket::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernWebsocket::Internal::Types::Union
    ...
    SymbolStringHash = FernWebsocket::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernWebsocket::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernWebsocket::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernWebsocket::Internal::Types::Array[String]
      ModelArray = -> { FernWebsocket::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernWebsocket::Internal::Types::Array[TestUtils::U] }
