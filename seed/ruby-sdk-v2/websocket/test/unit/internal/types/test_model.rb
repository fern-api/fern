...
describe FernWebsocket::Internal::Types::Model do
  ...
  class ExampleModel < FernWebsocket::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernWebsocket::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernWebsocket::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernWebsocket::Internal::Types::Model
