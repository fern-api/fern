...
# require_relative "lib/websocket/version"

Gem::Specification.new do |spec|
  spec.name = "websocket"
  spec.version = "0.0.1" # TODO: websocket::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the websocket API"
  # spec.description = "The websocket Ruby library provides convenient access to the websocket API from Ruby."
