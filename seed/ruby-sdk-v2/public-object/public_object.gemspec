...
# require_relative "lib/public_object/version"

Gem::Specification.new do |spec|
  spec.name = "public_object"
  spec.version = "0.0.1" # TODO: public_object::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the public_object API"
  # spec.description = "The public_object Ruby library provides convenient access to the public_object API from Ruby."
