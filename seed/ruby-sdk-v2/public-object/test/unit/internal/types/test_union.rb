...
describe FernPublicObject::Internal::Types::Union do
  class Rectangle < FernPublicObject::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernPublicObject::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernPublicObject::Internal::Types::Model
