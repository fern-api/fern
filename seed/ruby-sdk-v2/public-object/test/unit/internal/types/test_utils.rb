...
describe FernPublicObject::Internal::Types::Utils do
  Utils = FernPublicObject::Internal::Types::Utils

  module TestUtils
    class M < FernPublicObject::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernPublicObject::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernPublicObject::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernPublicObject::Internal::Types::Union
    ...
    SymbolStringHash = FernPublicObject::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernPublicObject::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises FernPublicObject::Internal::Errors::TypeError do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernPublicObject::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernPublicObject::Internal::Types::Array[String]
      ModelArray = -> { FernPublicObject::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernPublicObject::Internal::Types::Array[TestUtils::U] }
