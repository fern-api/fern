...
describe FernPublicObject::Internal::Types::Model do
  ...
  class ExampleModel < FernPublicObject::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernPublicObject::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernPublicObject::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernPublicObject::Internal::Types::Model
