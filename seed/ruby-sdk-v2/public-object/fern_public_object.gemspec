...
require_relative "lib/fern_public_object/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernPublicObject"]
  spec.version = FernPublicObject::VERSION
  spec.summary = "Ruby client library for the FernPublicObject API"
  spec.description = "The FernPublicObject Ruby library provides convenient access to the FernPublicObject API from Ruby."
