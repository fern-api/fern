...
require_relative "lib/fern_simple_api/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_simple_api"
  spec.authors = ["FernSimpleApi"]
  spec.version = FernSimpleApi::VERSION
  spec.summary = "Ruby client library for the FernSimpleApi API"
  spec.description = "The FernSimpleApi Ruby library provides convenient access to the FernSimpleApi API from Ruby."
