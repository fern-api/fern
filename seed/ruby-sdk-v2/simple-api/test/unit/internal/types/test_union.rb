...
describe FernSimpleApi::Internal::Types::Union do
  class Rectangle < FernSimpleApi::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernSimpleApi::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernSimpleApi::Internal::Types::Model
  ...
  module Shape
    extend FernSimpleApi::Internal::Types::Union
