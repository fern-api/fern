...
# require_relative "lib/simple_api/version"

Gem::Specification.new do |spec|
  spec.name = "simple_api"
  spec.version = "0.0.1" # TODO: simple_api::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the simple_api API"
  # spec.description = "The simple_api Ruby library provides convenient access to the simple_api API from Ruby."
