...
### Environments
```ruby
require "fern_simple_api"

fern_simple_api = FernSimpleApi::Client.new(
    base_url: FernSimpleApi::Environment::PRODUCTION
)
```
...
client = FernSimpleApi::Client.new(
...
rescue FernSimpleApi::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernSimpleApi::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernSimpleApi::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernSimpleApi::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernSimpleApi::Errors::ApiError => e
