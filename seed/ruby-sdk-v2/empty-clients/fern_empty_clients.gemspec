...
require_relative "lib/fern_empty_clients/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernEmptyClients"]
  spec.version = FernEmptyClients::VERSION
  spec.summary = "Ruby client library for the FernEmptyClients API"
  spec.description = "The FernEmptyClients Ruby library provides convenient access to the FernEmptyClients API from Ruby."
