...
describe FernEmptyClients::Internal::Types::Union do
  class Rectangle < FernEmptyClients::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernEmptyClients::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernEmptyClients::Internal::Types::Model
