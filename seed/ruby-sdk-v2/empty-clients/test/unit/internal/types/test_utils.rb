...
describe FernEmptyClients::Internal::Types::Utils do
  Utils = FernEmptyClients::Internal::Types::Utils

  module TestUtils
    class M < FernEmptyClients::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernEmptyClients::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernEmptyClients::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernEmptyClients::Internal::Types::Union
    ...
    SymbolStringHash = FernEmptyClients::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernEmptyClients::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernEmptyClients::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernEmptyClients::Internal::Types::Array[String]
      ModelArray = -> { FernEmptyClients::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernEmptyClients::Internal::Types::Array[TestUtils::U] }
