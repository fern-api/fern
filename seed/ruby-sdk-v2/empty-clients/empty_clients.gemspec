...
# require_relative "lib/empty_clients/version"

Gem::Specification.new do |spec|
  spec.name = "empty_clients"
  spec.version = "0.0.1" # TODO: empty_clients::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the empty_clients API"
  # spec.description = "The empty_clients Ruby library provides convenient access to the empty_clients API from Ruby."
