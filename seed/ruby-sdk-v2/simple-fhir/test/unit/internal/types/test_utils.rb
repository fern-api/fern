...
describe FernSimpleFhir::Internal::Types::Utils do
  Utils = FernSimpleFhir::Internal::Types::Utils

  module TestUtils
    class M < FernSimpleFhir::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernSimpleFhir::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernSimpleFhir::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernSimpleFhir::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernSimpleFhir::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernSimpleFhir::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernSimpleFhir::Internal::Types::Array[String]
      ModelArray = -> { FernSimpleFhir::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernSimpleFhir::Internal::Types::Array[TestUtils::U] }
