...
describe FernSimpleFhir::Internal::Types::Union do
  class Rectangle < FernSimpleFhir::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernSimpleFhir::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernSimpleFhir::Internal::Types::Model
