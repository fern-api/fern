...
### Custom URL
```ruby
require "fern_simple_fhir"

client = FernSimpleFhir::Client.new(
...
rescue FernSimpleFhir::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernSimpleFhir::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernSimpleFhir::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernSimpleFhir::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernSimpleFhir::Errors::ApiError => e
