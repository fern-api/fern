...
require_relative "lib/fern_simple_fhir/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_simple_fhir"
  spec.authors = ["FernSimpleFhir"]
  spec.version = FernSimpleFhir::VERSION
  spec.summary = "Ruby client library for the FernSimpleFhir API"
  spec.description = "The FernSimpleFhir Ruby library provides convenient access to the FernSimpleFhir API from Ruby."
