...
describe FernInferredAuthImplicitReference::Internal::Types::Model do
  module StringInteger
    extend FernInferredAuthImplicitReference::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernInferredAuthImplicitReference::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernInferredAuthImplicitReference::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernInferredAuthImplicitReference::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernInferredAuthImplicitReference::Internal::Types::Model
