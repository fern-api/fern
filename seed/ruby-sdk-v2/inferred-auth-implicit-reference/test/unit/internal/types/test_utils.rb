...
describe FernInferredAuthImplicitReference::Internal::Types::Utils do
  Utils = FernInferredAuthImplicitReference::Internal::Types::Utils

  module TestUtils
    class M < FernInferredAuthImplicitReference::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernInferredAuthImplicitReference::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernInferredAuthImplicitReference::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernInferredAuthImplicitReference::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernInferredAuthImplicitReference::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernInferredAuthImplicitReference::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernInferredAuthImplicitReference::Internal::Types::Array[TestUtils::U] }
