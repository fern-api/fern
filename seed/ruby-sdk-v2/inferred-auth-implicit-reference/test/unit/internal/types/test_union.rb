...
describe FernInferredAuthImplicitReference::Internal::Types::Union do
  class Rectangle < FernInferredAuthImplicitReference::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernInferredAuthImplicitReference::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernInferredAuthImplicitReference::Internal::Types::Model
