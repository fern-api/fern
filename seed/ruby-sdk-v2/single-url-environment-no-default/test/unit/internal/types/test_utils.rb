...
describe FernSingleUrlEnvironmentNoDefault::Internal::Types::Utils do
  Utils = FernSingleUrlEnvironmentNoDefault::Internal::Types::Utils

  module TestUtils
    class M < FernSingleUrlEnvironmentNoDefault::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernSingleUrlEnvironmentNoDefault::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernSingleUrlEnvironmentNoDefault::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernSingleUrlEnvironmentNoDefault::Internal::Types::Union
    ...
    SymbolStringHash = FernSingleUrlEnvironmentNoDefault::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernSingleUrlEnvironmentNoDefault::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernSingleUrlEnvironmentNoDefault::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernSingleUrlEnvironmentNoDefault::Internal::Types::Array[String]
      ModelArray = -> { FernSingleUrlEnvironmentNoDefault::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernSingleUrlEnvironmentNoDefault::Internal::Types::Array[TestUtils::U] }
