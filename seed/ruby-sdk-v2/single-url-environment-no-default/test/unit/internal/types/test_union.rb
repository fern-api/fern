...
describe FernSingleUrlEnvironmentNoDefault::Internal::Types::Union do
  class Rectangle < FernSingleUrlEnvironmentNoDefault::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernSingleUrlEnvironmentNoDefault::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernSingleUrlEnvironmentNoDefault::Internal::Types::Model
