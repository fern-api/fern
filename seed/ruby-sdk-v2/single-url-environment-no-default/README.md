...
fern_single_url_environment_no_default = FernSingleUrlEnvironmentNoDefault::Client.new(
    base_url: FernSingleUrlEnvironmentNoDefault::Environment::PRODUCTION
)
```
...
client = FernSingleUrlEnvironmentNoDefault::Client.new(
...
rescue FernSingleUrlEnvironmentNoDefault::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernSingleUrlEnvironmentNoDefault::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernSingleUrlEnvironmentNoDefault::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernSingleUrlEnvironmentNoDefault::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernSingleUrlEnvironmentNoDefault::Errors::ApiError => e
