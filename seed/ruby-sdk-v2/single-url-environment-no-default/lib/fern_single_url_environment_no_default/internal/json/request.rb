...
module FernSingleUrlEnvironmentNoDefault
  module Internal
    module JSON
      # @api private
      class Request < FernSingleUrlEnvironmentNoDefault::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernSingleUrlEnvironmentNoDefault::RequestOptions, Hash{Symbol=>Object}, nil]
