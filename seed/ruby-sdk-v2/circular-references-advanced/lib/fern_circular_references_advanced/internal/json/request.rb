...
module FernCircularReferencesAdvanced
  module Internal
    module JSON
      # @api private
      class Request < FernCircularReferencesAdvanced::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernCircularReferencesAdvanced::RequestOptions, Hash{Symbol=>Object}, nil]
