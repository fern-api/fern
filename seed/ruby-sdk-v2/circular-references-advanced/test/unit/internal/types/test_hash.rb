...
describe FernCircularReferencesAdvanced::Internal::Types::Hash do
  module TestHash
    SymbolStringHash = FernCircularReferencesAdvanced::Internal::Types::Hash[Symbol, String]
  end
  ...
  describe "#coerce" do
    ...
    it "raises an error with other values with strictness on" do
      assert_raises FernCircularReferencesAdvanced::Internal::Errors::TypeError do
