...
describe FernCircularReferencesAdvanced::Internal::Types::Utils do
  Utils = FernCircularReferencesAdvanced::Internal::Types::Utils

  module TestUtils
    class M < FernCircularReferencesAdvanced::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernCircularReferencesAdvanced::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernCircularReferencesAdvanced::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernCircularReferencesAdvanced::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernCircularReferencesAdvanced::Internal::Types::Array[String]
      ModelArray = -> { FernCircularReferencesAdvanced::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernCircularReferencesAdvanced::Internal::Types::Array[TestUtils::U] }
