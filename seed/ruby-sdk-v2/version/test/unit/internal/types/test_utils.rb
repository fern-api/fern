...
describe FernVersion::Internal::Types::Utils do
  Utils = FernVersion::Internal::Types::Utils

  module TestUtils
    class M < FernVersion::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernVersion::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernVersion::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernVersion::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernVersion::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernVersion::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernVersion::Internal::Types::Array[String]
      ModelArray = -> { FernVersion::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernVersion::Internal::Types::Array[TestUtils::U] }
