...
require_relative "lib/fern_version/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_version"
  spec.authors = ["FernVersion"]
  spec.version = FernVersion::VERSION
  spec.summary = "Ruby client library for the FernVersion API"
  spec.description = "The FernVersion Ruby library provides convenient access to the FernVersion API from Ruby."
