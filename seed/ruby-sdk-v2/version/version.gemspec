...
Gem::Specification.new do |spec|
  spec.name = "version"
  spec.version = "0.0.1" # TODO: version::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the version API"
  # spec.description = "The version Ruby library provides convenient access to the version API from Ruby."
