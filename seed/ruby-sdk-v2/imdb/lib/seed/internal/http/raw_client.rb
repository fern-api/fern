  ...
  module Internal
    module Http
      ...
      class RawClient
        ...
        # @return [Seed::Internal::Logging::Logger] The SDK logger
        attr_reader :logger
        ...
        # @param logging_config [Seed::Internal::Logging::LogConfig, Hash, nil] Logging configuration.
        def initialize(base_url:, max_retries: 2, timeout: 60.0, headers: {}, logging_config: nil)
          ...
          @logger = Seed::Internal::Logging::Logger.from(logging_config)
