...
require_relative "lib/fern_imdb/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_imdb"
  spec.authors = ["FernImdb"]
  spec.version = FernImdb::VERSION
  spec.summary = "Ruby client library for the FernImdb API"
  spec.description = "The FernImdb Ruby library provides convenient access to the FernImdb API from Ruby."
