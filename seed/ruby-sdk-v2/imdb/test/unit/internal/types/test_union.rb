...
describe FernImdb::Internal::Types::Union do
  class Rectangle < FernImdb::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernImdb::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernImdb::Internal::Types::Model
