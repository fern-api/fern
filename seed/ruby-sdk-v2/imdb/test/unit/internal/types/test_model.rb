...
describe FernImdb::Internal::Types::Model do
  module StringInteger
    extend FernImdb::Internal::Types::Union

    member String
    member Integer
  end

  class ExampleModel < FernImdb::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernImdb::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernImdb::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernImdb::Internal::Types::Model
