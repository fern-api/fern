...
describe FernImdb::Internal::Types::Utils do
  Utils = FernImdb::Internal::Types::Utils

  module TestUtils
    class M < FernImdb::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernImdb::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernImdb::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernImdb::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernImdb::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernImdb::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernImdb::Internal::Types::Array[TestUtils::U] }
