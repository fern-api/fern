...
describe FernUnions::Internal::Types::Utils do
  Utils = FernUnions::Internal::Types::Utils

  module TestUtils
    class M < FernUnions::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernUnions::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernUnions::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernUnions::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernUnions::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernUnions::Internal::Types::Array[String]
      ModelArray = -> { FernUnions::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernUnions::Internal::Types::Array[TestUtils::U] }
