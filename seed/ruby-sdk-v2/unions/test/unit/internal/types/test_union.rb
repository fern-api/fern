...
describe FernUnions::Internal::Types::Union do
  class Rectangle < FernUnions::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernUnions::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernUnions::Internal::Types::Model
