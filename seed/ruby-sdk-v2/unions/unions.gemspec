...
# require_relative "lib/unions/version"

Gem::Specification.new do |spec|
  spec.name = "unions"
  spec.version = "0.0.1" # TODO: unions::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the unions API"
  # spec.description = "The unions Ruby library provides convenient access to the unions API from Ruby."
