...
require_relative "lib/fern_unions/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernUnions"]
  spec.version = FernUnions::VERSION
  spec.summary = "Ruby client library for the FernUnions API"
  spec.description = "The FernUnions Ruby library provides convenient access to the FernUnions API from Ruby."
