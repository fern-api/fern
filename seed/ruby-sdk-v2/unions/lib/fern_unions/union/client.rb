...
module FernUnions
  module Union
    class Client
      ...
      #
      # @return [FernUnions::Union::Types::Shape]
      def get(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          FernUnions::Union::Types::Shape.load(response.body)
        else
      ...
      # @param request_options [Hash]
      # @param params [FernUnions::Union::Types::Shape]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def update(request_options: {}, **params)
        ...
        request = FernUnions::Internal::JSON::Request.new(
          ...
          method: "PATCH",
          path: "",
          body: FernUnions::Union::Types::Shape.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
