...
require_relative "lib/fern_server_sent_event_examples/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernServerSentEventExamples"]
  spec.version = FernServerSentEventExamples::VERSION
  spec.summary = "Ruby client library for the FernServerSentEventExamples API"
  spec.description = "The FernServerSentEventExamples Ruby library provides convenient access to the FernServerSentEventExamples API from Ruby."
