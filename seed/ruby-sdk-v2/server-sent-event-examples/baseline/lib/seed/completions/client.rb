    ...
    class Client
      ...
      def stream_events(request_options: {}, **params)
        ...
        request = Seed::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "stream-events",
          body: Seed::Completions::Types::StreamEventsRequest.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      # @param request_options [Hash]
      # @param params [Seed::Completions::Types::StreamEventsDiscriminantInDataRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #
      # @return [untyped]
      def stream_events_discriminant_in_data(request_options: {}, **params)
        params = Seed::Internal::Types::Utils.normalize_keys(params)
        request = Seed::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
          path: "stream-events-discriminant-in-data",
          body: Seed::Completions::Types::StreamEventsDiscriminantInDataRequest.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      def stream_events_context_protocol(request_options: {}, **params)
        ...
        request = Seed::Internal::JSON::Request.new(
          ...
          body: Seed::Completions::Types::StreamEventsContextProtocolRequest.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
