...
module FernServerSentEventExamples
  module Internal
    module Multipart
      # @api private
      class Request < FernServerSentEventExamples::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernServerSentEventExamples::RequestOptions, Hash{Symbol=>Object}, nil]
