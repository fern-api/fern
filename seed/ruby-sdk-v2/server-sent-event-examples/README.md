...
### Custom URL
```ruby
require "fern_server_sent_event_examples"

client = FernServerSentEventExamples::Client.new(
...
begin
    result = client.completions.stream
rescue FernServerSentEventExamples::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernServerSentEventExamples::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernServerSentEventExamples::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernServerSentEventExamples::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernServerSentEventExamples::Errors::ApiError => e
