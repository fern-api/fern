...
describe FernServerSentEventExamples::Internal::Types::Union do
  class Rectangle < FernServerSentEventExamples::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernServerSentEventExamples::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernServerSentEventExamples::Internal::Types::Model
  ...
  module Shape
    extend FernServerSentEventExamples::Internal::Types::Union
