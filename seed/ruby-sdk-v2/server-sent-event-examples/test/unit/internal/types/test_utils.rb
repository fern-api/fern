...
describe FernServerSentEventExamples::Internal::Types::Utils do
  Utils = FernServerSentEventExamples::Internal::Types::Utils

  module TestUtils
    class M < FernServerSentEventExamples::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernServerSentEventExamples::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernServerSentEventExamples::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernServerSentEventExamples::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = FernServerSentEventExamples::Internal::Types::Array[String]
      ModelArray = -> { FernServerSentEventExamples::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernServerSentEventExamples::Internal::Types::Array[TestUtils::U] }
