...
# require_relative "lib/multi_url_environment/version"

Gem::Specification.new do |spec|
  spec.name = "multi_url_environment"
  spec.version = "0.0.1" # TODO: multi_url_environment::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the multi_url_environment API"
  # spec.description = "The multi_url_environment Ruby library provides convenient access to the multi_url_environment API from Ruby."
