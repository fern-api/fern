...
fern_multi_url_environment = FernMultiUrlEnvironment::Client.new(
    base_url: FernMultiUrlEnvironment::Environment::PRODUCTION
)
```
...
client = FernMultiUrlEnvironment::Client.new(
...
rescue FernMultiUrlEnvironment::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernMultiUrlEnvironment::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernMultiUrlEnvironment::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernMultiUrlEnvironment::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernMultiUrlEnvironment::Errors::ApiError => e
