...
require_relative "lib/fern_multi_url_environment/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernMultiUrlEnvironment"]
  spec.version = FernMultiUrlEnvironment::VERSION
  spec.summary = "Ruby client library for the FernMultiUrlEnvironment API"
  spec.description = "The FernMultiUrlEnvironment Ruby library provides convenient access to the FernMultiUrlEnvironment API from Ruby."
