...
describe FernMultiUrlEnvironment::Internal::Types::Utils do
  Utils = FernMultiUrlEnvironment::Internal::Types::Utils

  module TestUtils
    class M < FernMultiUrlEnvironment::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernMultiUrlEnvironment::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernMultiUrlEnvironment::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernMultiUrlEnvironment::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernMultiUrlEnvironment::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernMultiUrlEnvironment::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernMultiUrlEnvironment::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernMultiUrlEnvironment::Internal::Types::Array[TestUtils::U] }
