...
describe FernMultiUrlEnvironment::Internal::Types::Model do
  ...
  class ExampleModel < FernMultiUrlEnvironment::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernMultiUrlEnvironment::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernMultiUrlEnvironment::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernMultiUrlEnvironment::Internal::Types::Model
