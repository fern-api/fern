...
describe FernMultiUrlEnvironment::Internal::Types::Union do
  class Rectangle < FernMultiUrlEnvironment::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernMultiUrlEnvironment::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernMultiUrlEnvironment::Internal::Types::Model
