...
# require_relative "lib/any_auth/version"

Gem::Specification.new do |spec|
  spec.name = "any_auth"
  spec.version = "0.0.1" # TODO: any_auth::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the any_auth API"
  # spec.description = "The any_auth Ruby library provides convenient access to the any_auth API from Ruby."
