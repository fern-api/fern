...
describe FernAnyAuth::Internal::Types::Utils do
  Utils = FernAnyAuth::Internal::Types::Utils

  module TestUtils
    class M < FernAnyAuth::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernAnyAuth::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernAnyAuth::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernAnyAuth::Internal::Types::Union
    ...
    SymbolStringHash = FernAnyAuth::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernAnyAuth::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernAnyAuth::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernAnyAuth::Internal::Types::Array[String]
      ModelArray = -> { FernAnyAuth::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernAnyAuth::Internal::Types::Array[TestUtils::U] }
