...
describe FernAnyAuth::Internal::Types::Union do
  class Rectangle < FernAnyAuth::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernAnyAuth::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernAnyAuth::Internal::Types::Model
