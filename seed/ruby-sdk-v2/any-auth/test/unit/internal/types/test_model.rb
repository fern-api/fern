...
describe FernAnyAuth::Internal::Types::Model do
  ...
  class ExampleModel < FernAnyAuth::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernAnyAuth::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernAnyAuth::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernAnyAuth::Internal::Types::Model
