...
require_relative "lib/fern_any_auth/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_any_auth"
  spec.authors = ["FernAnyAuth"]
  spec.version = FernAnyAuth::VERSION
  spec.summary = "Ruby client library for the FernAnyAuth API"
  spec.description = "The FernAnyAuth Ruby library provides convenient access to the FernAnyAuth API from Ruby."
