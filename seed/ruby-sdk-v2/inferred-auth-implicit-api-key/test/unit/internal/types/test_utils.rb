...
describe FernInferredAuthImplicitApiKey::Internal::Types::Utils do
  Utils = FernInferredAuthImplicitApiKey::Internal::Types::Utils

  module TestUtils
    class M < FernInferredAuthImplicitApiKey::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernInferredAuthImplicitApiKey::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernInferredAuthImplicitApiKey::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernInferredAuthImplicitApiKey::Internal::Types::Union
    ...
    SymbolStringHash = FernInferredAuthImplicitApiKey::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernInferredAuthImplicitApiKey::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernInferredAuthImplicitApiKey::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernInferredAuthImplicitApiKey::Internal::Types::Array[String]
      ModelArray = -> { FernInferredAuthImplicitApiKey::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernInferredAuthImplicitApiKey::Internal::Types::Array[TestUtils::U] }
