...
### Custom URL
```ruby
require "fern_inferred_auth_implicit_api_key"

client = FernInferredAuthImplicitApiKey::Client.new(
...
rescue FernInferredAuthImplicitApiKey::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernInferredAuthImplicitApiKey::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernInferredAuthImplicitApiKey::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernInferredAuthImplicitApiKey::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernInferredAuthImplicitApiKey::Errors::ApiError => e
