...
describe FernWebsocketBearerAuth::Internal::Types::Utils do
  Utils = FernWebsocketBearerAuth::Internal::Types::Utils

  module TestUtils
    class M < FernWebsocketBearerAuth::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernWebsocketBearerAuth::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernWebsocketBearerAuth::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernWebsocketBearerAuth::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernWebsocketBearerAuth::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernWebsocketBearerAuth::Internal::Types::Enum
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernWebsocketBearerAuth::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernWebsocketBearerAuth::Internal::Types::Array[TestUtils::U] }
