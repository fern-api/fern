...
describe FernWebsocketBearerAuth::Internal::Types::Model do
  ...
  class ExampleModel < FernWebsocketBearerAuth::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernWebsocketBearerAuth::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernWebsocketBearerAuth::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernWebsocketBearerAuth::Internal::Types::Model
