...
describe FernWebsocketBearerAuth::Internal::Types::Array do
  module TestArray
    StringArray = FernWebsocketBearerAuth::Internal::Types::Array[String]
  end
  ...
  describe "#coerce" do
    ...
    it "raises an error if not an array and strictness is on" do
      assert_raises FernWebsocketBearerAuth::Internal::Errors::TypeError do
