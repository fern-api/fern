...
# require_relative "lib/websocket_bearer_auth/version"

Gem::Specification.new do |spec|
  spec.name = "websocket_bearer_auth"
  spec.version = "0.0.1" # TODO: websocket_bearer_auth::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the websocket_bearer_auth API"
  # spec.description = "The websocket_bearer_auth Ruby library provides convenient access to the websocket_bearer_auth API from Ruby."
