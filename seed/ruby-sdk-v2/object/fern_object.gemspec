...
require_relative "lib/fern_object/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernObject"]
  spec.version = FernObject::VERSION
  spec.summary = "Ruby client library for the FernObject API"
  spec.description = "The FernObject Ruby library provides convenient access to the FernObject API from Ruby."
