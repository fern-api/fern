...
# require_relative "lib/object/version"

Gem::Specification.new do |spec|
  spec.name = "object"
  spec.version = "0.0.1" # TODO: object::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the object API"
  # spec.description = "The object Ruby library provides convenient access to the object API from Ruby."
