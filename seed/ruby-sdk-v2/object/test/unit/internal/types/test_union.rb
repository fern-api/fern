...
describe FernObject::Internal::Types::Union do
  class Rectangle < FernObject::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernObject::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernObject::Internal::Types::Model
