...
describe FernObject::Internal::Types::Utils do
  Utils = FernObject::Internal::Types::Utils

  module TestUtils
    class M < FernObject::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernObject::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernObject::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernObject::Internal::Types::Union
    ...
    SymbolStringHash = FernObject::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernObject::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernObject::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernObject::Internal::Types::Array[String]
      ModelArray = -> { FernObject::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernObject::Internal::Types::Array[TestUtils::U] }
