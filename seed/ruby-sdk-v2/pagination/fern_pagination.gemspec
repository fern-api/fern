...
require_relative "lib/fern_pagination/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernPagination"]
  spec.version = FernPagination::VERSION
  spec.summary = "Ruby client library for the FernPagination API"
  spec.description = "The FernPagination Ruby library provides convenient access to the FernPagination API from Ruby."
