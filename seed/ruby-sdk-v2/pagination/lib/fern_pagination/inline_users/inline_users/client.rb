  ...
  module InlineUsers
    module InlineUsers
      class Client
        ...
        # @option params [FernPagination::InlineUsers::InlineUsers::Types::Order, nil] :order
        ...
        def list_with_cursor_pagination(request_options: {}, **params)
          ...
          FernPagination::Internal::CursorItemIterator.new(
            ...
            if code.between?(200, 299)
              FernPagination::InlineUsers::InlineUsers::Types::ListUsersPaginationResponse.load(response.body)
            else
        ...
        #
        # @return [FernPagination::InlineUsers::InlineUsers::Types::ListUsersMixedTypePaginationResponse]
        def list_with_mixed_type_cursor_pagination(request_options: {}, **params)
          ...
          FernPagination::Internal::CursorItemIterator.new(
            ...
            code = response.code.to_i
            if code.between?(200, 299)
              FernPagination::InlineUsers::InlineUsers::Types::ListUsersMixedTypePaginationResponse.load(response.body)
            else
              error_class = FernPagination::Errors::ResponseError.subclass_for_code(code)
              raise error_class.new(response.body, code: code)
            end
        ...
        # @param request_options [Hash]
        # @param params [FernPagination::InlineUsers::InlineUsers::Types::ListUsersBodyCursorPaginationRequest]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        # @param request_options [Hash]
        # @param params [FernPagination::InlineUsers::InlineUsers::Types::ListUsersBodyOffsetPaginationRequest]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        # @option params [String, nil] :cursor
        #
        # @return [FernPagination::InlineUsers::InlineUsers::Types::ListUsersExtendedResponse]
        def list_with_extended_results(request_options: {}, **params)
          ...
          FernPagination::Internal::CursorItemIterator.new(
            ...
            code = response.code.to_i
            if code.between?(200, 299)
              FernPagination::InlineUsers::InlineUsers::Types::ListUsersExtendedResponse.load(response.body)
            else
              error_class = FernPagination::Errors::ResponseError.subclass_for_code(code)
              raise error_class.new(response.body, code: code)
            end
        ...
        # @option params [String, nil] :cursor
        #
        # @return [FernPagination::InlineUsers::InlineUsers::Types::ListUsersExtendedOptionalListResponse]
        def list_with_extended_results_and_optional_data(request_options: {}, **params)
          ...
          FernPagination::Internal::CursorItemIterator.new(
            ...
            code = response.code.to_i
            if code.between?(200, 299)
              FernPagination::InlineUsers::InlineUsers::Types::ListUsersExtendedOptionalListResponse.load(response.body)
            else
              error_class = FernPagination::Errors::ResponseError.subclass_for_code(code)
              raise error_class.new(response.body, code: code)
            end
        ...
        #
        # @return [FernPagination::InlineUsers::InlineUsers::Types::UsernameContainer]
        def list_with_global_config(request_options: {}, **params)
          ...
          FernPagination::Internal::OffsetItemIterator.new(
            ...
            code = response.code.to_i
            if code.between?(200, 299)
              FernPagination::InlineUsers::InlineUsers::Types::UsernameContainer.load(response.body)
            else
              error_class = FernPagination::Errors::ResponseError.subclass_for_code(code)
              raise error_class.new(response.body, code: code)
            end
