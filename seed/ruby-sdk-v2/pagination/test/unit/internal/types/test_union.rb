...
describe FernPagination::Internal::Types::Union do
  class Rectangle < FernPagination::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernPagination::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernPagination::Internal::Types::Model
