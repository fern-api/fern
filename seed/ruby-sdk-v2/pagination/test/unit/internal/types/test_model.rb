...
describe FernPagination::Internal::Types::Model do
  ...
  class ExampleModel < FernPagination::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernPagination::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernPagination::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernPagination::Internal::Types::Model
