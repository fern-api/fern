...
describe FernPagination::Internal::Types::Utils do
  Utils = FernPagination::Internal::Types::Utils

  module TestUtils
    class M < FernPagination::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernPagination::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernPagination::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernPagination::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernPagination::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernPagination::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernPagination::Internal::Types::Array[TestUtils::U] }
