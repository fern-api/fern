...
client = FernPackageYml::Client.new(
...
begin
    result = client.echo
rescue FernPackageYml::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernPackageYml::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernPackageYml::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernPackageYml::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernPackageYml::Errors::ApiError => e
