...
require_relative "lib/fern_package_yml/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernPackageYml"]
  spec.version = FernPackageYml::VERSION
  spec.summary = "Ruby client library for the FernPackageYml API"
  spec.description = "The FernPackageYml Ruby library provides convenient access to the FernPackageYml API from Ruby."
