...
# require_relative "lib/package_yml/version"

Gem::Specification.new do |spec|
  spec.name = "package_yml"
  spec.version = "0.0.1" # TODO: package_yml::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the package_yml API"
  # spec.description = "The package_yml Ruby library provides convenient access to the package_yml API from Ruby."
