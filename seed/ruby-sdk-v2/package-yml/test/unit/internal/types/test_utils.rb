...
describe FernPackageYml::Internal::Types::Utils do
  Utils = FernPackageYml::Internal::Types::Utils

  module TestUtils
    class M < FernPackageYml::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernPackageYml::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernPackageYml::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernPackageYml::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernPackageYml::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernPackageYml::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernPackageYml::Internal::Types::Array[String]
      ModelArray = -> { FernPackageYml::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernPackageYml::Internal::Types::Array[TestUtils::U] }
