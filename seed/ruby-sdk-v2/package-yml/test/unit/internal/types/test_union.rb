...
describe FernPackageYml::Internal::Types::Union do
  class Rectangle < FernPackageYml::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernPackageYml::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernPackageYml::Internal::Types::Model
  ...
  module Shape
    extend FernPackageYml::Internal::Types::Union
