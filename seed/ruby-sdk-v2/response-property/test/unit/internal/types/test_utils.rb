...
describe FernResponseProperty::Internal::Types::Utils do
  Utils = FernResponseProperty::Internal::Types::Utils

  module TestUtils
    class M < FernResponseProperty::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernResponseProperty::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernResponseProperty::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolModelHash = -> { FernResponseProperty::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernResponseProperty::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernResponseProperty::Internal::Types::Array[String]
      ModelArray = -> { FernResponseProperty::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernResponseProperty::Internal::Types::Array[TestUtils::U] }
