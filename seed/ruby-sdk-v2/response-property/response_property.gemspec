...
# require_relative "lib/response_property/version"

Gem::Specification.new do |spec|
  spec.name = "response_property"
  spec.version = "0.0.1" # TODO: response_property::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the response_property API"
  # spec.description = "The response_property Ruby library provides convenient access to the response_property API from Ruby."
