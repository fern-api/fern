...
client = FernResponseProperty::Client.new(
...
rescue FernResponseProperty::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernResponseProperty::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernResponseProperty::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernResponseProperty::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernResponseProperty::Errors::ApiError => e
