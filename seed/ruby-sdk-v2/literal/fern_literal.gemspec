...
require_relative "lib/fern_literal/version"
...
Gem::Specification.new do |spec|
  spec.name = "fern_literal"
  spec.authors = ["FernLiteral"]
  spec.version = FernLiteral::VERSION
  spec.summary = "Ruby client library for the FernLiteral API"
  spec.description = "The FernLiteral Ruby library provides convenient access to the FernLiteral API from Ruby."
