...
Gem::Specification.new do |spec|
  spec.name = "literal"
  spec.version = "0.0.1" # TODO: literal::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the literal API"
  # spec.description = "The literal Ruby library provides convenient access to the literal API from Ruby."
