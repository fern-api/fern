...
describe FernLiteral::Internal::Types::Union do
  class Rectangle < FernLiteral::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernLiteral::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernLiteral::Internal::Types::Model
