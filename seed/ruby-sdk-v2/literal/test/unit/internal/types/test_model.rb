...
describe FernLiteral::Internal::Types::Model do
  ...
  class ExampleModel < FernLiteral::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernLiteral::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernLiteral::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernLiteral::Internal::Types::Model
