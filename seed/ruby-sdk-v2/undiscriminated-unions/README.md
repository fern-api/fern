...
client = FernUndiscriminatedUnions::Client.new(
...
begin
    result = client.union.get
rescue FernUndiscriminatedUnions::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernUndiscriminatedUnions::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernUndiscriminatedUnions::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernUndiscriminatedUnions::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernUndiscriminatedUnions::Errors::ApiError => e
