...
require_relative "lib/fern_undiscriminated_unions/version"
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["FernUndiscriminatedUnions"]
  spec.version = FernUndiscriminatedUnions::VERSION
  spec.summary = "Ruby client library for the FernUndiscriminatedUnions API"
  spec.description = "The FernUndiscriminatedUnions Ruby library provides convenient access to the FernUndiscriminatedUnions API from Ruby."
