...
# require_relative "lib/undiscriminated_unions/version"

Gem::Specification.new do |spec|
  spec.name = "undiscriminated_unions"
  spec.version = "0.0.1" # TODO: undiscriminated_unions::VERSION
  spec.authors = ["Fern"]
  spec.email = ["support@buildwithfern.com"]
  spec.summary = "Ruby client library for the undiscriminated_unions API"
  # spec.description = "The undiscriminated_unions Ruby library provides convenient access to the undiscriminated_unions API from Ruby."
