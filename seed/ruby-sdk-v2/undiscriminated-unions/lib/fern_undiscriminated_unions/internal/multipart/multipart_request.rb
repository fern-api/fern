...
module FernUndiscriminatedUnions
  module Internal
    module Multipart
      # @api private
      class Request < FernUndiscriminatedUnions::Internal::Http::BaseRequest
        attr_reader :body
        ...
        # @param request_options [FernUndiscriminatedUnions::RequestOptions, Hash{Symbol=>Object}, nil]
