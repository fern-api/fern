...
describe FernUndiscriminatedUnions::Internal::Types::Utils do
  Utils = FernUndiscriminatedUnions::Internal::Types::Utils

  module TestUtils
    class M < FernUndiscriminatedUnions::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernUndiscriminatedUnions::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernUndiscriminatedUnions::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = FernUndiscriminatedUnions::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernUndiscriminatedUnions::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      ...
      ModelArray = -> { FernUndiscriminatedUnions::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernUndiscriminatedUnions::Internal::Types::Array[TestUtils::U] }
