...
describe FernUndiscriminatedUnions::Internal::Types::Union do
  class Rectangle < FernUndiscriminatedUnions::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernUndiscriminatedUnions::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernUndiscriminatedUnions::Internal::Types::Model
