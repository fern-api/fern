...
### Custom URL
```ruby
require "fern_endpoint_security_auth"

client = FernEndpointSecurityAuth::Client.new(
...
rescue FernEndpointSecurityAuth::Errors::TimeoutError
    puts "API didn't respond before our timeout elapsed"
rescue FernEndpointSecurityAuth::Errors::ServiceUnavailableError
    puts "API returned status 503, is probably overloaded, try again later"
rescue FernEndpointSecurityAuth::Errors::ServerError
    puts "API returned some other 5xx status, this is probably a bug"
rescue FernEndpointSecurityAuth::Errors::ResponseError => e
    puts "API returned an unexpected status other than 5xx: #{e.code} #{e.message}"
rescue FernEndpointSecurityAuth::Errors::ApiError => e
