...
describe FernEndpointSecurityAuth::Internal::Types::Utils do
  Utils = FernEndpointSecurityAuth::Internal::Types::Utils

  module TestUtils
    class M < FernEndpointSecurityAuth::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < FernEndpointSecurityAuth::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < FernEndpointSecurityAuth::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend FernEndpointSecurityAuth::Internal::Types::Union
    ...
    SymbolStringHash = FernEndpointSecurityAuth::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { FernEndpointSecurityAuth::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend FernEndpointSecurityAuth::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = FernEndpointSecurityAuth::Internal::Types::Array[String]
      ModelArray = -> { FernEndpointSecurityAuth::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { FernEndpointSecurityAuth::Internal::Types::Array[TestUtils::U] }
