...
describe FernEndpointSecurityAuth::Internal::Types::Model do
  ...
  class ExampleModel < FernEndpointSecurityAuth::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < FernEndpointSecurityAuth::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < FernEndpointSecurityAuth::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < FernEndpointSecurityAuth::Internal::Types::Model
