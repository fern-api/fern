...
describe FernEndpointSecurityAuth::Internal::Types::Union do
  class Rectangle < FernEndpointSecurityAuth::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < FernEndpointSecurityAuth::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < FernEndpointSecurityAuth::Internal::Types::Model
