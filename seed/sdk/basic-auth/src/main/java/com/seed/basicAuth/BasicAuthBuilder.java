...
public final class BasicAuthBuilder {
    ...
    public BasicAuthBuilder credentials(String username, String password) {
    ...
    public BasicAuthBuilder url(String url) {
    ...
    public BasicAuth build() {
        ...
        return new BasicAuth(clientOptionsBuilder.build());
    }
}
