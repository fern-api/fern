...
public final class ProblemDescriptionBoard {
    ...
    public static ProblemDescriptionBoard variable(com.seed.trace.commons.VariableValue value) {
    ...
    public Optional<com.seed.trace.commons.VariableValue> getVariable() {
        if (isVariable()) {
    ...
    public interface Visitor<T> {
        ...
        T visitVariable(com.seed.trace.commons.VariableValue variable);
    ...
    private static final class VariableValue implements Value {
        @JsonProperty("value")
        private com.seed.trace.commons.VariableValue value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private VariableValue(@JsonProperty("value") com.seed.trace.commons.VariableValue value) {
            this.value = value;
        }
