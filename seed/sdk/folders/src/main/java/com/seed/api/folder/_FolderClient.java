...
import com.seed.api.folder.service._ServiceClient;
...
public class _FolderClient {
    protected final ClientOptions clientOptions;

    protected final Supplier<_ServiceClient> serviceClient;

    public _FolderClient(ClientOptions clientOptions) {
