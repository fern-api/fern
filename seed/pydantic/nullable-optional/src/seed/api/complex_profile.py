...
class ComplexProfile(UniversalBaseModel):
    ...
    nullable_role: typing_extensions.Annotated[
        UserRole, FieldMetadata(alias="nullableRole"), pydantic.Field(alias="nullableRole")
    ]
    ...
    nullable_status: typing_extensions.Annotated[
        UserStatus, FieldMetadata(alias="nullableStatus"), pydantic.Field(alias="nullableStatus")
    ]
    ...
    nullable_notification: typing_extensions.Annotated[
        NotificationMethod, FieldMetadata(alias="nullableNotification"), pydantic.Field(alias="nullableNotification")
    ]
    ...
    nullable_search_result: typing_extensions.Annotated[
        SearchResult, FieldMetadata(alias="nullableSearchResult"), pydantic.Field(alias="nullableSearchResult")
    ]
    ...
    optional_map_of_enums: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, typing.Optional[UserRole]]],
