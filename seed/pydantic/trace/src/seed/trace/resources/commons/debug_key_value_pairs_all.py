...
class DebugKeyValuePairs(UniversalBaseModel):
    key: "resources_commons_debug_variable_value_DebugVariableValue"
    value: "resources_commons_debug_variable_value_DebugVariableValue"
...
class DebugMapValue(UniversalBaseModel):
    key_value_pairs: typing.List["resources_commons_debug_key_value_pairs_DebugKeyValuePairs"] = pydantic.Field(
        alias="keyValuePairs"
    )
...
from .debug_map_value import DebugMapValue as resources_commons_debug_map_value_DebugMapValue  # noqa: E402, F401, I001


class DebugVariableValue_ListValue(UniversalBaseModel):
    value: typing.List["resources_commons_debug_variable_value_DebugVariableValue"]
...
from .debug_variable_value import DebugVariableValue as resources_commons_debug_variable_value_DebugVariableValue  # noqa: E402, F401, I001
from .debug_key_value_pairs import DebugKeyValuePairs as resources_commons_debug_key_value_pairs_DebugKeyValuePairs  # noqa: E402, F401, I001
