...
class KeyValuePair(UniversalBaseModel):
    key: "resources_commons_variable_value_VariableValue"
    value: "resources_commons_variable_value_VariableValue"
...
class MapValue(UniversalBaseModel):
    key_value_pairs: typing.List["resources_commons_key_value_pair_KeyValuePair"] = pydantic.Field(
        alias="keyValuePairs"
    )
...
from .map_value import MapValue as resources_commons_map_value_MapValue  # noqa: E402, F401, I001
...
from .variable_value import VariableValue as resources_commons_variable_value_VariableValue  # noqa: E402, F401, I001
from .key_value_pair import KeyValuePair as resources_commons_key_value_pair_KeyValuePair  # noqa: E402, F401, I001
