...
class ListType(UniversalBaseModel):
    value_type: "resources_commons_variable_type_VariableType" = pydantic.Field(alias="valueType")
...
class MapType(UniversalBaseModel):
    key_type: "resources_commons_variable_type_VariableType" = pydantic.Field(alias="keyType")
    value_type: "resources_commons_variable_type_VariableType" = pydantic.Field(alias="valueType")
...
from .map_type import MapType as resources_commons_map_type_MapType  # noqa: E402, F401, I001
from .list_type import ListType as resources_commons_list_type_ListType  # noqa: E402, F401, I001
...
from .variable_type import VariableType as resources_commons_variable_type_VariableType  # noqa: E402, F401, I001
