...
update_forward_refs(MapValue, ProblemInfoV2=ProblemInfoV2)
update_forward_refs(ListType, ProblemInfoV2=ProblemInfoV2)
update_forward_refs(MapType, ProblemInfoV2=ProblemInfoV2)
