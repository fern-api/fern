...
[JsonConverter(typeof(TracedFile.JsonConverter))]
[Serializable]
public record TracedFile
{
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<TracedFile>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(TracedFile).IsAssignableFrom(typeToConvert);

        public override TracedFile? Read(
        ...
        public override TracedFile ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return JsonSerializer.Deserialize<TracedFile>(json, options);
        }
