...
[JsonConverter(typeof(WorkspaceTracedUpdate.JsonConverter))]
[Serializable]
public record WorkspaceTracedUpdate
{
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<WorkspaceTracedUpdate>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(WorkspaceTracedUpdate).IsAssignableFrom(typeToConvert);

        public override WorkspaceTracedUpdate? Read(
        ...
        )
        {
            ...
            return new WorkspaceTracedUpdate
            {
        ...
        public override WorkspaceTracedUpdate ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return JsonSerializer.Deserialize<WorkspaceTracedUpdate>(json, options);
        }
