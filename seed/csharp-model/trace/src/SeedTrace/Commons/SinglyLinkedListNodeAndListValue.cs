...
[JsonConverter(typeof(SinglyLinkedListNodeAndListValue.JsonConverter))]
[Serializable]
public record SinglyLinkedListNodeAndListValue
{
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<SinglyLinkedListNodeAndListValue>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(SinglyLinkedListNodeAndListValue).IsAssignableFrom(typeToConvert);

        public override SinglyLinkedListNodeAndListValue? Read(
        ...
        )
        {
            ...
            SinglyLinkedListValue _fullList = default;
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                switch (propertyName)
                {
                    case "nodeId":
                        ...
                        break;
                    case "fullList":
                        _fullList = JsonSerializer.Deserialize<SinglyLinkedListValue>(
                            ref reader,
                            options
                        );
                        break;
            ...
            return new SinglyLinkedListNodeAndListValue
            {
                NodeId = _nodeId,
                FullList = _fullList,
