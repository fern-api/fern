...
[JsonConverter(typeof(StreamProtocolCollisionResponse.JsonConverter))]
[Serializable]
public record StreamProtocolCollisionResponse
{
    internal StreamProtocolCollisionResponse(string type, object? value)
    {
        Event = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of StreamProtocolCollisionResponse with <see cref="StreamProtocolCollisionResponse.Heartbeat"/>.
    /// </summary>
    public StreamProtocolCollisionResponse(StreamProtocolCollisionResponse.Heartbeat value)
    {
        Event = "heartbeat";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of StreamProtocolCollisionResponse with <see cref="StreamProtocolCollisionResponse.StringData"/>.
    /// </summary>
    public StreamProtocolCollisionResponse(StreamProtocolCollisionResponse.StringData value)
    {
        Event = "string_data";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of StreamProtocolCollisionResponse with <see cref="StreamProtocolCollisionResponse.NumberData"/>.
    /// </summary>
    public StreamProtocolCollisionResponse(StreamProtocolCollisionResponse.NumberData value)
    {
        Event = "number_data";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of StreamProtocolCollisionResponse with <see cref="StreamProtocolCollisionResponse.ObjectData"/>.
    /// </summary>
    public StreamProtocolCollisionResponse(StreamProtocolCollisionResponse.ObjectData value)
    {
        Event = "object_data";
        Value = value.Value;
    }
    ...
    public SeedApi.ProtocolHeartbeat AsHeartbeat() =>
        IsHeartbeat
            ...
            : throw new global::System.Exception(
                "StreamProtocolCollisionResponse.Event is not 'heartbeat'"
            );
    ...
    public SeedApi.ProtocolStringEvent AsStringData() =>
        IsStringData
            ...
            : throw new global::System.Exception(
                "StreamProtocolCollisionResponse.Event is not 'string_data'"
            );
    ...
    public SeedApi.ProtocolNumberEvent AsNumberData() =>
        IsNumberData
            ...
            : throw new global::System.Exception(
                "StreamProtocolCollisionResponse.Event is not 'number_data'"
            );

    /// <summary>
    /// Returns the value as a <see cref="SeedApi.ProtocolCollisionObjectEvent"/> if <see cref="Event"/> is 'object_data', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Event"/> is not 'object_data'.</exception>
    public SeedApi.ProtocolCollisionObjectEvent AsObjectData() =>
        IsObjectData
            ? (SeedApi.ProtocolCollisionObjectEvent)Value!
            : throw new global::System.Exception(
                "StreamProtocolCollisionResponse.Event is not 'object_data'"
            );
    ...
    public T Match<T>(
        ...
        Func<SeedApi.ProtocolCollisionObjectEvent, T> onObjectData,
    ...
    public void Visit(
        ...
        Action<SeedApi.ProtocolCollisionObjectEvent> onObjectData,
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="SeedApi.ProtocolCollisionObjectEvent"/> and returns true if successful.
    /// </summary>
    public bool TryAsObjectData(out SeedApi.ProtocolCollisionObjectEvent? value)
    {
        if (Event == "object_data")
        {
            value = (SeedApi.ProtocolCollisionObjectEvent)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    public static implicit operator StreamProtocolCollisionResponse(
        StreamProtocolCollisionResponse.Heartbeat value
    ) => new(value);

    public static implicit operator StreamProtocolCollisionResponse(
        StreamProtocolCollisionResponse.StringData value
    ) => new(value);

    public static implicit operator StreamProtocolCollisionResponse(
        StreamProtocolCollisionResponse.NumberData value
    ) => new(value);

    public static implicit operator StreamProtocolCollisionResponse(
        StreamProtocolCollisionResponse.ObjectData value
    ) => new(value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<StreamProtocolCollisionResponse>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(StreamProtocolCollisionResponse).IsAssignableFrom(typeToConvert);

        public override StreamProtocolCollisionResponse Read(
        ...
        )
        {
            ...
            var value = discriminator switch
            {
                ...
                "object_data" =>
                    jsonWithoutDiscriminator.Deserialize<SeedApi.ProtocolCollisionObjectEvent?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize SeedApi.ProtocolCollisionObjectEvent"
                        ),
                _ => json.Deserialize<object?>(options),
            };
            return new StreamProtocolCollisionResponse(discriminator, value);
        }

        public override void Write(
            Utf8JsonWriter writer,
            StreamProtocolCollisionResponse value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
        ...
        public override StreamProtocolCollisionResponse ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new StreamProtocolCollisionResponse(stringValue, stringValue);
        }
    ...
    public struct Heartbeat
    {
        ...
        public static implicit operator StreamProtocolCollisionResponse.Heartbeat(
            SeedApi.ProtocolHeartbeat value
        ) => new(value);
    }
    ...
    public struct StringData
    {
        ...
        public static implicit operator StreamProtocolCollisionResponse.StringData(
            SeedApi.ProtocolStringEvent value
        ) => new(value);
    }
    ...
    public struct NumberData
    {
        ...
        public static implicit operator StreamProtocolCollisionResponse.NumberData(
            SeedApi.ProtocolNumberEvent value
        ) => new(value);
    }
    ...
    {
        public ObjectData(SeedApi.ProtocolCollisionObjectEvent value)
        {
            Value = value;
        }

        internal SeedApi.ProtocolCollisionObjectEvent Value { get; set; }

        public override string ToString() => Value.ToString() ?? "null";

        public static implicit operator StreamProtocolCollisionResponse.ObjectData(
            SeedApi.ProtocolCollisionObjectEvent value
        ) => new(value);
    }
}
