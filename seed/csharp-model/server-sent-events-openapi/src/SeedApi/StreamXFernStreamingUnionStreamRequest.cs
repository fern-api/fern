...
/// </summary>
[JsonConverter(typeof(StreamXFernStreamingUnionStreamRequest.JsonConverter))]
[Serializable]
public record StreamXFernStreamingUnionStreamRequest
{
    ...
    /// <summary>
    /// Create an instance of StreamXFernStreamingUnionStreamRequest with <see cref="StreamXFernStreamingUnionStreamRequest.Message"/>.
    /// </summary>
    public StreamXFernStreamingUnionStreamRequest(
        StreamXFernStreamingUnionStreamRequest.Message value
    )
    {
        Type = "message";
        Value = value.Value;
    ...
    /// <summary>
    /// Create an instance of StreamXFernStreamingUnionStreamRequest with <see cref="StreamXFernStreamingUnionStreamRequest.Interrupt"/>.
    /// </summary>
    public StreamXFernStreamingUnionStreamRequest(
        StreamXFernStreamingUnionStreamRequest.Interrupt value
    )
    {
        Type = "interrupt";
        Value = value.Value;
    ...
    /// <summary>
    /// Create an instance of StreamXFernStreamingUnionStreamRequest with <see cref="StreamXFernStreamingUnionStreamRequest.Compact"/>.
    /// </summary>
    public StreamXFernStreamingUnionStreamRequest(
        StreamXFernStreamingUnionStreamRequest.Compact value
    )
    {
        Type = "compact";
        Value = value.Value;
    ...
    public SeedApi.UnionStreamMessageVariant AsMessage() =>
        IsMessage
            ...
            : throw new global::System.Exception(
                "StreamXFernStreamingUnionStreamRequest.Type is not 'message'"
            );
    ...
    public SeedApi.UnionStreamInterruptVariant AsInterrupt() =>
        IsInterrupt
            ...
            : throw new global::System.Exception(
                "StreamXFernStreamingUnionStreamRequest.Type is not 'interrupt'"
            );
    ...
    public SeedApi.UnionStreamCompactVariant AsCompact() =>
        IsCompact
            ...
            : throw new global::System.Exception(
                "StreamXFernStreamingUnionStreamRequest.Type is not 'compact'"
            );
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<StreamXFernStreamingUnionStreamRequest>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(StreamXFernStreamingUnionStreamRequest).IsAssignableFrom(typeToConvert);

        public override StreamXFernStreamingUnionStreamRequest Read(
        ...
        )
        {
            ...
            var baseProperties =
                json.Deserialize<StreamXFernStreamingUnionStreamRequest.BaseProperties>(options)
                ?? throw new JsonException(
                    "Failed to deserialize StreamXFernStreamingUnionStreamRequest.BaseProperties"
                );
            return new StreamXFernStreamingUnionStreamRequest(discriminator, value)
            {
        ...
        public override void Write(
            ...
            StreamXFernStreamingUnionStreamRequest value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
            ...
            var basePropertiesJson =
                JsonSerializer.SerializeToNode(
                    new StreamXFernStreamingUnionStreamRequest.BaseProperties
                    {
                ...
                ?? throw new JsonException(
                    "Failed to serialize StreamXFernStreamingUnionStreamRequest.BaseProperties"
                );
        ...
        public override StreamXFernStreamingUnionStreamRequest ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new StreamXFernStreamingUnionStreamRequest(stringValue, stringValue);
        }
    ...
    public struct Message
    {
        ...
        public static implicit operator StreamXFernStreamingUnionStreamRequest.Message(
            SeedApi.UnionStreamMessageVariant value
        ) => new(value);
    }
    ...
    public struct Interrupt
    {
        ...
        public static implicit operator StreamXFernStreamingUnionStreamRequest.Interrupt(
            SeedApi.UnionStreamInterruptVariant value
        ) => new(value);
    }
    ...
    public struct Compact
    {
        ...
        public static implicit operator StreamXFernStreamingUnionStreamRequest.Compact(
            SeedApi.UnionStreamCompactVariant value
        ) => new(value);
    }
}
