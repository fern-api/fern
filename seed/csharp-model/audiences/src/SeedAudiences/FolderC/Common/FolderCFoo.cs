...
[JsonConverter(typeof(FolderCFoo.JsonConverter))]
[Serializable]
public record FolderCFoo
{
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<FolderCFoo>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(FolderCFoo).IsAssignableFrom(typeToConvert);

        public override FolderCFoo? Read(
        ...
        public override FolderCFoo ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return JsonSerializer.Deserialize<FolderCFoo>(json, options);
        }
