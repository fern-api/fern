...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/schemaless-request-body-examples)](https://central.sonatype.com/artifact/com.fern/schemaless-request-body-examples)
...
```groovy
dependencies {
  implementation 'com.fern:schemaless-request-body-examples:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>schemaless-request-body-examples</artifactId>
...
```java
SeedApiHttpResponse response = client.withRawResponse().createPlant(...);
