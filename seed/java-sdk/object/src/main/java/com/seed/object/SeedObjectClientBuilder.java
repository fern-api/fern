...
import com.seed.object.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedObjectClientBuilder {
     ...
     */
    public SeedObjectClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedObjectClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedObjectClientBuilder addHeader(String name, String value) {
    ...
    public SeedObjectClient build() {
        ...
        return new SeedObjectClient(buildClientOptions());
    }
}
