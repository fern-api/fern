...
public class Example38 {
    public static void main(String[] args) {
        ...
        client.problem()
                .updateproblem(
                        "problemId",
                        ProblemUpdateProblemRequest.builder()
                                .body(CreateProblemRequest.builder()
                                        .problemName("problemName")
                                        .problemDescription(ProblemDescription.builder()
                                                .boards(Arrays.asList(ProblemDescriptionBoard.html(
                                                        ProblemDescriptionBoardHtml.builder()
                                                                .build())))
                                                .build())
                                        ...
                                        .testcases(Arrays.asList(TestCaseWithExpectedResult.builder()
                                                .testCase(TestCase.builder()
                                                        .id("id")
                                                        .params(Arrays.asList(VariableValue.of(
                                                                VariableValueZero.builder()
