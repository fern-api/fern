...
public final class SubmissionIdNotFound implements ISubmissionIdNotFound {
    ...
    private SubmissionIdNotFound(String missingSubmissionId, Map<String, Object> additionalProperties) {
    ...
    public interface MissingSubmissionIdStage {
        _FinalStage missingSubmissionId(@NotNull String missingSubmissionId);
    ...
    public static final class Builder implements MissingSubmissionIdStage, _FinalStage {
        ...
        public _FinalStage missingSubmissionId(@NotNull String missingSubmissionId) {
