...
public class RawAsyncV2Client {
    protected final ClientOptions clientOptions;

    public RawAsyncV2Client(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedTraceHttpResponse<Void>> test() {
        return test(null);
    }

    public CompletableFuture<SeedTraceHttpResponse<Void>> test(RequestOptions requestOptions) {
