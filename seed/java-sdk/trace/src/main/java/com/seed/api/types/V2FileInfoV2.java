...
@JsonDeserialize(builder = V2FileInfoV2.Builder.class)
public final class V2FileInfoV2 {
    ...
    public static final class Builder
        ...
        public V2FileInfoV2 build() {
            return new V2FileInfoV2(filename, directory, contents, editable, additionalProperties);
        }
