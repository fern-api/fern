...
@JsonDeserialize(builder = V2BasicTestCaseTemplate.Builder.class)
public final class V2BasicTestCaseTemplate {
    ...
    private V2BasicTestCaseTemplate(
            String templateId,
            String name,
    ...
    public interface DescriptionStage {
        ExpectedValueParameterIdStage description(@NotNull V2TestCaseImplementationDescription description);
    }
    ...
    public static final class Builder
        ...
        public ExpectedValueParameterIdStage description(@NotNull V2TestCaseImplementationDescription description) {
        ...
        public V2BasicTestCaseTemplate build() {
            return new V2BasicTestCaseTemplate(
