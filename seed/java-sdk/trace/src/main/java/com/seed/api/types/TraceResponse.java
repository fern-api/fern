...
public final class TraceResponse {
    ...
    @JsonProperty("stdout")
    private Optional<String> _getStdout() {
        return stdout;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage stdout(Nullable<String> stdout);
    }
    ...
    public static final class Builder implements SubmissionIdStage, LineNumberStage, StackStage, _FinalStage {
        ...
        @java.lang.Override
        public _FinalStage stdout(Nullable<String> stdout) {
            if (stdout.isNull()) {
                this.stdout = null;
            } else if (stdout.isEmpty()) {
                this.stdout = Optional.empty();
            } else {
                this.stdout = Optional.of(stdout.get());
            }
            return this;
        }
