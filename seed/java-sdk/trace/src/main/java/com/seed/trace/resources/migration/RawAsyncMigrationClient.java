...
public class RawAsyncMigrationClient {
    protected final ClientOptions clientOptions;

    public RawAsyncMigrationClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedTraceHttpResponse<List<Migration>>> getAttemptedMigrations(
    ...
    public CompletableFuture<SeedTraceHttpResponse<List<Migration>>> getAttemptedMigrations(
        ...
        CompletableFuture<SeedTraceHttpResponse<List<Migration>>> future = new CompletableFuture<>();
