...
public final class StdoutResponse {
    ...
    private StdoutResponse(String submissionId, String stdout, Map<String, Object> additionalProperties) {
    ...
    public interface SubmissionIdStage {
        StdoutStage submissionId(@NotNull String submissionId);
    ...
    public static final class Builder implements SubmissionIdStage, StdoutStage, _FinalStage {
        ...
        public StdoutStage submissionId(@NotNull String submissionId) {
