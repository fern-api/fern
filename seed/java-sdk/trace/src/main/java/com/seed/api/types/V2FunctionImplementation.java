...
@JsonDeserialize(builder = V2FunctionImplementation.Builder.class)
public final class V2FunctionImplementation {
    ...
    private V2FunctionImplementation(String impl, Optional<String> imports, Map<String, Object> additionalProperties) {
        this.impl = impl;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof V2FunctionImplementation && equalTo((V2FunctionImplementation) other);
    }
    ...
    private boolean equalTo(V2FunctionImplementation other) {
    ...
    public interface ImplStage {
        ...
        Builder from(V2FunctionImplementation other);
    }

    public interface _FinalStage {
        V2FunctionImplementation build();
    ...
    public static final class Builder implements ImplStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(V2FunctionImplementation other) {
            impl(other.getImpl());
        ...
        @java.lang.Override
        public V2FunctionImplementation build() {
            return new V2FunctionImplementation(impl, imports, additionalProperties);
        }
