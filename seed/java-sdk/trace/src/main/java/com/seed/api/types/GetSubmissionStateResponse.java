...
public final class GetSubmissionStateResponse {
    ...
    private Optional<OffsetDateTime> _getTimeSubmitted() {
        return timeSubmitted;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage timeSubmitted(Nullable<OffsetDateTime> timeSubmitted);
    }
    ...
    public static final class Builder implements SubmissionStage, LanguageStage, SubmissionTypeStateStage, _FinalStage {
        ...
        @java.lang.Override
        public _FinalStage timeSubmitted(Nullable<OffsetDateTime> timeSubmitted) {
            if (timeSubmitted.isNull()) {
                this.timeSubmitted = null;
            } else if (timeSubmitted.isEmpty()) {
                this.timeSubmitted = Optional.empty();
            } else {
                this.timeSubmitted = Optional.of(timeSubmitted.get());
            }
            return this;
        }
