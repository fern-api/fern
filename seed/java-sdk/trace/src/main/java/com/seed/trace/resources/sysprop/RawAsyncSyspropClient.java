...
public class RawAsyncSyspropClient {
    protected final ClientOptions clientOptions;

    public RawAsyncSyspropClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedTraceHttpResponse<Void>> setNumWarmInstances(Language language, int numWarmInstances) {
        return setNumWarmInstances(language, numWarmInstances, null);
    }

    public CompletableFuture<SeedTraceHttpResponse<Void>> setNumWarmInstances(
    ...
    public CompletableFuture<SeedTraceHttpResponse<Map<Language, Integer>>> getNumWarmInstances() {
