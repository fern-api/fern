...
public class RawHomepageClient {
    ...
    public SeedApiHttpResponse<List<String>> gethomepageproblems() {
        return gethomepageproblems(null);
    }

    public SeedApiHttpResponse<List<String>> gethomepageproblems(RequestOptions requestOptions) {
    ...
    public SeedApiHttpResponse<Void> sethomepageproblems(List<String> request) {
        return sethomepageproblems(request, null);
    }

    public SeedApiHttpResponse<Void> sethomepageproblems(List<String> request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("homepage-problems");
        if (requestOptions != null) {
