...
public final class ErroredResponse implements IErroredResponse {
    ...
    private ErroredResponse(String submissionId, ErrorInfo errorInfo, Map<String, Object> additionalProperties) {
