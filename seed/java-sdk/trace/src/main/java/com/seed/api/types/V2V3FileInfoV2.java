...
@JsonDeserialize(builder = V2V3FileInfoV2.Builder.class)
public final class V2V3FileInfoV2 {
    ...
    public static final class Builder
        ...
        public V2V3FileInfoV2 build() {
            return new V2V3FileInfoV2(filename, directory, contents, editable, additionalProperties);
        }
