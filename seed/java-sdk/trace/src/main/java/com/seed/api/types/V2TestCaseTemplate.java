...
@JsonDeserialize(builder = V2TestCaseTemplate.Builder.class)
public final class V2TestCaseTemplate {
    private final String templateId;

    private final String name;

    private final V2TestCaseImplementation implementation;

    private final Map<String, Object> additionalProperties;

    private V2TestCaseTemplate(
            String templateId,
            String name,
            V2TestCaseImplementation implementation,
    ...
    public V2TestCaseImplementation getImplementation() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof V2TestCaseTemplate && equalTo((V2TestCaseTemplate) other);
    }
    ...
    private boolean equalTo(V2TestCaseTemplate other) {
    ...
    public interface TemplateIdStage {
        ...
        Builder from(V2TestCaseTemplate other);
    }
    ...
    public interface ImplementationStage {
        _FinalStage implementation(@NotNull V2TestCaseImplementation implementation);
    }

    public interface _FinalStage {
        V2TestCaseTemplate build();
    ...
    public static final class Builder implements TemplateIdStage, NameStage, ImplementationStage, _FinalStage {
        ...
        private V2TestCaseImplementation implementation;
        ...
        @java.lang.Override
        public Builder from(V2TestCaseTemplate other) {
        ...
        public _FinalStage implementation(@NotNull V2TestCaseImplementation implementation) {
            this.implementation = Objects.requireNonNull(implementation, "implementation must not be null");
            return this;
        }

        @java.lang.Override
        public V2TestCaseTemplate build() {
            return new V2TestCaseTemplate(templateId, name, implementation, additionalProperties);
        }
