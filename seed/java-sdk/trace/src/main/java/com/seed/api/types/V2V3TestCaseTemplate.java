...
@JsonDeserialize(builder = V2V3TestCaseTemplate.Builder.class)
public final class V2V3TestCaseTemplate {
    private final String templateId;

    private final String name;

    private final V2V3TestCaseImplementation implementation;

    private final Map<String, Object> additionalProperties;

    private V2V3TestCaseTemplate(
            String templateId,
            String name,
            V2V3TestCaseImplementation implementation,
    ...
    public V2V3TestCaseImplementation getImplementation() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof V2V3TestCaseTemplate && equalTo((V2V3TestCaseTemplate) other);
    }
    ...
    private boolean equalTo(V2V3TestCaseTemplate other) {
    ...
    public interface TemplateIdStage {
        ...
        Builder from(V2V3TestCaseTemplate other);
    }
    ...
    public interface ImplementationStage {
        _FinalStage implementation(@NotNull V2V3TestCaseImplementation implementation);
    }

    public interface _FinalStage {
        V2V3TestCaseTemplate build();
    ...
    public static final class Builder implements TemplateIdStage, NameStage, ImplementationStage, _FinalStage {
        ...
        private V2V3TestCaseImplementation implementation;
        ...
        @java.lang.Override
        public Builder from(V2V3TestCaseTemplate other) {
        ...
        public _FinalStage implementation(@NotNull V2V3TestCaseImplementation implementation) {
            this.implementation = Objects.requireNonNull(implementation, "implementation must not be null");
            return this;
        }

        @java.lang.Override
        public V2V3TestCaseTemplate build() {
            return new V2V3TestCaseTemplate(templateId, name, implementation, additionalProperties);
        }
