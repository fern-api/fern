 ...
 */
public class SeedTraceApiException extends SeedTraceException {
    /**
    ...
    public SeedTraceApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public SeedTraceApiException(String message, int statusCode, Object body, Response rawResponse) {
        super(message);
        this.statusCode = statusCode;
        this.body = body;
        this.headers = new HashMap<>();
