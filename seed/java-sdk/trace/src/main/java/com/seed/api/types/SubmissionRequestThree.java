...
@JsonDeserialize(builder = SubmissionRequestThree.Builder.class)
public final class SubmissionRequestThree implements IWorkspaceSubmitRequest {
    ...
    private SubmissionRequestThree(
            String submissionId,
            Language language,
    ...
    public interface LanguageStage {
        TypeStage language(@NotNull Language language);
    }

    public interface TypeStage {
        _FinalStage type(@NotNull SubmissionRequestThreeType type);
    }
    ...
    public static final class Builder implements SubmissionIdStage, LanguageStage, TypeStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("language")
        public TypeStage language(@NotNull Language language) {
        ...
        @java.lang.Override
        @JsonSetter("type")
        public _FinalStage type(@NotNull SubmissionRequestThreeType type) {
        ...
        public SubmissionRequestThree build() {
            return new SubmissionRequestThree(
                    submissionId, language, submissionFiles, userId, type, additionalProperties);
        }
