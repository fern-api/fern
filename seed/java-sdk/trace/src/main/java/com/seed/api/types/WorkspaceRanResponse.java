...
public final class WorkspaceRanResponse implements IWorkspaceRanResponse {
    ...
    private WorkspaceRanResponse(
            String submissionId, WorkspaceRunDetails runDetails, Map<String, Object> additionalProperties) {
