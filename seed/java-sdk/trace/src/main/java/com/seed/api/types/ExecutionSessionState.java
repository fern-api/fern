...
public final class ExecutionSessionState {
    ...
    private Optional<String> _getLastTimeContacted() {
        return lastTimeContacted;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("awsTaskId")
    private Optional<String> _getAwsTaskId() {
        return awsTaskId;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage lastTimeContacted(Nullable<String> lastTimeContacted);

        _FinalStage awsTaskId(Optional<String> awsTaskId);

        _FinalStage awsTaskId(String awsTaskId);

        _FinalStage awsTaskId(Nullable<String> awsTaskId);
    }
    ...
    public static final class Builder
        ...
        @java.lang.Override
        public _FinalStage awsTaskId(Nullable<String> awsTaskId) {
            if (awsTaskId.isNull()) {
                this.awsTaskId = null;
            } else if (awsTaskId.isEmpty()) {
                this.awsTaskId = Optional.empty();
            } else {
                this.awsTaskId = Optional.of(awsTaskId.get());
            }
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage lastTimeContacted(Nullable<String> lastTimeContacted) {
            if (lastTimeContacted.isNull()) {
                this.lastTimeContacted = null;
            } else if (lastTimeContacted.isEmpty()) {
                this.lastTimeContacted = Optional.empty();
            } else {
                this.lastTimeContacted = Optional.of(lastTimeContacted.get());
            }
            return this;
        }
