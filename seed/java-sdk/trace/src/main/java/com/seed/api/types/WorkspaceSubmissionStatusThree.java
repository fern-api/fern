...
@JsonDeserialize(builder = WorkspaceSubmissionStatusThree.Builder.class)
public final class WorkspaceSubmissionStatusThree implements IWorkspaceRunDetails {
    ...
    private WorkspaceSubmissionStatusThree(
            Optional<ExceptionV2> exceptionV2,
            Optional<ExceptionInfo> exception,
            String stdout,
            WorkspaceSubmissionStatusThreeType type,
    ...
    public interface TypeStage {
        _FinalStage type(@NotNull WorkspaceSubmissionStatusThreeType type);
    }
    ...
    public static final class Builder implements StdoutStage, TypeStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("type")
        public _FinalStage type(@NotNull WorkspaceSubmissionStatusThreeType type) {
        ...
        public WorkspaceSubmissionStatusThree build() {
            return new WorkspaceSubmissionStatusThree(exceptionV2, exception, stdout, type, additionalProperties);
        }
