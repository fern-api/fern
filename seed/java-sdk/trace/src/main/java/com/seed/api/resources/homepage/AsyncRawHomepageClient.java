...
public class AsyncRawHomepageClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<List<String>>> gethomepageproblems() {
        return gethomepageproblems(null);
    }

    public CompletableFuture<SeedApiHttpResponse<List<String>>> gethomepageproblems(RequestOptions requestOptions) {
    ...
    public CompletableFuture<SeedApiHttpResponse<Void>> sethomepageproblems(List<String> request) {
        return sethomepageproblems(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> sethomepageproblems(
