...
public final class ExecutionSessionResponse {
    ...
    private Optional<String> _getExecutionSessionUrl() {
        return executionSessionUrl;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage executionSessionUrl(Nullable<String> executionSessionUrl);
    }
    ...
    public static final class Builder implements SessionIdStage, LanguageStage, StatusStage, _FinalStage {
        ...
        @java.lang.Override
        public _FinalStage executionSessionUrl(Nullable<String> executionSessionUrl) {
            if (executionSessionUrl.isNull()) {
                this.executionSessionUrl = null;
            } else if (executionSessionUrl.isEmpty()) {
                this.executionSessionUrl = Optional.empty();
            } else {
                this.executionSessionUrl = Optional.of(executionSessionUrl.get());
            }
            return this;
        }
