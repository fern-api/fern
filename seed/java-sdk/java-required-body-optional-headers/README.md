...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/java-required-body-optional-headers)](https://central.sonatype.com/artifact/com.fern/java-required-body-optional-headers)
...
```groovy
dependencies {
  implementation 'com.fern:java-required-body-optional-headers:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>java-required-body-optional-headers</artifactId>
...
public class Example {
    public static void main(String[] args) {
        SeedJavaRequiredBodyOptionalHeadersClient client = SeedJavaRequiredBodyOptionalHeadersClient
            .builder()
            .build();
...
try{
    client.createUser(...);
} catch (SeedJavaRequiredBodyOptionalHeadersApiException e){
...
```java
SeedJavaRequiredBodyOptionalHeadersHttpResponse response = client.withRawResponse().createUser(...);
