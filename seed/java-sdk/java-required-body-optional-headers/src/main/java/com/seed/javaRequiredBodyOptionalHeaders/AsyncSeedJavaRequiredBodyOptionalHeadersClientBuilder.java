...
import com.seed.javaRequiredBodyOptionalHeaders.core.Environment;
import com.seed.javaRequiredBodyOptionalHeaders.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedJavaRequiredBodyOptionalHeadersClientBuilder {
    ...
    public AsyncSeedJavaRequiredBodyOptionalHeadersClientBuilder url(String url) {
     ...
     */
    public AsyncSeedJavaRequiredBodyOptionalHeadersClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedJavaRequiredBodyOptionalHeadersClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedJavaRequiredBodyOptionalHeadersClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedJavaRequiredBodyOptionalHeadersClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedJavaRequiredBodyOptionalHeadersClient build() {
        validateConfiguration();
        return new AsyncSeedJavaRequiredBodyOptionalHeadersClient(buildClientOptions());
    }
}
