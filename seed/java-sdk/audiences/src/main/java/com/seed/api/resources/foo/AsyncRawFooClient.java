...
public class AsyncRawFooClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<ImportingType>> find() {
        return find(FooFindRequest.builder().build());
    }

    public CompletableFuture<SeedApiHttpResponse<ImportingType>> find(RequestOptions requestOptions) {
        return find(FooFindRequest.builder().build(), requestOptions);
    }

    public CompletableFuture<SeedApiHttpResponse<ImportingType>> find(FooFindRequest request) {
        return find(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<ImportingType>> find(
            FooFindRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<SeedApiHttpResponse<ImportingType>> future = new CompletableFuture<>();
