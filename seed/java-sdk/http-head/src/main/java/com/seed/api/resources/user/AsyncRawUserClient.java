...
public class AsyncRawUserClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<List<User>>> list(UserListRequest request) {
        return list(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<List<User>>> list(
            UserListRequest request, RequestOptions requestOptions) {
    ...
    public CompletableFuture<SeedApiHttpResponse<Void>> head() {
        return head(null);
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> head(RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("users");
        if (requestOptions != null) {
