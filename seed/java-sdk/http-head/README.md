...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/http-head)](https://central.sonatype.com/artifact/com.fern/http-head)
...
```groovy
dependencies {
  implementation 'com.fern:http-head:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>http-head</artifactId>
...
```java
SeedHttpHeadHttpResponse response = client.user().withRawResponse().head(...);
