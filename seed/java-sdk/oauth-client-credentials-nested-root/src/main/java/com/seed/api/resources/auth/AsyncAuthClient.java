...
public class AsyncAuthClient {
    ...
    public CompletableFuture<AuthTokenResponse> gettoken(AuthGetTokenRequest request) {
        return this.rawClient.gettoken(request).thenApply(response -> response.body());
    }

    public CompletableFuture<AuthTokenResponse> gettoken(AuthGetTokenRequest request, RequestOptions requestOptions) {
