...
public class RawAuthClient {
    ...
    public SeedOauthClientCredentialsHttpResponse<TokenResponse> getToken(GetTokenRequest request) {
        return getToken(request, null);
    }

    public SeedOauthClientCredentialsHttpResponse<TokenResponse> getToken(
