...
public class RawAuthClient {
    ...
    public SeedApiHttpResponse<AuthTokenResponse> gettoken(AuthGetTokenRequest request) {
        return gettoken(request, null);
    }

    public SeedApiHttpResponse<AuthTokenResponse> gettoken(AuthGetTokenRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SeedApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AuthTokenResponse.class), response);
            }
