...
public class AuthClient {
    ...
    public AuthTokenResponse gettoken(AuthGetTokenRequest request) {
        return this.rawClient.gettoken(request).body();
    }

    public AuthTokenResponse gettoken(AuthGetTokenRequest request, RequestOptions requestOptions) {
