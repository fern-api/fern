...
import com.seed.api.types.AuthTokenResponse;
...
public class AsyncRawAuthClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<AuthTokenResponse>> gettoken(AuthGetTokenRequest request) {
        return gettoken(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<AuthTokenResponse>> gettoken(
        ...
        CompletableFuture<SeedApiHttpResponse<AuthTokenResponse>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SeedApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AuthTokenResponse.class),
                                response));
                        return;
                    }
