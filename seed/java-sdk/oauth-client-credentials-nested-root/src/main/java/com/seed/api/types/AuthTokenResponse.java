...
@JsonDeserialize(builder = AuthTokenResponse.Builder.class)
public final class AuthTokenResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AuthTokenResponse && equalTo((AuthTokenResponse) other);
    }
    ...
    private boolean equalTo(AuthTokenResponse other) {
    ...
    public interface AccessTokenStage {
        ...
        Builder from(AuthTokenResponse other);
    }
    ...
    public static final class Builder implements AccessTokenStage, ExpiresInStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(AuthTokenResponse other) {
        ...
        public AuthTokenResponse build() {
            return new AuthTokenResponse(accessToken, expiresIn, refreshToken, additionalProperties);
        }
