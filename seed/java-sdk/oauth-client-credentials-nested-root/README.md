...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/oauth-client-credentials-nested-root)](https://central.sonatype.com/artifact/com.fern/oauth-client-credentials-nested-root)
...
```groovy
dependencies {
  implementation 'com.fern:oauth-client-credentials-nested-root:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>oauth-client-credentials-nested-root</artifactId>
...
```java
SeedOauthClientCredentialsHttpResponse response = client.auth().withRawResponse().getToken(...);
