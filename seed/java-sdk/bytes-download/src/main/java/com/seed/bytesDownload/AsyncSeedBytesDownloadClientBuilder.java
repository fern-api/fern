...
import com.seed.bytesDownload.core.Environment;
import com.seed.bytesDownload.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedBytesDownloadClientBuilder {
    ...
    public AsyncSeedBytesDownloadClientBuilder url(String url) {
     ...
     */
    public AsyncSeedBytesDownloadClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedBytesDownloadClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedBytesDownloadClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedBytesDownloadClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedBytesDownloadClient build() {
        validateConfiguration();
        return new AsyncSeedBytesDownloadClient(buildClientOptions());
    }
}
