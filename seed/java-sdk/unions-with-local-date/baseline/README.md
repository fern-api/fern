...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/unions-with-local-date)](https://central.sonatype.com/artifact/com.fern/unions-with-local-date)
...
```groovy
dependencies {
  implementation 'com.fern:unions-with-local-date:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>unions-with-local-date</artifactId>
...
```java
SeedUnionsHttpResponse response = client.bigunion().withRawResponse().get(...);
