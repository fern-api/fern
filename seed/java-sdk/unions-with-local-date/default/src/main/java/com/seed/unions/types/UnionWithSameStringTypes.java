...
public final class UnionWithSameStringTypes {
    ...
    public static UnionWithSameStringTypes customFormat(UnionWithSameStringTypesCustomFormat value) {
        return new UnionWithSameStringTypes(new CustomFormatValue(value));
    }

    public static UnionWithSameStringTypes regularString(UnionWithSameStringTypesRegularString value) {
        return new UnionWithSameStringTypes(new RegularStringValue(value));
    }

    public static UnionWithSameStringTypes patternString(UnionWithSameStringTypesPatternString value) {
    ...
    public Optional<UnionWithSameStringTypesCustomFormat> getCustomFormat() {
        if (isCustomFormat()) {
    ...
    public Optional<UnionWithSameStringTypesRegularString> getRegularString() {
        if (isRegularString()) {
    ...
    public Optional<UnionWithSameStringTypesPatternString> getPatternString() {
        if (isPatternString()) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UnionWithSameStringTypes && value.equals(((UnionWithSameStringTypes) other).value);
    }
    ...
    public interface Visitor<T> {
        T visitCustomFormat(UnionWithSameStringTypesCustomFormat customFormat);

        T visitRegularString(UnionWithSameStringTypesRegularString regularString);

        T visitPatternString(UnionWithSameStringTypesPatternString patternString);
    ...
    private static final class CustomFormatValue implements Value {
        ...
        private UnionWithSameStringTypesCustomFormat value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private CustomFormatValue() {}

        private CustomFormatValue(UnionWithSameStringTypesCustomFormat value) {
            this.value = value;
        }
    ...
    private static final class RegularStringValue implements Value {
        @JsonUnwrapped
        @JsonIgnoreProperties(value = "type", allowSetters = true)
        private UnionWithSameStringTypesRegularString value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private RegularStringValue() {}

        private RegularStringValue(UnionWithSameStringTypesRegularString value) {
            this.value = value;
        }
    ...
    private static final class PatternStringValue implements Value {
        @JsonUnwrapped
        @JsonIgnoreProperties(value = "type", allowSetters = true)
        private UnionWithSameStringTypesPatternString value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private PatternStringValue() {}

        private PatternStringValue(UnionWithSameStringTypesPatternString value) {
            this.value = value;
        }
