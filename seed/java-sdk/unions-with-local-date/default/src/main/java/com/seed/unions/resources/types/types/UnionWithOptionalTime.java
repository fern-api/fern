...
public final class UnionWithOptionalTime {
    ...
    public static UnionWithOptionalTime date(Optional<LocalDate> value) {
    ...
    public Optional<Optional<LocalDate>> getDate() {
        if (isDate()) {
    ...
    public interface Visitor<T> {
        T visitDate(Optional<LocalDate> date);
    ...
    private static final class DateValue implements Value {
        ...
        private DateValue(@JsonProperty("value") Optional<LocalDate> value) {
            this.value = value;
        }
