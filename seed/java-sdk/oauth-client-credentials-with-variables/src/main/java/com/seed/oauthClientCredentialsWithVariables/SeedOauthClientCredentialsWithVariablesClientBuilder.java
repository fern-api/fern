...
public class SeedOauthClientCredentialsWithVariablesClientBuilder {
     ...
     * Sets clientId
     */
    public SeedOauthClientCredentialsWithVariablesClientBuilder clientId(String clientId) {
     ...
     * Sets scope
     */
    public SeedOauthClientCredentialsWithVariablesClientBuilder scope(String scope) {
        this.scope = scope;
        return this;
    }
