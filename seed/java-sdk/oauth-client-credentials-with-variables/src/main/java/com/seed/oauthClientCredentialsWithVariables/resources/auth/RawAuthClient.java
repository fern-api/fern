...
public class RawAuthClient {
    ...
    public SeedOauthClientCredentialsWithVariablesHttpResponse<TokenResponse> getTokenWithClientCredentials(
    ...
    public SeedOauthClientCredentialsWithVariablesHttpResponse<TokenResponse> refreshToken(
