...
public class SeedOauthClientCredentialsWithVariablesApiException
        extends SeedOauthClientCredentialsWithVariablesException {
    /**
    ...
    public SeedOauthClientCredentialsWithVariablesApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public SeedOauthClientCredentialsWithVariablesApiException(
