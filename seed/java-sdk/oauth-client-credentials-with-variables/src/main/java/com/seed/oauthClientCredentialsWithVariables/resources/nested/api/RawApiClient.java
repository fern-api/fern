...
public class RawApiClient {
    ...
    public SeedOauthClientCredentialsWithVariablesHttpResponse<Void> getSomething() {
        return getSomething(null);
    }

    public SeedOauthClientCredentialsWithVariablesHttpResponse<Void> getSomething(RequestOptions requestOptions) {
