...
public class AsyncRawItemsClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<String>> listItems() {
        return listItems(null);
    }

    public CompletableFuture<SeedApiHttpResponse<String>> listItems(RequestOptions requestOptions) {
