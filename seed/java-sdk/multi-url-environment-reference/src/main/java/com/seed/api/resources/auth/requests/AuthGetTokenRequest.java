...
public final class AuthGetTokenRequest {
    ...
    private AuthGetTokenRequest(String clientId, String clientSecret, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder implements ClientIdStage, ClientSecretStage, _FinalStage {
        ...
        public AuthGetTokenRequest build() {
            return new AuthGetTokenRequest(clientId, clientSecret, additionalProperties);
        }
