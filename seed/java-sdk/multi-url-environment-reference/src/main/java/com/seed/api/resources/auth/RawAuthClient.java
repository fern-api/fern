...
public class RawAuthClient {
    ...
    public SeedApiHttpResponse<AuthGetTokenResponse> gettoken(AuthGetTokenRequest request) {
        return gettoken(request, null);
    }

    public SeedApiHttpResponse<AuthGetTokenResponse> gettoken(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SeedApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AuthGetTokenResponse.class), response);
            }
