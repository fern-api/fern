...
public class AsyncRawAuthClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<AuthGetTokenResponse>> gettoken(AuthGetTokenRequest request) {
        return gettoken(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<AuthGetTokenResponse>> gettoken(
        ...
        CompletableFuture<SeedApiHttpResponse<AuthGetTokenResponse>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SeedApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AuthGetTokenResponse.class),
                                response));
                        return;
                    }
