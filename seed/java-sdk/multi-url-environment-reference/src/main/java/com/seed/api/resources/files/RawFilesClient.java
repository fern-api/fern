...
public class RawFilesClient {
    ...
    public SeedApiHttpResponse<String> upload(FilesUploadRequest request) {
        return upload(request, null);
    }

    public SeedApiHttpResponse<String> upload(FilesUploadRequest request, RequestOptions requestOptions) {
