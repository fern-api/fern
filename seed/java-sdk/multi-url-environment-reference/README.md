...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/multi-url-environment-reference)](https://central.sonatype.com/artifact/com.fern/multi-url-environment-reference)
...
```groovy
dependencies {
  implementation 'com.fern:multi-url-environment-reference:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>multi-url-environment-reference</artifactId>
