 ...
 */
public class SeedBearerTokenEnvironmentVariableApiException extends SeedBearerTokenEnvironmentVariableException {
    /**
    ...
    public SeedBearerTokenEnvironmentVariableApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public SeedBearerTokenEnvironmentVariableApiException(
