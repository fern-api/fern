...
import com.seed.bearerTokenEnvironmentVariable.core.RetryInterceptor;
...
public class AsyncRawServiceClient {
     ...
     */
    public CompletableFuture<SeedBearerTokenEnvironmentVariableHttpResponse<String>> getWithBearerToken() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SeedBearerTokenEnvironmentVariableHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, String.class), response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
                    future.completeExceptionally(new SeedBearerTokenEnvironmentVariableApiException(
                            "Error with status code " + response.code(), response.code(), errorBody, response));
                    return;
                } catch (JsonProcessingException e) {
                    future.completeExceptionally(new SeedBearerTokenEnvironmentVariableException(
