...
```groovy
dependencies {
  implementation 'com.fern:bearer-token-environment-variable:0.0.1'
}
```
...
```java
SeedBearerTokenEnvironmentVariableHttpResponse response = client.service().withRawResponse().getWithBearerToken(...);
