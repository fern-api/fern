 ...
 */
package com.seed.api.resources.oauth.types;
...
public final class GetTokenResponse {
    ...
    private GetTokenResponse(String accessToken, int expiresIn, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder implements AccessTokenStage, ExpiresInStage, _FinalStage {
        ...
        public GetTokenResponse build() {
            return new GetTokenResponse(accessToken, expiresIn, additionalProperties);
        }
