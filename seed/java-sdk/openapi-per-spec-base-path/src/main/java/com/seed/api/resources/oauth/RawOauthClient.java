...
public class RawOauthClient {
    ...
    public SeedApiHttpResponse<GetTokenResponse> getToken(GetTokenRequest request) {
        return getToken(request, null);
    }

    public SeedApiHttpResponse<GetTokenResponse> getToken(GetTokenRequest request, RequestOptions requestOptions) {
