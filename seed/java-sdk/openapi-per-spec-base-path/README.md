...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/openapi-per-spec-base-path)](https://central.sonatype.com/artifact/com.fern/openapi-per-spec-base-path)
...
```groovy
dependencies {
  implementation 'com.fern:openapi-per-spec-base-path:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>openapi-per-spec-base-path</artifactId>
...
```java
SeedApiHttpResponse response = client.oauth().withRawResponse().getToken(...);
