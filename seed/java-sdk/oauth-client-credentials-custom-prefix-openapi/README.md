...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/oauth-client-credentials-custom-prefix-openapi)](https://central.sonatype.com/artifact/com.fern/oauth-client-credentials-custom-prefix-openapi)
...
```groovy
dependencies {
  implementation 'com.fern:oauth-client-credentials-custom-prefix-openapi:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>oauth-client-credentials-custom-prefix-openapi</artifactId>
