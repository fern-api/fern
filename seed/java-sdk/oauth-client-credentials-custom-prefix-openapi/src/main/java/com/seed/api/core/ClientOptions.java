...
public final class ClientOptions {
    ...
    private ClientOptions(
        ...
        this.headers.putAll(new HashMap<String, String>() {
            {
                put("User-Agent", "com.fern.oauth-client-credentials-custom-prefix-openapi/0.0.1");
                put("X-Fern-Language", "JAVA");
                put("X-Fern-SDK-Name", "com.fern:oauth-client-credentials-custom-prefix-openapi");
