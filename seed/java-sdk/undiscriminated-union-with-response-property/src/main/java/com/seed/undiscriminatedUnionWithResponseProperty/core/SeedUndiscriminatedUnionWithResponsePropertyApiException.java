...
public class SeedUndiscriminatedUnionWithResponsePropertyApiException
        extends SeedUndiscriminatedUnionWithResponsePropertyException {
    /**
    ...
    public SeedUndiscriminatedUnionWithResponsePropertyApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public SeedUndiscriminatedUnionWithResponsePropertyApiException(
