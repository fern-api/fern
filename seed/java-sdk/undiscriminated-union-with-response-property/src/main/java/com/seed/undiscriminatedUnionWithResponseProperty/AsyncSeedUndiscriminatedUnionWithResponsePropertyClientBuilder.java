...
import com.seed.undiscriminatedUnionWithResponseProperty.core.Environment;
import com.seed.undiscriminatedUnionWithResponseProperty.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedUndiscriminatedUnionWithResponsePropertyClientBuilder {
    ...
    public AsyncSeedUndiscriminatedUnionWithResponsePropertyClientBuilder url(String url) {
     ...
     */
    public AsyncSeedUndiscriminatedUnionWithResponsePropertyClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedUndiscriminatedUnionWithResponsePropertyClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedUndiscriminatedUnionWithResponsePropertyClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedUndiscriminatedUnionWithResponsePropertyClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedUndiscriminatedUnionWithResponsePropertyClient build() {
        validateConfiguration();
        return new AsyncSeedUndiscriminatedUnionWithResponsePropertyClient(buildClientOptions());
    }
}
