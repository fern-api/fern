...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/undiscriminated-union-with-response-property)](https://central.sonatype.com/artifact/com.fern/undiscriminated-union-with-response-property)
...
<dependency>
  ...
  <artifactId>undiscriminated-union-with-response-property</artifactId>
...
try{
    client.getUnion(...);
} catch (SeedUndiscriminatedUnionWithResponsePropertyApiException e){
