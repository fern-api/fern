...
public class SeedErrorPropertyClientBuilder {
     ...
     */
    public SeedErrorPropertyClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedErrorPropertyClientBuilder addHeader(String name, String value) {
    ...
    public SeedErrorPropertyClient build() {
        ...
        return new SeedErrorPropertyClient(buildClientOptions());
    }
}
