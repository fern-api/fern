...
public class RawPropertyBasedErrorClient {
     ...
     */
    public SeedErrorPropertyHttpResponse<String> throwError() {
     ...
     * GET request that always throws an error
     */
    public SeedErrorPropertyHttpResponse<String> throwError(RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SeedErrorPropertyHttpResponse<>(
