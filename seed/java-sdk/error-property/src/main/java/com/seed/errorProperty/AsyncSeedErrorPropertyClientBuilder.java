...
import com.seed.errorProperty.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedErrorPropertyClientBuilder {
     ...
     */
    public AsyncSeedErrorPropertyClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedErrorPropertyClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedErrorPropertyClient build() {
        ...
        return new AsyncSeedErrorPropertyClient(buildClientOptions());
    }
}
