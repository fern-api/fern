...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/error-property)](https://central.sonatype.com/artifact/com.fern/error-property)
...
```groovy
dependencies {
  implementation 'com.fern:error-property:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>error-property</artifactId>
...
```java
SeedErrorPropertyHttpResponse response = client.propertyBasedError().withRawResponse().throwError(...);
