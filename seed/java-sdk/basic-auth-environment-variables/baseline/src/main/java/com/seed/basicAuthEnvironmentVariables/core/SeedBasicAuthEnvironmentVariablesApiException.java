 ...
 */
public class SeedBasicAuthEnvironmentVariablesApiException extends SeedBasicAuthEnvironmentVariablesException {
    /**
    ...
    public SeedBasicAuthEnvironmentVariablesApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public SeedBasicAuthEnvironmentVariablesApiException(
