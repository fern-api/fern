...
import com.seed.objectsWithImports.resources.commons.metadata.types.Metadata;
...
public final class Node {
    ...
    private Node(
            String id, Optional<String> label, Optional<Metadata> metadata, Map<String, Object> additionalProperties) {
        this.id = id;
        this.label = label;
