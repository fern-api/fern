...
import com.seed.objectsWithImports.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedObjectsWithImportsClientBuilder {
     ...
     */
    public SeedObjectsWithImportsClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedObjectsWithImportsClientBuilder addHeader(String name, String value) {
    ...
    public SeedObjectsWithImportsClient build() {
        ...
        return new SeedObjectsWithImportsClient(buildClientOptions());
    }
}
