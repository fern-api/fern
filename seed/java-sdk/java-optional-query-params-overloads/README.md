...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/java-optional-query-params-overloads)](https://central.sonatype.com/artifact/com.fern/java-optional-query-params-overloads)
...
```groovy
dependencies {
  implementation 'com.fern:java-optional-query-params-overloads:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>java-optional-query-params-overloads</artifactId>
...
try{
    client.getLatestInsurance(...);
} catch (SeedJavaOptionalQueryParamsOverloadsApiException e){
