...
public final class Identity {
    ...
    public interface ProviderStage {
        IsSocialStage provider(@NotNull String provider);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage accessToken(Nullable<String> accessToken);

        _FinalStage expiresIn(Optional<Integer> expiresIn);

        _FinalStage expiresIn(Integer expiresIn);

        _FinalStage expiresIn(Nullable<Integer> expiresIn);
    }
    ...
    public static final class Builder
        ...
        @java.lang.Override
        @JsonSetter("provider")
        public IsSocialStage provider(@NotNull String provider) {
        ...
        @java.lang.Override
        public _FinalStage expiresIn(Nullable<Integer> expiresIn) {
            if (expiresIn.isNull()) {
                this.expiresIn = null;
        ...
        @java.lang.Override
        public _FinalStage accessToken(Nullable<String> accessToken) {
