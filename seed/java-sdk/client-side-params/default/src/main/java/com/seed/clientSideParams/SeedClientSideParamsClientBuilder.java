...
public class SeedClientSideParamsClientBuilder {
     ...
     */
    public SeedClientSideParamsClientBuilder timeout(int timeout) {
     ...
     */
    public SeedClientSideParamsClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedClientSideParamsClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedClientSideParamsClientBuilder addHeader(String name, String value) {
    ...
    public SeedClientSideParamsClient build() {
        validateConfiguration();
        return new SeedClientSideParamsClient(buildClientOptions());
    }
}
