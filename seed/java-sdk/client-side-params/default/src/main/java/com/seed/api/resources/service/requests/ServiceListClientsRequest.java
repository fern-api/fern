...
@JsonDeserialize(builder = ServiceListClientsRequest.Builder.class)
public final class ServiceListClientsRequest {
    ...
    private ServiceListClientsRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ServiceListClientsRequest && equalTo((ServiceListClientsRequest) other);
    }
    ...
    private boolean equalTo(ServiceListClientsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ServiceListClientsRequest other) {
        ...
        public Builder isGlobal(Nullable<Boolean> isGlobal) {
            if (isGlobal.isNull()) {
                ...
                this.isGlobal = Optional.empty();
            } else {
                this.isGlobal = Optional.of(isGlobal.get());
            }
            return this;
        }
        ...
        public Builder appType(Nullable<List<String>> appType) {
            if (appType.isNull()) {
                this.appType = null;
        ...
        public ServiceListClientsRequest build() {
            return new ServiceListClientsRequest(
                    fields,
                    includeFields,
                    page,
                    perPage,
