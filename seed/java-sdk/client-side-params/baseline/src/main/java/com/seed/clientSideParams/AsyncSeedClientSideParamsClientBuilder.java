...
import com.seed.clientSideParams.core.Environment;
import com.seed.clientSideParams.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedClientSideParamsClientBuilder {
     ...
     * Sets token
     */
    public AsyncSeedClientSideParamsClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public AsyncSeedClientSideParamsClientBuilder url(String url) {
     ...
     */
    public AsyncSeedClientSideParamsClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedClientSideParamsClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedClientSideParamsClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedClientSideParamsClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedClientSideParamsClient build() {
        validateConfiguration();
        return new AsyncSeedClientSideParamsClient(buildClientOptions());
    }
}
