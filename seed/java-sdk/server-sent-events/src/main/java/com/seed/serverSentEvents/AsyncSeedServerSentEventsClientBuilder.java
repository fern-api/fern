...
import com.seed.serverSentEvents.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedServerSentEventsClientBuilder {
     ...
     */
    public AsyncSeedServerSentEventsClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedServerSentEventsClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedServerSentEventsClient build() {
        ...
        return new AsyncSeedServerSentEventsClient(buildClientOptions());
    }
}
