...
public final class StreamedCompletion {
    ...
    @JsonProperty("tokens")
    private Optional<Integer> _getTokens() {
        return tokens;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage tokens(Nullable<Integer> tokens);
    }
    ...
    public static final class Builder implements DeltaStage, _FinalStage {
        ...
        @java.lang.Override
        public _FinalStage tokens(Nullable<Integer> tokens) {
            if (tokens.isNull()) {
                this.tokens = null;
            } else if (tokens.isEmpty()) {
                this.tokens = Optional.empty();
            } else {
                this.tokens = Optional.of(tokens.get());
            }
            return this;
        }
