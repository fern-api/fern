...
public class RawPackageClient {
    ...
    public SeedApiHttpResponse<Void> test(PackageTestRequest request) {
        return test(request, null);
    }

    public SeedApiHttpResponse<Void> test(PackageTestRequest request, RequestOptions requestOptions) {
