...
public class AsyncRawPackageClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<Void>> test(PackageTestRequest request) {
        return test(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> test(
            PackageTestRequest request, RequestOptions requestOptions) {
