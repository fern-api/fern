...
import com.seed.unionQueryParameters.core.Environment;
import com.seed.unionQueryParameters.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedUnionQueryParametersClientBuilder {
    ...
    public SeedUnionQueryParametersClientBuilder url(String url) {
     ...
     */
    public SeedUnionQueryParametersClientBuilder timeout(int timeout) {
     ...
     */
    public SeedUnionQueryParametersClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedUnionQueryParametersClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedUnionQueryParametersClientBuilder addHeader(String name, String value) {
    ...
    public SeedUnionQueryParametersClient build() {
        validateConfiguration();
        return new SeedUnionQueryParametersClient(buildClientOptions());
    }
}
