...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/union-query-parameters)](https://central.sonatype.com/artifact/com.fern/union-query-parameters)
...
```groovy
dependencies {
  implementation 'com.fern:union-query-parameters:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>union-query-parameters</artifactId>
...
public class Example {
    public static void main(String[] args) {
        SeedUnionQueryParametersClient client = SeedUnionQueryParametersClient
            .builder()
            .build();
...
```java
SeedUnionQueryParametersHttpResponse response = client.events().withRawResponse().subscribe(...);
