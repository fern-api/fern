...
public class RawUserClient {
     ...
     * List all users.
     */
    public SeedApiHttpResponse<List<User>> list() {
        return list(UserListRequest.builder().build());
    }

    /**
     * List all users.
     */
    public SeedApiHttpResponse<List<User>> list(RequestOptions requestOptions) {
        return list(UserListRequest.builder().build(), requestOptions);
    }
