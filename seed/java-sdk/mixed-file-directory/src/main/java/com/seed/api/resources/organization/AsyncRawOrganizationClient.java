...
public class AsyncRawOrganizationClient {
     ...
     */
    public CompletableFuture<SeedApiHttpResponse<Organization>> create(CreateOrganizationRequest request) {
     ...
     * Create a new organization.
     */
    public CompletableFuture<SeedApiHttpResponse<Organization>> create(
