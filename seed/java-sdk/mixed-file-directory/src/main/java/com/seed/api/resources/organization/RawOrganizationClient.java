...
public class RawOrganizationClient {
     ...
     */
    public SeedApiHttpResponse<Organization> create(CreateOrganizationRequest request) {
     ...
     * Create a new organization.
     */
    public SeedApiHttpResponse<Organization> create(CreateOrganizationRequest request, RequestOptions requestOptions) {
