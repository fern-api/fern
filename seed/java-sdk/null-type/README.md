...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/null-type)](https://central.sonatype.com/artifact/com.fern/null-type)
...
```groovy
dependencies {
  implementation 'com.fern:null-type:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>null-type</artifactId>
