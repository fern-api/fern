...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/respect-optional-request-body)](https://central.sonatype.com/artifact/com.fern/respect-optional-request-body)
...
```groovy
dependencies {
  implementation 'com.fern:respect-optional-request-body:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>respect-optional-request-body</artifactId>
...
```java
SeedApiHttpResponse response = client.withRawResponse().refund(...);
