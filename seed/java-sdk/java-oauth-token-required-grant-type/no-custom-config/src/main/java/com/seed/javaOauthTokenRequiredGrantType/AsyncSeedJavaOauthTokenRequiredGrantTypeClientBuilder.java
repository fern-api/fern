...
import com.seed.javaOauthTokenRequiredGrantType.core.Environment;
import com.seed.javaOauthTokenRequiredGrantType.core.LogConfig;
import com.seed.javaOauthTokenRequiredGrantType.core.OAuthTokenSupplier;
...
public class AsyncSeedJavaOauthTokenRequiredGrantTypeClientBuilder {
    ...
    public AsyncSeedJavaOauthTokenRequiredGrantTypeClientBuilder url(String url) {
     ...
     */
    public AsyncSeedJavaOauthTokenRequiredGrantTypeClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedJavaOauthTokenRequiredGrantTypeClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncSeedJavaOauthTokenRequiredGrantTypeClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncSeedJavaOauthTokenRequiredGrantTypeClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncSeedJavaOauthTokenRequiredGrantTypeClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncSeedJavaOauthTokenRequiredGrantTypeClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedJavaOauthTokenRequiredGrantTypeClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedJavaOauthTokenRequiredGrantTypeClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedJavaOauthTokenRequiredGrantTypeClient build() {
        validateConfiguration();
        return new AsyncSeedJavaOauthTokenRequiredGrantTypeClient(buildClientOptions());
    }

    public static final class _TokenAuth extends AsyncSeedJavaOauthTokenRequiredGrantTypeClientBuilder {
    ...
    public static final class _CredentialsAuth extends AsyncSeedJavaOauthTokenRequiredGrantTypeClientBuilder {
        ...
        public AsyncSeedJavaOauthTokenRequiredGrantTypeClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new AsyncSeedJavaOauthTokenRequiredGrantTypeClient(finalOptions);
        }
    }
