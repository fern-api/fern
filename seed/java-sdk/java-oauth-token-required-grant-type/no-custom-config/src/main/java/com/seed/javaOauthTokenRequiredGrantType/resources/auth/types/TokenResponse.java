 ...
 */
package com.seed.javaOauthTokenRequiredGrantType.resources.auth.types;
...
public final class TokenResponse {
    ...
    private TokenResponse(String accessToken, int expiresIn, Map<String, Object> additionalProperties) {
