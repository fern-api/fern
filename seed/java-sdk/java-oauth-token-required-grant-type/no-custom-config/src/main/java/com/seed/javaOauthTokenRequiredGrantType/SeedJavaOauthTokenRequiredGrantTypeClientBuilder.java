...
public class SeedJavaOauthTokenRequiredGrantTypeClientBuilder {
    ...
    public SeedJavaOauthTokenRequiredGrantTypeClientBuilder url(String url) {
     ...
     */
    public SeedJavaOauthTokenRequiredGrantTypeClientBuilder timeout(int timeout) {
     ...
     */
    public SeedJavaOauthTokenRequiredGrantTypeClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public SeedJavaOauthTokenRequiredGrantTypeClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public SeedJavaOauthTokenRequiredGrantTypeClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public SeedJavaOauthTokenRequiredGrantTypeClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public SeedJavaOauthTokenRequiredGrantTypeClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedJavaOauthTokenRequiredGrantTypeClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedJavaOauthTokenRequiredGrantTypeClientBuilder addHeader(String name, String value) {
    ...
    public SeedJavaOauthTokenRequiredGrantTypeClient build() {
        validateConfiguration();
        return new SeedJavaOauthTokenRequiredGrantTypeClient(buildClientOptions());
    }

    public static final class _TokenAuth extends SeedJavaOauthTokenRequiredGrantTypeClientBuilder {
    ...
    public static final class _CredentialsAuth extends SeedJavaOauthTokenRequiredGrantTypeClientBuilder {
        ...
        public SeedJavaOauthTokenRequiredGrantTypeClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new SeedJavaOauthTokenRequiredGrantTypeClient(finalOptions);
        }
    }
