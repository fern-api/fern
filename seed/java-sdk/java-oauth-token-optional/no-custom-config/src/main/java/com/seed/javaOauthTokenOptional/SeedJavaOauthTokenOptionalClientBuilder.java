...
public class SeedJavaOauthTokenOptionalClientBuilder {
    ...
    public SeedJavaOauthTokenOptionalClientBuilder url(String url) {
     ...
     */
    public SeedJavaOauthTokenOptionalClientBuilder timeout(int timeout) {
     ...
     */
    public SeedJavaOauthTokenOptionalClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public SeedJavaOauthTokenOptionalClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public SeedJavaOauthTokenOptionalClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public SeedJavaOauthTokenOptionalClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public SeedJavaOauthTokenOptionalClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedJavaOauthTokenOptionalClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedJavaOauthTokenOptionalClientBuilder addHeader(String name, String value) {
    ...
    public SeedJavaOauthTokenOptionalClient build() {
        validateConfiguration();
        return new SeedJavaOauthTokenOptionalClient(buildClientOptions());
    }

    public static final class _TokenAuth extends SeedJavaOauthTokenOptionalClientBuilder {
    ...
    public static final class _CredentialsAuth extends SeedJavaOauthTokenOptionalClientBuilder {
        ...
        public SeedJavaOauthTokenOptionalClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new SeedJavaOauthTokenOptionalClient(finalOptions);
        }
    }
