...
import com.seed.javaOauthTokenOptional.core.Environment;
import com.seed.javaOauthTokenOptional.core.LogConfig;
import com.seed.javaOauthTokenOptional.core.OAuthTokenSupplier;
...
public class AsyncSeedJavaOauthTokenOptionalClientBuilder {
    ...
    public AsyncSeedJavaOauthTokenOptionalClientBuilder url(String url) {
     ...
     */
    public AsyncSeedJavaOauthTokenOptionalClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedJavaOauthTokenOptionalClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncSeedJavaOauthTokenOptionalClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncSeedJavaOauthTokenOptionalClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncSeedJavaOauthTokenOptionalClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncSeedJavaOauthTokenOptionalClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedJavaOauthTokenOptionalClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedJavaOauthTokenOptionalClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedJavaOauthTokenOptionalClient build() {
        validateConfiguration();
        return new AsyncSeedJavaOauthTokenOptionalClient(buildClientOptions());
    }

    public static final class _TokenAuth extends AsyncSeedJavaOauthTokenOptionalClientBuilder {
    ...
    public static final class _CredentialsAuth extends AsyncSeedJavaOauthTokenOptionalClientBuilder {
        ...
        public AsyncSeedJavaOauthTokenOptionalClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new AsyncSeedJavaOauthTokenOptionalClient(finalOptions);
        }
    }
