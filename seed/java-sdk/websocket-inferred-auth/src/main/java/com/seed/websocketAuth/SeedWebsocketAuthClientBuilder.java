...
import com.seed.websocketAuth.core.LogConfig;
...
public class SeedWebsocketAuthClientBuilder {
     ...
     * Sets xApiKey
     */
    public SeedWebsocketAuthClientBuilder xApiKey(String xApiKey) {
     ...
     * Sets clientId
     */
    public SeedWebsocketAuthClientBuilder clientId(String clientId) {
     ...
     * Sets clientSecret
     */
    public SeedWebsocketAuthClientBuilder clientSecret(String clientSecret) {
     ...
     * Sets scope
     */
    public SeedWebsocketAuthClientBuilder scope(String scope) {
        this.scope = scope;
        return this;
    }

    public SeedWebsocketAuthClientBuilder url(String url) {
     ...
     */
    public SeedWebsocketAuthClientBuilder timeout(int timeout) {
     ...
     */
    public SeedWebsocketAuthClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedWebsocketAuthClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedWebsocketAuthClientBuilder addHeader(String name, String value) {
    ...
    public SeedWebsocketAuthClient build() {
        validateConfiguration();
        return new SeedWebsocketAuthClient(buildClientOptions());
    }
}
