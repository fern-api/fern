...
public class AsyncSeedWebsocketAuthClientBuilder {
     ...
     */
    public AsyncSeedWebsocketAuthClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedWebsocketAuthClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedWebsocketAuthClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedWebsocketAuthClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedWebsocketAuthClient build() {
        validateConfiguration();
        return new AsyncSeedWebsocketAuthClient(buildClientOptions());
    }
}
