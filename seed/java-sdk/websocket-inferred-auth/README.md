...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/websocket-inferred-auth)](https://central.sonatype.com/artifact/com.fern/websocket-inferred-auth)
...
```groovy
dependencies {
  implementation 'com.fern:websocket-inferred-auth:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>websocket-inferred-auth</artifactId>
