...
public final class SeedJavaIdempotencyHeadersFileUploadHttpResponse<T> {

    private final T body;

    private final Map<String, List<String>> headers;

    public SeedJavaIdempotencyHeadersFileUploadHttpResponse(T body, Response rawResponse) {
        this.body = body;
