...
import com.seed.javaIdempotencyHeadersFileUpload.core.Environment;
import com.seed.javaIdempotencyHeadersFileUpload.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedJavaIdempotencyHeadersFileUploadClientBuilder {
     ...
     * Sets token
     */
    public AsyncSeedJavaIdempotencyHeadersFileUploadClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public AsyncSeedJavaIdempotencyHeadersFileUploadClientBuilder url(String url) {
     ...
     */
    public AsyncSeedJavaIdempotencyHeadersFileUploadClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedJavaIdempotencyHeadersFileUploadClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedJavaIdempotencyHeadersFileUploadClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedJavaIdempotencyHeadersFileUploadClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedJavaIdempotencyHeadersFileUploadClient build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new AsyncSeedJavaIdempotencyHeadersFileUploadClient(buildClientOptions());
    }
}
