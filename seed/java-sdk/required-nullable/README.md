...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/required-nullable)](https://central.sonatype.com/artifact/com.fern/required-nullable)
...
```groovy
dependencies {
  implementation 'com.fern:required-nullable:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>required-nullable</artifactId>
...
```java
SeedApiHttpResponse response = client.withRawResponse().getFoo(...);
