...
public class AsyncSeedJavaOauthStagedBuilderClientBuilder {
     ...
     * Sets clientId
     */
    public AsyncSeedJavaOauthStagedBuilderClientBuilder clientId(String clientId) {
     ...
     * Sets clientSecret
     */
    public AsyncSeedJavaOauthStagedBuilderClientBuilder clientSecret(String clientSecret) {
     ...
     * Sets apiKey
     */
    public AsyncSeedJavaOauthStagedBuilderClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
     ...
     * Sets scope
     */
    public AsyncSeedJavaOauthStagedBuilderClientBuilder scope(String scope) {
        this.scope = scope;
        return this;
    }

    public AsyncSeedJavaOauthStagedBuilderClientBuilder url(String url) {
     ...
     */
    public AsyncSeedJavaOauthStagedBuilderClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedJavaOauthStagedBuilderClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncSeedJavaOauthStagedBuilderClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedJavaOauthStagedBuilderClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedJavaOauthStagedBuilderClient build() {
        validateConfiguration();
        return new AsyncSeedJavaOauthStagedBuilderClient(buildClientOptions());
    }
}
