...
import com.seed.javaOauthStagedBuilder.core.Environment;
import com.seed.javaOauthStagedBuilder.core.OAuthTokenSupplier;
...
public class SeedJavaOauthStagedBuilderClientBuilder {
     ...
     * Sets clientId
     */
    public SeedJavaOauthStagedBuilderClientBuilder clientId(String clientId) {
     ...
     * Sets clientSecret
     */
    public SeedJavaOauthStagedBuilderClientBuilder clientSecret(String clientSecret) {
     ...
     * Sets apiKey
     */
    public SeedJavaOauthStagedBuilderClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
     ...
     * Sets scope
     */
    public SeedJavaOauthStagedBuilderClientBuilder scope(String scope) {
        this.scope = scope;
        return this;
    }

    public SeedJavaOauthStagedBuilderClientBuilder url(String url) {
     ...
     */
    public SeedJavaOauthStagedBuilderClientBuilder timeout(int timeout) {
     ...
     */
    public SeedJavaOauthStagedBuilderClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public SeedJavaOauthStagedBuilderClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedJavaOauthStagedBuilderClientBuilder addHeader(String name, String value) {
    ...
    public SeedJavaOauthStagedBuilderClient build() {
        validateConfiguration();
        return new SeedJavaOauthStagedBuilderClient(buildClientOptions());
    }
}
