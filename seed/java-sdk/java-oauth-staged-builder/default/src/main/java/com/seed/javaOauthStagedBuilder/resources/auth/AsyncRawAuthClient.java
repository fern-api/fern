...
public class AsyncRawAuthClient {
    ...
    public CompletableFuture<SeedJavaOauthStagedBuilderHttpResponse<TokenResponse>> getToken(GetTokenRequest request) {
        return getToken(request, null);
    }

    public CompletableFuture<SeedJavaOauthStagedBuilderHttpResponse<TokenResponse>> getToken(
        ...
        CompletableFuture<SeedJavaOauthStagedBuilderHttpResponse<TokenResponse>> future = new CompletableFuture<>();
