...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/java-oauth-staged-builder)](https://central.sonatype.com/artifact/com.fern/java-oauth-staged-builder)
...
```groovy
dependencies {
  implementation 'com.fern:java-oauth-staged-builder'
}
```
...
<dependency>
  ...
  <artifactId>java-oauth-staged-builder</artifactId>
...
try{
    client.auth().getToken(...);
} catch (SeedJavaOauthStagedBuilderApiException e){
