...
public final class CompletionRequest {
    ...
    private CompletionRequest(String query, Optional<Boolean> stream, Map<String, Object> additionalProperties) {
        this.query = query;
        this.stream = stream;
    ...
    public static final class Builder implements QueryStage, _FinalStage {
        ...
        public CompletionRequest build() {
            return new CompletionRequest(query, stream, additionalProperties);
        }
