...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/server-sent-events-openapi)](https://central.sonatype.com/artifact/com.fern/server-sent-events-openapi)
...
<dependency>
  ...
  <artifactId>server-sent-events-openapi</artifactId>
...
```java
SeedApiHttpResponse response = client.withRawResponse().streamProtocolNoCollision(...);
