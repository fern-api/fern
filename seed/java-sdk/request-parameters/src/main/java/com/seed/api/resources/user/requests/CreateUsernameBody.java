...
@JsonDeserialize(builder = CreateUsernameBody.Builder.class)
public final class CreateUsernameBody {
    ...
    public static final class Builder implements UsernameStage, PasswordStage, NameStage, _FinalStage {
        ...
        public CreateUsernameBody build() {
            return new CreateUsernameBody(tags, username, password, name, additionalProperties);
        }
