...
import com.seed.requestParameters.core.Environment;
import com.seed.requestParameters.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedRequestParametersClientBuilder {
    ...
    public AsyncSeedRequestParametersClientBuilder url(String url) {
     ...
     */
    public AsyncSeedRequestParametersClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedRequestParametersClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedRequestParametersClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedRequestParametersClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedRequestParametersClient build() {
        validateConfiguration();
        return new AsyncSeedRequestParametersClient(buildClientOptions());
    }
}
