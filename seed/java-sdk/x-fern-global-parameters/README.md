...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/x-fern-global-parameters)](https://central.sonatype.com/artifact/com.fern/x-fern-global-parameters)
...
```groovy
dependencies {
  implementation 'com.fern:x-fern-global-parameters:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>x-fern-global-parameters</artifactId>
...
```java
SeedApiHttpResponse response = client.products().withRawResponse().search(...);
