...
public class RawAuthClient {
    ...
    public SeedApiHttpResponse<TokenResponse> gettokenwithclientcredentials(GetTokenRequest request) {
    ...
    public SeedApiHttpResponse<TokenResponse> refreshtoken(RefreshTokenRequest request) {
        return refreshtoken(request, null);
    }

    public SeedApiHttpResponse<TokenResponse> refreshtoken(RefreshTokenRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
