...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/inferred-auth-implicit-reference)](https://central.sonatype.com/artifact/com.fern/inferred-auth-implicit-reference)
...
```groovy
dependencies {
  implementation 'com.fern:inferred-auth-implicit-reference:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>inferred-auth-implicit-reference</artifactId>
