...
import com.seed.javaWithPropertyConflict.core.Environment;
import com.seed.javaWithPropertyConflict.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedJavaWithPropertyConflictClientBuilder {
    ...
    public SeedJavaWithPropertyConflictClientBuilder url(String url) {
     ...
     */
    public SeedJavaWithPropertyConflictClientBuilder timeout(int timeout) {
     ...
     */
    public SeedJavaWithPropertyConflictClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedJavaWithPropertyConflictClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedJavaWithPropertyConflictClientBuilder addHeader(String name, String value) {
    ...
    public SeedJavaWithPropertyConflictClient build() {
        validateConfiguration();
        return new SeedJavaWithPropertyConflictClient(buildClientOptions());
    }
}
