...
public class AsyncSeedJavaWithPropertyConflictClientBuilder {
    ...
    public AsyncSeedJavaWithPropertyConflictClientBuilder url(String url) {
     ...
     */
    public AsyncSeedJavaWithPropertyConflictClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedJavaWithPropertyConflictClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedJavaWithPropertyConflictClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedJavaWithPropertyConflictClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedJavaWithPropertyConflictClient build() {
        validateConfiguration();
        return new AsyncSeedJavaWithPropertyConflictClient(buildClientOptions());
    }
}
