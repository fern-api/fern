...
public class AsyncSeedVariablesClientBuilder {
     ...
     */
    public AsyncSeedVariablesClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedVariablesClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedVariablesClient build() {
        ...
        return new AsyncSeedVariablesClient(buildClientOptions());
    }
}
