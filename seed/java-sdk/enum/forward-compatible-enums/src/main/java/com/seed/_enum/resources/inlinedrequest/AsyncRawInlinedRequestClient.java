...
public class AsyncRawInlinedRequestClient {
    ...
    public AsyncRawInlinedRequestClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedEnumHttpResponse<Void>> send(SendEnumInlinedRequest request) {
        return send(request, null);
    }

    public CompletableFuture<SeedEnumHttpResponse<Void>> send(
            SendEnumInlinedRequest request, RequestOptions requestOptions) {
