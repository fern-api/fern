...
public class AsyncRawPathParamClient {
    protected final ClientOptions clientOptions;

    public AsyncRawPathParamClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedEnumHttpResponse<Void>> send(Operand operand, ColorOrOperand operandOrColor) {
