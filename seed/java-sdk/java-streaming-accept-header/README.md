...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/java-streaming-accept-header)](https://central.sonatype.com/artifact/com.fern/java-streaming-accept-header)
...
<dependency>
  ...
  <artifactId>java-streaming-accept-header</artifactId>
...
public class Example {
    public static void main(String[] args) {
        SeedJavaStreamingAcceptHeaderClient client = SeedJavaStreamingAcceptHeaderClient
            .builder()
            .build();
...
try{
    client.dummy().generateStream(...);
} catch (SeedJavaStreamingAcceptHeaderApiException e){
...
```java
SeedJavaStreamingAcceptHeaderHttpResponse response = client.dummy().withRawResponse().generateStream(...);
