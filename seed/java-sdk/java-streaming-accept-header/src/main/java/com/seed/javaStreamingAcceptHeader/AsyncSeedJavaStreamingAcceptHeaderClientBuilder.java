...
import com.seed.javaStreamingAcceptHeader.core.Environment;
import com.seed.javaStreamingAcceptHeader.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedJavaStreamingAcceptHeaderClientBuilder {
    ...
    public AsyncSeedJavaStreamingAcceptHeaderClientBuilder url(String url) {
     ...
     */
    public AsyncSeedJavaStreamingAcceptHeaderClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedJavaStreamingAcceptHeaderClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedJavaStreamingAcceptHeaderClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedJavaStreamingAcceptHeaderClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedJavaStreamingAcceptHeaderClient build() {
        validateConfiguration();
        return new AsyncSeedJavaStreamingAcceptHeaderClient(buildClientOptions());
    }
}
