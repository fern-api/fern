...
public class AsyncRawDummyClient {
    ...
    public CompletableFuture<SeedJavaStreamingAcceptHeaderHttpResponse<Iterable<StreamResponse>>> generateStream(
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SeedJavaStreamingAcceptHeaderHttpResponse<>(
    ...
    public CompletableFuture<SeedJavaStreamingAcceptHeaderHttpResponse<StreamResponse>> generate(
