...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/no-retries)](https://central.sonatype.com/artifact/com.fern/no-retries)
...
```groovy
dependencies {
  implementation 'com.fern:no-retries'
}
```
...
<dependency>
  ...
  <artifactId>no-retries</artifactId>
...
```java
GetUsersHttpResponse response = client.retries().withRawResponse().getUsers(...);
