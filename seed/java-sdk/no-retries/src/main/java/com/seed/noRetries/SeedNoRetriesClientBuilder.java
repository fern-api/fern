...
import com.seed.noRetries.core.Environment;
import com.seed.noRetries.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedNoRetriesClientBuilder {
    ...
    public SeedNoRetriesClientBuilder url(String url) {
     ...
     */
    public SeedNoRetriesClientBuilder timeout(int timeout) {
     ...
     */
    public SeedNoRetriesClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedNoRetriesClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedNoRetriesClientBuilder addHeader(String name, String value) {
    ...
    public SeedNoRetriesClient build() {
        validateConfiguration();
        return new SeedNoRetriesClient(buildClientOptions());
    }
}
