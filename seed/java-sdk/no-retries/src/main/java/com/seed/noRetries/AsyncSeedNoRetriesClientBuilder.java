...
public class AsyncSeedNoRetriesClientBuilder {
    ...
    public AsyncSeedNoRetriesClientBuilder url(String url) {
     ...
     */
    public AsyncSeedNoRetriesClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedNoRetriesClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedNoRetriesClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedNoRetriesClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedNoRetriesClient build() {
        validateConfiguration();
        return new AsyncSeedNoRetriesClient(buildClientOptions());
    }
}
