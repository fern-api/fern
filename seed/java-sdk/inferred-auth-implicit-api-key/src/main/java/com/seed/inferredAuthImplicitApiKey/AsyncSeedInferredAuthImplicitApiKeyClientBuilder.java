...
public class AsyncSeedInferredAuthImplicitApiKeyClientBuilder {
     ...
     * Sets apiKey
     */
    public AsyncSeedInferredAuthImplicitApiKeyClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncSeedInferredAuthImplicitApiKeyClientBuilder url(String url) {
     ...
     */
    public AsyncSeedInferredAuthImplicitApiKeyClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedInferredAuthImplicitApiKeyClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedInferredAuthImplicitApiKeyClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedInferredAuthImplicitApiKeyClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedInferredAuthImplicitApiKeyClient build() {
        validateConfiguration();
        return new AsyncSeedInferredAuthImplicitApiKeyClient(buildClientOptions());
    }
}
