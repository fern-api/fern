...
public class SeedInferredAuthImplicitApiKeyClientBuilder {
     ...
     * Sets apiKey
     */
    public SeedInferredAuthImplicitApiKeyClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public SeedInferredAuthImplicitApiKeyClientBuilder url(String url) {
     ...
     */
    public SeedInferredAuthImplicitApiKeyClientBuilder timeout(int timeout) {
     ...
     */
    public SeedInferredAuthImplicitApiKeyClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedInferredAuthImplicitApiKeyClientBuilder addHeader(String name, String value) {
    ...
    protected void setAuthentication(ClientOptions.Builder builder) {
        if (this.apiKey != null) {
            ...
            InferredAuthTokenSupplier inferredAuthTokenSupplier =
                    new InferredAuthTokenSupplier(this.apiKey, authClient);
            builder.addHeader(
    ...
    public SeedInferredAuthImplicitApiKeyClient build() {
        validateConfiguration();
        return new SeedInferredAuthImplicitApiKeyClient(buildClientOptions());
    }
}
