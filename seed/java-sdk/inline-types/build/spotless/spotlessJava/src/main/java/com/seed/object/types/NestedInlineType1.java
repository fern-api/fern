...
public final class NestedInlineType1 {
    ...
    private NestedInlineType1(String foo, String bar, InlineEnum myEnum, Map<String, Object> additionalProperties) {
        this.foo = foo;
        this.bar = bar;
        this.myEnum = myEnum;
    ...
    public interface MyEnumStage {
        _FinalStage myEnum(@NotNull InlineEnum myEnum);
    }
    ...
    public static final class Builder implements FooStage, BarStage, MyEnumStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("myEnum")
        public _FinalStage myEnum(@NotNull InlineEnum myEnum) {
        ...
        public NestedInlineType1 build() {
            return new NestedInlineType1(foo, bar, myEnum, additionalProperties);
        }
    }
}
