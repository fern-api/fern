...
public class AsyncRawUsersClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<UsersListResponse>> listwithcustompager() {
    ...
    public CompletableFuture<SeedApiHttpResponse<UsersListResponse>> listwithcustompager(
        ...
        CompletableFuture<SeedApiHttpResponse<UsersListResponse>> future = new CompletableFuture<>();
