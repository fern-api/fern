...
public class SeedAcceptClientBuilder {
     ...
     * Sets token
     */
    public SeedAcceptClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public SeedAcceptClientBuilder url(String url) {
     ...
     */
    public SeedAcceptClientBuilder timeout(int timeout) {
     ...
     */
    public SeedAcceptClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedAcceptClientBuilder addHeader(String name, String value) {
    ...
    public SeedAcceptClient build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new SeedAcceptClient(buildClientOptions());
    }
}
