...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/multi-content-type-examples)](https://central.sonatype.com/artifact/com.fern/multi-content-type-examples)
...
```groovy
dependencies {
  implementation 'com.fern:multi-content-type-examples:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>multi-content-type-examples</artifactId>
...
```java
SeedApiHttpResponse response = client.clients().withRawResponse().create(...);
