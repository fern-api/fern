...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/server-url-templating)](https://central.sonatype.com/artifact/com.fern/server-url-templating)
...
```groovy
dependencies {
  implementation 'com.fern:server-url-templating:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>server-url-templating</artifactId>
