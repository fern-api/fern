...
public class SeedBasicAuthPwOmittedClientBuilder {
    ...
    public SeedBasicAuthPwOmittedClientBuilder url(String url) {
     ...
     */
    public SeedBasicAuthPwOmittedClientBuilder timeout(int timeout) {
     ...
     */
    public SeedBasicAuthPwOmittedClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedBasicAuthPwOmittedClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedBasicAuthPwOmittedClientBuilder addHeader(String name, String value) {
