...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/basic-auth-pw-omitted)](https://central.sonatype.com/artifact/com.fern/basic-auth-pw-omitted)
...
```groovy
dependencies {
  implementation 'com.fern:basic-auth-pw-omitted:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>basic-auth-pw-omitted</artifactId>
...
```java
SeedBasicAuthPwOmittedHttpResponse response = client.basicAuth().withRawResponse().postWithBasicAuth(...);
