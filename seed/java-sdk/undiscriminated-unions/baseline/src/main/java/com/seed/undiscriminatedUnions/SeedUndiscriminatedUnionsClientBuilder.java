...
import com.seed.undiscriminatedUnions.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedUndiscriminatedUnionsClientBuilder {
     ...
     */
    public SeedUndiscriminatedUnionsClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedUndiscriminatedUnionsClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedUndiscriminatedUnionsClientBuilder addHeader(String name, String value) {
    ...
    public SeedUndiscriminatedUnionsClient build() {
        ...
        return new SeedUndiscriminatedUnionsClient(buildClientOptions());
    }
}
