 ...
 */
public class SeedUndiscriminatedUnionsApiException extends SeedUndiscriminatedUnionsException {
    /**
    ...
    public SeedUndiscriminatedUnionsApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public SeedUndiscriminatedUnionsApiException(String message, int statusCode, Object body, Response rawResponse) {
        super(message);
        this.statusCode = statusCode;
        this.body = body;
        this.headers = new HashMap<>();
