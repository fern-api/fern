...
@JsonDeserialize(using = UnionWithIdenticalStrings.Deserializer.class)
public final class UnionWithIdenticalStrings {
    ...
    static final class Deserializer extends StdDeserializer<UnionWithIdenticalStrings> {
        ...
        @java.lang.Override
        public UnionWithIdenticalStrings deserialize(JsonParser p, DeserializationContext context) throws IOException {
