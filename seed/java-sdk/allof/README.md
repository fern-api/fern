...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/allof)](https://central.sonatype.com/artifact/com.fern/allof)
...
```groovy
dependencies {
  implementation 'com.fern:allof:0.0.1'
}
```
