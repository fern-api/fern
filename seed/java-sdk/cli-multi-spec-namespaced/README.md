...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/cli-multi-spec-namespaced)](https://central.sonatype.com/artifact/com.fern/cli-multi-spec-namespaced)
...
```groovy
dependencies {
  implementation 'com.fern:cli-multi-spec-namespaced:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>cli-multi-spec-namespaced</artifactId>
...
```java
SeedApiHttpResponse response = client.v1().withRawResponse().listUsers(...);
