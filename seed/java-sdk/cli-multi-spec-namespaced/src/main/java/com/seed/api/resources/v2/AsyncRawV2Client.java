...
public class AsyncRawV2Client {
    ...
    public CompletableFuture<SeedApiHttpResponse<List<UserV2>>> listUsers() {
        return listUsers(ListUsersRequest.builder().build());
    }

    public CompletableFuture<SeedApiHttpResponse<List<UserV2>>> listUsers(RequestOptions requestOptions) {
        return listUsers(ListUsersRequest.builder().build(), requestOptions);
    }

    public CompletableFuture<SeedApiHttpResponse<List<UserV2>>> listUsers(ListUsersRequest request) {
    ...
    public CompletableFuture<SeedApiHttpResponse<List<UserV2>>> listUsers(
        ...
        CompletableFuture<SeedApiHttpResponse<List<UserV2>>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SeedApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, new TypeReference<List<UserV2>>() {}),
                                response));
                        return;
                    }
