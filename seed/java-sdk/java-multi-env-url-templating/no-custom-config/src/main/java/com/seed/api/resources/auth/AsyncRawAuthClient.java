...
public class AsyncRawAuthClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<GetTokenResponse>> getToken(RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getOauthURL())
                .newBuilder()
