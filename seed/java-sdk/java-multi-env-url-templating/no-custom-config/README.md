...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/java-multi-env-url-templating)](https://central.sonatype.com/artifact/com.fern/java-multi-env-url-templating)
...
```groovy
dependencies {
  implementation 'com.fern:java-multi-env-url-templating:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>java-multi-env-url-templating</artifactId>
