...
public class RawReferenceClient {
    ...
    public SeedLiteralHttpResponse<SendResponse> send(SendRequest request) {
        return send(request, null);
    }

    public SeedLiteralHttpResponse<SendResponse> send(SendRequest request, RequestOptions requestOptions) {
