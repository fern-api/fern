...
public class RawReferenceClient {
    ...
    public SeedApiHttpResponse<SendResponse> send(SendRequest request) {
        return send(request, null);
    }

    public SeedApiHttpResponse<SendResponse> send(SendRequest request, RequestOptions requestOptions) {
