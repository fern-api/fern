...
public final class ContainerObject {
    ...
    private ContainerObject(List<NestedObjectWithLiterals> nestedObjects, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder {
        ...
        public ContainerObject build() {
            return new ContainerObject(nestedObjects, additionalProperties);
        }
