...
public class RawQueryClient {
    ...
    public SeedApiHttpResponse<SendResponse> send(QuerySendRequest request) {
        return send(request, null);
    }

    public SeedApiHttpResponse<SendResponse> send(QuerySendRequest request, RequestOptions requestOptions) {
