...
public class RawInlinedClient {
    ...
    public SeedApiHttpResponse<SendResponse> send(InlinedSendRequest request) {
        return send(request, null);
    }

    public SeedApiHttpResponse<SendResponse> send(InlinedSendRequest request, RequestOptions requestOptions) {
