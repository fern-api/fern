...
public class SeedLiteralClientBuilder {
     ...
     */
    public SeedLiteralClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedLiteralClientBuilder addHeader(String name, String value) {
    ...
    protected void setCustomHeaders(ClientOptions.Builder builder) {
        ...
        builder.addHeader("X-API-Enable-Audit-Logging", this.auditLogging);
    }
