...
public class AsyncRawInlinedClient {
    protected final ClientOptions clientOptions;

    public AsyncRawInlinedClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedLiteralHttpResponse<SendResponse>> send(SendLiteralsInlinedRequest request) {
