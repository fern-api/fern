...
import com.seed.manyProperties.core.Environment;
import com.seed.manyProperties.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedManyPropertiesClientBuilder {
    ...
    public AsyncSeedManyPropertiesClientBuilder url(String url) {
     ...
     */
    public AsyncSeedManyPropertiesClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedManyPropertiesClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedManyPropertiesClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedManyPropertiesClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedManyPropertiesClient build() {
        validateConfiguration();
        return new AsyncSeedManyPropertiesClient(buildClientOptions());
    }
}
