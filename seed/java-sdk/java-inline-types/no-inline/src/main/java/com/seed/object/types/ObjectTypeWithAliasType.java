...
public final class ObjectTypeWithAliasType {
    private final AliasProperty prop;

    private final Map<String, Object> additionalProperties;

    private ObjectTypeWithAliasType(AliasProperty prop, Map<String, Object> additionalProperties) {
        this.prop = prop;
        this.additionalProperties = additionalProperties;
    }

    @JsonProperty("prop")
    public AliasProperty getProp() {
        return prop;
    }
    ...
    public interface PropStage {
        _FinalStage prop(@NotNull AliasProperty prop);
    ...
    public static final class Builder implements PropStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("prop")
        public _FinalStage prop(@NotNull AliasProperty prop) {
