...
public final class UnionTypeWithAliasListVariant {
    ...
    public static UnionTypeWithAliasListVariant aliasVariant(List<AliasVariant> value) {
    ...
    public Optional<List<AliasVariant>> getAliasVariant() {
        if (isAliasVariant()) {
    ...
    public interface Visitor<T> {
        T visitAliasVariant(List<AliasVariant> aliasVariant);
    ...
    private static final class AliasVariantValue implements Value {
        ...
        private AliasVariantValue(@JsonProperty("value") List<AliasVariant> value) {
            this.value = value;
        }
