...
@JsonDeserialize(builder = OtherAliasPropertyType.Builder.class)
public final class OtherAliasPropertyType {
    private final String prop;

    private final Map<String, Object> additionalProperties;

    private OtherAliasPropertyType(String prop, Map<String, Object> additionalProperties) {
        this.prop = prop;
    ...
    public static final class Builder implements PropStage, _FinalStage {
        ...
        public OtherAliasPropertyType build() {
            return new OtherAliasPropertyType(prop, additionalProperties);
        }
    }
}
