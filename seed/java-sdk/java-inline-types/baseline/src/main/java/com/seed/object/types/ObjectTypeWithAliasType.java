...
public final class ObjectTypeWithAliasType {
    ...
    private ObjectTypeWithAliasType(AliasPropertyType prop, Map<String, Object> additionalProperties) {
        this.prop = prop;
    ...
    public interface PropStage {
        _FinalStage prop(@NotNull AliasPropertyType prop);
    ...
    public static final class Builder implements PropStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("prop")
        public _FinalStage prop(@NotNull AliasPropertyType prop) {
