...
public final class UndiscriminatedUnion1 {
    ...
    public static UndiscriminatedUnion1 of(InlineType1 value) {
        return new UndiscriminatedUnion1(value, 0);
    }

    public static UndiscriminatedUnion1 of(InlineType2 value) {
        return new UndiscriminatedUnion1(value, 1);
    }

    public static UndiscriminatedUnion1 of(DiscriminatedUnion1 value) {
        return new UndiscriminatedUnion1(value, 2);
    }

    public static UndiscriminatedUnion1 of(InlineEnum1 value) {
    ...
    public static UndiscriminatedUnion1 of(List<InlineListItem1> value) {
        return new UndiscriminatedUnion1(value, 5);
    }

    public static UndiscriminatedUnion1 of(Set<InlineSetItem1> value) {
        return new UndiscriminatedUnion1(value, 6);
    }

    public static UndiscriminatedUnion1 of(Map<String, InlineMapItem1> value) {
    ...
    static final class Deserializer extends StdDeserializer<UndiscriminatedUnion1> {
        ...
        public UndiscriminatedUnion1 deserialize(JsonParser p, DeserializationContext context) throws IOException {
            ...
            try {
                return of(ObjectMappers.JSON_MAPPER.convertValue(value, new TypeReference<List<InlineListItem1>>() {}));
            } catch (RuntimeException e) {
            }
            try {
                return of(ObjectMappers.JSON_MAPPER.convertValue(value, new TypeReference<Set<InlineSetItem1>>() {}));
            } catch (RuntimeException e) {
            }
            try {
    ...
    public static final class InlineType1 {
        ...
        private InlineType1(String foo, Bar bar, ReferenceType ref, Map<String, Object> additionalProperties) {
            this.foo = foo;
            this.bar = bar;
            this.ref = ref;
        ...
        public static final class Bar {
            ...
            private Bar(String foo, ReferenceType ref, Map<String, Object> additionalProperties) {
                this.foo = foo;
                this.ref = ref;
                this.additionalProperties = additionalProperties;
            }
            ...
            public static final class Builder implements FooStage, RefStage, _FinalStage {
                ...
                @java.lang.Override
                public Bar build() {
                    return new Bar(foo, ref, additionalProperties);
                }
    ...
    public static final class DiscriminatedUnion1 {
        ...
        private static final class Type1Value implements Value {
            ...
            @java.lang.Override
            public String toString() {
                return "UndiscriminatedUnion1.DiscriminatedUnion1{" + "value: " + value + "}";
            }
        }
        ...
        private static final class _UnknownValue implements Value {
            ...
            @java.lang.Override
            public String toString() {
                return "UndiscriminatedUnion1.DiscriminatedUnion1{" + "type: " + type + ", value: " + value + "}";
            }
        }
        ...
        public static final class Type1 {
            ...
            private Type1(String foo, Bar bar, ReferenceType ref, Map<String, Object> additionalProperties) {
                this.foo = foo;
                this.bar = bar;
                this.ref = ref;
                this.additionalProperties = additionalProperties;
