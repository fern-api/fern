...
import com.seed.responseProperty.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedResponsePropertyClientBuilder {
     ...
     */
    public AsyncSeedResponsePropertyClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedResponsePropertyClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedResponsePropertyClient build() {
        ...
        return new AsyncSeedResponsePropertyClient(buildClientOptions());
    }
}
