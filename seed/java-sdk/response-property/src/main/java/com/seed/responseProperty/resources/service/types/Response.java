...
import com.seed.responseProperty.types.IWithMetadata;
...
public final class Response implements IWithMetadata, IWithDocs {
    ...
    private Response(Map<String, String> metadata, String docs, Movie data, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder implements DocsStage, DataStage, _FinalStage {
        ...
        public Response build() {
            return new Response(metadata, docs, data, additionalProperties);
        }
    }
}
