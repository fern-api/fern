...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/response-property)](https://central.sonatype.com/artifact/com.fern/response-property)
...
```groovy
dependencies {
  implementation 'com.fern:response-property:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>response-property</artifactId>
