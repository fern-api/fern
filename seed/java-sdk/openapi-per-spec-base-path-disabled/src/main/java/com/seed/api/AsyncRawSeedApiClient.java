...
public class AsyncRawSeedApiClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<List<String>>> listItems() {
        return listItems(null);
    }

    public CompletableFuture<SeedApiHttpResponse<List<String>>> listItems(RequestOptions requestOptions) {
