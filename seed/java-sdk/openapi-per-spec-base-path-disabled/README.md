...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/openapi-per-spec-base-path-disabled)](https://central.sonatype.com/artifact/com.fern/openapi-per-spec-base-path-disabled)
...
```groovy
dependencies {
  implementation 'com.fern:openapi-per-spec-base-path-disabled:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>openapi-per-spec-base-path-disabled</artifactId>
