 ...
 */
public class SeedIdempotencyHeadersApiException extends SeedIdempotencyHeadersException {
    /**
    ...
    public SeedIdempotencyHeadersApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public SeedIdempotencyHeadersApiException(String message, int statusCode, Object body, Response rawResponse) {
        super(message);
        this.statusCode = statusCode;
        this.body = body;
        this.headers = new HashMap<>();
