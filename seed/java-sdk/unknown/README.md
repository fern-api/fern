...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/unknown)](https://central.sonatype.com/artifact/com.fern/unknown)
...
```java
SeedUnknownAsAnyHttpResponse response = client.unknown().withRawResponse().post(...);
