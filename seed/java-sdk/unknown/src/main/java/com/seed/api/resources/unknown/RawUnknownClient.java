...
public class RawUnknownClient {
    ...
    public SeedApiHttpResponse<List<Object>> post(Object request) {
        return post(request, null);
    }

    public SeedApiHttpResponse<List<Object>> post(Object request, RequestOptions requestOptions) {
    ...
    public SeedApiHttpResponse<List<Object>> postobject(MyObject request) {
        return postobject(request, null);
    }

    public SeedApiHttpResponse<List<Object>> postobject(MyObject request, RequestOptions requestOptions) {
