 ...
 */
public class SeedUnknownAsAnyApiException extends SeedUnknownAsAnyException {
    /**
    ...
    public SeedUnknownAsAnyApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public SeedUnknownAsAnyApiException(String message, int statusCode, Object body, Response rawResponse) {
        super(message);
        this.statusCode = statusCode;
        this.body = body;
        this.headers = new HashMap<>();
