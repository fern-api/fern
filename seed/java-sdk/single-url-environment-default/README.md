...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/single-url-environment-default)](https://central.sonatype.com/artifact/com.fern/single-url-environment-default)
...
```groovy
dependencies {
  implementation 'com.fern:single-url-environment-default:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>single-url-environment-default</artifactId>
...
```java
SeedSingleUrlEnvironmentDefaultHttpResponse response = client.dummy().withRawResponse().getDummy(...);
