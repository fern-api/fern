...
public class AsyncRawDummyClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<String>> getdummy() {
        return getdummy(null);
    }

    public CompletableFuture<SeedApiHttpResponse<String>> getdummy(RequestOptions requestOptions) {
