...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/no-content-response)](https://central.sonatype.com/artifact/com.fern/no-content-response)
...
<dependency>
  ...
  <artifactId>no-content-response</artifactId>
...
```java
SeedApiHttpResponse response = client.contacts().withRawResponse().create(...);
