...
public class AsyncRawS3Client {
    protected final ClientOptions clientOptions;

    public AsyncRawS3Client(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedApiHttpResponse<String>> getpresignedurl(S3GetPresignedUrlRequest request) {
        return getpresignedurl(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<String>> getpresignedurl(
            S3GetPresignedUrlRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("s3/presigned-url");
