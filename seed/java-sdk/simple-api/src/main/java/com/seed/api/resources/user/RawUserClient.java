...
public class RawUserClient {
    ...
    public SeedApiHttpResponse<User> get(String id, UserGetRequest request) {
        return get(id, request, null);
    }

    public SeedApiHttpResponse<User> get(String id, UserGetRequest request, RequestOptions requestOptions) {
