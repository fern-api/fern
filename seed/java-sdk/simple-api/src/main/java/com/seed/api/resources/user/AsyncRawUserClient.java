...
public class AsyncRawUserClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<User>> get(String id) {
        return get(id, UserGetRequest.builder().build());
    }

    public CompletableFuture<SeedApiHttpResponse<User>> get(String id, RequestOptions requestOptions) {
        return get(id, UserGetRequest.builder().build(), requestOptions);
    }

    public CompletableFuture<SeedApiHttpResponse<User>> get(String id, UserGetRequest request) {
        return get(id, request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<User>> get(
            String id, UserGetRequest request, RequestOptions requestOptions) {
