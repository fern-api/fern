...
import com.seed.simpleApi.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedSimpleApiClientBuilder {
     ...
     * Sets token
     */
    public SeedSimpleApiClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public SeedSimpleApiClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public SeedSimpleApiClientBuilder url(String url) {
     ...
     */
    public SeedSimpleApiClientBuilder timeout(int timeout) {
     ...
     */
    public SeedSimpleApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedSimpleApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedSimpleApiClientBuilder addHeader(String name, String value) {
    ...
    public SeedSimpleApiClient build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new SeedSimpleApiClient(buildClientOptions());
    }
}
