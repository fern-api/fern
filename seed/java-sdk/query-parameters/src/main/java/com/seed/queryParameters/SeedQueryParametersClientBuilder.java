...
import com.seed.queryParameters.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedQueryParametersClientBuilder {
     ...
     */
    public SeedQueryParametersClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedQueryParametersClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedQueryParametersClientBuilder addHeader(String name, String value) {
    ...
    public SeedQueryParametersClient build() {
        ...
        return new SeedQueryParametersClient(buildClientOptions());
    }
}
