...
public class SeedJavaReservedKeywordEnvironmentClientBuilder {
     ...
     * Sets token
     */
    public SeedJavaReservedKeywordEnvironmentClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public SeedJavaReservedKeywordEnvironmentClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public SeedJavaReservedKeywordEnvironmentClientBuilder url(String url) {
     ...
     */
    public SeedJavaReservedKeywordEnvironmentClientBuilder timeout(int timeout) {
     ...
     */
    public SeedJavaReservedKeywordEnvironmentClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public SeedJavaReservedKeywordEnvironmentClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedJavaReservedKeywordEnvironmentClientBuilder addHeader(String name, String value) {
    ...
    public SeedJavaReservedKeywordEnvironmentClient build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new SeedJavaReservedKeywordEnvironmentClient(buildClientOptions());
    }
}
