...
public class AsyncSeedJavaReservedKeywordEnvironmentClientBuilder {
     ...
     * Sets token
     */
    public AsyncSeedJavaReservedKeywordEnvironmentClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public AsyncSeedJavaReservedKeywordEnvironmentClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncSeedJavaReservedKeywordEnvironmentClientBuilder url(String url) {
     ...
     */
    public AsyncSeedJavaReservedKeywordEnvironmentClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedJavaReservedKeywordEnvironmentClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncSeedJavaReservedKeywordEnvironmentClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedJavaReservedKeywordEnvironmentClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedJavaReservedKeywordEnvironmentClient build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new AsyncSeedJavaReservedKeywordEnvironmentClient(buildClientOptions());
    }
}
