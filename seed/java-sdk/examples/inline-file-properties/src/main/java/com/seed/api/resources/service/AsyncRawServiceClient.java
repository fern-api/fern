...
public class AsyncRawServiceClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<Movie>> getmovie(ServiceGetMovieRequest request) {
        return getmovie(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Movie>> getmovie(
            ServiceGetMovieRequest request, RequestOptions requestOptions) {
