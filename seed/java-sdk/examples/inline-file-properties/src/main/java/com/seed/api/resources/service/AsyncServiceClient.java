...
public class AsyncServiceClient {
    ...
    public CompletableFuture<Movie> getmovie(ServiceGetMovieRequest request) {
        return this.rawClient.getmovie(request).thenApply(response -> response.body());
    }

    public CompletableFuture<Movie> getmovie(ServiceGetMovieRequest request, RequestOptions requestOptions) {
