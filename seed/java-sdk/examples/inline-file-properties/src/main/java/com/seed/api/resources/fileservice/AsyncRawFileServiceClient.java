...
public class AsyncRawFileServiceClient {
    protected final ClientOptions clientOptions;

    public AsyncRawFileServiceClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<SeedApiHttpResponse<File>> fileServiceGetFile(FileServiceGetFileRequest request) {
        return fileServiceGetFile(request, null);
    }

    /**
     * This endpoint returns a file by its name.
     */
    public CompletableFuture<SeedApiHttpResponse<File>> fileServiceGetFile(
            FileServiceGetFileRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("file")
                .addPathSegment(request.getFilename());
        ...
        CompletableFuture<SeedApiHttpResponse<File>> future = new CompletableFuture<>();
