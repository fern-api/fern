...
public final class EventInfo {
    ...
    public static EventInfo tag(String value) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventInfo && value.equals(((EventInfo) other).value);
    }
    ...
    public interface Visitor<T> {
        ...
        T visitTag(String tag);

        T _visitUnknown(Object unknownType);
    }

    @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "type", visible = true, defaultImpl = _UnknownValue.class)
    @JsonSubTypes({@JsonSubTypes.Type(MetadataValue.class), @JsonSubTypes.Type(TagValue.class)})
    ...
    private static final class TagValue implements Value {
        ...
        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private TagValue(@JsonProperty("value") String value) {
            this.value = value;
        }
