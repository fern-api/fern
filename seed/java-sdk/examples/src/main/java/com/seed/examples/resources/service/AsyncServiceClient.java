...
public class AsyncServiceClient {
    ...
    public CompletableFuture<Metadata> getMetadata(GetMetadataRequest request, RequestOptions requestOptions) {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Metadata.class));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    future.completeExceptionally(new SeedExamplesApiException(
    ...
    public CompletableFuture<com.seed.examples.resources.types.types.Response> createBigEntity() {
        return createBigEntity(BigEntity.builder().build());
    }

    public CompletableFuture<com.seed.examples.resources.types.types.Response> createBigEntity(BigEntity request) {
    ...
    public CompletableFuture<com.seed.examples.resources.types.types.Response> createBigEntity(
        ...
        CompletableFuture<com.seed.examples.resources.types.types.Response> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
