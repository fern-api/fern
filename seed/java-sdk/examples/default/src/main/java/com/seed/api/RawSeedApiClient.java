...
public class RawSeedApiClient {
    ...
    public SeedApiHttpResponse<String> echo(String request) {
        return echo(request, null);
    }

    public SeedApiHttpResponse<String> echo(String request, RequestOptions requestOptions) {
    ...
    public SeedApiHttpResponse<Identifier> createType(Type request) {
        return createType(request, null);
    }

    public SeedApiHttpResponse<Identifier> createType(Type request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
