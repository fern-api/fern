...
public final class BigEntity {
    ...
    private final Optional<com.seed.examples.resources.commons.types.types.Metadata> commonMetadata;
    ...
    private BigEntity(
            ...
            Optional<com.seed.examples.resources.commons.types.types.Metadata> commonMetadata,
    ...
    public Optional<com.seed.examples.resources.commons.types.types.Metadata> getCommonMetadata() {
    ...
    public static final class Builder {
        ...
        private Optional<com.seed.examples.resources.commons.types.types.Metadata> commonMetadata = Optional.empty();
        ...
        public Builder commonMetadata(com.seed.examples.resources.commons.types.types.Metadata commonMetadata) {
