...
@JsonDeserialize(builder = ExceptionZero.Builder.class)
public final class ExceptionZero implements IExceptionInfo {
    ...
    private final ExceptionZeroType type;

    private final Map<String, Object> additionalProperties;

    private ExceptionZero(
            String exceptionType,
            String exceptionMessage,
            String exceptionStacktrace,
            ExceptionZeroType type,
    ...
    @JsonProperty("type")
    public ExceptionZeroType getType() {
        return type;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExceptionZero && equalTo((ExceptionZero) other);
    }
    ...
    private boolean equalTo(ExceptionZero other) {
    ...
    public interface ExceptionTypeStage {
        ...
        Builder from(ExceptionZero other);
    }
    ...
    public interface TypeStage {
        _FinalStage type(@NotNull ExceptionZeroType type);
    }
    ...
    public static final class Builder
        ...
        private ExceptionZeroType type;
        ...
        @java.lang.Override
        public Builder from(ExceptionZero other) {
        ...
        @java.lang.Override
        @JsonSetter("type")
        public _FinalStage type(@NotNull ExceptionZeroType type) {
            this.type = Objects.requireNonNull(type, "type must not be null");
            return this;
        }

        @java.lang.Override
        public ExceptionZero build() {
            return new ExceptionZero(exceptionType, exceptionMessage, exceptionStacktrace, type, additionalProperties);
        }
