...
import com.seed.examples.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedExamplesClientBuilder {
     ...
     */
    public SeedExamplesClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedExamplesClientBuilder addHeader(String name, String value) {
    ...
    public SeedExamplesClient build() {
        ...
        return new SeedExamplesClient(buildClientOptions());
    }
}
