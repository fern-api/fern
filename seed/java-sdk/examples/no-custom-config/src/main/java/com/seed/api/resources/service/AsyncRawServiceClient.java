...
public class AsyncRawServiceClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<Movie>> getmovie(String movieId) {
        return getmovie(movieId, ServiceGetMovieRequest.builder().build());
    }

    public CompletableFuture<SeedApiHttpResponse<Movie>> getmovie(String movieId, RequestOptions requestOptions) {
        return getmovie(movieId, ServiceGetMovieRequest.builder().build(), requestOptions);
    }

    public CompletableFuture<SeedApiHttpResponse<Movie>> getmovie(String movieId, ServiceGetMovieRequest request) {
    ...
    public CompletableFuture<SeedApiHttpResponse<String>> createmovie(Movie request) {
        return createmovie(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<String>> createmovie(Movie request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("movie");
        if (requestOptions != null) {
    ...
    public CompletableFuture<SeedApiHttpResponse<Metadata>> getmetadata(ServiceGetMetadataRequest request) {
        return getmetadata(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Metadata>> getmetadata(
            ServiceGetMetadataRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
        ...
        CompletableFuture<SeedApiHttpResponse<Metadata>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<SeedApiHttpResponse<com.seed.api.types.Response>> createbigentity() {
    ...
    public CompletableFuture<SeedApiHttpResponse<com.seed.api.types.Response>> createbigentity(BigEntity request) {
    ...
    public CompletableFuture<SeedApiHttpResponse<com.seed.api.types.Response>> createbigentity(
        ...
        CompletableFuture<SeedApiHttpResponse<com.seed.api.types.Response>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SeedApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, com.seed.api.types.Response.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
    ...
    public CompletableFuture<SeedApiHttpResponse<Void>> refreshtoken(RefreshTokenRequest request) {
        return refreshtoken(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> refreshtoken(
