...
public class AsyncRawSeedApiClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<String>> echo(String request) {
        return echo(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<String>> echo(String request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("echo");
    ...
    public CompletableFuture<SeedApiHttpResponse<Identifier>> createType(Type request) {
        return createType(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Identifier>> createType(Type request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
        ...
        CompletableFuture<SeedApiHttpResponse<Identifier>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
