...
public class AsyncRawServiceClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<Void>> upload(InputStream request) {
        return upload(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> upload(InputStream request, RequestOptions requestOptions) {
    ...
    public CompletableFuture<SeedApiHttpResponse<Void>> upload(byte[] request) {
        return upload(new ByteArrayInputStream(request));
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> upload(byte[] request, RequestOptions requestOptions) {
        return upload(new ByteArrayInputStream(request), requestOptions);
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> uploadwithqueryparams(
