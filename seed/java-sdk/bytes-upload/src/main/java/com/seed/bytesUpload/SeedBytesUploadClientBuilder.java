...
public class SeedBytesUploadClientBuilder {
     ...
     */
    public SeedBytesUploadClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedBytesUploadClientBuilder addHeader(String name, String value) {
    ...
    public SeedBytesUploadClient build() {
        ...
        return new SeedBytesUploadClient(buildClientOptions());
    }
}
