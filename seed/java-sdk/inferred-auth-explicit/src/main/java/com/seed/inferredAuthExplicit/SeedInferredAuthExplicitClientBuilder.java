...
import com.seed.inferredAuthExplicit.core.Environment;
import com.seed.inferredAuthExplicit.core.InferredAuthTokenSupplier;
import com.seed.inferredAuthExplicit.core.LogConfig;
...
public class SeedInferredAuthExplicitClientBuilder {
     ...
     * Sets xApiKey
     */
    public SeedInferredAuthExplicitClientBuilder xApiKey(String xApiKey) {
     ...
     * Sets clientId
     */
    public SeedInferredAuthExplicitClientBuilder clientId(String clientId) {
     ...
     * Sets clientSecret
     */
    public SeedInferredAuthExplicitClientBuilder clientSecret(String clientSecret) {
     ...
     * Sets scope
     */
    public SeedInferredAuthExplicitClientBuilder scope(String scope) {
        this.scope = scope;
        return this;
    }

    public SeedInferredAuthExplicitClientBuilder url(String url) {
     ...
     */
    public SeedInferredAuthExplicitClientBuilder timeout(int timeout) {
     ...
     */
    public SeedInferredAuthExplicitClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedInferredAuthExplicitClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedInferredAuthExplicitClientBuilder addHeader(String name, String value) {
    ...
    public SeedInferredAuthExplicitClient build() {
        validateConfiguration();
        return new SeedInferredAuthExplicitClient(buildClientOptions());
    }
}
