...
public final class UserProfile {
    ...
    private UserProfile(
            String name, UserProfileVerification verification, String ssn, Map<String, Object> additionalProperties) {
        this.name = name;
    ...
    public static final class Builder implements NameStage, VerificationStage, SsnStage, _FinalStage {
        ...
        public UserProfile build() {
            return new UserProfile(name, verification, ssn, additionalProperties);
        }
