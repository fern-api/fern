...
public class AsyncRawSeedApiClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<User>> createUser(User request) {
        return createUser(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<User>> createUser(User request, RequestOptions requestOptions) {
