...
import com.seed.propertyAccess.core.Environment;
import com.seed.propertyAccess.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedPropertyAccessClientBuilder {
    ...
    public AsyncSeedPropertyAccessClientBuilder url(String url) {
     ...
     */
    public AsyncSeedPropertyAccessClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedPropertyAccessClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedPropertyAccessClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedPropertyAccessClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedPropertyAccessClient build() {
        validateConfiguration();
        return new AsyncSeedPropertyAccessClient(buildClientOptions());
    }
}
