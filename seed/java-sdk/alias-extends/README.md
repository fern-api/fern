...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/alias-extends)](https://central.sonatype.com/artifact/com.fern/alias-extends)
...
```groovy
dependencies {
  implementation 'com.fern:alias-extends'
}
```
...
<dependency>
  ...
  <artifactId>alias-extends</artifactId>
...
public class Example {
    public static void main(String[] args) {
        SeedAliasExtendsClient client = SeedAliasExtendsClient
            .builder()
            .build();
...
try{
    client.extendedInlineRequestBody(...);
} catch (SeedAliasExtendsApiException e){
...
```java
ExtendedInlineRequestBodyHttpResponse response = client.withRawResponse().extendedInlineRequestBody(...);
