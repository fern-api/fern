...
import com.seed.aliasExtends.core.Environment;
import com.seed.aliasExtends.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedAliasExtendsClientBuilder {
    ...
    public AsyncSeedAliasExtendsClientBuilder url(String url) {
     ...
     */
    public AsyncSeedAliasExtendsClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedAliasExtendsClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedAliasExtendsClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedAliasExtendsClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedAliasExtendsClient build() {
        validateConfiguration();
        return new AsyncSeedAliasExtendsClient(buildClientOptions());
    }
}
