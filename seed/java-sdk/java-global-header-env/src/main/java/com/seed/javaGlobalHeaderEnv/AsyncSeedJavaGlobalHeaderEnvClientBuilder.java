...
import com.seed.javaGlobalHeaderEnv.core.Environment;
import com.seed.javaGlobalHeaderEnv.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedJavaGlobalHeaderEnvClientBuilder {
    ...
    private String version =
            Optional.ofNullable(System.getenv("MY_API_VERSION")).orElse("2024-01-01");
    ...
    /**
     * Sets version.
     * Defaults to the MY_API_VERSION environment variable.
     */
    public AsyncSeedJavaGlobalHeaderEnvClientBuilder version(String version) {
        this.version = version;
        return this;
    }

    public AsyncSeedJavaGlobalHeaderEnvClientBuilder url(String url) {
     ...
     */
    public AsyncSeedJavaGlobalHeaderEnvClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedJavaGlobalHeaderEnvClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncSeedJavaGlobalHeaderEnvClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncSeedJavaGlobalHeaderEnvClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncSeedJavaGlobalHeaderEnvClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncSeedJavaGlobalHeaderEnvClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedJavaGlobalHeaderEnvClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedJavaGlobalHeaderEnvClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedJavaGlobalHeaderEnvClient build() {
        validateConfiguration();
        return new AsyncSeedJavaGlobalHeaderEnvClient(buildClientOptions());
    }
}
