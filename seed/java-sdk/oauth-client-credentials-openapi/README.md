...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/oauth-client-credentials-openapi)](https://central.sonatype.com/artifact/com.fern/oauth-client-credentials-openapi)
...
```groovy
dependencies {
  implementation 'com.fern:oauth-client-credentials-openapi:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>oauth-client-credentials-openapi</artifactId>
