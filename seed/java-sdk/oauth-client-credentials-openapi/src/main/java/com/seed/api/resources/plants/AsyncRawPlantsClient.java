...
public class AsyncRawPlantsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawPlantsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedApiHttpResponse<List<Plant>>> list() {
        return list(null);
    }

    public CompletableFuture<SeedApiHttpResponse<List<Plant>>> list(RequestOptions requestOptions) {
