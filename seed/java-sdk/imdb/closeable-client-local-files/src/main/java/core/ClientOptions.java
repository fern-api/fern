...
public final class ClientOptions {
  ...
  public static class Builder {
    ...
    public ClientOptions build() {
      ...
      return new ClientOptions(environment, headers, headerSuppliers, httpClient, ownsHttpClient, this.timeout.get(), this.maxRetries, this.initialRetryDelayMillis, this.maxRetryDelayMillis, this.retryJitterFactor, this.logging);
    }
