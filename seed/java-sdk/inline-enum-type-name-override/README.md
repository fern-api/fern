...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/inline-enum-type-name-override)](https://central.sonatype.com/artifact/com.fern/inline-enum-type-name-override)
...
```groovy
dependencies {
  implementation 'com.fern:inline-enum-type-name-override:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>inline-enum-type-name-override</artifactId>
...
```java
SeedApiHttpResponse response = client.reporting().withRawResponse().load(...);
