...
import com.seed.literalUserAgent.core.Environment;
import com.seed.literalUserAgent.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedLiteralUserAgentClientBuilder {
     ...
     * Sets userAgent
     */
    public SeedLiteralUserAgentClientBuilder userAgent(String userAgent) {
        this.userAgent = userAgent;
        return this;
    }

    public SeedLiteralUserAgentClientBuilder url(String url) {
     ...
     */
    public SeedLiteralUserAgentClientBuilder timeout(int timeout) {
     ...
     */
    public SeedLiteralUserAgentClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedLiteralUserAgentClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedLiteralUserAgentClientBuilder addHeader(String name, String value) {
    ...
    public SeedLiteralUserAgentClient build() {
        validateConfiguration();
        return new SeedLiteralUserAgentClient(buildClientOptions());
    }
}
