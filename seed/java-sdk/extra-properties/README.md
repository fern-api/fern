...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/extra-properties)](https://central.sonatype.com/artifact/com.fern/extra-properties)
...
```groovy
dependencies {
  implementation 'com.fern:extra-properties:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>extra-properties</artifactId>
...
```java
SeedExtraPropertiesHttpResponse response = client.user().withRawResponse().createUser(...);
