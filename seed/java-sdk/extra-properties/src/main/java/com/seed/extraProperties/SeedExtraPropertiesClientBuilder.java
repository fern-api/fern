...
public class SeedExtraPropertiesClientBuilder {
     ...
     */
    public SeedExtraPropertiesClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedExtraPropertiesClientBuilder addHeader(String name, String value) {
    ...
    public SeedExtraPropertiesClient build() {
        ...
        return new SeedExtraPropertiesClient(buildClientOptions());
    }
}
