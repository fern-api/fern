 ...
 */
package com.seed.extraProperties.resources.user.types;
...
public final class User {
    ...
    private User(String name, Map<String, Object> additionalProperties) {
        this.name = name;
    ...
    public static final class Builder implements NameStage, _FinalStage {
        ...
        @java.lang.Override
        public User build() {
            return new User(name, additionalProperties);
        }
    }
}
