...
import com.seed.api.resources.user.requests.CreateUserRequest;
import com.seed.api.resources.user.requests.GetUserRequest;
import com.seed.api.resources.user.types.CreateUserResponse;
import com.seed.api.resources.user.types.User;
...
public class UserClient {
    ...
    public CreateUserResponse createUser(CreateUserRequest request, RequestOptions requestOptions) {
    ...
    public User getUser(GetUserRequest request, RequestOptions requestOptions) {
        ...
        if (request.getAge().isPresent()) {
            httpUrl.addQueryParameter("age", request.getAge().get().toString());
        }
        if (request.getWeight().isPresent()) {
            httpUrl.addQueryParameter("weight", request.getWeight().get().toString());
        }
