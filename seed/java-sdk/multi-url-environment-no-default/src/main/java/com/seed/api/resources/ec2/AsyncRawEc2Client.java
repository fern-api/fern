...
public class AsyncRawEc2Client {
    ...
    public CompletableFuture<SeedApiHttpResponse<Void>> bootinstance(Ec2BootInstanceRequest request) {
        return bootinstance(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> bootinstance(
            Ec2BootInstanceRequest request, RequestOptions requestOptions) {
