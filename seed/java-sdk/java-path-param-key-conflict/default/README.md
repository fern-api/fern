...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/java-path-param-key-conflict)](https://central.sonatype.com/artifact/com.fern/java-path-param-key-conflict)
...
<dependency>
  ...
  <artifactId>java-path-param-key-conflict</artifactId>
...
```java
CreateItemHttpResponse response = client.withRawResponse().createItem(...);
