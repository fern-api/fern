...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/java-path-parameter-suffix)](https://central.sonatype.com/artifact/com.fern/java-path-parameter-suffix)
...
```groovy
dependencies {
  implementation 'com.fern:java-path-parameter-suffix:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>java-path-parameter-suffix</artifactId>
...
```java
SeedApiHttpResponse response = client.withRawResponse().fetchMessage(...);
