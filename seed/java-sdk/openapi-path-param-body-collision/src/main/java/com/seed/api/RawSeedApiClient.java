...
public class RawSeedApiClient {
    ...
    public SeedApiHttpResponse<UpdateProfileIdentifierResponse> updateProfileIdentifier(
            String profileId, String idTypePathParam, IdentifierUpdate request) {
        return updateProfileIdentifier(profileId, idTypePathParam, request, null);
    }
    ...
    public SeedApiHttpResponse<UpdateProfileIdentifierResponse> updateProfileIdentifier(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                ...
                .addPathSegments("Identifiers")
                .addPathSegment(idTypePathParam);
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SeedApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UpdateProfileIdentifierResponse.class),
                        response);
            }
