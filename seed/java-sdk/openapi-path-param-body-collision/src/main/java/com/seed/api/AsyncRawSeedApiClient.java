...
public class AsyncRawSeedApiClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<UpdateProfileIdentifierResponse>> updateProfileIdentifier(
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SeedApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, UpdateProfileIdentifierResponse.class),
                                response));
                        return;
                    }
