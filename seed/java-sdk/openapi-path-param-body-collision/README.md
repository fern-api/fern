...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/openapi-path-param-body-collision)](https://central.sonatype.com/artifact/com.fern/openapi-path-param-body-collision)
...
```groovy
dependencies {
  implementation 'com.fern:openapi-path-param-body-collision:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>openapi-path-param-body-collision</artifactId>
...
```java
SeedApiHttpResponse response = client.withRawResponse().updateProfileIdentifier(...);
