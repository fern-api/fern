...
public final class CreateRequest {
    ...
    private CreateRequest(double decimal, int even, String name, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder implements DecimalStage, EvenStage, NameStage, _FinalStage {
        ...
        public CreateRequest build() {
            return new CreateRequest(decimal, even, name, additionalProperties);
        }
    }
}
