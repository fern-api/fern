...
public class AsyncSeedValidationClientBuilder {
     ...
     */
    public AsyncSeedValidationClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedValidationClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedValidationClient build() {
        ...
        return new AsyncSeedValidationClient(buildClientOptions());
    }
}
