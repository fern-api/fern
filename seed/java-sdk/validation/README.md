...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/validation)](https://central.sonatype.com/artifact/com.fern/validation)
...
```groovy
dependencies {
  implementation 'com.fern:validation:0.0.1'
}
```
...
```java
SeedValidationHttpResponse response = client.withRawResponse().create(...);
