...
public class AsyncRawAbClient {
    protected final ClientOptions clientOptions;

    public AsyncRawAbClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> aBFoo() {
        return aBFoo(null);
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> aBFoo(RequestOptions requestOptions) {
