...
public class AsyncRawAcClient {
    protected final ClientOptions clientOptions;

    public AsyncRawAcClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> aCFoo() {
        return aCFoo(null);
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> aCFoo(RequestOptions requestOptions) {
