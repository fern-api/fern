 ...
 */
package com.seed.emptyClients.resources.level1.level2.types.types;
...
import com.seed.emptyClients.core.ObjectMappers;
...
public final class Person {
    ...
    private Person(String name, Address address, Map<String, Object> additionalProperties) {
        this.name = name;
    ...
    public static final class Builder implements NameStage, AddressStage, _FinalStage {
        ...
        @java.lang.Override
        public Person build() {
            return new Person(name, address, additionalProperties);
        }
    }
}
