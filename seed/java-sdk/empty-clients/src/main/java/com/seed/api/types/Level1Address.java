...
@JsonDeserialize(builder = Level1Address.Builder.class)
public final class Level1Address {
    ...
    public interface CountryStage {
        _FinalStage country(@NotNull Level1AddressCountry country);
    }
    ...
    public static final class Builder
        ...
        @java.lang.Override
        @JsonSetter("country")
        public _FinalStage country(@NotNull Level1AddressCountry country) {
        ...
        public Level1Address build() {
            return new Level1Address(line1, line2, city, state, zip, country, additionalProperties);
        }
