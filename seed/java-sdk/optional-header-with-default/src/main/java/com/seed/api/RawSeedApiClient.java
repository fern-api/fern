...
public class RawSeedApiClient {
    ...
    public SeedApiHttpResponse<List<Item>> listItems() {
        return listItems(null);
    }

    public SeedApiHttpResponse<List<Item>> listItems(RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SeedApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<Item>>() {}),
                        response);
            }
