...
public class AsyncSeedApiClientBuilder {
    ...
    /**
     * Sets requiredVersion
     */
    public AsyncSeedApiClientBuilder requiredVersion(String requiredVersion) {
    ...
    protected void setCustomHeaders(ClientOptions.Builder builder) {
        ...
        builder.addHeader("X-Required-Version", this.requiredVersion);
    }
    ...
    public AsyncSeedApiClient build() {
        if (requiredVersion == null) {
            throw new RuntimeException("Please provide requiredVersion");
        }
