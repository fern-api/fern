...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/openapi-subtitle)](https://central.sonatype.com/artifact/com.fern/openapi-subtitle)
...
```groovy
dependencies {
  implementation 'com.fern:openapi-subtitle:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>openapi-subtitle</artifactId>
...
```java
SeedApiHttpResponse response = client.withRawResponse().listPlants(...);
