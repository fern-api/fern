...
public class AsyncRawServiceClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<String>> gettext() {
        return gettext(null);
    }

    public CompletableFuture<SeedApiHttpResponse<String>> gettext(RequestOptions requestOptions) {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SeedApiHttpResponse<>(responseBodyString, response));
                        return;
                    }
