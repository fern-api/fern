...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/plain-text)](https://central.sonatype.com/artifact/com.fern/plain-text)
...
```groovy
dependencies {
  implementation 'com.fern:plain-text:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>plain-text</artifactId>
...
try{
    client.service().getText(...);
} catch (SeedPlainTextApiException e){
...
```java
SeedPlainTextHttpResponse response = client.service().withRawResponse().getText(...);
