...
@JsonDeserialize(builder = ServicePatchRequest.Builder.class)
public final class ServicePatchRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ServicePatchRequest && equalTo((ServicePatchRequest) other);
    }
    ...
    private boolean equalTo(ServicePatchRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ServicePatchRequest other) {
        ...
        public ServicePatchRequest build() {
            return new ServicePatchRequest(application, requireAuth, additionalProperties);
        }
