...
import com.seed.contentTypes.core.Environment;
import com.seed.contentTypes.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedContentTypesClientBuilder {
    ...
    public AsyncSeedContentTypesClientBuilder url(String url) {
     ...
     */
    public AsyncSeedContentTypesClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedContentTypesClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedContentTypesClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedContentTypesClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedContentTypesClient build() {
        validateConfiguration();
        return new AsyncSeedContentTypesClient(buildClientOptions());
    }
}
