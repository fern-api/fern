...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/content-type)](https://central.sonatype.com/artifact/com.fern/content-type)
...
```groovy
dependencies {
  implementation 'com.fern:content-type:0.0.1'
}
```
