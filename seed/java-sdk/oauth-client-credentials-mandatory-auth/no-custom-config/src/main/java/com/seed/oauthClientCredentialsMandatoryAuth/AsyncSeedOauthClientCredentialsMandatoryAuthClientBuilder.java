...
public class AsyncSeedOauthClientCredentialsMandatoryAuthClientBuilder {
     ...
     */
    public AsyncSeedOauthClientCredentialsMandatoryAuthClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedOauthClientCredentialsMandatoryAuthClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedOauthClientCredentialsMandatoryAuthClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedOauthClientCredentialsMandatoryAuthClientBuilder addHeader(String name, String value) {
    ...
    public static final class _CredentialsAuth extends AsyncSeedOauthClientCredentialsMandatoryAuthClientBuilder {
        ...
        public AsyncSeedOauthClientCredentialsMandatoryAuthClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new AsyncSeedOauthClientCredentialsMandatoryAuthClient(finalOptions);
        }
    }
