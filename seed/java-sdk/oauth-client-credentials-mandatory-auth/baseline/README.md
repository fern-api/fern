...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/oauth-client-credentials-mandatory-auth)](https://central.sonatype.com/artifact/com.fern/oauth-client-credentials-mandatory-auth)
...
```groovy
dependencies {
  implementation 'com.fern:oauth-client-credentials-mandatory-auth:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>oauth-client-credentials-mandatory-auth</artifactId>
...
```java
SeedOauthClientCredentialsMandatoryAuthHttpResponse response = client.auth().withRawResponse().getTokenWithClientCredentials(...);
