...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/java-oauth-token-required-enum-grant-type)](https://central.sonatype.com/artifact/com.fern/java-oauth-token-required-enum-grant-type)
...
```groovy
dependencies {
  implementation 'com.fern:java-oauth-token-required-enum-grant-type:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>java-oauth-token-required-enum-grant-type</artifactId>
...
```java
SeedApiHttpResponse response = client.authorization().withRawResponse().createToken(...);
