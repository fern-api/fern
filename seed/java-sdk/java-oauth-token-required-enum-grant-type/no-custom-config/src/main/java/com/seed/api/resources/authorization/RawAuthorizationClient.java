...
public class RawAuthorizationClient {
    protected final ClientOptions clientOptions;

    public RawAuthorizationClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public SeedApiHttpResponse<TokenResponse> createToken(TokenRequest request) {
        return createToken(request, null);
    }

    public SeedApiHttpResponse<TokenResponse> createToken(TokenRequest request, RequestOptions requestOptions) {
