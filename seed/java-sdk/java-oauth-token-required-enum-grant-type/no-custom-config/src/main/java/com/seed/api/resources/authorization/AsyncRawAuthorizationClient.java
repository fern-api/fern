...
public class AsyncRawAuthorizationClient {
    protected final ClientOptions clientOptions;

    public AsyncRawAuthorizationClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedApiHttpResponse<TokenResponse>> createToken(TokenRequest request) {
        return createToken(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<TokenResponse>> createToken(
