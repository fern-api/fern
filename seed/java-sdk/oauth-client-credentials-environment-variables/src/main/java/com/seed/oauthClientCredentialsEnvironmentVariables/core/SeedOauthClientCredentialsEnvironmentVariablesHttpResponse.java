...
public final class SeedOauthClientCredentialsEnvironmentVariablesHttpResponse<T> {

    private final T body;

    private final Map<String, List<String>> headers;

    public SeedOauthClientCredentialsEnvironmentVariablesHttpResponse(T body, Response rawResponse) {
        this.body = body;
