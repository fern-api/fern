...
public class AsyncRawAuthClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<TokenResponse>> gettokenwithclientcredentials(
    ...
    public CompletableFuture<SeedApiHttpResponse<TokenResponse>> refreshtoken(AuthRefreshTokenRequest request) {
        return refreshtoken(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<TokenResponse>> refreshtoken(
