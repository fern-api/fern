...
public class SeedOauthClientCredentialsEnvironmentVariablesClientBuilder {
     ...
     */
    public SeedOauthClientCredentialsEnvironmentVariablesClientBuilder logging(LogConfig logging) {
    ...
    public static final class _TokenAuth extends SeedOauthClientCredentialsEnvironmentVariablesClientBuilder {
    ...
    public static final class _CredentialsAuth extends SeedOauthClientCredentialsEnvironmentVariablesClientBuilder {
        ...
        public SeedOauthClientCredentialsEnvironmentVariablesClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new SeedOauthClientCredentialsEnvironmentVariablesClient(finalOptions);
        }
    }
