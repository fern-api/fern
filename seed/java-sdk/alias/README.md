...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/alias)](https://central.sonatype.com/artifact/com.fern/alias)
...
```groovy
dependencies {
  implementation 'com.fern:alias:0.0.1'
}
```
...
```java
SeedAliasHttpResponse response = client.withRawResponse().get(...);
