 ...
 */
public class SeedAliasApiException extends SeedAliasException {
    /**
    ...
    public SeedAliasApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public SeedAliasApiException(String message, int statusCode, Object body, Response rawResponse) {
        super(message);
        this.statusCode = statusCode;
        this.body = body;
        this.headers = new HashMap<>();
