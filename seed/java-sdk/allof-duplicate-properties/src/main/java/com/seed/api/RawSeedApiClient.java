...
public class RawSeedApiClient {
     ...
     */
    public SeedApiHttpResponse<PlantOrder> createPlantOrder(String plantId, CreatePlantOrderRequest request) {
        return createPlantOrder(plantId, request, null);
    }

    /**
     * Creates an order for a plant.
     */
    public SeedApiHttpResponse<PlantOrder> createPlantOrder(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SeedApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PlantOrder.class), response);
            }
