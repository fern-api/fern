...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/allof-duplicate-properties)](https://central.sonatype.com/artifact/com.fern/allof-duplicate-properties)
...
```groovy
dependencies {
  implementation 'com.fern:allof-duplicate-properties'
}
```
...
<dependency>
  ...
  <artifactId>allof-duplicate-properties</artifactId>
...
```java
CreatePlantOrderHttpResponse response = client.withRawResponse().createPlantOrder(...);
