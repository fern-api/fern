...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/simple-fhir)](https://central.sonatype.com/artifact/com.fern/simple-fhir)
...
<dependency>
  ...
  <artifactId>simple-fhir</artifactId>
...
```java
SeedApiHttpResponse response = client.withRawResponse().getAccount(...);
