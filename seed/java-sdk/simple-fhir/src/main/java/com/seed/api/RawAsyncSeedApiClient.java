...
public class RawAsyncSeedApiClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<Account>> getAccount(String accountId) {
        return getAccount(accountId, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Account>> getAccount(String accountId, RequestOptions requestOptions) {
