...
public class RawSeedApiClient {
    ...
    public SeedApiHttpResponse<Account> getAccount(String accountId) {
        return getAccount(accountId, null);
    }

    public SeedApiHttpResponse<Account> getAccount(String accountId, RequestOptions requestOptions) {
