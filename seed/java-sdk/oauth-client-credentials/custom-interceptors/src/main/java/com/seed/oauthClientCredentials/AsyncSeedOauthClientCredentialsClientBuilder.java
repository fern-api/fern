...
public class AsyncSeedOauthClientCredentialsClientBuilder {
     ...
     */
    public AsyncSeedOauthClientCredentialsClientBuilder addInterceptor(Interceptor interceptor) {
    ...
    public static final class _Builder {
         ...
         */
        public _Builder addInterceptor(Interceptor interceptor) {
            this.interceptors.add(interceptor);
            return this;
        }
        ...
        public _TokenAuth token(String token) {
            ...
            for (Interceptor interceptor : this.interceptors) {
                auth.addInterceptor(interceptor);
            }
            return auth;
        }
