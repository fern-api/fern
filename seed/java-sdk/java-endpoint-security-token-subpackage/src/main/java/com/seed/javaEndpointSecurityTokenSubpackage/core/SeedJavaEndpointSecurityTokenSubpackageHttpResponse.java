...
public final class SeedJavaEndpointSecurityTokenSubpackageHttpResponse<T> {

    private final T body;

    private final Map<String, List<String>> headers;

    public SeedJavaEndpointSecurityTokenSubpackageHttpResponse(T body, Response rawResponse) {
        this.body = body;
