...
public class SeedJavaEndpointSecurityTokenSubpackageClientBuilder {
     ...
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder token(String token) {
        this.token = token;
        return this;
    }
     ...
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder clientId(String clientId) {
     ...
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder clientSecret(String clientSecret) {
     ...
     * Sets state
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder state(Optional<String> state) {
        this.state = state;
        return this;
    }
     ...
     * Sets state
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder state(String state) {
     ...
     * Sets permissions
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder permissions(Optional<List<String>> permissions) {
    ...
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder url(String url) {
     ...
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder timeout(int timeout) {
     ...
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder logging(LogConfig logging) {
     ...
     * @return This builder for method chaining
     */
    public SeedJavaEndpointSecurityTokenSubpackageClientBuilder addHeader(String name, String value) {
    ...
    public SeedJavaEndpointSecurityTokenSubpackageClient build() {
        validateConfiguration();
        return new SeedJavaEndpointSecurityTokenSubpackageClient(buildClientOptions());
    }
}
