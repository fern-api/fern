...
public class AsyncRawUserClient {
    ...
    public CompletableFuture<SeedJavaEndpointSecurityTokenSubpackageHttpResponse<List<User>>> getWithOAuth() {
    ...
    public CompletableFuture<SeedJavaEndpointSecurityTokenSubpackageHttpResponse<List<User>>> getWithApiKeyOrOAuth() {
