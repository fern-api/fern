...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/streaming-parameter)](https://central.sonatype.com/artifact/com.fern/streaming-parameter)
...
```groovy
dependencies {
  implementation 'com.fern:streaming-parameter:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>streaming-parameter</artifactId>
...
```java
SeedStreamingHttpResponse response = client.dummy().withRawResponse().generate(...);
