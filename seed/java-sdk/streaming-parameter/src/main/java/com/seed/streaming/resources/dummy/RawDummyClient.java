...
public class RawDummyClient {
    ...
    public SeedStreamingHttpResponse<Iterable<StreamResponse>> generate(GenerateRequest request) {
        return generate(request, null);
    }

    public SeedStreamingHttpResponse<Iterable<StreamResponse>> generate(
