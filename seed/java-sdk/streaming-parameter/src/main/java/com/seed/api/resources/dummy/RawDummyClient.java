...
public class RawDummyClient {
    ...
    public SeedApiHttpResponse<Void> generate(DummyGenerateRequest request) {
        return generate(request, null);
    }

    public SeedApiHttpResponse<Void> generate(DummyGenerateRequest request, RequestOptions requestOptions) {
