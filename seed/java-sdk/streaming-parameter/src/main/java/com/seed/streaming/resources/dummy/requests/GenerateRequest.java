...
public final class GenerateRequest {
    ...
    private GenerateRequest(boolean stream, int numEvents, Map<String, Object> additionalProperties) {
        this.stream = stream;
    ...
    public static final class Builder implements StreamStage, NumEventsStage, _FinalStage {
        ...
        public GenerateRequest build() {
            return new GenerateRequest(stream, numEvents, additionalProperties);
        }
