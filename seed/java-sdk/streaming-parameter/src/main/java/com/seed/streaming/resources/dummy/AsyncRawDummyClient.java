...
public class AsyncRawDummyClient {
    ...
    public CompletableFuture<SeedStreamingHttpResponse<Iterable<StreamResponse>>> generate(GenerateRequest request) {
        return generate(request, null);
    }

    public CompletableFuture<SeedStreamingHttpResponse<Iterable<StreamResponse>>> generate(
