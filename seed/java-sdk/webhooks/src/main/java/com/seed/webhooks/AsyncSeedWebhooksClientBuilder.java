...
import com.seed.webhooks.core.Environment;
import com.seed.webhooks.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedWebhooksClientBuilder {
    ...
    public AsyncSeedWebhooksClientBuilder url(String url) {
     ...
     */
    public AsyncSeedWebhooksClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedWebhooksClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedWebhooksClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedWebhooksClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedWebhooksClient build() {
        validateConfiguration();
        return new AsyncSeedWebhooksClient(buildClientOptions());
    }
}
