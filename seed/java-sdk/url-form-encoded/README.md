...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/url-form-encoded)](https://central.sonatype.com/artifact/com.fern/url-form-encoded)
...
```groovy
dependencies {
  implementation 'com.fern:url-form-encoded:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>url-form-encoded</artifactId>
