...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/path-parameters)](https://central.sonatype.com/artifact/com.fern/path-parameters)
...
```groovy
dependencies {
  implementation 'com.fern:path-parameters:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>path-parameters</artifactId>
