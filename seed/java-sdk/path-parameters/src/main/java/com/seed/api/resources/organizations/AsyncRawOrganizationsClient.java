...
public class AsyncRawOrganizationsClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<User>> getorganizationuser(
            String tenantId, String organizationId, String userId) {
    ...
    public CompletableFuture<SeedApiHttpResponse<List<Organization>>> searchorganizations(
            String tenantId, String organizationId) {
    ...
    public CompletableFuture<SeedApiHttpResponse<List<Organization>>> searchorganizations(
        ...
        CompletableFuture<SeedApiHttpResponse<List<Organization>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
