...
import com.seed.dollarStringExamples.core.Environment;
import com.seed.dollarStringExamples.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedDollarStringExamplesClientBuilder {
    ...
    public AsyncSeedDollarStringExamplesClientBuilder url(String url) {
     ...
     */
    public AsyncSeedDollarStringExamplesClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedDollarStringExamplesClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedDollarStringExamplesClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedDollarStringExamplesClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedDollarStringExamplesClient build() {
        validateConfiguration();
        return new AsyncSeedDollarStringExamplesClient(buildClientOptions());
    }
}
