...
import com.seed.websocketMultiUrl.core.Environment;
import com.seed.websocketMultiUrl.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedWebsocketMultiUrlClientBuilder {
     ...
     * Sets token
     */
    public SeedWebsocketMultiUrlClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public SeedWebsocketMultiUrlClientBuilder environment(Environment environment) {
     ...
     */
    public SeedWebsocketMultiUrlClientBuilder timeout(int timeout) {
     ...
     */
    public SeedWebsocketMultiUrlClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedWebsocketMultiUrlClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedWebsocketMultiUrlClientBuilder addHeader(String name, String value) {
    ...
    public SeedWebsocketMultiUrlClient build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new SeedWebsocketMultiUrlClient(buildClientOptions());
    }
}
