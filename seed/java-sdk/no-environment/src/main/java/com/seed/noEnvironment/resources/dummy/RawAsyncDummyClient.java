...
public class RawAsyncDummyClient {
    ...
    public CompletableFuture<SeedNoEnvironmentHttpResponse<String>> getDummy() {
        return getDummy(null);
    }

    public CompletableFuture<SeedNoEnvironmentHttpResponse<String>> getDummy(RequestOptions requestOptions) {
        ...
        CompletableFuture<SeedNoEnvironmentHttpResponse<String>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new SeedNoEnvironmentHttpResponse<>(
