...
public class RawDummyClient {
    ...
    public SeedNoEnvironmentHttpResponse<String> getDummy() {
        return getDummy(null);
    }

    public SeedNoEnvironmentHttpResponse<String> getDummy(RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SeedNoEnvironmentHttpResponse<>(
