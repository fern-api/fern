...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/no-environment)](https://central.sonatype.com/artifact/com.fern/no-environment)
...
<dependency>
  ...
  <artifactId>no-environment</artifactId>
...
```java
SeedNoEnvironmentHttpResponse response = client.dummy().withRawResponse().getDummy(...);
