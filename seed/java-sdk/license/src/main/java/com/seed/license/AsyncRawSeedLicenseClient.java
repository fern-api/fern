...
public class AsyncRawSeedLicenseClient {
    protected final ClientOptions clientOptions;

    public AsyncRawSeedLicenseClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedLicenseHttpResponse<Void>> get() {
        return get(null);
    }

    public CompletableFuture<SeedLicenseHttpResponse<Void>> get(RequestOptions requestOptions) {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new SeedLicenseHttpResponse<>(null, response));
                        return;
                    }
