...
import com.seed.license.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedLicenseClientBuilder {
    ...
    public AsyncSeedLicenseClientBuilder url(String url) {
     ...
     */
    public AsyncSeedLicenseClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedLicenseClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedLicenseClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedLicenseClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedLicenseClient build() {
        validateConfiguration();
        return new AsyncSeedLicenseClient(buildClientOptions());
    }
}
