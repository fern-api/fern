...
public class RawAuthClient {
    ...
    public SeedOauthClientCredentialsDefaultHttpResponse<TokenResponse> getToken(GetTokenRequest request) {
        return getToken(request, null);
    }

    public SeedOauthClientCredentialsDefaultHttpResponse<TokenResponse> getToken(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SeedOauthClientCredentialsDefaultHttpResponse<>(
