...
public class SeedOauthClientCredentialsDefaultClientBuilder {
     ...
     */
    public SeedOauthClientCredentialsDefaultClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedOauthClientCredentialsDefaultClientBuilder addHeader(String name, String value) {
    ...
    public static final class _CredentialsAuth extends SeedOauthClientCredentialsDefaultClientBuilder {
        ...
        public SeedOauthClientCredentialsDefaultClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new SeedOauthClientCredentialsDefaultClient(finalOptions);
        }
    }
