...
public class RawAuthClient {
    ...
    public SeedApiHttpResponse<TokenResponse> gettoken(AuthGetTokenRequest request) {
        return gettoken(request, null);
    }

    public SeedApiHttpResponse<TokenResponse> gettoken(AuthGetTokenRequest request, RequestOptions requestOptions) {
