...
import com.seed.apiWideBasePath.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedApiWideBasePathClientBuilder {
     ...
     */
    public AsyncSeedApiWideBasePathClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedApiWideBasePathClientBuilder addHeader(String name, String value) {
        this.customHeaders.put(name, value);
        return this;
    }

    public AsyncSeedApiWideBasePathClientBuilder pathParam(String pathParam) {
    ...
    public AsyncSeedApiWideBasePathClient build() {
        ...
        return new AsyncSeedApiWideBasePathClient(buildClientOptions());
    }
}
