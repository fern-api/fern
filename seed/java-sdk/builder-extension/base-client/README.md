...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/builder-extension)](https://central.sonatype.com/artifact/com.fern/builder-extension)
...
```groovy
dependencies {
  implementation 'com.fern:builder-extension'
}
```
...
<dependency>
  ...
  <artifactId>builder-extension</artifactId>
