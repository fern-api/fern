...
public class AsyncRawNullableClient {
    protected final ClientOptions clientOptions;

    public AsyncRawNullableClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedNullableHttpResponse<List<User>>> getUsers() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new SeedNullableHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), new TypeReference<List<User>>() {}),
                                response));
                        return;
                    }
    ...
    public CompletableFuture<SeedNullableHttpResponse<User>> createUser(CreateUserRequest request) {
