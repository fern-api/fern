...
public class RawNullableClient {
    ...
    public SeedApiHttpResponse<List<User>> getusers() {
        return getusers(NullableGetUsersRequest.builder().build());
    }

    public SeedApiHttpResponse<List<User>> getusers(RequestOptions requestOptions) {
        return getusers(NullableGetUsersRequest.builder().build(), requestOptions);
    }

    public SeedApiHttpResponse<List<User>> getusers(NullableGetUsersRequest request) {
        return getusers(request, null);
    }

    public SeedApiHttpResponse<List<User>> getusers(NullableGetUsersRequest request, RequestOptions requestOptions) {
    ...
    public SeedApiHttpResponse<User> createuser(NullableCreateUserRequest request) {
        return createuser(request, null);
    }

    public SeedApiHttpResponse<User> createuser(NullableCreateUserRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("users");
        if (requestOptions != null) {
    ...
    public SeedApiHttpResponse<Boolean> deleteuser() {
        return deleteuser(NullableDeleteUserRequest.builder().build());
    }

    public SeedApiHttpResponse<Boolean> deleteuser(RequestOptions requestOptions) {
        return deleteuser(NullableDeleteUserRequest.builder().build(), requestOptions);
    }

    public SeedApiHttpResponse<Boolean> deleteuser(NullableDeleteUserRequest request) {
        return deleteuser(request, null);
    }

    public SeedApiHttpResponse<Boolean> deleteuser(NullableDeleteUserRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("users");
        if (requestOptions != null) {
