...
@JsonDeserialize(builder = NullableGetUsersRequest.Builder.class)
public final class NullableGetUsersRequest {
    ...
    private NullableGetUsersRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof NullableGetUsersRequest && equalTo((NullableGetUsersRequest) other);
    }
    ...
    private boolean equalTo(NullableGetUsersRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(NullableGetUsersRequest other) {
        ...
        public Builder usernames(Nullable<List<String>> usernames) {
            if (usernames.isNull()) {
                ...
                this.usernames = Optional.empty();
            } else {
                this.usernames = Optional.of(usernames.get());
            }
            return this;
        }
        ...
        public Builder activated(Nullable<List<Boolean>> activated) {
            if (activated.isNull()) {
                this.activated = null;
        ...
        public NullableGetUsersRequest build() {
            return new NullableGetUsersRequest(usernames, activated, tags, avatar, extra, additionalProperties);
        }
