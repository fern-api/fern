...
public final class Metadata {
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("values")
    private Optional<Map<String, Optional<String>>> _getValues() {
        return values;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage values(Nullable<Map<String, Optional<String>>> values);
    }
    ...
    public static final class Builder implements CreatedAtStage, UpdatedAtStage, StatusStage, _FinalStage {
        ...
        @java.lang.Override
        public _FinalStage values(Nullable<Map<String, Optional<String>>> values) {
            if (values.isNull()) {
                this.values = null;
