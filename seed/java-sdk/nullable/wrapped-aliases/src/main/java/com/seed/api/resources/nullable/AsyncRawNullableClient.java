...
public class AsyncRawNullableClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<List<User>>> getusers(NullableGetUsersRequest request) {
        return getusers(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<List<User>>> getusers(
            NullableGetUsersRequest request, RequestOptions requestOptions) {
    ...
    public CompletableFuture<SeedApiHttpResponse<User>> createuser(NullableCreateUserRequest request) {
        return createuser(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<User>> createuser(
            NullableCreateUserRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("users");
        if (requestOptions != null) {
    ...
    public CompletableFuture<SeedApiHttpResponse<Boolean>> deleteuser() {
        return deleteuser(NullableDeleteUserRequest.builder().build());
    }

    public CompletableFuture<SeedApiHttpResponse<Boolean>> deleteuser(RequestOptions requestOptions) {
        return deleteuser(NullableDeleteUserRequest.builder().build(), requestOptions);
    }

    public CompletableFuture<SeedApiHttpResponse<Boolean>> deleteuser(NullableDeleteUserRequest request) {
        return deleteuser(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Boolean>> deleteuser(
            NullableDeleteUserRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("users");
        if (requestOptions != null) {
