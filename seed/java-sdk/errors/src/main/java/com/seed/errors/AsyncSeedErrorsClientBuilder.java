...
import com.seed.errors.core.Environment;
import com.seed.errors.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedErrorsClientBuilder {
    ...
    public AsyncSeedErrorsClientBuilder url(String url) {
     ...
     */
    public AsyncSeedErrorsClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedErrorsClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedErrorsClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedErrorsClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedErrorsClient build() {
        validateConfiguration();
        return new AsyncSeedErrorsClient(buildClientOptions());
    }
}
