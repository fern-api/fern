...
public class SeedErrorsClientBuilder {
    ...
    public SeedErrorsClientBuilder url(String url) {
     ...
     */
    public SeedErrorsClientBuilder timeout(int timeout) {
     ...
     */
    public SeedErrorsClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedErrorsClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedErrorsClientBuilder addHeader(String name, String value) {
    ...
    public SeedErrorsClient build() {
        validateConfiguration();
        return new SeedErrorsClient(buildClientOptions());
    }
}
