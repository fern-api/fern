...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/errors)](https://central.sonatype.com/artifact/com.fern/errors)
...
```java
SeedErrorsHttpResponse response = client.simple().withRawResponse().fooWithoutEndpointError(...);
