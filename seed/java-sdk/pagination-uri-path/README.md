...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/pagination-uri-path)](https://central.sonatype.com/artifact/com.fern/pagination-uri-path)
...
<dependency>
  ...
  <artifactId>pagination-uri-path</artifactId>
...
```java
ListWithUriPaginationHttpResponse response = client.users().withRawResponse().listWithUriPagination(...);
