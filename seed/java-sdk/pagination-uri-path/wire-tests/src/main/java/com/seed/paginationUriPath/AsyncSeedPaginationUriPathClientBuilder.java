...
import com.seed.paginationUriPath.core.Environment;
import com.seed.paginationUriPath.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedPaginationUriPathClientBuilder {
     ...
     * Sets token
     */
    public AsyncSeedPaginationUriPathClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public AsyncSeedPaginationUriPathClientBuilder url(String url) {
     ...
     */
    public AsyncSeedPaginationUriPathClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedPaginationUriPathClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedPaginationUriPathClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedPaginationUriPathClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedPaginationUriPathClient build() {
        validateConfiguration();
        return new AsyncSeedPaginationUriPathClient(buildClientOptions());
    }
}
