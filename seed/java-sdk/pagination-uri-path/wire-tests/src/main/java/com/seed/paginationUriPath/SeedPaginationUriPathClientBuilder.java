...
public class SeedPaginationUriPathClientBuilder {
     ...
     * Sets token
     */
    public SeedPaginationUriPathClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public SeedPaginationUriPathClientBuilder url(String url) {
     ...
     */
    public SeedPaginationUriPathClientBuilder timeout(int timeout) {
     ...
     */
    public SeedPaginationUriPathClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedPaginationUriPathClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedPaginationUriPathClientBuilder addHeader(String name, String value) {
    ...
    public SeedPaginationUriPathClient build() {
        validateConfiguration();
        return new SeedPaginationUriPathClient(buildClientOptions());
    }
}
