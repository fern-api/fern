...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/file-download)](https://central.sonatype.com/artifact/com.fern/file-download)
...
```groovy
dependencies {
  implementation 'com.fern:file-download:0.0.1'
}
```
...
```java
SeedFileDownloadHttpResponse response = client.service().withRawResponse().simple(...);
