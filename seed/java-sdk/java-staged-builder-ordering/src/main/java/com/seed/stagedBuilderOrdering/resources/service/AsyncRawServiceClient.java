...
public class AsyncRawServiceClient {
    ...
    public CompletableFuture<SeedStagedBuilderOrderingHttpResponse<String>> createSimple(SimpleStaged request) {
        return createSimple(request, null);
    }

    public CompletableFuture<SeedStagedBuilderOrderingHttpResponse<String>> createSimple(
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SeedStagedBuilderOrderingHttpResponse<>(
    ...
    public CompletableFuture<SeedStagedBuilderOrderingHttpResponse<String>> createMedium(MediumStaged request) {
        return createMedium(request, null);
    }

    public CompletableFuture<SeedStagedBuilderOrderingHttpResponse<String>> createMedium(
    ...
    public CompletableFuture<SeedStagedBuilderOrderingHttpResponse<String>> createComplex(ComplexStaged request) {
        return createComplex(request, null);
    }

    public CompletableFuture<SeedStagedBuilderOrderingHttpResponse<String>> createComplex(
    ...
    public CompletableFuture<SeedStagedBuilderOrderingHttpResponse<String>> createMixed(MixedStaged request) {
        return createMixed(request, null);
    }

    public CompletableFuture<SeedStagedBuilderOrderingHttpResponse<String>> createMixed(
    ...
    public CompletableFuture<SeedStagedBuilderOrderingHttpResponse<String>> createParent(Parent request) {
        return createParent(request, null);
    }

    public CompletableFuture<SeedStagedBuilderOrderingHttpResponse<String>> createParent(
            Parent request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("staged-builder")
