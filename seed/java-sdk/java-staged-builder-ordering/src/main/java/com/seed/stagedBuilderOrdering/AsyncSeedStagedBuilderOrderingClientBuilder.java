...
import com.seed.stagedBuilderOrdering.core.Environment;
import com.seed.stagedBuilderOrdering.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedStagedBuilderOrderingClientBuilder {
    ...
    public AsyncSeedStagedBuilderOrderingClientBuilder url(String url) {
     ...
     */
    public AsyncSeedStagedBuilderOrderingClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedStagedBuilderOrderingClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedStagedBuilderOrderingClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedStagedBuilderOrderingClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedStagedBuilderOrderingClient build() {
        validateConfiguration();
        return new AsyncSeedStagedBuilderOrderingClient(buildClientOptions());
    }
}
