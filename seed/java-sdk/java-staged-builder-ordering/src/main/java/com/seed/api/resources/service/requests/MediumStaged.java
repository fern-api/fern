...
@JsonDeserialize(builder = MediumStaged.Builder.class)
public final class MediumStaged {
    ...
    private Optional<String> _getOptional() {
        return optional;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage optional(Nullable<String> optional);
    }
    ...
    public static final class Builder implements AlphaStage, BetaStage, GammaStage, DeltaStage, _FinalStage {
        ...
        @java.lang.Override
        public _FinalStage optional(Nullable<String> optional) {
            if (optional.isNull()) {
                this.optional = null;
