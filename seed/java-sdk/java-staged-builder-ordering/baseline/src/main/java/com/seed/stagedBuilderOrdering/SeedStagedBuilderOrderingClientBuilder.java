...
public class SeedStagedBuilderOrderingClientBuilder {
    ...
    public SeedStagedBuilderOrderingClientBuilder url(String url) {
     ...
     */
    public SeedStagedBuilderOrderingClientBuilder timeout(int timeout) {
     ...
     */
    public SeedStagedBuilderOrderingClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedStagedBuilderOrderingClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedStagedBuilderOrderingClientBuilder addHeader(String name, String value) {
    ...
    public SeedStagedBuilderOrderingClient build() {
        validateConfiguration();
        return new SeedStagedBuilderOrderingClient(buildClientOptions());
    }
}
