 ...
 */
package com.seed._extends.requests;
...
import com.seed._extends.types.IDocs;
import com.seed._extends.types.IExampleType;
...
public final class Inlined implements IExampleType, IDocs {
    ...
    private Inlined(String name, String docs, String unique, Map<String, Object> additionalProperties) {
        this.name = name;
        this.docs = docs;
        this.unique = unique;
