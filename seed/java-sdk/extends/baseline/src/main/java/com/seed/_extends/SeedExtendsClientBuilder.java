...
public class SeedExtendsClientBuilder {
     ...
     */
    public SeedExtendsClientBuilder timeout(int timeout) {
     ...
     */
    public SeedExtendsClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedExtendsClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedExtendsClientBuilder addHeader(String name, String value) {
    ...
    public SeedExtendsClient build() {
        ...
        return new SeedExtendsClient(buildClientOptions());
    }
}
