...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/query-param-name-conflict)](https://central.sonatype.com/artifact/com.fern/query-param-name-conflict)
...
<dependency>
  ...
  <artifactId>query-param-name-conflict</artifactId>
...
```java
SeedApiHttpResponse response = client.withRawResponse().bulkUpdateTasks(...);
