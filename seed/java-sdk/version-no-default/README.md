...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/version-no-default)](https://central.sonatype.com/artifact/com.fern/version-no-default)
...
```groovy
dependencies {
  implementation 'com.fern:version-no-default:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>version-no-default</artifactId>
