...
public class AsyncDummyClient {
    ...
    public CompletableFuture<Iterable<StreamResponse>> generateStream(
        ...
        CompletableFuture<Iterable<StreamResponse>> future = new CompletableFuture<>();
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new Stream<StreamResponse>(
    ...
    public CompletableFuture<StreamResponse> generate(Generateequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<StreamResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), StreamResponse.class));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    future.completeExceptionally(new SeedStreamingApiException(
