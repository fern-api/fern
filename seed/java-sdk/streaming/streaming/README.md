...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/streaming)](https://central.sonatype.com/artifact/com.fern/streaming)
...
```groovy
dependencies {
  implementation 'com.fern:streaming:0.0.1'
}
```
