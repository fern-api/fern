...
import com.seed.streaming.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedStreamingClientBuilder {
     ...
     */
    public AsyncSeedStreamingClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedStreamingClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedStreamingClient build() {
        ...
        return new AsyncSeedStreamingClient(buildClientOptions());
    }
}
