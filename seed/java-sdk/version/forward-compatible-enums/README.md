...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/version)](https://central.sonatype.com/artifact/com.fern/version)
...
```groovy
dependencies {
  implementation 'com.fern:version:0.0.1'
}
```
...
```java
SeedVersionHttpResponse response = client.user().withRawResponse().getUser(...);
