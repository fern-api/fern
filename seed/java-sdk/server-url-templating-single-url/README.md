...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/server-url-templating-single-url)](https://central.sonatype.com/artifact/com.fern/server-url-templating-single-url)
...
```groovy
dependencies {
  implementation 'com.fern:server-url-templating-single-url:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>server-url-templating-single-url</artifactId>
...
```java
SeedApiHttpResponse response = client.withRawResponse().getUsers(...);
