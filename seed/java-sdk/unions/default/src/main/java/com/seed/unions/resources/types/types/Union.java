...
public final class Union {
    ...
    public static Union foo(Foo foo) {
        return new Union(new FooValue(foo));
    }

    public static Union bar(Bar bar) {
        return new Union(new BarValue(bar));
    }
