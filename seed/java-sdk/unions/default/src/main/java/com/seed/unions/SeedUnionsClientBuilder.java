...
import com.seed.unions.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedUnionsClientBuilder {
     ...
     */
    public SeedUnionsClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedUnionsClientBuilder addHeader(String name, String value) {
    ...
    public SeedUnionsClient build() {
        ...
        return new SeedUnionsClient(buildClientOptions());
    }
}
