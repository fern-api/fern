...
public class AsyncRawWidgetsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawWidgetsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<SeedApiHttpResponse<Widget>> create(Widget request) {
        return create(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Widget>> create(Widget request, RequestOptions requestOptions) {
