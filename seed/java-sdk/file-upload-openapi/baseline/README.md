...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/file-upload-openapi)](https://central.sonatype.com/artifact/com.fern/file-upload-openapi)
...
<dependency>
  ...
  <artifactId>file-upload-openapi</artifactId>
...
```java
SeedApiHttpResponse response = client.fileUploadExample().withRawResponse().uploadFile(...);
