...
public class AsyncRawFileUploadExampleClient {
     ...
     */
    public CompletableFuture<SeedApiHttpResponse<String>> uploadFile(File file, UploadFileRequest request) {
    ...
    public CompletableFuture<SeedApiHttpResponse<String>> uploadFile(
            File file, UploadFileRequest request, RequestOptions requestOptions) {
