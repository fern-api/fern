...
import com.seed.literalsUnions.core.Environment;
import com.seed.literalsUnions.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedLiteralsUnionsClientBuilder {
    ...
    public AsyncSeedLiteralsUnionsClientBuilder url(String url) {
     ...
     */
    public AsyncSeedLiteralsUnionsClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedLiteralsUnionsClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedLiteralsUnionsClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedLiteralsUnionsClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedLiteralsUnionsClient build() {
        validateConfiguration();
        return new AsyncSeedLiteralsUnionsClient(buildClientOptions());
    }
}
