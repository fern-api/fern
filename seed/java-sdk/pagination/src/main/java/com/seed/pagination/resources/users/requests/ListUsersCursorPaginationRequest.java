...
@JsonDeserialize(
    builder = ListUsersCursorPaginationRequest.Builder.class
)
public final class ListUsersCursorPaginationRequest {
  ...
  private ListUsersCursorPaginationRequest(Optional<Integer> page, Optional<Integer> perPage,
      Optional<Order> order, Optional<String> startingAfter,
  ...
  private boolean equalTo(ListUsersCursorPaginationRequest other) {
    return page.equals(other.page) && perPage.equals(other.perPage) && order.equals(other.order) && startingAfter.equals(other.startingAfter);
  }
