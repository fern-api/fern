...
public final class UserPage implements IUserPage {
    ...
    private UserPage(UserListContainer data, Optional<UUID> next, Map<String, Object> additionalProperties) {
        this.data = data;
        this.next = next;
    ...
    public interface DataStage {
        _FinalStage data(@NotNull UserListContainer data);
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull UserListContainer data) {
