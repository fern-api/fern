 ...
 */
package com.seed.pagination.resources.longpath.types;
...
public final class Response {
    ...
    private Response(Optional<String> startingAfter, List<String> results, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder {
        ...
        public Response build() {
            return new Response(startingAfter, results, additionalProperties);
        }
    }
}
