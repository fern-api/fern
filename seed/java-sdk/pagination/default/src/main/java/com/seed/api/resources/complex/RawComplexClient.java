...
public class RawComplexClient {
    ...
    public SeedApiHttpResponse<PaginatedConversationResponse> search(String index, SearchRequest request) {
        return search(index, request, null);
    }

    public SeedApiHttpResponse<PaginatedConversationResponse> search(
