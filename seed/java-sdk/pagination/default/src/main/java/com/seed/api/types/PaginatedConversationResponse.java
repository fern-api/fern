...
public final class PaginatedConversationResponse {
    ...
    private PaginatedConversationResponse(
            ...
            int totalCount,
            PaginatedConversationResponseType type,
    ...
    private boolean equalTo(PaginatedConversationResponse other) {
        return conversations.equals(other.conversations)
    ...
    public interface TypeStage {
        _FinalStage type(@NotNull PaginatedConversationResponseType type);
    }
    ...
    public static final class Builder implements TotalCountStage, TypeStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("type")
        public _FinalStage type(@NotNull PaginatedConversationResponseType type) {
        ...
        public PaginatedConversationResponse build() {
            return new PaginatedConversationResponse(conversations, pages, totalCount, type, additionalProperties);
        }
