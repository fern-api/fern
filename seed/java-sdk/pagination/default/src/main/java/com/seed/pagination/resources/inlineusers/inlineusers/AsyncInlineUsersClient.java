...
public class AsyncInlineUsersClient {
    ...
    private final AsyncRawInlineUsersClient rawClient;

    public AsyncInlineUsersClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
        this.rawClient = new AsyncRawInlineUsersClient(clientOptions);
    }

    /**
     * Get responses with HTTP metadata like headers
     */
    public AsyncRawInlineUsersClient withRawResponse() {
