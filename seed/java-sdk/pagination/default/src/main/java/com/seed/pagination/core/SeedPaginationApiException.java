 ...
 */
public class SeedPaginationApiException extends SeedPaginationException {
    /**
    ...
    public SeedPaginationApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public SeedPaginationApiException(String message, int statusCode, Object body, Response rawResponse) {
        super(message);
        this.statusCode = statusCode;
        this.body = body;
        this.headers = new HashMap<>();
