...
public class AsyncRawComplexClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<PaginatedConversationResponse>> search(
    ...
    public CompletableFuture<SeedApiHttpResponse<PaginatedConversationResponse>> search(
        ...
        CompletableFuture<SeedApiHttpResponse<PaginatedConversationResponse>> future = new CompletableFuture<>();
