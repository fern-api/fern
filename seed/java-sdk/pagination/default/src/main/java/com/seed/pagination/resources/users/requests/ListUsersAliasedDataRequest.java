...
@JsonDeserialize(builder = ListUsersAliasedDataRequest.Builder.class)
public final class ListUsersAliasedDataRequest {
    ...
    private ListUsersAliasedDataRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListUsersAliasedDataRequest && equalTo((ListUsersAliasedDataRequest) other);
    }
    ...
    private boolean equalTo(ListUsersAliasedDataRequest other) {
        return page.equals(other.page) && perPage.equals(other.perPage) && startingAfter.equals(other.startingAfter);
    }

    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.page, this.perPage, this.startingAfter);
    }
    ...
    public static final class Builder {
        ...
        public Builder from(ListUsersAliasedDataRequest other) {
            page(other.getPage());
        ...
        public ListUsersAliasedDataRequest build() {
            return new ListUsersAliasedDataRequest(page, perPage, startingAfter, additionalProperties);
        }
