...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/single-url-environment-no-default)](https://central.sonatype.com/artifact/com.fern/single-url-environment-no-default)
...
```groovy
dependencies {
  implementation 'com.fern:single-url-environment-no-default:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>single-url-environment-no-default</artifactId>
...
```java
SeedSingleUrlEnvironmentNoDefaultHttpResponse response = client.dummy().withRawResponse().getDummy(...);
