...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/allof-inline)](https://central.sonatype.com/artifact/com.fern/allof-inline)
...
```groovy
dependencies {
  implementation 'com.fern:allof-inline:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>allof-inline</artifactId>
...
```java
SeedApiHttpResponse response = client.withRawResponse().createRule(...);
