...
public final class ContainerValue {
    ...
    public static ContainerValue list(ContainerValueList value) {
        return new ContainerValue(new ListValue(value));
    }

    public static ContainerValue optional(ContainerValueOptional value) {
    ...
    public Optional<ContainerValueList> getList() {
        if (isList()) {
    ...
    public Optional<ContainerValueOptional> getOptional() {
        if (isOptional()) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ContainerValue && value.equals(((ContainerValue) other).value);
    }
    ...
    public interface Visitor<T> {
        T visitList(ContainerValueList list);

        T visitOptional(ContainerValueOptional optional);
    ...
    private static final class ListValue implements Value {
        ...
        private ContainerValueList value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private ListValue() {}

        private ListValue(ContainerValueList value) {
            this.value = value;
        }
    ...
    private static final class OptionalValue implements Value {
        @JsonUnwrapped
        @JsonIgnoreProperties(value = "type", allowSetters = true)
        private ContainerValueOptional value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private OptionalValue() {}

        private OptionalValue(ContainerValueOptional value) {
            this.value = value;
        }
