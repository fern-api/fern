...
public class AsyncSeedNullableOptionalClientBuilder {
    ...
    public AsyncSeedNullableOptionalClientBuilder url(String url) {
     ...
     */
    public AsyncSeedNullableOptionalClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedNullableOptionalClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedNullableOptionalClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedNullableOptionalClient build() {
        validateConfiguration();
        return new AsyncSeedNullableOptionalClient(buildClientOptions());
    }
}
