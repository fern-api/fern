...
public final class Address {
    ...
    private Optional<String> _getBuildingId() {
        return buildingId;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("tenantId")
    private Optional<String> _getTenantId() {
        return tenantId;
    }
    ...
    public static final class Builder implements StreetStage, ZipCodeStage, _FinalStage {
        ...
        public _FinalStage tenantId(Nullable<String> tenantId) {
            if (tenantId.isNull()) {
                ...
                this.tenantId = Optional.of(tenantId.get());
            }
            return this;
        }
        ...
        public _FinalStage buildingId(Nullable<String> buildingId) {
            if (buildingId.isNull()) {
                ...
                this.buildingId = Optional.empty();
            } else {
                this.buildingId = Optional.of(buildingId.get());
            }
            return this;
        }
