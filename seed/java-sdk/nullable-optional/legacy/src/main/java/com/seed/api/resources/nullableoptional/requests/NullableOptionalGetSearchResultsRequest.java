...
public final class NullableOptionalGetSearchResultsRequest {
    ...
    private Optional<Map<String, Optional<String>>> _getFilters() {
        return filters;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage filters(Nullable<Map<String, Optional<String>>> filters);
    ...
    public static final class Builder implements QueryStage, _FinalStage {
        ...
        @java.lang.Override
        public _FinalStage filters(Nullable<Map<String, Optional<String>>> filters) {
            if (filters.isNull()) {
                this.filters = null;
