...
public final class Address {
    ...
    private final OptionalNullable<String> tenantId;
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("state")
    public OptionalNullable<String> getState() {
        if (state == null) {
            return OptionalNullable.absent();
        }
        return state;
    ...
    public OptionalNullable<String> getTenantId() {
        if (tenantId == null) {
            return OptionalNullable.absent();
        }
        return tenantId;
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("state")
    private OptionalNullable<String> _getState() {
        return state;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("tenantId")
    private OptionalNullable<String> _getTenantId() {
        return tenantId;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage state(OptionalNullable<String> state);
        ...
        _FinalStage tenantId(OptionalNullable<String> tenantId);
    ...
    public static final class Builder implements StreetStage, ZipCodeStage, _FinalStage {
        ...
        private OptionalNullable<String> tenantId = OptionalNullable.absent();
        ...
        private OptionalNullable<String> state = OptionalNullable.absent();
        ...
        public _FinalStage tenantId(Nullable<String> tenantId) {
            if (tenantId.isNull()) {
                this.tenantId = OptionalNullable.ofNull();
            } else if (tenantId.isEmpty()) {
                this.tenantId = OptionalNullable.absent();
            } else {
                this.tenantId = OptionalNullable.of(tenantId.get());
            }
            return this;
        }
        ...
        public _FinalStage tenantId(String tenantId) {
            this.tenantId = OptionalNullable.of(tenantId);
            return this;
        }

        @java.lang.Override
        @JsonSetter(value = "tenantId", nulls = Nulls.SKIP)
        public _FinalStage tenantId(OptionalNullable<String> tenantId) {
            this.tenantId = tenantId;
            return this;
        }
        ...
        public _FinalStage state(Nullable<String> state) {
            if (state.isNull()) {
                this.state = OptionalNullable.ofNull();
            } else if (state.isEmpty()) {
                this.state = OptionalNullable.absent();
            } else {
                this.state = OptionalNullable.of(state.get());
            }
            return this;
        }
        ...
        public _FinalStage state(OptionalNullable<String> state) {
            this.state = state;
            return this;
        }
