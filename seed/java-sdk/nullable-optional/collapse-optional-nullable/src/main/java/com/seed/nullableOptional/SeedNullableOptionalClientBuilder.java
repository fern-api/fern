...
import com.seed.nullableOptional.core.Environment;
import com.seed.nullableOptional.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedNullableOptionalClientBuilder {
    ...
    public SeedNullableOptionalClientBuilder url(String url) {
     ...
     */
    public SeedNullableOptionalClientBuilder timeout(int timeout) {
     ...
     */
    public SeedNullableOptionalClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedNullableOptionalClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedNullableOptionalClientBuilder addHeader(String name, String value) {
    ...
    public SeedNullableOptionalClient build() {
        validateConfiguration();
        return new SeedNullableOptionalClient(buildClientOptions());
    }
}
