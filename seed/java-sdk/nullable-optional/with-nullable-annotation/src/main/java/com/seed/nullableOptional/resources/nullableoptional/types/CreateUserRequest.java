...
public final class CreateUserRequest {
    ...
    public interface _FinalStage {
        ...
        _FinalStage address(@Nullable Optional<Address> address);

        _FinalStage address(Address address);

        _FinalStage address(com.seed.nullableOptional.core.Nullable<Address> address);
    }
    ...
    public static final class Builder implements UsernameStage, _FinalStage {
        ...
        public _FinalStage address(@Nullable Optional<Address> address) {
            this.address = address;
            return this;
        }
