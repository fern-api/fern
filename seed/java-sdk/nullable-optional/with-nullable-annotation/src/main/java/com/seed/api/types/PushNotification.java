...
public final class PushNotification implements IPushNotification {
    ...
    @JsonProperty("badge")
    private Optional<Integer> _getBadge() {
        return badge;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage badge(@Nullable Optional<Integer> badge);

        _FinalStage badge(Integer badge);

        _FinalStage badge(com.seed.api.core.Nullable<Integer> badge);
    }
    ...
    public static final class Builder implements DeviceTokenStage, TitleStage, BodyStage, _FinalStage {
        ...
        @java.lang.Override
        public _FinalStage badge(com.seed.api.core.Nullable<Integer> badge) {
            if (badge.isNull()) {
                this.badge = null;
            } else if (badge.isEmpty()) {
                this.badge = Optional.empty();
            } else {
                this.badge = Optional.of(badge.get());
            }
            return this;
        }
        ...
        public _FinalStage badge(@Nullable Optional<Integer> badge) {
            this.badge = badge;
            return this;
        }
