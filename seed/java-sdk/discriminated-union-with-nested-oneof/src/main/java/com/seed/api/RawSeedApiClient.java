...
public class RawSeedApiClient {
    ...
    public SeedApiHttpResponse<AstNode> createAst(AstNode request) {
        return createAst(request, null);
    }

    public SeedApiHttpResponse<AstNode> createAst(AstNode request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SeedApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AstNode.class), response);
            }
