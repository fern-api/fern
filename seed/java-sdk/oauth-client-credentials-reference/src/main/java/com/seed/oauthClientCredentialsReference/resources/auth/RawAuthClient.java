...
public class RawAuthClient {
    ...
    public SeedOauthClientCredentialsReferenceHttpResponse<TokenResponse> getToken(GetTokenRequest request) {
        return getToken(request, null);
    }

    public SeedOauthClientCredentialsReferenceHttpResponse<TokenResponse> getToken(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SeedOauthClientCredentialsReferenceHttpResponse<>(
