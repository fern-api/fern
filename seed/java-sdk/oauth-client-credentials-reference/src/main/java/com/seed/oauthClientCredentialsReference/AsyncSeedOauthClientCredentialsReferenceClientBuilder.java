...
import com.seed.oauthClientCredentialsReference.core.Environment;
import com.seed.oauthClientCredentialsReference.core.LogConfig;
import com.seed.oauthClientCredentialsReference.core.OAuthTokenSupplier;
...
public class AsyncSeedOauthClientCredentialsReferenceClientBuilder {
    ...
    public AsyncSeedOauthClientCredentialsReferenceClientBuilder url(String url) {
     ...
     */
    public AsyncSeedOauthClientCredentialsReferenceClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedOauthClientCredentialsReferenceClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedOauthClientCredentialsReferenceClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedOauthClientCredentialsReferenceClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedOauthClientCredentialsReferenceClient build() {
        validateConfiguration();
        return new AsyncSeedOauthClientCredentialsReferenceClient(buildClientOptions());
    }

    public static final class _TokenAuth extends AsyncSeedOauthClientCredentialsReferenceClientBuilder {
    ...
    public static final class _CredentialsAuth extends AsyncSeedOauthClientCredentialsReferenceClientBuilder {
        ...
        public AsyncSeedOauthClientCredentialsReferenceClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new AsyncSeedOauthClientCredentialsReferenceClient(finalOptions);
        }
    }
