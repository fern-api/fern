...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/cli-multi-spec)](https://central.sonatype.com/artifact/com.fern/cli-multi-spec)
...
```groovy
dependencies {
  implementation 'com.fern:cli-multi-spec:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>cli-multi-spec</artifactId>
...
```java
SeedApiHttpResponse response = client.withRawResponse().listUsers(...);
