...
import com.seed.javaWebsocketSharedDiscriminator.core.Environment;
import com.seed.javaWebsocketSharedDiscriminator.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedJavaWebsocketSharedDiscriminatorClientBuilder {
    ...
    public AsyncSeedJavaWebsocketSharedDiscriminatorClientBuilder url(String url) {
     ...
     */
    public AsyncSeedJavaWebsocketSharedDiscriminatorClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedJavaWebsocketSharedDiscriminatorClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedJavaWebsocketSharedDiscriminatorClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedJavaWebsocketSharedDiscriminatorClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedJavaWebsocketSharedDiscriminatorClient build() {
        validateConfiguration();
        return new AsyncSeedJavaWebsocketSharedDiscriminatorClient(buildClientOptions());
    }
}
