...
public final class ErrorEvent implements IErrorEvent {
    ...
    private ErrorEvent(String error, Optional<Integer> code, Map<String, Object> additionalProperties) {
        this.error = error;
        this.code = code;
    ...
    public static final class Builder implements ErrorStage, _FinalStage {
        ...
        public ErrorEvent build() {
            return new ErrorEvent(error, code, additionalProperties);
        }
