...
public class RawFooClient {
    ...
    public SeedApiHttpResponse<ImportingType> find() {
        return find(FooFindRequest.builder().build());
    }

    public SeedApiHttpResponse<ImportingType> find(RequestOptions requestOptions) {
        return find(FooFindRequest.builder().build(), requestOptions);
    }

    public SeedApiHttpResponse<ImportingType> find(FooFindRequest request) {
        return find(request, null);
    }

    public SeedApiHttpResponse<ImportingType> find(FooFindRequest request, RequestOptions requestOptions) {
