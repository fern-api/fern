...
public class SeedWebsocketBearerAuthClientBuilder {
     ...
     */
    public SeedWebsocketBearerAuthClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public SeedWebsocketBearerAuthClientBuilder url(String url) {
     ...
     */
    public SeedWebsocketBearerAuthClientBuilder timeout(int timeout) {
     ...
     */
    public SeedWebsocketBearerAuthClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedWebsocketBearerAuthClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedWebsocketBearerAuthClientBuilder addHeader(String name, String value) {
    ...
    public SeedWebsocketBearerAuthClient build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey or set the SEED_API_KEY environment variable.");
        }
        validateConfiguration();
        return new SeedWebsocketBearerAuthClient(buildClientOptions());
    }
}
