...
import com.seed.websocketBearerAuth.core.Environment;
import com.seed.websocketBearerAuth.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedWebsocketBearerAuthClientBuilder {
    ...
    /**
     * Sets apiKey.
     * Defaults to the SEED_API_KEY environment variable.
     */
    public AsyncSeedWebsocketBearerAuthClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncSeedWebsocketBearerAuthClientBuilder url(String url) {
     ...
     */
    public AsyncSeedWebsocketBearerAuthClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedWebsocketBearerAuthClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedWebsocketBearerAuthClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedWebsocketBearerAuthClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedWebsocketBearerAuthClient build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey or set the SEED_API_KEY environment variable.");
        }
        validateConfiguration();
        return new AsyncSeedWebsocketBearerAuthClient(buildClientOptions());
    }
}
