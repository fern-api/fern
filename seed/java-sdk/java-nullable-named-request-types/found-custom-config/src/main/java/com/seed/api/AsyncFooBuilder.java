...
public class AsyncFooBuilder {
    ...
    public AsyncFooBuilder url(String url) {
     ...
     */
    public AsyncFooBuilder timeout(int timeout) {
     ...
     */
    public AsyncFooBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncFooBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncFooBuilder addHeader(String name, String value) {
    ...
    public AsyncFoo build() {
        validateConfiguration();
        return new AsyncFoo(buildClientOptions());
    }
}
