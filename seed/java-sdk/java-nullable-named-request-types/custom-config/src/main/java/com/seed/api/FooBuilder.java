...
public class FooBuilder {
    ...
    public FooBuilder url(String url) {
     ...
     */
    public FooBuilder timeout(int timeout) {
     ...
     */
    public FooBuilder maxRetries(int maxRetries) {
     ...
     */
    public FooBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public FooBuilder addHeader(String name, String value) {
    ...
    public Foo build() {
        ...
        return new Foo(buildClientOptions());
    }
}
