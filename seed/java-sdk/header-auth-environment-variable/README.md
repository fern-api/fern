...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/header-auth-environment-variable)](https://central.sonatype.com/artifact/com.fern/header-auth-environment-variable)
...
```groovy
dependencies {
  implementation 'com.fern:header-auth-environment-variable:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>header-auth-environment-variable</artifactId>
...
```java
SeedHeaderTokenEnvironmentVariableHttpResponse response = client.service().withRawResponse().getWithBearerToken(...);
