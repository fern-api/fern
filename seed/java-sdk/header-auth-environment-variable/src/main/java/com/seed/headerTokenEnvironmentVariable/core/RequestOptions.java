...
public final class RequestOptions {
    private final String headerTokenAuth;
    ...
    public static class Builder {
        ...
        public Builder headerTokenAuth(String headerTokenAuth) {
            this.headerTokenAuth = headerTokenAuth;
            return this;
        }
        ...
        public RequestOptions build() {
            return new RequestOptions(headerTokenAuth, timeout, timeoutTimeUnit, headers, headerSuppliers);
        }
    }
}
