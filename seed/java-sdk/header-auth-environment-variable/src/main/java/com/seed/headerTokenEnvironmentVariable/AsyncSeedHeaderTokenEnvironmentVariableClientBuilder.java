...
public class AsyncSeedHeaderTokenEnvironmentVariableClientBuilder {
     ...
     */
    public AsyncSeedHeaderTokenEnvironmentVariableClientBuilder headerTokenAuth(String headerTokenAuth) {
        this.headerTokenAuth = headerTokenAuth;
        return this;
    }

    public AsyncSeedHeaderTokenEnvironmentVariableClientBuilder url(String url) {
     ...
     */
    public AsyncSeedHeaderTokenEnvironmentVariableClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedHeaderTokenEnvironmentVariableClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedHeaderTokenEnvironmentVariableClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedHeaderTokenEnvironmentVariableClient build() {
        if (headerTokenAuth == null) {
            throw new RuntimeException(
                    "Please provide headerTokenAuth or set the HEADER_TOKEN_ENV_VAR environment variable.");
        }
        validateConfiguration();
        return new AsyncSeedHeaderTokenEnvironmentVariableClient(buildClientOptions());
    }
}
