...
public class SeedHeaderTokenEnvironmentVariableClientBuilder {
     ...
     * Defaults to the HEADER_TOKEN_ENV_VAR environment variable.
     */
    public SeedHeaderTokenEnvironmentVariableClientBuilder headerTokenAuth(String headerTokenAuth) {
        this.headerTokenAuth = headerTokenAuth;
        return this;
    }

    public SeedHeaderTokenEnvironmentVariableClientBuilder url(String url) {
     ...
     */
    public SeedHeaderTokenEnvironmentVariableClientBuilder timeout(int timeout) {
     ...
     */
    public SeedHeaderTokenEnvironmentVariableClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedHeaderTokenEnvironmentVariableClientBuilder addHeader(String name, String value) {
    ...
    public SeedHeaderTokenEnvironmentVariableClient build() {
        if (headerTokenAuth == null) {
            throw new RuntimeException(
                    "Please provide headerTokenAuth or set the HEADER_TOKEN_ENV_VAR environment variable.");
        }
        validateConfiguration();
        return new SeedHeaderTokenEnvironmentVariableClient(buildClientOptions());
    }
}
