...
public class AsyncRawAuthClient {
    ...
    public CompletableFuture<SeedAnyAuthHttpResponse<TokenResponse>> getToken(GetTokenRequest request) {
        return getToken(request, null);
    }

    public CompletableFuture<SeedAnyAuthHttpResponse<TokenResponse>> getToken(
        ...
        CompletableFuture<SeedAnyAuthHttpResponse<TokenResponse>> future = new CompletableFuture<>();
