...
public class RawAuthClient {
    ...
    public SeedAnyAuthHttpResponse<TokenResponse> getToken(GetTokenRequest request) {
        return getToken(request, null);
    }

    public SeedAnyAuthHttpResponse<TokenResponse> getToken(GetTokenRequest request, RequestOptions requestOptions) {
