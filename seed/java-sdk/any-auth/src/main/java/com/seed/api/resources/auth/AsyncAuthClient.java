...
public class AsyncAuthClient {
    ...
    public CompletableFuture<TokenResponse> gettoken(AuthGetTokenRequest request) {
        return this.rawClient.gettoken(request).thenApply(response -> response.body());
    }

    public CompletableFuture<TokenResponse> gettoken(AuthGetTokenRequest request, RequestOptions requestOptions) {
