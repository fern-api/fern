...
public class SeedAnyAuthClientBuilder {
     ...
     * Sets audience
     */
    public SeedAnyAuthClientBuilder audience(String audience) {
     ...
     * Sets grantType
     */
    public SeedAnyAuthClientBuilder grantType(String grantType) {
     ...
     * Sets scope
     */
    public SeedAnyAuthClientBuilder scope(String scope) {
        this.scope = scope;
        return this;
    }
