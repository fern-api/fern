...
public class RawUserClient {
    ...
    public SeedApiHttpResponse<List<User>> get() {
        return get(null);
    }

    public SeedApiHttpResponse<List<User>> get(RequestOptions requestOptions) {
    ...
    public SeedApiHttpResponse<List<User>> getadmins() {
        return getadmins(null);
    }

    public SeedApiHttpResponse<List<User>> getadmins(RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
