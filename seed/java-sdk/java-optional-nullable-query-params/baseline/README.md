...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/java-optional-nullable-query-params)](https://central.sonatype.com/artifact/com.fern/java-optional-nullable-query-params)
...
<dependency>
  ...
  <artifactId>java-optional-nullable-query-params</artifactId>
...
try{
    client.search(...);
} catch (SeedJavaOptionalNullableQueryParamsApiException e){
