...
import com.seed.javaOptionalNullableQueryParams.core.Environment;
import com.seed.javaOptionalNullableQueryParams.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedJavaOptionalNullableQueryParamsClientBuilder {
    ...
    public AsyncSeedJavaOptionalNullableQueryParamsClientBuilder url(String url) {
     ...
     */
    public AsyncSeedJavaOptionalNullableQueryParamsClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedJavaOptionalNullableQueryParamsClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedJavaOptionalNullableQueryParamsClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedJavaOptionalNullableQueryParamsClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedJavaOptionalNullableQueryParamsClient build() {
        validateConfiguration();
        return new AsyncSeedJavaOptionalNullableQueryParamsClient(buildClientOptions());
    }
}
