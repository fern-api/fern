...
public class AsyncSeedJavaOptionalRequestBodyClient {
     ...
     */
    public CompletableFuture<Refund> refundExactAmount(String id) {
        return this.rawClient.refundExactAmount(id).thenApply(response -> response.body());
    }

    /**
     * Refund a payment, optionally with an exact amount.
     */
    public CompletableFuture<Refund> refundExactAmount(String id, RequestOptions requestOptions) {
        return this.rawClient.refundExactAmount(id, requestOptions).thenApply(response -> response.body());
    }
