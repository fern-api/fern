...
import com.seed.serverSentEventsResumable.core.Environment;
import com.seed.serverSentEventsResumable.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedServerSentEventsResumableClientBuilder {
    ...
    public AsyncSeedServerSentEventsResumableClientBuilder url(String url) {
     ...
     */
    public AsyncSeedServerSentEventsResumableClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedServerSentEventsResumableClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedServerSentEventsResumableClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedServerSentEventsResumableClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedServerSentEventsResumableClient build() {
        validateConfiguration();
        return new AsyncSeedServerSentEventsResumableClient(buildClientOptions());
    }
}
