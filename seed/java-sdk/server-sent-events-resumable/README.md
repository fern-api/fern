...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/server-sent-events-resumable)](https://central.sonatype.com/artifact/com.fern/server-sent-events-resumable)
...
```groovy
dependencies {
  implementation 'com.fern:server-sent-events-resumable:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>server-sent-events-resumable</artifactId>
...
public class Example {
    public static void main(String[] args) {
        SeedServerSentEventsResumableClient client = SeedServerSentEventsResumableClient
            .builder()
            .build();
...
```java
SeedServerSentEventsResumableHttpResponse response = client.completions().withRawResponse().stream(...);
