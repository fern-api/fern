...
public class AsyncSeedDeepCursorPathClientBuilder {
    ...
    public AsyncSeedDeepCursorPathClientBuilder url(String url) {
     ...
     */
    public AsyncSeedDeepCursorPathClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedDeepCursorPathClientBuilder httpClient(OkHttpClient httpClient) {
