...
public class RawDeepcursorpathClient {
    ...
    public SeedApiHttpResponse<Response> doThing() {
        return doThing(A.builder().build());
    }

    public SeedApiHttpResponse<Response> doThing(RequestOptions requestOptions) {
        return doThing(A.builder().build(), requestOptions);
    }

    public SeedApiHttpResponse<Response> doThing(A request) {
        return doThing(request, null);
    }

    public SeedApiHttpResponse<Response> doThing(A request, RequestOptions requestOptions) {
    ...
    public SeedApiHttpResponse<Response> doThingRequired(MainRequired request) {
        return doThingRequired(request, null);
    }

    public SeedApiHttpResponse<Response> doThingRequired(MainRequired request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
    ...
    public SeedApiHttpResponse<Response> doThingInline() {
        return doThingInline(InlineA.builder().build());
    }

    public SeedApiHttpResponse<Response> doThingInline(RequestOptions requestOptions) {
        return doThingInline(InlineA.builder().build(), requestOptions);
    }

    public SeedApiHttpResponse<Response> doThingInline(InlineA request) {
        return doThingInline(request, null);
    }

    public SeedApiHttpResponse<Response> doThingInline(InlineA request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
