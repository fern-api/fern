...
public class AsyncRawDeepcursorpathClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<Response>> doThing() {
        return doThing(A.builder().build());
    }

    public CompletableFuture<SeedApiHttpResponse<Response>> doThing(RequestOptions requestOptions) {
        return doThing(A.builder().build(), requestOptions);
    }

    public CompletableFuture<SeedApiHttpResponse<Response>> doThing(A request) {
        return doThing(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Response>> doThing(A request, RequestOptions requestOptions) {
    ...
    public CompletableFuture<SeedApiHttpResponse<Response>> doThingRequired(MainRequired request) {
        return doThingRequired(request, null);
    }

    public CompletableFuture<SeedApiHttpResponse<Response>> doThingRequired(
    ...
    public CompletableFuture<SeedApiHttpResponse<Response>> doThingInline() {
        return doThingInline(InlineA.builder().build());
    }

    public CompletableFuture<SeedApiHttpResponse<Response>> doThingInline(RequestOptions requestOptions) {
        return doThingInline(InlineA.builder().build(), requestOptions);
    }

    public CompletableFuture<SeedApiHttpResponse<Response>> doThingInline(InlineA request) {
