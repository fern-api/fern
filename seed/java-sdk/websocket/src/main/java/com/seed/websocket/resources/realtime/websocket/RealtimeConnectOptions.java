...
public final class RealtimeConnectOptions {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.model, this.temperature, this.languageCode);
    }
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "language-code", nulls = Nulls.SKIP)
        ...
        public RealtimeConnectOptions build() {
            return new RealtimeConnectOptions(model, temperature, languageCode, additionalProperties);
        }
