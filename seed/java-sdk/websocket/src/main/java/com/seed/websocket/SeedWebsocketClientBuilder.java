...
public class SeedWebsocketClientBuilder {
     ...
     */
    public SeedWebsocketClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedWebsocketClientBuilder addHeader(String name, String value) {
    ...
    public SeedWebsocketClient build() {
        ...
        return new SeedWebsocketClient(buildClientOptions());
    }
}
