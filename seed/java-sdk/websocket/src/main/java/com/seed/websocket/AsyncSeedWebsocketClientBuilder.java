...
public class AsyncSeedWebsocketClientBuilder {
     ...
     */
    public AsyncSeedWebsocketClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedWebsocketClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedWebsocketClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedWebsocketClient build() {
        validateConfiguration();
        return new AsyncSeedWebsocketClient(buildClientOptions());
    }
}
