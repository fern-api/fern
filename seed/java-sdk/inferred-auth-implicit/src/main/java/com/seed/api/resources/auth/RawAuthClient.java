...
public class RawAuthClient {
    ...
    public SeedApiHttpResponse<TokenResponse> gettokenwithclientcredentials(
            AuthGetTokenWithClientCredentialsRequest request) {
        return gettokenwithclientcredentials(request, null);
    }

    public SeedApiHttpResponse<TokenResponse> gettokenwithclientcredentials(
            AuthGetTokenWithClientCredentialsRequest request, RequestOptions requestOptions) {
    ...
    public SeedApiHttpResponse<TokenResponse> refreshtoken(AuthRefreshTokenRequest request) {
        return refreshtoken(request, null);
    }

    public SeedApiHttpResponse<TokenResponse> refreshtoken(
            AuthRefreshTokenRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
