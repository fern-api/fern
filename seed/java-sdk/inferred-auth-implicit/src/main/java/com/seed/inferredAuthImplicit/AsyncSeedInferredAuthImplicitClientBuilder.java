...
import com.seed.inferredAuthImplicit.core.Environment;
import com.seed.inferredAuthImplicit.core.InferredAuthTokenSupplier;
import com.seed.inferredAuthImplicit.core.LogConfig;
...
public class AsyncSeedInferredAuthImplicitClientBuilder {
     ...
     * Sets xApiKey
     */
    public AsyncSeedInferredAuthImplicitClientBuilder xApiKey(String xApiKey) {
     ...
     */
    public AsyncSeedInferredAuthImplicitClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedInferredAuthImplicitClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedInferredAuthImplicitClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedInferredAuthImplicitClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedInferredAuthImplicitClient build() {
        validateConfiguration();
        return new AsyncSeedInferredAuthImplicitClient(buildClientOptions());
    }
}
