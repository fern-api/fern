...
public class AsyncRawSeedApiClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<TestGetResponse>> testGet(String region) {
        return testGet(region, TestGetRequest.builder().build());
    }

    public CompletableFuture<SeedApiHttpResponse<TestGetResponse>> testGet(
            String region, RequestOptions requestOptions) {
        return testGet(region, TestGetRequest.builder().build(), requestOptions);
    }

    public CompletableFuture<SeedApiHttpResponse<TestGetResponse>> testGet(String region, TestGetRequest request) {
    ...
    public CompletableFuture<SeedApiHttpResponse<TestGetResponse>> testGet(
        ...
        CompletableFuture<SeedApiHttpResponse<TestGetResponse>> future = new CompletableFuture<>();
