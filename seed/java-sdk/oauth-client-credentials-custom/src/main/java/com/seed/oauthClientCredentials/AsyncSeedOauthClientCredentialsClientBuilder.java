...
import com.seed.oauthClientCredentials.core.LogConfig;
...
public class AsyncSeedOauthClientCredentialsClientBuilder {
     ...
     */
    public AsyncSeedOauthClientCredentialsClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedOauthClientCredentialsClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedOauthClientCredentialsClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedOauthClientCredentialsClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedOauthClientCredentialsClient build() {
        ...
        return new AsyncSeedOauthClientCredentialsClient(buildClientOptions());
    }

    public static final class _TokenAuth extends AsyncSeedOauthClientCredentialsClientBuilder {
    ...
    public static final class _CredentialsAuth extends AsyncSeedOauthClientCredentialsClientBuilder {
