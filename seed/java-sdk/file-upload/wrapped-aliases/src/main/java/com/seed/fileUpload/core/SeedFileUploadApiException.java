 ...
 */
public class SeedFileUploadApiException extends SeedFileUploadException {
    /**
    ...
    public SeedFileUploadApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public SeedFileUploadApiException(String message, int statusCode, Object body, Response rawResponse) {
        super(message);
        this.statusCode = statusCode;
        this.body = body;
        this.headers = new HashMap<>();
