...
public final class MyObjectWithOptional {
    ...
    private Optional<String> _getOptionalProp() {
        return optionalProp;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage optionalProp(Nullable<String> optionalProp);
    }
    ...
    public static final class Builder implements PropStage, _FinalStage {
        ...
        @java.lang.Override
        public _FinalStage optionalProp(Nullable<String> optionalProp) {
            if (optionalProp.isNull()) {
                this.optionalProp = null;
            } else if (optionalProp.isEmpty()) {
                this.optionalProp = Optional.empty();
            } else {
                this.optionalProp = Optional.of(optionalProp.get());
            }
            return this;
        }
