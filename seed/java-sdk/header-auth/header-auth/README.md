...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/header-auth)](https://central.sonatype.com/artifact/com.fern/header-auth)
...
```groovy
dependencies {
  implementation 'com.fern:header-auth:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>header-auth</artifactId>
