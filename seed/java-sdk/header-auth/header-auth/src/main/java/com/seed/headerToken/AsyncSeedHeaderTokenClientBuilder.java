...
import com.seed.headerToken.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedHeaderTokenClientBuilder {
     ...
     */
    public AsyncSeedHeaderTokenClientBuilder headerTokenAuth(String headerTokenAuth) {
        this.headerTokenAuth = headerTokenAuth;
        return this;
    }

    public AsyncSeedHeaderTokenClientBuilder url(String url) {
     ...
     */
    public AsyncSeedHeaderTokenClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedHeaderTokenClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedHeaderTokenClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedHeaderTokenClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedHeaderTokenClient build() {
        if (headerTokenAuth == null) {
            throw new RuntimeException("Please provide headerTokenAuth");
        }
        validateConfiguration();
        return new AsyncSeedHeaderTokenClient(buildClientOptions());
    }
}
