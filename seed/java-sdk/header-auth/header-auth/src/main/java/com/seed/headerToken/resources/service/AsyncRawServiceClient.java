...
public class AsyncRawServiceClient {
     ...
     */
    public CompletableFuture<SeedHeaderTokenHttpResponse<String>> getWithBearerToken() {
     ...
     * GET request with custom api key
     */
    public CompletableFuture<SeedHeaderTokenHttpResponse<String>> getWithBearerToken(RequestOptions requestOptions) {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SeedHeaderTokenHttpResponse<>(
