...
public class AsyncRawServiceClient {
     ...
     */
    public CompletableFuture<SeedApiHttpResponse<String>> getwithbearertoken() {
     ...
     * GET request with custom api key
     */
    public CompletableFuture<SeedApiHttpResponse<String>> getwithbearertoken(RequestOptions requestOptions) {
