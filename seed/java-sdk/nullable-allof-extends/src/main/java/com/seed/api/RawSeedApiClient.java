...
public class RawSeedApiClient {
     ...
     */
    public SeedApiHttpResponse<RootObject> getTest() {
        return getTest(null);
    }
     ...
     * Returns a RootObject which inherits from a nullable schema.
     */
    public SeedApiHttpResponse<RootObject> getTest(RequestOptions requestOptions) {
     ...
     */
    public SeedApiHttpResponse<RootObject> createTest() {
     ...
     * Creates a test object with nullable allOf in request body.
     */
    public SeedApiHttpResponse<RootObject> createTest(RequestOptions requestOptions) {
     ...
     * Creates a test object with nullable allOf in request body.
     */
    public SeedApiHttpResponse<RootObject> createTest(RootObject request) {
     ...
     * Creates a test object with nullable allOf in request body.
     */
    public SeedApiHttpResponse<RootObject> createTest(RootObject request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("test");
        if (requestOptions != null) {
