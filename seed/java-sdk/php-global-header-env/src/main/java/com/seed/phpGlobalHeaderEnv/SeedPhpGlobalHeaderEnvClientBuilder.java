...
import com.seed.phpGlobalHeaderEnv.core.Environment;
import com.seed.phpGlobalHeaderEnv.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedPhpGlobalHeaderEnvClientBuilder {
     ...
     * Sets version
     */
    public SeedPhpGlobalHeaderEnvClientBuilder version(String version) {
        this.version = version;
        return this;
    }

    public SeedPhpGlobalHeaderEnvClientBuilder url(String url) {
     ...
     */
    public SeedPhpGlobalHeaderEnvClientBuilder timeout(int timeout) {
     ...
     */
    public SeedPhpGlobalHeaderEnvClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public SeedPhpGlobalHeaderEnvClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public SeedPhpGlobalHeaderEnvClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public SeedPhpGlobalHeaderEnvClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public SeedPhpGlobalHeaderEnvClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedPhpGlobalHeaderEnvClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedPhpGlobalHeaderEnvClientBuilder addHeader(String name, String value) {
    ...
    protected void setCustomHeaders(ClientOptions.Builder builder) {
        if (this.version != null) {
            builder.addHeader("X-API-Version", this.version);
        }
    }
    ...
    public SeedPhpGlobalHeaderEnvClient build() {
        validateConfiguration();
        return new SeedPhpGlobalHeaderEnvClient(buildClientOptions());
    }
}
