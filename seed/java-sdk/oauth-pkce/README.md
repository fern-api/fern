...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/oauth-pkce)](https://central.sonatype.com/artifact/com.fern/oauth-pkce)
...
```groovy
dependencies {
  implementation 'com.fern:oauth-pkce:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>oauth-pkce</artifactId>
...
public class Example {
    public static void main(String[] args) {
        SeedOauthPkceClient client = SeedOauthPkceClient
            .builder()
            .build();
...
try{
    client.oauth().authorize(...);
} catch (SeedOauthPkceApiException e){
...
```java
SeedOauthPkceHttpResponse response = client.oauth().withRawResponse().authorize(...);
