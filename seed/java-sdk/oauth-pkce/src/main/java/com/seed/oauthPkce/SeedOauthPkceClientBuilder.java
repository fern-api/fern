...
import com.seed.oauthPkce.core.Environment;
import com.seed.oauthPkce.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class SeedOauthPkceClientBuilder {
    ...
    public SeedOauthPkceClientBuilder url(String url) {
     ...
     */
    public SeedOauthPkceClientBuilder timeout(int timeout) {
     ...
     */
    public SeedOauthPkceClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public SeedOauthPkceClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public SeedOauthPkceClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public SeedOauthPkceClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public SeedOauthPkceClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedOauthPkceClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedOauthPkceClientBuilder addHeader(String name, String value) {
    ...
    public SeedOauthPkceClient build() {
        validateConfiguration();
        return new SeedOauthPkceClient(buildClientOptions());
    }
}
