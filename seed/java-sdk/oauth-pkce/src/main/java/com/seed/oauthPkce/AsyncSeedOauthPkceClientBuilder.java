...
public class AsyncSeedOauthPkceClientBuilder {
    ...
    public AsyncSeedOauthPkceClientBuilder url(String url) {
     ...
     */
    public AsyncSeedOauthPkceClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedOauthPkceClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncSeedOauthPkceClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncSeedOauthPkceClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncSeedOauthPkceClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncSeedOauthPkceClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedOauthPkceClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedOauthPkceClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedOauthPkceClient build() {
        validateConfiguration();
        return new AsyncSeedOauthPkceClient(buildClientOptions());
    }
}
