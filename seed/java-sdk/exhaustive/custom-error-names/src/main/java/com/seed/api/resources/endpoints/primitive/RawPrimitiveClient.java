...
public class RawPrimitiveClient {
    ...
    public SeedApiHttpResponse<String> getAndReturnString(String request, RequestOptions requestOptions) {
    ...
    public SeedApiHttpResponse<Integer> getAndReturnInt(int request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
    ...
    public SeedApiHttpResponse<Long> getAndReturnLong(long request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
    ...
    public SeedApiHttpResponse<Double> getAndReturnDouble(double request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
    ...
    public SeedApiHttpResponse<Boolean> getAndReturnBool(boolean request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
    ...
    public SeedApiHttpResponse<String> getAndReturnDate(String request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
    ...
    public SeedApiHttpResponse<String> getAndReturnUuid(String request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
    ...
    public SeedApiHttpResponse<String> getAndReturnBase64(String request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
