...
public class AsyncRawContainerClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<List<String>>> getAndReturnListOfPrimitives(List<String> request) {
    ...
    public CompletableFuture<SeedApiHttpResponse<List<String>>> getAndReturnSetOfPrimitives(List<String> request) {
    ...
    public CompletableFuture<SeedApiHttpResponse<Map<String, TypesObjectWithRequiredField>>>
            getAndReturnMapOfPrimToObject(Map<String, TypesObjectWithRequiredField> request) {
    ...
    public CompletableFuture<SeedApiHttpResponse<Map<String, TypesObjectWithRequiredField>>>
        ...
        CompletableFuture<SeedApiHttpResponse<Map<String, TypesObjectWithRequiredField>>> future =
    ...
    public CompletableFuture<SeedApiHttpResponse<Map<String, TypesMixedType>>>
            getAndReturnMapOfPrimToUndiscriminatedUnion(Map<String, TypesMixedType> request) {
