...
public class RawContentTypeClient {
    ...
    public SeedApiHttpResponse<Void> postJsonPatchContentWithCharsetType(RequestOptions requestOptions) {
        return postJsonPatchContentWithCharsetType(
                TypesObjectWithOptionalField.builder().build(), requestOptions);
    }

    public SeedApiHttpResponse<Void> postJsonPatchContentWithCharsetType(TypesObjectWithOptionalField request) {
