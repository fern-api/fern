...
public class AsyncRawHttpMethodsClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<String>> testGet(TestGetHttpMethodsRequest request) {
    ...
    public CompletableFuture<SeedApiHttpResponse<Boolean>> testDelete(TestDeleteHttpMethodsRequest request) {
