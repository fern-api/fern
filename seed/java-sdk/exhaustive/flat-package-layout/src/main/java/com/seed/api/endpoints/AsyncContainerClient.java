...
public class AsyncContainerClient {
    ...
    public CompletableFuture<List<String>> getAndReturnSetOfPrimitives(
            List<String> request, RequestOptions requestOptions) {
        return this.rawClient
    ...
    public CompletableFuture<TypesObjectWithRequiredField> getAndReturnOptional(TypesObjectWithRequiredField request) {
