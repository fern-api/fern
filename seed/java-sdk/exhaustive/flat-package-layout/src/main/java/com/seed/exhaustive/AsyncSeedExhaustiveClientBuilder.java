...
public class AsyncSeedExhaustiveClientBuilder {
    ...
    public static final class _TokenAuth extends AsyncSeedExhaustiveClientBuilder {
    ...
    public static final class _CredentialsAuth extends AsyncSeedExhaustiveClientBuilder {
        ...
        public AsyncSeedExhaustiveClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new AsyncSeedExhaustiveClient(finalOptions);
        }
    }
