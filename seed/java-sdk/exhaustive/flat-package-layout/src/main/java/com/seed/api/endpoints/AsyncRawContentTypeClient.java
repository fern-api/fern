...
public class AsyncRawContentTypeClient {
    ...
    public CompletableFuture<SeedApiHttpResponse<Void>> postJsonPatchContentType(RequestOptions requestOptions) {
        return postJsonPatchContentType(TypesObjectWithOptionalField.builder().build(), requestOptions);
    }

    public CompletableFuture<SeedApiHttpResponse<Void>> postJsonPatchContentType(TypesObjectWithOptionalField request) {
