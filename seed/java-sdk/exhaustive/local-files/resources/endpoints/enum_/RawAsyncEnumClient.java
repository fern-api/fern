...
public class RawAsyncEnumClient {
  protected final ClientOptions clientOptions;

  public RawAsyncEnumClient(ClientOptions clientOptions) {
      ...
      public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
        try (ResponseBody responseBody = response.body()) {
          if (response.isSuccessful()) {
            future.complete(new SeedExhaustiveHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), WeatherReport.class), response));
            return;
          }
