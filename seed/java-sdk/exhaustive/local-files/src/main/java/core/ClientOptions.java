...
public final class ClientOptions {
  ...
  private ClientOptions(Environment environment, Map<String, String> headers,
    ...
    this.headers.putAll(new HashMap<String,String>() {{put("X-Fern-Language", "JAVA");put("X-Fern-SDK-Name", "com.seed.fern:exhaustive-sdk");put("X-Fern-Runtime", "jvm");put("X-Fern-Runtime-Version", System.getProperty("java.version"));put("X-Fern-Platform", System.getProperty("os.name"));}});
