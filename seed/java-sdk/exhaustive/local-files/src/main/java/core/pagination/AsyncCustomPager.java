...
public class AsyncCustomPager<T> implements BiDirectionalPage<T> {
    ...
    public boolean hasNext() {
        throw new UnsupportedOperationException(
            "AsyncCustomPager.hasNext() must be implemented. " +
    ...
    public boolean hasPrevious() {
        throw new UnsupportedOperationException(
            "AsyncCustomPager.hasPrevious() must be implemented. " +
    ...
    public CompletableFuture<BiDirectionalPage<T>> nextPageAsync() {
        ...
        future.completeExceptionally(new UnsupportedOperationException(
            "AsyncCustomPager.nextPageAsync() must be implemented. " +
    ...
    public CompletableFuture<BiDirectionalPage<T>> previousPageAsync() {
        CompletableFuture<BiDirectionalPage<T>> future = new CompletableFuture<>();
        future.completeExceptionally(new UnsupportedOperationException(
            "AsyncCustomPager.previousPageAsync() must be implemented. " +
    ...
    public BiDirectionalPage<T> nextPage() throws IOException {
        throw new UnsupportedOperationException(
            "AsyncCustomPager.nextPage() must be implemented. " +
    ...
    public List<T> getItems() {
        throw new UnsupportedOperationException(
            "AsyncCustomPager.getItems() must be implemented. " +
    ...
    public <R> Optional<R> getResponse() {
        throw new UnsupportedOperationException(
            "AsyncCustomPager.getResponse() must be implemented. " +
    ...
    public CompletableFuture<List<T>> getAllItemsAsync() {
        throw new UnsupportedOperationException(
            "AsyncCustomPager.getAllItemsAsync() must be implemented. " +
    ...
    public CompletableFuture<Void> forEachPageAsync(
        ...
        throw new UnsupportedOperationException(
            "AsyncCustomPager.forEachPageAsync() must be implemented. " +
