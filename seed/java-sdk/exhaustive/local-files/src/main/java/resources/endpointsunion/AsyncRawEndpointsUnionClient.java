...
public class AsyncRawEndpointsUnionClient {
  protected final ClientOptions clientOptions;

  public AsyncRawEndpointsUnionClient(ClientOptions clientOptions) {
    this.clientOptions = clientOptions;
  }

  public CompletableFuture<SeedApiHttpResponse<TypesAnimal>> endpointsUnionGetAndReturnUnion(
      TypesAnimal request) {
