...
public class AsyncRawOauthClient {
  ...
  public CompletableFuture<SeedExhaustiveHttpResponse<OAuthTokenResponse>> getToken(
  ...
  public CompletableFuture<SeedExhaustiveHttpResponse<OAuthTokenResponse>> getToken(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      .addPathSegments("token");if (requestOptions != null) {
      ...
      CompletableFuture<SeedExhaustiveHttpResponse<OAuthTokenResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new SeedExhaustiveHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, OAuthTokenResponse.class), response));
              return;
            }
