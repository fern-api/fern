...
package com.fern.sdk.resources.inlinedrequests.requests;
...
@JsonDeserialize(
    builder = RequiredAndOptionalRequest.Builder.class
)
public final class RequiredAndOptionalRequest {
  ...
  private RequiredAndOptionalRequest(String requiredString, Optional<String> optionalString,
