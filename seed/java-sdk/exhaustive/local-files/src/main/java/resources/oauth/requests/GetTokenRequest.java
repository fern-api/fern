...
package com.fern.sdk.resources.oauth.requests;
...
public final class GetTokenRequest {
  ...
  private GetTokenRequest(String grantType, String clientId, Optional<String> clientSecret,
  ...
  private boolean equalTo(GetTokenRequest other) {
    return grantType.equals(other.grantType) && clientId.equals(other.clientId) && clientSecret.equals(other.clientSecret) && scope.equals(other.scope);
  }
