...
public class RawOauthClient {
    ...
    public BestHttpResponse<OAuthTokenResponse> getToken(GetTokenRequest request) {
        return getToken(request, null);
    }

    public BestHttpResponse<OAuthTokenResponse> getToken(GetTokenRequest request, RequestOptions requestOptions) {
