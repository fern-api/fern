...
public class AsyncRawParamsClient {
     ...
     * GET with path param
     */
    public CompletableFuture<BestHttpResponse<String>> getWithPath(GetWithPathParamsRequest request) {
     ...
     * GET with path param
     */
    public CompletableFuture<BestHttpResponse<String>> getWithPath(
     ...
     */
    public CompletableFuture<BestHttpResponse<TypesObjectWithRequiredField>> uploadWithPath(
     ...
     */
    public CompletableFuture<BestHttpResponse<String>> modifyWithPath(ModifyWithPathParamsRequest request) {
     ...
     * GET with path param
     */
    public CompletableFuture<BestHttpResponse<String>> getWithInlinePath(GetWithInlinePathParamsRequest request) {
     ...
     * PUT to update with path param
     */
    public CompletableFuture<BestHttpResponse<String>> modifyWithInlinePath(ModifyWithInlinePathParamsRequest request) {
     ...
     */
    public CompletableFuture<BestHttpResponse<Void>> getWithQuery(GetWithQueryParamsRequest request) {
     ...
     * GET with query param
     */
    public CompletableFuture<BestHttpResponse<Void>> getWithQuery(
     ...
     * GET with multiple of same query param
     */
    public CompletableFuture<BestHttpResponse<Void>> getWithAllowMultipleQuery(RequestOptions requestOptions) {
        return getWithAllowMultipleQuery(
     ...
     */
    public CompletableFuture<BestHttpResponse<Void>> getWithPathAndQuery(GetWithPathAndQueryParamsRequest request) {
