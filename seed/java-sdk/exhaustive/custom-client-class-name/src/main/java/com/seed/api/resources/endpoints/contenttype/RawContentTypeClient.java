...
public class RawContentTypeClient {
    ...
    public BestHttpResponse<Void> postJsonPatchContentType(TypesObjectWithOptionalField request) {
    ...
    public BestHttpResponse<Void> postJsonPatchContentWithCharsetType(TypesObjectWithOptionalField request) {
