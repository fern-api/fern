...
public class AsyncRawObjectClient {
     ...
     */
    public CompletableFuture<BestHttpResponse<ObjectWithRequiredAndOptionalFields>>
    ...
    public CompletableFuture<BestHttpResponse<ObjectWithRequiredAndOptionalFields>>
        ...
        CompletableFuture<BestHttpResponse<ObjectWithRequiredAndOptionalFields>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
