...
public class AsyncRawInlinedRequestsClient {
     ...
     */
    public CompletableFuture<BestHttpResponse<ObjectWithOptionalField>> postWithObjectBodyandResponse(
     ...
     */
    public CompletableFuture<BestHttpResponse<String>> postWithRequiredAndOptionalFields(
