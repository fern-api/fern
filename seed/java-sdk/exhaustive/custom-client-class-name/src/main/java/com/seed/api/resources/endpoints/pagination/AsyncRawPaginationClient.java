...
public class AsyncRawPaginationClient {
     ...
     */
    public CompletableFuture<BestHttpResponse<EndpointsPaginatedResponse>> listItems() {
     ...
     * List items with cursor pagination
     */
    public CompletableFuture<BestHttpResponse<EndpointsPaginatedResponse>> listItems(RequestOptions requestOptions) {
    ...
    public CompletableFuture<BestHttpResponse<EndpointsPaginatedResponse>> listItems(
        ...
        CompletableFuture<BestHttpResponse<EndpointsPaginatedResponse>> future = new CompletableFuture<>();
