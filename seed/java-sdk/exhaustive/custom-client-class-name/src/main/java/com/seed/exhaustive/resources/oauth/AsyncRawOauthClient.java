...
public class AsyncRawOauthClient {
    ...
    public CompletableFuture<BestHttpResponse<OAuthTokenResponse>> getToken(GetTokenRequest request) {
        return getToken(request, null);
    }

    public CompletableFuture<BestHttpResponse<OAuthTokenResponse>> getToken(
        ...
        CompletableFuture<BestHttpResponse<OAuthTokenResponse>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BestHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, OAuthTokenResponse.class),
                                response));
                        return;
                    }
