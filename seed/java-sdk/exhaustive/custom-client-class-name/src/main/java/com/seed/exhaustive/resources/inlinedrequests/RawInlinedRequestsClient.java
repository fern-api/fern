...
public class RawInlinedRequestsClient {
     ...
     */
    public BestHttpResponse<ObjectWithOptionalField> postWithObjectBodyandResponse(PostWithObjectBody request) {
     ...
     */
    public BestHttpResponse<String> postWithArrayBodyAndHeaders(List<String> body) {
     ...
     * POST with root-level array body and header params
     */
    public BestHttpResponse<String> postWithArrayBodyAndHeaders(List<String> body, RequestOptions requestOptions) {
        return postWithArrayBodyAndHeaders(
     ...
     * POST with root-level array body and header params
     */
    public BestHttpResponse<String> postWithArrayBodyAndHeaders(PostWithArrayBodyAndHeaders request) {
     ...
     * POST with root-level array body and header params
     */
    public BestHttpResponse<String> postWithArrayBodyAndHeaders(
