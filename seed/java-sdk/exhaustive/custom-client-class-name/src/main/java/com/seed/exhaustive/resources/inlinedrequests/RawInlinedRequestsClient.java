...
public class RawInlinedRequestsClient {
     ...
     */
    public BestHttpResponse<String> postWithRequiredAndOptionalFields(RequiredAndOptionalRequest request) {
     ...
     * for staged builders (Java).
     */
    public BestHttpResponse<String> postWithRequiredAndOptionalFields(
