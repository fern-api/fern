...
public class AsyncBestBuilder {
    ...
    public static final class _TokenAuth extends AsyncBestBuilder {
    ...
    public static final class _CredentialsAuth extends AsyncBestBuilder {
        ...
        public AsyncBest build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new AsyncBest(finalOptions);
        }
    }
