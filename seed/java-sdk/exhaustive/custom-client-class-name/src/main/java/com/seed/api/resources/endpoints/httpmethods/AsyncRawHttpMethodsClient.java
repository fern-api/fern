...
public class AsyncRawHttpMethodsClient {
    ...
    public CompletableFuture<BestHttpResponse<String>> testGet(TestGetHttpMethodsRequest request) {
        return testGet(request, null);
    }

    public CompletableFuture<BestHttpResponse<String>> testGet(
    ...
    public CompletableFuture<BestHttpResponse<TypesObjectWithOptionalField>> testPut(
    ...
    public CompletableFuture<BestHttpResponse<Boolean>> testDelete(TestDeleteHttpMethodsRequest request) {
        return testDelete(request, null);
    }

    public CompletableFuture<BestHttpResponse<Boolean>> testDelete(
    ...
    public CompletableFuture<BestHttpResponse<TypesObjectWithOptionalField>> testPatch(
    ...
    public CompletableFuture<BestHttpResponse<TypesObjectWithOptionalField>> testPost(
