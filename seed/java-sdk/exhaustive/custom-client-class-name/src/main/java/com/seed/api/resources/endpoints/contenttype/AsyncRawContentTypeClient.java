...
public class AsyncRawContentTypeClient {
    ...
    public CompletableFuture<BestHttpResponse<Void>> postJsonPatchContentType(RequestOptions requestOptions) {
        return postJsonPatchContentType(TypesObjectWithOptionalField.builder().build(), requestOptions);
    }

    public CompletableFuture<BestHttpResponse<Void>> postJsonPatchContentType(TypesObjectWithOptionalField request) {
