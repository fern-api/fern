...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/exhaustive)](https://central.sonatype.com/artifact/com.fern/exhaustive)
...
<dependency>
  ...
  <artifactId>exhaustive</artifactId>
...
```java
SeedApiHttpResponse response = client.endpointsContainer().withRawResponse().endpointsContainerGetAndReturnListOfPrimitives(...);
