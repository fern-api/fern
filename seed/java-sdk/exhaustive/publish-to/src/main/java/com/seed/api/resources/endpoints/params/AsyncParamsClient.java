...
public class AsyncParamsClient {
     ...
     * GET with path param
     */
    public CompletableFuture<String> getWithPath(
     ...
     * GET with path param
     */
    public CompletableFuture<String> getWithInlinePath(String param, GetWithInlinePathParamsRequest request) {
     ...
     * PUT to update with path param
     */
    public CompletableFuture<String> modifyWithInlinePath(String param, ModifyWithInlinePathParamsRequest request) {
     ...
     */
    public CompletableFuture<Void> getWithPathAndQuery(String param, GetWithPathAndQueryParamsRequest request) {
