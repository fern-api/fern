...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/nullable-request-body)](https://central.sonatype.com/artifact/com.fern/nullable-request-body)
...
```groovy
dependencies {
  implementation 'com.fern:nullable-request-body:0.0.1'
}
```
...
<dependency>
  ...
  <artifactId>nullable-request-body</artifactId>
