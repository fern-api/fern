...
import com.seed.javaDefaultTimeout.core.Environment;
import com.seed.javaDefaultTimeout.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSeedJavaDefaultTimeoutClientBuilder {
    ...
    public AsyncSeedJavaDefaultTimeoutClientBuilder url(String url) {
     ...
     */
    public AsyncSeedJavaDefaultTimeoutClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSeedJavaDefaultTimeoutClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSeedJavaDefaultTimeoutClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSeedJavaDefaultTimeoutClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSeedJavaDefaultTimeoutClient build() {
        validateConfiguration();
        return new AsyncSeedJavaDefaultTimeoutClient(buildClientOptions());
    }
}
