...
public class SeedJavaDefaultTimeoutClientBuilder {
    ...
    public SeedJavaDefaultTimeoutClientBuilder url(String url) {
     ...
     */
    public SeedJavaDefaultTimeoutClientBuilder timeout(int timeout) {
     ...
     */
    public SeedJavaDefaultTimeoutClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public SeedJavaDefaultTimeoutClientBuilder logging(LogConfig logging) {
     ...
     */
    public SeedJavaDefaultTimeoutClientBuilder addHeader(String name, String value) {
    ...
    public SeedJavaDefaultTimeoutClient build() {
        validateConfiguration();
        return new SeedJavaDefaultTimeoutClient(buildClientOptions());
    }
}
