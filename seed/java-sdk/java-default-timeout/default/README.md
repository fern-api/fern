...
[![Maven Central](https://img.shields.io/maven-central/v/com.fern/java-default-timeout)](https://central.sonatype.com/artifact/com.fern/java-default-timeout)
...
<dependency>
  ...
  <artifactId>java-default-timeout</artifactId>
...
try{
    client.getUser(...);
} catch (SeedJavaDefaultTimeoutApiException e){
...
```java
SeedJavaDefaultTimeoutHttpResponse response = client.withRawResponse().getUser(...);
