...
pub struct RefreshTokenRequest {
    ...
    pub audience: RefreshTokenRequestAudience,
    pub grant_type: RefreshTokenRequestGrantType,
...
pub struct RefreshTokenRequestBuilder {
    ...
    audience: Option<RefreshTokenRequestAudience>,
    grant_type: Option<RefreshTokenRequestGrantType>,
    scope: Option<String>,
}
...
impl RefreshTokenRequestBuilder {
    ...
    pub fn audience(mut self, value: RefreshTokenRequestAudience) -> Self {
        self.audience = Some(value);
        self
    }

    pub fn grant_type(mut self, value: RefreshTokenRequestGrantType) -> Self {
