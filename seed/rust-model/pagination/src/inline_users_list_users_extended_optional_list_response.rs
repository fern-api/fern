...
impl InlineUsersListUsersExtendedOptionalListResponseBuilder {
    pub fn inline_users_user_optional_list_page_fields(mut self, value: InlineUsersUserOptionalListPage) -> Self {
    ...
    pub fn build(self) -> Result<InlineUsersListUsersExtendedOptionalListResponse, BuildError> {
        Ok(InlineUsersListUsersExtendedOptionalListResponse {
            inline_users_user_optional_list_page_fields: self.inline_users_user_optional_list_page_fields.ok_or_else(|| BuildError::missing_field("inline_users_user_optional_list_page_fields"))?,
