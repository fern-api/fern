...
/// Query parameters for inlineUsers_inlineUsers_listWithMixedTypeCursorPagination
...
impl InlineUsersInlineUsersListWithMixedTypeCursorPaginationQueryRequestBuilder {
    ...
    pub fn build(self) -> Result<InlineUsersInlineUsersListWithMixedTypeCursorPaginationQueryRequest, BuildError> {
        Ok(InlineUsersInlineUsersListWithMixedTypeCursorPaginationQueryRequest {
            cursor: self.cursor,
        })
    }
}
