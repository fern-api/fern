...
pub struct InlinedRequestSendRequest {
    pub operand: Operand,
...
impl InlinedRequestSendRequest {
    pub fn builder() -> InlinedRequestSendRequestBuilder {
        <InlinedRequestSendRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct InlinedRequestSendRequestBuilder {
...
impl InlinedRequestSendRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`InlinedRequestSendRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`operand`](InlinedRequestSendRequestBuilder::operand)
    /// - [`operand_or_color`](InlinedRequestSendRequestBuilder::operand_or_color)
    pub fn build(self) -> Result<InlinedRequestSendRequest, BuildError> {
        Ok(InlinedRequestSendRequest {
