...
pub struct FirstItemType {
    ...
    pub r#type: Option<FirstItemTypeType>,
    #[serde(default)]
    pub name: String,
}
...
impl FirstItemType {
    pub fn builder() -> FirstItemTypeBuilder {
        <FirstItemTypeBuilder as Default>::default()
    }
}
...
pub struct FirstItemTypeBuilder {
    r#type: Option<FirstItemTypeType>,
    name: Option<String>,
}

impl FirstItemTypeBuilder {
    pub fn r#type(mut self, value: FirstItemTypeType) -> Self {
