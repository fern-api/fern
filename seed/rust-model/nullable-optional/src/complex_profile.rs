...
impl ComplexProfileBuilder {
    ...
    pub fn build(self) -> Result<ComplexProfile, BuildError> {
        Ok(ComplexProfile {
            ...
            nullable_role: self.nullable_role.ok_or_else(|| BuildError::missing_field("nullable_role"))?,
            optional_role: self.optional_role,
            optional_nullable_role: self.optional_nullable_role,
            nullable_status: self.nullable_status.ok_or_else(|| BuildError::missing_field("nullable_status"))?,
            optional_status: self.optional_status,
            optional_nullable_status: self.optional_nullable_status,
            nullable_notification: self.nullable_notification.ok_or_else(|| BuildError::missing_field("nullable_notification"))?,
            optional_notification: self.optional_notification,
            optional_nullable_notification: self.optional_nullable_notification,
            nullable_search_result: self.nullable_search_result.ok_or_else(|| BuildError::missing_field("nullable_search_result"))?,
