...
pub struct DeserializationTestRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nullable_map: Option<HashMap<String, Option<i64>>>,
    #[serde(rename = "nullableObject")]
    #[serde(default)]
    pub nullable_object: Address,
...
pub struct DeserializationTestRequestBuilder {
    ...
    nullable_map: Option<HashMap<String, Option<i64>>>,
...
impl DeserializationTestRequestBuilder {
    ...
    pub fn nullable_map(mut self, value: HashMap<String, Option<i64>>) -> Self {
    ...
    /// - [`nullable_enum`](DeserializationTestRequestBuilder::nullable_enum)
    /// - [`nullable_union`](DeserializationTestRequestBuilder::nullable_union)
    /// - [`nullable_object`](DeserializationTestRequestBuilder::nullable_object)
    pub fn build(self) -> Result<DeserializationTestRequest, BuildError> {
        Ok(DeserializationTestRequest {
            ...
            nullable_enum: self.nullable_enum.ok_or_else(|| BuildError::missing_field("nullable_enum"))?,
            optional_enum: self.optional_enum,
            nullable_union: self.nullable_union.ok_or_else(|| BuildError::missing_field("nullable_union"))?,
            optional_union: self.optional_union,
            nullable_list: self.nullable_list,
            nullable_map: self.nullable_map,
            nullable_object: self.nullable_object.ok_or_else(|| BuildError::missing_field("nullable_object"))?,
