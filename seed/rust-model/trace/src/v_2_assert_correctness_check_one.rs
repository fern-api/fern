...
pub struct V2AssertCorrectnessCheckOne {
    #[serde(flatten)]
    pub v2void_function_definition_that_takes_actual_result_fields: V2VoidFunctionDefinitionThatTakesActualResult,
...
pub struct V2AssertCorrectnessCheckOneBuilder {
    v2void_function_definition_that_takes_actual_result_fields: Option<V2VoidFunctionDefinitionThatTakesActualResult>,
    r#type: Option<V2AssertCorrectnessCheckOneType>,
}

impl V2AssertCorrectnessCheckOneBuilder {
    pub fn v2void_function_definition_that_takes_actual_result_fields(mut self, value: V2VoidFunctionDefinitionThatTakesActualResult) -> Self {
    ...
    pub fn build(self) -> Result<V2AssertCorrectnessCheckOne, BuildError> {
        Ok(V2AssertCorrectnessCheckOne {
            v2void_function_definition_that_takes_actual_result_fields: self.v2void_function_definition_that_takes_actual_result_fields.ok_or_else(|| BuildError::missing_field("v2void_function_definition_that_takes_actual_result_fields"))?,
