...
impl AssertCorrectnessCheck2 {
    pub fn deep_equality(expected_value_parameter_id: ParameterId2) -> Self {
        Self::DeepEquality { expected_value_parameter_id }
    }

    pub fn custom(additional_parameters: Vec<Parameter2>, code: FunctionImplementationForMultipleLanguages2) -> Self {
        Self::Custom { additional_parameters, code }
    }
}
