...
pub struct V2V3LightweightProblemInfoV2 {
...
impl V2V3LightweightProblemInfoV2 {
    pub fn builder() -> V2V3LightweightProblemInfoV2Builder {
        <V2V3LightweightProblemInfoV2Builder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct V2V3LightweightProblemInfoV2Builder {
...
impl V2V3LightweightProblemInfoV2Builder {
    ...
    /// Consumes the builder and constructs a [`V2V3LightweightProblemInfoV2`].
    /// This method will fail if any of the following fields are not set:
    /// - [`problem_id`](V2V3LightweightProblemInfoV2Builder::problem_id)
    /// - [`problem_name`](V2V3LightweightProblemInfoV2Builder::problem_name)
    /// - [`problem_version`](V2V3LightweightProblemInfoV2Builder::problem_version)
    /// - [`variable_types`](V2V3LightweightProblemInfoV2Builder::variable_types)
    pub fn build(self) -> Result<V2V3LightweightProblemInfoV2, BuildError> {
        Ok(V2V3LightweightProblemInfoV2 {
