...
impl V2V3TestCaseFunctionOneBuilder {
    pub fn v2v3void_function_definition_fields(mut self, value: V2V3VoidFunctionDefinition) -> Self {
    ...
    pub fn build(self) -> Result<V2V3TestCaseFunctionOne, BuildError> {
        Ok(V2V3TestCaseFunctionOne {
            v2v3void_function_definition_fields: self.v2v3void_function_definition_fields.ok_or_else(|| BuildError::missing_field("v2v3void_function_definition_fields"))?,
