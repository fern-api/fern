...
impl CodeExecutionUpdate {
    ...
    pub fn graded(submission_id: SubmissionId, test_cases: HashMap<String, TestCaseResultWithStdout>) -> Self {
    ...
    pub fn workspace_ran(submission_id: SubmissionId, run_details: WorkspaceRunDetails) -> Self {
        Self::WorkspaceRan { submission_id, run_details }
    }

    pub fn recording(submission_id: SubmissionId, line_number: i64, lightweight_stack_info: LightweightStackframeInformation) -> Self {
        Self::Recording { submission_id, test_case_id: None, line_number, lightweight_stack_info, traced_file: None }
    }

    pub fn recorded(submission_id: SubmissionId, trace_responses_size: i64) -> Self {
        Self::Recorded { submission_id, trace_responses_size, test_case_id: None }
    }
