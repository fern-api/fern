...
pub struct V2FunctionSignatureTwo {
    #[serde(flatten)]
    pub v2void_function_signature_that_takes_actual_result_fields: V2VoidFunctionSignatureThatTakesActualResult,
...
pub struct V2FunctionSignatureTwoBuilder {
    v2void_function_signature_that_takes_actual_result_fields: Option<V2VoidFunctionSignatureThatTakesActualResult>,
    r#type: Option<V2FunctionSignatureTwoType>,
}

impl V2FunctionSignatureTwoBuilder {
    pub fn v2void_function_signature_that_takes_actual_result_fields(mut self, value: V2VoidFunctionSignatureThatTakesActualResult) -> Self {
    ...
    pub fn build(self) -> Result<V2FunctionSignatureTwo, BuildError> {
        Ok(V2FunctionSignatureTwo {
            v2void_function_signature_that_takes_actual_result_fields: self.v2void_function_signature_that_takes_actual_result_fields.ok_or_else(|| BuildError::missing_field("v2void_function_signature_that_takes_actual_result_fields"))?,
