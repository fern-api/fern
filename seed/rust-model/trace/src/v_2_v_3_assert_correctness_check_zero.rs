...
impl V2V3AssertCorrectnessCheckZeroBuilder {
    pub fn v2v3deep_equality_correctness_check_fields(mut self, value: V2V3DeepEqualityCorrectnessCheck) -> Self {
    ...
    pub fn build(self) -> Result<V2V3AssertCorrectnessCheckZero, BuildError> {
        Ok(V2V3AssertCorrectnessCheckZero {
            v2v3deep_equality_correctness_check_fields: self.v2v3deep_equality_correctness_check_fields.ok_or_else(|| BuildError::missing_field("v2v3deep_equality_correctness_check_fields"))?,
