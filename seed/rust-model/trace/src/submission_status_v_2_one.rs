...
impl SubmissionStatusV2OneBuilder {
    pub fn workspace_submission_status_v2_fields(mut self, value: WorkspaceSubmissionStatusV2) -> Self {
    ...
    pub fn build(self) -> Result<SubmissionStatusV2One, BuildError> {
        Ok(SubmissionStatusV2One {
            workspace_submission_status_v2_fields: self.workspace_submission_status_v2_fields.ok_or_else(|| BuildError::missing_field("workspace_submission_status_v2_fields"))?,
