...
impl DebugVariableValueSevenBuilder {
    pub fn binary_tree_node_and_tree_value_fields(mut self, value: BinaryTreeNodeAndTreeValue) -> Self {
    ...
    pub fn build(self) -> Result<DebugVariableValueSeven, BuildError> {
        Ok(DebugVariableValueSeven {
            binary_tree_node_and_tree_value_fields: self.binary_tree_node_and_tree_value_fields.ok_or_else(|| BuildError::missing_field("binary_tree_node_and_tree_value_fields"))?,
