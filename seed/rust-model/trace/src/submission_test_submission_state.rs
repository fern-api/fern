...
impl TestSubmissionStateBuilder {
    ...
    pub fn build(self) -> Result<TestSubmissionState, BuildError> {
        Ok(TestSubmissionState {
            ...
            default_test_cases: self.default_test_cases.ok_or_else(|| BuildError::missing_field("default_test_cases"))?,
            custom_test_cases: self.custom_test_cases.ok_or_else(|| BuildError::missing_field("custom_test_cases"))?,
