...
pub struct V2V3TestCaseFunctionZero {
    #[serde(flatten)]
    pub v2v3test_case_with_actual_result_implementation_fields: V2V3TestCaseWithActualResultImplementation,
...
pub struct V2V3TestCaseFunctionZeroBuilder {
    v2v3test_case_with_actual_result_implementation_fields: Option<V2V3TestCaseWithActualResultImplementation>,
    r#type: Option<V2V3TestCaseFunctionZeroType>,
}

impl V2V3TestCaseFunctionZeroBuilder {
    pub fn v2v3test_case_with_actual_result_implementation_fields(mut self, value: V2V3TestCaseWithActualResultImplementation) -> Self {
    ...
    pub fn build(self) -> Result<V2V3TestCaseFunctionZero, BuildError> {
        Ok(V2V3TestCaseFunctionZero {
            v2v3test_case_with_actual_result_implementation_fields: self.v2v3test_case_with_actual_result_implementation_fields.ok_or_else(|| BuildError::missing_field("v2v3test_case_with_actual_result_implementation_fields"))?,
