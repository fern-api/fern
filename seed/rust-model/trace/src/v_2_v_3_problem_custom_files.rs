...
impl CustomFiles2 {
    pub fn basic(method_name: String, signature: NonVoidFunctionSignature2, additional_files: HashMap<Language, Files2>, basic_test_case_template: BasicTestCaseTemplate2) -> Self {
