...
#[non_exhaustive]
pub struct LightweightProblemInfoV2Builder {
...
impl LightweightProblemInfoV2Builder {
    ...
    /// Consumes the builder and constructs a [`LightweightProblemInfoV2`].
    /// This method will fail if any of the following fields are not set:
    /// - [`problem_id`](LightweightProblemInfoV2Builder::problem_id)
    /// - [`problem_name`](LightweightProblemInfoV2Builder::problem_name)
    /// - [`problem_version`](LightweightProblemInfoV2Builder::problem_version)
