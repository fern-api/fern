...
impl InvalidRequestCauseOneBuilder {
    pub fn custom_test_cases_unsupported_fields(mut self, value: CustomTestCasesUnsupported) -> Self {
    ...
    pub fn build(self) -> Result<InvalidRequestCauseOne, BuildError> {
        Ok(InvalidRequestCauseOne {
            custom_test_cases_unsupported_fields: self.custom_test_cases_unsupported_fields.ok_or_else(|| BuildError::missing_field("custom_test_cases_unsupported_fields"))?,
