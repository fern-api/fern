...
pub struct WorkspaceStarterFilesResponseV2 {
    ...
    #[serde(default)]
    pub files_by_language: HashMap<String, V2Files>,
}
...
pub struct WorkspaceStarterFilesResponseV2Builder {
    files_by_language: Option<HashMap<String, V2Files>>,
}

impl WorkspaceStarterFilesResponseV2Builder {
    pub fn files_by_language(mut self, value: HashMap<String, V2Files>) -> Self {
