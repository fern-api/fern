...
impl V2V3FunctionSignatureOneBuilder {
    pub fn v2v3non_void_function_signature_fields(mut self, value: V2V3NonVoidFunctionSignature) -> Self {
    ...
    pub fn build(self) -> Result<V2V3FunctionSignatureOne, BuildError> {
        Ok(V2V3FunctionSignatureOne {
            v2v3non_void_function_signature_fields: self.v2v3non_void_function_signature_fields.ok_or_else(|| BuildError::missing_field("v2v3non_void_function_signature_fields"))?,
