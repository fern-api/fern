...
pub struct V2TestCaseFunctionZero {
    #[serde(flatten)]
    pub v2test_case_with_actual_result_implementation_fields: V2TestCaseWithActualResultImplementation,
...
pub struct V2TestCaseFunctionZeroBuilder {
    v2test_case_with_actual_result_implementation_fields: Option<V2TestCaseWithActualResultImplementation>,
    r#type: Option<V2TestCaseFunctionZeroType>,
}

impl V2TestCaseFunctionZeroBuilder {
    pub fn v2test_case_with_actual_result_implementation_fields(mut self, value: V2TestCaseWithActualResultImplementation) -> Self {
    ...
    pub fn build(self) -> Result<V2TestCaseFunctionZero, BuildError> {
        Ok(V2TestCaseFunctionZero {
            v2test_case_with_actual_result_implementation_fields: self.v2test_case_with_actual_result_implementation_fields.ok_or_else(|| BuildError::missing_field("v2test_case_with_actual_result_implementation_fields"))?,
