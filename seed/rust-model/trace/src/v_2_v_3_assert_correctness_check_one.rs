...
pub struct V2V3AssertCorrectnessCheckOne {
    #[serde(flatten)]
    pub v2v3void_function_definition_that_takes_actual_result_fields: V2V3VoidFunctionDefinitionThatTakesActualResult,
...
pub struct V2V3AssertCorrectnessCheckOneBuilder {
    v2v3void_function_definition_that_takes_actual_result_fields: Option<V2V3VoidFunctionDefinitionThatTakesActualResult>,
    r#type: Option<V2V3AssertCorrectnessCheckOneType>,
}

impl V2V3AssertCorrectnessCheckOneBuilder {
    pub fn v2v3void_function_definition_that_takes_actual_result_fields(mut self, value: V2V3VoidFunctionDefinitionThatTakesActualResult) -> Self {
    ...
    pub fn build(self) -> Result<V2V3AssertCorrectnessCheckOne, BuildError> {
        Ok(V2V3AssertCorrectnessCheckOne {
            v2v3void_function_definition_that_takes_actual_result_fields: self.v2v3void_function_definition_that_takes_actual_result_fields.ok_or_else(|| BuildError::missing_field("v2v3void_function_definition_that_takes_actual_result_fields"))?,
