...
pub struct AuthGetTokenRequest {
    ...
    pub audience: AuthGetTokenRequestAudience,
    pub grant_type: AuthGetTokenRequestGrantType,
}
...
pub struct AuthGetTokenRequestBuilder {
    ...
    audience: Option<AuthGetTokenRequestAudience>,
    grant_type: Option<AuthGetTokenRequestGrantType>,
}
...
impl AuthGetTokenRequestBuilder {
    ...
    pub fn audience(mut self, value: AuthGetTokenRequestAudience) -> Self {
        self.audience = Some(value);
        self
    }

    pub fn grant_type(mut self, value: AuthGetTokenRequestGrantType) -> Self {
    ...
    /// - [`audience`](AuthGetTokenRequestBuilder::audience)
    /// - [`grant_type`](AuthGetTokenRequestBuilder::grant_type)
