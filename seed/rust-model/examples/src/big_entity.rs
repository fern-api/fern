...
pub struct BigEntity {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub common_metadata: Option<CommonsMetadata>,
    #[serde(rename = "eventInfo")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub event_info: Option<CommonsEventInfo>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub data: Option<CommonsData>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl BigEntityBuilder {
    ...
    pub fn common_metadata(mut self, value: CommonsMetadata) -> Self {
        self.common_metadata = Some(value);
        self
    }

    pub fn event_info(mut self, value: CommonsEventInfo) -> Self {
        self.event_info = Some(value);
        self
    }

    pub fn data(mut self, value: CommonsData) -> Self {
