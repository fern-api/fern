...
impl ResponseBuilder {
    ...
    pub fn build(self) -> Result<Response, BuildError> {
        Ok(Response {
            with_metadata_fields: self.with_metadata_fields.ok_or_else(|| BuildError::missing_field("with_metadata_fields"))?,
            with_docs_fields: self.with_docs_fields.ok_or_else(|| BuildError::missing_field("with_docs_fields"))?,
