...
pub struct ServiceOptionalMergePatchTestRequest {
...
impl ServiceOptionalMergePatchTestRequest {
    pub fn builder() -> ServiceOptionalMergePatchTestRequestBuilder {
        <ServiceOptionalMergePatchTestRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ServiceOptionalMergePatchTestRequestBuilder {
...
impl ServiceOptionalMergePatchTestRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ServiceOptionalMergePatchTestRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`required_field`](ServiceOptionalMergePatchTestRequestBuilder::required_field)
    pub fn build(self) -> Result<ServiceOptionalMergePatchTestRequest, BuildError> {
        Ok(ServiceOptionalMergePatchTestRequest {
