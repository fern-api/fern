...
import resources.commons.types.types.Data;
import resources.commons.types.types.EventInfo;
...
public final class BigEntity {
  ...
  private final Optional<resources.commons.types.types.Metadata> commonMetadata;
  ...
  private BigEntity(Optional<CastMember> castMember, Optional<ExtendedMovie> extendedMovie,
      ...
      Optional<resources.commons.types.types.Metadata> commonMetadata,
  ...
  public Optional<resources.commons.types.types.Metadata> getCommonMetadata() {
  ...
  public static final class Builder {
    ...
    private Optional<resources.commons.types.types.Metadata> commonMetadata = Optional.empty();
    ...
    public Builder commonMetadata(Optional<resources.commons.types.types.Metadata> commonMetadata) {
      this.commonMetadata = commonMetadata;
      return this;
    }

    public Builder commonMetadata(resources.commons.types.types.Metadata commonMetadata) {
