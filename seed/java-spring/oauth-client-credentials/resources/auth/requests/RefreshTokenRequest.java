...
public final class RefreshTokenRequest {
  ...
  private RefreshTokenRequest(String clientId, String clientSecret, String refreshToken,
  ...
  private boolean equalTo(RefreshTokenRequest other) {
    return clientId.equals(other.clientId) && clientSecret.equals(other.clientSecret) && refreshToken.equals(other.refreshToken) && scope.equals(other.scope);
  }
  ...
  public static final class Builder implements ClientIdStage, ClientSecretStage, RefreshTokenStage, _FinalStage {
    ...
    public RefreshTokenRequest build() {
      return new RefreshTokenRequest(clientId, clientSecret, refreshToken, scope);
    }
  }
}
