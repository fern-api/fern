...
package resources.headers.requests;
...
@JsonDeserialize(
    builder = SendLiteralsInHeadersRequest.Builder.class
)
public final class SendLiteralsInHeadersRequest {
  private final String query;

  private SendLiteralsInHeadersRequest(String query) {
    this.query = query;
  }
  ...
  public static final class Builder implements QueryStage, _FinalStage {
    ...
    public SendLiteralsInHeadersRequest build() {
      return new SendLiteralsInHeadersRequest(query);
    }
  }
}
