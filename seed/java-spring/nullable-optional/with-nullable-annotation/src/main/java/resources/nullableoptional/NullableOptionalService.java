...
public interface NullableOptionalService {
  ...
  List<UserResponse> filterByRole(@RequestParam("role") UserRole role,
  ...
  NotificationMethod getNotificationSettings(@PathVariable("userId") String userId);
  ...
  List<SearchResult> getSearchResults(@RequestBody SearchRequest body);
}
