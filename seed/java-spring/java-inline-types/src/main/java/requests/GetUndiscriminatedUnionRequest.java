...
import types.UndiscriminatedUnion1;

@JsonInclude(JsonInclude.Include.NON_ABSENT)
@JsonDeserialize(
    builder = GetUndiscriminatedUnionRequest.Builder.class
)
public final class GetUndiscriminatedUnionRequest {
  ...
  private GetUndiscriminatedUnionRequest(UndiscriminatedUnion1 bar, String foo) {
    this.bar = bar;
    this.foo = foo;
  }
  ...
  public static final class Builder implements BarStage, FooStage, _FinalStage {
    ...
    public GetUndiscriminatedUnionRequest build() {
      return new GetUndiscriminatedUnionRequest(bar, foo);
    }
  }
}
