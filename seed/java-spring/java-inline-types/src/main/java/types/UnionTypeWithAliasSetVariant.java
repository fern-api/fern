...
public final class UnionTypeWithAliasSetVariant {
  ...
  public static UnionTypeWithAliasSetVariant aliasVariant(Set<AliasVariant> value) {
  ...
  public Optional<Set<AliasVariant>> getAliasVariant() {
    if (isAliasVariant()) {
  ...
  public interface Visitor<T> {
    T visitAliasVariant(Set<AliasVariant> aliasVariant);
  ...
  private static final class AliasVariantValue implements Value {
    @JsonProperty("value")
    private Set<AliasVariant> value;

    @JsonCreator(
        mode = JsonCreator.Mode.PROPERTIES
    )
    private AliasVariantValue(@JsonProperty("value") Set<AliasVariant> value) {
      this.value = value;
    }
