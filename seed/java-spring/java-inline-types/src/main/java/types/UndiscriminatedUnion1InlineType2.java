...
@JsonDeserialize(
    builder = UndiscriminatedUnion1InlineType2.Builder.class
)
public final class UndiscriminatedUnion1InlineType2 {
  ...
  private UndiscriminatedUnion1InlineType2(String baz, ReferenceType ref) {
    this.baz = baz;
    this.ref = ref;
  }
  ...
  public static final class Builder implements BazStage, RefStage, _FinalStage {
    ...
    public UndiscriminatedUnion1InlineType2 build() {
      return new UndiscriminatedUnion1InlineType2(baz, ref);
    }
  }
}
