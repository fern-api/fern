...
public final class User {
  ...
  private User(String id, String username, Optional<String> email, Optional<Integer> age,
  ...
  private boolean equalTo(User other) {
    return id.equals(other.id) && username.equals(other.username) && email.equals(other.email) && age.equals(other.age) && weight.equals(other.weight) && metadata.equals(other.metadata);
  }
