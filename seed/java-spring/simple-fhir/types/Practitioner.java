...
@JsonDeserialize(
    builder = Practitioner.Builder.class
)
public final class Practitioner implements IBaseResource {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof Practitioner && equalTo((Practitioner) other);
  }
  ...
  public static final class Builder implements IdStage, MemoStage, NameStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(Practitioner other) {
      id(other.getId());
