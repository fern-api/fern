...
public final class GetTokenRequest {
  ...
  private GetTokenRequest(String cid, String csr, String scp, String entityId,
  ...
  private boolean equalTo(GetTokenRequest other) {
    return cid.equals(other.cid) && csr.equals(other.csr) && scp.equals(other.scp) && entityId.equals(other.entityId) && scope.equals(other.scope);
  }
  ...
  public static final class Builder implements CidStage, CsrStage, ScpStage, EntityIdStage, _FinalStage {
    ...
    public GetTokenRequest build() {
      return new GetTokenRequest(cid, csr, scp, entityId, scope);
    }
  }
}
