...
@JsonDeserialize(
    builder = UndiscriminatedUnion1InlineListItem1.Builder.class
)
public final class UndiscriminatedUnion1InlineListItem1 {
  private final String foo;

  private final ReferenceType ref;

  private UndiscriminatedUnion1InlineListItem1(String foo, ReferenceType ref) {
    this.foo = foo;
    this.ref = ref;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof UndiscriminatedUnion1InlineListItem1 && equalTo((UndiscriminatedUnion1InlineListItem1) other);
  }
  ...
  public static final class Builder implements FooStage, RefStage, _FinalStage {
    ...
    public UndiscriminatedUnion1InlineListItem1 build() {
      return new UndiscriminatedUnion1InlineListItem1(foo, ref);
    }
  }
}
