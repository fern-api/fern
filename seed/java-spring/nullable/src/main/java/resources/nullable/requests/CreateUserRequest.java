...
import resources.nullable.types.Metadata;
...
public final class CreateUserRequest {
  ...
  private CreateUserRequest(String username, Optional<List<String>> tags,
      Optional<Metadata> metadata, Optional<String> avatar) {
  ...
  private boolean equalTo(CreateUserRequest other) {
    return username.equals(other.username) && tags.equals(other.tags) && metadata.equals(other.metadata) && avatar.equals(other.avatar);
  }
  ...
  public static final class Builder implements UsernameStage, _FinalStage {
    ...
    public CreateUserRequest build() {
      return new CreateUserRequest(username, tags, metadata, avatar);
    }
  }
}
