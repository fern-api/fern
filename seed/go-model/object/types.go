...
type TypeEighteen string

const (
	TypeEighteenEighteen = "eighteen"
)

func NewTypeEighteenFromString(s string) (TypeEighteen, error) {
	switch s {
	case "eighteen":
		return TypeEighteenEighteen, nil
	}
	var t TypeEighteen
	return "", fmt.Errorf("%s is not a valid %T", s, t)
}

func (t TypeEighteen) Ptr() *TypeEighteen {
	return &t
}
...
type Type struct {
	...
	Eight       string           `json:"eight" url:"eight"`
	Nine        string           `json:"nine" url:"nine"`
	...
	Seventeen   []*string        `json:"seventeen" url:"seventeen"`
	Eighteen    *TypeEighteen    `json:"eighteen" url:"eighteen"`
	Nineteen    *Name            `json:"nineteen" url:"nineteen"`
	Twenty      int64            `json:"twenty" url:"twenty"`
	Twentyone   int64            `json:"twentyone" url:"twentyone"`
	Twentytwo   float64          `json:"twentytwo" url:"twentytwo"`
	Twentythree int              `json:"twentythree" url:"twentythree"`
...
func (t *Type) GetSeventeen() []*string {
	if t == nil {
		return nil
	}
	return t.Seventeen
...
func (t *Type) GetEighteen() *TypeEighteen {
	if t == nil {
		return nil
	}
	return t.Eighteen
...
func (t *Type) GetTwentythree() int {
	if t == nil {
		return 0
	}
