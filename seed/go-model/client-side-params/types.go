...
func (u *User) UnmarshalJSON(
	...
	var unmarshaler = struct {
		...
		CreatedAt *internal.DateTime `json:"created_at"`
		UpdatedAt *internal.DateTime `json:"updated_at"`
		LastLogin *internal.DateTime `json:"last_login"`
	}{
		embed: embed(*u),
	}
	if err := json.Unmarshal(data, &unmarshaler); err != nil {
...
func (i *Identity) GetExtraProperties() map[string]any {
	if i == nil {
		return nil
	}
...
func (p *PaginatedUserResponse) GetExtraProperties() map[string]any {
	if p == nil {
		return nil
	}
...
func (p *PaginatedUserResponse) UnmarshalJSON(
	data []byte,
) error {
...
func (c *Connection) GetExtraProperties() map[string]any {
	if c == nil {
		return nil
	}
	return c.extraProperties
...
func (c *Connection) UnmarshalJSON(
	data []byte,
) error {
...
func (c *Client) GetExtraProperties() map[string]any {
	if c == nil {
		return nil
	}
	return c.extraProperties
...
func (p *PaginatedClientResponse) GetExtraProperties() map[string]any {
	if p == nil {
		return nil
	}
	return p.extraProperties
...
func (p *PaginatedClientResponse) UnmarshalJSON(
	data []byte,
) error {
