...
```go
response, err := client.Items.CreateItem(...)
if err != nil {
...
```go
response, err := client.Items.WithRawResponse.CreateItem(...)
if err != nil {
    return err
}
...
response, err := client.Items.CreateItem(ctx, ...)
```
...
response, err := client.Items.CreateItem(ctx, request, ...)
```
