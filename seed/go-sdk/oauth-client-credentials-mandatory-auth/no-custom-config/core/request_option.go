...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/oauth-client-credentials-mandatory-auth/fern")
	headers.Set("X-Fern-SDK-Version", "v0.0.1")
	headers.Set("User-Agent", "github.com/oauth-client-credentials-mandatory-auth/fern/0.0.1")
	return headers
}
