...
type CreateUserRequest struct {
	...
	UserMetadata  map[string]any `json:"user_metadata,omitempty" url:"-"`
	AppMetadata   map[string]any `json:"app_metadata,omitempty" url:"-"`
...
var (
	serviceDeleteUserRequestFieldUserID = big.NewInt(1 << 0)
)

type ServiceDeleteUserRequest struct {
...
func (s *ServiceDeleteUserRequest) require(field *big.Int) {
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceDeleteUserRequest) SetUserID(userID string) {
	s.UserID = userID
	s.require(serviceDeleteUserRequestFieldUserID)
}

var (
	serviceGetClientRequestFieldClientID      = big.NewInt(1 << 0)
	serviceGetClientRequestFieldFields        = big.NewInt(1 << 1)
	serviceGetClientRequestFieldIncludeFields = big.NewInt(1 << 2)
)

type ServiceGetClientRequest struct {
...
func (s *ServiceGetClientRequest) require(field *big.Int) {
	if s.explicitFields == nil {
		s.explicitFields = big.NewInt(0)
	}
	s.explicitFields.Or(s.explicitFields, field)
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceGetClientRequest) SetClientID(clientID string) {
	s.ClientID = clientID
	s.require(serviceGetClientRequestFieldClientID)
}

// SetFields sets the Fields field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceGetClientRequest) SetFields(fields *string) {
	s.Fields = fields
	s.require(serviceGetClientRequestFieldFields)
}

// SetIncludeFields sets the IncludeFields field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceGetClientRequest) SetIncludeFields(includeFields *bool) {
	s.IncludeFields = includeFields
	s.require(serviceGetClientRequestFieldIncludeFields)
}

var (
	serviceGetConnectionRequestFieldConnectionID = big.NewInt(1 << 0)
	serviceGetConnectionRequestFieldFields       = big.NewInt(1 << 1)
)

type ServiceGetConnectionRequest struct {
	ConnectionID string `json:"-" url:"-"`
	// Comma-separated list of fields to include
	Fields *string `json:"-" url:"fields,omitempty"`
...
func (s *ServiceGetConnectionRequest) require(field *big.Int) {
	if s.explicitFields == nil {
		s.explicitFields = big.NewInt(0)
	}
	s.explicitFields.Or(s.explicitFields, field)
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceGetConnectionRequest) SetConnectionID(connectionID string) {
	s.ConnectionID = connectionID
	s.require(serviceGetConnectionRequestFieldConnectionID)
}

// SetFields sets the Fields field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceGetConnectionRequest) SetFields(fields *string) {
	s.Fields = fields
	s.require(serviceGetConnectionRequestFieldFields)
}

var (
	serviceGetResourceRequestFieldResourceID      = big.NewInt(1 << 0)
	serviceGetResourceRequestFieldIncludeMetadata = big.NewInt(1 << 1)
	serviceGetResourceRequestFieldFormat          = big.NewInt(1 << 2)
)
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceGetResourceRequest) SetIncludeMetadata(includeMetadata bool) {
	s.IncludeMetadata = includeMetadata
	s.require(serviceGetResourceRequestFieldIncludeMetadata)
}

// SetFormat sets the Format field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceGetResourceRequest) SetFormat(format string) {
	s.Format = format
	s.require(serviceGetResourceRequestFieldFormat)
}

var (
	serviceGetUserByIDRequestFieldUserID        = big.NewInt(1 << 0)
	serviceGetUserByIDRequestFieldFields        = big.NewInt(1 << 1)
	serviceGetUserByIDRequestFieldIncludeFields = big.NewInt(1 << 2)
)

type ServiceGetUserByIDRequest struct {
	UserID string `json:"-" url:"-"`
...
func (s *ServiceGetUserByIDRequest) require(field *big.Int) {
	if s.explicitFields == nil {
		s.explicitFields = big.NewInt(0)
	}
	s.explicitFields.Or(s.explicitFields, field)
...
// SetUserID sets the UserID field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceGetUserByIDRequest) SetUserID(userID string) {
	s.UserID = userID
	s.require(serviceGetUserByIDRequestFieldUserID)
}

// SetFields sets the Fields field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceGetUserByIDRequest) SetFields(fields *string) {
	s.Fields = fields
	s.require(serviceGetUserByIDRequestFieldFields)
}

// SetIncludeFields sets the IncludeFields field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceGetUserByIDRequest) SetIncludeFields(includeFields *bool) {
	s.IncludeFields = includeFields
	s.require(serviceGetUserByIDRequestFieldIncludeFields)
}

var (
	serviceListClientsRequestFieldFields        = big.NewInt(1 << 0)
	serviceListClientsRequestFieldIncludeFields = big.NewInt(1 << 1)
	serviceListClientsRequestFieldPage          = big.NewInt(1 << 2)
	serviceListClientsRequestFieldPerPage       = big.NewInt(1 << 3)
	serviceListClientsRequestFieldIncludeTotals = big.NewInt(1 << 4)
	serviceListClientsRequestFieldIsGlobal      = big.NewInt(1 << 5)
	serviceListClientsRequestFieldIsFirstParty  = big.NewInt(1 << 6)
	serviceListClientsRequestFieldAppType       = big.NewInt(1 << 7)
)

type ServiceListClientsRequest struct {
	// Comma-separated list of fields to include
	Fields *string `json:"-" url:"fields,omitempty"`
	// Whether specified fields are included or excluded
	IncludeFields *bool `json:"-" url:"include_fields,omitempty"`
...
func (s *ServiceListClientsRequest) require(field *big.Int) {
	if s.explicitFields == nil {
		s.explicitFields = big.NewInt(0)
	}
	s.explicitFields.Or(s.explicitFields, field)
...
// SetFields sets the Fields field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListClientsRequest) SetFields(fields *string) {
	s.Fields = fields
	s.require(serviceListClientsRequestFieldFields)
}

// SetIncludeFields sets the IncludeFields field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListClientsRequest) SetIncludeFields(includeFields *bool) {
	s.IncludeFields = includeFields
	s.require(serviceListClientsRequestFieldIncludeFields)
}

// SetPage sets the Page field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListClientsRequest) SetPage(page *int) {
	s.Page = page
	s.require(serviceListClientsRequestFieldPage)
}

// SetPerPage sets the PerPage field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListClientsRequest) SetPerPage(perPage *int) {
	s.PerPage = perPage
	s.require(serviceListClientsRequestFieldPerPage)
}

// SetIncludeTotals sets the IncludeTotals field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListClientsRequest) SetIncludeTotals(includeTotals *bool) {
	s.IncludeTotals = includeTotals
	s.require(serviceListClientsRequestFieldIncludeTotals)
}

// SetIsGlobal sets the IsGlobal field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListClientsRequest) SetIsGlobal(isGlobal *bool) {
	s.IsGlobal = isGlobal
	s.require(serviceListClientsRequestFieldIsGlobal)
}

// SetIsFirstParty sets the IsFirstParty field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListClientsRequest) SetIsFirstParty(isFirstParty *bool) {
	s.IsFirstParty = isFirstParty
	s.require(serviceListClientsRequestFieldIsFirstParty)
}

// SetAppType sets the AppType field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListClientsRequest) SetAppType(appType []string) {
	s.AppType = appType
	s.require(serviceListClientsRequestFieldAppType)
}

var (
	serviceListConnectionsRequestFieldStrategy = big.NewInt(1 << 0)
	serviceListConnectionsRequestFieldName     = big.NewInt(1 << 1)
	serviceListConnectionsRequestFieldFields   = big.NewInt(1 << 2)
)

type ServiceListConnectionsRequest struct {
...
func (s *ServiceListConnectionsRequest) require(field *big.Int) {
	if s.explicitFields == nil {
		s.explicitFields = big.NewInt(0)
	}
	s.explicitFields.Or(s.explicitFields, field)
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListConnectionsRequest) SetStrategy(strategy *string) {
	s.Strategy = strategy
	s.require(serviceListConnectionsRequestFieldStrategy)
}

// SetName sets the Name field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListConnectionsRequest) SetName(name *string) {
	s.Name = name
	s.require(serviceListConnectionsRequestFieldName)
}

// SetFields sets the Fields field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListConnectionsRequest) SetFields(fields *string) {
	s.Fields = fields
	s.require(serviceListConnectionsRequestFieldFields)
}

var (
	serviceListResourcesRequestFieldPage          = big.NewInt(1 << 0)
	serviceListResourcesRequestFieldPerPage       = big.NewInt(1 << 1)
	serviceListResourcesRequestFieldSort          = big.NewInt(1 << 2)
	serviceListResourcesRequestFieldOrder         = big.NewInt(1 << 3)
	serviceListResourcesRequestFieldIncludeTotals = big.NewInt(1 << 4)
	serviceListResourcesRequestFieldFields        = big.NewInt(1 << 5)
	serviceListResourcesRequestFieldSearch        = big.NewInt(1 << 6)
)
...
// SetPage sets the Page field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListResourcesRequest) SetPage(page int) {
	s.Page = page
	s.require(serviceListResourcesRequestFieldPage)
}

// SetPerPage sets the PerPage field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListResourcesRequest) SetPerPage(perPage int) {
	s.PerPage = perPage
	s.require(serviceListResourcesRequestFieldPerPage)
}

// SetSort sets the Sort field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListResourcesRequest) SetSort(sort string) {
	s.Sort = sort
	s.require(serviceListResourcesRequestFieldSort)
}

// SetOrder sets the Order field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListResourcesRequest) SetOrder(order string) {
	s.Order = order
	s.require(serviceListResourcesRequestFieldOrder)
}

// SetIncludeTotals sets the IncludeTotals field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListResourcesRequest) SetIncludeTotals(includeTotals bool) {
	s.IncludeTotals = includeTotals
	s.require(serviceListResourcesRequestFieldIncludeTotals)
}

// SetFields sets the Fields field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListResourcesRequest) SetFields(fields *string) {
	s.Fields = fields
	s.require(serviceListResourcesRequestFieldFields)
}

// SetSearch sets the Search field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListResourcesRequest) SetSearch(search *string) {
	s.Search = search
	s.require(serviceListResourcesRequestFieldSearch)
}

var (
	serviceListUsersRequestFieldPage          = big.NewInt(1 << 0)
	serviceListUsersRequestFieldPerPage       = big.NewInt(1 << 1)
	serviceListUsersRequestFieldIncludeTotals = big.NewInt(1 << 2)
	serviceListUsersRequestFieldSort          = big.NewInt(1 << 3)
	serviceListUsersRequestFieldConnection    = big.NewInt(1 << 4)
	serviceListUsersRequestFieldQ             = big.NewInt(1 << 5)
	serviceListUsersRequestFieldSearchEngine  = big.NewInt(1 << 6)
	serviceListUsersRequestFieldFields        = big.NewInt(1 << 7)
)

type ServiceListUsersRequest struct {
...
func (s *ServiceListUsersRequest) require(field *big.Int) {
	if s.explicitFields == nil {
		s.explicitFields = big.NewInt(0)
	}
	s.explicitFields.Or(s.explicitFields, field)
...
// SetPage sets the Page field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListUsersRequest) SetPage(page *int) {
	s.Page = page
	s.require(serviceListUsersRequestFieldPage)
}

// SetPerPage sets the PerPage field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListUsersRequest) SetPerPage(perPage *int) {
	s.PerPage = perPage
	s.require(serviceListUsersRequestFieldPerPage)
}

// SetIncludeTotals sets the IncludeTotals field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListUsersRequest) SetIncludeTotals(includeTotals *bool) {
	s.IncludeTotals = includeTotals
	s.require(serviceListUsersRequestFieldIncludeTotals)
}

// SetSort sets the Sort field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListUsersRequest) SetSort(sort *string) {
	s.Sort = sort
	s.require(serviceListUsersRequestFieldSort)
}

// SetConnection sets the Connection field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListUsersRequest) SetConnection(connection *string) {
	s.Connection = connection
	s.require(serviceListUsersRequestFieldConnection)
}

// SetQ sets the Q field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListUsersRequest) SetQ(q *string) {
	s.Q = q
	s.require(serviceListUsersRequestFieldQ)
}

// SetSearchEngine sets the SearchEngine field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListUsersRequest) SetSearchEngine(searchEngine *string) {
	s.SearchEngine = searchEngine
	s.require(serviceListUsersRequestFieldSearchEngine)
}

// SetFields sets the Fields field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceListUsersRequest) SetFields(fields *string) {
	s.Fields = fields
	s.require(serviceListUsersRequestFieldFields)
}

var (
	serviceSearchResourcesRequestFieldLimit   = big.NewInt(1 << 0)
	serviceSearchResourcesRequestFieldOffset  = big.NewInt(1 << 1)
	serviceSearchResourcesRequestFieldQuery   = big.NewInt(1 << 2)
	serviceSearchResourcesRequestFieldFilters = big.NewInt(1 << 3)
)

type ServiceSearchResourcesRequest struct {
...
func (s *ServiceSearchResourcesRequest) require(field *big.Int) {
	if s.explicitFields == nil {
		s.explicitFields = big.NewInt(0)
	}
	s.explicitFields.Or(s.explicitFields, field)
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceSearchResourcesRequest) SetLimit(limit int) {
	s.Limit = limit
	s.require(serviceSearchResourcesRequestFieldLimit)
}

// SetOffset sets the Offset field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceSearchResourcesRequest) SetOffset(offset int) {
	s.Offset = offset
	s.require(serviceSearchResourcesRequestFieldOffset)
}

// SetQuery sets the Query field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceSearchResourcesRequest) SetQuery(query *string) {
	s.Query = query
	s.require(serviceSearchResourcesRequestFieldQuery)
}

// SetFilters sets the Filters field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *ServiceSearchResourcesRequest) SetFilters(filters map[string]any) {
	s.Filters = filters
	s.require(serviceSearchResourcesRequestFieldFilters)
}

func (s *ServiceSearchResourcesRequest) UnmarshalJSON(data []byte) error {
	type unmarshaler ServiceSearchResourcesRequest
	var body unmarshaler
	if err := json.Unmarshal(data, &body); err != nil {
		return err
	}
	*s = ServiceSearchResourcesRequest(body)
	return nil
}

func (s *ServiceSearchResourcesRequest) MarshalJSON() ([]byte, error) {
	type embed ServiceSearchResourcesRequest
	var marshaler = struct {
		embed
	}{
		embed: embed(*s),
...
var (
	...
	updateUserRequestFieldEmailVerified = big.NewInt(1 << 2)
	updateUserRequestFieldUsername      = big.NewInt(1 << 3)
	updateUserRequestFieldPhoneNumber   = big.NewInt(1 << 4)
	updateUserRequestFieldPhoneVerified = big.NewInt(1 << 5)
	updateUserRequestFieldUserMetadata  = big.NewInt(1 << 6)
	updateUserRequestFieldAppMetadata   = big.NewInt(1 << 7)
	updateUserRequestFieldPassword      = big.NewInt(1 << 8)
	updateUserRequestFieldBlocked       = big.NewInt(1 << 9)
)
