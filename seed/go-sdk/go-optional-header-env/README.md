...
```go
response, err := client.Service.GetWithAPIVersion(...)
if err != nil {
...
```go
response, err := client.Service.WithRawResponse.GetWithAPIVersion(...)
if err != nil {
    return err
}
...
response, err := client.Service.GetWithAPIVersion(ctx, ...)
```
...
response, err := client.Service.GetWithAPIVersion(ctx, request, ...)
```
