...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/query-parameters-openapi-as-objects/fern")
	headers.Set("X-Fern-SDK-Version", "v0.0.1")
	headers.Set("User-Agent", "github.com/query-parameters-openapi-as-objects/fern/0.0.1")
	return headers
}
