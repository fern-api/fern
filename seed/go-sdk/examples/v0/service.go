...
func NewCommonsDataFromFieldString(value *CommonsDataString) *CommonsData {
	return &CommonsData{Type: "string", FieldString: value}
}

func NewCommonsDataFromBase64(value *CommonsDataBase64) *CommonsData {
	return &CommonsData{Type: "base64", Base64: value}
}
...
func NewCommonsEventInfoFromCommonsEventInfoZero(value *CommonsEventInfoZero) *CommonsEventInfo {
	return &CommonsEventInfo{typ: "CommonsEventInfoZero", CommonsEventInfoZero: value}
}

func NewCommonsEventInfoFromCommonsEventInfoType(value *CommonsEventInfoType) *CommonsEventInfo {
	return &CommonsEventInfo{typ: "CommonsEventInfoType", CommonsEventInfoType: value}
}
...
func NewMetadataFromHTML(value *MetadataHTML) *Metadata {
	return &Metadata{Type: "html", HTML: value}
}

func NewMetadataFromMarkdown(value *MetadataMarkdown) *Metadata {
...
func NewTestFromAnd(value *TestAnd) *Test {
	return &Test{Type: "and", And: value}
}

func NewTestFromOr(value *TestOr) *Test {
