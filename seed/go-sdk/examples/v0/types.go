...
func NewExceptionFromExceptionZero(value *ExceptionZero) *Exception {
	return &Exception{typ: "ExceptionZero", ExceptionZero: value}
}

func NewExceptionFromExceptionType(value *ExceptionType) *Exception {
	return &Exception{typ: "ExceptionType", ExceptionType: value}
}
