...
// WithConnectTimeout overrides, for this request, the maximum duration to
// wait for a connection to be established (including TLS handshake).
func WithConnectTimeout(timeout time.Duration) *core.ConnectTimeoutOption {
	return &core.ConnectTimeoutOption{
		ConnectTimeout: timeout,
	}
}

// WithReadTimeout overrides, for this request, the maximum duration to
// wait for response headers and between reads of the response body.
func WithReadTimeout(timeout time.Duration) *core.ReadTimeoutOption {
	return &core.ReadTimeoutOption{
		ReadTimeout: timeout,
	}
}

// WithWriteTimeout overrides, for this request, the maximum duration to
// wait when writing the request body. This is an approximation; see the
// package documentation for details.
func WithWriteTimeout(timeout time.Duration) *core.WriteTimeoutOption {
	return &core.WriteTimeoutOption{
