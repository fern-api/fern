...
// WithUserAgentAppInfo appends an application product token to the User-Agent
// header sent by the client ("{name}/{version} ({comment})", RFC 9110). The
// version and comment are optional; pass "" to omit them. Caller-supplied
// values are sanitized before being written to the header.
func WithUserAgentAppInfo(name, version, comment string) *core.AppInfoOption {
	return &core.AppInfoOption{
