...
func TestAuthGetTokenWithClientCredentialsWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/token")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    ...
                    "properties": {
                        "client_id": {"type": "string"}, "client_secret": {"type": "string"}, "audience": {"type": "string", "const": "https://api.example.com"}, "grant_type": {"type": "string", "const": "client_credentials"}
                    },
                    "additionalProperties": true
                }`, "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"access_token": "access_token", "expires_in": 1, "refresh_token": "refresh_token"},
...
func TestAuthRefreshTokenWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/token/refresh")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": ["client_id", "client_secret", "refresh_token", "audience", "grant_type"],
                    "properties": {
                        "client_id": {"type": "string"}, "client_secret": {"type": "string"}, "refresh_token": {"type": "string"}, "audience": {"type": "string", "const": "https://api.example.com"}, "grant_type": {"type": "string", "const": "refresh_token"}
                    },
                    "additionalProperties": true
                }`, "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
