...
func TestServiceEndpointWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/container/")).WillReturnResponse(
	...
	invocationErr := client.Service.Endpoint(
		context.TODO(),
	)
