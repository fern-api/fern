...
func TestSettersAuthGetTokenRequest(t *testing.T) {
	...
	t.Run("SetGrantType", func(t *testing.T) {
		obj := &AuthGetTokenRequest{}
		var fernTestValueGrantType AuthGetTokenRequestGrantType
...
func TestEnumAuthGetTokenRequestGrantType(t *testing.T) {
	t.Run("NewFromString_client_credentials", func(t *testing.T) {
		t.Parallel()
		val, err := NewAuthGetTokenRequestGrantTypeFromString("client_credentials")
		assert.NoError(t, err, "valid enum value should not return error")
		assert.Equal(t, AuthGetTokenRequestGrantType("client_credentials"), val, "enum value should match expected wire value")
	})

	t.Run("NewFromString_Invalid", func(t *testing.T) {
		_, err := NewAuthGetTokenRequestGrantTypeFromString("invalid_value_that_does_not_exist")
		assert.Error(t, err)
	})
