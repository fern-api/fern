...
func TestEndpointsPutAddWithWireMock(
	...
	stub := gowiremock.Put(gowiremock.URLPathTemplate("/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"errors": []interface{}{map[string]interface{}{"category": "API_ERROR", "code": "INTERNAL_SERVER_ERROR", "detail": "detail", "field": "field"}, map[string]interface{}{"category": "API_ERROR", "code": "INTERNAL_SERVER_ERROR", "detail": "detail", "field": "field"}}},
