...
func TestEndpointsUrlsWithMixedCaseWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/urls/MixedCase")).WillReturnResponse(
...
func TestEndpointsUrlsNoEndingSlashWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/urls/no-ending-slash")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			"string",
		).WithStatus(http.StatusOK),
	)
...
func TestEndpointsUrlsWithEndingSlashWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/urls/with-ending-slash/")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			"string",
		).WithStatus(http.StatusOK),
	)
...
func TestEndpointsUrlsWithUnderscoresWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/urls/with_underscores")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			"string",
		).WithStatus(http.StatusOK),
	)
