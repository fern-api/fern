...
func TestEndpointsPrimitiveGetAndReturnDateWithWireMock(
    ...
    _, invocationErr :=     client.Endpoints.Primitive.GetAndReturnDate(
            ...
            request,
            option.WithHTTPHeader(
                http.Header{"X-Test-Id": []string{"TestEndpointsPrimitiveGetAndReturnDateWithWireMock"}},
            ),
        )

    require.NoError(t, invocationErr, "Client method call should succeed")
    VerifyRequestCount(t, "TestEndpointsPrimitiveGetAndReturnDateWithWireMock", "POST", "/primitive/date", nil, 1)
}
