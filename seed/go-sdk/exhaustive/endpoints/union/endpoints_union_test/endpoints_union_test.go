...
func TestEndpointsUnionGetAndReturnUnionWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/union")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"animal": "dog", "name": "name", "likesToWoof": true},
