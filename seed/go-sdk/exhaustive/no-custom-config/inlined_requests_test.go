...
func TestSettersPostWithObjectBodyandResponseInlinedRequestsRequest(t *testing.T) {
	t.Run("SetFieldString", func(t *testing.T) {
		obj := &PostWithObjectBodyandResponseInlinedRequestsRequest{}
...
func TestSettersMarkExplicitPostWithObjectBodyandResponseInlinedRequestsRequest(t *testing.T) {
