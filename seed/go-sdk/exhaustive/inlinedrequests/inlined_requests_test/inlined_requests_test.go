...
func TestInlinedRequestsPostWithObjectBodyandResponseWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/req-bodies/object")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": ["string", "integer", "NestedObject"],
                    "properties": {
                        "string": {"type": "string"}, "integer": {"type": "integer"}, "NestedObject": {"type": "object"}
                    },
