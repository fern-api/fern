...
func TestSettersCreateWithBodyAndQuery(t *testing.T) {
	t.Run("SetFields", func(t *testing.T) {
		obj := &CreateWithBodyAndQuery{}
...
func TestSettersMarkExplicitCreateWithBodyAndQuery(t *testing.T) {
...
func TestSettersUploadBytesWithQuery(t *testing.T) {
	t.Run("SetFields", func(t *testing.T) {
		obj := &UploadBytesWithQuery{}
		var fernTestValueFields *string
		obj.SetFields(fernTestValueFields)
		assert.Equal(t, fernTestValueFields, obj.Fields)
		assert.NotNil(t, obj.explicitFields)
...
func TestSettersMarkExplicitUploadBytesWithQuery(t *testing.T) {
	t.Run("SetFields_MarksExplicit", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &UploadBytesWithQuery{}
