...
func NewAliasedObjectUnionFromAliasedLeafA(value AliasedLeafA) *AliasedObjectUnion {
	return &AliasedObjectUnion{typ: "AliasedLeafA", AliasedLeafA: value}
}

func NewAliasedObjectUnionFromAliasedLeafB(value AliasedLeafB) *AliasedObjectUnion {
	return &AliasedObjectUnion{typ: "AliasedLeafB", AliasedLeafB: value}
}
...
func NewNestedObjectUnionFromLeafTypeA(value *LeafTypeA) *NestedObjectUnion {
	return &NestedObjectUnion{typ: "LeafTypeA", LeafTypeA: value}
}

func NewNestedObjectUnionFromLeafTypeB(value *LeafTypeB) *NestedObjectUnion {
	return &NestedObjectUnion{typ: "LeafTypeB", LeafTypeB: value}
}
...
func NewOuterNestedUnionFromString(value string) *OuterNestedUnion {
	return &OuterNestedUnion{typ: "String", String: value}
}

func NewOuterNestedUnionFromWrapperObject(value *WrapperObject) *OuterNestedUnion {
	return &OuterNestedUnion{typ: "WrapperObject", WrapperObject: value}
}
...
type WrapperObject struct {
	Inner *NestedObjectUnion `json:"inner,omitempty" url:"inner,omitempty"`
