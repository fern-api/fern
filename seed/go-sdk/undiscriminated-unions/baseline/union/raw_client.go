...
func (r *RawClient) AliasedObjectUnion(
	ctx context.Context,
	...
	endpointURL := baseURL + "/aliased-object"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
...
func (r *RawClient) GetWithBaseProperties(
	...
	opts ...option.RequestOption,
) (*core.Response[*undiscriminated.UnionWithBaseProperties], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	var response *undiscriminated.UnionWithBaseProperties
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*undiscriminated.UnionWithBaseProperties]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
