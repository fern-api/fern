...
```go
response, err := client.Payment.CreatePayment(...)
if err != nil {
...
```go
response, err := client.Payment.WithRawResponse.CreatePayment(...)
if err != nil {
    return err
}
...
response, err := client.Payment.CreatePayment(ctx, ...)
```
...
response, err := client.Payment.CreatePayment(ctx, request, ...)
```
