...
func TestAuthGetTokenWithClientCredentialsWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/token")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    ...
                    "type": "object",
                    "required": ["cid", "csr", "scp", "entity_id", "audience", "grant_type"],
                    "properties": {
                        "cid": {"type": "string"}, "csr": {"type": "string"}, "scp": {"type": "string"}, "entity_id": {"type": "string"}, "audience": {"type": "string", "const": "https://api.example.com"}, "grant_type": {"type": "string", "const": "client_credentials"}
                    },
