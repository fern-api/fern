...
```go
response, err := client.Oauth.Authorize(...)
if err != nil {
...
```go
response, err := client.Oauth.WithRawResponse.Authorize(...)
if err != nil {
    return err
}
...
response, err := client.Oauth.Authorize(ctx, ...)
```
...
response, err := client.Oauth.Authorize(ctx, request, ...)
```
