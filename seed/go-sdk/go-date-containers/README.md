...
```go
response, err := client.Loans.GetLoan(...)
if err != nil {
...
```go
response, err := client.Loans.WithRawResponse.GetLoan(...)
if err != nil {
    return err
}
...
response, err := client.Loans.GetLoan(ctx, ...)
```
...
response, err := client.Loans.GetLoan(ctx, request, ...)
```
