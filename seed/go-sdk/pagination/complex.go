...
var (
	searchRequestFieldIndex      = big.NewInt(1 << 0)
	searchRequestFieldPagination = big.NewInt(1 << 1)
	searchRequestFieldQuery      = big.NewInt(1 << 2)
)

type SearchRequest struct {
	Index      string               `json:"-" url:"-"`
	Pagination *StartingAfterPaging `json:"pagination,omitempty" url:"-"`
	Query      *SearchRequestQuery  `json:"query" url:"-"`
...
func (s *SearchRequest) SetIndex(index string) {
	s.Index = index
	s.require(searchRequestFieldIndex)
}
...
var (
	...
	cursorPagesFieldType       = big.NewInt(1 << 4)
)
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CursorPages) SetType(type_ CursorPagesType) {
	c.Type = type_
	c.require(cursorPagesFieldType)
}
...
var (
	...
	paginatedConversationResponseFieldType          = big.NewInt(1 << 3)
)
...
// SetType sets the Type field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PaginatedConversationResponse) SetType(type_ PaginatedConversationResponseType) {
	p.Type = type_
	p.require(paginatedConversationResponseFieldType)
}
...
const (
	PaginatedConversationResponseTypeConversationList PaginatedConversationResponseType = "conversation.list"
)
...
const (
	SingleFilterSearchRequestOperatorEqualTo     SingleFilterSearchRequestOperator = "="
	...
	SingleFilterSearchRequestOperatorNotTilde    SingleFilterSearchRequestOperator = "!~"
	SingleFilterSearchRequestOperatorCaret       SingleFilterSearchRequestOperator = "^"
	SingleFilterSearchRequestOperatorDollar      SingleFilterSearchRequestOperator = "$"
)
