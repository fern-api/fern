...
func (l *ListUsersMixedTypePaginationResponse) GetData() *Users {
	if l == nil {
		return nil
	}
	return l.Data
...
// SetData sets the Data field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (l *ListUsersMixedTypePaginationResponse) SetData(data *Users) {
	l.Data = data
...
func (l *ListUsersPaginationResponse) GetData() *Users {
	if l == nil {
		return nil
	}
	return l.Data
...
// SetData sets the Data field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (l *ListUsersPaginationResponse) SetData(data *Users) {
	l.Data = data
...
var (
	usersFieldUsers = big.NewInt(1 << 0)
)
...
func (u *Users) SetUsers(users []*User) {
	u.Users = users
	u.require(usersFieldUsers)
}

func (u *Users) UnmarshalJSON(data []byte) error {
	type unmarshaler Users
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
