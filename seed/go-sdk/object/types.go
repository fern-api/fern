...
var (
	...
	typeFieldEighteen    = big.NewInt(1 << 17)
	typeFieldNineteen    = big.NewInt(1 << 18)
	typeFieldTwenty      = big.NewInt(1 << 19)
	typeFieldTwentyone   = big.NewInt(1 << 20)
	typeFieldTwentytwo   = big.NewInt(1 << 21)
	typeFieldTwentythree = big.NewInt(1 << 22)
	typeFieldTwentyfour  = big.NewInt(1 << 23)
	typeFieldTwentyfive  = big.NewInt(1 << 24)
)
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (t *Type) SetEight(eight string) {
	t.Eight = eight
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (t *Type) SetNine(nine string) {
	t.Nine = nine
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (t *Type) SetSeventeen(seventeen []*string) {
	t.Seventeen = seventeen
	t.require(typeFieldSeventeen)
}

// SetEighteen sets the Eighteen field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (t *Type) SetEighteen(eighteen TypeEighteen) {
	t.Eighteen = eighteen
	t.require(typeFieldEighteen)
}
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (t *Type) SetTwenty(twenty int64) {
	t.Twenty = twenty
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (t *Type) SetTwentythree(twentythree int) {
...
const (
	TypeEighteenEighteen TypeEighteen = "eighteen"
)
