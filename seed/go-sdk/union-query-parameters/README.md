...
```go
response, err := client.Events.Subscribe(...)
if err != nil {
...
```go
response, err := client.Events.WithRawResponse.Subscribe(...)
if err != nil {
    return err
}
...
response, err := client.Events.Subscribe(ctx, ...)
```
...
response, err := client.Events.Subscribe(ctx, request, ...)
```
