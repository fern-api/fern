...
```go
response, err := client.Endpoints.GetAndReturnWithDatetimeAliasWithDocs(...)
if err != nil {
...
```go
response, err := client.Endpoints.WithRawResponse.GetAndReturnWithDatetimeAliasWithDocs(...)
if err != nil {
    return err
}
...
response, err := client.Endpoints.GetAndReturnWithDatetimeAliasWithDocs(ctx, ...)
```
...
response, err := client.Endpoints.GetAndReturnWithDatetimeAliasWithDocs(ctx, request, ...)
```
