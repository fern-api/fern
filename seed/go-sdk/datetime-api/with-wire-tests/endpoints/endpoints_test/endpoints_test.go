...
func TestEndpointsGetAndReturnWithDatetimeAliasWithDocsWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Endpoints.GetAndReturnWithDatetimeAliasWithDocs(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEndpointsGetAndReturnWithDatetimeAliasWithDocsWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEndpointsGetAndReturnWithDatetimeAliasWithDocsWithWireMock", "POST", "/get-and-return-with-datetime-alias-with-docs", nil, 1)
}
