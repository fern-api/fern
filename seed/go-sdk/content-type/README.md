...
```go
response, err := client.Service.Patch(...)
if err != nil {
...
```go
response, err := client.Service.WithRawResponse.Patch(...)
if err != nil {
    return err
}
...
response, err := client.Service.Patch(ctx, ...)
```
...
response, err := client.Service.Patch(ctx, request, ...)
```
