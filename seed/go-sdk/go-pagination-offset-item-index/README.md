...
response, err := client.Plants.WithRawResponse.ListWithBodyOffset(...)
if err != nil {
    return err
}
...
response, err := client.Plants.ListWithBodyOffset(ctx, ...)
```
...
response, err := client.Plants.ListWithBodyOffset(ctx, request, ...)
```
