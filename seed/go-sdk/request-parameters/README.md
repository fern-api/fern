...
```go
response, err := client.User.Createusername(...)
if err != nil {
...
```go
response, err := client.User.WithRawResponse.Createusername(...)
if err != nil {
    return err
}
...
response, err := client.User.Createusername(ctx, ...)
```
...
response, err := client.User.Createusername(ctx, request, ...)
```
