...
func TestSettersGetTokenRequest(t *testing.T) {
	...
	t.Run("SetAudience", func(t *testing.T) {
		obj := &GetTokenRequest{}
		var fernTestValueAudience GetTokenRequestAudience
	...
	t.Run("SetGrantType", func(t *testing.T) {
		obj := &GetTokenRequest{}
		var fernTestValueGrantType GetTokenRequestGrantType
...
func TestSettersRefreshTokenRequest(t *testing.T) {
	...
	t.Run("SetAudience", func(t *testing.T) {
		obj := &RefreshTokenRequest{}
		var fernTestValueAudience RefreshTokenRequestAudience
		obj.SetAudience(fernTestValueAudience)
		assert.Equal(t, fernTestValueAudience, obj.Audience)
		assert.NotNil(t, obj.explicitFields)
	})
	...
	t.Run("SetGrantType", func(t *testing.T) {
		obj := &RefreshTokenRequest{}
		var fernTestValueGrantType RefreshTokenRequestGrantType
		obj.SetGrantType(fernTestValueGrantType)
		assert.Equal(t, fernTestValueGrantType, obj.GrantType)
		assert.NotNil(t, obj.explicitFields)
	})
...
func TestEnumGetTokenRequestAudience(t *testing.T) {
	t.Run("NewFromString_https___api_example_com", func(t *testing.T) {
		t.Parallel()
		val, err := NewGetTokenRequestAudienceFromString("https://api.example.com")
		assert.NoError(t, err, "valid enum value should not return error")
		assert.Equal(t, GetTokenRequestAudience("https://api.example.com"), val, "enum value should match expected wire value")
	})

	t.Run("NewFromString_Invalid", func(t *testing.T) {
		_, err := NewGetTokenRequestAudienceFromString("invalid_value_that_does_not_exist")
		assert.Error(t, err)
	})
...
func TestEnumGetTokenRequestGrantType(t *testing.T) {
	t.Run("NewFromString_client_credentials", func(t *testing.T) {
		t.Parallel()
		val, err := NewGetTokenRequestGrantTypeFromString("client_credentials")
		assert.NoError(t, err, "valid enum value should not return error")
		assert.Equal(t, GetTokenRequestGrantType("client_credentials"), val, "enum value should match expected wire value")
	})

	t.Run("NewFromString_Invalid", func(t *testing.T) {
		_, err := NewGetTokenRequestGrantTypeFromString("invalid_value_that_does_not_exist")
		assert.Error(t, err)
	})
...
func TestEnumRefreshTokenRequestAudience(t *testing.T) {
	t.Run("NewFromString_https___api_example_com", func(t *testing.T) {
		t.Parallel()
		val, err := NewRefreshTokenRequestAudienceFromString("https://api.example.com")
		assert.NoError(t, err, "valid enum value should not return error")
		assert.Equal(t, RefreshTokenRequestAudience("https://api.example.com"), val, "enum value should match expected wire value")
	})

	t.Run("NewFromString_Invalid", func(t *testing.T) {
		_, err := NewRefreshTokenRequestAudienceFromString("invalid_value_that_does_not_exist")
		assert.Error(t, err)
	})
...
func TestEnumRefreshTokenRequestGrantType(t *testing.T) {
	t.Run("NewFromString_refresh_token", func(t *testing.T) {
		t.Parallel()
		val, err := NewRefreshTokenRequestGrantTypeFromString("refresh_token")
		assert.NoError(t, err, "valid enum value should not return error")
		assert.Equal(t, RefreshTokenRequestGrantType("refresh_token"), val, "enum value should match expected wire value")
	})

	t.Run("NewFromString_Invalid", func(t *testing.T) {
		_, err := NewRefreshTokenRequestGrantTypeFromString("invalid_value_that_does_not_exist")
		assert.Error(t, err)
	})
