...
var (
	getAttemptedMigrationsRequestFieldAdminKeyHeader = big.NewInt(1 << 0)
)

type GetAttemptedMigrationsRequest struct {
...
func (g *GetAttemptedMigrationsRequest) SetAdminKeyHeader(adminKeyHeader string) {
	g.AdminKeyHeader = adminKeyHeader
	g.require(getAttemptedMigrationsRequestFieldAdminKeyHeader)
}
