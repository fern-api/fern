...
func (r *RequestOptions) ToHeader() http.Header {
	...
	if r.XRandomHeader != nil {
		header.Set("X-Random-Header", fmt.Sprintf("%v", *r.XRandomHeader))
	}
	return header
}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/trace/fern")
	headers.Set("X-Fern-SDK-Version", "v0.0.1")
	headers.Set("User-Agent", "github.com/trace/fern/0.0.1")
	return headers
}
...
// XRandomHeaderOption implements the RequestOption interface.
type XRandomHeaderOption struct {
	XRandomHeader *string
}

func (x *XRandomHeaderOption) applyRequestOptions(opts *RequestOptions) {
	opts.XRandomHeader = x.XRandomHeader
}
