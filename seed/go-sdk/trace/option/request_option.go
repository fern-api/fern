...
// WithXRandomHeader sets the xRandomHeader request header.
func WithXRandomHeader(xRandomHeader *string) *core.XRandomHeaderOption {
	return &core.XRandomHeaderOption{
		XRandomHeader: xRandomHeader,
	}
}
