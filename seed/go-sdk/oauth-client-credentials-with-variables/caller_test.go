...
import (
	...
	"github.com/oauth-client-credentials-with-variables/fern/core"
	"github.com/oauth-client-credentials-with-variables/fern/internal"
...
func TestMergeHeaders(t *testing.T) {
	t.Run("both empty", func(t *testing.T) {
		merged := internal.MergeHeaders(make(http.Header), make(http.Header))
	...
	t.Run("empty left", func(t *testing.T) {
		...
		merged := internal.MergeHeaders(left, right)
