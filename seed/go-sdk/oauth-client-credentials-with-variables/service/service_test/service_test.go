...
func TestServicePostWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/service/{endpointParam}")).WillReturnResponse(
	...
	invocationErr := client.Service.Post(
		context.TODO(),
	)
