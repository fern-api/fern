...
```go
response, err := client.Entities.AddEntity(...)
if err != nil {
...
```go
response, err := client.Entities.WithRawResponse.AddEntity(...)
if err != nil {
    return err
}
...
response, err := client.Entities.AddEntity(ctx, ...)
```
...
response, err := client.Entities.AddEntity(ctx, request, ...)
```
