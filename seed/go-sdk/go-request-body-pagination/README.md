...
ctx := context.TODO()
page, err := client.Users.ListWithBodyCursorPagination(
    ctx,
    ...
)
if err != nil {
...
response, err := client.Users.WithRawResponse.ListWithBodyCursorPagination(...)
if err != nil {
    return err
}
...
response, err := client.Users.ListWithBodyCursorPagination(ctx, ...)
```
...
response, err := client.Users.ListWithBodyCursorPagination(ctx, request, ...)
```
