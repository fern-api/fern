...
```go
response, err := client.StreamProtocolNoCollision(...)
if err != nil {
...
```go
response, err := client.WithRawResponse.StreamProtocolNoCollision(...)
if err != nil {
    return err
}
...
response, err := client.StreamProtocolNoCollision(ctx, ...)
```
...
response, err := client.StreamProtocolNoCollision(ctx, request, ...)
```
