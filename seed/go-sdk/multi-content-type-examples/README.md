...
```go
response, err := client.Clients.Create(...)
if err != nil {
...
```go
response, err := client.Clients.WithRawResponse.Create(...)
if err != nil {
    return err
}
...
response, err := client.Clients.Create(ctx, ...)
```
...
response, err := client.Clients.Create(ctx, request, ...)
```
