...
```go
response, err := client.FileUploadExample.UploadFile(...)
if err != nil {
...
```go
response, err := client.FileUploadExample.WithRawResponse.UploadFile(...)
if err != nil {
    return err
}
...
response, err := client.FileUploadExample.UploadFile(ctx, ...)
```
...
response, err := client.FileUploadExample.UploadFile(ctx, request, ...)
```
