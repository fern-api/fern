...
func TestFolderDServiceGetDirectThreadWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/partner-path")).WillReturnResponse(
	...
	_, invocationErr := client.FolderD.Service.GetDirectThread(
		context.TODO(),
	)
