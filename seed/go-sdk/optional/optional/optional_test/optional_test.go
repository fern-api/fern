...
func TestOptionalSendOptionalBodyWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/send-optional-body")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
	...
	_, invocationErr := client.Optional.SendOptionalBody(
		context.TODO(),
		request,
	)
