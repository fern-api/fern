...
```go
response, err := client.DidCommMessageRecv(...)
if err != nil {
...
```go
response, err := client.WithRawResponse.DidCommMessageRecv(...)
if err != nil {
    return err
}
...
response, err := client.DidCommMessageRecv(ctx, ...)
```
...
response, err := client.DidCommMessageRecv(ctx, request, ...)
```
