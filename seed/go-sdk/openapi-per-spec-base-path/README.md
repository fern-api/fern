...
```go
response, err := client.Oauth.GetToken(...)
if err != nil {
...
```go
response, err := client.Oauth.WithRawResponse.GetToken(...)
if err != nil {
    return err
}
...
response, err := client.Oauth.GetToken(ctx, ...)
```
...
response, err := client.Oauth.GetToken(ctx, request, ...)
```
