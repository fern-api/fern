...
func (r *RequestOptions) ToHeader() http.Header {
	...
	if r.HeaderTokenAuth != "" {
		header.Set("x-api-key", fmt.Sprintf("test_prefix %v", r.HeaderTokenAuth))
	}
	return header
}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/header-auth-environment-variable/fern")
	headers.Set("X-Fern-SDK-Version", "v0.0.1")
	headers.Set("User-Agent", "github.com/header-auth-environment-variable/fern/0.0.1")
	return headers
}
