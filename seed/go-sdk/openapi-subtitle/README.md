...
```go
response, err := client.ListPlants(...)
if err != nil {
...
```go
response, err := client.WithRawResponse.ListPlants(...)
if err != nil {
    return err
}
...
response, err := client.ListPlants(ctx, ...)
```
...
response, err := client.ListPlants(ctx, request, ...)
```
