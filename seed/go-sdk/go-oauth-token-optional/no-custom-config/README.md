...
```go
response, err := client.Auth.CreateOauth2Token(...)
if err != nil {
...
```go
response, err := client.Auth.WithRawResponse.CreateOauth2Token(...)
if err != nil {
    return err
}
...
response, err := client.Auth.CreateOauth2Token(ctx, ...)
```
...
response, err := client.Auth.CreateOauth2Token(ctx, request, ...)
```
