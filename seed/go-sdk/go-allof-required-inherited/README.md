...
```go
response, err := client.GetTransactions(...)
if err != nil {
...
```go
response, err := client.WithRawResponse.GetTransactions(...)
if err != nil {
    return err
}
...
response, err := client.GetTransactions(ctx, ...)
```
...
response, err := client.GetTransactions(ctx, request, ...)
```
