...
```go
response, err := client.AssetReport.GetPdf(...)
if err != nil {
...
```go
response, err := client.AssetReport.WithRawResponse.GetPdf(...)
if err != nil {
    return err
}
...
response, err := client.AssetReport.GetPdf(ctx, ...)
```
...
response, err := client.AssetReport.GetPdf(ctx, request, ...)
```
