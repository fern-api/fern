...
func TestEc2BootInstanceWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/ec2/boot")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
	...
	invocationErr := client.Ec2.BootInstance(
		context.TODO(),
		request,
	)
