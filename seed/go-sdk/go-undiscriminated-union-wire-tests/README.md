...
```go
response, err := client.Service.Rerank(...)
if err != nil {
...
```go
response, err := client.Service.WithRawResponse.Rerank(...)
if err != nil {
    return err
}
...
response, err := client.Service.Rerank(ctx, ...)
```
...
response, err := client.Service.Rerank(ctx, request, ...)
```
