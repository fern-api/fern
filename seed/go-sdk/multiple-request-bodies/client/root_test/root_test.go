...
func TestUploadJsonDocumentWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/documents/upload")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
		...
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"author": "author", "id": 1, "tags": []interface{}{map[string]interface{}{"key": "value"}}, "title": "title"},
	...
	_, invocationErr := client.UploadJsonDocument(
		context.TODO(),
		request,
	)
