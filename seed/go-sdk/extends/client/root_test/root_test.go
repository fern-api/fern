...
func TestExtendedInlineRequestBodyWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/extends/extended-inline-request-body")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
	...
	invocationErr := client.ExtendedInlineRequestBody(
		context.TODO(),
		request,
	)
