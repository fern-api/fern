...
```go
response, err := client.ExtendedInlineRequestBody(...)
if err != nil {
...
response, err := client.ExtendedInlineRequestBody(ctx, ...)
```
...
response, err := client.ExtendedInlineRequestBody(ctx, request, ...)
```
