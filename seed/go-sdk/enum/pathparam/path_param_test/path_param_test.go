...
func TestPathParamSendWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/path/{operand}/{operandOrColor}")).WithPathParam(
		"operand",
		gowiremock.Matching(">"),
	).WithPathParam(
		"operandOrColor",
		gowiremock.Matching("red"),
	).WillReturnResponse(
	...
	invocationErr := client.PathParam.Send(
		context.TODO(),
