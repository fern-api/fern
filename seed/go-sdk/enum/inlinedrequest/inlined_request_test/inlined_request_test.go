...
func TestInlinedRequestSendWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/inlined")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": ["operand", "operandOrColor"],
                    "properties": {
                        "operand": {"type": "string"}, "operandOrColor": {"type": "object"}
                    },
	...
	invocationErr := client.InlinedRequest.Send(
		context.TODO(),
		request,
	)
