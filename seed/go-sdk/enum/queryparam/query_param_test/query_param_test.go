...
func TestQueryParamSendWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/query")).WillReturnResponse(
	...
	invocationErr := client.QueryParam.Send(
		context.TODO(),
		request,
	)
...
func TestQueryParamSendListWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/query-list")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{},
		).WithStatus(http.StatusOK),
	)
	...
	invocationErr := client.QueryParam.SendList(
		context.TODO(),
		request,
	)
