...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/openapi-path-param-body-collision/fern")
	headers.Set("X-Fern-SDK-Version", "v0.0.1")
	headers.Set("User-Agent", "github.com/openapi-path-param-body-collision/fern/0.0.1")
	return headers
}
