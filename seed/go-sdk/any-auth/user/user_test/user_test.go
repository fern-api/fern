...
func TestUserGetWithWireMock(
	...
	VerifyRequestCount(t, "TestUserGetWithWireMock", "POST", "/users", nil, 1)
}
...
func TestUserGetAdminsWithWireMock(
	...
	_, invocationErr := client.User.GetAdmins(
		context.TODO(),
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestUserGetAdminsWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestUserGetAdminsWithWireMock", "GET", "/admins", nil, 1)
}
