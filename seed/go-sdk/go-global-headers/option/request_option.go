...
// WithClientID sets the clientID request header.
...
// WithTenant sets the tenant request header.
func WithTenant(tenant *string) *core.TenantOption {
	return &core.TenantOption{
		Tenant: tenant,
	}
}
