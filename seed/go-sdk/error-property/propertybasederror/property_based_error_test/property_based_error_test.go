...
package property_based_error_test
...
func TestPropertyBasedErrorThrowErrorWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/property-based-error")).WillReturnResponse(
	...
	_, invocationErr := client.PropertyBasedError.ThrowError(
		context.TODO(),
	)
