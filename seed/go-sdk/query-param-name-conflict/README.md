...
```go
response, err := client.BulkUpdateTasks(...)
if err != nil {
...
```go
response, err := client.WithRawResponse.BulkUpdateTasks(...)
if err != nil {
    return err
}
...
response, err := client.BulkUpdateTasks(ctx, ...)
```
...
response, err := client.BulkUpdateTasks(ctx, request, ...)
```
