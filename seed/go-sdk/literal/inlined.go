...
type UndiscriminatedLiteral struct {
	...
	Field10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral string
	TrueLiteral                                                                                bool
	FalseLiteral                                                                               bool
	Boolean                                                                                    bool
...
func NewUndiscriminatedLiteralWithField10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral() *UndiscriminatedLiteral {
	return &UndiscriminatedLiteral{typ: "Field10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral", Field10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral: "10 non-alphanumeric string literals you're going to love & why (number 8 will surprise you)"}
}
...
func (u *UndiscriminatedLiteral) UnmarshalJSON(data []byte) error {
	...
	var valueField10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral string
	if err := json.Unmarshal(data, &valueField10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral); err == nil {
		u.typ = "Field10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral"
		u.Field10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral = valueField10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral
		if u.Field10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral != "10 non-alphanumeric string literals you're going to love & why (number 8 will surprise you)" {
			return fmt.Errorf("unexpected value for literal on type %T; expected %v got %v", u, "10 non-alphanumeric string literals you're going to love & why (number 8 will surprise you)", valueField10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral)
		}
		return nil
	}
...
func (u UndiscriminatedLiteral) MarshalJSON() ([]byte, error) {
	...
	if u.typ == "Field10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral" || u.Field10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral != "" {
...
type UndiscriminatedLiteralVisitor interface {
	...
	VisitField10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral(string) error
...
func (u *UndiscriminatedLiteral) Accept(visitor UndiscriminatedLiteralVisitor) error {
	...
	if u.typ == "Field10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral" || u.Field10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral != "" {
		return visitor.VisitField10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral(u.Field10nonalphanumericstringliteralsyouregoingtolovewhynumber8willsurpriseyouStringLiteral)
	}
	if u.typ == "TrueLiteral" || u.TrueLiteral != false {
