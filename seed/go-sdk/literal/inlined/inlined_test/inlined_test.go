...
func TestInlinedSendWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Inlined.Send(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestInlinedSendWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestInlinedSendWithWireMock", "POST", "/inlined", nil, 1)
}
