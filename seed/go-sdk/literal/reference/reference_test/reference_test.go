...
func TestReferenceSendWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Reference.Send(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestReferenceSendWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestReferenceSendWithWireMock", "POST", "/reference", nil, 1)
}
