...
func TestFolderAServiceGetDirectThreadWithWireMock(
	t *testing.T,
) {
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"foo": map[string]interface{}{"foo": map[string]interface{}{"bar_property": "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32"}}},
	...
	_, invocationErr := client.FolderA.Service.GetDirectThread(
		context.TODO(),
	)
