...
var (
	fooFindRequestFieldOptionalString  = big.NewInt(1 << 0)
	fooFindRequestFieldPublicProperty  = big.NewInt(1 << 1)
	fooFindRequestFieldPrivateProperty = big.NewInt(1 << 2)
)

type FooFindRequest struct {
...
func (f *FooFindRequest) require(field *big.Int) {
...
func (f *FooFindRequest) SetOptionalString(optionalString *OptionalString) {
	f.OptionalString = optionalString
	f.require(fooFindRequestFieldOptionalString)
}

// SetPublicProperty sets the PublicProperty field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (f *FooFindRequest) SetPublicProperty(publicProperty *string) {
	f.PublicProperty = publicProperty
	f.require(fooFindRequestFieldPublicProperty)
}

// SetPrivateProperty sets the PrivateProperty field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (f *FooFindRequest) SetPrivateProperty(privateProperty *int) {
	f.PrivateProperty = privateProperty
	f.require(fooFindRequestFieldPrivateProperty)
}

func (f *FooFindRequest) UnmarshalJSON(data []byte) error {
	type unmarshaler FooFindRequest
	var body unmarshaler
	if err := json.Unmarshal(data, &body); err != nil {
		return err
	}
	*f = FooFindRequest(body)
	return nil
}

func (f *FooFindRequest) MarshalJSON() ([]byte, error) {
	type embed FooFindRequest
