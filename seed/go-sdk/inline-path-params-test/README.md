...
```go
response, err := client.Users.GetUser(...)
if err != nil {
...
```go
response, err := client.Users.WithRawResponse.GetUser(...)
if err != nil {
    return err
}
...
response, err := client.Users.GetUser(ctx, ...)
```
...
response, err := client.Users.GetUser(ctx, request, ...)
```
