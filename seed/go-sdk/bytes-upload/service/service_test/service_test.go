...
func TestServiceUploadWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/upload-content")).WillReturnResponse(
	...
	invocationErr := client.Service.Upload(
		context.TODO(),
		nil,
	)
