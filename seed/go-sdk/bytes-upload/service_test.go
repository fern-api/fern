...
func TestSettersServiceUploadWithQueryParamsRequest(t *testing.T) {
	t.Run("SetModel", func(t *testing.T) {
		obj := &ServiceUploadWithQueryParamsRequest{}
...
func TestSettersMarkExplicitServiceUploadWithQueryParamsRequest(t *testing.T) {
