...
var (
	usersListWithCustomPagerRequestFieldLimit         = big.NewInt(1 << 0)
	usersListWithCustomPagerRequestFieldStartingAfter = big.NewInt(1 << 1)
)

type UsersListWithCustomPagerRequest struct {
...
func (u *UsersListWithCustomPagerRequest) require(field *big.Int) {
...
func (u *UsersListWithCustomPagerRequest) SetLimit(limit *int) {
	u.Limit = limit
	u.require(usersListWithCustomPagerRequestFieldLimit)
}

// SetStartingAfter sets the StartingAfter field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (u *UsersListWithCustomPagerRequest) SetStartingAfter(startingAfter *string) {
	u.StartingAfter = startingAfter
	u.require(usersListWithCustomPagerRequestFieldStartingAfter)
}
