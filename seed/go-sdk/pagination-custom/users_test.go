...
func TestSettersUsersListWithCustomPagerRequest(t *testing.T) {
	t.Run("SetLimit", func(t *testing.T) {
		obj := &UsersListWithCustomPagerRequest{}
...
func TestSettersMarkExplicitUsersListWithCustomPagerRequest(t *testing.T) {
