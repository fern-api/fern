...
func TestUserEventsListEventsWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/users/events/")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			[]interface{}{map[string]interface{}{"id": "id", "name": "name"}, map[string]interface{}{"id": "id", "name": "name"}},
	...
	_, invocationErr := client.User.Events.ListEvents(
		context.TODO(),
		request,
	)
