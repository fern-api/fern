...
package user_events_metadata_test
...
func TestUserEventsMetadataGetMetadataWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/users/events/metadata/")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "value": map[string]interface{}{"key": "value"}},
	...
	_, invocationErr := client.User.Events.Metadata.GetMetadata(
		context.TODO(),
		request,
	)
