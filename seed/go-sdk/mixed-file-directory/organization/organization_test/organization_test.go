...
func TestOrganizationCreateWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/organizations/")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "name": "name", "users": []interface{}{map[string]interface{}{"id": "id", "name": "name", "age": 1}, map[string]interface{}{"id": "id", "name": "name", "age": 1}}},
