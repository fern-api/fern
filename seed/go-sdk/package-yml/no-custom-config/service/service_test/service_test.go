...
func TestServiceNopWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/{id}//{nestedId}")).WithPathParam(
		"id",
		gowiremock.Matching("id-a2ijs82"),
	).WithPathParam(
		"nestedId",
		gowiremock.Matching("id-219xca8"),
	).WillReturnResponse(
	...
	invocationErr := client.Service.Nop(
		context.TODO(),
		"id-a2ijs82",
		"id-219xca8",
	)
