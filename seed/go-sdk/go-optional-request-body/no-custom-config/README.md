...
```go
response, err := client.WaterPlant(...)
if err != nil {
...
```go
response, err := client.WithRawResponse.WaterPlant(...)
if err != nil {
    return err
}
...
response, err := client.WaterPlant(ctx, ...)
```
...
response, err := client.WaterPlant(ctx, request, ...)
```
