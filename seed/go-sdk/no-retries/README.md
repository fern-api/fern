...
```go
response, err := client.Retries.GetUsers(...)
if err != nil {
...
```go
response, err := client.Retries.WithRawResponse.GetUsers(...)
if err != nil {
    return err
}
...
response, err := client.Retries.GetUsers(ctx, ...)
```
...
response, err := client.Retries.GetUsers(ctx, request, ...)
```
