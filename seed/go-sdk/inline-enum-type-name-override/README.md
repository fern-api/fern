...
```go
response, err := client.Reporting.Load(...)
if err != nil {
...
```go
response, err := client.Reporting.WithRawResponse.Load(...)
if err != nil {
    return err
}
...
response, err := client.Reporting.Load(ctx, ...)
```
...
response, err := client.Reporting.Load(ctx, request, ...)
```
