...
func NewBigUnionFromBigUnionZero(value *BigUnionZero) *BigUnion {
	return &BigUnion{typ: "BigUnionZero", BigUnionZero: value}
}

func NewBigUnionFromBigUnionOne(value *BigUnionOne) *BigUnion {
	return &BigUnion{typ: "BigUnionOne", BigUnionOne: value}
}

func NewBigUnionFromBigUnionTwo(value *BigUnionTwo) *BigUnion {
	return &BigUnion{typ: "BigUnionTwo", BigUnionTwo: value}
}

func NewBigUnionFromBigUnionThree(value *BigUnionThree) *BigUnion {
	return &BigUnion{typ: "BigUnionThree", BigUnionThree: value}
}

func NewBigUnionFromBigUnionFour(value *BigUnionFour) *BigUnion {
	return &BigUnion{typ: "BigUnionFour", BigUnionFour: value}
}

func NewBigUnionFromBigUnionFive(value *BigUnionFive) *BigUnion {
	return &BigUnion{typ: "BigUnionFive", BigUnionFive: value}
}

func NewBigUnionFromBigUnionSix(value *BigUnionSix) *BigUnion {
	return &BigUnion{typ: "BigUnionSix", BigUnionSix: value}
}

func NewBigUnionFromBigUnionSeven(value *BigUnionSeven) *BigUnion {
	return &BigUnion{typ: "BigUnionSeven", BigUnionSeven: value}
}

func NewBigUnionFromBigUnionEight(value *BigUnionEight) *BigUnion {
	return &BigUnion{typ: "BigUnionEight", BigUnionEight: value}
}

func NewBigUnionFromBigUnionNine(value *BigUnionNine) *BigUnion {
	return &BigUnion{typ: "BigUnionNine", BigUnionNine: value}
}

func NewBigUnionFromBigUnionTen(value *BigUnionTen) *BigUnion {
	return &BigUnion{typ: "BigUnionTen", BigUnionTen: value}
}

func NewBigUnionFromBigUnionEleven(value *BigUnionEleven) *BigUnion {
	return &BigUnion{typ: "BigUnionEleven", BigUnionEleven: value}
}

func NewBigUnionFromBigUnionTwelve(value *BigUnionTwelve) *BigUnion {
	return &BigUnion{typ: "BigUnionTwelve", BigUnionTwelve: value}
}

func NewBigUnionFromBigUnionThirteen(value *BigUnionThirteen) *BigUnion {
	return &BigUnion{typ: "BigUnionThirteen", BigUnionThirteen: value}
}

func NewBigUnionFromBigUnionFourteen(value *BigUnionFourteen) *BigUnion {
	return &BigUnion{typ: "BigUnionFourteen", BigUnionFourteen: value}
}

func NewBigUnionFromBigUnionFifteen(value *BigUnionFifteen) *BigUnion {
	return &BigUnion{typ: "BigUnionFifteen", BigUnionFifteen: value}
}

func NewBigUnionFromBigUnionSixteen(value *BigUnionSixteen) *BigUnion {
	return &BigUnion{typ: "BigUnionSixteen", BigUnionSixteen: value}
}

func NewBigUnionFromBigUnionSeventeen(value *BigUnionSeventeen) *BigUnion {
	return &BigUnion{typ: "BigUnionSeventeen", BigUnionSeventeen: value}
}

func NewBigUnionFromBigUnionEighteen(value *BigUnionEighteen) *BigUnion {
	return &BigUnion{typ: "BigUnionEighteen", BigUnionEighteen: value}
}

func NewBigUnionFromBigUnionNineteen(value *BigUnionNineteen) *BigUnion {
	return &BigUnion{typ: "BigUnionNineteen", BigUnionNineteen: value}
}

func NewBigUnionFromBigUnionTwenty(value *BigUnionTwenty) *BigUnion {
	return &BigUnion{typ: "BigUnionTwenty", BigUnionTwenty: value}
}

func NewBigUnionFromBigUnionTwentyOne(value *BigUnionTwentyOne) *BigUnion {
	return &BigUnion{typ: "BigUnionTwentyOne", BigUnionTwentyOne: value}
}

func NewBigUnionFromBigUnionTwentyTwo(value *BigUnionTwentyTwo) *BigUnion {
	return &BigUnion{typ: "BigUnionTwentyTwo", BigUnionTwentyTwo: value}
}

func NewBigUnionFromBigUnionTwentyThree(value *BigUnionTwentyThree) *BigUnion {
	return &BigUnion{typ: "BigUnionTwentyThree", BigUnionTwentyThree: value}
}

func NewBigUnionFromBigUnionTwentyFour(value *BigUnionTwentyFour) *BigUnion {
	return &BigUnion{typ: "BigUnionTwentyFour", BigUnionTwentyFour: value}
}

func NewBigUnionFromBigUnionTwentyFive(value *BigUnionTwentyFive) *BigUnion {
	return &BigUnion{typ: "BigUnionTwentyFive", BigUnionTwentyFive: value}
}

func NewBigUnionFromBigUnionTwentySix(value *BigUnionTwentySix) *BigUnion {
	return &BigUnion{typ: "BigUnionTwentySix", BigUnionTwentySix: value}
}

func NewBigUnionFromBigUnionTwentySeven(value *BigUnionTwentySeven) *BigUnion {
	return &BigUnion{typ: "BigUnionTwentySeven", BigUnionTwentySeven: value}
}

func NewBigUnionFromBigUnionTwentyEight(value *BigUnionTwentyEight) *BigUnion {
	return &BigUnion{typ: "BigUnionTwentyEight", BigUnionTwentyEight: value}
}
