...
```go
response, err := client.Vendor.CreateVendor(...)
if err != nil {
...
```go
response, err := client.Vendor.WithRawResponse.CreateVendor(...)
if err != nil {
    return err
}
...
response, err := client.Vendor.CreateVendor(ctx, ...)
```
...
response, err := client.Vendor.CreateVendor(ctx, request, ...)
```
