...
func TestUnknownPostWithWireMock(
	t *testing.T,
) {
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			[]interface{}{map[string]interface{}{"key": "value"}, map[string]interface{}{"key": "value"}},
	...
	_, invocationErr := client.Unknown.Post(
		context.TODO(),
		request,
	)
...
func TestUnknownPostObjectWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/with-object")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			[]interface{}{map[string]interface{}{"key": "value"}, map[string]interface{}{"key": "value"}},
		).WithStatus(http.StatusOK),
	)
	...
	_, invocationErr := client.Unknown.PostObject(
		context.TODO(),
		request,
	)
