...
```go
response, err := client.CRAReport.Get(...)
if err != nil {
...
```go
response, err := client.CRAReport.WithRawResponse.Get(...)
if err != nil {
    return err
}
...
response, err := client.CRAReport.Get(ctx, ...)
```
...
response, err := client.CRAReport.Get(ctx, request, ...)
```
