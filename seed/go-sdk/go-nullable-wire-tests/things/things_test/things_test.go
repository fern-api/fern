...
func TestThingsGetThingWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Things.GetThing(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestThingsGetThingWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestThingsGetThingWithWireMock", "GET", "/thing", nil, 1)
}
