...
```go
response, err := client.Things.GetThing(...)
if err != nil {
...
```go
response, err := client.Things.WithRawResponse.GetThing(...)
if err != nil {
    return err
}
...
response, err := client.Things.GetThing(ctx, ...)
```
...
response, err := client.Things.GetThing(ctx, request, ...)
```
