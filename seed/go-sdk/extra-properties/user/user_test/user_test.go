...
func TestUserCreateUserWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/user")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": ["_type", "_version", "name"],
                    "properties": {
                        "_type": {"type": "string", "const": "CreateUserRequest"}, "_version": {"type": "string", "const": "v1"}, "name": {"type": "string"}
                    },
