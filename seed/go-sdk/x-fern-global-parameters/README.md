...
```go
response, err := client.Products.Search(...)
if err != nil {
...
```go
response, err := client.Products.WithRawResponse.Search(...)
if err != nil {
    return err
}
...
response, err := client.Products.Search(ctx, ...)
```
...
response, err := client.Products.Search(ctx, request, ...)
```
