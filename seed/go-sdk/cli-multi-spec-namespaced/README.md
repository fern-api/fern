...
```go
response, err := client.V1.ListUsers(...)
if err != nil {
...
```go
response, err := client.V1.WithRawResponse.ListUsers(...)
if err != nil {
    return err
}
...
response, err := client.V1.ListUsers(ctx, ...)
```
...
response, err := client.V1.ListUsers(ctx, request, ...)
```
