...
```go
response, err := client.CreateTest(...)
if err != nil {
...
```go
response, err := client.WithRawResponse.CreateTest(...)
if err != nil {
    return err
}
...
response, err := client.CreateTest(ctx, ...)
```
...
response, err := client.CreateTest(ctx, request, ...)
```
