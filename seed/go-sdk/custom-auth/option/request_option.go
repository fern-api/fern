...
// WithCustomAuthScheme sets the customAuthScheme auth request header.
func WithCustomAuthScheme(customAuthScheme string) *core.CustomAuthSchemeOption {
	return &core.CustomAuthSchemeOption{
