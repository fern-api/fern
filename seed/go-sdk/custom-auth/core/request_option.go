...
func (r *RequestOptions) ToHeader() http.Header {
	...
	if r.CustomAuthScheme != "" {
		header.Set("X-API-KEY", fmt.Sprintf("%v", r.CustomAuthScheme))
	}
	return header
}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/custom-auth/fern")
	headers.Set("X-Fern-SDK-Version", "v0.0.1")
	headers.Set("User-Agent", "github.com/custom-auth/fern/0.0.1")
	return headers
}
...
// CustomAuthSchemeOption implements the RequestOption interface.
type CustomAuthSchemeOption struct {
	CustomAuthScheme string
}

func (c *CustomAuthSchemeOption) applyRequestOptions(opts *RequestOptions) {
	opts.CustomAuthScheme = c.CustomAuthScheme
}
