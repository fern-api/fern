...
import { BaseTypescriptCustomConfigSchema } from "./BaseTypescriptCustomConfigSchema";
...
export function resolveRootImportPath({
    ...
    customConfig: BaseTypescriptCustomConfigSchema | undefined;
}): string {
...
function getImportPath({
    ...
    return customConfig?.importPath ?? "todo-import-path";
}
...
// parseMajorVersion returns the major version of the SDK, including Typescript's expected "v"
