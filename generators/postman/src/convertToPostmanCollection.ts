...
}): FernPostman.PostmanCollectionSchema {
...
}): FernPostman.PostmanCollectionItem[] {
...
function getCollectionItemsForPackage(
    ...
    const items: FernPostman.PostmanCollectionItem[] = [];
    ...
    if (package_.service != null) {
        ...
        items.push(
            ...service.endpoints
                .map((httpEndpoint): FernPostman.PostmanCollectionItem.Endpoint | undefined => {
...
}): FernPostman.PostmanCollectionEndpointItem | undefined {
