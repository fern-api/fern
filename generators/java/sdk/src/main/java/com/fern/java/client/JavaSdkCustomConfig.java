...
public interface JavaSdkCustomConfig extends ICustomConfig {
     ...
     * payloads, WebSocket channels/messages, and errors. Opting in is a breaking change for consumers that compile with
     * warnings-as-errors, so the flag defaults to {@code false}.
     *
