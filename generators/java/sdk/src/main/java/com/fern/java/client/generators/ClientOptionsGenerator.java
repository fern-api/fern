...
import com.fern.irV42.model.ir.PlatformHeaders;
import com.fern.irV42.model.variables.VariableDeclaration;
...
public final class ClientOptionsGenerator extends AbstractFileGenerator {
    ...
    public GeneratedClientOptions generateFile() {
        ...
        variableFields.values().forEach(fieldSpec -> contructorBuilder.addStatement("this.$N = $N", fieldSpec, fieldSpec));
