            ...
            if (isProperty) {
                ...
                httpEndpoint.getPagination().get().visit(new Visitor<Void>() {
                    ...
                    public Void visitCursor(CursorPagination cursor) {
                        if (cursor.getPage().getPropertyPath().isPresent() && !cursor.getPage().getPropertyPath().get().isEmpty()) {
                            return null;
                        }
                    ...
                    public Void visitOffset(OffsetPagination offset) {
                        if (offset.getPage().getPropertyPath().isPresent() && !offset.getPage().getPropertyPath().get().isEmpty()) {
                            return null;
                        }
