...
public final class RedirectInterceptorGenerator extends AbstractFileGenerator {
    ...
    public GeneratedResourcesJavaFile generateFile() {
        try (InputStream is = RedirectInterceptorGenerator.class.getResourceAsStream("/RedirectInterceptor.java")) {
            ...
            throw new RuntimeException("Failed to read RedirectInterceptor.java");
        }
    }
}
