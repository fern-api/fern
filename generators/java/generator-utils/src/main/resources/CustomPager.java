...
public class CustomPager<T> implements BiDirectionalPage<T>, Iterable<T> {
    ...
    public boolean hasNext() {
        throw new UnsupportedOperationException(
            "CustomPager.hasNext() must be implemented. " +
    ...
    public boolean hasPrevious() {
        throw new UnsupportedOperationException(
            "CustomPager.hasPrevious() must be implemented. " +
    ...
    public BiDirectionalPage<T> nextPage() throws IOException {
        throw new UnsupportedOperationException(
            "CustomPager.nextPage() must be implemented. " +
    ...
    public BiDirectionalPage<T> previousPage() throws IOException {
        throw new UnsupportedOperationException(
            "CustomPager.previousPage() must be implemented. " +
    ...
    public List<T> getItems() {
        throw new UnsupportedOperationException(
            "CustomPager.getItems() must be implemented. " +
    ...
    public <R> Optional<R> getResponse() {
        throw new UnsupportedOperationException(
            "CustomPager.getResponse() must be implemented. " +
    ...
    public Iterator<T> iterator() {
        throw new UnsupportedOperationException(
            "CustomPager.iterator() must be implemented. " +
