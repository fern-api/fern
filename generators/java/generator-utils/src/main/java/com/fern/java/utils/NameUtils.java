...
/**
 * Utility methods for resolving IR v66 {@link NameOrString} and {@link NameAndWireValueOrString}
 * union types into their fully-typed counterparts.
 *
 * <p>IR v66 compresses {@link Name} into {@link NameOrString} (which can be a plain string or a
 * full {@link Name} object) and {@link NameAndWireValue} into {@link NameAndWireValueOrString}.
 * These helpers provide a uniform way to extract the typed values, building synthetic
 * {@link Name}/{@link NameAndWireValue} objects from plain strings when necessary.
 */
public final class NameUtils {
    ...
    /**
     * Resolves a {@link NameOrString} into a {@link Name}.
     * If the value is already a {@link Name}, returns it directly.
     * If it is a plain string, constructs a synthetic {@link Name} using
     * the string for all casing variants.
     */
    ...
    /**
     * Resolves a {@link NameAndWireValueOrString} into a {@link NameAndWireValue}.
     * If the value is already a {@link NameAndWireValue}, returns it directly.
     * If it is a plain string, constructs a synthetic {@link NameAndWireValue} using
     * the string as both the wire value and all name casing variants.
     */
    ...
    /**
     * Extracts the wire value from a {@link NameAndWireValueOrString}.
     * If the value is a plain string, uses that string directly.
     * If it is a {@link NameAndWireValue}, returns its wire value.
     */
    ...
    /**
     * Extracts the {@link NameOrString} from a {@link NameAndWireValueOrString}.
     * If the value is a plain string, wraps it as a {@link NameOrString}.
     * If it is a {@link NameAndWireValue}, returns its name field.
     */
