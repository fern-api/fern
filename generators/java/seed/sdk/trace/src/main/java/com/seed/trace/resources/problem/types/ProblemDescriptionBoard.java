...
public final class ProblemDescriptionBoard {
    ...
    public static ProblemDescriptionBoard variable(com.seed.trace.resources.commons.types.VariableValue value) {
    ...
    public Optional<com.seed.trace.resources.commons.types.VariableValue> getVariable() {
        if (isVariable()) {
    ...
    public interface Visitor<T> {
        ...
        T visitVariable(com.seed.trace.resources.commons.types.VariableValue variable);
    ...
    private static final class VariableValue implements Value {
        ...
        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private VariableValue(@JsonProperty("value") com.seed.trace.resources.commons.types.VariableValue value) {
            this.value = value;
        }
