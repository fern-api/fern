...
function withoutExamplesOmittingRequestBody({
    ...
    return examples.filter((example) => !exampleOmitsRequestBody({ endpoint, example }));
}
...
export function getExampleEndpointCallsForTests({
    ...
    if (hasUserExamples) {
        ...
        return withoutExamplesOmittingRequestBody({ endpoint, examples });
    }
...
export function getExampleEndpointCalls(endpoint: FernIr.HttpEndpoint): FernIr.ExampleEndpointCall[] {
    ...
    for (const autogenerated of endpoint.autogeneratedExamples) {
        if (autogenerated.example != null && !exampleOmitsRequestBody({ endpoint, example: autogenerated.example })) {
