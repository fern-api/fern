            ...
            const result = benchmark(
                ...
                () => {
                    zurg.record({
                        ...
                        valueSchema: zurg.object([{ key: { parsed: "name", raw: "name" }, value: zurg.string() }])
                    });
                },
                3000
            );
    ...
    describe("Schema Operations", () => {
        ...
        it("object.extend() performance", () => {
            ...
            const result = benchmark(
                "object.extend()",
                () => {
                    baseSchema.extend(zurg.object([{ key: { parsed: "name", raw: "name" }, value: zurg.string() }]));
                },
                3000
            );
