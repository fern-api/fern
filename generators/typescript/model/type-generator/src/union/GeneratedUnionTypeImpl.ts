import { getPropertyKey, GetReferenceOpts } from "@fern-typescript/commons";
                    ...
                    singleProperty: (property) => {
                        ...
                        return [
                            ts.factory.createPropertyAssignment(
                                getPropertyKey(ParsedSingleUnionTypeForUnion.getSinglePropertyKey(unionMember.shape, {
                                    includeSerdeLayer: this.includeSerdeLayer,
                                    retainOriginalCasing: this.retainOriginalCasing
                                })),
