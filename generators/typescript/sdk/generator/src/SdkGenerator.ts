...
export class SdkGenerator {
    ...
    constructor({
        ...
        this.obs = new PerformanceObserver((list) => {
            for (const entry of list.getEntries()) {
                this.context.logger.info(`${entry.name} took ${entry.duration}ms`);
            }
        });
        this.obs.observe({ type: "measure" });

        performance.mark("start");
        performance.mark("start finished");
        performance.measure("start", "start", "start finished");
    ...
    public async generate(): Promise<TypescriptProject> {
        ...
        performance.measure(
            ...
            "generateTypeDeclarations",
            "generateTypeDeclarations finished"
        );
        ...
        performance.measure(
            ...
            "generateErrorDeclarations",
            "generateErrorDeclarations finished"
        );
        ...
        performance.measure(
            ...
            "generateServiceDeclarations",
            "generateServiceDeclarations finished"
        );
        ...
        performance.mark("generateRequestWrappers");
        await this.generateRequestWrappers();
        performance.mark("generateRequestWrappers finished");
        ...
        if (this.config.neverThrowErrors) {
            performance.mark("generateEndpointErrorUnion");
            await this.generateEndpointErrorUnion();
            performance.mark("generateEndpointErrorUnion finished");
            performance.measure(
                "generateEndpointErrorUnion",
                "generateEndpointErrorUnion",
                "generateEndpointErrorUnion finished"
            );
        }
        if (!this.config.neverThrowErrors || this.generateOAuthClients) {
            performance.mark("generateGenericAPISdkError");
            await this.generateGenericAPISdkError();
            performance.mark("generateGenericAPISdkError finished");
            performance.measure(
                "generateGenericAPISdkError",
                "generateGenericAPISdkError",
                "generateGenericAPISdkError finished"
            );
            performance.mark("generateTimeoutSdkError");
            await this.generateTimeoutSdkError();
            performance.mark("generateTimeoutSdkError finished");
            performance.measure(
                "generateTimeoutSdkError",
                "generateTimeoutSdkError",
                "generateTimeoutSdkError finished"
            );
            if (this.config.includeSerdeLayer) {
                performance.mark("generateSdkErrorSchemas");
                await this.generateSdkErrorSchemas();
                performance.mark("generateSdkErrorSchemas finished");
                performance.measure(
                    "generateSdkErrorSchemas",
                    "generateSdkErrorSchemas",
                    "generateSdkErrorSchemas finished"
                );
            }
        }

        if (this.config.includeSerdeLayer) {
            performance.mark("generateTypeSchemas");
            await this.generateTypeSchemas();
            performance.mark("generateTypeSchemas finished");
            performance.measure("generateTypeSchemas", "generateTypeSchemas", "generateTypeSchemas finished");
            performance.mark("generateEndpointTypeSchemas");
            await this.generateEndpointTypeSchemas();
            performance.mark("generateEndpointTypeSchemas finished");
            performance.measure(
                "generateEndpointTypeSchemas",
                "generateEndpointTypeSchemas",
                "generateEndpointTypeSchemas finished"
            );
            ...
            performance.measure(
                "generateInlinedRequestBodySchemas",
                "generateInlinedRequestBodySchemas",
                "generateInlinedRequestBodySchemas finished"
            );
        }
        ...
        if (this.generateOAuthClients) {
            ...
            if (oauthScheme != null && oauthScheme.type === "oauth") {
                ...
                performance.measure(
                    "generateOAuthTokenProvider",
                    "generateOAuthTokenProvider",
                    "generateOAuthTokenProvider finished"
                );
            }
        }
        ...
        if (this.generateJestTests && this.config.writeUnitTests) {
            performance.mark("generateTestFiles");
            await this.generateTestFiles();
            performance.mark("generateTestFiles finished");
            performance.measure("generateTestFiles", "generateTestFiles", "generateTestFiles finished");
        }
        ...
        if (this.config.snippetFilepath != null) {
            performance.mark("generateSnippets");
            await this.generateSnippets();
            performance.mark("generateSnippets finished");
            performance.measure("generateSnippets", "generateSnippets", "generateSnippets finished");
            ...
            try {
                performance.mark("generateReadme");
                await this.generateReadme();
                performance.mark("generateReadme finished");
                performance.measure("generateReadme", "generateReadme", "generateReadme finished");
            } catch (e) {
                this.context.logger.warn("Failed to generate README.md, this is OK");
            }

            try {
                performance.mark("generateReference");
                await this.generateReference();
                performance.mark("generateReference finished");
                performance.measure("generateReference", "generateReference", "generateReference finished");
            } catch (e) {
