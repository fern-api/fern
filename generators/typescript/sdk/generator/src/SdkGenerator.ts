...
export class SdkGenerator {
    ...
    public async generate(): Promise<TypescriptProject> {
        ...
        if (this.config.generateMultipleExports) {
        ...
        const subpackageExportPaths = this.config.generateMultipleExports ? this.getSubpackageExportPaths() : [];
        ...
        return this.config.shouldBundle
            ? new BundledTypescriptProject({
                  ...
                  generateMultipleExports: this.config.generateMultipleExports,
