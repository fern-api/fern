...
export class WebsocketClientDeclarationReferencer extends AbstractSdkClientClassDeclarationReferencer<SubpackageId> {
    ...
    public getReferenceToWebsocket(args: DeclarationReferencer.getReferenceTo.Options<SubpackageId>): Reference {
