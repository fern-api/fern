...
export class GeneratedStreamingEndpointImplementation implements GeneratedEndpointImplementation {
    ...
    public getStatements(context: SdkContext): ts.Statement[] {
        const buildStatements = this.getRequestBuilderStatements(context);
        return [
            ...(this.generateEndpointMetadata
                ...
                : []),
            ...buildStatements,
            ...this.invokeFetcher(context, buildStatements),
    ...
    public invokeFetcher(context: SdkContext, buildStatements?: ts.Statement[]): ts.Statement[] {
