...
export class WireTestGenerator {
    ...
    public async generate(): Promise<void> {
        ...
        const sortedServices = Array.from(endpointsByService.entries()).sort(([a], [b]) => a.localeCompare(b));
    ...
    private async generateServiceTestFile(
        ...
        const serviceTestFileContent = go.codeblock((writer) => {
            const sortedImports = Array.from(imports.entries()).sort(([a], [b]) => a.localeCompare(b));
