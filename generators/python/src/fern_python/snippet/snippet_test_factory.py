    ...
    def _test_body(
        ...
        def writer(writer: AST.NodeWriter) -> None:
            if response_json is not None:
                ...
                writer.write_node(AST.Expression(AST.TypeHint.tuple_(AST.TypeHint.any(), AST.TypeHint.any())) if isinstance(expectations, Tuple) else AST.Expression(AST.TypeHint.any()))
