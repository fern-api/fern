...
class TypeDeclarationHandler:
    ...
    def _get_snippet_for_type_declaration(
        ...
        # Why did we split these out, I'd rather a list of union types...
        examples = self._declaration.autogenerated_examples
        examples.extend(self._declaration.user_provided_examples)
