...
class BaseWrappedClientGenerator(BaseClientGenerator):
    ...
    def _add_wrapped_client_methods(self, *, is_async: bool, service: ir_types.HttpService, class_declaration: AST.ClassDeclaration, generated_root_client: GeneratedRootClient) -> None:
