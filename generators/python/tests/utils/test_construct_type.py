...
def test_forward_ref_list_field_resolved_in_construct() -> None:
    ...
    instances."""
    from .example_models.types.resources.types.block import Chunk, Block
...
def test_literal_discriminant_strict_matching_figure_details() -> None:
    ...
    from .example_models.types.resources.types.block import (
        Chunk,
        Block,
        TextDetails,
        FigureDetails,
...
def test_model_dump_by_alias_uses_camel_case_after_construct() -> None:
    ...
    from .example_models.types.resources.types.block import Chunk, FigureDetails
