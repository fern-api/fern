...
from .circle import Circle as resources_types_circle_Circle
from .square import Square as resources_types_square_Square
...
class Shape(UniversalRootModel):
    ...
    def visit(
        self,
        circle: typing.Callable[[resources_types_circle_Circle], T_Result],
        square: typing.Callable[[resources_types_square_Square], T_Result],
    ) -> T_Result:
