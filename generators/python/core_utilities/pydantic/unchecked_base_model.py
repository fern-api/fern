...
class UncheckedBaseModel(UniversalBaseModel):
    ...
    def construct(
        ...
        if IS_PYDANTIC_V2:
            ...
            m._init_private_attributes()  # mypy: ignore # type: ignore # Pydantic v1
        return m
...
def _get_is_populate_by_name(model: typing.Type["Model"]) -> bool:
    ...
    return model.__config__.allow_population_by_field_name  # mypy: ignore # type: ignore # Pydantic v1
