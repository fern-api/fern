...
if IS_PYDANTIC_V2:
    from pydantic.v1.datetime_parse import parse_date as parse_date  # type: ignore
    from pydantic.v1.datetime_parse import parse_datetime as parse_datetime  # type: ignore
    from pydantic.v1.json import ENCODERS_BY_TYPE as encoders_by_type  # type: ignore
    from pydantic.v1.typing import get_args as get_args  # type: ignore
    from pydantic.v1.typing import get_origin as get_origin  # type: ignore
    from pydantic.v1.typing import is_literal_type as is_literal_type  # type: ignore
    from pydantic.v1.typing import is_union as is_union  # type: ignore
...
class UniversalBaseModel(pydantic.BaseModel):
    if IS_PYDANTIC_V2:
        ...
        model_config: typing.ClassVar[pydantic.ConfigDict] = pydantic.ConfigDict(
            smart_union=True, allow_population_by_field_name=True, json_encoders={dt.datetime: serialize_datetime}
        )
