...
from .code_execution_update import CodeExecutionUpdate as submission_types_code_execution_update_CodeExecutionUpdate
...
class _Factory:
    ...
    def code_execution_update(
        self, value: submission_types_code_execution_update_CodeExecutionUpdate
    ) -> SubmissionResponse:
        return SubmissionResponse(
...
class SubmissionResponse(pydantic.BaseModel):
    ...
    def visit(
        ...
        code_execution_update: typing.Callable[[submission_types_code_execution_update_CodeExecutionUpdate], T_Result],
...
class _SubmissionResponse:
    ...
    class CodeExecutionUpdate(pydantic.BaseModel):
        ...
        value: submission_types_code_execution_update_CodeExecutionUpdate
