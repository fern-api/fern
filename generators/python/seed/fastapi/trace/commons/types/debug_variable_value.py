...
from .generic_value import GenericValue as commons_types_generic_value_GenericValue
...
class _Factory:
    ...
    def generic_value(self, value: commons_types_generic_value_GenericValue) -> DebugVariableValue:
        return DebugVariableValue(
...
class DebugVariableValue(pydantic.BaseModel):
    ...
    def visit(
        ...
        generic_value: typing.Callable[[commons_types_generic_value_GenericValue], T_Result],
    ) -> T_Result:
        ...
        if self.__root__.type == "genericValue":
            return generic_value(
                commons_types_generic_value_GenericValue(**self.__root__.dict(exclude_unset=True, exclude={"type"}))
            )
...
class _DebugVariableValue:
    ...
    class GenericValue(commons_types_generic_value_GenericValue):
