...
class _Factory:
    ...
    def list_type(self, value: commons_types_list_type_ListType) -> VariableType:
        return VariableType(__root__=_VariableType.ListType(**value.dict(exclude_unset=True), type="listType"))

    def map_type(self, value: commons_types_map_type_MapType) -> VariableType:
...
class VariableType(pydantic.BaseModel):
    ...
    def visit(
        ...
        list_type: typing.Callable[["commons_types_list_type_ListType"], T_Result],
        map_type: typing.Callable[["commons_types_map_type_MapType"], T_Result],
        ...
        if self.__root__.type == "listType":
            return list_type(
                commons_types_list_type_ListType(**self.__root__.dict(exclude_unset=True, exclude={"type"}))
            )
        if self.__root__.type == "mapType":
            return map_type(commons_types_map_type_MapType(**self.__root__.dict(exclude_unset=True, exclude={"type"})))
...
from .list_type import ListType as commons_types_list_type_ListType  # noqa: E402
from .map_type import MapType as commons_types_map_type_MapType  # noqa: E402
...
class _VariableType:
    ...
    class ListType(commons_types_list_type_ListType):
        type: typing_extensions.Literal["listType"]

        class Config:
            allow_population_by_field_name = True

    class MapType(commons_types_map_type_MapType):
...
_VariableType.ListType.update_forward_refs(
    ListType=commons_types_list_type_ListType, MapType=commons_types_map_type_MapType, VariableType=VariableType
)
