...
from .binary_tree_value import BinaryTreeValue as commons_types_binary_tree_value_BinaryTreeValue
...
from .singly_linked_list_value import (
    SinglyLinkedListValue as commons_types_singly_linked_list_value_SinglyLinkedListValue,
)
...
class _Factory:
    ...
    def map_value(self, value: commons_types_map_value_MapValue) -> VariableValue:
    ...
    def binary_tree_value(self, value: commons_types_binary_tree_value_BinaryTreeValue) -> VariableValue:
    ...
    def singly_linked_list_value(
        self, value: commons_types_singly_linked_list_value_SinglyLinkedListValue
    ) -> VariableValue:
        return VariableValue(
...
class VariableValue(pydantic.BaseModel):
    ...
    def visit(
        ...
        doubly_linked_list_value: typing.Callable[
            [commons_types_doubly_linked_list_value_DoublyLinkedListValue], T_Result
        ],
        ...
        if self.__root__.type == "mapValue":
            return map_value(
                commons_types_map_value_MapValue(**self.__root__.dict(exclude_unset=True, exclude={"type"}))
            )
        ...
        if self.__root__.type == "binaryTreeValue":
            return binary_tree_value(
                commons_types_binary_tree_value_BinaryTreeValue(
        ...
        if self.__root__.type == "singlyLinkedListValue":
            return singly_linked_list_value(
                commons_types_singly_linked_list_value_SinglyLinkedListValue(
                    **self.__root__.dict(exclude_unset=True, exclude={"type"})
                )
            )
...
from .map_value import MapValue as commons_types_map_value_MapValue  # noqa: E402
...
class _VariableValue:
    ...
    class MapValue(commons_types_map_value_MapValue):
    ...
    class SinglyLinkedListValue(commons_types_singly_linked_list_value_SinglyLinkedListValue):
        type: typing_extensions.Literal["singlyLinkedListValue"]

        class Config:
            allow_population_by_field_name = True

    class DoublyLinkedListValue(commons_types_doubly_linked_list_value_DoublyLinkedListValue):
