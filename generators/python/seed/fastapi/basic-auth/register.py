...
from .basic_auth.service.service import AbstractBasicAuthService
...
def register(
    ...
    *,
    basic_auth: AbstractBasicAuthService,
    dependencies: typing.Optional[typing.Sequence[params.Depends]] = None
) -> None:
    _app.include_router(__register_service(basic_auth), dependencies=dependencies)
