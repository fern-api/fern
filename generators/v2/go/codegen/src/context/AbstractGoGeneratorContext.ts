...
> extends AbstractGeneratorContext {
    ...
    public constructor(
        ...
        this.rootImportPath = this.customConfig.importPath ?? this.config.organization;
    ...
    // TODO: Move this to the SDK generator context when available.
    public getRootClientFuncInvocation(arguments_: AstNode[]): go.FuncInvocation {
    ...
    // TODO: Move this to the SDK generator context when available.
    public getRootClientTypeReference(): go.TypeReference {
    ...
    protected getFileLocation(filepath: FernFilepath, suffix?: string): FileLocation {
        // TODO: Is packagePath correct here?
