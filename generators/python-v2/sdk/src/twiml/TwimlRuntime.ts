/**
 * XML runtime shared by every generated TwiML builder module. Mirrors the shape of
 * twilio-python's `twilio/twiml/__init__.py` (`TwiML`, `nest`/`append`, `add_child`,
 * `to_xml`) so snippets written against the official SDK keep working.
 */
export const TWIML_RUNTIME_SOURCE = `"""XML runtime for the generated TwiML builders."""
