...
export class RubySdkGeneratorCli extends AbstractGeneratorCli<RubySdkCustomConfig> {
    ...
    private getGemName(config: FernGeneratorExec.GeneratorConfig, customConfig: RubySdkCustomConfig): string {
        return customConfig.gemName ?? this.getClientName(config, customConfig);
    }

    private getClientName(config: FernGeneratorExec.GeneratorConfig, customConfig: RubySdkCustomConfig): string {
