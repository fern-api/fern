...
use <%= coreNamespace%>\Client\HttpClientBuilder;
use <%= coreNamespace%>\Client\MockHttpClient;
use <%= coreNamespace%>\Client\RawClient;
use <%= coreNamespace%>\Client\RetryDecoratingClient;
...
use <%= coreNamespace%>\Multipart\MultipartFormData;
