import { Arguments, getOriginalName, NameInput, UnnamedArgument, GeneratorError } from "@fern-api/base-generator";
...
export class HttpEndpointGenerator extends AbstractEndpointGenerator {
            ...
            reference: (() => {
                switch (endpoint.pagination.type) {
                    ...
                    case "path":
                        ...
                        throw GeneratorError.validationError(`Pagination type ${endpoint.pagination.type} is not supported`);
                    default:
                        assertNever(endpoint.pagination);
                }
            })()
    ...
    private decodeJsonResponse(return_: php.Type | undefined): php.CodeBlock {
        ...
        switch (internalType.type) {
            ...
            case "null":
            case "typeDict":
                throw GeneratorError.internalError(`Internal error; '${internalType.type}' type is not a supported return type`);
            default:
