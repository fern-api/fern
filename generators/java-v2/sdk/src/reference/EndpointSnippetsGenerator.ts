...
export class EndpointSnippetsGenerator {
    ...
    public async populateSnippetsCache(dynamicSnippetsGenerator: DynamicSnippetsGenerator): Promise<void> {
    ...
    private async generateSingleEndpointSnippetFromDynamic({
        ...
        try {
            ...
            return {
                exampleIdentifier: (example as FernIr.dynamic.EndpointExample).id, // Use unique example ID for FernIr.dynamic examples
