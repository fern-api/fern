...
describe("buildWireTestManifest", () => {
    ...
    it("matches the OAuth scheme's configured token header and prefix", () => {
        const example = {
            rootPathParameters: [],
            servicePathParameters: [],
            endpointPathParameters: [],
                ...
                schemes: [
                    {
                        ...
                        configuration: {
                            ...
                            tokenPrefix: "",
                            tokenEndpoint: {
                                endpointReference: { endpointId: "endpoint_identity.getToken" }
                            }
                        }
                    }
                ]
        ...
        expect(manifest.cases[0]?.headerMatchers).toEqual([{ name: "token", matches: ".+" }]);
    });
