public enum CustomDiscriminantKeyedUnion: Codable, Hashable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let discriminant = try container.decode(String.self, forKey: .shapeType)
        switch discriminant {
        case "square":
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        case .square(let data):
            try container.encode("square", forKey: .shapeType)
            try container.encode(data, forKey: .square)
        case .triangle(let data):
            try container.encode("triangle", forKey: .shapeType)
