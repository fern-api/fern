...
export class DynamicTypeLiteralMapper {
    ...
    private convertList({
        ...
        if (!Array.isArray(value)) {
            ...
            // `allow-multiple` query parameters are modeled as lists but their
            // autogenerated examples carry a single scalar value. Render it as a
            // single-element array so the snippet matches the generated `[T]` type.
            return this.convertList({ fromSymbol, list, value: [value] });
        }
    ...
    private convertPrimitive({
        ...
        switch (primitive) {
            ...
            case "BIG_INTEGER": {
                ...
                return swift.Expression.escapedStringLiteral(bigInt);
            }
            default:
