...
export class DynamicTypeLiteralMapper {
    ...
    private getOrderedObjectProperties(object_: FernIr.dynamic.ObjectType): FernIr.dynamic.NamedParameter[] {
        if (object_.extends == null || object_.extends.length === 0) {
        ...
        this.collectExtendedPropertyWireValues(object_.extends, extendedPropertyWireValues);
     ...
     */
    private collectExtendedPropertyWireValues(
        extendedTypeIds: FernIr.dynamic.TypeId[],
        wireValues: Set<string>
    ): void {
        for (const typeId of extendedTypeIds) {
            ...
            if (namedType.extends != null && namedType.extends.length > 0) {
                this.collectExtendedPropertyWireValues(namedType.extends, wireValues);
            }
