...
export class WireTestFunctionGenerator {
    ...
    private readonly exampleEndpointCallsById: Record<string, FernIr.ExampleEndpointCall>;
    ...
    private buildExampleEndpointCallsById(endpoint: FernIr.HttpEndpoint) {
        return [
            ...
            {} as Record<string, FernIr.ExampleEndpointCall>
        );
    }
    ...
    private generateClientDeclaration(dynamicEndpointExample: FernIr.dynamic.EndpointExample): swift.Statement {
    ...
    public getSwiftTypeReferenceForExampleTypeReferenceFromTestModuleScope(
        typeReference: FernIr.ExampleTypeReference
    ): swift.TypeReference {
