...
import { convertExampleEndpointCallToSnippetRequest } from "../../utils/convertEndpointSnippetRequest";
...
export class WireTestSuiteGenerator {
            ...
            return exampleEndpointCalls
                .map((exampleEndpointCall, exampleEndpointCallIndex) => {
                    ...
                    const statements: swift.Statement[] = [
                        ...
                        this.generateClientDeclaration(exampleEndpointCall, endpoint),
                        swift.Statement.constantDeclaration({
    ...
    private generateClientDeclaration(
        ...
        const endpointSnippetRequest = convertExampleEndpointCallToSnippetRequest(exampleEndpointCall, endpoint, dynamicEndpoint);
