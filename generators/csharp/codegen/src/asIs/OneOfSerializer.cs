...
public class OneOfSerializer<TOneOf> : JsonConverter<TOneOf> where TOneOf : IOneOf
{
    ...
    {
        var casts = typeof(TOneOf).GetRuntimeMethods().Where(m => m.IsSpecialName && m.Name == "op_Implicit").ToArray();
