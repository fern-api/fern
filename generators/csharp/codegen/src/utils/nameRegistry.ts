...
export class NameRegistry {
     ...
     * @example
     * ```typescript
     * nameRegistry.isRegistered("System.String"); // true - built-in type
     * nameRegistry.isRegistered("MyNamespace.MyType"); // false - not yet registered
     * ```
     */
     ...
     * @param originalFullyQualifiedName - Optional original fully qualified name for the type before any remapping
    ...
    /**
     * Creates a new ClassReference, handling conflict resolution and type registration.
     * This method is the main entry point for creating class references and ensures that
     * all types are properly registered and any naming conflicts are resolved.
     *
     * @param classReferenceArgs - The arguments for creating the class reference
     * @param fullyQualifiedName - The fully qualified name for the class reference
     * @param csharp - The CSharp instance for creating the ClassReference
     * @returns A new ClassReference instance, potentially with modified names to avoid conflicts
     *
     * @example
     * ```typescript
     * const classRef = nameRegistry.createClassReference(
     *   { name: "MyType", namespace: "MyNamespace" },
     *   "MyNamespace.MyType",
     *   csharp
     * );
     * ```
