...
export class HttpPagerEndpointGenerator extends AbstractEndpointGenerator {
    ...
    public generate({
        ...
        const optionsParamName = getRequestOptionsParamNameForEndpoint({ context: this.context, endpoint });
        const requestOptionsParam = getRequestOptionsParameter({ context: this.context, endpoint });
        ...
        const endpointSnippets = this.context.snippetGenerator.getSnippetsForEndpoint(
            this.context.snippetGenerator.getPagerSnippetId(endpoint.id)
        );
