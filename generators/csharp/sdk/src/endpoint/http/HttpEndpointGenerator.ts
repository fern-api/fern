...
export class HttpEndpointGenerator extends AbstractEndpointGenerator {
    ...
    private async getHttpMethodSnippet({
        endpoint
    }: {
        endpoint: HttpEndpoint;
    ...
    private async getHttpPagerMethodSnippet({
        endpoint
    }: {
        endpoint: HttpEndpoint;
    }): Promise<SingleEndpointSnippet | undefined> {
    ...
    private async generateUnpagedMethod({
        serviceId,
        endpoint,
        rawClientReference,
        rawClient
        ...
        const snippet = await this.getHttpMethodSnippet({ endpoint });
    ...
    public async generatePagerMethod({
        serviceId,
        endpoint,
        rawClientReference,
        rawClient
        ...
        const snippet = await this.getHttpPagerMethodSnippet({ endpoint });
        const body = csharp.codeblock((writer) => {
