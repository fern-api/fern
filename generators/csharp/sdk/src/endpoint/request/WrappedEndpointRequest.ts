    ...
    public getQueryParameterCodeBlock(): QueryParameterCodeBlock | undefined {
        ...
        return {
            code: this.csharp.codeblock((writer) => {
                writer.write(
                    `var ${queryStringVar} = new ${this.qualifyNamespace(this.namespaces.core)}.QueryStringBuilder.Builder(capacity: ${this.endpoint.queryParameters.length})`
                );
                writer.indent();
    ...
    public getHeaderParameterCodeBlock(): HeaderParameterCodeBlock | undefined {
        ...
        return {
            code: this.csharp.codeblock((writer) => {
                ...
                writer.write(
                    `var ${this.names.variables.headers} = await new ${this.qualifyNamespace(this.namespaces.core)}.HeadersBuilder.Builder()`
                );
                writer.indent();
