...
public class MultipartFormTests
{
    ...
    private static <%= qualifyNamespace(namespaces.core) %>.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new <%= qualifyNamespace(namespaces.core) %>.MultipartFormRequest
        {
