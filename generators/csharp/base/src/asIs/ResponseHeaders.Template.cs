...
public readonly struct ResponseHeaders : IEnumerable<HttpHeader>
{
    ...
    public long? ContentLength
    {
        get
        {
            ...
            return long.TryParse(stringValue, NumberStyles.Integer, CultureInfo.InvariantCulture, out var longValue)
                ? longValue
                : null;
        }
    }
    ...
    /// </summary>
    public string? RequestId => TryGetValue(HttpHeader.Names.XRequestId, out var value) ? value : null;
