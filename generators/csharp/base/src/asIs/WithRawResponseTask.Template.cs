...
public readonly struct WithRawResponseTask<T>
{
    ...
    /// </summary>
    public static implicit operator global::System.Threading.Tasks.Task<T>(WithRawResponseTask<T> task)
    {
    ...
    public readonly struct Awaiter : ICriticalNotifyCompletion
    {
        ...
        /// </summary>
        public void OnCompleted(System.Action continuation) => _awaiter.OnCompleted(continuation);
    ...
    public readonly struct ConfiguredTaskAwaitable
    {
        ...
        {
            private readonly ConfiguredTaskAwaitable<WithRawResponse<T>>.ConfiguredTaskAwaiter _awaiter;
