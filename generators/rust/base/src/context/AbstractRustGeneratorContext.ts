...
import { BaseRustCustomConfigSchema, GLOBAL_NAMESPACE, SELF, rust } from "@fern-api/rust-codegen";
...
import { RustAttributeMapper } from "./RustAttributeMapper";
import { RustTypeMapper } from "./RustTypeMapper";
...
> extends AbstractGeneratorContext {
    ...
    public readonly rustTypeMapper: RustTypeMapper;
    public readonly rustAttributeMapper: RustAttributeMapper;
    ...
    public constructor(
        ...
        this.rustTypeMapper = new RustTypeMapper(this);
        this.rustAttributeMapper = new RustAttributeMapper(this);
    ...
    public getDateFormat(): rust.AstNode {
    ...
    public getDateTimeFormat(): rust.AstNode {
        return rust.codeblock((writer) => {
            writer.writeNode(this.getConstantClassReference());
    ...
    public getToStringMethod(): rust.Method {
        return rust.method({
            name: "__toString",
            access: "public",
            parameters: [],
    ...
    public isMixedArray(type: rust.Type): boolean {
        return (
    ...
    public getSetterMethod({ name, field }: { name: Name; field: rust.Field }): rust.Method {
        return rust.method({
            name: this.getPropertySetterName(name),
            access: rust.Access.Public,
            parameters: [rust.parameter({ name: "value", type: field.type })],
            return_: SELF,
            body: rust.codeblock((writer) => {
    ...
    public getPropertyAccess(): rust.Access {
        const propertyAccess = this.customConfig.propertyAccess;
        if (propertyAccess == null) {
            return rust.Access.Public;
        }
        switch (propertyAccess) {
            case "public":
                return rust.Access.Public;
            case "private":
                return rust.Access.Private;
            default:
