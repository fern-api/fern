//! Flexible datetime parsing module for DateTime<FixedOffset>
//!
//! This module provides serde helpers for parsing datetime strings that may or may not
//! include a timezone suffix. It preserves the original timezone offset when present,
//! and assumes UTC (+00:00) when no timezone is specified.
//!
//! Supported formats:
//! - `2024-01-15T09:30:00Z` (RFC3339 with Z, preserved as +00:00)
//! - `2024-01-15T09:30:00-05:00` (RFC3339 with offset, preserved)
//! - `2024-01-15T09:30:00` (ISO 8601 without timezone, assumes UTC +00:00)
