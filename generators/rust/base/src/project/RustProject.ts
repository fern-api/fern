...
export class RustProject extends AbstractProject<AbstractRustGeneratorContext<BaseRustCustomConfigSchema>> {
    ...
    private testFiles: RustFile[] = [];
    private coreFiles: File[] = [];
    private coreTestFiles: File[] = [];
    private utilsFiles: File[] = [];
    public readonly filepaths: RustProjectFilepaths;
    ...
    public constructor({
        ...
        super(context);
        this.name = name;
        this.packagePathPrefix = RustProject.getPackagePathPrefix(this.context.customConfig.packagePath);
        this.filepaths = new RustProjectFilepaths(this.packagePathPrefix, this.name);
    }

    public addSourceFiles(file: RustFile): void {
        this.sourceFiles.push(file);
    }

    public addTestFiles(file: RustFile): void {
    ...
    private async createSourceDirectory(): Promise<AbsoluteFilePath> {
        return await this.createRustDirectory({
    ...
    private async createRustDirectory({
