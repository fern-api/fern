...
const DEFAULT_CONFIG: FernGeneratorExec.GeneratorConfig = {
    ...
    customConfig: {
        namespace: "Acme"
    } as BaseRustCustomConfigSchema
};

export function buildGeneratorConfig({
    customConfig
}: { customConfig?: Partial<BaseRustCustomConfigSchema> } = {}): FernGeneratorExec.GeneratorConfig {
    return {
        ...DEFAULT_CONFIG,
        customConfig: {
            ...(DEFAULT_CONFIG.customConfig as BaseRustCustomConfigSchema),
            ...customConfig
        }
    };
}
