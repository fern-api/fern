...
export class DynamicTypeLiteralMapper {
    ...
    public convert(args: DynamicTypeLiteralMapper.Args): rust.TypeLiteral {
        // eslint-disable-next-line eqeqeq
        if (args.value === null) {
            if (this.context.isNullable(args.typeReference)) {
                return rust.TypeLiteral.null();
            }
    ...
    private convertLiteral({
        ...
        switch (literalType.type) {
            case "boolean": {
                ...
                return rust.TypeLiteral.boolean(bool);
            }
            case "string": {
                ...
                return rust.TypeLiteral.string(str);
            }
            default:
    ...
    private convertList({ list, value }: { list: FernIr.dynamic.TypeReference; value: unknown }): rust.TypeLiteral {
    ...
    private convertMap({ map, value }: { map: FernIr.dynamic.MapType; value: unknown }): rust.TypeLiteral {
    ...
    }): rust.ConstructorField[] | undefined {
    ...
    private convertDiscriminatedUnionVariantArgs({
        ...
        discriminatedUnionTypeInstance: DiscriminatedUnionTypeInstance;
        unionVariant: FernIr.dynamic.SingleDiscriminatedUnionType;
        unionProperties: rust.ConstructorField[];
    }): rust.AstNode[] {
    ...
    private convertEnum({ enum_, value }: { enum_: FernIr.dynamic.EnumType; value: unknown }): rust.TypeLiteral {
    ...
    private convertUnknown({ value }: { value: unknown }): rust.TypeLiteral {
        return rust.TypeLiteral.unknown(value);
    }
    ...
    private convertPrimitive({
        ...
        switch (primitive) {
            ...
            case "UINT_64": {
                ...
                return rust.TypeLiteral.number(num);
            }
            case "FLOAT":
            case "DOUBLE": {
                ...
                return rust.TypeLiteral.float(num);
            }
            case "BOOLEAN": {
            ...
            case "DATE_TIME": {
                ...
                return rust.TypeLiteral.datetime(str);
            }
            case "BASE_64":
            case "UUID":
            case "BIG_INTEGER":
