...
export class DynamicSnippetsGeneratorContext extends AbstractDynamicSnippetsGeneratorContext {
    ...
    constructor({
        ...
        this.ir = ir;
        this.customConfig =
            config.customConfig != null ? (config.customConfig as BaseRustCustomConfigSchema) : undefined;
    ...
    public getEnvironmentClassAccessFromID(environmentID: string): rust.AstNode | undefined {
