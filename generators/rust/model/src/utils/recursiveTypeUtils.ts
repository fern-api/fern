...
function checkRecursion(
    ...
    if (typeReference.type === "container") {
        return typeReference.container._visit({
            ...
            list: (listType) => checkRecursion(targetTypeId, listType.itemType, ir, visitedPath),
            ...
            set: (setType) => checkRecursion(targetTypeId, setType.itemType, ir, visitedPath),
...
export function getReferencedTypeId(typeReference: TypeReference): string | undefined {
    ...
    if (typeReference.type === "container") {
        return typeReference.container._visit<string | undefined>({
            ...
            list: (listType) => getReferencedTypeId(listType.itemType),
            map: (mapType) => getReferencedTypeId(mapType.valueType),
            set: (setType) => getReferencedTypeId(setType.itemType),
            literal: () => undefined,
            _other: () => undefined
        });
    }
