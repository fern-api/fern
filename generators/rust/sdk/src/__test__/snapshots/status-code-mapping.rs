...
pub enum ApiError {
    #[error("BadRequestError: Validation error in field '{{field:?}}': {{message}}")]
    BadRequestError { field: Option<String>, details: Option<String> },
    ...
    ForbiddenError { resource: Option<String>, required_permission: Option<String> },
    #[error("NotFoundError: {{resource_type:?}} not found: {{resource_id:?}}")]
    NotFoundError { resource_id: Option<String>, resource_type: Option<String> },
