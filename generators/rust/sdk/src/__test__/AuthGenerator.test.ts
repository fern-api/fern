...
//             });
//         case "oauth":
//             // TODO: Implement oauth auth scheme
//             throw new Error(`OAuth auth type not yet implemented: ${config.type}`);
//         case "inferred":
//             // TODO: Implement inferred auth scheme
//             throw new Error(`Inferred auth type not yet implemented: ${config.type}`);
//         default:
