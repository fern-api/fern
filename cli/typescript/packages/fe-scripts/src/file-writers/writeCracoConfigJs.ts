...
export const writeCracoConfigJs = createLooseFileWriter({
    relativePath: "craco.config.js",
    generateFile: () => DEFAULT_CRACO_CONFIG,
    isForBundlesOnly: true,
});

const DEFAULT_CRACO_CONFIG = `const { getLoader, loaderByName } = require("@craco/craco");
