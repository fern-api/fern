...
public abstract class CodeGenerationResult {
    ...
    public static String getModelBuildGradle(FernPluginConfig pluginConfig) {
        return "plugins {\n"
                ...
                + "    api project('io.github.fern-api:exception-utils:" + pluginConfig.version() + "')\n"
                + "    api project('io.github.fern-api:immutables-utils:" + pluginConfig.version() + "')\n"
                + "\n"
    ...
    public static String getClientBuildGradle(FernPluginConfig pluginConfig) {
        return "plugins {\n"
                ...
                + "    api project('io.github.fern-api:auth-utils:" + pluginConfig.version() + "')\n"
                + "    api project('io.github.fern-api:exception-utils:" + pluginConfig.version() + "')\n"
                + "    api project('io.github.fern-api:immutables-utils:" + pluginConfig.version() + "')\n"
                + "    api project('io.github.fern-api:jackson-utils:" + pluginConfig.version() + "')\n"
                + "    implementation 'com.fasterxml.jackson.core:jackson-databind:2.12.3'\n"
