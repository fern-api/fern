...
By default, the generation runs in the cloud. If you want to run it on your local machine, you can use the `--local` option. _This will run the compiler in a Docker container._

To keep the container after the compiler is done, use the `--keepDocker` option.
