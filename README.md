...
| `fernapi/fern-go-model`     | [![Go Model Generator Version](https://img.shields.io/docker/v/fernapi/fern-go-model)](./generators/go/VERSION)| [CHANGELOG.md](./generators/go/sdk/CHANGELOG.md)      | [main.go](./generators/go/cmd/fern-go-model/main.go)                                  |
