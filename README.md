...
1. **Leave you with an OpenAPI spec**. Fern also generates an OpenAPI spec, so you’re never locked in and can use any other tools that integrate with OpenAPI.
