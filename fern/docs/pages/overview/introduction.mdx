---
title: Introduction to the Fern toolkit
...
While we are big fans of OpenAPI, we know it isn't the _easiest_ format to read and write. If you're looking for an alternative, give the [Fern Definition](/learn/overview/define-your-api/ferndef/overview) a try.
