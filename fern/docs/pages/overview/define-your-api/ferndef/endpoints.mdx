...
2. Whether the service requires [authentication](/overview/define-your-api/ferndef/api-yml-reference#authentication)
3. **Endpoints**

<CodeBlock title='user.yml'>
  ```yaml service: base-path: /users auth: false endpoints: {}
  ```
</CodeBlock>
...
- The [environment](/overview/define-your-api/ferndef/api-yml-reference#environments) URL
...
You can learn more about how to define errors on the [Errors](/overview/define-your-api/ferndef/errors) page.
