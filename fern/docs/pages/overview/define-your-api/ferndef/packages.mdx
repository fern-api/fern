...
other definition file, it can contain [imports](/overview/define-your-api/ferndef/imports),
[types](/overview/define-your-api/ferndef/types), [endpoints](/overview/define-your-api/ferndef/endpoints),
and [errors](/overview/define-your-api/ferndef/errors).
...
Note the `fern/` folder structure will now look like:
