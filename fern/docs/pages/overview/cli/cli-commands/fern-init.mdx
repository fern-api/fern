...
The `generators.yml` file contains settings for the generators you want to use. By default, it uses the TypeScript SDK generator. Use [fern add](/learn/overview/cli/commands) to add generators, and edit the file to remove generators.
