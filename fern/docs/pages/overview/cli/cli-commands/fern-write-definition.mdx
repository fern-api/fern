...
<Tip>
You can convert Fern Definition files back to OpenAPI at any time using our [OpenAPI generator](/sdks/other-generators/spec/openapi). Whether you want to switch back, or you need an OpenAPI specification for use with other tools, you're never locked in.
</Tip>
