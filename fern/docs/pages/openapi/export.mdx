...
<CodeBlock title="generators.yml">
  ``` generators: convert: - name: fernapi/fern-openapi version: 0.0.28 config: format: yaml #options are yaml or json
  github: repository: your-organization/your-repository ```
</CodeBlock>
