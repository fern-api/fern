...
You can customize the behavior of the TypeScript Browser generator in `generators.yml`. The options available are identical to [the options for the TypeScript Node generator](/generate-sd-ks/generators/type-script-node-js-sdk#configuration-options).
