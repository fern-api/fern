...
description: Use Fern's TypeScript Node.js SDK generator and your API definition to output a fully functional SDK locally, and publish the package internally or publicly.
---
