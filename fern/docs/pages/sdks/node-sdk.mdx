...
The TypeScript Node.js SDK generator outputs a fully functional TypeScript/JavaScript SDK for server-side usage. It can publish the SDK to [npmjs.org](https://npmjs.org) (or any other Node package repository).
