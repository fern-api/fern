...
description: Use Fern's Java SDK generator and your API definition to output a fully functional Java SDK and publish it to a private Maven repository or Maven Central. 
---
