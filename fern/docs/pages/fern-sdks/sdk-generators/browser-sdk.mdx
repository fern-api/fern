---
title: The TypeScript Browser SDK generator
...
[Source code](https://github.com/fern-api/fern/tree/main/generators/typescript)
...
You can customize the behavior of the TypeScript Browser generator in `generators.yml`. The options available are identical to [the options for the TypeScript Node generator](/fern-sd-ks/sdk-generators/type-script-node-js-sdk#configuration-options).
