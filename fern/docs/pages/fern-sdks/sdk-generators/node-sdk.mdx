...
description: Use Fern's TypeScript SDK generator and your API definition to output a fully functional SDK locally, or to a private or public Node package repository.
---

[Source code](https://github.com/fern-api/fern/tree/main/generators/typescript)<br/>
**Latest version**: `0.12.5`

Output a fully functional TypeScript/JavaScript SDK. The generator can publish the SDK to [npmjs.org](https://npmjs.org) (or any other Node package repository), or to a private repository hosted by Fern. You can also download the SDK to your local file system.
