...
The Java SDK generator outputs a fully functional Java SDK. It can publish the SDK to [Maven Central](https://central.sonatype.com/) or to a private repository hosted by Fern.
