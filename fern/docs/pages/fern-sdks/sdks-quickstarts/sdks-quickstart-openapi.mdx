...
desc: In this Quickstart, install the Fern CLI tool, initialize a Fern project, and generate a sample SDK from an API defined with OpenAPI.
---
...
<Callout intent="tip">
Looking for an alternative to OpenAPI? Give the simpler Fern Definition format a try: [Fern SDKs Quickstart with Fern Definition](/fern-sd-ks/quickstarts/ferndef).
</Callout>
