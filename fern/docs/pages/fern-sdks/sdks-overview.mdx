...
| -------------------------------------------------------------- | --------------------- | --------------- | ------------------------------------- |
| [TypeScript Node.js](/learn/sdks/sdk-generators/typescript)    | Generally available   | NPM             | `fernapi/fern-typescript-node-sdk`    |
| [Python](/learn/sdks/sdk-generators/python)                    | Generally available   | PyPI            | `fernapi/fern-python-sdk`             |
| [Java](/learn/sdks/sdk-generators/java)                        | Generally available   | Maven           | `fernapi/fern-java-sdk`               |
| [Go](/learn/sdks/sdk-generators/go)                            | Generally available   | Proxy Module    | `fernapi/fern-go-sdk`                 |
| [Ruby](/learn/sdks/sdk-generators/ruby)                        | Generally available   | Gems            | `fernapi/fern-ruby-sdk`               |
| [C#](/learn/sdks/sdk-generators/csharp)                        | In private beta       | NuGet           | `fernapi/fern-csharp-sdk`             |
| [PHP](/learn/sdks/sdk-generators/php)                          | Coming in 2024        | Packagist       | `fernapi/fern-php-sdk`                |
| [Swift](/learn/sdks/sdk-generators/swift)                      | Coming in 2024        | SwiftPM         | `fernapi/fern-swift-sdk`              |
| [Rust](/learn/sdks/sdk-generators/rust)                        | Coming in 2024        | Cargo           | `fernapi/fern-rust-sdk`               |
...
Fern can automatically update your SDK code in GitHub repositories. See our guide on [Fern's GitHub Bot](/learn/sdks/guides/github-bot).
...
| ---------------------------------------------------------------------- | ---------- | ------------------- | --------------------------------- |
| [Express](/learn/sdks/other-generators/server-side/express)            | JavaScript | Generally available | `fernapi/fern-typescript-express` |
| [FastAPI](/learn/sdks/other-generators/server-side/fastapi)            | Python     | Generally available | `fernapi/fern-fastapi-server`     |
| [Spring](/learn/sdks/other-generators/server-side/spring)              | Java       | Generally available | `fernapi/fern-java-spring`        |
...
Use our [OpenAPI generator](/learn/sdks/other-generators/spec/openapi) to export your Fern Definition to the OpenAPI specification, and our [Postman Collection generator](/learn/sdks/other-generators/spec/postman) to export your API definition to a Postman Collection. 
