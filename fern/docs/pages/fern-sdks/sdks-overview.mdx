...
| [Ruby](/fern-sd-ks/sdk-generators/ruby)                        | Generally available   | Gems            | `fernapi/fern-ruby-sdk`               |
| [C#](/fern-sd-ks/sdk-generators/csharp)                        | In private beta       | NuGet           | `fernapi/fern-csharp-sdk`             |
| [PHP](/fern-sd-ks/sdk-generators/php)                          | Coming in 2024        | Packagist       | `fernapi/fern-php-sdk`                |
| [Swift](/fern-sd-ks/sdk-generators/swift)                      | Coming in 2024        | SwiftPM         | `fernapi/fern-swift-sdk`              |
| [Rust](/fern-sd-ks/sdk-generators/rust)                        | Coming in 2024        | Cargo           | `fernapi/fern-rust-sdk`               |
...
| ---------------------------------------------------------------------- | ---------- | ------------------- | --------------------------------- |
| [Express](/fern-sd-ks/other-generators/server-side/express)            | JavaScript | Generally available | `fernapi/fern-typescript-express` |
| [FastAPI](/fern-sd-ks/other-generators/server-side/fastapi)            | Python     | Generally available | `fernapi/fern-fastapi-server`     |
