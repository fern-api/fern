...
See TypeScript Node.js SDK Configuration options: [useBrandedStringAliases](/fern-sd-ks/sdk-generators/typescript#usebrandedstringaliases).

### `treatUnknownAsAny`

See TypeScript Node.js SDK Configuration options: [treatUnknownAsAny](/fern-sd-ks/sdk-generators/typescript#treatunknownasany).

### `noSerdeLayer`

See TypeScript Node.js SDK Configuration options: [noSerdeLayer](/fern-sd-ks/sdk-generators/typescript#noserdelayer).

### `outputSourceFiles`

See TypeScript Node.js SDK Configuration options: [outputSourceFiles](/fern-sd-ks/sdk-generators/typescript#outputsourcefiles).
