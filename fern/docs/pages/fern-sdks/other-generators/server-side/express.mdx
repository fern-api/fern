...
<CodeBlock title='generators.yml'>
  ```yaml - name: fernapi/fern-typescript-express version: 0.9.7 output: location:
  local-file-system path: ../generated/server-boilerplate/express
  ```
</CodeBlock>
...
See TypeScript Node.js SDK Configuration options: [useBrandedStringAliases](/fern-sd-ks/sdk-generators/type-script-node-js-sdk#usebrandedstringaliases).

#### `treatUnknownAsAny`

See TypeScript Node.js SDK Configuration options: [treatUnknownAsAny](/fern-sd-ks/sdk-generators/type-script-node-js-sdk#treatunknownasany).

#### `noSerdeLayer`

See TypeScript Node.js SDK Configuration options: [noSerdeLayer](/fern-sd-ks/sdk-generators/type-script-node-js-sdk#noserdelayer).

#### `outputSourceFiles`

See TypeScript Node.js SDK Configuration options: [outputSourceFiles](/fern-sd-ks/sdk-generators/type-script-node-js-sdk#outputsourcefiles).
