This configuration enables errors to show up on the endpoint pages of your documetnation. The error names, codes, and objects returned are configured in your API definition.
