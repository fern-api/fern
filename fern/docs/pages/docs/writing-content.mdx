...
### Nested Sections
If you'd like a section to toggle into more sections and pages, you can nest sections within sections. Here's an example of how it's done.
<CodeBlock title="docs.yml">
```mdx
navigation:
  - tab: guides
...
![Result of above docs.yml example](https://private-user-images.githubusercontent.com/83524670/297957632-6dc55e8c-0b7b-4ef0-ab13-2b48a5dbf424.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..7zYsugnrdFoXSiXJ-3TIbXEOZ5YYYwaEIKOO6kCOvsw)
