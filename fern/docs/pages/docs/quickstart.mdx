...
If you will be using [Fern Definitions](/api-definition/fern-definition/overview) to describe your API, skip to [Step 6](#step-6--generate-your-documentation).
...
```fern init --openapi ../fern/openapi/openapi.yml```
...
- For [Fern Definitions](/api-definition/fern-definition/overview), update the files in the `definition` folder.
