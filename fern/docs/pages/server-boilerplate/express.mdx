...
See TypeScript Node.js SDK Configuration options: [useBrandedStringAliases](/generate-sd-ks/generators/type-script-node-js-sdk#use-branded-string-aliases).

#### `treatUnknownAsAny`

See TypeScript Node.js SDK Configuration options: [treatUnknownAsAny](/generate-sd-ks/generators/type-script-node-js-sdk#treat-unknown-as-any).

#### `noSerdeLayer`

See TypeScript Node.js SDK Configuration options: [noSerdeLayer](/generate-sd-ks/generators/type-script-node-js-sdk#no-serde-layer).

#### `outputSourceFiles`

See TypeScript Node.js SDK Configuration options: [outputSourceFiles](/generate-sd-ks/generators/type-script-node-js-sdk#output-source-files).
