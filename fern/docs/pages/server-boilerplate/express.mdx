...
See TypeScript Node.js SDK Configuration options: [useBrandedStringAliases](https://docs.buildwithfern.com/generate-sd-ks/generators/type-script-node-js-sdk#use-branded-string-aliases).

#### `treatUnknownAsAny`

See TypeScript Node.js SDK Configuration options: [treatUnknownAsAny](https://docs.buildwithfern.com/generate-sd-ks/generators/type-script-node-js-sdk#treat-unknown-as-any).

#### `noSerdeLayer`

See TypeScript Node.js SDK Configuration options: [noSerdeLayer](https://docs.buildwithfern.com/generate-sd-ks/generators/type-script-node-js-sdk#no-serde-layer).

#### `outputSourceFiles`

See TypeScript Node.js SDK Configuration options: [outputSourceFiles](https://docs.buildwithfern.com/generate-sd-ks/generators/type-script-node-js-sdk#output-source-files).
