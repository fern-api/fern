...
### The `icon` prop
The usage for the `icon` prop for this component is identical to the `icon` prop for the `Icon` component. See [Icons](/fern-docs/content/components/icons#set-icon-and-style) for more information about setting this prop.
