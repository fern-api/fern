...
You can only use endpoints that [you have defined](/overview/define-your-api), using OpenAPI or Fern Definition. If you have [generated an API Reference](/fern-docs/content/generate-api-ref) in your Fern Docs site, you can view it to verify the endpoints available for use as the `endpoint` prop. For example, see the endpoint inside the red box below:
