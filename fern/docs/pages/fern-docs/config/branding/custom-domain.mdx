...
<Callout intent='tip'>
  Note: Custom domains is a paid feature. Want to get set up? Reach out in
  [Discord](https://discord.com/invite/JkkXumPzcG) or [email
  us](mailto:sales@buildwithfern.com).
</Callout>

### 1. Add your domain to `docs.yml`
...
### 3. Create DNS records to point at Fern Docs
