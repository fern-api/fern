...
<Tip>
No Fern Docs repository yet? Use our [Fern Docs Quickstart with OpenAPI](/fern-docs/quickstarts/openapi) or [Fern Docs Quickstart with Fern Definition](/fern-docs/quickstarts/ferndef) to set up your starter site, then return to this page. 
</Tip>
...
If you created your Fern Docs site using one of our [Docs Quickstarts](/overview/get-started#fern-docs-quickstarts), push the changes you made to your GitHub repository. This runs a GitHub Action to update the site with your new configuration.
