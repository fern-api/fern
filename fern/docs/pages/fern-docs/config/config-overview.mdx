...
- Brand your site with your organization's [logo and favicon](/fern-docs/config/branding/logo-and-favicon), as well as custom [colors, fonts, and background image](/fern-docs/config/branding/colors-fonts-background-image).
