...
If you'd like to bring SDK snippets into your own documentation, you can use the [Snippets API](/sdks/api-reference/snippets). API access requires a [SDK Business plan](https://buildwithfern.com/pricing) or above.
...
Looking for information on generating API endpoint request and response snippets? See our documentation on [Endpoint Snippets](/docs/components/endpoint-snippets).