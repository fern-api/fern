...
In order to generate code snippets, Fern needs to read request examples from your API definition. If you're using a Fern Definition, you can follow [these instructions](/learn/overview/define-your-api/ferndef/examples). If you're using an OpenAPI Specification, you can follow [these instructions](https://swagger.io/docs/specification/adding-examples/).
...
If you'd like to bring SDK snippets into your own documentation, you can use the [Snippets API](/learn/sdks/api-reference/snippets). API access requires a [SDK Business plan](https://buildwithfern.com/pricing) or above.
