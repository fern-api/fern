---
title: Generate SDK snippets for your docs
...
If you'd like to bring SDK snippets into your own documentation, you can use the [Snippets API](/fern-docs/content/use-snippets-api/introduction). API access requires a [SDK Business plan](https://buildwithfern.com/pricing).
