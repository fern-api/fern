...
<Callout intent='tip'>
Looking for an alternative to OpenAPI? Give the simpler Fern Definition format a try: [Fern Docs Quickstart with Fern Definition](/fern-docs/quickstarts/ferndef).
</Callout>
