<Callout intent='success'>
  Beautiful documentation in under 5 minutes. Here's [an
  example.](https://docs.propexo.com/documentation)
</Callout>
...
If you will be using [Fern Definitions](/overview/define-your-api/ferndef/overview) to describe your API, skip to [Step 6](/fern-docs/docs-quickstart#step-6-generate-your-documentation).
...
- For [Fern Definitions](/overview/define-your-api/ferndef/overview), update the files in the `definition/` folder.
...
Fern has a built-in component library for you to use. [Explore the components.](/fern-docs/content/component-library/)
...
For advanced documentation features and options, view the full [configuration docs](/fern-docs/config/overview).
