...
- Update or replace the Fern Definition files in the `definition/` folder. See our documentation on [how to define your API with Fern Definition](define-your-api/ferndef/overview).
...
- See the [Component Library](/fern-docs/content/component-library/).
...
<CodeBlocks>
    ...
    ```yaml
    - url: YOUR_ORGANIZATION.docs.buildwithfern.com
      custom-domain: YOUR_ORGANIZATION.COM/docs
    ```
    </CodeBlock>
</CodeBlocks>
