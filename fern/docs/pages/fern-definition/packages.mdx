...
other definition file, it can contain [imports](/api-definition/fern-definition/imports),
[types](/api-definition/fern-definition/types), [endpoints](/api-definition/fern-definition/endpoints),
and [errors](/api-definition/fern-definition/errors).
