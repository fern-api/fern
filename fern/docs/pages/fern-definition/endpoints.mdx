...
2. Whether the service requires [authentication](/api-definition/fern-definition/api-yml-reference#authentication)
3. **Endpoints**
...
- The [environment](/api-definition/fern-definition/api-yml-reference#environments) URL
...
You can learn more about how to define errors on the [Errors](/api-definition/fern-definition/errors) page.
