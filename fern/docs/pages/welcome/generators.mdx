...
| ------------------------------------------------------------------------------------------------------ | --------------------- | --------------- | ------------------------------------- |
| [TypeScript Node.js](https://docs.buildwithfern.com/generate-sd-ks/generators/type-script-node-js-sdk) | Generally available   | NPM             | `fernapi/fern-typescript-node-sdk`    |
| [TypeScript Browser](https://docs.buildwithfern.com/generate-sd-ks/generators/type-script-browser-sdk) | Generally available   | NPM             | `fernapi/fern-typescript-browser-sdk` |
| [Python](https://docs.buildwithfern.com/generate-sd-ks/generators/python-sdk)                          | Generally available   | PyPI            | `fernapi/fern-python-sdk`             |
| [Java](https://docs.buildwithfern.com/generate-sd-ks/generators/java-sdk)                              | Generally available   | Maven           | `fernapi/fern-java-sdk`               |
| [Go](https://docs.buildwithfern.com/generate-sd-ks/generators/go-sdk)                                  | Generally available   | Proxy Module    | `fernapi/fern-go-sdk`                 |
| [C#](https://docs.buildwithfern.com/generate-sd-ks/generators/c-sdk)                                   | In development        | NuGet           | `fernapi/fern-csharp-sdk`             |
| [Ruby](https://docs.buildwithfern.com/generate-sd-ks/generators/ruby-sdk)                              | Coming by end of year | Gems            | `fernapi/fern-ruby-sdk`               |
| [PHP](https://docs.buildwithfern.com/generate-sd-ks/generators/php-sdk)                                | Coming next year      | Packagist       | `fernapi/fern-php-sdk`                |
...
| --------------------------------------------------------------------------------------------------- | ---------- | ------------------- | -------------------------------------- |
| [Express](https://docs.buildwithfern.com/server-boilerplate/server-boilerplate/express-js)          | JavaScript | Generally available | `fernapi/fern-typescript-express`      |
...
Export your [Fern Definition](https://docs.buildwithfern.com/api-definition/fern-definition/overview) to an OpenAPI Description file. 

| Availability |  `fern add <generator>` Command  |
| ------------ | ---------------------------------|
| Generally available | `fernapi/fern-openapi` |

For more information, see [Exporting OpenAPI](https://docs.buildwithfern.com/api-definition/openapi/exporting-open-api).
