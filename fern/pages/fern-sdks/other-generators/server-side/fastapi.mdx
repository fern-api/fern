...
[![Python FastAPI Server Generator Version](https://img.shields.io/docker/v/fernapi/fern-fastapi-server)](https://github.com/fern-api/fern/blob/main/generators/python/fastapi/VERSION)
