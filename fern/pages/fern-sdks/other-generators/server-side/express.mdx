...
[![Typescript Express Server Generator Version](https://img.shields.io/docker/v/fernapi/fern-typescript-express)](https://github.com/fern-api/fern/blob/main/generators/typescript/express/VERSION)
...
See TypeScript Node.js SDK Configuration options: [useBrandedStringAliases](/learn/sdks/sdk-generators/typescript#usebrandedstringaliases).

### `treatUnknownAsAny`

See TypeScript Node.js SDK Configuration options: [treatUnknownAsAny](/learn/sdks/sdk-generators/typescript#treatunknownasany).

### `noSerdeLayer`

See TypeScript Node.js SDK Configuration options: [noSerdeLayer](/learn/sdks/sdk-generators/typescript#noserdelayer).

### `outputSourceFiles`

See TypeScript Node.js SDK Configuration options: [outputSourceFiles](/learn/sdks/sdk-generators/typescript#outputsourcefiles).
