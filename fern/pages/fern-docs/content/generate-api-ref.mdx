...
and errors automatically populated from your [OpenAPI specification](/learn/overview/define-your-api/openapi/overview) or [Fern Definition](/learn/overview/define-your-api/ferndef/overview).
...
| `snippets`       | Enable [generated SDK code snippets](/docs/api-references/sdk-snippets) in your API reference |
