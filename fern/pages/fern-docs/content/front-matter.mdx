...
<Tip>
  By default, Fern will center the contents of a page when the table of contents is hidden. You can override this behavior by setting `layout: overview` in the frontmatter of the page. More information is available in the [layout documentation](#layout).
</Tip>
...
- `overview`: The page is displayed full-width.
- `guide`: The page is displayed with the standard guide layout.
- `reference`: The page is displayed with the API Reference layout. The table of contents is hidden in this layout.
- `page`: The page is displayed full-screen. The table of contents and sidebar navigation are hidden in this layout.
- `custom`: The page is displayed without layout styling. The table of contents and sidebar navigation are hidden in this layout.
