...
If you are using an OpenAPI Specification, sections are created based on the `tags` property. If you are using a Fern Definition, sections are created based on the [`service`](/learn/api-definition/fern/endpoints#service-definition) file names.
</Note>
