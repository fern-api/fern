...
If you'd like to bring SDK snippets into your own documentation, you can use the [Snippets API](/learn/api/api-reference/snippets/get). API access requires a [SDK Business plan](https://buildwithfern.com/pricing) or above.
...
Looking for information on generating API endpoint request and response snippets? See our documentation on [Endpoint Request Snippets](/learn/docs/components/endpoint-request-snippet) and [Endpoint Response Snippets](/learn/docs/components/endpoint-response-snippet).