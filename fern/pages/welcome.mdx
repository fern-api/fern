...
<Note>Our entire docs website (the one you're looking at right now!) is buit by Fern. [See the source markdown.](https://github.com/fern-api/fern/blob/main/fern/pages/welcome.mdx)</Note>
