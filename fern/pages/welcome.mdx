...
<div className="motivation">
  ...
  We built Fern to productize this process and make it accessible. Just input an OpenAPI
  (formerly Swagger) or AsyncAPI Spec, and output idiomatic SDKs and beautiful documentation.
</div>
