...
<ParamField path="last" type="boolean" required={false}>
  Removes the bottom border from the parameter. 

  Best used for the last element in a list of `<ParamField />` components.
</ParamField>
...
## Example
  <Tabs>
    <Tab title="Example">
      ...
      <ParamField path="api_key" type="string" deprecated={true} last={true}>
