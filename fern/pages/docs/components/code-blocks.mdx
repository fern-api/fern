...
By default, `CodeBlocks` will sync based on the language specified immediately after the opening backticks. To override the language used to sync the `CodeBlocks`, use the `for` property.
