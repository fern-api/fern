...
You can highlight specific lines in your code snippet {/* either by adding a comment `// [!code highlight]` or */} by 
...
Instead of highlighting lines, you can focus on specific lines {/* either by adding a comment `// [!code focus]` or */} by adding a 
