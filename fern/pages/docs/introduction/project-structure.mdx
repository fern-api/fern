...
The `openapi` folder contains the OpenAPI specification file for your API Reference section. If you have an API Reference section in your documentation, you can place the OpenAPI specification file in this folder.
