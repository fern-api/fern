...
<CodeBlock title='docs.yml for example landing page'>
```yaml 
landing-page: 
...
See Cohere's landing page live [here](https://docs.cohere.com/) and `pages/index.mdx` [here](https://github.com/cohere-ai/cohere-developer-experience/blob/23117454e015e12245c14fe67278c342309d28ca/fern/pages/index.mdx?plain=1). 