...
<ParamField path="instances.edit-this-page" type="object" required={false}>
  ...
  Learn more about the [`edit-this-page` object](/learn/docs/getting-started/global-configuration#github-configuration). 
</ParamField>
...
<ParamField path="typography.bodyFont" type="object" required={false}>
  ...
  Learn more about the [`font` configuration](/learn/docs/getting-started/global-configuration#font-configuration).
</ParamField>
...
<ParamField path="style" type="string" required={false}>
  The style of the font. Options are `normal` or `italic`. Defaults to `normal`. 
</ParamField>
