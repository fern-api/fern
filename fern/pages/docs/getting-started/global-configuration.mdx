...
<ParamField path="redirects" type="object" required={false}>
  Learn more about the redirects configuration [here](/learn/docs/building-your-docs/redirects-and-links).
</ParamField>
