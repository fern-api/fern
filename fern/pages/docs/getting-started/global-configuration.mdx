...
<ParamField path="instances.edit-this-page" type="object" required={false}>
  ...
  Learn more about the `edit-this-page` object [here](#edit-this-page-configuration). 
</ParamField>
...
<ParamField path="edit-this-page.github" type="object" required={false}>
  Set the GitHub repository and branch where you would like users to suggest edits. 
  
  Learn more about the GitHub configuration [here](#github-configuration).
</ParamField>
