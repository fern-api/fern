...
<ParamField path="icon" type="string" required={false}>
  The [Font Awesome icon](https://fontawesome.com/icons) to be used in the button. This icon will appear to the **left** of the text content. Pro Icons from Font Awesome are supported.
</ParamField>

<ParamField path="rightIcon" type="string" required={false}>
  The [Font Awesome icon](https://fontawesome.com/icons) to be used in the button. This icon will appear to the **right** of the text content. Pro Icons from Font Awesome are supported.
