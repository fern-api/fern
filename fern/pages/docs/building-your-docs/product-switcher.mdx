...
- `fern-product-selector` - Controls the styling of the product dropdown
- `fern-version-selector` - Controls the styling of the version dropdown

### Common Styling Adjustments

**Adjusting line height and positioning:**
Use `transform: translateY(4px)` to adjust the vertical positioning of the selectors. This ensures that the product and version selectors match the line height of your logo for better visual alignment.
