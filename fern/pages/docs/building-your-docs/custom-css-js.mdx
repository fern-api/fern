...
subtitle: Add custom CSS, global JavaScript, and components. 
description: Add brand-specific styling, user interactions. and components to make your docs your own.
---

<Note>Custom CSS & JS are available on the Business plan. Adding Custom Components is available on the Enterprise plan.</Note>
