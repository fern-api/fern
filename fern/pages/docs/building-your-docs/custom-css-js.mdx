...
subtitle: Add custom CSS, JavaScript, and components. 
description: Add brand-specific styling, user interactions. and components to make your docs your own.
---

<Note>Custom CSS & JS are available on the Business plan. Add Custom Components with Enterprise.</Note>
...
You can also specify multiple custom CSS files:
...
Customize the behavior of your Docs site by injecting custom JavaScript. Add a `custom.js` file and include it in your `fern/` project:
