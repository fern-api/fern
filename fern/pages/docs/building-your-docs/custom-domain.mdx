...
You'll need a CNAME record for your root domain. Reach out to Fern Support to get the record to add.

### Verify the setup

Once we've completed the setup on our end, you should be able to access your documentation at `mydomain.com`. SSL will be automatically provisioned for your domain, but it may take a few minutes to propagate globally.
