...
![LLMs.txt Splash Image](../../../../fern/images/changelogs/docs/llms-txt.png)

Check out ElevenLabs:

https://elevenlabs.io/docs/llms.txt *loads in < 1 sec*

https://elevenlabs.io/docs/llms-full.txt *loads in 5+ sec*