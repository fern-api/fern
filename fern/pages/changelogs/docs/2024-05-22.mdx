## Tab URL Management
Enhanced URL handling in documentation tabs, allowing control over URL behavior when switching between tabs. This provides better navigation history and sharing capabilities.
