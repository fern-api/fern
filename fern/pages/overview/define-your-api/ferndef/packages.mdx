...
description: Fern Definition packages have namespaces for reusing API type and error names across packages, and can configure the order in which your docs shows services.
---
...
other definition file, it can contain [imports](/learn/overview/define-your-api/ferndef/imports),
[types](/learn/overview/define-your-api/ferndef/types), [endpoints](/learn/overview/define-your-api/ferndef/endpoints),
and [errors](/learn/overview/define-your-api/ferndef/errors).
