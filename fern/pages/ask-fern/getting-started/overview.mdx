...
<Frame>
  <video 
    ...
    loop
  >
    <source src="ask-fern.mp4" type="video/mp4" />
  </video>
</Frame>

## Overview
Fern Ask fern indexes your documentation and provides an interface for your users to ask questions and get answers. We've found that it helps our customers:
