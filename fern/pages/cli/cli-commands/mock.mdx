...
Use `fern mock` to start a mock server for your API. Fern will use your 
API Definition to generate a mock server that will be used in the integration tests. 
