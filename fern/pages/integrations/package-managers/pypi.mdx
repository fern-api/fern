...
To authenticate and integrate the Python Package Index within your Python SDK, you'll need to [create an PyPI token](http://localhost:3000/learn/integrations/package-managers/py-pi#creating-a-pypi-token) and [add it to your repository](http://localhost:3000/learn/integrations/package-managers/py-pi#adding-tokens-to-your-github-repository). 
...
<Info>
Using GitLab? Follow [these steps](/learn/integrations/development-tools/gitlab#add-a-token-to-gitlab). 
</Info>
<Steps>
### Open Repository
