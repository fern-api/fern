...
To authenticate and integrate npm within your TypeScript/JavaScript SDK, you'll need to [create an npm token](/learn/integrations/package-managers/npm#creating-an-npm-token) and [add it to your repository](/learn/integrations/package-managers/npm#adding-tokens-to-your-github-repository). 
