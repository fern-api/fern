...
To host your Fern docs using GitLab, you will need to [add a Fern token to your repository variables](/learn/integrations/development-tools/gitlab#add-a-token-to-gitlab). 
...
You can do this using [the steps listed above](/learn/integrations/development-tools/gitlab#add-a-token-to-gitlab). 
</Steps>
