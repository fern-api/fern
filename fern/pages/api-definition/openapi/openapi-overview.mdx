...
[Read more.](/learn/cli-api/cli-reference/commands/write-definition)

If there are no errors, you can run [fern generate](/learn/cli-api/cli-reference/commands/generate#for-sdks) to generate SDKs or [fern generate --docs](/learn/cli-api/cli-reference/commands/generate#for-documentation) to generate docs.
