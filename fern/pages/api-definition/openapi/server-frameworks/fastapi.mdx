...
```python
from fastapi import FastAPI, servers
...
Please view our [OpenAPI extensions](../extensions#fastapi) page for more information on how to extend your OpenAPI spec, including with Fern OpenAPI extensions.
