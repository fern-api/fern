...
excerpt: Describe the contract between the API provider and API consumer
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon={<img src="https://cdn.worldvectorlogo.com/logos/postman.svg" />}
  >
    A published Postman collection, with example request and responses. 
  </Card>
  <Card
    title="Server Boilerplate"
    icon={<img src="https://cdn.worldvectorlogo.com/logos/fastapi-1.svg" />}
  >
