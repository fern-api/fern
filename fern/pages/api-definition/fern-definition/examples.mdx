...
description: Add examples for API types and endpoints that are shown as comments in SDKs, in API reference documentation, and in a Postman collection, using Fern Definition.
---
