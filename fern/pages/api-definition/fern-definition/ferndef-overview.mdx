...
Once you've defined and configured your API, you can run [fern generate](/learn/cli-api/cli-reference/commands/generate#for-sdks) to generate SDKs or [fern generate --docs](cli-api/cli-reference/commands/generate#for-documentation) to generate docs. 
