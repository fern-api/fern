...
Configuring authentication schemes happens in the `auth-schemes` section of the `api.yml` file. 

<Tabs>
<Tab title="File Directory">
```bash {5}
fern/
...
You can also create your own authentication scheme with customizaed headers. 
