...
- **[Services](/learn/api-definition/fern/services)**. A **service** is a set of related REST endpoints.
- **[Errors](/learn/api-definition/fern/errors)**. An **error** represents a failed (non-200) response from an endpoint.
- **[Imports](/learn/api-definition/fern/imports)**. Use **imports** to import types across files.
