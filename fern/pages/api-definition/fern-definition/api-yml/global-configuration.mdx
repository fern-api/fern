...
It's possible that you may have certain endpoints that do not live at the configured `base-path`. To account 
for this, you can simply override the `base-path` at the endpoint level. 
