...
2. Whether the service requires [authentication](/learn/api-definition/fern/api-yml-reference#authentication)
3. **Endpoints**
...
- The [environment](/learn/api-definition/fern/api-yml-reference#environments) URL
- The service `base-path`
- The endpoint `path`

## Display Name

By default, the display name of an endpoint will be automatically generated. If you would like to customize the endpoint name, you can **set the display name**. 
