---
title: 'API Overview'
subtitle: Manage Docs, SDKs, and code snippets using Fern's API.
...
The Fern API allows you to interact programatically with Fern Docs, SDKs, and code snippets via a REST-styled API. 
