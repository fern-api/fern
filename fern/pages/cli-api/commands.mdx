...
<AccordionGroup toc={true}>
  ...
  <Accordion title="fern generate">
    ...
    Use `--preview` to preview updates to your SDKs before pushing changes to your GitHub repo or publishing to a package manager. The preview SDK will be generated into the `.preview/` folder.
