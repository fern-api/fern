...
| Command | Description |
|---------|-------------|
| [`fern init`](#fern-init) | Initialize new Fern API projects |
| [`fern check`](#fern-check) | Validate API definition & configuration for development and CI |
| [`fern upgrade`](#fern-upgrade) | Update Fern CLI & compiler to latest versions |
...
| [`fern docs broken-links`](#fern-docs-broken-links) | Validate documentation links for quality assurance |
...
| [`fern write-overrides`](#fern-write-overrides) | Create OpenAPI customizations and enhancements |
