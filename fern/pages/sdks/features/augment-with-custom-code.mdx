...
<Tabs>
  ...
  <Tab title="Java">
    <Steps>
      ...
      ### Create a new file `src/main/java/com/example/wrapper/MyClient.java`
      You can extended the Fern client and add whatever methods you want.
      ...
      Add the `wrapper` directory to `.fernignore`.

      <CodeBlock title=".fernignore">
        ```yaml
        + src/main/java/com/example/wrapper
        ```
      </CodeBlock>
