...
<Steps>
  ...
  <Warning>
    You can also configure Fern to push your SDK to a GitHub repository. To do this, 
    you must (1) create a Github repository and (2) install the [Fern GitHub App](https://github.com/apps/fern-api)
    on the repository. 
  </Warning>
  ...
  At this point, you are ready to go and can run `fern generate --version <version>` to 
  see your SDK generate! Make sure that any environment variables like `NPM_TOKEN` are present!
  ...
  <CodeBlocks>
    ...
    <Frame caption="Pass in your version and hit release!">
