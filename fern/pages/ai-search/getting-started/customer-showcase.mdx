---
title: AI Search Customer Showcase
subtitle: See how our customers are using Fern AI Search to elevate their developer experience.
---
<div class="showcase">
---
## <div style={{ display: 'flex', alignItems: 'center', height: '1.5em' }}><img src="../logos/eleven-labs.svg" alt="ElevenLabs" width="16px" height= "16px" class="logo-icon" style={{ marginRight: '10px' }} /> ElevenLabs</div>
...
<CardGroup cols={1}>
  <Card href="https://elevenlabs.io/docs/overview">
    View ElevenLabs' API documentation and AI Search feature
  </Card>
</CardGroup>

---
## <div style={{ display: 'flex', alignItems: 'center', height: '1.5em' }}><img src="../logos/open-router.png" alt="OpenRouter" width="20px" height="20px" class="logo-icon" style={{ marginRight: '10px' }} /> OpenRouter</div>
...
<CardGroup cols={1}>
  <Card href="https://openrouter.ai/docs/quickstart">
    View OpenRouter's API documentation and AI Search feature
  </Card>
</CardGroup>

---
## <div style={{ display: 'flex', alignItems: 'center', height: '1.5em' }}><img src="../logos/vapi.png" alt="Vapi" width="20px" height="20px" class="logo-icon" style={{ marginRight: '10px' }} /> Vapi</div>
<div style={{ display: 'flex', alignItems: 'center' }}>
...
<CardGroup cols={1}>
  <Card href="https://docs.vapi.ai/welcome">
    View Vapi's API documentation and AI Search feature
  </Card>
</CardGroup>
