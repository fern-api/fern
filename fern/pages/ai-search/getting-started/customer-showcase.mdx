...
<div class="showcase">
---
## <div style={{ display: 'flex', alignItems: 'center', height: '1.5em' }}><img src="../assets/eleven-labs.svg" alt="ElevenLabs" width="16px" height= "16px" class="logo-icon" style={{ marginRight: '10px' }} /> ElevenLabs</div>
...
---
## <div style={{ display: 'flex', alignItems: 'center', height: '1.5em' }}><img src="../assets/open-router.png" alt="OpenRouter" width="20px" height="20px" class="logo-icon" style={{ marginRight: '10px' }} /> OpenRouter</div>
