...
<div class="showcase">
---
## <div style={{ display: 'flex', alignItems: 'center', height: '1.5em' }}><img src="../logos/eleven-labs.png" alt="ElevenLabs" width="40px" height= "auto" class="logo-icon" style={{ marginRight: '10px' }} /> ElevenLabs</div>
